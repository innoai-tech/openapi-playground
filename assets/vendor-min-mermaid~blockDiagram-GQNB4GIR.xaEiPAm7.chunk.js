...
import { Q as Qt$1, y as yt$1 } from './vendor-min-mermaid~chunk-HESFG3RP.EvsgN7RW.chunk.js';
import { I as Ie$1, X as Xe$1, b as be$1 } from './vendor-min-mermaid~chunk-YM3XIQPS.CNQBySGW.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { E as Er$1, i as ih, T as Tf, t as tt, S as Sf, a as Su, b as ae$1, H as Hl, c as vc, d as Bc, m as mf, g as gC, O as Oe$1 } from './vendor-min-mermaid~chunk-ZKYS2E5M.Dvid1YGB.chunk.js';
import { _ as _f } from './vendor-min-mermaid~chunk-5ZJXQJOJ.CxiwLIA0.chunk.js';
...
yt.parser = yt;
var Ht = yt;
var X = new Map, kt = [], mt = new Map, jt = "color", Kt = "fill", Te = "bgFill", Ut = ",", Ce = /*#__PURE__*/ Hl(), lt = new Map, Ne = /*#__PURE__*/ m$1((e)=>gC.sanitizeText(e, Ce), "sanitizeText"), Ie = /*#__PURE__*/ m$1(function(e) {
...
var ot = /*#__PURE__*/ m$1((e, t)=>{
    let s = Su, n = /*#__PURE__*/ s(e, "r"), i = /*#__PURE__*/ s(e, "g"), r = /*#__PURE__*/ s(e, "b");
    return ae$1(n, i, r, t);
...
function Lt(e, t) {
    ...
    if (e.children?.length > 0) {
        ...
        l > 0 && l < o && (u = l);
        let g = /*#__PURE__*/ Math.ceil(o / u), x = u * (i + O) + O, m = g * (r + O) + O;
        if (x < s) {
...
function Qt(e) {
    ...
    if (e.children) for (let r of e.children)({ minX: t, minY: s, maxX: n, maxY: i } = /*#__PURE__*/ Qt(r, {
        minX: t,
        minY: s,
        maxX: n,
        maxY: i
...
m$1(te, "applyStyle");
function hr(e) {
    let t = /*#__PURE__*/ ih(/*#__PURE__*/ document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), s = /*#__PURE__*/ t.append("xhtml:div"), n = e.label, i = e.isNode ? "nodeLabel" : "edgeLabel", r = /*#__PURE__*/ s.append("span");
...
var se = /*#__PURE__*/ m$1((e, t)=>{
    let s = /*#__PURE__*/ Hl(), n = /*#__PURE__*/ mf(s.flowchart.htmlLabels), i = t.labelType === "markdown" ? Qt$1(e, t.label, {
        style: t.labelStyle,
        useHtmlLabels: n,
    ...
    if (n) {
        let u = i.children[0], g = /*#__PURE__*/ ih(i);
...
var ie = /*#__PURE__*/ m$1((e, t)=>{
    ...
    let s = t.updatedPath ? t.updatedPath : t.originalPath, n$1 = /*#__PURE__*/ Hl(), { subGraphTitleTotalMargin: i } = n(n$1);
    if (e.label) {
    ...
    let s = e.x, n = e.y, i = /*#__PURE__*/ Math.abs(t.x - s), r = /*#__PURE__*/ Math.abs(t.y - n), a = e.width / 2, l = e.height / 2;
    return i >= a || r >= l;
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    let n = e.x, i = e.y, r = /*#__PURE__*/ Math.abs(n - s.x), a = e.width / 2, l = s.x < t.x ? a - r : a + r, o = e.height / 2, u = /*#__PURE__*/ Math.abs(t.y - s.y), g = /*#__PURE__*/ Math.abs(t.x - s.x);
    ...
    return e.forEach((r)=>{
        if (!ur(t, r) && !i) {
            let a = /*#__PURE__*/ pr(t, n, r), l = false;
            s.forEach((o)=>{
                l = l || o.x === a.x && o.y === a.y;
            }), s.some((o)=>o.x === a.x && o.y === a.y) || s.push(a), i = true;
        } else n = r, i || s.push(r);
    }), s;
}, "cutPathAtIntersect"), ne = /*#__PURE__*/ m$1(function(e, t, s, n, i, r, a) {
    let l = s.points;
    tt.debug("abc88 InsertEdge: edge=", s, "e=", t);
    let o = false, u = /*#__PURE__*/ r.node(t.v);
    var g = /*#__PURE__*/ r.node(t.w);
    g?.intersect && u?.intersect && (l = /*#__PURE__*/ l.slice(1, s.points.length - 1), l.unshift(/*#__PURE__*/ u.intersect(l[0])), l.push(/*#__PURE__*/ g.intersect(l[l.length - 1]))), s.toCluster && (tt.debug("to cluster abc88", n[s.toCluster]), l = /*#__PURE__*/ ae(s.points, n[s.toCluster].node), o = true), s.fromCluster && (tt.debug("from cluster abc88", n[s.fromCluster]), l = /*#__PURE__*/ ae(/*#__PURE__*/ l.reverse(), n[s.fromCluster].node).reverse(), o = true);
    let x = /*#__PURE__*/ l.filter((y)=>!Number.isNaN(y.y)), m = Bc;
    s.curve && (i === "graph" || i === "flowchart") && (m = s.curve);
    let { x: b, y: L } = d(s), _ = /*#__PURE__*/ vc().x(b).y(L).curve(m), S;
    switch(s.thickness){
        case "normal":
    ...
    (Hl().flowchart.arrowMarkerAbsolute || Hl().state.arrowMarkerAbsolute) && (D = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, D = /*#__PURE__*/ D.replace(/\(/g, "\\("), D = /*#__PURE__*/ D.replace(/\)/g, "\\)")), re(I, s, D, a, i);
    let T = {};
...
var fr = /*#__PURE__*/ m$1((e)=>{
    ...
    let n = /*#__PURE__*/ fr(e), i = 2, r = t.height + 2 * s.padding, a = r / i, l = t.width + 2 * a + s.padding, o = s.padding / 2;
...
var oe = xr;
function br(e, t, s, n) {
    var i = e.x, r = e.y, a = i - n.x, l = r - n.y, o = /*#__PURE__*/ Math.sqrt(t * t * l * l + s * s * a * a), u = /*#__PURE__*/ Math.abs(t * s * a / o);
    n.x < i && (u = -u);
...
function mr(e, t, s, n) {
    ...
    if (i = t.y - e.y, a = e.x - t.x, o = t.x * e.y - e.x * t.y, m = i * s.x + a * s.y + o, b = i * n.x + a * n.y + o, !(m !== 0 && b !== 0 && he(m, b)) && (r = n.y - s.y, l = s.x - n.x, u = n.x * s.y - s.x * n.y, g = r * e.x + l * e.y + u, x = r * t.x + l * t.y + u, !(g !== 0 && x !== 0 && he(g, x)) && (L = i * l - r * a, L !== 0))) return _ = /*#__PURE__*/ Math.abs(L / 2), S = a * u - l * o, I = S < 0 ? (S - _) / L : (S + _) / L, S = r * o - i * u, D = S < 0 ? (S - _) / L : (S + _) / L, {
        x: I,
        y: D
    };
}
...
function kr(e, t, s) {
    ...
    for(var o = n - e.width / 2 - a, u = i - e.height / 2 - l, g = 0; g < t.length; g++){
        var x = t[g], m = t[g < t.length - 1 ? g + 1 : 0], b = /*#__PURE__*/ ge(e, s, {
            x: o + x.x,
            y: u + x.y
        }, {
            x: o + m.x,
...
var A = /*#__PURE__*/ m$1(async (e, t, s, n)=>{
    let i = /*#__PURE__*/ Hl(), r, a = t.useHtmlLabels || mf(i.flowchart.htmlLabels);
    ...
    t.labelType === "markdown" ? x = /*#__PURE__*/ Qt$1(o, /*#__PURE__*/ Oe$1(/*#__PURE__*/ Xe$1(u), i), {
        useHtmlLabels: a,
        width: t.width || i.flowchart.wrappingWidth,
        classes: "markdown-node-label"
    }, i) : x = /*#__PURE__*/ g.appendChild(/*#__PURE__*/ W(/*#__PURE__*/ Oe$1(/*#__PURE__*/ Xe$1(u), i), t.labelStyle, false, n));
    let m = /*#__PURE__*/ x.getBBox(), b = t.padding / 2;
    if (mf(i.flowchart.htmlLabels)) {
        let L = x.children[0], _ = /*#__PURE__*/ ih(x), S = /*#__PURE__*/ L.getElementsByTagName("img");
        if (S) {
...
var Lr = /*#__PURE__*/ m$1(async (e, t)=>{
    ...
    let a = /*#__PURE__*/ n.insert("rect", ":first-child");
...
var fe = /*#__PURE__*/ m$1((e)=>e ? " " + e : "", "formatClass"), j = /*#__PURE__*/ m$1((e, t)=>`${t || "node default"}${fe(e.classes)} ${fe(e.class)}`, "getClassesFromNode"), xe = /*#__PURE__*/ m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, /*#__PURE__*/ j(t, void 0), true), i = n.width + t.padding, r = n.height + t.padding, a = i + r, l = [
        {
            x: a / 2,
            y: 0
        },
    ...
    let { shapeSvg: s, bbox: n } = await A(e, t, /*#__PURE__*/ j(t, void 0), true), i = 4, r = n.height + t.padding, a = r / i, l = n.width + 2 * a + t.padding, o = [
        {
            x: a,
            y: 0
        },
    ...
    let { shapeSvg: s, bbox: n } = await A(e, t, void 0, true), i = 2, r = n.height + 2 * t.padding, a = r / i, l = n.width + 2 * a + t.padding, o = /*#__PURE__*/ le(t.directions, n, t), u = /*#__PURE__*/ U(s, l, r, o);
    return u.attr("style", t.style), N(t, u), t.intersect = function(g) {
        return v.polygon(t, o, g);
    }, s;
}, "block_arrow"), Dr = /*#__PURE__*/ m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, /*#__PURE__*/ j(t, void 0), true), i = n.width + t.padding, r = n.height + t.padding, a = [
        {
            x: -r / 2,
            y: 0
        },
    ...
    let { shapeSvg: s, bbox: n } = await A(e, t, /*#__PURE__*/ j(t), true), i = n.width + t.padding, r = n.height + t.padding, a = [
        {
            x: -2 * r / 6,
            y: 0
        },
    ...
    let { shapeSvg: s, bbox: n } = await A(e, t, /*#__PURE__*/ j(t, void 0), true), i = n.width + t.padding, r = i / 2, a = r / (2.5 + i / 50), l = n.height + a + t.padding, o = "M 0," + a + " a " + r + "," + a + " 0,0,0 " + i + " 0 a " + r + "," + a + " 0,0,0 " + -i + " 0 l 0," + l + " a " + r + "," + a + " 0,0,0 " + i + " 0 l 0," + -l, u = /*#__PURE__*/ s.attr("label-offset-y", a).insert("path", ":first-child").attr("style", t.style).attr("d", o).attr("transform", "translate(" + -i / 2 + "," + -(l / 2 + a) + ")");
    ...
    let { shapeSvg: s, bbox: n, halfPadding: i } = await A(e, t, "node " + t.classes + " " + t.class, true), r = /*#__PURE__*/ s.insert("rect", ":first-child"), a = t.positioned ? t.width : n.width + t.padding, l = t.positioned ? t.height : n.height + t.padding, o = t.positioned ? -a / 2 : -n.width / 2 - i, u = t.positioned ? -l / 2 : -n.height / 2 - i;
    ...
    let { shapeSvg: s, bbox: n, halfPadding: i } = await A(e, t, "node " + t.classes, true), r = /*#__PURE__*/ s.insert("rect", ":first-child"), a = t.positioned ? t.width : n.width + t.padding, l = t.positioned ? t.height : n.height + t.padding, o = t.positioned ? -a / 2 : -n.width / 2 - i, u = t.positioned ? -l / 2 : -n.height / 2 - i;
    ...
    let n = /*#__PURE__*/ s.insert("rect", ":first-child"), i = 0, r = 0;
...
function Et(e, t, s, n) {
    ...
    t.includes("t") ? (tt.debug("add top border"), r(s)) : a(s), t.includes("r") ? (tt.debug("add right border"), r(n)) : a(n), t.includes("b") ? (tt.debug("add bottom border"), r(s)) : a(s), t.includes("l") ? (tt.debug("add left border"), r(n)) : a(n), e.attr("stroke-dasharray", /*#__PURE__*/ i.join(" "));
}
m$1(Et, "applyNodePropertyBorders");
var zr = /*#__PURE__*/ m$1((e, t)=>{
    let s;
    t.classes ? s = "node " + t.classes : s = "node default";
    let n = /*#__PURE__*/ e.insert("g").attr("class", s).attr("id", t.domId || t.id), i = /*#__PURE__*/ n.insert("rect", ":first-child"), r = /*#__PURE__*/ n.insert("line"), a = /*#__PURE__*/ n.insert("g").attr("class", "label"), l = t.labelText.flat ? t.labelText.flat() : t.labelText, o = "";
    ...
    if (mf(Hl().flowchart.htmlLabels)) {
        let _ = u.children[0], S = /*#__PURE__*/ ih(u);
        g = /*#__PURE__*/ _.getBoundingClientRect(), S.attr("width", g.width), S.attr("height", g.height);
    }
    tt.info("Text 2", l);
    let x = /*#__PURE__*/ l.slice(1, l.length), m = /*#__PURE__*/ u.getBBox(), b = /*#__PURE__*/ a.node().appendChild(/*#__PURE__*/ W(x.join ? x.join("<br/>") : x, t.labelStyle, true, true));
    if (mf(Hl().flowchart.htmlLabels)) {
        let _ = b.children[0], S = /*#__PURE__*/ ih(b);
        g = /*#__PURE__*/ _.getBoundingClientRect(), S.attr("width", g.width), S.attr("height", g.height);
    }
    let L = t.padding / 2;
    return ih(b).attr("transform", "translate( " + (g.width > m.width ? 0 : (m.width - g.width) / 2) + ", " + (m.height + L + 5) + ")"), ih(u).attr("transform", "translate( " + (g.width < m.width ? 0 : -(m.width - g.width) / 2) + ", 0)"), g = /*#__PURE__*/ a.node().getBBox(), a.attr("transform", "translate(" + -g.width / 2 + ", " + (-g.height / 2 - L + 3) + ")"), i.attr("class", "outer title-state").attr("x", -g.width / 2 - L).attr("y", -g.height / 2 - L).attr("width", g.width + t.padding).attr("height", g.height + t.padding), r.attr("class", "divider").attr("x1", -g.width / 2 - L).attr("x2", g.width / 2 + L).attr("y1", -g.height / 2 - L + m.height + L).attr("y2", -g.height / 2 - L + m.height + L), N(t, i), t.intersect = function(_) {
        return v.rect(t, _);
    }, n;
}, "rectWithTitle"), Mr = /*#__PURE__*/ m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, /*#__PURE__*/ j(t, void 0), true), i = n.height + t.padding, r = n.width + i / 4 + t.padding, a = /*#__PURE__*/ s.insert("rect", ":first-child").attr("style", t.style).attr("rx", i / 2).attr("ry", i / 2).attr("x", -r / 2).attr("y", -i / 2).attr("width", r).attr("height", i);
    return N(t, a), t.intersect = function(l) {
        return v.rect(t, l);
    }, s;
}, "stadium"), Fr = /*#__PURE__*/ m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n, halfPadding: i } = await A(e, t, /*#__PURE__*/ j(t, void 0), true), r = /*#__PURE__*/ s.insert("circle", ":first-child");
    ...
    let { shapeSvg: s, bbox: n, halfPadding: i } = await A(e, t, /*#__PURE__*/ j(t, void 0), true), r = 5, a = /*#__PURE__*/ s.insert("g", ":first-child"), l = /*#__PURE__*/ a.insert("circle"), o = /*#__PURE__*/ a.insert("circle");
    ...
    let n = /*#__PURE__*/ e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), i = 70, r = 10;
    s === "LR" && (i = 10, r = 70);
    let a = /*#__PURE__*/ n.append("rect").attr("x", -1 * i / 2).attr("y", -1 * r / 2).attr("width", i).attr("height", r).attr("class", "fork-join");
    ...
    let a = /*#__PURE__*/ e.insert("g").attr("class", r).attr("id", t.domId || t.id), l = /*#__PURE__*/ a.insert("rect", ":first-child"), o = /*#__PURE__*/ a.insert("line"), u = /*#__PURE__*/ a.insert("line"), g = 0, x = n, m = /*#__PURE__*/ a.insert("g").attr("class", "label"), b = 0, L = t.classData.annotations?.[0], _ = t.classData.annotations[0] ? "\xAB" + t.classData.annotations[0] + "\xBB" : "", S = /*#__PURE__*/ m.node().appendChild(/*#__PURE__*/ W(_, t.labelStyle, true, true)), I = /*#__PURE__*/ S.getBBox();
    if (mf(Hl().flowchart.htmlLabels)) {
        let E = S.children[0], h = /*#__PURE__*/ ih(S);
    ...
    let T = /*#__PURE__*/ m.node().appendChild(/*#__PURE__*/ W(D, t.labelStyle, true, true));
    ih(T).attr("class", "classTitle");
    let y = /*#__PURE__*/ T.getBBox();
    if (mf(Hl().flowchart.htmlLabels)) {
        let E = T.children[0], h = /*#__PURE__*/ ih(T);
    ...
    t.classData.members.forEach((E)=>{
        ...
        Hl().flowchart.htmlLabels && (Y = /*#__PURE__*/ Y.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
        let p = /*#__PURE__*/ m.node().appendChild(/*#__PURE__*/ W(Y, h.cssStyle ? h.cssStyle : t.labelStyle, true, true)), R = /*#__PURE__*/ p.getBBox();
        if (mf(Hl().flowchart.htmlLabels)) {
            let Z = p.children[0], V = /*#__PURE__*/ ih(p);
    ...
    if (t.link) {
        let r;
        Hl().securityLevel === "sandbox" ? r = "_top" : t.linkTarget && (r = t.linkTarget || "_blank"), n = /*#__PURE__*/ e.insert("svg:a").attr("xlink:href", t.link).attr("target", r), i = await ye[t.shape](n, t, s);
...
async function Kr(e, t, s) {
    let n = /*#__PURE__*/ ke(t, s, false);
    if (n.type === "group") return;
    let i = /*#__PURE__*/ Er$1(), r = await _t(e, n, {
        config: i
    }), a = /*#__PURE__*/ r.node().getBBox(), l = /*#__PURE__*/ s.getBlock(n.id);
    l.size = {
        width: a.width,
        height: a.height,
        x: 0,
...
async function Se(e, t, s, n, i) {
    ...
    for (let a of t)if (a.start && a.end) {
        let l = /*#__PURE__*/ n.getBlock(a.start), o = /*#__PURE__*/ n.getBlock(a.end);
        if (l?.size && o?.size) {
...
var Ur = /*#__PURE__*/ m$1(function(e, t) {
...
}, "getClasses"), Vr = /*#__PURE__*/ m$1(async function(e, t, s, n) {
    let { securityLevel: i, block: r } = Er$1(), a = n.db, l;
    i === "sandbox" && (l = /*#__PURE__*/ ih("#i" + t));
    ...
    let x = /*#__PURE__*/ a.getBlocks(), m = /*#__PURE__*/ a.getBlocksFlat(), b = /*#__PURE__*/ a.getEdges(), L = /*#__PURE__*/ u.insert("g").attr("class", "block");
    await we(L, x, a);
    let _ = /*#__PURE__*/ $t(a);
    if (await Le(L, x, a), await Se(L, b, m, a, t), _) {
        let S = _, I = /*#__PURE__*/ Math.max(1, /*#__PURE__*/ Math.round(.125 * (S.width / S.height))), D = S.height + I + 10, T = S.width + 10, { useMaxWidth: y } = r;
