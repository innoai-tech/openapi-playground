import { U as Ut$1 } from './vendor-min-mermaid~chunk-RGZHNYJS.BZGdGDWl.chunk.js';
import { f } from './vendor-min-mermaid~chunk-TI4EEUUG.BFlBPHyk.chunk.js';
import { G as Go, U as Uo, j as jo, $ as $o, H as Ho, N as No, u as ur, R as Ro, n as nn$1, P as Po } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
import { i as ia, v as vs, h as Vo, j as Wo, k as Zi, Y as Yf, p as pt$1, S as Su, l as Hn, m as ke, n as $t$1, o as Xa, r as Va, s as zt, t as Wa, u as qa, M as Me$1, D as Dt$1, w as be, x as we, T as Tt$1, y as jt$1, C as ku, F as Bo } from './vendor-min-mermaid~chunk-BF7QJ6L7.DK9jwCiC.chunk.js';
...
var Ae = {
    ...
    Qt = [], wt = [], ft = "", Kt = [], Tt = 0, Ht = void 0, vt = void 0, V = [], K = "", Xt = "", $t = "", qt = void 0, Ut = "", yt = [], pt = [], gt = false, Jt = false, jt = 0, Zt = new Map, Po(), te = "sunday", _t = "saturday";
    ...
    let s = n;
    ur().securityLevel !== "loose" && (s = /*#__PURE__*/ (0, Ie.sanitizeUrl)(n)), t.split(",").forEach(function(a) {
        st(a) !== void 0 && (Ge(a, ()=>{
            window.open(s, "_self");
        }), Zt.set(a, s));
    }), je(t, "clickable");
    ...
    if (ur().securityLevel !== "loose" || n === void 0) return;
    let a = [];
    if (typeof s == "string") {
    ...
    getConfig: /*#__PURE__*/ m$1(()=>ur().gantt, "getConfig"),
    clear: $e,
    setDateFormat: sn,
    getDateFormat: fn,
...
var In = /*#__PURE__*/ m$1(function() {
    ...
    let r = ur().gantt, d = ur().securityLevel, h;
    ...
    m$1(L, "taskCompare"), C.sort(L), Y(C, tt, z), Ro(p, z, tt, r.useMaxWidth), p.append("text").text(/*#__PURE__*/ a.db.getDiagramTitle()).attr("x", tt / 2).attr("y", r.titleTopMargin).attr("class", "titleText");
    function Y(g, v, T) {
    ...
    function U(g, v) {
        ...
        p.append("g").selectAll("text").data(x).enter().append(function(b) {
            let w = /*#__PURE__*/ b[0].split(nn$1.lineBreakRegex), l = -(w.length - 1) / 2, f = /*#__PURE__*/ _.createElementNS("http://www.w3.org/2000/svg", "text");
