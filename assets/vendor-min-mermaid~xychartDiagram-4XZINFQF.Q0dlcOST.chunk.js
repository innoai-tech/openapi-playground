import { d as d$1 } from './vendor-min-mermaid~chunk-I2YQ4O7X.eSgKSoUq.chunk.js';
import { Q as Qr } from './vendor-min-mermaid~chunk-ABV7UDA7.pPZHVmyz.chunk.js';
import { L as Le } from './vendor-min-mermaid~chunk-IIWVAQKY.CwtpAX-Q.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { B as Bf, F as Ff, M as Mf, L as Lf, w as wf, v as vf, t as tt$1, T as Tf, S as Sf, E as Er, p as pl, X as hl, D as De$1, aO as Ya, a2 as Ia, b as vc } from './vendor-min-mermaid~chunk-RAMAZW42.vc82q0BN.chunk.js';
...
var ht = class extends K {
    ...
    constructor(t, e, a, n, l){
        super(t, n, l, e), this.categories = a, this.scale = /*#__PURE__*/ Ya().domain(this.categories).range(/*#__PURE__*/ this.getRange());
    }
    setRange(t) {
        super.setRange(t);
    }
    recalculateScale() {
        this.scale = /*#__PURE__*/ Ya().domain(this.categories).range(/*#__PURE__*/ this.getRange()).paddingInner(1).paddingOuter(0).align(.5), tt$1.trace("BandAxis axis final categories, range: ", this.categories, /*#__PURE__*/ this.getRange());
    }
    getTickValues() {
...
var lt = class extends K {
    ...
    constructor(t, e, a, n, l){
        super(t, n, l, e), this.domain = a, this.scale = /*#__PURE__*/ Ia().domain(this.domain).range(/*#__PURE__*/ this.getRange());
    }
    getTickValues() {
    ...
    recalculateScale() {
        ...
        this.axisPosition === "left" && t.reverse(), this.scale = /*#__PURE__*/ Ia().domain(t).range(/*#__PURE__*/ this.getRange());
    }
    getScaleValue(t) {
        return this.scale(t);
    }
...
var ct = class {
    ...
    getDrawableElement() {
        ...
        return this.orientation === "horizontal" ? e = /*#__PURE__*/ vc().y((a)=>a[0]).x((a)=>a[1])(t) : e = /*#__PURE__*/ vc().x((a)=>a[0]).y((a)=>a[1])(t), e ? [
            {
                groupTexts: [
                    "plot",
...
function Ce() {
    ...
    return d.title = /*#__PURE__*/ Mf(), ut.build(tt, d, et, Zt);
}
...
var we = /*#__PURE__*/ m$1(function() {
    Sf(), J = 0, tt = /*#__PURE__*/ te(), d = /*#__PURE__*/ ee(), et = /*#__PURE__*/ Jt(), vt = /*#__PURE__*/ et.plotColorPalette.split(",").map((i)=>i.trim()), xt = false, Et = false;
}, "clear"), ne = {
    getDrawableElem: Ce,
    clear: we,
    setAccTitle: vf,
...
` + i);
    ...
    Tf(_, x.height, x.width, true), _.attr("viewBox", `0 0 ${x.width} ${x.height}`), I.attr("fill", l.backgroundColor), n.setTmpSVGG(/*#__PURE__*/ _.append("g").attr("class", "mermaid-tmp-group"));
