import { G as Gr$1 } from "./vendor-min-mermaid~chunk-MBJCTAW2.dQwDb1IE.chunk.js";
...
import { S as St, y as yt, T as Te } from "./vendor-min-mermaid~chunk-2VPXETT4.xhKexg6X.chunk.js";
import { Q as Qt$1 } from "./vendor-min-mermaid~chunk-HESFG3RP.X24hc0uC.chunk.js";
import "./vendor-min-mermaid~chunk-YM3XIQPS.DzKxOkHI.chunk.js";
import { m as m$1, q, n } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
import { F as Ff, B as Bf, w as wf, v as vf, L as Lf, M as Mf, P as Pl, S as Sf, t as tt, H as Hl, i as ih, p as pl } from "./vendor-min-mermaid~chunk-ZKYS2E5M.DYmB7G2x.chunk.js";
    ...
    return function(E) {
      ...
      function(E, M, N) {
        ...
        i.prototype.getSource = function() {
          ...
          for (var u = this.getOtherEnd(c2), r = t.getGraphManager().getRoot(); ; ) {
          ...
          var c2 = new Array(4);
          this.isOverlapingSourceAndTarget = s2.getIntersection(this.target.getRect(), this.source.getRect(), c2), this.isOverlapingSourceAndTarget || (this.lengthX = c2[0] - c2[2], this.lengthY = c2[1] - c2[3], Math.abs(this.lengthX) < 1 && (this.lengthX = n2.sign(this.lengthX)), Math.abs(this.lengthY) < 1 && (this.lengthY = n2.sign(this.lengthY)), this.length = Math.sqrt(this.lengthX * this.lengthX + this.lengthY * this.lengthY));
        }, i.prototype.updateLengthSimple = function() {
          this.lengthX = this.target.getCenterX() - this.source.getCenterX(), this.lengthY = this.target.getCenterY() - this.source.getCenterY(), Math.abs(this.lengthX) < 1 && (this.lengthX = n2.sign(this.lengthX)), Math.abs(this.lengthY) < 1 && (this.lengthY = n2.sign(this.lengthY)), this.length = Math.sqrt(this.lengthX * this.lengthX + this.lengthY * this.lengthY);
        }, E.exports = i;
      },
      function(E, M, N) {
        function g(s2) {
      ...
      function(E, M, N) {
        var g = N(2), s2 = N(10), n2 = N(13), i = N(0), a = N(16), c2 = N(5);
        function t(r, e, o, f) {
        ...
        t.prototype.getEdges = function() {
          ...
          var f = new c2(e, o), l = r.inverseTransformPoint(f);
      ...
      function(E, M, N) {
        var g = N(2), s2 = N(10), n2 = N(0), i = N(7), a = N(3), c2 = N(1), t = N(13), u = N(12), r = N(11);
        function e(f, l, A) {
        ...
        e.prototype.getNodes = function() {
          ...
          for (var f = s2.MAX_VALUE, l = s2.MAX_VALUE, A, v, y, D = this.getNodes(), S = D.length, C = 0; C < S; C++) {
            var b = D[C];
          ...
          l == s2.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), X[0].getParent().paddingLeft != null ? z = X[0].getParent().paddingLeft : z = this.margin, this.left = h.x - z, this.right = h.x + h.width + z, this.top = h.y - z, this.bottom = h.y + h.height + z;
          ...
          var l = new r(), A = /* @__PURE__ */ new Set(), v = this.nodes[0], y, D, S = v.withChildren();
      ...
      function(E, M, N) {
        ...
        m$1(n2, "LGraphManager"), n2.prototype.addRoot = function() {
          var i = this.layout.newGraph(), a = this.layout.newNode(null), c2 = this.add(i, a);
          ...
          if (this.allNodes == null) {
            for (var i = [], a = this.getGraphs(), c2 = a.length, t = 0; t < c2; t++) i = i.concat(a[t].getNodes());
            this.allNodes = i;
          }
          ...
          if (this.allEdges == null) {
            for (var i = [], a = this.getGraphs(), c2 = a.length, t = 0; t < a.length; t++) i = i.concat(a[t].getEdges());
          ...
          for (var i, a, c2, t, u, r = this.getAllEdges(), e = r.length, o = 0; o < e; o++) {
          ...
          for (var c2, t = i.getNodes(), u = t.length, r = 0; r < u; r++) c2 = t[r], c2.inclusionTreeDepth = a, c2.child != null && this.calcInclusionTreeDepths(c2.child, a + 1);
      ...
      function(E, M, N) {
        ...
        m$1(s2, "IGeometry"), s2.calcSeparationAmount = function(n2, i, a, c2) {
          ...
          var t = new Array(2);
          this.decideDirectionsForOverlappingNodes(n2, i, t), a[0] = Math.min(n2.getRight(), i.getRight()) - Math.max(n2.x, i.x), a[1] = Math.min(n2.getBottom(), i.getBottom()) - Math.max(n2.y, i.y), n2.getX() <= i.getX() && n2.getRight() >= i.getRight() ? a[0] += Math.min(i.getX() - n2.getX(), n2.getRight() - i.getRight()) : i.getX() <= n2.getX() && i.getRight() >= n2.getRight() && (a[0] += Math.min(n2.getX() - i.getX(), i.getRight() - n2.getRight())), n2.getY() <= i.getY() && n2.getBottom() >= i.getBottom() ? a[1] += Math.min(i.getY() - n2.getY(), n2.getBottom() - i.getBottom()) : i.getY() <= n2.getY() && i.getBottom() >= n2.getBottom() && (a[1] += Math.min(n2.getY() - i.getY(), i.getBottom() - n2.getBottom()));
          var u = Math.abs((i.getCenterY() - n2.getCenterY()) / (i.getCenterX() - n2.getCenterX()));
          ...
          var c2 = n2.getCenterX(), t = n2.getCenterY(), u = i.getCenterX(), r = i.getCenterY();
          if (n2.intersects(i)) return a[0] = c2, a[1] = t, a[2] = u, a[3] = r, true;
          var e = n2.getX(), o = n2.getY(), f = n2.getRight(), l = n2.getX(), A = n2.getBottom(), v = n2.getRight(), y = n2.getWidthHalf(), D = n2.getHeightHalf(), S = i.getX(), C = i.getY(), b = i.getRight(), z = i.getX(), X = i.getBottom(), K = i.getRight(), R = i.getWidthHalf(), J = i.getHeightHalf(), h = false, m = false;
          if (c2 === u) {
            ...
            if (c2 > u ? t > r ? (O = this.getCardinalDirection(d2, p2, 4), x = this.getCardinalDirection(T, p2, 2)) : (O = this.getCardinalDirection(-d2, p2, 3), x = this.getCardinalDirection(-T, p2, 1)) : t > r ? (O = this.getCardinalDirection(-d2, p2, 1), x = this.getCardinalDirection(-T, p2, 3)) : (O = this.getCardinalDirection(d2, p2, 2), x = this.getCardinalDirection(T, p2, 4)), !h) switch (O) {
              case 1:
          ...
          var t = void 0;
          return n2 !== a ? (t = Math.atan((c2 - i) / (a - n2)), a < n2 ? t += Math.PI : c2 < i && (t += this.TWO_PI)) : c2 < i ? t = this.ONE_AND_HALF_PI : t = this.HALF_PI, t;
          ...
          return m$1(t, "LinkedList"), g(t, [
            ...
            },
            {
              ...
              value: m$1(function(r, e) {
                return i(e.prev, n2(r), e, this);
              }, "insertBefore")
            },
            {
              key: "insertAfter",
              value: m$1(function(r, e) {
                return i(e, n2(r), e.next, this);
              }, "insertAfter")
            },
            {
            ...
            },
            {
              ...
              value: m$1(function(r) {
                return i(this.tail, n2(r), null, this);
              }, "push")
            },
            {
              key: "unshift",
              value: m$1(function(r) {
                return i(null, n2(r), this.head, this);
              }, "unshift")
            },
            {
              key: "remove",
      ...
      function(E, M, N) {
        ...
        m$1(g, "Point"), g.prototype.getX = function() {
          ...
          s2.constructor.name == "Point" && n2 == null && i == null ? (i = s2, this.setLocation(i.x, i.y)) : typeof s2 == "number" && typeof n2 == "number" && i == null && (parseInt(s2) == s2 && parseInt(n2) == n2 ? this.move(s2, n2) : (this.x = Math.floor(s2 + 0.5), this.y = Math.floor(n2 + 0.5)));
      ...
      function(E, M, N) {
        ...
        m$1(s2, "UniqueIDGeneretor"), s2.lastID = 0, s2.createID = function(n2) {
          return s2.isPrimitive(n2) ? n2 : (n2.uniqueID != null || (n2.uniqueID = s2.getString(), s2.lastID++), n2.uniqueID);
      ...
      function(E, M, N) {
        ...
        var s2 = N(0), n2 = N(7), i = N(3), a = N(1), c2 = N(6), t = N(5), u = N(17), r = N(29);
        function e(o) {
        ...
        m$1(e, "Layout"), e.RANDOM_SEED = 1, e.prototype = Object.create(r.prototype), e.prototype.getGraphManager = function() {
          ...
          var o;
          return this.checkLayoutSuccess() ? o = false : o = this.layout(), s2.ANIMATE === "during" ? false : (o && (this.isSubLayout || this.doPostLayout()), this.tilingPostLayout && this.tilingPostLayout(), this.isLayoutFinished = true, o);
      ...
      function(E, M, N) {
        ...
        m$1(g, "_toConsumableArray");
        var s2 = N(15), n2 = N(4), i = N(0), a = N(8), c2 = N(9);
        function t() {
        ...
        m$1(t, "FDLayout"), t.prototype = Object.create(s2.prototype);
      ...
      function(E, M, N) {
        ...
        m$1(n2, "FDLayoutEdge"), n2.prototype = Object.create(g.prototype);
      ...
      function(E, M, N) {
        ...
        m$1(n2, "FDLayoutNode"), n2.prototype = Object.create(g.prototype);
        for (var i in g) n2[i] = g[i];
      ...
      function(E, M, N) {
        ...
        m$1(s2, "HashSet"), s2.prototype.add = function(n2) {
          ...
          for (var i = Object.keys(this.set), a = i.length, c2 = 0; c2 < a; c2++) n2.push(this.set[i[c2]]);
        }, s2.prototype.size = function() {
          return Object.keys(this.set).length;
      ...
      function(E, M, N) {
        ...
        m$1(g, "Matrix"), g.multMat = function(s2, n2) {
          ...
          return Math.sqrt(this.dotProduct(s2, s2));
        }, g.normalize = function(s2) {
          for (var n2 = [], i = this.mag(s2), a = 0; a < s2.length; a++) n2[a] = s2[a] / i;
          return n2;
      ...
      function(E, M, N) {
        ...
        m$1(s2, "_classCallCheck");
        var n2 = N(11), i = function() {
          function a(c2, t) {
            s2(this, a), (t !== null || t !== void 0) && (this.compareFunction = this._defaultCompareFunction);
            var u = void 0;
            c2 instanceof n2 ? u = c2.size() : u = c2.length, this._quicksort(c2, 0, u - 1);
          }
      ...
      function(E, M, N) {
        ...
        m$1(g, "SVD"), g.svd = function(s2) {
          ...
          var n2 = Math.min(this.m, this.n);
          this.s = function(Ot) {
            for (var Nt = []; Ot-- > 0; ) Nt.push(0);
            return Nt;
          }(Math.min(this.m + 1, this.n)), this.U = function(Ot) {
            var Nt = m$1(function Zt(St2) {
              if (St2.length == 0) return 0;
              for (var Wt = [], $t = 0; $t < St2[0]; $t++) Wt.push(Zt(St2.slice(1)));
              return Wt;
            }, "allocate");
            return Nt(Ot);
          }([
          ...
          for (var i = function(Ot) {
            ...
            for (var Nt = []; Ot-- > 0; ) Nt.push(0);
            return Nt;
          }(this.m), c2 = true, t = true, u = Math.min(this.m - 1, this.n), r = Math.max(0, Math.min(this.n - 2, this.m)), e = 0; e < Math.max(u, r); e++) {
            if (e < u) {
              this.s[e] = 0;
              for (var o = e; o < this.m; o++) this.s[e] = g.hypot(this.s[e], s2[o][e]);
              if (this.s[e] !== 0) {
          ...
          for (var j = m - 1, ht = 0, Lt = Math.pow(2, -52), bt = Math.pow(2, -966); m > 0; ) {
            ...
            switch (Q++, Xt) {
              case 1:
                {
                  ...
                  for (var yt2 = m - 2; yt2 >= Q; yt2--) {
                    var Et = g.hypot(this.s[yt2], rt), Dt = this.s[yt2] / Et, Tt = rt / Et;
              ...
              case 3:
                {
                  var Y = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[m - 1]), Math.abs(this.s[m - 2])), Math.abs(i[m - 2])), Math.abs(this.s[Q])), Math.abs(i[Q])), W = this.s[m - 1] / Y, V = this.s[m - 2] / Y, $ = i[m - 2] / Y, k = this.s[Q] / Y, _ = i[Q] / Y, gt = ((V + W) * (V - W) + $ * $) / 2, ft = W * $ * (W * $), q2 = 0;
                  /* @__PURE__ */ (function(Ot, Nt) {
                    return Ot || Nt;
                  })(gt !== 0, ft !== 0) && (q2 = Math.sqrt(gt * gt + ft), gt < 0 && (q2 = -q2), q2 = ft / (gt + q2));
                  for (var lt = (k + W) * (k - W) + q2, ut = k * _, it = Q; it < m - 1; it++) {
                    ...
                    if (pt = g.hypot(lt, ut), Ct = lt / pt, st = ut / pt, this.s[it] = pt, lt = Ct * i[it] + st * this.s[it + 1], this.s[it + 1] = -st * i[it] + Ct * this.s[it + 1], ut = st * i[it + 1], i[it + 1] = Ct * i[it + 1], c2 && it < this.m - 1) for (var dt = 0; dt < this.m; dt++) pt = Ct * this.U[dt][it] + st * this.U[dt][it + 1], this.U[dt][it + 1] = -st * this.U[dt][it] + Ct * this.U[dt][it + 1], this.U[dt][it] = pt;
                  }
                  i[m - 2] = lt, ht = ht + 1;
                }
                break;
      ...
      function(E, M, N) {
        ...
        var n2 = function() {
          ...
          return m$1(i, "NeedlemanWunsch"), g(i, [
            ...
            {
              key: "getAllIndexes",
              value: m$1(function(c2, t) {
                for (var u = [], r = -1; (r = c2.indexOf(t, r + 1)) !== -1; ) u.push(r);
                return u;
              }, "getAllIndexes")
            },
            {
              key: "arrayAllMaxIndexes",
              value: m$1(function(c2) {
  ...
  m$1(function(M, N) {
    ...
    return (() => {
      var M = {
        45: (n2, i, a) => {
          var c2 = {};
          c2.layoutBase = a(551), c2.CoSEConstants = a(806), c2.CoSEEdge = a(767), c2.CoSEGraph = a(880), c2.CoSEGraphManager = a(578), c2.CoSELayout = a(765), c2.CoSENode = a(991), c2.ConstraintHandler = a(902), n2.exports = c2;
        },
        806: (n2, i, a) => {
        ...
        767: (n2, i, a) => {
          ...
          m$1(t, "CoSEEdge"), t.prototype = Object.create(c2.prototype);
          for (var u in c2) t[u] = c2[u];
          n2.exports = t;
        },
        880: (n2, i, a) => {
          ...
          m$1(t, "CoSEGraph"), t.prototype = Object.create(c2.prototype);
          for (var u in c2) t[u] = c2[u];
          n2.exports = t;
        },
        578: (n2, i, a) => {
          ...
          m$1(t, "CoSEGraphManager"), t.prototype = Object.create(c2.prototype);
          for (var u in c2) t[u] = c2[u];
          n2.exports = t;
        },
        765: (n2, i, a) => {
          var c2 = a(551).FDLayout, t = a(578), u = a(880), r = a(991), e = a(767), o = a(806), f = a(902), l = a(551).FDLayoutConstants, A = a(551).LayoutConstants, v = a(551).Point, y = a(551).PointD, D = a(551).DimensionD, S = a(551).Layout, C = a(551).Integer, b = a(551).IGeometry, z = a(551).LGraph, X = a(551).Transform, K = a(551).LinkedList;
          function R() {
            c2.call(this), this.toBeTiled = {}, this.constraints = {};
          }
          m$1(R, "CoSELayout"), R.prototype = Object.create(c2.prototype);
          ...
          R.prototype.newGraphManager = function() {
            ...
            if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
              if (o.TREE_REDUCTION_ON_INCREMENTAL) {
                ...
                var m = new Set(this.getAllNodes()), d2 = this.nodesWithGravity.filter(function(O) {
                  return m.has(O);
                });
              ...
              if (h.length > 0) this.positionNodesRadially(h);
                ...
                this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
                var m = new Set(this.getAllNodes()), d2 = this.nodesWithGravity.filter(function(T) {
                  return m.has(T);
                });
            ...
            if (this.isTreeGrowing) {
              if (this.growTreeIterations % 10 == 0) if (this.prunedNodesAll.length > 0) {
                ...
                var h = new Set(this.getAllNodes()), m = this.nodesWithGravity.filter(function(p2) {
                  return h.has(p2);
                });
            ...
            for (var h = this.graphManager.getAllNodes(), m = {}, d2 = 0; d2 < h.length; d2++) {
            ...
            for (var h = this.getAllNodes(), m, d2 = 0; d2 < h.length; d2++) m = h[d2], m.calculateDisplacement();
            ...
            for (var m = this.graphManager.getAllNodes(), d2 = 0; d2 < m.length; d2++) {
              var T = m[d2];
              this.idToNodeMap.set(T.id, T);
            }
            var p2 = m$1(function w(U) {
            ...
            if (this.constraints.fixedNodeConstraint) {
              ...
              for (var m = this.graphManager.getAllNodes(), T, d2 = 0; d2 < m.length; d2++) if (T = m[d2], T.getChild() != null) {
                var O = p2(T);
            ...
            if (this.constraints.relativePlacementConstraint) {
              ...
              if (o.RELAX_MOVEMENT_ON_CONSTRAINTS) this.shuffle = function(w) {
                ...
                }, "constructComponents"), tt2 = P(Z, h.fixedNodesOnHorizontal);
              ...
              for (var d2 = 0; d2 < this.componentsOnHorizontal.length; d2++) {
                ...
                if (this.fixedComponentsOnHorizontal[d2]) for (var p2 = 0; p2 < I.length; p2++) this.dummyToNodeForVerticalAlignment.has(I[p2]) ? this.dummyToNodeForVerticalAlignment.get(I[p2]).forEach(function(U) {
                  ...
                  for (var Z = 0, et = 0, p2 = 0; p2 < I.length; p2++) if (this.dummyToNodeForVerticalAlignment.has(I[p2])) {
                    var P = this.dummyToNodeForVerticalAlignment.get(I[p2]);
              ...
              for (var d2 = 0; d2 < this.componentsOnVertical.length; d2++) {
                ...
                if (this.fixedComponentsOnVertical[d2]) for (var p2 = 0; p2 < I.length; p2++) this.dummyToNodeForHorizontalAlignment.has(I[p2]) ? this.dummyToNodeForHorizontalAlignment.get(I[p2]).forEach(function(H) {
                  ...
                  for (var Z = 0, et = 0, p2 = 0; p2 < I.length; p2++) if (this.dummyToNodeForHorizontalAlignment.has(I[p2])) {
                    var P = this.dummyToNodeForHorizontalAlignment.get(I[p2]);
            ...
            var h = [], m, d2 = this.graphManager.getGraphs(), T = d2.length, p2;
            for (p2 = 0; p2 < T; p2++) m = d2[p2], m.updateConnected(), m.isConnected || (h = h.concat(m.getNodes()));
            return h;
            ...
            for (d2 = 0; d2 < h.length; d2++) {
              var T = h[d2];
              if (!m.has(T)) {
                var p2 = T.getSource(), O = T.getTarget();
                if (p2 == O) T.getBendpoints().push(new y()), T.getBendpoints().push(new y()), this.createDummyNodesForBendpoints(T), m.add(T);
                else {
                  var x = [];
                  if (x = x.concat(p2.getEdgeListToNode(O)), x = x.concat(O.getEdgeListToNode(p2)), !m.has(x[0])) {
                    if (x.length > 1) {
                      var G;
            ...
            for (var m = new v(0, 0), d2 = Math.ceil(Math.sqrt(h.length)), T = 0, p2 = 0, O = 0, x = new y(0, 0), G = 0; G < h.length; G++) {
              G % d2 == 0 && (O = 0, p2 = T, G != 0 && (p2 += o.DEFAULT_COMPONENT_SEPERATION), T = 0);
              var F = h[G], I = S.findCenterOfTree(F);
              m.x = O, m.y = p2, x = R.radialLayout(F, I, m), x.y > T && (T = Math.floor(x.y)), O = Math.floor(x.x + o.DEFAULT_COMPONENT_SEPERATION);
            }
            ...
            var p2 = z.calculateBounds(h), O = new X();
            O.setDeviceOrgX(p2.getMinX()), O.setDeviceOrgY(p2.getMinY()), O.setWorldOrgX(d2.x), O.setWorldOrgY(d2.y);
            ...
            for (var d2 = [], T = this.graphManager.getAllNodes(), p2 = 0; p2 < T.length; p2++) {
              var O = T[p2], x = O.getParent();
            ...
            Object.keys(m).forEach(function(F) {
              if (m[F].length > 1) {
                ...
                var P = h.getGraphManager().add(h.newGraph(), et), tt2 = Z.getChild();
                tt2.add(et);
            ...
            for (var d2 = 0; d2 < this.compoundOrder.length; d2++) m[this.compoundOrder[d2].id] = this.compoundOrder[d2], h[this.compoundOrder[d2].id] = [].concat(this.compoundOrder[d2].getChild().getNodes()), this.graphManager.remove(this.compoundOrder[d2].getChild()), this.compoundOrder[d2].child = null;
            ...
            Object.keys(this.memberGroups).forEach(function(d2) {
              ...
              if (m[d2] = h.tileNodes(h.memberGroups[d2], T.paddingLeft + T.paddingRight), T.rect.width = m[d2].width, T.rect.height = m[d2].height, T.setCenter(m[d2].centerX, m[d2].centerY), T.labelMarginLeft = 0, T.labelMarginTop = 0, o.NODE_DIMENSIONS_INCLUDE_LABELS) {
            ...
            for (var T = d2.getNodes(), p2 = 0; p2 < T.length; p2++) {
              var O = T[p2];
            ...
            for (var m = h.id, d2 = h.getEdges(), T = 0, p2 = 0; p2 < d2.length; p2++) {
              var O = d2[p2];
            ...
            for (var d2 = h.getChild().getNodes(), T = 0; T < d2.length; T++) {
              var p2 = d2[T];
              m += this.getNodeDegreeWithChildren(p2);
            }
            return m;
            ...
            for (var m = 0; m < h.length; m++) {
              var d2 = h[m];
              d2.getChild() != null && this.fillCompexOrderByDFS(d2.getChild().getNodes()), this.getToBeTiled(d2) && this.compoundOrder.push(d2);
            }
            ...
            this.tiledMemberPack = [], Object.keys(h).forEach(function(T) {
              var p2 = m[T];
              if (d2.tiledMemberPack[T] = d2.tileNodes(h[T], p2.paddingLeft + p2.paddingRight), p2.rect.width = d2.tiledMemberPack[T].width, p2.rect.height = d2.tiledMemberPack[T].height, p2.setCenter(d2.tiledMemberPack[T].centerX, d2.tiledMemberPack[T].centerY), p2.labelMarginLeft = 0, p2.labelMarginTop = 0, o.NODE_DIMENSIONS_INCLUDE_LABELS) {
            ...
            var d2 = this.tileNodesByFavoringDim(h, m, true), T = this.tileNodesByFavoringDim(h, m, false), p2 = this.getOrgRatio(d2), O = this.getOrgRatio(T), x;
            ...
            O && (x.idealRowWidth = this.calcIdealRowWidth(h, d2));
            ...
            for (var et = 0; et < h.length; et++) {
              ...
              if (x.rows.length == 0) this.insertNodeToRow(x, P, 0, m);
                ...
                x.idealRowWidth || (tt2 = this.getShortestRowIndex(x)), this.insertNodeToRow(x, P, tt2, m);
            ...
            var m = this.getLongestRowIndex(h), d2 = h.rowWidth.length - 1, T = h.rows[m], p2 = T[T.length - 1], O = p2.width + h.horizontalPadding;
            ...
            for (var h = [], m = true, d2; m; ) {
              var T = this.graphManager.getAllNodes(), p2 = [];
              m = false;
              for (var O = 0; O < T.length; O++) if (d2 = T[O], d2.getEdges().length == 1 && !d2.getEdges()[0].isInterGraph && d2.getChild() == null) {
                if (o.PURE_INCREMENTAL) {
                  var x = d2.getEdges()[0].getOtherEnd(d2), G = new D(d2.getCenterX() - x.getCenterX(), d2.getCenterY() - x.getCenterY());
                  p2.push([
                    d2,
                    d2.getEdges()[0],
                    d2.getOwner(),
            ...
            if (T == h[1].source ? d2 = h[1].target : d2 = h[1].source, o.PURE_INCREMENTAL) T.setCenter(d2.getCenterX() + h[3].getWidth(), d2.getCenterY() + h[3].getHeight());
              ...
              m == 0 ? T.setCenter(d2.getCenterX(), d2.getCenterY() - d2.getHeight() / 2 - l.DEFAULT_EDGE_LENGTH - T.getHeight() / 2) : m == 1 ? T.setCenter(d2.getCenterX() + d2.getWidth() / 2 + l.DEFAULT_EDGE_LENGTH + T.getWidth() / 2, d2.getCenterY()) : m == 2 ? T.setCenter(d2.getCenterX(), d2.getCenterY() + d2.getHeight() / 2 + l.DEFAULT_EDGE_LENGTH + T.getHeight() / 2) : T.setCenter(d2.getCenterX() - d2.getWidth() / 2 - l.DEFAULT_EDGE_LENGTH - T.getWidth() / 2, d2.getCenterY());
            }
          }, n2.exports = R;
        },
        991: (n2, i, a) => {
          ...
          m$1(u, "CoSENode"), u.prototype = Object.create(c2.prototype);
        ...
        902: (n2, i, a) => {
          ...
          m$1(o, "ConstraintHandler"), o.handleConstraints = function(f) {
            ...
            for (var A = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), y = [], D = [], S = f.getAllNodes(), C = 0, b = 0; b < S.length; b++) {
              var z = S[b];
            ...
            var X = m$1(function(W, V) {
              ...
              function gt(st, nt) {
                ...
                try {
                  for (var Rt = nt[Symbol.iterator](), Bt; !(at = (Bt = Rt.next()).done); at = true) {
                    var Ot = Bt.value;
                    dt.add(Ot);
                  }
                } catch (Nt) {
              ...
              ft.forEach(function(st, nt) {
                ...
                if (st.forEach(function(ct) {
                  ...
                  nt.forEach(function(ct) {
                    V == "horizontal" ? (q2.set(ct, v.has(ct) ? y[v.get(ct)] : k.get(ct)), dt += q2.get(ct)) : (q2.set(ct, v.has(ct) ? D[v.get(ct)] : k.get(ct)), dt += q2.get(ct));
              ...
              if ($) {
                ...
                lt.forEach(function(st, nt) {
                  if (pt.has(nt)) {
                    ...
                    try {
                      for (var Rt = st[Symbol.iterator](), Bt; !(at = (Bt = Rt.next()).done); at = true) {
                        var Ot = Bt.value;
                        $.has(Ot) && (dt = true);
                      }
                    } catch (St2) {
                    ...
                    if (!dt) {
                      ...
                      Ct.forEach(function(St2, Wt) {
                        St2.has([].concat(c2(st))[0]) && (Nt = true, Zt = Wt);
                  ...
                  try {
                    for (var Nt = st[Symbol.iterator](), Zt; !(Rt = (Zt = Nt.next()).done); Rt = true) {
                  ...
                  try {
                    for (var jt = st[Symbol.iterator](), ge; !(Kt = (ge = jt.next()).done); Kt = true) {
                      var ie = ge.value;
            ...
            }, "dagToUndirected"), d2 = m$1(function(W) {
              var V = /* @__PURE__ */ new Map();
              return W.forEach(function($, k) {
                V.set(k, []);
              }), W.forEach(function($, k) {
            ...
            if (l.fixedNodeConstraint && l.fixedNodeConstraint.forEach(function(Y) {
              ...
              if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1) l.fixedNodeConstraint.forEach(function(Y, W) {
                ...
                if (l.alignmentConstraint.vertical) {
                  for (var W = l.alignmentConstraint.vertical, V = m$1(function(q2) {
                    var lt = /* @__PURE__ */ new Set();
                    W[q2].forEach(function(pt) {
                      lt.add(pt);
                    });
                    var ut = new Set([].concat(c2(lt)).filter(function(pt) {
                      return G.has(pt);
                    })), it = void 0;
                ...
                if (l.alignmentConstraint.horizontal) {
                  for (var k = l.alignmentConstraint.horizontal, _ = m$1(function(q2) {
                    var lt = /* @__PURE__ */ new Set();
              ...
              if (O) {
                for (var ht = void 0, Lt = r.transpose(T), bt = r.transpose(p2), Q = 0; Q < Lt.length; Q++) Lt[Q] = r.multGamma(Lt[Q]), bt[Q] = r.multGamma(bt[Q]);
                ...
                for (var ot = 0; ot < v.size; ot++) {
                  ...
                  y[ot] = r.dotProduct(rt, yt2), D[ot] = r.dotProduct(rt, Et);
                }
            ...
            if (t.ENFORCE_CONSTRAINTS) {
              ...
              if (l.alignmentConstraint) {
                if (l.alignmentConstraint.vertical) for (var Tt = l.alignmentConstraint.vertical, At = m$1(function(W) {
                  ...
                  var $ = new Set([].concat(c2(V)).filter(function(_) {
                    return G.has(_);
                  })), k = void 0;
              ...
              l.relativePlacementConstraint && function() {
                ...
                if (G.forEach(function(Ut) {
                  ...
                  if (l.alignmentConstraint.vertical) for (var q2 = l.alignmentConstraint.vertical, lt = m$1(function(mt) {
                ...
                var st = /* @__PURE__ */ new Map(), nt = /* @__PURE__ */ new Map(), dt = m$1(function(mt) {
                ...
                try {
                  for (var Rt = F.keys()[Symbol.iterator](), Bt; !(at = (Bt = Rt.next()).done); at = true) {
                    var Ot = Bt.value;
                    dt(Ot);
                  }
                } catch (Ut) {
                ...
                var Nt = m(st), Zt = m(nt), St2 = h(Nt), Wt = h(Zt), $t = d2(st), me = d2(nt), Kt = [], ee = [];
                ...
                try {
                  for (var Ee = re.keys()[Symbol.iterator](), Pe; !(ie = (Pe = Ee.next()).done); ie = true) {
                    var Te2 = Pe.value;
                    ge(Te2);
                  }
                } catch (Ut) {
                ...
                try {
                  for (var Ne = jt.keys()[Symbol.iterator](), Ue; !(Ae = (Ue = Ne.next()).done); Ae = true) {
                    var Te2 = Ue.value;
                    mr(Te2);
                  }
                } catch (Ut) {
      ...
      var M = {
        658: (n2) => {
          n2.exports = Object.assign != null ? Object.assign.bind(Object) : function(i) {
            for (var a = arguments.length, c2 = Array(a > 1 ? a - 1 : 0), t = 1; t < a; t++) c2[t - 1] = arguments[t];
        ...
        548: (n2, i, a) => {
          var c2 = function() {
            function r(e, o) {
              ...
              try {
                for (var y = e[Symbol.iterator](), D; !(l = (D = y.next()).done) && (f.push(D.value), !(o && f.length === o)); l = true) ;
              } catch (S) {
                A = true, v = S;
              } finally {
                try {
          ...
          u.getTopMostNodes = function(r) {
            ...
            var l = new t(), A = /* @__PURE__ */ new Set(), v = [], y = void 0, D = void 0, S = void 0, C = false, b = 1, z = [], X = [], K = m$1(function() {
              var J = r.collection();
              X.push(J);
              var h = o[0], m = r.collection();
              m.merge(h).merge(h.descendants().intersection(e)), v.push(h), m.forEach(function(p2) {
                l.push(p2), A.add(p2), J.merge(p2);
              });
              for (var d2 = m$1(function() {
                h = l.shift();
                var O = r.collection();
              ...
              if (J.forEach(function(p2) {
                e.intersection(p2.connectedEdges()).forEach(function(O) {
            ...
            if (!o.fixedNodeConstraint) {
              ...
              if (o.quality == "draft") {
                ...
                try {
                  for (var C = e.nodeIndexes[Symbol.iterator](), b; !(y = (b = C.next()).done); y = true) {
                    var z = b.value, X = c2(z, 2), K = X[0], R = X[1], J = o.cy.getElementById(K);
                    if (J) {
                      var h = J.boundingBox(), m = e.xCoords[R] - h.w / 2, d2 = e.xCoords[R] + h.w / 2, T = e.yCoords[R] - h.h / 2, p2 = e.yCoords[R] + h.h / 2;
        ...
        816: (n2, i, a) => {
          var c2 = a(548), t = a(140).CoSELayout, u = a(140).CoSENode, r = a(140).layoutBase.PointD, e = a(140).layoutBase.DimensionD, o = a(140).layoutBase.LayoutConstants, f = a(140).layoutBase.FDLayoutConstants, l = a(140).CoSEConstants, A = m$1(function(y, D) {
            ...
            var h = m$1(function(I) {
              ...
              return h(I) ? I(Z) : I;
            }, "optFn"), d2 = c2.calcParentsWithoutChildren(S, C), T = m$1(function F(I, Z, et, P) {
              for (var tt2 = Z.length, B = 0; B < tt2; B++) {
                var w = Z[B], U = null;
                w.intersection(d2).length == 0 && (U = w.children());
                ...
                if (w.outerWidth() != null && w.outerHeight() != null) if (P.randomize) if (!w.isParent()) H = I.add(new u(et.graphManager, new r(K[X.get(w.id())] - j.w / 2, R[X.get(w.id())] - j.h / 2), new e(parseFloat(j.w), parseFloat(j.h))));
                  ...
                  var ht = c2.calcBoundingBox(w, K, R, X);
                  w.intersection(d2).length == 0 ? H = I.add(new u(et.graphManager, new r(ht.topLeftX, ht.topLeftY), new e(ht.width, ht.height))) : H = I.add(new u(et.graphManager, new r(ht.topLeftX, ht.topLeftY), new e(parseFloat(j.w), parseFloat(j.h))));
                }
            ...
            }, "processChildrenList"), p2 = m$1(function(I, Z, et) {
              for (var P = 0, tt2 = 0, B = 0; B < et.length; B++) {
                ...
                if (U && H && U !== H && U.getEdgesBetween(H).length == 0) {
                  ...
                  j.id = w.id(), j.idealLength = m(y.idealEdgeLength, w), j.edgeElasticity = m(y.edgeElasticity, w), P += j.idealLength, tt2++;
                }
              }
            ...
            return T(G.addRoot(), c2.getTopMostNodes(b), x, y), p2(x, G, z), O(x, y), x.runLayout(), J;
          }, "coseLayout");
          n2.exports = {
            coseLayout: A
          };
            ...
            return m$1(y, "Layout"), c2(y, [
              {
                ...
                value: m$1(function() {
                  ...
                  if (b.layoutUtilities && C.packComponents && (T = b.layoutUtilities("get"), T || (T = b.layoutUtilities()), p2 = true), z.nodes().length > 0) if (p2) {
                      ...
                      if (C.tile) {
                        ...
                        if (h.forEach(function(ot, rt) {
                          ot.edges().length == 0 && (ot.nodes().forEach(function(yt2, Et) {
                            F.merge(ot.nodes()[Et]), yt2.isParent() || (tt2.nodeIndexes.set(ot.nodes()[Et].id(), P++), tt2.xCoords.push(ot.nodes()[0].position().x), tt2.yCoords.push(ot.nodes()[0].position().y));
                          }), B.push(rt));
                        }), F.length > 1) {
                          var w = F.boundingBox();
                          m.push({
                    ...
                    if (h.length > 1) {
                      ...
                      h.forEach(function(ot, rt) {
                        ...
                        if (C.quality == "draft" && (yt2 = X[rt].nodeIndexes), ot.nodes().not(ht).length > 0) {
                          ...
                          ot.nodes().not(ht).forEach(function(Tt) {
                            if (C.quality == "draft") if (!Tt.isParent()) Dt = yt2.get(Tt.id()), Et.nodes.push({
                              ...
                              var At = r.calcBoundingBox(Tt, X[rt].xCoords, X[rt].yCoords, yt2);
                              Et.nodes.push({
                                x: At.topLeftX,
                                y: At.topLeftY,
                                width: At.width,
                            ...
                            if (At.css("display") != "none" && xt.css("display") != "none") if (C.quality == "draft") {
                              var It = yt2.get(At.id()), zt = yt2.get(xt.id()), Yt = [], Ht = [];
                              if (At.isParent()) {
                                var Pt = r.calcBoundingBox(At, X[rt].xCoords, X[rt].yCoords, yt2);
                                Yt.push(Pt.topLeftX + Pt.width / 2), Yt.push(Pt.topLeftY + Pt.height / 2);
                              } else Yt.push(X[rt].xCoords[It]), Yt.push(X[rt].yCoords[It]);
                              if (xt.isParent()) {
                                var Y = r.calcBoundingBox(xt, X[rt].xCoords, X[rt].yCoords, yt2);
                      ...
                      if (C.quality == "draft") X.forEach(function(ot, rt) {
                        var yt2 = ot.xCoords.map(function(Dt) {
                          return Dt + Lt[rt].dx;
        ...
        657: (n2, i, a) => {
          var c2 = a(548), t = a(140).layoutBase.Matrix, u = a(140).layoutBase.SVD, r = m$1(function(o) {
            var f = o.cy, l = o.eles, A = l.nodes(), v = l.nodes(":parent"), y = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), C = [], b = [], z = [], X = [], K = [], R = [], J = [], h = [], d2 = void 0, T = 1e8, p2 = 1e-9, O = o.piTol, x = o.samplingType, G = o.nodeSeparation, F = void 0, I = m$1(function() {
              for (var V = 0, $ = 0, k = false; $ < F; ) {
                V = Math.floor(Math.random() * d2), k = false;
              ...
              for (_[ft] = V, ut[V] = 0; ft >= gt; ) {
                q2 = _[gt++];
                for (var st = C[q2], nt = 0; nt < st.length; nt++) lt = D.get(st[nt]), ut[lt] == T && (ut[lt] = ut[q2] + 1, _[++ft] = lt);
                R[q2][$] = ut[q2] * G;
              }
              if (k) {
              ...
              for (var V = u.svd(J), $ = V.S, k = V.U, _ = V.V, gt = $[0] * $[0] * $[0], ft = [], q2 = 0; q2 < F; q2++) {
                ft[q2] = [];
                for (var lt = 0; lt < F; lt++) ft[q2][lt] = 0, q2 == lt && (ft[q2][lt] = $[q2] / ($[q2] * $[q2] + gt / ($[q2] * $[q2])));
              }
              h = t.multMat(t.multMat(_, ft), t.transpose(k));
            }, "sample"), tt2 = m$1(function() {
              for (var V = void 0, $ = void 0, k = [], _ = [], gt = [], ft = [], q2 = 0; q2 < d2; q2++) k[q2] = Math.random(), _[q2] = Math.random();
            ...
            c2.connectComponents(f, l, c2.getTopMostNodes(A), y), v.forEach(function(W) {
              c2.connectComponents(f, l, c2.getTopMostNodes(W.descendants().intersection(l)), y);
            });
            for (var B = 0, w = 0; w < A.length; w++) A[w].isParent() || D.set(A[w].id(), B++);
            var U = true, H = false, j = void 0;
            try {
              for (var ht = y.keys()[Symbol.iterator](), Lt; !(U = (Lt = ht.next()).done); U = true) {
                var bt = Lt.value;
                D.set(bt, B++);
              }
            } catch (W) {
            ...
            try {
              for (var yt2 = y.keys()[Symbol.iterator](), Et; !(wt = (Et = yt2.next()).done); wt = true) {
                var Dt = Et.value;
                Xt(Dt);
              }
            } catch (W) {
...
var hr = pl.architecture, vt = new s(() => ({
  ...
  if (vt.records.dataStructures === void 0) {
    let E = {}, M = Object.entries(vt.records.nodes).reduce((a, param) => {
      let [c2, t] = param;
      return a[c2] = t.edges.reduce((u, r) => {
        var _a, _b;
      ...
      [N]: 1
    }, s2 = Object.keys(M).reduce((a, c2) => c2 === N ? a : {
      ...a,
      [c2]: 1
    }, {}), n2 = m$1((a) => {
      let c2 = {
    ...
    for (; Object.keys(s2).length > 0; ) i.push(n2(Object.keys(s2)[0]));
...
var ur = m$1(async function(E, M) {
  let N = Gt("padding"), g = Gt("iconSize"), s2 = g / 2, n2 = g / 6, i = n2 / 2;
  await Promise.all(M.edges().map(async (a) => {
    ...
    if (r && (Vt(t) ? v += t === "L" ? -z : z : y += t === "T" ? -z : z + 18), l && (Vt(o) ? C += o === "L" ? -z : z : b += o === "T" ? -z : z + 18), !r && ((_a = _t.getNode(c2)) == null ? void 0 : _a.type) === "junction" && (Vt(t) ? v += t === "L" ? s2 : -s2 : y += t === "T" ? s2 : -s2), !l && ((_b = _t.getNode(e)) == null ? void 0 : _b.type) === "junction" && (Vt(o) ? C += o === "L" ? s2 : -s2 : b += o === "T" ? s2 : -s2), a[0]._private.rscratch) {
      ...
      if (X.insert("path").attr("d", `M ${v},${y} L ${D},${S} L${C},${b} `).attr("class", "edge"), u) {
        ...
        X.insert("polygon").attr("points", Me[t](n2)).attr("transform", `translate(${K},${R})`).attr("class", "arrow");
      }
      if (f) {
        let K = Vt(o) ? se[o](C, n2) : C - i, R = Jt(o) ? se[o](b, n2) : b - i;
        X.insert("polygon").attr("points", Me[o](n2)).attr("transform", `translate(${K},${R})`).attr("class", "arrow");
      }
      if (A) {
        ...
        if (await Qt$1(J, A, {
          ...
          let h = le(t, o);
          if (h && rr(h)) {
            let m = J.node().getBoundingClientRect(), [d2, T] = nr(h);
            J.attr("dominant-baseline", "auto").attr("transform", `rotate(${-1 * d2 * T * 45})`);
            let p2 = J.node().getBoundingClientRect();
            J.attr("transform", `
  ...
  let g = Gt("padding") * 0.75, s2 = Gt("fontSize"), i = Gt("iconSize") / 2;
  ...
  for (let g of N) {
    let s2 = M.append("g"), n2 = Gt("iconSize");
    if (g.title) {
      let t = s2.append("g");
      await Qt$1(t, g.title, {
        ...
        width: n2 * 1.5,
        classes: "architecture-service-label"
      }, Hl()), t.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), t.attr("transform", "translate(" + n2 / 2 + ", " + n2 + ")");
    }
    let i = s2.append("g");
    if (g.icon) i.html(`<g>${await St(g.icon, {
      ...
      let r = i.append("g").append("foreignObject").attr("width", n2).attr("height", n2).append("div").attr("class", "node-icon-text").attr("style", `height: ${n2}px;`).append("div").html(g.iconText), e = parseInt(window.getComputedStyle(r.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
...
m$1(Hr, "addEdges");
function Wr(E, M, N) {
  let g = m$1((a, c2) => Object.entries(a).reduce((t, param) => {
    var _a;
    let [u, r] = param;
    ...
    return Object.entries(a).forEach((param) => {
      ...
      horiz: Object.values(g(c2, "horizontal")).filter((u) => u.length > 1),
...
function Vr(E) {
  let M = [], N = m$1((s2) => `${s2[0]},${s2[1]}`, "posToStr"), g = m$1((s2) => s2.split(",").map((n2) => parseInt(n2)), "strToPos");
  return E.forEach((s2) => {
    let n2 = Object.fromEntries(Object.entries(s2).map((param) => {
      let [t, u] = param;
      return [
        N(u),
        t
...
function zr(E, M, N, g, s2, param) {
  ...
  return new Promise((a) => {
    let c2 = ih("body").append("div").attr("id", "cy").attr("style", "display:none"), t = Gr$1({
    ...
    let u = Wr(s2, n2, i), r = Vr(n2), e = t.layout({
      name: "fcose",
      quality: "proof",
      styleEnabled: false,
      animate: false,
    ...
    e.one("layoutstop", () => {
      ...
      for (let f of Object.values(t.edges())) if ((_a = f.data) == null ? void 0 : _a.call(f)) {
...
var Br = m$1(async (E, M, N, g) => {
  let s2 = g.db, n2 = s2.getServices(), i = s2.getJunctions(), a = s2.getGroups(), c2 = s2.getEdges(), t = s2.getDataStructures(), u = d(M), r = u.append("g");
  ...
  await ur(r, f), await gr(o, f), Ur(s2, f), Pl(void 0, u, Gt("padding"), Gt("useMaxWidth"));
}, "draw"), yr = {
  draw: Br
};
var Ui = {
