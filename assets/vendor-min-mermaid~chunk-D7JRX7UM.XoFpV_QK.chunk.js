import { w as w$1, $ } from './vendor-min-mermaid~chunk-IO347I67.C0spWecY.chunk.js';
import { S } from './vendor-min-mermaid~chunk-L736DJ4U.BR40ACnm.chunk.js';
import { I as Ie, C as Ce } from './vendor-min-mermaid~chunk-YM3XIQPS.BqB7gHkV.chunk.js';
import { t as tt, H as Hl, g as gC, S as Sf, w as wf, v as vf, F as Ff, B as Bf, M as Mf, L as Lf } from './vendor-min-mermaid~chunk-ZKYS2E5M.Cc2x1uDP.chunk.js';
    ...
    var t = /*#__PURE__*/ m$1(function(G, o, h, n) {
        ...
        parse: /*#__PURE__*/ m$1(function(o) {
            var h = this, n = [
                ...
                null
            ], i = [], K = this.table, u = "", F = 0, U = 0, J = 0, at = 2, ot = 1, Ce = /*#__PURE__*/ i.slice.call(arguments, 1), k = /*#__PURE__*/ Object.create(this.lexer), B = {
                yy: {}
            };
            ...
            for(var D, bt, M, C, He, kt, H = {}, ct, R, Vt, lt;;){
                if (M = n[n.length - 1], this.defaultActions[M] ? C = this.defaultActions[M] : ((D === null || typeof D > "u") && (D = /*#__PURE__*/ Ie()), C = K[M] && K[M][D]), typeof C > "u" || !C.length || !C[0]) {
                    var Dt = "";
                    lt = [];
...
var Yt = /*#__PURE__*/ m$1(function(t) {
    ...
    let T = 8;
    Ie.insertTitle(p, "statediagramTitleText", f?.titleTopMargin ?? 25, /*#__PURE__*/ a.db.getDiagramTitle()), $(p, T, z, f?.useMaxWidth ?? true);
}, "draw"), ss = {
    getClasses: Ge,
    draw: we,
    getDir: Yt
...
var W = /*#__PURE__*/ m$1((t, e, s, a, c, f, r, d)=>{
    ...
    if (tt.info("dataFetcher parsedItem", e, T, b), p !== "root") {
        ...
        e.description && (Array.isArray(S.description) ? (S.shape = pt, S.description.push(e.description)) : S.description?.length > 0 ? (S.shape = pt, S.description === p ? S.description = [
            ...
            S.description,
            e.description
        ]) : (S.shape = dt, S.description = e.description), S.description = /*#__PURE__*/ gC.sanitizeTextOrArray(S.description, /*#__PURE__*/ Hl())), S.description?.length === 1 && S.shape === pt && (S.type === "group" ? S.shape = Nt : S.shape = dt), !S.type && e.doc && (tt.info("Setting cluster for XCX", p, /*#__PURE__*/ ye(e)), S.type = "group", S.isGroup = true, S.dir = /*#__PURE__*/ ye(e), S.shape = e.type === ut ? Ot : Nt, S.cssClasses = `${S.cssClasses} ${de} ${f ? pe : ""}`);
        let L = {
            labelStyle: "",
            shape: S.shape,
            label: S.description,
...
var De = /*#__PURE__*/ m$1(()=>({
        ...
        states: new Map,
        documents: {}
    }), "newDoc"), Tt = /*#__PURE__*/ m$1((t)=>JSON.parse(/*#__PURE__*/ JSON.stringify(t)), "clone"), xe = class {
                ...
                case ie:
                    {
                        ...
                        d.forEach((T)=>{
                            ...
                            m.styles = /*#__PURE__*/ p.map((b)=>b.replace(/;/g, "")?.trim());
                        });
                    }
                    break;
                case re:
