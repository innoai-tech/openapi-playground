...
import { R as Zi, V as ia, q as pt } from "./vendor-min-mermaid~chunk-63GW7ZVL.JXMkVvO5.chunk.js";
import { B as jo, D as Wo, E as Vo, T as Uo, U as mr, _ as No, c as Ii, g as Ni, o as Go, q as ot, s as Ho, t as $o } from "./vendor-min-mermaid~chunk-KXVH62NG.DXOHBXLD.chunk.js";
var Et = /* @__PURE__ */ function() {
	var t = /* @__PURE__ */ m(function(X, o, l, x) {
		...
		56,
		57
	], A = [2, 36], h = [1, 37], T = [1, 36], m$1 = [1, 38], b = [1, 35], q = [1, 43], p = [1, 41], K = [1, 14], dt = [1, 23], ft = [1, 18], pt$1 = [1, 19], gt = [1, 20], ut = [1, 21], kt = [1, 22], ct = [1, 24], a = [1, 25], Bt = [1, 26], wt = [1, 27], It = [1, 28], Ot = [1, 29], W = [1, 32], N = [1, 33], P = [1, 34], _ = [1, 39], F = [1, 40], Q = [1, 42], C = [1, 44], R = [1, 62], H = [1, 61], v = [
		4,
		5,
		8,
		10,
		...
		66,
		67
	], Wt = [1, 65], Nt = [1, 66], Rt = [1, 67], Ht = [1, 68], Ut = [1, 69], jt = [1, 70], Xt = [1, 71], Mt = [1, 72], Yt = [1, 73], Gt = [1, 74], Kt = [1, 75], Zt = [1, 76], B = [
		4,
		5,
		6,
		7,
		...
		15,
		18
	], Z = [1, 90], J = [1, 91], $ = [1, 92], tt = [1, 99], et = [1, 93], at = [1, 96], it = [1, 94], nt = [1, 95], rt = [1, 97], st = [1, 98], St = [1, 102], Jt = [
		10,
		55,
		56,
		57
		...
		performAction: /* @__PURE__ */ m(function(o, l, x, d, k, e, ht) {
			var s = e.length - 1;
			switch (k) {
				case 23:
					this.$ = e[s];
		...
		parse: /* @__PURE__ */ m(function(o) {
			var l = this, x = [0], d = [], k = [null], e = [], ht = this.table, s = "", yt = 0, $t = 0, te = 0, Te = 2, ee = 1, me = /* @__PURE__ */ e.slice.call(arguments, 1), D = /* @__PURE__ */ Object.create(this.lexer), M = { yy: {} };
			...
			m(qe, "lex");
			for (var z, Qt, Y, O, Ct, ot$1 = {}, Tt, U, ae, mt;;) {
...
Expecting ` + mt.join(", ") + ", got '" + (this.terminals_[z] || z) + "'" : Lt = "Parse error on line " + (yt + 1) + ": Unexpected " + (z == ee ? "end of input" : "'" + (this.terminals_[z] || z) + "'"), this.parseError(Lt, {
				...
				switch (O[0]) {
					case 1:
						...
						break;
					case 2:
						if (U = this.productions_[O[1]][1], ot$1.$ = k[k.length - U], ot$1._$ = {
							first_line: e[e.length - (U || 1)].first_line,
							last_line: e[e.length - 1].last_line,
							first_column: e[e.length - (U || 1)].first_column,
							last_column: e[e.length - 1].last_column
						}, be && (ot$1._$.range = [e[e.length - (U || 1)].range[0], e[e.length - 1].range[1]]), Ct = /* @__PURE__ */ this.performAction.apply(ot$1, /* @__PURE__ */ [
							s,
							$t,
							yt,
							M.yy,
						...
						U && (x = /* @__PURE__ */ x.slice(0, -1 * U * 2), k = /* @__PURE__ */ k.slice(0, -1 * U), e = /* @__PURE__ */ e.slice(0, -1 * U)), x.push(this.productions_[O[1]][0]), k.push(ot$1.$), e.push(ot$1._$), ae = ht[x[x.length - 2]][x[x.length - 1]], x.push(ae);
						break;
					case 3: return !0;
				}
			}
	...
	At.lexer = /* @__PURE__ */ function() {
		return {
			EOF: 1,
			parseError: /* @__PURE__ */ m(function(l, x) {
				if (this.yy.parser) this.yy.parser.parseError(l, x);
				else throw new Error(l);
			}, "parseError"),
			setInput: /* @__PURE__ */ m(function(o, l) {
...
` + l + "^";
			...
			test_match: /* @__PURE__ */ m(function(o, l) {
				var x, d, k;
			...
			next: /* @__PURE__ */ m(function() {
				...
				for (var k = /* @__PURE__ */ this._currentRules(), e = 0; e < k.length; e++) if (x = /* @__PURE__ */ this._input.match(this.rules[k[e]]), x && (!l || x[0].length > l[0].length)) {
					if (l = x, d = e, this.options.backtrack_lexer) {
						if (o = /* @__PURE__ */ this.test_match(x, k[e]), o !== !1) return o;
						if (this._backtrack) {
							l = !1;
							continue;
						} else return !1;
				...
				return l ? (o = /* @__PURE__ */ this.test_match(l, k[d]), o !== !1 ? o : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
					text: "",
					token: null,
					line: this.yylineno
			...
			topState: /* @__PURE__ */ m(function(l) {
				return l = this.conditionStack.length - 1 - Math.abs(l || 0), l >= 0 ? this.conditionStack[l] : "INITIAL";
			}, "topState"),
			pushState: /* @__PURE__ */ m(function(l) {
				this.begin(l);
			}, "pushState"),
			...
			performAction: /* @__PURE__ */ m(function(l, x, d, k) {
				switch (d) {
					case 0: break;
					case 1: break;
					case 2: return 55;
...
var V = /* @__PURE__ */ Ii(), qt = class {
	...
	getDefaultConfig() {
		return {
			...
			showYAxis: !0,
			showTitle: !0,
			chartHeight: Ni.quadrantChart?.chartWidth || 500,
			chartWidth: Ni.quadrantChart?.chartHeight || 500,
			titlePadding: Ni.quadrantChart?.titlePadding || 10,
			titleFontSize: Ni.quadrantChart?.titleFontSize || 20,
			quadrantPadding: Ni.quadrantChart?.quadrantPadding || 5,
			xAxisLabelPadding: Ni.quadrantChart?.xAxisLabelPadding || 5,
			yAxisLabelPadding: Ni.quadrantChart?.yAxisLabelPadding || 5,
			xAxisLabelFontSize: Ni.quadrantChart?.xAxisLabelFontSize || 16,
			yAxisLabelFontSize: Ni.quadrantChart?.yAxisLabelFontSize || 16,
			quadrantLabelFontSize: Ni.quadrantChart?.quadrantLabelFontSize || 16,
			quadrantTextTopPadding: Ni.quadrantChart?.quadrantTextTopPadding || 5,
			pointTextPadding: Ni.quadrantChart?.pointTextPadding || 5,
			pointLabelFontSize: Ni.quadrantChart?.pointLabelFontSize || 12,
			pointRadius: Ni.quadrantChart?.pointRadius || 5,
			xAxisPosition: Ni.quadrantChart?.xAxisPosition || "top",
			yAxisPosition: Ni.quadrantChart?.yAxisPosition || "left",
			quadrantInternalBorderStrokeWidth: Ni.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
			quadrantExternalBorderStrokeWidth: Ni.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
		};
	}
	...
	clear() {
		this.config = /* @__PURE__ */ this.getDefaultConfig(), this.themeConfig = /* @__PURE__ */ this.getDefaultThemeConfig(), this.data = /* @__PURE__ */ this.getDefaultData(), this.classes = /* @__PURE__ */ new Map(), pt.info("clear called");
	}
	setData(n) {
		this.data = {
			...this.data,
	...
	calculateSpace(n, f, u, c) {
		...
		}, A = this.config.titleFontSize + this.config.titlePadding * 2, h = { top: c ? A : 0 }, T = this.config.quadrantPadding + i.left, m$1 = this.config.quadrantPadding + y.top + h.top, b = this.config.chartWidth - this.config.quadrantPadding * 2 - i.left - i.right, q = this.config.chartHeight - this.config.quadrantPadding * 2 - y.top - y.bottom - h.top;
		return {
			xAxisSpace: y,
			yAxisSpace: i,
			titleSpace: h,
	...
	getAxisLabels(n, f, u, c) {
		let { quadrantSpace: g, titleSpace: y } = c, { quadrantHalfHeight: S, quadrantHeight: i, quadrantLeft: A, quadrantHalfWidth: h, quadrantTop: T, quadrantWidth: m$1 } = g, b = !!this.data.xAxisRightText, q = !!this.data.yAxisTopText, p = [];
		return this.data.xAxisLeftText && f && p.push({
			...
			x: this.config.yAxisPosition === "left" ? this.config.yAxisLabelPadding : this.config.yAxisLabelPadding + A + m$1 + this.config.quadrantPadding,
			y: T + i - (q ? S / 2 : 0),
	...
	getQuadrantPoints(n) {
		let { quadrantSpace: f } = n, { quadrantHeight: u, quadrantLeft: c, quadrantTop: g, quadrantWidth: y } = f, S = /* @__PURE__ */ Zi().domain([0, 1]).range([c, y + c]), i = /* @__PURE__ */ Zi().domain([0, 1]).range([u + g, g]);
...
var ke = /* @__PURE__ */ mr();
function j(t) {
	return ot(/* @__PURE__ */ t.trim(), ke);
}
m(j, "textSanitizer");
var E = new qt();
function Se(t) {
	E.setData({ quadrant1Text: /* @__PURE__ */ j(t.text) });
}
m(Se, "setQuadrant1Text");
function Ae(t) {
	E.setData({ quadrant2Text: /* @__PURE__ */ j(t.text) });
}
m(Ae, "setQuadrant2Text");
function Pe(t) {
	E.setData({ quadrant3Text: /* @__PURE__ */ j(t.text) });
}
m(Pe, "setQuadrant3Text");
function _e(t) {
	E.setData({ quadrant4Text: /* @__PURE__ */ j(t.text) });
}
m(_e, "setQuadrant4Text");
function Fe(t) {
	E.setData({ xAxisLeftText: /* @__PURE__ */ j(t.text) });
}
m(Fe, "setXAxisLeftText");
function Qe(t) {
	E.setData({ xAxisRightText: /* @__PURE__ */ j(t.text) });
}
m(Qe, "setXAxisRightText");
function Ce(t) {
	E.setData({ yAxisTopText: /* @__PURE__ */ j(t.text) });
}
m(Ce, "setYAxisTopText");
function Le(t) {
	E.setData({ yAxisBottomText: /* @__PURE__ */ j(t.text) });
}
...
m(ze, "setHeight");
function Ve() {
	let { themeVariables: n, quadrantChart: f } = mr();
	...
	}), E.setData({ titleText: /* @__PURE__ */ Vo() }), E.build();
}
...
var ha = {
	...
	renderer: { draw: /* @__PURE__ */ m((t, n, f, u) => {
		function c(a) {
...
` + t);
		...
		i === "sandbox" && (A = /* @__PURE__ */ ia("#i" + n));
		let T = /* @__PURE__ */ (i === "sandbox" ? ia(A.nodes()[0].contentDocument.body) : ia("body")).select(`[id="${n}"]`), m$1 = /* @__PURE__ */ T.append("g").attr("class", "main"), b = S.quadrantChart?.chartWidth ?? 500, q = S.quadrantChart?.chartHeight ?? 500;
		Wo(T, q, b, S.quadrantChart?.useMaxWidth ?? !0), T.attr("viewBox", "0 0 " + b + " " + q), u.db.setHeight(q), u.db.setWidth(b);
		let p = /* @__PURE__ */ u.db.getQuadrantData(), K = /* @__PURE__ */ m$1.append("g").attr("class", "quadrants"), dt = /* @__PURE__ */ m$1.append("g").attr("class", "border"), ft = /* @__PURE__ */ m$1.append("g").attr("class", "data-points"), pt$1 = /* @__PURE__ */ m$1.append("g").attr("class", "labels"), gt = /* @__PURE__ */ m$1.append("g").attr("class", "title");
