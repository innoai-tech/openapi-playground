...
import { S } from './vendor-min-mermaid~chunk-L2HI3BDI.Dq5F1R3d.chunk.js';
import { U as Ut, C as Ct } from './vendor-min-mermaid~chunk-RGZHNYJS.BZGdGDWl.chunk.js';
import { u as ur, H as Ho, N as No, G as Go, U as Uo, $ as $o, j as jo, n as nn, P as Po } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
import { p as pt$1 } from './vendor-min-mermaid~chunk-BF7QJ6L7.DK9jwCiC.chunk.js';
...
var Ft = /*#__PURE__*/ m$1((t, e = St)=>{
    ...
    let { securityLevel: r, state: d, layout: u } = ur();
    ...
    try {
        (typeof n.db.getLinks == "function" ? n.db.getLinks() : new Map).forEach((b, L)=>{
            ...
            if (!x) {
                pt$1.warn("\u26A0\uFE0F Invalid or missing stateId from key:", /*#__PURE__*/ JSON.stringify(L));
                return;
            }
            ...
            if (p?.forEach((R)=>{
                ...
                pt$1.warn("\u26A0\uFE0F Could not find node matching text:", x);
                return;
            }
            let O = k.parentNode;
            if (!O) {
                pt$1.warn("\u26A0\uFE0F Node has no parent, cannot wrap:", x);
                return;
            }
            ...
            O.replaceChild(I, k), I.appendChild(k), pt$1.info("\uD83D\uDD17 Wrapped node in <a> tag for:", x, b.url);
        });
    } catch (E) {
        pt$1.error("\u274C Error injecting clickable links:", E);
    }
    Ut.insertTitle(S$1, "statediagramTitleText", d?.titleTopMargin ?? 25, /*#__PURE__*/ n.db.getDiagramTitle()), y(S$1, m$1, J, d?.useMaxWidth ?? true);
}, "draw"), qe = {
    getClasses: Ne,
    draw: Oe,
    getDir: Ft
            ...
            case tt:
                {
                    ...
                    let m = {
                        ...
                        style: Rt,
                        labelStyle: "",
                        label: /*#__PURE__*/ nn.sanitizeText(S.description ?? "", /*#__PURE__*/ ur()),
                        arrowheadStyle: vt,
                        labelpos: Nt,
                        labelType: Ot,
                        thickness: wt,
...
}, "setupDoc"), me = /*#__PURE__*/ m$1((t, e = St)=>{
    let s = e;
...
var q = /*#__PURE__*/ m$1((t, e, s, n, r, d, u, f)=>{
    let S = e.id, m = /*#__PURE__*/ s.get(S), E = /*#__PURE__*/ Ge(m), b = /*#__PURE__*/ Pe(m), L = /*#__PURE__*/ ur();
    if (pt$1.info("dataFetcher parsedItem", e, m, b), S !== "root") {
        let x = ft;
        e.start === true ? x = oe : e.start === false && (x = le), e.type !== W && (x = e.type), Tt.get(S) || Tt.set(S, {
            id: S,
            shape: x,
            description: /*#__PURE__*/ nn.sanitizeText(S, L),
            cssClasses: `${E} ${de}`,
            cssStyles: b
        });
        ...
        e.description && (Array.isArray(p.description) ? (p.shape = gt, p.description.push(e.description)) : p.description?.length && p.description.length > 0 ? (p.shape = gt, p.description === S ? p.description = [
            ...
            p.description,
            e.description
        ]) : (p.shape = ft, p.description = e.description), p.description = /*#__PURE__*/ nn.sanitizeTextOrArray(p.description, L)), p.description?.length === 1 && p.shape === gt && (p.type === "group" ? p.shape = Pt : p.shape = ft), !p.type && e.doc && (pt$1.info("Setting cluster for XCX", S, /*#__PURE__*/ me(e)), p.type = "group", p.isGroup = true, p.dir = /*#__PURE__*/ me(e), p.shape = e.type === pt ? Gt : Pt, p.cssClasses = `${p.cssClasses} ${pe} ${d ? fe : ""}`);
        let k = {
            labelStyle: "",
            shape: p.shape,
            label: p.description,
        ...
        if (k.shape === Gt && (k.label = ""), t && t.id !== "root" && (pt$1.trace("Setting node ", S, " to be child of its parent ", t.id), k.parentId = t.id), k.centerLabel = true, e.note) {
            let O = {
                labelStyle: "",
                shape: ce,
                label: e.note.text,
    ...
    e.doc && (pt$1.trace("Adding nodes children "), we(e, e.doc, s, n, r, !d, u, f));
...
var A = {
    ...
    extract(e) {
        ...
        let s = /*#__PURE__*/ this.getStates(), n = /*#__PURE__*/ ur();
    ...
    setRootDoc(e) {
        pt$1.info("Setting root doc", e), this.rootDoc = e, this.version === 1 ? this.extract(e) : this.extract(/*#__PURE__*/ this.getRootDocV2());
    }
    docTranslator(e, s, n) {
        if (s.stmt === tt) {
    ...
    addState(e, s = W, n = void 0, r = void 0, d = void 0, u = void 0, f = void 0, S = void 0) {
        let m = e?.trim();
        ...
        if (r && (pt$1.info("Setting state description", m, r), (Array.isArray(r) ? r : [
            r
        ]).forEach((b)=>this.addDescription(m, /*#__PURE__*/ b.trim()))), d) {
            let E = /*#__PURE__*/ this.currentDocument.states.get(m);
            if (!E) throw new Error(`State not found: ${m}`);
            E.note = d, E.note.text = /*#__PURE__*/ nn.sanitizeText(E.note.text, /*#__PURE__*/ ur());
        }
        u && (pt$1.info("Setting state classes", m, u), (Array.isArray(u) ? u : [
            u
        ]).forEach((b)=>this.setCssClass(m, /*#__PURE__*/ b.trim()))), f && (pt$1.info("Setting state styles", m, f), (Array.isArray(f) ? f : [
            f
        ]).forEach((b)=>this.setStyle(m, /*#__PURE__*/ b.trim()))), S && (pt$1.info("Setting state styles", m, f), (Array.isArray(S) ? S : [
            S
    ...
    clear(e) {
        this.nodes = [], this.edges = [], this.documents = {
            root: /*#__PURE__*/ _e()
        }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = /*#__PURE__*/ Ee(), e || (this.links = new Map, Po());
    }
    getState(e) {
    ...
    addRelationObjs(e, s, n = "") {
        ...
        this.addState(r, d, e.doc, e.description, e.note, e.classes, e.styles, e.textStyles), this.addState(u, f, s.doc, s.description, s.note, s.classes, s.styles, s.textStyles), this.currentDocument.relations.push({
            id1: r,
            id2: u,
            relationTitle: /*#__PURE__*/ nn.sanitizeText(n, /*#__PURE__*/ ur())
        });
    }
    addRelation(e, s, n) {
        if (typeof e == "object" && typeof s == "object") this.addRelationObjs(e, s, n);
            ...
            this.addState(r, d), this.addState(u, f), this.currentDocument.relations.push({
                id1: r,
                id2: u,
                relationTitle: n ? nn.sanitizeText(n, /*#__PURE__*/ ur()) : void 0
            });
        }
    }
    addDescription(e, s) {
        let n = /*#__PURE__*/ this.currentDocument.states.get(e), r = s.startsWith(":") ? s.replace(":", "").trim() : s;
        n?.descriptions?.push(nn.sanitizeText(r, /*#__PURE__*/ ur()));
    }
    cleanupLabel(e) {
