	...
	return r.prototype.unsubscribe = function() {
		if (!this.closed) {
			...
			if (d) {
				...
				try {
					for (var b = e(d), y = b.next(); !y.done; y = b.next()) {
						var m = y.value;
						try {
							v(m);
						} catch (t) {
...
function tw(t) {
	return ty(function(r) {
		return tm(r) ? t.apply(void 0, i([], o(r))) : t(r);
	});
}
...
function tE(t, r, n) {
	return (void 0 === n && (n = Infinity), c(r)) ? tE(function(n, e) {
		...
		return o = n, i = [], u = 0, c = 0, s = !1, a = function() {
			...
			u++;
			var n = !1;
			ts(t(r, c++)).subscribe(Y(e, function(t) {
				e.next(t);
			}, function() {
				n = !0;
			}, void 0, function() {
		...
		}, r.subscribe(Y(e, l, function() {
			s = !0, a();
		})), function() {};
	}));
}
function tO(t) {
	return void 0 === t && (t = Infinity), tE(C, t);
}
var tA = ["addListener", "removeListener"], tP = ["addEventListener", "removeEventListener"], tj = ["on", "off"];
function tT(t, r, n, e) {
	if (c(n) && (e = n, n = void 0), e) return tT(t, r, n).pipe(tw(e));
	var i, u, s, a = o(c((i = t).addEventListener) && c(i.removeEventListener) ? tP.map(function(e) {
		return function(o) {
			return t[e](r, o, n);
		};
	}) : c((u = t).addListener) && c(u.removeListener) ? tA.map(tk(t, r)) : c((s = t).on) && c(s.off) ? tj.map(tk(t, r)) : [], 2), l = a[0], f = a[1];
	if (!l && tt(t)) return tE(function(t) {
		return tT(t, r, n);
	})(ts(t));
...
function tz() {
	...
	return r.length ? 1 === r.length ? ts(r[0]) : tO(o)(tv(r, e)) : Q;
}
function tL(t, r) {
	return M(function(n, e) {
		var o = 0;
...
function tU(t) {
	return M(function(r, n) {
		var e, o = null, i = !1;
		o = r.subscribe(Y(n, void 0, void 0, function(u) {
			e = ts(t(u, tU(t)(r))), o ? (o.unsubscribe(), o = null, e.subscribe(n)) : i = !0;
		})), i && (o.unsubscribe(), o = null, e.subscribe(n));
	});
}
function tF(t, r) {
	return void 0 === r && (r = K), M(function(n, e) {
...
function tN(t, r) {
	...
	return function t(r, n) {
		return n ? function(e) {
			return function() {
				for (var t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
				return tO(1)(tv(t, Z(t)));
			}(n.pipe(tM(1), tY()), e.pipe(t(r)));
		} : tE(function(t, n) {
			return ts(r(t, n)).pipe(tM(1), ty(function() {
				return t;
			}));
		});
	}(function() {
...
function tR(t, r) {
	return void 0 === r && (r = C), t = null != t ? t : tq, M(function(n, e) {
		var o, i = !0;
		n.subscribe(Y(e, function(n) {
			var u = r(n);
...
function tV(t, r) {
	return M(function(n, e) {
		...
		n.subscribe(Y(e, function(n) {
			o?.unsubscribe();
			var u = 0, s = i++;
			ts(t(n, s)).subscribe(o = Y(e, function(t) {
...
export { z as C, U as S, td as _, tN as a, V as b, tU as c, tC as d, tT as f, tb as g, ty as h, tR as i, tL as l, tI as m, tV as n, tY as o, tE as p, tD as r, tF as s, tB as t, tz as u, tv as v, q as x, Q as y };
