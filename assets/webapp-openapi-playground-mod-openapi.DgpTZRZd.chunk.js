...
import { I as e, r as t, c as a, a as r, o as i, e as n, s as o, y as l, k as s, j as d, C as p, R as c, d as u, F as m, b as h, D as y, E as f, G as v, m as b } from "./lib-nodepkg-vuekit.QtssM2ga.chunk.js";
import { S as g, s as x, b as w, e as $, f as _, g as N, h as S, j as I, o as P } from "./lib-nodepkg-typedef.TQFspoef.chunk.js";
import { c as O, a as k, p as C, t as j } from "./vendor-innoai-tech-fetcher.DqjD3TZI.chunk.js";
import { B as D, s as T, b as q, m as L, E as B, o as F, S as E, t as R, k as W, O as M, l as J, c as H, e as A, n as V } from "./vendor-rxjs.BqYGlyAQ.chunk.js";
import { N as z, g as U, a as K, Y as G, d as Y, e as Q } from "./vendor-innoai-tech-lodash.DOnJCRVn.chunk.js";
import { s as X, B as Z, v as ee, a as et } from "./lib-nodepkg-vueuikit.CfSvdUEI.chunk.js";
import { M as ea } from "./lib-nodepkg-vuemarkdown.uItxsVwU.chunk.js";
import { I as er, D as ei, m as en, T as eo, F as el, f as es, g as ed, h as ep } from "./lib-nodepkg-vuematerial.BGRJCmb6.chunk.js";
import { l as ec, h as eu, i as em, F as eh } from "./lib-nodepkg-vueformdata.mWV8DVN9.chunk.js";
import { J as ey, a as ef, b as ev } from "./lib-nodepkg-jsoneditor.DMt9pCoT.chunk.js";
import { m as eb } from "./vendor-mermaid.SdzO39rg.chunk.js";
const _eg = class _eg extends e {
  ...
  asRequestConfigCreator(e10) {
    ...
    return (e11) => {
      var t3, a3;
      return { method: r2.method, url: __privateGet(this, _eg_instances, a_get) + ew(r2.path, e11), params: z(e11, null === (t3 = r2.parameters) || void 0 === t3 ? void 0 : t3.filter((e12) => "query" == e12.in).map((e12) => e12.name)), headers: { ...z(e11, null === (a3 = r2.parameters) || void 0 === a3 ? void 0 : a3.filter((e12) => "header" == e12.in).map((e12) => e12.name)), ...i2 ? { "Content-Type": i2 } : {} }, body: e11.body, inputs: e11 };
    };
  }
  request(e10, t2) {
...
let ew = function(e10) {
  ...
  return (t3) => {
    ...
    return n(t3, { children: [i2, " ", o2 ? d(eo, { title: d(eL, { children: d(ea, { text: o2 }) }), children: d(er, { path: en }) }) : null] });
  };
...
let eW = a(() => new eR("")), eM = r((e10) => {
  ...
  return () => {
    ...
    }, children: d(ej, { id: o2, children: o2 }) }), t2.safe(o2) && d(ei, { isOpen: r2.value, onClose: () => {
      r2.next(false);
...
let eV = r({ code: $(), response: $() }, (e10) => {
  ...
  return () => {
    ...
    }(e11)).map((e11) => e11 ? d(Z, { sx: { mb: 16 }, children: n(eT, { spacing: 0, children: [n(ej, { children: ["{", " "] }), d(eE, { children: Object.entries(e11).map((e12) => {
      let [t3, a3] = e12;
...
[File Content]
` : Y(r2) ? r2.map((e11) => a2(t3, e11)).join("\n") : `${e10}
...
`;
  ...
  return n(e4, { children: [d(e1, { ...t2 }), d(m, { children: Object.entries({ ...eZ(), ...t2.headers }).toSorted().map((e11) => {
    ...
    return e5(e11.headers).includes("application/x-www-form-urlencoded") ? C(e11.body) : e7(e11.headers) ? JSON.stringify(e11.body, null, 2) : e11.body;
  }(t2)] })] });
  ...
  return () => {
    ...
    }) }), d("br", {}), t3.body ? e7(t3.headers) ? JSON.stringify(t3.body, null, 2) : `${t3.body}` : null] });
  };
...
let e7 = (e10) => e5(e10).includes("application/json"), e9 = r({ operationID: x() }, (e10) => t(e$.use().response$(e10.operationID), s((e11) => d(te, { children: d(e3, { response: e11 }) }))), { displayName: "ResponsePreview" }), te = X("section", { displayName: "ResponseSection" })({ maxHeight: "40vh", overflow: "auto" }), tt = r((e10, a2) => {
  var r2, i2, l2, p2;
  ...
  for (let t2 of null !== (r2 = e10.operation.parameters) && void 0 !== r2 ? r2 : []) {
    ...
    }).use(ec(`${t2.name}, in=${JSON.stringify(t2.in)}`));
    t2.required || (e11 = e11.optional()), e11.use(eu(t2.schema.title)), ["object", "array"].includes(null !== (i2 = t2.schema.type) && void 0 !== i2 ? i2 : "") ? m2[t2.name] = e11.use(em(eQ)) : m2[t2.name] = e11;
  }
  if (e10.operation.requestBody) {
    ...
    if (t2) {
      let [e11, a3] = t2, r3 = _.decode(null !== (p2 = a3.schema) && void 0 !== p2 ? p2 : {}, (e12) => {
        var t3;
        return [null !== (t3 = u2.schema(e12)) && void 0 !== t3 ? t3 : {}, N(e12)];
      }).use(ec(`body, content-type = ${JSON.stringify(e11)}`));
      e11.includes("json") ? m2.body = r3.use(em(eQ)) : e11.includes("octet-stream") ? m2.body = r3.use(em(ti)) : m2.body = r3;
    }
  }
  let h2 = f(), y2 = v(), b2 = eh.of(P(m2), (() => {
    try {
      var e11;
  ...
  return () => {
    ...
    }, children: [d(Z, { sx: { flex: 2, py: 24, display: "flex", flexDirection: "column", gap: 32, height: "100%", overflow: "auto" }, children: [...b2.fields(b2.typedef)].map((e11) => d(ta, { field$: e11 })) }), d(Z, { sx: { flex: 3, gap: 24, display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }, children: n(Z, { sx: { display: "flex", flexDirection: "column", gap: 24, height: "100%", overflow: "hidden" }, children: [g2, d(Z, { sx: { px: 8 }, children: d(el, { type: "submit", children: "发起请求" }) }), d(e9, { operationID: e10.operation.operationId }), d(Z, { sx: { flex: 1, overflow: "auto" }, children: null === (t2 = c2.default) || void 0 === t2 ? void 0 : t2.call(c2) })] }) })] }, e10.operation.operationId);
  };
  ...
  return y(() => {
    ...
    return d(eG, { valued: !K(null != l2 ? l2 : o2.initial), invalid: !!o2.error, focus: !!o2.focus, $label: n("span", { children: [null !== (i3 = r2.meta.label) && void 0 !== i3 ? i3 : r2.name, r2.optional ? "（非必填）" : ""] }), $supporting: n(eT, { children: [d(eq, { schema: r2.typedef }), d(eH, { schema: r2.typedef })] }), $trailing: s2.$trailing, children: d(s2, { field$: r2, readOnly: p2 }) });
  }));
  ...
  return t(o2, i2((e10) => {
    ...
    return n(tc, { open: true, children: [n(tu, { children: [d("span", { children: a2.tableName }), d(tw, {}), d(tb, { meta: a2.table })] }), Object.keys(t2).map((r4) => {
      ...
      return d(tm, { onMouseover: () => {
        ...
        o2.next([]);
      }, children: n(tx, { "data-primary": a3.primary, "data-unique": a3.unique, children: [d(er, { path: a3.unique ? ed : ep }), d("span", { children: t3 }), n("span", { children: ["(", a3.columnNames.map((e12) => {
        var t4;
...
}, { displayName: "DatabaseErTableColumnOfView", props: ["of", "database"] }), td = X("div", { displayName: "DatabaseErMain" })({ py: 18, px: 24, flex: 1, overflow: "auto" }), tp = X("div", { displayName: "DatabaseErHeader" })({ py: 8, px: 16, textStyle: "sys.label-large" }), tc = X("details", { displayName: "DatabaseErTable" })({ "& + &": { mt: 16 }, rounded: "sm", border: "1px solid", borderColor: ee("sys.outline-variant", et(0.38)), overflow: "hidden", width: "100%" }), tu = X("summary", { displayName: "DatabaseErTableSummary" })({ textStyle: "sys.label-large", py: 8, px: 16, display: "flex", color: "sys.primary" }), tm = X("div", { displayName: "DatabaseErTableDef" })({ px: 16, py: 4, display: "flex", _hover: { containerStyle: "sys.surface-container-low" } }), th = X("div", { displayName: "DatabaseErTableColumnName" })({ display: "flex", width: "20vw", textStyle: "sys.label-small", font: "code" }), ty = X("div", { displayName: "DatabaseErTableColumnComment" })({ display: "flex", textStyle: "sys.label-small", width: "20vw", justifyContent: "end" }), tf = X("div", { displayName: "DatabaseErTableColumnOf" })({ flex: 1, textStyle: "sys.label-small", font: "code", fontWeight: "bold", color: "sys.primary", _hover: { cursor: "pointer" } }), tv = X("div", { displayName: "DatabaseErTableColumnType" })({ flex: 1, textStyle: "sys.label-small" }), tb = X("div", (e10, t2) => {
  let {} = t2;
  return (t3) => n(t3, { children: [e10.meta.title, " ", e10.meta.description ? d(eo, { title: d(eL, { children: d(ea, { text: e10.meta.description }) }), children: d(er, { path: en }) }) : null] });
}, { displayName: "DatabaseDescription", props: ["meta"] })({ position: "relative", display: "flex", alignItems: "center", gap: 4, textStyle: "sys.body-small", fontSize: 10, lineHeight: 12, [`${er}`]: { width: 12, height: 12, overflow: "hidden" } }), tg = X("div", { displayName: "DialogContainer" })({ display: "flex", containerStyle: "sys.surface", width: "90vw", roundedLeft: "sm", px: 16, py: 36, top: 0, position: "absolute", overflow: "auto" }), tx = X("div", { displayName: "DatabaseErTableConstraintName" })({ flex: 1, textStyle: "sys.label-small", font: "code", fontWeight: "bold", display: "flex", alignItems: "center", gap: "1em", _primary: { [`${er}`]: { color: "sys.primary" } }, _unique: { [`${er}`]: { position: "relative", "&::before": { content: JSON.stringify("1"), position: "absolute", right: -6, textStyle: "sys.label-small", fontSize: 8 } } } }), tw = X("div", { displayName: "Spacer" })({ flex: 1 }), t$ = X("pre", (e10, t2) => {
  let {} = e10, { slots: a2 } = t2;
  return (e11) => {
    var t3;
  ...
  let {} = a2, r2 = i(null);
  return eb.initialize({}), t(r2, T((e11) => e11 ? A(eb.run({ nodes: [e11] })) : B), l()), () => d("div", { ref: r2, class: "mermaid", children: e10.code });
}, { displayName: "Mermaid", props: ["code"] }), tN = r({ operationId: x() }, (e10, a2) => {
  let {} = a2, r2 = e$.use(), i2 = t(e10.operationId$, T((e11) => r2.operation$(e11))), o2 = t(i2, V((e11) => !!e11)), l2 = t(o2, s((e11) => {
    var t2;
    return n(tP, { sx: { containerStyle: null !== (t2 = { get: "sys.primary-container", post: "sys.success-container", put: "sys.warning-container", delete: "sys.error-container" }[e11.method]) && void 0 !== t2 ? t2 : "sys.secondary-container" }, children: [d("div", { "data-operation-method": true, children: e11.method }), n("div", { "data-operation-desc": true, children: [d("div", { "data-operation-path": true, children: e11.path }), n("div", { "data-operation-summary": true, children: [e11.summary, " ", e11.operationId != e11.summary ? e11.operationId : ""] })] })] });
  })), p2 = t(o2, s((e11) => e11.description ? d(Z, { sx: { px: 24, py: 12, overflow: "hidden", borderBottom: "1px solid", borderColor: ee("sys.outline-variant", et(0.38)) }, children: d(ea, { text: e11.description, components: { pre: t$ } }) }) : null)), c2 = t(o2, s((e11) => {
    var t2;
    return d(tt, { operation: e11, children: d(m, { children: Object.entries(null !== (t2 = e11.responses) && void 0 !== t2 ? t2 : {}).map((e12) => {
      let [t3, a3] = e12;
      return d(eV, { code: t3, response: a3 }, t3);
    }) }) }, e11.operationId);
  }));
  return t(i2, s((e11) => e11 ? "SycDatabaseEr" == e11.operationId ? n(tS, { children: [l2, p2, d(tI, { children: d(tn, { op: e11 }) })] }, e11.operationId) : n(tS, { children: [n("details", { open: true, children: [l2, p2] }), d(tI, { children: d(Z, { sx: { flex: 1, overflow: "auto" }, children: c2 }) })] }, e11.operationId) : null));
}, { displayName: "OperationView" }), tS = X("div", { displayName: "OperationContainer" })({ height: "100%", display: "flex", flexDirection: "column", alignItems: "stretch" }), tI = X("div", { displayName: "OperationMain" })({ flex: 1, overflow: "hidden", display: "flex", flexDirection: "column", alignItems: "stretch" }), tP = X("summary", { displayName: "OperationHeading" })({ display: "flex", alignItems: "center", width: "100%", px: 16, py: 8, gap: 16, $data_operation_method: { textTransform: "uppercase", fontSize: 24, fontFamily: "code" }, $data_operation_path: { fontFamily: "code" }, $data_operation_summary: { opacity: 0.8, textStyle: "sys.body-small" } });
export {
  e$ as O,
  tN as a,
  eN as b
