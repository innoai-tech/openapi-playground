import { G as Gr } from "./vendor-min-mermaid~chunk-MBJCTAW2.D-Ge4gH3.chunk.js";
import { d } from "./vendor-min-mermaid~chunk-SWF7N4V6.BpsFbHh7.chunk.js";
import { Q as Qt$1 } from "./vendor-min-mermaid~chunk-I5SP4YIW.DqV4C2Qh.chunk.js";
import { S } from "./vendor-min-mermaid~chunk-QS5O44OF.L_MBO-WO.chunk.js";
import { m as m$1, q, n } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Q7R0ayzM.chunk.js";
import { t as tt, H as Hl, P as Pl, p as pl, D as De, al as Wt$1, am as F, an as E, i as ih } from "./vendor-min-mermaid~chunk-QJLC67TO.Dw34GYds.chunk.js";
    ...
    return function(E2) {
      ...
      function(E2, I, o) {
        ...
        c.prototype.getNodes = function() {
          ...
          for (var v = e.MAX_VALUE, m = e.MAX_VALUE, T, y, A, O = /* @__PURE__ */ this.getNodes(), R = O.length, n2 = 0; n2 < R; n2++) {
            var h = O[n2];
          ...
          for (var m = e.MAX_VALUE, T = -e.MAX_VALUE, y = e.MAX_VALUE, A = -e.MAX_VALUE, O, R, n2, h, g, p = this.nodes, D = p.length, N = 0; N < D; N++) {
            var M = p[N];
            v && M.child != null && M.updateBounds(), O = /* @__PURE__ */ M.getLeft(), R = /* @__PURE__ */ M.getRight(), n2 = /* @__PURE__ */ M.getTop(), h = /* @__PURE__ */ M.getBottom(), m > O && (m = O), T < R && (T = R), y > n2 && (y = n2), A < h && (A = h);
          }
          ...
          for (var m = e.MAX_VALUE, T = -e.MAX_VALUE, y = e.MAX_VALUE, A = -e.MAX_VALUE, O, R, n2, h, g = v.length, p = 0; p < g; p++) {
            var D = v[p];
            O = /* @__PURE__ */ D.getLeft(), R = /* @__PURE__ */ D.getRight(), n2 = /* @__PURE__ */ D.getTop(), h = /* @__PURE__ */ D.getBottom(), m > O && (m = O), T < R && (T = R), y > n2 && (y = n2), A < h && (A = h);
          }
          ...
          var m = new s(), T = /* @__PURE__ */ new Set(), y = this.nodes[0], A, O, R = /* @__PURE__ */ y.withChildren();
      ...
      function(E2, I, o) {
        ...
        m$1(e, "IGeometry"), e.calcSeparationAmount = function(t, r, l, f) {
          ...
          var c = /* @__PURE__ */ t.getX(), u = /* @__PURE__ */ t.getY(), v = /* @__PURE__ */ t.getRight(), m = /* @__PURE__ */ t.getX(), T = /* @__PURE__ */ t.getBottom(), y = /* @__PURE__ */ t.getRight(), A = /* @__PURE__ */ t.getWidthHalf(), O = /* @__PURE__ */ t.getHeightHalf(), R = /* @__PURE__ */ r.getX(), n2 = /* @__PURE__ */ r.getY(), h = /* @__PURE__ */ r.getRight(), g = /* @__PURE__ */ r.getX(), p = /* @__PURE__ */ r.getBottom(), D = /* @__PURE__ */ r.getRight(), N = /* @__PURE__ */ r.getWidthHalf(), M = /* @__PURE__ */ r.getHeightHalf(), C = false, w = false;
          if (f === d2) {
            ...
            if (f > d2 ? a > s ? (x = /* @__PURE__ */ this.getCardinalDirection(P, F2, 4), G = /* @__PURE__ */ this.getCardinalDirection(U, F2, 2)) : (x = /* @__PURE__ */ this.getCardinalDirection(-P, F2, 3), G = /* @__PURE__ */ this.getCardinalDirection(-U, F2, 1)) : a > s ? (x = /* @__PURE__ */ this.getCardinalDirection(-P, F2, 1), G = /* @__PURE__ */ this.getCardinalDirection(-U, F2, 3)) : (x = /* @__PURE__ */ this.getCardinalDirection(P, F2, 2), G = /* @__PURE__ */ this.getCardinalDirection(U, F2, 4)), !C) switch (x) {
              case 1:
      ...
      function(E2, I, o) {
        ...
        a.prototype.initParameters = function() {
          ...
          var u = /* @__PURE__ */ s.getRect(), v = /* @__PURE__ */ c.getRect(), m = new Array(2), T = new Array(4), y, A, O, R, n2, h, g;
          if (u.intersects(v)) {
          ...
          } else this.uniformLeafNodeSizes && s.getChild() == null && c.getChild() == null ? (y = v.getCenterX() - u.getCenterX(), A = v.getCenterY() - u.getCenterY()) : (l.getIntersection(u, v, T), y = T[2] - T[0], A = T[3] - T[1]), Math.abs(y) < t.MIN_REPULSION_DIST && (y = f.sign(y) * t.MIN_REPULSION_DIST), Math.abs(A) < t.MIN_REPULSION_DIST && (A = f.sign(A) * t.MIN_REPULSION_DIST), O = y * y + A * A, R = /* @__PURE__ */ Math.sqrt(O), n2 = this.repulsionConstant * s.noOfChildren * c.noOfChildren / O, h = n2 * y / R, g = n2 * A / R, s.repulsionForceX -= h, s.repulsionForceY -= g, c.repulsionForceX += h, c.repulsionForceY += g;
...
var vt = /* @__PURE__ */ n((it, dt) => {
  m$1(function(I, o) {
    ...
    return function(I) {
      ...
      function(I, o, i) {
        var e = i(0).FDLayout, t = /* @__PURE__ */ i(4), r = /* @__PURE__ */ i(3), l = /* @__PURE__ */ i(5), f = /* @__PURE__ */ i(2), a = /* @__PURE__ */ i(1), d2 = i(0).FDLayoutConstants, s = i(0).LayoutConstants, c = i(0).Point, u = i(0).PointD, v = i(0).Layout, m = i(0).Integer, T = i(0).IGeometry, y = i(0).LGraph, A = i(0).Transform;
        function O() {
        ...
        O.prototype.newGraphManager = function() {
          ...
          var D = /* @__PURE__ */ y.calculateBounds(n2), N = new A();
          ...
          Object.keys(h).forEach(function(w) {
            if (h[w].length > 1) {
              ...
              var U = /* @__PURE__ */ h[w][0].getParent(), F2 = new l(n2.graphManager);
              ...
              var x = /* @__PURE__ */ n2.getGraphManager().add(/* @__PURE__ */ n2.newGraph(), F2), G = /* @__PURE__ */ U.getChild();
              G.add(F2);
    ...
    return function(I) {
      ...
      function(I, o, i) {
        ...
        u.prototype.run = function() {
          ...
          var P = /* @__PURE__ */ m$1(function(x, G) {
          ...
          }, "getPositions"), U = /* @__PURE__ */ m$1(function F2() {
            ...
            }), x(), y = /* @__PURE__ */ requestAnimationFrame(F2);
          }, "iterateAnimated");
          ...
          var O = /* @__PURE__ */ T.filter(function(R, n2) {
          ...
          for (var O = y.length, R = 0; R < O; R++) {
            var n2 = y[R], h = /* @__PURE__ */ n2.children(), g, p = /* @__PURE__ */ n2.layoutDimensions({
              nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels
            });
            if (n2.outerWidth() != null && n2.outerHeight() != null ? g = /* @__PURE__ */ T.add(new f(A.graphManager, new a(n2.position("x") - p.w / 2, n2.position("y") - p.h / 2), new d2(parseFloat(p.w), parseFloat(p.h)))) : g = /* @__PURE__ */ T.add(new f(this.graphManager)), g.id = /* @__PURE__ */ n2.data("id"), g.paddingLeft = /* @__PURE__ */ parseInt(/* @__PURE__ */ n2.css("padding")), g.paddingTop = /* @__PURE__ */ parseInt(/* @__PURE__ */ n2.css("padding")), g.paddingRight = /* @__PURE__ */ parseInt(/* @__PURE__ */ n2.css("padding")), g.paddingBottom = /* @__PURE__ */ parseInt(/* @__PURE__ */ n2.css("padding")), this.options.nodeDimensionsIncludeLabels && n2.isParent()) {
...
var gt = /* @__PURE__ */ function() {
  var E2 = /* @__PURE__ */ m$1(function(R, n2, h, g) {
    ...
    parse: /* @__PURE__ */ m$1(function(n2) {
      var h = this, g = [
        ...
        null
      ], N = [], M = this.table, C = "", w = 0, P = 0, U = 0, F2 = 2, x = 1, G = /* @__PURE__ */ N.slice.call(arguments, 1), S2 = /* @__PURE__ */ Object.create(this.lexer), _ = {
        yy: {}
      };
...
var V = [], Mt = 0, ut = {}, Yt = /* @__PURE__ */ m$1(() => {
  V = [], Mt = 0, ut = {};
}, "clear"), Xt = /* @__PURE__ */ m$1(function(E2) {
  for (let I = V.length - 1; I >= 0; I--) if (V[I].level < E2) return V[I];
  return null;
}, "getParent"), kt = /* @__PURE__ */ m$1(() => V.length > 0 ? V[0] : null, "getMindmap"), Ht = /* @__PURE__ */ m$1((E2, I, o, i) => {
  var _a, _b;
  tt.info("addNode", E2, I, o, i);
  let e = /* @__PURE__ */ Hl(), t = ((_a = e.mindmap) == null ? void 0 : _a.padding) ?? pl.mindmap.padding;
  switch (i) {
    case k.ROUNDED_RECT:
    case k.RECT:
    case k.HEXAGON:
...
}, "getType"), Wt = /* @__PURE__ */ m$1((E2, I) => {
  ut[E2] = I;
}, "setElementForId"), Bt = /* @__PURE__ */ m$1((E2) => {
  if (!E2) return;
  let I = /* @__PURE__ */ Hl(), o = V[V.length - 1];
  E2.icon && (o.icon = /* @__PURE__ */ De(E2.icon, I)), E2.class && (o.class = /* @__PURE__ */ De(E2.class, I));
}, "decorateNode"), Vt = /* @__PURE__ */ m$1((E2) => {
  switch (E2) {
    case k.DEFAULT:
      return "no-border";
    case k.RECT:
...
}, "type2Str"), jt = /* @__PURE__ */ m$1(() => tt, "getLogger"), Zt = /* @__PURE__ */ m$1((E2) => ut[E2], "getElementById"), Qt = {
  clear: Yt,
  addNode: Ht,
  getMindmap: kt,
  nodeType: k,
...
var zt = 12, Kt = /* @__PURE__ */ m$1(function(E2, I, o, i) {
  ...
  I.append("path").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E2.type2Str(o.type)).attr("d", `M0 0 a${t},${t} 0 0,1 ${i * 0.25},${-1 * i * 0.1}
    ...
    H0 V0 Z`);
}, "cloudBkg"), te = /* @__PURE__ */ m$1(function(E2, I, o) {
...
var ie = /* @__PURE__ */ m$1(function(E2, I, o) {
  ...
  re(I, r, i, l, o);
}, "hexagonBkg"), ne = /* @__PURE__ */ m$1(function(E2, I, o) {
...
}, "roundedRectBkg"), wt = /* @__PURE__ */ m$1(async function(E2, I, o, i, e) {
...
}, "drawNode"), St = /* @__PURE__ */ m$1(function(E2, I) {
  let o = /* @__PURE__ */ E2.getElementById(I.id), i = I.x || 0, e = I.y || 0;
  o.attr("transform", "translate(" + i + "," + e + ")");
}, "positionNode");
Gr.use(Gt.default);
async function Ft(E2, I, o, i, e) {
  await wt(E2, I, o, i, e), o.children && await Promise.all(/* @__PURE__ */ o.children.map((t, r) => Ft(E2, I, t, i < 0 ? r : i, e)));
}
m$1(Ft, "drawNodes");
function se(E2, I) {
  I.edges().map((o, i) => {
...
function oe(E2, I) {
  I.nodes().map((o, i) => {
    ...
    let t = /* @__PURE__ */ E2.getElementById(e.nodeId);
...
var he = /* @__PURE__ */ m$1(async (E2, I, o, i) => {
  var _a, _b;
...
var le = /* @__PURE__ */ m$1((E$1) => {
  let I = "";
  for (let o = 0; o < E$1.THEME_COLOR_LIMIT; o++) E$1["lineColor" + o] = E$1["lineColor" + o] || E$1["cScaleInv" + o], Wt$1(E$1["lineColor" + o]) ? E$1["lineColor" + o] = /* @__PURE__ */ F(E$1["lineColor" + o], 20) : E$1["lineColor" + o] = /* @__PURE__ */ E(E$1["lineColor" + o], 20);
  ...
  return I;
}, "genSections"), ce = /* @__PURE__ */ m$1((E2) => `
  .edge {
    stroke-width: 3;
  }
  ${le(E2)}
