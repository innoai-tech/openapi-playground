...
import { i as is, H as He, I as Ir, O as Ot } from './vendor-min-mermaid~chunk-IXVBHSNP.BDZ5TJ6K.chunk.js';
import { L as Lt } from './vendor-min-mermaid~chunk-3R3PQ5PD.DqcBTR0a.chunk.js';
...
var Er = Il.architecture, re = class {
    constructor(){
        this.nodes = {};
        this.groups = {};
        this.edges = [];
        ...
        this.setAccTitle = jf;
        this.getAccTitle = Zf;
        this.setDiagramTitle = Jf;
        this.getDiagramTitle = td;
        this.getAccDescription = Qf;
        this.setAccDescription = Kf;
        this.clear();
    }
    static{
    ...
    clear() {
        this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.dataStructures = void 0, this.elements = {}, Xf();
    }
...
var cr = /*#__PURE__*/ m$1(async function(D, C, T) {
    ...
    await Promise.all(/*#__PURE__*/ C.edges().map(async (c)=>{
        ...
        if (e && (Ht(u) ? y += u === "L" ? -X : X : N += u === "T" ? -X : X + 18), A && (Ht(f) ? b += f === "L" ? -X : X : $ += f === "T" ? -X : X + 18), !e && T.getNode(t)?.type === "junction" && (Ht(u) ? y += u === "L" ? n : -n : N += u === "T" ? n : -n), !A && T.getNode(l)?.type === "junction" && (Ht(f) ? b += f === "L" ? n : -n : $ += f === "T" ? n : -n), c[0]._private.rscratch) {
            ...
            if (v) {
                ...
                }, /*#__PURE__*/ hh()), s.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), R === "X") s.attr("transform", "translate(" + S + ", " + M + ")");
        ...
        if (t.type === "group") {
            ...
            if (t.label) {
                ...
                await is(v, t.label, {
                    ...
                    width: i,
                    classes: "architecture-service-label"
                }, /*#__PURE__*/ hh()), v.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), v.attr("transform", "translate(" + (h + a + 4) + ", " + (A + a + 2) + ")");
            }
        }
    }));
    ...
    for (let o of T){
        ...
        if (o.icon) a.html(`<g>${await He(o.icon, {
            height: r,
            width: r,
            fallbackPrefix: Kt.prefix
        })}</g>`);
        else if (o.iconText) {
            a.html(`<g>${await He("blank", {
                height: r,
                width: r,
                fallbackPrefix: Kt.prefix
            })}</g>`);
            let e = /*#__PURE__*/ a.append("g").append("foreignObject").attr("width", r).attr("height", r).append("div").attr("class", "node-icon-text").attr("style", `height: ${r}px;`).append("div").html(/*#__PURE__*/ Ce$1(o.iconText, g)), l = parseInt(/*#__PURE__*/ window.getComputedStyle(/*#__PURE__*/ e.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
...
function Or(D, C, T, g, o, { spatialMaps: n, groupAlignments: r }) {
    return new Promise((a)=>{
        let c = /*#__PURE__*/ kh("body").append("div").attr("id", "cy").attr("style", "display:none"), t = /*#__PURE__*/ Gr({
...
var Rr = /*#__PURE__*/ m$1(async (D, C, T, g)=>{
    ...
    await cr(i, f, o), await fr(l, f, o), Dr(o, f), ah(void 0, u, /*#__PURE__*/ o.getConfigField("padding"), /*#__PURE__*/ o.getConfigField("useMaxWidth"));
}, "draw"), pr = {
    draw: Rr
};
var Li = {
