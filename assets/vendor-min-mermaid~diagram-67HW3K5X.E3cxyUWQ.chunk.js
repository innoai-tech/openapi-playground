...
import { K as Kf, Q as Qf, b as td, J as Jf, Z as Zf, j as jf, X as Xf, O as Or, I as Il, t as tt$1, L as Ll } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
var f = {
    showLegend: true,
    ticks: 5,
    max: null,
    ...
    curves: [],
    options: f
}, g = /*#__PURE__*/ structuredClone(P), q = Il.radar, z = /*#__PURE__*/ m$1(()=>Lt({
        ...q,
        ...Or().radar
    ...
    Xf(), g = /*#__PURE__*/ structuredClone(P);
}, "clear"), x = {
    getAxes: k,
    getCurves: W,
    getOptions: H,
...
var it = /*#__PURE__*/ m$1((e, t)=>{
    ...
    let t = /*#__PURE__*/ Ll(), r = /*#__PURE__*/ Or(), a = /*#__PURE__*/ Lt(t, r.themeVariables), o = /*#__PURE__*/ Lt(a.radar, e);
    return {
        themeVariables: a,
        radarOptions: o
    };
}, "buildRadarStyleOptions"), F = /*#__PURE__*/ m$1(({ radar: e } = {})=>{
