...
import { M as Mf, L as Lf, B as Bf, F as Ff, v as vf, w as wf, H as Hl, X as RC, i as ih, aH as Vr, P as Pl, S as Sf, g as gC, aK as Yp } from "./vendor-min-mermaid~chunk-QJLC67TO.Dw34GYds.chunk.js";
...
lt.parser = lt;
var G = lt;
var tt = [], et = [], Z = /* @__PURE__ */ new Map(), Ht = /* @__PURE__ */ m$1(() => {
...
}, __ = new WeakMap(), __privateAdd(_a, __, m$1(_a, "SankeyLink")), _a), Yt = /* @__PURE__ */ m$1((t, r, i) => {
  tt.push(new ut(t, r, i));
}, "addLink"), ft = (_b = class {
  constructor(r) {
    this.ID = r;
  }
}, __2 = new WeakMap(), __privateAdd(_b, __2, m$1(_b, "SankeyNode")), _b), qt = /* @__PURE__ */ m$1((t) => {
  t = /* @__PURE__ */ gC.sanitizeText(t, /* @__PURE__ */ Hl());
  ...
  nodesMap: Z,
  getConfig: /* @__PURE__ */ m$1(() => Hl().sankey, "getConfig"),
  getNodes: Ut,
  getLinks: Xt,
  getGraph: Gt,
  addLink: Yt,
...
var ae = {
  ...
  let { securityLevel: c, sankey: S } = Hl(), m = RC.sankey, x;
  c === "sandbox" && (x = /* @__PURE__ */ ih("#i" + r));
  let o = c === "sandbox" ? ih(x.nodes()[0].contentDocument.body) : ih("body"), a = c === "sandbox" ? o.select(`[id="${r}"]`) : ih(`[id="${r}"]`), l = (S == null ? void 0 : S.width) ?? m.width, k = (S == null ? void 0 : S.height) ?? m.width, _ = (S == null ? void 0 : S.useMaxWidth) ?? m.useMaxWidth, p = (S == null ? void 0 : S.nodeAlignment) ?? m.nodeAlignment, v = (S == null ? void 0 : S.prefix) ?? m.prefix, C = (S == null ? void 0 : S.suffix) ?? m.suffix, E = (S == null ? void 0 : S.showValues) ?? m.showValues, M = /* @__PURE__ */ u.db.getGraph(), D = ae[p];
...
${v}${Math.round(T * 100) / 100}${C}` : y;
  ...
  N.append("path").attr("d", /* @__PURE__ */ it()).attr("stroke", O).attr("stroke-width", (y) => Math.max(1, y.width)), Pl(void 0, a, 0, _);
}, "draw"), Vt = {
  draw: le
};
