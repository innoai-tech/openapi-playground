import { S as St$1 } from './vendor-min-mermaid~chunk-2VPXETT4.C9tLaSPs.chunk.js';
...
import { J as Je$1, X as Xe$1, S, M as M$1 } from './vendor-min-mermaid~chunk-YM3XIQPS.DjUuqvt-.chunk.js';
import { t as tt$1, H as Hl, m as mf, i as ih, O as Oe$1, p as pl, E as Er, R as Rl, C as Cf, g as gC, r as Ef, q as mC } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
...
var C = m$1(async (l, t, o)=>{
    ...
    let r = o.useHtmlLabels || mf(Hl()?.flowchart?.htmlLabels), e = l.insert("g").attr("class", "label").attr("style", o.labelStyle || ""), a = await Qt$1(e, Oe$1(Xe$1(t), Hl()), {
        useHtmlLabels: r,
...
function Zs(l, t, o) {
    ...
    let e = o, a = Math.max(t, .1), h = l[0] && l[0][0] && typeof l[0][0] == "number" ? [
        l
    ] : l, s = [
        0,
        0
    ...
    let c = function(i, n, p) {
        ...
        for(; d.length || g.length;){
            ...
            if (d = d.filter((b)=>!(b.edge.ymax <= y)), d.sort((b, S)=>b.edge.x === S.edge.x ? 0 : (b.edge.x - S.edge.x) / Math.abs(b.edge.x - S.edge.x)), (p !== 1 || x % n == 0) && d.length > 1) for(let b = 0; b < d.length; b += 2){
                let S = b + 1;
                if (S >= d.length) break;
...
var te = class extends Mt {
    ...
    dotsOnLines(t, o) {
        ...
        let h = e / 4;
        for (let s of t){
            let c = Vt(s), i = c / e, n = Math.ceil(i) - 1, p = c - n * e, f = (s[0][0] + s[1][0]) / 2 - e / 4, m = Math.min(s[0][1], s[1][1]);
            for(let g = 0; g < n; g++){
    ...
    dashedLine(t, o) {
        ...
        return t.forEach((h)=>{
            let s = Vt(h), c = Math.floor(s / (r + e)), i = (s + e - c * (r + e)) / 2, n = h[0], p = h[1];
            n[0] > p[0] && (n = h[1], p = h[0]);
            let f = Math.atan((p[1] - n[1]) / (p[0] - n[0]));
            for(let m = 0; m < c; m++){
                let g = m * (r + e), d = g + r, y = [
...
function Pe(l) {
    ...
    for (let { key: i, data: n } of l){
        switch(i){
            ...
            case "A":
                {
                    let p = Math.abs(n[0]), f = Math.abs(n[1]), m = n[2], g = n[3], d = n[4], y = n[5], x = n[6];
                    p === 0 || f === 0 ? (t.push({
                        key: "C",
                        data: [
                            r,
...
function Be(l, t, o, r, e, a, h, s, c, i) {
    ...
    x = g - m;
    let b = Math.cos(m), S = Math.sin(m), $ = Math.cos(g), w = Math.sin(g), P = Math.tan(x / 4), B = 4 / 3 * e * P, R = 4 / 3 * a * P, j = [
        l,
        t
    ], G = [
        l + B * S,
    ...
    ].concat(f);
    {
        ...
        for(let L = 0; L < f.length; L += 3){
            let H = vt(f[L][0], f[L][1], n), O = vt(f[L + 1][0], f[L + 1][1], n), F = vt(f[L + 2][0], f[L + 2][1], n);
            A.push([
                H[0],
                H[1],
                O[0],
...
function Se(l, t) {
    if (l.length) {
        let o = typeof l[0][0] == "number" ? [
            l
        ] : l, r = Et(o[0], 1 * (1 + .2 * t.roughness), t), e = t.disableMultiStroke ? [] : Et(o[0], 1.5 * (1 + .22 * t.roughness), ve(t));
        for(let a = 1; a < o.length; a++){
            let h = o[a];
            if (h.length) {
                let s = Et(h, 1 * (1 + .2 * t.roughness), t), c = t.disableMultiStroke ? [] : Et(h, 1.5 * (1 + .22 * t.roughness), ve(t));
...
m$1(Ce, "T");
function ie(l, t, o, r) {
    let [e, a] = De(r.increment, l, t, r.rx, r.ry, 1, r.increment * Lt(.1, Lt(.4, 1, o), o), o), h = Ht(e, null, o);
...
function we(l, t, o, r, e, a, h, s, c) {
    let i = l, n = t, p = Math.abs(o / 2), f = Math.abs(r / 2);
    p += _(.01 * p, c), f += _(.01 * f, c);
    let m = e, g = a;
    for(; m < 0;)m += 2 * Math.PI, g += 2 * Math.PI;
    g - m > 2 * Math.PI && (m = 0, g = 2 * Math.PI);
    let d = 2 * Math.PI / c.curveStepCount, y = Math.min(d / 2, (g - m) / 2), x = Me(y, i, n, p, f, m, g, 1, c);
    if (!c.disableMultiStroke) {
        let b = Me(y, i, n, p, f, m, g, 1.5, c);
        x.push(...b);
    }
    return h && (s ? x.push(...ft(i, n, i + p * Math.cos(m), n + f * Math.sin(m), c), ...ft(i, n, i + p * Math.cos(g), n + f * Math.sin(g), c)) : x.push({
        op: "lineTo",
        data: [
            i,
            n
...
function ne(l, t, o, r, e, a, h) {
    ...
    m = _(m, e, i), g = _(g, e, i);
    let d = [], y = m$1(()=>_(p, e, i), "M"), x = m$1(()=>_(n, e, i), "k"), b = e.preserveVertices;
    return a && (h ? d.push({
        op: "move",
        data: [
            l + (b ? 0 : y()),
...
function le(l, t, o, r) {
    ...
    if (function(s, c) {
        ...
        let c = l[t + 0], i = l[t + 1], n = l[t + 2], p = l[t + 3], f = xt(c, i, .5), m = xt(i, n, .5), g = xt(n, p, .5), d = xt(f, m, .5), y = xt(m, g, .5), x = xt(d, y, .5);
        le([
            c,
            f,
            d,
...
var st = "none", St = class {
    ...
    arc(t, o, r, e, a, h) {
        ...
        let i = this._o(c), n = [], p = we(t, o, r, e, a, h, s, true, i);
        ...
        } else n.push(function(f, m, g, d, y, x, b) {
            let S = f, $ = m, w = Math.abs(g / 2), P = Math.abs(d / 2);
            w += _(.01 * w, b), P += _(.01 * P, b);
            let B = y, R = x;
    ...
    path(t, o) {
        ...
        let a = r.fill && r.fill !== "transparent" && r.fill !== st, h = r.stroke !== st, s = !!(r.simplification && r.simplification < 1), c = function(n, p, f) {
            let m = Pe($e(pe(n))), g = [], d = [], y = [
                0,
                0
            ], x = [], b = m$1(()=>{
        ...
        if (a) if (r.fillStyle === "solid") if (c.length === 1) {
            let n = Ne(t, Object.assign(Object.assign({}, r), {
                disableMultiStroke: true,
                roughness: r.roughness ? r.roughness + r.fillShapeRoughnessGain : 0
            }));
            e.push({
...
var Ee = m$1(async (l, t)=>{
    ...
    } else $ = p.insert("rect", ":first-child"), $.attr("style", c).attr("rx", t.rx).attr("ry", t.ry).attr("x", b).attr("y", S).attr("width", y).attr("height", x);
    ...
    let o = Hl(), { themeVariables: r, handDrawnSeed: e } = o, { altBackground: a, compositeBackground: h, compositeTitleBackground: s, nodeBorder: c } = r, i = l.insert("g").attr("class", t.cssClasses).attr("id", t.id).attr("data-id", t.id).attr("data-look", t.look), n = i.insert("g", ":first-child"), p = i.insert("g").attr("class", "cluster-label"), f = i.append("rect"), m = p.node().appendChild(await $t(t.label, t.labelStyle, void 0, true)), g = m.getBBox();
    if (mf(o.flowchart.htmlLabels)) {
    ...
    } else B = n.insert("rect", ":first-child"), B.attr("class", "outer").attr("x", $).attr("y", w).attr("width", x).attr("height", b).attr("data-look", t.look), f.attr("class", "inner").attr("x", $).attr("y", P).attr("width", x).attr("height", S);
    ...
    let m;
    if (t.look === "handDrawn") {
        let y = v.svg(h).rectangle(p, f, i, n, {
            fill: "lightgrey",
            roughness: .5,
            strokeLineDash: [
                5
    ...
    } else m = s.insert("rect", ":first-child"), m.attr("class", "divider").attr("x", p).attr("y", f).attr("width", i).attr("height", n).attr("data-look", t.look);
...
function yr(l, t, o, r) {
    ...
    if (e = t.y - l.y, h = l.x - t.x, c = t.x * l.y - l.x * t.y, f = e * o.x + h * o.y + c, m = e * r.x + h * r.y + c, !(f !== 0 && m !== 0 && Le(f, m)) && (a = r.y - o.y, s = o.x - r.x, i = r.x * o.y - o.x * r.y, n = a * l.x + s * l.y + i, p = a * t.x + s * t.y + i, !(n !== 0 && p !== 0 && Le(n, p)) && (g = e * s - a * h, g !== 0))) return d = Math.abs(g / 2), y = h * i - s * c, x = y < 0 ? (y - d) / g : (y + d) / g, y = a * c - e * i, b = y < 0 ? (y - d) / g : (y + d) / g, {
        x,
        y: b
    };
}
...
function xr(l, t, o) {
    ...
    for(let n = 0; n < t.length; n++){
        let p = t[n], f = t[n < t.length - 1 ? n + 1 : 0], m = He(l, o, {
            x: c + p.x,
            y: i + p.y
        }, {
            x: c + f.x,
    ...
    return a.length ? (a.length > 1 && a.sort(function(n, p) {
        let f = n.x - o.x, m = n.y - o.y, g = Math.sqrt(f * f + m * m), d = p.x - o.x, y = p.y - o.y, x = Math.sqrt(d * d + y * y);
...
function Ve(l, t) {
    ...
    let n = c.circle(0, 0, h * 2, i), p = a.insert(()=>n, ":first-child");
...
function Ie(l, t, o, r, e, a, h) {
    let c = (l + o) / 2, i = (t + r) / 2, n = Math.atan2(r - t, o - l), p = (o - l) / 2, f = (r - t) / 2, m = p / e, g = f / a, d = Math.sqrt(m ** 2 + g ** 2);
    if (d > 1) throw new Error("The given radii are too small to create an arc between the points.");
    let y = Math.sqrt(1 - d ** 2), x = c + y * a * Math.sin(n) * (h ? -1 : 1), b = i - y * e * Math.cos(n) * (h ? -1 : 1), S = Math.atan2((t - b) / a, (l - x) / e), w = Math.atan2((r - b) / a, (o - x) / e) - S;
...
async function Fe(l, t) {
    ...
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = a.width + t.padding + 20, s = a.height + t.padding, c = s / 2, i = c / (2.5 + s / 50), { cssStyles: n } = t, p = [
        {
            x: h / 2,
            y: -s / 2
        },
...
async function _e(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = a.height + t.padding, s = 12, c = a.width + t.padding + s, i = 0, n = c, p = -h, f = 0, m = [
        {
            x: i + s,
            y: p
        },
    ...
    if (t.look === "handDrawn") {
        let y = v.svg(e), x = D(t, {}), b = V(m), S = y.path(b, x);
...
function ze(l, t) {
    ...
    let i = V(h), n = s.path(i, c), p = r.insert(()=>n, ":first-child");
...
async function qe(l, t) {
    ...
    if (t.look === "handDrawn") {
        let n = v.svg(e), p = D(t, {}), f = n.circle(0, 0, s * 2, p);
...
function Xe(l, t) {
    ...
    let e = l.insert("g").attr("class", T(t)).attr("id", t.domId ?? t.id), a = Math.max(30, t?.width ?? 0), { cssStyles: h } = t, s = v.svg(e), c = D(t, {});
    t.look !== "handDrawn" && (c.roughness = 0, c.fillStyle = "solid");
    let i = s.circle(0, 0, a * 2, c), n = br(a), p = s.path(n, c), f = e.insert(()=>i, ":first-child");
...
async function Ye(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = a.width + (t.padding ?? 0), c = a.height + (t.padding ?? 0), i = Math.max(5, c * .1), { cssStyles: n } = t, p = [
        ...
        ...dt(s / 2 + s * .1, -i, i, 20, -180, -270),
        ...dt(s / 2 + s * .1, i, i, 20, -90, -180),
        {
            x: -s / 2 - i,
            y: c / 2
        },
    ...
    let y = V(p).replace("Z", ""), x = m.path(y, g), b = V(f), S = m.path(b, {
        ...g
...
async function Qe(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = 80, s = 20, c = Math.max(h, (a.width + (t.padding ?? 0) * 2) * 1.25, t?.width ?? 0), i = Math.max(s, a.height + (t.padding ?? 0) * 2, t?.height ?? 0), n = i / 2, { cssStyles: p } = t, f = v.svg(e), m = D(t, {});
    t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
    let g = c, d = i, y = g - n, x = d / 4, b = [
        ...
        ...Rt(-y, -d / 2, n, 50, 270, 90)
    ], S = V(b), $ = f.path(S, m), w = e.insert(()=>$, ":first-child");
...
async function Je(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + t.padding, t.width ?? 0), c = s / 2, i = c / (2.5 + s / 50), n = Math.max(a.height + i + t.padding, t.height ?? 0), p, { cssStyles: f } = t;
    if (t.look === "handDrawn") {
        let m = v.svg(e), g = wr(0, 0, s, n, c, i), d = Nr(0, i, s, n, c, i), y = m.path(g, D(t, {})), x = m.path(d, D(t, {
            fill: "none"
        }));
        p = e.insert(()=>x, ":first-child"), p = e.insert(()=>y, ":first-child"), p.attr("class", "basic label-container"), f && p.attr("style", f);
    } else {
        let m = Sr(0, 0, s, n, c, i);
...
async function Ke(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = a.width + t.padding, c = a.height + t.padding, i = c * .2, n = -s / 2, p = -c / 2 - i / 2, { cssStyles: f } = t, m = v.svg(e), g = D(t, {});
    t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
    let d = [
        {
            x: n,
...
async function ts(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, halfPadding: h } = await C(l, t, T(t)), c = a.width / 2 + h + 5, i = a.width / 2 + h, n, { cssStyles: p } = t;
    if (t.look === "handDrawn") {
        let f = v.svg(e), m = D(t, {
            roughness: .2,
            strokeWidth: 2.5
        ...
        n = e.insert("g", ":first-child"), n.attr("class", Je$1(t.cssClasses)).attr("style", Je$1(p)), n.node()?.appendChild(d), n.node()?.appendChild(y);
    } else {
        n = e.insert("g", ":first-child");
        let f = n.insert("circle", ":first-child"), m = n.insert("circle");
...
function es(l, t, param) {
    ...
    let a = l.insert("g").attr("class", T(t)).attr("id", t.domId ?? t.id), h = 7, { cssStyles: s } = t, c = v.svg(a), { nodeBorder: i } = o, n = D(t, {
        fillStyle: "solid"
    });
    t.look !== "handDrawn" && (n.roughness = 0);
    let p = c.circle(0, 0, h * 2, n), f = a.insert(()=>p, ":first-child");
...
async function ss(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = a.width + (t.padding ?? 0), c = s + a.height, i = s + a.height, n = [
        {
            x: 0,
            y: -c
        },
    ...
    t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
    let g = V(n), d = f.path(g, m), y = e.insert(()=>d, ":first-child").attr("transform", `translate(${-c / 2}, ${c / 2})`);
...
function rs(l, t, param) {
    ...
    t.label = "";
    let h = l.insert("g").attr("class", T(t)).attr("id", t.domId ?? t.id), { cssStyles: s } = t, c = Math.max(70, t?.width ?? 0), i = Math.max(10, t?.height ?? 0);
    o === "LR" && (c = Math.max(10, t?.width ?? 0), i = Math.max(70, t?.height ?? 0));
    let n = -1 * c / 2, p = -1 * i / 2, f = v.svg(h), m = D(t, {
        stroke: e.lineColor,
        fill: e.lineColor
    });
    t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
    let g = f.rectangle(n, p, c, i, m), d = h.insert(()=>g, ":first-child");
...
async function os(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let e = 80, a = 50, { shapeSvg: h, bbox: s } = await C(l, t, T(t)), c = Math.max(e, s.width + (t.padding ?? 0) * 2, t?.width ?? 0), i = Math.max(a, s.height + (t.padding ?? 0) * 2, t?.height ?? 0), n = i / 2, { cssStyles: p } = t, f = v.svg(h), m = D(t, {});
    t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
    let g = [
        {
            x: -c / 2,
...
async function as(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = 4, s = a.height + t.padding, c = s / h, i = a.width + 2 * c + t.padding, n = [
        {
            x: c,
            y: 0
        },
...
async function is(l, t) {
    ...
    let { shapeSvg: e } = await C(l, t, T(t)), a = Math.max(30, t?.width ?? 0), h = Math.max(30, t?.height ?? 0), { cssStyles: s } = t, c = v.svg(e), i = D(t, {});
    ...
    ], p = V(n), f = c.path(p, i), m = e.insert(()=>f, ":first-child");
...
async function ns(l, t, param) {
    ...
    t.labelStyle = e;
    let a = t.assetHeight ?? 48, h = t.assetWidth ?? 48, s = Math.max(a, h), c = r?.wrappingWidth;
    t.width = Math.max(s, c ?? 0);
    let { shapeSvg: i, bbox: n, label: p } = await C(l, t, "icon-shape default"), f = t.pos === "t", m = s, g = s, { nodeBorder: d } = o, { stylesMap: y } = nt(t), x = -g / 2, b = -m / 2, S = t.label ? 8 : 0, $ = v.svg(i), w = D(t, {
        stroke: "none",
        fill: "none"
    });
    t.look !== "handDrawn" && (w.roughness = 0, w.fillStyle = "solid");
    let P = $.rectangle(x, b, g, m, w), B = Math.max(g, n.width), R = m + n.height + S, j = $.rectangle(-B / 2, -R / 2, B, R, {
        ...w,
        fill: "transparent",
        stroke: "none"
...
async function ls(l, t, param) {
    ...
    let a = t.assetHeight ?? 48, h = t.assetWidth ?? 48, s = Math.max(a, h), c = r?.wrappingWidth;
    t.width = Math.max(s, c ?? 0);
    let { shapeSvg: i, bbox: n, label: p } = await C(l, t, "icon-shape default"), f = 20, m = t.label ? 8 : 0, g = t.pos === "t", { nodeBorder: d, mainBkg: y } = o, { stylesMap: x } = nt(t), b = v.svg(i), S = D(t, {});
    ...
    let P = w.node().getBBox(), B = P.width, R = P.height, j = P.x, G = P.y, E = Math.max(B, R) * Math.SQRT2 + f * 2, I = b.circle(0, 0, E, S), A = Math.max(E, n.width), L = E + n.height + m, H = b.rectangle(-A / 2, -L / 2, A, L, {
        ...S,
        fill: "transparent",
        stroke: "none"
...
async function cs(l, t, param) {
    ...
    let a = t.assetHeight ?? 48, h = t.assetWidth ?? 48, s = Math.max(a, h), c = r?.wrappingWidth;
    t.width = Math.max(s, c ?? 0);
    let { shapeSvg: i, bbox: n, halfPadding: p, label: f } = await C(l, t, "icon-shape default"), m = t.pos === "t", g = s + p * 2, d = s + p * 2, { nodeBorder: y, mainBkg: x } = o, { stylesMap: b } = nt(t), S = -d / 2, $ = -g / 2, w = t.label ? 8 : 0, P = v.svg(i), B = D(t, {});
    t.look !== "handDrawn" && (B.roughness = 0, B.fillStyle = "solid");
    let R = b.get("fill");
    B.stroke = R ?? x;
    let j = P.path(J(S, $, d, g, 5), B), G = Math.max(d, n.width), E = g + n.height + w, I = P.rectangle(-G / 2, -E / 2, G, E, {
        ...B,
        fill: "transparent",
        stroke: "none"
...
async function hs(l, t, param) {
    ...
    let R = b.get("fill");
    B.stroke = R ?? x;
    let j = P.path(J(S, $, d, g, .1), B), G = Math.max(d, n.width), E = g + n.height + w, I = P.rectangle(-G / 2, -E / 2, G, E, {
        ...B,
        fill: "transparent",
        stroke: "none"
...
async function ps(l, t, param) {
    ...
    let c = Math.max(t.label ? s ?? 0 : 0, t?.assetWidth ?? e), i = t.constraint === "on" && t?.assetHeight ? t.assetHeight * t.imageAspectRatio : c, n = t.constraint === "on" ? i / t.imageAspectRatio : t?.assetHeight ?? a;
    t.width = Math.max(i, s ?? 0);
    let { shapeSvg: p, bbox: f, label: m } = await C(l, t, "image-shape default"), g = t.pos === "t", d = -i / 2, y = -n / 2, x = t.label ? 8 : 0, b = v.svg(p), S = D(t, {});
    t.look !== "handDrawn" && (S.roughness = 0, S.fillStyle = "solid");
    let $ = b.rectangle(d, y, i, n, S), w = Math.max(i, f.width), P = n + f.height + x, B = b.rectangle(-w / 2, -P / 2, w, P, {
        ...S,
        fill: "none",
        stroke: "none"
...
async function ms(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), s = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = [
        {
            x: 0,
            y: 0
        },
...
async function ct(l, t, o) {
    let { labelStyles: r, nodeStyles: e } = k(t);
    t.labelStyle = r;
    let { shapeSvg: a, bbox: h } = await C(l, t, T(t)), s = Math.max(h.width + o.labelPaddingX * 2, t?.width || 0), c = Math.max(h.height + o.labelPaddingY * 2, t?.height || 0), i = -s / 2, n = -c / 2, p, { rx: f, ry: m } = t, { cssStyles: g } = t;
    if (o?.rx && o.ry && (f = o.rx, m = o.ry), t.look === "handDrawn") {
        let d = v.svg(a), y = D(t, {}), x = f || m ? d.path(J(i, n, s, c, f || 0), y) : d.rectangle(i, n, s, c, y);
        p = a.insert(()=>x, ":first-child"), p.attr("class", "basic label-container").attr("style", Je$1(g));
    } else p = a.insert("rect", ":first-child"), p.attr("class", "basic label-container").attr("style", e).attr("rx", Je$1(f)).attr("ry", Je$1(m)).attr("x", i).attr("y", n).attr("width", s).attr("height", c);
...
async function gs(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = Math.max(a.width + (t.padding ?? 0), t?.width ?? 0), s = Math.max(a.height + (t.padding ?? 0), t?.height ?? 0), c = [
        {
            x: 0,
            y: 0
        },
...
function us(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.label = "", t.labelStyle = o;
    let e = l.insert("g").attr("class", T(t)).attr("id", t.domId ?? t.id), { cssStyles: a } = t, h = Math.max(35, t?.width ?? 0), s = Math.max(35, t?.height ?? 0), c = 7, i = [
        {
            x: h,
            y: 0
        },
    ...
    let f = V(i), m = n.path(f, p), g = e.insert(()=>m, ":first-child");
...
async function ys(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + (t.padding ?? 0), t.width ?? 0), c = s / 2, i = c / (2.5 + s / 50), n = Math.max(a.height + i + (t.padding ?? 0), t.height ?? 0), p = n * .1, f, { cssStyles: m } = t;
    if (t.look === "handDrawn") {
        let g = v.svg(e), d = Mr(0, 0, s, n, c, i, p), y = kr(0, i, s, n, c, i), x = D(t, {}), b = g.path(d, x), S = g.path(y, x);
        e.insert(()=>S, ":first-child").attr("class", "line"), f = e.insert(()=>b, ":first-child"), f.attr("class", "basic label-container"), m && f.attr("style", m);
    } else {
        let g = Dr(0, 0, s, n, c, i, p);
...
async function xs(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), i = c / 4, n = c + i, { cssStyles: p } = t, f = v.svg(e), m = D(t, {});
    t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
    let g = [
        {
            x: -s / 2 - s / 2 * .1,
        ...
        ...at(-s / 2 - s / 2 * .1, n / 2, s / 2 + s / 2 * .1, n / 2, i, .8),
        {
            x: s / 2 + s / 2 * .1,
            y: -n / 2
        },
...
async function bs(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), i = 5, n = -s / 2, p = -c / 2, { cssStyles: f } = t, m = v.svg(e), g = D(t, {}), d = [
        {
            x: n - i,
            y: p + i
        },
    ...
    t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
    let x = V(d), b = m.path(x, g), S = V(y), $ = m.path(S, {
        ...g,
        fill: "none"
...
async function Ss(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), i = c / 4, n = c + i, p = -s / 2, f = -n / 2, m = 5, { cssStyles: g } = t, d = at(p - m, f + n + m, p + s - m, f + n + m, i, .8), y = d?.[d.length - 1], x = [
        {
            x: p - m,
            y: f + m
        },
    ...
    let w = V(x), P = S.path(w, $), B = V(b), R = S.path(B, $), j = e.insert(()=>P, ":first-child");
...
async function ws(l, t, param) {
    ...
    let { shapeSvg: h, bbox: s } = await C(l, t, T(t)), c = Math.max(s.width + (t.padding ?? 0) * 2, t?.width ?? 0), i = Math.max(s.height + (t.padding ?? 0) * 2, t?.height ?? 0), n = -c / 2, p = -i / 2, { cssStyles: f } = t, m = v.svg(h), g = D(t, {
        fill: o.noteBkgColor,
        stroke: o.noteBorderColor
    });
    t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
    let d = m.rectangle(n, p, c, i, g), y = h.insert(()=>d, ":first-child");
...
async function vs(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + (t.padding ?? 0), t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0), t?.height ?? 0), i = -s / 2, n = -c / 2, p = n / 2, f = [
        {
            x: i + p,
            y: n
        },
...
async function Ds(l, t) {
    ...
    let a = l.insert("g").attr("class", e).attr("id", t.domId || t.id), h = a.insert("g"), s = a.insert("g").attr("class", "label").attr("style", r), c = t.description, i = t.label, n = s.node().appendChild(await $t(i, t.labelStyle, true, true)), p = {
        width: 0,
        height: 0
    };
    if (mf(Hl()?.flowchart?.htmlLabels)) {
        let R = n.children[0], j = ih(n);
        p = R.getBoundingClientRect(), j.attr("width", p.width), j.attr("height", p.height);
    }
    tt$1.info("Text 2", c);
    let f = c || [], m = n.getBBox(), g = s.node().appendChild(await $t(f.join ? f.join("<br/>") : f, t.labelStyle, true, true)), d = g.children[0], y = ih(g);
    p = d.getBoundingClientRect(), y.attr("width", p.width), y.attr("height", p.height);
    let x = (t.padding || 0) / 2;
    ih(g).attr("transform", "translate( " + (p.width > m.width ? 0 : (m.width - p.width) / 2) + ", " + (m.height + x + 5) + ")"), ih(n).attr("transform", "translate( " + (p.width < m.width ? 0 : -(m.width - p.width) / 2) + ", 0)"), p = s.node().getBBox(), s.attr("transform", "translate(" + -p.width / 2 + ", " + (-p.height / 2 - x + 3) + ")");
    let b = p.width + (t.padding || 0), S = p.height + (t.padding || 0), $ = -p.width / 2 - x, w = -p.height / 2 - x, P, B;
    if (t.look === "handDrawn") {
        let R = v.svg(a), j = D(t, {}), G = R.path(J($, w, b, S, t.rx || 0), j), E = R.line(-p.width / 2 - x, -p.height / 2 - x + m.height + x, p.width / 2 + x, -p.height / 2 - x + m.height + x, j);
...
async function ks(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = t?.padding ?? 0, c = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), i = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), n = -a.width / 2 - s, p = -a.height / 2 - s, { cssStyles: f } = t, m = v.svg(e), g = D(t, {});
    t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
    let d = [
        {
            x: n,
...
async function $s(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), i = -s / 2, n = -c / 2, { cssStyles: p } = t, f = v.svg(e), m = D(t, {});
    t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
    let g = [
        {
            x: i,
...
async function Bs(l, t) {
    ...
    if (t.look === "handDrawn") {
        let n = v.svg(e), p = D(t, {}), f = J(-s / 2, -h / 2, s, h, h / 2), m = n.path(f, p);
...
function Cs(l, t, param) {
    ...
    let { labelStyles: r, nodeStyles: e } = k(t);
    t.labelStyle = r;
    let { cssStyles: a } = t, { lineColor: h, stateBorder: s, nodeBorder: c } = o, i = l.insert("g").attr("class", "node default").attr("id", t.domId || t.id), n = v.svg(i), p = D(t, {});
    t.look !== "handDrawn" && (p.roughness = 0, p.fillStyle = "solid");
    let f = n.circle(0, 0, 14, {
        ...p,
        stroke: h,
        strokeWidth: 2
    }), m = s ?? c, g = n.circle(0, 0, 5, {
        ...p,
        fill: m,
        stroke: m,
        strokeWidth: 2,
...
async function Gs(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = (t?.padding || 0) / 2, s = a.width + t.padding, c = a.height + t.padding, i = -a.width / 2 - h, n = -a.height / 2 - h, p = [
        {
            x: 0,
            y: 0
        },
    ...
    if (t.look === "handDrawn") {
        let f = v.svg(e), m = D(t, {}), g = f.rectangle(i - 8, n, s + 16, c, m), d = f.line(i, n, i, n + c, m), y = f.line(i + s, n, i + s, n + c, m);
...
async function Es(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), s = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), c = -h / 2, i = -s / 2, n = .2 * s, p = .2 * s, { cssStyles: f } = t, m = v.svg(e), g = D(t, {}), d = [
        {
            x: c - n / 2,
            y: i
        },
...
async function js(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), i = c / 4, n = .2 * s, p = .2 * c, f = c + i, { cssStyles: m } = t, g = v.svg(e), d = D(t, {});
    t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
    let y = [
        {
            x: -s / 2 - s / 2 * .1,
        ...
        ...at(-s / 2 - s / 2 * .1, f / 2, s / 2 + s / 2 * .1, f / 2, i, .8),
        {
            x: s / 2 + s / 2 * .1,
            y: -f / 2
        },
        ...
        ...at(x + s, (b + c) * 1.3, x + s - n, (b + c) * 1.5, -c * .03, .5)
    ], $ = V(y), w = g.path($, d), P = V(S), B = g.path(P, {
        ...d,
        fillStyle: "solid"
...
async function As(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = Math.max(a.width + t.padding, t?.width || 0), s = Math.max(a.height + t.padding, t?.height || 0), c = -h / 2, i = -s / 2, n = e.insert("rect", ":first-child");
...
async function Os(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h, halfPadding: s } = await C(l, t, T(t)), c = t.look === "neo" ? s * 2 : s, i = a.height + c, n = i / 2, p = n / (2.5 + i / 50), f = a.width + p + c, { cssStyles: m } = t, g;
    if (t.look === "handDrawn") {
        let d = v.svg(e), y = Br(0, 0, f, i, p, n), x = Tr(0, 0, f, i, p, n), b = d.path(y, D(t, {})), S = d.path(x, D(t, {
            fill: "none"
        }));
        g = e.insert(()=>S, ":first-child"), g = e.insert(()=>b, ":first-child"), g.attr("class", "basic label-container"), m && g.attr("style", m);
    } else {
        let d = Pr(0, 0, f, i, p, n);
...
async function Hs(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = 60, s = 20, c = Math.max(h, a.width + (t.padding ?? 0) * 2, t?.width ?? 0), i = Math.max(s, a.height + (t.padding ?? 0) * 2, t?.height ?? 0), { cssStyles: n } = t, p = v.svg(e), f = D(t, {});
...
async function Ws(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = mf(Hl().flowchart?.htmlLabels), c = a.width + (t.padding ?? 0), i = c + a.height, n = c + a.height, p = [
        {
            x: 0,
            y: 0
        },
...
async function Vs(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a, label: h } = await C(l, t, T(t)), s = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), c = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), i = c / 8, n = c + i, { cssStyles: p } = t, m = 70 - s, g = m > 0 ? m / 2 : 0, d = v.svg(e), y = D(t, {});
    ...
    ], b = V(x), S = d.path(b, y), $ = e.insert(()=>S, ":first-child");
...
async function Is(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let { shapeSvg: e, bbox: a } = await C(l, t, T(t)), h = 100, s = 50, c = Math.max(a.width + (t.padding ?? 0) * 2, t?.width ?? 0), i = Math.max(a.height + (t.padding ?? 0) * 2, t?.height ?? 0), n = c / i, p = c, f = i;
    p > f * n ? f = p / n : p = f * n, p = Math.max(p, h), f = Math.max(f, s);
    let m = Math.min(f * .2, f / 4), g = f + m * 2, { cssStyles: d } = t, y = v.svg(e), x = D(t, {});
    ...
    let b = [
        ...
        ...at(p / 2, -g / 2, -p / 2, -g / 2, m, -1)
    ], S = V(b), $ = y.path(S, x), w = e.insert(()=>$, ":first-child");
...
async function me(l, t) {
    ...
    if (o.attributes.length === 0 && t.label) {
        ...
        if (!mf(r.htmlLabels)) {
            let it = Q.select("text"), rt = it.node()?.getBBox();
    ...
    let c = T(t);
    c || (c = "node default");
    let i = l.insert("g").attr("class", c).attr("id", t.domId || t.id), n = await Pt(i, t.label ?? "", r, 0, 0, [
        "name"
    ], s);
    n.height += a;
    ...
    t.look !== "handDrawn" && (B.roughness = 0, B.fillStyle = "solid");
    let R = Math.max($.width + e * 2, t?.width || 0, w), j = Math.max($.height + (f[0] || p) + a, t?.height || 0), G = -R / 2, E = -j / 2;
    ...
    for (let [q, Q] of f.entries()){
        ...
        let it = q % 2 === 0 && Q !== 0, rt = P.rectangle(G, n.height + E + Q, R, n.height, {
            ...B,
            fill: it ? H : O,
            stroke: F
        });
    ...
    let W = P.line(G, n.height + E, R + G, n.height + E, B);
    i.insert(()=>W).attr("class", "divider"), W = P.line(m + G, n.height + E, m + G, j + E, B), i.insert(()=>W).attr("class", "divider"), x && (W = P.line(m + g + G, n.height + E, m + g + G, j + E, B), i.insert(()=>W).attr("class", "divider")), b && (W = P.line(m + g + d + G, n.height + E, m + g + d + G, j + E, B), i.insert(()=>W).attr("class", "divider"));
    for (let q of f)W = P.line(G, n.height + E + q, R + G, n.height + E + q, B), i.insert(()=>W).attr("class", "divider");
...
async function _s(l, t, o, r) {
    ...
    let a = r ? 0 : 3, h = l.insert("g").attr("class", T(t)).attr("id", t.domId || t.id), s = null, c = null, i = null, n = null, p = 0, f = 0, m = 0;
    ...
    m = i.node().getBBox().height, m <= 0 && (m = e / 2), n = h.insert("g").attr("class", "methods-group text");
    let y = 0;
    ...
    return c.attr("transform", `translate(${-g.width / 2}, ${p})`), x = h.node().getBBox(), i.attr("transform", `translate(0, ${p + f + e * 2})`), x = h.node().getBBox(), n.attr("transform", `translate(0, ${p + f + (m ? m + e * 4 : e * 2)})`), x = h.node().getBBox(), {
        shapeSvg: h,
        bbox: x
    };
}
...
async function zs(l, t) {
    ...
    let f = h.members.length === 0 && h.methods.length === 0 && !o.class?.hideEmptyMembersBox, m = v.svg(s), g = D(t, {});
    t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
    let d = c.width, y = c.height;
    h.members.length === 0 && h.methods.length === 0 ? y += e : h.members.length > 0 && h.methods.length === 0 && (y += e * 2);
    let x = -d / 2, b = -y / 2, S = m.rectangle(x - r, b - r - (f ? r : h.members.length === 0 && h.methods.length === 0 ? -r / 2 : 0), d + 2 * r, y + 2 * r + (f ? r * 2 : h.members.length === 0 && h.methods.length === 0 ? -r : 0), g), $ = s.insert(()=>S, ":first-child");
...
async function qs(l, t) {
    let { labelStyles: o, nodeStyles: r } = k(t);
    t.labelStyle = o;
    let e = t, a = t, h = 20, s = 20, c = "verifyMethod" in t, i = T(t), n = l.insert("g").attr("class", i).attr("id", t.domId ?? t.id), p;
    ...
    let g = (n.node()?.getBBox().width ?? 200) + h, d = (n.node()?.getBBox().height ?? 200) + h, y = -g / 2, x = -d / 2, b = v.svg(n), S = D(t, {});
    t.look !== "handDrawn" && (S.roughness = 0, S.fillStyle = "solid");
    let $ = b.rectangle(y, x, g, d, S), w = n.insert(()=>$, ":first-child");
    if (w.attr("class", "basic label-container").attr("style", r), n.selectAll(".label").each((P, B, R)=>{
        ...
        let P = b.line(y, x + p + m + s, y + g, x + p + m + s, S);
...
async function Xs(l, t, param) {
    ...
    let { shapeSvg: s, bbox: c, label: i } = await C(l, t, T(t)), n = t.padding || 10, p = "", f;
    "ticket" in t && t.ticket && o?.kanban?.ticketBaseUrl && (p = o?.kanban?.ticketBaseUrl.replace("#TICKET#", t.ticket), f = s.insert("svg:a", ":first-child").attr("class", "kanban-ticket-link").attr("xlink:href", p).attr("target", "_blank"));
    let m = {
    ...
    if (t.look === "handDrawn") {
        let I = v.svg(s), A = D(t, {}), L = j || G ? I.path(J(P, B, S, w, j || 0), A) : I.rectangle(P, B, S, w, A);
        R = s.insert(()=>L, ":first-child"), R.attr("class", "basic label-container").attr("style", E || null);
    } else {
        R = s.insert("rect", ":first-child"), R.attr("class", "basic label-container __APA__").attr("style", e).attr("rx", j ?? 5).attr("ry", G ?? 5).attr("x", P).attr("y", B).attr("width", S).attr("height", w);
