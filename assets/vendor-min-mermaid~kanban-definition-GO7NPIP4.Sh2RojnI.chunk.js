...
import { S as So, a as ag, l as lg } from './vendor-min-mermaid~chunk-2BQHA3SY.DoMtHC3O.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { t as tt, H as Hl, P as Pl, p as pl, D as De$1, an as $t, ao as F, ap as E } from './vendor-min-mermaid~chunk-RAMAZW42.vc82q0BN.chunk.js';
...
var x = [], se = [], re = 0, oe = {}, Ce = /*#__PURE__*/ m$1(()=>{
    ...
    let e = [], g = [], p = /*#__PURE__*/ _e(), r = /*#__PURE__*/ Hl();
    for (let d of p){
        let _ = {
            id: d.id,
...
` + d + `
    ...
    if (!e) return;
    let g = /*#__PURE__*/ Hl(), p = x[x.length - 1];
...
` + e);
    ...
    for (let y of u){
        ...
        for (let i of J){
            ...
            let s = /*#__PURE__*/ (await ag(C, i, {
                config: b
            })).node().getBBox();
            i.y = T + s.height / 2, await lg(i), T = i.y + s.height / 2 + k / 2;
        }
