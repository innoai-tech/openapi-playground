import { j as jo, V as Vo, G as Go, $ as $o, H as Ho, U as Uo, m as mr, c as An, d as dr, N as No, h as hn } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
import { i as ia, g as He, O as $c } from './vendor-min-mermaid~chunk-63GW7ZVL.CUmzAGpZ.chunk.js';
...
var tt = [], et = [], Z = new Map, Ht = /*#__PURE__*/ m$1(()=>{
    ...
    nodesMap: Z,
    getConfig: /*#__PURE__*/ m$1(()=>mr().sankey, "getConfig"),
    getNodes: Ut,
    getLinks: Xt,
    getGraph: Gt,
    addLink: Yt,
...
var ae = {
    ...
    let { securityLevel: c, sankey: S } = mr(), m = An.sankey, x;
