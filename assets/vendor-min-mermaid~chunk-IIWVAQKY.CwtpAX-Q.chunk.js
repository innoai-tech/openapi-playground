...
import { e as Mt, t as tt, u as ug, j as fg, G as Gc, Y as Yc, k as cg, l as hg, y as Rc, x as xo, n as ag, z as lg, A as sg, r as ig, I as ng, J as og, K as rg, o as eg, q as tg, N as Ac, O as Lc, c as Bc, Q as js, U as Fi, V as dx, g as gC, i as ih } from './vendor-min-mermaid~chunk-RAMAZW42.vc82q0BN.chunk.js';
...
`, "ig");
        ...
        let n, i = [];
        for(; (n = /*#__PURE__*/ js.exec(t)) !== null;)if (n.index === js.lastIndex && js.lastIndex++, n && !e || e && n[1]?.match(e) || e && n[2]?.match(e)) {
