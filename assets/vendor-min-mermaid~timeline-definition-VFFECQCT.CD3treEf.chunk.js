import { H as Hl, t as tt$1, i as ih, P as Pl, am as $t$1, an as F$1, ao as E, al as bc, aM as un, S as Sf } from './vendor-min-mermaid~chunk-ZKYS2E5M.BKIs2nux.chunk.js';
...
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : K = "Parse error on line " + (N + 1) + ": Unexpected " + (w == L ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(K, {
                ...
                switch(M[0]){
                    ...
                    case 2:
                        ...
                        $ && (c = /*#__PURE__*/ c.slice(0, -1 * $ * 2), y = /*#__PURE__*/ y.slice(0, -1 * $), l = /*#__PURE__*/ l.slice(0, -1 * $)), c.push(this.productions_[M[1]][0]), y.push(R.$), l.push(R._$), nt = E[c[c.length - 2]][c[c.length - 1]], c.push(nt);
                        break;
                    case 3:
                        return true;
                }
...
var F = "", dt = 0, Y = [], G = [], W = [], pt = /*#__PURE__*/ m$1(()=>un, "getCommonDb"), yt = /*#__PURE__*/ m$1(function() {
...
var $t = 12, q = /*#__PURE__*/ m$1(function(n, t) {
    ...
    function u(g) {
        let d = /*#__PURE__*/ bc().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
        g.append("path").attr("class", "mouth").attr("d", d).attr("transform", "translate(" + t.cx + "," + (t.cy + 2) + ")");
    }
    m$1(u, "smile");
    function h(g) {
        let d = /*#__PURE__*/ bc().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
...
function St(n, t) {
    n.each(function() {
        var e = /*#__PURE__*/ ih(this), o = /*#__PURE__*/ e.text().split(/(\s+|<br>)/).reverse(), r, u = [], h = 1.1, f = /*#__PURE__*/ e.attr("y"), g = /*#__PURE__*/ parseFloat(/*#__PURE__*/ e.attr("dy")), d = /*#__PURE__*/ e.text(null).append("tspan").attr("x", 0).attr("y", f).attr("dy", g + "em");
        for(let x = 0; x < o.length; x++)r = o[o.length - 1 - x], u.push(r), d.text(/*#__PURE__*/ u.join(" ").trim()), (d.node().getComputedTextLength() > t || r === "<br>") && (u.pop(), d.text(/*#__PURE__*/ u.join(" ").trim()), r === "<br>" ? u = [
            ""
        ] : u = [
            r
...
m$1(St, "wrap");
var Ft = /*#__PURE__*/ m$1(function(n, t, e, o) {
    let r = e % $t - 1, u = /*#__PURE__*/ n.append("g");
    t.section = r, u.attr("class", (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + r));
    let h = /*#__PURE__*/ u.append("g"), f = /*#__PURE__*/ u.append("g"), d = /*#__PURE__*/ f.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(St, t.width).node().getBBox(), x = o.fontSize?.replace ? o.fontSize.replace("px", "") : o.fontSize;
    return t.height = d.height + x * 1.1 * .5 + t.padding, t.height = /*#__PURE__*/ Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, f.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), Ot(h, t, r, o), t;
...
var jt = /*#__PURE__*/ m$1(function(n, t, e, o) {
    let r = /*#__PURE__*/ Hl(), u = r.leftMargin ?? 50;
    tt$1.debug("timeline", o.db);
    let h = r.securityLevel, f;
    h === "sandbox" && (f = /*#__PURE__*/ ih("#i" + t));
    let d = /*#__PURE__*/ (h === "sandbox" ? ih(f.nodes()[0].contentDocument.body) : ih("body")).select("#" + t);
    d.append("g");
    let x = /*#__PURE__*/ o.db.getTasks(), _ = /*#__PURE__*/ o.db.getCommonDb().getDiagramTitle();
    ...
    for (let [L, v] of x.entries()){
        ...
        for (let P of v.events){
            ...
            A += /*#__PURE__*/ H.getVirtualNodeHeight(d, U, r);
        }
        C = /*#__PURE__*/ Math.max(C, A);
    }
    tt$1.debug("maxSectionHeight before draw", i), tt$1.debug("maxTaskHeight before draw", a), m && m.length > 0 ? m.forEach((L)=>{
        ...
        let T = /*#__PURE__*/ d.append("g"), A = /*#__PURE__*/ H.drawNode(T, b, E, r);
...
}, "draw"), Et = /*#__PURE__*/ m$1(function(n, t, e, o, r, u, h, f, g, d, x) {
    for (let _ of t){
        let m = {
            descr: _.task,
            section: e,
...
var qt = /*#__PURE__*/ m$1((n)=>{
    let t = "";
    for(let e = 0; e < n.THEME_COLOR_LIMIT; e++)n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], $t$1(n["lineColor" + e]) ? n["lineColor" + e] = /*#__PURE__*/ F$1(n["lineColor" + e], 20) : n["lineColor" + e] = /*#__PURE__*/ E(n["lineColor" + e], 20);
