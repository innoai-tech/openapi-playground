import { s as e, v as o, a, d as t, t as r, P as s, O as l } from "./lib-nodepkg-vueuikit.CCThKRrA.chunk.js";
import { j as n, d as i, h as d, b as p, w as c, e as u } from "./lib-nodepkg-vuekit.DHDC8L6I.chunk.js";
import { g as y } from "./vendor-innoai-tech-lodash.BmKfyDt9.chunk.js";
...
let w = /* @__PURE__ */ e("span", (e2, o2) => (o3) => {
  var a2;
  let t2 = null !== (a2 = e2.size) && void 0 !== a2 ? a2 : 24;
  return /* @__PURE__ */ n(o3, { "data-icon": true, "data-placement": e2.placement, "data-has-size": !!e2.size, children: /* @__PURE__ */ n("svg", { viewBox: "0 0 24 24", width: t2, height: t2, children: /* @__PURE__ */ n("path", { d: e2.path }) }) });
}, { displayName: "Icon", props: ["path", "size", "placement"] })({ display: "inline-block", _data_has_size__false: { boxSize: "1.2em", "& svg": { w: "100%", h: "100%" } } }), H = /* @__PURE__ */ t({ from: { opacity: 0 }, to: { opacity: 1 }, duration: r.duration.md1, easing: r.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: r.duration.sm4, easing: r.easing.standard.decelerate }), M = /* @__PURE__ */ e("div", { displayName: "TooltipContainer" })({ py: 4, px: 12, rounded: "sm", shadow: "3", containerStyle: "sys.on-surface", pos: "relative", zIndex: 100 }), V = /* @__PURE__ */ i((e2, o2) => {
  let { slots: a2 } = o2, t2 = /* @__PURE__ */ d(false);
  return () => {
    let o3 = a2.default()[0];
    return /* @__PURE__ */ n(s, { isOpen: t2.value, $content: /* @__PURE__ */ n(M, { children: e2.title }), $transition: (e3) => {
      let { content: o4 } = e3;
      return /* @__PURE__ */ n(H, { children: o4 });
...
}, { displayName: "Tooltip", props: ["title"] }), B = /* @__PURE__ */ e("div", { displayName: "MenuContainer" })({ py: 8, rounded: "sm", shadow: "2", minW: 120, containerStyle: "sys.surface-container", pos: "relative", zIndex: 100 });
e("div", { displayName: "ListItem" })({ "& + &": { borderTop: "1px solid", borderColor: "sys.outline-variant" }, py: 8, px: 16, textStyle: "sys.label-large", containerStyle: "sys.surface-container", _hover: { cursor: "pointer", bgColor: /* @__PURE__ */ o("sys.on-surface", /* @__PURE__ */ a(0.08)) } }), i((e2, o2) => {
  ...
  return () => {
    ...
    return /* @__PURE__ */ n(s, { isOpen: t2.value, placement: e2.placement, onClickOutside: () => {
      t2.value = false;
    }, $content: /* @__PURE__ */ n(B, { children: null === (o3 = a2.menu) || void 0 === o3 ? void 0 : o3.call(a2) }), children: r2 ? p(r2, { onClick: () => {
      t2.value = true;
    } }) : null });
  };
}, { displayName: "Menu", props: ["placement"] });
let N = /* @__PURE__ */ e("div", { displayName: "Container" })({ pos: "absolute", top: 0, left: 0, h: "100vh", w: "100vw", zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center" }), S = /* @__PURE__ */ e("div", { displayName: "DialogBackdrop" })({ cursor: "pointer", pos: "absolute", top: 0, left: 0, h: "100vh", w: "100vw", zIndex: -1, bgColor: /* @__PURE__ */ o("sys.scrim", /* @__PURE__ */ a(0.38)) });
e("div", { displayName: "DialogContainer" })({ py: 12, rounded: "sm", shadow: "3", minW: "50vw", containerStyle: "sys.surface-container-high" });
let A = /* @__PURE__ */ t({ from: { opacity: 0 }, to: { opacity: 1 }, duration: r.duration.md1, easing: r.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: r.duration.sm4, easing: r.easing.standard.accelerate });
i((e2, o2) => {
  var a2;
  let { slots: t2, emit: r2 } = o2, s2 = /* @__PURE__ */ d(null !== (a2 = e2.isOpen) && void 0 !== a2 && a2), i2 = /* @__PURE__ */ d(false);
  return c(() => e2.isOpen, (e3) => {
    true === e3 ? s2.value = true : false === e3 && (i2.value = false);
  }), () => {
    var e3;
    return /* @__PURE__ */ n(l, { isOpen: s2.value, onContentBeforeMount: () => {
      i2.value = true;
    }, onEscKeydown: () => {
      i2.value = false;
    }, children: /* @__PURE__ */ u(N, { children: [/* @__PURE__ */ n(A, { onComplete: (e4) => {
      "leave" === e4 && (s2.value = false, r2("close"));
    }, children: i2.value ? /* @__PURE__ */ n(S, { onClick: () => {
      i2.value = false;
  ...
  return (o3) => {
    ...
    return /* @__PURE__ */ u(o3, { "data-valued": i2, "data-invalid": d2, "data-disabled": c2, "data-focus-within": e2.focus, "data-has-leading": !!a2.leading, "data-has-trailing": !!a2.trailing, children: [/* @__PURE__ */ u("div", { "data-input-container": "", children: [a2.leading && /* @__PURE__ */ n(I, { role: "leading", children: /* @__PURE__ */ a2.leading() }), /* @__PURE__ */ n("div", { "data-input-label": "", children: null === (r2 = a2.label) || void 0 === r2 ? void 0 : r2.call(a2) }), b2, a2.trailing && /* @__PURE__ */ n(I, { role: "trailing", children: /* @__PURE__ */ a2.trailing() })] }), a2.supporting && /* @__PURE__ */ n("div", { "data-input-supporting": "", children: null === (s2 = a2.supporting) || void 0 === s2 ? void 0 : s2.call(a2) })] });
  };
...
let I = /* @__PURE__ */ e("div", { displayName: "Maker", props: ["role"] })({ pos: "absolute", top: 4, bottom: 4, display: "flex", alignItems: "center", color: "sys.on-surface-variant", _role__leading: { left: 12, $data_icon: { ml: -4 } }, _role__trailing: { right: 12, $data_icon: { mr: -4 } } });
export {
  m as F,
  w as I,
  V as T,
