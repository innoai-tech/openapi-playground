import { Y as Yt$1 } from './vendor-min-mermaid~chunk-EFRVIJHI.wT3iKf0B.chunk.js';
import { n as nr, O as Ot$1, o as ot$1, q as qo, h as hn } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
...
var X = /*#__PURE__*/ m$1((n, e, r, s = "")=>{
    ...
    return null;
}, "stringToIcon"), O = /*#__PURE__*/ m$1((n, e)=>n ? !!((e && n.prefix === "" || n.prefix) && n.name) : false, "validateIconName");
function $e(n, e) {
    let r = {};
...
function ze(n, e, r) {
    ...
    return m$1(i, "parse"), i(e), r.forEach(i), J(n, l);
}
...
m$1(lt, "mergeDefsAndContent");
function Ee(n, e, r) {
    let s = /*#__PURE__*/ ot(n);
    return lt(s.defs, e + s.content + r);
}
m$1(Ee, "wrapSVGContent");
var at = /*#__PURE__*/ m$1((n)=>n === "unset" || n === "undefined" || n === "none", "isUnsetKeyword");
function te(n, e) {
    let r = {
        ...K,
        ...n
    ...
    let u = {}, m = /*#__PURE__*/ m$1((x, b)=>{
        at(b) || (u[x] = /*#__PURE__*/ b.toString());
    }, "setAttr");
    m("width", h), m("height", f);
    let k = [
        t.left,
        t.top,
        a,
...
m$1(te, "iconToSVG");
var ct = /\sid="(\S+)"/g, pt = "IconifyId" + Date.now().toString(16) + (Math.random() * 16777216 | 0).toString(16), ht = 0;
function ne(n, e = pt) {
    let r = [], s;
...
var ut = {
    ...
    height: 80,
    width: 80
}, se = new Map, Ae = new Map, Hn = /*#__PURE__*/ m$1((n)=>{
    for (let e of n){
        if (!e.name) throw new Error('Invalid icon loader. Must have a "name" property with non-empty string value.');
        if (pt$1.debug("Registering icon pack:", e.name), "loader" in e) Ae.set(e.name, e.loader);
...
}, "registerIconPacks"), Le = /*#__PURE__*/ m$1(async (n, e)=>{
    let r = /*#__PURE__*/ X(n, true, e !== void 0);
    ...
    if (!t) {
        ...
        try {
            ...
            throw pt$1.error(o), new Error(`Failed to load icon set: ${r.prefix}`);
        }
    }
    let l = /*#__PURE__*/ Y(t, r.name);
    if (!l) throw new Error(`Icon not found: ${n}`);
    return l;
}, "getRegisteredIconData"), Me = /*#__PURE__*/ m$1(async (n)=>{
    try {
        return await Le(n), !0;
    } catch  {
        return false;
    }
}, "isIconAvailable"), ve = /*#__PURE__*/ m$1(async (n, e, r)=>{
    let s;
    try {
    ...
    let t = /*#__PURE__*/ te(s, e), l = /*#__PURE__*/ re(/*#__PURE__*/ ne(t.body), {
        ...t.attributes,
        ...r
    });
    return ot$1(l, /*#__PURE__*/ Ot$1());
}, "getIconSVG");
function Ce(n) {
    for(var e = [], r = 1; r < arguments.length; r++)e[r - 1] = arguments[r];
    var s = /*#__PURE__*/ Array.from(typeof n == "string" ? [
        n
    ] : n);
...
m$1(De, "J");
function _e(n, e) {
    let r = /*#__PURE__*/ n.replace(w.findPipe, (l, i, o)=>{
        let a = false, c = i;
        for(; --c >= 0 && o[c] === "\\";)a = !a;
        return a ? "|" : " |";
    }), s = /*#__PURE__*/ r.split(w.splitPipe), t = 0;
...
`), x = /*#__PURE__*/ this.blockquote(k);
                    l[l.length - 1] = x, s = s.substring(0, s.length - m.raw.length) + x.raw, t = t.substring(0, t.length - m.text.length) + x.text;
                    break;
                } else if (u?.type === "list") {
                    let m = u, k = m.raw + `
` + r.join(`
`), x = /*#__PURE__*/ this.list(k);
                    l[l.length - 1] = x, s = s.substring(0, s.length - u.raw.length) + x.raw, t = t.substring(0, t.length - m.raw.length) + x.raw, r = /*#__PURE__*/ k.substring(l.at(-1).raw.length).split(`
`);
                    continue;
                }
            }
    ...
    list(n) {
        ...
        if (e) {
            ...
            let l = /*#__PURE__*/ this.rules.other.listItemRegex(r), i = false;
            for(; n;){
                let a = false, c = "", h = "";
...
`, 1)[0], m = !f.trim(), k = 0;
                if (this.options.pedantic ? (k = 2, h = /*#__PURE__*/ f.trimStart()) : m ? k = e[1].length + 1 : (k = /*#__PURE__*/ e[2].search(this.rules.other.nonSpaceChar), k = k > 4 ? 1 : k, h = /*#__PURE__*/ f.slice(k), k += e[1].length), m && this.rules.other.blankLine.test(u) && (c += u + `
`, n = /*#__PURE__*/ n.substring(u.length + 1), a = true), !a) {
...
` + v.slice(k);
                            ...
                            if (m || f.replace(this.rules.other.tabCharGlobal, "    ").search(this.rules.other.nonSpaceChar) >= 4 || S.test(f) || y.test(f) || M.test(f)) break;
                            h += `
` + u;
                        }
                        !m && !u.trim() && (m = true), c += U + `
`, n = /*#__PURE__*/ n.substring(U.length + 1), f = /*#__PURE__*/ v.slice(k);
            ...
            for(let a = 0; a < t.items.length; a++)if (this.lexer.state.top = false, t.items[a].tokens = /*#__PURE__*/ this.lexer.blockTokens(t.items[a].text, []), !t.loose) {
                let c = /*#__PURE__*/ t.items[a].tokens.filter((f)=>f.type === "space"), h = c.length > 0 && c.some((f)=>this.rules.other.anyLine.test(f.raw));
                t.loose = h;
            }
...
` ? e[1].slice(0, -1) : e[1];
    ...
    emStrong(n, e, r = "") {
        ...
        if (!(!s || s[3] && r.match(this.rules.other.unicodeAlphaNumeric)) && (!(s[1] || s[2]) || !r || this.rules.inline.punctuation.exec(r))) {
            let t = [
                ...s[0]
            ].length - 1, l, i, o = t, a = 0, c = s[0][0] === "*" ? this.rules.inline.emStrongRDelimAst : this.rules.inline.emStrongRDelimUnd;
            for(c.lastIndex = 0, e = /*#__PURE__*/ e.slice(-1 * n.length + t); (s = /*#__PURE__*/ c.exec(e)) != null;){
                ...
                let h = [
                    ...s[0]
                ][0].length, f = /*#__PURE__*/ n.slice(0, t + s.index + h + i);
                if (Math.min(t, i) % 2) {
                    let m = /*#__PURE__*/ f.slice(1, -1);
                    return {
                        type: "em",
                        raw: f,
                        text: m,
...
`), this.blockTokens(e, this.tokens);
    ...
    blockTokens(e, r = [], s = false) {
        for(this.options.pedantic && (e = /*#__PURE__*/ e.replace(w.tabCharGlobal, "    ").replace(w.spaceLine, "")); e;){
            let t;
            if (this.options.extensions?.block?.some((i)=>(t = /*#__PURE__*/ i.call({
                    lexer: this
                }, e, r)) ? (e = /*#__PURE__*/ e.substring(t.raw.length), r.push(t), true) : false)) continue;
...
` + t.raw, this.inlineQueue.at(-1).src = i.text) : this.tokens.links[t.tag] || (this.tokens.links[t.tag] = {
            ...
            if (this.options.extensions?.startBlock) {
                let i = 1 / 0, o = /*#__PURE__*/ e.slice(1), a;
                this.options.extensions.startBlock.forEach((c)=>{
                    a = /*#__PURE__*/ c.call({
                        lexer: this
                    }, o), typeof a == "number" && a >= 0 && (i = /*#__PURE__*/ Math.min(i, a));
                }), i < 1 / 0 && i >= 0 && (l = /*#__PURE__*/ e.substring(0, i + 1));
            }
...
` + t.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = i.text) : r.push(t);
    ...
    inlineTokens(e, r = []) {
        ...
        for(; e;){
            l || (i = ""), l = false;
            let o;
            if (this.options.extensions?.inline?.some((c)=>(o = /*#__PURE__*/ c.call({
                    lexer: this
                }, e, r)) ? (e = /*#__PURE__*/ e.substring(o.raw.length), r.push(o), true) : false)) continue;
            ...
            if (this.options.extensions?.startInline) {
                let c = 1 / 0, h = /*#__PURE__*/ e.slice(1), f;
                this.options.extensions.startInline.forEach((u)=>{
                    f = /*#__PURE__*/ u.call({
                        lexer: this
                    }, h), typeof f == "number" && f >= 0 && (c = /*#__PURE__*/ Math.min(c, f));
                }), c < 1 / 0 && c >= 0 && (a = /*#__PURE__*/ e.substring(0, c + 1));
            }
            if (o = /*#__PURE__*/ this.tokenizer.inlineText(a)) {
                e = /*#__PURE__*/ e.substring(o.raw.length), o.raw.slice(-1) !== "_" && (i = /*#__PURE__*/ o.raw.slice(-1)), l = true;
                let c = /*#__PURE__*/ r.at(-1);
...
`;
    ...
    listitem(n) {
        let e = "";
        if (n.task) {
            let r = /*#__PURE__*/ this.checkbox({
                checked: !!n.checked
            });
            n.loose ? n.tokens[0]?.type === "paragraph" ? (n.tokens[0].text = r + " " + n.tokens[0].text, n.tokens[0].tokens && n.tokens[0].tokens.length > 0 && n.tokens[0].tokens[0].type === "text" && (n.tokens[0].tokens[0].text = r + " " + T(n.tokens[0].tokens[0].text), n.tokens[0].tokens[0].escaped = true)) : n.tokens.unshift({
                type: "text",
                raw: r + " ",
                text: r + " ",
                escaped: true
    ...
    parse(e, r = true) {
        ...
        for(let t = 0; t < e.length; t++){
            ...
            if (this.options.extensions?.renderers?.[l.type]) {
                let o = l, a = /*#__PURE__*/ this.options.extensions.renderers[o.type].call({
                    parser: this
                }, o);
                if (a !== false || ![
                    "space",
...
` + this.renderer.text(o);
    ...
    parseInline(e, r = this.renderer) {
        ...
        for(let t = 0; t < e.length; t++){
            let l = e[t];
            if (this.options.extensions?.renderers?.[l.type]) {
                let o = /*#__PURE__*/ this.options.extensions.renderers[l.type].call({
                    parser: this
                }, l);
                if (o !== false || ![
                    "escape",
            ...
            if (s.async = this.defaults.async || s.async || false, r.extensions && (r.extensions.forEach((t)=>{
                ...
                if ("renderer" in t) {
                    ...
                    l ? e.renderers[t.name] = function(...i) {
                        ...
                        return o === false && (o = /*#__PURE__*/ l.apply(this, i)), o;
                    } : e.renderers[t.name] = t.renderer;
                }
                if ("tokenizer" in t) {
                    if (!t.level || t.level !== "block" && t.level !== "inline") throw new Error("extension level must be 'block' or 'inline'");
                    let l = e[t.level];
                    l ? l.unshift(t.tokenizer) : e[t.level] = [
                        t.tokenizer
                    ], t.start && (t.level === "block" ? e.startBlock ? e.startBlock.push(t.start) : e.startBlock = [
                        t.start
                    ] : t.level === "inline" && (e.startInline ? e.startInline.push(t.start) : e.startInline = [
                        t.start
                    ]));
                }
                ...
                for(let l in r.renderer){
                    ...
                    t[i] = (...c)=>{
                        ...
                        return h === false && (h = /*#__PURE__*/ a.apply(t, c)), h || "";
                    };
                }
                s.renderer = t;
            }
...
function Ke(n, e = {}) {
    let r = /*#__PURE__*/ Qt(n, e), s = /*#__PURE__*/ g.lexer(r), t = [
        []
    ], l = 0;
...
function Kt(n) {
    return Intl.Segmenter ? [
        .../*#__PURE__*/ new Intl.Segmenter().segment(n)
    ].map((e)=>e.segment) : [
        ...n
    ];
}
...
m$1(et, "applyStyle");
async function Jt(n, e, r, s, t = false, l = Ot$1()) {
...
`), l) : ot$1(e.label, l), c = e.isNode ? "nodeLabel" : "edgeLabel", h = /*#__PURE__*/ o.append("span");
...
function en(n, e, r, s = false) {
    ...
    for (let c of r){
        let h = /*#__PURE__*/ m$1((u)=>Yt(l, 1.1, u) <= n, "checkWidth"), f = h(c) ? [
            c
        ] : Ye(c, h);
        for (let u of f){
            let m = /*#__PURE__*/ xe(o, a, 1.1);
            be(m, u), a++;
        }
    }
    if (s) {
...
async function tn(n, e = {}) {
    ...
    n.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (t, l, i)=>(r.push(/*#__PURE__*/ (async ()=>{
            let o = `${l}:${i}`;
            return await Me(o) ? await ve(o, void 0, {
                class: "label-icon"
            }) : `<i class='${ot$1(t, e).replace(":", " ")}'></i>`;
        })()), t));
    let s = await Promise.all(r);
    return n.replace(/(fa[bklrs]?):fa-([\w-]+)/g, ()=>s.shift() ?? "");
}
m$1(tn, "replaceIconSubstring");
var Rr = /*#__PURE__*/ m$1(async (n, e = "", { style: r = "", isTitle: s = false, classes: t = "", useHtmlLabels: l = true, isNode: i = true, width: o = 200, addSvgBackground: a = false } = {}, c)=>{
    if (pt$1.debug("XYZ createText", e, r, s, t, l, i, "addSvgBackground: ", a), l) {
        let h = /*#__PURE__*/ Xe(e, c), f = await tn(/*#__PURE__*/ Yt$1(h), c), u = /*#__PURE__*/ e.replace(/\\\\/g, "\\"), m = {
            isNode: i,
            label: nr(e) ? u : f,
            labelStyle: /*#__PURE__*/ r.replace("fill:", "color:")
        };
        return await Jt(n, m, o, t, a, c);
    } else {
        let h = /*#__PURE__*/ e.replace(/<br\s*\/?>/g, "<br/>"), f = /*#__PURE__*/ Ke(/*#__PURE__*/ h.replace("<br>", "<br/>"), c), u = /*#__PURE__*/ en(o, n, f, e ? a : false);
        if (i) {
            /stroke:/.exec(r) && (r = /*#__PURE__*/ r.replace("stroke:", "lineColor:"));
            let m = /*#__PURE__*/ r.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
            ia(u).attr("style", m);
        } else {
            let m = /*#__PURE__*/ r.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/background:/g, "fill:");
            ia(u).select("rect").attr("style", /*#__PURE__*/ m.replace(/background:/g, "fill:"));
...
export { $r as $, Ce as C, Hn as H, Rr as R, tn as t, ut as u, ve as v };
