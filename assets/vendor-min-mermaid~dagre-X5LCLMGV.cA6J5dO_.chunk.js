...
import { W as sn, o as Jr, w as _f } from "./vendor-min-mermaid~chunk-OMTJKCYW.DapDh1DZ.chunk.js";
import { q as pt } from "./vendor-min-mermaid~chunk-63GW7ZVL.JXMkVvO5.chunk.js";
import { U as mr } from "./vendor-min-mermaid~chunk-KXVH62NG.DXOHBXLD.chunk.js";
...
import { c as Td, d as xa, i as Gd, l as ba, n as D, o as Rd, r as Ed } from "./vendor-min-mermaid~chunk-EQI6KKA3.DKxGc_Rn.chunk.js";
import { a as pr, i as kr, n as dr, r as fr, t as cr } from "./vendor-min-mermaid~chunk-TVVDRG3C.tqzZ9l_C.chunk.js";
import { t as fn } from "./vendor-min-mermaid~chunk-CCU7O4O5.yiCBVM4x.chunk.js";
function h(e) {
	var t = {
		options: {
...
function re(e) {
	return Jr(/* @__PURE__ */ e.nodes(), function(t) {
		var n$1 = /* @__PURE__ */ e.node(t), c = /* @__PURE__ */ e.parent(t), s = { v: t };
		return sn(n$1) || (s.value = n$1), sn(c) || (s.parent = c), s;
	});
}
m$1(re, "writeNodes");
function se(e) {
	return Jr(/* @__PURE__ */ e.edges(), function(t) {
		var n$1 = /* @__PURE__ */ e.edge(t), c = {
			v: t.v,
			w: t.w
		};
		return sn(t.name) || (c.name = t.name), sn(n$1) || (c.value = n$1), c;
	});
}
m$1(se, "writeEdges");
var a = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ m$1(() => {
	...
	let n$1 = v.get(t) || [];
	return pt.trace("In isDescendant", t, " ", e, " = ", /* @__PURE__ */ n$1.includes(e)), n$1.includes(e);
}, "isDescendant"), ce = /* @__PURE__ */ m$1((e, t) => {
	let n$1 = v.get(t) || [];
	return pt.info("Descendants of ", t, " is ", n$1), pt.info("Edge is ", e), e.v === t || e.w === t ? !1 : n$1 ? n$1.includes(e.v) || J(e.v, t) || J(e.w, t) || n$1.includes(e.w) : (pt.debug("Tilt, ", t, ",not in descendants"), !1);
}, "edgeInCluster"), $ = m$1((e, t, n$1, c) => {
	...
	e !== c && s.push(e), pt.warn("Copying (nodes) clusterId", e, "nodes", s), s.forEach((o) => {
		if (t.children(o).length > 0) $(o, t, n$1, c);
		else {
			let l = /* @__PURE__ */ t.node(o);
			pt.info("cp ", o, " to ", c, " with parent ", e), n$1.setNode(o, l), c !== t.parent(o) && (pt.warn("Setting parent", o, /* @__PURE__ */ t.parent(o)), n$1.setParent(o, /* @__PURE__ */ t.parent(o))), e !== c && o !== e ? (pt.debug("Setting parent", o, e), n$1.setParent(o, e)) : (pt.info("In copy ", e, "root", c, "data", /* @__PURE__ */ t.node(e), c), pt.debug("Not Setting parent for node=", o, "cluster!==rootId", e !== c, "node!==clusterId", o !== e));
			let u = /* @__PURE__ */ t.edges(o);
			pt.debug("Copying Edges", u), u.forEach((d) => {
				pt.info("Edge", d);
				let m$2 = /* @__PURE__ */ t.edge(d.v, d.w, d.name);
				pt.info("Edge data", m$2, c);
				try {
					ce(d, c) ? (pt.info("Copying as ", d.v, d.w, m$2, d.name), n$1.setEdge(d.v, d.w, m$2, d.name), pt.info("newGraph edges ", /* @__PURE__ */ n$1.edges(), /* @__PURE__ */ n$1.edge(n$1.edges()[0]))) : pt.info("Skipping copy of edge ", d.v, "-->", d.w, " rootId: ", c, " clusterId:", e);
				} catch (p) {
					pt.error(p);
				}
			});
	...
	let n$1 = /* @__PURE__ */ t.children(e), c = [...n$1];
	for (let s of n$1) W.set(s, e), c = [...c, .../* @__PURE__ */ L(s, t)];
	return c;
}, "extractDescendants");
var ae = /* @__PURE__ */ m$1((e, t, n$1) => {
	let c = /* @__PURE__ */ e.edges().filter((d) => d.v === t || d.w === t), s = /* @__PURE__ */ e.edges().filter((d) => d.v === n$1 || d.w === n$1), o = /* @__PURE__ */ c.map((d) => ({
		v: d.v === t ? n$1 : d.v,
		w: d.w === t ? t : d.w
	})), l = /* @__PURE__ */ s.map((d) => ({
		v: d.v,
	...
	return o.filter((d) => l.some((m$2) => d.v === m$2.v && d.w === m$2.w));
}, "findCommonEdges"), x = m$1((e, t, n$1) => {
	let c = /* @__PURE__ */ t.children(e);
	if (pt.trace("Searching children of id ", e, c), c.length < 1) return e;
	let s;
	for (let o of c) {
		let l = /* @__PURE__ */ x(o, t, n$1), u = /* @__PURE__ */ ae(t, n$1, l);
	...
	e.nodes().forEach(function(n$1) {
		e.children(n$1).length > 0 && (pt.warn("Cluster identified", n$1, " Replacement id in edges: ", /* @__PURE__ */ x(n$1, e, n$1)), v.set(n$1, /* @__PURE__ */ L(n$1, e)), a.set(n$1, {
			id: /* @__PURE__ */ x(n$1, e, n$1),
			clusterData: /* @__PURE__ */ e.node(n$1)
		}));
	}), e.nodes().forEach(function(n$1) {
		let c = /* @__PURE__ */ e.children(n$1), s = /* @__PURE__ */ e.edges();
		c.length > 0 ? (pt.debug("Cluster identified", n$1, v), s.forEach((o) => {
			J(o.v, n$1) ^ J(o.w, n$1) && (pt.warn("Edge: ", o, " leaves cluster ", n$1), pt.warn("Descendants of XXX ", n$1, ": ", /* @__PURE__ */ v.get(n$1)), a.get(n$1).externalConnections = !0);
		})) : pt.debug("Not a cluster ", n$1, v);
	});
	for (let n$1 of a.keys()) {
		let c = a.get(n$1).id, s = /* @__PURE__ */ e.parent(c);
		s !== n$1 && a.has(s) && !a.get(s).externalConnections && (a.get(n$1).id = s);
	}
	e.edges().forEach(function(n$1) {
		let c = /* @__PURE__ */ e.edge(n$1);
		pt.warn("Edge " + n$1.v + " -> " + n$1.w + ": " + JSON.stringify(n$1)), pt.warn("Edge " + n$1.v + " -> " + n$1.w + ": " + JSON.stringify(/* @__PURE__ */ e.edge(n$1)));
		let s = n$1.v, o = n$1.w;
		if (pt.warn("Fix XXX", a, "ids:", n$1.v, n$1.w, "Translating: ", /* @__PURE__ */ a.get(n$1.v), " --- ", /* @__PURE__ */ a.get(n$1.w)), a.get(n$1.v) || a.get(n$1.w)) {
			if (pt.warn("Fixing and trying - removing XXX", n$1.v, n$1.w, n$1.name), s = /* @__PURE__ */ Q(n$1.v), o = /* @__PURE__ */ Q(n$1.w), e.removeEdge(n$1.v, n$1.w, n$1.name), s !== n$1.v) {
				let l = /* @__PURE__ */ e.parent(s);
				a.get(l).externalConnections = !0, c.fromCluster = n$1.v;
			}
			if (o !== n$1.w) {
				let l = /* @__PURE__ */ e.parent(o);
				a.get(l).externalConnections = !0, c.toCluster = n$1.w;
			}
			pt.warn("Fix Replacing with XXX", s, o, n$1.name), e.setEdge(s, o, c, n$1.name);
		}
	...
	let n$1 = /* @__PURE__ */ e.nodes(), c = !1;
	for (let s of n$1) c = c || (/* @__PURE__ */ e.children(s)).length > 0;
	if (!c) {
		pt.debug("Done, no node has children", /* @__PURE__ */ e.nodes());
		return;
	}
	pt.debug("Nodes = ", n$1, t);
	for (let s of n$1) if (pt.debug("Extracting node", s, a, a.has(s) && !a.get(s).externalConnections, !e.parent(s), /* @__PURE__ */ e.node(s), /* @__PURE__ */ e.children("D"), " Depth ", t), !a.has(s)) pt.debug("Not a cluster", s, t);
	...
	n$1 = /* @__PURE__ */ e.nodes(), pt.warn("New list of nodes", n$1);
	for (let s of n$1) {
	...
	let n$1 = /* @__PURE__ */ Object.assign([], t);
	return t.forEach((c) => {
		let o = /* @__PURE__ */ ne(e, /* @__PURE__ */ e.children(c));
		n$1 = [...n$1, ...o];
	}), n$1;
...
var ie = m$1(async (e, t, n$1, c, s, o) => {
	...
	let d = /* @__PURE__ */ u.insert("g").attr("class", "clusters"), m$2 = /* @__PURE__ */ u.insert("g").attr("class", "edgePaths"), p = /* @__PURE__ */ u.insert("g").attr("class", "edgeLabels"), b = /* @__PURE__ */ u.insert("g").attr("class", "nodes");
...
Parent cluster`, s.height), t.setNode(s.id, w), t.parent(f) || (pt.trace("Setting parent", f, s.id), t.setParent(f, s.id, w));
	...
	return await Promise.all(/* @__PURE__ */ te(t).map(async function(f) {
		...
		pt.info("Edge " + f.v + " -> " + f.w + ": " + JSON.stringify(r), r), r.points.forEach((D$1) => D$1.y += S / 2);
		dr(r, /* @__PURE__ */ fr(m$2, r, a, n$1, /* @__PURE__ */ t.node(f.v), /* @__PURE__ */ t.node(f.w), c));
	...
	kr(c, e.markers, e.type, e.diagramId), Gd(), cr(), ba(), Z(), e.nodes.forEach((o) => {
		n$1.setNode(o.id, { ...o }), o.parentId && n$1.setParent(o.id, o.parentId);
	}), pt.debug("Edges:", e.edges), e.edges.forEach((o) => {
		if (o.start === o.end) {
			let l = o.start, u = l + "---" + l + "---1", d = l + "---" + l + "---2", m$2 = /* @__PURE__ */ n$1.node(l);
			n$1.setNode(u, {
				domId: u,
				id: u,
				parentId: m$2.parentId,
				labelStyle: "",
				label: "",
				padding: 0,
				shape: "labelRect",
				...
				width: 10,
				height: 10
			}), n$1.setParent(u, m$2.parentId), n$1.setNode(d, {
				domId: d,
				id: d,
				parentId: m$2.parentId,
				labelStyle: "",
				...
				width: 10,
				height: 10
			}), n$1.setParent(d, m$2.parentId);
			let p = /* @__PURE__ */ structuredClone(o), b = /* @__PURE__ */ structuredClone(o), X = /* @__PURE__ */ structuredClone(o);
			p.label = "", p.arrowTypeEnd = "none", p.id = l + "-cyclic-special-1", b.arrowTypeStart = "none", b.arrowTypeEnd = "none", b.id = l + "-cyclic-special-mid", X.label = "", m$2.isGroup && (p.fromCluster = l, X.toCluster = l), X.id = l + "-cyclic-special-2", X.arrowTypeStart = "none", n$1.setEdge(l, u, p, l + "-cyclic-special-0"), n$1.setEdge(u, d, b, l + "-cyclic-special-1"), n$1.setEdge(d, l, X, l + "-cyc<lic-special-2");
		} else n$1.setEdge(o.start, o.end, { ...o }, o.id);
	}), pt.warn("Graph at first:", /* @__PURE__ */ JSON.stringify(/* @__PURE__ */ h(n$1))), I(n$1), pt.warn("Graph after XAX:", /* @__PURE__ */ JSON.stringify(/* @__PURE__ */ h(n$1)));
	let s = /* @__PURE__ */ mr();
	await ie(c, n$1, e.type, e.diagramId, void 0, s);
}, "render");
export { Se as t };
