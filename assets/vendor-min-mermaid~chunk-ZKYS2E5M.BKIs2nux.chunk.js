const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-min-mermaid~katex-SWYD7GD6.DOr13hih.chunk.js","assets/vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js"])))=>i.map(i=>d[i]);
...
var Nl = /*#__PURE__*/ m$1((t)=>(af(), er.sanitize(t)), "removeScript"), Il = /*#__PURE__*/ m$1((t, e)=>{
    ...
    let { default: r } = await __vitePreload(async ()=>{
        const { default: r } = await import('./vendor-min-mermaid~katex-SWYD7GD6.DOr13hih.chunk.js');
        return {
            default: r
        };
