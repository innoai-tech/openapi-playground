...
var _a, __;
import { w as w$1, $ } from "./vendor-min-mermaid~chunk-IO347I67.jAXjFTQY.chunk.js";
import { S } from "./vendor-min-mermaid~chunk-L736DJ4U.CrZlOsoh.chunk.js";
import { I as Ie, C as Ce } from "./vendor-min-mermaid~chunk-YM3XIQPS.DzKxOkHI.chunk.js";
import { t as tt, H as Hl, g as gC, S as Sf, w as wf, v as vf, F as Ff, B as Bf, M as Mf, L as Lf } from "./vendor-min-mermaid~chunk-ZKYS2E5M.DYmB7G2x.chunk.js";
  ...
  var t = m$1(function(G, o, h, n) {
    ...
    parse: m$1(function(o) {
      var h = this, n = [
        ...
        null
      ], i = [], K = this.table, u = "", F = 0, U = 0, J = 0, at = 2, ot = 1, Ce2 = i.slice.call(arguments, 1), k = Object.create(this.lexer), B = {
        yy: {}
      };
      ...
      for (var D, bt, M, C, He, kt, H = {}, ct, R, Vt, lt; ; ) {
        if (M = n[n.length - 1], this.defaultActions[M] ? C = this.defaultActions[M] : ((D === null || typeof D > "u") && (D = Ie2()), C = K[M] && K[M][D]), typeof C > "u" || !C.length || !C[0]) {
          var Dt = "";
          lt = [];
...
var Yt = m$1(function(t) {
  ...
  let T = 8;
  Ie.insertTitle(p, "statediagramTitleText", (f == null ? void 0 : f.titleTopMargin) ?? 25, a.db.getDiagramTitle()), $(p, T, z, (f == null ? void 0 : f.useMaxWidth) ?? true);
}, "draw"), ss = {
  getClasses: Ge,
  draw: we,
  getDir: Yt
...
var W = m$1((t, e, s, a, c, f, r, d) => {
  ...
  if (tt.info("dataFetcher parsedItem", e, T, b), p !== "root") {
    ...
    e.description && (Array.isArray(S2.description) ? (S2.shape = pt, S2.description.push(e.description)) : ((_a2 = S2.description) == null ? void 0 : _a2.length) > 0 ? (S2.shape = pt, S2.description === p ? S2.description = [
      ...
      S2.description,
      e.description
    ]) : (S2.shape = dt, S2.description = e.description), S2.description = gC.sanitizeTextOrArray(S2.description, Hl())), ((_b = S2.description) == null ? void 0 : _b.length) === 1 && S2.shape === pt && (S2.type === "group" ? S2.shape = Nt : S2.shape = dt), !S2.type && e.doc && (tt.info("Setting cluster for XCX", p, ye(e)), S2.type = "group", S2.isGroup = true, S2.dir = ye(e), S2.shape = e.type === ut ? Ot : Nt, S2.cssClasses = `${S2.cssClasses} ${de} ${f ? pe : ""}`);
    let L = {
      labelStyle: "",
      shape: S2.shape,
...
var De = m$1(() => ({
  ...
  documents: {}
}), "newDoc"), Tt = m$1((t) => JSON.parse(JSON.stringify(t)), "clone"), xe = (_a = class {
  constructor(e) {
