...
var je = (_b = class {
  ...
  join() {
    ...
    do
      i = /* @__PURE__ */ t.next(), i.done || (s && (n2 += e), n2 += /* @__PURE__ */ Th(i.value)), s = true;
    while (!i.done);
    return n2;
  }
  indexOf(e) {
...
function kh(r, e) {
  let t = /* @__PURE__ */ Kc(r), n2 = /* @__PURE__ */ Kc(e), i;
...
function Mo(r, e) {
  ...
  for (let i of t.properties) i.defaultValue !== void 0 && n2[i.name] === void 0 && (n2[i.name] = /* @__PURE__ */ Yc(i.defaultValue));
}
...
function bo(r, e) {
  ...
  for (let [n2, i] of Object.entries(r)) if (!n2.startsWith("$")) if (le(i)) t[n2] = /* @__PURE__ */ bo(i, e);
  else if (Ee(i)) t[n2] = /* @__PURE__ */ e(t, n2, i.$refNode, i.$refText);
  else if (Array.isArray(i)) {
    let s = [];
    for (let o2 of i) le(o2) ? s.push(/* @__PURE__ */ bo(o2, e)) : Ee(o2) ? s.push(/* @__PURE__ */ e(t, n2, o2.$refNode, o2.$refText)) : s.push(o2);
    t[n2] = s;
  } else t[n2] = i;
  return Ds(t), t;
}
  ...
  characterClass() {
    ...
    for (this.consumeChar("["), this.peekChar(0) === "^" && (this.consumeChar("^"), t = true); this.isClassAtom(); ) {
      ...
      if (Do(n2) && this.isRangeDash()) {
        ...
        } else Gs(n2.value, e), e.push(/* @__PURE__ */ _("-")), Gs(s.value, e);
      } else Gs(n2.value, e);
    }
    return this.consumeChar("]"), {
      type: "Set",
...
function Vo(r, e) {
  let t = /* @__PURE__ */ Zc(r), n2 = /* @__PURE__ */ e.match(t);
...
function mi(r, e) {
  let t = /* @__PURE__ */ new Set(), n2 = /* @__PURE__ */ eu(r);
...
function gi(r, e, t) {
  if (!r || !e) return;
  let n2 = /* @__PURE__ */ Xo(r, e, r.astNode, true);
...
function Yo(r, e, t) {
  if (!r) return;
  let n2 = /* @__PURE__ */ Jo(r, e, r == null ? void 0 : r.astNode);
  if (n2.length !== 0) return t !== void 0 ? t = /* @__PURE__ */ Math.max(0, /* @__PURE__ */ Math.min(t, n2.length - 1)) : t = 0, n2[t];
}
...
function nu(r, e, t) {
  ...
  function i(s, o2) {
    let l;
    return ir(s, rt) || (l = /* @__PURE__ */ nu(o2, o2, t)), t.set(r, l), l;
  }
...
function tl(r) {
  let e = [], t = r.Grammar;
  for (let n2 of t.rules) He(n2) && zo(n2) && Bo(/* @__PURE__ */ Tn(n2)) && e.push(n2.name);
  return {
...
var il = (_v = class extends Nt {
  ...
  walkProdRef(e, t, n2) {
    let i = op(e.referencedRule, e.idx) + this.topProd.name, s = /* @__PURE__ */ t.concat(n2), o2 = new J({
      definition: s
    }), l = /* @__PURE__ */ ur(o2);
    this.follows[i] = l;
  }
...
function lu(r) {
  let e = {};
  return Zr$1(r, (t) => {
    let n2 = /* @__PURE__ */ new il(t).startWalking();
    fi$1(e, n2);
  }), e;
}
...
function qs(r, e) {
  if (e instanceof RegExp) {
    let t = /* @__PURE__ */ An(e), n2 = new ol(r);
...
`
  ...
  t("Line Terminator Handling", () => {
    ...
    f = /* @__PURE__ */ Jr$1(n2, (x) => false), e.positionTracking !== "onlyOffset" && (f = /* @__PURE__ */ Jr$1(n2, (x) => fm$1(x, "LINE_BREAKS") ? !!x.LINE_BREAKS : Au(x, A) === false && qs(A, x.PATTERN)));
  });
  let h2, p2, g, y;
  t("Misc Mapping #2", () => {
    h2 = /* @__PURE__ */ Jr$1(n2, Ru), p2 = /* @__PURE__ */ Jr$1(s, Ip), g = /* @__PURE__ */ Rn$1(n2, (A, x) => {
      let P = x.GROUP;
...
function gu(r, e) {
  let t = [], n2 = /* @__PURE__ */ dp(r);
  t = /* @__PURE__ */ t.concat(n2.errors);
  let i = /* @__PURE__ */ fp(n2.valid), s = i.valid;
...
function Tu(r, e, t) {
  let n2 = [], i = false, s = /* @__PURE__ */ Ai$1(/* @__PURE__ */ Qr$1(/* @__PURE__ */ Xr$1(r.modes))), o2 = /* @__PURE__ */ Qm(s, (c) => c[dr] === se.NA), l = /* @__PURE__ */ vu(t);
  return e && Zr$1(o2, (c) => {
      ...
      if (Zr$1(i.modes, (l, c) => {
        this.TRACE_INIT(`Mode: <${c}> processing`, () => {
          if (this.modes.push(c), this.config.skipValidations === false && this.TRACE_INIT("validatePatterns", () => {
            this.lexerDefinitionErrors = /* @__PURE__ */ this.lexerDefinitionErrors.concat(/* @__PURE__ */ gu(l, o2));
...
` + i);
  ...
  tokenizeInternal(e, t) {
    let n2, i, s, o2, l, c, u, d, f, h2, p2, g, y, R, A, x = e, P = x.length, b = 0, Te = 0, kr2 = this.hasCustom ? 0 : Math.floor(e.length / 10), Ae = new Array(kr2), Mt = [], yt = this.trackStartLines ? 1 : void 0, k = this.trackStartLines ? 1 : void 0, T2 = /* @__PURE__ */ xu(this.emptyGroups), C = this.trackStartLines, S = this.config.lineTerminatorsPattern, K = 0, O = [], L = [], Le = [], Oe = [];
    Object.freeze(Oe);
    let ee;
    function Ht() {
      return O;
    ...
    for (; b < P; ) {
      ...
      for (n2 = 0; n2 < Ir; n2++) {
        ...
        u = null;
        let Tt = Ze.short;
        if (Tt !== false ? ve === Tt && (c = Ve) : Ze.isCustom === true ? (A = /* @__PURE__ */ Ve.exec(x, b, Ae, T2), A !== null ? (c = A[0], A.payload !== void 0 && (u = A.payload)) : c = null) : (this.updateLastIndex(Ve, b), c = /* @__PURE__ */ this.match(Ve, e, b)), c !== null) {
      ...
      if (c !== null) {
        if (f = c.length, h2 = Ze.group, h2 !== void 0 && (p2 = Ze.tokenTypeIdx, g = /* @__PURE__ */ this.createTokenInstance(c, b, p2, Ze.tokenType, yt, k, f), this.handlePayload(g, u), h2 === false ? Te = /* @__PURE__ */ this.addToken(Ae, Te, g) : T2[h2].push(g)), e = /* @__PURE__ */ this.chopInput(e, f), b = b + f, k = /* @__PURE__ */ this.computeNewColumn(k, f), C === true && Ze.canLineTerminator === true) {
          ...
          S.lastIndex = 0;
          do
            Tt = /* @__PURE__ */ S.test(c), Tt === true && (Dt = S.lastIndex - 1, Ve++);
          while (Tt === true);
...
but found: '` + De$1(e).image + "'";
    if (n2) return s + n2 + l;
    {
      let c = /* @__PURE__ */ Rn$1(r, (h2, p2) => h2.concat(p2), []), u = /* @__PURE__ */ Jr$1(c, (h2) => `[${Jr$1(h2, (p2) => $t(p2)).join(", ")}]`), f = `one of these possible Token sequences:
...
For Further details.`;
  ...
  buildAlternationAmbiguityError(r) {
    let e = /* @__PURE__ */ Jr$1(r.prefixPath, (i) => $t(i)).join(", "), t = r.alternation.idx === 0 ? "" : r.alternation.idx, n2 = `Ambiguous Alternatives Detected: <${r.ambiguityIndices.join(" ,")}> in <OR${t}> inside <${r.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
...
function Uu(r, e, t, n2, i, s) {
  let o2 = /* @__PURE__ */ Cn(r, e, t), l = Hu(o2) ? In : St;
  return s(o2, n2, l, i);
}
m$1(Uu, "buildLookaheadFuncForOr");
function Bu(r, e, t, n2, i, s) {
  let o2 = /* @__PURE__ */ $n(r, e, i, t), l = Hu(o2) ? In : St;
  return s(o2[0], l, n2);
}
...
function Ku(r, e) {
  let t = /* @__PURE__ */ Jr$1(r, (o2) => ea([
    o2
  ], 1)), n2 = /* @__PURE__ */ Gu(t.length), i = /* @__PURE__ */ Jr$1(t, (o2) => {
    let l = {};
    return Zr$1(o2, (c) => {
  ...
  for (let o2 = 1; o2 <= e; o2++) {
    ...
    for (let c = 0; c < l.length; c++) {
      ...
      for (let d = 0; d < u.length; d++) {
        let f = u[d].partialPath, h2 = u[d].suffixDef, p2 = /* @__PURE__ */ pl(f);
...
function qu(r, e, t, n2) {
  let i = /* @__PURE__ */ zi$1(r, (c) => Fp(c, t)), s = /* @__PURE__ */ Kp(r, e, t), o2 = /* @__PURE__ */ zi$1(r, (c) => Bp(c, t)), l = /* @__PURE__ */ zi$1(r, (c) => Up(c, r, n2, t));
...
function Fp(r, e) {
  let t = new gl();
  r.accept(t);
  let n2 = t.allProductions, i = /* @__PURE__ */ Vi$1(n2, Gp), s = /* @__PURE__ */ Tm$1(i, (l) => l.length > 1);
...
function Qu(r, e, t) {
  ...
  return i = /* @__PURE__ */ Qm(i, (o2) => o2.ignoreAmbiguities === true), zi$1(i, (o2) => {
    let l = o2.idx, c = o2.maxLookahead || e, u = /* @__PURE__ */ Cn(l, r, c, o2), d = /* @__PURE__ */ Wp(u, o2, r, t), f = /* @__PURE__ */ Vp(u, o2, r, t);
    return d.concat(f);
  });
}
...
function Zu(r, e, t) {
  ...
  return Zr$1(r, (i) => {
    ...
    Zr$1(o2, (l) => {
      let c = /* @__PURE__ */ Si(l), u = l.maxLookahead || e, d = l.idx, h2 = $n(d, i, c, u)[0];
...
function Vp(r, e, t, n2) {
  ...
  return Ai$1(/* @__PURE__ */ zi$1(i, (o2) => {
    ...
    let c = o2.idx, u = o2.path, d = /* @__PURE__ */ fn$1(i, (h2) => e.definition[h2.idx].ignoreAmbiguities !== true && h2.idx < c && ju(h2.path, u));
    return Jr$1(d, (h2) => {
      let p2 = [
        h2.idx + 1,
        c + 1
...
var Qp = {
 ...
 inside top level rule: <${this.recordingProdStack[0].name}>`);
    ...
    let i = /* @__PURE__ */ Df(this.recordingProdStack), s = e.ruleName, o2 = new H({
      idx: t,
      nonTerminalName: s,
...
function Oi(r, e, t) {
  ...
  Ra(t);
  let i = /* @__PURE__ */ Df(this.recordingProdStack), s = T(e) ? e : e.DEF, o2 = new r({
    definition: [],
    idx: t
  });
...
function Zp(r, e) {
  Ra(e);
  let t = /* @__PURE__ */ Df(this.recordingProdStack), n2 = N(r) === false, i = n2 === false ? r : r.DEF, s = new X({
    definition: [],
    idx: e,
...
function dm(r, e, t) {
  ...
  Kt(r, n2);
  let i = /* @__PURE__ */ Jr$1(t.definition, (o2) => Ed(r, e, o2));
...
m$1(fm, "option");
function pr(r, e, t) {
  let n2 = /* @__PURE__ */ fn$1(/* @__PURE__ */ Jr$1(t.definition, (i) => Ed(r, e, i)), (i) => i !== void 0);
...
function Mn(r, e, t, n2) {
  ...
  return r.decisionMap[hr(e, /* @__PURE__ */ pm(n2), n2.idx)] = t, o2;
}
m$1(Mn, "makeAlts");
function pm(r) {
...
var ka = (_ia = class {
  ...
  buildLookaheadForAlternation(e) {
    ...
    if (Id(f, false) && !s) {
      ...
      let h2 = /* @__PURE__ */ Ol.call(this, o2, d, kd, l);
...
function Rm(r) {
  ...
  for (let n2 = 0; n2 < e; n2++) t[n2] = /* @__PURE__ */ xm(r.decisionStates[n2], n2);
  return t;
}
...
function Am(r, e, t, n2, i, s) {
  let o2 = /* @__PURE__ */ Cm(e.configs, t, i);
  if (o2.size === 0) return Nd(r, e, t, Fi), Fi;
  let l = /* @__PURE__ */ Sd(o2), c = /* @__PURE__ */ _m(o2, i);
...
function vm(r, e, t, n2) {
  ...
  let s = r.atnStartState, o2 = s.rule, l = s.production, c = /* @__PURE__ */ km({
    topLevelRule: o2,
    ambiguityIndices: t,
    production: l,
    prefixPath: i
...
function km(r) {
  let e = /* @__PURE__ */ Jr$1(r.prefixPath, (i) => $t(i)).join(", "), t = r.production.idx === 0 ? "" : r.production.idx, n2 = `Ambiguous Alternatives Detected: <${r.ambiguityIndices.join(", ")}> in <${Im(r.production)}${t}> inside <${r.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
  return n2 = n2 + `See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES
For Further details.`, n2;
...
function Nm(r, e, t) {
  let n2 = /* @__PURE__ */ zi$1(e.configs.elements, (s) => s.state.transitions), i = /* @__PURE__ */ s0(/* @__PURE__ */ n2.filter((s) => s instanceof On).map((s) => s.tokenType), (s) => s.tokenTypeIdx);
  return {
    actualToken: t,
...
function Cm(r, e, t) {
  ...
  for (let o2 of r.elements) {
    ...
    for (let c = 0; c < l; c++) {
      let u = o2.state.transitions[c], d = /* @__PURE__ */ $m(u, e);
      d !== void 0 && n2.add({
        state: d,
        alt: o2.alt,
        stack: o2.stack
...
function Nd(r, e, t, n2) {
  return n2 = /* @__PURE__ */ Cd(r, n2), e.edges[t.tokenTypeIdx] = n2, n2;
}
m$1(Nd, "addDFAEdge");
function Cd(r, e) {
  if (e === Fi) return e;
...
function Ia(r, e) {
  ...
  for (let i = 0; i < n2; i++) {
    let s = t.transitions[i], o2 = /* @__PURE__ */ Lm(r, s);
    o2 !== void 0 && Ia(o2, e);
  }
}
m$1(Ia, "closure");
...
(function(r) {
  function e(n2, i, s, o2) {
    if (m.uinteger(n2) && m.uinteger(i) && m.uinteger(s) && m.uinteger(o2)) return {
      start: /* @__PURE__ */ W.create(n2, i),
      end: /* @__PURE__ */ W.create(s, o2)
    };
...
var wf = "​", Lf = /* @__PURE__ */ m$1((r) => r.endsWith(wf) ? r : r + wf, "withRuleSuffix"), Vi = (_ra = class {
  constructor(e) {
  ...
  rule(e, t) {
    let n2 = /* @__PURE__ */ this.computeRuleType(e), i = /* @__PURE__ */ this.wrapper.DEFINE_RULE(/* @__PURE__ */ Lf(e.name), /* @__PURE__ */ this.startImplementation(n2, t).bind(this));
  ...
  performSubruleAssignment(e, t, n2) {
    ...
    if (i) this.assign(i.operator, i.feature, e, n2, s);
      ...
      let o2 = this.current;
      if (Xl(o2)) o2.value += /* @__PURE__ */ e.toString();
  ...
  rule(e, t) {
    let n2 = /* @__PURE__ */ this.wrapper.DEFINE_RULE(/* @__PURE__ */ Lf(e.name), /* @__PURE__ */ this.startImplementation(t).bind(this));
...
m$1(Hi, "createParser");
function Um(r, e) {
  let t = /* @__PURE__ */ mi(e, false), n2 = /* @__PURE__ */ j(e.rules).filter($e).filter((i) => t.has(i));
  for (let i of n2) {
...
function yr(r, e) {
  ...
  let n2;
  if (Ye(e)) n2 = /* @__PURE__ */ zm(r, e);
  else if (kt(e)) n2 = /* @__PURE__ */ Bm(r, e);
  else if (rt(e)) n2 = /* @__PURE__ */ yr(r, e.terminal);
  else if (nr(e)) n2 = /* @__PURE__ */ Of(r, e);
  else if (nt(e)) n2 = /* @__PURE__ */ Wm(r, e);
  else if (Ps(e)) n2 = /* @__PURE__ */ Km(r, e);
  else if (Ms(e)) n2 = /* @__PURE__ */ jm(r, e);
  else if (Ut(e)) n2 = /* @__PURE__ */ Hm(r, e);
  else if (So(e)) {
    let i = r.consume++;
...
function Wm(r, e) {
  ...
  if ($e(t)) {
    ...
    return (o2) => r.parser.subrule(n2, /* @__PURE__ */ bf(r, t), i, e, /* @__PURE__ */ s(o2));
  } else if (He(t)) {
    let n2 = r.consume++, i = /* @__PURE__ */ Jl(r, t.name);
...
function Vm(r, e) {
  let t = /* @__PURE__ */ e.map((n2) => Ot(n2.value));
  return (n2) => {
    let i = {};
...
function Km(r, e) {
  if (e.elements.length === 1) return yr(r, e.elements[0]);
  {
    ...
    for (let i of e.elements) {
      ...
      o2 && (s.GATE = /* @__PURE__ */ Ot(o2)), t.push(s);
    }
    let n2 = r.or++;
...
function jm(r, e) {
  ...
  })), "alternatives"), o2 = /* @__PURE__ */ Pf(r, /* @__PURE__ */ Oa(e), s, "*");
  return (l) => {
...
function Of(r, e) {
  ...
  if (t) if (nt(t) && $e(t.rule.ref)) {
    ...
    return (s) => r.parser.subrule(i, /* @__PURE__ */ bf(r, n2), false, e, s);
  } else if (nt(t) && He(t.rule.ref)) {
    let n2 = r.consume++, i = /* @__PURE__ */ Jl(r, t.rule.ref.name);
    return () => r.parser.consume(n2, i, e);
  } else if (Ye(t)) {
    let n2 = r.consume++, i = /* @__PURE__ */ Jl(r, t.value);
    return () => r.parser.consume(n2, i, e);
...
m$1(Pf, "wrap");
function bf(r, e) {
  let t = /* @__PURE__ */ qm(r, e), n2 = /* @__PURE__ */ r.parser.getRule(t);
...
var Pt = (_xa = class {
  ...
  buildTokens(e, t) {
    let n2 = /* @__PURE__ */ j(/* @__PURE__ */ mi(e, false)), i = /* @__PURE__ */ this.buildTerminalTokens(n2), s = /* @__PURE__ */ this.buildKeywordTokens(n2, i, t);
    return i.forEach((o2) => {
      let l = o2.PATTERN;
...
var Tr = (_ya = class {
  convert(e, t) {
    ...
    if (nr(n2) && (n2 = /* @__PURE__ */ Ho(n2)), nt(n2)) {
      let i = n2.rule.ref;
...
var Ga = (_Aa = class {
  ...
  update(e, t) {
    for (let n2 of e) if (_Aa.isIncremental(n2)) {
      let i = /* @__PURE__ */ Hf(n2.range), s = /* @__PURE__ */ this.offsetAt(i.start), o2 = /* @__PURE__ */ this.offsetAt(i.end);
      this._content = this._content.substring(0, s) + n2.text + this._content.substring(o2, this._content.length);
      let l = /* @__PURE__ */ Math.max(i.start.line, 0), c = /* @__PURE__ */ Math.max(i.end.line, 0), u = this._lineOffsets, d = /* @__PURE__ */ Kf(n2.text, false, s);
...
(function(r) {
  ...
  function n2(i, s) {
    let o2 = /* @__PURE__ */ i.getText(), l = /* @__PURE__ */ cc(/* @__PURE__ */ s.map(ig), (d, f) => {
      let h2 = d.range.start.line - f.range.start.line;
      return h2 === 0 ? d.range.start.character - f.range.start.character : h2;
    }), c = 0, u = [];
    for (let d of l) {
  ...
  (() => {
    ...
    const _h3 = class _h3 {
      constructor(T2, C, S, K, O, L = false) {
        ...
        }(T2, L), this.authority = C || u, this.path = /* @__PURE__ */ function(Le, Oe) {
          switch (Le) {
            case "https":
            case "http":
            case "file":
    ...
    function v(k, T2, C) {
      ...
      for (let O = 0; O < k.length; O++) {
        ...
        if (L >= 97 && L <= 122 || L >= 65 && L <= 90 || L >= 48 && L <= 57 || L === 45 || L === 46 || L === 95 || L === 126 || T2 && L === 47 || C && L === 91 || C && L === 93 || C && L === 58) K !== -1 && (S += /* @__PURE__ */ encodeURIComponent(/* @__PURE__ */ k.substring(K, O)), K = -1), S !== void 0 && (S += /* @__PURE__ */ k.charAt(O));
        else {
    ...
    function x(k, T2) {
      ...
      return Le && (S += "?", S += /* @__PURE__ */ C(Le, false, false)), Oe && (S += "#", S += T2 ? Oe : v(Oe, false, false)), S;
    }
    m$1(x, "y");
    function P(k) {
      try {
    ...
    (function(k) {
      k.joinPath = function(T2) {
        ...
        return K && O[0] === Mt && !T2.authority && (O = /* @__PURE__ */ O.substring(1)), T2.with({
          path: O
        });
...
var zi = (_Ba = class {
  ...
  createTextDocumentGetter(e, t) {
    ...
    return () => i ?? (i = /* @__PURE__ */ jn.create(/* @__PURE__ */ e.toString(), n2.getServices(e).LanguageMetaData.languageId, 0, t ?? ""));
  }
...
var uc = /* @__PURE__ */ Symbol("ref_resolving"), Xi = (_Da = class {
  constructor(e) {
...
var Ji = (_Fa = class {
  ...
  findDeclaration(e) {
    if (e) {
      let t = /* @__PURE__ */ Qo(e), n2 = e.astNode;
      if (t && n2) {
        let i = n2[t.feature];
  ...
  findReferences(e, t) {
    ...
    return t.documentUri && (i = /* @__PURE__ */ i.filter((s) => Be.equals(s.sourceUri, t.documentUri))), n2.push(...i), j(n2);
  }
  getReferenceToSelf(e) {
    let t = /* @__PURE__ */ this.nameProvider.getNameNode(e);
    if (t) {
      let n2 = /* @__PURE__ */ _e(e), i = /* @__PURE__ */ this.nodeLocator.getAstNodePath(e);
      return {
        sourceUri: n2.uri,
        sourcePath: i,
        targetUri: n2.uri,
...
var ts = (_Qa = class {
  ...
  getScope(e) {
    let t = [], n2 = /* @__PURE__ */ this.reflection.getReferenceType(e), i = _e(e.container).precomputedScopes;
    if (i) {
      let o2 = e.container;
      do {
        let l = /* @__PURE__ */ i.get(o2);
        l.length > 0 && t.push(/* @__PURE__ */ j(l).filter((c) => this.reflection.isSubtype(c.type, n2))), o2 = o2.$container;
      } while (o2);
    }
...
var rs = (_Ra = class {
  ...
  serialize(e, t) {
    ...
    try {
      return this.currentDocument = /* @__PURE__ */ _e(e), JSON.stringify(e, o2, t == null ? void 0 : t.space);
    } finally {
  ...
  addAstNodeRegionWithAssignmentsTo(e) {
    ...
    if (e.$cstNode) {
      ...
      return Object.keys(e).filter((s) => !s.startsWith("$")).forEach((s) => {
        let o2 = /* @__PURE__ */ qo(e.$cstNode, s).map(t);
        o2.length !== 0 && (i[s] = o2);
      }), e;
    }
  }
  linkNode(e, t, n2, i, s, o2) {
    for (let [c, u] of Object.entries(e)) if (Array.isArray(u)) for (let d = 0; d < u.length; d++) {
      let f = u[d];
      Xf(f) ? u[d] = /* @__PURE__ */ this.reviveReference(e, c, t, f, n2) : le(f) && this.linkNode(f, t, n2, e, c, d);
    }
    else Xf(u) ? e[c] = /* @__PURE__ */ this.reviveReference(e, c, t, u, n2) : le(u) && this.linkNode(u, t, n2, e, c);
    let l = e;
  ...
  getRefNode(e, t, n2) {
    try {
      ...
      if (i < 0) {
        let c = n2 ? n2(t) : Ue.parse(t), u = /* @__PURE__ */ this.langiumDocuments.getDocument(c);
        return u ? u.parseResult.value : "Could not find document for URI: " + t;
      }
      let s = n2 ? n2(/* @__PURE__ */ t.substring(0, i)) : Ue.parse(/* @__PURE__ */ t.substring(0, i)), o2 = /* @__PURE__ */ this.langiumDocuments.getDocument(s);
...
var is = (_Ta = class {
  ...
  getChecks(e, t) {
    let n2 = /* @__PURE__ */ j(/* @__PURE__ */ this.entries.get(e)).concat(/* @__PURE__ */ this.entries.get("AstNode"));
...
var us = (_Za = class {
  ...
  async update(e, t) {
    ...
    let i = /* @__PURE__ */ j(e).concat(t).map((o2) => o2.toString()).toSet();
...
var ds = (__a = class {
  ...
  allElements(e, t) {
    let n2 = /* @__PURE__ */ j(/* @__PURE__ */ this.symbolIndex.keys());
...
function gc(r, e, t) {
  let n2, i;
  typeof r == "string" ? (i = e, n2 = t) : (i = r.range.start, n2 = e), i || (i = /* @__PURE__ */ W.create(0, 0));
  let s = /* @__PURE__ */ eh(r), o2 = /* @__PURE__ */ Tc(n2), l = /* @__PURE__ */ og({
    lines: s,
    position: i,
    options: o2
  });
...
m$1(gc, "parseJSDoc");
function yc(r, e) {
  let t = /* @__PURE__ */ Tc(e), n2 = /* @__PURE__ */ eh(r);
...
function og(r) {
  ...
  for (let l = 0; l < r.lines.length; l++) {
    ...
    if (d = /* @__PURE__ */ d.substring(0, /* @__PURE__ */ dg(d)), mc(d, f) >= d.length) {
      if (i.length > 0) {
        let p2 = /* @__PURE__ */ W.create(s, o2);
        i.push({
          type: "break",
          content: "",
          range: /* @__PURE__ */ G.create(p2, p2)
        });
      }
    } else {
      Qf.lastIndex = f;
      let p2 = /* @__PURE__ */ Qf.exec(d);
      if (p2) {
        let g = p2[0], y = p2[1], v = /* @__PURE__ */ W.create(s, o2 + f), R = /* @__PURE__ */ W.create(s, o2 + f + g.length);
        i.push({
          type: "tag",
          content: y,
...
function lg(r, e, t, n2) {
  let i = [];
  if (r.length === 0) {
    let s = /* @__PURE__ */ W.create(t, n2), o2 = /* @__PURE__ */ W.create(t, n2 + e.length);
    i.push({
      type: "text",
      content: e,
      range: /* @__PURE__ */ G.create(s, o2)
    });
  } else {
    let s = 0;
    for (let l of r) {
      ...
      u.length > 0 && i.push({
        ...
        range: /* @__PURE__ */ G.create(/* @__PURE__ */ W.create(t, s + n2), /* @__PURE__ */ W.create(t, c + n2))
      });
      let d = u.length + 1, f = l[1];
      if (i.push({
        type: "inline-tag",
        content: f,
        range: /* @__PURE__ */ G.create(/* @__PURE__ */ W.create(t, s + d + n2), /* @__PURE__ */ W.create(t, s + d + f.length + n2))
        ...
        i.push({
          type: "text",
          content: h2,
          range: /* @__PURE__ */ G.create(/* @__PURE__ */ W.create(t, s + d + n2), /* @__PURE__ */ W.create(t, s + d + h2.length + n2))
        });
      } else i.push({
        type: "text",
        content: "",
        range: /* @__PURE__ */ G.create(/* @__PURE__ */ W.create(t, s + d + n2), /* @__PURE__ */ W.create(t, s + d + n2))
      });
      s = c + l[0].length;
    }
    ...
    o2.length > 0 && i.push({
      type: "text",
      content: o2,
      range: /* @__PURE__ */ G.create(/* @__PURE__ */ W.create(t, s + n2), /* @__PURE__ */ W.create(t, s + n2 + o2.length))
    });
  }
  return i;
}
...
function fg(r) {
  ...
  for (; r.index < r.tokens.length; ) {
    let u = /* @__PURE__ */ hg(r, o2[o2.length - 1]);
    u && o2.push(u);
  }
...
function th(r) {
  ...
  for (; e && e.type !== "break" && e.type !== "tag"; ) i.push(/* @__PURE__ */ mg(r)), n2 = e, e = r.tokens[r.index];
...
var Ts = (_ib = class {
  ...
  async parse(e, t) {
    let n2 = await this.acquireParserWorker(t), i = new Ge(), s, o2 = /* @__PURE__ */ t.onCancellationRequested(() => {
...
function lh(r, e) {
  let t = new Proxy({}, {
    ...
    get: /* @__PURE__ */ m$1((n2, i) => i === ah ? true : sh(n2, i, r, e || t), "get"),
    getOwnPropertyDescriptor: /* @__PURE__ */ m$1((n2, i) => (sh(n2, i, r, e || t), Object.getOwnPropertyDescriptor(n2, i)), "getOwnPropertyDescriptor"),
...
function bt(r) {
  var e;
  let t = /* @__PURE__ */ Rg(), n2 = /* @__PURE__ */ t.serializer.JsonSerializer.deserialize(r);
  return t.shared.workspace.LangiumDocumentFactory.fromModel(n2, /* @__PURE__ */ Ue.parse(`memory://${(e = n2.name) !== null && e !== void 0 ? e : "grammar"}.langium`)), n2;
}
