...
var _a, __;
import { g as gr, m as mr } from "./vendor-min-mermaid~chunk-7LIB5WBN.VCeBPxAO.chunk.js";
import { w, $ } from "./vendor-min-mermaid~chunk-IO347I67.jAXjFTQY.chunk.js";
import { V, S } from "./vendor-min-mermaid~chunk-L736DJ4U.CrZlOsoh.chunk.js";
import "./vendor-min-mermaid~chunk-QTJCGBHB.B_EP1PNg.chunk.js";
import { Q as Qf } from "./vendor-min-mermaid~chunk-USR3SDWQ.C0XgfhoF.chunk.js";
import "./vendor-min-mermaid~chunk-2VPXETT4.xhKexg6X.chunk.js";
import "./vendor-min-mermaid~chunk-S67DUUA5.By2qN2hC.chunk.js";
import "./vendor-min-mermaid~chunk-LM6QDVU5.CCcUlC7q.chunk.js";
import "./vendor-min-mermaid~chunk-HESFG3RP.X24hc0uC.chunk.js";
import { I as Ie, Y as Ye } from "./vendor-min-mermaid~chunk-YM3XIQPS.DzKxOkHI.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
import { X as IC, t as tt, H as Hl, i as ih, v as vf, B as Bf, M as Mf, w as wf, F as Ff, L as Lf, g as gC, S as Sf, Z as zC, a as Su, b as ae } from "./vendor-min-mermaid~chunk-ZKYS2E5M.DYmB7G2x.chunk.js";
...
` + A + `
    ...
    if (k === void 0 && (k = {
      ...
      styles: [],
      classes: []
    }, this.vertices.set(i, k)), this.vertexCounter++, r !== void 0 ? (this.config = Hl(), w2 = this.sanitizeText(r.text.trim()), k.labelType = r.type, w2.startsWith('"') && w2.endsWith('"') && (w2 = w2.substring(1, w2.length - 1)), k.text = w2) : k.text === void 0 && (k.text = i), n !== void 0 && (k.type = n), u == null ? void 0 : u.forEach((E) => {
      k.styles.push(E);
      ...
      (a == null ? void 0 : a.label) && (k.text = a == null ? void 0 : a.label), (a == null ? void 0 : a.icon) && (k.icon = a == null ? void 0 : a.icon, !((_a2 = a.label) == null ? void 0 : _a2.trim()) && k.text === i && (k.text = "")), (a == null ? void 0 : a.form) && (k.form = a == null ? void 0 : a.form), (a == null ? void 0 : a.pos) && (k.pos = a == null ? void 0 : a.pos), (a == null ? void 0 : a.img) && (k.img = a == null ? void 0 : a.img, !((_b = a.label) == null ? void 0 : _b.trim()) && k.text === i && (k.text = "")), (a == null ? void 0 : a.constraint) && (k.constraint = a.constraint), a.w && (k.assetWidth = Number(a.w)), a.h && (k.assetHeight = Number(a.h));
    }
  }
...
You have to call mermaid.initialize.`);
  ...
  clear() {
    ...
    ], this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = true, this.version = i, this.config = Hl(), Sf();
  }
  setGen(i) {
  ...
  getCompiledStyles(i) {
    ...
    for (let n of i) {
      ...
      (u == null ? void 0 : u.styles) && (r = [
        ...r,
        ...u.styles ?? []
      ].map((l) => l.trim())), (u == null ? void 0 : u.textStyles) && (r = [
        ...r,
        ...u.textStyles ?? []
      ].map((l) => l.trim()));
    }
  ...
  getData() {
    let i = Hl(), r = [], n = [], u = this.getSubGraphs(), l = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
    ...
    return A.forEach((a, g) => {
      ...
      let S2 = {
        ...
        curve: a.interpolate || this.edges.defaultInterpolate || ((_a2 = i.flowchart) == null ? void 0 : _a2.curve)
      };
      n.push(S2);
    }), {
      nodes: r,
...
var g1 = m$1(function(s, i) {
  ...
  Ie.insertTitle(g, "flowchartTitleText", (l == null ? void 0 : l.titleTopMargin) || 0, n.db.getDiagramTitle()), $(g, k, "flowchart", (l == null ? void 0 : l.useMaxWidth) || false);
  for (let E of a.nodes) {
    ...
    let J = S2.insert(function() {
      return m;
    }, ":first-child"), ge = S2.select(".label-container");
    ge && J.append(function() {
      return ge.node();
    });
    let ke = S2.select(".label");
