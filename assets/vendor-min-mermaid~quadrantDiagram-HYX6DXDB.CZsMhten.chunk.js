import { U as Uo, G as Go, j as jo, $ as $o, H as Ho, N as No, u as ur, R as Ro, P as Po, a as Pi, D as Di, r as rt } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
import { p as pt, i as ia, k as Zi } from './vendor-min-mermaid~chunk-BF7QJ6L7.DK9jwCiC.chunk.js';
...
var V = /*#__PURE__*/ Di(), qt = class {
    ...
    getDefaultConfig() {
        return {
            ...
            showYAxis: true,
            showTitle: true,
            chartHeight: Pi.quadrantChart?.chartWidth || 500,
            chartWidth: Pi.quadrantChart?.chartHeight || 500,
            titlePadding: Pi.quadrantChart?.titlePadding || 10,
            titleFontSize: Pi.quadrantChart?.titleFontSize || 20,
            quadrantPadding: Pi.quadrantChart?.quadrantPadding || 5,
            xAxisLabelPadding: Pi.quadrantChart?.xAxisLabelPadding || 5,
            yAxisLabelPadding: Pi.quadrantChart?.yAxisLabelPadding || 5,
            xAxisLabelFontSize: Pi.quadrantChart?.xAxisLabelFontSize || 16,
            yAxisLabelFontSize: Pi.quadrantChart?.yAxisLabelFontSize || 16,
            quadrantLabelFontSize: Pi.quadrantChart?.quadrantLabelFontSize || 16,
            quadrantTextTopPadding: Pi.quadrantChart?.quadrantTextTopPadding || 5,
            pointTextPadding: Pi.quadrantChart?.pointTextPadding || 5,
            pointLabelFontSize: Pi.quadrantChart?.pointLabelFontSize || 12,
            pointRadius: Pi.quadrantChart?.pointRadius || 5,
            xAxisPosition: Pi.quadrantChart?.xAxisPosition || "top",
            yAxisPosition: Pi.quadrantChart?.yAxisPosition || "left",
            quadrantInternalBorderStrokeWidth: Pi.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
            quadrantExternalBorderStrokeWidth: Pi.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
        };
    }
    ...
    clear() {
        this.config = /*#__PURE__*/ this.getDefaultConfig(), this.themeConfig = /*#__PURE__*/ this.getDefaultThemeConfig(), this.data = /*#__PURE__*/ this.getDefaultData(), this.classes = new Map, pt.info("clear called");
    }
    setData(n) {
        this.data = {
            ...this.data,
    ...
    getQuadrantPoints(n) {
        let { quadrantSpace: f } = n, { quadrantHeight: u, quadrantLeft: c, quadrantTop: g, quadrantWidth: y } = f, S = /*#__PURE__*/ Zi().domain([
            0,
            1
        ]).range([
            c,
            y + c
        ]), i = /*#__PURE__*/ Zi().domain([
            0,
            1
        ]).range([
            u + g,
...
m$1(ze, "setHeight");
function Ve() {
    let t = /*#__PURE__*/ ur(), { themeVariables: n, quadrantChart: f } = t;
...
` + t);
    ...
    let T = /*#__PURE__*/ (i === "sandbox" ? ia(A.nodes()[0].contentDocument.body) : ia("body")).select(`[id="${n}"]`), m = /*#__PURE__*/ T.append("g").attr("class", "main"), b = S.quadrantChart?.chartWidth ?? 500, q = S.quadrantChart?.chartHeight ?? 500;
    Ro(T, q, b, S.quadrantChart?.useMaxWidth ?? true), T.attr("viewBox", "0 0 " + b + " " + q), u.db.setHeight(q), u.db.setWidth(b);
    let p = /*#__PURE__*/ u.db.getQuadrantData(), K = /*#__PURE__*/ m.append("g").attr("class", "quadrants"), dt = /*#__PURE__*/ m.append("g").attr("class", "border"), ft = /*#__PURE__*/ m.append("g").attr("class", "data-points"), pt$1 = /*#__PURE__*/ m.append("g").attr("class", "labels"), gt = /*#__PURE__*/ m.append("g").attr("class", "title");
