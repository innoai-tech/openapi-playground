const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-mermaid.VyCN2OC8.chunk.js","assets/vendor-min-mermaid~chunk-GTKDMUJJ.DL2Iapv7.chunk.js","assets/vendor-min-mermaid~katex-RV2QPRKB.Y2kGb6V3.chunk.js"])))=>i.map(i=>d[i]);
import { t as __vitePreload } from "./index.DdIYnUiz.entry.js";
import { r as o, t as m } from "./vendor-min-mermaid~chunk-GTKDMUJJ.DL2Iapv7.chunk.js";
import { M as Wh, q as pt } from "./vendor-min-mermaid~chunk-63GW7ZVL.JXMkVvO5.chunk.js";
...
var Fe = m((e, t, { depth: i = 2, clobber: s = !1 } = {}) => {
	...
	return Array.isArray(t) && !Array.isArray(e) ? (t.forEach((d) => Fe(e, d, l)), e) : Array.isArray(t) && Array.isArray(e) ? (t.forEach((d) => {
		...
		typeof t[d] == "object" && (e[d] === void 0 || typeof e[d] == "object") ? (e[d] === void 0 && (e[d] = Array.isArray(t[d]) ? [] : {}), e[d] = /* @__PURE__ */ Fe(e[d], t[d], {
			depth: i - 1,
			clobber: s
...
var Vt = {
	...
	hsl2rgb: /* @__PURE__ */ m(({ h: e, s: t, l: i }, s) => {
		...
		switch (s) {
			case "r": return Vt.hue2rgb(d, l, e + .3333333333333333) * 255;
			case "g": return Vt.hue2rgb(d, l, e) * 255;
			case "b": return Vt.hue2rgb(d, l, e - .3333333333333333) * 255;
		}
	}, "hsl2rgb"),
...
var K = {};
for (let e = 0; e <= 255; e++) K[e] = /* @__PURE__ */ m$1.unit.dec2hex(e);
var S = {
	ALL: 0,
	RGB: 1,
	HSL: 2
...
var _e = class {
	...
	set(t, i) {
		return this.color = i, this.changed = !1, this.data = t, this.type.type = S.ALL, this;
	}
	_ensureHSL() {
		let t = this.data, { h: i, s, l } = t;
		i === void 0 && (t.h = /* @__PURE__ */ m$1.channel.rgb2hsl(t, "h")), s === void 0 && (t.s = /* @__PURE__ */ m$1.channel.rgb2hsl(t, "s")), l === void 0 && (t.l = /* @__PURE__ */ m$1.channel.rgb2hsl(t, "l"));
	}
	_ensureRGB() {
		let t = this.data, { r: i, g: s, b: l } = t;
		i === void 0 && (t.r = /* @__PURE__ */ m$1.channel.hsl2rgb(t, "r")), s === void 0 && (t.g = /* @__PURE__ */ m$1.channel.hsl2rgb(t, "g")), l === void 0 && (t.b = /* @__PURE__ */ m$1.channel.hsl2rgb(t, "b"));
	}
	get r() {
		let t = this.data, i = t.r;
		return !this.type.is(S.HSL) && i !== void 0 ? i : (this._ensureHSL(), m$1.channel.hsl2rgb(t, "r"));
	}
	get g() {
		let t = this.data, i = t.g;
		return !this.type.is(S.HSL) && i !== void 0 ? i : (this._ensureHSL(), m$1.channel.hsl2rgb(t, "g"));
	}
	get b() {
		let t = this.data, i = t.b;
		return !this.type.is(S.HSL) && i !== void 0 ? i : (this._ensureHSL(), m$1.channel.hsl2rgb(t, "b"));
	}
	get h() {
		let t = this.data, i = t.h;
		return !this.type.is(S.RGB) && i !== void 0 ? i : (this._ensureRGB(), m$1.channel.rgb2hsl(t, "h"));
	}
	get s() {
		let t = this.data, i = t.s;
		return !this.type.is(S.RGB) && i !== void 0 ? i : (this._ensureRGB(), m$1.channel.rgb2hsl(t, "s"));
	}
	get l() {
		let t = this.data, i = t.l;
		return !this.type.is(S.RGB) && i !== void 0 ? i : (this._ensureRGB(), m$1.channel.rgb2hsl(t, "l"));
	}
	get a() {
		return this.data.a;
	}
	set r(t) {
		this.type.set(S.RGB), this.changed = !0, this.data.r = t;
	}
	set g(t) {
		this.type.set(S.RGB), this.changed = !0, this.data.g = t;
	}
	set b(t) {
		this.type.set(S.RGB), this.changed = !0, this.data.b = t;
	}
	set h(t) {
		this.type.set(S.HSL), this.changed = !0, this.data.h = t;
	}
	set s(t) {
		this.type.set(S.HSL), this.changed = !0, this.data.s = t;
	}
	set l(t) {
		this.type.set(S.HSL), this.changed = !0, this.data.l = t;
	}
	set a(t) {
...
var Ei = {
	...
	parse: /* @__PURE__ */ m((e) => {
		...
		if (!t) return;
		let i = t[1], s = /* @__PURE__ */ parseInt(i, 16), l = i.length, d = l % 4 === 0, f = l > 4, x = f ? 1 : 17, E = f ? 8 : 4, A = d ? 0 : -1, H = f ? 255 : 15;
		return tt.set({
			r: (s >> E * (A + 3) & H) * x,
			g: (s >> E * (A + 2) & H) * x,
			b: (s >> E * (A + 1) & H) * x,
...
var Yt = {
	...
	_hue2deg: /* @__PURE__ */ m((e) => {
		...
		if (t) {
			let [, i, s] = t;
			switch (s) {
				case "grad": return m$1.channel.clamp.h(parseFloat(i) * .9);
				case "rad": return m$1.channel.clamp.h(parseFloat(i) * 180 / Math.PI);
				case "turn": return m$1.channel.clamp.h(parseFloat(i) * 360);
			}
		}
		return m$1.channel.clamp.h(/* @__PURE__ */ parseFloat(e));
	}, "_hue2deg"),
	parse: /* @__PURE__ */ m((e) => {
		...
		return tt.set({
			...
			s: /* @__PURE__ */ m$1.channel.clamp.s(/* @__PURE__ */ parseFloat(l)),
			l: /* @__PURE__ */ m$1.channel.clamp.l(/* @__PURE__ */ parseFloat(d)),
			a: f ? m$1.channel.clamp.a(x ? parseFloat(f) / 100 : parseFloat(f)) : 1
		}, e);
	}, "parse"),
	stringify: /* @__PURE__ */ m((e) => {
		let { h: t, s: i, l: s, a: l } = e;
		return l < 1 ? `hsla(${m$1.lang.round(t)}, ${m$1.lang.round(i)}%, ${m$1.lang.round(s)}%, ${l})` : `hsl(${m$1.lang.round(t)}, ${m$1.lang.round(i)}%, ${m$1.lang.round(s)}%)`;
	}, "stringify")
}, _t = Yt;
var Xt = {
	colors: {
...
var Ai = {
	...
	parse: /* @__PURE__ */ m((e) => {
		...
		return tt.set({
			r: /* @__PURE__ */ m$1.channel.clamp.r(l ? parseFloat(s) * 2.55 : parseFloat(s)),
			g: /* @__PURE__ */ m$1.channel.clamp.g(f ? parseFloat(d) * 2.55 : parseFloat(d)),
			b: /* @__PURE__ */ m$1.channel.clamp.b(E ? parseFloat(x) * 2.55 : parseFloat(x)),
			a: A ? m$1.channel.clamp.a(H ? parseFloat(A) / 100 : parseFloat(A)) : 1
		}, e);
	}, "parse"),
	stringify: /* @__PURE__ */ m((e) => {
		let { r: t, g: i, b: s, a: l } = e;
		return l < 1 ? `rgba(${m$1.lang.round(t)}, ${m$1.lang.round(i)}, ${m$1.lang.round(s)}, ${m$1.lang.round(l)})` : `rgb(${m$1.lang.round(t)}, ${m$1.lang.round(i)}, ${m$1.lang.round(s)})`;
	}, "stringify")
}, Et = Ai;
var F = {
	format: {
	...
	stringify: /* @__PURE__ */ m((e) => !e.changed && e.color ? e.color : e.type.is(S.HSL) || e.data.r === void 0 ? _t.stringify(e) : e.a < 1 || !Number.isInteger(e.r) || !Number.isInteger(e.g) || !Number.isInteger(e.b) ? Et.stringify(e) : at.stringify(e), "stringify")
};
var Kt = /* @__PURE__ */ m((e, t) => {
	let i = /* @__PURE__ */ F.parse(e);
	for (let s in t) i[s] = /* @__PURE__ */ m$1.channel.clamp[s](t[s]);
	return F.stringify(i);
}, "change");
var Z = /* @__PURE__ */ m((e, t, i = 0, s = 1) => {
	if (typeof e != "number") return Kt(e, { a: t });
	let l = /* @__PURE__ */ tt.set({
		r: /* @__PURE__ */ m$1.channel.clamp.r(e),
		g: /* @__PURE__ */ m$1.channel.clamp.g(t),
		b: /* @__PURE__ */ m$1.channel.clamp.b(i),
		a: /* @__PURE__ */ m$1.channel.clamp.a(s)
	});
	return F.stringify(l);
}, "rgba");
var Pr = /* @__PURE__ */ m((e, t) => m$1.lang.round(F.parse(e)[t]), "channel");
var Mi = /* @__PURE__ */ m((e) => {
	let { r: t, g: i, b: s } = F.parse(e), l = .2126 * m$1.channel.toLinear(t) + .7152 * m$1.channel.toLinear(i) + .0722 * m$1.channel.toLinear(s);
	return m$1.lang.round(l);
}, "luminance");
var Oi = /* @__PURE__ */ m((e) => Mi(e) >= .5, "isLight");
var U = /* @__PURE__ */ m((e) => !Oi(e), "isDark");
var Zt = /* @__PURE__ */ m((e, t, i) => {
	let s = /* @__PURE__ */ F.parse(e), l = s[t], d = /* @__PURE__ */ m$1.channel.clamp[t](l + i);
	return l !== d && (s[t] = d), F.stringify(s);
}, "adjustChannel");
var c = /* @__PURE__ */ m((e, t) => Zt(e, "l", t), "lighten");
var g = /* @__PURE__ */ m((e, t) => Zt(e, "l", -t), "darken");
...
var vi = /* @__PURE__ */ m((e, t, i = 50) => {
	let { r: s, g: l, b: d, a: f } = F.parse(e), { r: x, g: E, b: A, a: H } = F.parse(t), bt = i / 100, nt = bt * 2 - 1, Q = f - H, ct = ((nt * Q === -1 ? nt : (nt + Q) / (1 + nt * Q)) + 1) / 2, Tt = 1 - ct;
	return Z(s * ct + x * Tt, l * ct + E * Tt, d * ct + A * Tt, f * bt + H * (1 - bt));
}, "mix");
var h = /* @__PURE__ */ m((e, t = 100) => {
	let i = /* @__PURE__ */ F.parse(e);
...
var Ae = class {
	...
	updateColors() {
		if (this.primaryTextColor = this.primaryTextColor || (this.darkMode ? "#eee" : "#333"), this.secondaryColor = this.secondaryColor || a(this.primaryColor, { h: -120 }), this.tertiaryColor = this.tertiaryColor || a(this.primaryColor, {
			...
			h: 210,
			l: 150
		}), this.cScale9 = this.cScale9 || a(this.primaryColor, { h: 270 }), this.cScale10 = this.cScale10 || a(this.primaryColor, { h: 300 }), this.cScale11 = this.cScale11 || a(this.primaryColor, { h: 330 }), this.darkMode) for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScale" + i] = /* @__PURE__ */ g(this["cScale" + i], 75);
...
var Oe = class {
	...
	updateColors() {
		...
		}, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || this.labelBackground, this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = this.git0 || this.primaryColor, this.git1 = this.git1 || this.secondaryColor, this.git2 = this.git2 || this.tertiaryColor, this.git3 = this.git3 || a(this.primaryColor, { h: -30 }), this.git4 = this.git4 || a(this.primaryColor, { h: -60 }), this.git5 = this.git5 || a(this.primaryColor, { h: -90 }), this.git6 = this.git6 || a(this.primaryColor, { h: 60 }), this.git7 = this.git7 || a(this.primaryColor, { h: 120 }), this.darkMode ? (this.git0 = /* @__PURE__ */ c(this.git0, 25), this.git1 = /* @__PURE__ */ c(this.git1, 25), this.git2 = /* @__PURE__ */ c(this.git2, 25), this.git3 = /* @__PURE__ */ c(this.git3, 25), this.git4 = /* @__PURE__ */ c(this.git4, 25), this.git5 = /* @__PURE__ */ c(this.git5, 25), this.git6 = /* @__PURE__ */ c(this.git6, 25), this.git7 = /* @__PURE__ */ c(this.git7, 25)) : (this.git0 = /* @__PURE__ */ g(this.git0, 25), this.git1 = /* @__PURE__ */ g(this.git1, 25), this.git2 = /* @__PURE__ */ g(this.git2, 25), this.git3 = /* @__PURE__ */ g(this.git3, 25), this.git4 = /* @__PURE__ */ g(this.git4, 25), this.git5 = /* @__PURE__ */ g(this.git5, 25), this.git6 = /* @__PURE__ */ g(this.git6, 25), this.git7 = /* @__PURE__ */ g(this.git7, 25)), this.gitInv0 = this.gitInv0 || g(/* @__PURE__ */ h(this.git0), 25), this.gitInv1 = this.gitInv1 || h(this.git1), this.gitInv2 = this.gitInv2 || h(this.git2), this.gitInv3 = this.gitInv3 || h(this.git3), this.gitInv4 = this.gitInv4 || h(this.git4), this.gitInv5 = this.gitInv5 || h(this.git5), this.gitInv6 = this.gitInv6 || h(this.git6), this.gitInv7 = this.gitInv7 || h(this.git7), this.gitBranchLabel0 = this.gitBranchLabel0 || h(this.labelTextColor), this.gitBranchLabel1 = this.gitBranchLabel1 || this.labelTextColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.labelTextColor, this.gitBranchLabel3 = this.gitBranchLabel3 || h(this.labelTextColor), this.gitBranchLabel4 = this.gitBranchLabel4 || this.labelTextColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.labelTextColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.labelTextColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.labelTextColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || et, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || it;
	}
	calculate(t) {
...
var Mt = /* @__PURE__ */ Object.freeze(Ni), P = /* @__PURE__ */ v({}, Mt), Qt, lt = [], At = /* @__PURE__ */ v({}, Mt), te = /* @__PURE__ */ m((e, t) => {
	...
	if (i = /* @__PURE__ */ v(i, s), s.theme && s.theme in rt) {
		let d = /* @__PURE__ */ v(v({}, Qt).themeVariables || {}, s.themeVariables);
		i.theme && i.theme in rt && (i.themeVariables = /* @__PURE__ */ rt[i.theme].getThemeVariables(d));
	}
	return At = i, $i(At), At;
...
function sr() {
	...
	let { document: i } = e, s = i, l = s.currentScript, { DocumentFragment: d, HTMLTemplateElement: f, Node: x, Element: E, NodeFilter: A, NamedNodeMap: H = e.NamedNodeMap || e.MozNamedAttrMap, HTMLFormElement: bt, DOMParser: nt, trustedTypes: Q } = e, ht = E.prototype, ct = /* @__PURE__ */ It(ht, "cloneNode"), Tt = /* @__PURE__ */ It(ht, "remove"), le = /* @__PURE__ */ It(ht, "nextSibling"), ne = /* @__PURE__ */ It(ht, "childNodes"), dt = /* @__PURE__ */ It(ht, "parentNode");
	if (typeof f == "function") {
		let C = /* @__PURE__ */ i.createElement("template");
		C.content && C.content.ownerDocument && (i = C.content.ownerDocument);
	}
	let M, kt = "", { implementation: he, createNodeIterator: Cr, createDocumentFragment: pr, getElementsByTagName: fr } = i, { importNode: xr } = s, I = /* @__PURE__ */ tr();
	t.isSupported = typeof er == "function" && typeof dt == "function" && he && he.createHTMLDocument !== void 0;
	let { MUSTACHE_EXPR: ce, ERB_EXPR: de, TMPLIT_EXPR: ge, DATA_ATTR: yr, ARIA_ATTR: br, IS_SCRIPT_OR_DATA: Tr, ATTR_WHITESPACE: Ye, CUSTOM_ELEMENT: kr } = Qi, { IS_ALLOWED_URI: Xe } = Qi, L = null, Ke = /* @__PURE__ */ p({}, [
		...Xi,
		...Ie,
		...qe,
		...ze,
		...Ki
	]), O = null, Ze = /* @__PURE__ */ p({}, [
		...Zi,
		...Re,
		...Ji,
		...ie
	...
	})), Bt = null, ue = null, Je = !0, me = !0, Qe = !1, ti = !0, gt = !1, Rt = !0, st = !1, Ce = !1, pe = !1, ut = !1, Wt = !1, Pt = !1, ei = !0, ii = !1, Br = "user-content-", fe = !0, St = !1, mt = {}, Ct = null, ri = /* @__PURE__ */ p({}, [
		"annotation-xml",
		"audio",
		"colgroup",
		"desc",
		...
		"style",
		"xmlns"
	]), Nt = "http://www.w3.org/1998/Math/MathML", Ht = "http://www.w3.org/2000/svg", V = "http://www.w3.org/1999/xhtml", pt$1 = V, ye = !1, be = null, Sr = /* @__PURE__ */ p({}, [
		Nt,
		Ht,
		V
	], De), Ut = /* @__PURE__ */ p({}, [
		...
		"ms",
		"mtext"
	]), Gt = /* @__PURE__ */ p({}, ["annotation-xml"]), Fr = /* @__PURE__ */ p({}, [
		"title",
		"style",
		"font",
		"a",
		"script"
	]), Ft = null, Lr = ["application/xhtml+xml", "text/html"], _r = "text/html", _ = null, ft = null, Er = /* @__PURE__ */ i.createElement("form"), li = /* @__PURE__ */ m(function(o$1) {
		return o$1 instanceof RegExp || o$1 instanceof Function;
	}, "isRegexOrFunction"), Te = /* @__PURE__ */ m(function() {
		let o$1 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
		if (!(ft && ft === o$1)) {
			if ((!o$1 || typeof o$1 != "object") && (o$1 = {}), o$1 = /* @__PURE__ */ J(o$1), Ft = Lr.indexOf(o$1.PARSER_MEDIA_TYPE) === -1 ? _r : o$1.PARSER_MEDIA_TYPE, _ = Ft === "application/xhtml+xml" ? De : re, L = $(o$1, "ALLOWED_TAGS") ? p({}, o$1.ALLOWED_TAGS, _) : Ke, O = $(o$1, "ALLOWED_ATTR") ? p({}, o$1.ALLOWED_ATTR, _) : Ze, be = $(o$1, "ALLOWED_NAMESPACES") ? p({}, o$1.ALLOWED_NAMESPACES, De) : Sr, xe = $(o$1, "ADD_URI_SAFE_ATTR") ? p(/* @__PURE__ */ J(ai), o$1.ADD_URI_SAFE_ATTR, _) : ai, oi = $(o$1, "ADD_DATA_URI_TAGS") ? p(/* @__PURE__ */ J(si), o$1.ADD_DATA_URI_TAGS, _) : si, Ct = $(o$1, "FORBID_CONTENTS") ? p({}, o$1.FORBID_CONTENTS, _) : ri, Bt = $(o$1, "FORBID_TAGS") ? p({}, o$1.FORBID_TAGS, _) : J({}), ue = $(o$1, "FORBID_ATTR") ? p({}, o$1.FORBID_ATTR, _) : J({}), mt = $(o$1, "USE_PROFILES") ? o$1.USE_PROFILES : !1, Je = o$1.ALLOW_ARIA_ATTR !== !1, me = o$1.ALLOW_DATA_ATTR !== !1, Qe = o$1.ALLOW_UNKNOWN_PROTOCOLS || !1, ti = o$1.ALLOW_SELF_CLOSE_IN_ATTR !== !1, gt = o$1.SAFE_FOR_TEMPLATES || !1, Rt = o$1.SAFE_FOR_XML !== !1, st = o$1.WHOLE_DOCUMENT || !1, ut = o$1.RETURN_DOM || !1, Wt = o$1.RETURN_DOM_FRAGMENT || !1, Pt = o$1.RETURN_TRUSTED_TYPE || !1, pe = o$1.FORCE_BODY || !1, ei = o$1.SANITIZE_DOM !== !1, ii = o$1.SANITIZE_NAMED_PROPS || !1, fe = o$1.KEEP_CONTENT !== !1, St = o$1.IN_PLACE || !1, Xe = o$1.ALLOWED_URI_REGEXP || rr, pt$1 = o$1.NAMESPACE || V, Ut = o$1.MATHML_TEXT_INTEGRATION_POINTS || Ut, Gt = o$1.HTML_INTEGRATION_POINTS || Gt, b = o$1.CUSTOM_ELEMENT_HANDLING || {}, o$1.CUSTOM_ELEMENT_HANDLING && li(o$1.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (b.tagNameCheck = o$1.CUSTOM_ELEMENT_HANDLING.tagNameCheck), o$1.CUSTOM_ELEMENT_HANDLING && li(o$1.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (b.attributeNameCheck = o$1.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), o$1.CUSTOM_ELEMENT_HANDLING && typeof o$1.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (b.allowCustomizedBuiltInElements = o$1.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), gt && (me = !1), Wt && (ut = !0), mt && (L = /* @__PURE__ */ p({}, Ki), O = [], mt.html === !0 && (p(L, Xi), p(O, Zi)), mt.svg === !0 && (p(L, Ie), p(O, Re), p(O, ie)), mt.svgFilters === !0 && (p(L, qe), p(O, Re), p(O, ie)), mt.mathMl === !0 && (p(L, ze), p(O, Ji), p(O, ie))), o$1.ADD_TAGS && (L === Ke && (L = /* @__PURE__ */ J(L)), p(L, o$1.ADD_TAGS, _)), o$1.ADD_ATTR && (O === Ze && (O = /* @__PURE__ */ J(O)), p(O, o$1.ADD_ATTR, _)), o$1.ADD_URI_SAFE_ATTR && p(xe, o$1.ADD_URI_SAFE_ATTR, _), o$1.FORBID_CONTENTS && (Ct === ri && (Ct = /* @__PURE__ */ J(Ct)), p(Ct, o$1.FORBID_CONTENTS, _)), fe && (L["#text"] = !0), st && p(L, [
				"html",
				"head",
				"body"
			]), L.table && (p(L, ["tbody"]), delete Bt.tbody), o$1.TRUSTED_TYPES_POLICY) {
	...
	}, "_parseConfig"), ni = /* @__PURE__ */ p({}, [
		...Ie,
		...qe,
		...ho
	]), hi = /* @__PURE__ */ p({}, [...ze, ...co]), Ar = /* @__PURE__ */ m(function(o$1) {
		let n = /* @__PURE__ */ dt(o$1);
		(!n || !n.tagName) && (n = {
			namespaceURI: pt$1,
			tagName: "template"
		});
		let u = /* @__PURE__ */ re(o$1.tagName), y = /* @__PURE__ */ re(n.tagName);
		return be[o$1.namespaceURI] ? o$1.namespaceURI === Ht ? n.namespaceURI === V ? u === "svg" : n.namespaceURI === Nt ? u === "svg" && (y === "annotation-xml" || Ut[y]) : !!ni[u] : o$1.namespaceURI === Nt ? n.namespaceURI === V ? u === "math" : n.namespaceURI === Ht ? u === "math" && Gt[y] : !!hi[u] : o$1.namespaceURI === V ? n.namespaceURI === Ht && !Gt[y] || n.namespaceURI === Nt && !Ut[y] ? !1 : !hi[u] && (Fr[u] || !ni[u]) : !!(Ft === "application/xhtml+xml" && be[o$1.namespaceURI]) : !1;
	}, "_checkValidNamespace"), j = /* @__PURE__ */ m(function(o$1) {
	...
	}, "_forceRemove"), xt = /* @__PURE__ */ m(function(o$1, n) {
		try {
			vt(t.removed, {
				attribute: /* @__PURE__ */ n.getAttributeNode(o$1),
				from: n
			});
		} catch {
			vt(t.removed, {
		...
		if (n.removeAttribute(o$1), o$1 === "is") if (ut || Wt) try {
			j(n);
		} catch {}
		else try {
			n.setAttribute(o$1, "");
		} catch {}
	}, "_removeAttribute"), ci = /* @__PURE__ */ m(function(o$1) {
		let n = null, u = null;
		if (pe) o$1 = "<remove></remove>" + o$1;
		else {
			let B = /* @__PURE__ */ Yi(o$1, /^[\r\n\t ]+/);
			u = B && B[0];
		}
		Ft === "application/xhtml+xml" && pt$1 === V && (o$1 = "<html xmlns=\"http://www.w3.org/1999/xhtml\"><head></head><body>" + o$1 + "</body></html>");
		let y = M ? M.createHTML(o$1) : o$1;
		if (pt$1 === V) try {
			n = /* @__PURE__ */ new nt().parseFromString(y, Ft);
		} catch {}
		if (!n || !n.documentElement) {
			n = /* @__PURE__ */ he.createDocument(pt$1, "template", null);
			try {
				n.documentElement.innerHTML = ye ? kt : y;
			} catch {}
		}
		let w = n.body || n.documentElement;
		return o$1 && u && w.insertBefore(/* @__PURE__ */ i.createTextNode(u), w.childNodes[0] || null), pt$1 === V ? fr.call(n, st ? "html" : "body")[0] : st ? n.documentElement : w;
	}, "_initDocument"), di = /* @__PURE__ */ m(function(o$1) {
		return Cr.call(o$1.ownerDocument || o$1, o$1, A.SHOW_ELEMENT | A.SHOW_COMMENT | A.SHOW_TEXT | A.SHOW_PROCESSING_INSTRUCTION | A.SHOW_CDATA_SECTION, null);
	}, "_createNodeIterator"), ke = /* @__PURE__ */ m(function(o$1) {
		return o$1 instanceof bt && (typeof o$1.nodeName != "string" || typeof o$1.textContent != "string" || typeof o$1.removeChild != "function" || !(o$1.attributes instanceof H) || typeof o$1.removeAttribute != "function" || typeof o$1.setAttribute != "function" || typeof o$1.namespaceURI != "string" || typeof o$1.insertBefore != "function" || typeof o$1.hasChildNodes != "function");
	}, "_isClobbered"), gi = /* @__PURE__ */ m(function(o$1) {
	...
	m(Y, "_executeHooks");
	let ui = /* @__PURE__ */ m(function(o$1) {
		let n = null;
		if (Y(I.beforeSanitizeElements, o$1, null), ke(o$1)) return j(o$1), !0;
		let u = /* @__PURE__ */ _(o$1.nodeName);
		if (Y(I.uponSanitizeElement, o$1, {
			tagName: u,
			allowedTags: L
		}), Rt && o$1.hasChildNodes() && !gi(o$1.firstElementChild) && q(/<[/\w!]/g, o$1.innerHTML) && q(/<[/\w!]/g, o$1.textContent) || o$1.nodeType === qt.progressingInstruction || Rt && o$1.nodeType === qt.comment && q(/<[/\w]/g, o$1.data)) return j(o$1), !0;
		if (!L[u] || Bt[u]) {
			if (!Bt[u] && Ci(u) && (b.tagNameCheck instanceof RegExp && q(b.tagNameCheck, u) || b.tagNameCheck instanceof Function && b.tagNameCheck(u))) return !1;
			if (fe && !Ct[u]) {
				let y = dt(o$1) || o$1.parentNode, w = ne(o$1) || o$1.childNodes;
				if (w && y) {
					let B = w.length;
					for (let W = B - 1; W >= 0; --W) {
						let X = /* @__PURE__ */ ct(w[W], !0);
						X.__removalCount = (o$1.__removalCount || 0) + 1, y.insertBefore(X, /* @__PURE__ */ le(o$1));
					}
				}
			}
			return j(o$1), !0;
		}
		return o$1 instanceof E && !Ar(o$1) || (u === "noscript" || u === "noembed" || u === "noframes") && q(/<\/no(script|embed|frames)/i, o$1.innerHTML) ? (j(o$1), !0) : (gt && o$1.nodeType === qt.text && (n = o$1.textContent, ee([
			ce,
			de,
			ge
		], (y) => {
			n = /* @__PURE__ */ wt(n, y, " ");
		}), o$1.textContent !== n && (vt(t.removed, { element: /* @__PURE__ */ o$1.cloneNode() }), o$1.textContent = n)), Y(I.afterSanitizeElements, o$1, null), !1);
	}, "_sanitizeElements"), mi = /* @__PURE__ */ m(function(o$1, n, u) {
		if (ei && (n === "id" || n === "name") && (u in i || u in Er)) return !1;
		if (!(me && !ue[n] && q(yr, n))) {
			if (!(Je && q(br, n))) {
				if (!O[n] || ue[n]) {
					if (!(Ci(o$1) && (b.tagNameCheck instanceof RegExp && q(b.tagNameCheck, o$1) || b.tagNameCheck instanceof Function && b.tagNameCheck(o$1)) && (b.attributeNameCheck instanceof RegExp && q(b.attributeNameCheck, n) || b.attributeNameCheck instanceof Function && b.attributeNameCheck(n)) || n === "is" && b.allowCustomizedBuiltInElements && (b.tagNameCheck instanceof RegExp && q(b.tagNameCheck, u) || b.tagNameCheck instanceof Function && b.tagNameCheck(u)))) return !1;
				} else if (!xe[n]) {
					if (!q(Xe, /* @__PURE__ */ wt(u, Ye, ""))) {
						if (!((n === "src" || n === "xlink:href" || n === "href") && o$1 !== "script" && so(u, "data:") === 0 && oi[o$1])) {
							if (!(Qe && !q(Tr, /* @__PURE__ */ wt(u, Ye, "")))) {
								if (u) return !1;
							}
						}
					}
		...
		return !0;
	}, "_isValidAttribute"), Ci = /* @__PURE__ */ m(function(o$1) {
		return o$1 !== "annotation-xml" && Yi(o$1, kr);
	}, "_isBasicCustomElement"), pi = /* @__PURE__ */ m(function(o$1) {
		Y(I.beforeSanitizeAttributes, o$1, null);
		let { attributes: n } = o$1;
		if (!n || ke(o$1)) return;
		let u = {
			attrName: "",
			attrValue: "",
		...
		for (; y--;) {
			let { name: B, namespaceURI: W, value: X } = n[y], Lt = /* @__PURE__ */ _(B), Be = X, D = B === "value" ? Be : ao(Be);
			if (u.attrName = Lt, u.attrValue = D, u.keepAttr = !0, u.forceKeepAttr = void 0, Y(I.uponSanitizeAttribute, o$1, u), D = u.attrValue, ii && (Lt === "id" || Lt === "name") && (xt(B, o$1), D = Br + D), Rt && q(/((--!?|])>)|<\/(style|title)/i, D)) {
				xt(B, o$1);
				continue;
			}
			...
			let fi = /* @__PURE__ */ _(o$1.nodeName);
			if (!mi(fi, Lt, D)) {
				xt(B, o$1);
				continue;
			}
			...
			if (D !== Be) try {
				W ? o$1.setAttributeNS(W, B, D) : o$1.setAttribute(B, D), ke(o$1) ? j(o$1) : Vi(t.removed);
			} catch {
				xt(B, o$1);
			}
		}
		Y(I.afterSanitizeAttributes, o$1, null);
	}, "_sanitizeAttributes"), Mr = /* @__PURE__ */ m(function C(o$1) {
		let n = null, u = /* @__PURE__ */ di(o$1);
		for (Y(I.beforeSanitizeShadowDOM, o$1, null); n = /* @__PURE__ */ u.nextNode();) Y(I.uponSanitizeShadowNode, n, null), ui(n), pi(n), n.content instanceof d && C(n.content);
		Y(I.afterSanitizeShadowDOM, o$1, null);
	}, "_sanitizeShadowDOM");
	return t.sanitize = function(C) {
		let o$1 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = null, u = null, y = null, w = null;
		...
		if (Ce || Te(o$1), t.removed = [], typeof C == "string" && (St = !1), St) {
			if (C.nodeName) {
				let X = /* @__PURE__ */ _(C.nodeName);
				if (!L[X] || Bt[X]) throw Dt("root node is forbidden and cannot be sanitized in-place");
			}
		} else if (C instanceof x) n = /* @__PURE__ */ ci("<!---->"), u = /* @__PURE__ */ n.ownerDocument.importNode(C, !0), u.nodeType === qt.element && u.nodeName === "BODY" || u.nodeName === "HTML" ? n = u : n.appendChild(u);
		else {
			if (!ut && !gt && !st && C.indexOf("<") === -1) return M && Pt ? M.createHTML(C) : C;
			if (n = /* @__PURE__ */ ci(C), !n) return ut ? null : Pt ? kt : "";
		}
		n && pe && j(n.firstChild);
		let B = /* @__PURE__ */ di(St ? C : n);
		for (; y = /* @__PURE__ */ B.nextNode();) ui(y), pi(y), y.content instanceof d && Mr(y.content);
		if (St) return C;
		if (ut) {
			if (Wt) for (w = /* @__PURE__ */ pr.call(n.ownerDocument); n.firstChild;) w.appendChild(n.firstChild);
			else w = n;
			return (O.shadowroot || O.shadowrootmode) && (w = /* @__PURE__ */ xr.call(s, w, !0)), w;
		}
...
` + W), gt && ee([
		...
		Te(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), Ce = !0;
	}, t.clearConfig = function() {
		ft = null, Ce = !1;
	}, t.isValidAttribute = function(C, o$1, n) {
		ft || Te({});
		return mi(/* @__PURE__ */ _(C), /* @__PURE__ */ _(o$1), n);
	}, t.addHook = function(C, o$1) {
		typeof o$1 == "function" && vt(I[C], o$1);
	}, t.removeHook = function(C, o$1) {
		if (o$1 !== void 0) {
			let n = /* @__PURE__ */ ro(I[C], o$1);
...
var hr = /* @__PURE__ */ m((e) => (Bo(), yt.sanitize(e)), "removeScript"), ar = /* @__PURE__ */ m((e, t) => {
	...
	let s = [...e], l = /* @__PURE__ */ s.indexOf("~"), d = /* @__PURE__ */ s.lastIndexOf("~");
	...
	if (!(lr() || t.legacyMathML || t.forceLegacyMathML)) return e.replace(oe, "MathML is unsupported in this environment.");
	{
		let { default: i } = await __vitePreload(async () => {
			const { default: i$1 } = await import("./vendor-mermaid.VyCN2OC8.chunk.js");
			return { default: i$1 };
		}, __vite__mapDeps([0,1,2])), s = t.forceLegacyMathML || !lr() && t.legacyMathML ? "htmlAndMathml" : "mathml";
		return e.split(zt).map((l) => nr(l) ? `<div style="display: flex; align-items: center; justify-content: center; white-space: nowrap;">${l}</div>` : `<div>${l}</div>`).join("").replace(oe, (l, d) => i.renderToString(d, {
			throwOnError: !0,
			displayMode: !0,
			output: s
...
export { v as $, Z as A, jo as B, U as C, Wo as D, Vo as E, c as F, nr as G, ln as H, dr as I, pn as J, os as K, g as L, Zr as M, as as N, Xl as O, bi as P, tn as Q, hn as R, Ti as S, Uo as T, mr as U, jt as V, nn as W, rt as X, qo as Y, ss as Z, No as _, En as a, Pr as b, Ii as c, Kl as d, yt as et, Ko as f, Ni as g, Mt as h, Ao as i, Zl as j, Xo as k, Jl as l, Mo as m, $t as n, Go as o, Mn as p, ot as q, An as r, Ho as s, $o as t, zt as tt, Jt as u, On as v, Ui as w, Ql as x, Ot as y, je as z };
