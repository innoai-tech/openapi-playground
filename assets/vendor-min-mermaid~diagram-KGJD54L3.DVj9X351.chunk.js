...
import { m, g } from './vendor-min-mermaid~chunk-543QDF6V.CSpQVPcT.chunk.js';
import { L as Lt } from './vendor-min-mermaid~chunk-RGZHNYJS.BZGdGDWl.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { M as Mt, R as Ro, N as No, H as Ho, $ as $o, j as jo, G as Go, U as Uo, a as Pi, P as Po } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
import { f as $n, p as pt$1, g as He, P as Pn, U as Ua, i as ia } from './vendor-min-mermaid~chunk-BF7QJ6L7.DK9jwCiC.chunk.js';
var $ = class {
    constructor(){
        this.nodes = [];
        this.levels = new Map;
    ...
    clear() {
        Po(), this.nodes = [], this.levels = new Map, this.outerNodes = [], this.classes = new Map, this.root = void 0;
    }
};
function fe(m) {
    if (!m.length) return [];
...
var we = 10, F = 10, E = 25, Ne = /*#__PURE__*/ m$1((m$2, a, n, o)=>{
    let c = o.db, l = /*#__PURE__*/ c.getConfig(), d$1 = l.padding ?? we, u = /*#__PURE__*/ c.getDiagramTitle(), W = /*#__PURE__*/ c.getRoot(), { themeVariables: r } = Mt();
    if (!W) return;
    let P = u ? 30 : 0, T = /*#__PURE__*/ d(a), X = l.nodeWidth ? l.nodeWidth * F : 960, Y = l.nodeHeight ? l.nodeHeight * F : 500, G = X, q = Y + P;
    T.attr("viewBox", `0 0 ${G} ${q}`), Ro(T, q, G, l.useMaxWidth);
    let C;
    try {
        let e = l.valueFormat || ",";
    ...
    u && T.append("text").attr("x", G / 2).attr("y", P / 2).attr("class", "treemapTitle").attr("text-anchor", "middle").attr("dominant-baseline", "middle").text(u);
    ...
    R.append("rect").attr("width", (e)=>e.x1 - e.x0).attr("height", (e)=>e.y1 - e.y0).attr("class", "treemapLeaf").attr("fill", (e)=>e.parent ? A(e.parent.data.name) : A(e.data.name)).attr("style", (e)=>m({
        ...
        let t = /*#__PURE__*/ ia(this), s = e.x1 - e.x0, f = e.y1 - e.y0, S = /*#__PURE__*/ t.node(), b = 4, w = s - 2 * b, h = f - 2 * b;
        if (w < 10 || h < 10) {
        ...
        let S = /*#__PURE__*/ ia(f).select(".treemapLabel");
