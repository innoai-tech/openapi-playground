...
import { I as Ie$1, L as Le$1, w as we$1 } from './vendor-min-mermaid~chunk-YR5264OA.BCCprDC8.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { J as Jf, Q as Qf, Z as Zf, K as Kf, j as jf, X as Xf, t as tt$1, h as hh, k as kh, ap as rd, V as Vf, e as XC, O as Or, I as Il } from './vendor-min-mermaid~chunk-U6SPV2NK.BkMACcv9.chunk.js';
var u = {
    NORMAL: 0,
    REVERSE: 1,
    HIGHLIGHT: 2,
...
var he = Il.gitGraph, M = /*#__PURE__*/ m$1(()=>Le$1({
        ...he,
        ...Or().gitGraph
    }), "getConfig"), i = new s(()=>{
...
var fe = /*#__PURE__*/ m$1(function(r) {
    ...
    let n = /*#__PURE__*/ M();
    o = /*#__PURE__*/ XC.sanitizeText(o, n), e = /*#__PURE__*/ XC.sanitizeText(e, n), t = t?.map((s)=>XC.sanitizeText(s, n));
    let m = {
    ...
    if (e = /*#__PURE__*/ XC.sanitizeText(e, /*#__PURE__*/ M()), i.records.branches.has(e)) throw new Error(`Trying to create an existing branch. (Help: Either use a new name if you want create a new branch or try using "checkout ${e}")`);
    ...
    e = /*#__PURE__*/ XC.sanitizeText(e, n), o && (o = /*#__PURE__*/ XC.sanitizeText(o, n));
    ...
    let n = /*#__PURE__*/ M();
    if (e = /*#__PURE__*/ XC.sanitizeText(e, n), o = /*#__PURE__*/ XC.sanitizeText(o, n), a = a?.map((g)=>XC.sanitizeText(g, n)), t = /*#__PURE__*/ XC.sanitizeText(t, n), !e || !i.records.commits.has(e)) {
    ...
    if (r = /*#__PURE__*/ XC.sanitizeText(r, /*#__PURE__*/ M()), i.records.branches.has(r)) {
...
`, "id:", e, o), !w) throw new Error("GitGraph config not found");
    ...
    }), ie(s, L, false), w.showBranches && Qe(s, m), Xe(s, L), ie(s, L, true), Ie$1.insertTitle(s, "gitTitleText", w.titleTopMargin ?? 0, /*#__PURE__*/ n.getDiagramTitle()), rd(void 0, s, w.diagramPadding, w.useMaxWidth);
}, "draw"), de = {
    draw: tt
};
