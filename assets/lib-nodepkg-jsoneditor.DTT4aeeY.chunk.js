...
var _e, _t, _n;
var e, t, n, a;
import { c as r, I as i, j as l, a as o, r as s, s as d, b as p, d as c, e as u, f as h, T as y, F as m, o as f, t as x, g as v } from "./lib-nodepkg-vuekit.BXgk23Jh.chunk.js";
import { o as g, J as b, g as w, S as N, a as C, b as S, r as $, s as k, E as O } from "./lib-nodepkg-typedef.rFthNQ04.chunk.js";
import { s as E, a as I, P as T, v as A, b as D, B as R } from "./lib-nodepkg-vueuikit.CrgBAuzC.chunk.js";
import { I as J, a as L, m as P, b as M, c as B, d as _, e as W } from "./lib-nodepkg-vuematerial.B3Kxwgvu.chunk.js";
import { O as j, s as z, m as H, f as F, d as U, t as V, E as K, c as X, B as q, S as G } from "./vendor-rxjs.CJTxSfRI.chunk.js";
import { i as Q, g as Y, a as Z, b as ee, s as et, l as en, c as ea, d as er, e as ei } from "./vendor-innoai-tech-lodash.BqsjFXV_.chunk.js";
import { M as el } from "./lib-nodepkg-vuemarkdown.DleyKn0y.chunk.js";
...
let ef = E("div", { displayName: "PopoverContainer" })({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: A("sys.outline-variant", D(0.38)) }), ex = E("div", { displayName: "MenuItem" })({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), ev = o((e6, t2) => {
  ...
  let { slots: n2, render: a2 } = t2, r2 = eE.use(), i2 = s(es.use().error$, a2((t3) => {
    ...
    return c(eO, { "data-error": i3, "data-dirty": e6.dirty, style: { paddingLeft: `${32 * r2.indent}px` }, children: [(e6.title || e6.description) && l(e$, { style: { paddingLeft: `${32 * r2.indent}px` }, children: e6.description ? l(ev, { $title: l(eL, { children: l(el, { text: e6.description }) }), children: c("div", { children: [e6.title, " ", l(L, { path: P })] }) }) : l("span", { children: e6.title }) }), l(eJ, { children: (_a = n2.default) == null ? void 0 : _a.call(n2) }), i3 && l(ek, { children: `${t3[a3]}` })] });
  }));
...
let ez = r(() => new ej()), eH = o((e6, t2) => {
  ...
  return s(e6.value$, n2((t3) => l(eI, { openToken: "{", closeToken: "}", $leading: l(ec, { children: l(eB, { value: t3 }) }), $trailing: l(eG, { ctx: e6.ctx, onAdd: (t4) => {
    ...
    return c(eT, { path: d2, dirty: a2.isDirty(o2, d2), title: N.metaProp(s2, "title"), description: N.metaProp(s2, "description"), children: [l(eN, { deprecated: N.schemaProp(s2, "deprecated"), $leading: l(eX, { onRemove: () => {
      a2.delete(d2);
    } }), children: String(i2) }), c(ew, { children: [":", " "] }), (_a = r2.$value) == null ? void 0 : _a.call(r2, s2, o2, { ...e6.ctx, path: d2, branch: [...e6.ctx.branch, o2] })] });
  }) })));
  ...
  let v2 = s(u2, a2((e7) => l("div", { "data-input-wrapper": true, children: l("input", { ref: r2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)", "data-options": e7 }) })));
  return s(X([p2, u2, y2, e6.options$]), a2((t3) => {
    let [n3, a3, i2, s2] = t3;
    return s2 ? s2.length > 0 ? l(eT, { path: e6.ctx.path, children: l(eU, { sx: { mx: -4 }, children: l(em, { onSelected: (e7) => {
      x2(e7);
    }, open$: u2, $content: l("div", { children: s2.map((e7, t4) => n3 && !e7.propName.includes(n3) ? null : l(eQ, { propName: e7.propName, typedef: e7.typedef, "data-focus": t4 === i2.index % s2.length })) }), children: v2 }) }) }) : null : l(eT, { path: [...e6.ctx.path, N.RecordKey], children: l(eU, { sx: { mx: -4 }, children: l(T, { isOpen: a3, placement: "right-start", $content: c(eF, { children: [l(eu, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: l(L, { path: B }) }), l(eu, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: l(L, { path: _ }) })] }), children: l("div", { "data-input-wrapper": true, children: l("input", { ref: r2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)" }) }) }) }) });
  }));
}, { displayName: "PropValueInput", props: ["ctx", "options"], emits: ["add"] }), eQ = h((e6) => () => c(eY, { "data-value": e6.propName, tabindex: 0, children: [l(eN, { optional: N.schemaProp(e6.typedef, N.optional), children: e6.propName }), l(eL, { children: N.metaProp(e6.typedef, "title") })] }), { displayName: "PropMenuItem", props: ["propName", "typedef"] }), eY = E(ex, { displayName: "AddPropMenuItemContainer" })({ [`& ${eN}`]: { textAlign: "left" } }), eZ = o((e6, t2) => {
  let { render: n2 } = t2, a2 = es.use(), r2 = ed.use();
  return s(e6.value$, n2((t3) => l(eI, { openToken: "[", closeToken: "]", $leading: l(ec, { children: l(eB, { value: t3 }) }), $trailing: l(e0, { ctx: e6.ctx, typedef: e6.typedef, onAdd: (t4) => {
    ...
    return c(eT, { path: s2, dirty: a2.isDirty(i2, s2), children: [l(eN, { $leading: l(e1, { onRemove: () => {
      a2.delete(s2);
  ...
  let m2 = s(p2, a2((e7) => l(T, { isOpen: e7, placement: "right-start", $content: c(eF, { children: [l(eu, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: l(L, { path: B }) }), l(eu, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: l(L, { path: _ }) })] }), children: l("div", { "data-input-wrapper": true, children: l("input", { ref: r2, type: "text", placeholder: "添加数组项 (可粘贴 JSON 字符串)" }) }) })));
  ...
  return s(e6.value$, n2((t3) => l(eI, { openToken: "{", closeToken: "}", $leading: l(ec, { children: l(eB, { value: t3 }) }), $trailing: l(eG, { ctx: e6.ctx, onAdd: (t4) => {
    ...
    if (!Object.hasOwn(t3, i2)) return null;
    let d2 = [...e6.ctx.path, i2];
    return c(eT, { path: d2, dirty: a2.isDirty(o2, d2), children: [l(eN, { $leading: l(eX, { onRemove: () => {
      a2.delete(d2);
    } }), children: String(i2) }), c(ew, { children: [":", " "] }), (_a = r2.$value) == null ? void 0 : _a.call(r2, s2, o2, { ...e6.ctx, path: d2, branch: [...e6.ctx.branch, o2] })] });
  }) })));
  ...
  return s(a2, n2((e7) => {
    let t3 = r2.$value ?? e4;
    return l(ez, { children: l(ed, { value: { $value: r2.$value ?? e4 }, children: c(e5, { children: [l("section", { ref: i2 }), i2.value && l(eE, { value: { indent: 0, $container: i2 }, children: l(eT, { path: [], viewOnly: true, children: t3(a2.typedef, e7, O) }) })] }) }) });
  }));
