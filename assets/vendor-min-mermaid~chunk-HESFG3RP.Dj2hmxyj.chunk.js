...
import { X as Xe$1 } from "./vendor-min-mermaid~chunk-YM3XIQPS.DIMTnqRF.chunk.js";
import { t as tt$1, R as Rl, i as ih, C as Cf, g as gC, H as Hl } from "./vendor-min-mermaid~chunk-ZKYS2E5M.CwhZsQ7z.chunk.js";
...
`, e = e.substring(g.length + 1), c = true), !c) {
          let D = this.rules.other.nextBulletRegex(m), re = this.rules.other.hrRegex(m), se = this.rules.other.fencesBeginRegex(m), ie = this.rules.other.headingBeginRegex(m), _e2 = this.rules.other.htmlBeginRegex(m);
          for (; e; ) {
            let Z = e.split(`
`, 1)[0], C;
            if (g = Z, this.options.pedantic ? (g = g.replace(this.rules.other.listReplaceNesting, "  "), C = g) : C = g.replace(this.rules.other.tabCharGlobal, "    "), se.test(g) || ie.test(g) || _e2.test(g) || D.test(g) || re.test(g)) break;
...
`, e = e.substring(Z.length + 1), f = C.slice(m);
  ...
  table(e) {
    ...
    let n = de(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = ((_a2 = t[3]) == null ? void 0 : _a2.trim()) ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], s = {
      type: "table",
      raw: t[0],
      header: [],
...
`), this.blockTokens(e, this.tokens);
  ...
  blockTokens(e) {
    ...
    for (this.options.pedantic && (e = e.replace(b.tabCharGlobal, "    ").replace(b.spaceLine, "")); e; ) {
      let r;
      if ((_b2 = (_a2 = this.options.extensions) == null ? void 0 : _a2.block) == null ? void 0 : _b2.some((s) => (r = s.call({
        lexer: this
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = s.text) : t.push(r);
  ...
  inlineTokens(e) {
    ...
    for (; e; ) {
      i || (s = ""), i = false;
      let l;
      if ((_b2 = (_a2 = this.options.extensions) == null ? void 0 : _a2.inline) == null ? void 0 : _b2.some((c) => (l = c.call({
        lexer: this
