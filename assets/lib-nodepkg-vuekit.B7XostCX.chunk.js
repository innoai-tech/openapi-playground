import { i as isType, p as produce, e as custom, o as object } from './lib-nodepkg-typedef.CzjpWxrC.chunk.js';
import { p as pipe, e as from, O as Observable, S as Subject, b as map, t as tap, B as BehaviorSubject, i as isObservable } from './vendor-rxjs.BsXCl7Vk.chunk.js';
import { b as isFunction$2, p as partition, k as kebabCase, i as isPlainObject$1, a as isUndefined$1, d as isArray$2, h as isEmpty } from './vendor-innoai-tech-lodash.CDxVqk50.chunk.js';
...
function component(...args) {
  ...
  const [emits, props] = partition(
    Object.keys(finalPropTypes),
    (v) => /^on[A-Z]/.test(v)
  );
  const emitsAndProps = {
    emits: [
...
class ImmerBehaviorSubject extends Observable {
  ...
  next(valueOrUpdater, defaultValue) {
    const v = isFunction$2(valueOrUpdater) ? produce(this._value ?? defaultValue, valueOrUpdater) : valueOrUpdater;
...
const jsx = (type, rawProps, key)=>{
    ...
    if (isTagOrInternal(type)) {
        const children = slots?.default?.() ?? (isFragment(type) ? [] : void 0);
...
function render(renderFunc) {
  return (input$) => {
    return /* @__PURE__ */ jsx(RxSlot, { elem$: input$.pipe(map((v) => () => renderFunc(v))), children: {} });
  };
}
...
const observableRef = (value) => {
  ...
  const ref = customRef((track, trigger) => {
    return {
      ...
      set(value2) {
        const newValue = value2?.[SymbolForwardRef] ?? value2;
    ...
    get(_, p) {
      if (p === "next") {
        return (valueOrUpdater) => {
          ref.value = isFunction$2(valueOrUpdater) ? produce(store$.value, valueOrUpdater) : valueOrUpdater;
        };
      }
      if (p === "value") {
        return ref.value;
      }
      return store$[p] ?? ref[p];
    },
...
export { RouterLink as A, useRouter as B, useRoute as C, onUnmounted as D, Fragment as F, ImmerBehaviorSubject as I, RouterView as R, SymbolForwardRef as S, Teleport as T, component$ as a, cloneVNode as b, createProvider as c, jsxs as d, ref as e, component as f, ref$1 as g, render as h, Transition as i, jsx as j, onMounted as k, isComponent as l, isPropTypes as m, onBeforeMount as n, observableRef as o, onBeforeUnmount as p, toObservable as q, rx as r, subscribeUntilUnmount as s, tapEffect as t, unref as u, subscribeOnMountedUntilUnmount as v, watch as w, createRouter as x, createWebHistory as y, createApp as z };
