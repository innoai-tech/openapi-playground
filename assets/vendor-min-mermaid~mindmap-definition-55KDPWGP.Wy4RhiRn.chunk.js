import { F as Ft$1 } from "./vendor-min-mermaid~chunk-PWCSEZZ4.xEHpHduO.chunk.js";
import { d } from "./vendor-min-mermaid~chunk-3YFHLAX3.uIQbCDI_.chunk.js";
import { Z as Zt$1 } from "./vendor-min-mermaid~chunk-AFC6EC46.6qmv9LnR.chunk.js";
import { S } from "./vendor-min-mermaid~chunk-UENA7NWE.DfvA4zio.chunk.js";
import { m as m$1, q, n } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Q7R0ayzM.chunk.js";
import { t as tt, W as Wl, z as zl, d as dl, D as De, al as Wt$1, am as A, an as R, r as rh } from "./vendor-min-mermaid~chunk-OR2G2HG5.D15VT8Rm.chunk.js";
    ...
    return function(E) {
      ...
      function(E, I, o) {
        ...
        r.prototype.getSource = function() {
          ...
          for (var d2 = /* @__PURE__ */ this.getOtherEnd(f), s = /* @__PURE__ */ a.getGraphManager().getRoot(); ; ) {
            if (d2.getOwner() == a) return d2;
            if (d2.getOwner() == s) break;
            d2 = /* @__PURE__ */ d2.getOwner().getParent();
          }
          return null;
      ...
      function(E, I, o) {
        var i = /* @__PURE__ */ o(2), e = /* @__PURE__ */ o(10), t = /* @__PURE__ */ o(0), r = /* @__PURE__ */ o(6), l = /* @__PURE__ */ o(3), f = /* @__PURE__ */ o(1), a = /* @__PURE__ */ o(13), d2 = /* @__PURE__ */ o(12), s = /* @__PURE__ */ o(11);
        function c(v, m, T) {
        ...
        c.prototype.getNodes = function() {
          ...
          if (m == null && T == null) {
            ...
            return m.owner != T.owner ? null : (A2.source = m, A2.target = T, A2.isInterGraph = false, this.getEdges().push(A2), m.edges.push(A2), T != m && T.edges.push(A2), A2);
          }
          ...
          if (v instanceof l) {
            ...
            for (var T = /* @__PURE__ */ m.edges.slice(), y, A2 = T.length, O = 0; O < A2; O++) y = T[O], y.isInterGraph ? this.graphManager.remove(y) : y.source.owner.remove(y);
            var R2 = /* @__PURE__ */ this.nodes.indexOf(m);
            if (R2 == -1) throw "Node not in owner node list!";
            this.nodes.splice(R2, 1);
            ...
            var n2 = /* @__PURE__ */ y.source.edges.indexOf(y), h = /* @__PURE__ */ y.target.edges.indexOf(y);
            ...
            var R2 = /* @__PURE__ */ y.source.owner.getEdges().indexOf(y);
            if (R2 == -1) throw "Not in owner's edge list!";
            y.source.owner.getEdges().splice(R2, 1);
          }
        }, c.prototype.updateLeftTop = function() {
          for (var v = e.MAX_VALUE, m = e.MAX_VALUE, T, y, A2, O = /* @__PURE__ */ this.getNodes(), R2 = O.length, n2 = 0; n2 < R2; n2++) {
            var h = O[n2];
            T = /* @__PURE__ */ h.getTop(), y = /* @__PURE__ */ h.getLeft(), v > T && (v = T), m > y && (m = y);
          }
          return v == e.MAX_VALUE ? null : (O[0].getParent().paddingLeft != null ? A2 = O[0].getParent().paddingLeft : A2 = this.margin, this.left = m - A2, this.top = v - A2, new d2(this.left, this.top));
        }, c.prototype.updateBounds = function(v) {
          for (var m = e.MAX_VALUE, T = -e.MAX_VALUE, y = e.MAX_VALUE, A2 = -e.MAX_VALUE, O, R2, n2, h, g, p = this.nodes, D = p.length, N = 0; N < D; N++) {
            var M = p[N];
            v && M.child != null && M.updateBounds(), O = /* @__PURE__ */ M.getLeft(), R2 = /* @__PURE__ */ M.getRight(), n2 = /* @__PURE__ */ M.getTop(), h = /* @__PURE__ */ M.getBottom(), m > O && (m = O), T < R2 && (T = R2), y > n2 && (y = n2), A2 < h && (A2 = h);
          }
          var C = new a(m, y, T - m, A2 - y);
          ...
          for (var m = e.MAX_VALUE, T = -e.MAX_VALUE, y = e.MAX_VALUE, A2 = -e.MAX_VALUE, O, R2, n2, h, g = v.length, p = 0; p < g; p++) {
            var D = v[p];
            O = /* @__PURE__ */ D.getLeft(), R2 = /* @__PURE__ */ D.getRight(), n2 = /* @__PURE__ */ D.getTop(), h = /* @__PURE__ */ D.getBottom(), m > O && (m = O), T < R2 && (T = R2), y > n2 && (y = n2), A2 < h && (A2 = h);
          }
          var N = new a(m, y, T - m, A2 - y);
          return N;
          ...
          for (var v = 0, m = this.nodes, T = m.length, y = 0; y < T; y++) {
            var A2 = m[y];
            v += /* @__PURE__ */ A2.calcEstimatedSize();
          }
          ...
          var m = new s(), T = /* @__PURE__ */ new Set(), y = this.nodes[0], A2, O, R2 = /* @__PURE__ */ y.withChildren();
          for (R2.forEach(function(N) {
            m.push(N), T.add(N);
          }); m.length !== 0; ) {
            y = /* @__PURE__ */ m.shift(), A2 = /* @__PURE__ */ y.getEdges();
            for (var n2 = A2.length, h = 0; h < n2; h++) {
              var g = A2[h];
      ...
      function(E, I, o) {
        ...
        m$1(t, "LGraphManager"), t.prototype.addRoot = function() {
          ...
          if (f == null && a == null && d2 == null) {
            ...
            d2 = f, a = l, f = r;
            var s = /* @__PURE__ */ a.getOwner(), c = /* @__PURE__ */ d2.getOwner();
          ...
          for (var r, l, f, a, d2, s = /* @__PURE__ */ this.getAllEdges(), c = s.length, u = 0; u < c; u++) {
            ...
            for (a = /* @__PURE__ */ l.getOwner(); r.lca == null; ) {
              for (r.targetInLca = f, d2 = /* @__PURE__ */ f.getOwner(); r.lca == null; ) {
                if (d2 == a) {
                  r.lca = d2;
                  break;
                }
                ...
                r.targetInLca = /* @__PURE__ */ d2.getParent(), d2 = /* @__PURE__ */ r.targetInLca.getOwner();
              }
          ...
          for (var f, a = /* @__PURE__ */ r.getNodes(), d2 = a.length, s = 0; s < d2; s++) f = a[s], f.inclusionTreeDepth = l, f.child != null && this.calcInclusionTreeDepths(f.child, l + 1);
      ...
      function(E, I, o) {
        ...
        m$1(e, "IGeometry"), e.calcSeparationAmount = function(t, r, l, f) {
          ...
          var d2 = /* @__PURE__ */ Math.abs((r.getCenterY() - t.getCenterY()) / (r.getCenterX() - t.getCenterX()));
          ...
          var f = /* @__PURE__ */ t.getCenterX(), a = /* @__PURE__ */ t.getCenterY(), d2 = /* @__PURE__ */ r.getCenterX(), s = /* @__PURE__ */ r.getCenterY();
          if (t.intersects(r)) return l[0] = f, l[1] = a, l[2] = d2, l[3] = s, true;
          var c = /* @__PURE__ */ t.getX(), u = /* @__PURE__ */ t.getY(), v = /* @__PURE__ */ t.getRight(), m = /* @__PURE__ */ t.getX(), T = /* @__PURE__ */ t.getBottom(), y = /* @__PURE__ */ t.getRight(), A2 = /* @__PURE__ */ t.getWidthHalf(), O = /* @__PURE__ */ t.getHeightHalf(), R2 = /* @__PURE__ */ r.getX(), n2 = /* @__PURE__ */ r.getY(), h = /* @__PURE__ */ r.getRight(), g = /* @__PURE__ */ r.getX(), p = /* @__PURE__ */ r.getBottom(), D = /* @__PURE__ */ r.getRight(), N = /* @__PURE__ */ r.getWidthHalf(), M = /* @__PURE__ */ r.getHeightHalf(), C = false, w = false;
          if (f === d2) {
            ...
            if (f < d2) return l[0] = v, l[1] = a, l[2] = R2, l[3] = s, false;
          } else {
            var P = t.height / t.width, U = r.height / r.width, F = (s - a) / (d2 - f), x = void 0, G = void 0, S2 = void 0, _ = void 0, X = void 0, b = void 0;
            if (-P === F ? f > d2 ? (l[0] = m, l[1] = T, C = true) : (l[0] = v, l[1] = u, C = true) : P === F && (f > d2 ? (l[0] = c, l[1] = u, C = true) : (l[0] = y, l[1] = T, C = true)), -U === F ? d2 > f ? (l[2] = g, l[3] = p, w = true) : (l[2] = h, l[3] = n2, w = true) : U === F && (d2 > f ? (l[2] = R2, l[3] = n2, w = true) : (l[2] = D, l[3] = p, w = true)), C && w) return false;
            if (f > d2 ? a > s ? (x = /* @__PURE__ */ this.getCardinalDirection(P, F, 4), G = /* @__PURE__ */ this.getCardinalDirection(U, F, 2)) : (x = /* @__PURE__ */ this.getCardinalDirection(-P, F, 3), G = /* @__PURE__ */ this.getCardinalDirection(-U, F, 1)) : a > s ? (x = /* @__PURE__ */ this.getCardinalDirection(-P, F, 1), G = /* @__PURE__ */ this.getCardinalDirection(-U, F, 3)) : (x = /* @__PURE__ */ this.getCardinalDirection(P, F, 2), G = /* @__PURE__ */ this.getCardinalDirection(U, F, 4)), !C) switch (x) {
              case 1:
                _ = u, S2 = f + -O / F, l[0] = S2, l[1] = _;
                break;
              case 2:
                S2 = y, _ = a + A2 * F, l[0] = S2, l[1] = _;
                break;
              case 3:
                _ = T, S2 = f + O / F, l[0] = S2, l[1] = _;
                break;
              case 4:
                S2 = m, _ = a + -A2 * F, l[0] = S2, l[1] = _;
                break;
            }
            if (!w) switch (G) {
              case 1:
                b = n2, X = d2 + -M / F, l[2] = X, l[3] = b;
                break;
              case 2:
                X = D, b = s + N * F, l[2] = X, l[3] = b;
                break;
              case 3:
                b = p, X = d2 + M / F, l[2] = X, l[3] = b;
                break;
              case 4:
          ...
          var a = t.x, d2 = t.y, s = r.x, c = r.y, u = l.x, v = l.y, m = f.x, T = f.y, y = void 0, A2 = void 0, O = void 0, R2 = void 0, n2 = void 0, h = void 0, g = void 0, p = void 0, D = void 0;
          return O = c - d2, n2 = a - s, g = s * d2 - a * c, R2 = T - v, h = u - m, p = m * v - u * T, D = O * h - R2 * n2, D === 0 ? null : (y = (n2 * p - h * g) / D, A2 = (R2 * g - O * p) / D, new i(y, A2));
          ...
          if (y === 0) return false;
          var A2 = ((T - v) * (m - a) + (u - m) * (T - d2)) / y, O = ((d2 - c) * (m - a) + (s - a) * (T - d2)) / y;
          return 0 < A2 && A2 < 1 && 0 < O && O < 1;
        }, e.HALF_PI = 0.5 * Math.PI, e.ONE_AND_HALF_PI = 1.5 * Math.PI, e.TWO_PI = 2 * Math.PI, e.THREE_PI = 3 * Math.PI, E.exports = e;
      },
      function(E, I, o) {
        function i() {
        }
      ...
      function(E, I, o) {
        ...
        var t = /* @__PURE__ */ m$1(function(d2) {
          return {
            value: d2,
            next: null,
            prev: null
          };
        }, "nodeFrom"), r = /* @__PURE__ */ m$1(function(d2, s, c, u) {
          return d2 !== null ? d2.next = s : u.head = s, c !== null ? c.prev = s : u.tail = s, s.prev = d2, s.next = c, u.length++, s;
        }, "add"), l = /* @__PURE__ */ m$1(function(d2, s) {
      ...
      function(E, I, o) {
        ...
        m$1(i, "Point"), i.prototype.getX = function() {
          ...
          e.constructor.name == "Point" && t == null && r == null ? (r = e, this.setLocation(r.x, r.y)) : typeof e == "number" && typeof t == "number" && r == null && (parseInt(e) == e && parseInt(t) == t ? this.move(e, t) : (this.x = /* @__PURE__ */ Math.floor(e + 0.5), this.y = /* @__PURE__ */ Math.floor(t + 0.5)));
      ...
      function(E, I, o) {
        ...
        var e = /* @__PURE__ */ o(0), t = /* @__PURE__ */ o(6), r = /* @__PURE__ */ o(3), l = /* @__PURE__ */ o(1), f = /* @__PURE__ */ o(5), a = /* @__PURE__ */ o(4), d2 = /* @__PURE__ */ o(17), s = /* @__PURE__ */ o(27);
        function c(u) {
        ...
        m$1(c, "Layout"), c.RANDOM_SEED = 1, c.prototype = /* @__PURE__ */ Object.create(s.prototype), c.prototype.getGraphManager = function() {
          ...
          if (u == null) this.update2();
            ...
            var A2 = u;
            if (A2.vGraphObject != null) {
              var O = A2.vGraphObject;
              O.update(A2);
            }
          } else if (u instanceof f) {
            var R2 = u;
            if (R2.vGraphObject != null) {
              var n2 = R2.vGraphObject;
              n2.update(R2);
            }
          }
          ...
          if (u == null) this.transform(new a(0, 0));
            ...
            var v = new d2(), m = /* @__PURE__ */ this.graphManager.getRoot().updateLeftTop();
            if (m != null) {
              v.setWorldOrgX(u.x), v.setWorldOrgY(u.y), v.setDeviceOrgX(m.x), v.setDeviceOrgY(m.y);
              for (var T = /* @__PURE__ */ this.getAllNodes(), y, A2 = 0; A2 < T.length; A2++) y = T[A2], y.transform(v);
            }
          }
          ...
          if (!T) return u;
          var A2 = /* @__PURE__ */ new Set(), O = [], R2 = /* @__PURE__ */ new Map(), n2 = [];
          for (n2 = /* @__PURE__ */ n2.concat(m); n2.length > 0 && v; ) {
            for (O.push(n2[0]); O.length > 0 && v; ) {
              var h = O[0];
              O.splice(0, 1), A2.add(h);
              for (var g = /* @__PURE__ */ h.getEdges(), y = 0; y < g.length; y++) {
                var p = /* @__PURE__ */ g[y].getOtherEnd(h);
                if (R2.get(h) != p) if (!A2.has(p)) O.push(p), R2.set(p, h);
                else {
                  v = false;
                  break;
                }
            ...
            if (!v) u = [];
              ...
              var D = /* @__PURE__ */ [].concat(/* @__PURE__ */ i(A2));
              u.push(D);
              for (var y = 0; y < D.length; y++) {
                var N = D[y], M = /* @__PURE__ */ n2.indexOf(N);
                M > -1 && n2.splice(M, 1);
              }
              A2 = /* @__PURE__ */ new Set(), R2 = /* @__PURE__ */ new Map();
            }
          }
          return u;
          ...
          for (var v = [], m = u.source, T = /* @__PURE__ */ this.graphManager.calcLowestCommonAncestor(u.source, u.target), y = 0; y < u.bendpoints.length; y++) {
            var A2 = /* @__PURE__ */ this.newNode(null);
            A2.setRect(new Point(0, 0), new Dimension(1, 1)), T.add(A2);
            var O = /* @__PURE__ */ this.newEdge(null);
            this.graphManager.add(O, m, A2), v.add(A2), m = A2;
          }
          var O = /* @__PURE__ */ this.newEdge(null);
          ...
          for (var v = 0; v < u.length; v++) {
            ...
            if (m.bendpoints.length > 0) {
              for (var T = /* @__PURE__ */ this.edgeToDummyNodes.get(m), y = 0; y < T.length; y++) {
                var A2 = T[y], O = new a(A2.getCenterX(), A2.getCenterY()), R2 = /* @__PURE__ */ m.bendpoints.get(y);
                R2.x = O.x, R2.y = O.y, A2.getOwner().remove(A2);
              }
          ...
          if (m != null && T != null) {
            ...
            var R2, n2;
            return u <= 50 ? (R2 = 9 * v / 500, n2 = v / 10) : (R2 = 9 * v / 50, n2 = -8 * v), R2 * u + n2;
          }
        }, c.findCenterOfTree = function(u) {
          var v = [];
          v = /* @__PURE__ */ v.concat(u);
          var m = [], T = /* @__PURE__ */ new Map(), y = false, A2 = null;
          (v.length == 1 || v.length == 2) && (y = true, A2 = v[0]);
          for (var O = 0; O < v.length; O++) {
            var R2 = v[O], n2 = R2.getNeighborsList().size;
            T.set(R2, R2.getNeighborsList().size), n2 == 1 && m.push(R2);
          }
          var h = [];
          for (h = /* @__PURE__ */ h.concat(m); !y; ) {
            ...
            for (var O = 0; O < v.length; O++) {
              var R2 = v[O], p = /* @__PURE__ */ v.indexOf(R2);
              p >= 0 && v.splice(p, 1);
              var D = /* @__PURE__ */ R2.getNeighborsList();
            ...
            m = /* @__PURE__ */ m.concat(h), (v.length == 1 || v.length == 2) && (y = true, A2 = v[0]);
          }
          return A2;
      ...
      function(E, I, o) {
        ...
        a.prototype.initParameters = function() {
          ...
          var s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, c = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, u, v, m, T, y = /* @__PURE__ */ this.getAllNodes(), A2;
          if (this.useFRGridVariant) for (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && s && this.updateGrid(), A2 = /* @__PURE__ */ new Set(), u = 0; u < y.length; u++) m = y[u], this.calculateRepulsionForceOfANode(m, A2, s, c), A2.add(m);
          ...
          var u = /* @__PURE__ */ s.getSource(), v = /* @__PURE__ */ s.getTarget(), m, T, y, A2;
          ...
          m = /* @__PURE__ */ s.getLength(), m != 0 && (T = this.springConstant * (m - c), y = T * (s.lengthX / m), A2 = T * (s.lengthY / m), u.springForceX += y, u.springForceY += A2, v.springForceX -= y, v.springForceY -= A2);
        }, a.prototype.calcRepulsionForce = function(s, c) {
          var u = /* @__PURE__ */ s.getRect(), v = /* @__PURE__ */ c.getRect(), m = new Array(2), T = new Array(4), y, A2, O, R2, n2, h, g;
          if (u.intersects(v)) {
          ...
          } else this.uniformLeafNodeSizes && s.getChild() == null && c.getChild() == null ? (y = v.getCenterX() - u.getCenterX(), A2 = v.getCenterY() - u.getCenterY()) : (l.getIntersection(u, v, T), y = T[2] - T[0], A2 = T[3] - T[1]), Math.abs(y) < t.MIN_REPULSION_DIST && (y = f.sign(y) * t.MIN_REPULSION_DIST), Math.abs(A2) < t.MIN_REPULSION_DIST && (A2 = f.sign(A2) * t.MIN_REPULSION_DIST), O = y * y + A2 * A2, R2 = /* @__PURE__ */ Math.sqrt(O), n2 = this.repulsionConstant * s.noOfChildren * c.noOfChildren / O, h = n2 * y / R2, g = n2 * A2 / R2, s.repulsionForceX -= h, s.repulsionForceY -= g, c.repulsionForceX += h, c.repulsionForceY += g;
        }, a.prototype.calcGravitationalForce = function(s) {
          var c, u, v, m, T, y, A2, O;
          c = /* @__PURE__ */ s.getOwner(), u = (c.getRight() + c.getLeft()) / 2, v = (c.getTop() + c.getBottom()) / 2, m = s.getCenterX() - u, T = s.getCenterY() - v, y = Math.abs(m) + s.getWidth() / 2, A2 = Math.abs(T) + s.getHeight() / 2, s.getOwner() == this.graphManager.getRoot() ? (O = c.getEstimatedSize() * this.gravityRangeFactor, (y > O || A2 > O) && (s.gravitationForceX = -this.gravityConstant * m, s.gravitationForceY = -this.gravityConstant * T)) : (O = c.getEstimatedSize() * this.compoundGravityRangeFactor, (y > O || A2 > O) && (s.gravitationForceX = -this.gravityConstant * m * this.compoundGravityConstant, s.gravitationForceY = -this.gravityConstant * T * this.compoundGravityConstant));
          ...
          for (var A2 = v; A2 <= m; A2++) for (var O = T; O <= y; O++) this.grid[A2][O].push(s), s.setGridCoordinates(v, m, T, y);
          ...
          if (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && u || v) {
            ...
            for (var T, y = this.grid, A2 = s.startX - 1; A2 < s.finishX + 2; A2++) for (var O = s.startY - 1; O < s.finishY + 2; O++) if (!(A2 < 0 || O < 0 || A2 >= y.length || O >= y[0].length)) {
              for (var R2 = 0; R2 < y[A2][O].length; R2++) if (T = y[A2][O][R2], !(s.getOwner() != T.getOwner() || s == T) && !c.has(T) && !m.has(T)) {
          ...
          for (A2 = 0; A2 < s.surrounding.length; A2++) this.calcRepulsionForce(s, s.surrounding[A2]);
      ...
      function(E, I, o) {
        ...
        var t = /* @__PURE__ */ o(11), r = /* @__PURE__ */ function() {
          function l(f, a) {
            ...
            var d2 = void 0;
            f instanceof t ? d2 = /* @__PURE__ */ f.size() : d2 = f.length, this._quicksort(f, 0, d2 - 1);
          }
          return m$1(l, "Quicksort"), i(l, [
            {
              key: "_quicksort",
              value: /* @__PURE__ */ m$1(function(a, d2, s) {
                if (d2 < s) {
                  var c = /* @__PURE__ */ this._partition(a, d2, s);
            ...
            },
            {
              key: "_partition",
              value: /* @__PURE__ */ m$1(function(a, d2, s) {
                for (var c = /* @__PURE__ */ this._get(a, d2), u = d2, v = s; ; ) {
            ...
            {
              key: "_get",
              value: /* @__PURE__ */ m$1(function(a, d2) {
            ...
            },
            {
              key: "_swap",
              value: /* @__PURE__ */ m$1(function(a, d2, s) {
                var c = /* @__PURE__ */ this._get(a, d2);
                this._set(a, d2, /* @__PURE__ */ this._get(a, s)), this._set(a, s, c);
              }, "_swap")
            },
            {
          ...
          return m$1(r, "NeedlemanWunsch"), i(r, [
            ...
            },
            {
              ...
              value: /* @__PURE__ */ m$1(function(f, a) {
                for (var d2 = [], s = -1; (s = /* @__PURE__ */ f.indexOf(a, s + 1)) !== -1; ) d2.push(s);
                return d2;
              }, "getAllIndexes")
            },
            {
    ...
    return function(I) {
      ...
      function(I, o, i) {
        ...
        r.prototype.move = function() {
          ...
          for (var d2 = /* @__PURE__ */ this.getChild().getNodes(), s, c = 0; c < d2.length; c++) s = d2[c], s.getChild() == null ? (s.moveBy(f, a), s.displacementX += f, s.displacementY += a) : s.propogateDisplacementToChildren(f, a);
      ...
      function(I, o, i) {
        var e = i(0).FDLayout, t = /* @__PURE__ */ i(4), r = /* @__PURE__ */ i(3), l = /* @__PURE__ */ i(5), f = /* @__PURE__ */ i(2), a = /* @__PURE__ */ i(1), d2 = i(0).FDLayoutConstants, s = i(0).LayoutConstants, c = i(0).Point, u = i(0).PointD, v = i(0).Layout, m = i(0).Integer, T = i(0).IGeometry, y = i(0).LGraph, A2 = i(0).Transform;
        function O() {
          e.call(this), this.toBeTiled = {};
        }
        m$1(O, "CoSELayout"), O.prototype = /* @__PURE__ */ Object.create(e.prototype);
        for (var R2 in e) O[R2] = e[R2];
        O.prototype.newGraphManager = function() {
          ...
          if (this.nodesWithGravity = /* @__PURE__ */ this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
            ...
            var n2 = /* @__PURE__ */ this.getFlatForest();
          ...
          if (this.isTreeGrowing) {
            if (this.growTreeIterations % 10 == 0) if (this.prunedNodesAll.length > 0) {
              ...
              var n2 = new Set(this.getAllNodes()), h = /* @__PURE__ */ this.nodesWithGravity.filter(function(D) {
                return n2.has(D);
              });
          ...
          for (var n2 = /* @__PURE__ */ this.graphManager.getAllNodes(), h = {}, g = 0; g < n2.length; g++) {
          ...
          if (d2.ANIMATE === "during") this.emit("layoutstarted");
            ...
            for (; !n2; ) n2 = /* @__PURE__ */ this.tick();
            this.graphManager.updateBounds();
          }
        }, O.prototype.calculateNodesToApplyGravitationTo = function() {
          var n2 = [], h, g = /* @__PURE__ */ this.graphManager.getGraphs(), p = g.length, D;
          for (D = 0; D < p; D++) h = g[D], h.updateConnected(), h.isConnected || (n2 = /* @__PURE__ */ n2.concat(/* @__PURE__ */ h.getNodes()));
          return n2;
        }, O.prototype.createBendpoints = function() {
          var n2 = [];
          n2 = /* @__PURE__ */ n2.concat(/* @__PURE__ */ this.graphManager.getAllEdges());
          ...
          for (var h = new c(0, 0), g = /* @__PURE__ */ Math.ceil(/* @__PURE__ */ Math.sqrt(n2.length)), p = 0, D = 0, N = 0, M = new u(0, 0), C = 0; C < n2.length; C++) {
            C % g == 0 && (N = 0, D = p, C != 0 && (D += a.DEFAULT_COMPONENT_SEPERATION), p = 0);
            var w = n2[C], P = /* @__PURE__ */ v.findCenterOfTree(w);
          ...
          var p = /* @__PURE__ */ Math.max(/* @__PURE__ */ this.maxDiagonalInTree(n2), a.DEFAULT_RADIAL_SEPARATION);
          O.branchRadialLayout(h, null, 0, 359, 0, p);
          var D = /* @__PURE__ */ y.calculateBounds(n2), N = new A2();
          ...
          n2.setCenter(U, F);
          var x = [];
          x = /* @__PURE__ */ x.concat(/* @__PURE__ */ n2.getEdges());
          var G = x.length;
          h != null && G--;
          for (var S2 = 0, _ = x.length, X, b = /* @__PURE__ */ n2.getEdgesBetween(h); b.length > 1; ) {
            var H = b[0];
            b.splice(0, 1);
          ...
          for (var B = Math.abs(p - g) / G, Y = X; S2 != G; Y = ++Y % _) {
            var K = /* @__PURE__ */ x[Y].getOtherEnd(n2);
            if (K != h) {
          ...
          for (var h = m.MIN_VALUE, g = 0; g < n2.length; g++) {
            var p = n2[g], D = /* @__PURE__ */ p.getDiagonal();
            D > h && (h = D);
          }
          return h;
          ...
          Object.keys(h).forEach(function(w) {
            if (h[w].length > 1) {
              ...
              var U = /* @__PURE__ */ h[w][0].getParent(), F = new l(n2.graphManager);
              F.id = P, F.paddingLeft = U.paddingLeft || 0, F.paddingRight = U.paddingRight || 0, F.paddingBottom = U.paddingBottom || 0, F.paddingTop = U.paddingTop || 0, n2.idToDummyNode[P] = F;
              var x = /* @__PURE__ */ n2.getGraphManager().add(/* @__PURE__ */ n2.newGraph(), F), G = /* @__PURE__ */ U.getChild();
              G.add(F);
          ...
          for (var g = 0; g < this.compoundOrder.length; g++) h[this.compoundOrder[g].id] = this.compoundOrder[g], n2[this.compoundOrder[g].id] = /* @__PURE__ */ [].concat(/* @__PURE__ */ this.compoundOrder[g].getChild().getNodes()), this.graphManager.remove(/* @__PURE__ */ this.compoundOrder[g].getChild()), this.compoundOrder[g].child = null;
          ...
          Object.keys(this.memberGroups).forEach(function(g) {
            ...
            h[g] = /* @__PURE__ */ n2.tileNodes(n2.memberGroups[g], p.paddingLeft + p.paddingRight), p.rect.width = h[g].width, p.rect.height = h[g].height;
          });
          ...
          for (var h = n2.id, g = /* @__PURE__ */ n2.getEdges(), p = 0, D = 0; D < g.length; D++) {
            var N = g[D];
            N.getSource().id !== N.getTarget().id && (p = p + 1);
          }
          return p;
        }, O.prototype.getNodeDegreeWithChildren = function(n2) {
          var h = /* @__PURE__ */ this.getNodeDegree(n2);
          if (n2.getChild() == null) return h;
          for (var g = /* @__PURE__ */ n2.getChild().getNodes(), p = 0; p < g.length; p++) {
            var D = g[p];
          ...
          this.tiledMemberPack = [], Object.keys(n2).forEach(function(p) {
            var D = h[p];
            g.tiledMemberPack[p] = /* @__PURE__ */ g.tileNodes(n2[p], D.paddingLeft + D.paddingRight), D.rect.width = g.tiledMemberPack[p].width, D.rect.height = g.tiledMemberPack[p].height;
          });
          ...
          var p = /* @__PURE__ */ this.getShortestRowIndex(n2);
          if (p < 0) return true;
          var D = n2.rowWidth[p];
          ...
          var h = /* @__PURE__ */ this.getLongestRowIndex(n2), g = n2.rowWidth.length - 1, p = n2.rows[h], D = p[p.length - 1], N = D.width + n2.horizontalPadding;
  ...
  m$1(function(I, o) {
    ...
    return function(I) {
      ...
      function(I, o, i) {
        ...
        function c(T, y) {
          var A2 = {};
          for (var O in T) A2[O] = T[O];
          for (var O in y) A2[O] = y[O];
          return A2;
        }
        m$1(c, "extend");
        function u(T) {
        ...
        u.prototype.run = function() {
          var T, y, A2 = this.options;
          this.idToLNode = {};
          var R2 = this.layout = new l(), n2 = this;
          n2.stopped = false, this.cy = this.options.cy, this.cy.trigger({
            type: "layoutstart",
            layout: this
          });
          var h = /* @__PURE__ */ R2.newGraphManager();
          this.gm = h;
          var g = /* @__PURE__ */ this.options.eles.nodes(), p = /* @__PURE__ */ this.options.eles.edges();
          this.root = /* @__PURE__ */ h.addRoot(), this.processChildrenList(this.root, /* @__PURE__ */ this.getTopMostNodes(g), R2);
          for (var D = 0; D < p.length; D++) {
            var N = p[D], M = this.idToLNode[N.data("source")], C = this.idToLNode[N.data("target")];
            if (M !== C && M.getEdgesBetween(C).length == 0) {
              var w = /* @__PURE__ */ h.add(/* @__PURE__ */ R2.newEdge(), M, C);
              w.id = /* @__PURE__ */ N.id();
            }
          }
          var P = /* @__PURE__ */ m$1(function(x, G) {
            typeof x == "number" && (x = G);
            var S2 = /* @__PURE__ */ x.data("id"), _ = n2.idToLNode[S2];
            return {
            ...
            for (var x = /* @__PURE__ */ m$1(function() {
              A2.fit && A2.cy.fit(A2.eles, A2.padding), T || (T = true, n2.cy.one("layoutready", A2.ready), n2.cy.trigger({
                type: "layoutready",
                layout: n2
              }));
            }, "afterReposition"), G = n2.options.refresh, S2, _ = 0; _ < G && !S2; _++) S2 = n2.stopped || n2.layout.tick();
            if (S2) {
              R2.checkLayoutSuccess() && !R2.isSubLayout && R2.doPostLayout(), R2.tilingPostLayout && R2.tilingPostLayout(), R2.isLayoutFinished = true, n2.options.eles.nodes().positions(P), x(), n2.cy.one("layoutstop", n2.options.stop), n2.cy.trigger({
                type: "layoutstop",
                layout: n2
              }), y && cancelAnimationFrame(y), T = false;
              return;
            }
            var X = /* @__PURE__ */ n2.layout.getPositionsData();
            A2.eles.nodes().positions(function(b, H) {
          ...
          return R2.addListener("layoutstarted", function() {
            n2.options.animate === "during" && (y = /* @__PURE__ */ requestAnimationFrame(U));
          }), R2.runLayout(), this.options.animate !== "during" && (n2.options.eles.nodes().not(":parent").layoutPositions(n2, n2.options, P), T = false), this;
        }, u.prototype.getTopMostNodes = function(T) {
          for (var y = {}, A2 = 0; A2 < T.length; A2++) y[T[A2].id()] = true;
          var O = /* @__PURE__ */ T.filter(function(R2, n2) {
            typeof R2 == "number" && (R2 = n2);
            for (var h = R2.parent()[0]; h != null; ) {
          ...
          return O;
        }, u.prototype.processChildrenList = function(T, y, A2) {
          for (var O = y.length, R2 = 0; R2 < O; R2++) {
            var n2 = y[R2], h = /* @__PURE__ */ n2.children(), g, p = /* @__PURE__ */ n2.layoutDimensions({
              nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels
            });
            if (n2.outerWidth() != null && n2.outerHeight() != null ? g = /* @__PURE__ */ T.add(new f(A2.graphManager, new a(n2.position("x") - p.w / 2, n2.position("y") - p.h / 2), new d2(parseFloat(p.w), parseFloat(p.h)))) : g = /* @__PURE__ */ T.add(new f(this.graphManager)), g.id = /* @__PURE__ */ n2.data("id"), g.paddingLeft = /* @__PURE__ */ parseInt(/* @__PURE__ */ n2.css("padding")), g.paddingTop = /* @__PURE__ */ parseInt(/* @__PURE__ */ n2.css("padding")), g.paddingRight = /* @__PURE__ */ parseInt(/* @__PURE__ */ n2.css("padding")), g.paddingBottom = /* @__PURE__ */ parseInt(/* @__PURE__ */ n2.css("padding")), this.options.nodeDimensionsIncludeLabels && n2.isParent()) {
              var D = n2.boundingBox({
                ...
                includeLabels: true,
                includeNodes: false
              }).h, M = /* @__PURE__ */ n2.css("text-halign");
            ...
            if (this.idToLNode[n2.data("id")] = g, isNaN(g.rect.x) && (g.rect.x = 0), isNaN(g.rect.y) && (g.rect.y = 0), h != null && h.length > 0) {
              var C;
              C = /* @__PURE__ */ A2.getGraphManager().add(/* @__PURE__ */ A2.newGraph(), g), this.processChildrenList(C, h, A2);
            }
          }
...
var gt = /* @__PURE__ */ function() {
  var E = /* @__PURE__ */ m$1(function(R2, n2, h, g) {
    for (h = h || {}, g = R2.length; g--; h[R2[g]] = n2) ;
    return h;
  }, "o"), I = [
    1,
    4
    ...
    performAction: /* @__PURE__ */ m$1(function(n2, h, g, p, D, N, M) {
      var C = N.length - 1;
      switch (D) {
        case 6:
        case 7:
    ...
    parseError: /* @__PURE__ */ m$1(function(n2, h) {
    ...
    parse: /* @__PURE__ */ m$1(function(n2) {
      var h = this, g = [
        0
      ], p = [], D = [
        null
      ], N = [], M = this.table, C = "", w = 0, P = 0, U = 0, F = 2, x = 1, G = /* @__PURE__ */ N.slice.call(arguments, 1), S2 = /* @__PURE__ */ Object.create(this.lexer), _ = {
        yy: {}
      };
      ...
      function B() {
        var W;
        return W = p.pop() || S2.lex() || x, typeof W != "number" && (W instanceof Array && (p = W, W = /* @__PURE__ */ p.pop()), W = h.symbols_[W] || W), W;
      }
      m$1(B, "lex");
...
Expecting ` + at.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : ht = "Parse error on line " + (w + 1) + ": Unexpected " + (Y == x ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(ht, {
    ...
    var R2 = {
      ...
      setInput: /* @__PURE__ */ m$1(function(n2, h) {
      ...
      input: /* @__PURE__ */ m$1(function() {
        ...
        var h = /* @__PURE__ */ n2.match(/(?:\r\n?|\n).*/g);
        return h ? (this.yylineno++, this.yylloc.last_line++) : this.yylloc.last_column++, this.options.ranges && this.yylloc.range[1]++, this._input = /* @__PURE__ */ this._input.slice(1), n2;
      }, "input"),
      unput: /* @__PURE__ */ m$1(function(n2) {
        var h = n2.length, g = /* @__PURE__ */ n2.split(/(?:\r\n?|\n)/g);
        this._input = n2 + this._input, this.yytext = /* @__PURE__ */ this.yytext.substr(0, this.yytext.length - h), this.offset -= h;
...
` + this.showPosition(), {
      ...
      less: /* @__PURE__ */ m$1(function(n2) {
        this.unput(/* @__PURE__ */ this.match.slice(n2));
      }, "less"),
      pastInput: /* @__PURE__ */ m$1(function() {
        var n2 = /* @__PURE__ */ this.matched.substr(0, this.matched.length - this.match.length);
        return (n2.length > 20 ? "..." : "") + n2.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      upcomingInput: /* @__PURE__ */ m$1(function() {
        var n2 = this.match;
        return n2.length < 20 && (n2 += /* @__PURE__ */ this._input.substr(0, 20 - n2.length)), (n2.substr(0, 20) + (n2.length > 20 ? "..." : "")).replace(/\n/g, "");
      }, "upcomingInput"),
      showPosition: /* @__PURE__ */ m$1(function() {
        var n2 = /* @__PURE__ */ this.pastInput(), h = /* @__PURE__ */ new Array(n2.length + 1).join("-");
        return n2 + this.upcomingInput() + `
` + h + "^";
      }, "showPosition"),
      test_match: /* @__PURE__ */ m$1(function(n2, h) {
        var g, p, D;
        ...
        }, this.options.ranges && (D.yylloc.range = /* @__PURE__ */ this.yylloc.range.slice(0))), p = /* @__PURE__ */ n2[0].match(/(?:\r\n?|\n).*/g), p && (this.yylineno += p.length), this.yylloc = {
        ...
        ]), this._more = false, this._backtrack = false, this._input = /* @__PURE__ */ this._input.slice(n2[0].length), this.matched += n2[0], g = /* @__PURE__ */ this.performAction.call(this, this.yy, this, h, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), g) return g;
        if (this._backtrack) {
      ...
      next: /* @__PURE__ */ m$1(function() {
        ...
        for (var D = /* @__PURE__ */ this._currentRules(), N = 0; N < D.length; N++) if (g = /* @__PURE__ */ this._input.match(this.rules[D[N]]), g && (!h || g[0].length > h[0].length)) {
          if (h = g, p = N, this.options.backtrack_lexer) {
            if (n2 = /* @__PURE__ */ this.test_match(g, D[N]), n2 !== false) return n2;
            if (this._backtrack) {
              h = false;
              continue;
            } else return false;
        ...
        return h ? (n2 = /* @__PURE__ */ this.test_match(h, D[p]), n2 !== false ? n2 : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var V = [], Mt = 0, ut = {}, Yt = /* @__PURE__ */ m$1(() => {
  ...
  let e = /* @__PURE__ */ Wl(), t = ((_a = e.mindmap) == null ? void 0 : _a.padding) ?? dl.mindmap.padding;
  switch (i) {
    case k.ROUNDED_RECT:
    case k.RECT:
    case k.HEXAGON:
  ...
  let r = {
    id: Mt++,
    nodeId: /* @__PURE__ */ De(I, e),
    level: E,
    descr: /* @__PURE__ */ De(o, e),
    type: i,
    children: [],
    width: ((_b = e.mindmap) == null ? void 0 : _b.maxNodeWidth) ?? dl.mindmap.maxNodeWidth,
    padding: t
  }, l = /* @__PURE__ */ Xt(E);
  ...
  if (!E) return;
  let I = /* @__PURE__ */ Wl(), o = V[V.length - 1];
  E.icon && (o.icon = /* @__PURE__ */ De(E.icon, I)), E.class && (o.class = /* @__PURE__ */ De(E.class, I));
...
var zt = 12, Kt = /* @__PURE__ */ m$1(function(E, I, o, i) {
  ...
  I.append("path").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E.type2Str(o.type)).attr("d", `M0 0 a${t},${t} 0 0,1 ${i * 0.25},${-1 * i * 0.1}
  ...
  I.append("path").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E.type2Str(o.type)).attr("d", `M0 0 a${t},${t} 1 0,0 ${i * 0.25},${-1 * e * 0.1}
...
var ie = /* @__PURE__ */ m$1(function(E, I, o) {
  ...
  let a = /* @__PURE__ */ l.append("g"), d2 = /* @__PURE__ */ l.append("g"), s = /* @__PURE__ */ o.descr.replace(/(<br\/*>)/g, `
`);
  await Zt$1(d2, s, {
    useHtmlLabels: t,
    width: o.width,
  ...
  let c = /* @__PURE__ */ d2.node().getBBox(), [u] = S(e.fontSize);
  if (o.height = c.height + u * 1.1 * 0.5 + o.padding, o.width = c.width + 2 * o.padding, o.icon) if (o.type === E.nodeType.CIRCLE) o.height += 50, o.width += 50, l.append("foreignObject").attr("height", "50px").attr("width", o.width).attr("style", "text-align: center;").append("div").attr("class", "icon-container").append("i").attr("class", "node-icon-" + r + " " + o.icon), d2.attr("transform", "translate(" + o.width / 2 + ", " + (o.height / 2 - 1.5 * o.padding) + ")");
  else {
    o.width += 50;
    let v = o.height;
...
function ae(E, I) {
  return new Promise((o) => {
    let i = /* @__PURE__ */ rh("body").append("div").attr("id", "cy").attr("style", "display:none"), e = /* @__PURE__ */ Ft$1({
...
` + E);
  ...
  se(f, d$1), oe(e, d$1), zl(void 0, l, ((_a = r.mindmap) == null ? void 0 : _a.padding) ?? dl.mindmap.padding, ((_b = r.mindmap) == null ? void 0 : _b.useMaxWidth) ?? dl.mindmap.useMaxWidth);
}, "draw"), bt = {
  draw: he
};
var le = /* @__PURE__ */ m$1((E) => {
  let I = "";
  for (let o = 0; o < E.THEME_COLOR_LIMIT; o++) E["lineColor" + o] = E["lineColor" + o] || E["cScaleInv" + o], Wt$1(E["lineColor" + o]) ? E["lineColor" + o] = /* @__PURE__ */ A(E["lineColor" + o], 20) : E["lineColor" + o] = /* @__PURE__ */ R(E["lineColor" + o], 20);
