...
var _a2, __, _b, __2, _c2, __3, _d, __4, _e2, __5, _f2, __6, _g2, __7, _h2, __8, _i, __9, _j, __10, _k, __11, _l2, __12;
...
var Ya = /* @__PURE__ */ n((qo, Po) => {
  (function(t9, e) {
    ...
    var t9 = 1e3, e = 6e4, r = 36e5, o2 = "millisecond", n2 = "second", s = "minute", a = "hour", l = "day", c = "week", h = "month", u = "quarter", p = "year", f = "date", g = "Invalid Date", T = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, A = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, $ = {
      name: "en",
      ...
      m: /* @__PURE__ */ m$1(function k(x, y) {
        ...
        var L = 12 * (y.year() - x.year()) + (y.month() - x.month()), S = /* @__PURE__ */ x.clone().add(L, h), R = y - S < 0, I = /* @__PURE__ */ x.clone().add(L + (R ? -1 : 1), h);
        return +(-(L + (y - S) / (R ? S - I : I - S)) || 0);
      }, "t"),
    ...
    var it = /* @__PURE__ */ function() {
      ...
      return x.parse = function(y) {
        this.$d = /* @__PURE__ */ function(L) {
          ...
          if (typeof S == "string" && !/Z$/i.test(S)) {
            ...
            if (I) {
              ...
              return R ? new Date(Date.UTC(I[1], U, I[3] || 1, I[4] || 0, I[5] || 0, I[6] || 0, rt)) : new Date(I[1], U, I[3] || 1, I[4] || 0, I[5] || 0, I[6] || 0, rt);
            }
          }
          return new Date(S);
        }(y), this.init();
        ...
        return W.u(y) ? this[L] : this.set(S, y);
      }, x.unix = function() {
        return Math.floor(this.valueOf() / 1e3);
      }, x.valueOf = function() {
        return this.$d.getTime();
      }, x.startOf = function(y, L) {
        var S = this, R = !!W.u(L) || L, I = /* @__PURE__ */ W.p(y), U = /* @__PURE__ */ m$1(function(_t, lt) {
          var v = /* @__PURE__ */ W.w(S.$u ? Date.UTC(S.$y, lt, _t) : new Date(S.$y, lt, _t), S);
          return R ? v : v.endOf(l);
        }, "l"), rt = /* @__PURE__ */ m$1(function(_t, lt) {
          return W.w(/* @__PURE__ */ S.toDate()[_t].apply(/* @__PURE__ */ S.toDate("s"), /* @__PURE__ */ (R ? [
            0,
            0,
            0,
            0
        ...
        switch (I) {
          ...
          case h:
            return R ? U(1, nt) : U(0, nt + 1);
          case c:
            var Z = this.$locale().weekStart || 0, Ct = (Y < Z ? Y + 7 : Y) - Z;
            return U(R ? Q - Ct : Q + (6 - Ct), nt);
          case l:
          case f:
        ...
        var S, R = /* @__PURE__ */ W.p(y), I = "set" + (this.$u ? "UTC" : ""), U = (S = {}, S[l] = I + "Date", S[f] = I + "Date", S[h] = I + "Month", S[p] = I + "FullYear", S[a] = I + "Hours", S[s] = I + "Minutes", S[n2] = I + "Seconds", S[o2] = I + "Milliseconds", S)[R], rt = R === l ? this.$D + (L - this.$W) : L;
        if (R === h || R === p) {
        ...
        var S, R = this;
        y = /* @__PURE__ */ Number(y);
        var I = /* @__PURE__ */ W.p(L), U = /* @__PURE__ */ m$1(function(nt) {
          var Q = /* @__PURE__ */ j(R);
          return W.w(/* @__PURE__ */ Q.date(Q.date() + Math.round(nt * y)), R);
        }, "y");
        ...
        var R = y || "YYYY-MM-DDTHH:mm:ssZ", I = /* @__PURE__ */ W.z(this), U = this.$H, rt = this.$m, Y = this.$M, nt = S.weekdays, Q = S.months, Ft = S.meridiem, Z = /* @__PURE__ */ m$1(function(lt, v, H, V) {
          return lt && (lt[v] || lt(L, R)) || H[v].slice(0, V);
        ...
        return R.replace(A, function(lt, v) {
          return v || function(H) {
            switch (H) {
              case "YY":
        ...
        var R, I = this, U = /* @__PURE__ */ W.p(L), rt = /* @__PURE__ */ j(y), Y = (rt.utcOffset() - this.utcOffset()) * e, nt = this - rt, Q = /* @__PURE__ */ m$1(function() {
          return W.m(I, rt);
        }, "D");
        switch (U) {
          case p:
        ...
        if (!y) return this.$L;
        var S = /* @__PURE__ */ this.clone(), R = /* @__PURE__ */ X(y, L, true);
        return R && (S.$L = R), S;
      }, x.clone = function() {
...
var Ti = {}, mx = /* @__PURE__ */ m$1(function(t9, e) {
...
}, "detectType"), dx = /* @__PURE__ */ m$1(function() {
  for (var _len = arguments.length, t9 = new Array(_len), _key = 0; _key < _len; _key++) {
    t9[_key] = arguments[_key];
  }
  for (let { id: e, detector: r, loader: o2 } of t9) $o(e, r, o2);
}, "registerLazyLoadedDiagrams"), $o = /* @__PURE__ */ m$1((t9, e, r) => {
...
var Wo = m$1(function(t9, e) {
  let { depth: r = 2, clobber: o2 = false } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  let n2 = {
    depth: r,
    clobber: o2
  };
  return Array.isArray(e) && !Array.isArray(t9) ? (e.forEach((s) => Wo(t9, s, n2)), t9) : Array.isArray(e) && Array.isArray(t9) ? (e.forEach((s) => {
    ...
    typeof e[s] == "object" && (t9[s] === void 0 || typeof t9[s] == "object") ? (t9[s] === void 0 && (t9[s] = Array.isArray(e[s]) ? [] : {}), t9[s] = /* @__PURE__ */ Wo(t9[s], e[s], {
      depth: r - 1,
      clobber: o2
    })) : (o2 || typeof t9[s] != "object" && typeof e[s] != "object") && (t9[s] = e[s]);
  }), t9);
}, "assignWithDepth"), Lt = Wo;
var ki = {
  min: {
    r: 0,
    g: 0,
...
var ne = {};
for (let t9 = 0; t9 <= 255; t9++) ne[t9] = /* @__PURE__ */ N.unit.dec2hex(t9);
var ut = {
  ALL: 0,
  RGB: 1,
  HSL: 2
...
var Uo = (_c2 = class {
  ...
  _ensureHSL() {
    ...
    r === void 0 && (e.h = /* @__PURE__ */ N.channel.rgb2hsl(e, "h")), o2 === void 0 && (e.s = /* @__PURE__ */ N.channel.rgb2hsl(e, "s")), n2 === void 0 && (e.l = /* @__PURE__ */ N.channel.rgb2hsl(e, "l"));
  }
  _ensureRGB() {
    let e = this.data, { r, g: o2, b: n2 } = e;
    r === void 0 && (e.r = /* @__PURE__ */ N.channel.hsl2rgb(e, "r")), o2 === void 0 && (e.g = /* @__PURE__ */ N.channel.hsl2rgb(e, "g")), n2 === void 0 && (e.b = /* @__PURE__ */ N.channel.hsl2rgb(e, "b"));
  }
  get r() {
    let e = this.data, r = e.r;
    return !this.type.is(ut.HSL) && r !== void 0 ? r : (this._ensureHSL(), N.channel.hsl2rgb(e, "r"));
  }
  get g() {
    let e = this.data, r = e.g;
    return !this.type.is(ut.HSL) && r !== void 0 ? r : (this._ensureHSL(), N.channel.hsl2rgb(e, "g"));
  }
  get b() {
    let e = this.data, r = e.b;
    return !this.type.is(ut.HSL) && r !== void 0 ? r : (this._ensureHSL(), N.channel.hsl2rgb(e, "b"));
  }
  get h() {
    let e = this.data, r = e.h;
    return !this.type.is(ut.RGB) && r !== void 0 ? r : (this._ensureRGB(), N.channel.rgb2hsl(e, "h"));
  }
  get s() {
    let e = this.data, r = e.s;
    return !this.type.is(ut.RGB) && r !== void 0 ? r : (this._ensureRGB(), N.channel.rgb2hsl(e, "s"));
  }
  get l() {
    let e = this.data, r = e.l;
    return !this.type.is(ut.RGB) && r !== void 0 ? r : (this._ensureRGB(), N.channel.rgb2hsl(e, "l"));
  }
  get a() {
    return this.data.a;
  }
...
var Si = {
  ...
  _hue2deg: /* @__PURE__ */ m$1((t9) => {
    ...
    if (e) {
      ...
      switch (o2) {
        case "grad":
          return N.channel.clamp.h(parseFloat(r) * 0.9);
        case "rad":
          return N.channel.clamp.h(parseFloat(r) * 180 / Math.PI);
        case "turn":
          return N.channel.clamp.h(parseFloat(r) * 360);
      }
    }
    return N.channel.clamp.h(/* @__PURE__ */ parseFloat(t9));
  }, "_hue2deg"),
  parse: /* @__PURE__ */ m$1((t9) => {
    ...
    return pe.set({
      ...
      s: /* @__PURE__ */ N.channel.clamp.s(/* @__PURE__ */ parseFloat(n2)),
      l: /* @__PURE__ */ N.channel.clamp.l(/* @__PURE__ */ parseFloat(s)),
      a: a ? N.channel.clamp.a(l ? parseFloat(a) / 100 : parseFloat(a)) : 1
    }, t9);
  }, "parse"),
  stringify: /* @__PURE__ */ m$1((t9) => {
    let { h: e, s: r, l: o2, a: n2 } = t9;
    return n2 < 1 ? `hsla(${N.lang.round(e)}, ${N.lang.round(r)}%, ${N.lang.round(o2)}%, ${n2})` : `hsl(${N.lang.round(e)}, ${N.lang.round(r)}%, ${N.lang.round(o2)}%)`;
  }, "stringify")
}, Fr = Si;
var vi = {
  colors: {
...
var il = {
  ...
  parse: /* @__PURE__ */ m$1((t9) => {
    ...
    return pe.set({
      r: /* @__PURE__ */ N.channel.clamp.r(n2 ? parseFloat(o2) * 2.55 : parseFloat(o2)),
      g: /* @__PURE__ */ N.channel.clamp.g(a ? parseFloat(s) * 2.55 : parseFloat(s)),
      b: /* @__PURE__ */ N.channel.clamp.b(c ? parseFloat(l) * 2.55 : parseFloat(l)),
      a: h ? N.channel.clamp.a(u ? parseFloat(h) / 100 : parseFloat(h)) : 1
    }, t9);
  }, "parse"),
  stringify: /* @__PURE__ */ m$1((t9) => {
    let { r: e, g: r, b: o2, a: n2 } = t9;
    return n2 < 1 ? `rgba(${N.lang.round(e)}, ${N.lang.round(r)}, ${N.lang.round(o2)}, ${N.lang.round(n2)})` : `rgb(${N.lang.round(e)}, ${N.lang.round(r)}, ${N.lang.round(o2)})`;
  }, "stringify")
}, Mr = il;
var _u = {
  format: {
...
var bu = /* @__PURE__ */ m$1((t9, e) => {
  ...
  for (let o2 in e) r[o2] = /* @__PURE__ */ N.channel.clamp[o2](e[o2]);
...
var Tu = /* @__PURE__ */ m$1(function(t9, e) {
  ...
  let n2 = /* @__PURE__ */ pe.set({
    r: /* @__PURE__ */ N.channel.clamp.r(t9),
    g: /* @__PURE__ */ N.channel.clamp.g(e),
    b: /* @__PURE__ */ N.channel.clamp.b(r),
    a: /* @__PURE__ */ N.channel.clamp.a(o2)
  });
  return ft.stringify(n2);
}, "rgba"), se = Tu;
var ku = /* @__PURE__ */ m$1((t9, e) => N.lang.round(ft.parse(t9)[e]), "channel"), Su = ku;
var vu = /* @__PURE__ */ m$1((t9) => {
  let { r: e, g: r, b: o2 } = ft.parse(t9), n2 = 0.2126 * N.channel.toLinear(e) + 0.7152 * N.channel.toLinear(r) + 0.0722 * N.channel.toLinear(o2);
  return N.lang.round(n2);
}, "luminance"), ol = vu;
var wu = /* @__PURE__ */ m$1((t9) => ol(t9) >= 0.5, "isLight"), nl = wu;
var Bu = /* @__PURE__ */ m$1((t9) => !nl(t9), "isDark"), Wt = Bu;
var Fu = /* @__PURE__ */ m$1((t9, e, r) => {
  let o2 = /* @__PURE__ */ ft.parse(t9), n2 = o2[e], s = /* @__PURE__ */ N.channel.clamp[e](n2 + r);
...
var Eu = /* @__PURE__ */ m$1(function(t9, e) {
  ...
  let { r: o2, g: n2, b: s, a } = ft.parse(t9), { r: l, g: c, b: h, a: u } = ft.parse(e), p = r / 100, f = p * 2 - 1, g = a - u, A = ((f * g === -1 ? f : (f + g) / (1 + f * g)) + 1) / 2, $ = 1 - A, q2 = o2 * A + l * $, G = n2 * A + c * $, D = s * A + h * $, M = a * p + u * (1 - p);
  return se(q2, G, D, M);
}, "mix"), sl = Eu;
var Du = /* @__PURE__ */ m$1(function(t9) {
...
var ct = /* @__PURE__ */ m$1((t9, e) => e ? d(t9, {
  s: -40,
  l: 10
}) : d(t9, {
  s: -40,
...
var Go = (_d = class {
  ...
  updateColors() {
    ...
    for (let r = 0; r < 5; r++) this["surface" + r] = this["surface" + r] || d(this.mainBkg, {
      h: 180,
      s: -15,
      l: e * (5 + r * 3)
    }), this["surfacePeer" + r] = this["surfacePeer" + r] || d(this.mainBkg, {
      h: 180,
      s: -15,
      l: e * (8 + r * 3)
    });
    this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || this.primaryColor, this.fillType1 = this.fillType1 || this.secondaryColor, this.fillType2 = this.fillType2 || d(this.primaryColor, {
      h: 64
    }), this.fillType3 = this.fillType3 || d(this.secondaryColor, {
      h: 64
    }), this.fillType4 = this.fillType4 || d(this.primaryColor, {
      h: -64
    }), this.fillType5 = this.fillType5 || d(this.secondaryColor, {
      h: -64
    }), this.fillType6 = this.fillType6 || d(this.primaryColor, {
      h: 128
    }), this.fillType7 = this.fillType7 || d(this.secondaryColor, {
      h: 128
    }), this.pie1 = this.pie1 || this.primaryColor, this.pie2 = this.pie2 || this.secondaryColor, this.pie3 = this.pie3 || this.tertiaryColor, this.pie4 = this.pie4 || d(this.primaryColor, {
      l: -10
    }), this.pie5 = this.pie5 || d(this.secondaryColor, {
      l: -10
    }), this.pie6 = this.pie6 || d(this.tertiaryColor, {
      l: -10
    }), this.pie7 = this.pie7 || d(this.primaryColor, {
      h: 60,
      l: -10
    }), this.pie8 = this.pie8 || d(this.primaryColor, {
      h: -60,
      l: -10
    }), this.pie9 = this.pie9 || d(this.primaryColor, {
      h: 120,
      l: 0
    }), this.pie10 = this.pie10 || d(this.primaryColor, {
      h: 60,
      l: -20
    }), this.pie11 = this.pie11 || d(this.primaryColor, {
      h: -60,
      l: -20
    }), this.pie12 = this.pie12 || d(this.primaryColor, {
      h: 120,
      l: -10
    }), this.pieTitleTextSize = this.pieTitleTextSize || "25px", this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || "17px", this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || "17px", this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || "black", this.pieStrokeWidth = this.pieStrokeWidth || "2px", this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || "2px", this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black", this.pieOpacity = this.pieOpacity || "0.7", this.archEdgeColor = this.archEdgeColor || "#777", this.archEdgeArrowColor = this.archEdgeArrowColor || "#777", this.archEdgeWidth = this.archEdgeWidth || "3", this.archGroupBorderColor = this.archGroupBorderColor || "#000", this.archGroupBorderWidth = this.archGroupBorderWidth || "2px", this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || d(this.primaryColor, {
      r: 5,
      g: 5,
      b: 5
    }), this.quadrant3Fill = this.quadrant3Fill || d(this.primaryColor, {
      r: 10,
      g: 10,
      b: 10
    }), this.quadrant4Fill = this.quadrant4Fill || d(this.primaryColor, {
      r: 15,
      g: 15,
      b: 15
    }), this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor, this.quadrant2TextFill = this.quadrant2TextFill || d(this.primaryTextColor, {
      r: -5,
      g: -5,
      b: -5
    }), this.quadrant3TextFill = this.quadrant3TextFill || d(this.primaryTextColor, {
      r: -10,
      g: -10,
      b: -10
    }), this.quadrant4TextFill = this.quadrant4TextFill || d(this.primaryTextColor, {
      r: -15,
      g: -15,
      b: -15
    }), this.quadrantPointFill = this.quadrantPointFill || Wt(this.quadrant1Fill) ? F(this.quadrant1Fill) : E(this.quadrant1Fill), this.quadrantPointTextFill = this.quadrantPointTextFill || this.primaryTextColor, this.quadrantXAxisTextFill = this.quadrantXAxisTextFill || this.primaryTextColor, this.quadrantYAxisTextFill = this.quadrantYAxisTextFill || this.primaryTextColor, this.quadrantInternalBorderStrokeFill = this.quadrantInternalBorderStrokeFill || this.primaryBorderColor, this.quadrantExternalBorderStrokeFill = this.quadrantExternalBorderStrokeFill || this.primaryBorderColor, this.quadrantTitleFill = this.quadrantTitleFill || this.primaryTextColor, this.xyChart = {
...
}, __4 = new WeakMap(), __privateAdd(_d, __4, m$1(_d, "Theme")), _d), al = /* @__PURE__ */ m$1((t9) => {
  let e = new Go();
  return e.calculate(t9), e;
}, "getThemeVariables");
var Vo = (_e2 = class {
  constructor() {
    this.background = "#333", this.primaryColor = "#1f2020", this.secondaryColor = /* @__PURE__ */ F(this.primaryColor, 16), this.tertiaryColor = /* @__PURE__ */ d(this.primaryColor, {
      h: -160
  ...
  updateColors() {
    ...
    for (let e = 0; e < 5; e++) this["surface" + e] = this["surface" + e] || d(this.mainBkg, {
      h: 30,
      s: -30,
      l: -(-10 + e * 4)
    }), this["surfacePeer" + e] = this["surfacePeer" + e] || d(this.mainBkg, {
      h: 30,
      s: -30,
      l: -(-7 + e * 4)
    });
    ...
    this.pieTitleTextSize = this.pieTitleTextSize || "25px", this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor, this.pieSectionTextSize = this.pieSectionTextSize || "17px", this.pieSectionTextColor = this.pieSectionTextColor || this.textColor, this.pieLegendTextSize = this.pieLegendTextSize || "17px", this.pieLegendTextColor = this.pieLegendTextColor || this.taskTextDarkColor, this.pieStrokeColor = this.pieStrokeColor || "black", this.pieStrokeWidth = this.pieStrokeWidth || "2px", this.pieOuterStrokeWidth = this.pieOuterStrokeWidth || "2px", this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black", this.pieOpacity = this.pieOpacity || "0.7", this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || d(this.primaryColor, {
      r: 5,
      g: 5,
      b: 5
    }), this.quadrant3Fill = this.quadrant3Fill || d(this.primaryColor, {
    ...
    }, this.classText = this.primaryTextColor, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || (this.darkMode ? E(this.secondaryColor, 30) : this.secondaryColor), this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = /* @__PURE__ */ F(this.secondaryColor, 20), this.git1 = /* @__PURE__ */ F(this.pie2 || this.secondaryColor, 20), this.git2 = /* @__PURE__ */ F(this.pie3 || this.tertiaryColor, 20), this.git3 = /* @__PURE__ */ F(this.pie4 || d(this.primaryColor, {
      h: -30
    }), 20), this.git4 = /* @__PURE__ */ F(this.pie5 || d(this.primaryColor, {
      h: -60
    }), 20), this.git5 = /* @__PURE__ */ F(this.pie6 || d(this.primaryColor, {
      h: -90
    }), 10), this.git6 = /* @__PURE__ */ F(this.pie7 || d(this.primaryColor, {
      h: 60
    }), 10), this.git7 = /* @__PURE__ */ F(this.pie8 || d(this.primaryColor, {
      h: 120
...
var Xo = (_f2 = class {
  constructor() {
    this.background = "#f4f4f4", this.primaryColor = "#ECECFF", this.secondaryColor = /* @__PURE__ */ d(this.primaryColor, {
      h: 120
    }), this.secondaryColor = "#ffffde", this.tertiaryColor = /* @__PURE__ */ d(this.primaryColor, {
      h: -160
  ...
  updateColors() {
    var _a3, _b2, _c3, _d2, _e3, _f3, _g3, _h3, _i2, _j2, _k2;
    this.cScale0 = this.cScale0 || this.primaryColor, this.cScale1 = this.cScale1 || this.secondaryColor, this.cScale2 = this.cScale2 || this.tertiaryColor, this.cScale3 = this.cScale3 || d(this.primaryColor, {
      h: 30
    }), this.cScale4 = this.cScale4 || d(this.primaryColor, {
      h: 60
    }), this.cScale5 = this.cScale5 || d(this.primaryColor, {
    ...
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++) this["cScaleInv" + e] = this["cScaleInv" + e] || d(this["cScale" + e], {
      h: 180
    });
    for (let e = 0; e < 5; e++) this["surface" + e] = this["surface" + e] || d(this.mainBkg, {
      h: 30,
    ...
    this.nodeBkg = this.mainBkg, this.nodeBorder = this.border1, this.clusterBkg = this.secondBkg, this.clusterBorder = this.border2, this.defaultLinkColor = this.lineColor, this.titleColor = this.textColor, this.edgeLabelBackground = this.labelBackground, this.actorBorder = /* @__PURE__ */ F(this.border1, 23), this.actorBkg = this.mainBkg, this.labelBoxBkgColor = this.actorBkg, this.signalColor = this.textColor, this.signalTextColor = this.textColor, this.labelBoxBorderColor = this.actorBorder, this.labelTextColor = this.actorTextColor, this.loopTextColor = this.actorTextColor, this.noteBorderColor = this.border2, this.noteTextColor = this.actorTextColor, this.actorLineColor = this.actorBorder, this.taskTextColor = this.taskTextLightColor, this.taskTextOutsideColor = this.taskTextDarkColor, this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.rowOdd = this.rowOdd || F(this.primaryColor, 75) || "#ffffff", this.rowEven = this.rowEven || F(this.primaryColor, 1), this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || "#f0f0f0", this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.nodeBorder, this.specialStateColor = this.lineColor, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.classText = this.primaryTextColor, this.fillType0 = this.primaryColor, this.fillType1 = this.secondaryColor, this.fillType2 = /* @__PURE__ */ d(this.primaryColor, {
      ...
      h: 128
    }), this.pie1 = this.pie1 || this.primaryColor, this.pie2 = this.pie2 || this.secondaryColor, this.pie3 = this.pie3 || d(this.tertiaryColor, {
      l: -40
    }), this.pie4 = this.pie4 || d(this.primaryColor, {
      l: -10
    }), this.pie5 = this.pie5 || d(this.secondaryColor, {
      l: -30
    }), this.pie6 = this.pie6 || d(this.tertiaryColor, {
...
var Zo = (_h2 = class {
  constructor() {
    this.primaryColor = "#eee", this.contrast = "#707070", this.secondaryColor = /* @__PURE__ */ F(this.contrast, 55), this.background = "#ffffff", this.tertiaryColor = /* @__PURE__ */ d(this.primaryColor, {
      h: -160
  ...
  updateColors() {
    ...
    }, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || this.edgeLabelBackground, this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = E(this.pie1, 25) || this.primaryColor, this.git1 = this.pie2 || this.secondaryColor, this.git2 = this.pie3 || this.tertiaryColor, this.git3 = this.pie4 || d(this.primaryColor, {
      h: -30
    }), this.git4 = this.pie5 || d(this.primaryColor, {
      h: -60
    }), this.git5 = this.pie6 || d(this.primaryColor, {
      h: -90
    }), this.git6 = this.pie7 || d(this.primaryColor, {
      h: 60
    }), this.git7 = this.pie8 || d(this.primaryColor, {
      h: 120
...
var Fi = m$1((t9) => {
  if (tt.debug("sanitizeDirective called with", t9), !(typeof t9 != "object" || t9 == null)) {
    ...
    for (let e of Object.keys(t9)) {
      if (tt.debug("Checking key", e), e.startsWith("__") || e.includes("proto") || e.includes("constr") || !dl.has(e) || t9[e] == null) {
      ...
      for (let o2 of r) e.includes(o2) && (tt.debug("sanitizing css option", e), t9[e] = /* @__PURE__ */ Ou(t9[e]));
    }
...
}, "sanitizeDirective"), Ou = /* @__PURE__ */ m$1((t9) => {
  let e = 0, r = 0;
  for (let o2 of t9) {
...
var Ar = /* @__PURE__ */ Object.freeze(pl), Nt = /* @__PURE__ */ Lt({}, Ar), xl, tr = [], Lr = /* @__PURE__ */ Lt({}, Ar), Mi = /* @__PURE__ */ m$1((t9, e) => {
...
}, "updateCurrentConfig"), Iu = /* @__PURE__ */ m$1((t9) => (Nt = /* @__PURE__ */ Lt({}, Ar), Nt = /* @__PURE__ */ Lt(Nt, t9), t9.theme && ye[t9.theme] && (Nt.themeVariables = /* @__PURE__ */ ye[t9.theme].getThemeVariables(t9.themeVariables)), Mi(Nt, tr), Nt), "setSiteConfig"), oC = /* @__PURE__ */ m$1((t9) => {
  xl = /* @__PURE__ */ Lt({}, t9);
}, "saveConfigFromInitialize"), nC = /* @__PURE__ */ m$1((t9) => (Nt = /* @__PURE__ */ Lt(Nt, t9), Mi(Nt, tr), Nt), "updateSiteConfig"), sC = /* @__PURE__ */ m$1(() => Lt({}, Nt), "getSiteConfig"), yl = /* @__PURE__ */ m$1((t9) => (_l(t9), Lt(Lr, t9), Er()), "setConfig"), Er = /* @__PURE__ */ m$1(() => Lt({}, Lr), "getConfig"), Cl = m$1((t9) => {
  t9 && ([
    "secure",
    ...Nt.secure ?? []
  ].forEach((e) => {
  ...
  let t9 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Nt;
  tr = [], Mi(t9, tr);
}, "reset"), Ru = {
  LAZY_LOAD_DEPRECATED: "The configuration options lazyLoadedDiagrams and loadExternalDiagramsAtStartup are deprecated. Please use registerExternalDiagrams instead."
}, gl = {}, Nu = /* @__PURE__ */ m$1((t9) => {
  gl[t9] || (tt.warn(Ru[t9]), gl[t9] = true);
}, "issueWarning"), _l = /* @__PURE__ */ m$1((t9) => {
  t9 && (t9.lazyLoadedDiagrams || t9.loadExternalDiagramsAtStartup) && Nu("LAZY_LOAD_DEPRECATED");
}, "checkConfig");
var { entries: Ll, setPrototypeOf: bl, isFrozen: zu, getPrototypeOf: qu, getOwnPropertyDescriptor: Pu } = Object, { freeze: Et, seal: $t, create: Al } = Object, { apply: rn, construct: on } = typeof Reflect < "u" && Reflect;
...
var Li = /* @__PURE__ */ Dt(Array.prototype.forEach), $u = /* @__PURE__ */ Dt(Array.prototype.lastIndexOf), Tl = /* @__PURE__ */ Dt(Array.prototype.pop), Dr = /* @__PURE__ */ Dt(Array.prototype.push), Wu = /* @__PURE__ */ Dt(Array.prototype.splice), Ei = /* @__PURE__ */ Dt(String.prototype.toLowerCase), Ko = /* @__PURE__ */ Dt(String.prototype.toString), kl = /* @__PURE__ */ Dt(String.prototype.match), Or = /* @__PURE__ */ Dt(String.prototype.replace), Hu = /* @__PURE__ */ Dt(String.prototype.indexOf), Uu = /* @__PURE__ */ Dt(String.prototype.trim), Ht = /* @__PURE__ */ Dt(Object.prototype.hasOwnProperty), At = /* @__PURE__ */ Dt(RegExp.prototype.test), Ir = /* @__PURE__ */ Yu(TypeError);
function Dt(t9) {
  return function(e) {
...
function Rr(t9, e) {
  for (; t9 !== null; ) {
    ...
    if (o2) {
      if (o2.get) return Dt(o2.get);
      if (typeof o2.value == "function") return Dt(o2.value);
    }
    t9 = /* @__PURE__ */ qu(t9);
  }
  function r() {
...
var Sl = /* @__PURE__ */ Et([
  ...
  "xml:space",
  "xmlns:xlink"
]), ju = /* @__PURE__ */ $t(/\{\{[\w\W]*|[\w\W]*\}\}/gm), Zu = /* @__PURE__ */ $t(/<%[\w\W]*|[\w\W]*%>/gm), Ku = /* @__PURE__ */ $t(/\$\{[\w\W]*/gm), Qu = /* @__PURE__ */ $t(/^data-[\-\w.\u00B7-\uFFFF]+$/), Ju = /* @__PURE__ */ $t(/^aria-[\-\w]+$/), El = /* @__PURE__ */ $t(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i), tf = /* @__PURE__ */ $t(/^(?:\w+script|data):/i), ef = /* @__PURE__ */ $t(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g), Dl = /* @__PURE__ */ $t(/^html$/i), rf = /* @__PURE__ */ $t(/^[a-z][.\w]*(-[.\w]+)+$/i), Fl = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  ARIA_ATTR: Ju,
  ATTR_WHITESPACE: ef,
  CUSTOM_ELEMENT: rf,
...
function Ol() {
  let t9 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : of(), e = /* @__PURE__ */ m$1((z) => Ol(z), "DOMPurify");
  if (e.version = "3.2.4", e.removed = [], !t9 || !t9.document || t9.document.nodeType !== Nr.document || !t9.Element) return e.isSupported = false, e;
  let { document: r } = t9, o2 = r, n2 = o2.currentScript, { DocumentFragment: s, HTMLTemplateElement: a, Node: l, Element: c, NodeFilter: h, NamedNodeMap: u = t9.NamedNodeMap || t9.MozNamedAttrMap, HTMLFormElement: p, DOMParser: f, trustedTypes: g } = t9, T = c.prototype, A = /* @__PURE__ */ Rr(T, "cloneNode"), $ = /* @__PURE__ */ Rr(T, "remove"), q2 = /* @__PURE__ */ Rr(T, "nextSibling"), G = /* @__PURE__ */ Rr(T, "childNodes"), D = /* @__PURE__ */ Rr(T, "parentNode");
  if (typeof a == "function") {
    let z = /* @__PURE__ */ r.createElement("template");
    z.content && z.content.ownerDocument && (r = z.content.ownerDocument);
  }
  let M, P = "", { implementation: w, createNodeIterator: X, createDocumentFragment: j, getElementsByTagName: W } = r, { importNode: it } = o2, B = /* @__PURE__ */ Ml();
  e.isSupported = typeof Ll == "function" && typeof D == "function" && w && w.createHTMLDocument !== void 0;
  let { MUSTACHE_EXPR: k, ERB_EXPR: x, TMPLIT_EXPR: y, DATA_ATTR: L, ARIA_ATTR: S, IS_SCRIPT_OR_DATA: R, ATTR_WHITESPACE: I, CUSTOM_ELEMENT: U } = Fl, { IS_ALLOWED_URI: rt } = Fl, Y = null, nt = /* @__PURE__ */ K({}, [
    ...Sl,
    ...Qo,
    ...Jo,
    ...tn,
  ...
  })), Ct = null, _t = null, lt = true, v = true, H = false, V = true, C = false, dt = true, J = false, bt = false, Tt = false, It = false, Le = false, pi = false, Ba = true, Fa = false, nu = "user-content-", Do = true, vr = false, Ze = {}, Ke = null, Ma = /* @__PURE__ */ K({}, [
    "annotation-xml",
    "audio",
    "colgroup",
    "desc",
    ...
    "style",
    "xmlns"
  ]), gi = "http://www.w3.org/1998/Math/MathML", xi = "http://www.w3.org/2000/svg", re = "http://www.w3.org/1999/xhtml", Qe = re, Io = false, Ro = null, su = /* @__PURE__ */ K({}, [
    gi,
    xi,
    re
  ], Ko), yi = /* @__PURE__ */ K({}, [
    ...
    "text/html"
  ], hu = "text/html", pt = null, Je = null, cu = /* @__PURE__ */ r.createElement("form"), Da = /* @__PURE__ */ m$1(function(m) {
    return m instanceof RegExp || m instanceof Function;
  }, "isRegexOrFunction"), No = /* @__PURE__ */ m$1(function() {
    let m = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (!(Je && Je === m)) {
      if ((!m || typeof m != "object") && (m = {}), m = /* @__PURE__ */ Ee(m), wr = lu.indexOf(m.PARSER_MEDIA_TYPE) === -1 ? hu : m.PARSER_MEDIA_TYPE, pt = wr === "application/xhtml+xml" ? Ko : Ei, Y = Ht(m, "ALLOWED_TAGS") ? K({}, m.ALLOWED_TAGS, pt) : nt, Q = Ht(m, "ALLOWED_ATTR") ? K({}, m.ALLOWED_ATTR, pt) : Ft, Ro = Ht(m, "ALLOWED_NAMESPACES") ? K({}, m.ALLOWED_NAMESPACES, Ko) : su, Oo = Ht(m, "ADD_URI_SAFE_ATTR") ? K(/* @__PURE__ */ Ee(Ea), m.ADD_URI_SAFE_ATTR, pt) : Ea, La = Ht(m, "ADD_DATA_URI_TAGS") ? K(/* @__PURE__ */ Ee(Aa), m.ADD_DATA_URI_TAGS, pt) : Aa, Ke = Ht(m, "FORBID_CONTENTS") ? K({}, m.FORBID_CONTENTS, pt) : Ma, Ct = Ht(m, "FORBID_TAGS") ? K({}, m.FORBID_TAGS, pt) : {}, _t = Ht(m, "FORBID_ATTR") ? K({}, m.FORBID_ATTR, pt) : {}, Ze = Ht(m, "USE_PROFILES") ? m.USE_PROFILES : false, lt = m.ALLOW_ARIA_ATTR !== false, v = m.ALLOW_DATA_ATTR !== false, H = m.ALLOW_UNKNOWN_PROTOCOLS || false, V = m.ALLOW_SELF_CLOSE_IN_ATTR !== false, C = m.SAFE_FOR_TEMPLATES || false, dt = m.SAFE_FOR_XML !== false, J = m.WHOLE_DOCUMENT || false, It = m.RETURN_DOM || false, Le = m.RETURN_DOM_FRAGMENT || false, pi = m.RETURN_TRUSTED_TYPE || false, Tt = m.FORCE_BODY || false, Ba = m.SANITIZE_DOM !== false, Fa = m.SANITIZE_NAMED_PROPS || false, Do = m.KEEP_CONTENT !== false, vr = m.IN_PLACE || false, rt = m.ALLOWED_URI_REGEXP || El, Qe = m.NAMESPACE || re, yi = m.MATHML_TEXT_INTEGRATION_POINTS || yi, Ci = m.HTML_INTEGRATION_POINTS || Ci, Z = m.CUSTOM_ELEMENT_HANDLING || {}, m.CUSTOM_ELEMENT_HANDLING && Da(m.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (Z.tagNameCheck = m.CUSTOM_ELEMENT_HANDLING.tagNameCheck), m.CUSTOM_ELEMENT_HANDLING && Da(m.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (Z.attributeNameCheck = m.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), m.CUSTOM_ELEMENT_HANDLING && typeof m.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (Z.allowCustomizedBuiltInElements = m.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), C && (v = false), Le && (It = true), Ze && (Y = /* @__PURE__ */ K({}, vl), Q = [], Ze.html === true && (K(Y, Sl), K(Q, wl)), Ze.svg === true && (K(Y, Qo), K(Q, en), K(Q, Ai)), Ze.svgFilters === true && (K(Y, Jo), K(Q, en), K(Q, Ai)), Ze.mathMl === true && (K(Y, tn), K(Q, Bl), K(Q, Ai))), m.ADD_TAGS && (Y === nt && (Y = /* @__PURE__ */ Ee(Y)), K(Y, m.ADD_TAGS, pt)), m.ADD_ATTR && (Q === Ft && (Q = /* @__PURE__ */ Ee(Q)), K(Q, m.ADD_ATTR, pt)), m.ADD_URI_SAFE_ATTR && K(Oo, m.ADD_URI_SAFE_ATTR, pt), m.FORBID_CONTENTS && (Ke === Ma && (Ke = /* @__PURE__ */ Ee(Ke)), K(Ke, m.FORBID_CONTENTS, pt)), Do && (Y["#text"] = true), J && K(Y, [
        "html",
        "head",
        "body"
      ]), Y.table && (K(Y, [
    ...
    ...tn,
    ...Xu
  ]), uu = /* @__PURE__ */ m$1(function(m) {
    let _ = /* @__PURE__ */ D(m);
    (!_ || !_.tagName) && (_ = {
      namespaceURI: Qe,
      tagName: "template"
    });
    let O = /* @__PURE__ */ Ei(m.tagName), at = /* @__PURE__ */ Ei(_.tagName);
    return Ro[m.namespaceURI] ? m.namespaceURI === xi ? _.namespaceURI === re ? O === "svg" : _.namespaceURI === gi ? O === "svg" && (at === "annotation-xml" || yi[at]) : !!Oa[O] : m.namespaceURI === gi ? _.namespaceURI === re ? O === "math" : _.namespaceURI === xi ? O === "math" && Ci[at] : !!Ia[O] : m.namespaceURI === re ? _.namespaceURI === xi && !Ci[at] || _.namespaceURI === gi && !yi[at] ? false : !Ia[O] && (au[O] || !Oa[O]) : !!(wr === "application/xhtml+xml" && Ro[m.namespaceURI]) : false;
    ...
    if (_.removeAttribute(m), m === "is") if (It || Le) try {
      jt(_);
    } catch {
    }
    else try {
  ...
  }, "_removeAttribute"), Ra = /* @__PURE__ */ m$1(function(m) {
    let _ = null, O = null;
    ...
    return m && O && Bt.insertBefore(/* @__PURE__ */ r.createTextNode(O), Bt.childNodes[0] || null), Qe === re ? W.call(_, J ? "html" : "body")[0] : J ? _.documentElement : Bt;
  }, "_initDocument"), Na = /* @__PURE__ */ m$1(function(m) {
  ...
  }, "_createNodeIterator"), zo = /* @__PURE__ */ m$1(function(m) {
  ...
  }, "_isClobbered"), za = /* @__PURE__ */ m$1(function(m) {
  ...
  m$1(ie, "_executeHooks");
  let qa = /* @__PURE__ */ m$1(function(m) {
    let _ = null;
    if (ie(B.beforeSanitizeElements, m, null), zo(m)) return jt(m), true;
    let O = /* @__PURE__ */ pt(m.nodeName);
    if (ie(B.uponSanitizeElement, m, {
      tagName: O,
      allowedTags: Y
    }), m.hasChildNodes() && !za(m.firstElementChild) && At(/<[/\w]/g, m.innerHTML) && At(/<[/\w]/g, m.textContent) || m.nodeType === Nr.progressingInstruction || dt && m.nodeType === Nr.comment && At(/<[/\w]/g, m.data)) return jt(m), true;
    if (!Y[O] || Ct[O]) {
      if (!Ct[O] && $a(O) && (Z.tagNameCheck instanceof RegExp && At(Z.tagNameCheck, O) || Z.tagNameCheck instanceof Function && Z.tagNameCheck(O))) return false;
      if (Do && !Ke[O]) {
        let at = D(m) || m.parentNode, Bt = G(m) || m.childNodes;
        if (Bt && at) {
          let kt = Bt.length;
          for (let Rt = kt - 1; Rt >= 0; --Rt) {
            let Zt = /* @__PURE__ */ A(Bt[Rt], true);
            Zt.__removalCount = (m.__removalCount || 0) + 1, at.insertBefore(Zt, /* @__PURE__ */ q2(m));
          }
        }
      }
      return jt(m), true;
    }
    return m instanceof c && !uu(m) || (O === "noscript" || O === "noembed" || O === "noframes") && At(/<\/no(script|embed|frames)/i, m.innerHTML) ? (jt(m), true) : (C && m.nodeType === Nr.text && (_ = m.textContent, Li([
      k,
      x,
      y
    ], (at) => {
    ...
    }), m.textContent = _)), ie(B.afterSanitizeElements, m, null), false);
  }, "_sanitizeElements"), Pa = /* @__PURE__ */ m$1(function(m, _, O) {
    if (Ba && (_ === "id" || _ === "name") && (O in r || O in cu)) return false;
    if (!(v && !_t[_] && At(L, _))) {
      if (!(lt && At(S, _))) {
        if (!Q[_] || _t[_]) {
          if (!($a(m) && (Z.tagNameCheck instanceof RegExp && At(Z.tagNameCheck, m) || Z.tagNameCheck instanceof Function && Z.tagNameCheck(m)) && (Z.attributeNameCheck instanceof RegExp && At(Z.attributeNameCheck, _) || Z.attributeNameCheck instanceof Function && Z.attributeNameCheck(_)) || _ === "is" && Z.allowCustomizedBuiltInElements && (Z.tagNameCheck instanceof RegExp && At(Z.tagNameCheck, O) || Z.tagNameCheck instanceof Function && Z.tagNameCheck(O)))) return false;
        } else if (!Oo[_]) {
          if (!At(rt, /* @__PURE__ */ Or(O, I, ""))) {
            if (!((_ === "src" || _ === "xlink:href" || _ === "href") && m !== "script" && Hu(O, "data:") === 0 && La[m])) {
              if (!(H && !At(R, /* @__PURE__ */ Or(O, I, "")))) {
                if (O) return false;
              }
            }
          }
    ...
    ie(B.beforeSanitizeAttributes, m, null);
    let { attributes: _ } = m;
    if (!_ || zo(m)) return;
    let O = {
      attrName: "",
    ...
    for (; at--; ) {
      let Bt = _[at], { name: kt, namespaceURI: Rt, value: Zt } = Bt, Br = /* @__PURE__ */ pt(kt), Mt = kt === "value" ? Zt : Uu(Zt);
      if (O.attrName = Br, O.attrValue = Mt, O.keepAttr = true, O.forceKeepAttr = void 0, ie(B.uponSanitizeAttribute, m, O), Mt = O.attrValue, Fa && (Br === "id" || Br === "name") && (_i2(kt, m), Mt = nu + Mt), dt && At(/((--!?|])>)|<\/(style|title)/i, Mt)) {
        _i2(kt, m);
        continue;
      }
      if (O.forceKeepAttr || (_i2(kt, m), !O.keepAttr)) continue;
      if (!V && At(/\/>/i, Mt)) {
        _i2(kt, m);
        continue;
      }
      ...
      let Ha = /* @__PURE__ */ pt(m.nodeName);
      if (Pa(Ha, Br, Mt)) {
        if (M && typeof g == "object" && typeof g.getAttributeType == "function" && !Rt) switch (g.getAttributeType(Ha, Br)) {
          case "TrustedHTML": {
        ...
        try {
          Rt ? m.setAttributeNS(Rt, kt, Mt) : m.setAttribute(kt, Mt), zo(m) ? jt(m) : Tl(e.removed);
        } catch {
        }
      }
    }
    ie(B.afterSanitizeAttributes, m, null);
  }, "_sanitizeAttributes"), fu = /* @__PURE__ */ m$1(function z(m) {
    let _ = null, O = /* @__PURE__ */ Na(m);
    for (ie(B.beforeSanitizeShadowDOM, m, null); _ = /* @__PURE__ */ O.nextNode(); ) ie(B.uponSanitizeShadowNode, _, null), qa(_), Wa(_), _.content instanceof s && z(_.content);
    ie(B.afterSanitizeShadowDOM, m, null);
  }, "_sanitizeShadowDOM");
  return e.sanitize = function(z) {
    let m = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ = null, O = null, at = null, Bt = null;
    if (Io = !z, Io && (z = "<!-->"), typeof z != "string" && !za(z)) if (typeof z.toString == "function") {
      if (z = /* @__PURE__ */ z.toString(), typeof z != "string") throw Ir("dirty is not a string, aborting");
    } else throw Ir("toString is not a function");
    if (!e.isSupported) return z;
    if (bt || No(m), e.removed = [], typeof z == "string" && (vr = false), vr) {
      if (z.nodeName) {
        let Zt = /* @__PURE__ */ pt(z.nodeName);
        if (!Y[Zt] || Ct[Zt]) throw Ir("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (z instanceof l) _ = /* @__PURE__ */ Ra("<!---->"), O = /* @__PURE__ */ _.ownerDocument.importNode(z, true), O.nodeType === Nr.element && O.nodeName === "BODY" || O.nodeName === "HTML" ? _ = O : _.appendChild(O);
    else {
      if (!It && !C && !J && z.indexOf("<") === -1) return M && pi ? M.createHTML(z) : z;
      if (_ = /* @__PURE__ */ Ra(z), !_) return It ? null : pi ? P : "";
    }
    _ && Tt && jt(_.firstChild);
    let kt = /* @__PURE__ */ Na(vr ? z : _);
    for (; at = /* @__PURE__ */ kt.nextNode(); ) qa(at), Wa(at), at.content instanceof s && fu(at.content);
    if (vr) return z;
    if (It) {
    ...
    let Rt = J ? _.outerHTML : _.innerHTML;
    return J && Y["!doctype"] && _.ownerDocument && _.ownerDocument.doctype && _.ownerDocument.doctype.name && At(Dl, _.ownerDocument.doctype.name) && (Rt = "<!DOCTYPE " + _.ownerDocument.doctype.name + `>
` + Rt), C && Li([
      k,
      x,
      y
    ], (Zt) => {
      Rt = /* @__PURE__ */ Or(Rt, Zt, " ");
    }), M && pi ? M.createHTML(Rt) : Rt;
  }, e.setConfig = function() {
    let z = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    No(z), bt = true;
  }, e.clearConfig = function() {
    Je = null, bt = false;
  }, e.isValidAttribute = function(z, m, _) {
    Je || No({});
    let O = /* @__PURE__ */ pt(z), at = /* @__PURE__ */ pt(m);
    return Pa(O, at, _);
  }, e.addHook = function(z, m) {
    typeof m == "function" && Dr(B[z], m);
  }, e.removeHook = function(z, m) {
    if (m !== void 0) {
      let _ = /* @__PURE__ */ $u(B[z], m);
      return _ === -1 ? void 0 : Wu(B[z], _, 1)[0];
    }
    return Tl(B[z]);
...
var er = /* @__PURE__ */ Ol();
var zr = /<br\s*\/?>/gi, sf = /* @__PURE__ */ m$1((t9) => t9 ? ql(t9).replace(/\\n/g, "#br#").split("#br#") : [
  ""
], "getRows"), af = /* @__PURE__ */ (() => {
  let t9 = false;
  return () => {
...
var zl = /* @__PURE__ */ m$1((t9) => (af(), er.sanitize(t9)), "removeScript"), Il = /* @__PURE__ */ m$1((t9, e) => {
  var _a3;
  if (((_a3 = e.flowchart) == null ? void 0 : _a3.htmlLabels) !== false) {
    let r = e.securityLevel;
    r === "antiscript" || r === "strict" ? t9 = /* @__PURE__ */ zl(t9) : r !== "loose" && (t9 = /* @__PURE__ */ ql(t9), t9 = /* @__PURE__ */ t9.replace(/</g, "&lt;").replace(/>/g, "&gt;"), t9 = /* @__PURE__ */ t9.replace(/=/g, "&equals;"), t9 = /* @__PURE__ */ ff(t9));
  }
  return t9;
}, "sanitizeMore"), De = /* @__PURE__ */ m$1((t9, e) => t9 && (e.dompurifyConfig ? t9 = /* @__PURE__ */ er.sanitize(/* @__PURE__ */ Il(t9, e), e.dompurifyConfig).toString() : t9 = /* @__PURE__ */ er.sanitize(/* @__PURE__ */ Il(t9, e), {
  FORBID_TAGS: [
    "style"
  ]
}).toString(), t9), "sanitizeText"), hf = /* @__PURE__ */ m$1((t9, e) => typeof t9 == "string" ? De(t9, e) : t9.flat().map((r) => De(r, e)), "sanitizeTextOrArray"), cf = /* @__PURE__ */ m$1((t9) => zr.test(t9), "hasBreaks"), uf = /* @__PURE__ */ m$1((t9) => t9.split(zr), "splitBreaks"), ff = /* @__PURE__ */ m$1((t9) => t9.replace(/#br#/g, "<br/>"), "placeholderToBreak"), ql = /* @__PURE__ */ m$1((t9) => t9.replace(zr, "#br#"), "breakToPlaceholder"), mf = /* @__PURE__ */ m$1((t9) => {
  let e = "";
...
}, "getUrl"), df = /* @__PURE__ */ m$1((t9) => !(t9 === false || [
  "false",
  "null",
  "0"
  ...
  let e = /* @__PURE__ */ t9.filter((r) => !isNaN(r));
  return Math.min(...e);
}, "getMin"), dC = /* @__PURE__ */ m$1(function(t9) {
...
}, "processSet"), Rl = /* @__PURE__ */ m$1(() => window.MathMLElement !== void 0, "isMathMLSupported"), sn = /\$\$(.*)\$\$/g, Nl = /* @__PURE__ */ m$1((t9) => {
  var _a3;
  ...
  if (!Nl(t9)) return t9;
  if (!(Rl() || e.legacyMathML || e.forceLegacyMathML)) return t9.replace(sn, "MathML is unsupported in this environment.");
  let { default: r } = await __vitePreload(async () => {
    const { default: r2 } = await import("./vendor-min-mermaid~katex-SWYD7GD6.DYaxWg_a.chunk.js");
    return {
      default: r2
    };
  }, true ? __vite__mapDeps([0,1]) : void 0), o2 = e.forceLegacyMathML || !Rl() && e.legacyMathML ? "htmlAndMathml" : "mathml";
  return t9.split(zr).map((n2) => Nl(n2) ? `<div style="display: flex; align-items: center; justify-content: center; white-space: nowrap;">${n2}</div>` : `<div>${n2}</div>`).join("").replace(sn, (n2, s) => r.renderToString(s, {
    throwOnError: true,
    displayMode: true,
    output: o2
...
var an = "", ln = "", hn = "", cn = /* @__PURE__ */ m$1((t9) => De(t9, /* @__PURE__ */ Er()), "sanitizeText"), Sf = /* @__PURE__ */ m$1(() => {
  an = "", hn = "", ln = "";
...
var Wl = tt, Af = Va, Hl = Er, IC = yl, RC = Ar;
var Ef = /* @__PURE__ */ m$1((t9) => De(t9, /* @__PURE__ */ Hl()), "sanitizeText"), Df = Pl, Of = /* @__PURE__ */ m$1(() => un, "getCommonDb"), Oi = {}, NC = /* @__PURE__ */ m$1((t9, e, r) => {
  var _a3;
  Oi[t9] && Wl.warn(`Diagram with id ${t9} already registered. Overwriting.`), Oi[t9] = e, r && $o(t9, r), $l(t9, e.styles), (_a3 = e.injectUtils) == null ? void 0 : _a3.call(e, Wl, Af, Hl, Ef, Df, Of(), () => {
  });
}, "registerDiagram"), zC = /* @__PURE__ */ m$1((t9) => {
...
function Ie(t9) {
  let e, r, o2;
  t9.length !== 2 ? (e = Oe, r = /* @__PURE__ */ m$1((l, c) => Oe(/* @__PURE__ */ t9(l), c), "compare2"), o2 = /* @__PURE__ */ m$1((l, c) => t9(l) - c, "delta")) : (e = t9 === Oe || t9 === mn ? t9 : If, r = t9, o2 = t9);
  function n2(l, c) {
...
var rr = (_j = class extends Map {
  ...
  set(e, r) {
    return super.set(/* @__PURE__ */ zf(this, e), r);
  }
  delete(e) {
...
m$1(Pf, "keyof");
var $f = /* @__PURE__ */ Math.sqrt(50), Wf = /* @__PURE__ */ Math.sqrt(10), Hf = /* @__PURE__ */ Math.sqrt(2);
function Ii(t9, e, r) {
  let o2 = (e - t9) / Math.max(0, r), n2 = /* @__PURE__ */ Math.floor(/* @__PURE__ */ Math.log10(o2)), s = o2 / Math.pow(10, n2), a = s >= $f ? 10 : s >= Wf ? 5 : s >= Hf ? 2 : 1, l, c, h;
...
m$1(gn, "default");
var qi = 1, xn = 2, yn = 3, zi = 4, jl = 1e-6;
function Uf(t9) {
...
m$1(Xf, "entering");
function Zl(t9, e) {
  var r = [], o2 = null, n2 = null, s = 6, a = 6, l = 3, c = typeof window < "u" && window.devicePixelRatio > 1 ? 0 : 0.5, h = t9 === qi || t9 === zi ? -1 : 1, u = t9 === zi || t9 === xn ? "x" : "y", p = t9 === qi || t9 === yn ? Uf : Yf;
  function f(g) {
    var T = o2 ?? (e.ticks ? e.ticks.apply(e, r) : e.domain()), A = n2 ?? (e.tickFormat ? e.tickFormat.apply(e, r) : gn), $ = Math.max(s, 0) + l, q2 = /* @__PURE__ */ e.range(), G = +q2[0] + c, D = +q2[q2.length - 1] + c, M = /* @__PURE__ */ (e.bandwidth ? Vf : Gf)(/* @__PURE__ */ e.copy(), c), P = g.selection ? g.selection() : g, w = /* @__PURE__ */ P.selectAll(".domain").data([
      null
    ]), X = /* @__PURE__ */ P.selectAll(".tick").data(T, e).order(), j = /* @__PURE__ */ X.exit(), W = /* @__PURE__ */ X.enter().append("g").attr("class", "tick"), it = /* @__PURE__ */ X.select("line"), B = /* @__PURE__ */ X.select("text");
    w = /* @__PURE__ */ w.merge(/* @__PURE__ */ w.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), X = /* @__PURE__ */ X.merge(W), it = /* @__PURE__ */ it.merge(/* @__PURE__ */ W.append("line").attr("stroke", "currentColor").attr(u + "2", h * s)), B = /* @__PURE__ */ B.merge(/* @__PURE__ */ W.append("text").attr("fill", "currentColor").attr(u, h * $).attr("dy", t9 === qi ? "0em" : t9 === yn ? "0.71em" : "0.32em")), g !== P && (w = /* @__PURE__ */ w.transition(g), X = /* @__PURE__ */ X.transition(g), it = /* @__PURE__ */ it.transition(g), B = /* @__PURE__ */ B.transition(g), j = /* @__PURE__ */ j.transition(g).attr("opacity", jl).attr("transform", function(k) {
      return isFinite(k = /* @__PURE__ */ M(k)) ? p(k + c) : this.getAttribute("transform");
    }), W.attr("opacity", jl).attr("transform", function(k) {
      var x = this.parentNode.__axis;
      return p((x && isFinite(x = /* @__PURE__ */ x(k)) ? x : M(k)) + c);
    })), j.remove(), w.attr("d", t9 === zi || t9 === xn ? a ? "M" + h * a + "," + G + "H" + c + "V" + D + "H" + h * a : "M" + c + "," + G + "V" + D : a ? "M" + G + "," + h * a + "V" + c + "H" + D + "V" + h * a : "M" + G + "," + c + "H" + D), X.attr("opacity", 1).attr("transform", function(k) {
      return p(M(k) + c);
    }), it.attr(u + "2", h * s), B.attr(u, h * $).text(A), P.filter(Xf).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t9 === xn ? "start" : t9 === zi ? "end" : "middle"), P.each(function() {
      this.__axis = M;
    });
  }
...
m$1(rm, "childFirst");
function Tn(t9) {
  return this.select(t9 == null ? rm : em(typeof t9 == "function" ? t9 : Pi(t9)));
}
m$1(Tn, "default");
var im = Array.prototype.filter;
function om() {
...
function nm(t9) {
  return function() {
    return im.call(this.children, t9);
  };
}
m$1(nm, "childrenFilter");
function kn(t9) {
  return this.selectAll(t9 == null ? om : nm(typeof t9 == "function" ? t9 : Pi(t9)));
}
m$1(kn, "default");
function Sn(t9) {
...
function am(t9, e, r, o2, n2, s, a) {
  ...
  for (l = 0; l < p; ++l) g = a.call(t9, s[l], l, s) + "", (c = /* @__PURE__ */ h.get(g)) ? (o2[l] = c, c.__data__ = s[l], h.delete(g)) : r[l] = new $r(t9, s[l]);
...
function Bn(t9, e) {
  ...
  var r = e ? am : sm, o2 = this._parents, n2 = this._groups;
  typeof t9 != "function" && (t9 = /* @__PURE__ */ wn(t9));
  for (var s = n2.length, a = new Array(s), l = new Array(s), c = new Array(s), h = 0; h < s; ++h) {
    var u = o2[h], p = n2[h], f = p.length, g = /* @__PURE__ */ hm(/* @__PURE__ */ t9.call(u, u && u.__data__, h, o2)), T = g.length, A = l[h] = new Array(T), $ = a[h] = new Array(T), q2 = c[h] = new Array(f);
    r(u, p, A, $, q2, g, e);
    for (var G = 0, D = 0, M, P; G < T; ++G) if (M = A[G]) {
      for (G >= D && (D = G + 1); !(P = $[D]) && ++D < T; ) ;
      M._next = P || null;
    }
  }
...
function Pn(t9, e) {
  ...
  return this.each(/* @__PURE__ */ (e == null ? r.local ? fm : um : typeof e == "function" ? r.local ? gm : pm : r.local ? dm : mm)(r, e));
}
m$1(Pn, "default");
function Wr(t9) {
...
m$1(Cm, "styleFunction");
function $n(t9, e, r) {
  return arguments.length > 1 ? this.each(/* @__PURE__ */ (e == null ? xm : typeof e == "function" ? Cm : ym)(t9, e, r ?? "")) : _e(/* @__PURE__ */ this.node(), t9);
}
m$1($n, "default");
function _e(t9, e) {
...
m$1(_m, "propertyRemove");
function bm(t9, e) {
  return function() {
    this[t9] = e;
  };
}
m$1(bm, "propertyConstant");
function Tm(t9, e) {
  return function() {
    var r = /* @__PURE__ */ e.apply(this, arguments);
...
m$1(Tm, "propertyFunction");
function Wn(t9, e) {
  return arguments.length > 1 ? this.each(/* @__PURE__ */ (e == null ? _m : typeof e == "function" ? Tm : bm)(t9, e)) : this.node()[t9];
}
m$1(Wn, "default");
function Kl(t9) {
...
function Un(t9, e) {
  ...
  return this.each(/* @__PURE__ */ (typeof e == "function" ? vm : e ? km : Sm)(r, e));
}
m$1(Un, "default");
function wm() {
  this.textContent = "";
...
m$1(Fm, "textFunction");
function Yn(t9) {
  return arguments.length ? this.each(t9 == null ? wm : (typeof t9 == "function" ? Fm : Bm)(t9)) : this.node().textContent;
}
m$1(Yn, "default");
function Mm() {
  this.innerHTML = "";
...
m$1(Am, "htmlFunction");
function Gn(t9) {
  return arguments.length ? this.each(t9 == null ? Mm : (typeof t9 == "function" ? Am : Lm)(t9)) : this.node().innerHTML;
}
m$1(Gn, "default");
function Em() {
...
m$1(Rm, "constantNull");
function Zn(t9, e) {
  var r = typeof t9 == "function" ? t9 : Hr(t9), o2 = e == null ? Rm : typeof e == "function" ? e : Ce(e);
  return this.select(function() {
...
m$1(zm, "selection_cloneShallow");
function qm() {
  var t9 = /* @__PURE__ */ this.cloneNode(true), e = this.parentNode;
  return e ? e.insertBefore(t9, this.nextSibling) : t9;
}
m$1(qm, "selection_cloneDeep");
function Qn(t9) {
  return this.select(t9 ? qm : zm);
}
m$1(Qn, "default");
function Jn(t9) {
...
function Hm(t9, e, r) {
  return function() {
    var o2 = this.__on, n2, s = /* @__PURE__ */ Pm(e);
    if (o2) {
...
m$1(Hm, "onAdd");
function ts(t9, e, r) {
  var o2 = /* @__PURE__ */ $m(t9 + ""), n2, s = o2.length, a;
  if (arguments.length < 2) {
  ...
  for (l = e ? Hm : Wm, n2 = 0; n2 < s; ++n2) this.each(/* @__PURE__ */ l(o2[n2], e, r));
  return this;
}
m$1(ts, "default");
function eh(t9, e, r) {
...
m$1(Um, "dispatchConstant");
function Ym(t9, e) {
  return function() {
    return eh(this, t9, /* @__PURE__ */ e.apply(this, arguments));
  };
}
m$1(Ym, "dispatchFunction");
function es(t9, e) {
  return this.each(/* @__PURE__ */ (typeof e == "function" ? Ym : Um)(t9, e));
}
m$1(es, "default");
function* rs() {
...
m$1(Te, "Color");
var Ur = 0.7, Ui = 1 / Ur, ar = "\\s*([+-]?\\d+)\\s*", Yr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Qt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Vm = /^#([0-9a-f]{3,8})$/, Xm = new RegExp(`^rgb\\(${ar},${ar},${ar}\\)$`), jm = new RegExp(`^rgb\\(${Qt},${Qt},${Qt}\\)$`), Zm = new RegExp(`^rgba\\(${ar},${ar},${ar},${Yr}\\)$`), Km = new RegExp(`^rgba\\(${Qt},${Qt},${Qt},${Yr}\\)$`), Qm = new RegExp(`^hsl\\(${Yr},${Qt},${Qt}\\)$`), Jm = new RegExp(`^hsla\\(${Yr},${Qt},${Qt},${Yr}\\)$`), oh = {
  aliceblue: 15792383,
...
m$1(td, "color_formatHex8");
function ed() {
  return fh(this).formatHsl();
}
m$1(ed, "color_formatHsl");
function sh() {
...
function Yt(t9) {
  var e, r;
  return t9 = /* @__PURE__ */ (t9 + "").trim().toLowerCase(), (e = /* @__PURE__ */ Vm.exec(t9)) ? (r = e[1].length, e = /* @__PURE__ */ parseInt(e[1], 16), r === 6 ? ah(e) : r === 3 ? new St(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : r === 8 ? Wi(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : r === 4 ? Wi(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = /* @__PURE__ */ Xm.exec(t9)) ? new St(e[1], e[2], e[3], 1) : (e = /* @__PURE__ */ jm.exec(t9)) ? new St(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = /* @__PURE__ */ Zm.exec(t9)) ? Wi(e[1], e[2], e[3], e[4]) : (e = /* @__PURE__ */ Km.exec(t9)) ? Wi(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = /* @__PURE__ */ Qm.exec(t9)) ? ch(e[1], e[2] / 100, e[3] / 100, 1) : (e = /* @__PURE__ */ Jm.exec(t9)) ? ch(e[1], e[2] / 100, e[3] / 100, e[4]) : oh.hasOwnProperty(t9) ? ah(oh[t9]) : t9 === "transparent" ? new St(NaN, NaN, NaN, 0) : null;
}
m$1(Yt, "color");
function ah(t9) {
...
m$1(os, "hsl2rgb");
var dh = Math.PI / 180, ph = 180 / Math.PI;
var Gi = 18, gh = 0.96422, xh = 1, yh = 0.82521, Ch = 4 / 29, hr = 6 / 29, _h = 3 * hr * hr, id = hr * hr * hr;
function bh(t9) {
  ...
  return e === r && r === o2 ? s = a = n2 : (s = /* @__PURE__ */ ss((0.4360747 * e + 0.3850649 * r + 0.1430804 * o2) / gh), a = /* @__PURE__ */ ss((0.0139322 * e + 0.0971045 * r + 0.7141733 * o2) / yh)), new Jt(116 * n2 - 16, 500 * (s - n2), 200 * (n2 - a), t9.opacity);
}
m$1(bh, "labConvert");
function cs(t9, e, r, o2) {
  return arguments.length === 1 ? bh(t9) : new Jt(t9, e, r, o2 ?? 1);
}
m$1(cs, "lab");
...
function ss(t9) {
  return t9 > id ? Math.pow(t9, 1 / 3) : t9 / _h + Ch;
}
m$1(ss, "xyz2lab");
function as(t9) {
...
function od(t9) {
  ...
  if (t9 instanceof Jt || (t9 = /* @__PURE__ */ bh(t9)), t9.a === 0 && t9.b === 0) return new he(NaN, 0 < t9.l && t9.l < 100 ? 0 : NaN, t9.l, t9.opacity);
...
function Gr(t9, e, r, o2) {
  return arguments.length === 1 ? od(t9) : new he(t9, e, r, o2 ?? 1);
}
m$1(Gr, "hcl");
...
function vh(t9) {
  return (t9 = +t9) == 1 ? ce : function(e, r) {
    return r - e ? nd(e, r, t9) : cr(isNaN(e) ? r : e);
  };
}
m$1(vh, "gamma");
function ce(t9, e) {
...
m$1(ms, "default");
var ze = /* @__PURE__ */ m$1(function t(e) {
  var r = /* @__PURE__ */ vh(e);
  function o2(n2, s) {
...
function ur(t9, e) {
  ...
  return r < e.length && (s = /* @__PURE__ */ e.slice(r), l[a] ? l[a] += s : l[++a] = s), l.length < 2 ? c[0] ? ud(c[0].x) : cd(e) : (e = c.length, function(h) {
...
function ke(t9, e) {
  var r = typeof e, o2;
  return e == null || r === "boolean" ? cr(e) : (r === "number" ? gt : r === "string" ? (o2 = /* @__PURE__ */ Yt(e)) ? (e = o2, ze) : ur : e instanceof Yt ? ze : e instanceof Date ? ps : Fh(e) ? ds : Array.isArray(e) ? Mh : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? gs : gt)(t9, e);
}
m$1(ke, "default");
function Vi(t9, e) {
  return t9 = +t9, e = +e, function(r) {
...
function Dh(t9, e, r, o2) {
  ...
  return m$1(c, "scale"), function(h, u) {
    ...
    return h = /* @__PURE__ */ t9(h), u = /* @__PURE__ */ t9(u), s(h.translateX, h.translateY, u.translateX, u.translateY, p, f), a(h.rotate, u.rotate, p, f), l(h.skewX, u.skewX, p, f), c(h.scaleX, h.scaleY, u.scaleX, u.scaleY, p, f), h = u = null, function(g) {
      for (var T = -1, A = f.length, $; ++T < A; ) p[($ = f[T]).i] = /* @__PURE__ */ $.x(g);
      return p.join("");
    };
  };
}
m$1(Dh, "interpolateTransform");
var Cs = /* @__PURE__ */ Dh(Ah, "px, ", "px)", "deg)"), _s = /* @__PURE__ */ Dh(Eh, ", ", ")", ")");
function Se(t9, e) {
...
m$1(Ki, "copy");
function pd() {
  var t9 = Oh, e = Oh, r = ke, o2, n2, s, a = fr, l, c, h;
  function u() {
    var f = /* @__PURE__ */ Math.min(t9.length, e.length);
    return a !== fr && (a = /* @__PURE__ */ fd(t9[0], t9[f - 1])), l = f > 2 ? dd : md, c = h = null, p;
  }
  m$1(u, "rescale");
  function p(f) {
...
var gd = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function ve(t9) {
  if (!(e = /* @__PURE__ */ gd.exec(t9))) throw new Error("invalid format: " + t9);
  var e;
  return new Qi({
    fill: e[1],
    align: e[2],
...
function Es(t9) {
  ...
  function h(p) {
    p = /* @__PURE__ */ ve(p);
    var f = p.fill, g = p.align, T = p.sign, A = p.symbol, $ = p.zero, q2 = p.width, G = p.comma, D = p.precision, M = p.trim, P = p.type;
    P === "n" ? (G = true, P = "g") : As[P] || (D === void 0 && (D = 12), M = true, P = "g"), ($ || f === "0" && g === "=") && ($ = true, f = "0", g = "=");
    var w = A === "$" ? r : A === "#" && /[boxX]/.test(P) ? "0" + P.toLowerCase() : "", X = A === "$" ? o2 : /[%p]/.test(P) ? a : "", j = As[P], W = /* @__PURE__ */ /[defgprs%]/.test(P);
    ...
    function it(B) {
      ...
      if (P === "c") x = j(B) + x, B = "";
        ...
        B = +B;
        var R = B < 0 || 1 / B < 0;
        if (B = isNaN(B) ? c : j(/* @__PURE__ */ Math.abs(B), D), M && (B = /* @__PURE__ */ Fs(B)), R && +B == 0 && T !== "+" && (R = false), k = (R ? T === "(" ? T : l : T === "-" || T === "(" ? "" : T) + k, x = (P === "s" ? Rh[8 + Ms / 3] : "") + x + (R && T === "(" ? ")" : ""), W) {
      ...
      G && !$ && (B = /* @__PURE__ */ e(B, 1 / 0));
      var I = k.length + B.length + x.length, U = I < q2 ? new Array(q2 - I + 1).join(f) : "";
      switch (G && $ && (B = /* @__PURE__ */ e(U + B, U.length ? q2 - x.length : 1 / 0), U = ""), g) {
        case "<":
          B = k + B + x + U;
          break;
        case "=":
  ...
  m$1(h, "newFormat");
  function u(p, f) {
    var g = /* @__PURE__ */ h((p = /* @__PURE__ */ ve(p), p.type = "f", p)), T = Math.max(-8, /* @__PURE__ */ Math.min(8, /* @__PURE__ */ Math.floor(Gt(f) / 3))) * 3, A = /* @__PURE__ */ Math.pow(10, -T), $ = Rh[8 + T / 3];
    return function(q2) {
      return g(A * q2) + $;
    };
  }
...
function xd(t9) {
  ...
  return t9.ticks = function(r) {
    ...
    var n2 = /* @__PURE__ */ e();
    return Os(n2[0], n2[n2.length - 1], r ?? 10, o2);
  }, t9.nice = function(r) {
    r == null && (r = 10);
...
function Is() {
  ...
  }, Se.apply(t9, arguments), xd(t9);
}
m$1(Is, "linear");
var Rs = /* @__PURE__ */ new Date(), Ns = /* @__PURE__ */ new Date();
function ot(t9, e, r, o2) {
  ...
  }), r && (n2.count = (s, a) => (Rs.setTime(+s), Ns.setTime(+a), t9(Rs), t9(Ns), Math.floor(/* @__PURE__ */ r(Rs, Ns))), n2.every = (s) => (s = /* @__PURE__ */ Math.floor(s), !isFinite(s) || !(s > 0) ? null : s > 1 ? n2.filter(o2 ? (a) => o2(a) % s === 0 : (a) => n2.count(0, a) % s === 0) : n2)), n2;
}
m$1(ot, "timeInterval");
var Pe = /* @__PURE__ */ ot(() => {
}, (t9, e) => {
...
m$1(He, "timeWeekday");
var fe = /* @__PURE__ */ He(0), pr = /* @__PURE__ */ He(1), Ph = /* @__PURE__ */ He(2), $h = /* @__PURE__ */ He(3), we = /* @__PURE__ */ He(4), Wh = /* @__PURE__ */ He(5), Hh = /* @__PURE__ */ He(6);
fe.range;
pr.range;
Ph.range;
$h.range;
...
m$1(Kh, "ticker");
var [Wd, Hd] = Kh(Vt, co, Ye, ho, lo, ao), [zs, qs] = Kh(zt, xr, fe, ue, dr, mr);
function Ps(t9) {
  if (0 <= t9.y && t9.y < 100) {
...
m$1(Kr, "newDate");
function Ws(t9) {
  var e = t9.dateTime, r = t9.date, o2 = t9.time, n2 = t9.periods, s = t9.days, a = t9.shortDays, l = t9.months, c = t9.shortMonths, h = /* @__PURE__ */ Qr(n2), u = /* @__PURE__ */ Jr(n2), p = /* @__PURE__ */ Qr(s), f = /* @__PURE__ */ Jr(s), g = /* @__PURE__ */ Qr(a), T = /* @__PURE__ */ Jr(a), A = /* @__PURE__ */ Qr(l), $ = /* @__PURE__ */ Jr(l), q2 = /* @__PURE__ */ Qr(c), G = /* @__PURE__ */ Jr(c), D = {
    a: R,
    A: I,
    b: U,
    B: rt,
  ...
  D.x = /* @__PURE__ */ w(r, D), D.X = /* @__PURE__ */ w(o2, D), D.c = /* @__PURE__ */ w(e, D), M.x = /* @__PURE__ */ w(r, M), M.X = /* @__PURE__ */ w(o2, M), M.c = /* @__PURE__ */ w(e, M);
  function w(v, H) {
    return function(V) {
      var C = [], dt = -1, J = 0, bt = v.length, Tt, It, Le;
      for (V instanceof Date || (V = /* @__PURE__ */ new Date(+V)); ++dt < bt; ) v.charCodeAt(dt) === 37 && (C.push(/* @__PURE__ */ v.slice(J, dt)), (It = Qh[Tt = /* @__PURE__ */ v.charAt(++dt)]) != null ? Tt = /* @__PURE__ */ v.charAt(++dt) : It = Tt === "e" ? " " : "0", (Le = H[Tt]) && (Tt = /* @__PURE__ */ Le(V, It)), C.push(Tt), J = dt + 1);
      return C.push(/* @__PURE__ */ v.slice(J, dt)), C.join("");
    };
  }
  m$1(w, "newFormat");
  function X(v, H) {
    return function(V) {
      var C = /* @__PURE__ */ Kr(1900, void 0, 1), dt = /* @__PURE__ */ j(C, v, V += "", 0), J, bt;
      if (dt != V.length) return null;
      ...
      if (H && !("Z" in C) && (C.Z = 0), "p" in C && (C.H = C.H % 12 + C.p * 12), C.m === void 0 && (C.m = "q" in C ? C.q : 0), "V" in C) {
        ...
        "w" in C || (C.w = 1), "Z" in C ? (J = /* @__PURE__ */ $s(/* @__PURE__ */ Kr(C.y, 0, 1)), bt = /* @__PURE__ */ J.getUTCDay(), J = bt > 4 || bt === 0 ? gr.ceil(J) : gr(J), J = /* @__PURE__ */ Zr.offset(J, (C.V - 1) * 7), C.y = /* @__PURE__ */ J.getUTCFullYear(), C.m = /* @__PURE__ */ J.getUTCMonth(), C.d = J.getUTCDate() + (C.w + 6) % 7) : (J = /* @__PURE__ */ Ps(/* @__PURE__ */ Kr(C.y, 0, 1)), bt = /* @__PURE__ */ J.getDay(), J = bt > 4 || bt === 0 ? pr.ceil(J) : pr(J), J = /* @__PURE__ */ ue.offset(J, (C.V - 1) * 7), C.y = /* @__PURE__ */ J.getFullYear(), C.m = /* @__PURE__ */ J.getMonth(), C.d = J.getDate() + (C.w + 6) % 7);
      } else ("W" in C || "U" in C) && ("w" in C || (C.w = "u" in C ? C.u % 7 : "W" in C ? 1 : 0), bt = "Z" in C ? $s(/* @__PURE__ */ Kr(C.y, 0, 1)).getUTCDay() : Ps(/* @__PURE__ */ Kr(C.y, 0, 1)).getDay(), C.m = 0, C.d = "W" in C ? (C.w + 6) % 7 + C.W * 7 - (bt + 5) % 7 : C.w + C.U * 7 - (bt + 6) % 7);
      return "Z" in C ? (C.H += C.Z / 100 | 0, C.M += C.Z % 100, $s(C)) : Ps(C);
    };
  }
  m$1(X, "newParse");
  function j(v, H, V, C) {
    for (var dt = 0, J = H.length, bt = V.length, Tt, It; dt < J; ) {
      if (C >= bt) return -1;
      if (Tt = /* @__PURE__ */ H.charCodeAt(dt++), Tt === 37) {
        if (Tt = /* @__PURE__ */ H.charAt(dt++), It = P[Tt in Qh ? H.charAt(dt++) : Tt], !It || (C = /* @__PURE__ */ It(v, V, C)) < 0) return -1;
...
m$1(et, "pad");
function Gd(t9) {
  return t9.replace(Yd, "\\$&");
}
m$1(Gd, "requote");
function Qr(t9) {
  return new RegExp("^(?:" + t9.map(Gd).join("|") + ")", "i");
}
m$1(Qr, "formatRe");
function Jr(t9) {
...
m$1(Vd, "parseWeekdayNumberSunday");
function Xd(t9, e, r) {
  var o2 = /* @__PURE__ */ xt.exec(/* @__PURE__ */ e.slice(r, r + 1));
  return o2 ? (t9.u = +o2[0], r + o2[0].length) : -1;
}
m$1(Xd, "parseWeekdayNumberMonday");
function jd(t9, e, r) {
  var o2 = /* @__PURE__ */ xt.exec(/* @__PURE__ */ e.slice(r, r + 2));
  return o2 ? (t9.U = +o2[0], r + o2[0].length) : -1;
}
m$1(jd, "parseWeekNumberSunday");
function Zd(t9, e, r) {
  var o2 = /* @__PURE__ */ xt.exec(/* @__PURE__ */ e.slice(r, r + 2));
  return o2 ? (t9.V = +o2[0], r + o2[0].length) : -1;
}
m$1(Zd, "parseWeekNumberISO");
function Kd(t9, e, r) {
  var o2 = /* @__PURE__ */ xt.exec(/* @__PURE__ */ e.slice(r, r + 2));
  return o2 ? (t9.W = +o2[0], r + o2[0].length) : -1;
}
m$1(Kd, "parseWeekNumberMonday");
function Jh(t9, e, r) {
...
function sp(t9, e, r) {
  var o2 = /* @__PURE__ */ Ud.exec(/* @__PURE__ */ e.slice(r, r + 1));
...
m$1(cp, "formatHour12");
function up(t9, e) {
  return et(1 + ue.count(/* @__PURE__ */ zt(t9), t9), e, 3);
}
...
m$1(mp, "formatMonthNumber");
function dp(t9, e) {
  return et(/* @__PURE__ */ t9.getMinutes(), e, 2);
}
m$1(dp, "formatMinutes");
function pp(t9, e) {
...
function xp(t9, e) {
  return et(/* @__PURE__ */ fe.count(zt(t9) - 1, t9), e, 2);
}
...
m$1(hc, "dISO");
function yp(t9, e) {
  return t9 = /* @__PURE__ */ hc(t9), et(we.count(/* @__PURE__ */ zt(t9), t9) + (zt(t9).getDay() === 4), e, 2);
}
...
function _p(t9, e) {
  return et(/* @__PURE__ */ pr.count(zt(t9) - 1, t9), e, 2);
}
...
m$1(Rp, "formatUTCWeekdayNumberSunday");
function Np(t9, e) {
  return et(/* @__PURE__ */ gr.count(Vt(t9) - 1, t9), e, 2);
}
m$1(Np, "formatUTCWeekNumberMonday");
function zp(t9, e) {
  return et(t9.getUTCFullYear() % 100, e, 2);
}
m$1(zp, "formatUTCYear");
function qp(t9, e) {
...
m$1($p, "formatUTCFullYearISO");
function Wp() {
  return "+0000";
}
m$1(Wp, "formatUTCZone");
function nc() {
  return "%";
}
...
function Hs(t9) {
  return yr = /* @__PURE__ */ Ws(t9), uo = yr.format, yr.parse, yr.utcFormat, yr.utcParse, yr;
}
...
function pc(t9, e, r, o2, n2, s, a, l, c, h) {
  var u = /* @__PURE__ */ Xr(), p = u.invert, f = u.domain, g = /* @__PURE__ */ h(".%L"), T = /* @__PURE__ */ h(":%S"), A = /* @__PURE__ */ h("%I:%M"), $ = /* @__PURE__ */ h("%I %p"), q2 = /* @__PURE__ */ h("%a %d"), G = /* @__PURE__ */ h("%b %d"), D = /* @__PURE__ */ h("%B"), M = /* @__PURE__ */ h("%Y");
  function P(w) {
    return (c(w) < w ? g : l(w) < w ? T : a(w) < w ? A : s(w) < w ? $ : o2(w) < w ? n2(w) < w ? q2 : G : r(w) < w ? D : M)(w);
  }
...
m$1(pc, "calendar");
function gc() {
  return Se.apply(/* @__PURE__ */ pc(zs, qs, zt, xr, fe, ue, dr, mr, te, uo).domain([
    new Date(2e3, 0, 1),
    new Date(2e3, 0, 2)
  ]), arguments);
}
...
function Ys() {
  ...
  function p() {
    ...
    var $ = /* @__PURE__ */ Ni(f).map(function(q2) {
      return T + s * q2;
    });
    return r(g ? $.reverse() : $);
  }
...
var Xe = (_k = class {
  ...
  arcTo(e, r, o2, n2, s) {
    ...
    if (this._x1 === null) this._append`M${this._x1 = e},${this._y1 = r}`;
      ...
      let g = o2 - a, T = n2 - l, A = c * c + h * h, $ = g * g + T * T, q2 = /* @__PURE__ */ Math.sqrt(A), G = /* @__PURE__ */ Math.sqrt(f), D = s * Math.tan((js - Math.acos((A + f - $) / (2 * q2 * G))) / 2), M = D / G, P = D / q2;
...
function po(t9, e, r, o2, n2, s, a) {
  var l = t9 - r, c = e - o2, h = (a ? s : -s) / Ge(l * l + c * c), u = h * c, p = -h * l, f = t9 + u, g = e + p, T = r + u, A = o2 + p, $ = (f + T) / 2, q2 = (g + A) / 2, G = T - f, D = A - g, M = G * G + D * D, P = n2 - s, w = f * A - T * g, X = (D < 0 ? -1 : 1) * Ge(/* @__PURE__ */ xc(0, P * P * M - w * w)), j = (w * D - G * X) / M, W = (-w * G - D * X) / M, it = (w * D + G * X) / M, B = (-w * G + D * X) / M, k = j - $, x = W - q2, y = it - $, L = B - q2;
  return k * k + x * x > y * y + L * L && (j = it, W = B), {
    cx: j,
    cy: W,
    x01: -u,
    y01: -p,
...
function bc() {
  ...
  function h() {
    var u, p, f = +t9.apply(this, arguments), g = +e.apply(this, arguments), T = n2.apply(this, arguments) - ti, A = s.apply(this, arguments) - ti, $ = /* @__PURE__ */ Vs(A - T), q2 = A > T;
    if (l || (l = u = /* @__PURE__ */ c()), g < f && (p = g, g = f, f = p), !(g > yt)) l.moveTo(0, 0);
    else if ($ > _r - yt) l.moveTo(g * Fe(T), g * Xt(T)), l.arc(0, 0, g, T, A, !q2), f > yt && (l.moveTo(f * Fe(A), f * Xt(A)), l.arc(0, 0, f, A, T, q2));
    else {
      var G = T, D = A, M = T, P = A, w = $, X = $, j = a.apply(this, arguments) / 2, W = j > yt && (o2 ? +o2.apply(this, arguments) : Ge(f * f + g * g)), it = /* @__PURE__ */ fo(Vs(g - f) / 2, +r.apply(this, arguments)), B = it, k = it, x, y;
      if (W > yt) {
        var L = /* @__PURE__ */ Xs(W / f * Xt(j)), S = /* @__PURE__ */ Xs(W / g * Xt(j));
        (w -= L * 2) > yt ? (L *= q2 ? 1 : -1, M += L, P -= L) : (w = 0, M = P = (T + A) / 2), (X -= S * 2) > yt ? (S *= q2 ? 1 : -1, G += S, D -= S) : (X = 0, G = D = (T + A) / 2);
      }
      var R = g * Fe(G), I = g * Xt(G), U = f * Fe(P), rt = f * Xt(P);
      if (it > yt) {
        var Y = g * Fe(D), nt = g * Xt(D), Q = f * Fe(M), Ft = f * Xt(M), Z;
        if ($ < Cr) if (Z = /* @__PURE__ */ Jp(R, I, Q, Ft, Y, nt, U, rt)) {
          var Ct = R - Z[0], _t = I - Z[1], lt = Y - Z[0], v = nt - Z[1], H = 1 / Xt(yc((Ct * lt + _t * v) / (Ge(Ct * Ct + _t * _t) * Ge(lt * lt + v * v))) / 2), V = /* @__PURE__ */ Ge(Z[0] * Z[0] + Z[1] * Z[1]);
          B = /* @__PURE__ */ fo(it, (f - V) / (H - 1)), k = /* @__PURE__ */ fo(it, (g - V) / (H + 1));
        } else B = k = 0;
      }
      X > yt ? k > yt ? (x = /* @__PURE__ */ po(Q, Ft, R, I, g, k, q2), y = /* @__PURE__ */ po(Y, nt, U, rt, g, k, q2), l.moveTo(x.cx + x.x01, x.cy + x.y01), k < it ? l.arc(x.cx, x.cy, k, /* @__PURE__ */ vt(x.y01, x.x01), /* @__PURE__ */ vt(y.y01, y.x01), !q2) : (l.arc(x.cx, x.cy, k, /* @__PURE__ */ vt(x.y01, x.x01), /* @__PURE__ */ vt(x.y11, x.x11), !q2), l.arc(0, 0, g, /* @__PURE__ */ vt(x.cy + x.y11, x.cx + x.x11), /* @__PURE__ */ vt(y.cy + y.y11, y.cx + y.x11), !q2), l.arc(y.cx, y.cy, k, /* @__PURE__ */ vt(y.y11, y.x11), /* @__PURE__ */ vt(y.y01, y.x01), !q2))) : (l.moveTo(R, I), l.arc(0, 0, g, G, D, !q2)) : l.moveTo(R, I), !(f > yt) || !(w > yt) ? l.lineTo(U, rt) : B > yt ? (x = /* @__PURE__ */ po(U, rt, Y, nt, f, -B, q2), y = /* @__PURE__ */ po(R, I, Q, Ft, f, -B, q2), l.lineTo(x.cx + x.x01, x.cy + x.y01), B < it ? l.arc(x.cx, x.cy, B, /* @__PURE__ */ vt(x.y01, x.x01), /* @__PURE__ */ vt(y.y01, y.x01), !q2) : (l.arc(x.cx, x.cy, B, /* @__PURE__ */ vt(x.y01, x.x01), /* @__PURE__ */ vt(x.y11, x.x11), !q2), l.arc(0, 0, f, /* @__PURE__ */ vt(x.cy + x.y11, x.cx + x.x11), /* @__PURE__ */ vt(y.cy + y.y11, y.cx + y.x11), q2), l.arc(y.cx, y.cy, B, /* @__PURE__ */ vt(y.y11, y.x11), /* @__PURE__ */ vt(y.y01, y.x01), !q2))) : l.arc(0, 0, f, P, M, q2);
    }
...
function wc() {
  ...
  function a(l) {
    var c, h = (l = /* @__PURE__ */ ei(l)).length, u, p, f = 0, g = new Array(h), T = new Array(h), A = +o2.apply(this, arguments), $ = /* @__PURE__ */ Math.min(_r, /* @__PURE__ */ Math.max(-_r, n2.apply(this, arguments) - A)), q2, G = /* @__PURE__ */ Math.min(Math.abs($) / h, /* @__PURE__ */ s.apply(this, arguments)), D = G * ($ < 0 ? -1 : 1), M;
    for (c = 0; c < h; ++c) (M = T[g[c] = c] = +t9(l[c], c, l)) > 0 && (f += M);
    for (e != null ? g.sort(function(P, w) {
      return e(T[P], T[w]);
    }) : r != null && g.sort(function(P, w) {
      return r(l[P], l[w]);
    }), c = 0, p = f ? ($ - h * D) / f : 0; c < h; ++c, A = q2) u = g[c], M = T[u], q2 = A + (M > 0 ? M * p : 0) + D, T[u] = {
      data: l[u],
      index: c,
      value: M,
      startAngle: A,
...
var sg = /* @__PURE__ */ m$1(function t6(e) {
  function r(o2) {
    return e ? new Dc(o2, e) : new yo(o2, 0);
  }
...
var ag = /* @__PURE__ */ m$1(function t7(e) {
  function r(o2) {
    return e ? new Oc(o2, e) : new Co(o2, 0);
  }
  return m$1(r, "catmullRom"), r.alpha = function(o2) {
    return t7(+o2);
  }, r;
...
function qc(t9, e, r) {
  ...
  return (zc(s) + zc(a)) * Math.min(/* @__PURE__ */ Math.abs(s), /* @__PURE__ */ Math.abs(a), 0.5 * Math.abs(l)) || 0;
}
m$1(qc, "slope3");
function Pc(t9, e) {
  var r = t9._x1 - t9._x0;
...
function $c(t9) {
  this._context = new Wc(t9);
}
m$1($c, "MonotoneY");
($c.prototype = /* @__PURE__ */ Object.create(bo.prototype)).point = function(t9, e) {
  bo.prototype.point.call(this, e, t9);
};
function Wc(t9) {
  this._context = t9;
}
m$1(Wc, "ReflectContext");
Wc.prototype = {
...
m$1(dg, "parseTypenames");
ko.prototype = Xc.prototype = {
  constructor: ko,
  on: /* @__PURE__ */ m$1(function(t9, e) {
    var r = this._, o2 = /* @__PURE__ */ dg(t9 + "", r), n2, s = -1, a = o2.length;
    if (arguments.length < 2) {
...
function Vc(t9, e, r) {
  for (var o2 = 0, n2 = t9.length; o2 < n2; ++o2) if (t9[o2].name === e) {
    t9[o2] = mg, t9 = /* @__PURE__ */ t9.slice(0, o2).concat(/* @__PURE__ */ t9.slice(o2 + 1));
    break;
  }
...
function di(t9, e) {
  var r;
  return (typeof e == "number" ? gt : e instanceof Yt ? ze : (r = /* @__PURE__ */ Yt(e)) ? (e = r, ze) : ur)(t9, e);
}
m$1(di, "default");
function Sg(t9) {
  return function() {
...
function oa(t9, e) {
  var r = /* @__PURE__ */ Kt(t9), o2 = r === "transform" ? _s : di;
...
function na(t9, e) {
  ...
  return this.tween(r, /* @__PURE__ */ (o2.local ? Eg : Dg)(o2, e));
}
m$1(na, "default");
function Og(t9, e) {
  return function() {
...
function sa(t9) {
  var e = this._id;
  return arguments.length ? this.each(/* @__PURE__ */ (typeof t9 == "function" ? Og : Ig)(e, t9)) : mt(/* @__PURE__ */ this.node(), e).delay;
}
m$1(sa, "default");
function Rg(t9, e) {
  return function() {
...
m$1(Rg, "durationFunction");
function Ng(t9, e) {
  return e = +e, function() {
    wt(this, t9).duration = e;
  };
}
m$1(Ng, "durationConstant");
function aa(t9) {
  var e = this._id;
  return arguments.length ? this.each(/* @__PURE__ */ (typeof t9 == "function" ? Rg : Ng)(e, t9)) : mt(/* @__PURE__ */ this.node(), e).duration;
}
m$1(aa, "default");
function zg(t9, e) {
  if (typeof e != "function") throw new Error();
...
function la(t9) {
  var e = this._id;
  return arguments.length ? this.each(/* @__PURE__ */ zg(e, t9)) : mt(/* @__PURE__ */ this.node(), e).ease;
}
m$1(la, "default");
function qg(t9, e) {
  return function() {
...
function ca(t9) {
  typeof t9 != "function" && (t9 = /* @__PURE__ */ nr(t9));
  for (var e = this._groups, r = e.length, o2 = new Array(r), n2 = 0; n2 < r; ++n2) for (var s = e[n2], a = s.length, l = o2[n2] = [], c, h = 0; h < a; ++h) (c = s[h]) && t9.call(c, c.__data__, h, s) && l.push(c);
  return new Ot(o2, this._parents, this._name, this._id);
}
m$1(ca, "default");
function ua(t9) {
...
function fa(t9, e) {
  var r = this._id;
  return arguments.length < 2 ? mt(/* @__PURE__ */ this.node(), r).on.on(t9) : this.each(/* @__PURE__ */ $g(r, t9, e));
}
m$1(fa, "default");
function Wg(t9) {
  return function() {
...
m$1(Wg, "removeFunction");
function ma() {
  return this.on("end.remove", /* @__PURE__ */ Wg(this._id));
}
m$1(ma, "default");
function da(t9) {
  var e = this._name, r = this._id;
  typeof t9 != "function" && (t9 = /* @__PURE__ */ Ce(t9));
  for (var o2 = this._groups, n2 = o2.length, s = new Array(n2), a = 0; a < n2; ++a) for (var l = o2[a], c = l.length, h = s[a] = new Array(c), u, p, f = 0; f < c; ++f) (u = l[f]) && (p = /* @__PURE__ */ t9.call(u, u.__data__, f, l)) && ("__data__" in u && (p.__data__ = u.__data__), h[f] = p, me(h[f], e, r, f, h, /* @__PURE__ */ mt(u, r)));
  return new Ot(s, this._parents, e, r);
}
m$1(da, "default");
function pa(t9) {
  var e = this._name, r = this._id;
  ...
  for (var o2 = this._groups, n2 = o2.length, s = [], a = [], l = 0; l < n2; ++l) for (var c = o2[l], h = c.length, u, p = 0; p < h; ++p) if (u = c[p]) {
    for (var f = /* @__PURE__ */ t9.call(u, u.__data__, p, c), g, T = /* @__PURE__ */ mt(u, r), A = 0, $ = f.length; A < $; ++A) (g = f[A]) && me(g, e, r, A, f, T);
    s.push(f), a.push(u);
  }
  return new Ot(s, a, e, r);
}
m$1(pa, "default");
...
function ba() {
  ...
  return new Ot(o2, this._parents, t9, r);
}
m$1(ba, "default");
function Ta() {
...
function ka(t9) {
  var e, r;
  t9 instanceof Ot ? (e = t9._id, t9 = t9._name) : (e = /* @__PURE__ */ Ao(), (r = ex).time = /* @__PURE__ */ hi(), t9 = t9 == null ? null : t9 + "");
  for (var o2 = this._groups, n2 = o2.length, s = 0; s < n2; ++s) for (var a = o2[s], l = a.length, c, h = 0; h < l; ++h) (c = a[h]) && me(c, t9, e, h, a, r || rx(c, e));
  return new Ot(o2, this._parents, t9, e);
}
m$1(ka, "default");
