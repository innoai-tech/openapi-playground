import { I as Ie$1 } from './vendor-min-mermaid~chunk-YM3XIQPS.BqB7gHkV.chunk.js';
import { f } from './vendor-min-mermaid~chunk-TI4EEUUG.BFlBPHyk.chunk.js';
import { F as Ff, B as Bf, L as Lf, M as Mf, w as wf, v as vf, H as Hl, i as ih, _ as gc, $ as Yl, a0 as Ul, T as Tf, a1 as Is, a2 as sm, t as tt$1, a3 as Zf, a4 as uo, a5 as xr, a6 as fe, a7 as Hh, a8 as $h, a9 as we, aa as Wh, ab as Ph, ac as pr, ad as ue, ae as mr, af as dr, ag as ee, ah as Pe$1, ai as jf, g as gC, S as Sf, aj as Ya } from './vendor-min-mermaid~chunk-ZKYS2E5M.Cc2x1uDP.chunk.js';
...
var Me = /*#__PURE__*/ n((zt, Nt)=>{
    (function(t, e) {
        ...
        }, e = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, s = /\d/, a = /\d\d/, r = /\d\d?/, f = /\d*[^-_:/,()\s\d]+/, k = {}, D = /*#__PURE__*/ m$1(function(p) {
                ...
                if (typeof j == "string") {
                    ...
                    v && (x = B[2]), k = /*#__PURE__*/ this.$locale(), !g && x && (k = A.Ls[x]), this.$d = /*#__PURE__*/ function(l, h, d, T) {
                        try {
                            ...
                            var n = /*#__PURE__*/ z(h)(l), u = n.year, i = n.month, M = n.day, C = n.hours, E = n.minutes, P = n.seconds, Y = n.milliseconds, at = n.zone, F = n.week, Z = new Date, nt = M || (u || i ? 1 : Z.getDate()), it = u || Z.getFullYear(), ot = 0;
                    ...
                    }(K, j, U, A), this.init(), x && x !== true && (this.$L = this.locale(x).$L), b && K != this.format(j) && (this.$d = new Date("")), k = {};
            ...
            s.format = function(r) {
                ...
                var D = /*#__PURE__*/ this.$utils(), _ = /*#__PURE__*/ (r || "YYYY-MM-DDTHH:mm:ssZ").replace(/\[([^\]]+)]|Q|wo|ww|w|WW|W|zzz|z|gggg|GGGG|Do|X|x|k{1,2}|S/g, function(L) {
                    switch(L){
                        ...
                        case "w":
                        case "ww":
                            return D.s(/*#__PURE__*/ f.week(), L === "w" ? 1 : 2, "0");
                        case "W":
                        case "WW":
                            return D.s(/*#__PURE__*/ f.isoWeek(), L === "W" ? 1 : 2, "0");
                        case "k":
                        case "kk":
                            return D.s(/*#__PURE__*/ String(f.$H === 0 ? 24 : f.$H), L === "k" ? 1 : 2, "0");
                        case "X":
...
var Vt = /*#__PURE__*/ function() {
    var t = /*#__PURE__*/ m$1(function(w, c, l, h) {
        ...
        performAction: /*#__PURE__*/ m$1(function(c, l, h, d, T, n, u) {
            var i = n.length - 1;
            switch(T){
                case 1:
                    return n[i - 1];
                ...
                case 16:
                    ...
                    break;
                case 17:
                    d.setDateFormat(/*#__PURE__*/ n[i].substr(11)), this.$ = /*#__PURE__*/ n[i].substr(11);
                    break;
                case 18:
                    d.enableInclusiveEndDates(), this.$ = /*#__PURE__*/ n[i].substr(18);
                    break;
                case 19:
                    d.TopAxis(), this.$ = /*#__PURE__*/ n[i].substr(8);
                    break;
                case 20:
                    d.setAxisFormat(/*#__PURE__*/ n[i].substr(11)), this.$ = /*#__PURE__*/ n[i].substr(11);
                    break;
                case 21:
                    d.setTickInterval(/*#__PURE__*/ n[i].substr(13)), this.$ = /*#__PURE__*/ n[i].substr(13);
                    break;
                case 22:
                    d.setExcludes(/*#__PURE__*/ n[i].substr(9)), this.$ = /*#__PURE__*/ n[i].substr(9);
                    break;
                case 23:
                    d.setIncludes(/*#__PURE__*/ n[i].substr(9)), this.$ = /*#__PURE__*/ n[i].substr(9);
                    break;
                case 24:
                    d.setTodayMarker(/*#__PURE__*/ n[i].substr(12)), this.$ = /*#__PURE__*/ n[i].substr(12);
                    break;
                case 27:
                    d.setDiagramTitle(/*#__PURE__*/ n[i].substr(6)), this.$ = /*#__PURE__*/ n[i].substr(6);
                    break;
                case 28:
                    this.$ = /*#__PURE__*/ n[i].trim(), d.setAccTitle(this.$);
                    break;
                case 29:
                case 30:
                    this.$ = /*#__PURE__*/ n[i].trim(), d.setAccDescription(this.$);
                    break;
                case 31:
                    d.addSection(/*#__PURE__*/ n[i].substr(8)), this.$ = /*#__PURE__*/ n[i].substr(8);
                    break;
                case 33:
        ...
        parse: /*#__PURE__*/ m$1(function(c) {
            var l = this, h = [
                ...
                null
            ], n = [], u = this.table, i = "", M = 0, C = 0, E = 0, P = 2, Y = 1, at = /*#__PURE__*/ n.slice.call(arguments, 1), F = /*#__PURE__*/ Object.create(this.lexer), Z = {
                yy: {}
            };
            ...
            function ht(X) {
                h.length = h.length - 2 * X, T.length = T.length - X, n.length = n.length - X;
            }
            m$1(ht, "popStack");
            function kt() {
                var X;
            ...
            m$1(kt, "lex");
            for(var V, rt, Q, H, On, Ct, ct = {}, bt, J, ee, xt;;){
...
Expecting ` + xt.join(", ") + ", got '" + (this.terminals_[V] || V) + "'" : St = "Parse error on line " + (M + 1) + ": Unexpected " + (V == Y ? "end of input" : "'" + (this.terminals_[V] || V) + "'"), this.parseError(St, {
                ...
                switch(H[0]){
                    case 1:
                        h.push(V), T.push(F.yytext), n.push(F.yylloc), h.push(H[1]), V = null, rt ? (V = rt, rt = null) : (C = F.yyleng, i = F.yytext, M = F.yylineno, it = F.yylloc, E > 0);
                        break;
                    case 2:
                        ...
                        J && (h = /*#__PURE__*/ h.slice(0, -1 * J * 2), T = /*#__PURE__*/ T.slice(0, -1 * J), n = /*#__PURE__*/ n.slice(0, -1 * J)), h.push(this.productions_[H[1]][0]), T.push(ct.$), n.push(ct._$), ee = u[h[h.length - 2]][h[h.length - 1]], h.push(ee);
                        break;
                    case 3:
                        return true;
                }
...
` + l + "^";
            ...
            next: /*#__PURE__*/ m$1(function() {
                ...
                for(var T = /*#__PURE__*/ this._currentRules(), n = 0; n < T.length; n++)if (h = /*#__PURE__*/ this._input.match(this.rules[T[n]]), h && (!l || h[0].length > l[0].length)) {
                    if (l = h, d = n, this.options.backtrack_lexer) {
                        if (c = /*#__PURE__*/ this.test_match(h, T[n]), c !== false) return c;
                        if (this._backtrack) {
                            l = false;
                            continue;
                        } else return false;
...
var Le = {
    friday: 5,
    saturday: 6
}, $ = "", Xt = "", qt, Ut = "", yt = [], pt = [], Zt = new Map, Qt = [], wt = [], ft = "", Kt = "", Oe = [
    "active",
    "done",
    "crit",
    "milestone"
], $t = [], gt = false, Jt = false, te = "sunday", _t = "saturday", jt = 0, Ke = /*#__PURE__*/ m$1(function() {
    Qt = [], wt = [], ft = "", $t = [], Tt = 0, Ht = void 0, vt = void 0, O = [], $ = "", Xt = "", Kt = "", qt = void 0, Ut = "", yt = [], pt = [], gt = false, Jt = false, jt = 0, Zt = new Map, Sf(), te = "sunday", _t = "saturday";
    ...
    let [k, D] = _n(r, f, e, s, a);
    t.endTime = /*#__PURE__*/ k.toDate(), t.renderEndTime = D;
}, "checkTaskDates"), _n = /*#__PURE__*/ m$1(function(t, e, s, a, r) {
    let f = false, k = null;
    for(; t <= e;)f || (k = /*#__PURE__*/ e.toDate()), f = /*#__PURE__*/ Pe(t, s, a, r), f && (e = /*#__PURE__*/ e.add(1, "d")), t = /*#__PURE__*/ t.add(1, "d");
    return [
        e,
        k
    ];
    ...
    switch(a.length){
        case 1:
            r.id = /*#__PURE__*/ dt(), r.startTime = t.endTime, f = a[0];
            break;
        case 2:
            r.id = /*#__PURE__*/ dt(), r.startTime = /*#__PURE__*/ Gt(void 0, $, a[0]), f = a[1];
            break;
        case 3:
            r.id = /*#__PURE__*/ dt(a[0]), r.startTime = /*#__PURE__*/ Gt(void 0, $, a[1]), f = a[2];
            break;
    }
    return f && (r.endTime = /*#__PURE__*/ Re(r.startTime, $, f, gt), r.manualEndTime = /*#__PURE__*/ (0, q.default)(f, "YYYY-MM-DD", true).isValid(), ze(r, $, pt, yt)), r;
...
var Yn = /*#__PURE__*/ m$1(function() {
    ...
    let s = /*#__PURE__*/ [
        ...
        ...t
    ].sort((f, k)=>f.startTime - k.startTime || f.order - k.order), r = 0;
    for (let f of a)for(let k = 0; k < s.length; k++)if (f.startTime >= s[k]) {
        s[k] = f.endTime, f.order = k + e, k > r && (r = k);
        break;
    }
    return r;
}, "getMaxIntersections"), tt, Wn = /*#__PURE__*/ m$1(function(t, e, s, a) {
    let r = Hl().gantt, f = Hl().securityLevel, k;
    f === "sandbox" && (k = /*#__PURE__*/ ih("#i" + e));
    let D = f === "sandbox" ? ih(k.nodes()[0].contentDocument.body) : ih("body"), _ = f === "sandbox" ? k.nodes()[0].contentDocument : document, L = /*#__PURE__*/ _.getElementById(e);
    ...
    function N(g, v, b, x, y, w, c) {
        ...
        if (d.append("rect").attr("id", function(u) {
            ...
            return u.milestone ? m(u.startTime) + x + .5 * (m(u.endTime) - m(u.startTime)) - .5 * y : m(u.startTime) + x;
        }).attr("y", function(u, i) {
            ...
            return i = u.order, (m(u.startTime) + x + .5 * (m(u.endTime) - m(u.startTime))).toString() + "px " + (i * v + b + .5 * y).toString() + "px";
            ...
            u.milestone && (i += .5 * (m(u.endTime) - m(u.startTime)) - .5 * y), u.milestone && (M = i + y);
    ...
    function R(g, v, b, x, y, w, c, l) {
        ...
        let T = /*#__PURE__*/ a.db.getDateFormat(), n = [], u = null, i = /*#__PURE__*/ (0, Dt.default)(h);
        for(; i.valueOf() <= d;)a.db.isInvalidDate(i, T, c, l) ? u ? u.end = i : u = {
            start: i,
            end: i
        } : u && (n.push(u), u = null), i = /*#__PURE__*/ i.add(1, "d");
        p.append("g").selectAll("rect").data(n).enter().append("rect").attr("id", function(C) {
            ...
            return (m(C.start) + b + .5 * (m(C.end) - m(C.start))).toString() + "px " + (E * g + .5 * y).toString() + "px";
    ...
    function B(g, v, b, x) {
        ...
        if (y === "off") return;
        let w = /*#__PURE__*/ p.append("g").attr("class", "today"), c = new Date, l = /*#__PURE__*/ w.append("line");
