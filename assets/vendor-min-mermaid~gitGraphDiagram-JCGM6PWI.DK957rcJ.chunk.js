import { $ as Vo, A as $o, B as Ko, F as Go, G as No, I as Ho, Mn as c, Q as Uo, T as wt, W as Ni, _ as Ut, dt as hn, gt as mr, hn as pt, jn as p, ln as ia, m as Lt, pt as jo, q as Ot } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.BVgxNvHA.chunk.js";
...
var w = mr()?.gitGraph, P = 10, D = 40, k = 4, T = 2, G = 8, b = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), R = 30, L = /* @__PURE__ */ new Map(), A = [], E = 0, y = "LR", qe = /* @__PURE__ */ m(() => {
	...
	y === "BT" && (s$1 && Se(p$1, e, n), p$1 = /* @__PURE__ */ p$1.reverse()), p$1.forEach((h) => {
		...
		if (o) {
			...
			Fe(a, f, c$1, l, I, x), ze(t, f, c$1, n), Ke(t, f, c$1, n);
		}
