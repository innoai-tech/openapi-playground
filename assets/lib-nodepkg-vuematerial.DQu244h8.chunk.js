...
const Icon = styled("span", (props, _) => {
  return (Wrapper) => {
    ...
    return /* @__PURE__ */ jsx(Wrapper, { "data-icon": true, "data-placement": props.placement, "data-has-size": !!props.size, children: /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", width: size, height: size, children: /* @__PURE__ */ jsx("path", { d: props.path }) }) });
  };
})({
...
const Tooltip = component((props, { slots }) => {
  ...
  return () => {
    ...
    return /* @__PURE__ */ jsx(Popper, { isOpen: isOpen.value, $content: /* @__PURE__ */ jsx(TooltipContainer, { children: props.title }), $transition: ({ content }) => /* @__PURE__ */ jsx(FadeInOutTransition$1, { children: content }), children: child ? cloneVNode(child, {
      onMouseover: () => {
        isOpen.value = true;
      },
      onMouseout: () => {
...
component((props, { slots }) => {
  ...
  return () => {
    ...
    return /* @__PURE__ */ jsx(Popper, { isOpen: isOpen.value, placement: props.placement, onClickOutside: () => {
      isOpen.value = false;
    }, $content: /* @__PURE__ */ jsx(MenuContainer, { children: slots.menu?.() }), children: trigger ? cloneVNode(trigger, {
      onClick: () => {
        isOpen.value = true;
      }
    }) : null });
...
const Dialog = component((props, { slots, emit }) => {
  ...
  return () => {
    return /* @__PURE__ */ jsx(Overlay, { isOpen: mount.value, onContentBeforeMount: () => {
      animateEnterOrLeave.value = true;
    }, onEscKeydown: () => {
      animateEnterOrLeave.value = false;
    }, children: /* @__PURE__ */ jsxs(Container, { children: [
      /* @__PURE__ */ jsx(FadeInOutTransition, { onComplete: (t) => {
        if (t === "leave") {
          mount.value = false;
          emit("close");
        }
...
styled("label", (props, { slots }) => {
  return (Wrap) => {
    ...
    return /* @__PURE__ */ jsxs(Wrap, { "data-valued": valued, "data-invalid": invalid, "data-disabled": disabled, "data-focus-within": props.focus, "data-has-leading": !!slots.leading, "data-has-trailing": !!slots.trailing, children: [
      /* @__PURE__ */ jsxs("div", { "data-input-container": "", children: [
        slots.leading && /* @__PURE__ */ jsx(Maker, { role: "leading", children: slots.leading() }),
        /* @__PURE__ */ jsx("div", { "data-input-label": "", children: slots.label?.() }),
        children,
        slots.trailing && /* @__PURE__ */ jsx(Maker, { role: "trailing", children: slots.trailing() })
      ] }),
      slots.supporting && /* @__PURE__ */ jsx("div", { "data-input-supporting": "", children: slots.supporting?.() })
    ] });
  };
})({
  display: "block",
...
export { Dialog as D, FilledButton as F, IconButton as I, Tooltip as T, Icon as a, mdiContentCopy as b, mdiCancel as c, mdiCheckBold as d, mdiMinusBoxOutline as e, mdiUploadBox as f, mdiKeyOutline as g, mdiKey as h, mdiHelp as i, mdiHelpBox as m };
