...
var d = { Promise: void 0 }, b = { setTimeout: function(t2, r2) {
...
var w = function(t2) {
  ...
  function n2(r2, n3, e2) {
    ...
    return o2 = c(r2) || !r2 ? { next: null != r2 ? r2 : void 0, error: null != n3 ? n3 : void 0, complete: null != e2 ? e2 : void 0 } : r2, i2.destination = new g(o2), i2;
  }
  return r(n2, t2), n2;
...
var A = function() {
  ...
  return t2.prototype.lift = function(r2) {
    ...
    var e2, o2, i2, u2 = (e2 = t3) && e2 instanceof w || e2 && c(e2.next) && c(e2.error) && c(e2.complete) && p(e2) ? t3 : new _(t3, r2, n2);
...
var th = Array.isArray, tp = Object.getPrototypeOf, tv = Object.prototype, td = Object.keys;
function tb() {
...
var tm = ["addListener", "removeListener"], tw = ["addEventListener", "removeEventListener"], tg = ["on", "off"];
function t_(t2, r2, n2, e2) {
  if (c(n2) && (e2 = n2, n2 = void 0), e2) return t_(t2, r2, n2).pipe(tf(e2));
  var i2 = o(c(t2.addEventListener) && c(t2.removeEventListener) ? tw.map(function(e3) {
    return function(o2) {
      return t2[e3](r2, o2, n2);
    };
  }) : c(t2.addListener) && c(t2.removeListener) ? tm.map(tx(t2, r2)) : c(t2.on) && c(t2.off) ? tg.map(tx(t2, r2)) : [], 2), u2 = i2[0], s2 = i2[1];
...
function tE(t2) {
  return j(function(r2, n2) {
    ...
    o2 = r2.subscribe(k(n2, void 0, void 0, function(u2) {
      e2 = tt(t2(u2, tE(t2)(r2))), o2 ? (o2.unsubscribe(), o2 = null, e2.subscribe(n2)) : i2 = true;
...
function tj(t2, r2) {
  return void 0 === r2 && (r2 = O), t2 = null != t2 ? t2 : tk, j(function(n2, e2) {
    var o2, i2 = true;
    n2.subscribe(k(e2, function(n3) {
      var u2 = r2(n3);
