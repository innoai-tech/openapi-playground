import { g, h, y, x } from './vendor-min-mermaid~chunk-DLZS2ZFX.BxtWJuSo.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { F as Ff, B as Bf, w as wf, v as vf, L as Lf, M as Mf, H as Hl, i as ih, T as Tf, S as Sf, al as bc } from './vendor-min-mermaid~chunk-ZKYS2E5M.Cc2x1uDP.chunk.js';
var U = /*#__PURE__*/ function() {
    var t = /*#__PURE__*/ m$1(function(g, n, a, o) {
        ...
        performAction: /*#__PURE__*/ m$1(function(n, a, o, y, p, l, $) {
            var _ = l.length - 1;
            switch(p){
                case 1:
                    return l[_ - 1];
                ...
                case 7:
                    ...
                    break;
                case 8:
                    y.setDiagramTitle(/*#__PURE__*/ l[_].substr(6)), this.$ = /*#__PURE__*/ l[_].substr(6);
                    break;
                case 9:
                    this.$ = /*#__PURE__*/ l[_].trim(), y.setAccTitle(this.$);
                    break;
                case 10:
                case 11:
                    this.$ = /*#__PURE__*/ l[_].trim(), y.setAccDescription(this.$);
                    break;
                case 12:
                    y.addSection(/*#__PURE__*/ l[_].substr(8)), this.$ = /*#__PURE__*/ l[_].substr(8);
                    break;
                case 13:
        ...
        parse: /*#__PURE__*/ m$1(function(n) {
            ...
            function St() {
                var v;
                return v = y.pop() || k.lex() || rt, typeof v != "number" && (v instanceof Array && (y = v, v = /*#__PURE__*/ y.pop()), v = a.symbols_[v] || v), v;
            }
            m$1(St, "lex");
...
var V = "", Z = [], L = [], R = [], Et = /*#__PURE__*/ m$1(function() {
    ...
    let u = /*#__PURE__*/ i.map((d)=>d.trim()), h = {
        section: V,
        type: V,
        people: u,
        task: t,
...
var K = /*#__PURE__*/ m$1(function(t, e) {
    ...
    function u(f) {
        let x = /*#__PURE__*/ bc().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
        f.append("path").attr("class", "mouth").attr("d", x).attr("transform", "translate(" + e.cx + "," + (e.cy + 2) + ")");
    }
    m$1(u, "smile");
    function h(f) {
        let x = /*#__PURE__*/ bc().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
    ...
    c.attr("points", /*#__PURE__*/ s(e.x, e.y, 50, 20, 7)), c.attr("class", "labelBox"), e.y = e.y + e.labelMargin, e.x = e.x + .5 * e.labelMargin, bt(t, e);
    ...
    function t(i, u, h, d, f, x, m, g) {
        let n = /*#__PURE__*/ u.append("text").attr("x", h + f / 2).attr("y", d + x / 2 + 5).style("font-color", g).style("text-anchor", "middle").text(i);
        c(n, m);
    }
    m$1(t, "byText");
    function e(i, u, h, d, f, x, m, g, n) {
        let { taskFontSize: a, taskFontFamily: o } = g, y = /*#__PURE__*/ i.split(/<br\s*\/?>/gi);
        for(let p = 0; p < y.length; p++){
            let l = p * a - a * (y.length - 1) / 2, $ = /*#__PURE__*/ u.append("text").attr("x", h + f / 2).attr("y", d).attr("fill", n).style("text-anchor", "middle").style("font-size", a).style("font-family", o);
    ...
    function s(i, u, h, d, f, x, m, g) {
        let n = /*#__PURE__*/ u.append("switch"), o = /*#__PURE__*/ n.append("foreignObject").attr("x", h).attr("y", d).attr("width", f).attr("height", x).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
...
var Y = Hl().journey, I = Y.leftMargin, Wt = /*#__PURE__*/ m$1(function(t, e, s, c) {
    ...
    u === "sandbox" && (h = /*#__PURE__*/ ih("#i" + e));
    let d = u === "sandbox" ? ih(h.nodes()[0].contentDocument.body) : ih("body");
    T.init();
    let f = /*#__PURE__*/ d.select("#" + e);
    F.initGraphics(f);
    let x = /*#__PURE__*/ c.db.getTasks(), m = /*#__PURE__*/ c.db.getDiagramTitle(), g = /*#__PURE__*/ c.db.getActors();
    ...
    insert: /*#__PURE__*/ m$1(function(t, e, s, c) {
        let i = /*#__PURE__*/ Math.min(t, s), u = /*#__PURE__*/ Math.max(t, s), h = /*#__PURE__*/ Math.min(e, c), d = /*#__PURE__*/ Math.max(e, c);
    ...
    for (let [g, n] of e.entries()){
        ...
        let a = /*#__PURE__*/ n.people.reduce((o, y)=>(E[y] && (o[y] = E[y]), o), {});
