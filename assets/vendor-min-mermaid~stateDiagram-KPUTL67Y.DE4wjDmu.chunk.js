import { m as ms, j as je, x as xe } from "./vendor-min-mermaid~chunk-FF66LA6F.mPJmwwei.chunk.js";
import { f as fn } from "./vendor-min-mermaid~chunk-FASC7IG4.CzfLmak3.chunk.js";
...
import { H as Hl, i as ih, t as tt$1, T as Tf, g as gC, b as vc, c as Bc } from "./vendor-min-mermaid~chunk-QJLC67TO.Dw34GYds.chunk.js";
...
var V = /* @__PURE__ */ m$1((e) => e.append("circle").attr("class", "start-state").attr("r", Hl().state.sizeUnit).attr("cx", Hl().state.padding + Hl().state.sizeUnit).attr("cy", Hl().state.padding + Hl().state.sizeUnit), "drawStartState"), D = /* @__PURE__ */ m$1((e) => e.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", Hl().state.textHeight).attr("class", "divider").attr("x2", Hl().state.textHeight * 2).attr("y1", 0).attr("y2", 0), "drawDivider"), tt = /* @__PURE__ */ m$1((e, n) => {
  ...
  let m2 = /* @__PURE__ */ e.append("line").attr("x1", Hl().state.padding).attr("y1", Hl().state.padding + h + Hl().state.dividerMargin / 2).attr("y2", Hl().state.padding + h + Hl().state.dividerMargin / 2).attr("class", "descr-divider"), x = /* @__PURE__ */ f.node().getBBox(), c = /* @__PURE__ */ Math.max(x.width, r.width);
...
var at = /* @__PURE__ */ m$1((e, n, s, d) => {
  ...
  if (Hl().state.arrowMarkerAbsolute && (i = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, i = /* @__PURE__ */ i.replace(/\(/g, "\\("), i = /* @__PURE__ */ i.replace(/\)/g, "\\)")), f.attr("marker-end", "url(" + i + "#" + d(xe.relationType.DEPENDENCY) + "End)"), s.title !== void 0) {
    let o = /* @__PURE__ */ e.append("g").attr("class", "stateLabel"), { x: m2, y: x } = Ie.calcLabelPosition(n.points), c = /* @__PURE__ */ gC.getRows(s.title), p = 0, y = [], w = 0, k = 0;
    for (let a = 0; a <= c.length; a++) {
      let u = /* @__PURE__ */ o.append("text").attr("text-anchor", "middle").text(c[a]).attr("x", m2).attr("y", x + p), l = /* @__PURE__ */ u.node().getBBox();
      w = /* @__PURE__ */ Math.max(w, l.width), k = /* @__PURE__ */ Math.min(k, l.x), tt$1.info(l.x, m2, x + p), p === 0 && (p = u.node().getBBox().height, tt$1.info("Title height", p, x)), y.push(u);
    }
    let M = p * c.length;
    if (c.length > 1) {
