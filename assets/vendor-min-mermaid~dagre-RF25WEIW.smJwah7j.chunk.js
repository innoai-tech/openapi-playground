import { $ as $t, v as vt, T as Tt, H as Ht, E as Et } from "./vendor-min-mermaid~chunk-ZUCAP7FR.6sCyN4jm.chunk.js";
import { v as v$1, a as Sf, b as bf, N as Nf, r as ro, w as wf, o as oo } from "./vendor-min-mermaid~chunk-E7A2AWYO.9sfNWd-b.chunk.js";
...
import { t as tt, W as Wl } from "./vendor-min-mermaid~chunk-OR2G2HG5.BWDWUMki.chunk.js";
import { s as sn, _ as _f, J as Jr } from "./vendor-min-mermaid~chunk-5ZJXQJOJ.DyIdZ9M4.chunk.js";
function h(e) {
  var t = {
    options: {
...
var ae = /* @__PURE__ */ m$1((e, t, n2) => {
  ...
  e.nodes().forEach(function(n2) {
    e.children(n2).length > 0 && (tt.warn("Cluster identified", n2, " Replacement id in edges: ", /* @__PURE__ */ y(n2, e, n2)), v.set(n2, /* @__PURE__ */ L(n2, e)), a.set(n2, {
      id: /* @__PURE__ */ y(n2, e, n2),
...
Parent cluster`, s.height), t.setNode(s.id, w), t.parent(f) || (tt.trace("Setting parent", f, s.id), t.setParent(f, s.id, w));
    ...
    if (tt.info("(Insert) Node XXX" + f + ": " + JSON.stringify(/* @__PURE__ */ t.node(f))), r == null ? void 0 : r.clusterNode) {
      ...
      let E = await ie(b, r.graph, n$1, c, /* @__PURE__ */ t.node(f), o), D = E.elem;
      v$1(r, D), r.diff = E.diff || 0, tt.info("New compound node after recursive render XAX", f, "width", r.width, "height", r.height), Sf(D, r);
    } else t.children(f).length > 0 ? (tt.trace("Cluster - the non recursive path XBX", f, r.id, r, r.width, "Graph:", t), tt.trace(/* @__PURE__ */ y(r.id, t)), a.set(r.id, {
      id: /* @__PURE__ */ y(r.id, t),
      node: r
    })) : (tt.trace("Node - the non recursive path XAX", f, b, /* @__PURE__ */ t.node(f), l), await bf(b, /* @__PURE__ */ t.node(f), {
      config: o,
      dir: l
    }));
  })), await m$1(async () => {
    let f = /* @__PURE__ */ t.edges().map(async function(r) {
      ...
      tt.info("Edge " + r.v + " -> " + r.w + ": " + JSON.stringify(r)), tt.info("Edge " + r.v + " -> " + r.w + ": ", r, " ", /* @__PURE__ */ JSON.stringify(/* @__PURE__ */ t.edge(r))), tt.info("Fix", a, "ids:", r.v, r.w, "Translating: ", /* @__PURE__ */ a.get(r.v), /* @__PURE__ */ a.get(r.w)), await $t(p, w);
    });
    await Promise.all(f);
  ...
  return await Promise.all(/* @__PURE__ */ te(t).map(async function(f) {
    var _a;
    let r = /* @__PURE__ */ t.node(f);
    if (tt.info("Position XBX => " + f + ": (" + r.x, "," + r.y, ") width: ", r.width, " height: ", r.height), r == null ? void 0 : r.clusterNode) r.y += S, tt.info("A tainted cluster node XBX1", f, r.id, r.width, r.height, r.x, r.y, /* @__PURE__ */ t.parent(f)), a.get(r.id).node = r, Nf(r);
      ...
      let w = (r == null ? void 0 : r.padding) / 2 || 0, X = ((_a = r == null ? void 0 : r.labelBBox) == null ? void 0 : _a.height) || 0, E = X - w || 0;
      tt.debug("OffsetY", E, "labelHeight", X, "halfPadding", w), await ro(d, r), a.get(r.id).node = r;
    } else {
      let w = /* @__PURE__ */ t.node(r.parentId);
      r.y += S / 2, tt.info("A regular node XBX1 - using the padding", r.id, "parent", r.parentId, r.width, r.height, r.x, r.y, "offsetY", r.offsetY, "parent", w, w == null ? void 0 : w.offsetY, r), Nf(r);
    }
    ...
    var X = /* @__PURE__ */ t.node(f.w);
    let E = /* @__PURE__ */ vt(m2, r, a, n$1, w, X, c);
    Tt(r, E);
  ...
  Ht(c, e.markers, e.type, e.diagramId), wf(), Et(), oo(), Z(), e.nodes.forEach((o) => {
    n2.setNode(o.id, {
      ...o
    ...
    if (o.start === o.end) {
      ...
      p.label = "", p.arrowTypeEnd = "none", p.id = l + "-cyclic-special-1", b.arrowTypeEnd = "none", b.id = l + "-cyclic-special-mid", x.label = "", m2.isGroup && (p.fromCluster = l, x.toCluster = l), x.id = l + "-cyclic-special-2", n2.setEdge(l, u, p, l + "-cyclic-special-0"), n2.setEdge(u, d, b, l + "-cyclic-special-1"), n2.setEdge(d, l, x, l + "-cyc<lic-special-2");
