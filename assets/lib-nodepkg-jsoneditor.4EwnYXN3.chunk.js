import { c as e, I as t, a as n, r as l, j as i, b as a, d as r, e as o, f as d, T as s, F as c, g as p, o as u } from "./lib-nodepkg-vuekit.Cj45zBBP.chunk.js";
...
import { s as w, d as N, t as S, P as C, v as $, a as I } from "./lib-nodepkg-vueuikit.BWFiRsjH.chunk.js";
import { M as D } from "./lib-nodepkg-vuemarkdown.BPQMpXPF.chunk.js";
import { I as O, m as A, a as T, b as E, c as R, d as j, e as P, f as B } from "./lib-nodepkg-vuematerial.iSy9Tq2u.chunk.js";
class J extends t {
  constructor(e2, t2) {
...
let F = e(() => new J(h(), {})), M = e(() => ({ render: (e2, t2, n2) => null })), K = n((e2, t2) => {
  ...
  return l(d2, o2((e3) => {
    var t3, n3, l2, a3;
    return i(C, { isOpen: e3, onClickOutside: () => d2.hide(), $transition: (e4) => i(U, { children: e4.content }), placement: "bottom-start", $content: i(V, { onClick: s2, children: null === (t3 = r2.content) || void 0 === t3 ? void 0 : t3.call(r2) }), children: null !== (a3 = null === (l2 = r2.default) || void 0 === l2 ? void 0 : null === (n3 = l2.call(r2)) || void 0 === n3 ? void 0 : n3[0]) && void 0 !== a3 ? a3 : null });
  }));
  ...
  return l(o2, r2((e3) => {
    var t3, n3, l2, r3;
    return i(C, { isOpen: e3, onClickOutside: () => o2.hide(), $transition: (e4) => i(U, { children: e4.content }), placement: "bottom-start", $content: i(V, { children: null === (t3 = a2.content) || void 0 === t3 ? void 0 : t3.call(a2) }), children: null !== (r3 = null === (l2 = a2.default) || void 0 === l2 ? void 0 : null === (n3 = l2.call(a2)) || void 0 === n3 ? void 0 : n3[0]) && void 0 !== r3 ? r3 : null });
  }));
...
let V = w("div", { displayName: "PopoverContainer" })({ py: 4, rounded: "sm", shadow: "1", containerStyle: "sys.surface", textStyle: "sys.body-small", pos: "relative", maxW: "30vw" }), L = w("div", { displayName: "MenuItem" })({ px: 12, py: 8, gap: 23, display: "flex", alignItems: "start", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" } }), U = N({ from: { opacity: 0 }, to: { opacity: 1 }, duration: S.duration.md1, easing: S.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: S.duration.sm4, easing: S.easing.standard.decelerate }), H = n((e2, t2) => {
  ...
  return l(o2, r2((t3) => {
    ...
    return i(C, { isOpen: t3, placement: null !== (r3 = e2.placement) && void 0 !== r3 ? r3 : "left", $content: i(X, { children: i(z, { children: n2.title() }) }), $transition: (e3) => i(U, { children: e3.content }), children: d2 ? a(d2, { onMouseover: () => {
      o2.show();
    }, onMouseout: () => {
      o2.hide();
    } }) : null });
...
let eh = p(function(e2, t2) {
  ...
  return c2;
}), ey = w("form", { displayName: "FormControls" })({ display: "flex", pos: "absolute", right: 0, bottom: 0, px: 8 }), em = w("div", { displayName: "FormContainer" })({ display: "block", pos: "relative", textarea: { minW: 400, outline: "none", border: "none", bg: "none", py: 8, px: 12 } }), ev = w("div", { displayName: "FormContainerAsRow" })({ display: "flex", alignItems: "center", gap: 8, pos: "relative", px: 8, input: { outline: "none", border: "none", bg: "none", minWidth: "10vw", py: 8, px: 12 }, [`& ${ey}`]: { pos: "relative", px: 0 } }), ef = n((e2, t2) => {
  let {} = t2;
  return () => i(H, { $title: "复制当前节点为 JSON 字符串", children: i(ec, { onClick: () => eh(JSON.stringify(e2.value, null, 2)), children: i(O, { path: A }) }) });
  ...
  }, onKeypress: y2 }), o(ey, { children: [i(R, { type: "button", onClick: () => {
    p2();
  ...
  return l(e2.value$, n2((t3) => i(Z, { openToken: "{", closeToken: "}", $leading: o(es, { children: [i(ew, { onAddProp: (t4) => {
    ...
    return o(ee, { dirty: a2.isDirty(d2, c2), children: [i(Q, { deprecated: s2.getSchema("deprecated"), description: s2.getMeta("description"), $leading: i(ek, { onRemove: () => {
      a2.next((t4) => {
        let n4 = t4;
  ...
  let { render: n2 } = t2, a2 = F.use(), r2 = M.use();
  return l(e2.value$, n2((t3) => i(Z, { openToken: "[", closeToken: "]", $leading: o(es, { children: [i(e$, { onAdd: () => {
    a2.next((t4) => {
    ...
    return o(ee, { dirty: a2.isDirty(l2, s2), children: [i(Q, { sx: { opacity: 0.3, mr: "0.5em" }, $leading: i(eI, { onRemove: () => {
      a2.next((t5) => {
  ...
  return l(e2.value$, n2((t3) => i(Z, { openToken: "{", closeToken: "}", $leading: o(es, { children: [i(eA, { onAddKey: (t4) => {
    ...
    if (!Object.hasOwn(t3, l2)) return null;
    let c2 = [...e2.ctx.path, l2];
    return o(ee, { dirty: a2.isDirty(d2, c2), children: [i(Q, { $leading: i(eO, { onRemove: () => {
      a2.next((t4) => {
        let n4 = t4;
        for (let t5 of e2.ctx.path) n4 = n4[t5];
        delete n4[l2];
  ...
  }, onKeypress: p2 }), o(ey, { children: [i(R, { type: "button", onClick: (t3) => {
  ...
  let {} = e2, { render: n2 } = t2, a2 = F.use(), r2 = (e3, t3, n3) => "object" == e3.type || "intersection" == e3.type || "union" == e3.type ? i(eg, { typedef: e3, value: null != t3 ? t3 : {}, ctx: n3 }) : "record" == e3.type ? i(eD, { typedef: e3, value: t3, ctx: n3 }) : "array" == e3.type ? i(eC, { typedef: e3, value: t3, ctx: n3 }) : "enums" == e3.type ? i(eE, { typedef: e3, value: t3, ctx: n3 }) : "string" == e3.type ? i(eR, { typedef: e3, value: t3, ctx: n3 }) : "number" == e3.type || "integer" == e3.type ? i(eB, { typedef: e3, value: t3, ctx: n3 }) : "boolean" == e3.type ? i(eP, { typedef: e3, value: t3, ctx: n3 }) : null, s2 = d(null);
  return l(a2, n2((e3) => i(M, { value: { render: r2 }, children: o(eM, { children: [i("section", { ref: s2 }), s2.value && i(Y, { value: { indent: 0, $container: s2 }, children: i(ee, { children: r2(a2.typedef, e3, y) }) })] }) })));
