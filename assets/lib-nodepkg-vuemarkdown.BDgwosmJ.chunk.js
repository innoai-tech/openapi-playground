import { g as e } from "./lib-nodepkg-typedef.wThrm2fx.chunk.js";
import { F as t, j as n, e as r, a as i, r as l, h as o } from "./lib-nodepkg-vuekit.BOSnaom6.chunk.js";
import { b as a } from "./vendor-rxjs.BHYITtPb.chunk.js";
let u = {};
...
let x = M(/[A-Za-z]/), v = M(/[\dA-Za-z]/), b = M(/[#-'*+\--9=?A-Z^-~]/);
function S(e10) {
  return null !== e10 && (e10 < 32 || 127 === e10);
}
let C = M(/\d/), w = M(/[\dA-Fa-f]/), A = M(/[!-/:-@[-`{-~]/);
function T(e10) {
...
let z = { tokenize: function(e10) {
  ...
  function u2(e11) {
    if (o2++, i2.containerState._closeFlow) {
      ...
      y2(o2);
      let a3 = r3;
      for (; a3 < i2.events.length; ) i2.events[a3][1].end = Object.assign({}, n11), a3++;
  ...
  function g2(e11, l3) {
    ...
    if (l3 && a3.push(null), e11.previous = n10, n10 && (n10.next = e11), n10 = e11, t10.defineSkip(e11.start), t10.write(a3), i2.parser.lazy[e11.start.line]) {
      ...
      for (y2(o2), l4 = a4; l4 < i2.events.length; ) i2.events[l4][1].end = Object.assign({}, n11), l4++;
  ...
  return O(e10, e10.attempt(this.parser.constructs.document, t10, n10), "linePrefix", this.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4);
} };
function R(e10) {
...
let _ = { name: "attention", tokenize: function(e10, t10) {
  let n10;
  let r2 = this.parser.constructs.attentionMarkers.null, i2 = this.previous, l2 = R(i2);
  return function(o2) {
    return n10 = o2, e10.enter("attentionSequence"), function o3(a2) {
      if (a2 === n10) return e10.consume(a2), o3;
      let u2 = e10.exit("attentionSequence"), c2 = R(a2), s2 = !c2 || 2 === c2 && l2 || r2.includes(a2), f2 = !l2 || 2 === l2 && c2 || r2.includes(i2);
  ...
  for (; ++s2 < e10.length; ) if ("enter" === e10[s2][0] && "attentionSequence" === e10[s2][1].type && e10[s2][1]._close) {
    for (n10 = s2; n10--; ) if ("exit" === e10[n10][0] && "attentionSequence" === e10[n10][1].type && e10[n10][1]._open && t10.sliceSerialize(e10[n10][1]).charCodeAt(0) === t10.sliceSerialize(e10[s2][1]).charCodeAt(0)) {
      ...
      B(f2, -a2), B(p2, a2), l2 = { type: a2 > 1 ? "strongSequence" : "emphasisSequence", start: f2, end: Object.assign({}, e10[n10][1].end) }, o2 = { type: a2 > 1 ? "strongSequence" : "emphasisSequence", start: Object.assign({}, e10[s2][1].start), end: p2 }, i2 = { type: a2 > 1 ? "strongText" : "emphasisText", start: Object.assign({}, e10[n10][1].end), end: Object.assign({}, e10[s2][1].start) }, r2 = { type: a2 > 1 ? "strong" : "emphasis", start: Object.assign({}, l2.start), end: Object.assign({}, o2.end) }, e10[n10][1].end = Object.assign({}, l2.start), e10[s2][1].start = Object.assign({}, o2.end), u2 = [], e10[n10][1].end.offset - e10[n10][1].start.offset && (u2 = h(u2, [["enter", e10[n10][1], t10], ["exit", e10[n10][1], t10]])), u2 = h(u2, [["enter", r2, t10], ["enter", l2, t10], ["exit", l2, t10], ["enter", i2, t10]]), u2 = h(u2, j(t10.parser.constructs.insideSpan.null, e10.slice(n10 + 1, s2), t10)), u2 = h(u2, [["exit", i2, t10], ["enter", o2, t10], ["exit", o2, t10], ["exit", r2, t10]]), e10[s2][1].end.offset - e10[s2][1].start.offset ? (c2 = 2, u2 = h(u2, [["enter", e10[s2][1], t10], ["exit", e10[s2][1], t10]])) : c2 = 0, d(e10, n10 - 1, s2 - n10 + 3, u2), s2 = n10 + u2.length - c2 - 2;
      break;
    }
  }
...
let ei = { tokenize: function(e10, t10, n10) {
  ...
  return function(t11) {
    return r2 ? r2._inactive ? s2(t11) : (i2 = l2.parser.defined.includes(k(l2.sliceSerialize({ start: r2.end, end: l2.now() }))), e10.enter("labelEnd"), e10.enter("labelMarker"), e10.consume(t11), e10.exit("labelMarker"), e10.exit("labelEnd"), a2) : n10(t11);
  };
  function a2(t11) {
  ...
  return l2 = h(l2 = [["enter", u2, t10], ["enter", c2, t10]], e10.slice(r2 + 1, r2 + a2 + 3)), l2 = h(l2, [["enter", s2, t10]]), l2 = h(l2, j(t10.parser.constructs.insideSpan.null, e10.slice(r2 + a2 + 4, i2 - 3), t10)), l2 = h(l2, [["exit", s2, t10], e10[i2 - 2], e10[i2 - 1], ["exit", c2, t10]]), l2 = h(l2, e10.slice(i2 + 1)), l2 = h(l2, [["exit", u2, t10]]), d(e10, r2, e10.length, l2), e10;
  ...
  function i2(e11) {
    return r2.parser.defined.includes(k(r2.sliceSerialize(r2.events[r2.events.length - 1][1]).slice(1, -1))) ? t10(e11) : n10(e11);
  }
  function l2(e11) {
    return n10(e11);
  }
  ...
  function a2(t11) {
    return e10.enter("listItemMarker"), e10.consume(t11), e10.exit("listItemMarker"), r2.containerState.marker = r2.containerState.marker || t11, e10.check(V, r2.interrupt ? n10 : u2, e10.attempt(ek, s2, c2));
  }
  function u2(e11) {
  ...
  function i2(i3) {
    return r2.containerState._closeFlow = true, r2.interrupt = void 0, O(e10, e10.attempt(ey, t10, n10), "linePrefix", r2.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(i3);
  }
} }, exit: function(e10) {
  ...
  let t10 = this, n10 = e10.attempt(V, function(r3) {
    if (null === r3) {
      e10.consume(r3);
      return;
    }
    return e10.enter("lineEndingBlank"), e10.consume(r3), e10.exit("lineEndingBlank"), t10.currentConstruct = void 0, n10;
  }, e10.attempt(this.parser.constructs.flowInitial, r2, O(e10, e10.attempt(this.parser.constructs.flow, r2, e10.attempt(J, r2)), "linePrefix")));
  return n10;
  function r2(r3) {
    if (null === r3) {
      e10.consume(r3);
...
} }, eS = { resolveAll: eT() }, eC = eA("string"), ew = eA("text");
function eA(e10) {
  ...
  }, resolveAll: eT("text" === e10 ? eI : void 0) };
}
function eT(e10) {
...
let eL = Object.freeze(Object.defineProperty({ __proto__: null, attentionMarkers: { null: [42, 95] }, contentInitial: { 91: { name: "definition", tokenize: function(e10, t10, n10) {
  ...
  function l2(t11) {
    return (r2 = k(i2.sliceSerialize(i2.events[i2.events.length - 1][1]).slice(1, -1)), 58 === t11) ? (e10.enter("definitionMarker"), e10.consume(t11), e10.exit("definitionMarker"), o2) : n10(t11);
  }
  function o2(t11) {
  ...
  function c2(o3) {
    return 33 === o3 ? (e10.consume(o3), s2) : 47 === o3 ? (e10.consume(o3), i2 = true, d2) : 63 === o3 ? (e10.consume(o3), r2 = 3, u2.interrupt ? t10 : R2) : x(o3) ? (e10.consume(o3), l2 = String.fromCharCode(o3), h2) : n10(o3);
  }
  function s2(i3) {
  ...
  function d2(t11) {
    return x(t11) ? (e10.consume(t11), l2 = String.fromCharCode(t11), h2) : n10(t11);
  }
  function h2(o3) {
  ...
  function P2(t11) {
    ...
    return x(t11) && l2.length < 8 ? (e10.consume(t11), l2 += String.fromCharCode(t11), P2) : D2(t11);
  }
  function N2(t11) {
...
let eB = function(e10) {
  ...
  if ("object" == typeof e10) return Array.isArray(e10) ? function(e11) {
    let t10 = [], n10 = -1;
    for (; ++n10 < e11.length; ) t10[n10] = eB(e11[n10]);
    return eV(function() {
...
function eJ(e10, t10, n10, r2, i2) {
  ...
  let o2 = function(e11) {
    ...
    let n11 = t11[0], r3 = n11.indexOf(")"), i3 = e_(e11, "("), l3 = e_(e11, ")");
...
function e4(e10) {
  ...
  n10.type, n10.label = t10, n10.identifier = k(this.sliceSerialize(e10)).toLowerCase();
}
function e3(e10) {
  this.exit(e10);
}
...
let ts = { tokenize: function(e10, t10, n10) {
  ...
  function o2(t11) {
    if (x(t11) && i2.length < 5) return i2 += String.fromCodePoint(t11), e10.consume(t11), o2;
    if (58 === t11) {
  ...
  function u2(t11) {
    return null === t11 || S(t11) || I(t11) || E(t11) || D(t11) ? n10(t11) : e10.attempt(tf, e10.attempt(tp, c2), n10)(t11);
  }
  function c2(n11) {
...
function tT(e10, t10, n10) {
  ...
  return function(l3) {
    ...
    let a2 = k(i2.sliceSerialize({ start: r2.end, end: i2.now() }));
...
function tL(e10, t10, n10) {
  ...
  function u2(a3) {
    ...
    if (93 === a3) {
      ...
      return l2.includes(k(i2.sliceSerialize(r3))) ? (e10.enter("gfmFootnoteCallLabelMarker"), e10.consume(a3), e10.exit("gfmFootnoteCallLabelMarker"), e10.exit("gfmFootnoteCall"), t10) : n10(a3);
    }
...
function tD(e10, t10, n10) {
  ...
  function c2(t11) {
    ...
    if (93 === t11) {
      ...
      return r2 = k(l2.sliceSerialize(n11)), e10.enter("gfmFootnoteDefinitionLabelMarker"), e10.consume(t11), e10.exit("gfmFootnoteDefinitionLabelMarker"), e10.exit("gfmFootnoteDefinitionLabel"), f2;
    }
...
function tE(e10, t10, n10) {
  return e10.check(V, t10, e10.attempt(tA, t10, n10));
}
function tM(e10) {
...
function tz(e10, t10) {
  ...
  for (; ++l2 < e10.length; ) {
    ...
    "enter" === d2[0] ? "tableHead" === h2.type ? (s2 = false, 0 !== f2 && (tN(p2, t10, f2, n10, r2), r2 = void 0, f2 = 0), n10 = { type: "table", start: Object.assign({}, h2.start), end: Object.assign({}, h2.end) }, p2.add(l2, 0, [["enter", n10, t10]])) : "tableRow" === h2.type || "tableDelimiterRow" === h2.type ? (o2 = true, i2 = void 0, u2 = [0, 0, 0, 0], c2 = [0, l2 + 1, 0, 0], s2 && (s2 = false, r2 = { type: "tableBody", start: Object.assign({}, h2.start), end: Object.assign({}, h2.end) }, p2.add(l2, 0, [["enter", r2, t10]])), a2 = "tableDelimiterRow" === h2.type ? 2 : r2 ? 3 : 1) : a2 && ("data" === h2.type || "tableDelimiterMarker" === h2.type || "tableDelimiterFiller" === h2.type) ? (o2 = false, 0 === c2[2] && (0 !== u2[1] && (c2[0] = c2[1], i2 = tP(p2, t10, u2, a2, void 0, i2), u2 = [0, 0, 0, 0]), c2[2] = l2)) : "tableCellDivider" === h2.type && (o2 ? o2 = false : (0 !== u2[1] && (c2[0] = c2[1], i2 = tP(p2, t10, u2, a2, void 0, i2)), c2 = [(u2 = c2)[1], l2, 0, 0])) : "tableHead" === h2.type ? (s2 = true, f2 = l2) : "tableRow" === h2.type || "tableDelimiterRow" === h2.type ? (f2 = l2, 0 !== u2[1] ? (c2[0] = c2[1], i2 = tP(p2, t10, u2, a2, l2, i2)) : 0 !== c2[1] && (i2 = tP(p2, t10, c2, a2, l2, i2)), a2 = 0) : a2 && ("data" === h2.type || "tableDelimiterMarker" === h2.type || "tableDelimiterFiller" === h2.type) && (c2[3] = l2);
  }
...
function tP(e10, t10, n10, r2, i2, l2) {
  0 !== n10[0] && (l2.end = Object.assign({}, tR(t10.events, n10[0])), e10.add(n10[0], 0, [["exit", l2, t10]]));
  let o2 = tR(t10.events, n10[1]);
  if (l2 = { type: 1 === r2 ? "tableHeader" : 2 === r2 ? "tableDelimiter" : "tableData", start: Object.assign({}, o2), end: Object.assign({}, o2) }, e10.add(n10[1], 0, [["enter", l2, t10]]), 0 !== n10[2]) {
    let i3 = tR(t10.events, n10[2]), l3 = tR(t10.events, n10[3]), o3 = { type: "tableContent", start: Object.assign({}, i3), end: Object.assign({}, l3) };
  ...
  return void 0 !== i2 && (l2.end = Object.assign({}, tR(t10.events, i2)), e10.add(i2, 0, [["exit", l2, t10]]), l2 = void 0), l2;
}
function tN(e10, t10, n10, r2, i2) {
  let l2 = [], o2 = tR(t10.events, n10);
...
function t9(e10) {
  ...
  for (a2--; ++a2 <= e10.length; ) if (10 === r2 && (f2 = (n10 ? n10[u2] : 0) || 1), 38 === (r2 = e10.charCodeAt(a2))) {
    let t11;
    ...
    for (x2--; ++x2 <= e10.length; ) {
      let n12 = e10.charCodeAt(x2);
      if (!C2(n12)) break;
      S2 += t3(n12), "named" === t11 && tG.includes(S2) && (v2 = S2, b2 = p(S2));
    }
    ...
    if (w2 || false !== i2.nonTerminated) {
      if (S2) {
        if ("named" === t11) {
          ...
          if ((h2 = e11) >= 55296 && h2 <= 57343 || h2 > 1114111) y2(7, A2), T2 = t3(65533);
          else if (e11 in t1) y2(6, A2), T2 = t1[e11];
          else {
            let t12 = "";
            ((m2 = e11) >= 1 && m2 <= 8 || 11 === m2 || m2 >= 13 && m2 <= 31 || m2 >= 127 && m2 <= 159 || m2 >= 64976 && m2 <= 65007 || (65535 & m2) == 65535 || (65535 & m2) == 65534) && y2(6, A2), e11 > 65535 && (e11 -= 65536, t12 += t3(e11 >>> 10 | 55296), e11 = 56320 | 1023 & e11), T2 = t12 + t3(e11);
          }
        }
      } else "named" !== t11 && y2(4, A2);
    }
    if (T2) {
      k2(), d2 = g2(), a2 = x2 - 1, f2 += x2 - u3 + 1, o2.push(T2);
      let t12 = g2();
      t12.offset++, i2.reference && i2.reference.call(i2.referenceContext, T2, { start: d2, end: t12 }, e10.slice(u3 - 1, x2)), d2 = t12;
    } else S2 = e10.slice(u3 - 1, x2), c2 += S2, f2 += S2.length, a2 = x2 - 1;
  } else 10 === r2 && (s2++, u2++, f2 = 0), Number.isNaN(r2) ? k2() : (c2 += t3(r2), f2++);
  return o2.join("");
  function g2() {
  ...
  function y2(e11, t11) {
    let n11;
    i2.warning && (n11 = g2(), n11.column += t11, n11.offset += t11, i2.warning.call(i2.warningContext, t5[e11], n11, e11));
  }
  function k2() {
...
function nl(e10) {
  this.data.directiveAttributes.push(["id", t9(this.sliceSerialize(e10), { attribute: true })]);
}
function no(e10) {
  this.data.directiveAttributes.push(["class", t9(this.sliceSerialize(e10), { attribute: true })]);
}
function na(e10) {
  let t10 = this.data.directiveAttributes;
  t10[t10.length - 1][1] = t9(this.sliceSerialize(e10), { attribute: true });
}
function nu(e10) {
...
let nf = (e10) => {
  var t10, n10;
  let r2, i2, l2, o2;
  return "string" != typeof (t10 = { extensions: [g([{ text: tk }, { document: { 91: { name: "gfmFootnoteDefinition", tokenize: tD, continuation: { tokenize: tE }, exit: tM } }, text: { 91: { name: "gfmFootnoteCall", tokenize: tL }, 93: { name: "gfmPotentialFootnoteCall", add: "after", tokenize: tT, resolveTo: tI } } }, function(e11) {
    let t11;
    let n11 = { name: "strikethrough", tokenize: function(e12, n12, r3) {
      ...
      return function(a2) {
        return 126 === i3 && "characterEscape" !== l3[l3.length - 1][1].type ? r3(a2) : (e12.enter("strikethroughSequenceTemporary"), function l4(a3) {
          ...
          let c2 = e12.exit("strikethroughSequenceTemporary"), s2 = R(a3);
      ...
      for (; ++n12 < e12.length; ) if ("enter" === e12[n12][0] && "strikethroughSequenceTemporary" === e12[n12][1].type && e12[n12][1]._close) {
        ...
        for (; r3--; ) if ("exit" === e12[r3][0] && "strikethroughSequenceTemporary" === e12[r3][1].type && e12[r3][1]._open && e12[n12][1].end.offset - e12[n12][1].start.offset == e12[r3][1].end.offset - e12[r3][1].start.offset) {
          ...
          a2 && d(o3, o3.length, 0, j(a2, e12.slice(r3 + 1, n12), t12)), d(o3, o3.length, 0, [["exit", l3, t12], ["enter", e12[n12][1], t12], ["exit", e12[n12][1], t12], ["exit", i3, t12]]), d(e12, r3 - 1, n12 - r3 + 3, o3), n12 = r3 + o3.length - 2;
          break;
        }
      }
    ...
    let t11 = { transforms: [], canContainEols: ["emphasis", "fragment", "heading", "paragraph", "strong"], enter: { autolink: r3(S2), autolinkProtocol: f2, autolinkEmail: f2, atxHeading: r3(x2), blockQuote: r3(function() {
    ...
    }, referenceString: i3, resourceDestinationString: i3, resourceTitleString: i3, setextHeading: r3(x2), strong: r3(function() {
      ...
      this.stack.pop().position.end = eR(e12.end);
      ...
      n12.label = t12, n12.identifier = k(this.sliceSerialize(e12)).toLowerCase();
      ...
      n12.label = t12.replace(eE, eM), n12.identifier = k(t12).toLowerCase();
    }, lineEnding: function(e12) {
      let n12 = this.stack[this.stack.length - 1];
      if (this.data.atHardBreak) {
        n12.children[n12.children.length - 1].position.end = eR(e12.end), this.data.atHardBreak = void 0;
        return;
      }
      ...
      let t12 = this.resume(), n12 = this.stack[this.stack.length - 1];
      n12.label = t12, n12.identifier = k(this.sliceSerialize(e12)).toLowerCase(), this.data.referenceType = "full";
    ...
    return function(e12) {
      ...
      for (r4.position = { start: eR(e12.length > 0 ? e12[0][1].start : { line: 1, column: 1, offset: 0 }), end: eR(e12.length > 0 ? e12[e12.length - 2][1].end : { line: 1, column: 1, offset: 0 }) }, c2 = -1; ++c2 < t11.transforms.length; ) r4 = t11.transforms[c2](r4) || r4;
      return r4;
    };
    function r3(e12, t12) {
      return function(n12) {
    ...
    function l3(e12, t12, n12) {
      this.stack[this.stack.length - 1].children.push(e12), this.stack.push(e12), this.tokenStack.push([t12, n12 || void 0]), e12.position = { start: eR(t12.start), end: void 0 };
    }
    function o3(e12) {
      return function(t12) {
    ...
    function f2(e12) {
      ...
      n12 && "text" === n12.type || ((n12 = { type: "text", value: "" }).position = { start: eR(e12.start), end: void 0 }, t12.push(n12)), this.stack.push(n12);
    }
    function d2(e12) {
      let t12 = this.stack.pop();
      t12.value += this.sliceSerialize(e12), t12.position.end = eR(e12.end);
    }
    function h2() {
    ...
    let t11 = { defined: [], lazy: {}, constructs: g([eL, ...(e11 || {}).extensions || []]), content: n11(z), document: n11(P), flow: n11(eb), string: n11(eC), text: n11(ew) };
    return t11;
    function n11(e12) {
      return function(n12) {
        return function(e13, t12, n13) {
          let r3 = Object.assign(n13 ? Object.assign({}, n13) : { line: 1, column: 1, offset: 0 }, { _index: 0, _bufferIndex: -1 }), i3 = {}, l3 = [], o3 = [], a2 = [], u2 = { consume: function(e14) {
          ...
          }, attempt: g2(function(e14, t13) {
            y2(e14, t13.from);
          }), check: g2(m2), interrupt: g2(m2, { interrupt: true }) }, c2 = { previous: null, code: null, containerState: {}, events: [], parser: e13, sliceStream: f2, sliceSerialize: function(e14, t13) {
            ...
            }(), null !== o3[o3.length - 1]) ? [] : (y2(t12, 0), c2.events = j(l3, c2.events, c2), c2.events);
            ...
            return function(n14, i4, l4) {
              ...
              function m3(e15) {
                return function(n15) {
                  ...
                  }(), f3 = e15, e15.partial || (c2.currentConstruct = e15), e15.name && c2.parser.constructs.disable.null.includes(e15.name)) ? y3() : e15.tokenize.call(t13 ? Object.assign(Object.create(c2), t13) : c2, u2, g3, y3)(n15);
                };
              }
              function g3(t14) {
                return e14(f3, d2), i4;
...
let nS = 0, nC = nE(), nw = nE(), nA = nE(), nT = nE(), nI = nE(), nL = nE(), nD = nE();
function nE() {
  return 2 ** ++nS;
}
let nM = Object.freeze(Object.defineProperty({ __proto__: null, boolean: nC, booleanish: nw, commaOrSpaceSeparated: nD, commaSeparated: nL, number: nT, overloadedBoolean: nA, spaceSeparated: nI }, Symbol.toStringTag, { value: "Module" })), nF = Object.keys(nM);
class nO extends nb {
...
let n2 = e(function() {
  ...
  var t10 = e10(function() {
    if (nG) return nJ;
    nG = 1;
    var e11 = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g, t11 = /\n/g, n10 = /^\s*/, r2 = /^(\*?[-#/*\\\w]+(\[[0-9a-z_-]+\])?)\s*/, i2 = /^:\s*/, l2 = /^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};])+)/, o2 = /^[;\s]*/, a2 = /^\s+|\s+$/g;
    function u2(e12) {
      return e12 ? e12.replace(a2, "") : "";
    }
    return nJ = function(a3, c2) {
      ...
      function m2(e12) {
        ...
        if (t12.reason = e12, t12.filename = c2.source, t12.line = s2, t12.column = f2, t12.source = a3, c2.silent) ;
        else throw t12;
      }
      function g2(e12) {
        var t12 = e12.exec(a3);
        if (t12) {
          var n11 = t12[0];
          return p2(n11), a3 = a3.slice(n11.length), t12;
        }
      }
      function y2(e12) {
        var t12;
        for (e12 = e12 || []; t12 = k2(); ) false !== t12 && e12.push(t12);
        return e12;
      }
      function k2() {
        var e12 = d2();
        if ("/" == a3.charAt(0) && "*" == a3.charAt(1)) {
          for (var t12 = 2; "" != a3.charAt(t12) && ("*" != a3.charAt(t12) || "/" != a3.charAt(t12 + 1)); ) ++t12;
          if (t12 += 2, "" === a3.charAt(t12 - 1)) return m2("End of comment missing");
          var n11 = a3.slice(2, t12 - 2);
          return f2 += 2, p2(n11), a3 = a3.slice(t12), f2 += 2, e12({ type: "comment", comment: n11 });
        }
      }
      return h2.prototype.content = a3, g2(n10), function() {
        var t12, n11 = [];
        for (y2(n11); t12 = function() {
          var t13 = d2(), n12 = g2(r2);
          if (n12) {
            if (k2(), !g2(i2)) return m2("property missing ':'");
            var a4 = g2(l2), c3 = t13({ type: "declaration", property: u2(n12[0].replace(e11, "")), value: a4 ? u2(a4[0].replace(e11, "")) : "" });
            return g2(o2), c3;
          }
  ...
  return n0;
}()), n4 = n2.default || n2, n3 = n9("end"), n5 = n9("start");
function n9(e10) {
  return function(t10) {
...
n6.prototype.file = "", n6.prototype.name = "", n6.prototype.reason = "", n6.prototype.message = "", n6.prototype.stack = "", n6.prototype.column = void 0, n6.prototype.line = void 0, n6.prototype.ancestors = void 0, n6.prototype.cause = void 0, n6.prototype.fatal = void 0, n6.prototype.place = void 0, n6.prototype.ruleId = void 0, n6.prototype.source = void 0;
let n8 = {}.hasOwnProperty, n7 = /* @__PURE__ */ new Map(), re = /[A-Z]/g, rt = /-([a-z])/g, rn = /* @__PURE__ */ new Set(["table", "tbody", "thead", "tfoot", "tr"]), rr = /* @__PURE__ */ new Set(["td", "th"]), ri = "https://github.com/syntax-tree/hast-util-to-jsx-runtime";
  ...
  return "element" === t10.type ? function(e11, t11, n11) {
    ...
    let l2 = rc(e11, t11.tagName, false), o2 = function(e12, t12) {
      ...
      for (r3 in t12.properties) if ("children" !== r3 && n8.call(t12.properties, r3)) {
          ...
          if (!(null == n13 || "number" == typeof n13 && Number.isNaN(n13))) {
            if (Array.isArray(n13) && (n13 = r4.commaSeparated ? function(e14, t14) {
              ...
              let t14 = "object" == typeof n13 ? n13 : function(e14, t15) {
                let n14 = {};
                try {
                  n4(t15, function(e15, t16) {
                    let r5 = e15;
                    "--" !== r5.slice(0, 2) && ("-ms-" === r5.slice(0, 4) && (r5 = "ms-" + r5.slice(4)), r5 = r5.replace(rt, rf)), n14[r5] = t16;
                  });
                } catch (t16) {
                  if (!e14.ignoreInvalidStyle) {
                    let n15 = new n6("Cannot parse `style` attribute", { ancestors: e14.ancestors, cause: t16, ruleId: "style", source: "hast-util-to-jsx-runtime" });
                    throw n15.file = e14.filePath || void 0, n15.url = ri + "#cannot-parse-style-attribute", n15;
                  }
                }
                return n14;
              }(e13, String(n13));
              return "css" === e13.stylePropertyNameCase && (t14 = function(e14) {
                let t15;
                let n14 = {};
                for (t15 in e14) n8.call(e14, t15) && (n14[function(e15) {
                  let t16 = e15.replace(re, rp);
        ...
        if (l3) {
          let [r4, o3] = l3;
          e12.tableCellAlignToStyle && "align" === r4 && "string" == typeof o3 && rr.has(t12.tagName) ? n12 = o3 : i3[r4] = o3;
        }
      }
    ...
    })), ro(e11, o2, l2, t11), ra(o2, a2), e11.ancestors.pop(), e11.schema = r2, e11.create(t11, l2, o2, n11);
    ...
    return ro(e11, o2, l2, t11), ra(o2, a2), e11.ancestors.pop(), e11.schema = r2, e11.create(t11, l2, o2, n11);
    ...
    let r2 = {};
    return ra(r2, ru(e11, t11)), e11.create(t11, e11.Fragment, r2, n11);
...
function ru(e10, t10) {
  let n10 = [], r2 = -1, i2 = e10.passKeys ? /* @__PURE__ */ new Map() : n7;
...
function rc(e10, t10, n10) {
  ...
  if ("Literal" === r2.type) {
    let t11 = r2.value;
    return n8.call(e10.components, t11) ? e10.components[t11] : t11;
  }
  if (e10.evaluater) return e10.evaluater.evaluateExpression(r2);
  rs(e10);
}
function rs(e10, t10) {
  let n10 = new n6("Cannot handle MDX estrees without `createEvaluater`", { ancestors: e10.ancestors, place: t10, ruleId: "mdx-estree", source: "hast-util-to-jsx-runtime" });
...
let rg = { blockquote: function(e10, t10) {
  ...
  let r2 = e10.all(t10), i2 = n10 ? function(e11) {
    ...
    if ("list" === e11.type) {
      ...
      for (; !t11 && ++r3 < n11.length; ) t11 = rh(n11[r3]);
    }
    return t11;
  }(n10) : rh(t10), l2 = {}, o2 = [];
  ...
  if (n10.length > 0) {
    let r3 = { type: "element", tagName: "tbody", properties: {}, children: e10.wrap(n10, true) }, l3 = n5(t10.children[1]), o2 = n3(t10.children[t10.children.length - 1]);
  ...
  let n10 = { type: "text", value: function(e11) {
    ...
    for (; r2; ) l2.push(rm(t11.slice(i2, r2.index), i2 > 0, true), r2[0]), i2 = r2.index + r2[0].length, r2 = n11.exec(t11);
    return l2.push(rm(t11.slice(i2), i2 > 0, false)), l2.join("");
  }(String(t10.value)) };
  return e10.patch(t10, n10), e10.applyData(t10, n10);
}, thematicBreak: function(e10, t10) {
  let n10 = { type: "element", tagName: "hr", properties: {}, children: [] };
  return e10.patch(t10, n10), e10.applyData(t10, n10);
}, toml: ry, yaml: ry, definition: ry, footnoteDefinition: ry };
function ry() {
}
let rk = "object" == typeof self ? self : globalThis, rx = (e10, t10) => {
  let n10 = (t11, n11) => (e10.set(n11, t11), t11), r2 = (i2) => {
    ...
    return n10(new rk[l2](o2), i2);
  };
  return r2;
}, rv = (e10) => rx(/* @__PURE__ */ new Map(), e10)(0), { toString: rb } = {}, { keys: rS } = Object, rC = (e10) => {
  let t10 = typeof e10;
  if ("object" !== t10 || !e10) return [0, t10];
  let n10 = rb.call(e10).slice(8, -1);
  switch (n10) {
    case "Array":
      return [1, ""];
    case "Object":
  ...
  let i2 = (e11, t11) => {
    ...
    switch (o2) {
      ...
      case 2: {
        ...
        for (let t11 of rS(r3)) (e10 || !rw(rC(r3[t11]))) && n11.push([l2(t11), l2(r3[t11])]);
        return u3;
      }
      case 3:
      ...
      case 5: {
        ...
        for (let [n12, i3] of r3) (e10 || !(rw(rC(n12)) || rw(rC(i3)))) && t11.push([l2(n12), l2(i3)]);
        return n11;
      }
      case 6: {
        let t11 = [], n11 = i2([o2, t11], r3);
        for (let n12 of r3) (e10 || !rw(rC(n12))) && t11.push(l2(n12));
        return n11;
      }
    }
    let { message: u2 } = r3;
  ...
  return rA(!(t10 || n10), !!t10, /* @__PURE__ */ new Map(), r2)(e10), r2;
}, rI = "function" == typeof structuredClone ? (e10, t10) => t10 && ("json" in t10 || "lossy" in t10) ? rv(rT(e10, t10)) : structuredClone(e10) : (e10, t10) => rv(rT(e10, t10));
function rL(e10, t10) {
...
let rE = {}.hasOwnProperty, rM = {};
function rF(e10, t10) {
  e10.position && (t10.position = function(e11) {
    let t11 = n5(e11), n10 = n3(e11);
...
function rO(e10, t10) {
  ...
  if (e10 && e10.data) {
    ...
    "string" == typeof t11 && ("element" === n10.type ? n10.tagName = t11 : n10 = { type: "element", tagName: t11, properties: {}, children: "children" in n10 ? n10.children : [n10] }), "element" === n10.type && i2 && Object.assign(n10.properties, rI(i2)), "children" in n10 && n10.children && null != r2 && (n10.children = r2);
  }
  return n10;
}
function rz(e10, t10) {
...
let rN = i((e10, i2) => l(e10.text$, a(), o((i3) => {
  let l2 = function(e11, t10) {
    let n10 = function(e12, t11) {
      var n11, r3;
      let i5, l4;
      let o2 = /* @__PURE__ */ new Map(), a2 = /* @__PURE__ */ new Map(), u2 = { all: function(e13) {
        let t12 = [];
        if ("children" in e13) {
        ...
        return t12;
      }, applyData: rO, definitionById: o2, footnoteById: a2, footnoteCounts: /* @__PURE__ */ new Map(), footnoteOrder: [], handlers: { ...rg, ...rM.handlers }, one: function(e13, t12) {
      ...
      return "function" == typeof (n11 = function(e13) {
        if ("definition" === e13.type || "footnoteDefinition" === e13.type) {
          let t12 = "definition" === e13.type ? o2 : a2, n12 = String(e13.identifier).toUpperCase();
      ...
      let t11 = "string" == typeof e12.options.clobberPrefix ? e12.options.clobberPrefix : "user-content-", n11 = e12.options.footnoteBackContent || rL, r3 = e12.options.footnoteBackLabel || rD, i5 = e12.options.footnoteLabel || "Footnotes", l4 = e12.options.footnoteLabelTagName || "h2", o2 = e12.options.footnoteLabelProperties || { className: ["sr-only"] }, a2 = [], u2 = -1;
      ...
      if (0 !== a2.length) return { type: "element", tagName: "section", properties: { dataFootnotes: true, className: ["footnotes"] }, children: [{ type: "element", tagName: l4, properties: { ...rI(o2), id: "footnote-label" }, children: [{ type: "text", value: i5 }] }, { type: "text", value: "\n" }, { type: "element", tagName: "ol", properties: {}, children: e12.wrap(a2, true) }, { type: "text", value: "\n" }] };
      ...
      return function(e13, t10) {
        ...
        if (t10.development) {
          ...
          n10 = t10.jsxDEV, l3 = function(e14, t11, r3, i6) {
            let l4 = Array.isArray(r3.children), a3 = n5(e14);
            return n10(t11, r3, i6, l4, { columnNumber: a3 ? a3.column - 1 : void 0, fileName: o2, lineNumber: a3 ? a3.line : void 0 }, void 0);
          };
        } else {
