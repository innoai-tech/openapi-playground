...
var _e, _t, _n;
import { c as e, I as t, j as n, a as l, b as a, d as i, r, T as o, F as d, e as s, s as c, g as p, f as u, o as h, t as y, h as v } from "./lib-nodepkg-vuekit.37JH-Ya9.chunk.js";
import { o as m, J as f, S as x, E as g } from "./lib-nodepkg-typedef.DWT0hHJh.chunk.js";
import { O as b, s as w, m as N, f as $, d as C, t as k, E as S, c as E, B as O, S as T } from "./vendor-rxjs.ByE15jUQ.chunk.js";
import { i as I, g as A, a as D, b as L, s as P, l as M, c as R, d as _ } from "./vendor-innoai-tech-lodash.XmF8H4xo.chunk.js";
import { s as J, v as B, a as j, P as z, b as H, B as W } from "./lib-nodepkg-vueuikit.DuvyZHLT.chunk.js";
import { I as U, a as V, m as F, b as K, c as X, d as q } from "./lib-nodepkg-vuematerial.DBnnYGmq.chunk.js";
...
let Q = /* @__PURE__ */ e(() => new G(m(), {})), Y = /* @__PURE__ */ e(() => ({})), Z = /* @__PURE__ */ J("span", { displayName: "ActionToolbar" })({ px: 2, pos: "relative", display: "flex", alignItems: "center", gap: 8, visibility: "hidden" }), ee = /* @__PURE__ */ J("span", (e2, t2) => {
  ...
  let { slots: l2, render: a2 } = t2, r2 = /* @__PURE__ */ es.use(), d2 = /* @__PURE__ */ s(Q.use().error$, /* @__PURE__ */ a2((t3) => {
    ...
    return /* @__PURE__ */ i(ed, { "data-error": d3, "data-dirty": e2.dirty, style: { paddingLeft: `${32 * r2.indent}px` }, children: [e2.title && /* @__PURE__ */ n(er, { style: { paddingLeft: `${32 * r2.indent}px` }, children: e2.title }), /* @__PURE__ */ n(ev, { children: null === (a3 = l2.default) || void 0 === a3 ? void 0 : a3.call(l2) }), d3 && /* @__PURE__ */ n(eo, { children: `${t3[o2]}` })] });
  }));
...
let eC = /* @__PURE__ */ p(function(e2, t2) {
  ...
  let {} = t2;
  return () => /* @__PURE__ */ n(ek, { $title: "复制当前节点为 JSON 字符串", children: /* @__PURE__ */ n(et, { type: "button", onClick: () => eC(/* @__PURE__ */ JSON.stringify(e2.value, null, 2)), children: /* @__PURE__ */ n(U, { path: F }) }) });
...
let eD = /* @__PURE__ */ e(() => new eA()), eL = /* @__PURE__ */ l((e2, l2) => {
  let a2, { render: r2 } = l2, o2 = /* @__PURE__ */ h(null), d2 = /* @__PURE__ */ h(null), p2 = /* @__PURE__ */ h(null), u2 = /* @__PURE__ */ eI.from(p2), v2 = /* @__PURE__ */ eD.use(), m2 = /* @__PURE__ */ ef.from(p2), f2 = /* @__PURE__ */ Q.use();
  ...
  return (s(u2, /* @__PURE__ */ k((e3) => {
    ...
    return S;
  }))), /* @__PURE__ */ c()), "enums" == e2.typedef.type) ? s(/* @__PURE__ */ E([e2.value$, m2, b2]), /* @__PURE__ */ r2((t2) => {
    var l3, a3, i2;
    let [r3, s2, { index: c2 }] = t2, u3 = null !== (l3 = /* @__PURE__ */ x.schemaProp(e2.typedef, "enum")) && void 0 !== l3 ? l3 : [], h2 = null !== (a3 = /* @__PURE__ */ x.metaProp(e2.typedef, "enumLabels")) && void 0 !== a3 ? a3 : [];
    return /* @__PURE__ */ n(eM, { ref: d2, onClick: () => {
      m2.show();
    }, "data-type": typeof r3, tabindex: 0, children: s2 ? /* @__PURE__ */ n(eg, { onSelected: (e3) => {
      T2(e3);
    }, open$: m2, $content: /* @__PURE__ */ n("div", { ref: o2, children: /* @__PURE__ */ u3.map((e3, t3) => /* @__PURE__ */ n(e_, { "data-focus": c2 % u3.length === t3, value: e3, label: h2[t3] })) }), children: /* @__PURE__ */ n("input", { value: void 0 == r3 ? "" : `${r3}`, ref: p2, "data-options": true }) }) : /* @__PURE__ */ n("span", { children: null !== (i2 = /* @__PURE__ */ JSON.stringify(r3)) && void 0 !== i2 ? i2 : "undefined" }) });
    ...
    return /* @__PURE__ */ n(eM, { ref: d2, onClick: () => {
      ...
      m2.show();
    }, children: a3 ? /* @__PURE__ */ n(z, { isOpen: true, placement: "right-start", $content: /* @__PURE__ */ i(eP, { ref: o2, children: [/* @__PURE__ */ n(et, { type: "button", onClick: () => u2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(U, { path: K }) }), /* @__PURE__ */ n(et, { type: "button", onClick: () => u2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(U, { path: X }) })] }), children: /* @__PURE__ */ n("textarea", { ref: p2, rows: 1, value: void 0 == l3 ? "" : `${l3}` }) }) : /* @__PURE__ */ n("span", { "data-value": true, children: null !== (t2 = /* @__PURE__ */ JSON.stringify(l3)) && void 0 !== t2 ? t2 : "undefined" }) });
  }));
...
}, { displayName: "RemovePropIconBtn", emits: ["remove"] }), eB = /* @__PURE__ */ l((e2, t2) => {
  let { render: l2 } = t2, a2 = /* @__PURE__ */ Q.use(), r2 = /* @__PURE__ */ Y.use();
  return s(e2.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(ec, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(ee, { children: /* @__PURE__ */ n(eO, { value: t3 }) }), $trailing: /* @__PURE__ */ n(ej, { ctx: e2.ctx, onAdd: (t4) => {
  ...
  let { emit: a2, render: r2 } = l2, o2 = /* @__PURE__ */ h(null), d2 = /* @__PURE__ */ eI.from(o2), p2 = /* @__PURE__ */ eT.from(o2), u2 = /* @__PURE__ */ ef.from(o2), y2 = /* @__PURE__ */ Q.use(), v2 = new t({ index: 0 }), m2 = () => {
  ...
  return s(/* @__PURE__ */ E([p2, u2, v2, e2.options$]), /* @__PURE__ */ r2((t2) => {
    let [l3, a3, r3, s2] = t2;
  ...
  let { emit: l2, render: a2 } = t2, r2 = /* @__PURE__ */ h(null), o2 = /* @__PURE__ */ eT.from(r2), d2 = /* @__PURE__ */ eI.from(r2), p2 = /* @__PURE__ */ ef.from(r2), u2 = /* @__PURE__ */ Q.use(), y2 = () => {
...
}, { displayName: "RecordInput", props: ["ctx", "value", "typedef"] }), eK = (e2, t2, l2) => "object" == e2.type || "intersection" == e2.type || "union" == e2.type && x.schemaProp(e2, "discriminator") ? /* @__PURE__ */ n(eB, { typedef: e2, value: null != t2 ? t2 : {}, ctx: l2 }) : "union" == e2.type && D(/* @__PURE__ */ x.schemaProp(e2, "discriminator")) ? /* @__PURE__ */ n(eL, { typedef: e2, value: t2, ctx: l2 }) : "record" == e2.type ? /* @__PURE__ */ n(eF, { typedef: e2, value: t2, ctx: l2 }) : "array" == e2.type ? /* @__PURE__ */ n(eW, { typedef: e2, value: t2, ctx: l2 }) : /* @__PURE__ */ n(eL, { typedef: e2, value: t2, ctx: l2 }), eX = /* @__PURE__ */ l((e2, t2) => {
  let {} = e2, { render: l2 } = t2, a2 = /* @__PURE__ */ Q.use(), r2 = /* @__PURE__ */ Y.use(), o2 = /* @__PURE__ */ v(null);
