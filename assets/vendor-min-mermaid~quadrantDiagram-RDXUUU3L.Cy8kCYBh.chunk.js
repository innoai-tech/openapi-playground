import { B as Bf, F as Ff, M as Mf, L as Lf, w as wf, v as vf, H as Hl, t as tt, i as ih, T as Tf, S as Sf, p as pl, X as hl, a2 as Ia, D as De$1 } from './vendor-min-mermaid~chunk-RAMAZW42.vc82q0BN.chunk.js';
...
var V = /*#__PURE__*/ hl(), qt = class {
    ...
    getQuadrantPoints(n) {
        let { quadrantSpace: f } = n, { quadrantHeight: u, quadrantLeft: c, quadrantTop: g, quadrantWidth: y } = f, S = /*#__PURE__*/ Ia().domain([
            0,
            1
        ]).range([
            c,
            y + c
        ]), i = /*#__PURE__*/ Ia().domain([
            0,
            1
        ]).range([
            u + g,
...
` + t);
    ...
    let T = /*#__PURE__*/ (i === "sandbox" ? ih(A.nodes()[0].contentDocument.body) : ih("body")).select(`[id="${n}"]`), m = /*#__PURE__*/ T.append("g").attr("class", "main"), b = S.quadrantChart?.chartWidth ?? 500, q = S.quadrantChart?.chartHeight ?? 500;
