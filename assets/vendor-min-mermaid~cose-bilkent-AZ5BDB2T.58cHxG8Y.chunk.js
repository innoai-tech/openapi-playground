import { O as ra, hn as pt, ln as ia } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.BVgxNvHA.chunk.js";
import { $ as n, Q as m, tt as q } from "./vendor-min-mermaid~architecture-U656AL7Q-3ZQKGQJL.BH0ewMis.chunk.js";
...
var ot = /* @__PURE__ */ q(/* @__PURE__ */ (/* @__PURE__ */ n((j, tt) => {
	m(function(M, v) {
	...
	a.debug("Positioning nodes based on layout results"), D.nodes.forEach((E) => {
		...
		if (s && g) {
			...
			if (f) {
				...
				let L = { ...E }, N = /* @__PURE__ */ n$1(d, L, i, m$1.type, s, g, m$1.diagramId);
				u(L, N);
			} else {
				let L = {
					...E,
				...
				}, N = /* @__PURE__ */ n$1(d, L, i, m$1.type, s, g, m$1.diagramId);
				u(L, N);
			}
		}
