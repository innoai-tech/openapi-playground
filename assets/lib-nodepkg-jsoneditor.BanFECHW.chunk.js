...
var _e, _t, _n;
var e, t, n, a;
import { c as r, I as i, j as l, a as o, r as s, s as d, b as p, d as c, e as u, f as h, T as y, F as m, o as f, t as x, g as v } from "./lib-nodepkg-vuekit.C3GNUPgi.chunk.js";
import { o as g, J as b, g as w, S as N, a as C, b as S, r as $, s as k, E as O } from "./lib-nodepkg-typedef.rFthNQ04.chunk.js";
import { s as E, a as I, P as T, v as A, b as D, B as R } from "./lib-nodepkg-vueuikit.D_WKTDjQ.chunk.js";
import { I as J, a as L, m as P, b as M, c as B, d as _, e as W } from "./lib-nodepkg-vuematerial.Cnl9DVua.chunk.js";
import { O as j, s as z, m as H, f as V, d as F, t as U, E as K, c as X, B as q, S as G } from "./vendor-rxjs.DXC5TYZz.chunk.js";
...
import { M as el } from "./lib-nodepkg-vuemarkdown.CuFjjCHt.chunk.js";
...
let ef = E("div", { displayName: "PopoverContainer" })({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: A("sys.outline-variant", D(0.38)) }), ex = E("div", { displayName: "MenuItem" })({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), ev = o((e9, t2) => {
  ...
  return s(r2, a2((t3) => {
    ...
    return l(T, { isOpen: t3, placement: e9.placement ?? "left", $content: l(eb, { children: l(eg, { children: n2.title() }) }), children: a3 ? p(a3, { onMouseover: () => {
      r2.show();
    }, onMouseout: () => {
      r2.hide();
    } }) : null });
  ...
  let { slots: n2, render: a2 } = t2, r2 = eE.use(), i2 = s(es.use().error$, a2((t3) => {
    ...
    return c(eO, { "data-error": i3, "data-dirty": e9.dirty, style: { paddingLeft: `${32 * r2.indent}px` }, children: [(e9.title || e9.description) && l(e$, { style: { paddingLeft: `${32 * r2.indent}px` }, children: e9.description ? l(ev, { $title: l(eL, { children: l(el, { text: e9.description }) }), children: c("div", { children: [e9.title, " ", l(L, { path: P })] }) }) : l("span", { children: e9.title }) }), l(eJ, { children: (_a = n2.default) == null ? void 0 : _a.call(n2) }), i3 && l(ek, { children: `${t3[a3]}` })] });
  }));
...
let ez = r(() => new ej()), eH = o((e9, t2) => {
  ...
  let g2 = () => {
    ...
    w2(), b2.next({ index: g2() }), Z(e9.value) && v2.delete(e9.ctx.path);
  }, S2 = (t3) => {
    var _a, _b;
    if ("enums" === e9.typedef.type) {
  ...
  return (e9.allowRawJSON && s(h2, U((t3) => {
    ...
    if (e10) {
      ...
      return setTimeout(() => a3(e10)), H(s(V(e10, "blur"), U((t4) => {
        var _a, _b;
        !(t4.relatedTarget && (((_a = o2.value) == null ? void 0 : _a.contains(t4.relatedTarget)) || ((_b = r2.value) == null ? void 0 : _b.contains(t4.relatedTarget)))) && (t4.preventDefault(), S2(e10.value));
      })), s(V(e10, "input"), U((e11) => {
        a3(e11.target), h2.next(e11.target.value);
      })));
    }
    return K;
  }))), d()), "enums" == e9.typedef.type) ? s(X([e9.value$, m2, b2]), a2((t3) => {
  ...
  let { render: n2 } = t2;
  return s(e9.value$, n2((t3) => er(t3) ? l(e1, { value: t3, typedef: C(S()), ctx: e9.ctx }) : ei(t3) ? l(e4, { value: t3, typedef: $(k(), S()), ctx: e9.ctx }) : l(eH, { value: t3, typedef: S(), ctx: e9.ctx, allowRawJSON: true })));
