import { A as Xr, B as hi, D as Rn, E as Qr, F as dn, G as ym, H as np, I as fm, J as N, L as fn, M as Zr, O as Ti, P as bn, Q as m$1, R as gp, S as Ki, T as Om, U as sn, V as lp, W as tp, Z as qs, b as Jm, j as Zi, k as Tn, q as Mt, v as Df, w as Nf, x as Jr, y as Ji } from "./vendor-min-mermaid~architecture-U656AL7Q-3ZQKGQJL.BHePMx5P.chunk.js";
import { s as m } from "./vendor-min-mermaid~blockDiagram-MFEFEJY7.ApPexMK5.chunk.js";
function g(r, e, n, t) {
	var o;
	do
		o = /* @__PURE__ */ lp(t);
...
function xr(r) {
	...
	return Zr(/* @__PURE__ */ r.nodes(), function(n) {
		e.setNode(n, /* @__PURE__ */ r.node(n));
	}), Zr(/* @__PURE__ */ r.edges(), function(n) {
...
m$1(xr, "simplify");
function X(r) {
	var e = /* @__PURE__ */ new m({ multigraph: /* @__PURE__ */ r.isMultigraph() }).setGraph(/* @__PURE__ */ r.graph());
	return Zr(/* @__PURE__ */ r.nodes(), function(n) {
...
m$1($, "intersectRect");
function C(r) {
	var e = /* @__PURE__ */ Jr(/* @__PURE__ */ Jm(er(r) + 1), function() {
		return [];
	});
	return Zr(/* @__PURE__ */ r.nodes(), function(n) {
...
function kr(r) {
	var e = /* @__PURE__ */ ym(/* @__PURE__ */ Jr(/* @__PURE__ */ r.nodes(), function(n) {
		return r.node(n).rank;
	}));
	Zr(/* @__PURE__ */ r.nodes(), function(n) {
...
function gr(r) {
	var e = /* @__PURE__ */ ym(/* @__PURE__ */ Jr(/* @__PURE__ */ r.nodes(), function(a) {
		return r.node(a).rank;
	})), n = [];
	Zr(/* @__PURE__ */ r.nodes(), function(a) {
		var i = r.node(a).rank - e;
		n[i] || (n[i] = []), n[i].push(a);
	});
	var t = 0, o = r.graph().nodeRankFactor;
	Zr(n, function(a, i) {
		sn(a) && i % o !== 0 ? --t : t && Zr(a, function(f) {
			r.node(f).rank += t;
		});
	});
}
...
function er(r) {
	return bn(/* @__PURE__ */ Jr(/* @__PURE__ */ r.nodes(), function(e) {
		var n = r.node(e).rank;
		if (!sn(n)) return n;
	}));
}
...
function Lr(r) {
	function e(n) {
		...
		if (t.length && Zr(t, e), Object.prototype.hasOwnProperty.call(o, "minRank")) {
			o.borderLeft = [], o.borderRight = [];
			for (var a = o.minRank, i = o.maxRank + 1; a < i; ++a) Pr(r, "borderLeft", "_bl", n, o, a), Pr(r, "borderRight", "_br", n, o, a);
		}
	}
	m$1(e, "dfs"), Zr(/* @__PURE__ */ r.children(), e);
}
m$1(Lr, "addBorderSegments");
...
m$1(Tr, "undo");
function Rr(r) {
	Zr(/* @__PURE__ */ r.nodes(), function(e) {
		Cr(/* @__PURE__ */ r.node(e));
	}), Zr(/* @__PURE__ */ r.edges(), function(e) {
...
function pe(r) {
	Zr(/* @__PURE__ */ r.nodes(), function(e) {
		...
		Zr(n.points, nr), Object.prototype.hasOwnProperty.call(n, "y") && nr(n);
	});
}
m$1(pe, "reverseY");
function nr(r) {
...
function me(r) {
	Zr(/* @__PURE__ */ r.nodes(), function(e) {
		...
		var n = /* @__PURE__ */ r.edge(e);
		Zr(n.points, tr), Object.prototype.hasOwnProperty.call(n, "x") && tr(n);
	});
}
m$1(me, "swapXY");
function tr(r) {
...
function Mr(r, e) {
	...
	var n = /* @__PURE__ */ Ee(r, e || we);
	return Qr(/* @__PURE__ */ Jr(/* @__PURE__ */ be(n.graph, n.buckets, n.zeroIdx), function(o) {
	...
	for (var t = [], o = e[e.length - 1], a = e[0], i; r.nodeCount();) {
		...
		if (r.nodeCount()) {
			for (var f = e.length - 2; f > 0; --f) if (i = /* @__PURE__ */ e[f].dequeue(), i) {
				t = /* @__PURE__ */ t.concat(/* @__PURE__ */ or(r, e, n, i, !0));
				break;
			}
		}
	}
...
function or(r, e, n, t, o) {
	var a = o ? [] : void 0;
	return Zr(/* @__PURE__ */ r.inEdges(t.v), function(i) {
		var f = /* @__PURE__ */ r.edge(i), d = /* @__PURE__ */ r.node(i.v);
		o && a.push({
			v: i.v,
			w: i.w
		}), d.out -= f, ar(e, n, d);
	}), Zr(/* @__PURE__ */ r.outEdges(t.v), function(i) {
...
function Ee(r, e) {
	var n = new m(), t = 0, o = 0;
	Zr(/* @__PURE__ */ r.nodes(), function(f) {
		n.setNode(f, {
			v: f,
			in: 0,
			out: 0
		});
	}), Zr(/* @__PURE__ */ r.edges(), function(f) {
	...
	return Zr(/* @__PURE__ */ n.nodes(), function(f) {
...
m$1(ar, "assignBucket");
function Fr(r) {
	Zr(r.graph().acyclicer === "greedy" ? Mr(r, /* @__PURE__ */ n(r)) : ye(r), function(t) {
		var o = /* @__PURE__ */ r.edge(t);
		r.removeEdge(t), o.forwardName = t.name, o.reversed = !0, r.setEdge(t.w, t.v, o, /* @__PURE__ */ lp("rev"));
	});
	function n(t) {
		return function(o) {
...
function ye(r) {
	var e = [], n = {}, t = {};
	function o(a) {
		Object.prototype.hasOwnProperty.call(t, a) || (t[a] = !0, n[a] = !0, Zr(/* @__PURE__ */ r.outEdges(a), function(i) {
			Object.prototype.hasOwnProperty.call(n, i.w) ? e.push(i) : o(i.w);
		}), delete n[a]);
	}
	return m$1(o, "dfs"), Zr(/* @__PURE__ */ r.nodes(), o), e;
}
m$1(ye, "dfsFAS");
function Gr(r) {
	Zr(/* @__PURE__ */ r.edges(), function(e) {
...
m$1(Gr, "undo");
function Br(r) {
	r.graph().dummyChains = [], Zr(/* @__PURE__ */ r.edges(), function(e) {
		xe(r, e);
	});
}
m$1(Br, "run");
function xe(r, e) {
	...
	if (a !== t + 1) {
		...
		for (l = 0, ++t; t < a; ++l, ++t) f.points = [], c = {
			...
			edgeObj: e,
			rank: t
		}, h = /* @__PURE__ */ g(r, "edge", c, "_d"), t === d && (c.width = f.width, c.height = f.height, c.dummy = "edge-label", c.labelpos = f.labelpos), r.setEdge(n, h, { weight: f.weight }, i), l === 0 && r.graph().dummyChains.push(h), n = h;
		r.setEdge(n, o, { weight: f.weight }, i);
	}
}
m$1(xe, "normalizeEdge");
function Ar(r) {
	Zr(r.graph().dummyChains, function(e) {
...
function U(r) {
	...
	function n(t) {
		...
		e[t] = !0;
		var a = /* @__PURE__ */ ym(/* @__PURE__ */ Jr(/* @__PURE__ */ r.outEdges(t), function(i) {
			return n(i.w) - r.edge(i).minlen;
		}));
		return (a === Number.POSITIVE_INFINITY || a === void 0 || a === null) && (a = 0), o.rank = a;
	}
	m$1(n, "dfs"), Zr(/* @__PURE__ */ r.sources(), n);
}
m$1(U, "longestPath");
function M(r, e) {
...
m$1(M, "slack");
function J(r) {
	var e = new m({ directed: !1 }), n = r.nodes()[0], t = /* @__PURE__ */ r.nodeCount();
	e.setNode(n, {});
...
function ke(r, e) {
	function n(t) {
		Zr(/* @__PURE__ */ e.nodeEdges(t), function(o) {
			var a = o.v, i = t === a ? o.w : a;
			!r.hasNode(i) && !M(e, o) && (r.setNode(i, {}), r.setEdge(t, i, {}), n(i));
		});
	}
	return m$1(n, "dfs"), Zr(/* @__PURE__ */ r.nodes(), n), r.nodeCount();
}
m$1(ke, "tightTree");
function ge(r, e) {
...
function Ne(r, e, n) {
	Zr(/* @__PURE__ */ r.nodes(), function(t) {
		e.node(t).rank += n;
	});
}
m$1(Ne, "shiftRanks");
...
function ir(r) {
	...
	function o(a) {
		...
		Object.prototype.hasOwnProperty.call(e, a) || (n[a] = !0, e[a] = !0, Zr(/* @__PURE__ */ r.predecessors(a), o), delete n[a], t.push(a));
	}
	if (m$1(o, "visit"), Zr(/* @__PURE__ */ r.sinks(), o), tp(e) !== r.nodeCount()) throw new W();
	return t;
}
m$1(ir, "topsort");
function W() {}
...
function Yr(r, e, n, t, o, a) {
	Object.prototype.hasOwnProperty.call(t, e) || (t[e] = !0, n || a.push(e), Zr(/* @__PURE__ */ o(e), function(i) {
		Yr(r, i, n, t, o, a);
	}), n && a.push(e));
}
m$1(Yr, "doDfs");
...
function T(r) {
	...
	var e = /* @__PURE__ */ J(r);
	dr(e), ur(e, r);
	for (var n, t; n = /* @__PURE__ */ qr(e);) t = /* @__PURE__ */ Xr$1(e, r, n), Hr(e, r, n, t);
}
m$1(T, "networkSimplex");
function ur(r, e) {
	var n = /* @__PURE__ */ sr(r, /* @__PURE__ */ r.nodes());
	n = /* @__PURE__ */ n.slice(0, n.length - 1), Zr(n, function(t) {
		Ce(r, e, t);
	});
}
...
function Ur(r, e, n) {
	var o = r.node(n).parent, a = !0, i = /* @__PURE__ */ e.edge(n, o), f = 0;
	return i || (a = !1, i = /* @__PURE__ */ e.edge(o, n)), f = i.weight, Zr(/* @__PURE__ */ e.nodeEdges(n), function(d) {
		var c = d.v === n, h = c ? d.w : d.v;
		if (h !== o) {
			var l = c === a, p = e.edge(d).weight;
			if (f += l ? p : -p, Te(r, n, h)) {
				var m$2 = r.edge(n, h).cutvalue;
				f += l ? -m$2 : m$2;
			}
		}
	}), f;
...
function Wr(r, e, n, t, o) {
	...
	return e[t] = !0, Zr(/* @__PURE__ */ r.neighbors(t), function(f) {
...
function Xr$1(r, e, n) {
	...
	var a = /* @__PURE__ */ r.node(t), i = /* @__PURE__ */ r.node(o), f = a, d = !1;
	a.lim > i.lim && (f = i, d = !0);
	return Om(/* @__PURE__ */ fn(/* @__PURE__ */ e.edges(), function(h) {
...
function je(r, e) {
	var t = /* @__PURE__ */ fr(r, /* @__PURE__ */ Ki(/* @__PURE__ */ r.nodes(), function(o) {
		return !e.node(o).parent;
	}));
	t = /* @__PURE__ */ t.slice(1), Zr(t, function(o) {
		var a = r.node(o).parent, i = /* @__PURE__ */ e.edge(o, a), f = !1;
		i || (i = /* @__PURE__ */ e.edge(a, o), f = !0), e.node(o).rank = e.node(a).rank + (f ? i.minlen : -i.minlen);
	});
}
m$1(je, "updateRanks");
function Te(r, e, n) {
...
m$1(Jr$1, "networkSimplexRanker");
function Kr(r) {
	var e = /* @__PURE__ */ g(r, "root", {}, "_root"), n = /* @__PURE__ */ Me(r), t = bn(/* @__PURE__ */ Xr(n)) - 1, o = 2 * t + 1;
	r.graph().nestingRoot = e, Zr(/* @__PURE__ */ r.edges(), function(i) {
		r.edge(i).minlen *= o;
	});
	var a = Fe(r) + 1;
	Zr(/* @__PURE__ */ r.children(), function(i) {
		Qr$1(r, e, o, a, t, n, i);
	}), r.graph().nodeRankFactor = o;
}
m$1(Kr, "run");
function Qr$1(r, e, n, t, o, a, i) {
	...
	r.setParent(d, i), h.borderTop = d, r.setParent(c, i), h.borderBottom = c, Zr(f, function(l) {
		Qr$1(r, e, n, t, o, a, l);
		var p = /* @__PURE__ */ r.node(l), m$2 = p.borderTop ? p.borderTop : l, v = p.borderBottom ? p.borderBottom : l, b = p.borderTop ? t : 2 * t, D = m$2 !== v ? 1 : o - a[i] + 1;
		r.setEdge(d, m$2, {
			weight: b,
			minlen: D,
			nestingEdge: !0
...
function Me(r) {
	...
	function n(t, o) {
		...
		a && a.length && Zr(a, function(i) {
			n(i, o + 1);
		}), e[t] = o;
	}
	return m$1(n, "dfs"), Zr(/* @__PURE__ */ r.children(), function(t) {
		n(t, 1);
	}), e;
}
m$1(Me, "treeDepths");
...
function Zr$1(r) {
	...
	r.removeNode(e.nestingRoot), delete e.nestingRoot, Zr(/* @__PURE__ */ r.edges(), function(n) {
...
function re(r, e, n) {
	var t = /* @__PURE__ */ Ve(r), o = /* @__PURE__ */ new m({ compound: !0 }).setGraph({ root: t }).setDefaultNodeLabel(function(a) {
		return r.node(a);
	});
	return Zr(/* @__PURE__ */ r.nodes(), function(a) {
		var i = /* @__PURE__ */ r.node(a), f = /* @__PURE__ */ r.parent(a);
		(i.rank === e || i.minRank <= e && e <= i.maxRank) && (o.setNode(a), o.setParent(a, f || t), Zr(/* @__PURE__ */ r[n](a), function(d) {
			var c = d.v === a ? d.w : d.v, h = /* @__PURE__ */ o.edge(c, a), l = sn(h) ? 0 : h.weight;
...
m$1(ee, "crossCount");
function Be(r, e, n) {
	for (var t = /* @__PURE__ */ gp(n, /* @__PURE__ */ Jr(n, function(c, h) {
		return h;
	})), o = /* @__PURE__ */ Qr(/* @__PURE__ */ Jr(e, function(c) {
		return np(/* @__PURE__ */ Jr(/* @__PURE__ */ r.outEdges(c), function(h) {
			return {
				pos: t[h.w],
	...
	var i = 2 * a - 1;
	a -= 1;
	var f = /* @__PURE__ */ Jr(new Array(i), function() {
		return 0;
	}), d = 0;
	return Zr(/* @__PURE__ */ o.forEach(function(c) {
		var h = c.pos + a;
		f[h] += c.weight;
...
function ne(r) {
	var e = {}, n = /* @__PURE__ */ fn(/* @__PURE__ */ r.nodes(), function(f) {
		return !r.children(f).length;
	}), o = /* @__PURE__ */ Jr(/* @__PURE__ */ Jm(bn(/* @__PURE__ */ Jr(n, function(f) {
	...
	function a(f) {
		if (!fm(e, f)) {
			e[f] = !0;
			o[r.node(f).rank].push(f), Zr(/* @__PURE__ */ r.successors(f), a);
		}
	}
	m$1(a, "dfs");
	return Zr(/* @__PURE__ */ np(n, function(f) {
		return r.node(f).rank;
	}), a), o;
}
m$1(ne, "initOrder");
...
function oe(r, e) {
	...
	Zr(r, function(o, a) {
		...
		sn(o.barycenter) || (i.barycenter = o.barycenter, i.weight = o.weight);
	}), Zr(/* @__PURE__ */ e.edges(), function(o) {
		var a = n[o.v], i = n[o.w];
		!sn(a) && !sn(i) && (i.indegree++, a.out.push(n[o.w]));
	});
	return Ae(/* @__PURE__ */ fn(n, function(o) {
		return !o.indegree;
	}));
}
...
function Ae(r) {
	...
	function n(a) {
		return function(i) {
			i.merged || (sn(i.barycenter) || sn(a.barycenter) || i.barycenter >= a.barycenter) && De(a, i);
		};
	}
	m$1(n, "handleIn");
	function t(a) {
	...
	for (m$1(t, "handleOut"); r.length;) {
		...
		e.push(o), Zr(/* @__PURE__ */ o.in.reverse(), /* @__PURE__ */ n(o)), Zr(o.out, /* @__PURE__ */ t(o));
	}
	return Jr(/* @__PURE__ */ fn(e, function(a) {
		return !a.merged;
	}), function(a) {
		return Tn(a, [
			"vs",
...
function De(r, e) {
	var n = 0, t = 0;
	r.weight && (n += r.barycenter * r.weight, t += r.weight), e.weight && (n += e.barycenter * e.weight, t += e.weight), r.vs = /* @__PURE__ */ e.vs.concat(r.vs), r.barycenter = n / t, r.weight = t, r.i = /* @__PURE__ */ Math.min(e.i, r.i), e.merged = !0;
}
m$1(De, "mergeEntries");
function ie(r, e) {
...
function hr(r, e, n, t) {
	...
	if (i && (l.vs = /* @__PURE__ */ Qr([
		i,
		l.vs,
		f
	]), r.predecessors(i).length)) {
		var p = /* @__PURE__ */ r.node(r.predecessors(i)[0]), m$2 = /* @__PURE__ */ r.node(r.predecessors(f)[0]);
		Object.prototype.hasOwnProperty.call(l, "barycenter") || (l.barycenter = 0, l.weight = 0), l.barycenter = (l.barycenter * l.weight + p.order + m$2.order) / (l.weight + 2), l.weight += 2;
	}
	return l;
}
m$1(hr, "sortSubgraph");
function ze(r, e) {
	Zr(r, function(n) {
		n.vs = /* @__PURE__ */ Qr(/* @__PURE__ */ n.vs.map(function(t) {
			return e[t] ? e[t].vs : t;
		}));
	});
}
...
function Ue(r, e) {
	sn(r.barycenter) ? (r.barycenter = e.barycenter, r.weight = e.weight) : (r.barycenter = (r.barycenter * r.weight + e.barycenter * e.weight) / (r.weight + e.weight), r.weight += e.weight);
}
...
function de(r) {
	var e = /* @__PURE__ */ Xe(r);
	Zr(r.graph().dummyChains, function(n) {
		for (var t = /* @__PURE__ */ r.node(n), o = t.edgeObj, a = /* @__PURE__ */ qe(r, e, o.v, o.w), i = a.path, f = a.lca, d = 0, c = i[d], h = !0; n !== o.w;) {
...
function qe(r, e, n, t) {
	var o = [], a = [], i = /* @__PURE__ */ Math.min(e[n].low, e[t].low), f = /* @__PURE__ */ Math.max(e[n].lim, e[t].lim), d = n, c;
	do
		d = /* @__PURE__ */ r.parent(d), o.push(d);
...
function Xe(r) {
	...
	function t(o) {
		var a = n;
		Zr(/* @__PURE__ */ r.children(o), t), e[o] = {
			low: a,
			lim: n++
		};
	}
	return m$1(t, "dfs"), Zr(/* @__PURE__ */ r.children(), t), e;
}
m$1(Xe, "postorder");
function He(r, e) {
	var n = {};
	function t(o, a) {
		...
		return Zr(a, function(h, l) {
			var p = /* @__PURE__ */ Ke(r, h), m$2 = p ? r.node(p).order : d;
			(p || h === c) && (Zr(/* @__PURE__ */ a.slice(f, l + 1), function(v) {
				Zr(/* @__PURE__ */ r.predecessors(v), function(b) {
					var D = /* @__PURE__ */ r.node(b), mr = D.order;
					(mr < i || m$2 < mr) && !(D.dummy && r.node(v).dummy) && ce(n, b, v);
				});
			}), f = l + 1, i = m$2);
		}), a;
	}
...
function Je(r, e) {
	...
	function t(a, i, f, d, c) {
		var h;
		Zr(/* @__PURE__ */ Jm(i, f), function(l) {
			h = a[l], r.node(h).dummy && Zr(/* @__PURE__ */ r.predecessors(h), function(p) {
				var m$2 = /* @__PURE__ */ r.node(p);
				m$2.dummy && (m$2.order < d || m$2.order > c) && ce(n, p, h);
			});
		});
	}
	m$1(t, "scan");
	...
	return Zr(e, function(f) {
		...
		Zr(f, function(c) {
			...
			if (h.length) {
				...
				for (var l = (h.length - 1) / 2, p = /* @__PURE__ */ Math.floor(l), m$2 = /* @__PURE__ */ Math.ceil(l); p <= m$2; ++p) {
					var v = h[p];
...
function $e(r, e, n, t, o) {
	...
	function d(l, p) {
		for (var m$2 = /* @__PURE__ */ i.nodes(), v = /* @__PURE__ */ m$2.pop(), b = {}; v;) b[v] ? l(v) : (b[v] = !0, m$2.push(v), m$2 = /* @__PURE__ */ m$2.concat(/* @__PURE__ */ p(v))), v = /* @__PURE__ */ m$2.pop();
	}
	m$1(d, "iterate");
	function c(l) {
		a[l] = /* @__PURE__ */ i.inEdges(l).reduce(function(p, m$2) {
			return Math.max(p, a[m$2.v] + i.edge(m$2));
		}, 0);
	}
	m$1(c, "pass1");
	function h(l) {
		...
		}, Number.POSITIVE_INFINITY), m$2 = /* @__PURE__ */ r.node(l);
		p !== Number.POSITIVE_INFINITY && m$2.borderType !== f && (a[l] = /* @__PURE__ */ Math.max(a[l], p));
	}
	return m$1(h, "pass2"), d(c, /* @__PURE__ */ i.predecessors.bind(i)), d(h, /* @__PURE__ */ i.successors.bind(i)), Zr(t, function(l) {
		a[l] = a[n[l]];
	}), a;
}
...
function en(r, e) {
	return Om(/* @__PURE__ */ Xr(e), function(n) {
...
function nn(r, e) {
	var n = /* @__PURE__ */ Xr(e), t = /* @__PURE__ */ ym(n), o = /* @__PURE__ */ bn(n);
	Zr(["u", "d"], function(a) {
		Zr(["l", "r"], function(i) {
			var f = a + i, d = r[f], c;
			if (d !== e) {
				var h = /* @__PURE__ */ Xr(d);
				c = i === "l" ? t - ym(h) : o - bn(h), c && (r[f] = /* @__PURE__ */ dn(d, function(l) {
					return l + c;
				}));
			}
		});
...
function tn(r, e) {
	return dn(r.ul, function(n, t) {
		if (e) return r[e.toLowerCase()][t];
		var o = /* @__PURE__ */ np(/* @__PURE__ */ Jr(r, t));
		return (o[1] + o[2]) / 2;
	});
}
m$1(tn, "balance");
function he(r) {
	...
	Zr(["u", "d"], function(i) {
		o = i === "u" ? e : Xr(e).reverse(), Zr(["l", "r"], function(f) {
			f === "r" && (o = /* @__PURE__ */ Jr(o, function(l) {
				return Xr(l).reverse();
			}));
			var c = /* @__PURE__ */ Ze(r, o, n, /* @__PURE__ */ (i === "u" ? r.predecessors : r.successors).bind(r)), h = /* @__PURE__ */ $e(r, o, c.root, c.align, f === "r");
			f === "r" && (h = /* @__PURE__ */ dn(h, function(l) {
				return -l;
			})), t[i + f] = h;
		});
	});
	return nn(t, /* @__PURE__ */ en(r, t)), tn(t, r.graph().align);
}
m$1(he, "positionX");
function on(r, e, n) {
...
m$1(an, "width");
function le(r) {
	r = /* @__PURE__ */ X(r), sn$1(r), Ji(/* @__PURE__ */ he(r), function(e, n) {
		r.node(n).x = e;
	});
}
m$1(le, "position");
function sn$1(r) {
	...
	Zr(e, function(o) {
		var a = /* @__PURE__ */ bn(/* @__PURE__ */ Jr(o, function(i) {
...
function bn$1(r) {
	...
	return e.setGraph(/* @__PURE__ */ qs({}, hn, /* @__PURE__ */ lr(n, cn), /* @__PURE__ */ Tn(n, ln))), Zr(/* @__PURE__ */ r.nodes(), function(t) {
		var o = /* @__PURE__ */ pr(/* @__PURE__ */ r.node(t));
		e.setNode(t, /* @__PURE__ */ Nf(/* @__PURE__ */ lr(o, pn), mn)), e.setParent(t, /* @__PURE__ */ r.parent(t));
	}), Zr(/* @__PURE__ */ r.edges(), function(t) {
		var o = /* @__PURE__ */ pr(/* @__PURE__ */ r.edge(t));
		e.setEdge(t, /* @__PURE__ */ qs({}, _n, /* @__PURE__ */ lr(o, vn), /* @__PURE__ */ Tn(o, wn)));
	}), e;
}
m$1(bn$1, "buildLayoutGraph");
function En(r) {
	var e = /* @__PURE__ */ r.graph();
	e.ranksep /= 2, Zr(/* @__PURE__ */ r.edges(), function(n) {
...
function xn(r) {
	...
	Zr(/* @__PURE__ */ r.nodes(), function(n) {
		var t = /* @__PURE__ */ r.node(n);
		t.borderTop && (t.minRank = r.node(t.borderTop).rank, t.maxRank = r.node(t.borderBottom).rank, e = /* @__PURE__ */ bn(e, t.maxRank));
	}), r.graph().maxRank = e;
}
...
function gn(r) {
	...
	function d(c) {
		var h = c.x, l = c.y, p = c.width, m$2 = c.height;
		e = /* @__PURE__ */ Math.min(e, h - p / 2), n = /* @__PURE__ */ Math.max(n, h + p / 2), t = /* @__PURE__ */ Math.min(t, l - m$2 / 2), o = /* @__PURE__ */ Math.max(o, l + m$2 / 2);
	}
	m$1(d, "getExtremes"), Zr(/* @__PURE__ */ r.nodes(), function(c) {
		d(/* @__PURE__ */ r.node(c));
	}), Zr(/* @__PURE__ */ r.edges(), function(c) {
		var h = /* @__PURE__ */ r.edge(c);
		Object.prototype.hasOwnProperty.call(h, "x") && d(h);
	}), e -= i, t -= f, Zr(/* @__PURE__ */ r.nodes(), function(c) {
		var h = /* @__PURE__ */ r.node(c);
		h.x -= e, h.y -= t;
	}), Zr(/* @__PURE__ */ r.edges(), function(c) {
		var h = /* @__PURE__ */ r.edge(c);
		Zr(h.points, function(l) {
			l.x -= e, l.y -= t;
...
m$1(In, "reversePointsForReversedEdges");
function Pn(r) {
	Zr(/* @__PURE__ */ r.nodes(), function(e) {
...
m$1(Ln, "removeSelfEdges");
function Cn(r) {
	Zr(/* @__PURE__ */ C(r), function(n) {
		var t = 0;
		Zr(n, function(o, a) {
			var i = /* @__PURE__ */ r.node(o);
			i.order = a + t, Zr(i.selfEdges, function(f) {
				g(r, "selfedge", {
					width: f.label.width,
...
m$1(jn, "positionSelfEdges");
function lr(r, e) {
	return dn(/* @__PURE__ */ Tn(r, e), Number);
}
m$1(lr, "selectNumberAttrs");
function pr(r) {
	var e = {};
	return Zr(r, function(n, t) {
		e[t.toLowerCase()] = n;
	}), e;
}
m$1(pr, "canonicalize");
