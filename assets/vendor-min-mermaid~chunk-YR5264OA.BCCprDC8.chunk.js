...
import { M as Mt, t as tt, H as Hg, U as Ug, m as mu, p as pu, l as $g, W as Wg, q as au, g as bo, N as Ng, r as Pg, u as qg, o as Ig, v as Rg, w as zg, x as Og, n as Dg, E as Eg, y as tu, A as Qc, d as Zc, B as ml, C as Ai, F as Yx, e as XC, k as kh } from './vendor-min-mermaid~chunk-U6SPV2NK.BkMACcv9.chunk.js';
...
var ce = "\u200B", ue = {
    ...
    curveBumpY: Dg,
    curveBundle: Og,
    curveCardinalClosed: zg,
    curveCardinalOpen: Rg,
    curveCardinal: Ig,
    curveCatmullRomClosed: qg,
    curveCatmullRomOpen: Pg,
    curveCatmullRom: Ng,
    curveLinear: bo,
    ...
    if (Array.isArray(r)) {
        ...
        Ai(s), n = /*#__PURE__*/ Mt(n, [
            ...s
        ]);
    } else n = r.args;
    if (!n) return;
    let i = /*#__PURE__*/ Yx(t, e), o = "config";
    return n[o] !== void 0 && (i === "flowchart-v2" && (i = "flowchart"), n[i] = n[o], delete n[o]), n;
}, "detectInit"), re = /*#__PURE__*/ m$1(function(t, e = null) {
    try {
...
`, "ig");
        ...
        let n, i = [];
        for(; (n = /*#__PURE__*/ ml.exec(t)) !== null;)if (n.index === ml.lastIndex && ml.lastIndex++, n && !e || e && n[1]?.match(e) || e && n[2]?.match(e)) {
...
var we = /*#__PURE__*/ m$1((t)=>Me(t.length), "random"), Pe = /*#__PURE__*/ m$1(function() {
    ...
    let r = /*#__PURE__*/ e.text.replace(XC.lineBreakRegex, " "), [, n] = S(e.fontSize), i = /*#__PURE__*/ t.append("text");
    ...
    if (!t || (r = /*#__PURE__*/ Object.assign({
        ...
        fontFamily: "Arial",
        joinWith: "<br/>"
    }, r), XC.lineBreakRegex.test(t))) return t;
...
}, (t, e, r)=>`${t}${e}${r.fontSize}${r.fontWeight}${r.fontFamily}${r.joinWith}`), Se = /*#__PURE__*/ ki((t, e, r = "-", n)=>{
...
var $ = /*#__PURE__*/ ki((t, e)=>{
    ...
    let [, o] = S(r), s = [
        "sans-serif",
        n
    ], u = /*#__PURE__*/ t.split(XC.lineBreakRegex), c = [], l = /*#__PURE__*/ kh("body");
    if (!l.remove) return {
        width: 0,
        height: 0,
        lineHeight: 0
...
var Ye = /*#__PURE__*/ m$1((t, e, { counter: r = 0, prefix: n, suffix: i }, o)=>o || `${n ? `${n}_` : ""}${t}_${e}_${r}${i ? `_${i}` : ""}`, "getEdgeId");
function Je(t) {
    return t ?? null;
}
