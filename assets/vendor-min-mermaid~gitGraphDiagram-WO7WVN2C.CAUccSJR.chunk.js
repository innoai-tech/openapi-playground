...
import { I as Ie$1, L as Le$1, w as we$1 } from "./vendor-min-mermaid~chunk-YM3XIQPS.TrSm0jHB.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Q7R0ayzM.chunk.js";
import { L as Lf, M as Mf, B as Bf, F as Ff, w as wf, v as vf, t as tt$1, H as Hl, i as ih, ak as Of, S as Sf, g as gC, E as Er, p as pl } from "./vendor-min-mermaid~chunk-ZKYS2E5M.BgSjvTzJ.chunk.js";
var u = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
var he = pl.gitGraph, D = /* @__PURE__ */ m$1(() => Le$1({
  ...he,
  ...Er().gitGraph
}), "getConfig"), i = new s(() => {
...
var fe = /* @__PURE__ */ m$1(function(r) {
  ...
  let n = /* @__PURE__ */ D();
  o = /* @__PURE__ */ gC.sanitizeText(o, n), e = /* @__PURE__ */ gC.sanitizeText(e, n), t = t == null ? void 0 : t.map((s2) => gC.sanitizeText(s2, n));
  let m = {
  ...
  if (e = /* @__PURE__ */ gC.sanitizeText(e, /* @__PURE__ */ D()), i.records.branches.has(e)) throw new Error(`Trying to create an existing branch. (Help: Either use a new name if you want create a new branch or try using "checkout ${e}")`);
  ...
  e = /* @__PURE__ */ gC.sanitizeText(e, n), o && (o = /* @__PURE__ */ gC.sanitizeText(o, n));
  ...
  let n = /* @__PURE__ */ D();
  if (e = /* @__PURE__ */ gC.sanitizeText(e, n), o = /* @__PURE__ */ gC.sanitizeText(o, n), a = a == null ? void 0 : a.map((g) => gC.sanitizeText(g, n)), t = /* @__PURE__ */ gC.sanitizeText(t, n), !e || !i.records.commits.has(e)) {
  ...
  if (r = /* @__PURE__ */ gC.sanitizeText(r, /* @__PURE__ */ D()), i.records.branches.has(r)) {
...
var Ie = /* @__PURE__ */ Hl(), w = Ie == null ? void 0 : Ie.gitGraph, P = 10, M = 40, k = 4, T = 2, G = 8, b = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), R = 30, L = /* @__PURE__ */ new Map(), A = [], E = 0, y = "LR", qe = /* @__PURE__ */ m$1(() => {
...
`, "id:", e, o), !w) throw new Error("GitGraph config not found");
  ...
  }), ie(s2, L, false), w.showBranches && Qe(s2, m), Xe(s2, L), ie(s2, L, true), Ie$1.insertTitle(s2, "gitTitleText", w.titleTopMargin ?? 0, /* @__PURE__ */ n.getDiagramTitle()), Of(void 0, s2, w.diagramPadding, w.useMaxWidth);
}, "draw"), de = {
  draw: tt
};
