const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-min-mermaid~katex-SWYD7GD6.Cs22TRdI.chunk.js","assets/vendor-min-mermaid~chunk-GTKDMUJJ.ByXaayWf.chunk.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './lib-nodepkg-typedef.BfNI1ZyL.chunk.js';
import { m as m$1, q, n, o } from './vendor-min-mermaid~chunk-GTKDMUJJ.ByXaayWf.chunk.js';
var Ya = n((qo, Po)=>{
    (function(t, e) {
        typeof qo == "object" && typeof Po < "u" ? Po.exports = e() : typeof define == "function" && define.amd ? define(e) : (t = typeof globalThis < "u" ? globalThis : t || self).dayjs = e();
    })(qo, function() {
        ...
        var it = function() {
            ...
            return x.parse = function(y) {
                ...
                var S, z = $.p(y), I = "set" + (this.$u ? "UTC" : ""), U = (S = {}, S[l] = I + "Date", S[f] = I + "Date", S[h] = I + "Month", S[p] = I + "FullYear", S[a] = I + "Hours", S[s] = I + "Minutes", S[n] = I + "Seconds", S[o] = I + "Milliseconds", S)[z], rt = z === l ? this.$D + (L - this.$W) : L;
                if (z === h || z === p) {
...
}, "setLogLevel"), Pt = m$1((t)=>`%c${(0, Ga.default)().format("ss.SSS")} : ${t} : `, "format");
...
var Ti = {}, dx = m$1(function(t, e) {
    t = t.replace(Xa, "").replace(ja, "").replace(Za, `
`);
...
var $o = m$1(function(t, e) {
    ...
    return Array.isArray(e) && !Array.isArray(t) ? (e.forEach((s)=>$o(t, s, n)), t) : Array.isArray(e) && Array.isArray(t) ? (e.forEach((s)=>{
        ...
        typeof e[s] == "object" && (t[s] === void 0 || typeof t[s] == "object") ? (t[s] === void 0 && (t[s] = Array.isArray(e[s]) ? [] : {}), t[s] = $o(t[s], e[s], {
            depth: r - 1,
            clobber: o
...
var ki = {
    ...
    clamp: {
        r: m$1((t)=>t >= 255 ? 255 : t < 0 ? 0 : t, "r"),
        g: m$1((t)=>t >= 255 ? 255 : t < 0 ? 0 : t, "g"),
        b: m$1((t)=>t >= 255 ? 255 : t < 0 ? 0 : t, "b"),
        h: m$1((t)=>t % 360, "h"),
        s: m$1((t)=>t >= 100 ? 100 : t < 0 ? 0 : t, "s"),
        l: m$1((t)=>t >= 100 ? 100 : t < 0 ? 0 : t, "l"),
        a: m$1((t)=>t >= 1 ? 1 : t < 0 ? 0 : t, "a")
    },
    toLinear: m$1((t)=>{
        let e = t / 255;
        return t > .03928 ? Math.pow((e + .055) / 1.055, 2.4) : e / 12.92;
    }, "toLinear"),
    hue2rgb: m$1((t, e, r)=>(r < 0 && (r += 1), r > 1 && (r -= 1), r < .16666666666666666 ? t + (e - t) * 6 * r : r < .5 ? e : r < .6666666666666666 ? t + (e - t) * (.6666666666666666 - r) * 6 : t), "hue2rgb"),
    hsl2rgb: m$1((param, o)=>{
    ...
    rgb2hsl: m$1((param, o)=>{
        ...
        t /= 255, e /= 255, r /= 255;
        let n = Math.max(t, e, r), s = Math.min(t, e, r), a = (n + s) / 2;
        if (o === "l") return a * 100;
        if (n === s) return 0;
...
var gu = {
    clamp: m$1((t, e, r)=>e > r ? Math.min(e, Math.max(r, t)) : Math.min(r, Math.max(e, t)), "clamp"),
    round: m$1((t)=>Math.round(t * 1e10) / 1e10, "round")
}, Qa = gu;
var xu = {
    dec2hex: m$1((t)=>{
...
var se = {};
for(let t = 0; t <= 255; t++)se[t] = R.unit.dec2hex(t);
var ut = {
    ALL: 0,
    RGB: 1,
    HSL: 2
...
var Uo = class {
    ...
    _ensureHSL() {
        ...
        r === void 0 && (e.h = R.channel.rgb2hsl(e, "h")), o === void 0 && (e.s = R.channel.rgb2hsl(e, "s")), n === void 0 && (e.l = R.channel.rgb2hsl(e, "l"));
    }
    _ensureRGB() {
        let e = this.data, { r, g: o, b: n } = e;
        r === void 0 && (e.r = R.channel.hsl2rgb(e, "r")), o === void 0 && (e.g = R.channel.hsl2rgb(e, "g")), n === void 0 && (e.b = R.channel.hsl2rgb(e, "b"));
    }
    get r() {
...
var rl = {
    ...
    parse: m$1((t)=>{
        ...
        let e = t.match(rl.re);
        if (!e) return;
        let r = e[1], o = parseInt(r, 16), n = r.length, s = n % 4 === 0, a = n > 4, l = a ? 1 : 17, c = a ? 8 : 4, h = s ? 0 : -1, u = a ? 255 : 15;
        return pe.set({
            r: (o >> c * (h + 3) & u) * l,
            g: (o >> c * (h + 2) & u) * l,
            b: (o >> c * (h + 1) & u) * l,
...
var Si = {
    ...
    _hue2deg: m$1((t)=>{
        ...
        return R.channel.clamp.h(parseFloat(t));
    }, "_hue2deg"),
    parse: m$1((t)=>{
        ...
        return pe.set({
            h: Si._hue2deg(o),
            s: R.channel.clamp.s(parseFloat(n)),
...
var il = {
    ...
    parse: m$1((t)=>{
        ...
        return pe.set({
            r: R.channel.clamp.r(n ? parseFloat(o) * 2.55 : parseFloat(o)),
...
var _u = {
    ...
    stringify: m$1((t)=>!t.changed && t.color ? t.color : t.type.is(ut.HSL) || t.data.r === void 0 ? Fr.stringify(t) : t.a < 1 || !Number.isInteger(t.r) || !Number.isInteger(t.g) || !Number.isInteger(t.b) ? Mr.stringify(t) : Ae.stringify(t), "stringify")
}, ft = _u;
var bu = m$1((t, e)=>{
    let r = ft.parse(t);
    for(let o in e)r[o] = R.channel.clamp[o](e[o]);
    return ft.stringify(r);
}, "change"), wi = bu;
var Tu = m$1(function(t, e) {
    ...
    let n = pe.set({
        r: R.channel.clamp.r(t),
        g: R.channel.clamp.g(e),
        b: R.channel.clamp.b(r),
        a: R.channel.clamp.a(o)
    });
    return ft.stringify(n);
}, "rgba"), ae = Tu;
var ku = m$1((t, e)=>R.lang.round(ft.parse(t)[e]), "channel"), Su = ku;
var vu = m$1((t)=>{
...
var wu = m$1((t)=>ol(t) >= .5, "isLight"), nl = wu;
var Bu = m$1((t)=>!nl(t), "isDark"), $t = Bu;
var Fu = m$1((t, e, r)=>{
    let o = ft.parse(t), n = o[e], s = R.channel.clamp[e](n + r);
    return n !== s && (o[e] = s), ft.stringify(o);
}, "adjustChannel"), Bi = Fu;
var Mu = m$1((t, e)=>Bi(t, "l", e), "lighten"), F = Mu;
var Lu = m$1((t, e)=>Bi(t, "l", -e), "darken"), E = Lu;
var Au = m$1((t, e)=>{
    let r = ft.parse(t), o = {};
    for(let n in e)e[n] && (o[n] = r[n] + e[n]);
    return wi(t, o);
}, "adjust"), m = Au;
var Eu = m$1(function(t, e) {
...
var Fi = m$1((t)=>{
    if (tt.debug("sanitizeDirective called with", t), !(typeof t != "object" || t == null)) {
        ...
        for (let e of Object.keys(t)){
            ...
            for (let o of r)e.includes(o) && (tt.debug("sanitizing css option", e), t[e] = Du(t[e]));
        }
...
var Ar = Object.freeze(pl), Rt = Lt({}, Ar), xl, tr = [], Lr = Lt({}, Ar), Mi = m$1((t, e)=>{
    let r = Lt({}, t), o = {};
    for (let n of e)Cl(n), o = Lt(o, n);
    if (r = Lt(r, o), o.theme && o.theme in ye) {
        let n = Lt({}, xl), s = Lt(n.themeVariables || {}, o.themeVariables);
        r.theme && r.theme in ye && (r.themeVariables = ye[r.theme].getThemeVariables(s));
    }
    return Lr = r, _l(Lr), Lr;
}, "updateCurrentConfig"), Iu = m$1((t)=>(Rt = Lt({}, Ar), Rt = Lt(Rt, t), t.theme && ye[t.theme] && (Rt.themeVariables = ye[t.theme].getThemeVariables(t.themeVariables)), Mi(Rt, tr), Rt), "setSiteConfig"), oC = m$1((t)=>{
    xl = Lt({}, t);
}, "saveConfigFromInitialize"), nC = m$1((t)=>(Rt = Lt(Rt, t), Mi(Rt, tr), Rt), "updateSiteConfig"), sC = m$1(()=>Lt({}, Rt), "getSiteConfig"), yl = m$1((t)=>(_l(t), Lt(Lr, t), Er()), "setConfig"), Er = m$1(()=>Lt({}, Lr), "getConfig"), Cl = m$1((t)=>{
    t && ([
        "secure",
        ...Rt.secure ?? []
    ].forEach((e)=>{
...
function Ee(t) {
    let e = Al(null);
    for (let [r, o] of Ll(t))Ht(t, r) && (Array.isArray(o) ? e[r] = Gu(o) : o && typeof o == "object" && o.constructor === Object ? e[r] = Ee(o) : e[r] = o);
    return e;
}
m$1(Ee, "clone");
function zr(t, e) {
...
function Dl() {
    ...
    let { MUSTACHE_EXPR: k, ERB_EXPR: x, TMPLIT_EXPR: y, DATA_ATTR: L, ARIA_ATTR: S, IS_SCRIPT_OR_DATA: z, ATTR_WHITESPACE: I, CUSTOM_ELEMENT: U } = Fl, { IS_ALLOWED_URI: rt } = Fl, Y = null, nt = K({}, [
        ...
        if (!(Je && Je === d)) {
            ...
            } else M === void 0 && (M = nf(g, n)), M !== null && typeof P == "string" && (P = M.createHTML(""));
            Et && Et(d), Je = d;
        }
    }, "_parseConfig"), Da = K({}, [
        ...Qo,
    ...
    }, "_forceRemove"), _i = m$1(function(d, _) {
        try {
            Or(e.removed, {
            ...
            if (Oo && !Ke[D]) {
                ...
                if (Bt && at) {
                    ...
                    for(let zt = kt - 1; zt >= 0; --zt){
                        let Zt = A(Bt[zt], true);
                        Zt.__removalCount = (d.__removalCount || 0) + 1, at.insertBefore(Zt, q(d));
                    }
                }
            }
            return jt(d), true;
    ...
    return e.sanitize = function(N) {
        ...
        if (It) {
            ...
            return (Q.shadowroot || Q.shadowrootmode) && (Bt = it.call(o, Bt, true)), Bt;
        }
...
var er = Dl();
var Nr = /<br\s*\/?>/gi, sf = m$1((t)=>t ? ql(t).replace(/\\n/g, "#br#").split("#br#") : [
        ""
    ], "getRows"), af = (()=>{
    let t = false;
    return ()=>{
...
var Nl = m$1((t)=>(af(), er.sanitize(t)), "removeScript"), Il = m$1((t, e)=>{
    if (e.flowchart?.htmlLabels !== false) {
        let r = e.securityLevel;
        r === "antiscript" || r === "strict" ? t = Nl(t) : r !== "loose" && (t = ql(t), t = t.replace(/</g, "&lt;").replace(/>/g, "&gt;"), t = t.replace(/=/g, "&equals;"), t = ff(t));
    }
    return t;
}, "sanitizeMore"), Oe = m$1((t, e)=>t && (e.dompurifyConfig ? t = er.sanitize(Il(t, e), e.dompurifyConfig).toString() : t = er.sanitize(Il(t, e), {
        FORBID_TAGS: [
            "style"
        ]
    }).toString(), t), "sanitizeText"), hf = m$1((t, e)=>typeof t == "string" ? Oe(t, e) : t.flat().map((r)=>Oe(r, e)), "sanitizeTextOrArray"), cf = m$1((t)=>Nr.test(t), "hasBreaks"), uf = m$1((t)=>t.split(Nr), "splitBreaks"), ff = m$1((t)=>t.replace(/#br#/g, "<br/>"), "placeholderToBreak"), ql = m$1((t)=>t.replace(Nr, "#br#"), "breakToPlaceholder"), df = m$1((t)=>{
    let e = "";
    return t && (e = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, e = e.replaceAll(/\(/g, "\\("), e = e.replaceAll(/\)/g, "\\)")), e;
}, "getUrl"), mf = m$1((t)=>!(t === false || [
        "false",
        "null",
        "0"
    ].includes(String(t).trim().toLowerCase())), "evaluate"), pf = m$1(function() {
    for(var _len = arguments.length, t = new Array(_len), _key = 0; _key < _len; _key++){
        t[_key] = arguments[_key];
    }
    ...
    return r.join("");
}, "parseGenericTypes"), nn = m$1((t, e)=>Math.max(0, t.split(e).length - 1), "countOccurrence"), xf = m$1((t, e)=>{
    let r = nn(t, "~"), o = nn(e, "~");
    return r === 1 && o === 1;
}, "shouldCombineSets"), yf = m$1((t)=>{
    let e = nn(t, "~"), r = false;
    if (e <= 1) return t;
    e % 2 !== 0 && t.startsWith("~") && (t = t.substring(1), r = true);
    let o = [
        ...t
    ], n = o.indexOf("~"), s = o.lastIndexOf("~");
    for(; n !== -1 && s !== -1 && n !== s;)o[n] = "<", o[s] = ">", n = o.indexOf("~"), s = o.lastIndexOf("~");
    return r && o.unshift("~"), o.join("");
}, "processSet"), zl = m$1(()=>window.MathMLElement !== void 0, "isMathMLSupported"), sn = /\$\$(.*)\$\$/g, Rl = m$1((t)=>(t.match(sn)?.length ?? 0) > 0, "hasKatex"), pC = m$1(async (t, e)=>{
    t = await Cf(t, e);
    ...
    return r.remove(), n;
}, "calculateMathMLDimensions"), Cf = m$1(async (t, e)=>{
    if (!Rl(t)) return t;
    ...
    let { default: r } = await __vitePreload(async ()=>{
        const { default: r } = await import('./vendor-min-mermaid~katex-SWYD7GD6.Cs22TRdI.chunk.js');
        return {
            default: r
        };
...
var _f = m$1(function(t, e) {
    for (let r of e)t.attr(r[0], r[1]);
}, "d3Attrs"), bf = m$1(function(t, e, r) {
    let o = new Map;
    return r ? (o.set("width", "100%"), o.set("style", `max-width: ${e}px;`)) : (o.set("height", t), o.set("width", e)), o;
}, "calculateSvgSizeAttrs"), Tf = m$1(function(t, e, r, o) {
    let n = bf(e, r, o);
    _f(t, n);
}, "configureSvgSize"), Pl = m$1(function(t, e, r, o) {
    let n = e.node().getBBox(), s = n.width, a = n.height;
...
var Oi = {}, kf = m$1((t, e, r)=>{
    let o = "";
    return t in Oi && Oi[t] ? o = Oi[t](r) : tt.warn(`No theme found for ${t}`), ` & {
...
var an = "", ln = "", hn = "", cn = m$1((t)=>Oe(t, Er()), "sanitizeText"), Sf = m$1(()=>{
    an = "", hn = "", ln = "";
}, "clear"), vf = m$1((t)=>{
    an = cn(t).replace(/^\s+/g, "");
}, "setAccTitle"), wf = m$1(()=>an, "getAccTitle"), Bf = m$1((t)=>{
    hn = cn(t).replace(/\n\s+/g, `
`);
}, "setAccDescription"), Ff = m$1(()=>hn, "getAccDescription"), Mf = m$1((t)=>{
    ln = cn(t);
}, "setDiagramTitle"), Lf = m$1(()=>ln, "getDiagramTitle");
var $l = tt, Af = Va, Hl = Er, IC = yl, zC = Ar;
var Ef = m$1((t)=>Oe(t, Hl()), "sanitizeText"), Of = Pl, Df = m$1(()=>un, "getCommonDb"), Di = {}, RC = m$1((t, e, r)=>{
...
function Ie(t) {
    let e, r, o;
    t.length !== 2 ? (e = De, r = m$1((l, c)=>De(t(l), c), "compare2"), o = m$1((l, c)=>t(l) - c, "delta")) : (e = t === De || t === dn ? t : If, r = t, o = t);
    function n(l, c) {
...
function Ii(t, e, r) {
    let o = (e - t) / Math.max(0, r), n = Math.floor(Math.log10(o)), s = o / Math.pow(10, n), a = s >= Wf ? 10 : s >= $f ? 5 : s >= Hf ? 2 : 1, l, c, h;
    return n < 0 ? (h = Math.pow(10, -n) / a, l = Math.round(t * h), c = Math.round(e * h), l / h < t && ++l, c / h > e && --c, h = -h) : (h = Math.pow(10, n) * a, l = Math.round(t / h), c = Math.round(e / h), l * h < t && ++l, c * h > e && --c), c < l && .5 <= r && r < 2 ? Ii(t, e, r * 2) : [
        l,
        c,
        h
    ];
...
function Ri(t, e, r) {
    ...
    for(var o = -1, n = Math.max(0, Math.ceil((e - t) / r)) | 0, s = new Array(n); ++o < n;)s[o] = t + o * r;
    return s;
}
m$1(Ri, "range");
function gn(t) {
...
function Zl(t, e) {
    ...
    function f(g) {
        var T = o ?? (e.ticks ? e.ticks.apply(e, r) : e.domain()), A = n ?? (e.tickFormat ? e.tickFormat.apply(e, r) : gn), W = Math.max(s, 0) + l, q = e.range(), G = +q[0] + c, O = +q[q.length - 1] + c, M = (e.bandwidth ? Vf : Gf)(e.copy(), c), P = g.selection ? g.selection() : g, w = P.selectAll(".domain").data([
            null
        ]), X = P.selectAll(".tick").data(T, e).order(), j = X.exit(), $ = X.enter().append("g").attr("class", "tick"), it = X.select("line"), B = X.select("text");
        w = w.merge(w.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), X = X.merge($), it = it.merge($.append("line").attr("stroke", "currentColor").attr(u + "2", h * s)), B = B.merge($.append("text").attr("fill", "currentColor").attr(u, h * W).attr("dy", t === qi ? "0em" : t === yn ? "0.71em" : "0.32em")), g !== P && (w = w.transition(g), X = X.transition(g), it = it.transition(g), B = B.transition(g), j = j.transition(g).attr("opacity", jl).attr("transform", function(k) {
...
function Cn(t) {
    ...
    for(var e = this._groups, r = e.length, o = new Array(r), n = 0; n < r; ++n)for(var s = e[n], a = s.length, l = o[n] = new Array(a), c, h, u = 0; u < a; ++u)(c = s[u]) && (h = t.call(c, c.__data__, u, s)) && ("__data__" in c && (h.__data__ = c.__data__), l[u] = h);
...
m$1(Jf, "arrayAll");
function bn(t) {
    typeof t == "function" ? t = Jf(t) : t = or(t);
    for(var e = this._groups, r = e.length, o = [], n = [], s = 0; s < r; ++s)for(var a = e[s], l = a.length, c, h = 0; h < l; ++h)(c = a[h]) && (o.push(t.call(c, c.__data__, h, a)), n.push(c));
    return new ht(o, n);
}
m$1(bn, "default");
function nr(t) {
...
Wr.prototype = {
    constructor: Wr,
    appendChild: m$1(function(t) {
        return this._parent.insertBefore(t, this._next);
    }, "appendChild"),
    insertBefore: m$1(function(t, e) {
        return this._parent.insertBefore(t, e);
    }, "insertBefore"),
    querySelector: m$1(function(t) {
        return this._parent.querySelector(t);
    }, "querySelector"),
    querySelectorAll: m$1(function(t) {
...
function ad(t, e, r, o, n, s, a) {
    ...
    for(l = 0; l < p; ++l)g = a.call(t, s[l], l, s) + "", (c = h.get(g)) ? (o[l] = c, c.__data__ = s[l], h.delete(g)) : r[l] = new Wr(t, s[l]);
...
function Bn(t, e) {
    ...
    for(var s = n.length, a = new Array(s), l = new Array(s), c = new Array(s), h = 0; h < s; ++h){
        var u = o[h], p = n[h], f = p.length, g = hd(t.call(u, u && u.__data__, h, o)), T = g.length, A = l[h] = new Array(T), W = a[h] = new Array(T), q = c[h] = new Array(f);
        r(u, p, A, W, q, g, e);
...
m$1(Fn, "default");
function Mn(t, e, r) {
    var o = this.enter(), n = this, s = this.exit();
    return typeof t == "function" ? (o = t(o), o && (o = o.selection())) : o = o.append(t + ""), e != null && (n = e(n), n && (n = n.selection())), r == null ? s.remove() : r(s), o && n ? o.merge(n).order() : n;
}
m$1(Mn, "default");
function Ln(t) {
    for(var e = t.selection ? t.selection() : t, r = this._groups, o = e._groups, n = r.length, s = o.length, a = Math.min(n, s), l = new Array(n), c = 0; c < a; ++c)for(var h = r[c], u = o[c], p = h.length, f = l[c] = new Array(p), g, T = 0; T < p; ++T)(g = h[T] || u[T]) && (f[T] = g);
    for(; c < n; ++c)l[c] = r[c];
...
function Qt(t) {
    var e = t += "", r = e.indexOf(":");
    return r >= 0 && (e = t.slice(0, r)) !== "xmlns" && (t = t.slice(r + 1)), qn.hasOwnProperty(e) ? {
        space: qn[e],
        local: t
    } : t;
}
...
function Wn(t, e, r) {
    return arguments.length > 1 ? this.each((e == null ? xd : typeof e == "function" ? Cd : yd)(t, e, r ?? "")) : _e(this.node(), t);
}
m$1(Wn, "default");
function _e(t, e) {
...
function $n(t, e) {
    return arguments.length > 1 ? this.each((e == null ? _d : typeof e == "function" ? Td : bd)(t, e)) : this.node()[t];
}
m$1($n, "default");
function Kl(t) {
...
m$1(Hn, "classList");
function Ql(t) {
    this._node = t, this._names = Kl(t.getAttribute("class") || "");
}
m$1(Ql, "ClassList");
Ql.prototype = {
    add: m$1(function(t) {
    ...
    remove: m$1(function(t) {
        var e = this._names.indexOf(t);
        e >= 0 && (this._names.splice(e, 1), this._node.setAttribute("class", this._names.join(" ")));
    }, "remove"),
    contains: m$1(function(t) {
        return this._names.indexOf(t) >= 0;
    }, "contains")
};
function Jl(t, e) {
    for(var r = Hn(t), o = -1, n = e.length; ++o < n;)r.add(e[o]);
}
m$1(Jl, "classedAdd");
function th(t, e) {
    for(var r = Hn(t), o = -1, n = e.length; ++o < n;)r.remove(e[o]);
}
...
function Un(t, e) {
    var r = Kl(t + "");
    if (arguments.length < 2) {
        for(var o = Hn(this.node()), n = -1, s = r.length; ++n < s;)if (!o.contains(r[n])) return false;
        return true;
    }
...
function ts(t, e, r) {
    ...
    for(l = e ? Hd : $d, n = 0; n < s; ++n)this.each(l(o[n], e, r));
    return this;
}
m$1(ts, "default");
function eh(t, e, r) {
    var o = $r(t), n = o.CustomEvent;
    typeof n == "function" ? n = new n(e, r) : (n = o.document.createEvent("Event"), r ? (n.initEvent(e, r.bubbles, r.cancelable), n.detail = r.detail) : n.initEvent(e, false, false)), t.dispatchEvent(n);
}
...
function Yd(t, e) {
    return function() {
        return eh(this, t, e.apply(this, arguments));
    };
}
m$1(Yd, "dispatchFunction");
function es(t, e) {
    return this.each((typeof e == "function" ? Yd : Ud)(t, e));
}
m$1(es, "default");
function* rs() {
...
function Yt(t) {
    var e, r;
    return t = (t + "").trim().toLowerCase(), (e = Vd.exec(t)) ? (r = e[1].length, e = parseInt(e[1], 16), r === 6 ? ah(e) : r === 3 ? new St(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : r === 8 ? $i(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : r === 4 ? $i(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = Xd.exec(t)) ? new St(e[1], e[2], e[3], 1) : (e = jd.exec(t)) ? new St(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = Zd.exec(t)) ? $i(e[1], e[2], e[3], e[4]) : (e = Kd.exec(t)) ? $i(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = Qd.exec(t)) ? ch(e[1], e[2] / 100, e[3] / 100, 1) : (e = Jd.exec(t)) ? ch(e[1], e[2] / 100, e[3] / 100, e[4]) : oh.hasOwnProperty(t) ? ah(oh[t]) : t === "transparent" ? new St(NaN, NaN, NaN, 0) : null;
}
m$1(Yt, "color");
function ah(t) {
...
m$1($i, "rgba");
function ns(t) {
    return t instanceof Te || (t = Yt(t)), t ? (t = t.rgb(), new St(t.r, t.g, t.b, t.opacity)) : new St;
}
m$1(ns, "rgbConvert");
function lr(t, e, r, o) {
...
function fh(t) {
    ...
    if (t instanceof Te || (t = Yt(t)), !t) return new Ut;
    if (t instanceof Ut) return t;
    t = t.rgb();
    var e = t.r / 255, r = t.g / 255, o = t.b / 255, n = Math.min(e, r, o), s = Math.max(e, r, o), a = NaN, l = s - n, c = (s + n) / 2;
...
function bh(t) {
    ...
    t instanceof St || (t = ns(t));
    var e = hs(t.r), r = hs(t.g), o = hs(t.b), n = ss((.2225045 * e + .7168786 * r + .0606169 * o) / xh), s, a;
    return e === r && r === o ? s = a = n : (s = ss((.4360747 * e + .3850649 * r + .1430804 * o) / gh), a = ss((.0139322 * e + .0971045 * r + .7141733 * o) / yh)), new te(116 * n - 16, 500 * (s - n), 200 * (n - a), t.opacity);
}
m$1(bh, "labConvert");
function cs(t, e, r, o) {
...
function om(t) {
    ...
    if (t instanceof te || (t = bh(t)), t.a === 0 && t.b === 0) return new he(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
...
function wh(t) {
    return function(e, r) {
        var o = t((e = Gr(e)).h, (r = Gr(r)).h), n = ce(e.c, r.c), s = ce(e.l, r.l), a = ce(e.opacity, r.opacity);
        return function(l) {
            return e.h = o(l), e.c = n(l), e.l = s(l), e.opacity = a(l), e + "";
        };
    };
}
m$1(wh, "hcl");
...
function ds(t) {
    var e = t.length;
    return function(r) {
        var o = Math.floor(((r %= 1) < 0 ? ++r : r) * e), n = t[(o + e - 1) % e], s = t[o % e], a = t[(o + 1) % e], l = t[(o + 2) % e];
...
var Ne = m$1(function t(e) {
    var r = vh(e);
    function o(n, s) {
        var a = r((n = lr(n)).r, (s = lr(s)).r), l = r(n.g, s.g), c = r(n.b, s.b), h = ce(n.opacity, s.opacity);
        return function(u) {
            return n.r = a(u), n.g = l(u), n.b = c(u), n.opacity = h(u), n + "";
        };
    }
...
function Bh(t) {
    return function(e) {
        ...
        for(a = 0; a < r; ++a)l = lr(e[a]), o[a] = l.r || 0, n[a] = l.g || 0, s[a] = l.b || 0;
        return o = t(o), n = t(n), s = t(s), l.opacity = 1, function(c) {
            return l.r = o(c), l.g = n(c), l.b = s(c), l + "";
        };
    };
}
m$1(Bh, "rgbSpline");
...
function Mh(t, e) {
    ...
    for(a = 0; a < o; ++a)n[a] = ke(t[a], e[a]);
    for(; a < r; ++a)s[a] = e[a];
    return function(l) {
        for(a = 0; a < o; ++a)s[a] = n[a](l);
        return s;
    };
}
m$1(Mh, "genericArray");
...
function ur(t, e) {
    ...
    for(t = t + "", e = e + ""; (o = ys.exec(t)) && (n = xs.exec(e));)(s = n.index) > r && (s = e.slice(r, s), l[a] ? l[a] += s : l[++a] = s), (o = o[0]) === (n = n[0]) ? l[a] ? l[a] += n : l[++a] = n : (l[++a] = null, c.push({
        i: a,
        x: gt(o, n)
    })), r = xs.lastIndex;
...
function ke(t, e) {
    var r = typeof e, o;
    return e == null || r === "boolean" ? cr(e) : (r === "number" ? gt : r === "string" ? (o = Yt(e)) ? (e = o, Ne) : ur : e instanceof Yt ? Ne : e instanceof Date ? ps : Fh(e) ? ms : Array.isArray(e) ? Mh : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? gs : gt)(t, e);
}
m$1(ke, "default");
function Vi(t, e) {
    return t = +t, e = +e, function(r) {
...
function ji(t, e, r, o, n, s) {
    var a, l, c;
    return (a = Math.sqrt(t * t + e * e)) && (t /= a, e /= a), (c = t * r + e * o) && (r -= t * c, o -= e * c), (l = Math.sqrt(r * r + o * o)) && (r /= l, o /= l, c /= l), t * o < e * r && (t = -t, e = -e, c = -c, a = -a), {
        translateX: n,
        translateY: s,
...
m$1(Ah, "parseCss");
function Eh(t) {
    return t == null ? Xi : (Zi || (Zi = document.createElementNS("http://www.w3.org/2000/svg", "g")), Zi.setAttribute("transform", t), (t = Zi.transform.baseVal.consolidate()) ? (t = t.matrix, ji(t.a, t.b, t.c, t.d, t.e, t.f)) : Xi);
}
m$1(Eh, "parseSvg");
function Oh(t, e, r, o) {
    function n(h) {
    ...
    function c(h, u, p, f, g, T) {
        if (h !== p || u !== f) {
            var A = g.push(n(g) + "scale(", null, ",", null, ")");
            T.push({
                i: A - 4,
                x: gt(h, p)
            }, {
    ...
    return m$1(c, "scale"), function(h, u) {
        var p = [], f = [];
        return h = t(h), u = t(u), s(h.translateX, h.translateY, u.translateX, u.translateY, p, f), a(h.rotate, u.rotate, p, f), l(h.skewX, u.skewX, p, f), c(h.scaleX, h.scaleY, u.scaleX, u.scaleY, p, f), h = u = null, function(g) {
...
function Vr() {
    ...
    return m$1(n, "scale"), n.domain = function(s) {
        ...
        return arguments.length ? (r = Array.from(s), n) : r.slice();
...
function dm(t, e, r) {
    ...
    return n < o ? (o = Ss(n, o), s = r(a, s)) : (o = Ss(o, n), s = r(s, a)), function(l) {
        return s(o(l));
    };
}
m$1(dm, "bimap");
function mm(t, e, r) {
    ...
    for(t[o] < t[0] && (t = t.slice().reverse(), e = e.slice().reverse()); ++a < o;)n[a] = Ss(t[a], t[a + 1]), s[a] = r(e[a], e[a + 1]);
    return function(l) {
        var c = pn(t, l, 1, o) - 1;
        return s[c](n[c](l));
    };
...
function pm() {
    ...
    function u() {
        ...
        return a !== fr && (a = fm(t[0], t[f - 1])), l = f > 2 ? mm : dm, c = h = null, p;
    }
    m$1(u, "rescale");
    function p(f) {
        return f == null || isNaN(f = +f) ? s : (c || (c = l(t.map(o), e, r)))(o(a(f)));
    }
    return m$1(p, "scale"), p.invert = function(f) {
        return a(n((h || (h = l(e, t.map(o), gt)))(f)));
    }, p.domain = function(f) {
        return arguments.length ? (t = Array.from(f, ks), u()) : t.slice();
    }, p.range = function(f) {
...
function ws(t, e) {
    return function(r, o) {
        for(var n = r.length, s = [], a = 0, l = t[0], c = 0; n > 0 && l > 0 && (c + l + 1 > o && (l = Math.max(1, o - c)), s.push(r.substring(n -= l, n + l)), !((c += l + 1) > o));)l = t[a = (a + 1) % t.length];
...
var gm = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function ve(t) {
    if (!(e = gm.exec(t))) throw new Error("invalid format: " + t);
    var e;
    return new Qi({
        fill: e[1],
        align: e[2],
...
function Ls(t, e) {
    var r = qe(t, e);
    if (!r) return t + "";
    var o = r[0], n = r[1], s = n - (Ms = Math.max(-8, Math.min(8, Math.floor(n / 3))) * 3) + 1, a = o.length;
    return s === a ? o : s > a ? o + new Array(s - a + 1).join("0") : s > 0 ? o.slice(0, s) + "." + o.slice(s) : "0." + new Array(1 - s).join("0") + qe(t, Math.max(0, e + s - 1))[0];
}
m$1(Ls, "default");
function Ji(t, e) {
    var r = qe(t, e);
...
m$1(Ji, "default");
var As = {
    "%": m$1((t, e)=>(t * 100).toFixed(e), "%"),
    b: m$1((t)=>Math.round(t).toString(2), "b"),
    c: m$1((t)=>t + "", "c"),
    d: vs,
    e: m$1((t, e)=>t.toExponential(e), "e"),
    f: m$1((t, e)=>t.toFixed(e), "f"),
    g: m$1((t, e)=>t.toPrecision(e), "g"),
    o: m$1((t)=>Math.round(t).toString(8), "o"),
    p: m$1((t, e)=>Ji(t * 100, e), "p"),
    r: Ji,
    s: Ls,
    X: m$1((t)=>Math.round(t).toString(16).toUpperCase(), "X"),
    x: m$1((t)=>Math.round(t).toString(16), "x")
};
function to(t) {
    return t;
}
...
function Es(t) {
    var e = t.grouping === void 0 || t.thousands === void 0 ? to : ws(Ih.call(t.grouping, Number), t.thousands + ""), r = t.currency === void 0 ? "" : t.currency[0] + "", o = t.currency === void 0 ? "" : t.currency[1] + "", n = t.decimal === void 0 ? "." : t.decimal + "", s = t.numerals === void 0 ? to : Bs(Ih.call(t.numerals, String)), a = t.percent === void 0 ? "%" : t.percent + "", l = t.minus === void 0 ? "\u2212" : t.minus + "", c = t.nan === void 0 ? "NaN" : t.nan + "";
    function h(p) {
        p = ve(p);
        ...
        var w = A === "$" ? r : A === "#" && /[boxX]/.test(P) ? "0" + P.toLowerCase() : "", X = A === "$" ? o : /[%p]/.test(P) ? a : "", j = As[P], $ = /[defgprs%]/.test(P);
        ...
        function it(B) {
            ...
            if (P === "c") x = j(B) + x, B = "";
                ...
                if (B = isNaN(B) ? c : j(Math.abs(B), O), M && (B = Fs(B)), z && +B == 0 && T !== "+" && (z = false), k = (z ? T === "(" ? T : l : T === "-" || T === "(" ? "" : T) + k, x = (P === "s" ? zh[8 + Ms / 3] : "") + x + (z && T === "(" ? ")" : ""), $) {
                    for(y = -1, L = B.length; ++y < L;)if (S = B.charCodeAt(y), 48 > S || S > 57) {
                        x = (S === 46 ? n + B.slice(y + 1) : B.slice(y)) + x, B = B.slice(0, y);
                        break;
                    }
                }
            }
            ...
            switch(G && W && (B = e(U + B, U.length ? q - x.length : 1 / 0), U = ""), g){
                case "<":
                    B = k + B + x + U;
                    break;
                case "=":
...
function Os(t) {
    return eo = Es(t), ro = eo.format, io = eo.formatPrefix, eo;
}
...
function Ds(t, e, r, o) {
    var n = ir(t, e, r), s;
    switch(o = ve(o ?? ",f"), o.type){
        case "s":
            {
                var a = Math.max(Math.abs(t), Math.abs(e));
                return o.precision == null && !isNaN(s = no(n, a)) && (o.precision = s), io(o, a);
            }
        case "":
        case "e":
        case "g":
        ...
        case "r":
            {
                o.precision == null && !isNaN(s = so(n, Math.max(Math.abs(t), Math.abs(e)))) && (o.precision = s - (o.type === "e"));
                break;
            }
        case "f":
        case "%":
            {
                o.precision == null && !isNaN(s = oo(n)) && (o.precision = s - (o.type === "%") * 2);
                break;
            }
    }
    return ro(o);
...
function xm(t) {
    ...
    return t.ticks = function(r) {
        ...
        r == null && (r = 10);
        var o = e(), n = 0, s = o.length - 1, a = o[n], l = o[s], c, h, u = 10;
        for(l < a && (h = a, a = l, l = h, h = n, n = s, s = h); u-- > 0;){
            if (h = qr(a, l, r), h === c) return o[n] = a, o[s] = l, e(o);
...
function ot(t, e, r, o) {
    ...
    return m$1(n, "interval"), n.floor = (s)=>(t(s = new Date(+s)), s), n.ceil = (s)=>(t(s = new Date(s - 1)), e(s, 1), t(s), s), n.round = (s)=>{
        let a = n(s), l = n.ceil(s);
        return s - a < l - s ? a : l;
    }, n.offset = (s, a)=>(e(s = new Date(+s), a == null ? 1 : Math.floor(a)), s), n.range = (s, a, l)=>{
        let c = [];
        if (s = n.ceil(s), l = l == null ? 1 : Math.floor(l), !(s < a) || !(l > 0)) return c;
        let h;
        ...
        }), r && (n.count = (s, a)=>(zs.setTime(+s), Rs.setTime(+a), t(zs), t(Rs), Math.floor(r(zs, Rs))), n.every = (s)=>(s = Math.floor(s), !isFinite(s) || !(s > 0) ? null : s > 1 ? n.filter(o ? (a)=>o(a) % s === 0 : (a)=>n.count(0, a) % s === 0) : n)), n;
}
m$1(ot, "timeInterval");
var Pe = ot(()=>{}, (t, e)=>{
    t.setTime(+t + e);
}, (t, e)=>e - t);
Pe.every = (t)=>(t = Math.floor(t), !isFinite(t) || !(t > 0) ? null : t > 1 ? ot((e)=>{
...
Vt.every = (t)=>!isFinite(t = Math.floor(t)) || !(t > 0) ? null : ot((e)=>{
...
function Kh(t, e, r, o, n, s) {
    ...
    function c(h, u, p) {
        ...
        if (g === a.length) return t.every(ir(h / 31536e6, u / 31536e6, p));
...
m$1(Kr, "newDate");
function $s(t) {
    var e = t.dateTime, r = t.date, o = t.time, n = t.periods, s = t.days, a = t.shortDays, l = t.months, c = t.shortMonths, h = Qr(n), u = Jr(n), p = Qr(s), f = Jr(s), g = Qr(a), T = Jr(a), A = Qr(l), W = Jr(l), q = Qr(c), G = Jr(c), O = {
        a: z,
        A: I,
        b: U,
        B: rt,
    ...
    O.x = w(r, O), O.X = w(o, O), O.c = w(e, O), M.x = w(r, M), M.X = w(o, M), M.c = w(e, M);
    function w(v, H) {
        return function(V) {
            var C = [], mt = -1, J = 0, bt = v.length, Tt, It, Le;
            for(V instanceof Date || (V = new Date(+V)); ++mt < bt;)v.charCodeAt(mt) === 37 && (C.push(v.slice(J, mt)), (It = Qh[Tt = v.charAt(++mt)]) != null ? Tt = v.charAt(++mt) : It = Tt === "e" ? " " : "0", (Le = H[Tt]) && (Tt = Le(V, It)), C.push(Tt), J = mt + 1);
...
m$1(hc, "dISO");
function yp(t, e) {
    return t = hc(t), et(we.count(Nt(t), t) + (Nt(t).getDay() === 4), e, 2);
}
...
function _p(t, e) {
    return et(pr.count(Nt(t) - 1, t), e, 2);
}
...
m$1(bp, "formatYear");
function Tp(t, e) {
    return t = hc(t), et(t.getFullYear() % 100, e, 2);
}
...
function Fp(t, e) {
    return et(1 + Zr.count(Vt(t), t), e, 3);
}
...
function Dp(t, e) {
    return et(Ye.count(Vt(t) - 1, t), e, 2);
}
...
m$1(uc, "UTCdISO");
function Ip(t, e) {
    return t = uc(t), et(Be.count(Vt(t), t) + (Vt(t).getUTCDay() === 4), e, 2);
}
...
function Rp(t, e) {
    return et(gr.count(Vt(t) - 1, t), e, 2);
}
...
function qp(t, e) {
    return t = uc(t), et(t.getUTCFullYear() % 100, e, 2);
}
...
function Hs(t) {
    return yr = $s(t), uo = yr.format, yr.parse, yr.utcFormat, yr.utcParse, yr;
}
m$1(Hs, "defaultLocale");
function Us(t, e) {
    t = t.slice();
    var r = 0, o = t.length - 1, n = t[r], s = t[o], a;
    return s < n && (a = r, r = o, o = a, a = n, n = s, s = a), t[r] = e.floor(n), t[o] = e.ceil(s), t;
}
m$1(Us, "nice");
function Hp(t) {
    return new Date(t);
...
function pc(t, e, r, o, n, s, a, l, c, h) {
    var u = Xr(), p = u.invert, f = u.domain, g = h(".%L"), T = h(":%S"), A = h("%I:%M"), W = h("%I %p"), q = h("%a %d"), G = h("%b %d"), O = h("%B"), M = h("%Y");
    function P(w) {
    ...
    return m$1(P, "tickFormat"), u.invert = function(w) {
        ...
        return Ki(u, pc(t, e, r, o, n, s, a, l, c, h));
    }, u;
}
m$1(pc, "calendar");
function gc() {
...
m$1(gc, "time");
function Ys() {
    var t = Vr().unknown(void 0), e = t.domain, r = t.range, o = 0, n = 1, s, a, l = false, c = 0, h = 0, u = .5;
    delete t.unknown;
    function p() {
...
var Xe = class {
    ...
    arcTo(e, r, o, n, s) {
        ...
        if (this._x1 === null) this._append`M${this._x1 = e},${this._y1 = r}`;
            ...
            let g = o - a, T = n - l, A = c * c + h * h, W = g * g + T * T, q = Math.sqrt(A), G = Math.sqrt(f), O = s * Math.tan((js - Math.acos((A + f - W) / (2 * q * G))) / 2), M = O / G, P = O / q;
...
function po(t, e, r, o, n, s, a) {
    var l = t - r, c = e - o, h = (a ? s : -s) / Ge(l * l + c * c), u = h * c, p = -h * l, f = t + u, g = e + p, T = r + u, A = o + p, W = (f + T) / 2, q = (g + A) / 2, G = T - f, O = A - g, M = G * G + O * O, P = n - s, w = f * A - T * g, X = (O < 0 ? -1 : 1) * Ge(xc(0, P * P * M - w * w)), j = (w * O - G * X) / M, $ = (-w * G - O * X) / M, it = (w * O + G * X) / M, B = (-w * G + O * X) / M, k = j - W, x = $ - q, y = it - W, L = B - q;
...
function bc() {
    var t = Xp, e = jp, r = st(0), o = null, n = Zp, s = Kp, a = Qp, l = null, c = mo(h);
    function h() {
        var u, p, f = +t.apply(this, arguments), g = +e.apply(this, arguments), T = n.apply(this, arguments) - ti, A = s.apply(this, arguments) - ti, W = Vs(A - T), q = A > T;
        if (l || (l = u = c()), g < f && (p = g, g = f, f = p), !(g > yt)) l.moveTo(0, 0);
            ...
            var G = T, O = A, M = T, P = A, w = W, X = W, j = a.apply(this, arguments) / 2, $ = j > yt && (o ? +o.apply(this, arguments) : Ge(f * f + g * g)), it = fo(Vs(g - f) / 2, +r.apply(this, arguments)), B = it, k = it, x, y;
            if ($ > yt) {
            ...
            X > yt ? k > yt ? (x = po(Q, Ft, z, I, g, k, q), y = po(Y, nt, U, rt, g, k, q), l.moveTo(x.cx + x.x01, x.cy + x.y01), k < it ? l.arc(x.cx, x.cy, k, vt(x.y01, x.x01), vt(y.y01, y.x01), !q) : (l.arc(x.cx, x.cy, k, vt(x.y01, x.x01), vt(x.y11, x.x11), !q), l.arc(0, 0, g, vt(x.cy + x.y11, x.cx + x.x11), vt(y.cy + y.y11, y.cx + y.x11), !q), l.arc(y.cx, y.cy, k, vt(y.y11, y.x11), vt(y.y01, y.x01), !q))) : (l.moveTo(z, I), l.arc(0, 0, g, G, O, !q)) : l.moveTo(z, I), !(f > yt) || !(w > yt) ? l.lineTo(U, rt) : B > yt ? (x = po(U, rt, Y, nt, f, -B, q), y = po(z, I, Q, Ft, f, -B, q), l.lineTo(x.cx + x.x01, x.cy + x.y01), B < it ? l.arc(x.cx, x.cy, B, vt(x.y01, x.x01), vt(y.y01, y.x01), !q) : (l.arc(x.cx, x.cy, B, vt(x.y01, x.x01), vt(x.y11, x.x11), !q), l.arc(0, 0, f, vt(x.cy + x.y11, x.cx + x.x11), vt(y.cy + y.y11, y.cx + y.x11), q), l.arc(y.cx, y.cy, B, vt(y.y11, y.x11), vt(y.y01, y.x01), !q))) : l.arc(0, 0, f, P, M, q);
        }
...
m$1(Sc, "y");
function vc(t, e) {
    var r = st(true), o = null, n = go, s = null, a = mo(l);
    t = typeof t == "function" ? t : t === void 0 ? kc : st(t), e = typeof e == "function" ? e : e === void 0 ? Sc : st(e);
    function l(c) {
        var h, u = (c = ei(c)).length, p, f = false, g;
        for(o == null && (s = n(g = a())), h = 0; h <= u; ++h)!(h < u && r(p = c[h], h, c)) === f && ((f = !f) ? s.lineStart() : s.lineEnd()), f && s.point(+t(p, h, c), +e(p, h, c));
    ...
    return m$1(l, "line"), l.x = function(c) {
        ...
        return arguments.length ? (n = c, o != null && (s = n(o)), l) : n;
...
m$1(Qs, "default");
function wc() {
    var t = Qs, e = Ks, r = null, o = st(0), n = st(_r), s = st(0);
    function a(l) {
        var c, h = (l = ei(l)).length, u, p, f = 0, g = new Array(h), T = new Array(h), A = +o.apply(this, arguments), W = Math.min(_r, Math.max(-_r, n.apply(this, arguments) - A)), q, G = Math.min(Math.abs(W) / h, s.apply(this, arguments)), O = G * (W < 0 ? -1 : 1), M;
...
function qc(t, e, r) {
    ...
    return (Nc(s) + Nc(a)) * Math.min(Math.abs(s), Math.abs(a), .5 * Math.abs(l)) || 0;
}
m$1(qc, "slope3");
function Pc(t, e) {
    var r = t._x1 - t._x0;
        ...
        if (t = +t, e = +e, !(t === this._x1 && e === this._y1)) {
            switch(this._point){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    this._point = 3, Js(this, Pc(this, r = qc(this, t, e)), r);
                    break;
                default:
                    Js(this, this._t0, r = qc(this, t, e));
                    break;
            }
...
m$1(Wc, "MonotoneY");
(Wc.prototype = Object.create(bo.prototype)).point = function(t, e) {
...
$c.prototype = {
    moveTo: m$1(function(t, e) {
        this._context.moveTo(e, t);
    }, "moveTo"),
    closePath: m$1(function() {
        this._context.closePath();
    }, "closePath"),
    lineTo: m$1(function(t, e) {
        this._context.lineTo(e, t);
    }, "lineTo"),
    bezierCurveTo: m$1(function(t, e, r, o, n, s) {
...
Uc.prototype = {
    ...
    lineEnd: m$1(function() {
        ...
        else for(var o = Hc(t), n = Hc(e), s = 0, a = 1; a < r; ++s, ++a)this._context.bezierCurveTo(o[0][s], n[0][s], o[1][s], n[1][s], t[a], e[a]);
...
ko.prototype = Xc.prototype = {
    constructor: ko,
    on: m$1(function(t, e) {
        var r = this._, o = mg(t + "", r), n, s = -1, a = o.length;
        if (arguments.length < 2) {
            for(; ++s < a;)if ((n = (t = o[s]).type) && (n = pg(r[n], t.name))) return n;
            return;
        }
        if (e != null && typeof e != "function") throw new Error("invalid callback: " + e);
        for(; ++s < a;)if (n = (t = o[s]).type) r[n] = Vc(r[n], t.name, e);
        else if (e == null) for(n in r)r[n] = Vc(r[n], t.name, null);
        return this;
    }, "on"),
    copy: m$1(function() {
        var t = {}, e = this._;
...
function Vc(t, e, r) {
    for(var o = 0, n = t.length; o < n; ++o)if (t[o].name === e) {
        t[o] = dg, t = t.slice(0, o).concat(t.slice(o + 1));
        break;
    }
...
function ea(t) {
    if (!kr) {
        ...
        var e = t - je;
        e > 24 ? (t < 1 / 0 && (ni = setTimeout(jc, t - ai.now() - wo)), oi && (oi = clearInterval(oi))) : (oi || (vo = ai.now(), oi = setInterval(xg, Zc)), kr = 1, Kc(jc));
    }
}
m$1(ea, "sleep");
function ci(t, e, r) {
...
function bg(t, e, r) {
    ...
    function a(h) {
        ...
        if (ci(function() {
            ...
            for(r.state = Fo, n = new Array(f = r.tween.length), u = 0, p = -1; u < f; ++u)(g = r.tween[u].value.call(t, t.__data__, r.index, r.group)) && (n[++p] = g);
            n.length = p + 1;
        }
    }
    m$1(a, "start");
...
function ia(t, e) {
    ...
    if (t += "", arguments.length < 2) {
        for(var o = dt(this.node(), r).tween, n = 0, s = o.length, a; n < s; ++n)if ((a = o[n]).name === t) return a.value;
        return null;
    }
    return this.each((e == null ? Tg : kg)(r, t, e));
}
m$1(ia, "default");
function Sr(t, e, r) {
    var o = t._id;
...
function mi(t, e) {
    var r;
    return (typeof e == "number" ? gt : e instanceof Yt ? Ne : (r = Yt(e)) ? (e = r, Ne) : ur)(t, e);
}
m$1(mi, "default");
function Sg(t) {
    return function() {
...
function wg(t, e, r) {
    ...
    return function() {
        ...
        return a === n ? null : a === o ? s : s = e(o = a, r);
    };
}
m$1(wg, "attrConstant");
function Bg(t, e, r) {
...
function Fg(t, e, r) {
    ...
    return function() {
        var a, l = r(this), c;
        return l == null ? void this.removeAttribute(t) : (a = this.getAttribute(t), c = l + "", a === c ? null : a === o && c === n ? s : (n = c, s = e(o = a, l)));
    };
}
m$1(Fg, "attrFunction");
function Mg(t, e, r) {
    ...
    return function() {
        var a, l = r(this), c;
        return l == null ? void this.removeAttributeNS(t.space, t.local) : (a = this.getAttributeNS(t.space, t.local), c = l + "", a === c ? null : a === o && c === n ? s : (n = c, s = e(o = a, l)));
    };
}
m$1(Mg, "attrFunctionNS");
function oa(t, e) {
    var r = Qt(t), o = r === "transform" ? _s : mi;
    return this.attrTween(t, typeof e == "function" ? (r.local ? Mg : Fg)(r, o, Sr(this, "attr." + t, e)) : e == null ? (r.local ? vg : Sg)(r) : (r.local ? Bg : wg)(r, o, e));
}
m$1(oa, "default");
function Lg(t, e) {
    return function(r) {
...
function na(t, e) {
    ...
    var o = Qt(t);
    return this.tween(r, (o.local ? Eg : Og)(o, e));
}
m$1(na, "default");
function Dg(t, e) {
    return function() {
...
function sa(t) {
    var e = this._id;
    return arguments.length ? this.each((typeof t == "function" ? Dg : Ig)(e, t)) : dt(this.node(), e).delay;
}
m$1(sa, "default");
function zg(t, e) {
    return function() {
...
function aa(t) {
    var e = this._id;
    return arguments.length ? this.each((typeof t == "function" ? zg : Rg)(e, t)) : dt(this.node(), e).duration;
}
m$1(aa, "default");
function Ng(t, e) {
    if (typeof e != "function") throw new Error;
...
function la(t) {
    var e = this._id;
    return arguments.length ? this.each(Ng(e, t)) : dt(this.node(), e).ease;
}
m$1(la, "default");
function qg(t, e) {
    return function() {
...
function ua(t) {
    ...
    for(var e = this._groups, r = t._groups, o = e.length, n = r.length, s = Math.min(o, n), a = new Array(o), l = 0; l < s; ++l)for(var c = e[l], h = r[l], u = c.length, p = a[l] = new Array(u), f, g = 0; g < u; ++g)(f = c[g] || h[g]) && (p[g] = f);
    for(; l < o; ++l)a[l] = e[l];
...
function Wg(t, e, r) {
    ...
    return function() {
        ...
        l !== o && (n = (o = l).copy()).on(e, r), a.on = n;
    };
}
m$1(Wg, "onFunction");
function fa(t, e) {
    var r = this._id;
    return arguments.length < 2 ? dt(this.node(), r).on.on(t) : this.each(Wg(r, t, e));
}
m$1(fa, "default");
function $g(t) {
    return function() {
...
function ma(t) {
    ...
    typeof t != "function" && (t = Ce(t));
    for(var o = this._groups, n = o.length, s = new Array(n), a = 0; a < n; ++a)for(var l = o[a], c = l.length, h = s[a] = new Array(c), u, p, f = 0; f < c; ++f)(u = l[f]) && (p = t.call(u, u.__data__, f, l)) && ("__data__" in u && (p.__data__ = u.__data__), h[f] = p, de(h[f], e, r, f, h, dt(u, r)));
...
function pa(t) {
    ...
    for(var o = this._groups, n = o.length, s = [], a = [], l = 0; l < n; ++l)for(var c = o[l], h = c.length, u, p = 0; p < h; ++p)if (u = c[p]) {
        for(var f = t.call(u, u.__data__, p, c), g, T = dt(u, r), A = 0, W = f.length; A < W; ++A)(g = f[A]) && de(g, e, r, A, f, T);
        s.push(f), a.push(u);
    }
...
function Ug(t, e) {
    var r, o, n;
    return function() {
        var s = _e(this, t), a = (this.style.removeProperty(t), _e(this, t));
        return s === a ? null : s === r && a === o ? n : n = e(r = s, o = a);
    };
}
m$1(Ug, "styleNull");
function ru(t) {
...
function Gg(t, e, r) {
    var o, n, s;
    return function() {
        var a = _e(this, t), l = r(this), c = l + "";
        return l == null && (c = l = (this.style.removeProperty(t), _e(this, t))), a === c ? null : a === o && c === n ? s : (n = c, s = e(o = a, l));
    };
}
...
function Vg(t, e) {
    ...
    return function() {
        var c = wt(this, t), h = c.on, u = c.value[s] == null ? l || (l = ru(e)) : void 0;
        (h !== r || n !== u) && (o = (r = h).copy()).on(a, n = u), c.on = o;
    };
}
m$1(Vg, "styleMaybeRemove");
function xa(t, e, r) {
    var o = (t += "") == "transform" ? Cs : mi;
    return e == null ? this.styleTween(t, Ug(t, o)).on("end.style." + t, ru(t)) : typeof e == "function" ? this.styleTween(t, Gg(t, o, Sr(this, "style." + t, e))).each(Vg(this._id, t)) : this.styleTween(t, Yg(t, o, e), r).on("end.style." + t, null);
}
m$1(xa, "default");
function Xg(t, e, r) {
    return function(o) {
...
m$1(Kg, "textFunction");
function Ca(t) {
    return this.tween("text", typeof t == "function" ? Kg(Sr(this, "text", t)) : Zg(t == null ? "" : t + ""));
}
m$1(Ca, "default");
function Qg(t) {
    return function(e) {
...
m$1(_a, "default");
function ba() {
    for(var t = this._name, e = this._id, r = Ao(), o = this._groups, n = o.length, s = 0; s < n; ++s)for(var a = o[s], l = a.length, c, h = 0; h < l; ++h)if (c = a[h]) {
        var u = dt(c, e);
        de(c, t, r, h, a, {
...
function ka(t) {
    var e, r;
    t instanceof Dt ? (e = t._id, t = t._name) : (e = Ao(), (r = ex).time = hi(), t = t == null ? null : t + "");
...
Me.prototype = {
    constructor: Me,
    scale: m$1(function(t) {
        return t === 1 ? this : new Me(this.k * t, this.x, this.y);
    }, "scale"),
    translate: m$1(function(t, e) {
        return t === 0 & e === 0 ? this : new Me(this.k, this.x + this.k * t, this.y + this.k * e);
    }, "translate"),
    apply: m$1(function(t) {
        return [
            t[0] * this.k + this.x,
            t[1] * this.k + this.y
        ];
    }, "apply"),
    applyX: m$1(function(t) {
        return t * this.k + this.x;
    }, "applyX"),
    applyY: m$1(function(t) {
        return t * this.k + this.y;
    }, "applyY"),
    invert: m$1(function(t) {
        return [
            (t[0] - this.x) / this.k,
            (t[1] - this.y) / this.k
        ];
    }, "invert"),
    invertX: m$1(function(t) {
        return (t - this.x) / this.k;
    }, "invertX"),
    invertY: m$1(function(t) {
        return (t - this.y) / this.k;
    }, "invertY"),
    rescaleX: m$1(function(t) {
        return t.copy().domain(t.range().map(this.invertX, this).map(t.invert, t));
    }, "rescaleX"),
    rescaleY: m$1(function(t) {
