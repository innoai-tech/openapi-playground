import { $ as Vo, A as $o, F as Go, G as No, I as Ho, L as Ii, Mn as c, Q as Uo, W as Ni, hn as pt, jn as p, k as d, m as Lt, pt as jo, q as Ot } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.BVgxNvHA.chunk.js";
	...
	if (o === "circle") for (let s = 0; s < a; s++) {
		...
		for (let m$1 = 0; m$1 < a; m$1++) {
			let n = r * (m$1 + 1) / a, l = /* @__PURE__ */ t.map((c$1, p$1) => {
				let d$1 = 2 * p$1 * Math.PI / s - Math.PI / 2, u = n * Math.cos(d$1), h = n * Math.sin(d$1);
				return `${u},${h}`;
			}).join(" ");
...
var it = /* @__PURE__ */ m((e, t) => {
	...
	let a = /* @__PURE__ */ Lt(/* @__PURE__ */ Ii(), (/* @__PURE__ */ Ot()).themeVariables), o = /* @__PURE__ */ Lt(a.radar, e);
	return {
		themeVariables: a,
		radarOptions: o
	};
