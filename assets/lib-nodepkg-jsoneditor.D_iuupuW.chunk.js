...
var _e, _t, _n;
import { c as e, I as t, j as n, a as l, b as a, d as i, r, T as o, F as d, e as s, s as c, g as p, f as u, o as h, t as v, h as y } from "./lib-nodepkg-vuekit.CYv97ktF.chunk.js";
import { o as m, J as f, S as x, E as g } from "./lib-nodepkg-typedef.CkHtBJ-Q.chunk.js";
import { O as b, s as w, m as N, f as C, d as $, t as k, E as S, c as E, B as O, S as T } from "./vendor-rxjs.B9ojupzi.chunk.js";
import { i as I, g as A, a as D, b as L, s as P, l as M, c as R, d as _ } from "./vendor-innoai-tech-lodash.XmF8H4xo.chunk.js";
import { s as J, v as j, a as B, P as z, b as H, B as W } from "./lib-nodepkg-vueuikit.BSmcQgYg.chunk.js";
import { I as U, a as V, m as F, b as K, c as X, d as q } from "./lib-nodepkg-vuematerial.B7qf5yHr.chunk.js";
const _G = class _G extends b {
  constructor(e2, t2) {
    super((e3) => {
      __privateGet(this, _e).next(t2);
      let n2 = /* @__PURE__ */ __privateGet(this, _e).subscribe(e3);
      return () => {
        n2.unsubscribe();
      };
    });
    ...
    this.typedef = e2, this.initials = t2;
  }
  static of(e2, t2) {
...
}, { displayName: "Actions" })({ display: "flex" }), et = /* @__PURE__ */ J(V, { displayName: "ActionBtn" })({ transition: "none", width: 24, height: 24, rounded: 12, [`& ${U}`]: { svg: { width: 18, height: 18 } } }), en = /* @__PURE__ */ J("span", { displayName: "Token" })({ textStyle: "sys.label-small", fontWeight: "bold", fontFamily: "inherit", fontSize: 12, lineHeight: 24, wordBreak: "keep-all", whiteSpace: "nowrap", font: "code", opacity: 0.3 }), el = /* @__PURE__ */ l((e2, t2) => {
  let { slots: l2 } = t2;
  return () => {
    var t3;
...
let e$ = /* @__PURE__ */ p(function(e2, t2) {
  ...
  let {} = t2;
  return () => /* @__PURE__ */ n(ek, { $title: "复制当前节点为 JSON 字符串", children: /* @__PURE__ */ n(et, { onClick: () => e$(/* @__PURE__ */ JSON.stringify(e2.value, null, 2)), children: /* @__PURE__ */ n(U, { path: F }) }) });
...
let eD = /* @__PURE__ */ e(() => new eA()), eL = /* @__PURE__ */ l((e2, l2) => {
  let a2, { render: r2 } = l2, o2 = /* @__PURE__ */ h(null), p2 = /* @__PURE__ */ h(null), u2 = /* @__PURE__ */ h(null), y2 = /* @__PURE__ */ eI.from(u2), m2 = /* @__PURE__ */ eD.use(), f2 = /* @__PURE__ */ ef.from(u2), g2 = /* @__PURE__ */ Q.use();
  eA.sync(m2, { editing$: f2, value$: e2.value$, path: () => e2.ctx.path });
  let b2 = () => {
    ...
    return 0;
  }, O2 = new t({ index: /* @__PURE__ */ b2() }), T2 = () => {
    f2.hide(), O2.next({ index: /* @__PURE__ */ b2() }), D(e2.value) && g2.delete(e2.ctx.path);
  }, I2 = (t2) => {
    var n2, l3, a3;
    if ("enums" === e2.typedef.type) {
      let l4 = null !== (n2 = /* @__PURE__ */ x.schemaProp(e2.typedef, "enum")) && void 0 !== n2 ? n2 : [];
      null != t2 || (t2 = l4[O2.value.index % l4.length]);
    } else null != t2 || (t2 = (null === (l3 = u2.value) || void 0 === l3 ? void 0 : l3.value) ? null === (a3 = u2.value) || void 0 === a3 ? void 0 : a3.value : void 0);
    if (D(t2)) {
      g2.delete(e2.ctx.path);
      return;
    }
    let [i2, r3] = e2.typedef.validate(t2, { coerce: true });
    if (i2) {
      g2.setError(e2.ctx.path, i2.message);
      return;
    }
    g2.update(e2.ctx.path, r3), f2.hide();
  };
  return (s(y2, /* @__PURE__ */ k((e3) => {
    switch (e3.type) {
      case "SELECT":
        O2.next((t2) => {
  ...
  }), /* @__PURE__ */ c()), s(/* @__PURE__ */ N(/* @__PURE__ */ s(p2, /* @__PURE__ */ v((e3) => {
    if (e3) {
    ...
    if (e3) {
      ...
      return n2(e3), N(/* @__PURE__ */ s(/* @__PURE__ */ C(e3, "blur"), /* @__PURE__ */ k((e4) => {
        if (e4.relatedTarget) {
          var t3, n3;
          if ((null === (t3 = p2.value) || void 0 === t3 ? void 0 : t3.contains(e4.relatedTarget)) || (null === (n3 = o2.value) || void 0 === n3 ? void 0 : n3.contains(e4.relatedTarget))) return;
        }
        e4.preventDefault(), y2.next({ type: "COMMIT" });
      })), /* @__PURE__ */ s(/* @__PURE__ */ C(e3, "input"), /* @__PURE__ */ k((e4) => {
        n2(e4.target);
      })));
    }
    return S;
  }))), /* @__PURE__ */ c()), "enums" == e2.typedef.type) ? s(/* @__PURE__ */ E([e2.value$, f2, O2]), /* @__PURE__ */ r2((t2) => {
    var l3, a3, i2;
    let [r3, o3, { index: s2 }] = t2, c2 = null !== (l3 = /* @__PURE__ */ x.schemaProp(e2.typedef, "enum")) && void 0 !== l3 ? l3 : [], h2 = null !== (a3 = /* @__PURE__ */ x.metaProp(e2.typedef, "enumLabels")) && void 0 !== a3 ? a3 : [];
    return /* @__PURE__ */ n(eM, { ref: p2, onClick: () => {
      f2.show();
    }, "data-type": typeof r3, tabindex: 0, onFocus: () => {
      f2.hide();
    }, children: o3 ? /* @__PURE__ */ n(eg, { onSelected: (e3) => {
      I2(e3);
    }, open$: f2, $content: /* @__PURE__ */ n(d, { children: /* @__PURE__ */ c2.map((e3, t3) => /* @__PURE__ */ n(e_, { "data-focus": s2 % c2.length === t3, value: e3, label: h2[t3] })) }), children: /* @__PURE__ */ n("input", { value: void 0 == r3 ? "" : `${r3}`, ref: u2, "data-options": true }) }) : /* @__PURE__ */ n("span", { children: null !== (i2 = /* @__PURE__ */ JSON.stringify(r3)) && void 0 !== i2 ? i2 : "undefined" }) });
  })) : s(/* @__PURE__ */ E([e2.value$, f2]), /* @__PURE__ */ r2((e3) => {
    var t2;
    let [l3, a3] = e3;
    return /* @__PURE__ */ n(eM, { ref: p2, onClick: () => {
      f2.show();
      ...
      f2.show();
    }, children: a3 ? /* @__PURE__ */ n(z, { isOpen: true, placement: "right-start", $content: /* @__PURE__ */ i(eP, { ref: o2, children: [/* @__PURE__ */ n(et, { onClick: () => y2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(U, { path: K }) }), /* @__PURE__ */ n(et, { onClick: () => y2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(U, { path: X }) })] }), children: /* @__PURE__ */ n("textarea", { ref: u2, rows: 1, value: void 0 == l3 ? "" : `${l3}` }) }) : /* @__PURE__ */ n("span", { "data-value": true, children: null !== (t2 = /* @__PURE__ */ JSON.stringify(l3)) && void 0 !== t2 ? t2 : "undefined" }) });
  }));
}, { displayName: "ValueInput", props: ["typedef", "ctx", "value"] }), eP = /* @__PURE__ */ J("div", { displayName: "ValueInputActions" })({ containerStyle: "sys.surface-container-lowest", roundedRight: "sm", display: "flex", px: 2, ml: -2 }), eM = /* @__PURE__ */ J("div", { displayName: "ValueContainer" })({ wordBreak: "keep-all", whiteSpace: "nowrap", cursor: "pointer", display: "flex", alignItems: "center", font: "code", width: "100%", textStyle: "sys.label-small", fontSize: 12, lineHeight: 24, gap: 8, "& [data-value]": { maxWidth: "40vw", width: "100%", overflow: "hidden", textOverflow: "ellipsis", _hover: { textOverflow: "clip", whiteSpace: "normal", wordBreak: "break-all" } }, "& textarea,input": { flex: 1, rounded: "xs", containerStyle: "sys.surface-container-lowest", width: "100%", maxWidth: "40vw", border: "none", outline: "none", px: 8, py: 0, m: 0, fontSize: "inherit", color: "inherit", lineHeight: "inherit", overflow: "hidden", resize: "none" }, _type__string: { color: "sys.primary" }, _type__number: { color: "sys.primary" }, _type__boolean: { color: "sys.warning" }, _type__undefined: { color: "sys.error" } }), eR = /* @__PURE__ */ J(ew, { displayName: "EnumMenuItemContainer" })({ [`& ${el}`]: { textAlign: "left" } }), e_ = /* @__PURE__ */ a((e2) => () => /* @__PURE__ */ i(eR, { "data-value": e2.value, tabindex: 0, children: [/* @__PURE__ */ n(el, { children: e2.value }), e2.label && /* @__PURE__ */ n(em, { children: e2.label })] }), { displayName: "EnumMenuItem", props: ["value", "label"] }), eJ = /* @__PURE__ */ l((e2, t2) => {
  let {} = e2, { emit: l2 } = t2;
  return () => /* @__PURE__ */ n(ek, { $title: "删除属性", children: /* @__PURE__ */ n(et, { onClick: () => l2("remove"), children: /* @__PURE__ */ n(U, { path: q }) }) });
  ...
  return s(e2.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(ec, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(ee, { children: /* @__PURE__ */ n(eO, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eB, { ctx: e2.ctx, onAdd: (t4) => {
    ...
    return /* @__PURE__ */ i(ep, { path: p2, dirty: /* @__PURE__ */ a2.isDirty(s2, p2), title: /* @__PURE__ */ x.metaProp(c2, "title"), description: /* @__PURE__ */ x.metaProp(c2, "description"), children: [/* @__PURE__ */ n(el, { deprecated: /* @__PURE__ */ x.schemaProp(c2, "deprecated"), $leading: /* @__PURE__ */ n(eJ, { onRemove: () => {
      a2.delete(p2);
    } }), children: /* @__PURE__ */ String(d2) }), /* @__PURE__ */ i(en, { children: [":", " "] }), null === (o2 = r2.$value) || void 0 === o2 ? void 0 : o2.call(r2, c2, s2, { ...e2.ctx, path: p2, branch: [...e2.ctx.branch, s2] })] });
  }) })));
}, { displayName: "ObjectInput", props: ["typedef", "ctx", "value"] }), eB = /* @__PURE__ */ l((e2, l2) => {
  let { emit: a2, render: r2 } = l2, o2 = /* @__PURE__ */ h(null), d2 = /* @__PURE__ */ eI.from(o2), p2 = /* @__PURE__ */ eT.from(o2), u2 = /* @__PURE__ */ ef.from(o2), v2 = /* @__PURE__ */ Q.use(), y2 = new t({ index: 0 }), m2 = () => {
    u2.hide(), p2.next(""), o2.value && (o2.value.value = "", o2.value.blur()), y2.next({ index: 0 });
  };
  s(p2, /* @__PURE__ */ k((t2) => {
  ...
  let g2 = /* @__PURE__ */ s(u2, /* @__PURE__ */ r2((e3) => /* @__PURE__ */ n("input", { ref: o2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)", "data-options": e3 })));
  return s(/* @__PURE__ */ E([p2, u2, y2, e2.options$]), /* @__PURE__ */ r2((t2) => {
    let [l3, a3, r3, s2] = t2;
    return s2 ? s2.length > 0 ? /* @__PURE__ */ n(ep, { path: e2.ctx.path, children: /* @__PURE__ */ n(eM, { sx: { mx: -4 }, children: /* @__PURE__ */ n(eg, { onSelected: (e3) => {
      f2(e3);
    }, open$: u2, $content: /* @__PURE__ */ s2.map((e3, t3) => l3 && !e3.propName.includes(l3) ? null : /* @__PURE__ */ n(ez, { propName: e3.propName, typedef: e3.typedef, "data-focus": t3 === r3.index % s2.length })), children: g2 }) }) }) : null : /* @__PURE__ */ n(ep, { path: [...e2.ctx.path, x.RecordKey], children: /* @__PURE__ */ n(eM, { sx: { mx: -4 }, children: /* @__PURE__ */ n(z, { isOpen: a3, placement: "right-start", $content: /* @__PURE__ */ i(eP, { children: [/* @__PURE__ */ n(et, { onClick: () => d2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(U, { path: K }) }), /* @__PURE__ */ n(et, { onClick: () => d2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(U, { path: X }) })] }), children: /* @__PURE__ */ n("input", { ref: o2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)" }) }) }) });
  }));
  ...
  return s(e2.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(ec, { openToken: "[", closeToken: "]", $leading: /* @__PURE__ */ n(ee, { children: /* @__PURE__ */ n(eO, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eU, { ctx: e2.ctx, typedef: e2.typedef, onAdd: (t4) => {
    ...
    return /* @__PURE__ */ i(ep, { path: c2, dirty: /* @__PURE__ */ a2.isDirty(d2, c2), children: [/* @__PURE__ */ n(el, { $leading: /* @__PURE__ */ n(eV, { onRemove: () => {
      a2.delete(c2);
    } }), children: /* @__PURE__ */ n(W, { sx: { opacity: 0.3, mr: "0.5em" }, children: /* @__PURE__ */ String(o2) }) }), null === (l3 = r2.$value) || void 0 === l3 ? void 0 : l3.call(r2, s2, d2, { ...e2.ctx, path: c2, branch: [...e2.ctx.branch, d2] })] });
  }) })));
}, { displayName: "ArrayInput", props: ["ctx", "value", "typedef"] }), eU = /* @__PURE__ */ l((e2, t2) => {
  let { emit: l2, render: a2 } = t2, r2 = /* @__PURE__ */ h(null), o2 = /* @__PURE__ */ eT.from(r2), d2 = /* @__PURE__ */ eI.from(r2), p2 = /* @__PURE__ */ ef.from(r2), u2 = /* @__PURE__ */ Q.use(), v2 = () => {
  ...
  let m2 = /* @__PURE__ */ s(p2, /* @__PURE__ */ a2((e3) => /* @__PURE__ */ n(z, { isOpen: e3, placement: "right-start", $content: /* @__PURE__ */ i(eP, { children: [/* @__PURE__ */ n(et, { onClick: () => d2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(U, { path: K }) }), /* @__PURE__ */ n(et, { onClick: () => d2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(U, { path: X }) })] }), children: /* @__PURE__ */ n("input", { ref: r2, type: "text", placeholder: "添加数组项 (可粘贴 JSON 字符串)" }) })));
  ...
  let {} = e2, { emit: l2 } = t2;
  return () => /* @__PURE__ */ n(ek, { $title: "移除项", children: /* @__PURE__ */ n(et, { onClick: () => l2("remove"), children: /* @__PURE__ */ n(U, { path: q }) }) });
  ...
  return s(e2.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(ec, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(ee, { children: /* @__PURE__ */ n(eO, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eB, { ctx: e2.ctx, onAdd: (t4) => {
    ...
    if (!Object.hasOwn(t3, d2)) return null;
    let p2 = [...e2.ctx.path, d2];
    return /* @__PURE__ */ i(ep, { path: p2, dirty: /* @__PURE__ */ a2.isDirty(s2, p2), children: [/* @__PURE__ */ n(el, { $leading: /* @__PURE__ */ n(eJ, { onRemove: () => {
      a2.delete(p2);
    } }), children: /* @__PURE__ */ String(d2) }), /* @__PURE__ */ i(en, { children: [":", " "] }), null === (o2 = r2.$value) || void 0 === o2 ? void 0 : o2.call(r2, c2, s2, { ...e2.ctx, path: p2, branch: [...e2.ctx.branch, s2] })] });
  }) })));
  ...
  return s(a2, /* @__PURE__ */ l2((e3) => {
    ...
    return /* @__PURE__ */ n(eD, { children: /* @__PURE__ */ n(Y, { value: { $value: null !== (l3 = r2.$value) && void 0 !== l3 ? l3 : eK }, children: /* @__PURE__ */ i(eq, { children: [/* @__PURE__ */ n("section", { ref: o2 }), o2.value && /* @__PURE__ */ n(es, { value: { indent: 0, $container: o2 }, children: /* @__PURE__ */ n(ep, { path: [], viewOnly: true, children: /* @__PURE__ */ d2(a2.typedef, e3, g) }) })] }) }) });
  }));
