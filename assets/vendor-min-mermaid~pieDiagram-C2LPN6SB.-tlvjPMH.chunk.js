...
import { Q as Qf, K as Kf, Z as Zf, j as jf, b as td, J as Jf, t as tt, h as hh, aq as Uc, T as Zr, G as Gf, X as Xf, aN as jc, I as Il } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
var X = Il.pie, w = {
    sections: new Map,
    showData: false
}, f = w.sections, A = w.showData, pe = /*#__PURE__*/ structuredClone(X), me = /*#__PURE__*/ m$1(()=>structuredClone(pe), "getConfig"), de = /*#__PURE__*/ m$1(()=>{
    f = new Map, A = w.showData, Xf();
    ...
    f.has(e) || (f.set(e, i), tt.debug(`added new section: ${e}, with value: ${i}`));
...
var he = /*#__PURE__*/ m$1((e)=>{
    ...
    return jc().value((o)=>o.value)(T);
}, "createPieArcs"), Pe = /*#__PURE__*/ m$1((e, i, T, v)=>{
    tt.debug(`rendering pie chart
` + e);
    let o = v.db, n = /*#__PURE__*/ hh(), $$1 = /*#__PURE__*/ Lt(/*#__PURE__*/ o.getConfig(), n.pie), b = 40, s = 18, m = 4, c = 450, D = c, u = /*#__PURE__*/ d(i), l = /*#__PURE__*/ u.append("g");
    l.attr("transform", "translate(" + D / 2 + "," + c / 2 + ")");
    let { themeVariables: a } = n, [E] = $(a.pieOuterStrokeWidth);
    E ??= 2;
    let G = $$1.textPosition, d$1 = Math.min(D, c) / 2 - b, ie = /*#__PURE__*/ Uc().innerRadius(0).outerRadius(d$1), re = /*#__PURE__*/ Uc().innerRadius(d$1 * G).outerRadius(d$1 * G);
    ...
    let k = /*#__PURE__*/ oe.filter((t)=>(t.data.value / y * 100).toFixed(0) !== "0"), h = /*#__PURE__*/ Zr(ae);
    ...
    u.attr("viewBox", `0 0 ${R} ${c}`), Gf(u, c, R, $$1.useMaxWidth);
}, "draw"), te = {
    draw: Pe
};
var Ue = {
