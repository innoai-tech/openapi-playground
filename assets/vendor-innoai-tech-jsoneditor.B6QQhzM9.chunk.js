...
import { At as r, D as i, Dt as l, F as o, Ft as a, I as u, It as s, L as c, M as d, Mt as p, N as f, Nt as h, O as m, Ot as g, P as y, Q as v, Tt as x, V as k, W as b, Z as C, a as S, bt as w, c as A, l as L, m as T, n as E, o as D, p as M, r as I, s as N, t as O, u as P, x as z, yt as F } from "./vendor-innoai-tech-vuekit.DCts1k_-.chunk.js";
import { d as _, f as R, l as H, n as V, o as B, r as $, s as j, t as U, u as q } from "./vendor-innoai-tech-vueuikit.BxzR6bgF.chunk.js";
import { S as W, a as J, b as Z, f as X, h as K, i as Q, m as Y, n as G, t as ee, u as et, x as en, y as er } from "./vendor-rxjs.TeOs2CXO.chunk.js";
var ei, el, eo = {};
function ea(e, t, n) {
	var r;
...
let eU = {
	...
	tokenize: function(e, t, n) {
		...
		return function(t) {
			var l;
			let s;
			return l = t, o = (s = i.events[i.events.length - 1]) && "linePrefix" === s[1].type ? s[2].sliceSerialize(s[1], !0).length : 0, r = l, e.enter("codeFenced"), e.enter("codeFencedFence"), e.enter("codeFencedFenceSequence"), function t(i) {
...
let tu = {
	...
	}, e.attempt(this.parser.constructs.flowInitial, r, eI(e, e.attempt(this.parser.constructs.flow, r, e.attempt(eK, r)), "linePrefix")));
	return n;
	function r(r) {
...
function tZ(e) {
	...
	})(e, [[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi, tX], [/(?<=^|\s|\p{P}|\p{S})([-.\w+]+)@([-\w]+(?:\.[-\w]+)+)/gu, tK]], { ignore: ["link", "linkReference"] });
}
...
let nJ = {
	tokenize: function(e, t, n) {
		...
		function l(t) {
			return 123 === t ? e.attempt(nX, o, o)(t) : o(t);
		}
		function o(n) {
...
function n1(e) {
	let t;
	return (t = "string" == typeof e ? e.charCodeAt(0) : e) >= 97 && t <= 122 || t >= 65 && t <= 90 || nY(e);
}
var n0 = [
	"",
...
function n2(e, t) {
	...
	for (u--; ++u <= e.length;) if (10 === i && (p = (r ? r[s] : 0) || 1), 38 === (i = e.charCodeAt(u))) {
		...
		for (d--; ++d <= e.length;) {
			let n = e.charCodeAt(d);
			if (!C(n)) break;
			b += String.fromCharCode(n), "named" === t && nK.includes(b) && (x = b, k = ec(b));
		}
...
var rW = n((e, t) => {
	...
	t.exports = function(e, t) {
		...
		function m(n) {
			...
			if (r.reason = n, r.filename = t.source, r.line = s, r.column = d, r.source = e, t.silent);
			else throw r;
		}
		function g(t) {
			var n = t.exec(e);
...
var r1 = t(rX(), 1), r0 = {}.hasOwnProperty, r2 = /* @__PURE__ */ new Map(), r3 = /[A-Z]/g, r4 = new Set([
	"table",
	"tbody",
	"thead",
	"tfoot",
...
function r6(e, t, n) {
	var r, i, l, o, a, u, s, c, d;
	let p, h, m, g, y, x, k, b, C;
	return "element" === t.type ? (r = e, i = t, l = n, p = r.schema, "svg" === i.tagName.toLowerCase() && "html" === p.space && (r.schema = rq), r.ancestors.push(i), h = it(r, i.tagName, !1), m = function(e, t) {
		let n, r, i = {};
	...
	}(r, i), g = ie(r, i), r4.has(i.tagName) && (g = g.filter(function(e) {
		return "string" != typeof e || !("object" == typeof e ? "text" === e.type && rp(e.value) : rp(e));
	})), r8(r, m, h, i), r7(m, g), r.ancestors.pop(), r.schema = p, r.create(i, h, m, l)) : "mdxFlowExpression" === t.type || "mdxTextExpression" === t.type ? function(e, t) {
		if (t.data && t.data.estree && e.evaluater) {
			let n = t.data.estree.body[0];
			return n.type, e.evaluater.evaluateExpression(n.expression);
		}
		ir(e, t.position);
	}(e, t) : "mdxJsxFlowElement" === t.type || "mdxJsxTextElement" === t.type ? (o = e, a = t, u = n, y = o.schema, "svg" === a.name && "html" === y.space && (o.schema = rq), o.ancestors.push(a), x = null === a.name ? o.Fragment : it(o, a.name, !0), k = function(e, t) {
		let n = {};
		...
		return n;
	}(o, a), b = ie(o, a), r8(o, k, x, a), r7(k, b), o.ancestors.pop(), o.schema = y, o.create(a, x, k, u)) : "mdxjsEsm" === t.type ? function(e, t) {
		if (t.data && t.data.estree && e.evaluater) return e.evaluater.evaluateProgram(t.data.estree);
		ir(e, t.position);
	}(e, t) : "root" === t.type ? (s = e, c = t, d = n, r7(C = {}, ie(s, c)), s.create(c, s.Fragment, C, d)) : "text" === t.type ? t.value : void 0;
}
function r8(e, t, n, r) {
	...
	table: function(e, t) {
		...
		if (n.length > 0) {
			let r = {
				...
				properties: {},
				children: e.wrap(n, !0)
			}, l = rQ(t.children[1]), o = rK(t.children[t.children.length - 1]);
			l && o && (r.position = {
				start: l,
				end: o
			}), i.push(r);
	...
	return (r = !(t || n), i = !!t, l = /* @__PURE__ */ new Map(), o = (e, t) => {
		...
		switch (t) {
			...
			case 2: {
				...
				let l = [], u = o([t, l], e);
				for (let t of ih(e)) (r || !ig(im(e[t]))) && l.push([a(t), a(e[t])]);
				return u;
			}
			...
			case 5: {
				let n = [], i = o([t, n], e);
				for (let [t, i] of e) (r || !(ig(im(t)) || ig(im(i)))) && n.push([a(t), a(i)]);
				return i;
			}
			case 6: {
				let n = [], i = o([t, n], e);
				for (let t of e) (r || !ig(im(t))) && n.push(a(t));
				return i;
			}
		}
		let { message: u } = e;
...
var iT = I((e, {}) => T(e.text$, Q(), S((t) => {
	...
	let a, u, s, c, d, p, f, h, m, g, y, v, x, b, C, S = ("string" != typeof (n = {
				...
				tokenize: function(e, t, n) {
					...
					return function(o) {
						return 126 === r && "characterEscape" !== i[i.length - 1][1].type ? n(o) : (e.enter("strikethroughSequenceTemporary"), function i(o) {
							...
							if (l < 2 && !a) return n(o);
							let s = e.exit("strikethroughSequenceTemporary"), c = ez(o);
							return s._open = !c || 2 === c && !!u, s._close = !u || 2 === u && !!c, t(o);
						}(o));
					};
				},
				resolveAll: function(e, t) {
		...
		function u() {
			var e;
			return e = this.stack.pop(), ea(e, "boolean" != typeof eo.includeImageAlt || eo.includeImageAlt, "boolean" != typeof eo.includeHtml || eo.includeHtml);
		}
		function s(e) {
					...
					function h(e, t) {
						return function(n, i, l) {
							...
							function y(e) {
								return function(n) {
									let i, l, o, c, d;
									return (i = p(), l = s.previous, o = s.currentConstruct, c = s.events.length, d = Array.from(a), h = {
										from: c,
										restore: function() {
											r = i, s.previous = l, s.currentConstruct = o, s.events.length = c, a = d, g();
										}
	...
	})(r).document().write((c = 1, d = "", p = !0, function(e, t, n) {
		let r, i, l, o, a, u = [];
		for (e = d + ("string" == typeof e ? e.toString() : new TextDecoder(t || void 0).decode(e)), l = 0, d = "", p && (65279 === e.charCodeAt(0) && l++, p = void 0); l < e.length;) {
			if (tL.lastIndex = l, o = (r = tL.exec(e)) && void 0 !== r.index ? r.index : e.length, a = e.charCodeAt(o), !r) {
				d = e.slice(l);
				break;
			}
			if (10 === a && l === o && s) u.push(-3), s = void 0;
			else switch (s && (u.push(-5), s = void 0), l < o && (u.push(e.slice(l, o)), c += o - l), a) {
				case 0:
					u.push(65533), c++;
					break;
				case 9:
					for (i = 4 * Math.ceil(c / 4), u.push(-2); c++ < i;) u.push(-1);
					break;
				case 10:
					u.push(-4), c = 1;
					break;
		...
		return n && (s && u.push(-5), d && u.push(d), u.push(null)), u;
	})(t, n, !0)))), m = {
		all: function(e) {
			let t = [];
			if ("children" in e) {
		...
		applyData: iw,
		definitionById: f = /* @__PURE__ */ new Map(),
		footnoteById: h = /* @__PURE__ */ new Map(),
		...
		one: function(e, t) {
			...
			return (m.options.unknownHandler || function(e, t) {
		...
		if ("definition" === e.type || "footnoteDefinition" === e.type) {
			let t = "definition" === e.type ? f : h, n = String(e.identifier).toUpperCase();
			t.has(n) || t.set(n, e);
		}
	}) ? (g = void 0, y = o) : (g = o, y = void 0), tB(l, g, function(e, t) {
		let n = t[t.length - 1], r = n ? n.children.indexOf(e) : void 0;
		return y(e, r, n);
	}, void 0), x = (v = m).one(i, void 0), b = function(e) {
...
}), iD = B(iE, { displayName: "FilledButton" })({
	containerStyle: "sys.primary",
	py: 6,
	px: 16,
	_hover: {
		shadow: "1",
		_$before: { bgColor: R("white", _(.08)) }
	},
	_focus: {
		shadow: "1",
		_$before: { bgColor: R("white", _(.12)) }
	},
	_active: {
		shadow: "1",
		_$before: { bgColor: R("white", _(.12)) }
	...
	_disabled: {
		shadow: "0",
		color: R("sys.on-surface", _(.38)),
		bgColor: "rgba(0,0,0,0)",
		_$before: { bgColor: R("sys.on-surface", _(.12)) }
	}
}), iM = B(iE, { displayName: "TextButton" })({
	extends: [{
		px: 16,
		$data_icon: {
...
}), iH = B(iM, { displayName: "IconButton" })({
	boxSize: 36,
	p: 0,
...
let iV = H({
	from: { opacity: 0 },
	to: { opacity: 1 },
	duration: q.duration.md1,
	easing: q.easing.standard.accelerate
}, {
	from: { opacity: 1 },
	to: { opacity: 0 },
	duration: q.duration.sm4,
	easing: q.easing.standard.decelerate
});
q.duration.sm4, q.easing.standard.decelerate, q.duration.sm1, q.easing.standard.accelerate, q.duration.sm4, q.easing.standard.decelerate, q.duration.sm1, q.easing.standard.accelerate, q.duration.sm4, q.easing.standard.decelerate, q.duration.sm1, q.easing.standard.accelerate, q.duration.sm4, q.easing.standard.decelerate, q.duration.sm1, q.easing.standard.accelerate;
var iB = B("div", { displayName: "TooltipContainer" })({
	mt: 4,
	py: 2,
	px: 8,
	rounded: "xs",
	...
	return () => {
		...
		return l ? D(U, {
			...
			$transition: ({ content: e }) => D(iV, { children: e }),
			$content: D(iB, { children: l }),
			children: i ? b(i, {
				onVnodeMounted: (e) => {
...
var ij = B("div", { displayName: "Container" })({
	pos: "absolute",
	top: 0,
	left: 0,
	h: "100vh",
	...
	alignItems: "center",
	justifyContent: "center"
}), iU = B("div", { displayName: "DialogBackdrop" })({
	cursor: "pointer",
	pos: "absolute",
	top: 0,
	left: 0,
	...
	duration: q.duration.sm4,
	easing: q.easing.standard.accelerate
}), iW = z((e, { slots: t, emit: n }) => {
	let r = v(e.isOpen ?? !1), i = v(!1);
	return C(() => e.isOpen, (e) => {
		...
		children: N(ij, { children: [D(iq, {
			onComplete: (e) => {
				"leave" === e && (r.value = !1, n("close"));
			},
			children: i.value ? D(iU, { onClick: () => {
				i.value = !1;
			} }) : null
		}), t.default?.()] })
	});
...
q.duration.sm4, q.easing.standard.accelerate, q.duration.sm1, q.easing.standard.accelerate;
let iJ = (e) => r(e) ? e : F(e) ? [] : [e], iZ = ((ei = {})[ei.NONE = 0] = "NONE", ei[ei.EXACT = 1] = "EXACT", ei[ei.PREFIX = 2] = "PREFIX", ei), iX = ((el = {}).NONE = "NONE", el.ADD = "ADD", el.EDIT = "EDIT", el.DELETE = "DELETE", el);
var iK = class e extends W {
	static of(t, n) {
	...
	update(e, t, n, i) {
		(console.log("[json-editor]", "update", JSON.stringify(e), this.typedef.type), this.#t.next({}), 0 == e.length) ? this.#e.next(t) : w(t) ? this.#e.next((o) => {
			let a = s(o, e, n);
			i && "array" == i.type && !r(a) && (a = iJ(a)), t(a), l(o, e, a);
		}) : this.#e.next((n) => {
			l(n, e, t);
		});
	}
	delete(e) {
		0 != e.length && (console.log("[json-editor]", "delete", e), this.#e.next((t) => {
			let n = h(e);
			if (g(n)) {
				let i = e.slice(0, e.length - 1), l = i.length > 0 ? s(t, i) : t;
				if (r(l)) return void l.splice(n, 1);
			}
			let i = e.slice(0, e.length - 1), l = i.length > 0 ? s(t, i) : t;
			delete l[n];
		}));
...
let iQ = O(() => new iK(d(), {})), iY = O(() => ({}));
var iG = B("span", { displayName: "ActionToolbar" })({
	px: 2,
	pos: "relative",
	visibility: "hidden",
	border: "1px solid",
	...
	wordBreak: "keep-all",
	whiteSpace: "nowrap"
}), i2 = B(i0, { displayName: "TokenView" })({
	font: "code",
	opacity: .3
}), i3 = B(iG, { displayName: "PropLeading" })({
	position: "absolute",
	ml: -28
}), i4 = B(i0, { displayName: "PropNameView" })({
	position: "relative",
	display: "flex",
	alignItems: "center",
	userSelect: "none",
	...
	props: ["open$"],
	emits: ["selected"]
}), i7 = B("div", { displayName: "PopoverContainer" })({
	textStyle: "sys.body-small",
	pos: "relative",
...
}), ln = B("span", { displayName: "PropDescription" })({
	display: "block",
	textStyle: "sys.body-small",
	"& p": {
		my: 1,
	...
	return T(r, n((n) => {
		...
		return D(U, {
			...
			$content: D(ll, { children: D(li, { children: t.title() }) }),
			children: i ? b(i, {
				onMouseover: () => {
					r.show();
				},
	...
	displayName: "Tooltip",
	props: ["placement"]
}), li = B("div", { displayName: "TooltipContainer" })({
	py: 4,
	px: 12,
	rounded: "xs",
	shadow: "3",
	...
	pos: "relative",
	zIndex: 100
}), ll = B("div", { displayName: "TooltipWrapper" })({ px: 8 }), lo = B("div", { displayName: "LineError" })({
	display: "block",
	fontSize: 10,
	lineHeight: 14,
	color: "sys.error",
	...
	top: -2,
	right: 0
}), la = B("div", { displayName: "LinePrefix" })({
	position: "relative",
	display: "flex",
	alignItems: "start",
	...
	px: 12,
	userSelect: "none"
}), lu = B("div", { displayName: "LineContent" })({
	flex: 1,
	minW: 0
}), ls = B("div", { displayName: "LineContentMain" })({
	position: "relative",
	display: "flex",
	alignItems: "start"
}), lc = B(i2, { displayName: "LineNumber" })({
	opacity: .28,
	font: "code"
}), ld = B(i2, (e) => (t) => D(t, { children: D(iR, { path: e.folded ? "M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" : "M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" }) }), {
...
}), lp = B("div", (e, { slots: t }) => (n) => N(n, { children: [D(la, { children: t.leading?.() }), D(lu, {
	sx: { paddingLeft: 14 * e.indent * 2 },
	children: N(ls, { children: [t.default?.(), t.comment?.()] })
})] }), {
	...
	[`&[data-dirty=${iX.EDIT}]`]: { bgColor: R("sys.warning-container", _(.38)) },
	[`&[data-dirty=${iX.ADD}]`]: { bgColor: R("sys.success-container", _(.38)) },
	[`&[data-dirty=${iX.DELETE}]`]: {
		bgColor: R("sys.error-container", _(.38)),
		textDecoration: "line-through",
		opacity: .58
	},
	_error: { bgColor: R("sys.error-container", _(.38)) }
	...
	enable(e) {
		this.#i.value || this.#i.next(o.create(e));
	}
	disable(e) {
		this.#i.value === o.create(e) && this.#i.next(null);
	}
};
let lg = O(() => new lm());
var ly = I((e, { render: t }) => {
	let n, r = A(null), i = A(null), l = A(null), o = lh.from(l), a = lf.from(l), s = lg.use(), c = i9.from(l), d = iQ.use();
	lm.sync(s, {
		editing$: c,
		value$: e.value$,
		path: () => e.ctx.path
	...
	let p = () => {
		if ("enums" === e.typedef.type) {
			let t = (u.schemaProp(e.typedef, "enum") ?? []).indexOf(e.value);
			if (t > -1) return t;
		}
		return 0;
	}, f = new M({ index: p() }), h = () => {
		...
		if ("enums" === e.typedef.type) {
			let n = u.schemaProp(e.typedef, "enum") ?? [];
			t ??= n[f.value.index % n.length];
		} else t ??= l.value?.value ? l.value?.value : void 0;
		if (F(t)) return void d.delete(e.ctx.path);
	...
	return (e.allowRawJSON && T(a, ee((t) => {
		...
		switch (t.type) {
			...
			case "COMMIT":
				m();
				break;
			case "CANCEL": h(), f.next({ index: p() }), F(e.value) && d.delete(e.ctx.path);
		}
	}), L()), T(et(T(i, E((e) => {
		if (e) {
		...
		let a = u.schemaProp(e.typedef, "enum") ?? [], s = u.metaProp(e.typedef, "enumLabels") ?? [];
		return D(lb, {
			ref: i,
			onClick: () => {
				c.show();
			...
			children: n ? D(i8, {
				...
				$content: D("div", {
					ref: r,
					children: a.map((e, t) => D(lS, {
						"data-focus": o % a.length === t,
						value: e,
						label: s[t]
					}))
				}),
				children: D(lx, { children: D("input", {
					value: void 0 == t ? "" : `${t}`,
					ref: l,
					"data-options": !0
				}) })
		...
		children: n ? D(U, {
			...
			$content: N(lv, {
				...
				children: [D(i1, {
					...
					children: D(iR, { path: iI })
				}), D(i1, {
					type: "button",
					onClick: () => o.next({ type: "COMMIT" }),
					children: D(iR, { path: iN })
				})]
			}),
			children: D(lx, { children: D("textarea", {
				ref: l,
				rows: 1,
				value: void 0 == t ? "" : `${t}`
			}) })
...
}), lv = B("div", { displayName: "ValueInputActions" })({
	borderRight: "1px solid",
	borderTop: "1px solid",
	borderBottom: "1px solid",
	borderColor: R("sys.outline-variant", _(.38)),
	...
	py: 0,
	ml: -4
}), lx = B("div", { displayName: "InputWrapper" })({
	flex: 1,
	minWidth: 0,
	maxWidth: "80%",
	display: "flex",
...
}), lb = B("div", { displayName: "ValueContainer" })({
	wordBreak: "keep-all",
	whiteSpace: "nowrap",
	cursor: "pointer",
	display: "flex",
...
}), lC = B(le, { displayName: "EnumMenuItemContainer" })({ [`& ${i5}`]: { textAlign: "left" } }), lS = z((e) => () => N(lC, {
	"data-value": e.value,
	tabindex: 0,
	children: [D(i5, { children: e.value }), e.label && D(ln, { children: e.label })]
}), {
	...
	children: D(i1, {
		...
		children: D(iR, { path: "M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z" })
	})
}), {
	...
	children: D(i1, {
		type: "button",
		onClick: () => e("remove"),
		children: D(iR, { path: "M19,19V5H5V19H19M19,3A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5C3,3.89 3.9,3 5,3H19M17,11V13H7V11H17Z" })
	})
}), {
	displayName: "ItemRemoveIconBtn",
	emits: ["remove"]
}), lE = I((e, { emit: t, render: n }) => {
	let r = A(null), i = lf.from(r), l = lh.from(r), o = i9.from(r), a = iQ.use(), s = () => {
		r.value && (r.value.value = "", r.value.blur());
	}, c = (n) => {
		if (n ??= i.value) {
			let [r, i] = u.schemaProp(e.typedef, "items").validate(n, { coerce: !0 });
	...
	let p = T(o, n((e) => D(lx, { children: D("input", {
		ref: r,
		type: "text",
	...
	return T(Y([
		...
		children: D(i8, {
			...
			open$: o,
			$content: D("div", { children: l.map((t, r) => e && !t.propName.includes(e) ? null : D(lM, {
	...
	tabindex: 0,
	children: [D(i5, {
		optional: !!u.schemaProp(e.typedef, u.optional),
		children: e.propName
	}), D(ln, { children: u.metaProp(e.typedef, "title") })]
}), {
	...
	return T(Y([
		...
		let d, f, m = !!s, g = r(o) || "array" == e.typedef.type, y = !g && x(o);
		if (t) return c ? null : D(k, { children: D(lp, {
			"data-error": m,
			$leading: l,
			indent: e.ctx.path.length,
			children: g ? N(k, { children: [N(i2, { children: ["]", "\xA0\xA0"] }), !e.ctx.readOnly && D(lE, {
				ctx: e.ctx,
				typedef: e.typedef,
				onAdd: (t) => {
			...
			})] }) : y ? N(k, { children: [N(i2, { children: ["}", "\xA0\xA0"] }), !e.ctx.readOnly && D(lD, {
				ctx: e.ctx,
				onAdd: (t) => {
		...
		let v = () => {
			let t = h(e.ctx.path);
			return N(k, { children: [F(t) ? null : D(i5, {
				deprecated: u.schemaProp(e.typedef, "deprecated"),
				$leading: e.ctx.readOnly ? null : D(lT, { onRemove: () => {
					n.delete(e.ctx.path);
				} }),
				children: D(j, {
					sx: p(t) ? { opacity: 1 } : {
			...
			}), p(t) ? D(i2, { children: ": " }) : e.ctx.path.length > 0 ? D(i2, { children: "\xA0\xA0" }) : null] });
		};
		return D(lp, {
			indent: e.ctx.path.length,
			"data-dirty": ((e, t) => {
				if (!(r(e) || x(e))) {
					if (F(t) && !F(e)) return iX.ADD;
					if (!F(t) && F(e)) return iX.DELETE;
					if (!F(t) && !F(e) && e !== t) return iX.EDIT;
				}
				return iX.NONE;
			})(o, e.previous),
			"data-error": m,
			$leading: N(k, { children: [l, g || y ? D(ld, {
				folded: c !== iZ.NONE,
				onClick: () => {
					n.toggleFold(a);
				}
			}) : null] }),
			$comment: (d = u.metaProp(e.typedef, "title"), f = u.metaProp(e.typedef, "description"), N(k, { children: [(d || f) && D(lt, { children: f ? D(lr, {
				$title: D(ln, { children: D(iT, { text: f }) }),
				placement: "top",
				children: N("div", { children: [
					d,
					" ",
					D(iR, { path: "M11,18H13V16H11V18M12,6A4,4 0 0,0 8,10H10A2,2 0 0,1 12,8A2,2 0 0,1 14,10C14,12 11,11.75 11,15H13C13,12.75 16,12.5 16,10A4,4 0 0,0 12,6M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3Z" })
				] })
			}) : D("span", { children: d }) }), m && D(lo, { children: `${s}` })] })),
			children: (() => {
				if (c) {
					if (c == iZ.EXACT) {
						if (g) return N(k, { children: [v(), D(i2, { children: "[...]" })] });
						if (y) return N(k, { children: [v(), D(i2, { children: "{...}" })] });
					}
					return null;
				}
				return N(k, { children: [v(), g ? N(k, { children: [D(i2, { children: "[" }), D(iG, { children: D(lL, { value: o }) })] }) : y ? N(k, { children: [D(i2, { children: "{" }), D(iG, { children: D(lL, { value: o }) })] }) : i.$value?.(e.typedef, o, e.ctx)] });
			})()
		});
	}));
}, {
...
var lP = I((e, { render: t }) => {
	let n = iQ.use(), l = iY.use();
	return T(n, t((t) => D(lg, { children: D(iY, {
		value: { $value: l.$value ?? lO },
		children: D(lz, { children: D(lF, { children: [...function* e(t, n, l, o) {
			if ("object" == l.type || "record" == l.type || "intersection" == l.type || "union" == l.type && u.schemaProp(l, "discriminator")) {
				let r = {
					value: t ?? {},
					previous: n,
					typedef: l,
				...
				for (let [t, i, a] of (yield r, l.entries(r.value, o))) Object.hasOwn(r.value, t) && (yield* e(i, s(n, [t]), a, {
					...o,
					path: [...o.path, t],
					branch: [...o.branch, i]
				}));
			...
			if ("union" == l.type && F(u.schemaProp(l, "discriminator"))) {
				let r = u.schemaProp(l, "oneOf");
				if (r?.length == 2) {
					let i = r.find((e) => "array" == e.type), l = r.find((e) => "array" != e.type);
					if (i && l && u.schemaProp(i, "items").type == l.type) {
						let r = iJ(t), l = iJ(n), a = {
							value: r,
							previous: l,
							typedef: i,
						...
						for (let [t, n, u] of (yield a, i.entries(r, o))) yield* e(n, s(l, [t]), u, {
							...o,
							path: [...o.path, t],
							branch: [...o.branch, n]
						});
			...
			if ("array" == l.type) {
				...
				for (let [i, a, u] of (yield r, l.entries(t, o))) yield* e(a, s(n, [i]), u, {
					...o,
					path: [...o.path, i],
					branch: [...o.branch, a]
				});
			...
			if ("any" == l.type || "unknown" == l.type) {
				if (r(t)) return void (yield* e(t, n, m(i()), o));
				if (a(t)) return void (yield* e(t, n, f(y(), i()), o));
			}
			yield {
				value: t,
				previous: n,
	...
	props: ["readOnly"]
}), lz = B("div", { displayName: "JSONEditorContainer" })({
	w: "100%",
	h: "100%",
	overflow: "auto"
}), lF = B("div", ({}, { slots: e }) => (t) => D(t, { children: e.default() }), { displayName: "Lines" })({
	position: "relative",
	display: "flex",
...
export { i$ as a, iO as c, iF as d, i_ as f, iW as i, iP as l, iT as m, iK as n, iH as o, iD as p, iQ as r, iR as s, lP as t, iz as u };
