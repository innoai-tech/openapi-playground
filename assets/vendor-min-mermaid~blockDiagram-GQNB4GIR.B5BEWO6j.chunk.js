...
import { Q as Qt$1, y as yt$1 } from "./vendor-min-mermaid~chunk-HESFG3RP.Dj2hmxyj.chunk.js";
import { I as Ie$1, X as Xe$1, b as be$1 } from "./vendor-min-mermaid~chunk-YM3XIQPS.DIMTnqRF.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
import { E as Er$1, i as ih, T as Tf, t as tt, S as Sf, a as Su, b as ae$1, H as Hl, c as vc, d as Bc, m as mf, g as gC, O as Oe$1 } from "./vendor-min-mermaid~chunk-ZKYS2E5M.CwhZsQ7z.chunk.js";
import { _ as _f } from "./vendor-min-mermaid~chunk-5ZJXQJOJ.DZaYt2YO.chunk.js";
...
var yt = function() {
  var e = m$1(function(T, y, d2, f) {
    ...
    performAction: m$1(function(y, d2, f, w, E, h, Y) {
      var p = h.length - 1;
      switch (E) {
        case 4:
    ...
    parse: m$1(function(y) {
      ...
      function Be() {
        var H;
        return H = w.pop() || z.lex() || at, typeof H != "number" && (H instanceof Array && (w = H, H = w.pop()), H = d2.symbols_[H] || H), H;
      }
      m$1(Be, "lex");
...
Expecting ` + it.join(", ") + ", got '" + (this.terminals_[F] || F) + "'" : xt = "Parse error on line " + (R + 1) + ": Unexpected " + (F == at ? "end of input" : "'" + (this.terminals_[F] || F) + "'"), this.parseError(xt, {
    ...
    var T = {
      ...
      input: m$1(function() {
        ...
        var d2 = y.match(/(?:\r\n?|\n).*/g);
        return d2 ? (this.yylineno++, this.yylloc.last_line++) : this.yylloc.last_column++, this.options.ranges && this.yylloc.range[1]++, this._input = this._input.slice(1), y;
      }, "input"),
      unput: m$1(function(y) {
        var d2 = y.length, f = y.split(/(?:\r\n?|\n)/g);
        this._input = y + this._input, this.yytext = this.yytext.substr(0, this.yytext.length - d2), this.offset -= d2;
...
` + this.showPosition(), {
      ...
      showPosition: m$1(function() {
        var y = this.pastInput(), d2 = new Array(y.length + 1).join("-");
        return y + this.upcomingInput() + `
` + d2 + "^";
      }, "showPosition"),
      test_match: m$1(function(y, d2) {
        var f, w, E;
        ...
        ]), this._more = false, this._backtrack = false, this._input = this._input.slice(y[0].length), this.matched += y[0], f = this.performAction.call(this, this.yy, this, d2, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), f) return f;
        if (this._backtrack) {
      ...
      next: m$1(function() {
        ...
        for (var E = this._currentRules(), h = 0; h < E.length; h++) if (f = this._input.match(this.rules[E[h]]), f && (!d2 || f[0].length > d2[0].length)) {
        ...
        return d2 ? (y = this.test_match(d2, E[w]), y !== false ? y : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: m$1(function(d2, f, w, E) {
        switch (w) {
          case 0:
            return 10;
          case 1:
          ...
          case 8:
            return f.yytext = f.yytext.replace(/columns\s+/, ""), d2.getLogger().debug("COLUMNS (LEX)", f.yytext), 28;
          case 9:
          ...
          case 15:
            return f.yytext = f.yytext.replace(/space\:/, ""), d2.getLogger().debug("SPACE NUM (LEX)", f.yytext), 21;
          case 16:
          ...
          case 85:
            ...
            break;
          case 86:
            return f.yytext = f.yytext.replace(/^,\s*/, ""), d2.getLogger().debug("Lex (right): dir:", f.yytext), "DIR";
          case 87:
            return f.yytext = f.yytext.replace(/^,\s*/, ""), d2.getLogger().debug("Lex (left):", f.yytext), "DIR";
          case 88:
            return f.yytext = f.yytext.replace(/^,\s*/, ""), d2.getLogger().debug("Lex (x):", f.yytext), "DIR";
          case 89:
            return f.yytext = f.yytext.replace(/^,\s*/, ""), d2.getLogger().debug("Lex (y):", f.yytext), "DIR";
          case 90:
            return f.yytext = f.yytext.replace(/^,\s*/, ""), d2.getLogger().debug("Lex (up):", f.yytext), "DIR";
          case 91:
            return f.yytext = f.yytext.replace(/^,\s*/, ""), d2.getLogger().debug("Lex (down):", f.yytext), "DIR";
          case 92:
          ...
          case 104:
            return this.popState(), d2.getLogger().debug("Lex: LINK", f.yytext), 15;
          case 105:
            return d2.getLogger().debug("Lex: COLON", f.yytext), f.yytext = f.yytext.slice(1), 27;
        }
      }, "anonymous"),
      rules: [
        /^(?:block-beta\b)/,
...
yt.parser = yt;
var Ht = yt;
var X = /* @__PURE__ */ new Map(), kt = [], mt = /* @__PURE__ */ new Map(), jt = "color", Kt = "fill", Te = "bgFill", Ut = ",", Ce = Hl(), lt = /* @__PURE__ */ new Map(), Ne = m$1((e) => gC.sanitizeText(e, Ce), "sanitizeText"), Ie = m$1(function(e) {
...
var ot = m$1((e, t) => {
  let s = Su, n2 = s(e, "r"), i = s(e, "g"), r = s(e, "b");
  return ae$1(n2, i, r, t);
}, "fade"), qe = m$1((e) => `.label {
...
var O = ((_b = (_a = Hl()) == null ? void 0 : _a.block) == null ? void 0 : _b.padding) ?? 8;
function or(e, t) {
...
function Lt(e, t) {
  ...
  if (((_c = e.children) == null ? void 0 : _c.length) > 0) {
    ...
    l > 0 && l < o && (u = l);
    let g = Math.ceil(o / u), x = u * (i + O) + O, m2 = g * (r + O) + O;
    if (x < s) {
...
function Qt(e) {
  ...
  if (e.children) for (let r of e.children) ({ minX: t, minY: s, maxX: n2, maxY: i } = Qt(r, {
    minX: t,
    minY: s,
    maxX: n2,
    maxY: i
...
m$1(te, "applyStyle");
function hr(e) {
  let t = ih(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), s = t.append("xhtml:div"), n2 = e.label, i = e.isNode ? "nodeLabel" : "edgeLabel", r = s.append("span");
...
var St = {}, M = {};
var se = m$1((e, t) => {
  let s = Hl(), n2 = mf(s.flowchart.htmlLabels), i = t.labelType === "markdown" ? Qt$1(e, t.label, {
    style: t.labelStyle,
    useHtmlLabels: n2,
...
var ie = m$1((e, t) => {
  ...
  let s = e.x, n2 = e.y, i = Math.abs(t.x - s), r = Math.abs(t.y - n2), a = e.width / 2, l = e.height / 2;
  return i >= a || r >= l;
  ...
  let n2 = e.x, i = e.y, r = Math.abs(n2 - s.x), a = e.width / 2, l = s.x < t.x ? a - r : a + r, o = e.height / 2, u = Math.abs(t.y - s.y), g = Math.abs(t.x - s.x);
  ...
  return e.forEach((r) => {
    if (!ur(t, r) && !i) {
      let a = pr(t, n2, r), l = false;
      s.forEach((o) => {
        l = l || o.x === a.x && o.y === a.y;
      }), s.some((o) => o.x === a.x && o.y === a.y) || s.push(a), i = true;
    } else n2 = r, i || s.push(r);
  }), s;
}, "cutPathAtIntersect"), ne = m$1(function(e, t, s, n2, i, r, a) {
  let l = s.points;
  tt.debug("abc88 InsertEdge: edge=", s, "e=", t);
  let o = false, u = r.node(t.v);
  var g = r.node(t.w);
  (g == null ? void 0 : g.intersect) && (u == null ? void 0 : u.intersect) && (l = l.slice(1, s.points.length - 1), l.unshift(u.intersect(l[0])), l.push(g.intersect(l[l.length - 1]))), s.toCluster && (tt.debug("to cluster abc88", n2[s.toCluster]), l = ae(s.points, n2[s.toCluster].node), o = true), s.fromCluster && (tt.debug("from cluster abc88", n2[s.fromCluster]), l = ae(l.reverse(), n2[s.fromCluster].node).reverse(), o = true);
  let x = l.filter((y) => !Number.isNaN(y.y)), m2 = Bc;
  s.curve && (i === "graph" || i === "flowchart") && (m2 = s.curve);
  let { x: b, y: L } = d(s), _ = vc().x(b).y(L).curve(m2), S;
  switch (s.thickness) {
    case "normal":
...
var fr = m$1((e) => {
  ...
  let n2 = fr(e), i = 2, r = t.height + 2 * s.padding, a = r / i, l = t.width + 2 * a + s.padding, o = s.padding / 2;
...
function br(e, t, s, n2) {
  var i = e.x, r = e.y, a = i - n2.x, l = r - n2.y, o = Math.sqrt(t * t * l * l + s * s * a * a), u = Math.abs(t * s * a / o);
  n2.x < i && (u = -u);
...
function mr(e, t, s, n2) {
  ...
  if (i = t.y - e.y, a = e.x - t.x, o = t.x * e.y - e.x * t.y, m2 = i * s.x + a * s.y + o, b = i * n2.x + a * n2.y + o, !(m2 !== 0 && b !== 0 && he(m2, b)) && (r = n2.y - s.y, l = s.x - n2.x, u = n2.x * s.y - s.x * n2.y, g = r * e.x + l * e.y + u, x = r * t.x + l * t.y + u, !(g !== 0 && x !== 0 && he(g, x)) && (L = i * l - r * a, L !== 0))) return _ = Math.abs(L / 2), S = a * u - l * o, I = S < 0 ? (S - _) / L : (S + _) / L, S = r * o - i * u, D = S < 0 ? (S - _) / L : (S + _) / L, {
    x: I,
    y: D
  };
}
...
function kr(e, t, s) {
  ...
  for (var o = n2 - e.width / 2 - a, u = i - e.height / 2 - l, g = 0; g < t.length; g++) {
    var x = t[g], m2 = t[g < t.length - 1 ? g + 1 : 0], b = ge(e, s, {
      x: o + x.x,
      y: u + x.y
    }, {
      x: o + m2.x,
  ...
  return r.length ? (r.length > 1 && r.sort(function(L, _) {
    var S = L.x - s.x, I = L.y - s.y, D = Math.sqrt(S * S + I * I), T = _.x - s.x, y = _.y - s.y, d2 = Math.sqrt(T * T + y * y);
...
var A = m$1(async (e, t, s, n2) => {
  ...
  }, i) : x = g.appendChild(W(Oe$1(Xe$1(u), i), t.labelStyle, false, n2));
  let m2 = x.getBBox(), b = t.padding / 2;
  if (mf(i.flowchart.htmlLabels)) {
    ...
    m2 = L.getBoundingClientRect(), _.attr("width", m2.width), _.attr("height", m2.height);
  }
...
function U(e, t, s, n2) {
  return e.insert("polygon", ":first-child").attr("points", n2.map(function(i) {
    return i.x + "," + i.y;
...
var Lr = m$1(async (e, t) => {
  ...
  let a = n2.insert("rect", ":first-child");
...
var fe = m$1((e) => e ? " " + e : "", "formatClass"), j = m$1((e, t) => `${t || "node default"}${fe(e.classes)} ${fe(e.class)}`, "getClassesFromNode"), xe = m$1(async (e, t) => {
  let { shapeSvg: s, bbox: n2 } = await A(e, t, j(t, void 0), true), i = n2.width + t.padding, r = n2.height + t.padding, a = i + r, l = [
    {
      x: a / 2,
      y: 0
    },
  ...
  let s = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), n2 = 28, i = [
    {
      x: 0,
      y: n2 / 2
    },
  ...
  let { shapeSvg: s, bbox: n2 } = await A(e, t, j(t, void 0), true), i = 4, r = n2.height + t.padding, a = r / i, l = n2.width + 2 * a + t.padding, o = [
    {
      x: a,
      y: 0
    },
  ...
  let { shapeSvg: s, bbox: n2 } = await A(e, t, void 0, true), i = 2, r = n2.height + 2 * t.padding, a = r / i, l = n2.width + 2 * a + t.padding, o = le(t.directions, n2, t), u = U(s, l, r, o);
  return u.attr("style", t.style), N(t, u), t.intersect = function(g) {
    return v.polygon(t, o, g);
  }, s;
}, "block_arrow"), Dr = m$1(async (e, t) => {
  let { shapeSvg: s, bbox: n2 } = await A(e, t, j(t, void 0), true), i = n2.width + t.padding, r = n2.height + t.padding, a = [
    {
      x: -r / 2,
      y: 0
    },
  ...
  let { shapeSvg: s, bbox: n2 } = await A(e, t, j(t), true), i = n2.width + t.padding, r = n2.height + t.padding, a = [
    {
      x: -2 * r / 6,
      y: 0
    },
  ...
  let { shapeSvg: s, bbox: n2 } = await A(e, t, j(t, void 0), true), i = n2.width + t.padding, r = i / 2, a = r / (2.5 + i / 50), l = n2.height + a + t.padding, o = "M 0," + a + " a " + r + "," + a + " 0,0,0 " + i + " 0 a " + r + "," + a + " 0,0,0 " + -i + " 0 l 0," + l + " a " + r + "," + a + " 0,0,0 " + i + " 0 l 0," + -l, u = s.attr("label-offset-y", a).insert("path", ":first-child").attr("style", t.style).attr("d", o).attr("transform", "translate(" + -i / 2 + "," + -(l / 2 + a) + ")");
  return N(t, u), t.intersect = function(g) {
    let x = v.rect(t, g), m2 = x.x - t.x;
  ...
  let { shapeSvg: s, bbox: n2, halfPadding: i } = await A(e, t, "node " + t.classes + " " + t.class, true), r = s.insert("rect", ":first-child"), a = t.positioned ? t.width : n2.width + t.padding, l = t.positioned ? t.height : n2.height + t.padding, o = t.positioned ? -a / 2 : -n2.width / 2 - i, u = t.positioned ? -l / 2 : -n2.height / 2 - i;
  ...
  let { shapeSvg: s, bbox: n2, halfPadding: i } = await A(e, t, "node " + t.classes, true), r = s.insert("rect", ":first-child"), a = t.positioned ? t.width : n2.width + t.padding, l = t.positioned ? t.height : n2.height + t.padding, o = t.positioned ? -a / 2 : -n2.width / 2 - i, u = t.positioned ? -l / 2 : -n2.height / 2 - i;
  ...
  let n2 = s.insert("rect", ":first-child"), i = 0, r = 0;
...
function Et(e, t, s, n2) {
  ...
  t.includes("t") ? (tt.debug("add top border"), r(s)) : a(s), t.includes("r") ? (tt.debug("add right border"), r(n2)) : a(n2), t.includes("b") ? (tt.debug("add bottom border"), r(s)) : a(s), t.includes("l") ? (tt.debug("add left border"), r(n2)) : a(n2), e.attr("stroke-dasharray", i.join(" "));
}
m$1(Et, "applyNodePropertyBorders");
var zr = m$1((e, t) => {
  let s;
  t.classes ? s = "node " + t.classes : s = "node default";
  let n2 = e.insert("g").attr("class", s).attr("id", t.domId || t.id), i = n2.insert("rect", ":first-child"), r = n2.insert("line"), a = n2.insert("g").attr("class", "label"), l = t.labelText.flat ? t.labelText.flat() : t.labelText, o = "";
  ...
  tt.info("Text 2", l);
  let x = l.slice(1, l.length), m2 = u.getBBox(), b = a.node().appendChild(W(x.join ? x.join("<br/>") : x, t.labelStyle, true, true));
  if (mf(Hl().flowchart.htmlLabels)) {
    let _ = b.children[0], S = ih(b);
    g = _.getBoundingClientRect(), S.attr("width", g.width), S.attr("height", g.height);
  }
  let L = t.padding / 2;
  return ih(b).attr("transform", "translate( " + (g.width > m2.width ? 0 : (m2.width - g.width) / 2) + ", " + (m2.height + L + 5) + ")"), ih(u).attr("transform", "translate( " + (g.width < m2.width ? 0 : -(m2.width - g.width) / 2) + ", 0)"), g = a.node().getBBox(), a.attr("transform", "translate(" + -g.width / 2 + ", " + (-g.height / 2 - L + 3) + ")"), i.attr("class", "outer title-state").attr("x", -g.width / 2 - L).attr("y", -g.height / 2 - L).attr("width", g.width + t.padding).attr("height", g.height + t.padding), r.attr("class", "divider").attr("x1", -g.width / 2 - L).attr("x2", g.width / 2 + L).attr("y1", -g.height / 2 - L + m2.height + L).attr("y2", -g.height / 2 - L + m2.height + L), N(t, i), t.intersect = function(_) {
    return v.rect(t, _);
  }, n2;
}, "rectWithTitle"), Mr = m$1(async (e, t) => {
  let { shapeSvg: s, bbox: n2 } = await A(e, t, j(t, void 0), true), i = n2.height + t.padding, r = n2.width + i / 4 + t.padding, a = s.insert("rect", ":first-child").attr("style", t.style).attr("rx", i / 2).attr("ry", i / 2).attr("x", -r / 2).attr("y", -i / 2).attr("width", r).attr("height", i);
  return N(t, a), t.intersect = function(l) {
    return v.rect(t, l);
  }, s;
}, "stadium"), Fr = m$1(async (e, t) => {
  let { shapeSvg: s, bbox: n2, halfPadding: i } = await A(e, t, j(t, void 0), true), r = s.insert("circle", ":first-child");
  ...
  let { shapeSvg: s, bbox: n2, halfPadding: i } = await A(e, t, j(t, void 0), true), r = 5, a = s.insert("g", ":first-child"), l = a.insert("circle"), o = a.insert("circle");
  ...
  let s = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), n2 = s.insert("circle", ":first-child");
  ...
  let n2 = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), i = 70, r = 10;
  s === "LR" && (i = 10, r = 70);
  let a = n2.append("rect").attr("x", -1 * i / 2).attr("y", -1 * r / 2).attr("width", i).attr("height", r).attr("class", "fork-join");
  return N(t, a), t.height = t.height + t.padding / 2, t.width = t.width + t.padding / 2, t.intersect = function(l) {
    return v.rect(t, l);
  }, n2;
}, "forkJoin"), Hr = m$1((e, t) => {
  let s = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), n2 = s.insert("circle", ":first-child"), i = s.insert("circle", ":first-child");
  ...
  let a = e.insert("g").attr("class", r).attr("id", t.domId || t.id), l = a.insert("rect", ":first-child"), o = a.insert("line"), u = a.insert("line"), g = 0, x = n2, m2 = a.insert("g").attr("class", "label"), b = 0, L = (_a2 = t.classData.annotations) == null ? void 0 : _a2[0], _ = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", S = m2.node().appendChild(W(_, t.labelStyle, true, true)), I = S.getBBox();
  if (mf(Hl().flowchart.htmlLabels)) {
  ...
  let T = m2.node().appendChild(W(D, t.labelStyle, true, true));
  ...
  t.classData.members.forEach((E) => {
    ...
    let p = m2.node().appendChild(W(Y, h.cssStyle ? h.cssStyle : t.labelStyle, true, true)), R = p.getBBox();
    if (mf(Hl().flowchart.htmlLabels)) {
  ...
  if (t.classData.methods.forEach((E) => {
    ...
    let E = (g - I.width) / 2;
    ih(S).attr("transform", "translate( " + (-1 * g / 2 + E) + ", " + -1 * x / 2 + ")"), b = I.height + n2;
  }
  let w = (g - y.width) / 2;
  return ih(T).attr("transform", "translate( " + (-1 * g / 2 + w) + ", " + (-1 * x / 2 + b) + ")"), b += y.height + n2, o.attr("class", "divider").attr("x1", -g / 2 - s).attr("x2", g / 2 + s).attr("y1", -x / 2 - s + i + b).attr("y2", -x / 2 - s + i + b), b += i, d2.forEach((E) => {
  ...
  if (t.link) {
    let r;
    Hl().securityLevel === "sandbox" ? r = "_top" : t.linkTarget && (r = t.linkTarget || "_blank"), n2 = e.insert("svg:a").attr("xlink:href", t.link).attr("target", r), i = await ye[t.shape](n2, t, s);
...
function ke(e, t) {
  ...
  let o = be$1((n2 == null ? void 0 : n2.styles) ?? []), u = n2.label, g = n2.size ?? {
    width: 0,
    height: 0,
    x: 0,
    y: 0
...
async function Kr(e, t, s) {
  ...
  let i = Er$1(), r = await _t(e, n2, {
    config: i
  }), a = r.node().getBBox(), l = s.getBlock(n2.id);
  l.size = {
    width: a.width,
    height: a.height,
    x: 0,
...
async function Se(e, t, s, n2, i) {
  ...
  for (let a of t) if (a.start && a.end) {
    let l = n2.getBlock(a.start), o = n2.getBlock(a.end);
...
var Ur = m$1(function(e, t) {
...
}, "getClasses"), Vr = m$1(async function(e, t, s, n2) {
  ...
  let x = a.getBlocks(), m2 = a.getBlocksFlat(), b = a.getEdges(), L = u.insert("g").attr("class", "block");
  await we(L, x, a);
  let _ = $t(a);
  if (await Le(L, x, a), await Se(L, b, m2, a, t), _) {
    let S = _, I = Math.max(1, Math.round(0.125 * (S.width / S.height))), D = S.height + I + 10, T = S.width + 10, { useMaxWidth: y } = r;
