...
import { I as Ie$1, L as Le$1, w as we$1 } from './vendor-min-mermaid~chunk-YM3XIQPS.CNQBySGW.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { L as Lf, M as Mf, B as Bf, F as Ff, w as wf, v as vf, t as tt$1, H as Hl, i as ih, ak as Of, S as Sf, g as gC, E as Er, p as pl } from './vendor-min-mermaid~chunk-ZKYS2E5M.Dvid1YGB.chunk.js';
var u = {
    NORMAL: 0,
    REVERSE: 1,
    HIGHLIGHT: 2,
...
var fe = /*#__PURE__*/ m$1(function(r) {
    ...
    let n = /*#__PURE__*/ D();
    o = /*#__PURE__*/ gC.sanitizeText(o, n), e = /*#__PURE__*/ gC.sanitizeText(e, n), t = t?.map((s)=>gC.sanitizeText(s, n));
    let m = {
    ...
    let n = /*#__PURE__*/ D();
    if (e = /*#__PURE__*/ gC.sanitizeText(e, n), o = /*#__PURE__*/ gC.sanitizeText(o, n), a = a?.map((g)=>gC.sanitizeText(g, n)), t = /*#__PURE__*/ gC.sanitizeText(t, n), !e || !i.records.commits.has(e)) {
...
var Ie = /*#__PURE__*/ Hl(), w = Ie?.gitGraph, P = 10, M = 40, k = 4, T = 2, G = 8, b = new Map, C = new Map, R = 30, L = new Map, A = [], E = 0, y = "LR", qe = /*#__PURE__*/ m$1(()=>{
...
`, "id:", e, o), !w) throw new Error("GitGraph config not found");
    ...
    }), ie(s, L, false), w.showBranches && Qe(s, m), Xe(s, L), ie(s, L, true), Ie$1.insertTitle(s, "gitTitleText", w.titleTopMargin ?? 0, /*#__PURE__*/ n.getDiagramTitle()), Of(void 0, s, w.diagramPadding, w.useMaxWidth);
}, "draw"), de = {
    draw: tt
};
