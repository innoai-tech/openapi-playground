...
var _e, _t, _n;
var e, t, n, l;
import { c as a, I as i, j as r, a as o, r as d, s, b as p, d as c, e as u, f as h, T as y, F as v, g as m, o as f, t as x, h as g } from "./lib-nodepkg-vuekit.Ce7n1Vqu.chunk.js";
import { o as b, J as w, S as N, a as C, r as $, s as S, E as k } from "./lib-nodepkg-typedef.C7AJ53Bp.chunk.js";
import { s as O, v as E, P as I, a as T, b as A, B as D } from "./lib-nodepkg-vueuikit.eUxXcvBP.chunk.js";
import { I as R, a as J, m as L, b as P, c as M, d as B, e as _ } from "./lib-nodepkg-vuematerial.B6tBgVxX.chunk.js";
import { O as W, s as j, m as z, f as H, d as F, t as U, E as V, c as K, B as X, S as q } from "./vendor-rxjs.BqYGlyAQ.chunk.js";
import { i as G, g as Q, a as Y, b as Z, s as ee, l as et, c as en, d as el, e as ea } from "./vendor-innoai-tech-lodash.CzrXiiPp.chunk.js";
import { M as ei } from "./lib-nodepkg-vuemarkdown.Cb-5gRUK.chunk.js";
...
_t = new WeakMap();
let er = _er;
let eo = a(() => new er(b(), {})), ed = a(() => ({})), es = O("span", { displayName: "ActionToolbar" })({ px: 2, pos: "relative", display: "flex", alignItems: "center", gap: 8, visibility: "hidden" }), ep = O("span", (e5, t2) => {
  let {} = e5, { slots: n2 } = t2;
  return (e6) => {
    var t3;
    return r(e6, { children: r(es, { "data-visible-on-hover": true, children: null === (t3 = n2.default) || void 0 === t3 ? void 0 : t3.call(n2) }) });
  };
}, { displayName: "Actions" })({ display: "flex" }), ec = O(J, { displayName: "ActionBtn" })({ transition: "none", width: 24, height: 24, rounded: 12, [`& ${R}`]: { svg: { width: 18, height: 18 } } });
class eu extends i {
  static from(e5) {
    let t2 = new eu(false);
...
let eh = A({ apply(e5) {
  ...
  return d(o2, i2((e6) => {
    var t3, n3, l3, i3;
    return r(I, { isOpen: e6, onClickOutside: () => o2.hide(), onEscKeydown: () => o2.hide(), placement: "bottom-start", middleware: [eh], $content: r(ev, { onClick: s2, children: null === (t3 = a2.content) || void 0 === t3 ? void 0 : t3.call(a2) }), children: null !== (i3 = null === (l3 = a2.default) || void 0 === l3 ? void 0 : null === (n3 = l3.call(a2)) || void 0 === n3 ? void 0 : n3[0]) && void 0 !== i3 ? i3 : null });
  }));
...
o((e5, t2) => {
  ...
  return d(i2, a2((e6) => {
    var t3, n3, a3, o2;
    return r(I, { isOpen: e6, onClickOutside: () => i2.hide(), placement: "bottom-start", $content: r(ev, { children: null === (t3 = l2.content) || void 0 === t3 ? void 0 : t3.call(l2) }), children: null !== (o2 = null === (a3 = l2.default) || void 0 === a3 ? void 0 : null === (n3 = a3.call(l2)) || void 0 === n3 ? void 0 : n3[0]) && void 0 !== o2 ? o2 : null });
  }));
}, { displayName: "Popover", props: ["open$"] });
let ev = O("div", { displayName: "PopoverContainer" })({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: E("sys.outline-variant", T(0.38)) }), em = O("div", { displayName: "MenuItem" })({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), ef = o((e5, t2) => {
  let { slots: n2, render: l2 } = t2, a2 = new eu(false);
  return d(a2, l2((t3) => {
    var l3, i2;
    let o2 = null === (l3 = n2.default) || void 0 === l3 ? void 0 : l3.call(n2)[0];
    return r(I, { isOpen: t3, placement: null !== (i2 = e5.placement) && void 0 !== i2 ? i2 : "left", $content: r(eg, { children: r(ex, { children: n2.title() }) }), children: o2 ? p(o2, { onMouseover: () => {
      a2.show();
    }, onMouseout: () => {
      a2.hide();
    } }) : null });
  }));
}, { displayName: "Tooltip", props: ["placement"] }), ex = O("div", { displayName: "TooltipContainer" })({ py: 4, px: 12, rounded: "xs", shadow: "3", textStyle: "sys.body-small", containerStyle: "sys.on-surface", pos: "relative", zIndex: 100 }), eg = O("div", { displayName: "TooltipWrapper" })({ px: 8 }), eb = O("span", { displayName: "Token" })({ textStyle: "sys.label-small", fontWeight: "bold", fontFamily: "inherit", fontSize: 12, lineHeight: 24, wordBreak: "keep-all", whiteSpace: "nowrap", font: "code", opacity: 0.3 }), ew = o((e5, t2) => {
  let { slots: n2 } = t2;
  return () => {
    var t3;
    return u(eC, { "data-deprecated": e5.deprecated, "data-optional": e5.optional, "data-nullable": e5.nullable, children: [n2.leading && r(eN, { "data-visible-on-hover": true, children: n2.leading() }), null === (t3 = n2.default) || void 0 === t3 ? void 0 : t3.call(n2)] });
  };
}, { displayName: "PropName", props: ["deprecated", "optional", "nullable"] }), eN = O(es, { displayName: "PropLeading" })({ position: "absolute", ml: -28 }), eC = O("div", { displayName: "PropNameView" })({ position: "relative", display: "flex", alignItems: "center", textStyle: "sys.label-small", fontWeight: "bold", fontFamily: "inherit", wordBreak: "keep-all", whiteSpace: "nowrap", border: "1px solid", borderColor: "rgba(0,0,0,0)", fontSize: 12, lineHeight: 24, _deprecated: { textDecoration: "line-through" }, _optional: { "&:after": { content: '"?"', color: "sys.secondary", opacity: 0.58 } } }), e$ = O("div", { displayName: "LineTitle" })({ position: "absolute", zIndex: 1, left: 0, opacity: 0.58, fontSize: 10, lineHeight: 10, top: 0, "& > *": { display: "flex", alignItems: "center", gap: 4, "&::before": { content: '"// "', font: "code" } } }), eS = O("div", { displayName: "LineError" })({ display: "block", fontSize: 10, lineHeight: 14, color: "sys.error" }), ek = O("div", { displayName: "LineContainer" })({ position: "relative", py: 4, _hover: { containerStyle: "sys.surface-container", "& [data-visible-on-hover]": { visibility: "visible" } }, "&:focus-within": { containerStyle: "sys.surface-container" }, _dirty: { bgColor: E("sys.warning-container", T(0.38)) }, _error: { bgColor: "sys.error-container" }, [`&:has(${ep})`]: { [`& > ${eS}`]: { display: "none" }, _error: { bgColor: "inherit" } } }), eO = a(() => ({ indent: 0, $container: h(null) }), { name: "IntentContext" }), eE = c((e5, t2) => {
  let { slots: n2 } = t2, l2 = eO.use(), a2 = h(null), i2 = h(null);
  return () => {
    var t3, o2, d2, s2, p2;
    return u(v, { children: [r(eb, { children: e5.openToken }), null === (t3 = n2.leading) || void 0 === t3 ? void 0 : t3.call(n2), u(y, { to: l2.$container.value, children: [u(eA, { "data-indent": l2.indent, children: [r(eT, { ref: a2 }), r(eD, { ref: i2 }), i2.value && r(eO, { value: { $container: i2, indent: 1 + (null !== (s2 = l2.indent) && void 0 !== s2 ? s2 : 0) }, children: null === (o2 = n2.trailing) || void 0 === o2 ? void 0 : o2.call(n2) })] }), r(eR, { style: { paddingLeft: `${32 * l2.indent}px`, display: "flex" }, children: r(eb, { children: e5.closeToken }) })] }), a2.value && r(eO, { value: { $container: a2, indent: 1 + (null !== (p2 = l2.indent) && void 0 !== p2 ? p2 : 0) }, children: null === (d2 = n2.default) || void 0 === d2 ? void 0 : d2.call(n2) })] });
  };
  ...
  let { slots: n2, render: l2 } = t2, a2 = eO.use(), i2 = d(eo.use().error$, l2((t3) => {
    ...
    return u(ek, { "data-error": o2, "data-dirty": e5.dirty, style: { paddingLeft: `${32 * a2.indent}px` }, children: [(e5.title || e5.description) && r(e$, { style: { paddingLeft: `${32 * a2.indent}px` }, children: e5.description ? r(ef, { $title: r(eJ, { children: r(ei, { text: e5.description }) }), children: u("div", { children: [e5.title, " ", r(R, { path: L })] }) }) : r("span", { children: e5.title }) }), r(eR, { children: null === (l3 = n2.default) || void 0 === l3 ? void 0 : l3.call(n2) }), o2 && r(eS, { children: `${t3[i3]}` })] });
  }));
...
let eP = m(function() {
  ...
  let {} = t2;
  return () => r(ef, { $title: "复制当前节点为 JSON 字符串", children: r(ec, { type: "button", onClick: () => eP(JSON.stringify(e5.value, null, 2)), children: r(R, { path: P }) }) });
...
let ej = a(() => new eW()), ez = o((e5, t2) => {
  let n2, { render: l2 } = t2, a2 = f(null), o2 = f(null), p2 = f(null), c2 = e_.from(p2), h2 = eB.from(p2), y2 = ej.use(), v2 = eu.from(p2), m2 = eo.use();
  ...
  let g2 = () => {
    ...
    return 0;
  }, b2 = new i({ index: g2() }), w2 = () => {
    h2.next(""), v2.hide();
  }, C2 = () => {
    w2(), b2.next({ index: g2() }), Y(e5.value) && m2.delete(e5.ctx.path);
  }, $2 = (t3) => {
    var n3, l3, a3;
    if ("enums" === e5.typedef.type) {
      let l4 = null !== (n3 = N.schemaProp(e5.typedef, "enum")) && void 0 !== n3 ? n3 : [];
      null != t3 || (t3 = l4[b2.value.index % l4.length]);
  ...
  return (e5.allowRawJSON && d(h2, U((t3) => {
    let n3 = t3.trim();
    ...
    if (e6) {
      ...
      return l3(e6), z(d(H(e6, "blur"), U((t4) => {
        ...
        t4.preventDefault(), $2(e6.value);
      })), d(H(e6, "input"), U((e7) => {
        l3(e7.target), h2.next(e7.target.value);
      })));
    }
    return V;
  }))), s()), "enums" == e5.typedef.type) ? d(K([e5.value$, v2, b2]), l2((t3) => {
    var n3, l3, i2;
    let [d2, s2, { index: c3 }] = t3, u2 = null !== (n3 = N.schemaProp(e5.typedef, "enum")) && void 0 !== n3 ? n3 : [], h3 = null !== (l3 = N.metaProp(e5.typedef, "enumLabels")) && void 0 !== l3 ? l3 : [];
    return r(eF, { ref: o2, onClick: () => {
      v2.show();
    }, "data-type": typeof d2, tabindex: 0, children: s2 ? r(ey, { onSelected: (e6) => {
      $2(e6);
    }, open$: v2, $content: r("div", { ref: a2, children: u2.map((e6, t4) => r(eV, { "data-focus": c3 % u2.length === t4, value: e6, label: h3[t4] })) }), children: r("div", { "data-input-wrapper": true, children: r("input", { value: void 0 == d2 ? "" : `${d2}`, ref: p2, "data-options": true }) }) }) : r("span", { children: null !== (i2 = JSON.stringify(d2)) && void 0 !== i2 ? i2 : "undefined" }) });
    ...
    return r(eF, { ref: o2, onClick: () => {
      ...
      v2.show();
    }, children: l3 ? r(I, { isOpen: true, placement: "right-start", $content: u(eH, { ref: a2, children: [r(ec, { type: "button", onClick: () => c2.next({ type: "CANCEL" }), children: r(R, { path: M }) }), r(ec, { type: "button", onClick: () => c2.next({ type: "COMMIT" }), children: r(R, { path: B }) })] }), children: r("div", { "data-input-wrapper": true, children: r("textarea", { ref: p2, rows: 1, value: void 0 == n3 ? "" : `${n3}` }) }) }) : r("span", { "data-value": true, children: null !== (t3 = JSON.stringify(n3)) && void 0 !== t3 ? t3 : "undefined" }) });
  }));
}, { displayName: "ValueInput", props: ["typedef", "ctx", "value", "allowRawJSON"] }), eH = O("div", { displayName: "ValueInputActions" })({ borderRight: "1px solid", borderTop: "1px solid", borderBottom: "1px solid", borderColor: E("sys.outline-variant", T(0.38)), containerStyle: "sys.surface-container-lowest", roundedRight: "sm", display: "flex", px: 2, ml: -4 }), eF = O("div", { displayName: "ValueContainer" })({ wordBreak: "keep-all", whiteSpace: "nowrap", cursor: "pointer", display: "flex", alignItems: "center", font: "code", width: "100%", textStyle: "sys.label-small", fontSize: 12, lineHeight: 24, gap: 8, "& [data-value]": { border: "1px solid", borderColor: "rgba(0,0,0,0)", maxWidth: "40vw", width: "100%", overflow: "hidden", textOverflow: "ellipsis", _hover: { textOverflow: "clip", whiteSpace: "normal", wordBreak: "break-all" } }, "& [data-input-wrapper]": { width: "100%", maxWidth: "40vw", display: "flex", alignItems: "center", border: "1px solid", overflow: "hidden", borderColor: E("sys.outline-variant", T(0.38)) }, "& textarea,input": { border: "1px solid", borderColor: "rgba(0,0,0,0)", flex: 1, rounded: "xs", containerStyle: "sys.surface-container-lowest", width: "100%", outline: "none", px: 8, py: 0, m: 0, fontSize: "inherit", color: "inherit", lineHeight: "inherit", overflow: "hidden", resize: "none", "&[data-options]:focus": { roundedBottom: 0 } }, _type__string: { color: "sys.primary" }, _type__number: { color: "sys.primary" }, _type__boolean: { color: "sys.warning" }, _type__undefined: { color: "sys.error" } }), eU = O(em, { displayName: "EnumMenuItemContainer" })({ [`& ${ew}`]: { textAlign: "left" } }), eV = c((e5) => () => u(eU, { "data-value": e5.value, tabindex: 0, children: [r(ew, { children: e5.value }), e5.label && r(eJ, { children: e5.label })] }), { displayName: "EnumMenuItem", props: ["value", "label"] }), eK = o((e5, t2) => {
  let {} = e5, { emit: n2 } = t2;
  return () => r(ef, { $title: "删除属性", children: r(ec, { type: "button", onClick: () => n2("remove"), children: r(R, { path: _ }) }) });
  ...
  return d(e5.value$, n2((t3) => r(eE, { openToken: "{", closeToken: "}", $leading: r(ep, { children: r(eM, { value: t3 }) }), $trailing: r(eq, { ctx: e5.ctx, onAdd: (t4) => {
    ...
    return u(eI, { path: p2, dirty: l2.isDirty(d2, p2), title: N.metaProp(s2, "title"), description: N.metaProp(s2, "description"), children: [r(ew, { deprecated: N.schemaProp(s2, "deprecated"), $leading: r(eK, { onRemove: () => {
      l2.delete(p2);
    } }), children: String(o2) }), u(eb, { children: [":", " "] }), null === (i2 = a2.$value) || void 0 === i2 ? void 0 : i2.call(a2, s2, d2, { ...e5.ctx, path: p2, branch: [...e5.ctx.branch, d2] })] });
  }) })));
}, { displayName: "ObjectInput", props: ["typedef", "ctx", "value"] }), eq = o((e5, t2) => {
  let { emit: n2, render: l2 } = t2, a2 = f(null), o2 = e_.from(a2), p2 = eB.from(a2), c2 = eu.from(a2), h2 = eo.use(), y2 = new i({ index: 0 }), v2 = () => {
  ...
  d(p2, U((t3) => {
    ...
    if (n3.startsWith("{") && n3.endsWith("}")) try {
      let t4 = JSON.parse(n3);
      h2.update(e5.ctx.path, t4), v2();
    } catch (t4) {
      h2.setError(e5.ctx.path, "无效的 JSON 字符串");
    }
  }), s());
  let m2 = (t3) => {
    if (e5.options) {
    ...
    t3 ? (n2("add", t3), v2()) : h2.setError([...e5.ctx.path, N.RecordKey], "无效的属性值");
  };
  d(o2, U((e6) => {
    switch (e6.type) {
      case "SELECT":
  ...
  return d(K([p2, c2, y2, e5.options$]), l2((t3) => {
    ...
    return d2 ? d2.length > 0 ? r(eI, { path: e5.ctx.path, children: r(eF, { sx: { mx: -4 }, children: r(ey, { onSelected: (e6) => {
      m2(e6);
    }, open$: c2, $content: r("div", { children: d2.map((e6, t4) => n3 && !e6.propName.includes(n3) ? null : r(eG, { propName: e6.propName, typedef: e6.typedef, "data-focus": t4 === i2.index % d2.length })) }), children: x2 }) }) }) : null : r(eI, { path: [...e5.ctx.path, N.RecordKey], children: r(eF, { sx: { mx: -4 }, children: r(I, { isOpen: l3, placement: "right-start", $content: u(eH, { children: [r(ec, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: r(R, { path: M }) }), r(ec, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: r(R, { path: B }) })] }), children: r("div", { "data-input-wrapper": true, children: r("input", { ref: a2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)" }) }) }) }) });
  }));
}, { displayName: "PropValueInput", props: ["ctx", "options"], emits: ["add"] }), eG = c((e5) => () => u(eQ, { "data-value": e5.propName, tabindex: 0, children: [r(ew, { optional: N.schemaProp(e5.typedef, N.optional), children: e5.propName }), r(eJ, { children: N.metaProp(e5.typedef, "title") })] }), { displayName: "PropMenuItem", props: ["propName", "typedef"] }), eQ = O(em, { displayName: "AddPropMenuItemContainer" })({ [`& ${ew}`]: { textAlign: "left" } }), eY = o((e5, t2) => {
  let { render: n2 } = t2, l2 = eo.use(), a2 = ed.use();
  return d(e5.value$, n2((t3) => r(eE, { openToken: "[", closeToken: "]", $leading: r(ep, { children: r(eM, { value: t3 }) }), $trailing: r(eZ, { ctx: e5.ctx, typedef: e5.typedef, onAdd: (t4) => {
    ...
    return u(eI, { path: s2, dirty: l2.isDirty(o2, s2), children: [r(ew, { $leading: r(e0, { onRemove: () => {
      l2.delete(s2);
  ...
  let { emit: n2, render: l2 } = t2, a2 = f(null), i2 = eB.from(a2), o2 = e_.from(a2), p2 = eu.from(a2), c2 = eo.use(), h2 = () => {
  ...
  let v2 = d(p2, l2((e6) => r(I, { isOpen: e6, placement: "right-start", $content: u(eH, { children: [r(ec, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: r(R, { path: M }) }), r(ec, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: r(R, { path: B }) })] }), children: r("div", { "data-input-wrapper": true, children: r("input", { ref: a2, type: "text", placeholder: "添加数组项 (可粘贴 JSON 字符串)" }) }) })));
  ...
  let {} = e5, { emit: n2 } = t2;
  return () => r(ef, { $title: "移除项", children: r(ec, { type: "button", onClick: () => n2("remove"), children: r(R, { path: _ }) }) });
  ...
  return d(e5.value$, n2((t3) => r(eE, { openToken: "{", closeToken: "}", $leading: r(ep, { children: r(eM, { value: t3 }) }), $trailing: r(eq, { ctx: e5.ctx, onAdd: (t4) => {
    ...
    if (!Object.hasOwn(t3, o2)) return null;
    let p2 = [...e5.ctx.path, o2];
    return u(eI, { path: p2, dirty: l2.isDirty(d2, p2), children: [r(ew, { $leading: r(eK, { onRemove: () => {
      l2.delete(p2);
    } }), children: String(o2) }), u(eb, { children: [":", " "] }), null === (i2 = a2.$value) || void 0 === i2 ? void 0 : i2.call(a2, s2, d2, { ...e5.ctx, path: p2, branch: [...e5.ctx.branch, d2] })] });
  }) })));
}, { displayName: "RecordInput", props: ["ctx", "value", "typedef"] }), e2 = o((e5, t2) => {
  let { render: n2 } = t2;
  return d(e5.value$, n2((t3) => el(t3) ? r(eY, { value: t3, typedef: C(), ctx: e5.ctx }) : ea(t3) ? r(e1, { value: t3, typedef: $(S(), C()), ctx: e5.ctx }) : r(ez, { value: t3, typedef: C(), ctx: e5.ctx, allowRawJSON: true })));
  ...
  let {} = e5, { render: n2 } = t2, l2 = eo.use(), a2 = ed.use(), i2 = g(null);
  return d(l2, n2((e6) => {
    var t3, n3;
    let o2 = null !== (t3 = a2.$value) && void 0 !== t3 ? t3 : e8;
    return r(ej, { children: r(ed, { value: { $value: null !== (n3 = a2.$value) && void 0 !== n3 ? n3 : e8 }, children: u(e3, { children: [r("section", { ref: i2 }), i2.value && r(eO, { value: { indent: 0, $container: i2 }, children: r(eI, { path: [], viewOnly: true, children: o2(l2.typedef, e6, k) }) })] }) }) });
  }));
