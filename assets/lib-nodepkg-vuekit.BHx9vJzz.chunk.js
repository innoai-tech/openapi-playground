...
import { p as h, f as g, B as y, m, t as b, i as _ } from "./vendor-rxjs.BlC8C2kN.chunk.js";
    ...
    let { insert: l11, remove: a10, patchProp: s10, createElement: u10, createText: c10, createComment: f10, setText: p10, setElementText: d5, parentNode: h2, nextSibling: g2, setScopeId: y2 = o5, insertStaticContent: m2 } = e12, b2 = function(e13, t12, r11) {
      ...
      if (c11 > p11) {
        ...
        for (h3 = O3.length - 1, c11 = w3 - 1; c11 >= 0; c11--) {
          let e14 = y3 + c11, p12 = t12[e14], d9 = e14 + 1 < f11 ? t12[e14 + 1].el : o12;
          0 === A3[c11] ? b2(null, p12, r11, d9, l12, i10, a11, s11, u11) : E3 && (h3 < 0 || c11 !== O3[h3] ? B2(p12, r11, d9, 2) : h3--);
        }
      }
...
let fx = Symbol("component"), fR = (e11) => A(e11) && e11.__component === fx, fk = (e11) => A(e11) && Object.values(e11)[0] instanceof f;
function fC() {
  let e11;
  ...
  return { ...s10, get name() {
    ...
    s10.name = n;
  }, setup: (t11, r10) => e11(t11, r10), emits: f10.emits, props: f10.props, inheritAttrs: s10.inheritAttrs, __component: fx };
}
let fT = (e11, t10) => new Proxy(e11, { get(e12, r5) {
  var o10;
  return null !== (o10 = t10[r5]) && void 0 !== o10 ? o10 : e12[r5];
} }), fP = "undefined" != typeof document;
function fj(e11) {
  return "object" == typeof e11 || "displayName" in e11 || "props" in e11 || "__vccOpts" in e11;
}
let fM = Object.assign;
function fD(e11, t10) {
  let r5 = {};
  for (let o10 in t10) {
    let l10 = t10[o10];
    r5[o10] = fL(l10) ? l10.map(e11) : e11(l10);
  }
  return r5;
}
let fI = () => {
}, fL = Array.isArray, fF = /#/g, fN = /&/g, f$ = /\//g, fU = /=/g, fB = /\?/g, fV = /\+/g, fW = /%5B/g, fz = /%5D/g, fH = /%5E/g, fq = /%60/g, fG = /%7B/g, fK = /%7C/g, fY = /%7D/g, fX = /%20/g;
function fQ(e11) {
  return encodeURI("" + e11).replace(fK, "|").replace(fW, "[").replace(fz, "]");
}
function fZ(e11) {
  return fQ(e11).replace(fV, "%2B").replace(fX, "+").replace(fF, "%23").replace(fN, "%26").replace(fq, "`").replace(fG, "{").replace(fY, "}").replace(fH, "^");
}
function fJ(e11) {
  return null == e11 ? "" : fQ(e11).replace(fF, "%23").replace(fB, "%3F").replace(f$, "%2F");
}
function f0(e11) {
  try {
...
function f3(e11, t10) {
  ...
  }(null != o10 ? o10 : t10, r5)) + (i10 && "?") + i10 + a10, path: o10, query: l10, hash: f0(a10) };
}
function f4(e11, t10) {
...
function f8(e11, t10) {
  ...
  for (let l10 in e11) {
    var r5, o10;
    if (r5 = e11[l10], o10 = t10[l10], fL(r5) ? !f5(r5, o10) : fL(o10) ? !f5(o10, r5) : r5 !== o10) return false;
  }
  return true;
}
function f5(e11, t10) {
  return fL(t10) ? e11.length === t10.length && e11.every((e12, r5) => e12 === t10[r5]) : 1 === e11.length && e11[0] === t10;
}
let f7 = { path: "/", name: void 0, params: {}, query: {}, hash: "", fullPath: "/", matched: [], meta: {}, redirectedFrom: void 0 };
(D = X || (X = {})).pop = "pop", D.push = "push", (I = Q || (Q = {})).back = "back", I.forward = "forward", I.unknown = "";
let f9 = /^[^#]+#/;
function pe(e11, t10) {
  return e11.replace(f9, "#") + t10;
}
let pt = () => ({ left: window.scrollX, top: window.scrollY });
function pr(e11, t10) {
  return (history.state ? history.state.position - t10 : -1) + e11;
}
let pn = /* @__PURE__ */ new Map(), po = () => location.protocol + "//" + location.host;
function pl(e11, t10) {
  ...
  if (i10 > -1) {
    ...
    return "/" !== r10[0] && (r10 = "/" + r10), f4(r10, "");
  }
  return f4(r5, e11) + o10 + l10;
}
function pi(e11, t10, r5) {
  let o10 = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], l10 = arguments.length > 4 && void 0 !== arguments[4] && arguments[4];
  return { back: e11, current: t10, forward: r5, replaced: o10, position: window.history.length, scroll: l10 ? pt() : null };
}
function pa(e11) {
  let t10 = function(e12) {
    let { history: t11, location: r10 } = window, o11 = { value: pl(e12, r10) }, l10 = { value: t11.state };
    function i10(o12, i11, a10) {
      let s10 = e12.indexOf("#"), u10 = s10 > -1 ? (r10.host && document.querySelector("base") ? e12 : e12.slice(s10)) + o12 : po() + e12 + o12;
      try {
    ...
    return l10.value || i10(o11.value, { back: null, current: o11.value, forward: null, position: t11.length - 1, replaced: true, scroll: null }, true), { location: o11, state: l10, push: function(e13, r11) {
      let a10 = fM({}, l10.value, t11.state, { forward: e13, scroll: pt() });
      i10(a10.current, a10, true);
      let s10 = fM({}, pi(o11.value, e13, null), { position: a10.position + 1 }, r11);
      i10(e13, s10, false), o11.value = e13;
    }, replace: function(e13, r11) {
      let a10 = fM({}, t11.state, pi(l10.value.back, e13, l10.value.forward, true), r11, { position: l10.value.position });
    ...
    return "/" !== e12[0] && "#" !== e12[0] && (e12 = "/" + e12), f2(e12);
  }(e11)), r5 = function(e12, t11, r10, o11) {
    let l10 = [], i10 = [], a10 = null, s10 = (i11) => {
      let { state: s11 } = i11, u11 = pl(e12, location), c10 = r10.value, f10 = t11.value, p10 = 0;
      if (s11) {
    ...
    function u10() {
      ...
      e13.state && e13.replaceState(fM({}, e13.state, { scroll: pt() }), "");
    }
  ...
  }(e11, t10.state, t10.location, t10.replace), o10 = fM({ location: "", base: e11, go: function(e12) {
    let t11 = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
    t11 || r5.pauseListeners(), history.go(e12);
  }, createHref: pe.bind(null, e11) }, t10, r5);
...
let pu = Symbol("");
function pc(e11, t10) {
  return fM(Error(), { type: e11, [pu]: true }, t10);
}
function pf(e11, t10) {
  return e11 instanceof Error && pu in e11 && (null == t10 || !!(e11.type & t10));
}
(L = Z || (Z = {}))[L.aborted = 4] = "aborted", L[L.cancelled = 8] = "cancelled", L[L.duplicated = 16] = "duplicated";
let pp = "[^/]+?", pd = { sensitive: false, strict: false, start: true, end: true }, ph = /[.+*?^${}()[\]/\\]/g;
function pv(e11, t10) {
...
let py = { type: 0, value: "" }, pm = /[a-zA-Z0-9_]/;
function pb(e11, t10) {
  let r5 = {};
...
function pA(e11) {
  ...
  for (let e12 = 0; e12 < r5.length; ++e12) {
    let o10 = r5[e12].replace(fV, " "), l10 = o10.indexOf("="), i10 = f0(l10 < 0 ? o10 : o10.slice(0, l10)), a10 = l10 < 0 ? null : f0(o10.slice(l10 + 1));
    if (i10 in t10) {
      let e13 = t10[i10];
...
function pO(e11) {
  ...
  for (let r5 in e11) {
    let o10 = e11[r5];
    if (r5 = fZ(r5).replace(fU, "%3D"), null == o10) {
      void 0 !== o10 && (t10 += (t10.length ? "&" : "") + r5);
      continue;
    }
    (fL(o10) ? o10.map((e12) => e12 && fZ(e12)) : [o10 && fZ(o10)]).forEach((e12) => {
      void 0 !== e12 && (t10 += (t10.length ? "&" : "") + r5, null != e12 && (t10 += "=" + e12));
    });
  }
  return t10;
}
let px = Symbol(""), pR = Symbol(""), pk = Symbol(""), pC = Symbol(""), pT = Symbol("");
function pP() {
  let e11 = [];
...
function pj(e11, t10, r5, o10, l10) {
  ...
  return () => new Promise((s10, u10) => {
    let c10 = (e12) => {
      false === e12 ? u10(pc(4, { from: r5, to: t10 })) : e12 instanceof Error ? u10(e12) : "string" == typeof e12 || e12 && "object" == typeof e12 ? u10(pc(2, { from: t10, to: e12 })) : (a10 && o10.enterCallbacks[l10] === a10 && "function" == typeof e12 && a10.push(e12), s10());
    }, f10 = Promise.resolve(i10(() => e11.call(o10 && o10.instances[l10], t10, r5, c10)));
    e11.length < 3 && (f10 = f10.then(c10)), f10.catch((e12) => u10(e12));
  });
}
function pM(e11, t10, r5, o10) {
  ...
  for (let a10 of e11) for (let e12 in a10.components) {
    ...
    if ("beforeRouteEnter" === t10 || a10.instances[e12]) {
      if (fj(s10)) {
        ...
        u10 && i10.push(pj(u10, r5, o10, a10, e12, l10));
      } else {
        let u10 = s10();
        i10.push(() => u10.then((i11) => {
          if (!i11) throw Error(`Couldn't resolve component "${e12}" at "${a10.path}"`);
          let s11 = i11.__esModule || "Module" === i11[Symbol.toStringTag] || i11.default && fj(i11.default) ? i11.default : i11;
          a10.mods[e12] = i11, a10.components[e12] = s11;
          let u11 = (s11.__vccOpts || s11)[t10];
          return u11 && pj(u11, r5, o10, a10, e12, l10)();
        }));
      }
    }
  }
...
function pD(e11) {
  let t10 = sE(pk), r5 = sE(pC), o10 = uw(() => {
    let r10 = i3(e11.to);
    return t10.resolve(r10);
  }), l10 = uw(() => {
    let { matched: e12 } = o10.value, { length: t11 } = e12, l11 = e12[t11 - 1], i11 = r5.matched;
    if (!l11 || !i11.length) return -1;
    let a11 = i11.findIndex(f6.bind(null, l11));
    if (a11 > -1) return a11;
    let s10 = pL(e12[t11 - 2]);
    return t11 > 1 && pL(l11) === s10 && i11[i11.length - 1].path !== s10 ? i11.findIndex(f6.bind(null, e12[t11 - 2])) : a11;
    ...
    return true;
  }(r5.params, o10.value.params)), a10 = uw(() => l10.value > -1 && l10.value === r5.matched.length - 1 && f8(r5.params, o10.value.params));
  return { route: o10, href: uw(() => o10.value.href), isActive: i10, isExactActive: a10, navigate: function() {
    ...
    }(r10) ? Promise.resolve() : t10[i3(e11.replace) ? "replace" : "push"](i3(e11.to)).catch(fI);
  } };
}
let pI = /* @__PURE__ */ aq({ name: "RouterLink", compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: "page" } }, useLink: pD, setup(e11, t10) {
  let { slots: r5 } = t10, o10 = iV(pD(e11)), { options: l10 } = sE(pk), i10 = uw(() => ({ [pF(e11.activeClass, l10.linkActiveClass, "router-link-active")]: o10.isActive, [pF(e11.exactActiveClass, l10.linkExactActiveClass, "router-link-exact-active")]: o10.isExactActive }));
  return () => {
...
let pF = (e11, t10, r5) => null != e11 ? e11 : null != t10 ? t10 : r5, pN = /* @__PURE__ */ aq({ name: "RouterView", inheritAttrs: false, props: { name: { type: String, default: "default" }, route: Object }, compatConfig: { MODE: 3 }, setup(e11, t10) {
  let { attrs: r5, slots: o10 } = t10, l10 = sE(pT), i10 = uw(() => e11.route || l10.value), a10 = sE(pR, 0), s10 = uw(() => {
    let e12, t11 = i3(a10), { matched: r10 } = i10.value;
    for (; (e12 = r10[t11]) && !e12.components; ) t11++;
    return t11;
  }), u10 = uw(() => i10.value.matched[s10.value]);
  sw(pR, uw(() => s10.value + 1)), sw(px, u10), sw(pT, i10);
  let c10 = i0();
  return sH(() => [c10.value, u10.value, e11.name], (e12, t11) => {
    let [r10, o11, l11] = e12, [i11, a11, s11] = t11;
    o11 && (o11.instances[l11] = r10, a11 && a11 !== o11 && r10 && r10 === i11 && (o11.leaveGuards.size || (o11.leaveGuards = a11.leaveGuards), o11.updateGuards.size || (o11.updateGuards = a11.updateGuards))), !r10 || !o11 || a11 && f6(o11, a11) && i11 || (o11.enterCallbacks[l11] || []).forEach((e13) => e13(r10));
  }, { flush: "post" }), () => {
    let t11 = i10.value, l11 = e11.name, a11 = u10.value, s11 = a11 && a11.components[l11];
    if (!s11) return p$(o10.default, { Component: s11, route: t11 });
    let f10 = a11.props[l11], p10 = uE(s11, fM({}, f10 ? true === f10 ? t11.params : "function" == typeof f10 ? f10(t11) : f10 : null, r5, { onVnodeUnmounted: (e12) => {
      e12.component.isUnmounted && (a11.instances[l11] = null);
    }, ref: c10 }));
    return p$(o10.default, { Component: p10, route: t11 }) || p10;
  };
} });
function p$(e11, t10) {
  if (!e11) return null;
...
function pU(e11) {
  ...
  let l10 = function(e12, t11) {
    ...
    function l11(e13, a11, s11) {
      let u11, c11;
      let f11 = !s11, p11 = p_(e13);
      p11.aliasOf = s11 && s11.record;
      let d7 = pE(t11, e13), h3 = [p11];
      if ("alias" in e13) for (let t12 of "string" == typeof e13.alias ? [e13.alias] : e13.alias) h3.push(p_(fM({}, p11, { components: s11 ? s11.record.components : p11.components, path: t12, aliasOf: s11 ? s11.record : p11 })));
      for (let t12 of h3) {
        let { path: h4 } = t12;
        if (a11 && "/" !== h4[0]) {
        ...
        if (u11 = function(e14, t13, r11) {
          let o12 = function(e15, t14) {
            let r12 = fM({}, pd, t14), o13 = [], l13 = r12.start ? "^" : "", i12 = [];
            for (let t15 of e15) {
              ...
              for (let o14 = 0; o14 < t15.length; o14++) {
                ...
                if (0 === a13.type) o14 || (l13 += "/"), l13 += a13.value.replace(ph, "\\$&"), s12 += 40;
                else if (1 === a13.type) {
            ...
            return { re: a12, score: o13, keys: i12, parse: function(e16) {
              ...
              for (let l14 of e15) for (let e16 of (o14 && r13.endsWith("/") || (r13 += "/"), o14 = false, l14)) if (0 === e16.type) r13 += e16.value;
                ...
                if (fL(u12) && !a13) throw Error(`Provided param "${i13}" is an array but it is not repeatable (* or + modifiers)`);
                let c12 = fL(u12) ? u12.join("/") : u12;
                if (!c12) {
            ...
            for (; u12 < e15.length; ) {
              ...
              switch (l13) {
                ...
                case 4:
                  ...
                  break;
                case 1:
                  "(" === r12 ? l13 = 2 : pm.test(r12) ? c12 += r12 : (p12(), l13 = 0, "*" !== r12 && "?" !== r12 && "+" !== r12 && u12--);
                  break;
                case 2:
          ...
          }(e14.path), r11), l12 = fM(o12, { record: e14, parent: t13, children: [], alias: [] });
          return t13 && !l12.record.aliasOf == !t13.record.aliasOf && t13.children.push(l12), l12;
        }(t12, a11, d7), s11 ? s11.alias.push(u11) : ((c11 = c11 || u11) !== u11 && c11.alias.push(u11), f11 && e13.name && !pw(u11) && i11(e13.name)), pS(u11) && function(e14) {
          let t13 = function(e15, t14) {
            let r11 = 0, o12 = t14.length;
            for (; r11 !== o12; ) {
              let l13 = r11 + o12 >> 1;
              0 > pv(e15, t14[l13]) ? o12 = l13 : r11 = l13 + 1;
            }
            let l12 = function(e16) {
              let t15 = e16;
              for (; t15 = t15.parent; ) if (pS(t15) && 0 === pv(e16, t15)) return t15;
            }(e15);
            return l12 && (o12 = t14.lastIndexOf(l12, o12 - 1)), o12;
          }(e14, r10);
          r10.splice(t13, 0, e14), e14.record.name && !pw(e14) && o11.set(e14.record.name, e14);
        }(u11), p11.children) {
    ...
    return t11 = pE({ strict: false, end: true, sensitive: false }, t11), e12.forEach((e13) => l11(e13)), { addRoute: l11, resolve: function(e13, t12) {
      let l12, i12, a11;
      let s11 = {};
      if ("name" in e13 && e13.name) {
        if (!(l12 = o11.get(e13.name))) throw pc(1, { location: e13 });
        a11 = l12.record.name, s11 = fM(pb(t12.params, l12.keys.filter((e14) => !e14.optional).concat(l12.parent ? l12.parent.keys.filter((e14) => e14.optional) : []).map((e14) => e14.name)), e13.params && pb(e13.params, l12.keys.map((e14) => e14.name))), i12 = l12.stringify(s11);
      } else if (null != e13.path) i12 = e13.path, (l12 = r10.find((e14) => e14.re.test(i12))) && (s11 = l12.parse(i12), a11 = l12.record.name);
      else {
        if (!(l12 = t12.name ? o11.get(t12.name) : r10.find((e14) => e14.re.test(t12.path)))) throw pc(1, { location: e13, currentLocation: t12 });
        a11 = l12.record.name, s11 = fM({}, t12.params, e13.params), i12 = l12.stringify(s11);
      }
      let u11 = [], c11 = l12;
      for (; c11; ) u11.unshift(c11.record), c11 = c11.parent;
      return { name: a11, path: i12, params: s11, matched: u11, meta: u11.reduce((e14, t13) => fM(e14, t13.meta), {}) };
  ...
  }(e11.routes, e11), i10 = e11.parseQuery || pA, a10 = e11.stringifyQuery || pO, s10 = e11.history, u10 = pP(), c10 = pP(), f10 = pP(), p10 = i1(f7, true), d5 = f7;
  fP && e11.scrollBehavior && "scrollRestoration" in history && (history.scrollRestoration = "manual");
  let h2 = fD.bind(null, (e12) => "" + e12), g2 = fD.bind(null, fJ), y2 = fD.bind(null, f0);
  function m2(e12, t11) {
    let r10;
    if (t11 = fM({}, t11 || p10.value), "string" == typeof e12) {
      let r11 = f3(i10, e12, t11.path), o12 = l10.resolve({ path: r11.path }, t11), a11 = s10.createHref(r11.fullPath);
      return fM(r11, o12, { params: y2(o12.params), hash: f0(r11.hash), redirectedFrom: void 0, href: a11 });
    }
    if (null != e12.path) r10 = fM({}, e12, { path: f3(i10, e12.path, t11.path).path });
    else {
      let o12 = fM({}, e12.params);
      for (let e13 in o12) null == o12[e13] && delete o12[e13];
      r10 = fM({}, e12, { params: g2(o12) }), t11.params = g2(t11.params);
    }
    ...
    }(a10, fM({}, e12, { hash: fQ(u11).replace(fG, "{").replace(fY, "}").replace(fH, "^"), path: o11.path })), f11 = s10.createHref(c11);
    return fM({ fullPath: c11, hash: u11, query: a10 === pO ? function(e13) {
      let t12 = {};
      for (let r11 in e13) {
        let o12 = e13[r11];
  ...
  function b2(e12) {
    return "string" == typeof e12 ? f3(i10, e12, p10.value.path) : fM({}, e12);
  }
  function _2(e12, t11) {
    if (d5 !== e12) return pc(8, { from: t11, to: e12 });
  }
  function w2(e12) {
    let t11 = e12.matched[e12.matched.length - 1];
    if (t11 && t11.redirect) {
      let { redirect: r10 } = t11, o11 = "function" == typeof r10 ? r10(e12) : r10;
      return "string" == typeof o11 && ((o11 = o11.includes("?") || o11.includes("#") ? o11 = b2(o11) : { path: o11 }).params = {}), fM({ query: e12.query, hash: e12.hash, params: null != o11.path ? {} : e12.params }, o11);
    }
  }
  function E2(e12, t11) {
    let r10;
    let o11 = d5 = m2(e12), l11 = p10.value, i11 = e12.state, s11 = e12.force, u11 = true === e12.replace, c11 = w2(o11);
    return c11 ? E2(fM(b2(c11), { state: "object" == typeof c11 ? fM({}, i11, c11.state) : i11, force: s11, replace: u11 }), t11 || o11) : (o11.redirectedFrom = t11, !s11 && function(e13, t12, r11) {
      let o12 = t12.matched.length - 1, l12 = r11.matched.length - 1;
      return o12 > -1 && o12 === l12 && f6(t12.matched[o12], r11.matched[l12]) && f8(t12.params, r11.params) && e13(t12.query) === e13(r11.query) && t12.hash === r11.hash;
    }(a10, l11, o11) && (r10 = pc(16, { to: o11, from: l11 }), j2(l11, l11, true, false)), (r10 ? Promise.resolve(r10) : O2(o11, l11)).catch((e13) => pf(e13) ? pf(e13, 2) ? e13 : P2(e13) : T2(e13, o11, l11)).then((e13) => {
      if (e13) {
        if (pf(e13, 2)) return E2(fM({ replace: u11 }, b2(e13.to), { state: "object" == typeof e13.to ? fM({}, i11, e13.to.state) : i11, force: s11 }), t11 || o11);
  ...
  function O2(e12, t11) {
    ...
    let [o11, l11, i11] = function(e13, t12) {
      ...
      for (let a12 = 0; a12 < i12; a12++) {
        ...
        i13 && (e13.matched.find((e14) => f6(e14, i13)) ? o12.push(i13) : r11.push(i13));
        let s11 = e13.matched[a12];
        s11 && !t12.matched.find((e14) => f6(e14, s11)) && l12.push(s11);
      }
      return [r11, o12, l12];
    }(e12, t11);
    for (let l12 of (r10 = pM(o11.reverse(), "beforeRouteLeave", e12, t11), o11)) l12.leaveGuards.forEach((o12) => {
      r10.push(pj(o12, e12, t11));
    });
    let a11 = S2.bind(null, e12, t11);
    return r10.push(a11), L2(r10).then(() => {
      for (let o12 of (r10 = [], u10.list())) r10.push(pj(o12, e12, t11));
      return r10.push(a11), L2(r10);
    }).then(() => {
      for (let o12 of (r10 = pM(l11, "beforeRouteUpdate", e12, t11), l11)) o12.updateGuards.forEach((o13) => {
        r10.push(pj(o13, e12, t11));
      });
      return r10.push(a11), L2(r10);
    }).then(() => {
      for (let o12 of (r10 = [], i11)) if (o12.beforeEnter) {
        if (fL(o12.beforeEnter)) for (let l12 of o12.beforeEnter) r10.push(pj(l12, e12, t11));
        else r10.push(pj(o12.beforeEnter, e12, t11));
      }
      return r10.push(a11), L2(r10);
    }).then(() => (e12.matched.forEach((e13) => e13.enterCallbacks = {}), (r10 = pM(i11, "beforeRouteEnter", e12, t11, A2)).push(a11), L2(r10))).then(() => {
      for (let o12 of (r10 = [], c10.list())) r10.push(pj(o12, e12, t11));
      return r10.push(a11), L2(r10);
    }).catch((e13) => pf(e13, 8) ? e13 : Promise.reject(e13));
  }
  ...
  function R2(e12, t11, r10, o11, l11) {
    let i11 = _2(e12, t11);
    if (i11) return i11;
    let a11 = t11 === f7, u11 = fP ? history.state : {};
    r10 && (o11 || a11 ? s10.replace(e12.fullPath, fM({ scroll: a11 && u11 && u11.scroll }, l11)) : s10.push(e12.fullPath, l11)), p10.value = e12, j2(e12, t11, r10, a11), P2();
  }
  let k2 = pP(), C2 = pP();
  ...
  function P2(e12) {
    return r5 || (r5 = !e12, t10 || (t10 = s10.listen((e13, t11, r10) => {
      ...
      if (l11) {
        E2(fM(l11, { replace: true }), o11).catch(fI);
        return;
      }
      d5 = o11;
      let i11 = p10.value;
      if (fP) {
        var a11, u11;
        a11 = pr(i11.fullPath, r10.delta), u11 = pt(), pn.set(a11, u11);
      }
      O2(o11, i11).catch((e14) => pf(e14, 12) ? e14 : pf(e14, 2) ? (E2(e14.to, o11).then((e15) => {
        pf(e15, 20) && !r10.delta && r10.type === X.pop && s10.go(-1, false);
      }).catch(fI), Promise.reject()) : (r10.delta && s10.go(-r10.delta, false), T2(e14, o11, i11))).then((e14) => {
        (e14 = e14 || R2(o11, i11, false)) && (r10.delta && !pf(e14, 8) ? s10.go(-r10.delta, false) : r10.type === X.pop && pf(e14, 20) && s10.go(-1, false)), x2(o11, i11, e14);
      }).catch(fI);
    })), k2.list().forEach((t11) => {
      let [r10, o11] = t11;
  ...
  function j2(t11, r10, o11, l11) {
    ...
    if (!fP || !i11) return Promise.resolve();
    let a11 = !o11 && function(e12) {
      let t12 = pn.get(e12);
      return pn.delete(e12), t12;
    }(pr(t11.fullPath, 0)) || (l11 || !o11) && history.state && history.state.scroll || null;
  ...
  let M2 = (e12) => s10.go(e12), D2 = /* @__PURE__ */ new Set(), I2 = { currentRoute: p10, listening: true, addRoute: function(e12, t11) {
    let r10, o11;
    return ps(e12) ? (r10 = l10.getRecordMatcher(e12), o11 = t11) : o11 = e12, l10.addRoute(o11, r10);
    ...
    return E2(fM(b2(e12), { replace: true }));
  }, go: M2, back: () => M2(-1), forward: () => M2(1), beforeEach: u10.add, beforeResolve: c10.add, afterEach: f10.add, onError: C2.add, isReady: function() {
    return r5 && p10.value !== f7 ? Promise.resolve() : new Promise((e12, t11) => {
      k2.add([e12, t11]);
    });
  }, install(e12) {
    e12.component("RouterLink", pI), e12.component("RouterView", pN), e12.config.globalProperties.$router = this, Object.defineProperty(e12.config.globalProperties, "$route", { enumerable: true, get: () => i3(p10) }), fP && !o10 && p10.value === f7 && (o10 = true, E2(s10.location).catch((e13) => {
    }));
    let l11 = {};
    for (let e13 in f7) Object.defineProperty(l11, e13, { get: () => p10.value[e13], enumerable: true });
    e12.provide(pk, this), e12.provide(pC, iW(l11)), e12.provide(pT, p10);
    let i11 = e12.unmount;
    D2.add(e12), e12.unmount = function() {
      D2.delete(e12), D2.size < 1 && (d5 = f7, t10 && t10(), t10 = null, p10.value = f7, o10 = false, r5 = false), i11();
    };
  } };
  function L2(e12) {
...
function dI(e11) {
  return (t10) => {
    ...
    }), a8(() => null == r5 ? void 0 : r5.unsubscribe());
  };
}
function dL(e11) {
  return (t10) => dM(dF, { elem$: t10.pipe(m((t11) => () => e11(t11))), children: {} });
}
let dF = fC({ elem$: p(), $default: p() }, (e11, t10) => {
  let r5 = i1(null, true);
  return pH(e11.elem$, b((e12) => {
    r5.value = e12;
  }), dD()), () => {
    var e12;
...
function dU() {
  ...
  return fC(l10, (t11, r10) => {
    let o11 = d$(t11), l11 = new Proxy({}, { get(e12, r11) {
      var l12;
      return null !== (l12 = t11[r11]) && void 0 !== l12 ? l12 : o11[r11];
    } }), i11 = new Proxy({}, { get: (e12, t12) => "render" === t12 ? dL : r10[t12] }), a10 = e11(l11, i11);
...
let dB = (e11) => {
  ...
  let r5 = null;
  return b({ next: (o10) => {
    dV(o10, r5) || (null == t10 || t10(), t10 = e11(o10), r5 = o10);
  }, unsubscribe: () => {
    null == t10 || t10();
  } });
};
function dz() {
  ...
  if (R(u10) && R(c10.props)) {
    ...
    return fT(fC({ value: p().optional(), $default: p().optional() }, (e13, t11) => {
      var o11;
      let { slots: l11 } = t11;
  ...
  return fT(fC({ ...u10, $default: p().optional() }, (r10, o11) => {
    let { slots: l11 } = o11;
...
var dH = tn("match"), dq = Math.floor, dG = eO("".charAt), dK = eO("".replace), dY = eO("".slice), dX = /\$([$&'`]|\d{1,2}|<[^>]*>)/g, dQ = /\$([$&'`]|\d{1,2})/g, dZ = function(e11) {
  var t10;
  return eu(e11) && (void 0 !== (t10 = e11[dH]) ? !!t10 : "RegExp" === tX(e11));
}, dJ = function(e11, t10, r5, o10, l10, i10) {
  var a10 = r5 + e11.length, s10 = o10.length, u10 = dQ;
  return void 0 !== l10 && (l10 = e3(l10), u10 = dX), dK(i10, u10, function(i11, u11) {
    var c10;
    switch (dG(u11, 0)) {
      case "$":
        return "$";
      ...
      default:
        ...
        if (f10 > s10) {
          var p10 = dq(f10 / 10);
          if (0 === p10) return i11;
          if (p10 <= s10) return void 0 === o10[p10 - 1] ? dG(u11, 1) : o10[p10 - 1] + dG(u11, 1);
          return i11;
        }
        c10 = o10[f10 - 1];
    }
...
}, d0 = tn("replace"), d1 = TypeError, d2 = eO("".indexOf);
eO("".replace);
var d3 = eO("".slice), d4 = Math.max;
rY({ target: "String", proto: true }, { replaceAll: function(e11, t10) {
  var r5, o10, l10, i10, a10, s10, u10, c10, f10 = e1(this), p10 = 0, d5 = "";
  if (!ez(e11)) {
    if (dZ(e11) && !~d2(t3(e1(cg(e11))), "g")) throw new d1("`.replaceAll` does not allow non-global regexes");
    if (r5 = eH(e11, d0)) return e_(r5, e11, f10, t10);
  }
  for (o10 = t3(f10), l10 = t3(e11), (i10 = en(t10)) || (t10 = t3(t10)), s10 = d4(1, a10 = l10.length), u10 = d2(o10, l10); -1 !== u10; ) c10 = i10 ? t3(t10(l10, u10, o10)) : dJ(l10, o10, u10, [], void 0, t10), d5 += d3(o10, p10, u10) + c10, p10 = u10 + a10, u10 = u10 + s10 > o10.length ? -1 : d2(o10, l10, u10 + s10);
  return p10 < o10.length && (d5 += d3(o10, p10)), d5;
} }), rY({ target: "Object", stat: true }, { hasOwn: e6 });
let d6 = {}, d8 = function(e11, t10, r5) {
  ...
  if (t10 && t10.length > 0) {
    ...
    o10 = Promise.allSettled(t10.map((e13) => {
      if ((e13 = "/__APP_BASE_HREF__/" + e13) in d6) return;
      d6[e13] = true;
