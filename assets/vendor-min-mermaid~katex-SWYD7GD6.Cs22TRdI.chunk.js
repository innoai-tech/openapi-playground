...
var c0 = class r {
    static #_ = m$1(this, "SourceLocation");
    constructor(e, t, a){
...
var xr = m$1(function r(e) {
    ...
    maxExpand: {
        ...
        processor: m$1((r)=>Math.max(0, r), "processor"),
        cli: "-e, --max-expand <n>",
        cliProcessor: m$1((r)=>r === "Infinity" ? 1 / 0 : parseInt(r), "cliProcessor")
    },
    globalGroup: {
        type: "boolean",
        cli: false
...
}, kt = 0, Ee = 1, re = 2, q0 = 3, ce = 4, p0 = 5, ae = 6, i0 = 7, k0 = [
    new w0(kt, 0, false),
    new w0(Ee, 0, true),
    new w0(re, 1, false),
    new w0(q0, 1, true),
...
var Re = [];
ht.forEach((r)=>r.blocks.forEach((e)=>Re.push(...e)));
function wr(r) {
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`;
    ...
    static #_ = m$1(this, "DocumentFragment");
    constructor(e){
...
function St(r, e, t) {
    ...
    var a = r.charCodeAt(0), n = S0[e][a];
    if (!n && r[0] in Yt && (a = Yt[r[0]].charCodeAt(0), n = S0[e][a]), !n && t === "text" && wr(a) && (n = S0[e][77]), n) return {
        depth: n[0],
        height: n[1],
        italic: n[2],
        skew: n[3],
...
var oe, ze, Ae = [
    ...
    if (G0(r.classes) !== G0(e.classes) || r.skew !== e.skew || r.maxFontSize !== e.maxFontSize) return false;
    ...
    for(var e = 0; e < r.length - 1; e++){
        var t = r[e], a = r[e + 1];
        t instanceof h0 && a instanceof h0 && n1(t, a) && (t.text += a.text, t.height = Math.max(t.height, a.height), t.depth = Math.max(t.depth, a.depth), t.italic = a.italic, r.splice(e + 1, 1), e--);
    }
    return r;
    ...
    return Mt(s), s;
}, "makeSpan"), Tr = m$1((r, e, t, a)=>new j0(r, e, t, a), "makeSvgSpan"), s1 = m$1(function(e, t, a) {
    var n = o0([
        e
    ], [], t);
...
}, "buildExpression"), Jt = m$1(function r(e, t, a, n, s) {
    n && e.push(n);
...
}, "checkPartialGroup"), y1 = m$1(function r(e, t) {
    var a = Nr(e);
    if (a) {
        var n = a.children;
        if (n.length) {
...
var Bt = m$1((r, e)=>{
    var t, a, n;
    r && r.type === "supsub" ? (a = L(r.base, "accent"), t = a.base, r.base = t, n = Ja(G(r, e)), r.base = a) : (a = L(r, "accent"), t = a.base);
...
}, "htmlBuilder$a"), Or = m$1((r, e)=>{
    var t = r.isStretchy ? E0.mathMLnode(r.label) : new M.MathNode("mo", [
        g0(r.label, r.mode)
...
D({
    ...
    handler: m$1((r, e)=>{
        var t = Le(e[0]), a = !B1.test(r.funcName), n = !a || r.funcName === "\\widehat" || r.funcName === "\\widetilde" || r.funcName === "\\widecheck";
        return {
            type: "accent",
            mode: r.parser.mode,
            label: r.funcName,
...
D({
    ...
    htmlBuilder: m$1((r, e)=>{
        var t = G(r.base, e), a = E0.svgSpan(r, e), n = r.label === "\\utilde" ? .12 : 0, s = y.makeVList({
            positionType: "top",
    ...
    mathmlBuilder: m$1((r, e)=>{
        var t = E0.mathMLnode(r.label), a = new M.MathNode("munder", [
            $(r.base, e),
            t
        ]);
...
D({
    ...
    htmlBuilder (r, e) {
        var t = e.style, a = e.havingStyle(t.sup()), n = y.wrapFragment(G(r.body, a, e), e), s = r.label.slice(0, 2) === "\\x" ? "x" : "cd";
        n.classes.push(s + "-arrow-pad");
        var o;
        r.below && (a = e.havingStyle(t.sub()), o = y.wrapFragment(G(r.below, a, e), e), o.classes.push(s + "-arrow-pad"));
        var h = E0.svgSpan(r, e), c = -e.fontMetrics().axisHeight + .5 * h.height, v = -e.fontMetrics().axisHeight - .5 * h.height - .111;
...
D({
    ...
    htmlBuilder (r, e) {
        var t = r0(r.body, e, true), a = y.makeSpan([
            r.mclass
        ], t, e);
        return a.style.textShadow = "0.02em 0.01em 0.04px", a;
    },
    mathmlBuilder (r, e) {
        var t = m0(r.body, e), a = new M.MathNode("mstyle", t);
...
var C1 = {
    ...
    ".": "no arrow"
        ...
        mode: "math",
        style: "display"
    }), "newCell"), er = m$1((r)=>r.type === "textord" && r.text === "@", "isStartOfArrow"), q1 = m$1((r, e)=>(r.type === "mathord" || r.type === "atom") && r.text === e, "isLabelEnd");
function N1(r, e, t) {
    var a = C1[r];
    switch(a){
        case "\\\\cdrightarrow":
...
D({
    ...
    htmlBuilder (r, e) {
        var t = e.havingStyle(e.style.sup()), a = y.wrapFragment(G(r.label, t, e), e);
...
D({
    ...
    htmlBuilder (r, e) {
        var t = y.wrapFragment(G(r.fragment, e), e);
...
D({
    ...
    handler (r, e) {
        for(var { parser: t } = r, a = L(e[0], "ordgroup"), n = a.body, s = "", o = 0; o < n.length; o++){
            var h = L(n[o], "textord");
            s += h.text;
        }
        var c = parseInt(s), v;
...
}, "htmlBuilder$8"), Pr = m$1((r, e)=>{
    var t = m0(r.body, e.withColor(r.color)), a = new M.MathNode("mstyle", t);
...
D({
    ...
    handler (r) {
        var { parser: e, funcName: t } = r, a = Gr(e.gullet.popToken());
...
D({
    ...
    handler (r) {
        var { parser: e, funcName: t } = r, a = Gr(e.gullet.popToken()), n = e.gullet.popToken(), s = e.gullet.popToken();
...
var ue = m$1(function(e, t, a) {
...
}, "makeStackedDelim"), at = 80, nt = .08, it = m$1(function(e, t, a, n, s) {
    ...
    return n.type === "small" ? (b = 1e3 + 1e3 * o + at, e < 1 ? s = 1 : e < 1.4 && (s = .7), c = (1 + o + nt) / s, v = (1 + o) / s, h = it("sqrtMain", c, b, o, t), h.style.minWidth = "0.853em", x = .833 / s) : n.type === "large" ? (b = (1e3 + at) * he[n.size], v = (he[n.size] + o) / s, c = (he[n.size] + o + nt) / s, h = it("sqrtSize" + n.size, c, b, o, t), h.style.minWidth = "1.02em", x = 1 / s) : (c = e + o + nt, v = e + o, b = Math.floor(1e3 * e + o) + at, h = it("sqrtTall", c, b, o, t), h.style.minWidth = "0.742em", x = 1.056), h.height = v, h.style.height = T(c), {
        span: h,
        advanceWidth: x,
...
D({
    ...
    handler: m$1((r, e)=>{
        ...
        return {
            type: "delimsizing",
            mode: r.parser.mode,
            size: tr[r.funcName].size,
            mclass: tr[r.funcName].mclass,
            delim: t.text
        };
    }, "handler"),
    htmlBuilder: m$1((r, e)=>r.delim === "." ? y.makeSpan([
            r.mclass
        ]) : N0.sizedDelim(r.delim, r.size, e, r.mode, [
            r.mclass
        ]), "htmlBuilder"),
    mathmlBuilder: m$1((r)=>{
        var e = [];
        ...
        var a = T(N0.sizeToMaxHeight[r.size]);
...
D({
    ...
    htmlBuilder: m$1((r, e)=>{
        ...
        if (r.left === "." ? h = pe(e, [
            "mopen"
        ]) : h = N0.leftRightDelim(r.left, a, n, e, r.mode, [
            "mopen"
        ]), t.unshift(h), s) for(var c = 1; c < t.length; c++){
            var v = t[c], b = v.isMiddle;
            b && (t[c] = N0.leftRightDelim(b.delim, a, n, b.options, r.mode, []));
        }
        var x;
        if (r.right === ".") x = pe(e, [
            "mclose"
            ...
            x = N0.leftRightDelim(r.right, a, n, k, r.mode, [
                "mclose"
            ]);
        }
...
D({
    ...
    mathmlBuilder: m$1((r, e)=>{
        var t = r.delim === "\\vert" || r.delim === "|" ? g0("|", "text") : g0(r.delim, r.mode), a = new M.MathNode("mo", [
            t
        ]);
...
var Ct = m$1((r, e)=>{
    var t = y.wrapFragment(G(r.body, e), e), a = r.label.slice(1), n = e.sizeMultiplier, s, o = 0, h = R.isCharacterBox(r.body);
    if (a === "sout") s = y.makeSpan([
        ...
        var B = 0, q = 0, N = 0;
        /box/.test(a) ? (N = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness), B = e.fontMetrics().fboxsep + (a === "colorbox" ? 0 : N), q = B) : a === "angl" ? (N = Math.max(e.fontMetrics().defaultRuleThickness, e.minRuleThickness), B = 4 * N, q = Math.max(0, .25 - t.depth)) : (B = h ? .2 : 0, q = B), s = E0.encloseSpan(t, a, B, q, e), /fbox|boxed|fcolorbox/.test(a) ? (s.style.borderStyle = "solid", s.style.borderWidth = T(N)) : a === "angl" && N !== .049 && (s.style.borderTopWidth = T(N), s.style.borderRightWidth = T(N)), o = t.depth + q, r.backgroundColor && (s.style.backgroundColor = r.backgroundColor, r.borderColor && (s.style.borderColor = r.borderColor));
    }
    var H;
    if (r.backgroundColor) H = y.makeVList({
        positionType: "individualShift",
        children: [
            {
                type: "elem",
...
function U0(r, e, t) {
    ...
    m$1(F, "beginRow");
    function U() {
        H && (r.gullet.macros.get("\\df@tag") ? (H.push(r.subparse([
            new v0("\\df@tag")
        ])), r.gullet.macros.set("\\df@tag", void 0, true)) : H.push(!!c && r.gullet.macros.get("\\@eqnsw") === "1"));
    }
    for(m$1(U, "endRow"), F(), N.push(ar(r));;){
        var P = r.parseExpression(false, v ? "\\end" : "\\\\");
        ...
        if (Y === "&") {
            ...
            r.consume();
            var V = void 0;
            r.gullet.future().text !== " " && (V = r.parseSizeGroup(true)), q.push(V ? V.value : null), U(), N.push(ar(r)), A = [], B.push(A), F();
...
var A0 = m$1(function(e, t) {
    ...
    var A = e.colSeparationType === "CD" ? Q({
        number: 3,
        unit: "ex"
    }, t) : 12 * x, B = 3 * x, q = e.arraystretch * A, N = .7 * q, H = .3 * q, F = 0;
    function U(ye) {
...
z0({
    ...
    handler (r, e) {
        ...
        return U0(r.parser, s, Rt(r.envName));
    },
    htmlBuilder: A0,
    mathmlBuilder: T0
});
z0({
    ...
    handler (r) {
        ...
        var s = U0(r.parser, a, Rt(r.envName)), o = Math.max(0, ...s.body.map((h)=>h.length));
...
z0({
    ...
    handler (r, e) {
        ...
        if (s = U0(r.parser, s, "script"), s.body.length > 0 && s.body[0].length > 1) throw new z("{subarray} can contain only one column");
        return s;
    },
    htmlBuilder: A0,
    mathmlBuilder: T0
...
D({
    ...
    handler: m$1((r, e)=>{
        var { parser: t } = r, a = e[0], n = R.isCharacterBox(a);
        return {
            type: "mclass",
            mode: t.mode,
            mclass: Xe(a),
...
D({
    ...
    handler: m$1((r, e)=>{
        var { parser: t, funcName: a, breakOnTokenText: n } = r, { mode: s } = t, o = t.parseExpression(true, n), h = "math" + a.slice(1);
        return {
            type: "font",
            mode: s,
            font: h,
...
var ra = m$1((r, e)=>{
...
}, "adjustStyle"), Et = m$1((r, e)=>{
    var t = ra(r.size, e.style), a = t.fracNum(), n = t.fracDen(), s;
    s = e.havingStyle(a);
    var o = G(r.numer, s, e);
    if (r.continued) {
    ...
    if (b) {
        ...
        w - o.depth - (H + .5 * x) < A && (w += A - (w - o.depth - (H + .5 * x))), H - .5 * x - (v.height - B) < A && (B += A - (H - .5 * x - (v.height - B)));
        var F = -(H - .5 * x);
        q = y.makeVList({
            positionType: "individualShift",
            children: [
        ...
        N < A && (w += .5 * (A - N), B += .5 * (A - N)), q = y.makeVList({
            positionType: "individualShift",
            children: [
                {
                    type: "elem",
    ...
    var P, Y;
    return r.leftDelim == null ? P = pe(e, [
        "mopen"
    ]) : P = N0.customSizedDelim(r.leftDelim, U, true, e.havingStyle(t), r.mode, [
        "mopen"
    ]), r.continued ? Y = y.makeSpan([]) : r.rightDelim == null ? Y = pe(e, [
        "mclose"
    ]) : Y = N0.customSizedDelim(r.rightDelim, U, true, e.havingStyle(t), r.mode, [
        "mclose"
    ]), y.makeSpan([
        "mord"
...
D({
    ...
    handler (r, e) {
        var { parser: t } = r, a = e[4], n = e[5], s = Le(e[0]), o = s.type === "atom" && s.family === "open" ? lr(s.text) : null, h = Le(e[1]), c = h.type === "atom" && h.family === "close" ? lr(h.text) : null, v = L(e[2], "size"), b, x = null;
...
D({
    ...
    handler: m$1((r, e)=>{
        var { parser: t, funcName: a } = r, n = e[0], s = Aa(L(e[1], "infix").size), o = e[2], h = s.number > 0;
        return {
            type: "genfrac",
            mode: t.mode,
            numer: n,
...
D({
    ...
    mathmlBuilder: m$1((r, e)=>V0(r.body, e), "mathmlBuilder")
});
D({
    type: "htmlmathml",
    names: [
    ...
    mathmlBuilder: m$1((r, e)=>V0(r.mathml, e), "mathmlBuilder")
});
...
D({
    ...
    handler (r, e) {
        var { parser: t, funcName: a } = r, n = L(e[0], "size");
...
var na = m$1((r, e, t, a, n, s, o)=>{
    ...
    var t, a, n = false, s;
    r.type === "supsub" ? (t = r.sup, a = r.sub, s = L(r.base, "op"), n = true) : s = L(r, "op");
    ...
    var t;
    if (r.symbol) t = new u0("mo", [
        g0(r.name, r.mode)
    ]), R.contains(ia, r.name) && t.setAttribute("largeop", "false");
    else if (r.body) t = new u0("mo", m0(r.body, e));
    else {
        t = new u0("mi", [
            new $0(r.name.slice(1))
        ]);
        var a = new u0("mo", [
            g0("\u2061", "text")
        ]);
        r.parentIsSupSub ? t = new u0("mrow", [
            t,
            a
        ]) : t = Rr([
            t,
...
var sa = m$1((r, e)=>{
    var t, a, n = false, s;
    r.type === "supsub" ? (t = r.sup, a = r.sub, s = L(r.base, "operatorname"), n = true) : s = L(r, "operatorname");
    var o;
    if (s.body.length > 0) {
...
Z0({
    type: "ordgroup",
    htmlBuilder (r, e) {
        return r.semisimple ? y.makeFragment(r0(r.body, e, false)) : y.makeSpan([
            "mord"
        ], r0(r.body, e, true), e);
    },
    mathmlBuilder (r, e) {
        return V0(r.body, e, true);
    }
});
D({
    type: "overline",
    ...
    htmlBuilder (r, e) {
        var t = G(r.body, e.havingCrampedStyle()), a = y.makeLineSpan("overline-line", e), n = e.fontMetrics().defaultRuleThickness, s = y.makeVList({
            positionType: "firstBaseline",
            children: [
                {
                    type: "elem",
...
D({
    ...
    mathmlBuilder: m$1((r, e)=>{
        var t = m0(_(r.body), e), a = new M.MathNode("mphantom", t), n = new M.MathNode("mpadded", [
            a
        ]);
...
D({
    ...
    handler (r, e, t) {
        var { parser: a } = r, n = t[0], s = L(e[0], "size"), o = L(e[1], "size");
        return {
            type: "rule",
            mode: a.mode,
    ...
    htmlBuilder (r, e) {
        var t = y.makeSpan([
            "mord",
            "rule"
        ], [], e), a = Q(r.width, e), n = Q(r.height, e), s = r.shift ? Q(r.shift, e) : 0;
    ...
    mathmlBuilder (r, e) {
        var t = Q(r.width, e), a = Q(r.height, e), n = r.shift ? Q(r.shift, e) : 0, s = e.color && e.getColor() || "black", o = new M.MathNode("mspace");
...
function la(r, e, t) {
    for(var a = r0(r, e, false), n = e.sizeMultiplier / t.sizeMultiplier, s = 0; s < a.length; s++){
...
D({
    ...
    htmlBuilder: Q1,
    mathmlBuilder: m$1((r, e)=>{
        var t = e.havingSize(r.size), a = m0(r.body, t), n = new M.MathNode("mstyle", a);
...
D({
    ...
    htmlBuilder (r, e) {
        ...
        if (r.index) {
            var A = e.havingStyle(I.SCRIPTSCRIPT), B = G(r.index, A, e), q = .6 * (w.height - w.depth), N = y.makeVList({
                positionType: "shift",
                positionData: -q,
                children: [
                    {
...
D({
    ...
    htmlBuilder (r, e) {
        var t = hr[r.style], a = e.havingStyle(t).withFont("");
        return la(r.body, a, e);
    },
    mathmlBuilder (r, e) {
        var t = hr[r.style], a = e.havingStyle(t), n = m0(r.body, a), s = new M.MathNode("mstyle", n), o = {
            display: [
                "0",
                "true"
            ],
...
Z0({
    ...
    htmlBuilder (r, e) {
        var t = _1(r, e);
        if (t) return t(r, e);
        var { base: a, sup: n, sub: s } = r, o = G(a, e), h, c, v = e.fontMetrics(), b = 0, x = 0, k = a && R.isCharacterBox(a);
        if (n) {
        ...
        var q = e.sizeMultiplier, N = T(.5 / v.ptPerEm / q), H = null;
        if (c) {
...
Z0({
    ...
    mathmlBuilder (r, e) {
        var t = g0(r.text, r.mode, e), a = At(r, e) || "normal", n;
...
Z0({
    ...
    htmlBuilder (r, e) {
        if (ot.hasOwnProperty(r.text)) {
            ...
            if (lt.hasOwnProperty(r.text)) return y.makeSpan([
                "mspace",
                lt[r.text]
            ], [], e);
    ...
    mathmlBuilder (r, e) {
        var t;
        if (ot.hasOwnProperty(r.text)) t = new M.MathNode("mtext", [
            new M.TextNode("\xA0")
        ]);
        else {
            if (lt.hasOwnProperty(r.text)) return new M.MathNode("mspace");
            throw new z('Unknown type of space "' + r.text + '"');
        }
        return t;
    }
...
D({
    ...
    htmlBuilder (r, e) {
        var t = fr(r, e), a = r0(r.body, t, true);
        return y.makeSpan([
            "mord",
            "text"
        ], a, t);
...
D({
    ...
    htmlBuilder (r, e) {
        var t = G(r.body, e), a = y.makeLineSpan("underline-line", e), n = e.fontMetrics().defaultRuleThickness, s = y.makeVList({
            positionType: "top",
            positionData: t.height,
            children: [
                {
...
D({
    ...
    htmlBuilder (r, e) {
        var t = G(r.body, e), a = e.fontMetrics().axisHeight, n = .5 * (t.height - a - (t.depth + a));
        return y.makeVList({
            positionType: "shift",
            positionData: n,
            children: [
...
D({
    ...
    htmlBuilder (r, e) {
        for(var t = pr(r), a = [], n = e.havingStyle(e.style.text()), s = 0; s < t.length; s++){
            var o = t[s];
    ...
    mathmlBuilder (r, e) {
        var t = new M.TextNode(pr(r)), a = new M.MathNode("mtext", [
            t
        ]);
        return a.setAttribute("mathvariant", "monospace"), a;
    }
});
var pr = m$1((r)=>r.body.replace(/ /g, r.star ? "\u2423" : "\xA0"), "makeVerb"), P0 = qr, ua = `[ \r
...
m("\\char", function(r) {
    ...
    if (t) {
        ...
        for(var n; (n = vr[r.future().text]) != null && n < t;)a *= t, a += n, r.popToken();
    }
    return "\\@char{" + a + "}";
});
var Ot = m$1((r, e, t)=>{
...
m("\\newcommand", (r)=>Ot(r, false, true));
m("\\renewcommand", (r)=>Ot(r, true, false));
m("\\providecommand", (r)=>Ot(r, true, true));
m("\\message", (r)=>{
...
m("\\show", (r)=>{
    ...
    return console.log(e, r.macros.get(t), P0[t], W.math[t], W.text[t]), "";
});
m("\\bgroup", "{");
m("\\egroup", "}");
m("~", "\\nobreakspace");
...
var ha = T(S0["Main-Regular"][84][1] - .7 * S0["Main-Regular"][65][1]);
...
var ca = {
    ...
    static #_ = m$1(this, "MacroExpander");
    constructor(e, t, a){
...
}, br = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, qe = Object.freeze({
    "\u208A": "+",
    "\u208B": "-",
    "\u208C": "=",
    "\u208D": "(",
    ...
    parseExpression(e, t) {
        for(var a = [];;){
            ...
            var n = this.fetch();
            if (r.endOfExpression.indexOf(n.text) !== -1 || t && n.text === t || e && P0[n.text] && P0[n.text].infix) break;
