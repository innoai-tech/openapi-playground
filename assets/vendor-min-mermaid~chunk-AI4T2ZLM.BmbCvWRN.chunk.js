...
import { S } from './vendor-min-mermaid~chunk-W6CKT3PL.BD4rRGDw.chunk.js';
import { U as Ut, C as Ct$1 } from './vendor-min-mermaid~chunk-EFRVIJHI.wT3iKf0B.chunk.js';
import { m as mr, U as Uo, H as Ho, $ as $o, G as Go, j as jo, V as Vo, h as hn, N as No } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
...
var Ct = /*#__PURE__*/ function() {
    var t = /*#__PURE__*/ m$1(function(Y, o, h, a) {
        ...
        performAction: /*#__PURE__*/ m$1(function(o, h, a, y, E, i, Q) {
            var l = i.length - 1;
            switch(E){
                case 3:
        ...
        parse: /*#__PURE__*/ m$1(function(o) {
            var h = this, a = [
                ...
                null
            ], i = [], Q = this.table, l = "", V = 0, K = 0, Z = 0, ct = 2, ht = 1, De = /*#__PURE__*/ i.slice.call(arguments, 1), D = /*#__PURE__*/ Object.create(this.lexer), U = {
                yy: {}
            };
            ...
            function xe() {
                var N;
                return N = y.pop() || D.lex() || ht, typeof N != "number" && (N instanceof Array && (y = N, N = /*#__PURE__*/ y.pop()), N = h.symbols_[N] || N), N;
            }
            m$1(xe, "lex");
...
Expecting ` + ut.join(", ") + ", got '" + (this.terminals_[A] || A) + "'" : At = "Parse error on line " + (V + 1) + ": Unexpected " + (A == ht ? "end of input" : "'" + (this.terminals_[A] || A) + "'"), this.parseError(At, {
                ...
                switch(w[0]){
                    case 1:
                        a.push(A), E.push(D.yytext), i.push(D.yylloc), a.push(w[1]), A = null, kt ? (A = kt, kt = null) : (K = D.yyleng, l = D.yytext, V = D.yylineno, Dt = D.yylloc, Z > 0);
                        break;
                    case 2:
                        ...
                        ]), xt = /*#__PURE__*/ this.performAction.apply(X, /*#__PURE__*/ [
                            l,
                            K,
                            V,
                            U.yy,
...
` + h + "^";
            ...
            test_match: /*#__PURE__*/ m$1(function(o, h) {
                ...
                }, this.options.ranges && (E.yylloc.range = /*#__PURE__*/ this.yylloc.range.slice(0))), y = /*#__PURE__*/ o[0].match(/(?:\r\n?|\n).*/g), y && (this.yylineno += y.length), this.yylloc = {
            ...
            next: /*#__PURE__*/ m$1(function() {
                ...
                for(var E = /*#__PURE__*/ this._currentRules(), i = 0; i < E.length; i++)if (a = /*#__PURE__*/ this._input.match(this.rules[E[i]]), a && (!h || a[0].length > h[0].length)) {
                    if (h = a, y = i, this.options.backtrack_lexer) {
                        if (o = /*#__PURE__*/ this.test_match(a, E[i]), o !== false) return o;
                        if (this._backtrack) {
                            h = false;
                            continue;
                        } else return false;
                ...
                return h ? (o = /*#__PURE__*/ this.test_match(h, E[y]), o !== false ? o : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
                    text: "",
                    token: null,
                    line: this.yylineno
            ...
            performAction: /*#__PURE__*/ m$1(function(h, a, y, E) {
                switch(y){
                    case 0:
                        return 38;
                    case 1:
...
var Rt = "text", Nt = "normal", pt = "rect", ft = "rectWithTitle", re = "stateStart", ne = "stateEnd", vt = "divider", Ot = "roundedWithTitle", ae = "note", oe = "noteGroup", J = "statediagram", Ae = "state", le = `${J}-${Ae}`, wt = "transition", Ce = "note", Le = "note-edge", ce = `${wt} ${Le}`, he = `${J}-${Ce}`, Ie = "cluster", de = `${J}-${Ie}`, Re = "cluster-alt", ue = `${J}-${Re}`, Gt = "parent", Pt = "note", Se = "state", gt = "----", pe = `${gt}${Pt}`, $t = `${gt}${Gt}`;
var Yt = /*#__PURE__*/ m$1((t, e = "TB")=>{
...
}, "getClasses"), ve = /*#__PURE__*/ m$1(async function(t, e, s, n) {
    ...
    try {
        ...
        pt$1.error("\u274C Error injecting clickable links:", T);
    }
            ...
            case tt:
                {
                    ...
                    let m = {
                        ...
                        style: Lt,
                        labelStyle: "",
                        label: /*#__PURE__*/ hn.sanitizeText(S.description ?? "", /*#__PURE__*/ mr()),
                        arrowheadStyle: It,
                        labelpos: "c",
                        labelType: Rt,
                        thickness: Nt,
...
var q = /*#__PURE__*/ m$1((t, e, s, n, r, d, u, f)=>{
    let S = e.id, m = /*#__PURE__*/ s.get(S), T = /*#__PURE__*/ we(m), b = /*#__PURE__*/ Ge(m), L = /*#__PURE__*/ mr();
    if (pt$1.info("dataFetcher parsedItem", e, m, b), S !== "root") {
        let x = pt;
        e.start === true ? x = re : e.start === false && (x = ne), e.type !== W && (x = e.type), mt.get(S) || mt.set(S, {
            id: S,
            shape: x,
            description: /*#__PURE__*/ hn.sanitizeText(S, L),
            cssClasses: `${T} ${le}`,
            cssStyles: b
        });
        let p = /*#__PURE__*/ mt.get(S);
        e.description && (Array.isArray(p.description) ? (p.shape = ft, p.description.push(e.description)) : p.description?.length && p.description.length > 0 ? (p.shape = ft, p.description === S ? p.description = [
            e.description
        ] : p.description = [
            p.description,
            e.description
        ]) : (p.shape = pt, p.description = e.description), p.description = /*#__PURE__*/ hn.sanitizeTextOrArray(p.description, L)), p.description?.length === 1 && p.shape === ft && (p.type === "group" ? p.shape = Ot : p.shape = pt), !p.type && e.doc && (pt$1.info("Setting cluster for XCX", S, /*#__PURE__*/ fe(e)), p.type = "group", p.isGroup = true, p.dir = /*#__PURE__*/ fe(e), p.shape = e.type === St ? vt : Ot, p.cssClasses = `${p.cssClasses} ${de} ${d ? ue : ""}`);
        let k = {
            labelStyle: "",
            shape: p.shape,
            label: p.description,
        ...
        if (k.shape === vt && (k.label = ""), t && t.id !== "root" && (pt$1.trace("Setting node ", S, " to be child of its parent ", t.id), k.parentId = t.id), k.centerLabel = true, e.note) {
            let O = {
                labelStyle: "",
                shape: ae,
                label: e.note.text,
    ...
    e.doc && (pt$1.trace("Adding nodes children "), Oe(e, e.doc, s, n, r, !d, u, f));
...
var C = {
    ...
    BG_FILL: "bgFill",
    STYLECLASS_SEP: ","
}, Ee = /*#__PURE__*/ m$1(()=>new Map, "newClassesList"), Te = /*#__PURE__*/ m$1(()=>({
        relations: [],
        states: new Map,
        documents: {}
    ...
    extract(e) {
        ...
        ye(), q(void 0, /*#__PURE__*/ this.getRootDocV2(), s, this.nodes, this.edges, true, n.look, this.classes);
    ...
    addState(e, s = W, n = void 0, r = void 0, d = void 0, u = void 0, f = void 0, S = void 0) {
        ...
        if (!this.currentDocument.states.has(m)) pt$1.info("Adding state ", m, r), this.currentDocument.states.set(m, {
            ...
            let T = /*#__PURE__*/ this.currentDocument.states.get(m);
            if (!T) throw new Error(`State not found: ${m}`);
    ...
    clear(e) {
        this.nodes = [], this.edges = [], this.documents = {
            root: /*#__PURE__*/ Te()
        }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = /*#__PURE__*/ Ee(), e || (this.links = new Map, No());
    }
    getState(e) {
...
`, "getStyles"), gs = $e;
export { Be as B, _e as _, gs as g, qe as q };
