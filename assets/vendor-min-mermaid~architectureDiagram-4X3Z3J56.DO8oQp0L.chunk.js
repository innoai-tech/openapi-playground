...
import { r as ra } from './vendor-min-mermaid~chunk-7SRKK4IT.j9jN9I8-.chunk.js';
import { R as Rr$1, v as ve, H as Hn, u as ut } from './vendor-min-mermaid~chunk-GOL2OBWC.BUAjn2kC.chunk.js';
import { L as Lt, J as Jt$1 } from './vendor-min-mermaid~chunk-EFRVIJHI.wT3iKf0B.chunk.js';
import { m as m$1, q, n } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { d as dr$1, H as Ho, U as Uo, j as jo, V as Vo, $ as $o, G as Go, N as No, O as Ot, a as Ni, m as mr, o as ot } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
import { p as pt, i as ia } from './vendor-min-mermaid~chunk-63GW7ZVL.CUmzAGpZ.chunk.js';
    ...
    m$1(function(C, T) {
        ...
        return function(D) {
            ...
            function(D, C, T) {
                ...
                function t(i, e, h, f) {
                    h == null && f == null && (f = e), g.call(this, f), i.graphManager != null && (i = i.graphManager), this.estimatedSize = o.MIN_VALUE, this.inclusionTreeDepth = o.MAX_VALUE, this.vGraphObject = f, this.edges = [], this.graphManager = i, h != null && e != null ? this.rect = new n(e.x, e.y, h.width, h.height) : this.rect = new n;
                }
                ...
                t.prototype.getEdges = function() {
                    ...
                    var f = new c(e, h), l = /*#__PURE__*/ i.inverseTransformPoint(f);
            ...
            function(D, C, T) {
                ...
                function e(f, l, A) {
                    g.call(this, A), this.estimatedSize = o.MIN_VALUE, this.margin = n.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = f, l != null && l instanceof r ? this.graphManager = l : l != null && l instanceof Layout && (this.graphManager = l.graphManager);
                }
                ...
                e.prototype.getNodes = function() {
                    ...
                    if (l == null && A == null) {
                        ...
                        return l.owner != A.owner ? null : (v.source = l, v.target = A, v.isInterGraph = false, this.getEdges().push(v), l.edges.push(v), A != l && A.edges.push(v), v);
                    }
                    ...
                    var l = new i, A = new Set, y = this.nodes[0], v, N, S = /*#__PURE__*/ y.withChildren();
                    for(S.forEach(function(R) {
                        l.push(R), A.add(R);
                    }); l.length !== 0;){
                        y = /*#__PURE__*/ l.shift(), v = /*#__PURE__*/ y.getEdges();
                        for(var M = v.length, b = 0; b < M; b++){
                            var $ = v[b];
                            if (N = /*#__PURE__*/ $.getOtherEndInGraph(y, this), N != null && !A.has(N)) {
            ...
            function(D, C, T) {
                ...
                m$1(n, "LGraphManager"), n.prototype.addRoot = function() {
                    ...
                    for(var r, a, c, t, u, i = /*#__PURE__*/ this.getAllEdges(), e = i.length, h = 0; h < e; h++){
                        if (r = i[h], a = r.source, c = r.target, r.lca = null, r.sourceInLca = a, r.targetInLca = c, a == c) {
            ...
            function(D, C, T) {
                ...
                m$1(o, "IGeometry"), o.calcSeparationAmount = function(n, r, a, c) {
                    ...
                    if (c === u) {
                        ...
                        if (-p === d ? c > u ? (a[0] = l, a[1] = A, s = true) : (a[0] = f, a[1] = h, s = true) : p === d && (c > u ? (a[0] = e, a[1] = h, s = true) : (a[0] = y, a[1] = A, s = true)), -E === d ? u > c ? (a[2] = $, a[3] = X, m = true) : (a[2] = b, a[3] = M, m = true) : E === d && (u > c ? (a[2] = S, a[3] = M, m = true) : (a[2] = et, a[3] = X, m = true)), s && m) return false;
                        if (c > u ? t > i ? (O = /*#__PURE__*/ this.getCardinalDirection(p, d, 4), x = /*#__PURE__*/ this.getCardinalDirection(E, d, 2)) : (O = /*#__PURE__*/ this.getCardinalDirection(-p, d, 3), x = /*#__PURE__*/ this.getCardinalDirection(-E, d, 1)) : t > i ? (O = /*#__PURE__*/ this.getCardinalDirection(-p, d, 1), x = /*#__PURE__*/ this.getCardinalDirection(-E, d, 3)) : (O = /*#__PURE__*/ this.getCardinalDirection(p, d, 2), x = /*#__PURE__*/ this.getCardinalDirection(E, d, 4)), !s) switch(O){
                            case 1:
                                F = h, G = c + -N / d, a[0] = G, a[1] = F;
                                break;
                            case 2:
                                G = y, F = t + v * d, a[0] = G, a[1] = F;
                                break;
                            case 3:
                                F = A, G = c + N / d, a[0] = G, a[1] = F;
                                break;
                            case 4:
                                G = l, F = t + -v * d, a[0] = G, a[1] = F;
                                break;
                        }
                        if (!m) switch(x){
                            case 1:
                    ...
                    var t = n.x, u = n.y, i = r.x, e = r.y, h = a.x, f = a.y, l = c.x, A = c.y, y = void 0, v = void 0, N = void 0, S = void 0, M = void 0, b = void 0, $ = void 0, X = void 0, et = void 0;
                    ...
                    var t = n.x, u = n.y, i = r.x, e = r.y, h = a.x, f = a.y, l = c.x, A = c.y, y = (i - t) * (A - f) - (l - h) * (e - u);
                    if (y === 0) return false;
                    var v = ((A - f) * (l - t) + (h - l) * (A - u)) / y, N = ((u - e) * (l - t) + (i - t) * (A - u)) / y;
                    return 0 < v && v < 1 && 0 < N && N < 1;
                }, o.findCircleLineIntersections = function(n, r, a, c, t, u, i) {
                    var e = (a - n) * (a - n) + (c - r) * (c - r), h = 2 * ((n - t) * (a - n) + (r - u) * (c - r)), f = (n - t) * (n - t) + (r - u) * (r - u) - i * i, l = h * h - 4 * e * f;
                    if (l >= 0) {
                        var A = (-h + Math.sqrt(h * h - 4 * e * f)) / (2 * e), y = (-h - Math.sqrt(h * h - 4 * e * f)) / (2 * e), v = null;
                        return A >= 0 && A <= 1 ? [
                            A
                        ] : y >= 0 && y <= 1 ? [
                            y
            ...
            function(D, C, T) {
                ...
                }, "nodeFrom"), r = /*#__PURE__*/ m$1(function(u, i, e, h) {
            ...
            function(D, C, T) {
                ...
                m$1(e, "Layout"), e.RANDOM_SEED = 1, e.prototype = /*#__PURE__*/ Object.create(i.prototype), e.prototype.getGraphManager = function() {
                    ...
                    return new c(null, this.graphManager, h);
                    ...
                    if (this.createBendsAsNeeded && (this.createBendpointsFromDummyNodes(), this.graphManager.resetAllEdges()), !this.isRemoteUse) {
                        ...
                        for(var A, y = /*#__PURE__*/ this.graphManager.getRoot().getNodes(), l = 0; l < y.length; l++)A = y[l];
                    ...
                    for(var h = [], f = true, l = /*#__PURE__*/ this.graphManager.getRoot().getNodes(), A = true, y = 0; y < l.length; y++)l[y].getChild() != null && (A = false);
                    if (!A) return h;
                    var v = new Set, N = [], S = new Map, M = [];
                    ...
                    var l = [], A = new Map, y = false, v = null;
                    (f.length == 1 || f.length == 2) && (y = true, v = f[0]);
                    ...
                    for(b = /*#__PURE__*/ b.concat(l); !y;){
                        ...
                        l = /*#__PURE__*/ l.concat(b), (f.length == 1 || f.length == 2) && (y = true, v = f[0]);
                    }
                    return v;
            ...
            function(D, C, T) {
                ...
                t.prototype.initParameters = function() {
                    ...
                    var i = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, h, f, l, A, y = /*#__PURE__*/ this.getAllNodes(), v;
                    if (this.useFRGridVariant) for(this.totalIterations % n.GRID_CALCULATION_CHECK_PERIOD == 1 && i && this.updateGrid(), v = new Set, h = 0; h < y.length; h++)l = y[h], this.calculateRepulsionForceOfANode(l, v, i, e), v.add(l);
                    ...
                    if (h.intersects(f)) {
                        a.calcSeparationAmount(h, f, l, n.DEFAULT_EDGE_LENGTH / 2), b = 2 * l[0], $ = 2 * l[1];
                    ...
                    if (this.totalIterations % n.GRID_CALCULATION_CHECK_PERIOD == 1 && h || f) {
                        var l = new Set;
            ...
            function(D, C, T) {
                ...
                m$1(g, "Matrix"), g.multMat = function(o, n) {
                    ...
                    for(var h = 0; h < r.length; h++){
                        for(var f = 0, l = 0; l < r.length; l++)f += r[h][l] * c[l];
                        t[h] = f;
                    }
                    for(var A = 0; A < n.length; A++){
                        for(var y = 0, v = 0; v < n[0].length; v++)y += n[A][v] * t[v];
                        a[A] = y;
                    }
                    return a;
                }, D.exports = g;
    ...
    m$1(function(C, T) {
        ...
        return (()=>{
            var C = {
                ...
                765: (n, r, a)=>{
                    var c = a(551).FDLayout, t = /*#__PURE__*/ a(578), u = /*#__PURE__*/ a(880), i = /*#__PURE__*/ a(991), e = /*#__PURE__*/ a(767), h = /*#__PURE__*/ a(806), f = /*#__PURE__*/ a(902), l = a(551).FDLayoutConstants, A = a(551).LayoutConstants, y = a(551).Point, v = a(551).PointD, N = a(551).DimensionD, S = a(551).Layout, M = a(551).Integer, b = a(551).IGeometry, $ = a(551).LGraph, X = a(551).Transform, et = a(551).LinkedList;
                    function R() {
                    ...
                    R.prototype.newGraphManager = function() {
                        ...
                        for(p = 0; p < s.length; p++){
                            ...
                            if (!m.has(E)) {
                                ...
                                if (d == O) E.getBendpoints().push(new v), E.getBendpoints().push(new v), this.createDummyNodesForBendpoints(E), m.add(E);
                                else {
                                    var x = [];
                        ...
                        for(var m = new y(0, 0), p = /*#__PURE__*/ Math.ceil(/*#__PURE__*/ Math.sqrt(s.length)), E = 0, d = 0, O = 0, x = new v(0, 0), G = 0; G < s.length; G++){
                            G % p == 0 && (O = 0, d = E, G != 0 && (d += h.DEFAULT_COMPONENT_SEPERATION), E = 0);
                            var F = s[G], I = /*#__PURE__*/ S.findCenterOfTree(F);
                            m.x = O, m.y = d, x = /*#__PURE__*/ R.radialLayout(F, I, m), x.y > E && (E = /*#__PURE__*/ Math.floor(x.y)), O = /*#__PURE__*/ Math.floor(x.x + h.DEFAULT_COMPONENT_SEPERATION);
                        }
                        ...
                        var F = new v(d.getMaxX(), d.getMaxY());
                        ...
                        Object.keys(this.memberGroups).forEach(function(p) {
                            ...
                            if (m[p] = /*#__PURE__*/ s.tileNodes(s.memberGroups[p], E.paddingLeft + E.paddingRight), E.rect.width = m[p].width, E.rect.height = m[p].height, E.setCenter(m[p].centerX, m[p].centerY), E.labelMarginLeft = 0, E.labelMarginTop = 0, h.NODE_DIMENSIONS_INCLUDE_LABELS) {
                        ...
                        this.tiledMemberPack = [], Object.keys(s).forEach(function(E) {
                            var d = m[E];
                            if (p.tiledMemberPack[E] = /*#__PURE__*/ p.tileNodes(s[E], d.paddingLeft + d.paddingRight), d.rect.width = p.tiledMemberPack[E].width, d.rect.height = p.tiledMemberPack[E].height, d.setCenter(p.tiledMemberPack[E].centerX, p.tiledMemberPack[E].centerY), d.labelMarginLeft = 0, d.labelMarginTop = 0, h.NODE_DIMENSIONS_INCLUDE_LABELS) {
                        ...
                        var p = h.TILING_PADDING_VERTICAL, E = h.TILING_PADDING_HORIZONTAL, d = s.length, O = 0, x = 0, G = 0;
                        ...
                        var E = h.TILING_PADDING_VERTICAL, d = h.TILING_PADDING_HORIZONTAL, O = h.TILING_COMPARE_BY, x = {
                            rows: [],
                            rowWidth: [],
                            rowHeight: [],
                            width: 0,
                        ...
                        if (E == s[1].source ? p = s[1].target : p = s[1].source, h.PURE_INCREMENTAL) E.setCenter(p.getCenterX() + s[3].getWidth(), p.getCenterY() + s[3].getHeight());
                            ...
                            m == 0 ? E.setCenter(/*#__PURE__*/ p.getCenterX(), p.getCenterY() - p.getHeight() / 2 - l.DEFAULT_EDGE_LENGTH - E.getHeight() / 2) : m == 1 ? E.setCenter(p.getCenterX() + p.getWidth() / 2 + l.DEFAULT_EDGE_LENGTH + E.getWidth() / 2, /*#__PURE__*/ p.getCenterY()) : m == 2 ? E.setCenter(/*#__PURE__*/ p.getCenterX(), p.getCenterY() + p.getHeight() / 2 + l.DEFAULT_EDGE_LENGTH + E.getHeight() / 2) : E.setCenter(p.getCenterX() - p.getWidth() / 2 - l.DEFAULT_EDGE_LENGTH - E.getWidth() / 2, /*#__PURE__*/ p.getCenterY());
                        }
                    }, n.exports = R;
                },
                991: (n, r, a)=>{
                ...
                902: (n, r, a)=>{
                    ...
                    m$1(h, "ConstraintHandler"), h.handleConstraints = function(f) {
                        ...
                        for(var A = new Map, y = new Map, v = [], N = [], S = /*#__PURE__*/ f.getAllNodes(), M = 0, b = 0; b < S.length; b++){
                            var $ = S[b];
                            $.getChild() == null && (y.set($.id, M++), v.push(/*#__PURE__*/ $.getCenterX()), N.push(/*#__PURE__*/ $.getCenterY()), A.set($.id, $));
                        }
                        ...
                        var X = /*#__PURE__*/ m$1(function(W, V) {
                            ...
                            ft.forEach(function(st, nt) {
                                st == 0 ? (ut.push(nt), z || (V == "horizontal" ? q.set(nt, y.has(nt) ? v[y.get(nt)] : k.get(nt)) : q.set(nt, y.has(nt) ? N[y.get(nt)] : k.get(nt)))) : q.set(nt, Number.NEGATIVE_INFINITY), z && lt.set(nt, new Set([
                                    nt
                                ]));
                                ...
                                if (st.forEach(function(ct) {
                                    ...
                                    nt.forEach(function(ct) {
                                        V == "horizontal" ? (q.set(ct, y.has(ct) ? v[y.get(ct)] : k.get(ct)), dt += /*#__PURE__*/ q.get(ct)) : (q.set(ct, y.has(ct) ? N[y.get(ct)] : k.get(ct)), dt += /*#__PURE__*/ q.get(ct));
                            ...
                            for(var it = /*#__PURE__*/ m$1(function() {
                                ...
                                dt.forEach(function(at) {
                                    if (q.get(at.id) < q.get(nt) + at.gap) if (z && z.has(at.id)) {
                                        var ct = void 0;
                                        if (V == "horizontal" ? ct = y.has(at.id) ? v[y.get(at.id)] : k.get(at.id) : ct = y.has(at.id) ? N[y.get(at.id)] : k.get(at.id), q.set(at.id, ct), ct < q.get(nt) + at.gap) {
                            ...
                            else if (k > j) for(var q = 0; q < y.size; q++)N[q] = -1 * N[q];
                            ...
                            if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1) l.fixedNodeConstraint.forEach(function(Y, W) {
                                ...
                                if (l.alignmentConstraint.vertical) {
                                    for(var W = l.alignmentConstraint.vertical, V = /*#__PURE__*/ m$1(function(q) {
                                        ...
                                        ut.size > 0 ? it = v[y.get(ut.values().next().value)] : it = et(lt).x, W[q].forEach(function(pt) {
                                            E[Y] = [
                                                it,
                                                N[y.get(pt)]
                                            ], d[Y] = [
                                ...
                                if (l.alignmentConstraint.horizontal) {
                                    for(var k = l.alignmentConstraint.horizontal, j = /*#__PURE__*/ m$1(function(q) {
                                        var lt = new Set;
                                        ...
                                        ut.size > 0 ? it = v[y.get(ut.values().next().value)] : it = et(lt).y, k[q].forEach(function(pt) {
                                            E[Y] = [
                                                v[y.get(pt)],
                                                it
                                            ], d[Y] = [
                                ...
                                if (tt < I.size / 2) J(l.relativePlacementConstraint), O = false, x = false;
                                else {
                                    ...
                                    Z[P].forEach(function(Y, W) {
                                        d[W] = [
                                            v[y.get(Y)],
                                            N[y.get(Y)]
                                        ], E[W] = [], H.has(Y) ? E[W][0] = /*#__PURE__*/ H.get(Y) : E[W][0] = v[y.get(Y)], K.has(Y) ? E[W][1] = /*#__PURE__*/ K.get(Y) : E[W][1] = N[y.get(Y)];
                                    }), O = true;
                                }
                            }
                            if (O) {
                                ...
                                for(var ot = 0; ot < y.size; ot++){
                                    ...
                                    v[ot] = /*#__PURE__*/ i.dotProduct(rt, vt), N[ot] = /*#__PURE__*/ i.dotProduct(rt, mt);
                                }
                        ...
                        if (t.ENFORCE_CONSTRAINTS) {
                            if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                                ...
                                l.fixedNodeConstraint.forEach(function(Y, W) {
                                    ...
                                    Lt.x += k.x, Lt.y += k.y;
                                }), Lt.x /= l.fixedNodeConstraint.length, Lt.y /= l.fixedNodeConstraint.length, v.forEach(function(Y, W) {
                                    v[W] += Lt.x;
                            ...
                            if (l.alignmentConstraint) {
                                if (l.alignmentConstraint.vertical) for(var Et = l.alignmentConstraint.vertical, Tt = /*#__PURE__*/ m$1(function(W) {
                                    var V = new Set;
                                ...
                                if (l.alignmentConstraint.horizontal) for(var Rt = l.alignmentConstraint.horizontal, Wt = /*#__PURE__*/ m$1(function(W) {
                                    var V = new Set;
                            ...
                            l.relativePlacementConstraint && function() {
                                ...
                                if (G.forEach(function(Gt) {
                                    ...
                                    if (l.alignmentConstraint.vertical) for(var q = l.alignmentConstraint.vertical, lt = /*#__PURE__*/ m$1(function(yt) {
                                        V.set("dummy" + yt, []), q[yt].forEach(function(Ct) {
                                            Y.set(Ct, "dummy" + yt), V.get("dummy" + yt).push(Ct), G.has(Ct) && gt.add("dummy" + yt);
                                        }), k.set("dummy" + yt, v[y.get(q[yt][0])]);
                                    }, "_loop6"), ut = 0; ut < q.length; ut++)lt(ut);
                                    if (l.alignmentConstraint.horizontal) for(var it = l.alignmentConstraint.horizontal, pt = /*#__PURE__*/ m$1(function(yt) {
                                ...
                                var yr = /*#__PURE__*/ m$1(function(yt) {
                        ...
                        for(var Ut = 0; Ut < S.length; Ut++){
                            var Ft = S[Ut];
                            Ft.getChild() == null && Ft.setCenter(v[y.get(Ft.id)], N[y.get(Ft.id)]);
                        }
                    }, n.exports = h;
                },
                551: (n)=>{
            ...
            var C = {
                ...
                548: (n, r, a)=>{
                    var c = /*#__PURE__*/ function() {
                        ...
                        return m$1(i, "sliceIterator"), function(e, h) {
                    ...
                    u.getTopMostNodes = function(i) {
                        ...
                        var l = new t, A = new Set, y = [], v = void 0, N = void 0, S = void 0, M = false, b = 1, $ = [], X = [], et = /*#__PURE__*/ m$1(function() {
                            var J = /*#__PURE__*/ i.collection();
                            X.push(J);
                            var s = h[0], m = /*#__PURE__*/ i.collection();
                            m.merge(s).merge(/*#__PURE__*/ s.descendants().intersection(e)), y.push(s), m.forEach(function(d) {
                                l.push(d), A.add(d), J.merge(d);
                            });
                            for(var p = /*#__PURE__*/ m$1(function() {
                                ...
                                for(var x = 0; x < O.length; x++){
                                    var G = O[x];
                                    if (v = /*#__PURE__*/ h.intersection(/*#__PURE__*/ G.union(/*#__PURE__*/ G.ancestors())), v != null && !A.has(v[0])) {
                                        var F = /*#__PURE__*/ v.union(/*#__PURE__*/ v.descendants());
                            ...
                            }), y.length == h.length && (M = true), !M || M && b > 1) {
                                N = y[0], S = N.connectedEdges().length, y.forEach(function(d) {
                                    d.connectedEdges().length < S && (S = d.connectedEdges().length, N = d);
                                }), $.push(/*#__PURE__*/ N.id());
                                var E = /*#__PURE__*/ i.collection();
                                E.merge(y[0]), y.forEach(function(d) {
                                    E.merge(d);
                ...
                816: (n, r, a)=>{
                    var c = /*#__PURE__*/ a(548), t = a(140).CoSELayout, u = a(140).CoSENode, i = a(140).layoutBase.PointD, e = a(140).layoutBase.DimensionD, h = a(140).layoutBase.LayoutConstants, f = a(140).layoutBase.FDLayoutConstants, l = a(140).CoSEConstants, A = /*#__PURE__*/ m$1(function(v, N) {
                        ...
                        var s = /*#__PURE__*/ m$1(function(I) {
                            ...
                            for(var P = 0, _ = 0, B = 0; B < tt.length; B++){
                                ...
                                if (U && H && U !== H && U.getEdgesBetween(H).length == 0) {
                                    ...
                                    K.id = /*#__PURE__*/ w.id(), K.idealLength = /*#__PURE__*/ m(v.idealEdgeLength, w), K.edgeElasticity = /*#__PURE__*/ m(v.edgeElasticity, w), P += K.idealLength, _++;
                                }
                            }
                ...
                212: (n, r, a)=>{
                    var c = /*#__PURE__*/ function() {
                        ...
                        return m$1(v, "defineProperties"), function(N, S, M) {
                    ...
                    var u = /*#__PURE__*/ a(658), i = /*#__PURE__*/ a(548), e = /*#__PURE__*/ a(657), h = e.spectralLayout, f = /*#__PURE__*/ a(816), l = f.coseLayout, A = /*#__PURE__*/ Object.freeze({
                        quality: "default",
                        randomize: true,
                        animate: true,
                                    ...
                                    if (b.layoutUtilities && M.packComponents && (E = /*#__PURE__*/ b.layoutUtilities("get"), E || (E = /*#__PURE__*/ b.layoutUtilities()), d = true), $.nodes().length > 0) if (d) {
                                        ...
                                        if (s = /*#__PURE__*/ i.connectComponents(b, M.eles, G), s.forEach(function(ot) {
                                            ...
                                            s.forEach(function(ot, rt) {
                                                M.eles = ot, J.push(/*#__PURE__*/ l(M, X[rt])), i.relocateComponent(m[rt], J[rt], M);
                                            });
                                        ...
                                        M.quality == "default" || M.quality == "proof" ? (J.push(/*#__PURE__*/ l(M, X[0])), i.relocateComponent(m[0], J[0], M)) : i.relocateComponent(m[0], X[0], M);
                                    }
                ...
                657: (n, r, a)=>{
                    var c = /*#__PURE__*/ a(548), t = a(140).layoutBase.Matrix, u = a(140).layoutBase.SVD, i = /*#__PURE__*/ m$1(function(h) {
                        var f = h.cy, l = h.eles, A = /*#__PURE__*/ l.nodes(), y = /*#__PURE__*/ l.nodes(":parent"), v = new Map, N = new Map, S = new Map, M = [], b = [], $ = [], X = [], et = [], R = [], J = [], s = [], p = void 0, E = 1e8, d = 1e-9, O = h.piTol, x = h.samplingType, G = h.nodeSeparation, F = void 0, I = /*#__PURE__*/ m$1(function() {
                        ...
                        c.connectComponents(f, l, /*#__PURE__*/ c.getTopMostNodes(A), v), y.forEach(function(W) {
                            c.connectComponents(f, l, /*#__PURE__*/ c.getTopMostNodes(/*#__PURE__*/ W.descendants().intersection(l)), v);
                        });
                        ...
                        var Et = void 0;
                        if (p > 2) {
                            F = p < h.sampleSize ? p : h.sampleSize;
...
var Le = {
    ...
    return T || g;
}, "isArchitectureDirectionXY"), ir = /*#__PURE__*/ m$1(function(D) {
    let C = D[0], T = D[1], g = Ht(C) && kt(T), o = kt(C) && Ht(T);
    return g || o;
}, "isArchitecturePairXY"), Er = /*#__PURE__*/ m$1(function(D) {
    return D !== "LL" && D !== "RR" && D !== "TT" && D !== "BB";
}, "isValidArchitectureDirectionPair"), oe = /*#__PURE__*/ m$1(function(D, C) {
    let T = `${D}${C}`;
    return Er(T) ? T : void 0;
}, "getArchitectureDirectionPair"), nr = /*#__PURE__*/ m$1(function([D, C], T) {
    let g = T[0], o = T[1];
    return Ht(g) ? kt(o) ? [
        D + (g === "L" ? -1 : 1),
        C + (o === "T" ? 1 : -1)
...
}, "shiftPositionByArchitectureDirectionPair"), ar = /*#__PURE__*/ m$1(function(D) {
    return D === "LT" || D === "TL" ? [
        1,
        1
    ] : D === "BL" || D === "LB" ? [
...
}, "getArchitectureDirectionXYFactors"), or = /*#__PURE__*/ m$1(function(D, C) {
    return ae(D, C) ? "bend" : Ht(D) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), sr = /*#__PURE__*/ m$1(function(D) {
    return D.type === "service";
}, "isArchitectureService"), hr = /*#__PURE__*/ m$1(function(D) {
...
var fr = /*#__PURE__*/ m$1(async function(D, C, T) {
    ...
    await Promise.all(/*#__PURE__*/ C.edges().map(async (c)=>{
        let { source: t, sourceDir: u, sourceArrow: i, sourceGroup: e, target: h, targetDir: f, targetArrow: l, targetGroup: A, label: y } = pe(c), { x: v, y: N } = c[0].sourceEndpoint(), { x: S, y: M } = c[0].midpoint(), { x: b, y: $ } = c[0].targetEndpoint(), X = g + 4;
        if (e && (Ht(u) ? v += u === "L" ? -X : X : N += u === "T" ? -X : X + 18), A && (Ht(f) ? b += f === "L" ? -X : X : $ += f === "T" ? -X : X + 18), !e && T.getNode(t)?.type === "junction" && (Ht(u) ? v += u === "L" ? n : -n : N += u === "T" ? n : -n), !A && T.getNode(h)?.type === "junction" && (Ht(f) ? b += f === "L" ? n : -n : $ += f === "T" ? n : -n), c[0]._private.rscratch) {
            let et = /*#__PURE__*/ D.insert("g");
            if (et.insert("path").attr("d", `M ${v},${N} L ${S},${M} L${b},${$} `).attr("class", "edge").attr("id", /*#__PURE__*/ Jt$1(t, h, {
                prefix: "L"
            })), i) {
            ...
            if (y) {
                ...
                if (await Rr$1(s, y, {
                    ...
                    if (m && ir(m)) {
                        let p = /*#__PURE__*/ s.node().getBoundingClientRect(), [E, d] = ar(m);
...
}, "drawEdges"), ur = /*#__PURE__*/ m$1(async function(D, C, T) {
    ...
    await Promise.all(/*#__PURE__*/ C.nodes().map(async (c)=>{
        let t = /*#__PURE__*/ Jt(c);
        if (t.type === "group") {
            let { h: u, w: i, x1: e, y1: h } = c.boundingBox(), f = /*#__PURE__*/ D.append("rect");
            ...
            if (t.icon) {
                ...
                })}</g>`), v.attr("transform", "translate(" + (A + a + 1) + ", " + (y + a + 1) + ")"), A += o, y += n / 2 - 1 - 2;
            }
            if (t.label) {
                let v = /*#__PURE__*/ l.append("g");
...
}, "drawGroups"), gr = /*#__PURE__*/ m$1(async function(D, C, T) {
    let g = /*#__PURE__*/ mr();
    for (let o of T){
        ...
        n.attr("id", `service-${o.id}`).attr("class", "architecture-service");
        let { width: c, height: t } = n.node().getBBox();
        o.width = c, o.height = t, D.setElementForId(o.id, n);
    }
    return 0;
}, "drawServices"), dr = /*#__PURE__*/ m$1(function(D, C, T) {
    T.forEach((g)=>{
...
function wr(D, C) {
    D.forEach((T)=>{
        let { lhsId: g, rhsId: o, lhsInto: n, lhsGroup: r, rhsInto: a, lhsDir: c, rhsDir: t, rhsGroup: u, title: i } = T, e = ae(T.lhsDir, T.rhsDir) ? "segments" : "straight", h = {
            id: `${g}-${o}`,
            label: i,
            source: g,
            sourceDir: c,
...
function xr(D, C, T) {
    let g = /*#__PURE__*/ m$1((a, c)=>Object.entries(a).reduce((t, [u, i])=>{
        ...
        return Object.entries(a).forEach(([u, [i, e]])=>{
            ...
            c[e] ??= {}, c[e][h] ??= [], c[e][h].push(u), t[i] ??= {}, t[i][h] ??= [], t[i][h].push(u);
        }), {
...
m$1(Or, "getRelativeConstraints");
function Rr(D, C, T, g, o, { spatialMaps: n, groupAlignments: r }) {
    return new Promise((a)=>{
        let c = /*#__PURE__*/ ia("body").append("div").attr("id", "cy").attr("style", "display:none"), t = /*#__PURE__*/ ra({
        ...
        c.remove(), Mr(T, t), Lr(D, t, o), Dr(C, t, o), wr(g, t);
        let u = /*#__PURE__*/ xr(o, n, r), i = /*#__PURE__*/ Or(n, o), e = /*#__PURE__*/ t.layout({
            name: "fcose",
            quality: "proof",
            styleEnabled: false,
            animate: false,
            nodeDimensionsIncludeLabels: false,
            idealEdgeLength (h) {
                let [f, l] = h.connectedNodes(), { parent: A } = Jt(f), { parent: y } = Jt(l);
        ...
        e.one("layoutstop", ()=>{
            ...
            m$1(h, "getSegmentWeights"), t.startBatch();
            for (let f of Object.values(/*#__PURE__*/ t.edges()))if (f.data?.()) {
                ...
                if (l !== y && A !== v) {
                    let N = /*#__PURE__*/ f.sourceEndpoint(), S = /*#__PURE__*/ f.targetEndpoint(), { sourceDir: M } = pe(f), [b, $] = kt(M) ? [
                        ...
                        S.x,
                        N.y
                    ], { weights: X, distances: et } = h(N, S, b, $);
...
m$1(Rr, "layoutArchitecture");
var Ir = /*#__PURE__*/ m$1(async (D, C, T, g)=>{
    ...
    h.attr("class", "architecture-groups"), await gr(o, e, n), dr(o, e, r);
    let f = await Rr(n, r, a, c, o, t);
    await fr(i, f, o), await ur(h, f, o), Cr(o, f), dr$1(void 0, u, /*#__PURE__*/ o.getConfigField("padding"), /*#__PURE__*/ o.getConfigField("useMaxWidth"));
}, "draw"), vr = {
    draw: Ir
};
var Ci = {
