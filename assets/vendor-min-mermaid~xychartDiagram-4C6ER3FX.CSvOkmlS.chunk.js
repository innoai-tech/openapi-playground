...
import { H as Ht } from './vendor-min-mermaid~chunk-HESFG3RP.DM0RUiMH.chunk.js';
import { L as Le } from './vendor-min-mermaid~chunk-YM3XIQPS.DjUuqvt-.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.ByXaayWf.chunk.js';
import { B as Bf, F as Ff, L as Lf, M as Mf, w as wf, v as vf, t as tt$1, T as Tf, S as Sf, E as Er, p as pl, W as hl, O as Oe, aN as Ys, a1 as Is, c as vc } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
...
var z = class {
    ...
    getMaxDimension(t, e) {
        ...
        for (let h of t){
            let u = Ht(a, 1, h), d = u ? u.width : h.length * e, y = u ? u.height : e;
...
var et = class extends F {
    ...
    recalculateScale() {
        this.scale = Ys().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(.5), tt$1.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
    }
    getTickValues() {
...
var nt = class {
    ...
    getDrawableElement() {
        let t = this.barData.data.map((h)=>[
            ...
            ]), s = Math.min(this.xAxis.getAxisOuterPadding() * 2, this.xAxis.getTickDistance()) * (1 - .05), a = s / 2;
