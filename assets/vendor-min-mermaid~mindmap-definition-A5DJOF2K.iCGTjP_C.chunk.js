...
import { S } from './vendor-min-mermaid~chunk-CRSA2SMT.DrUenSi3.chunk.js';
import { m as m$1, q, n } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { t as tt, h as hh, a as ah, I as Il, D as De, ar as $t$1, as as E, at as I, k as kh } from './vendor-min-mermaid~chunk-63ZE7VZ5.CfadwiGU.chunk.js';
...
var V = [], Mt = 0, ut = {}, Yt = /*#__PURE__*/ m$1(()=>{
    ...
    let e = /*#__PURE__*/ hh(), t = e.mindmap?.padding ?? Il.mindmap.padding;
    switch(i){
        case k.ROUNDED_RECT:
        case k.RECT:
        case k.HEXAGON:
    ...
    let r = {
        ...
        type: i,
        children: [],
        width: e.mindmap?.maxNodeWidth ?? Il.mindmap.maxNodeWidth,
        padding: t
    }, l = /*#__PURE__*/ Xt(E);
    ...
    if (!E) return;
    let I = /*#__PURE__*/ hh(), o = V[V.length - 1];
...
` + E);
    ...
    se(f, d$1), oe(e, d$1), ah(void 0, l, r.mindmap?.padding ?? Il.mindmap.padding, r.mindmap?.useMaxWidth ?? Il.mindmap.useMaxWidth);
}, "draw"), bt = {
    draw: he
};
var le = /*#__PURE__*/ m$1((E$1)=>{
    let I$1 = "";
    for(let o = 0; o < E$1.THEME_COLOR_LIMIT; o++)E$1["lineColor" + o] = E$1["lineColor" + o] || E$1["cScaleInv" + o], $t$1(E$1["lineColor" + o]) ? E$1["lineColor" + o] = /*#__PURE__*/ E(E$1["lineColor" + o], 20) : E$1["lineColor" + o] = /*#__PURE__*/ I(E$1["lineColor" + o], 20);
