import { s as o, v as e, a, d as t, t as r, P as l, O as n } from "./lib-nodepkg-vueuikit.L9PpP1Is.chunk.js";
import { j as i, e as s, f as d, g as p, w as c, a as u } from "./lib-nodepkg-vuekit.BhEjgaEZ.chunk.js";
import { b as y, c as b, e as m } from "./lib-nodepkg-typedef.E6pln5b6.chunk.js";
import { g } from "./vendor-innoai-tech-lodash.BKx2BmKI.chunk.js";
...
let N = o("div", { displayName: "Container" })({ pos: "absolute", top: 0, left: 0, h: "100vh", w: "100vw", zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center" }), S = o("div", { displayName: "DialogBackdrop" })({ cursor: "pointer", pos: "absolute", top: 0, left: 0, h: "100vh", w: "100vw", zIndex: -1, bgColor: e("sys.scrim", a(0.38)) });
o("div", { displayName: "DialogContainer" })({ py: 12, rounded: "sm", shadow: "3", minW: "50vw", containerStyle: "sys.surface-container-high" });
let B = t({ from: { opacity: 0 }, to: { opacity: 1 }, duration: r.duration.md1, easing: r.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: r.duration.sm4, easing: r.easing.standard.accelerate });
s({ isOpen: y().optional(), onClose: b(), $default: b().optional() }, (o2, e2) => {
  ...
  return c(() => o2.isOpen, (o3) => {
    ...
    return i(n, { isOpen: l2.value, onContentBeforeMount: () => {
      ...
      s2.value = false;
    }, children: u(N, { children: [i(B, { onComplete: (o4) => {
      "leave" === o4 && (l2.value = false, r2("close"));
    }, children: s2.value ? i(S, { onClick: () => {
      s2.value = false;
  ...
  return (e3) => {
    var t2, r2, l2, n2;
    let s2 = o2.valued, d2 = o2.invalid, c2 = o2.disabled, y2 = (null !== (n2 = null === (t2 = a2.default) || void 0 === t2 ? void 0 : t2.call(a2)) && void 0 !== n2 ? n2 : []).map((o3) => "input" === o3.type ? (s2 = !!g(o3.props, ["value"], g(o3.props, ["placeholder"], s2)), c2 = g(o3.props, ["disabled"], c2), p(o3, { disabled: c2 })) : p(o3));
    return u(e3, { "data-valued": s2, "data-invalid": d2, "data-disabled": c2, "data-focus-within": o2.focus, "data-has-leading": !!a2.leading, "data-has-trailing": !!a2.trailing, children: [u("div", { "data-input-container": "", children: [a2.leading && i(k, { children: a2.leading() }), i("div", { "data-input-label": "", children: null === (r2 = a2.label) || void 0 === r2 ? void 0 : r2.call(a2) }), y2, a2.trailing && i(k, { children: a2.trailing() })] }), a2.supporting && i("div", { "data-input-supporting": "", children: null === (l2 = a2.supporting) || void 0 === l2 ? void 0 : l2.call(a2) })] });
  };
...
let k = o("div", { role: m(["leading", "trailing"]).optional().default("leading") }, { displayName: "Maker" })({ pos: "absolute", top: 4, bottom: 4, display: "flex", alignItems: "center", color: "sys.on-surface-variant", _role__leading: { left: 12, $data_icon: { ml: -4 } }, _role__trailing: { right: 12, $data_icon: { mr: -4 } } });
export {
  v as F,
  C as I,
  h as m
