...
var _e, _t, _n;
import { c as e, I as t, j as n, a as l, r as a, s as i, b as r, d as o, e as d, f as s, T as p, F as c, g as u, o as h, t as y, h as v } from "./lib-nodepkg-vuekit.CJr2PA1p.chunk.js";
import { o as m, J as f, S as x, a as g, r as b, s as w, E as N } from "./lib-nodepkg-typedef.S8A8zKcZ.chunk.js";
import { s as C, v as $, P as S, a as k, b as O, B as E } from "./lib-nodepkg-vueuikit.D8fdV20v.chunk.js";
import { I, a as T, m as A, b as D, c as R, d as J, e as L } from "./lib-nodepkg-vuematerial.CyRJIG2i.chunk.js";
import { O as P, s as M, m as B, f as _, d as W, t as j, E as z, c as H, B as F, S as U } from "./vendor-rxjs.ByE15jUQ.chunk.js";
import { i as V, g as K, a as X, b as q, s as G, l as Q, c as Y, d as Z, e as ee } from "./vendor-innoai-tech-lodash.BIXzStxr.chunk.js";
import { M as et } from "./lib-nodepkg-vuemarkdown.BI8o8P3U.chunk.js";
...
let ec = /* @__PURE__ */ C("div", { displayName: "PopoverContainer" })({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: /* @__PURE__ */ $("sys.outline-variant", /* @__PURE__ */ k(0.38)) }), eu = /* @__PURE__ */ C("div", { displayName: "MenuItem" })({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), eh = /* @__PURE__ */ l((e3, t2) => {
  ...
  return () => {
    var t3;
    return /* @__PURE__ */ d(eg, { "data-deprecated": e3.deprecated, "data-optional": e3.optional, "data-nullable": e3.nullable, children: [l2.leading && /* @__PURE__ */ n(ex, { "data-visible-on-hover": true, children: /* @__PURE__ */ l2.leading() }), null === (t3 = l2.default) || void 0 === t3 ? void 0 : t3.call(l2)] });
  };
}, { displayName: "PropName", props: ["deprecated", "optional", "nullable"] }), ex = /* @__PURE__ */ C(ei, { displayName: "PropLeading" })({ position: "absolute", ml: -28 }), eg = /* @__PURE__ */ C("div", { displayName: "PropNameView" })({ position: "relative", display: "flex", alignItems: "center", textStyle: "sys.label-small", fontWeight: "bold", fontFamily: "inherit", wordBreak: "keep-all", whiteSpace: "nowrap", border: "1px solid", borderColor: "rgba(0,0,0,0)", fontSize: 12, lineHeight: 24, _deprecated: { textDecoration: "line-through" }, _optional: { "&:after": { content: '"?"', color: "sys.secondary", opacity: 0.58 } } }), eb = /* @__PURE__ */ C("div", { displayName: "LineTitle" })({ position: "absolute", zIndex: 1, left: 0, opacity: 0.58, fontSize: 10, lineHeight: 10, top: 0, "& > *": { display: "flex", alignItems: "center", gap: 4, "&::before": { content: '"// "', font: "code" } } }), ew = /* @__PURE__ */ C("div", { displayName: "LineError" })({ display: "block", fontSize: 10, lineHeight: 14, color: "sys.error" }), eN = /* @__PURE__ */ C("div", { displayName: "LineContainer" })({ position: "relative", py: 4, _hover: { containerStyle: "sys.surface-container", "& [data-visible-on-hover]": { visibility: "visible" } }, "&:focus-within": { containerStyle: "sys.surface-container" }, _dirty: { bgColor: /* @__PURE__ */ $("sys.warning-container", /* @__PURE__ */ k(0.38)) }, _error: { bgColor: "sys.error-container" }, [`&:has(${er})`]: { [`& > ${ew}`]: { display: "none" }, _error: { bgColor: "inherit" } } }), eC = /* @__PURE__ */ e(() => ({ indent: 0, $container: /* @__PURE__ */ s(null) }), { name: "IntentContext" }), e$ = /* @__PURE__ */ o((e3, t2) => {
...
}, { displayName: "Block", props: ["openToken", "closeToken"] }), eS = /* @__PURE__ */ l((e3, t2) => {
...
let eJ = /* @__PURE__ */ u(function(e3, t2) {
  ...
  let {} = t2;
  return () => /* @__PURE__ */ n(eh, { $title: "复制当前节点为 JSON 字符串", children: /* @__PURE__ */ n(eo, { type: "button", onClick: () => eJ(/* @__PURE__ */ JSON.stringify(e3.value, null, 2)), children: /* @__PURE__ */ n(I, { path: D }) }) });
...
let e_ = /* @__PURE__ */ e(() => new eB()), eW = /* @__PURE__ */ l((e3, l2) => {
  let r2, { render: o2 } = l2, s2 = /* @__PURE__ */ h(null), p2 = /* @__PURE__ */ h(null), c2 = /* @__PURE__ */ h(null), u2 = /* @__PURE__ */ eM.from(c2), v2 = /* @__PURE__ */ eP.from(c2), m2 = /* @__PURE__ */ e_.use(), f2 = /* @__PURE__ */ ed.from(c2), g2 = /* @__PURE__ */ el.use();
  ...
  let b2 = () => {
    ...
    return 0;
  }, w2 = new t({ index: /* @__PURE__ */ b2() }), N2 = () => {
    v2.next(""), f2.hide();
  }, C2 = () => {
    N2(), w2.next({ index: /* @__PURE__ */ b2() }), X(e3.value) && g2.delete(e3.ctx.path);
  }, $2 = (t2) => {
    var n2, l3, a2;
    if ("enums" === e3.typedef.type) {
    ...
    if (X(t2)) {
      g2.delete(e3.ctx.path);
      return;
    }
    let [i2, r3] = e3.typedef.validate(t2, { coerce: true });
    if (i2) {
      g2.setError(e3.ctx.path, i2.message);
      return;
    }
    g2.update(e3.ctx.path, r3), N2();
  };
  return (e3.allowRawJSON && a(v2, /* @__PURE__ */ j((t2) => {
    ...
    if (n2.startsWith("{") && n2.endsWith("}") || n2.startsWith("[") && n2.endsWith("]")) try {
      ...
      g2.update(e3.ctx.path, t3), N2();
    } catch (t3) {
      g2.setError(e3.ctx.path, "无效的 JSON 字符串");
    }
  ...
  let {} = e3, { emit: l2 } = t2;
  return () => /* @__PURE__ */ n(eh, { $title: "删除属性", children: /* @__PURE__ */ n(eo, { type: "button", onClick: () => l2("remove"), children: /* @__PURE__ */ n(I, { path: L }) }) });
  ...
  return a(e3.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(e$, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(er, { children: /* @__PURE__ */ n(eL, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eK, { ctx: e3.ctx, onAdd: (t4) => {
    ...
    return /* @__PURE__ */ d(eS, { path: c2, dirty: /* @__PURE__ */ i2.isDirty(s2, c2), title: /* @__PURE__ */ x.metaProp(p2, "title"), description: /* @__PURE__ */ x.metaProp(p2, "description"), children: [/* @__PURE__ */ n(ef, { deprecated: /* @__PURE__ */ x.schemaProp(p2, "deprecated"), $leading: /* @__PURE__ */ n(eU, { onRemove: () => {
      i2.delete(c2);
  ...
  let g2 = /* @__PURE__ */ a(u2, /* @__PURE__ */ o2((e4) => /* @__PURE__ */ n("div", { "data-input-wrapper": true, children: /* @__PURE__ */ n("input", { ref: s2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)", "data-options": e4 }) })));
  return a(/* @__PURE__ */ H([c2, u2, v2, e3.options$]), /* @__PURE__ */ o2((t2) => {
    let [l3, a2, i2, r3] = t2;
    return r3 ? r3.length > 0 ? /* @__PURE__ */ n(eS, { path: e3.ctx.path, children: /* @__PURE__ */ n(ez, { sx: { mx: -4 }, children: /* @__PURE__ */ n(ep, { onSelected: (e4) => {
      f2(e4);
    }, open$: u2, $content: /* @__PURE__ */ n("div", { children: /* @__PURE__ */ r3.map((e4, t3) => l3 && !e4.propName.includes(l3) ? null : /* @__PURE__ */ n(eX, { propName: e4.propName, typedef: e4.typedef, "data-focus": t3 === i2.index % r3.length })) }), children: g2 }) }) }) : null : /* @__PURE__ */ n(eS, { path: [...e3.ctx.path, x.RecordKey], children: /* @__PURE__ */ n(ez, { sx: { mx: -4 }, children: /* @__PURE__ */ n(S, { isOpen: a2, placement: "right-start", $content: /* @__PURE__ */ d(ej, { children: [/* @__PURE__ */ n(eo, { type: "button", onClick: () => p2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(I, { path: R }) }), /* @__PURE__ */ n(eo, { type: "button", onClick: () => p2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(I, { path: J }) })] }), children: /* @__PURE__ */ n("div", { "data-input-wrapper": true, children: /* @__PURE__ */ n("input", { ref: s2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)" }) }) }) }) });
  }));
  ...
  return a(e3.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(e$, { openToken: "[", closeToken: "]", $leading: /* @__PURE__ */ n(er, { children: /* @__PURE__ */ n(eL, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eQ, { ctx: e3.ctx, typedef: e3.typedef, onAdd: (t4) => {
    ...
    return /* @__PURE__ */ d(eS, { path: p2, dirty: /* @__PURE__ */ i2.isDirty(o2, p2), children: [/* @__PURE__ */ n(ef, { $leading: /* @__PURE__ */ n(eY, { onRemove: () => {
      i2.delete(p2);
  ...
  return () => /* @__PURE__ */ n(eS, { path: e3.ctx.path, children: /* @__PURE__ */ n(ez, { sx: { mx: -4 }, children: m2 }) });
}, { displayName: "AddItemIconBtn", props: ["ctx", "typedef"], emits: ["add"] }), eY = /* @__PURE__ */ l((e3, t2) => {
  let {} = e3, { emit: l2 } = t2;
  return () => /* @__PURE__ */ n(eh, { $title: "移除项", children: /* @__PURE__ */ n(eo, { type: "button", onClick: () => l2("remove"), children: /* @__PURE__ */ n(I, { path: L }) }) });
  ...
  return a(e3.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(e$, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(er, { children: /* @__PURE__ */ n(eL, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eK, { ctx: e3.ctx, onAdd: (t4) => {
    ...
    if (!Object.hasOwn(t3, o2)) return null;
    let c2 = [...e3.ctx.path, o2];
    return /* @__PURE__ */ d(eS, { path: c2, dirty: /* @__PURE__ */ i2.isDirty(s2, c2), children: [/* @__PURE__ */ n(ef, { $leading: /* @__PURE__ */ n(eU, { onRemove: () => {
      i2.delete(c2);
    } }), children: /* @__PURE__ */ String(o2) }), /* @__PURE__ */ d(em, { children: [":", " "] }), null === (a2 = r2.$value) || void 0 === a2 ? void 0 : a2.call(r2, p2, s2, { ...e3.ctx, path: c2, branch: [...e3.ctx.branch, s2] })] });
  }) })));
}, { displayName: "RecordInput", props: ["ctx", "value", "typedef"] }), e0 = /* @__PURE__ */ l((e3, t2) => {
  let { render: l2 } = t2;
  return a(e3.value$, /* @__PURE__ */ l2((t3) => Z(t3) ? /* @__PURE__ */ n(eG, { value: t3, typedef: /* @__PURE__ */ g(), ctx: e3.ctx }) : ee(t3) ? /* @__PURE__ */ n(eZ, { value: t3, typedef: /* @__PURE__ */ b(/* @__PURE__ */ w(), /* @__PURE__ */ g()), ctx: e3.ctx }) : /* @__PURE__ */ n(eW, { value: t3, typedef: /* @__PURE__ */ g(), ctx: e3.ctx, allowRawJSON: true })));
  ...
  return a(i2, /* @__PURE__ */ l2((e4) => {
    ...
    return /* @__PURE__ */ n(e_, { children: /* @__PURE__ */ n(ea, { value: { $value: null !== (l3 = r2.$value) && void 0 !== l3 ? l3 : e1 }, children: /* @__PURE__ */ d(e2, { children: [/* @__PURE__ */ n("section", { ref: o2 }), o2.value && /* @__PURE__ */ n(eC, { value: { indent: 0, $container: o2 }, children: /* @__PURE__ */ n(eS, { path: [], viewOnly: true, children: /* @__PURE__ */ a2(i2.typedef, e4, N) }) })] }) }) });
  }));
