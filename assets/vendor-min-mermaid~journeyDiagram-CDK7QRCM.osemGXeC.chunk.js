import { x, y, h, g } from "./vendor-min-mermaid~chunk-44WTIFVW.Das7HIIT.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Q7R0ayzM.chunk.js";
import { b as bf, W as Wl, w as wf, B as Bf, T as Tf, k as kf, S as Sf, v as vf, r as rh, C as Cf, ak as _c } from "./vendor-min-mermaid~chunk-OR2G2HG5.BWDWUMki.chunk.js";
var U = /* @__PURE__ */ function() {
  var t = /* @__PURE__ */ m$1(function(g2, n, a, o) {
    ...
    performAction: /* @__PURE__ */ m$1(function(n, a, o, y2, p, l, M) {
      var _ = l.length - 1;
      switch (p) {
        case 1:
          return l[_ - 1];
    ...
    parse: /* @__PURE__ */ m$1(function(n) {
      var a = this, o = [
        ...
        null
      ], l = [], M = this.table, _ = "", N = 0, et = 0, nt = 0, Tt = 2, rt = 1, Mt = /* @__PURE__ */ l.slice.call(arguments, 1), k = /* @__PURE__ */ Object.create(this.lexer), C = {
        yy: {}
      };
      ...
      for (var b, D, P, w, Ht, W, A = {}, B, S, it, j; ; ) {
        if (P = o[o.length - 1], this.defaultActions[P] ? w = this.defaultActions[P] : ((b === null || typeof b > "u") && (b = /* @__PURE__ */ $t()), w = M[P] && M[P][b]), typeof w > "u" || !w.length || !w[0]) {
          var X = "";
          j = [];
...
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : X = "Parse error on line " + (N + 1) + ": Unexpected " + (b == rt ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(X, {
        ...
        switch (w[0]) {
          ...
          case 2:
            ...
            S && (o = /* @__PURE__ */ o.slice(0, -1 * S * 2), p = /* @__PURE__ */ p.slice(0, -1 * S), l = /* @__PURE__ */ l.slice(0, -1 * S)), o.push(this.productions_[w[1]][0]), p.push(A.$), l.push(A._$), it = M[o[o.length - 2]][o[o.length - 1]], o.push(it);
            break;
          case 3:
            return true;
        }
...
var V = "", Z = [], L = [], R = [], Et = /* @__PURE__ */ m$1(function() {
  Z.length = 0, L.length = 0, V = "", R.length = 0, bf();
  ...
  getConfig: /* @__PURE__ */ m$1(() => Wl().journey, "getConfig"),
  clear: Et,
  setDiagramTitle: wf,
  getDiagramTitle: Bf,
  setAccTitle: Tf,
...
var K = /* @__PURE__ */ m$1(function(t, e) {
  ...
  function u(f) {
    let x2 = /* @__PURE__ */ _c().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
    f.append("path").attr("class", "mouth").attr("d", x2).attr("transform", "translate(" + e.cx + "," + (e.cy + 2) + ")");
  }
  m$1(u, "smile");
  function h2(f) {
    let x2 = /* @__PURE__ */ _c().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
  ...
  function e(i, u, h2, d, f, x2, m, g2, n) {
    ...
    for (let p = 0; p < y2.length; p++) {
      let l = p * a - a * (y2.length - 1) / 2, M = /* @__PURE__ */ u.append("text").attr("x", h2 + f / 2).attr("y", d).attr("fill", n).style("text-anchor", "middle").style("font-size", a).style("font-family", o);
      M.append("tspan").attr("x", h2 + f / 2).attr("dy", l).text(y2[p]), M.attr("y", d + x2 / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), c(M, m);
    }
  }
  m$1(e, "byTspan");
...
var Y = Wl().journey, I = Y.leftMargin, Wt = /* @__PURE__ */ m$1(function(t, e, s, c) {
  let i = Wl().journey, u = Wl().securityLevel, h2;
  u === "sandbox" && (h2 = /* @__PURE__ */ rh("#i" + e));
  let d = u === "sandbox" ? rh(h2.nodes()[0].contentDocument.body) : rh("body");
  T.init();
  ...
  Cf(f, o, y2, i.useMaxWidth), f.append("line").attr("x1", I).attr("y1", i.height * 4).attr("x2", y2 - I - 4).attr("y2", i.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  let p = m ? 70 : 0;
  ...
  let c = Wl().journey, i = "", u = c.height * 2 + c.diagramMarginY, h2 = s + u, d = 0, f = "#CCC", x2 = "black", m = 0;
