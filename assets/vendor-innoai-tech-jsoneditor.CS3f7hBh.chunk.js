...
var r1 = t(rK(), 1), r0 = {}.hasOwnProperty, r2 = /* @__PURE__ */ new Map(), r3 = /[A-Z]/g, r4 = new Set([
	"table",
	"tbody",
	"thead",
	"tfoot",
...
var iT = _((e, {}) => I(e.text$, U(), k((t) => {
	var n, r, i, l, o;
	let a, u, s, c, d, p, f, h, m, g, y, v, x, k, b, S = ("string" != typeof (n = {
		extensions: [eh([
			{ text: nm },
			{
				document: { 91: {
		...
		return y(e, r, n);
	}, void 0), x = (v = m).one(i, void 0), k = function(e) {
...
var iX = class e extends a {
	...
	update(e, t, n, r) {
		(console.log("[json-editor]", "update", JSON.stringify(e), this.typedef.type), this.#t.next({}), 0 == e.length) ? this.#e.next(t) : g(t) ? this.#e.next((i) => {
			let l = R(i, e, n);
...
var ly = _((e, { render: t }) => {
	...
	let m = () => {
		...
		n ? f.setError(e.ctx.path, n.message) : (f.update(e.ctx.path, r), y());
	};
	...
	return I(h([
		...
		let p, f, h = !!s, m = x(u) || "array" == e.typedef.type, g = !m && d(u);
		if (t) return c ? null : z(C, { children: z(lp, {
			"data-error": h,
			$leading: o,
			indent: e.ctx.path.length,
			children: m ? V(C, { children: [V(i2, { children: ["]", "\xA0\xA0"] }), !e.ctx.readOnly && z(lE, {
				ctx: e.ctx,
				typedef: e.typedef,
				onAdd: (t) => {
			...
			})] }) : g ? V(C, { children: [V(i2, { children: ["}", "\xA0\xA0"] }), !e.ctx.readOnly && z(lD, {
				ctx: e.ctx,
				onAdd: (t) => {
		...
		return z(lp, {
			...
			"data-error": h,
			$leading: V(C, { children: [o, m || g ? z(ld, {
				folded: c !== iZ.NONE,
				onClick: () => {
					n.toggleFold(a);
				}
			}) : null] }),
			$comment: (p = H.metaProp(e.typedef, "title"), f = H.metaProp(e.typedef, "description"), V(C, { children: [(p || f) && z(lt, { children: f ? z(lr, {
				$title: z(ln, { children: z(iT, { text: f }) }),
				placement: "top",
			...
			}) : z("span", { children: p }) }), h && z(lo, { children: `${s}` })] })),
			children: (() => {
				if (c) {
					if (c == iZ.EXACT) {
						if (m) return V(C, { children: [y(), z(i2, { children: "[...]" })] });
						if (g) return V(C, { children: [y(), z(i2, { children: "{...}" })] });
					}
					return null;
				}
				return V(C, { children: [y(), m ? V(C, { children: [z(i2, { children: "[" }), z(iG, { children: z(lL, { value: u }) })] }) : g ? V(C, { children: [z(i2, { children: "{" }), z(iG, { children: z(lL, { value: u }) })] }) : r.$value?.(e.typedef, u, e.ctx)] });
			})()
		});
	}));
}, {
