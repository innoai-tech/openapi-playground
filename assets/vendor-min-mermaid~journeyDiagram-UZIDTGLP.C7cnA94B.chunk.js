import { g, h, y, x } from "./vendor-min-mermaid~chunk-DLZS2ZFX.Dus1B2f5.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
import { F as Ff, B as Bf, w as wf, v as vf, L as Lf, M as Mf, H as Hl, i as ih, T as Tf, S as Sf, al as bc } from "./vendor-min-mermaid~chunk-ZKYS2E5M.DYmB7G2x.chunk.js";
import "./vendor-min-mermaid~chunk-TI4EEUUG.CAA-1BPs.chunk.js";
import "./lib-nodepkg-typedef.D-PCYzjh.chunk.js";
var U = function() {
  var t = m$1(function(g2, n, a, o) {
    ...
    performAction: m$1(function(n, a, o, y2, p, l, $) {
      var _ = l.length - 1;
      switch (p) {
        case 1:
          return l[_ - 1];
        ...
        case 7:
          ...
          break;
        case 8:
          y2.setDiagramTitle(l[_].substr(6)), this.$ = l[_].substr(6);
          break;
        case 9:
          this.$ = l[_].trim(), y2.setAccTitle(this.$);
          break;
        case 10:
        case 11:
          this.$ = l[_].trim(), y2.setAccDescription(this.$);
          break;
        case 12:
          y2.addSection(l[_].substr(8)), this.$ = l[_].substr(8);
          break;
        case 13:
    ...
    parse: m$1(function(n) {
      var a = this, o = [
        ...
        null
      ], l = [], $ = this.table, _ = "", N = 0, et = 0, nt = 0, Tt = 2, rt = 1, $t = l.slice.call(arguments, 1), k = Object.create(this.lexer), C = {
        yy: {}
      };
      ...
      function St() {
        var v;
        return v = y2.pop() || k.lex() || rt, typeof v != "number" && (v instanceof Array && (y2 = v, v = y2.pop()), v = a.symbols_[v] || v), v;
      }
      m$1(St, "lex");
      for (var b, D, P, w, Ht, W, A = {}, B, M, it, j; ; ) {
        if (P = o[o.length - 1], this.defaultActions[P] ? w = this.defaultActions[P] : ((b === null || typeof b > "u") && (b = St()), w = $[P] && $[P][b]), typeof w > "u" || !w.length || !w[0]) {
          var X = "";
          j = [];
...
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : X = "Parse error on line " + (N + 1) + ": Unexpected " + (b == rt ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(X, {
        ...
        switch (w[0]) {
          ...
          case 2:
            ...
            M && (o = o.slice(0, -1 * M * 2), p = p.slice(0, -1 * M), l = l.slice(0, -1 * M)), o.push(this.productions_[w[1]][0]), p.push(A.$), l.push(A._$), it = $[o[o.length - 2]][o[o.length - 1]], o.push(it);
            break;
          case 3:
            return true;
        }
...
` + a + "^";
      ...
      test_match: m$1(function(n, a) {
        ...
        }, this.options.ranges && (p.yylloc.range = this.yylloc.range.slice(0))), y2 = n[0].match(/(?:\r\n?|\n).*/g), y2 && (this.yylineno += y2.length), this.yylloc = {
        ...
        ]), this._more = false, this._backtrack = false, this._input = this._input.slice(n[0].length), this.matched += n[0], o = this.performAction.call(this, this.yy, this, a, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), o) return o;
        if (this._backtrack) {
      ...
      next: m$1(function() {
        ...
        for (var p = this._currentRules(), l = 0; l < p.length; l++) if (o = this._input.match(this.rules[p[l]]), o && (!a || o[0].length > a[0].length)) {
          if (a = o, y2 = l, this.options.backtrack_lexer) {
            if (n = this.test_match(o, p[l]), n !== false) return n;
            if (this._backtrack) {
              a = false;
              continue;
            } else return false;
        ...
        return a ? (n = this.test_match(a, p[y2]), n !== false ? n : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: m$1(function(a, o, y2, p) {
        switch (y2) {
          case 0:
            break;
          case 1:
...
U.parser = U;
var gt = U;
var V = "", Z = [], L = [], R = [], Et = m$1(function() {
  Z.length = 0, L.length = 0, V = "", R.length = 0, Sf();
}, "clear"), Ct = m$1(function(t) {
  V = t, Z.push(t);
}, "addSection"), Pt = m$1(function() {
  return Z;
}, "getSections"), It = m$1(function() {
  let t = mt(), e = 100, s = 0;
  for (; !t && s < e; ) t = mt(), s++;
  return L.push(...R), L;
}, "getTasks"), At = m$1(function() {
  let t = [];
  return L.forEach((s) => {
  ...
  L.push(e);
}, "addTaskOrg"), mt = m$1(function() {
  let t = m$1(function(s) {
    return R[s].processed;
  }, "compileTask"), e = true;
  for (let [s, c] of R.entries()) t(s), e = e && c.processed;
  return e;
}, "compileTasks"), Lt = m$1(function() {
  return At();
}, "getActors"), J = {
  getConfig: m$1(() => Hl().journey, "getConfig"),
  clear: Et,
  setDiagramTitle: Mf,
  getDiagramTitle: Lf,
  setAccTitle: vf,
...
`, "getStyles"), xt = Rt;
var K = m$1(function(t, e) {
  return x(t, e);
}, "drawRect"), Nt = m$1(function(t, e) {
  ...
  function u(f) {
    let x2 = bc().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
    f.append("path").attr("class", "mouth").attr("d", x2).attr("transform", "translate(" + e.cx + "," + (e.cy + 2) + ")");
  }
  m$1(u, "smile");
  function h2(f) {
    let x2 = bc().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
...
}, "drawCircle"), bt = m$1(function(t, e) {
  return y(t, e);
}, "drawText"), Bt = m$1(function(t, e) {
  function s(i, u, h2, d, f) {
    return i + "," + u + " " + (i + h2) + "," + u + " " + (i + h2) + "," + (u + d - f) + " " + (i + h2 - f * 1.2) + "," + (u + d) + " " + i + "," + (u + d);
  }
  m$1(s, "genPoints");
  let c = t.append("polygon");
  c.attr("points", s(e.x, e.y, 50, 20, 7)), c.attr("class", "labelBox"), e.y = e.y + e.labelMargin, e.x = e.x + 0.5 * e.labelMargin, bt(t, e);
}, "drawLabel"), jt = m$1(function(t, e, s) {
  let c = t.append("g"), i = h();
...
}, "drawSection"), kt = -1, zt = m$1(function(t, e, s) {
...
}, "drawTask"), Yt = m$1(function(t, e) {
  g(t, e);
}, "drawBackgroundRect"), vt = function() {
  function t(i, u, h2, d, f, x2, m, g2) {
    let n = u.append("text").attr("x", h2 + f / 2).attr("y", d + x2 / 2 + 5).style("font-color", g2).style("text-anchor", "middle").text(i);
    c(n, m);
  }
  m$1(t, "byText");
  function e(i, u, h2, d, f, x2, m, g2, n) {
    let { taskFontSize: a, taskFontFamily: o } = g2, y2 = i.split(/<br\s*\/?>/gi);
    for (let p = 0; p < y2.length; p++) {
      let l = p * a - a * (y2.length - 1) / 2, $ = u.append("text").attr("x", h2 + f / 2).attr("y", d).attr("fill", n).style("text-anchor", "middle").style("font-size", a).style("font-family", o);
  ...
  function s(i, u, h2, d, f, x2, m, g2) {
    let n = u.append("switch"), o = n.append("foreignObject").attr("x", h2).attr("y", d).attr("width", f).attr("height", x2).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
...
var Y = Hl().journey, I = Y.leftMargin, Wt = m$1(function(t, e, s, c) {
  ...
  let f = d.select("#" + e);
  F.initGraphics(f);
  let x2 = c.db.getTasks(), m = c.db.getDiagramTitle(), g2 = c.db.getActors();
  ...
  updateVal: m$1(function(t, e, s, c) {
    t[e] === void 0 ? t[e] = s : t[e] = c(s, t[e]);
  }, "updateVal"),
  updateBounds: m$1(function(t, e, s, c) {
    ...
    m$1(d, "updateFn"), this.sequenceItems.forEach(d());
  }, "updateBounds"),
  insert: m$1(function(t, e, s, c) {
    let i = Math.min(t, s), u = Math.max(t, s), h2 = Math.min(e, c), d = Math.max(e, c);
  ...
  bumpVerticalPos: m$1(function(t) {
...
}, Q = Y.sectionFills, wt = Y.sectionColours, Xt = m$1(function(t, e, s) {
  ...
  for (let [g2, n] of e.entries()) {
    ...
    let a = n.people.reduce((o, y2) => (E[y2] && (o[y2] = E[y2]), o), {});
