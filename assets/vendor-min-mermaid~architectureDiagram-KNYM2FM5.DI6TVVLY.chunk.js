...
import { r as rs, H as He, S as Sr$1, O as Ot } from './vendor-min-mermaid~chunk-3GKE4KUU.C-fENmn_.chunk.js';
...
import { K as Kf, Z as Zf, j as jf, X as Xf, J as Jf, Q as Qf, a as ah, O as Or$1, I as Il, V as Vf, t as tt, h as hh, k as kh } from './vendor-min-mermaid~chunk-U6SPV2NK.BkMACcv9.chunk.js';
...
}, "getArchitectureDirectionPair"), ar = /*#__PURE__*/ m$1(function([E, w], N) {
    let g = N[0], s = N[1];
    return Vt(g) ? Jt(s) ? [
        E + (g === "L" ? -1 : 1),
        w + (s === "T" ? 1 : -1)
...
var cr = Il.architecture, vt = new s(()=>({
        nodes: {},
        groups: {},
        edges: [],
        registeredIds: {},
    ...
    vt.reset(), Vf();
}, "clear"), Cr = /*#__PURE__*/ m$1(function({ id: E, icon: w, in: N, title: g, iconText: s }) {
...
}, "addService"), Mr = /*#__PURE__*/ m$1(()=>Object.values(vt.records.nodes).filter(hr), "getServices"), wr = /*#__PURE__*/ m$1(function({ id: E, in: w }) {
    vt.records.registeredIds[E] = "node", vt.records.nodes[E] = {
        id: E,
        type: "junction",
        edges: [],
...
}, "addJunction"), xr = /*#__PURE__*/ m$1(()=>Object.values(vt.records.nodes).filter(lr), "getJunctions"), Or = /*#__PURE__*/ m$1(()=>Object.values(vt.records.nodes), "getNodes"), xe = /*#__PURE__*/ m$1((E)=>vt.records.nodes[E], "getNode"), Rr = /*#__PURE__*/ m$1(function({ id: E, icon: w, in: N, title: g }) {
...
}, "addGroup"), Ir = /*#__PURE__*/ m$1(()=>Object.values(vt.records.groups), "getGroups"), Sr = /*#__PURE__*/ m$1(function({ lhsId: E, rhsId: w, lhsDir: N, rhsDir: g, lhsInto: s, rhsInto: n, lhsGroup: i, rhsGroup: a, title: c }) {
    ...
    if (vt.records.dataStructures === void 0) {
        let E = {}, w = /*#__PURE__*/ Object.entries(vt.records.nodes).reduce((a, [c, t])=>(a[c] = /*#__PURE__*/ t.edges.reduce((u, r)=>{
    ...
    await Promise.all(/*#__PURE__*/ w.edges().map(async (a)=>{
        ...
        if (r && (Vt(t) ? v += t === "L" ? -z : z : y += t === "T" ? -z : z + 18), l && (Vt(o) ? C += o === "L" ? -z : z : b += o === "T" ? -z : z + 18), !r && _t.getNode(c)?.type === "junction" && (Vt(t) ? v += t === "L" ? s : -s : y += t === "T" ? s : -s), !l && _t.getNode(e)?.type === "junction" && (Vt(o) ? C += o === "L" ? s : -s : b += o === "T" ? s : -s), a[0]._private.rscratch) {
            ...
            if (A) {
                ...
                }, /*#__PURE__*/ hh()), J.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), K === "X") J.attr("transform", "translate(" + D + ", " + S + ")");
        ...
        if (c.type === "group") {
            ...
            if (c.label) {
                ...
                await rs(A, c.label, {
                    ...
                    width: u,
                    classes: "architecture-service-label"
                }, /*#__PURE__*/ hh()), A.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), A.attr("transform", "translate(" + (f + i + 4) + ", " + (l + i + 2) + ")");
            }
        }
    }));
    ...
    for (let g of N){
        ...
        if (g.title) {
            ...
            await rs(t, g.title, {
                ...
                width: n * 1.5,
                classes: "architecture-service-label"
            }, /*#__PURE__*/ hh()), t.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), t.attr("transform", "translate(" + n / 2 + ", " + n + ")");
        }
        let i = /*#__PURE__*/ s.append("g");
        if (g.icon) i.html(`<g>${await He(g.icon, {
            height: n,
            width: n,
            fallbackPrefix: te.prefix
        })}</g>`);
        else if (g.iconText) {
            i.html(`<g>${await He("blank", {
                height: n,
                width: n,
                fallbackPrefix: te.prefix
            })}</g>`);
...
m$1(zr, "addEdges");
function Br(E, w, N) {
    let g = /*#__PURE__*/ m$1((a, c)=>Object.entries(a).reduce((t, [u, r])=>{
        ...
        let c = {}, t = {};
        return Object.entries(a).forEach(([u, [r, e]])=>{
    ...
    }), [n, i] = s.reduce(([a, c], { horiz: t, vert: u })=>[
            [
                ...a,
                ...t
            ],
...
function $r(E) {
    ...
    return E.forEach((s)=>{
        let n = /*#__PURE__*/ Object.fromEntries(/*#__PURE__*/ Object.entries(s).map(([t, u])=>[
                /*#__PURE__*/ N(u),
                t
            ])), i = [
            /*#__PURE__*/ N([
...
function kr(E, w, N, g, s, { spatialMaps: n, groupAlignments: i }) {
    return new Promise((a)=>{
        let c = /*#__PURE__*/ kh("body").append("div").attr("id", "cy").attr("style", "display:none"), t = /*#__PURE__*/ Gr$1({
...
var Zr = /*#__PURE__*/ m$1(async (E, w, N, g)=>{
    ...
    await pr(r, f), await vr(o, f), Wr(s, f), ah(void 0, u, /*#__PURE__*/ Gt("padding"), /*#__PURE__*/ Gt("useMaxWidth"));
}, "draw"), Tr = {
    draw: Zr
};
var Vi = {
