import { H as Hl, t as tt$1, i as ih, P as Pl, am as $t$1, an as F$1, ao as E, al as bc, aM as un, S as Sf } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
...
var X = function() {
    var n = m$1(function(m, i, a, c) {
        ...
        performAction: m$1(function(i, a, c, p, y, l, E) {
            var k = l.length - 1;
            switch(y){
                case 1:
                    return l[k - 1];
...
function St(n, t) {
    n.each(function() {
        var e = ih(this), o = e.text().split(/(\s+|<br>)/).reverse(), r, u = [], h = 1.1, f = e.attr("y"), g = parseFloat(e.attr("dy")), d = e.text(null).append("tspan").attr("x", 0).attr("y", f).attr("dy", g + "em");
...
var Ft = m$1(function(n, t, e, o) {
    ...
    return t.height = d.height + x * 1.1 * .5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, f.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), Ot(h, t, r, o), t;
...
var jt = m$1(function(n, t, e, o) {
    ...
    for (let _ of t){
        ...
        if (tt$1.debug("taskHeight after draw", c), i.attr("transform", `translate(${o}, ${r})`), u = Math.max(u, c), _.events) {
            let p = n.append("g").attr("class", "lineWrapper"), y = u;
            r += 100, y = y + Gt(n, _.events, e, o, r, h), r -= 100, p.append("line").attr("x1", o + 190 / 2).attr("y1", r + u).attr("x2", o + 190 / 2).attr("y2", r + u + (x ? u : d) + g + 120).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", "url(#arrowhead)").attr("stroke-dasharray", "5,5");
        }
        o = o + 200, x && !h.timeline?.disableMulticolor && e++;
    }
    r = r - 10;
}, "drawTasks"), Gt = m$1(function(n, t, e, o, r, u) {
    let h = 0, f = r;
    r = r + 100;
    for (let g of t){
        let d = {
