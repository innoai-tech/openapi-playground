import { h, x as x$1 } from './vendor-min-mermaid~chunk-WONJCSFZ.ByeypGzV.chunk.js';
import { M, S as St, W as Wt$1 } from './vendor-min-mermaid~chunk-EFRVIJHI.wT3iKf0B.chunk.js';
import { f } from './vendor-min-mermaid~chunk-THXVA4DE.BFlBPHyk.chunk.js';
import { G as Go, $ as $o, U as Uo, H as Ho, m as mr, W as Wo, v, o as ot, h as hn } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
...
var F = [], mt = [
    ...
    getConfig: /*#__PURE__*/ m$1(()=>mr().c4, "getConfig"),
    clear: d0,
    LINETYPE: f0,
    ARROWTYPE: p0,
    PLACEMENT: y0,
...
var se = /*#__PURE__*/ m$1(function(e, t) {
    ...
    function t(l, n, a, r, i, u, d, b) {
        let { fontSize: p, fontFamily: E, fontWeight: T } = b, D = /*#__PURE__*/ l.split(hn.lineBreakRegex);
...
function z(e, t, s, o, l) {
    if (!t[e].width) if (s) t[e].text = /*#__PURE__*/ St(t[e].text, l, o), t[e].textLines = t[e].text.split(hn.lineBreakRegex).length, t[e].width = l, t[e].height = /*#__PURE__*/ Wt$1(t[e].text, o);
    else {
...
var P0 = /*#__PURE__*/ m$1(function(e, t, s, o) {
    ...
    d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * x.diagramMarginX).attr("y", p.starty + x.diagramMarginY), Wo(i, T, P, x.useMaxWidth);
    let B = d ? 60 : 0;
