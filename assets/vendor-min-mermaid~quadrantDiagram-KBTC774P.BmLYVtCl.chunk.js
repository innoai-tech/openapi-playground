...
var _a, __, _b, __2;
import { B as Bf, F as Ff, L as Lf, M as Mf, w as wf, v as vf, H as Hl, t as tt, i as ih, T as Tf, S as Sf, p as pl, W as hl, a1 as Is, O as Oe } from "./vendor-min-mermaid~chunk-ZKYS2E5M.DYmB7G2x.chunk.js";
...
` + t);
  ...
  i === "sandbox" && (A = ih("#i" + n));
  let T = (i === "sandbox" ? ih(A.nodes()[0].contentDocument.body) : ih("body")).select(`[id="${n}"]`), m = T.append("g").attr("class", "main"), b = ((_a2 = S.quadrantChart) == null ? void 0 : _a2.chartWidth) ?? 500, q = ((_b2 = S.quadrantChart) == null ? void 0 : _b2.chartHeight) ?? 500;
