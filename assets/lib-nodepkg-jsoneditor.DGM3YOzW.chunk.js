...
var _e, _t, _n;
import { c as e, I as t, j as n, a as l, r as a, s as i, b as r, d as o, e as d, f as s, T as p, F as c, g as u, o as h, t as y, h as v } from "./lib-nodepkg-vuekit.C7_Of9rH.chunk.js";
import { o as m, J as f, S as x, a as b, r as g, s as w, E as N } from "./lib-nodepkg-typedef.B3bE_0L5.chunk.js";
import { s as C, v as S, P as $, a as k, b as O, B as E } from "./lib-nodepkg-vueuikit.UVLzLBkx.chunk.js";
import { I, a as T, m as A, b as D, c as R, d as L, e as J } from "./lib-nodepkg-vuematerial.DB3SQFbE.chunk.js";
import { O as P, s as M, m as B, f as _, d as W, t as j, E as z, c as H, B as F, S as U } from "./vendor-rxjs.ByE15jUQ.chunk.js";
import { i as V, g as K, a as X, b as q, s as G, l as Q, c as Y, d as Z, e as ee } from "./vendor-innoai-tech-lodash.BmKfyDt9.chunk.js";
import { M as et } from "./lib-nodepkg-vuemarkdown.CVG1X7Vr.chunk.js";
...
l((e3, t2) => {
  ...
  return a(o2, /* @__PURE__ */ r2((e4) => {
    var t3, l3, a2, r3;
    return /* @__PURE__ */ n($, { isOpen: e4, onClickOutside: () => o2.hide(), placement: "bottom-start", $content: /* @__PURE__ */ n(ec, { children: null === (t3 = i2.content) || void 0 === t3 ? void 0 : t3.call(i2) }), children: null !== (r3 = null === (a2 = i2.default) || void 0 === a2 ? void 0 : null === (l3 = /* @__PURE__ */ a2.call(i2)) || void 0 === l3 ? void 0 : l3[0]) && void 0 !== r3 ? r3 : null });
  }));
}, { displayName: "Popover", props: ["open$"] });
let ec = /* @__PURE__ */ C("div", { displayName: "PopoverContainer" })({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: /* @__PURE__ */ S("sys.outline-variant", /* @__PURE__ */ k(0.38)) }), eu = /* @__PURE__ */ C("div", { displayName: "MenuItem" })({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), eh = /* @__PURE__ */ l((e3, t2) => {
  ...
  return a(o2, /* @__PURE__ */ i2((t3) => {
    ...
    return /* @__PURE__ */ n($, { isOpen: t3, placement: null !== (i3 = e3.placement) && void 0 !== i3 ? i3 : "left", $content: /* @__PURE__ */ n(ev, { children: /* @__PURE__ */ n(ey, { children: /* @__PURE__ */ l2.title() }) }), children: d2 ? r(d2, { onMouseover: () => {
      o2.show();
    }, onMouseout: () => {
      o2.hide();
    } }) : null });
...
let e_ = /* @__PURE__ */ e(() => new eB()), eW = /* @__PURE__ */ l((e3, l2) => {
  let r2, { render: o2 } = l2, s2 = /* @__PURE__ */ h(null), p2 = /* @__PURE__ */ h(null), c2 = /* @__PURE__ */ h(null), u2 = /* @__PURE__ */ eM.from(c2), v2 = /* @__PURE__ */ eP.from(c2), m2 = /* @__PURE__ */ e_.use(), f2 = /* @__PURE__ */ ed.from(c2), b2 = /* @__PURE__ */ el.use();
  ...
  return (e3.allowRawJSON && a(v2, /* @__PURE__ */ j((t2) => {
    ...
    if (e4) {
      ...
      return n2(e4), B(/* @__PURE__ */ a(/* @__PURE__ */ _(e4, "blur"), /* @__PURE__ */ j((t3) => {
        if (t3.relatedTarget) {
          var n3, l3;
          if ((null === (n3 = p2.value) || void 0 === n3 ? void 0 : n3.contains(t3.relatedTarget)) || (null === (l3 = s2.value) || void 0 === l3 ? void 0 : l3.contains(t3.relatedTarget))) return;
        }
        t3.preventDefault(), S2(e4.value);
    ...
    var l3, a2, i2;
    let [r3, o3, { index: d2 }] = t2, u3 = null !== (l3 = /* @__PURE__ */ x.schemaProp(e3.typedef, "enum")) && void 0 !== l3 ? l3 : [], h2 = null !== (a2 = /* @__PURE__ */ x.metaProp(e3.typedef, "enumLabels")) && void 0 !== a2 ? a2 : [];
    return /* @__PURE__ */ n(ez, { ref: p2, onClick: () => {
      f2.show();
    }, "data-type": typeof r3, tabindex: 0, children: o3 ? /* @__PURE__ */ n(ep, { onSelected: (e4) => {
      S2(e4);
    }, open$: f2, $content: /* @__PURE__ */ n("div", { ref: s2, children: /* @__PURE__ */ u3.map((e4, t3) => /* @__PURE__ */ n(eF, { "data-focus": d2 % u3.length === t3, value: e4, label: h2[t3] })) }), children: /* @__PURE__ */ n("input", { value: void 0 == r3 ? "" : `${r3}`, ref: c2, "data-options": true }) }) : /* @__PURE__ */ n("span", { children: null !== (i2 = /* @__PURE__ */ JSON.stringify(r3)) && void 0 !== i2 ? i2 : "undefined" }) });
    ...
    return /* @__PURE__ */ n(ez, { ref: p2, onClick: () => {
      ...
      f2.show();
    }, children: a2 ? /* @__PURE__ */ n($, { isOpen: true, placement: "right-start", $content: /* @__PURE__ */ d(ej, { ref: s2, children: [/* @__PURE__ */ n(eo, { type: "button", onClick: () => u2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(I, { path: R }) }), /* @__PURE__ */ n(eo, { type: "button", onClick: () => u2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(I, { path: L }) })] }), children: /* @__PURE__ */ n("textarea", { ref: c2, rows: 1, value: void 0 == l3 ? "" : `${l3}` }) }) : /* @__PURE__ */ n("span", { "data-value": true, children: null !== (t2 = /* @__PURE__ */ JSON.stringify(l3)) && void 0 !== t2 ? t2 : "undefined" }) });
  }));
}, { displayName: "ValueInput", props: ["typedef", "ctx", "value", "allowRawJSON"] }), ej = /* @__PURE__ */ C("div", { displayName: "ValueInputActions" })({ borderRight: "1px solid", borderTop: "1px solid", borderBottom: "1px solid", borderColor: /* @__PURE__ */ S("sys.outline-variant", /* @__PURE__ */ k(0.38)), containerStyle: "sys.surface-container-lowest", roundedRight: "sm", display: "flex", px: 2, ml: -4 }), ez = /* @__PURE__ */ C("div", { displayName: "ValueContainer" })({ wordBreak: "keep-all", whiteSpace: "nowrap", cursor: "pointer", display: "flex", alignItems: "center", font: "code", width: "100%", textStyle: "sys.label-small", fontSize: 12, lineHeight: 24, gap: 8, "& [data-value]": { border: "1px solid", borderColor: "rgba(0,0,0,0)", maxWidth: "40vw", width: "100%", overflow: "hidden", textOverflow: "ellipsis", _hover: { textOverflow: "clip", whiteSpace: "normal", wordBreak: "break-all" } }, "& textarea,input": { border: "1px solid", borderColor: /* @__PURE__ */ S("sys.outline-variant", /* @__PURE__ */ k(0.38)), flex: 1, rounded: "xs", containerStyle: "sys.surface-container-lowest", width: "100%", maxWidth: "40vw", outline: "none", px: 8, py: 0, m: 0, fontSize: "inherit", color: "inherit", lineHeight: "inherit", overflow: "hidden", resize: "none", "&[data-options]:focus": { roundedBottom: 0 } }, _type__string: { color: "sys.primary" }, _type__number: { color: "sys.primary" }, _type__boolean: { color: "sys.warning" }, _type__undefined: { color: "sys.error" } }), eH = /* @__PURE__ */ C(eu, { displayName: "EnumMenuItemContainer" })({ [`& ${ef}`]: { textAlign: "left" } }), eF = /* @__PURE__ */ o((e3) => () => /* @__PURE__ */ d(eH, { "data-value": e3.value, tabindex: 0, children: [/* @__PURE__ */ n(ef, { children: e3.value }), e3.label && /* @__PURE__ */ n(eT, { children: e3.label })] }), { displayName: "EnumMenuItem", props: ["value", "label"] }), eU = /* @__PURE__ */ l((e3, t2) => {
  let {} = e3, { emit: l2 } = t2;
  ...
  return a(e3.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(eS, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(er, { children: /* @__PURE__ */ n(eJ, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eK, { ctx: e3.ctx, onAdd: (t4) => {
    ...
    return /* @__PURE__ */ d(e$, { path: c2, dirty: /* @__PURE__ */ i2.isDirty(s2, c2), title: /* @__PURE__ */ x.metaProp(p2, "title"), description: /* @__PURE__ */ x.metaProp(p2, "description"), children: [/* @__PURE__ */ n(ef, { deprecated: /* @__PURE__ */ x.schemaProp(p2, "deprecated"), $leading: /* @__PURE__ */ n(eU, { onRemove: () => {
      i2.delete(c2);
    } }), children: /* @__PURE__ */ String(o2) }), /* @__PURE__ */ d(em, { children: [":", " "] }), null === (a2 = r2.$value) || void 0 === a2 ? void 0 : a2.call(r2, p2, s2, { ...e3.ctx, path: c2, branch: [...e3.ctx.branch, s2] })] });
  }) })));
}, { displayName: "ObjectInput", props: ["typedef", "ctx", "value"] }), eK = /* @__PURE__ */ l((e3, l2) => {
  let { emit: r2, render: o2 } = l2, s2 = /* @__PURE__ */ h(null), p2 = /* @__PURE__ */ eM.from(s2), c2 = /* @__PURE__ */ eP.from(s2), u2 = /* @__PURE__ */ ed.from(s2), y2 = /* @__PURE__ */ el.use(), v2 = new t({ index: 0 }), m2 = () => {
    u2.hide(), c2.next(""), s2.value && (s2.value.value = "", s2.value.blur()), v2.next({ index: 0 });
  };
  a(c2, /* @__PURE__ */ j((t2) => {
    let n2 = /* @__PURE__ */ t2.trim();
  ...
  let b2 = /* @__PURE__ */ a(u2, /* @__PURE__ */ o2((e4) => /* @__PURE__ */ n("input", { ref: s2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)", "data-options": e4 })));
  return a(/* @__PURE__ */ H([c2, u2, v2, e3.options$]), /* @__PURE__ */ o2((t2) => {
    ...
    return r3 ? r3.length > 0 ? /* @__PURE__ */ n(e$, { path: e3.ctx.path, children: /* @__PURE__ */ n(ez, { sx: { mx: -4 }, children: /* @__PURE__ */ n(ep, { onSelected: (e4) => {
      f2(e4);
    }, open$: u2, $content: /* @__PURE__ */ n("div", { children: /* @__PURE__ */ r3.map((e4, t3) => l3 && !e4.propName.includes(l3) ? null : /* @__PURE__ */ n(eX, { propName: e4.propName, typedef: e4.typedef, "data-focus": t3 === i2.index % r3.length })) }), children: b2 }) }) }) : null : /* @__PURE__ */ n(e$, { path: [...e3.ctx.path, x.RecordKey], children: /* @__PURE__ */ n(ez, { sx: { mx: -4 }, children: /* @__PURE__ */ n($, { isOpen: a2, placement: "right-start", $content: /* @__PURE__ */ d(ej, { children: [/* @__PURE__ */ n(eo, { type: "button", onClick: () => p2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(I, { path: R }) }), /* @__PURE__ */ n(eo, { type: "button", onClick: () => p2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(I, { path: L }) })] }), children: /* @__PURE__ */ n("input", { ref: s2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)" }) }) }) });
  }));
}, { displayName: "PropValueInput", props: ["ctx", "options"], emits: ["add"] }), eX = /* @__PURE__ */ o((e3) => () => /* @__PURE__ */ d(eq, { "data-value": e3.propName, tabindex: 0, children: [/* @__PURE__ */ n(ef, { optional: /* @__PURE__ */ x.schemaProp(e3.typedef, x.optional), children: e3.propName }), /* @__PURE__ */ n(eT, { children: /* @__PURE__ */ x.metaProp(e3.typedef, "title") })] }), { displayName: "PropMenuItem", props: ["propName", "typedef"] }), eq = /* @__PURE__ */ C(eu, { displayName: "AddPropMenuItemContainer" })({ [`& ${ef}`]: { textAlign: "left" } }), eG = /* @__PURE__ */ l((e3, t2) => {
  let { render: l2 } = t2, i2 = /* @__PURE__ */ el.use(), r2 = /* @__PURE__ */ ea.use();
  return a(e3.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(eS, { openToken: "[", closeToken: "]", $leading: /* @__PURE__ */ n(er, { children: /* @__PURE__ */ n(eJ, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eQ, { ctx: e3.ctx, typedef: e3.typedef, onAdd: (t4) => {
    i2.update(e3.ctx.path, (e4) => {
      e4.push(t4);
    }, []);
  } }), children: /* @__PURE__ */ [.../* @__PURE__ */ e3.typedef.entries(t3, e3.ctx)].map((t4) => {
    var l3;
    let [a2, o2, s2] = t4, p2 = [...e3.ctx.path, a2];
    return /* @__PURE__ */ d(e$, { path: p2, dirty: /* @__PURE__ */ i2.isDirty(o2, p2), children: [/* @__PURE__ */ n(ef, { $leading: /* @__PURE__ */ n(eY, { onRemove: () => {
      i2.delete(p2);
    } }), children: /* @__PURE__ */ n(E, { sx: { opacity: 0.3, mr: "0.5em" }, children: /* @__PURE__ */ String(a2) }) }), null === (l3 = r2.$value) || void 0 === l3 ? void 0 : l3.call(r2, s2, o2, { ...e3.ctx, path: p2, branch: [...e3.ctx.branch, o2] })] });
  }) })));
}, { displayName: "ArrayInput", props: ["ctx", "value", "typedef"] }), eQ = /* @__PURE__ */ l((e3, t2) => {
  let { emit: l2, render: r2 } = t2, o2 = /* @__PURE__ */ h(null), s2 = /* @__PURE__ */ eP.from(o2), p2 = /* @__PURE__ */ eM.from(o2), c2 = /* @__PURE__ */ ed.from(o2), u2 = /* @__PURE__ */ el.use(), y2 = () => {
    o2.value && (o2.value.value = "", o2.value.blur());
  }, v2 = (t3) => {
    if (null != t3 || (t3 = s2.value), t3) {
  ...
  let m2 = /* @__PURE__ */ a(c2, /* @__PURE__ */ r2((e4) => /* @__PURE__ */ n($, { isOpen: e4, placement: "right-start", $content: /* @__PURE__ */ d(ej, { children: [/* @__PURE__ */ n(eo, { type: "button", onClick: () => p2.next({ type: "CANCEL" }), children: /* @__PURE__ */ n(I, { path: R }) }), /* @__PURE__ */ n(eo, { type: "button", onClick: () => p2.next({ type: "COMMIT" }), children: /* @__PURE__ */ n(I, { path: L }) })] }), children: /* @__PURE__ */ n("input", { ref: o2, type: "text", placeholder: "添加数组项 (可粘贴 JSON 字符串)" }) })));
  ...
  return a(e3.value$, /* @__PURE__ */ l2((t3) => /* @__PURE__ */ n(eS, { openToken: "{", closeToken: "}", $leading: /* @__PURE__ */ n(er, { children: /* @__PURE__ */ n(eJ, { value: t3 }) }), $trailing: /* @__PURE__ */ n(eK, { ctx: e3.ctx, onAdd: (t4) => {
    ...
    if (!Object.hasOwn(t3, o2)) return null;
    let c2 = [...e3.ctx.path, o2];
    return /* @__PURE__ */ d(e$, { path: c2, dirty: /* @__PURE__ */ i2.isDirty(s2, c2), children: [/* @__PURE__ */ n(ef, { $leading: /* @__PURE__ */ n(eU, { onRemove: () => {
      i2.delete(c2);
    } }), children: /* @__PURE__ */ String(o2) }), /* @__PURE__ */ d(em, { children: [":", " "] }), null === (a2 = r2.$value) || void 0 === a2 ? void 0 : a2.call(r2, p2, s2, { ...e3.ctx, path: c2, branch: [...e3.ctx.branch, s2] })] });
  }) })));
  ...
  return a(i2, /* @__PURE__ */ l2((e4) => {
    ...
    return /* @__PURE__ */ n(e_, { children: /* @__PURE__ */ n(ea, { value: { $value: null !== (l3 = r2.$value) && void 0 !== l3 ? l3 : e1 }, children: /* @__PURE__ */ d(e2, { children: [/* @__PURE__ */ n("section", { ref: o2 }), o2.value && /* @__PURE__ */ n(eC, { value: { indent: 0, $container: o2 }, children: /* @__PURE__ */ n(e$, { path: [], viewOnly: true, children: /* @__PURE__ */ a2(i2.typedef, e4, N) }) })] }) }) });
  }));
