import { H as Hl, t as tt$1, i as ih, P as Pl, am as $t$1, an as F$1, ao as E, al as bc, aM as un, S as Sf } from "./vendor-min-mermaid~chunk-ZKYS2E5M.CwhZsQ7z.chunk.js";
import { m as m$1, o } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
import "./lib-nodepkg-typedef.zwRRER3a.chunk.js";
var X = function() {
  var n = m$1(function(m, i, a, c) {
    ...
    performAction: m$1(function(i, a, c, p, y, l, E2) {
      var k = l.length - 1;
      switch (y) {
        case 1:
          return l[k - 1];
    ...
    parse: m$1(function(i) {
      var a = this, c = [
        ...
        null
      ], l = [], E2 = this.table, k = "", N = 0, C = 0, V = 0, et = 2, L = 1, v = l.slice.call(arguments, 1), b = Object.create(this.lexer), T = {
        yy: {}
      };
      ...
      for (var w, Z, B, M, Jt, J, R = {}, O, $, nt, j; ; ) {
        if (B = c[c.length - 1], this.defaultActions[B] ? M = this.defaultActions[B] : ((w === null || typeof w > "u") && (w = Mt()), M = E2[B] && E2[B][w]), typeof M > "u" || !M.length || !M[0]) {
          var K = "";
          j = [];
          for (O in E2[B]) this.terminals_[O] && O > et && j.push("'" + this.terminals_[O] + "'");
...
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : K = "Parse error on line " + (N + 1) + ": Unexpected " + (w == L ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(K, {
        ...
        switch (M[0]) {
          ...
          case 2:
            ...
            $ && (c = c.slice(0, -1 * $ * 2), y = y.slice(0, -1 * $), l = l.slice(0, -1 * $)), c.push(this.productions_[M[1]][0]), y.push(R.$), l.push(R._$), nt = E2[c[c.length - 2]][c[c.length - 1]], c.push(nt);
            break;
          case 3:
            return true;
        }
    ...
    var m = {
      EOF: 1,
      parseError: m$1(function(a, c) {
        if (this.yy.parser) this.yy.parser.parseError(a, c);
        else throw new Error(a);
      }, "parseError"),
      setInput: m$1(function(i, a) {
...
` + a + "^";
      ...
      test_match: m$1(function(i, a) {
        ...
        ]), this._more = false, this._backtrack = false, this._input = this._input.slice(i[0].length), this.matched += i[0], c = this.performAction.call(this, this.yy, this, a, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), c) return c;
        if (this._backtrack) {
      ...
      next: m$1(function() {
        ...
        for (var y = this._currentRules(), l = 0; l < y.length; l++) if (c = this._input.match(this.rules[y[l]]), c && (!a || c[0].length > a[0].length)) {
          if (a = c, p = l, this.options.backtrack_lexer) {
            if (i = this.test_match(c, y[l]), i !== false) return i;
            if (this._backtrack) {
              a = false;
              continue;
            } else return false;
...
` + this.showPosition(), {
      ...
      topState: m$1(function(a) {
        return a = this.conditionStack.length - 1 - Math.abs(a || 0), a >= 0 ? this.conditionStack[a] : "INITIAL";
      }, "topState"),
      pushState: m$1(function(a) {
        this.begin(a);
      }, "pushState"),
      ...
      performAction: m$1(function(a, c, p, y) {
        switch (p) {
          case 0:
            break;
          case 1:
...
var F = "", dt = 0, Y = [], G = [], W = [], pt = m$1(() => un, "getCommonDb"), yt = m$1(function() {
  Y.length = 0, G.length = 0, F = "", W.length = 0, Sf();
}, "clear"), ft = m$1(function(n) {
  F = n, Y.push(n);
}, "addSection"), gt = m$1(function() {
  return Y;
}, "getSections"), mt = m$1(function() {
  let n = ut(), t = 100, e = 0;
  for (; !n && e < t; ) n = ut(), e++;
  return G.push(...W), G;
}, "getTasks"), xt = m$1(function(n, t, e) {
  let o2 = {
    id: dt++,
    section: F,
    type: F,
  ...
  W.push(o2);
}, "addTask"), bt = m$1(function(n) {
  W.find((e) => e.id === dt - 1).events.push(n);
}, "addEvent"), kt = m$1(function(n) {
  let t = {
    section: F,
    type: F,
    description: n,
  ...
  G.push(t);
}, "addTaskOrg"), ut = m$1(function() {
  let n = m$1(function(e) {
...
var $t = 12, q = m$1(function(n, t) {
...
}, "drawRect"), At = m$1(function(n, t) {
  let o2 = n.append("circle").attr("cx", t.cx).attr("cy", t.cy).attr("class", "face").attr("r", 15).attr("stroke-width", 2).attr("overflow", "visible"), r = n.append("g");
  ...
  function u(g) {
    let d = bc().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
    g.append("path").attr("class", "mouth").attr("d", d).attr("transform", "translate(" + t.cx + "," + (t.cy + 2) + ")");
  }
  m$1(u, "smile");
  function h(g) {
    let d = bc().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
...
}, "drawCircle"), vt = m$1(function(n, t) {
  let e = t.text.replace(/<br\s*\/?>/gi, " "), o2 = n.append("text");
  o2.attr("x", t.x), o2.attr("y", t.y), o2.attr("class", "legend"), o2.style("text-anchor", t.anchor), t.class !== void 0 && o2.attr("class", t.class);
  let r = o2.append("tspan");
  return r.attr("x", t.x + t.textMargin * 2), r.text(e), o2;
}, "drawText"), Ct = m$1(function(n, t) {
  function e(r, u, h, f, g) {
    return r + "," + u + " " + (r + h) + "," + u + " " + (r + h) + "," + (u + f - g) + " " + (r + h - g * 1.2) + "," + (u + f) + " " + r + "," + (u + f);
  }
  m$1(e, "genPoints");
  let o2 = n.append("polygon");
  o2.attr("points", e(t.x, t.y, 50, 20, 7)), o2.attr("class", "labelBox"), t.y = t.y + t.labelMargin, t.x = t.x + 0.5 * t.labelMargin, vt(n, t);
}, "drawLabel"), Pt = m$1(function(n, t, e) {
  let o2 = n.append("g"), r = tt();
...
}, "drawSection"), _t = -1, Bt = m$1(function(n, t, e) {
  let o2 = t.x + e.width / 2, r = n.append("g");
  _t++;
  let u = 300 + 5 * 30;
...
}, "drawBackgroundRect"), Rt = m$1(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
function St(n, t) {
  n.each(function() {
    var e = ih(this), o2 = e.text().split(/(\s+|<br>)/).reverse(), r, u = [], h = 1.1, f = e.attr("y"), g = parseFloat(e.attr("dy")), d = e.text(null).append("tspan").attr("x", 0).attr("y", f).attr("dy", g + "em");
    for (let x = 0; x < o2.length; x++) r = o2[o2.length - 1 - x], u.push(r), d.text(u.join(" ").trim()), (d.node().getComputedTextLength() > t || r === "<br>") && (u.pop(), d.text(u.join(" ").trim()), r === "<br>" ? u = [
      ""
    ] : u = [
      r
...
m$1(St, "wrap");
var Ft = m$1(function(n, t, e, o2) {
  var _a;
  let r = e % $t - 1, u = n.append("g");
  t.section = r, u.attr("class", (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + r));
  let h = u.append("g"), f = u.append("g"), d = f.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(St, t.width).node().getBBox(), x = ((_a = o2.fontSize) == null ? void 0 : _a.replace) ? o2.fontSize.replace("px", "") : o2.fontSize;
  return t.height = d.height + x * 1.1 * 0.5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, f.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), Ot(h, t, r, o2), t;
}, "drawNode"), Wt = m$1(function(n, t, e) {
  var _a;
  let o2 = n.append("g"), u = o2.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(St, t.width).node().getBBox(), h = ((_a = e.fontSize) == null ? void 0 : _a.replace) ? e.fontSize.replace("px", "") : e.fontSize;
  return o2.remove(), u.height + h * 1.1 * 0.5 + t.padding;
}, "getVirtualNodeHeight"), Ot = m$1(function(n, t, e) {
...
var jt = m$1(function(n, t, e, o2) {
  var _a, _b;
  let r = Hl(), u = r.leftMargin ?? 50;
  tt$1.debug("timeline", o2.db);
  let h = r.securityLevel, f;
  h === "sandbox" && (f = ih("#i" + t));
  let d = (h === "sandbox" ? ih(f.nodes()[0].contentDocument.body) : ih("body")).select("#" + t);
  d.append("g");
  let x = o2.db.getTasks(), _ = o2.db.getCommonDb().getDiagramTitle();
  tt$1.debug("task", x), H.initGraphics(d);
  let m = o2.db.getSections();
  ...
  m.forEach(function(L) {
    ...
    tt$1.debug("sectionHeight before draw", b), i = Math.max(i, b + 20);
  });
  let N = 0, C = 0;
  ...
  for (let [L, v] of x.entries()) {
    ...
    tt$1.debug("taskHeight before draw", T), a = Math.max(a, T + 20), N = Math.max(N, v.events.length);
    let A = 0;
  ...
  tt$1.debug("maxSectionHeight before draw", i), tt$1.debug("maxTaskHeight before draw", a), m && m.length > 0 ? m.forEach((L) => {
    ...
    let T = d.append("g"), A = H.drawNode(T, b, E2, r);
    tt$1.debug("sectionNode output", A), T.attr("transform", `translate(${y}, ${p})`), l += i + 50, v.length > 0 && Et(d, v, E2, y, l, a, r, N, C, i, false), y += 200 * Math.max(v.length, 1), l = p, E2++;
  }) : (k = false, Et(d, x, E2, y, l, a, r, N, C, i, true));
  let V = d.node().getBBox();
  tt$1.debug("bounds", V), _ && d.append("text").text(_).attr("x", V.width / 2 - u).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), c = k ? i + a + 150 : a + 100, d.append("g").attr("class", "lineWrapper").append("line").attr("x1", u).attr("y1", c).attr("x2", V.width + 3 * u).attr("y2", c).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), Pl(void 0, d, ((_a = r.timeline) == null ? void 0 : _a.padding) ?? 50, ((_b = r.timeline) == null ? void 0 : _b.useMaxWidth) ?? false);
}, "draw"), Et = m$1(function(n, t, e, o2, r, u, h, f, g, d, x) {
  var _a;
  for (let _ of t) {
    let m = {
      descr: _.task,
    ...
    if (tt$1.debug("taskHeight after draw", c), i.attr("transform", `translate(${o2}, ${r})`), u = Math.max(u, c), _.events) {
  ...
  r = r - 10;
}, "drawTasks"), Gt = m$1(function(n, t, e, o2, r, u) {
  let h = 0, f = r;
  r = r + 100;
  for (let g of t) {
    let d = {
...
var qt = m$1((n) => {
  let t = "";
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], $t$1(n["lineColor" + e]) ? n["lineColor" + e] = F$1(n["lineColor" + e], 20) : n["lineColor" + e] = E(n["lineColor" + e], 20);
