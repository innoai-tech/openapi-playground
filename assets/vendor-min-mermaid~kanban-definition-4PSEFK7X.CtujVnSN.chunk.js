...
import { y as yo, s as sg, a as ag } from "./vendor-min-mermaid~chunk-USR3SDWQ.C0XgfhoF.chunk.js";
...
import { t as tt, H as Hl, P as Pl, p as pl, O as Oe, am as $t, an as F, ao as E } from "./vendor-min-mermaid~chunk-ZKYS2E5M.DYmB7G2x.chunk.js";
  ...
  var e = m$1(function(v, i, n, s) {
    ...
    parse: m$1(function(i) {
      ...
      for (var E2, Z, j, D, Ue, $, G = {}, X, I, he, Y; ; ) {
        if (j = s[s.length - 1], this.defaultActions[j] ? D = this.defaultActions[j] : ((E2 === null || typeof E2 > "u") && (E2 = Oe2()), D = R[j] && R[j][E2]), typeof D > "u" || !D.length || !D[0]) {
          var ee = "";
          Y = [];
...
}, "getData"), we = m$1((e, u, p, r, d2) => {
  var _a, _b;
  let _ = Hl(), b = ((_a = _.mindmap) == null ? void 0 : _a.padding) ?? pl.mindmap.padding;
  switch (r) {
    case f.ROUNDED_RECT:
    case f.RECT:
    case f.HEXAGON:
...
` + e);
  ...
  for (let y of g) {
    let A = K[M];
    M = M + 1;
    let O = ((_c = b == null ? void 0 : b.kanban) == null ? void 0 : _c.sectionWidth) || 200, U = -O * 3 / 2 + N, T = U, J = _.nodes.filter((i) => i.parentId === y.id);
    for (let i of J) {
...
var Ge = m$1((e) => {
  ...
  let p = m$1((r, d2) => e.darkMode ? E(r, d2) : F(r, d2), "adjuster");
