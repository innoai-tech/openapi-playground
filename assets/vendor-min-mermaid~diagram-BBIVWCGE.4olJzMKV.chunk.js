...
import { G as Gf, t as tt, j as jf, Z as Zf, J as Jf, b as td, Q as Qf, K as Kf, O as Or, I as Il, X as Xf } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
var O = Il.packet, b = class {
    constructor(){
        this.packet = [];
        this.setAccTitle = jf;
        this.getAccTitle = Zf;
...
var _ = 1e4, V = /*#__PURE__*/ m$1((e, t)=>{
    ...
    for (let { start: r, end: n, bits: d, label: p } of e.blocks){
        ...
        for(n ??= r + (d ?? 1) - 1, d ??= n - r + 1, a = n, tt.debug(`Packet block ${r} - ${a} with label ${p}`); o.length <= l + 1 && t.getPacket().length < _;){
            let [m, i] = q({
                start: r,
                end: n,
                bits: d,
...
var L = /*#__PURE__*/ m$1((e, t, a, o)=>{
    let s = o.db, l = /*#__PURE__*/ s.getConfig(), { rowHeight: r, paddingY: n, bitWidth: d$1, bitsPerRow: p } = l, m = /*#__PURE__*/ s.getPacket(), i = /*#__PURE__*/ s.getDiagramTitle(), g = r + n, f = g * (m.length + 1) - (i ? 0 : r), k = d$1 * p + 2, u = /*#__PURE__*/ d(t);
    u.attr("viewbox", `0 0 ${k} ${f}`), Gf(u, f, k, l.useMaxWidth);
...
}, "draw"), M = /*#__PURE__*/ m$1((e, t, a, { rowHeight: o, paddingX: s, paddingY: l, bitWidth: r, bitsPerRow: n, showBits: d })=>{
    let p = /*#__PURE__*/ e.append("g"), m = a * (o + l) + l;
    for (let i of t){
