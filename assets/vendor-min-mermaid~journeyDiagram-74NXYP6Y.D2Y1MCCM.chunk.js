import { g, h, y, x } from './vendor-min-mermaid~chunk-SQHZINSB.CUS1FH5S.chunk.js';
import { o } from './vendor-min-mermaid~chunk-ZZTKAOFA.BmEKORPt.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { Q as Qf, K as Kf, Z as Zf, j as jf, b as td, J as Jf, h as hh, k as kh, G as Gf, X as Xf, aq as Uc } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
...
var L = "", J = [], B = [], N = [], Pt = /*#__PURE__*/ m$1(function() {
    J.length = 0, B.length = 0, L = "", N.length = 0, Xf();
...
var S = hh().journey, I = 0, Ht = /*#__PURE__*/ m$1(function(t, e, s, c) {
    ...
    Gf(h, l, v, S.useMaxWidth), h.append("line").attr("x1", I).attr("y1", S.height * 4).attr("x2", v - I - 4).attr("y2", S.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
    let k = a ? 70 : 0;
