...
function xl(t10, e) {
  ...
  if (r != null) {
    ...
    try {
      for (r = /* @__PURE__ */ r.call(t10); !(n = (s = /* @__PURE__ */ r.next()).done) && (a.push(s.value), !(e && a.length === e)); n = true) ;
    } catch (l) {
      i = true, o = l;
    } finally {
      try {
...
function xi(t10, e) {
  if (t10) {
    ...
    var r = /* @__PURE__ */ Object.prototype.toString.call(t10).slice(8, -1);
...
function xt(t10, e) {
  ...
  if (!r) {
    if (Array.isArray(t10) || (r = /* @__PURE__ */ xi(t10)) || e && t10 && typeof t10.length == "number") {
      r && (t10 = r);
...
Ue && Ue.document;
var Cl = /* @__PURE__ */ Ye(""), mo = /* @__PURE__ */ Ye({}), Sl = /* @__PURE__ */ Ye(function() {
}), Dl = typeof HTMLElement > "u" ? "undefined" : Ye(HTMLElement), Ba = /* @__PURE__ */ m$1(function(e) {
  ...
  return a.cache = {}, a;
}, "memoize"), Ti = /* @__PURE__ */ ma(function(t10) {
  return t10.replace(/([A-Z])/g, function(e) {
    return "-" + e.toLowerCase();
  });
}), Tn = /* @__PURE__ */ ma(function(t10) {
  return t10.replace(/(-\w)/g, function(e) {
    return e[1].toUpperCase();
  });
}), xo = /* @__PURE__ */ ma(function(t10, e) {
...
function ev(t10) {
  for (var e = t10.length; e-- && jl.test(/* @__PURE__ */ t10.charAt(e)); ) ;
  return e;
}
...
function uv(t10) {
  var e = /* @__PURE__ */ sv.call(t10, ra), r = t10[ra];
  try {
    t10[ra] = void 0;
    var a = true;
  } catch {
  }
  var n = /* @__PURE__ */ ov.call(t10);
...
function Sv(t10) {
  ...
  t10 = /* @__PURE__ */ nv(t10);
  var r = /* @__PURE__ */ Ev.test(t10);
  return r || Tv.test(t10) ? Cv(/* @__PURE__ */ t10.slice(2), r ? 2 : 8) : xv.test(t10) ? es : +t10;
}
m$1(Sv, "toNumber");
...
function Bv(t10, e, r) {
  ...
  function g(T) {
    var E = a, D = n;
    return a = n = void 0, u = T, s = /* @__PURE__ */ t10.apply(D, E), s;
  }
  m$1(g, "invokeFunc");
  function h(T) {
...
var Ma = Bv, Gn = Ue ? Ue.performance : null, Po = Gn && Gn.now ? function() {
  ...
  return 0;
}, "zeroify"), Si = /* @__PURE__ */ m$1(function() {
}, "noop"), $e = /* @__PURE__ */ m$1(function(e) {
  throw new Error(e);
...
var Gv = /* @__PURE__ */ Xl(function(t10, e) {
  (function() {
    ...
    n = Math.floor, c = Math.min, a = /* @__PURE__ */ m$1(function(p, b1) {
      ...
      return t10.exports = /* @__PURE__ */ b1();
    }(this, function() {
      return r;
    });
  }).call(la);
  ...
  return {
    heightOffset: /* @__PURE__ */ Math.min(15, 0.05 * r),
...
var Wf = /* @__PURE__ */ et({
...
}, "getAllChildren"), ac = /* @__PURE__ */ m$1(function t2(e, r) {
  if (!e) return "";
  if (e.left && e.right) {
    var a = /* @__PURE__ */ t2(e.left, r), n = /* @__PURE__ */ t2(e.right, r), i = /* @__PURE__ */ r.add({
      group: "nodes",
      data: {
        id: a + "," + n
      }
...
}, "buildDendrogram"), nc = /* @__PURE__ */ m$1(function t3(e, r, a) {
  if (!e) return [];
  var n = [], i = [], s = [];
  return r === 0 ? (e.left && Wa(e.left, n), e.right && Wa(e.right, i), s = /* @__PURE__ */ n.concat(i), [
    ...
    /* @__PURE__ */ a.collection(e.value)
  ] : (e.left && (n = /* @__PURE__ */ t3(e.left, r - 1, a)), e.right && (i = /* @__PURE__ */ t3(e.right, r - 1, a)), n.concat(i));
  ...
  0.5 <= r && r < 1 || $e(/* @__PURE__ */ "Damping must range on [0.5, 1).  Got: ".concat(r));
  var n = [
    "median",
    "mean",
    "min",
...
var Yo = 0, _o = 1, Zo = 2, Xt = /* @__PURE__ */ m$1(function t4(e) {
...
}, "resolver"), yc = /* @__PURE__ */ m$1(function t5(e, r) {
  if (e === r || e.proxy === r) {
...
Xt.all = function(t10) {
  return new Xt(function(e, r) {
    for (var a = new Array(t10.length), n = 0, i = /* @__PURE__ */ m$1(function(l, u) {
...
function md(t10) {
  var e = this.__data__, r = /* @__PURE__ */ Bn(e, t10);
  if (r < 0) return false;
  var a = e.length - 1;
...
var Td = Ed;
function Cd(t10, e) {
  var r = this.__data__, a = /* @__PURE__ */ Bn(r, t10);
...
var An = Ld;
function Id(t10) {
  var e = /* @__PURE__ */ An(this, t10).delete(t10);
  return this.size -= e ? 1 : 0, e;
}
...
var Vd = Fd;
function qd(t10, e) {
  var r = /* @__PURE__ */ An(this, t10), a = r.size;
...
function Mi(t10, e) {
  ...
  var r = m$1(function() {
    ...
    var s = /* @__PURE__ */ t10.apply(this, a);
...
var Gd = Mi, Wd = 500;
function Hd(t10) {
  var e = /* @__PURE__ */ Gd(t10, function(a) {
    return r.size === Wd && r.clear(), a;
  }), r = e.cache;
  return e;
}
m$1(Hd, "memoizeCapped");
var Ud = Hd, Xd = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Yd = /\\(\\)?/g, _d = /* @__PURE__ */ Ud(function(t10) {
  var e = [];
...
function Zd(t10, e) {
  for (var r = -1, a = t10 == null ? 0 : t10.length, n = /* @__PURE__ */ Array(a); ++r < a; ) n[r] = /* @__PURE__ */ e(t10[r], r, t10);
  return n;
}
m$1(Zd, "arrayMap");
...
var sh = ih, oh = /* @__PURE__ */ function() {
  try {
    var t10 = /* @__PURE__ */ Ri(Object, "defineProperty");
    return t10({}, "", {}), t10;
  } catch {
  }
}(), Ss = oh;
...
function Eh(t10, e) {
  ...
  for (e || (e = /* @__PURE__ */ Array(a)); ++r < a; ) e[r] = t10[r];
  return e;
}
m$1(Eh, "copyArray");
var Th = Eh;
function Ch(t10) {
  return Pn(t10) ? tu(t10, Li) : Ra(t10) ? [
    t10
  ] : Th(/* @__PURE__ */ eu(/* @__PURE__ */ au(t10)));
}
m$1(Ch, "toPath");
var Sh = Ch, Dh = {
...
(function() {
  var t10, e, r;
  for (t10 = /* @__PURE__ */ ke.comparatorOp.split("|"), r = 0; r < t10.length; r++) e = t10[r], ke.comparatorOp += "|@" + e;
  for (t10 = /* @__PURE__ */ ke.comparatorOp.split("|"), r = 0; r < t10.length; r++) e = t10[r], !(e.indexOf("!") >= 0) && e !== "=" && (ke.comparatorOp += "|\\!" + e);
})();
...
Ge[oe.DATA_EXIST] = function(t10, e) {
  var r = t10.field;
  return t10.operator, Fh(/* @__PURE__ */ Ii(e, r));
};
Ge[oe.UNDIRECTED_EDGE] = function(t10, e) {
  var r = t10.nodes[0], a = t10.nodes[1], n = /* @__PURE__ */ e.source(), i = /* @__PURE__ */ e.target();
...
Ge[oe.DIRECTED_EDGE] = function(t10, e) {
  return Ve(t10.source, /* @__PURE__ */ e.source()) && Ve(t10.target, /* @__PURE__ */ e.target());
};
...
Ge[oe.CHILD] = function(t10, e) {
  return Ve(t10.child, e) && Ve(t10.parent, /* @__PURE__ */ e.parent());
};
...
var Dt = /* @__PURE__ */ m$1(function(e, r) {
  ...
  children: /* @__PURE__ */ Dt(function(t10) {
...
function Oi(t10, e, r, a) {
  for (var n = [], i = new Wr(), s = /* @__PURE__ */ t10.cy(), o = /* @__PURE__ */ s.hasCompoundNodes(), l = 0; l < t10.length; l++) {
    var u = t10[l];
...
function su(t10, e, r) {
  if (r.isParent()) for (var a = r._private.children, n = 0; n < a.length; n++) {
    var i = a[n];
    e.has(/* @__PURE__ */ i.id()) || t10.push(i);
  }
}
m$1(su, "addChildren");
...
function ou(t10, e, r) {
  if (r.isChild()) {
    ...
    e.has(/* @__PURE__ */ a.id()) || t10.push(a);
  }
}
m$1(ou, "addParent");
...
he(Rn, {
  degree: /* @__PURE__ */ Yn(function(t10, e) {
    return e.source().same(/* @__PURE__ */ e.target()) ? 2 : 1;
  }),
  indegree: /* @__PURE__ */ Yn(function(t10, e) {
    return e.target().same(t10) ? 1 : 0;
  }),
  outdegree: /* @__PURE__ */ Yn(function(t10, e) {
...
he(Rn, {
  minDegree: /* @__PURE__ */ Pr("degree", function(t10, e) {
    return t10 < e;
  }),
  maxDegree: /* @__PURE__ */ Pr("degree", function(t10, e) {
    return t10 > e;
  }),
  minIndegree: /* @__PURE__ */ Pr("indegree", function(t10, e) {
    return t10 < e;
  }),
  maxIndegree: /* @__PURE__ */ Pr("indegree", function(t10, e) {
    return t10 > e;
  }),
  minOutdegree: /* @__PURE__ */ Pr("outdegree", function(t10, e) {
    return t10 < e;
  }),
  maxOutdegree: /* @__PURE__ */ Pr("outdegree", function(t10, e) {
    return t10 > e;
  })
});
he(Rn, {
...
vr.renderedBoundingBox = function(t10) {
  var e = /* @__PURE__ */ this.boundingBox(t10), r = /* @__PURE__ */ this.cy(), a = /* @__PURE__ */ r.zoom(), n = /* @__PURE__ */ r.pan(), i = e.x1 * a + n.x, s = e.x2 * a + n.x, o = e.y1 * a + n.y, l = e.y2 * a + n.y;
  return {
    x1: i,
    x2: s,
    y1: o,
...
vr.dirtyCompoundBoundsCache = function() {
  var t10 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, e = /* @__PURE__ */ this.cy();
...
vr.boundingBox = function(t10) {
  var e;
  if (this.length === 1 && this[0]._private.bbCache != null && !this[0]._private.styleDirty && (t10 === void 0 || t10.useCache === void 0 || t10.useCache === true)) t10 === void 0 ? t10 = Da : t10 = /* @__PURE__ */ Bs(t10), e = /* @__PURE__ */ ks(this[0], t10);
  else {
    e = /* @__PURE__ */ yt(), t10 = t10 || Da;
    var r = /* @__PURE__ */ Bs(t10), a = this, n = /* @__PURE__ */ a.cy(), i = /* @__PURE__ */ n.styleEnabled();
...
vr.boundingBoxAt = function(t10) {
  ...
  if (a && (n = /* @__PURE__ */ e.filter(function(u) {
    return u.isParent();
  }), e = /* @__PURE__ */ e.not(n)), Pe(t10)) {
    var i = t10;
    t10 = /* @__PURE__ */ m$1(function() {
      return i;
    }, "fn");
  }
  var s = /* @__PURE__ */ m$1(function(f, c) {
    return f._private.bbAtOldPos = /* @__PURE__ */ t10(f, c);
...
}, "renderedName"), ig = /* @__PURE__ */ Object.keys(As).reduce(function(t10, e) {
...
function xu(t10, e, r) {
  ...
  return (i = n[t10]) != null || (i = n[t10] = /* @__PURE__ */ e(r)), i;
}
m$1(xu, "styleCache");
function Ln(t10, e) {
  return t10 = /* @__PURE__ */ ar(t10), m$1(function(a) {
    return xu(t10, e, a);
  }, "cachedStyleFunction");
}
...
var _r = /* @__PURE__ */ Ln("eleTakesUpSpace", function(t10) {
...
var hg = /* @__PURE__ */ Ln("eleInteractive", function(t10) {
  return t10.pstyle("events").value === "yes" && t10.pstyle("visibility").value === "visible" && _r(t10);
}), gg = /* @__PURE__ */ Ln("parentInteractive", function(t10) {
...
var pg = /* @__PURE__ */ Ln("eleVisible", function(t10) {
  ...
  return function() {
    ...
    if (e.length === 2) {
      ...
      for (var s = e.length === 1 ? e[0] : null, o = 0; o < this.length; o++) {
        ...
        if (t10.overrideAble) {
          var c = /* @__PURE__ */ t10.overrideAble(l);
...
he(ot, {
  neighborhood: /* @__PURE__ */ Dt(function(t10) {
...
he(ot, {
  connectedEdges: /* @__PURE__ */ Dt(function(t10) {
  ...
  connectedNodes: /* @__PURE__ */ Dt(function(t10) {
    for (var e = [], r = this, a = 0; a < r.length; a++) {
      var n = r[a];
...
function Vs(t10) {
  ...
  return t10 = /* @__PURE__ */ he({}, e, t10), m$1(function(a) {
    for (var n = [], i = /* @__PURE__ */ this.edges(), s = t10, o = 0; o < i.length; o++) for (var l = i[o], u = l._private, f = u.source, c = f._private.data.id, d = u.data.target, g = f._private.edges, h = 0; h < g.length; h++) {
...
Fe.getElementById = function(t10) {
  t10 = "" + t10;
  var e = this._private.cy, r = /* @__PURE__ */ this._private.map.get(t10);
...
Fe.clone = function() {
  for (var t10 = /* @__PURE__ */ this.cy(), e = [], r = 0; r < this.length; r++) {
    var a = this[r], n = /* @__PURE__ */ a.json(), i = new Sn(t10, n, false);
    e.push(i);
  }
  return new at(t10, e);
};
Fe.copy = Fe.clone;
Fe.restore = function() {
  for (var t10 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true, r = this, a = /* @__PURE__ */ r.cy(), n = a._private, i = [], s = [], o, l = 0, u = r.length; l < u; l++) {
    var f = r[l];
  ...
  if (o.length > 0) {
    ...
    var K;
    n.hasCompoundNodes ? K = /* @__PURE__ */ a.collection().merge($).merge(/* @__PURE__ */ $.connectedNodes()).merge(/* @__PURE__ */ $.parent()) : K = $, K.dirtyCompoundBoundsCache().dirtyBoundingBoxCache().updateStyle(t10), t10 ? $.emitAndNotify("add") : e && $.emit("add");
  }
  return r;
};
Fe.removed = function() {
...
Fe.move = function(t10) {
  ...
  if (t10.source !== void 0 || t10.target !== void 0) {
    var s = /* @__PURE__ */ i(t10.source), o = /* @__PURE__ */ i(t10.target), l = s != null && e.hasElementWithId(s), u = o != null && e.hasElementWithId(o);
    ...
    var f = /* @__PURE__ */ i(t10.parent), c = f === null || e.hasElementWithId(f);
    if (c) {
...
function bg(t10, e, r, a) {
  ...
  t10 = /* @__PURE__ */ Math.min(t10, 1), r = /* @__PURE__ */ Math.min(r, 1), t10 = /* @__PURE__ */ Math.max(t10, 0), r = /* @__PURE__ */ Math.max(r, 0);
  ...
  function w() {
    for (var B = 0; B < l; ++B) d[B] = /* @__PURE__ */ y(B * u, t10, r);
  }
  ...
  function S(B) {
    ...
    --P;
    var R = (B - d[P]) / (d[P + 1] - d[P]), I = A + R * u, L = /* @__PURE__ */ p(I, t10, r);
  ...
  var D = /* @__PURE__ */ m$1(function(A) {
    return T || E(), t10 === e && r === a ? A : A === 0 ? 0 : A === 1 ? 1 : y(/* @__PURE__ */ S(A), e, a);
  }, "f");
...
var wg = /* @__PURE__ */ function() {
  ...
  ease: /* @__PURE__ */ ze(0.25, 0.1, 0.25, 1),
  "ease-in": /* @__PURE__ */ ze(0.42, 0, 1, 1),
  "ease-out": /* @__PURE__ */ ze(0, 0, 0.58, 1),
  "ease-in-out": /* @__PURE__ */ ze(0.42, 0, 0.58, 1),
  "ease-in-sine": /* @__PURE__ */ ze(0.47, 0, 0.745, 0.715),
  "ease-out-sine": /* @__PURE__ */ ze(0.39, 0.575, 0.565, 1),
  "ease-in-out-sine": /* @__PURE__ */ ze(0.445, 0.05, 0.55, 0.95),
  "ease-in-quad": /* @__PURE__ */ ze(0.55, 0.085, 0.68, 0.53),
  "ease-out-quad": /* @__PURE__ */ ze(0.25, 0.46, 0.45, 0.94),
  "ease-in-out-quad": /* @__PURE__ */ ze(0.455, 0.03, 0.515, 0.955),
  "ease-in-cubic": /* @__PURE__ */ ze(0.55, 0.055, 0.675, 0.19),
  "ease-out-cubic": /* @__PURE__ */ ze(0.215, 0.61, 0.355, 1),
  "ease-in-out-cubic": /* @__PURE__ */ ze(0.645, 0.045, 0.355, 1),
  "ease-in-quart": /* @__PURE__ */ ze(0.895, 0.03, 0.685, 0.22),
  "ease-out-quart": /* @__PURE__ */ ze(0.165, 0.84, 0.44, 1),
  "ease-in-out-quart": /* @__PURE__ */ ze(0.77, 0, 0.175, 1),
  "ease-in-quint": /* @__PURE__ */ ze(0.755, 0.05, 0.855, 0.06),
  "ease-out-quint": /* @__PURE__ */ ze(0.23, 1, 0.32, 1),
  "ease-in-out-quint": /* @__PURE__ */ ze(0.86, 0, 0.07, 1),
  "ease-in-expo": /* @__PURE__ */ ze(0.95, 0.05, 0.795, 0.035),
  "ease-out-expo": /* @__PURE__ */ ze(0.19, 1, 0.22, 1),
  "ease-in-out-expo": /* @__PURE__ */ ze(1, 0, 0, 1),
  "ease-in-circ": /* @__PURE__ */ ze(0.6, 0.04, 0.98, 0.335),
  "ease-out-circ": /* @__PURE__ */ ze(0.075, 0.82, 0.165, 1),
  "ease-in-out-circ": /* @__PURE__ */ ze(0.785, 0.135, 0.15, 0.86),
...
function qs(t10, e, r, a, n) {
  ...
  return t10 == null || ((t10.roundValue || t10.color) && (i = /* @__PURE__ */ Math.round(i)), t10.min !== void 0 && (i = /* @__PURE__ */ Math.max(i, t10.min)), t10.max !== void 0 && (i = /* @__PURE__ */ Math.min(i, t10.max))), i;
}
...
function Br(t10, e, r, a, n) {
  ...
  r < 0 ? r = 0 : r > 1 && (r = 1);
  var s = /* @__PURE__ */ $s(t10, n), o = /* @__PURE__ */ $s(e, n);
...
function xg(t10, e, r, a) {
  var n = !a, i = t10._private, s = e._private, o = s.easing, l = s.startTime, u = a ? t10 : t10.cy(), f = /* @__PURE__ */ u.style();
  ...
  if (s.duration === 0 ? y = 1 : y = (r - l) / s.duration, s.applying && (y = s.progress), y < 0 ? y = 0 : y > 1 && (y = 1), s.delay == null) {
    ...
    if (b1 && n && !t10.locked()) {
      var w = {};
      sa(p.x, b1.x) && (w.x = /* @__PURE__ */ Br(p.x, b1.x, y, m)), sa(p.y, b1.y) && (w.y = /* @__PURE__ */ Br(p.y, b1.y, y, m)), t10.position(w);
    }
    var x = s.startPan, S = s.pan, T = i.pan, E = S != null && a;
    E && (sa(x.x, S.x) && (T.x = /* @__PURE__ */ Br(x.x, S.x, y, m)), sa(x.y, S.y) && (T.y = /* @__PURE__ */ Br(x.y, S.y, y, m)), t10.emit("pan"));
    var D = s.startZoom, C = s.zoom, B = C != null && a;
    B && (sa(D, C) && (i.zoom = /* @__PURE__ */ Ea(i.minZoom, /* @__PURE__ */ Br(D, C, y, m), i.maxZoom)), t10.emit("zoom")), (E || B) && t10.emit("viewport");
    var A = s.style;
    if (A && A.length > 0 && n) {
...
lt.apply = function(t10) {
  for (var e = this, r = e._private, a = r.cy, n = /* @__PURE__ */ a.collection(), i = 0; i < t10.length; i++) {
    var s = t10[i], o = /* @__PURE__ */ e.getContextMeta(s);
    if (!o.empty) {
...
lt.getContextMeta = function(t10) {
  ...
  return a = /* @__PURE__ */ e.getPropertiesDiff(n, r), t10._private.styleCxtKey = r, {
    key: r,
    diffPropNames: a,
    empty: a.length === 0
  };
...
lt.updateStyleHints = function(t10) {
  var e = t10._private, r = this, a = r.propertyGroupNames, n = r.propertyGroupKeys, i = /* @__PURE__ */ m$1(function(U, te, se) {
  ...
  for (var c = /* @__PURE__ */ m$1(function(U, te) {
    ...
    if (w != null) {
      ...
      x.hashOverride != null ? E = /* @__PURE__ */ x.hashOverride(t10, w) : w.pfValue != null && (E = w.pfValue);
...
lt.applyParsedProperty = function(t10, e) {
  var r = this, a = e, n = t10._private.style, i, s = r.types, o = r.properties[a.name].type, l = a.bypass, u = n[a.name], f = u && u.bypass, c = t10._private, d = "mapping", g = /* @__PURE__ */ m$1(function(Y) {
  ...
  if (e.name === "curve-style" && t10.isEdge() && (e.value !== "bezier" && t10.isLoop() || e.value === "haystack" && (t10.source().isParent() || t10.target().isParent())) && (a = e = /* @__PURE__ */ this.parse(e.name, "bezier", l)), a.delete) return n[a.name] = void 0, h(), true;
  ...
  switch (a.mapped) {
    ...
    case s.fn: {
      ...
      if (i = /* @__PURE__ */ this.parse(a.name, q, a.bypass, d), !i) return Re("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + t10.id() + "` is invalid)"), false;
...
lt.update = function() {
  var t10 = this._private.cy, e = /* @__PURE__ */ t10.mutableElements();
  e.updateStyle();
};
lt.updateTransitions = function(t10, e) {
  ...
  if (n.length > 0 && i > 0) {
    for (var o = {}, l = false, u = 0; u < n.length; u++) {
      var f = n[u], c = /* @__PURE__ */ t10.pstyle(f), d = e[f];
      if (d) {
...
zi.getEmSizeInPixels = function() {
  var t10 = /* @__PURE__ */ this.containerCss("font-size");
...
Vt.getRawStyle = function(t10, e) {
  ...
  if (t10 = t10[0], t10) {
    for (var a = {}, n = 0; n < r.properties.length; n++) {
      var i = r.properties[n], s = /* @__PURE__ */ r.getStylePropertyValue(t10, i.name, e);
...
Vt.getStylePropertyValue = function(t10, e, r) {
  ...
  if (t10 = t10[0], t10) {
    ...
    var i = n.type, s = /* @__PURE__ */ t10.pstyle(n.name);
    if (s) {
      var o = s.value, l = s.units, u = s.strValue;
      if (r && i.number && o != null && ae(o)) {
        var f = /* @__PURE__ */ t10.cy().zoom(), c = /* @__PURE__ */ m$1(function(y) {
          return y * f;
...
Vt.getAnimationStartStyle = function(t10, e) {
  for (var r = {}, a = 0; a < e.length; a++) {
    var n = e[a], i = n.name, s = /* @__PURE__ */ t10.pstyle(i);
...
Vt.getNonDefaultPropertiesHash = function(t10, e, r) {
  ...
  for (l = 0; l < e.length; l++) if (n = e[l], i = /* @__PURE__ */ t10.pstyle(n, false), i != null) if (i.pfValue != null) a[0] = /* @__PURE__ */ ba(o, a[0]), a[1] = /* @__PURE__ */ wa(o, a[1]);
...
On.appendFromJson = function(t10) {
  for (var e = this, r = 0; r < t10.length; r++) {
    var a = t10[r], n = a.selector, i = a.style || a.css, s = /* @__PURE__ */ Object.keys(i);
    e.selector(n);
...
var tt = {};
(function() {
  var t10 = Xe, e = Ol, r = zl, a = Fl, n = Vl, i = /* @__PURE__ */ m$1(function(W) {
    return "^" + W + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
...
Nn.parse = function(t10, e, r, a) {
  ...
  var i = a === "mapping" || a === true || a === false || a == null ? "dontcare" : a, s = r ? "t" : "f", o = "" + e, l = /* @__PURE__ */ Ro(t10, o, s, i), u = n.propCache = n.propCache || [], f;
  return (f = u[l]) || (f = u[l] = /* @__PURE__ */ n.parseImplWarn(t10, e, r, a)), (r || a === "mapping") && (f = /* @__PURE__ */ zt(f), f && (f.value = /* @__PURE__ */ zt(f.value))), f;
};
Nn.parseImplWarn = function(t10, e, r, a) {
  var n = /* @__PURE__ */ this.parseImpl(t10, e, r, a);
  return !n && e != null && Re(/* @__PURE__ */ "The style property `".concat(t10, ": ").concat(e, "` is invalid")), n && (n.name === "width" || n.name === "height") && e === "label" && Re("The style value of `label` is deprecated for `" + n.name + "`"), n;
};
Nn.parseImpl = function(t10, e, r, a) {
  ...
  if (!(!l || a || e.length < 7 || e[1] !== "a")) {
    if (e.length >= 7 && e[0] === "d" && (f = /* @__PURE__ */ new RegExp(o.data.regex).exec(e))) {
      ...
      var h = /* @__PURE__ */ this.parse(t10, c[4]);
      if (!h || h.mapped) return false;
      var m = /* @__PURE__ */ this.parse(t10, c[5]);
  ...
  if (u.multiple && a !== "multiple") {
    ...
    for (var x = [], S = [], T = [], E = "", D = false, C = 0; C < w.length; C++) {
      var B = /* @__PURE__ */ n.parse(t10, w[C], r, "multiple");
...
var st = /* @__PURE__ */ m$1(function t6(e) {
...
ut.clear = function() {
  for (var t10 = this._private, e = t10.cy, r = /* @__PURE__ */ e.elements(), a = 0; a < this.length; a++) this[a] = void 0;
...
ut.cssRule = function(t10, e) {
  var r = /* @__PURE__ */ this.parse(t10, e);
  if (r) {
    var a = this.length - 1;
...
function Tu(t10) {
  this.options = /* @__PURE__ */ he({}, Ag, Rg, t10);
}
m$1(Tu, "BreadthFirstLayout");
Tu.prototype.run = function() {
  var t10 = this.options, e = t10.cy, r = t10.eles, a = /* @__PURE__ */ r.nodes().filter(function(ve) {
    return ve.isChildless();
  }), n = r, i = t10.directed, s = t10.acyclic || t10.maximal || t10.maximalAdjustments > 0, o = !!t10.boundingBox, l = /* @__PURE__ */ e.extent(), u = /* @__PURE__ */ yt(o ? t10.boundingBox : {
    x1: l.x1,
    y1: l.y1,
    w: l.w,
    h: l.h
  ...
  if (Et(t10.roots)) f = t10.roots;
    ...
    for (var c = [], d = 0; d < t10.roots.length; d++) {
      var g = t10.roots[d], h = /* @__PURE__ */ e.getElementById(g);
      c.push(h);
    }
    f = /* @__PURE__ */ e.collection(c);
  } else if (ce(t10.roots)) f = /* @__PURE__ */ e.$(t10.roots);
  ...
  if (t10.avoidOverlap) for (var N = 0; N < a.length; N++) {
    var $ = a[N], H = /* @__PURE__ */ $.layoutDimensions(t10), q = H.w, K = H.h;
  ...
  var se = {
    ...
    w: -1,
    h: -1
  }), Se = /* @__PURE__ */ Math.max(Q === 1 ? 0 : o ? (u.h - t10.padding * 2 - le.h) / (Q - 1) : (u.h - t10.padding * 2 - le.h) / (Q + 1), O), Me = /* @__PURE__ */ b1.reduce(function(ve, ue) {
    ...
    if (t10.circle) {
      ...
      var j = b1[me].length, k = /* @__PURE__ */ Math.max(j === 1 ? 0 : o ? (u.w - t10.padding * 2 - le.w) / ((t10.grid ? Me : j) - 1) : (u.w - t10.padding * 2 - le.w) / ((t10.grid ? Me : j) + 1), O), F = {
        x: se.x + (ge + 1 - (j + 1) / 2) * k,
...
function Cu(t10) {
  this.options = /* @__PURE__ */ he({}, Mg, t10);
}
m$1(Cu, "CircleLayout");
Cu.prototype.run = function() {
  var t10 = this.options, e = t10, r = t10.cy, a = e.eles, n = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, i = /* @__PURE__ */ a.nodes().not(":parent");
...
function Su(t10) {
  this.options = /* @__PURE__ */ he({}, Lg, t10);
}
m$1(Su, "ConcentricLayout");
Su.prototype.run = function() {
  for (var t10 = this.options, e = t10, r = e.counterclockwise !== void 0 ? !e.counterclockwise : e.clockwise, a = t10.cy, n = e.eles, i = /* @__PURE__ */ n.nodes().not(":parent"), s = /* @__PURE__ */ yt(e.boundingBox ? e.boundingBox : {
    x1: 0,
    y1: 0,
    w: /* @__PURE__ */ a.width(),
    h: /* @__PURE__ */ a.height()
...
function zn(t10) {
  this.options = /* @__PURE__ */ he({}, Ig, t10), this.options.layout = this;
...
zn.prototype.run = function() {
  ...
  var n = /* @__PURE__ */ Ht(), i = /* @__PURE__ */ m$1(function() {
    ...
    if (t10.animate === true || t10.animate === false) i(), r.one("layoutstop", t10.stop), r.emit({
      ...
      var d = /* @__PURE__ */ t10.eles.nodes(), g = /* @__PURE__ */ Du(a, t10, d);
      d.layoutPositions(r, t10, g);
    }
  }, "done"), l = 0, u = true;
  if (t10.animate === true) {
    var f = /* @__PURE__ */ m$1(function c() {
      for (var d = 0; u && d < t10.refresh; ) u = /* @__PURE__ */ s(l), l++, d++;
      if (!u) Hs(a, t10), o();
      else {
        var g = /* @__PURE__ */ Ht();
...
var Og = /* @__PURE__ */ m$1(function(e, r, a) {
...
}, "findLCA"), zg = /* @__PURE__ */ m$1(function t7(e, r, a, n) {
  var i = n.graphSet[a];
  ...
  for (var s = 0, o = 0; o < i.length; o++) {
    ...
    if (f.length !== 0) {
      var c = n.indexToGraph[n.idToIndex[f[0]]], d = /* @__PURE__ */ t7(e, r, c, n);
  ...
  return i;
}, "limitForce"), Zg = /* @__PURE__ */ m$1(function t8(e, r) {
  var a = e.parentId;
  if (a != null) {
...
function ku(t10) {
  this.options = /* @__PURE__ */ he({}, Qg, t10);
}
m$1(ku, "GridLayout");
ku.prototype.run = function() {
  var t10 = this.options, e = t10, r = t10.cy, a = e.eles, n = /* @__PURE__ */ a.nodes().not(":parent");
...
function Vi(t10) {
  this.options = /* @__PURE__ */ he({}, Jg, t10);
}
m$1(Vi, "NullLayout");
...
Pu.prototype.run = function() {
  var t10 = this.options, e = t10.eles, r = /* @__PURE__ */ e.nodes(), a = /* @__PURE__ */ Ke(t10.positions);
  function n(i) {
    if (t10.positions == null) return rf(/* @__PURE__ */ i.position());
...
function Bu(t10) {
  this.options = /* @__PURE__ */ he({}, ep, t10);
}
m$1(Bu, "RandomLayout");
Bu.prototype.run = function() {
  var t10 = this.options, e = t10.cy, r = t10.eles, a = /* @__PURE__ */ yt(t10.boundingBox ? t10.boundingBox : {
    x1: 0,
    y1: 0,
    w: /* @__PURE__ */ e.width(),
    h: /* @__PURE__ */ e.height()
...
m$1(Au, "NullRenderer");
var Us = /* @__PURE__ */ m$1(function() {
}, "noop"), Xs = /* @__PURE__ */ m$1(function() {
...
qi.registerArrowShapes = function() {
  var t10 = this.arrowShapes = {}, e = this, r = /* @__PURE__ */ m$1(function(u, f, c, d, g, h, m) {
    ...
    ce(f) && (f = t10[f]), t10[u] = /* @__PURE__ */ he({
      name: u,
      points: [
        -0.15,
        -0.3,
...
Sr.projectIntoViewport = function(t10, e) {
  var r = this.cy, a = /* @__PURE__ */ this.findContainerClientCoords(), n = a[0], i = a[1], s = a[4], o = /* @__PURE__ */ r.pan(), l = /* @__PURE__ */ r.zoom(), u = ((t10 - n) / s - o.x) / l, f = ((e - i) / s - o.y) / l;
  return [
    u,
    f
  ];
...
Sr.findContainerClientCoords = function() {
  ...
  var t10 = this.container, e = /* @__PURE__ */ t10.getBoundingClientRect(), r = /* @__PURE__ */ this.cy.window().getComputedStyle(t10), a = /* @__PURE__ */ m$1(function(p) {
...
Sr.findNearestElements = function(t10, e, r, a) {
  ...
  function b1(E) {
    ...
    if (C.edgeType === "segments" || C.edgeType === "straight" || C.edgeType === "haystack") {
      for (var L = C.allpts, O = 0; O + 3 < L.length; O += 2) if (pf(t10, e, L[O], L[O + 1], L[O + 2], L[O + 3], R) && M > (I = /* @__PURE__ */ xf(t10, e, L[O], L[O + 1], L[O + 2], L[O + 3]))) return y(E, I), true;
    } else if (C.edgeType === "bezier" || C.edgeType === "multibezier" || C.edgeType === "self" || C.edgeType === "compound") {
      for (var L = C.allpts, O = 0; O + 5 < C.allpts.length; O += 4) if (yf(t10, e, L[O], L[O + 1], L[O + 2], L[O + 3], L[O + 4], L[O + 5], R) && M > (I = /* @__PURE__ */ wf(t10, e, L[O], L[O + 1], L[O + 2], L[O + 3], L[O + 4], L[O + 5]))) return y(E, I), true;
    }
...
Sr.getAllInBox = function(t10, e, r, a) {
  var n = this.getCachedZSortedEles().interactive, i = [], s = /* @__PURE__ */ Math.min(t10, r), o = /* @__PURE__ */ Math.max(t10, r), l = /* @__PURE__ */ Math.min(e, a), u = /* @__PURE__ */ Math.max(e, a);
  t10 = s, r = o, e = l, a = u;
...
wn.calculateArrowAngles = function(t10) {
  ...
  if (r ? (f = e.haystackPts[0], c = e.haystackPts[1], d = e.haystackPts[2], g = e.haystackPts[3]) : (f = e.arrowStartX, c = e.arrowStartY, d = e.arrowEndX, g = e.arrowEndY), p = e.midX, b1 = e.midY, i) l = f - e.segpts[0], u = c - e.segpts[1];
    ...
    var h = e.allpts, m = /* @__PURE__ */ je(h[0], h[2], h[4], 0.1), y = /* @__PURE__ */ je(h[1], h[3], h[5], 0.1);
    l = f - m, u = c - y;
  } else l = f - p, u = c - b1;
  ...
  if (r && (p = (f + d) / 2, b1 = (c + g) / 2), l = d - f, u = g - c, i) {
    ...
    if (S.length / 2 % 2 === 0) {
      ...
      T = /* @__PURE__ */ je(h[B], h[A], h[P], 0.4999), E = /* @__PURE__ */ je(h[B + 1], h[A + 1], h[P + 1], 0.4999), D = /* @__PURE__ */ je(h[B], h[A], h[P], 0.5), C = /* @__PURE__ */ je(h[B + 1], h[A + 1], h[P + 1], 0.5);
    }
    l = D - T, u = C - E;
  }
  ...
  if (e.midsrcArrowAngle = /* @__PURE__ */ Ka(l, u), i) l = d - e.segpts[e.segpts.length - 2], u = g - e.segpts[e.segpts.length - 1];
    ...
    var h = e.allpts, R = h.length, m = /* @__PURE__ */ je(h[R - 6], h[R - 4], h[R - 2], 0.9), y = /* @__PURE__ */ je(h[R - 5], h[R - 3], h[R - 1], 0.9);
    l = d - m, u = g - y;
  } else l = d - p, u = g - b1;
...
wn.getArrowWidth = wn.getArrowHeight = function(t10, e) {
  ...
  return a || (a = Math.max(/* @__PURE__ */ Math.pow(t10 * 13.37, 0.9), 29) * e, r[t10 + ", " + e] = a, a);
};
...
vt.findMidptPtsEtc = function(t10, e) {
  var r = e.posPts, a = e.intersectionPts, n = e.vectorNormInverse, i, s = /* @__PURE__ */ t10.pstyle("source-endpoint"), o = /* @__PURE__ */ t10.pstyle("target-endpoint"), l = s.units != null && o.units != null, u = /* @__PURE__ */ m$1(function(S, T, E, D) {
  ...
  switch (f) {
    ...
    case "endpoints": {
      if (l) {
        var c = /* @__PURE__ */ this.manualEndptToPx(t10.source()[0], s), d = /* @__PURE__ */ We(c, 2), g = d[0], h = d[1], m = /* @__PURE__ */ this.manualEndptToPx(t10.target()[0], o), y = /* @__PURE__ */ We(m, 2), p = y[0], b1 = y[1], w = {
          x1: g,
          y1: h,
          x2: p,
          y2: b1
      ...
      } else Re(/* @__PURE__ */ "Edge ".concat(/* @__PURE__ */ t10.id(), " has edge-distances:endpoints specified without manual endpoints specified via source-endpoint and target-endpoint.  Falling back on edge-distances:intersection (default).")), i = a;
      break;
    }
  }
  return {
...
vt.findSegmentsPoints = function(t10, e) {
  var r = t10._private.rscratch, a = /* @__PURE__ */ t10.pstyle("segment-weights"), n = /* @__PURE__ */ t10.pstyle("segment-distances"), i = /* @__PURE__ */ t10.pstyle("segment-radii"), s = /* @__PURE__ */ t10.pstyle("radius-type"), o = /* @__PURE__ */ Math.min(a.pfValue.length, n.pfValue.length), l = i.pfValue[i.pfValue.length - 1], u = s.pfValue[s.pfValue.length - 1];
  r.edgeType = "segments", r.segpts = [], r.radii = [], r.isArcRadius = [];
  for (var f = 0; f < o; f++) {
    var c = a.pfValue[f], d = n.pfValue[f], g = 1 - c, h = c, m = /* @__PURE__ */ this.findMidptPtsEtc(t10, e), y = m.midptPts, p = m.vectorNormInverse, b1 = {
      x: y.x1 * g + y.x2 * h,
      y: y.y1 * g + y.y2 * h
    };
...
vt.findLoopPoints = function(t10, e, r, a) {
  var n = t10._private.rscratch, i = e.dirCounts, s = e.srcPos, o = /* @__PURE__ */ t10.pstyle("control-point-distances"), l = o ? o.pfValue[0] : void 0, u = t10.pstyle("loop-direction").pfValue, f = t10.pstyle("loop-sweep").pfValue, c = t10.pstyle("control-point-step-size").pfValue;
  n.edgeType = "self";
  var d = r, g = c;
  a && (d = 0, g = l);
...
vt.findCompoundLoopPoints = function(t10, e, r, a) {
  ...
  n.edgeType = "compound";
  var i = e.srcPos, s = e.tgtPos, o = e.srcW, l = e.srcH, u = e.tgtW, f = e.tgtH, c = t10.pstyle("control-point-step-size").pfValue, d = /* @__PURE__ */ t10.pstyle("control-point-distances"), g = d ? d.pfValue[0] : void 0, h = r, m = c;
  a && (h = 0, m = g);
  var y = 50, p = {
    x: i.x - o / 2,
    y: i.y - l / 2
  ...
  }, x = 0.5, S = /* @__PURE__ */ Math.max(x, /* @__PURE__ */ Math.log(o * 0.01)), T = /* @__PURE__ */ Math.max(x, /* @__PURE__ */ Math.log(u * 0.01));
  n.ctrlpts = [
    w.x,
...
vt.findBezierPoints = function(t10, e, r, a, n) {
  var i = t10._private.rscratch, s = t10.pstyle("control-point-step-size").pfValue, o = /* @__PURE__ */ t10.pstyle("control-point-distances"), l = /* @__PURE__ */ t10.pstyle("control-point-weights"), u = o && l ? Math.min(o.value.length, l.value.length) : 1, f = o ? o.pfValue[0] : void 0, c = l.value[0], d = a;
  i.edgeType = d ? "multibezier" : "bezier", i.ctrlpts = [];
  for (var g = 0; g < u; g++) {
    var h = (0.5 - e.eles.length / 2 + r) * s * (n ? -1 : 1), m = void 0, y = /* @__PURE__ */ zo(h);
    d && (f = o ? o.pfValue[g] : s, c = l.value[g]), a ? m = f : m = f !== void 0 ? y * f : void 0;
    var p = m !== void 0 ? m : h, b1 = 1 - c, w = c, x = /* @__PURE__ */ this.findMidptPtsEtc(t10, e), S = x.midptPts, T = x.vectorNormInverse, E = {
      x: S.x1 * b1 + S.x2 * w,
      y: S.y1 * b1 + S.y2 * w
    };
...
vt.storeAllpts = function(t10) {
  ...
  if (e.edgeType === "multibezier" || e.edgeType === "bezier" || e.edgeType === "self" || e.edgeType === "compound") {
    ...
    var a, n;
    e.ctrlpts.length / 2 % 2 === 0 ? (a = e.allpts.length / 2 - 1, e.midX = e.allpts[a], e.midY = e.allpts[a + 1]) : (a = e.allpts.length / 2 - 3, n = 0.5, e.midX = /* @__PURE__ */ je(e.allpts[a], e.allpts[a + 2], e.allpts[a + 4], n), e.midY = /* @__PURE__ */ je(e.allpts[a + 1], e.allpts[a + 3], e.allpts[a + 5], n));
...
Na.manualEndptToPx = function(t10, e) {
  var r = this, a = /* @__PURE__ */ t10.position(), n = /* @__PURE__ */ t10.outerWidth(), i = /* @__PURE__ */ t10.outerHeight(), s = t10._private.rscratch;
  if (e.value.length === 2) {
    var o = [
      e.pfValue[0],
      e.pfValue[1]
...
Na.findEndpoints = function(t10) {
  var e = this, r, a = t10.source()[0], n = t10.target()[0], i = /* @__PURE__ */ a.position(), s = /* @__PURE__ */ n.position(), o = t10.pstyle("target-arrow-shape").value, l = t10.pstyle("source-arrow-shape").value, u = t10.pstyle("target-distance-from-node").pfValue, f = t10.pstyle("source-distance-from-node").pfValue, c = a._private.rscratch, d = n._private.rscratch, g = t10.pstyle("curve-style").value, h = t10._private.rscratch, m = h.edgeType, y = g === "taxi", p = m === "self" || m === "compound", b1 = m === "bezier" || m === "multibezier" || p, w = m !== "bezier", x = m === "straight" || m === "segments", S = m === "segments", T = b1 || w || x, E = p || y, D = /* @__PURE__ */ t10.pstyle("source-endpoint"), C = E ? "outside-to-node" : D.value, B = a.pstyle("corner-radius").value === "auto" ? "auto" : a.pstyle("corner-radius").pfValue, A = /* @__PURE__ */ t10.pstyle("target-endpoint"), P = E ? "outside-to-node" : A.value, M = n.pstyle("corner-radius").value === "auto" ? "auto" : n.pstyle("corner-radius").pfValue;
  ...
  var Le = /* @__PURE__ */ Ga(r, R, e.arrowShapes[o].spacing(t10) + u), ve = /* @__PURE__ */ Ga(r, R, e.arrowShapes[o].gap(t10) + u);
  ...
  var ie = /* @__PURE__ */ Ga(r, I, e.arrowShapes[l].spacing(t10) + f), de = /* @__PURE__ */ Ga(r, I, e.arrowShapes[l].gap(t10) + f);
...
Ki.storeEdgeProjections = function(t10) {
  ...
  if (e.rstyle.bezierPts = null, e.rstyle.linePts = null, e.rstyle.haystackPts = null, a === "multibezier" || a === "bezier" || a === "self" || a === "compound") {
    e.rstyle.bezierPts = [];
    for (var n = 0; n + 5 < r.allpts.length; n += 4) np(this, t10, /* @__PURE__ */ r.allpts.slice(n, n + 6));
...
qt.recalculateNodeLabelProjection = function(t10) {
  ...
  if (!rr(e)) {
    var r, a, n = t10._private, i = /* @__PURE__ */ t10.width(), s = /* @__PURE__ */ t10.height(), o = /* @__PURE__ */ t10.padding(), l = /* @__PURE__ */ t10.position(), u = t10.pstyle("text-halign").strValue, f = t10.pstyle("text-valign").strValue, c = n.rscratch, d = n.rstyle;
    switch (u) {
      case "left":
        r = l.x - i / 2 - o;
        break;
...
var Ou = /* @__PURE__ */ m$1(function(e, r) {
  ...
  var i = /* @__PURE__ */ Ea(0, n - 1e-3, 1), s = /* @__PURE__ */ Ea(0, n + 1e-3, 1), o = /* @__PURE__ */ Or(e, r, a, i), l = /* @__PURE__ */ Or(e, r, a, s);
  return Nu(o, l);
}, "bezierAngle");
...
qt.applyPrefixedLabelDimensions = function(t10, e) {
  var r = t10._private, a = /* @__PURE__ */ this.getLabelText(t10, e), n = /* @__PURE__ */ this.calculateLabelDimensions(t10, a), i = t10.pstyle("line-height").pfValue, s = t10.pstyle("text-wrap").strValue, o = At(r.rscratch, "labelWrapCachedLines", e) || [], l = s !== "wrap" ? 1 : Math.max(o.length, 1), u = n.height / l, f = u * i, c = n.width, d = n.height + (l - 1) * (i - 1) * u;
...
qt.getLabelText = function(t10, e) {
  var r = t10._private, a = e ? e + "-" : "", n = t10.pstyle(a + "label").strValue, i = t10.pstyle("text-transform").value, s = /* @__PURE__ */ m$1(function(Y, Z) {
...
`), c = t10.pstyle("text-max-width").pfValue, d = t10.pstyle("text-overflow-wrap").value, g = d === "anywhere", h = [], m = /[\s\u200b]+|$/g, y = 0; y < f.length; y++) {
      var p = f[y], b1 = /* @__PURE__ */ this.calculateLabelDimensions(t10, p), w = b1.width;
      if (g) {
      ...
      if (w > c) {
        ...
        try {
          for (D.s(); !(C = /* @__PURE__ */ D.n()).done; ) {
            ...
            E = B.index + A.length;
            var M = T.length === 0 ? P : T + P + A, R = /* @__PURE__ */ this.calculateLabelDimensions(t10, M), I = R.width;
...
qt.calculateLabelDimensions = function(t10, e) {
  var r = this, a = /* @__PURE__ */ r.cy.window(), n = a.document, i = /* @__PURE__ */ ar(e, t10._private.labelDimsKey), s = r.labelDimCache || (r.labelDimCache = []), o = s[i];
  if (o != null) return o;
...
qt.calculateLabelAngle = function(t10, e) {
  var r = t10._private, a = r.rscratch, n = /* @__PURE__ */ t10.isEdge(), i = e ? e + "-" : "", s = /* @__PURE__ */ t10.pstyle(i + "text-rotation"), o = s.strValue;
  return o === "none" ? 0 : n && o === "autorotate" ? a.labelAutoAngle : o === "autorotate" ? 0 : s.pfValue;
};
qt.calculateLabelAngles = function(t10) {
  var e = this, r = /* @__PURE__ */ t10.isEdge(), a = t10._private, n = a.rscratch;
  n.labelAngle = /* @__PURE__ */ e.calculateLabelAngle(t10), r && (n.sourceLabelAngle = /* @__PURE__ */ e.calculateLabelAngle(t10, "source"), n.targetLabelAngle = /* @__PURE__ */ e.calculateLabelAngle(t10, "target"));
};
...
Fn.registerCalculationListeners = function() {
  var t10 = this.cy, e = /* @__PURE__ */ t10.collection(), r = this, a = /* @__PURE__ */ m$1(function(s) {
  ...
  r.binder(t10).on("bounds.* dirty.*", /* @__PURE__ */ m$1(function(s) {
    var o = s.target;
    a(o);
  ...
  var n = /* @__PURE__ */ m$1(function(s) {
    if (s) {
      ...
      r.recalculateRenderedStyle(e), e = /* @__PURE__ */ t10.collection();
    }
  }, "updateEleCalcs");
...
Qr.registerBinding = function(t10, e, r, a) {
  ...
  var l = /* @__PURE__ */ this.binder(t10);
  return l.on.apply(l, n);
};
Qr.binder = function(t10) {
  var e = this, r = /* @__PURE__ */ e.cy.window(), a = t10 === r || t10 === r.document || t10 === r.document.body || Al(t10);
...
Qr.load = function() {
  var t10 = this, e = /* @__PURE__ */ t10.cy.window(), r = /* @__PURE__ */ m$1(function(k) {
    return k.selected();
  ...
  var C = /* @__PURE__ */ m$1(function() {
    ...
    for (var F = /* @__PURE__ */ t10.findContainerClientCoords(), X = F[0], V = F[1], G = F[2], ne = F[3], _ = k.touches ? k.touches : [
      k
  ...
  t10.registerBinding(t10.container, "mousedown", /* @__PURE__ */ m$1(function(k) {
    if (B(k) && !(t10.hoverData.which === 1 && k.which !== 1)) {
      k.preventDefault(), w(), t10.hoverData.capture = true, t10.hoverData.which = k.which;
      var F = t10.cy, X = [
        k.clientX,
        k.clientY
      ], V = /* @__PURE__ */ t10.projectIntoViewport(X[0], X[1]), G = t10.selection, ne = /* @__PURE__ */ t10.findNearestElements(V[0], V[1], true, false), _ = ne[0], ie = t10.dragData.possibleDragElements;
      t10.hoverData.mdownPos = V, t10.hoverData.mdownGPos = X;
      var de = /* @__PURE__ */ m$1(function() {
        t10.hoverData.tapholdCancelled = false, clearTimeout(t10.hoverData.tapholdTimeout), t10.hoverData.tapholdTimeout = /* @__PURE__ */ setTimeout(function() {
      ...
      if (k.which == 3) {
        ...
        _ ? (_.activate(), _.emit(Ee), t10.hoverData.down = _) : F.emit(Ee), t10.hoverData.downTime = /* @__PURE__ */ (/* @__PURE__ */ new Date()).getTime(), t10.hoverData.cxtDragged = false;
      } else if (k.which == 1) {
        _ && _.activate();
        {
          if (_ != null && t10.nodeIsGrabbable(_)) {
            ...
            if (c(_), !_.selected()) ie = t10.dragData.possibleDragElements = /* @__PURE__ */ F.collection(), y(_, {
              addToList: ie
            }), _.emit(/* @__PURE__ */ fe("grabon")).emit(/* @__PURE__ */ fe("grab"));
            else {
              ie = t10.dragData.possibleDragElements = /* @__PURE__ */ F.collection();
          ...
          t10.hoverData.down = _, t10.hoverData.downs = ne, t10.hoverData.downTime = /* @__PURE__ */ (/* @__PURE__ */ new Date()).getTime();
        }
        n(_, [
          "mousedown",
          "tapstart",
  ...
  var A = /* @__PURE__ */ a(t10.container);
  t10.registerBinding([
    e,
    A
    ...
    if (!(!F && !B(k))) {
      var X = false, V = t10.cy, G = /* @__PURE__ */ V.zoom(), ne = [
        k.clientX,
        k.clientY
      ], _ = /* @__PURE__ */ t10.projectIntoViewport(ne[0], ne[1]), ie = t10.hoverData.mdownPos, de = t10.hoverData.mdownGPos, Ee = t10.selection, fe = null;
      !t10.hoverData.draggingEles && !t10.hoverData.dragging && !t10.hoverData.selecting && (fe = /* @__PURE__ */ t10.findNearestElement(_[0], _[1], true, false));
      ...
      if (t10.hoverData.which === 3) {
        ...
        _ = /* @__PURE__ */ t10.projectIntoViewport(k.clientX, k.clientY);
        ...
        if (qe) {
          if (!t10.hoverData.dragging && V.boxSelectionEnabled() && (ft || !V.panningEnabled() || !V.userPanningEnabled())) Mt();
            ...
            var Gt = /* @__PURE__ */ s(xe, t10.hoverData.downs);
            Gt && (t10.hoverData.dragging = true, t10.hoverData.justStartedPan = true, Ee[4] = 0, t10.data.bgActivePosistion = /* @__PURE__ */ Lr(ie), t10.redrawHint("select", true), t10.redraw());
          }
  ...
  var P, M, R;
  t10.registerBinding(e, "mouseup", /* @__PURE__ */ m$1(function(k) {
    if (!(t10.hoverData.which === 1 && k.which !== 1 && t10.hoverData.capture)) {
      var F = t10.hoverData.capture;
      if (F) {
        t10.hoverData.capture = false;
        var X = t10.cy, V = /* @__PURE__ */ t10.projectIntoViewport(k.clientX, k.clientY), G = t10.selection, ne = /* @__PURE__ */ t10.findNearestElement(V[0], V[1], true, false), _ = t10.dragData.possibleDragElements, ie = t10.hoverData.down, de = /* @__PURE__ */ i(k);
        if (t10.data.bgActivePosistion && (t10.redrawHint("select", true), t10.redraw()), t10.hoverData.tapholdCancelled = true, t10.data.bgActivePosistion = void 0, ie && ie.unactivate(), t10.hoverData.which === 3) {
          ...
          if (n(ne, [
          ...
          }, /* @__PURE__ */ X.multiClickDebounceTime()), R = k.timeStamp)), ie == null && !t10.dragData.didDrag && !t10.hoverData.selecting && !t10.hoverData.dragged && !i(k) && (X.$(r).unselect([
            "tapunselect"
          ]), _.length > 0 && t10.redrawHint("eles", true), t10.dragData.possibleDragElements = _ = /* @__PURE__ */ X.collection()), ne == ie && !t10.dragData.didDrag && !t10.hoverData.selecting && ne != null && ne._private.selectable && (t10.hoverData.dragging || (X.selectionType() === "additive" || de ? ne.selected() ? ne.unselect([
            "tapunselect"
          ]) : ne.select([
            "tapselect"
            ...
            var we = /* @__PURE__ */ X.collection(/* @__PURE__ */ t10.getAllInBox(G[0], G[1], G[2], G[3]));
  ...
  var I = /* @__PURE__ */ m$1(function(k) {
    if (!t10.scrollingPage) {
      var F = t10.cy, X = /* @__PURE__ */ F.zoom(), V = /* @__PURE__ */ F.pan(), G = /* @__PURE__ */ t10.projectIntoViewport(k.clientX, k.clientY), ne = [
        G[0] * X + V.x,
        G[1] * X + V.y
      ];
      ...
      if (F.panningEnabled() && F.userPanningEnabled() && F.zoomingEnabled() && F.userZoomingEnabled()) {
        k.preventDefault(), t10.data.wheelZooming = true, clearTimeout(t10.data.wheelTimeout), t10.data.wheelTimeout = /* @__PURE__ */ setTimeout(function() {
  ...
  t10.registerBinding(t10.container, "wheel", I, true), t10.registerBinding(e, "scroll", /* @__PURE__ */ m$1(function(k) {
    t10.scrollingPage = true, clearTimeout(t10.scrollingPageTimeout), t10.scrollingPageTimeout = /* @__PURE__ */ setTimeout(function() {
      t10.scrollingPage = false;
    }, 250);
  }, "scrollHandler"), true), t10.registerBinding(t10.container, "gesturestart", /* @__PURE__ */ m$1(function(k) {
    t10.gestureStartZoom = /* @__PURE__ */ t10.cy.zoom(), t10.hasTouchStarted || k.preventDefault();
  }, "gestureStartHandler"), true), t10.registerBinding(t10.container, "gesturechange", function(j) {
    t10.hasTouchStarted || I(j);
  }, true), t10.registerBinding(t10.container, "mouseout", /* @__PURE__ */ m$1(function(k) {
    var F = /* @__PURE__ */ t10.projectIntoViewport(k.clientX, k.clientY);
    t10.cy.emit({
      originalEvent: k,
      type: "mouseout",
      position: {
  ...
  }, "mouseOutHandler"), false), t10.registerBinding(t10.container, "mouseover", /* @__PURE__ */ m$1(function(k) {
    var F = /* @__PURE__ */ t10.projectIntoViewport(k.clientX, k.clientY);
    t10.cy.emit({
      originalEvent: k,
      type: "mouseover",
  ...
  t10.registerBinding(t10.container, "touchstart", U = /* @__PURE__ */ m$1(function(k) {
    if (t10.hasTouchStarted = true, !!B(k)) {
      ...
      if (k.touches[0]) {
        var G = /* @__PURE__ */ t10.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
        X[0] = G[0], X[1] = G[1];
      }
      if (k.touches[1]) {
        var G = /* @__PURE__ */ t10.projectIntoViewport(k.touches[1].clientX, k.touches[1].clientY);
        X[2] = G[0], X[3] = G[1];
      }
      if (k.touches[2]) {
        var G = /* @__PURE__ */ t10.projectIntoViewport(k.touches[2].clientX, k.touches[2].clientY);
        X[4] = G[0], X[5] = G[1];
      }
      if (k.touches[1]) {
        t10.touchData.singleTouchMoved = true, p(t10.dragData.touchDragEles);
        var ne = /* @__PURE__ */ t10.findContainerClientCoords();
        ...
        var de = 200, Ee = de * de;
        if (q < Ee && !k.touches[2]) {
          var fe = /* @__PURE__ */ t10.findNearestElement(X[0], X[1], true, true), we = /* @__PURE__ */ t10.findNearestElement(X[2], X[3], true, true);
      ...
      if (k.touches[2]) F.boxSelectionEnabled() && k.preventDefault();
        ...
        if (k.touches[0]) {
          var xe = /* @__PURE__ */ t10.findNearestElements(X[0], X[1], true, true), pe = xe[0];
          if (pe != null && (pe.activate(), t10.touchData.start = pe, t10.touchData.starts = xe, t10.nodeIsGrabbable(pe))) {
            var Ne = t10.dragData.touchDragEles = /* @__PURE__ */ F.collection(), qe = null;
            t10.redrawHint("eles", true), t10.redrawHint("drag", true), pe.selected() ? (qe = /* @__PURE__ */ F.$(function(Qe) {
          ...
          n(pe, [
            ...
            x: G[0],
            y: G[1]
          }, t10.redrawHint("select", true), t10.redraw()), t10.touchData.singleTouchMoved = false, t10.touchData.singleTouchStartTime = +/* @__PURE__ */ new Date(), clearTimeout(t10.touchData.tapholdTimeout), t10.touchData.tapholdTimeout = /* @__PURE__ */ setTimeout(function() {
  ...
  var te;
  t10.registerBinding(e, "touchmove", te = /* @__PURE__ */ m$1(function(k) {
    var F = t10.touchData.capture;
    if (!(!F && !B(k))) {
      var X = t10.selection, V = t10.cy, G = t10.touchData.now, ne = t10.touchData.earlier, _ = /* @__PURE__ */ V.zoom();
      if (k.touches[0]) {
        var ie = /* @__PURE__ */ t10.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
        G[0] = ie[0], G[1] = ie[1];
      }
      if (k.touches[1]) {
        var ie = /* @__PURE__ */ t10.projectIntoViewport(k.touches[1].clientX, k.touches[1].clientY);
        G[2] = ie[0], G[3] = ie[1];
      }
      if (k.touches[2]) {
        var ie = /* @__PURE__ */ t10.projectIntoViewport(k.touches[2].clientX, k.touches[2].clientY);
        G[4] = ie[0], G[5] = ie[1];
      }
      ...
      if (F && t10.touchData.cxt) {
        ...
        var it = /* @__PURE__ */ t10.findNearestElement(G[0], G[1], true, true);
        ...
        var It = t10.touchData.start, bt = k.touches[0].clientX - Z, He = k.touches[0].clientY - J, Ze = k.touches[1].clientX - Z, Qe = k.touches[1].clientY - J, Ui = /* @__PURE__ */ W(bt, He, Ze, Qe), ll = Ui / H;
        if (re) {
        ...
        if (!t10.hoverData.draggingEles && !t10.swipePanning && (it = /* @__PURE__ */ t10.findNearestElement(G[0], G[1], true, true)), F && kt != null && k.preventDefault(), F && kt != null && t10.nodeIsDraggable(kt)) if (Ee) {
        ...
        if (F && (kt == null || kt.pannable()) && V.panningEnabled() && V.userPanningEnabled()) {
          var yl = /* @__PURE__ */ s(kt, t10.touchData.starts);
          yl && (k.preventDefault(), t10.data.bgActivePosistion || (t10.data.bgActivePosistion = /* @__PURE__ */ Lr(t10.touchData.startPosition)), t10.swipePanning ? (V.panBy({
            x: fe[0] * _,
            y: fe[1] * _
  ...
  var se;
  t10.registerBinding(e, "touchcancel", se = /* @__PURE__ */ m$1(function(k) {
    var F = t10.touchData.start;
    t10.touchData.capture = false, F && F.unactivate();
  }, "touchcancelHandler"));
  var le, Se, Me, Le;
  if (t10.registerBinding(e, "touchend", le = /* @__PURE__ */ m$1(function(k) {
    ...
    var G = t10.cy, ne = /* @__PURE__ */ G.zoom(), _ = t10.touchData.now, ie = t10.touchData.earlier;
    if (k.touches[0]) {
      var de = /* @__PURE__ */ t10.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
      _[0] = de[0], _[1] = de[1];
    }
    if (k.touches[1]) {
      var de = /* @__PURE__ */ t10.projectIntoViewport(k.touches[1].clientX, k.touches[1].clientY);
      _[2] = de[0], _[3] = de[1];
    }
    if (k.touches[2]) {
      var de = /* @__PURE__ */ t10.projectIntoViewport(k.touches[2].clientX, k.touches[2].clientY);
      _[4] = de[0], _[5] = de[1];
    }
    F && F.unactivate();
    var Ee;
    ...
    if (!k.touches[2] && G.boxSelectionEnabled() && t10.touchData.selecting) {
      ...
      var we = /* @__PURE__ */ G.collection(/* @__PURE__ */ t10.getAllInBox(V[0], V[1], V[2], V[3]));
      ...
      if (!k.touches[0]) {
        if (!k.touches[0]) {
          ...
          if (F != null) {
            ...
            var qe = /* @__PURE__ */ t10.findNearestElement(_[0], _[1], true, true);
            n(qe, [
              "touchend",
              "tapend",
              "vmouseup",
          ...
          }, /* @__PURE__ */ G.multiClickDebounceTime()), Le = k.timeStamp)), F != null && !t10.dragData.didDrag && F._private.selectable && ft < t10.touchTapThreshold2 && !t10.pinching && (G.selectionType() === "single" ? (G.$(r).unmerge(F).unselect([
            "tapunselect"
          ]), F.select([
            "tapselect"
...
Yt.generateBarrel = function() {
  return this.nodeShapes.barrel = {
    ...
    intersectLine: /* @__PURE__ */ m$1(function(e, r, a, n, i, s, o, l) {
      var u = 0.15, f = 0.5, c = 0.85, d = /* @__PURE__ */ this.generateBarrelBezierPts(a + 2 * o, n + 2 * o, e, r), g = /* @__PURE__ */ m$1(function(y) {
        var p = /* @__PURE__ */ Or({
          x: y[0],
          y: y[1]
        }, {
...
Yt.registerNodeShapes = function() {
  ...
  this.generateEllipse(), this.generatePolygon("triangle", /* @__PURE__ */ dt(3, 0)), this.generateRoundPolygon("round-triangle", /* @__PURE__ */ dt(3, 0)), this.generatePolygon("rectangle", /* @__PURE__ */ dt(4, 0)), t10.square = t10.rectangle, this.generateRoundRectangle(), this.generateCutRectangle(), this.generateBarrel(), this.generateBottomRoundrectangle();
  {
    var r = [
      0,
      1,
  ...
  var a = new Array(20);
  {
    var n = /* @__PURE__ */ ii(5, 0), i = /* @__PURE__ */ ii(5, Math.PI / 5), s = 0.5 * (3 - Math.sqrt(5));
    s *= 1.57;
    ...
    var r = /* @__PURE__ */ m$1(function a(n) {
      if (!t10.destroyed) {
        if (!e.batching()) if (t10.requestedFrame && !t10.skipFrame) {
          ...
          var s = t10.lastDrawTime = /* @__PURE__ */ Ht();
...
Jr.init = function(t10) {
  ...
  var r = e.container = /* @__PURE__ */ t10.cy.container(), a = /* @__PURE__ */ e.cy.window();
  if (a) {
...
_e.getElement = function(t10, e, r, a, n) {
  ...
  var u = /* @__PURE__ */ Math.pow(2, a), f = e.h * u, c = e.w * u, d = /* @__PURE__ */ s.eleTextBiggerThanMin(t10, u);
  if (!this.isVisible(t10, d)) return null;
  var g = /* @__PURE__ */ l.get(t10, a);
  ...
  if (y.context.setTransform(1, 0, 0, 1, 0, 0), y.context.clearRect(y.usedWidth, 0, c, h), b1(C)) B();
    ...
    for (var A = T.level; A > a; A--) C = /* @__PURE__ */ i.getElement(t10, e, r, A, Ir.downscale);
    B();
  } else return i.queueElement(t10, T.level - 1), T;
  else {
    var P;
    if (!w && !x && !S) for (var M = a - 1; M >= vn; M--) {
      var R = /* @__PURE__ */ l.get(t10, M);
      if (R) {
        P = R;
        break;
      }
  ...
  return g = {
    ...
    height: f,
    scaledLabelShown: d
  }, y.usedWidth += /* @__PURE__ */ Math.ceil(c + up), y.eleCaches.push(g), l.set(t10, a, g), i.checkTextureFullness(y), g;
};
...
_e.invalidateElement = function(t10) {
  var e = this, r = e.lookup, a = [], n = /* @__PURE__ */ r.isInvalid(t10);
  if (n) {
    for (var i = vn; i <= yi; i++) {
      var s = /* @__PURE__ */ r.getForCachedKey(t10, i);
      s && a.push(s);
    }
    var o = /* @__PURE__ */ r.invalidate(t10);
...
_e.checkTextureFullness = function(t10) {
  var e = this, r = /* @__PURE__ */ e.getTextureQueue(t10.height);
  t10.usedWidth / t10.width > dp && t10.fullnessChecks >= hp ? nr(r, t10) : t10.fullnessChecks++;
};
_e.retireTexture = function(t10) {
  var e = this, r = t10.height, a = /* @__PURE__ */ e.getTextureQueue(r), n = this.lookup;
...
_e.addTexture = function(t10, e) {
  var r = this, a = /* @__PURE__ */ r.getTextureQueue(t10), n = {};
  return a.push(n), n.eleCaches = [], n.height = t10, n.width = /* @__PURE__ */ Math.max(lp, e), n.usedWidth = 0, n.invalidatedWidth = 0, n.fullnessChecks = 0, n.canvas = /* @__PURE__ */ r.renderer.makeOffscreenCanvas(n.width, n.height), n.context = /* @__PURE__ */ n.canvas.getContext("2d"), n;
};
_e.recycleTexture = function(t10, e) {
  for (var r = this, a = /* @__PURE__ */ r.getTextureQueue(t10), n = /* @__PURE__ */ r.getRetiredTextureQueue(t10), i = 0; i < n.length; i++) {
    var s = n[i];
...
_e.queueElement = function(t10, e) {
  var r = this, a = /* @__PURE__ */ r.getElementQueue(), n = /* @__PURE__ */ r.getElementKeyToQueue(), i = /* @__PURE__ */ this.getKey(t10), s = n[i];
  if (s) s.level = /* @__PURE__ */ Math.max(s.level, e), s.eles.merge(t10), s.reqs++, a.updateItem(s);
  else {
    var o = {
      eles: /* @__PURE__ */ t10.spawn().merge(t10),
      level: e,
      reqs: 1,
      key: i
    };
...
_e.removeFromQueue = function(t10) {
  var e = this, r = /* @__PURE__ */ e.getElementQueue(), a = /* @__PURE__ */ e.getElementKeyToQueue(), n = /* @__PURE__ */ this.getKey(t10), i = a[n];
...
var Ep = 1, ga = -4, xn = 2, Tp = 3.99, Cp = 50, Sp = 50, Dp = 0.15, kp = 0.1, Pp = 0.9, Bp = 0.9, Ap = 1, ro = 250, Rp = 4e3 * 4e3, ao = 32767, Mp = true, Gu = /* @__PURE__ */ m$1(function(e) {
...
nt.makeLayer = function(t10, e) {
  var r = /* @__PURE__ */ Math.pow(2, e), a = /* @__PURE__ */ Math.ceil(t10.w * r), n = /* @__PURE__ */ Math.ceil(t10.h * r), i = /* @__PURE__ */ this.renderer.makeOffscreenCanvas(a, n), s = {
    id: no = ++no % Lp,
    bb: t10,
    level: e,
    width: a,
...
nt.getLayers = function(t10, e, r) {
  ...
  var l = a.layersByLevel, u = /* @__PURE__ */ Math.pow(2, r), f = l[r] = l[r] || [], c, d = /* @__PURE__ */ a.levelIsComplete(r, t10), g, h = /* @__PURE__ */ m$1(function() {
  ...
  var m = /* @__PURE__ */ m$1(function() {
    if (!c) {
      c = /* @__PURE__ */ yt();
      for (var B = 0; B < t10.length; B++) Fo(c, /* @__PURE__ */ t10[B].boundingBox());
    }
    return c;
...
nt.drawEleInLayer = function(t10, e, r, a) {
  var n = this, i = this.renderer, s = t10.context, o = /* @__PURE__ */ e.boundingBox();
...
nt.updateElementsInLayers = function(t10, e) {
  for (var r = this, a = /* @__PURE__ */ Aa(t10[0]), n = 0; n < t10.length; n++) for (var i = a ? null : t10[n], s = a ? t10[n] : t10[n].ele, o = s._private.rscratch, l = o.imgLayerCaches = o.imgLayerCaches || {}, u = ga; u <= xn; u++) {
    var f = l[u];
...
nt.invalidateElements = function(t10) {
  var e = this;
  t10.length !== 0 && (e.lastInvalidationTime = /* @__PURE__ */ Ht(), !(t10.length === 0 || !e.haveLayers()) && e.updateElementsInLayers(t10, /* @__PURE__ */ m$1(function(a, n, i) {
    e.invalidateLayer(a);
  }, "invalAssocLayers")));
};
nt.invalidateLayer = function(t10) {
  if (this.lastInvalidationTime = /* @__PURE__ */ Ht(), !t10.invalid) {
...
nt.refineElementTextures = function(t10) {
  var e = this;
  e.updateElementsInLayers(t10, /* @__PURE__ */ m$1(function(a, n, i) {
    var s = a.replacement;
...
nt.applyLayerReplacement = function(t10) {
  var e = this, r = e.layersByLevel[t10.level], a = t10.replaces, n = /* @__PURE__ */ r.indexOf(a);
  if (!(n < 0 || a.invalid)) {
    r[n] = t10;
  ...
  if (!(u.w === 0 || u.h === 0)) {
    ...
    if (f != null) {
      ...
      if (d !== 0) {
        ...
        w = T.x, x = T.y, t10.translate(w, x), t10.rotate(d), S = /* @__PURE__ */ l.getImgSmoothing(t10), S || l.setImgSmoothing(t10, true);
...
_t.drawEdgePath = function(t10, e, r, a) {
  var n = t10._private.rscratch, i = e, s, o = false, l = /* @__PURE__ */ this.usePaths(), u = t10.pstyle("line-dash-pattern").pfValue, f = t10.pstyle("line-dash-offset").pfValue;
  if (l) {
...
_t.drawArrowShape = function(t10, e, r, a, n, i, s, o, l) {
  var u = this, f = this.usePaths() && n !== "triangle-cross", c = false, d, g = e, h = {
    x: s,
    y: o
  }, m = t10.pstyle("arrow-scale").value, y = /* @__PURE__ */ this.getArrowWidth(a, m), p = u.arrowShapes[n];
  if (f) {
...
Gi.drawInscribedImage = function(t10, e, r, a, n) {
  ...
  if (f(r, "background-width", "value", a) !== "auto" && (f(r, "background-width", "units", a) === "%" ? B = f(r, "background-width", "pfValue", a) * y : B = /* @__PURE__ */ f(r, "background-width", "pfValue", a)), f(r, "background-height", "value", a) !== "auto" && (f(r, "background-height", "units", a) === "%" ? A = f(r, "background-height", "pfValue", a) * p : A = /* @__PURE__ */ f(r, "background-height", "pfValue", a)), !(B === 0 || A === 0)) {
    ...
    t10.globalAlpha = S;
    var Z = /* @__PURE__ */ i.getImgSmoothing(t10), J = false;
    if (T === "no" && Z ? (i.setImgSmoothing(t10, false), J = true) : T === "yes" && !Z && (i.setImgSmoothing(t10, true), J = true), d === "no-repeat") x && (t10.save(), b1.pathCache ? t10.clip(b1.pathCache) : (i.nodeShapes[i.getNodeShape(r)].draw(t10, o, l, y, p, E, b1), t10.clip())), i.safeDrawImage(t10, e, 0, 0, D, C, M, N, B, A), x && t10.restore();
      ...
      var Q = /* @__PURE__ */ t10.createPattern(e, d);
...
Dr.eleTextBiggerThanMin = function(t10, e) {
  if (!e) {
    var r = /* @__PURE__ */ t10.cy().zoom(), a = /* @__PURE__ */ this.getPixelRatio(), n = /* @__PURE__ */ Math.ceil(/* @__PURE__ */ ki(r * a));
...
Dr.getTextAngle = function(t10, e) {
  var r, a = t10._private, n = a.rscratch, i = e ? e + "-" : "", s = /* @__PURE__ */ t10.pstyle(i + "text-rotation");
...
Dr.drawText = function(t10, e, r) {
  ...
  if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
    ...
    if (d != null && d !== "" && !isNaN(l) && !isNaN(u)) {
      ...
      var S;
      switch (a ? S = /* @__PURE__ */ this.getTextAngle(e, r) : S = 0, S !== 0 && (f = l, c = u, t10.translate(f, c), t10.rotate(S), l = 0, u = 0), x) {
        case "top":
          break;
        case "center":
          u += m / 2;
    ...
    var Se = /* @__PURE__ */ m$1(function() {
      ...
      if (K > 0) {
        ...
        if (G === "ellipse") s.drawEllipsePath(we || t10, V.x, V.y, de, Ee);
          ...
          var Gt = (ne + K + Q) / o;
          fe = /* @__PURE__ */ hn(/* @__PURE__ */ gn(fe, Gt)), s.drawPolygonPath(we || t10, V.x, V.y, o, l, fe);
        } else {
          var it = (ne + K + Q) / o;
          fe = /* @__PURE__ */ hn(/* @__PURE__ */ gn(fe, -it)), s.drawPolygonPath(we || t10, V.x, V.y, o, l, fe);
        }
...
ht.getPixelRatio = function() {
  ...
  var e = /* @__PURE__ */ this.cy.window(), r = t10.backingStorePixelRatio || t10.webkitBackingStorePixelRatio || t10.mozBackingStorePixelRatio || t10.msBackingStorePixelRatio || t10.oBackingStorePixelRatio || t10.backingStorePixelRatio || 1;
...
ht.createGradientStyleFor = function(t10, e, r, a, n) {
  ...
  if (a === "radial-gradient") if (r.isEdge()) {
    ...
    i = /* @__PURE__ */ t10.createRadialGradient(c.x, c.y, 0, c.x, c.y, /* @__PURE__ */ Math.max(d, g));
  } else {
    var h = s ? {
      x: 0,
      y: 0
    } : r.position(), m = /* @__PURE__ */ r.paddedWidth(), y = /* @__PURE__ */ r.paddedHeight();
    i = /* @__PURE__ */ t10.createRadialGradient(h.x, h.y, 0, h.x, h.y, /* @__PURE__ */ Math.max(m, y));
  }
  else if (r.isEdge()) {
    var p = /* @__PURE__ */ r.sourceEndpoint(), b1 = /* @__PURE__ */ r.targetEndpoint();
    i = /* @__PURE__ */ t10.createLinearGradient(p.x, p.y, b1.x, b1.y);
  } else {
    var w = s ? {
      x: 0,
      y: 0
    ...
    switch (D) {
      case "to-bottom":
        i = /* @__PURE__ */ t10.createLinearGradient(w.x, w.y - E, w.x, w.y + E);
        break;
      case "to-top":
        i = /* @__PURE__ */ t10.createLinearGradient(w.x, w.y + E, w.x, w.y - E);
        break;
      case "to-left":
        i = /* @__PURE__ */ t10.createLinearGradient(w.x + T, w.y, w.x - T, w.y);
        break;
      case "to-right":
        i = /* @__PURE__ */ t10.createLinearGradient(w.x - T, w.y, w.x + T, w.y);
        break;
      ...
      case "to-right-bottom":
        i = /* @__PURE__ */ t10.createLinearGradient(w.x - T, w.y - E, w.x + T, w.y + E);
        break;
      case "to-top-right":
      case "to-right-top":
        i = /* @__PURE__ */ t10.createLinearGradient(w.x - T, w.y + E, w.x + T, w.y - E);
...
ht.gradientFillStyle = function(t10, e, r, a) {
  var n = /* @__PURE__ */ this.createGradientStyleFor(t10, "background", e, r, a);
  if (!n) return null;
  t10.fillStyle = n;
};
...
ht.gradientStrokeStyle = function(t10, e, r, a) {
  var n = /* @__PURE__ */ this.createGradientStyleFor(t10, "line", e, r, a);
  if (!n) return null;
  t10.strokeStyle = n;
};
...
ht.drawSelectionRectangle = function(t10, e) {
  var r = this, a = r.cy, n = r.data, i = /* @__PURE__ */ a.style(), s = t10.drawOnlyNodeLayer, o = t10.drawAllLayers, l = n.canvasNeedsRedraw, u = t10.forcedContext;
...
function oo(t10, e, r) {
  var a = /* @__PURE__ */ t10.createShader(e);
...
function Wp(t10, e, r) {
  var a = /* @__PURE__ */ oo(t10, t10.VERTEX_SHADER, e), n = /* @__PURE__ */ oo(t10, t10.FRAGMENT_SHADER, r), i = /* @__PURE__ */ t10.createProgram();
...
function Hp(t10, e, r) {
  r === void 0 && (r = e);
  var a = /* @__PURE__ */ t10.makeOffscreenCanvas(e, r), n = a.context = /* @__PURE__ */ a.getContext("2d");
...
function Wi(t10) {
  var e = t10.pixelRatio, r = /* @__PURE__ */ t10.cy.zoom(), a = /* @__PURE__ */ t10.cy.pan();
  return {
    zoom: r * e,
    pan: {
      x: a.x * e,
...
function ti(t10, e, r, a, n) {
  ...
  return s = /* @__PURE__ */ Math.round(t10.canvasHeight - s), [
    i,
    s
  ];
}
...
m$1(Up, "vec4ToIndex");
function Xp(t10, e) {
  var r = /* @__PURE__ */ t10.createTexture();
...
function _p(t10, e, r, a) {
  var n = /* @__PURE__ */ Xu(t10, e), i = /* @__PURE__ */ We(n, 2), s = i[0], o = i[1], l = /* @__PURE__ */ Yu(t10, o, a), u = /* @__PURE__ */ t10.createBuffer();
...
function wt(t10, e, r, a) {
  var n = /* @__PURE__ */ Xu(t10, r), i = /* @__PURE__ */ We(n, 3), s = i[0], o = i[1], l = i[2], u = /* @__PURE__ */ Yu(t10, o, e * s), f = s * l, c = /* @__PURE__ */ t10.createBuffer();
  ...
  for (var d = new Array(e), g = 0; g < e; g++) d[g] = /* @__PURE__ */ Yp(t10, o, u, f, s, g);
...
function Zp(t10) {
  var e = /* @__PURE__ */ t10.createFramebuffer();
...
var ya = {
  ...
  function t10(e, r) {
    ur(this, t10), this.debugID = /* @__PURE__ */ Math.floor(Math.random() * 1e4), this.r = e, this.atlasSize = r.webglTexSize, this.rows = r.webglTexRows, this.enableWrapping = r.enableWrapping, this.texHeight = /* @__PURE__ */ Math.floor(this.atlasSize / this.rows), this.maxTexWidth = this.atlasSize, this.texture = null, this.canvas = null, this.needsBuffer = true, this.freePointer = {
      x: 0,
      row: 0
    }, this.keyToLocation = /* @__PURE__ */ new Map(), this.canvas = /* @__PURE__ */ r.createTextureCanvas(e, this.atlasSize, this.atlasSize), this.scratch = /* @__PURE__ */ r.createTextureCanvas(e, this.atlasSize, this.texHeight, "scratch");
  }
  ...
  return m$1(t10, "AtlasCollection"), lr(t10, [
    ...
    },
    {
      ...
      value: /* @__PURE__ */ m$1(function() {
        var r = /* @__PURE__ */ new Set(), a = /* @__PURE__ */ xt(/* @__PURE__ */ this.styleKeyToAtlas.keys()), n;
        try {
    ...
    },
    {
      ...
      value: /* @__PURE__ */ m$1(function() {
        ...
        var i = [], s = /* @__PURE__ */ new Map(), o = null, l = /* @__PURE__ */ xt(this.atlases), u;
        try {
              ...
              try {
                for (m.s(); !(y = /* @__PURE__ */ m.n()).done; ) {
                  ...
                  if (u(p.type)) {
                    ...
                    i ? (p.atlasCollection.deleteKey(h, b1), p.atlasCollection.styleKeyNeedsRedraw.add(b1), f = true) : f |= /* @__PURE__ */ p.atlasCollection.checkKeyIsInvalid(h, b1);
                  }
                }
              } catch (w) {
                m.e(w);
...
Qu.initWebgl = function(t10, e) {
  var r = this, a = r.data.contexts[r.WEBGL], n = /* @__PURE__ */ t10.cy.container();
  t10.bgColor = /* @__PURE__ */ iy(n), t10.webglTexSize = /* @__PURE__ */ Math.min(t10.webglTexSize, /* @__PURE__ */ a.getParameter(a.MAX_TEXTURE_SIZE)), t10.webglTexRows = /* @__PURE__ */ Math.min(t10.webglTexRows, 54), t10.webglBatchSize = /* @__PURE__ */ Math.min(t10.webglBatchSize, 16384), t10.webglTexPerBatch = /* @__PURE__ */ Math.min(t10.webglTexPerBatch, /* @__PURE__ */ a.getParameter(a.MAX_TEXTURE_IMAGE_UNITS)), r.webglDebug = t10.webglDebug, r.webglDebugShowAtlases = t10.webglDebugShowAtlases, console.log("max texture units", /* @__PURE__ */ a.getParameter(a.MAX_TEXTURE_IMAGE_UNITS)), console.log("max texture size", /* @__PURE__ */ a.getParameter(a.MAX_TEXTURE_SIZE)), console.log("webgl options", t10), r.pickingFrameBuffer = /* @__PURE__ */ Zp(a), r.pickingFrameBuffer.needsDraw = true;
...
m$1(uy, "clearCanvas");
function ly(t10) {
  var e = t10.canvasWidth, r = t10.canvasHeight, a = /* @__PURE__ */ Wi(t10), n = a.pan, i = a.zoom, s = /* @__PURE__ */ pa();
  En(s, s, [
    n.x,
    n.y
  ]), Hi(s, s, [
...
function Ju(t10, e) {
  var r = t10.canvasWidth, a = t10.canvasHeight, n = /* @__PURE__ */ Wi(t10), i = n.pan, s = n.zoom;
...
function cy(t10) {
  var e = /* @__PURE__ */ m$1(function(n, i, s) {
    for (var o = /* @__PURE__ */ n.atlasManager.getRenderTypeOpts(i), l = t10.data.contexts[t10.NODE], u = 0.125, f = o.atlasCollection.atlases, c = 0; c < f.length; c++) {
...
function dy(t10, e, r, a, n) {
  var i, s, o, l, u = /* @__PURE__ */ Wi(t10), f = u.pan, c = u.zoom;
  if (a === void 0 || n === void 0) {
    var d = /* @__PURE__ */ ti(t10, f, c, e, r), g = /* @__PURE__ */ We(d, 2), h = g[0], m = g[1], y = 6;
    i = h - y / 2, s = m - y / 2, o = y, l = y;
  } else {
    var p = /* @__PURE__ */ ti(t10, f, c, e, r), b1 = /* @__PURE__ */ We(p, 2), w = b1[0], x = b1[1], S = /* @__PURE__ */ ti(t10, f, c, a, n), T = /* @__PURE__ */ We(S, 2), E = T[0], D = T[1];
...
function hy(t10, e, r) {
  var a = /* @__PURE__ */ dy(t10, e, r), n = /* @__PURE__ */ t10.getCachedZSortedEles(), i, s, o = /* @__PURE__ */ xt(a), l;
  try {
    for (o.s(); !(l = /* @__PURE__ */ o.n()).done; ) {
      var u = l.value, f = n[u];
...
function ju(t10, e, r) {
  var a, n;
  t10.webglDebug && (n = [], a = /* @__PURE__ */ performance.now());
  ...
  if (r.screen && t10.data.canvasNeedsRedraw[t10.SELECT_BOX] && vy(t10, e), t10.data.canvasNeedsRedraw[t10.NODE] || r.picking) {
    ...
    var u = /* @__PURE__ */ ly(t10), f = /* @__PURE__ */ t10.getCachedZSortedEles();
...
Fa.bufferCanvasImage = function(t10) {
  var e = this.cy, r = /* @__PURE__ */ e.mutableElements(), a = /* @__PURE__ */ r.boundingBox(), n = /* @__PURE__ */ this.findContainerClientCoords(), i = t10.full ? Math.ceil(a.w) : n[2], s = t10.full ? Math.ceil(a.h) : n[3], o = ae(t10.maxWidth) || ae(t10.maxHeight), l = /* @__PURE__ */ this.getPixelRatio(), u = 1;
  if (t10.scale !== void 0) i *= t10.scale, s *= t10.scale, u = t10.scale;
  else if (o) {
    var f = 1 / 0, c = 1 / 0;
    ae(t10.maxWidth) && (f = u * t10.maxWidth / i), ae(t10.maxHeight) && (c = u * t10.maxHeight / s), u = /* @__PURE__ */ Math.min(f, c), i *= u, s *= u;
  }
  o || (i *= l, s *= l, u *= l);
...
function gy(t10, e) {
  for (var r = /* @__PURE__ */ atob(t10), a = new ArrayBuffer(r.length), n = new Uint8Array(a), i = 0; i < r.length; i++) n[i] = /* @__PURE__ */ r.charCodeAt(i);
  return new Blob([
    a
  ], {
    type: e
...
m$1(tl, "output");
Fa.png = function(t10) {
  return tl(t10, /* @__PURE__ */ this.bufferCanvasImage(t10), "image/png");
};
Fa.jpg = function(t10) {
  return tl(t10, /* @__PURE__ */ this.bufferCanvasImage(t10), "image/jpeg");
};
var rl = {};
...
function al(t10) {
  ...
  var o = /* @__PURE__ */ t10.cy.container();
...
Ce.makeOffscreenCanvas = function(t10, e) {
  ...
  if ((typeof OffscreenCanvas > "u" ? "undefined" : Ye(OffscreenCanvas)) !== "undefined") r = new OffscreenCanvas(t10, e);
    ...
    r = /* @__PURE__ */ n.createElement("canvas"), r.width = t10, r.height = e;
  }
  return r;
};
[
...
var ul = /* @__PURE__ */ m$1(function t9() {
...
Cr.css = function(t10, e) {
  ...
  else if (Pe(t10)) for (var a = t10, n = /* @__PURE__ */ Object.keys(a), i = 0; i < n.length; i++) {
    var s = n[i], o = a[s];
    if (o != null) {
