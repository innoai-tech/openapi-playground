...
function Ce$2(t) {
	...
	if (o$1 < 0) return !1;
	return o$1 == r.length - 1 ? r.pop() : Ae$1.call(r, o$1, 1), --this.size, !0;
}
...
function fo(t) {
	...
	return t === (typeof r == "function" && r.prototype || io$2);
}
m(fo, "isPrototype");
var K$1 = fo;
function po$2(t) {
...
function ha$1(r, t, o$1, f$1, a, n$1) {
	var i$1 = o$1 & ga$1, m$3 = /* @__PURE__ */ mr$2(r), p$2 = m$3.length;
	if (p$2 != mr$2(t).length && !i$1) return !1;
	for (var d$1 = p$2; d$1--;) {
		var x$2 = m$3[d$1];
...
var ol = class extends Nt {
	...
	walkTerminal(e$1, t, n$1) {}
	walkProdRef(e$1, t, n$1) {
		let i$1 = hp(e$1.referencedRule, e$1.idx) + this.topProd.name, l$2 = /* @__PURE__ */ cr(new J({ definition: /* @__PURE__ */ t.concat(n$1) }));
		...
		x$2 = /* @__PURE__ */ Rn(n$1, (A$3, R$2, P$1) => {
			if (typeof R$2.PATTERN == "string") fl(A$3, /* @__PURE__ */ ht(/* @__PURE__ */ R$2.PATTERN.charCodeAt(0)), y$1[P$1]);
				...
				Zr(R$2.START_CHARS_HINT, (Te$2) => {
					let Ae$2 = /* @__PURE__ */ ht(typeof Te$2 == "string" ? Te$2.charCodeAt(0) : Te$2);
...
`,
			...
			else if (fm(o$1, "LONGER_ALT")) Zr(N(o$1.LONGER_ALT) ? o$1.LONGER_ALT : [o$1.LONGER_ALT], (c$2) => {
...
function vc(r, e$1, t) {
	let n$1 = [], i$1 = !1, o$1 = /* @__PURE__ */ Qm(/* @__PURE__ */ Ai(/* @__PURE__ */ Qr(/* @__PURE__ */ Xr(r.modes))), (u$2) => u$2[fr] === se.NA), l$2 = /* @__PURE__ */ Cc(t);
...
but found: '` + De(e$1).image + "'";
  ...
  <${Jr(r, (c$2) => `[${Jr(c$2, (f$1) => wt(f$1)).join(",")}]`).join(" ,")}>` + o$1;
	}
};
Object.freeze(Lt);
...
<OR${r.alternation.idx}> inside <${r.topLevelRule.name}> Rule.
 has ${r.alternation.definition.length + 1} alternatives.`;
	...
	buildLeftRecursionError(r) {
		let e$1 = r.topLevelRule.name;
		return `Left Recursion found in grammar.
rule: <${e$1}> can be invoked from itself (directly or indirectly)
without consuming any Tokens. The grammar path that causes this is: 
 ${`${e$1} --> ${Jr(r.leftRecursionPath, (s$1) => s$1.name).concat([e$1]).join(" --> ")}`}
...
var gl = class extends Nt {
	...
	walkTerminal(e$1, t, n$1) {
		if (this.isAtEndOfPath && e$1.terminalType.name === this.nextTerminalName && e$1.idx === this.nextTerminalOccurrence && !this.found) this.possibleTokTypes = /* @__PURE__ */ cr(new J({ definition: /* @__PURE__ */ t.concat(n$1) })), this.found = !0;
	}
}, Nn = class extends Nt {
	static {
...
function ea(r, e$1, t = []) {
	...
	for (m(o$1, "getAlternativesForProd"); t.length < e$1 && i$1 < r.length;) {
		...
		else if (l$2 instanceof Q) return o$1(/* @__PURE__ */ l$2.definition.concat([new G({ definition: l$2.definition })]));
		else if (l$2 instanceof Z) return o$1([new J({ definition: l$2.definition }), new G({ definition: /* @__PURE__ */ [new D({ terminalType: l$2.separator })].concat(l$2.definition) })]);
		else if (l$2 instanceof q$1) n$1 = /* @__PURE__ */ o$1(/* @__PURE__ */ l$2.definition.concat([new G({ definition: /* @__PURE__ */ [new D({ terminalType: l$2.separator })].concat(l$2.definition) })]));
		else if (l$2 instanceof G) n$1 = /* @__PURE__ */ o$1(/* @__PURE__ */ l$2.definition.concat([new G({ definition: l$2.definition })]));
		else {
...
function ta(r, e$1, t, n$1) {
	...
	for (d$1.push({
		...
		if (x$2 === i$1) {
			...
			let R$2 = new G({
				definition: /* @__PURE__ */ [new D({ terminalType: x$2.separator })].concat(x$2.definition),
				idx: x$2.idx
			}), b$1 = {
				idx: g$3,
			...
			let P$1 = {
				idx: g$3,
				def: /* @__PURE__ */ x$2.definition[A$3].definition.concat(/* @__PURE__ */ Mi(p$2)),
				ruleStack: y$1,
				occurrenceStack: v$3
			};
...
function jc(r, e$1, t, n$1, i$1, s$1) {
	let o$1 = /* @__PURE__ */ Cn(r, e$1, t);
	return s$1(o$1, n$1, Jc(o$1) ? $n : Ct, i$1);
}
...
function zc(r, e$1, t, n$1) {
	...
	if (e$1) return function(o$1) {
		...
		for (let u$2 = 0; u$2 < i$1; u$2++) {
			...
			if (!(d$1 !== void 0 && d$1.call(this) === !1)) e: for (let h$4 = 0; h$4 < f$1; h$4++) {
				...
				for (let y$1 = 0; y$1 < g$3; y$1++) if (t(/* @__PURE__ */ this.LA(y$1 + 1), p$2[y$1]) === !1) continue e;
				return u$2;
			}
		}
	};
	if (s$1 && !n$1) {
		...
		return function() {
			return l$2[this.LA(1).tokenTypeIdx];
		};
		...
		for (let o$1 = 0; o$1 < i$1; o$1++) {
			...
			e: for (let c$2 = 0; c$2 < u$2; c$2++) {
				...
				for (let h$4 = 0; h$4 < d$1; h$4++) if (t(/* @__PURE__ */ this.LA(h$4 + 1), f$1[h$4]) === !1) continue e;
				return o$1;
			}
		}
	};
...
function qc(r, e$1, t) {
	...
	if (n$1 && !t) {
		...
		e: for (let s$1 = 0; s$1 < i$1; s$1++) {
			...
			for (let u$2 = 0; u$2 < l$2; u$2++) if (e$1(/* @__PURE__ */ this.LA(u$2 + 1), o$1[u$2]) === !1) continue e;
			return !0;
		}
		return !1;
	};
...
function Kp(r, e$1, t) {
	for (let n$1 = 0; n$1 < r.length; n$1++) {
		if (n$1 === t) continue;
		let i$1 = r[n$1];
		for (let s$1 = 0; s$1 < e$1.length; s$1++) if (i$1[e$1[s$1]] === !0) return !1;
	}
	return !0;
}
...
function Xc(r, e$1) {
	let t = /* @__PURE__ */ Jr(r, (o$1) => ea([o$1], 1)), n$1 = /* @__PURE__ */ Vc(t.length), i$1 = /* @__PURE__ */ Jr(t, (o$1) => {
		let l$2 = {};
		return Zr(o$1, (u$2) => {
			Zr(/* @__PURE__ */ yl(u$2.partialPath), (f$1) => {
				l$2[f$1] = !0;
			});
		}), l$2;
	}), s$1 = t;
			...
			for (let f$1 = 0; f$1 < c$2.length; f$1++) {
				...
				if (Kp(i$1, p$2, u$2) || Cr(h$4) || d$1.length === e$1) {
					...
					s$1[u$2] = /* @__PURE__ */ s$1[u$2].concat(y$1), Zr(y$1, (v$3) => {
						Zr(/* @__PURE__ */ yl(v$3.partialPath), (A$3) => {
							i$1[u$2][A$3] = !0;
						});
					});
				}
...
function Sn(r, e$1, t, n$1) {
	let i$1 = new ra(r, t);
	e$1.accept(i$1);
	let s$1 = i$1.result, l$2 = /* @__PURE__ */ new Tl(e$1, r, t).startWalking();
	return Xc([new J({ definition: s$1 }), new J({ definition: l$2 })], n$1);
}
...
function rf(r, e$1) {
	...
	return zi(n$1, (s$1) => {
		return zi(/* @__PURE__ */ _i(s$1.definition), (l$2, u$2) => {
...
function nf(r, e$1, t) {
	...
	return i$1 = /* @__PURE__ */ Qm(i$1, (o$1) => o$1.ignoreAmbiguities === !0), zi(i$1, (o$1) => {
		let l$2 = o$1.idx, c$2 = /* @__PURE__ */ Cn(l$2, r, o$1.maxLookahead || e$1, o$1), f$1 = /* @__PURE__ */ qp(c$2, o$1, r, t), d$1 = /* @__PURE__ */ Xp(c$2, o$1, r, t);
...
var Al = {}, kl = "InRuleRecoveryException", vl = class extends Error {
	...
	tryInRepetitionRecovery(e$1, t, n$1, i$1) {
		let s$1 = /* @__PURE__ */ this.findReSyncTokenType(), o$1 = /* @__PURE__ */ this.exportLexerState(), l$2 = [], u$2 = !1, c$2 = /* @__PURE__ */ this.LA(1), f$1 = /* @__PURE__ */ this.LA(1), d$1 = /* @__PURE__ */ m(() => {
			let h$4 = /* @__PURE__ */ this.LA(0), g$3 = new dr(this.errorMessageProvider.buildMismatchTokenMessage({
				expected: i$1,
				actual: c$2,
				previous: h$4,
...
function em(r, e$1) {
	...
	for (let i$1 = 0; i$1 < n$1; i$1++) {
		let o$1 = r[t[i$1]], l$2 = o$1.length;
...
var ga = class {
	...
	For Further details.`);
		...
		else if (fm(e$1, "modes") && Ui(/* @__PURE__ */ Qr(/* @__PURE__ */ Xr(e$1.modes)), Oc)) this.tokensMap = /* @__PURE__ */ Rn(/* @__PURE__ */ mp(/* @__PURE__ */ Qr(/* @__PURE__ */ Xr(e$1.modes))), (l$2, u$2) => (l$2[u$2.name] = u$2, l$2), {});
		...
		this.tokenMatcher = Ui(fm(e$1, "modes") ? Qr(/* @__PURE__ */ Xr(e$1.modes)) : Xr(e$1), (s$1) => Cr(s$1.categoryMatches)) ? $n : Ct, St(/* @__PURE__ */ Xr(this.tokensMap));
	}
...
function pm$1(r, e$1, t) {
	let n$1 = /* @__PURE__ */ Re(r, e$1, t, { type: kf });
	Vt(r, n$1);
	return Sf(r, e$1, t, /* @__PURE__ */ Mn(r, e$1, n$1, t, /* @__PURE__ */ pr$1(r, e$1, t)), /* @__PURE__ */ Ol(r, e$1, t.separator, t));
}
...
function gm(r, e$1, t) {
	let n$1 = /* @__PURE__ */ Re(r, e$1, t, { type: vf });
	Vt(r, n$1);
	return Cf(r, e$1, t, /* @__PURE__ */ Mn(r, e$1, n$1, t, /* @__PURE__ */ pr$1(r, e$1, t)), /* @__PURE__ */ Ol(r, e$1, t.separator, t));
}
m(gm, "repetitionMandatorySep");
function ym$1(r, e$1, t) {
	let n$1 = /* @__PURE__ */ Re(r, e$1, t, { type: Kt });
	Vt(r, n$1);
	return Mn(r, e$1, n$1, t, .../* @__PURE__ */ Jr(t.definition, (o$1) => Nf$1(r, e$1, o$1)));
}
m(ym$1, "alternation");
...
m(Ol, "tokenRef");
function Am(r, e$1, t) {
	let n$1 = t.referencedRule, i$1 = /* @__PURE__ */ r.ruleToStartState.get(n$1), s$1 = /* @__PURE__ */ Re(r, e$1, t, { type: Kt }), o$1 = /* @__PURE__ */ Re(r, e$1, t, { type: Kt });
	return Pl(s$1, new Pn(i$1, n$1, o$1)), {
		left: s$1,
		right: o$1
	};
}
	...
	buildLookaheadForAlternation(e$1) {
		...
		if (_f$1(d$1, !1) && !s$1) {
			...
			return i$1 ? function(p$2) {
				var g$3;
				let v$3 = h$4[this.LA(1).tokenTypeIdx];
				...
				return h$4[this.LA(1).tokenTypeIdx];
			};
	...
	buildLookaheadForOptional(e$1) {
		...
		if (_f$1(d$1) && d$1[0][0] && !s$1) {
			...
			if (p$2.length === 1 && Cr(p$2[0].categoryMatches)) {
				...
				return function() {
					return g$3[this.LA(1).tokenTypeIdx] === !0;
				};
			}
		}
		return function() {
...
function Ml(r, e$1, t, n$1) {
	...
	if (s$1 === void 0) s$1 = /* @__PURE__ */ Pf(i$1, /* @__PURE__ */ Of(/* @__PURE__ */ Dm(i$1.atnStartState))), i$1.start = s$1;
...
function Lm(r, e$1, t) {
	return {
		actualToken: t,
		possibleTokenTypes: /* @__PURE__ */ s0(/* @__PURE__ */ zi(e$1.configs.elements, (s$1) => s$1.state.transitions).filter((s$1) => s$1 instanceof On).map((s$1) => s$1.tokenType), (s$1) => s$1.tokenTypeIdx),
		tokenPath: r
	};
}
...
function Jm(r, e$1) {
	...
	let n$1 = r.or++, i$1 = /* @__PURE__ */ m((l$2, u$2) => {
		return `uGroup_${l$2}_${u$2.getRuleStack().join("-")}`;
...
function Bd(r) {
	let e$1 = r.Grammar, t = r.parser.Lexer;
	return Hi(e$1, new Vi$1(r), t.definition);
}
...
(function(r) {
	...
	function t(i$1, s$1) {
		...
		return "../".repeat(u$2.length - f$1) + c$2.slice(f$1).join("/");
	}
...
var is = class {
	...
	async handleException(e$1, t, n$1, i$1) {
		try {
			...
			n$1("error", `${t}: ${s$1 instanceof Error ? s$1.message : String(s$1)}`, { node: i$1 });
		}
	}
	addEntry(e$1, t) {
		if (e$1 === "AstNode") {
	...
	waitUntil(e$1, t, n$1) {
		...
		return this.currentState >= e$1 ? Promise.resolve(void 0) : n$1.isCancellationRequested ? Promise.reject(mt) : new Promise((s$1, o$1) => {
			let l$2 = this.onBuildPhase(e$1, () => {
				if (l$2.dispose(), u$2.dispose(), i$1) s$1(this.langiumDocuments.getDocument(i$1)?.uri);
				else s$1(void 0);
	...
	async traverseFolder(e$1, t, n$1, i$1) {
		...
		await Promise.all(/* @__PURE__ */ s$1.map(async (o$1) => {
			if (this.includeEntry(e$1, o$1, n$1)) {
				...
				else if (o$1.isFile) i$1(await this.langiumDocuments.getOrCreateDocument(o$1.uri));
			}
		}));
	}
...
var hs = class {
	...
	constructor(e$1) {
		...
		this.chevrotainLexer = new se(mu(t) ? Object.values(t) : t, {
			positionTracking: "full",
			skipValidations: e$1.LanguageMetaData.mode === "production",
...
var gs = class {
	...
	documentationLinkRenderer(e$1, t, n$1) {
		...
		if (s$1 && s$1.nameSegment) {
			let o$1 = s$1.nameSegment.range.start.line + 1, l$2 = s$1.nameSegment.range.start.character + 1;
			return `[${n$1}](${s$1.documentUri.with({ fragment: `L${o$1},${l$2}` }).toString()})`;
		} else return;
	}
