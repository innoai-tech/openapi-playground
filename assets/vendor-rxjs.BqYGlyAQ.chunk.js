...
var _ = function() {
  ...
  function n2(r2, n3, e2) {
    ...
    }, o2 = { next: r2.next && g(r2.next, i2), error: r2.error && g(r2.error, i2), complete: r2.complete && g(r2.complete, i2) }) : o2 = r2, u2.destination = new _(o2), u2;
  }
  return r(n2, t2), n2;
...
var z = function(t2) {
  ...
  return r(n2, t2), n2.prototype.schedule = function(t3, r2) {
    ...
    return void 0 === n3 && (n3 = 0), N.setInterval(t3.flush.bind(t3, this), n3);
...
function tn(t2) {
  if (t2 instanceof P) return t2;
  if (null != t2) {
    if (c(t2[E])) return new P(function(r2) {
      var n2 = t2[E]();
      if (c(n2.subscribe)) return n2.subscribe(r2);
      throw TypeError("Provided object does not correctly implement Symbol.observable");
    });
    if (K(t2)) return new P(function(r2) {
      for (var n2 = 0; n2 < t2.length && !r2.closed; n2++) r2.next(t2[n2]);
      r2.complete();
    });
    if (Q(t2)) return new P(function(r2) {
      t2.then(function(t3) {
    ...
    if ($(t2)) return new P(function(r2) {
      var n2, o2;
      try {
    ...
    if (tr(t2)) return te(tt(t2));
  }
  throw X(t2);
}
function te(t2) {
  return new P(function(r2) {
    (function(t3, r3) {
...
function ts(t2, r2) {
  return r2 ? function(t3, r3) {
    if (null != t3) {
      if (c(t3[E])) return tn(t3).pipe(tu(r3), ti(r3));
      if (K(t3)) return new P(function(n2) {
        var e2 = 0;
        return r3.schedule(function() {
          e2 === t3.length ? n2.complete() : (n2.next(t3[e2++]), n2.closed || this.schedule());
        });
      });
      if (Q(t3)) return tn(t3).pipe(tu(r3), ti(r3));
      if (W(t3)) return tc(t3, r3);
      if ($(t3)) return new P(function(n2) {
        var e2;
        return to(n2, r3, function() {
          e2 = t3[Z](), to(n2, r3, function() {
            var t4, r4, o2;
            try {
...
function tl(t2) {
  return !!t2 && (t2 instanceof P || c(t2.lift) && c(t2.subscribe));
}
function tf(t2, r2) {
...
function tp(t2) {
  return tf(function(r2) {
    return th(r2) ? t2.apply(void 0, i([], o(r2))) : t2(r2);
  });
}
var tv = Array.isArray, td = Object.getPrototypeOf, tb = Object.prototype, ty = Object.keys;
function tm() {
  for (var t2, r2 = [], n2 = 0; n2 < arguments.length; n2++) r2[n2] = arguments[n2];
  var e2 = J(r2), o2 = c(H(r2)) ? r2.pop() : void 0, i2 = function(t3) {
    if (1 === t3.length) {
      var r3 = t3[0];
      if (tv(r3)) return { args: r3, keys: null };
      if (r3 && "object" == typeof r3 && td(r3) === tb) {
        var n3 = ty(r3);
  ...
  var a2 = new P((void 0 === (t2 = s2 ? function(t3) {
    ...
    n3 = e2, o3 = function() {
      for (var n4 = u2.length, o4 = Array(n4), i4 = n4, c2 = n4, s3 = function(n5) {
        var s4, a4, l2;
        s4 = e2, a4 = function() {
          var s5 = ts(u2[n5], e2), a5 = false;
          s5.subscribe(C(r3, function(e3) {
  ...
  return o2 ? a2.pipe(tp(o2)) : a2;
}
function tw(t2, r2, n2) {
  return (void 0 === n2 && (n2 = 1 / 0), c(r2)) ? tw(function(n3, e2) {
    return tf(function(t3, o2) {
    ...
    return o2 = n2, i2 = [], u2 = 0, c2 = 0, s2 = false, a2 = function() {
      ...
      u2++;
      var n3 = false;
      tn(t2(r4, c2++)).subscribe(C(e2, function(t3) {
        e2.next(t3);
      }, function() {
        n3 = true;
      }, void 0, function() {
...
var tx = ["addListener", "removeListener"], tg = ["addEventListener", "removeEventListener"], t_ = ["on", "off"];
function tS(t2, r2, n2, e2) {
  if (c(n2) && (e2 = n2, n2 = void 0), e2) return tS(t2, r2, n2).pipe(tp(e2));
  var i2 = o(c(t2.addEventListener) && c(t2.removeEventListener) ? tg.map(function(e3) {
    return function(o2) {
      return t2[e3](r2, o2, n2);
    };
  }) : c(t2.addListener) && c(t2.removeListener) ? tx.map(tO(t2, r2)) : c(t2.on) && c(t2.off) ? t_.map(tO(t2, r2)) : [], 2), u2 = i2[0], s2 = i2[1];
  if (!u2 && K(t2)) return tw(function(t3) {
    return tS(t3, r2, n2);
  })(tn(t2));
  if (!u2) throw TypeError("Invalid event target");
  return new P(function(t3) {
    var r3 = function() {
...
function tE() {
  ...
  var o2 = J(n2), i2 = (t2 = 1 / 0, "number" == typeof H(n2) ? n2.pop() : t2);
  return n2.length ? 1 === n2.length ? tn(n2[0]) : (void 0 === (r2 = i2) && (r2 = 1 / 0), tw(I, r2))(ts(n2, o2)) : V;
}
function tI(t2, r2) {
  return T(function(n2, e2) {
    var o2 = 0;
...
function tj(t2) {
  return T(function(r2, n2) {
    ...
    o2 = r2.subscribe(C(n2, void 0, void 0, function(u2) {
      e2 = tn(t2(u2, tj(t2)(r2))), o2 ? (o2.unsubscribe(), o2 = null, e2.subscribe(n2)) : i2 = true;
    })), i2 && (o2.unsubscribe(), o2 = null, e2.subscribe(n2));
  });
}
function tA(t2, r2) {
  return void 0 === r2 && (r2 = B), T(function(n2, e2) {
...
function tk(t2, r2) {
  void 0 === r2 && (r2 = B);
  var n2, e2, o2, i2, u2, c2 = (n2 = t2, e2 = r2, void 0 === n2 && (n2 = 0), void 0 === o2 && (o2 = B), i2 = -1, null != e2 && (G(e2) ? o2 = e2 : i2 = e2), new P(function(t3) {
  ...
  return u2 = function() {
    ...
    return tn(u2(t3, r3)).pipe(T(function(t4, r4) {
      var n3 = 0;
      t4.subscribe(C(r4, function(t5) {
...
function tT(t2, r2) {
  return void 0 === r2 && (r2 = I), t2 = null != t2 ? t2 : tC, T(function(n2, e2) {
    var o2, i2 = true;
    n2.subscribe(C(e2, function(n3) {
      var u2 = r2(n3);
...
function tL(t2, r2) {
  return T(function(n2, e2) {
    ...
    n2.subscribe(C(e2, function(n3) {
      ...
      var u3 = 0, s2 = i2++;
      tn(t2(n3, s2)).subscribe(o2 = C(e2, function(t3) {
