...
var oe, ze, Ae = [
	...
	if (x < 0) {
		...
		var Z = /* @__PURE__ */ u0(["vlist-s"], [new h0("​")]);
		P = [/* @__PURE__ */ u0(["vlist-r"], [U, Z]), /* @__PURE__ */ u0(["vlist-r"], [V])];
	...
	staticSvg: /* @__PURE__ */ m(function(e, t) {
		var [a, n, s] = Nr[e], o = new z0(a), h = new w0([o], {
			width: /* @__PURE__ */ T(n),
			height: /* @__PURE__ */ T(s),
			style: "width:" + T(n),
			viewBox: "0 0 " + 1e3 * n + " " + 1e3 * s,
			preserveAspectRatio: "xMinYMin"
		}), c = /* @__PURE__ */ Br(["overlay"], [h], t);
		...
		function a() {
			...
			if (R.contains([
				...
				for (var n0 = 0; n0 < V; n0++) {
					var t0 = new z0(H[n0]), X0 = new w0([t0], {
						width: "400em",
						height: /* @__PURE__ */ T(Y),
						viewBox: "0 0 " + h + " " + P,
	...
	switch (a) {
		...
		case "\\downarrow":
			var n = /* @__PURE__ */ t.callFunction("\\\\cdleft", [e[0]], []), s = {
				...
				mode: "math",
				family: "rel"
			}, o = /* @__PURE__ */ t.callFunction("\\Big", [s], []), h = /* @__PURE__ */ t.callFunction("\\\\cdright", [e[1]], []), c = {
				type: "ordgroup",
				mode: "math",
				body: [
					n,
...
var ue = /* @__PURE__ */ m(function(e, t, a) {
	...
	var n = M0["Size4-Regular"][e.charCodeAt(0)] ? M0["Size4-Regular"][e.charCodeAt(0)][4] : M0["Size1-Regular"][e.charCodeAt(0)][4], s = new z0("inner", Xa(e, /* @__PURE__ */ Math.round(1e3 * t))), o = new w0([s], {
		width: /* @__PURE__ */ T(n),
		height: /* @__PURE__ */ T(t),
		style: "width:" + T(n),
	...
	var h = new z0(e, /* @__PURE__ */ Ya(e, n, a)), c = new w0([h], {
		width: "400em",
		height: /* @__PURE__ */ T(t),
...
var Nt = /* @__PURE__ */ m((r, e) => {
	...
	if (a === "sout") s = /* @__PURE__ */ y.makeSpan(["stretchy", "sout"]), s.height = e.fontMetrics().defaultRuleThickness / n, o = -.5 * e.fontMetrics().xHeight;
		...
		var k = /* @__PURE__ */ Math.floor(1e3 * x * n), A = new w0([new z0("phase", /* @__PURE__ */ Va(k))], {
			width: "400em",
...
var T0 = /* @__PURE__ */ m(function(e, t) {
	...
	o.body.forEach(function(q) {
		for (var F = 1; F < q.length; F += 2) {
			var H = /* @__PURE__ */ L(q[F], "styling");
			L(H.body[0], "ordgroup").body.unshift(v);
		}
...
D({
	...
	handler: /* @__PURE__ */ m((r, e) => {
		var { parser: t, funcName: a, breakOnTokenText: n } = r, { mode: s } = t, o = /* @__PURE__ */ t.parseExpression(!0, n), h = "math" + a.slice(1);
		return {
			type: "font",
			mode: s,
			font: h,
