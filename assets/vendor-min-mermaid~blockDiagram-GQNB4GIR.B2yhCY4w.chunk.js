import { m } from './vendor-min-mermaid~chunk-ZN7TASNU.DoJPj5tk.chunk.js';
import { d } from './vendor-min-mermaid~chunk-S67DUUA5.BF3SGhc4.chunk.js';
import { n } from './vendor-min-mermaid~chunk-LM6QDVU5.CLWvmYRr.chunk.js';
import { Q as Qt$1, y as yt$1 } from './vendor-min-mermaid~chunk-HESFG3RP.DM0RUiMH.chunk.js';
import { I as Ie$1, X as Xe$1, b as be$1 } from './vendor-min-mermaid~chunk-YM3XIQPS.DjUuqvt-.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.ByXaayWf.chunk.js';
import { E as Er$1, i as ih, T as Tf, t as tt, S as Sf, a as Su, b as ae$1, H as Hl, c as vc, d as Bc, m as mf, g as gC, O as Oe$1 } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
import { _ as _f } from './vendor-min-mermaid~chunk-5ZJXQJOJ.DbrINuy3.chunk.js';
...
var yt = function() {
    var e = m$1(function(T, y, d, f) {
        ...
        performAction: m$1(function(y, d, f, w, E, h, Y) {
            var p = h.length - 1;
            switch(E){
                case 4:
                ...
                case 12:
                    ...
                    break;
                case 13:
                    w.getLogger().debug("Rule: statement #2: ", h[p - 1]), this.$ = [
                        h[p - 1]
                    ].concat(h[p]);
                    break;
                case 14:
                ...
                case 15:
                    ...
                    break;
                case 18:
                    let R = parseInt(h[p]), Z = w.generateId();
                    this.$ = {
                        id: Z,
                        type: "space",
                        label: "",
                ...
                case 23:
                    ...
                    let V = w.edgeStrToEdgeData(h[p - 1].edgeTypeStr);
                    this.$ = [
                        {
                            id: h[p - 2].id,
                            label: h[p - 2].label,
                        ...
                        },
                        {
                            id: h[p].id,
                            label: h[p].label,
                            type: w.typeStr2Type(h[p].typeStr),
                            directions: h[p].directions
                        }
                    ];
                    break;
                case 24:
                    w.getLogger().debug("Rule: nodeStatement (abc88 node size) ", h[p - 1], h[p]), this.$ = {
                        id: h[p - 1].id,
                        label: h[p - 1].label,
                        type: w.typeStr2Type(h[p - 1].typeStr),
                ...
                case 31:
                    ...
                    break;
                case 32:
                    w.getLogger().debug("Rule: dirList: ", h[p - 1], h[p]), this.$ = [
                        h[p - 1]
                    ].concat(h[p]);
                    break;
                case 33:
        ...
        parse: m$1(function(y) {
            var d = this, f = [
                0
            ], w = [], E = [
                null
            ], h = [], Y = this.table, p = "", R = 0, Z = 0, V = 0, Bt = 2, at = 1, _e = h.slice.call(arguments, 1), z = Object.create(this.lexer), J = {
                yy: {}
            };
            ...
            var ut = z.yylloc;
            h.push(ut);
            var De = z.options && z.options.ranges;
            ...
            function Be() {
                var H;
                return H = w.pop() || z.lex() || at, typeof H != "number" && (H instanceof Array && (w = H, H = w.pop()), H = d.symbols_[H] || H), H;
            }
            m$1(Be, "lex");
            for(var F, pt, Q, K, Zr, ft, $ = {}, st, G, vt, it;;){
                if (Q = f[f.length - 1], this.defaultActions[Q] ? K = this.defaultActions[Q] : ((F === null || typeof F > "u") && (F = Be()), K = Y[Q] && Y[Q][F]), typeof K > "u" || !K.length || !K[0]) {
                    var xt = "";
                    it = [];
...
Expecting ` + it.join(", ") + ", got '" + (this.terminals_[F] || F) + "'" : xt = "Parse error on line " + (R + 1) + ": Unexpected " + (F == at ? "end of input" : "'" + (this.terminals_[F] || F) + "'"), this.parseError(xt, {
                ...
                switch(K[0]){
                    ...
                    case 2:
                        if (G = this.productions_[K[1]][1], $.$ = E[E.length - G], $._$ = {
                            ...
                            E,
                            h
                        ].concat(_e)), typeof ft < "u") return ft;
                        G && (f = f.slice(0, -1 * G * 2), E = E.slice(0, -1 * G), h = h.slice(0, -1 * G)), f.push(this.productions_[K[1]][0]), E.push($.$), h.push($._$), vt = Y[f[f.length - 2]][f[f.length - 1]], f.push(vt);
                        break;
                    case 3:
                        return true;
                }
        ...
        var T = {
            EOF: 1,
            parseError: m$1(function(d, f) {
                if (this.yy.parser) this.yy.parser.parseError(d, f);
                else throw new Error(d);
            }, "parseError"),
            setInput: m$1(function(y, d) {
            ...
            input: m$1(function() {
                ...
                var d = y.match(/(?:\r\n?|\n).*/g);
                return d ? (this.yylineno++, this.yylloc.last_line++) : this.yylloc.last_column++, this.options.ranges && this.yylloc.range[1]++, this._input = this._input.slice(1), y;
            }, "input"),
            unput: m$1(function(y) {
                var d = y.length, f = y.split(/(?:\r\n?|\n)/g);
                this._input = y + this._input, this.yytext = this.yytext.substr(0, this.yytext.length - d), this.offset -= d;
...
` + this.showPosition(), {
            ...
            showPosition: m$1(function() {
                var y = this.pastInput(), d = new Array(y.length + 1).join("-");
                return y + this.upcomingInput() + `
` + d + "^";
            }, "showPosition"),
            test_match: m$1(function(y, d) {
                var f, w, E;
                ...
                }, this.options.ranges && (E.yylloc.range = this.yylloc.range.slice(0))), w = y[0].match(/(?:\r\n?|\n).*/g), w && (this.yylineno += w.length), this.yylloc = {
                ...
                ]), this._more = false, this._backtrack = false, this._input = this._input.slice(y[0].length), this.matched += y[0], f = this.performAction.call(this, this.yy, this, d, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), f) return f;
                if (this._backtrack) {
            ...
            next: m$1(function() {
                ...
                for(var E = this._currentRules(), h = 0; h < E.length; h++)if (f = this._input.match(this.rules[E[h]]), f && (!d || f[0].length > d[0].length)) {
                    if (d = f, w = h, this.options.backtrack_lexer) {
                        if (y = this.test_match(f, E[h]), y !== false) return y;
                        if (this._backtrack) {
                            d = false;
                            continue;
                        } else return false;
                ...
                return d ? (y = this.test_match(d, E[w]), y !== false ? y : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
                    text: "",
                    token: null,
                    line: this.yylineno
            ...
            options: {},
            performAction: m$1(function(d, f, w, E) {
                switch(w){
                    case 0:
                        return 10;
                    case 1:
                    ...
                    case 8:
                        return f.yytext = f.yytext.replace(/columns\s+/, ""), d.getLogger().debug("COLUMNS (LEX)", f.yytext), 28;
                    case 9:
                    ...
                    case 15:
                        return f.yytext = f.yytext.replace(/space\:/, ""), d.getLogger().debug("SPACE NUM (LEX)", f.yytext), 21;
                    case 16:
                    ...
                    case 85:
                        ...
                        break;
                    case 86:
                        return f.yytext = f.yytext.replace(/^,\s*/, ""), d.getLogger().debug("Lex (right): dir:", f.yytext), "DIR";
                    case 87:
                        return f.yytext = f.yytext.replace(/^,\s*/, ""), d.getLogger().debug("Lex (left):", f.yytext), "DIR";
                    case 88:
                        return f.yytext = f.yytext.replace(/^,\s*/, ""), d.getLogger().debug("Lex (x):", f.yytext), "DIR";
                    case 89:
                        return f.yytext = f.yytext.replace(/^,\s*/, ""), d.getLogger().debug("Lex (y):", f.yytext), "DIR";
                    case 90:
                        return f.yytext = f.yytext.replace(/^,\s*/, ""), d.getLogger().debug("Lex (up):", f.yytext), "DIR";
                    case 91:
                        return f.yytext = f.yytext.replace(/^,\s*/, ""), d.getLogger().debug("Lex (down):", f.yytext), "DIR";
                    case 92:
                    ...
                    case 104:
                        return this.popState(), d.getLogger().debug("Lex: LINK", f.yytext), 15;
                    case 105:
                        return d.getLogger().debug("Lex: COLON", f.yytext), f.yytext = f.yytext.slice(1), 27;
                }
            }, "anonymous"),
            rules: [
                /^(?:block-beta\b)/,
...
yt.parser = yt;
var Ht = yt;
var X = new Map, kt = [], mt = new Map, jt = "color", Kt = "fill", Te = "bgFill", Ut = ",", Ce = Hl(), lt = new Map, Ne = m$1((e)=>gC.sanitizeText(e, Ce), "sanitizeText"), Ie = m$1(function(e) {
    ...
    s || (s = {
        ...
        styles: [],
        textStyles: []
    }, lt.set(e, s)), t?.split(Ut).forEach((n)=>{
        let i = n.replace(/([^;]*);/, "$1").trim();
        if (RegExp(jt).exec(n)) {
            let a = i.replace(Kt, Te).replace(jt, Kt);
            s.textStyles.push(a);
        }
        s.styles.push(i);
    });
}, "addStyleClass"), Oe = m$1(function(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
    let s = X.get(e);
    t != null && (s.styles = t.split(Ut));
}, "addStyle2Node"), Re = m$1(function(e, t) {
    ...
    let s = e.flat(), n = [];
    for (let i of s){
        if (i.label && (i.label = Ne(i.label)), i.type === "classDef") {
            Ie(i.id, i.css);
            continue;
        }
        if (i.type === "applyClass") {
            Re(i.id, i?.styleClass ?? "");
            continue;
        }
        if (i.type === "applyStyles") {
            i?.stylesStr && Oe(i.id, i?.stylesStr);
            continue;
        }
...
var Xt = 0, We = m$1(()=>(Xt++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Xt), "generateId"), Pe = m$1((e)=>{
    rt.children = e, Vt(e, rt), wt = rt.children;
}, "setHierarchy"), Ye = m$1((e)=>{
    let t = X.get(e);
    return t ? t.columns ? t.columns : t.children ? t.children.length : -1 : -1;
}, "getColumns"), He = m$1(()=>[
        ...X.values()
    ], "getBlocksFlat"), je = m$1(()=>wt || [], "getBlocks"), Ke = m$1(()=>kt, "getEdges"), Xe = m$1((e)=>X.get(e), "getBlock"), Ue = m$1((e)=>{
    X.set(e.id, e);
}, "setBlock"), Ve = m$1(()=>console, "getLogger"), Ge = m$1(function() {
    return lt;
}, "getClasses"), Ze = {
    getConfig: m$1(()=>Er$1().block, "getConfig"),
    typeStr2Type: ze,
    edgeTypeStr2Type: Me,
...
var ot = m$1((e, t)=>{
    let s = Su, n = s(e, "r"), i = s(e, "g"), r = s(e, "b");
    return ae$1(n, i, r, t);
}, "fade"), qe = m$1((e)=>`.label {
...
var cr = m$1((e)=>{
    ...
    for (let n of e.children){
        let { width: i, height: r, x: a, y: l } = n.size ?? {
            width: 0,
            height: 0,
            x: 0,
            y: 0
        };
        tt.debug("getMaxChildSize abc95 child:", n.id, "width:", i, "height:", r, "x:", a, "y:", l, n.type), n.type !== "space" && (i > t && (t = i / (e.widthInColumns ?? 1)), r > s && (s = r));
    }
    return {
        width: t,
        height: s
...
function Lt(e, t) {
    ...
    tt.debug("setBlockSizes abc95 (start)", e.id, e?.size?.x, "block width =", e?.size, "sieblingWidth", s), e?.size?.width || (e.size = {
        width: s,
        height: n,
        x: 0,
        y: 0
    ...
    if (e.children?.length > 0) {
        ...
        l > 0 && l < o && (u = l);
        let g = Math.ceil(o / u), x = u * (i + O) + O, m = g * (r + O) + O;
        if (x < s) {
            tt.debug(`Detected to small siebling: abc95 ${e.id} sieblingWidth ${s} sieblingHeight ${n} width ${x}`), x = s, m = n;
...
function Jt(e, t) {
    ...
    if (tt.debug("layoutBlocks columns abc95", e.id, "=>", s, e), e.children && e.children.length > 0) {
        ...
        let a = e?.size?.x ? e?.size?.x + (-e?.size?.width / 2 || 0) : -O, l = 0;
        for (let o of e.children){
            let u = e;
            if (!o.size) continue;
            let { width: g, height: x } = o.size, { px: m, py: b } = or(s, r);
            if (b != l && (l = b, a = e?.size?.x ? e?.size?.x + (-e?.size?.width / 2 || 0) : -O, tt.debug("New row in layout for block", e.id, " and child ", o.id, l)), tt.debug(`abc89 layout blocks (child) id: ${o.id} Pos: ${r} (px, py) ${m},${b} (${u?.size?.x},${u?.size?.y}) parent: ${u.id} width: ${g}${O}`), u.size) {
                let L = g / 2;
            ...
            o.children && Jt(o), r += o?.widthInColumns ?? 1, tt.debug("abc88 columnsPos", o, r);
        }
    }
...
function Qt(e) {
    ...
    if (e.size && e.id !== "root") {
        ...
        r - l / 2 < t && (t = r - l / 2), a - o / 2 < s && (s = a - o / 2), r + l / 2 > n && (n = r + l / 2), a + o / 2 > i && (i = a + o / 2);
    }
    if (e.children) for (let r of e.children)({ minX: t, minY: s, maxX: n, maxY: i } = Qt(r, {
        minX: t,
        minY: s,
        maxX: n,
        maxY: i
...
function $t(e) {
    ...
    if (!t) return;
    Lt(t, e, 0, 0), Jt(t), tt.debug("getBlocks", JSON.stringify(t, null, 2));
    let { minX: s, minY: n, maxX: i, maxY: r } = Qt(t), a = r - n, l = i - s;
    return {
        x: s,
        y: n,
        width: l,
...
m$1(te, "applyStyle");
function hr(e) {
    let t = ih(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), s = t.append("xhtml:div"), n = e.label, i = e.isNode ? "nodeLabel" : "edgeLabel", r = s.append("span");
    return r.html(n), te(r, e.labelStyle), r.attr("class", i), te(s, e.labelStyle), s.style("display", "inline-block"), s.style("white-space", "nowrap"), s.attr("xmlns", "http://www.w3.org/1999/xhtml"), t.node();
}
m$1(hr, "addHtmlLabel");
var gr = m$1((e, t, s, n)=>{
    let i = e || "";
    if (typeof i == "object" && (i = i[0]), mf(Hl().flowchart.htmlLabels)) {
        ...
        for (let l of a){
            let o = document.createElementNS("http://www.w3.org/2000/svg", "tspan");
            o.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve"), o.setAttribute("dy", "1em"), o.setAttribute("x", "0"), s ? o.setAttribute("class", "title-row") : o.setAttribute("class", "row"), o.textContent = l.trim(), r.appendChild(o);
        }
        return r;
    }
}, "createLabel"), W = gr;
var re = m$1((e, t, s, n, i)=>{
    t.arrowTypeStart && ee(e, "start", t.arrowTypeStart, s, n, i), t.arrowTypeEnd && ee(e, "end", t.arrowTypeEnd, s, n, i);
}, "addEdgeMarkers"), dr = {
    arrow_cross: "cross",
    arrow_point: "point",
    arrow_barb: "barb",
...
var St = {}, M = {};
var se = m$1((e, t)=>{
    let s = Hl(), n = mf(s.flowchart.htmlLabels), i = t.labelType === "markdown" ? Qt$1(e, t.label, {
        style: t.labelStyle,
        useHtmlLabels: n,
        addSvgBackground: true
    }, s) : W(t.label, t.labelStyle), r = e.insert("g").attr("class", "edgeLabel"), a = r.insert("g").attr("class", "label");
    a.node().appendChild(i);
    let l = i.getBBox();
    if (n) {
        let u = i.children[0], g = ih(i);
        l = u.getBoundingClientRect(), g.attr("width", l.width), g.attr("height", l.height);
    }
    a.attr("transform", "translate(" + -l.width / 2 + ", " + -l.height / 2 + ")"), St[t.id] = r, t.width = l.width, t.height = l.height;
    let o;
    if (t.startLabelLeft) {
        let u = W(t.startLabelLeft, t.labelStyle), g = e.insert("g").attr("class", "edgeTerminals"), x = g.insert("g").attr("class", "inner");
    ...
    if (t.startLabelRight) {
        let u = W(t.startLabelRight, t.labelStyle), g = e.insert("g").attr("class", "edgeTerminals"), x = g.insert("g").attr("class", "inner");
        o = g.node().appendChild(u), x.node().appendChild(u);
        let m = u.getBBox();
        x.attr("transform", "translate(" + -m.width / 2 + ", " + -m.height / 2 + ")"), M[t.id] || (M[t.id] = {}), M[t.id].startRight = g, ct(o, t.startLabelRight);
    }
    if (t.endLabelLeft) {
        let u = W(t.endLabelLeft, t.labelStyle), g = e.insert("g").attr("class", "edgeTerminals"), x = g.insert("g").attr("class", "inner");
        o = x.node().appendChild(u);
        let m = u.getBBox();
        x.attr("transform", "translate(" + -m.width / 2 + ", " + -m.height / 2 + ")"), g.node().appendChild(u), M[t.id] || (M[t.id] = {}), M[t.id].endLeft = g, ct(o, t.endLabelLeft);
    }
    if (t.endLabelRight) {
        let u = W(t.endLabelRight, t.labelStyle), g = e.insert("g").attr("class", "edgeTerminals"), x = g.insert("g").attr("class", "inner");
        o = x.node().appendChild(u);
        let m = u.getBBox();
...
function ct(e, t) {
    Hl().flowchart.htmlLabels && e && (e.style.width = t.length * 9 + "px", e.style.height = "12px");
}
m$1(ct, "setTerminalWidth");
var ie = m$1((e, t)=>{
    tt.debug("Moving label abc88 ", e.id, e.label, St[e.id], t);
    let s = t.updatedPath ? t.updatedPath : t.originalPath, n$1 = Hl(), { subGraphTitleTotalMargin: i } = n(n$1);
    if (e.label) {
        let r = St[e.id], a = e.x, l = e.y;
        if (s) {
            let o = Ie$1.calcLabelPosition(s);
    ...
    if (e.startLabelLeft) {
        ...
        if (s) {
            let o = Ie$1.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, "start_left", s);
            a = o.x, l = o.y;
        }
    ...
    if (e.startLabelRight) {
        ...
        if (s) {
            let o = Ie$1.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, "start_right", s);
            a = o.x, l = o.y;
        }
        r.attr("transform", `translate(${a}, ${l})`);
    }
    if (e.endLabelLeft) {
        ...
        if (s) {
            let o = Ie$1.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, "end_left", s);
            a = o.x, l = o.y;
        }
        r.attr("transform", `translate(${a}, ${l})`);
    }
    if (e.endLabelRight) {
        ...
        if (s) {
            let o = Ie$1.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, "end_right", s);
            a = o.x, l = o.y;
        }
        r.attr("transform", `translate(${a}, ${l})`);
    }
}, "positionEdgeLabel"), ur = m$1((e, t)=>{
    let s = e.x, n = e.y, i = Math.abs(t.x - s), r = Math.abs(t.y - n), a = e.width / 2, l = e.height / 2;
    return i >= a || r >= l;
}, "outsideNode"), pr = m$1((e, t, s)=>{
    tt.debug(`intersection calc abc89:
  outsidePoint: ${JSON.stringify(t)}
  insidePoint : ${JSON.stringify(s)}
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    let n = e.x, i = e.y, r = Math.abs(n - s.x), a = e.width / 2, l = s.x < t.x ? a - r : a + r, o = e.height / 2, u = Math.abs(t.y - s.y), g = Math.abs(t.x - s.x);
    if (Math.abs(i - t.y) * a > Math.abs(n - t.x) * o) {
...
}, "intersection"), ae = m$1((e, t)=>{
    tt.debug("abc88 cutPathAtIntersect", e, t);
    let s = [], n = e[0], i = false;
    return e.forEach((r)=>{
        if (!ur(t, r) && !i) {
            let a = pr(t, n, r), l = false;
            s.forEach((o)=>{
                l = l || o.x === a.x && o.y === a.y;
            }), s.some((o)=>o.x === a.x && o.y === a.y) || s.push(a), i = true;
        } else n = r, i || s.push(r);
    }), s;
}, "cutPathAtIntersect"), ne = m$1(function(e, t, s, n, i, r, a) {
    let l = s.points;
    tt.debug("abc88 InsertEdge: edge=", s, "e=", t);
    let o = false, u = r.node(t.v);
    var g = r.node(t.w);
    g?.intersect && u?.intersect && (l = l.slice(1, s.points.length - 1), l.unshift(u.intersect(l[0])), l.push(g.intersect(l[l.length - 1]))), s.toCluster && (tt.debug("to cluster abc88", n[s.toCluster]), l = ae(s.points, n[s.toCluster].node), o = true), s.fromCluster && (tt.debug("from cluster abc88", n[s.fromCluster]), l = ae(l.reverse(), n[s.fromCluster].node).reverse(), o = true);
    let x = l.filter((y)=>!Number.isNaN(y.y)), m = Bc;
    s.curve && (i === "graph" || i === "flowchart") && (m = s.curve);
    let { x: b, y: L } = d(s), _ = vc().x(b).y(L).curve(m), S;
    switch(s.thickness){
        case "normal":
    ...
    let I = e.append("path").attr("d", _(x)).attr("id", s.id).attr("class", " " + S + (s.classes ? " " + s.classes : "")).attr("style", s.style), D = "";
    (Hl().flowchart.arrowMarkerAbsolute || Hl().state.arrowMarkerAbsolute) && (D = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, D = D.replace(/\(/g, "\\("), D = D.replace(/\)/g, "\\)")), re(I, s, D, a, i);
    let T = {};
...
var fr = m$1((e)=>{
    ...
    return t;
}, "expandAndDeduplicateDirections"), le = m$1((e, t, s)=>{
    let n = fr(e), i = 2, r = t.height + 2 * s.padding, a = r / i, l = t.width + 2 * a + s.padding, o = s.padding / 2;
...
var oe = xr;
function br(e, t, s, n) {
    var i = e.x, r = e.y, a = i - n.x, l = r - n.y, o = Math.sqrt(t * t * l * l + s * s * a * a), u = Math.abs(t * s * a / o);
    n.x < i && (u = -u);
    var g = Math.abs(t * s * l / o);
    return n.y < r && (g = -g), {
        x: i + u,
        y: r + g
    };
...
var ce = yr;
function mr(e, t, s, n) {
    var i, r, a, l, o, u, g, x, m, b, L, _, S, I, D;
    if (i = t.y - e.y, a = e.x - t.x, o = t.x * e.y - e.x * t.y, m = i * s.x + a * s.y + o, b = i * n.x + a * n.y + o, !(m !== 0 && b !== 0 && he(m, b)) && (r = n.y - s.y, l = s.x - n.x, u = n.x * s.y - s.x * n.y, g = r * e.x + l * e.y + u, x = r * t.x + l * t.y + u, !(g !== 0 && x !== 0 && he(g, x)) && (L = i * l - r * a, L !== 0))) return _ = Math.abs(L / 2), S = a * u - l * o, I = S < 0 ? (S - _) / L : (S + _) / L, S = r * o - i * u, D = S < 0 ? (S - _) / L : (S + _) / L, {
        x: I,
        y: D
    };
}
...
function kr(e, t, s) {
    ...
    typeof t.forEach == "function" ? t.forEach(function(L) {
        a = Math.min(a, L.x), l = Math.min(l, L.y);
    }) : (a = Math.min(a, t.x), l = Math.min(l, t.y));
    for(var o = n - e.width / 2 - a, u = i - e.height / 2 - l, g = 0; g < t.length; g++){
        var x = t[g], m = t[g < t.length - 1 ? g + 1 : 0], b = ge(e, s, {
            x: o + x.x,
            y: u + x.y
        }, {
            x: o + m.x,
    ...
    return r.length ? (r.length > 1 && r.sort(function(L, _) {
        var S = L.x - s.x, I = L.y - s.y, D = Math.sqrt(S * S + I * I), T = _.x - s.x, y = _.y - s.y, d = Math.sqrt(T * T + y * y);
        return D < d ? -1 : D === d ? 0 : 1;
    }), r[0]) : e;
}
m$1(kr, "intersectPolygon");
var wr = m$1((e, t)=>{
    var s = e.x, n = e.y, i = t.x - s, r = t.y - n, a = e.width / 2, l = e.height / 2, o, u;
...
var A = m$1(async (e, t, s, n)=>{
    let i = Hl(), r, a = t.useHtmlLabels || mf(i.flowchart.htmlLabels);
    s ? r = s : r = "node default";
    let l = e.insert("g").attr("class", r).attr("id", t.domId || t.id), o = l.insert("g").attr("class", "label").attr("style", t.labelStyle), u;
    t.labelText === void 0 ? u = "" : u = typeof t.labelText == "string" ? t.labelText : t.labelText[0];
    let g = o.node(), x;
    t.labelType === "markdown" ? x = Qt$1(o, Oe$1(Xe$1(u), i), {
        useHtmlLabels: a,
        width: t.width || i.flowchart.wrappingWidth,
        classes: "markdown-node-label"
    }, i) : x = g.appendChild(W(Oe$1(Xe$1(u), i), t.labelStyle, false, n));
    let m = x.getBBox(), b = t.padding / 2;
    if (mf(i.flowchart.htmlLabels)) {
        let L = x.children[0], _ = ih(x), S = L.getElementsByTagName("img");
        if (S) {
        ...
        m = L.getBoundingClientRect(), _.attr("width", m.width), _.attr("height", m.height);
    }
    return a ? o.attr("transform", "translate(" + -m.width / 2 + ", " + -m.height / 2 + ")") : o.attr("transform", "translate(0, " + -m.height / 2 + ")"), t.centerLabel && o.attr("transform", "translate(" + -m.width / 2 + ", " + -m.height / 2 + ")"), o.insert("rect", ":first-child"), {
        shapeSvg: l,
        bbox: m,
        halfPadding: b,
        label: o
    };
}, "labelHelper"), N = m$1((e, t)=>{
...
var Lr = m$1(async (e, t)=>{
    t.useHtmlLabels || Hl().flowchart.htmlLabels || (t.centerLabel = true);
    let { shapeSvg: n, bbox: i, halfPadding: r } = await A(e, t, "node " + t.classes, true);
...
var fe = m$1((e)=>e ? " " + e : "", "formatClass"), j = m$1((e, t)=>`${t || "node default"}${fe(e.classes)} ${fe(e.class)}`, "getClassesFromNode"), xe = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, j(t, void 0), true), i = n.width + t.padding, r = n.height + t.padding, a = i + r, l = [
        {
            x: a / 2,
            y: 0
        },
    ...
    let s = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), n = 28, i = [
        {
            x: 0,
            y: n / 2
        },
    ...
    return s.insert("polygon", ":first-child").attr("points", i.map(function(a) {
        return a.x + "," + a.y;
...
}, "choice"), Er = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, j(t, void 0), true), i = 4, r = n.height + t.padding, a = r / i, l = n.width + 2 * a + t.padding, o = [
        {
            x: a,
            y: 0
        },
...
}, "hexagon"), _r = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, void 0, true), i = 2, r = n.height + 2 * t.padding, a = r / i, l = n.width + 2 * a + t.padding, o = le(t.directions, n, t), u = U(s, l, r, o);
    return u.attr("style", t.style), N(t, u), t.intersect = function(g) {
        return v.polygon(t, o, g);
    }, s;
}, "block_arrow"), Dr = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, j(t, void 0), true), i = n.width + t.padding, r = n.height + t.padding, a = [
        {
            x: -r / 2,
            y: 0
        },
...
}, "rect_left_inv_arrow"), Br = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, j(t), true), i = n.width + t.padding, r = n.height + t.padding, a = [
        {
            x: -2 * r / 6,
            y: 0
        },
...
}, "inv_trapezoid"), Nr = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, j(t, void 0), true), i = n.width + t.padding, r = n.height + t.padding, a = [
        {
            x: 0,
            y: 0
...
}, "rect_right_inv_arrow"), Ir = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, j(t, void 0), true), i = n.width + t.padding, r = i / 2, a = r / (2.5 + i / 50), l = n.height + a + t.padding, o = "M 0," + a + " a " + r + "," + a + " 0,0,0 " + i + " 0 a " + r + "," + a + " 0,0,0 " + -i + " 0 l 0," + l + " a " + r + "," + a + " 0,0,0 " + i + " 0 l 0," + -l, u = s.attr("label-offset-y", a).insert("path", ":first-child").attr("style", t.style).attr("d", o).attr("transform", "translate(" + -i / 2 + "," + -(l / 2 + a) + ")");
    return N(t, u), t.intersect = function(g) {
        let x = v.rect(t, g), m = x.x - t.x;
        if (r != 0 && (Math.abs(m) < t.width / 2 || Math.abs(m) == t.width / 2 && Math.abs(x.y - t.y) > t.height / 2 - a)) {
            let b = a * a * (1 - m * m / (r * r));
            b != 0 && (b = Math.sqrt(b)), b = a - b, g.y - t.y > 0 && (b = -b), x.y += b;
        }
        return x;
    }, s;
}, "cylinder"), Or = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n, halfPadding: i } = await A(e, t, "node " + t.classes + " " + t.class, true), r = s.insert("rect", ":first-child"), a = t.positioned ? t.width : n.width + t.padding, l = t.positioned ? t.height : n.height + t.padding, o = t.positioned ? -a / 2 : -n.width / 2 - i, u = t.positioned ? -l / 2 : -n.height / 2 - i;
...
}, "rect"), Rr = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n, halfPadding: i } = await A(e, t, "node " + t.classes, true), r = s.insert("rect", ":first-child"), a = t.positioned ? t.width : n.width + t.padding, l = t.positioned ? t.height : n.height + t.padding, o = t.positioned ? -a / 2 : -n.width / 2 - i, u = t.positioned ? -l / 2 : -n.height / 2 - i;
...
function Et(e, t, s, n) {
    ...
    t.includes("t") ? (tt.debug("add top border"), r(s)) : a(s), t.includes("r") ? (tt.debug("add right border"), r(n)) : a(n), t.includes("b") ? (tt.debug("add bottom border"), r(s)) : a(s), t.includes("l") ? (tt.debug("add left border"), r(n)) : a(n), e.attr("stroke-dasharray", i.join(" "));
}
m$1(Et, "applyNodePropertyBorders");
var zr = m$1((e, t)=>{
    let s;
    t.classes ? s = "node " + t.classes : s = "node default";
    let n = e.insert("g").attr("class", s).attr("id", t.domId || t.id), i = n.insert("rect", ":first-child"), r = n.insert("line"), a = n.insert("g").attr("class", "label"), l = t.labelText.flat ? t.labelText.flat() : t.labelText, o = "";
    typeof l == "object" ? o = l[0] : o = l, tt.info("Label text abc79", o, l, typeof l == "object");
    let u = a.node().appendChild(W(o, t.labelStyle, true, true)), g = {
        width: 0,
        height: 0
    };
    if (mf(Hl().flowchart.htmlLabels)) {
        let _ = u.children[0], S = ih(u);
        g = _.getBoundingClientRect(), S.attr("width", g.width), S.attr("height", g.height);
    }
    tt.info("Text 2", l);
    let x = l.slice(1, l.length), m = u.getBBox(), b = a.node().appendChild(W(x.join ? x.join("<br/>") : x, t.labelStyle, true, true));
    if (mf(Hl().flowchart.htmlLabels)) {
        let _ = b.children[0], S = ih(b);
        g = _.getBoundingClientRect(), S.attr("width", g.width), S.attr("height", g.height);
    }
    let L = t.padding / 2;
    return ih(b).attr("transform", "translate( " + (g.width > m.width ? 0 : (m.width - g.width) / 2) + ", " + (m.height + L + 5) + ")"), ih(u).attr("transform", "translate( " + (g.width < m.width ? 0 : -(m.width - g.width) / 2) + ", 0)"), g = a.node().getBBox(), a.attr("transform", "translate(" + -g.width / 2 + ", " + (-g.height / 2 - L + 3) + ")"), i.attr("class", "outer title-state").attr("x", -g.width / 2 - L).attr("y", -g.height / 2 - L).attr("width", g.width + t.padding).attr("height", g.height + t.padding), r.attr("class", "divider").attr("x1", -g.width / 2 - L).attr("x2", g.width / 2 + L).attr("y1", -g.height / 2 - L + m.height + L).attr("y2", -g.height / 2 - L + m.height + L), N(t, i), t.intersect = function(_) {
        return v.rect(t, _);
    }, n;
}, "rectWithTitle"), Mr = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, j(t, void 0), true), i = n.height + t.padding, r = n.width + i / 4 + t.padding, a = s.insert("rect", ":first-child").attr("style", t.style).attr("rx", i / 2).attr("ry", i / 2).attr("x", -r / 2).attr("y", -i / 2).attr("width", r).attr("height", i);
    return N(t, a), t.intersect = function(l) {
        return v.rect(t, l);
    }, s;
}, "stadium"), Fr = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n, halfPadding: i } = await A(e, t, j(t, void 0), true), r = s.insert("circle", ":first-child");
    return r.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + i).attr("width", n.width + t.padding).attr("height", n.height + t.padding), tt.info("Circle main"), N(t, r), t.intersect = function(a) {
        return tt.info("Circle intersect", t, n.width / 2 + i, a), v.circle(t, n.width / 2 + i, a);
    }, s;
}, "circle"), Wr = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n, halfPadding: i } = await A(e, t, j(t, void 0), true), r = 5, a = s.insert("g", ":first-child"), l = a.insert("circle"), o = a.insert("circle");
    return a.attr("class", t.class), l.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + i + r).attr("width", n.width + t.padding + r * 2).attr("height", n.height + t.padding + r * 2), o.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + i).attr("width", n.width + t.padding).attr("height", n.height + t.padding), tt.info("DoubleCircle main"), N(t, l), t.intersect = function(u) {
        return tt.info("DoubleCircle intersect", t, n.width / 2 + i + r, u), v.circle(t, n.width / 2 + i + r, u);
    }, s;
}, "doublecircle"), Pr = m$1(async (e, t)=>{
    let { shapeSvg: s, bbox: n } = await A(e, t, j(t, void 0), true), i = n.width + t.padding, r = n.height + t.padding, a = [
        {
            x: 0,
            y: 0
...
}, "subroutine"), Yr = m$1((e, t)=>{
    let s = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), n = s.insert("circle", ":first-child");
    return n.attr("class", "state-start").attr("r", 7).attr("width", 14).attr("height", 14), N(t, n), t.intersect = function(i) {
        return v.circle(t, 7, i);
    }, s;
}, "start"), be = m$1((e, t, s)=>{
    let n = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), i = 70, r = 10;
    s === "LR" && (i = 10, r = 70);
    let a = n.append("rect").attr("x", -1 * i / 2).attr("y", -1 * r / 2).attr("width", i).attr("height", r).attr("class", "fork-join");
    return N(t, a), t.height = t.height + t.padding / 2, t.width = t.width + t.padding / 2, t.intersect = function(l) {
        return v.rect(t, l);
    }, n;
}, "forkJoin"), Hr = m$1((e, t)=>{
    let s = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id), n = s.insert("circle", ":first-child"), i = s.insert("circle", ":first-child");
    return i.attr("class", "state-start").attr("r", 7).attr("width", 14).attr("height", 14), n.attr("class", "state-end").attr("r", 5).attr("width", 10).attr("height", 10), N(t, i), t.intersect = function(r) {
        return v.circle(t, 7, r);
    }, s;
}, "end"), jr = m$1((e, t)=>{
    let s = t.padding / 2, n = 4, i = 8, r;
    t.classes ? r = "node " + t.classes : r = "node default";
    let a = e.insert("g").attr("class", r).attr("id", t.domId || t.id), l = a.insert("rect", ":first-child"), o = a.insert("line"), u = a.insert("line"), g = 0, x = n, m = a.insert("g").attr("class", "label"), b = 0, L = t.classData.annotations?.[0], _ = t.classData.annotations[0] ? "\xAB" + t.classData.annotations[0] + "\xBB" : "", S = m.node().appendChild(W(_, t.labelStyle, true, true)), I = S.getBBox();
    if (mf(Hl().flowchart.htmlLabels)) {
        let E = S.children[0], h = ih(S);
        I = E.getBoundingClientRect(), h.attr("width", I.width), h.attr("height", I.height);
    }
    t.classData.annotations[0] && (x += I.height + n, g += I.width);
    let D = t.classData.label;
    t.classData.type !== void 0 && t.classData.type !== "" && (Hl().flowchart.htmlLabels ? D += "&lt;" + t.classData.type + "&gt;" : D += "<" + t.classData.type + ">");
    let T = m.node().appendChild(W(D, t.labelStyle, true, true));
    ih(T).attr("class", "classTitle");
    let y = T.getBBox();
    if (mf(Hl().flowchart.htmlLabels)) {
        let E = T.children[0], h = ih(T);
    ...
    t.classData.members.forEach((E)=>{
        let h = E.getDisplayDetails(), Y = h.displayText;
        Hl().flowchart.htmlLabels && (Y = Y.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
        let p = m.node().appendChild(W(Y, h.cssStyle ? h.cssStyle : t.labelStyle, true, true)), R = p.getBBox();
        if (mf(Hl().flowchart.htmlLabels)) {
            let Z = p.children[0], V = ih(p);
            R = Z.getBoundingClientRect(), V.attr("width", R.width), V.attr("height", R.height);
        }
    ...
    if (t.classData.methods.forEach((E)=>{
        ...
        let E = (g - I.width) / 2;
        ih(S).attr("transform", "translate( " + (-1 * g / 2 + E) + ", " + -1 * x / 2 + ")"), b = I.height + n;
    }
    let w = (g - y.width) / 2;
    return ih(T).attr("transform", "translate( " + (-1 * g / 2 + w) + ", " + (-1 * x / 2 + b) + ")"), b += y.height + n, o.attr("class", "divider").attr("x1", -g / 2 - s).attr("x2", g / 2 + s).attr("y1", -x / 2 - s + i + b).attr("y2", -x / 2 - s + i + b), b += i, d.forEach((E)=>{
        ih(E).attr("transform", "translate( " + -g / 2 + ", " + (-1 * x / 2 + b + i / 2) + ")");
        let h = E?.getBBox();
        b += (h?.height ?? 0) + n;
    }), b += i, u.attr("class", "divider").attr("x1", -g / 2 - s).attr("x2", g / 2 + s).attr("y1", -x / 2 - s + i + b).attr("y2", -x / 2 - s + i + b), b += i, f.forEach((E)=>{
        ih(E).attr("transform", "translate( " + -g / 2 + ", " + (-1 * x / 2 + b) + ")");
        let h = E?.getBBox();
        b += (h?.height ?? 0) + n;
    ...
    join: be,
    class_box: jr
}, gt = {}, _t = m$1(async (e, t, s)=>{
    let n, i;
    if (t.link) {
        let r;
        Hl().securityLevel === "sandbox" ? r = "_top" : t.linkTarget && (r = t.linkTarget || "_blank"), n = e.insert("svg:a").attr("xlink:href", t.link).attr("target", r), i = await ye[t.shape](n, t, s);
    } else i = await ye[t.shape](e, t, s), n = i;
...
function ke(e, t) {
    ...
    let o = be$1(n?.styles ?? []), u = n.label, g = n.size ?? {
        width: 0,
        height: 0,
        x: 0,
        y: 0
    ...
    return {
        ...
        intersect: void 0,
        type: n.type,
        padding: l ?? Er$1()?.block?.padding ?? 0
    };
}
...
async function Kr(e, t, s) {
    ...
    let i = Er$1(), r = await _t(e, n, {
        config: i
    }), a = r.node().getBBox(), l = s.getBlock(n.id);
    l.size = {
        width: a.width,
        height: a.height,
        x: 0,
...
async function Se(e, t, s, n, i) {
    ...
    for (let a of t)if (a.start && a.end) {
        let l = n.getBlock(a.start), o = n.getBlock(a.end);
        if (l?.size && o?.size) {
...
m$1(Se, "insertEdges");
var Ur = m$1(function(e, t) {
    return t.db.getClasses();
}, "getClasses"), Vr = m$1(async function(e, t, s, n) {
    let { securityLevel: i, block: r } = Er$1(), a = n.db, l;
    i === "sandbox" && (l = ih("#i" + t));
    let o = i === "sandbox" ? ih(l.nodes()[0].contentDocument.body) : ih("body"), u = i === "sandbox" ? o.select(`[id="${t}"]`) : ih(`[id="${t}"]`);
    qt(u, [
        "point",
        "circle",
        "cross"
    ], n.type, t);
    let x = a.getBlocks(), m = a.getBlocksFlat(), b = a.getEdges(), L = u.insert("g").attr("class", "block");
    await we(L, x, a);
    let _ = $t(a);
    if (await Le(L, x, a), await Se(L, b, m, a, t), _) {
        let S = _, I = Math.max(1, Math.round(.125 * (S.width / S.height))), D = S.height + I + 10, T = S.width + 10, { useMaxWidth: y } = r;
        Tf(u, D, T, !!y), tt.debug("Here Bounds", _, S), u.attr("viewBox", `${S.x - 5} ${S.y - 5} ${S.width + 10} ${S.height + 10}`);
    }
}, "draw"), Ee = {
    draw: Vr,
    getClasses: Ur
