import { G as No, H as Mo, J as Pr, N as Ao, Nt as As, S as bt, _ as Ut, bt as ot, c as tn, dt as hn, et as Wo, gt as mr, hn as pt, jt as $s, ln as ia, q as Ot, rt as Z, s as Rr, x as Yt } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.BVgxNvHA.chunk.js";
import { A as Xr$1, C as Kn, D as Rn, K as Cr$1, L as fn, M as Zr, N as _f, Q as m$1, U as sn, Y as T, q as Mt, z as h } from "./vendor-min-mermaid~architecture-U656AL7Q-3ZQKGQJL.BH0ewMis.chunk.js";
...
var n = /* @__PURE__ */ m$1(({ flowchart: r }) => {
	let t$1 = r?.subGraphTitleMargin?.top ?? 0, a = r?.subGraphTitleMargin?.bottom ?? 0, o$1 = t$1 + a;
	return {
		subGraphTitleTopMargin: t$1,
		subGraphTitleBottomMargin: a,
		subGraphTitleTotalMargin: o$1
	};
...
function hr(e, t$1) {
	...
	let a = t$1 % e, i = /* @__PURE__ */ Math.floor(t$1 / e);
	return {
		px: a,
		py: i
	};
...
function ee(e) {
	...
	let { minX: a, minY: i, maxX: l$1, maxY: s$1 } = te(t$1), r = s$1 - i, n$1 = l$1 - a;
	return {
		x: a,
		y: i,
		width: n$1,
...
var W = /* @__PURE__ */ m$1(async (e, t$1, a, i) => {
	...
	if (Mo(s$1.flowchart.htmlLabels)) {
		...
		let r = await tn(/* @__PURE__ */ Yt(l$1));
		return dr({
			isNode: i,
			label: r,
...
var be = /* @__PURE__ */ m$1((e) => e ? " " + e : "", "formatClass"), j = /* @__PURE__ */ m$1((e, t$1) => `${t$1 || "node default"}${be(e.classes)} ${be(e.class)}`, "getClassesFromNode"), ye = /* @__PURE__ */ m$1(async (e, t$1) => {
	let { shapeSvg: a, bbox: i } = await z(e, t$1, /* @__PURE__ */ j(t$1, void 0), !0), l$1 = i.width + t$1.padding, s$1 = i.height + t$1.padding, r = l$1 + s$1, n$1 = [
		{
			x: r / 2,
			y: 0
		},
	...
	let { shapeSvg: a, bbox: i } = await z(e, t$1, /* @__PURE__ */ j(t$1, void 0), !0), l$1 = i.width + t$1.padding, s$1 = l$1 / 2, r = s$1 / (2.5 + l$1 / 50), n$1 = i.height + r + t$1.padding, o$1 = "M 0," + r + " a " + s$1 + "," + r + " 0,0,0 " + l$1 + " 0 a " + s$1 + "," + r + " 0,0,0 " + -l$1 + " 0 l 0," + n$1 + " a " + s$1 + "," + r + " 0,0,0 " + l$1 + " 0 l 0," + -n$1, u = /* @__PURE__ */ a.attr("label-offset-y", r).insert("path", ":first-child").attr("style", t$1.style).attr("d", o$1).attr("transform", "translate(" + -l$1 / 2 + "," + -(n$1 / 2 + r) + ")");
	return N(t$1, u), t$1.intersect = function(h$1) {
