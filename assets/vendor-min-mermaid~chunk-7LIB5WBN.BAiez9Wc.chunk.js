...
B.prototype.toString = m$1(function(n) {
...
function un(e, n) {
    ...
    for(var i = /\r?\n|\r|\0/g, l = [
        0
    ], r = [], u, o = -1; u = i.exec(e.buffer);)r.push(u.index), l.push(u.index + u[0].length), e.position <= u.index && o < 0 && (o = l.length - 2);
    o < 0 && (o = l.length - 1);
...
m$1(Z, "Schema$1");
Z.prototype.extend = m$1(function(n) {
    var i = [], l = [];
...
var Cn = new _("tag:yaml.org,2002:null", {
    ...
    predicate: yn,
    represent: {
        canonical: m$1(function() {
            return "~";
        }, "canonical"),
        lowercase: m$1(function() {
            return "null";
        }, "lowercase"),
        uppercase: m$1(function() {
            return "NULL";
        }, "uppercase"),
        camelcase: m$1(function() {
            return "Null";
        }, "camelcase"),
        empty: m$1(function() {
            return "";
...
var Sn = new _("tag:yaml.org,2002:bool", {
    ...
    predicate: En,
    represent: {
        lowercase: m$1(function(e) {
            return e ? "true" : "false";
        }, "lowercase"),
        uppercase: m$1(function(e) {
            return e ? "TRUE" : "FALSE";
        }, "uppercase"),
        camelcase: m$1(function(e) {
            return e ? "True" : "False";
        }, "camelcase")
    },
    defaultStyle: "lowercase"
...
var kn = new _("tag:yaml.org,2002:int", {
    ...
    predicate: Ln,
    represent: {
        binary: m$1(function(e) {
            return e >= 0 ? "0b" + e.toString(2) : "-0b" + e.toString(2).slice(1);
        }, "binary"),
        octal: m$1(function(e) {
            return e >= 0 ? "0o" + e.toString(8) : "-0o" + e.toString(8).slice(1);
        }, "octal"),
        decimal: m$1(function(e) {
            return e.toString(10);
        }, "decimal"),
        hexadecimal: m$1(function(e) {
...
function oi(e) {
    if (e === null) return [];
    var n, i, l, r, u, o = e;
    for(u = new Array(o.length), n = 0, i = o.length; n < i; n += 1)l = o[n], r = Object.keys(l), u[n] = [
        r[0],
        l[r[0]]
    ];
    return u;
...
function y(e, n, i) {
    for(var l = 0, r = e.input.charCodeAt(e.position); r !== 0;){
        ...
        if (n && r === 35) do r = e.input.charCodeAt(++e.position);
        while (r !== 10 && r !== 13 && r !== 0);
...
function wi(e, n) {
    var i = true, l, r, u, o = e.tag, f, a = e.anchor, p, h, t, s, x, m = Object.create(null), A, v, F, g;
...
function Ei(e, n) {
    ...
    if (k(t)) {
        ...
        while (k(t));
        if (t === 35) do t = e.input.charCodeAt(++e.position);
        while (!b(t) && t !== 0);
    }
    for(; t !== 0;){
...
function Si(e, n, i) {
    var l, r, u, o, f, a, p = e.tag, h = e.anchor, t = {}, s = Object.create(null), x = null, m = null, A = null, v = false, F = false, g;
    if (e.firstTabInLine !== -1) return false;
    for(e.anchor !== null && (e.anchorMap[e.anchor] = t), g = e.input.charCodeAt(e.position); g !== 0;){
        if (!v && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, d(e, "tab characters must not be used in indentation")), l = e.input.charCodeAt(e.position + 1), u = e.line, (g === 63 || g === 58) && S(l)) g === 63 ? (v && (D(e, t, s, x, m, null, o, f, a), x = m = A = null), F = true, v = true, r = true) : v ? (v = false, r = true) : d(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, g = l;
            ...
            if (e.line === u) {
                ...
                if (g === 58) g = e.input.charCodeAt(++e.position), S(g) || d(e, "a whitespace character is expected after the key-value separator within a block mapping"), v && (D(e, t, s, x, m, null, o, f, a), x = m = A = null), F = true, v = false, r = false, x = e.tag, m = e.result;
        ...
        if ((e.line === u || e.lineIndent > n) && (v && (o = e.line, f = e.lineStart, a = e.position), M(e, n, K, true, r) && (v ? m = e.result : A = e.result), v || (D(e, t, s, x, m, A, o, f, a), x = m = A = null), y(e, true, -1), g = e.input.charCodeAt(e.position)), (e.line === u || e.lineIndent > n) && g !== 0) d(e, "bad indentation of a mapping entry");
        else if (e.lineIndent < n) break;
    }
...
function Oi(e) {
    ...
    for(e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = Object.create(null), e.anchorMap = Object.create(null); (o = e.input.charCodeAt(e.position)) !== 0 && (y(e, true, -1), o = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || o !== 37));){
...
function or(e, n, i, l, r, u, o, f) {
    var a, p = 0, h = null, t = false, s = false, x = l !== -1, m = -1, A = rr(Y(e, 0)) && lr(Y(e, e.length - 1));
    if (n || o) for(a = 0; a < e.length; p >= 65536 ? a += 2 : a++){
        ...
        for(a = 0; a < e.length; p >= 65536 ? a += 2 : a++){
            if (p = Y(e, a), p === P) t = true, x && (s = s || a - m - 1 > l && e[m + 1] !== " ", m = a);
