...
import { H as Ht } from "./vendor-min-mermaid~chunk-HESFG3RP.X24hc0uC.chunk.js";
import { L as Le } from "./vendor-min-mermaid~chunk-YM3XIQPS.DzKxOkHI.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
import { B as Bf, F as Ff, L as Lf, M as Mf, w as wf, v as vf, t as tt$1, T as Tf, S as Sf, E as Er, p as pl, W as hl, O as Oe, aN as Ys, a1 as Is, c as vc } from "./vendor-min-mermaid~chunk-ZKYS2E5M.DYmB7G2x.chunk.js";
...
var At = function() {
  var i = m$1(function(B, o, c, g) {
    ...
    performAction: m$1(function(o, c, g, p, b, r, j) {
      var x = r.length - 1;
      switch (b) {
        case 5:
...
Expecting ` + K.join(", ") + ", got '" + (this.terminals_[D] || D) + "'" : mt = "Parse error on line " + (q + 1) + ": Unexpected " + (D == Yt ? "end of input" : "'" + (this.terminals_[D] || D) + "'"), this.parseError(mt, {
    ...
    var B = {
      EOF: 1,
      parseError: m$1(function(c, g) {
        if (this.yy.parser) this.yy.parser.parseError(c, g);
        else throw new Error(c);
      }, "parseError"),
      setInput: m$1(function(o, c) {
...
` + c + "^";
      ...
      test_match: m$1(function(o, c) {
        ...
        ]), this._more = false, this._backtrack = false, this._input = this._input.slice(o[0].length), this.matched += o[0], g = this.performAction.call(this, this.yy, this, c, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), g) return g;
        if (this._backtrack) {
      ...
      next: m$1(function() {
        ...
        for (var b = this._currentRules(), r = 0; r < b.length; r++) if (g = this._input.match(this.rules[b[r]]), g && (!c || g[0].length > c[0].length)) {
          if (c = g, p = r, this.options.backtrack_lexer) {
            if (o = this.test_match(g, b[r]), o !== false) return o;
            if (this._backtrack) {
              c = false;
              continue;
            } else return false;
        ...
        return c ? (o = this.test_match(c, b[p]), o !== false ? o : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: m$1(function(c, g, p, b) {
        switch (p) {
          case 0:
            break;
          case 1:
...
var z = (_a = class {
  ...
  getMaxDimension(t, e) {
    ...
    for (let h of t) {
      let u = Ht(a, 1, h), d2 = u ? u.width : h.length * e, y = u ? u.height : e;
      s.width = Math.max(s.width, d2), s.height = Math.max(s.height, y);
    }
    return a.remove(), s;
  }
...
var F = (_b = class {
  ...
  calculateSpaceIfDrawnHorizontally(t) {
    ...
    if (this.axisConfig.showAxisLine && e > this.axisConfig.axisLineWidth && (e -= this.axisConfig.axisLineWidth, this.showAxisLine = true), this.axisConfig.showLabel) {
      let s = this.getLabelDimension(), a = 0.2 * t.width;
  ...
  calculateSpaceIfDrawnVertical(t) {
    let e = t.width;
    if (this.axisConfig.showAxisLine && e > this.axisConfig.axisLineWidth && (e -= this.axisConfig.axisLineWidth, this.showAxisLine = true), this.axisConfig.showLabel) {
      let s = this.getLabelDimension(), a = 0.2 * t.height;
...
var et = (_c = class extends F {
  constructor(t, e, s, a, h) {
    super(t, a, h, e), this.categories = s, this.scale = Ys().domain(this.categories).range(this.getRange());
  }
  setRange(t) {
    super.setRange(t);
  }
  recalculateScale() {
    this.scale = Ys().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(0.5), tt$1.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
var it = (_d = class extends F {
  constructor(t, e, s, a, h) {
    super(t, a, h, e), this.domain = s, this.scale = Is().domain(this.domain).range(this.getRange());
  }
  getTickValues() {
  ...
  recalculateScale() {
    ...
    this.axisPosition === "left" && t.reverse(), this.scale = Is().domain(t).range(this.getRange());
  }
  getScaleValue(t) {
    return this.scale(t);
  }
...
var st = (_f = class {
  ...
  getDrawableElement() {
    ...
    return this.orientation === "horizontal" ? e = vc().y((s) => s[0]).x((s) => s[1])(t) : e = vc().x((s) => s[0]).y((s) => s[1])(t), e ? [
      {
        groupTexts: [
          "plot",
...
var at = (_i = class {
  ...
  calculateVerticalSpace() {
    let t = this.chartConfig.width, e = this.chartConfig.height, s = 0, a = 0, h = Math.floor(t * this.chartConfig.plotReservedSpacePercent / 100), u = Math.floor(e * this.chartConfig.plotReservedSpacePercent / 100), d2 = this.componentStore.plot.calculateSpace({
      width: h,
      height: u
    });
    t -= d2.width, e -= d2.height, d2 = this.componentStore.title.calculateSpace({
      width: this.chartConfig.width,
      height: e
    }), a = d2.height, e -= d2.height, this.componentStore.xAxis.setAxisPosition("bottom"), d2 = this.componentStore.xAxis.calculateSpace({
      width: t,
      height: e
    }), e -= d2.height, this.componentStore.yAxis.setAxisPosition("left"), d2 = this.componentStore.yAxis.calculateSpace({
      width: t,
      height: e
  ...
  calculateHorizontalSpace() {
    let t = this.chartConfig.width, e = this.chartConfig.height, s = 0, a = 0, h = 0, u = Math.floor(t * this.chartConfig.plotReservedSpacePercent / 100), d2 = Math.floor(e * this.chartConfig.plotReservedSpacePercent / 100), y = this.componentStore.plot.calculateSpace({
      width: u,
      height: d2
    });
...
var G = 0, Kt, H = Jt(), U = Zt(), m = te(), St = U.plotColorPalette.split(",").map((i) => i.trim()), ot = false, _t = false;
function Zt() {
  let i = hl(), t = Er();
...
function Ce() {
  ...
  return m.title = Lf(), rt.build(H, m, U, Kt);
}
...
var De = m$1(function() {
  Sf(), G = 0, H = Jt(), m = te(), U = Zt(), St = U.plotColorPalette.split(",").map((i) => i.trim()), ot = false, _t = false;
}, "clear"), ne = {
  getDrawableElem: Ce,
  clear: De,
  setAccTitle: vf,
...
` + i);
  let w = d(t), _ = w.append("g").attr("class", "main"), L = _.append("rect").attr("width", u.width).attr("height", u.height).attr("class", "background");
  Tf(w, u.height, u.width, true), w.attr("viewBox", `0 0 ${u.width} ${u.height}`), L.attr("fill", h.backgroundColor), a.setTmpSVGG(w.append("g").attr("class", "mermaid-tmp-group"));
