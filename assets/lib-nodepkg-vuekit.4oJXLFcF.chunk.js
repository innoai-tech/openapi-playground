...
import { i as b, p as _, e as x, o as w } from "./lib-nodepkg-typedef.BgZlbiby.chunk.js";
...
class tt {
  ...
  get(e10, t10, l10) {
    ...
    let s2 = Reflect.get(e10, t10, tR(e10) ? e10 : l10);
    return (ee(t10) ? e9.has(t10) : e7(t10)) ? s2 : (r10 || eQ(e10, "get", t10), i10) ? s2 : tR(s2) ? o2 && es(t10) ? s2 : s2.value : et(s2) ? r10 ? t_(s2) : ty(s2) : s2;
  }
}
class tn extends tt {
  constructor(e10 = false) {
  ...
  set(e10, t10, l10, r10) {
    ...
    if (!this._isShallow) {
      let t11 = tS(i10);
      if (tC(l10) || tS(l10) || (i10 = tE(i10), l10 = tE(l10)), !Z(e10) && tR(i10) && !tR(l10)) return !t11 && (i10.value = l10, true);
    }
    let o2 = Z(e10) && es(t10) ? Number(t10) < e10.length : K(e10, t10), s2 = Reflect.set(e10, t10, l10, tR(e10) ? e10 : r10);
...
function tP(e10, t10) {
  return tR(e10) ? e10 : new tT(e10, t10);
}
class tT {
  constructor(e10, t10) {
...
let tM = { get: (e10, t10, l10) => "__v_raw" === t10 ? e10 : t$(Reflect.get(e10, t10, l10)), set: (e10, t10, l10, r10) => {
  let i10 = e10[t10];
  return tR(i10) && !tR(l10) ? (i10.value = l10, true) : Reflect.set(e10, t10, l10, r10);
} };
function tL(e10) {
...
function tN(e10) {
  ...
  if (l10.add(e10), t10--, tR(e10)) tN(e10.value, t10, l10);
...
function nS(e10, t10, l10, r10) {
  ...
  if (null != c2 && c2 !== u2 && (J(c2) ? (f2[c2] = null, h2(c2) && (p2[c2] = null)) : tR(c2) && (c2.value = null)), Y(u2)) tU(u2, a2, 12, [s2, f2]);
  else {
    let t11 = J(u2), r11 = tR(u2);
    if (t11 || r11) {
      let a3 = () => {
        if (e10.f) {
...
function lx(e10, t10) {
  ...
  let h2 = function(e11, t11) {
    ...
    if (tR(e11) ? (r11 = () => e11.value, y2 = tC(e11)) : tw(e11) ? (r11 = () => g2(e11), y2 = true) : Z(e11) ? (b2 = true, y2 = e11.some((e12) => tw(e12) || tC(e12)), r11 = () => e11.map((e12) => tR(e12) ? e12.value : tw(e12) ? g2(e12) : Y(e12) ? h3 ? h3(e12, 2) : e12() : void 0)) : r11 = Y(e11) ? t11 ? h3 ? () => h3(e11, 2) : e11 : () => {
      if (i11) {
        eU();
        try {
          i11();
    ...
    return d3 && d3(S2), (l11 = new ej(r11)).scheduler = p3 ? () => p3(S2, false) : S2, o3 = (e12) => function(e13) {
...
function lA(e10) {
  ...
  if (l10 && false !== b2) {
    ...
    e11.length && 7 & t11 && (a2 && e11.some(q) && (l10 = lR(l10, a2)), x2 = lW(x2, l10, false, true));
  }
...
let lN = (e10) => {
  ...
  return "number" == typeof t10 && (t10 = "" + t10), null != t10 ? J(t10) || tR(t10) || Y(t10) ? { i: t3, r: t10, k: l10, f: !!r10 } : t10 : null;
}, lB = function(e10) {
  var t10, l10;
  ...
  e10.render || (e10.render = r10.render || U);
  {
    ...
    try {
      !function(e11) {
        ...
        if (f2 && nK(f2, e11, "c"), $2(nP, p2), $2(nT, d2), $2(n$, h2), $2(nM, g2), $2(nE, m2), $2(nA, y2), $2(nN, E2), $2(nV, C2), $2(nI, k2), $2(nL, _2), $2(nF, w2), $2(nD, A2), Z(O2)) {
          if (O2.length) {
        ...
        S2 && e11.render === U && (e11.render = S2), null != R2 && (e11.inheritAttrs = R2), j2 && (e11.components = j2), P2 && (e11.directives = P2), A2 && nw(e11);
      }(e10);
    } finally {
      eB(), t11();
    }
...
let rA = ["Webkit", "Moz", "ms"], rO = {}, rR = "http://www.w3.org/1999/xlink";
function rj(e10, t10, l10, r10, i10) {
  let o2 = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : eA(t10);
  if (r10 && t10.startsWith("xlink:")) null == l10 ? e10.removeAttributeNS(rR, t10.slice(6, t10.length)) : e10.setAttributeNS(rR, t10, l10);
...
let rT = Symbol("_vei"), r$ = /(?:Once|Passive|Capture)$/, rM = 0, rL = Promise.resolve(), rF = () => rM || (rL.then(() => rM = 0), rM = Date.now()), rD = (e10) => 111 === e10.charCodeAt(0) && 110 === e10.charCodeAt(1) && e10.charCodeAt(2) > 96 && 123 > e10.charCodeAt(2), rI = H({ patchProp: (e10, t10, l10, r10, i10, o2) => {
  ...
  }(e10, t10, r10, s2)) ? e10._isVueCE && (/[A-Z]/.test(t10) || !J(r10)) ? rP(e10, ef(t10), r10, o2, t10) : ("true-value" === t10 ? e10._trueValue = r10 : "false-value" === t10 && (e10._falseValue = r10), rj(e10, t10, r10, s2)) : (rP(e10, t10, r10), e10.tagName.includes("-") || "value" !== t10 && "checked" !== t10 && "selected" !== t10 || rj(e10, t10, r10, s2, o2, "value" !== t10));
} }, { insert: (e10, t10, l10) => {
  ...
  let r10 = (g || (g = function(e11, t11) {
    ...
    let { insert: r11, remove: i11, patchProp: o2, createElement: s2, createText: a2, createComment: u2, setText: c2, setElementText: f2, parentNode: p2, nextSibling: d2, setScopeId: g2 = U, insertStaticContent: m2 } = e11, y2 = function(e12, t12, l12) {
      ...
      if (l12 && lg(l12, false), (u3 = m3.onVnodeBeforeUpdate) && lz(u3, l12, t12, e12), h2 && t8(t12, e12, l12, "beforeUpdate"), l12 && lg(l12, true), (g3.innerHTML && null == m3.innerHTML || g3.textContent && null == m3.textContent) && f2(c3, ""), d3 ? R2(e12.dynamicChildren, d3, c3, l12, r12, lh(t12, i12), s3) : a3 || D2(e12, t12, c3, null, l12, r12, lh(t12, i12), s3, false), p3 > 0) {
      ...
      m3 && (c3 = c3 ? c3.concat(m3) : m3), null == e12 ? (r11(p3, l12, i12), r11(d3, l12, i12), A2(t12.children || [], l12, d3, o3, s3, u3, c3, f3)) : h2 > 0 && 64 & h2 && g3 && e12.dynamicChildren ? (R2(e12.dynamicChildren, g3, l12, o3, s3, u3, c3), (null != t12.key || o3 && t12 === o3.subTree) && lv(e12, t12, true)) : D2(e12, t12, l12, d3, o3, s3, u3, c3, f3);
      ...
      if (function(e13, t13, l13) {
        ...
        if (!l13 || !(u3 >= 0)) return (!!i12 || !!a3) && (!a3 || !a3.$stable) || r13 !== s3 && (r13 ? !s3 || lj(r13, s3, c3) : !!s3);
        if (1024 & u3) return true;
        if (16 & u3) return r13 ? lj(r13, s3, c3) : !!s3;
        if (8 & u3) {
    ...
    }, er2 = { p: y2, um: q2, m: W2, r: G2, mt: $2, mc: A2, pc: D2, pbc: R2, n: J2, o: e11 };
...
function iS(l10) {
  ...
  }, createHref: iv.bind(null, l10) }, r10, i10);
...
let iO = "[^/]+?", iR = { sensitive: false, strict: false, start: true, end: true }, ij = /[.+*?^${}()[\]/\\]/g;
function iP(e10, t10) {
...
let iQ = /* @__PURE__ */ nx({ name: "RouterLink", compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: "page" } }, useLink: iX, setup(e10, t10) {
...
let iJ = (e10, t10, l10) => null != e10 ? e10 : null != t10 ? t10 : l10, i0 = /* @__PURE__ */ nx({ name: "RouterView", inheritAttrs: false, props: { name: { type: String, default: "default" }, route: Object }, compatConfig: { MODE: 3 }, setup(e10, t10) {
...
function i2(t10) {
  ...
  function E2(e10, t11) {
    ...
    return l11.push(s3), D2(l11).then(() => {
      ...
      for (let r12 of (l11 = [], o3)) if (r12.beforeEnter) {
        if (rX(r12.beforeEnter)) for (let i12 of r12.beforeEnter) l11.push(iK(i12, e10, t11));
  ...
  function T2(t11) {
    return r10 || (r10 = !t11, l10 || (l10 = u2.listen((t12, l11, r11) => {
      ...
      if (o3) {
        S2(rz(o3, { replace: true, force: true }), i11).catch(rZ);
        return;
      }
      h2 = i11;
      let s3 = d2.value;
      if (rH) {
        var a3, c3;
        a3 = iy(s3.fullPath, r11.delta), c3 = im(), ib.set(a3, c3);
      }
      E2(i11, s3).catch((t13) => iA(t13, 12) ? t13 : iA(t13, 2) ? (S2(rz(_2(t13.to), { force: true }), i11).then((t14) => {
        iA(t14, 20) && !r11.delta && r11.type === e.pop && u2.go(-1, false);
      }).catch(rZ), Promise.reject()) : (r11.delta && u2.go(-r11.delta, false), P2(t13, i11, s3))).then((t13) => {
        (t13 = t13 || O2(i11, s3, false)) && (r11.delta && !iA(t13, 8) ? u2.go(-r11.delta, false) : r11.type === e.pop && iA(t13, 20) && u2.go(-1, false)), A2(i11, s3, t13);
      }).catch(rZ);
    })), R2.list().forEach((e10) => {
      let [l11, r11] = e10;
...
}, { name: "RxSlot" }, { displayName: "RxSlot" }), oh = (e10, t10) => {
  let l10 = new R(e10[t10]);
  return l_(() => e10[t10], (e11) => l10.next(e11)), l10;
}, og = (e10) => {
  let t10 = {};
  for (let l10 in e10) {
    if (P(e10[l10]) || j(e10[l10])) {
      t10[l10] = e10[l10];
      continue;
    }
    t10[`${l10}$`] = oh(e10, l10);
...
function ov() {
  ...
  return rW(i10, (t11, l11) => {
    let r11 = og(t11), i11 = new Proxy({}, { get: (e11, l12) => t11[l12] ?? r11[l12] }), o3 = new Proxy({}, { get: (e11, t12) => "render" === t12 ? op : l11[t12] }), s2 = e10(i11, o3);
    return P(s2) ? s2 : () => s2;
  }, o2);
}
let om = (e10) => {
