import { I as Ie$1 } from './vendor-min-mermaid~chunk-IIWVAQKY.CwtpAX-Q.chunk.js';
import { f } from './vendor-min-mermaid~chunk-TI4EEUUG.BFlBPHyk.chunk.js';
import { F as Ff, B as Bf, M as Mf, L as Lf, w as wf, v as vf, H as Hl, i as ih, $ as gc, a0 as Yl, a1 as Ul, T as Tf, a2 as Ia, a3 as am, t as tt$1, a4 as Zf, a5 as fo, a6 as xr, a7 as fe, a8 as Hh, a9 as $h, aa as we, ab as Wh, ac as Ph, ad as pr, ae as ue, af as mr, ag as dr, ah as ee, ai as Pe$1, aj as jf, g as gC, S as Sf, ak as Ys } from './vendor-min-mermaid~chunk-RAMAZW42.vc82q0BN.chunk.js';
...
Vt.parser = Vt;
var Se = Vt;
var Ye = /*#__PURE__*/ q$1(/*#__PURE__*/ f()), q = /*#__PURE__*/ q$1(/*#__PURE__*/ Ys()), Fe = /*#__PURE__*/ q$1(/*#__PURE__*/ Ee()), We = /*#__PURE__*/ q$1(/*#__PURE__*/ Me()), Ve = /*#__PURE__*/ q$1(/*#__PURE__*/ Le());
...
var Ae = {
    ...
    Qt = [], wt = [], ft = "", Kt = [], Tt = 0, Ht = void 0, vt = void 0, O = [], K = "", Xt = "", $t = "", qt = void 0, Ut = "", yt = [], pt = [], gt = false, Jt = false, jt = 0, Zt = new Map, Sf(), te = "sunday", _t = "saturday";
...
m$1(Xe, "getTaskTags");
var Dt = /*#__PURE__*/ q$1(/*#__PURE__*/ Ys());
var Yn = /*#__PURE__*/ m$1(function() {
    ...
    let n = Hl().gantt, f = Hl().securityLevel, k;
    f === "sandbox" && (k = /*#__PURE__*/ ih("#i" + e));
    let D = f === "sandbox" ? ih(k.nodes()[0].contentDocument.body) : ih("body"), _ = f === "sandbox" ? k.nodes()[0].contentDocument : document, A = /*#__PURE__*/ _.getElementById(e);
    ...
    let p = /*#__PURE__*/ D.select(`[id="${e}"]`), m = /*#__PURE__*/ gc().domain([
        /*#__PURE__*/ Yl(C, function(g) {
            return g.startTime;
        }),
        /*#__PURE__*/ Ul(C, function(g) {
            return g.endTime;
        })
    ]).rangeRound([
        0,
    ...
    m$1(L, "taskCompare"), C.sort(L), I(C, tt, z), Tf(p, z, tt, n.useMaxWidth), p.append("text").text(/*#__PURE__*/ a.db.getDiagramTitle()).attr("x", tt / 2).attr("y", n.titleTopMargin).attr("class", "titleText");
    function I(g, v, x) {
        let b = n.barHeight, y = b + n.barGap, w = n.topPadding, c = n.leftPadding, u = /*#__PURE__*/ Ia().domain([
            0,
            W.length
        ]).range([
            "#00B9FA",
    ...
    function $(g, v, x, b) {
        let y = /*#__PURE__*/ Zf(m).tickSize(-b + v + n.gridLineStartPadding).tickFormat(/*#__PURE__*/ fo(a.db.getAxisFormat() || n.axisFormat || "%Y-%m-%d")), c = /*#__PURE__*/ /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(a.db.getTickInterval() || n.tickInterval);
        if (c !== null) {
            let u = c[1], h = c[2], d = a.db.getWeekday() || n.weekday;
            switch(h){
                case "millisecond":
                    y.ticks(/*#__PURE__*/ Pe$1.every(u));
                    break;
                case "second":
                    y.ticks(/*#__PURE__*/ ee.every(u));
                    break;
                case "minute":
                    y.ticks(/*#__PURE__*/ dr.every(u));
                    break;
                case "hour":
        ...
        if (p.append("g").attr("class", "grid").attr("transform", "translate(" + g + ", " + (b - 50) + ")").call(y).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em"), a.db.topAxisEnabled() || n.topAxis) {
            let u = /*#__PURE__*/ jf(m).tickSize(-b + v + n.gridLineStartPadding).tickFormat(/*#__PURE__*/ fo(a.db.getAxisFormat() || n.axisFormat || "%Y-%m-%d"));
            if (c !== null) {
                let h = c[1], d = c[2], T = a.db.getWeekday() || n.weekday;
                switch(d){
                    case "millisecond":
                        u.ticks(/*#__PURE__*/ Pe$1.every(h));
                        break;
                    case "second":
                        u.ticks(/*#__PURE__*/ ee.every(h));
                        break;
                    case "minute":
                        u.ticks(/*#__PURE__*/ dr.every(h));
                        break;
                    case "hour":
    ...
    function U(g, v) {
        ...
        p.append("g").selectAll("text").data(b).enter().append(function(y) {
            let w = /*#__PURE__*/ y[0].split(gC.lineBreakRegex), c = -(w.length - 1) / 2, u = /*#__PURE__*/ _.createElementNS("http://www.w3.org/2000/svg", "text");
