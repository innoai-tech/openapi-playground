...
import { V, S } from './vendor-min-mermaid~chunk-YKNY556I.DcXDP0PQ.chunk.js';
import { Z as Zf$1 } from './vendor-min-mermaid~chunk-DPMNACAB.CIbaf8QU.chunk.js';
import { U as Ut, J as Jt } from './vendor-min-mermaid~chunk-3R3PQ5PD.DqcBTR0a.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { a1 as p_, t as tt, h as hh, k as kh, j as jf, K as Kf, J as Jf, Z as Zf, Q as Qf, b as td, e as jC, X as Xf, a2 as m_, V as Vu, s as se } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
var b1 = "flowchart-", Qe = class {
    constructor(){
        this.vertexCounter = 0;
        this.config = /*#__PURE__*/ hh();
    ...
    sanitizeText(i) {
        return jC.sanitizeText(i, this.config);
    }
    lookUpDomId(i) {
...
` + k + `
        ...
        let A = /*#__PURE__*/ this.edges.find((m)=>m.id === i);
        if (A) {
            let m = u;
            m?.animate !== void 0 && (A.animate = m.animate), m?.animation !== void 0 && (A.animation = m.animation), m?.curve !== void 0 && (A.interpolate = m.curve);
            return;
        }
        ...
        if (f === void 0 && (f = {
            ...
            styles: [],
            classes: []
        }, this.vertices.set(i, f)), this.vertexCounter++, r !== void 0 ? (this.config = /*#__PURE__*/ hh(), F = /*#__PURE__*/ this.sanitizeText(/*#__PURE__*/ r.text.trim()), f.labelType = r.type, F.startsWith('"') && F.endsWith('"') && (F = /*#__PURE__*/ F.substring(1, F.length - 1)), f.text = F) : f.text === void 0 && (f.text = i), n !== void 0 && (f.type = n), a?.forEach((m)=>{
            f.styles.push(m);
        }), l?.forEach((m)=>{
            f.classes.push(m);
            ...
            if (u.shape) {
                ...
                if (!Zf$1(u.shape)) throw new Error(`No such shape: ${u.shape}.`);
                f.type = u?.shape;
            }
    ...
    addSingleLink(i, r, n, a) {
        ...
        let k = n.text;
        if (k !== void 0 && (c.text = /*#__PURE__*/ this.sanitizeText(/*#__PURE__*/ k.text.trim()), c.text.startsWith('"') && c.text.endsWith('"') && (c.text = /*#__PURE__*/ c.text.substring(1, c.text.length - 1)), c.labelType = k.type), n !== void 0 && (c.type = n.type, c.stroke = n.stroke, c.length = n.length > 10 ? 10 : n.length), a && !this.edges.some((u)=>u.id === a)) c.id = a, c.isUserDefinedId = true;
        else {
...
You have to call mermaid.initialize.`);
    ...
    addClass(i, r) {
        let n = /*#__PURE__*/ r.join().replace(/\\,/g, "\xA7\xA7\xA7").replace(/,/g, ";").replace(/§§§/g, ",").split(";");
        i.split(",").forEach((a)=>{
    ...
    setupToolTips(i) {
        ...
        (r._groups || r)[0][0] === null && (r = /*#__PURE__*/ kh("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), kh(i).select("svg").selectAll("g.node").on("mouseover", (l)=>{
            let g = /*#__PURE__*/ kh(l.currentTarget);
            if (g.attr("title") === null) return;
            let k = l.currentTarget?.getBoundingClientRect();
            r.transition().duration(200).style("opacity", ".9"), r.text(/*#__PURE__*/ g.attr("title")).style("left", window.scrollX + k.left + (k.right - k.left) / 2 + "px").style("top", window.scrollY + k.bottom + "px"), r.html(/*#__PURE__*/ r.html().replace(/&lt;br\/&gt;/g, "<br/>")), g.classed("hover", true);
        }).on("mouseout", (l)=>{
            r.transition().duration(500).style("opacity", 0), kh(l.currentTarget).classed("hover", false);
        });
    }
    clear(i = "gen-2") {
        this.vertices = new Map, this.classes = new Map, this.edges = [], this.funs = [
            /*#__PURE__*/ this.setupToolTips.bind(this)
        ], this.subGraphs = [], this.subGraphLookup = new Map, this.subCount = 0, this.tooltips = new Map, this.firstGraphFlag = true, this.version = i, this.config = /*#__PURE__*/ hh(), Xf();
    }
    setGen(i) {
    ...
    addSubGraph(i, r, n) {
        ...
        let c = /*#__PURE__*/ m$1((f)=>{
            ...
            return {
                nodeList: /*#__PURE__*/ f.filter(function(j) {
                    let Z = typeof j;
                    return j.stmt && j.stmt === "dir" ? (x = j.value, false) : j.trim() === "" ? false : Z in m ? m[Z].hasOwnProperty(j) ? false : m[Z][j] = true : S.includes(j) ? false : S.push(j);
                }),
                dir: x
            };
        }, "uniq")(/*#__PURE__*/ r.flat()), k = c.nodeList, u = c.dir, A = hh().flowchart ?? {};
        if (u = u ?? (A.inheritDir ? this.getDirection() ?? hh().direction ?? void 0 : void 0), this.version === "gen-1") for(let f = 0; f < k.length; f++)k[f] = /*#__PURE__*/ this.lookUpDomId(k[f]);
        ...
        return tt.info("Adding", F.id, F.nodes, F.dir), F.nodes = this.makeUniq(F, this.subGraphs).nodes, this.subGraphs.push(F), this.subGraphLookup.set(a, F), a;
    }
    getPosForId(i) {
    ...
    addNodeFromVertex(i, r, n, a, l, g) {
        let c = /*#__PURE__*/ n.get(i.id), k = a.get(i.id) ?? false, u = /*#__PURE__*/ this.findNode(r, i.id);
    ...
    getCompiledStyles(i) {
        ...
        for (let n of i){
            ...
            a?.styles && (r = /*#__PURE__*/ [
                ...r,
                ...a.styles ?? []
            ].map((l)=>l.trim())), a?.textStyles && (r = /*#__PURE__*/ [
                ...r,
                ...a.textStyles ?? []
            ].map((l)=>l.trim()));
        }
    ...
    getData() {
        let i = /*#__PURE__*/ hh(), r = [], n = [], a = /*#__PURE__*/ this.getSubGraphs(), l = new Map, g = new Map;
        ...
        return k.forEach((u, A)=>{
            let { arrowTypeStart: F, arrowTypeEnd: f } = this.destructEdgeType(u.type), m = [
                ...k.defaultStyle ?? []
            ];
            u.style && m.push(...u.style);
            let S = {
...
var k1 = /*#__PURE__*/ m$1(function(s, i) {
    return i.db.getClasses();
}, "getClasses"), A1 = /*#__PURE__*/ m$1(async function(s, i, r, n) {
    tt.info("REF0:"), tt.info("Drawing state diagram (v2)", i);
    let { securityLevel: a, flowchart: l, layout: g } = hh(), c;
    a === "sandbox" && (c = /*#__PURE__*/ kh("#i" + i));
    ...
    u.type = n.type, u.layoutAlgorithm = /*#__PURE__*/ V(g), u.layoutAlgorithm === "dagre" && g === "elk" && tt.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), u.direction = F, u.nodeSpacing = l?.nodeSpacing || 50, u.rankSpacing = l?.rankSpacing || 50, u.markers = [
        "point",
        "circle",
        "cross"
    ], u.diagramId = i, tt.debug("REF1:", u), await S(u, A);
    let f = u.config.flowchart?.diagramPadding ?? 8;
    Ut.insertTitle(A, "flowchartTitleText", l?.titleTopMargin || 0, /*#__PURE__*/ n.db.getDiagramTitle()), y(A, f, "flowchart", l?.useMaxWidth || false);
    for (let m of u.nodes){
        let S = /*#__PURE__*/ kh(`#${i} [id="${m.id}"]`);
        if (!S || !m.link) continue;
        let x = /*#__PURE__*/ k.createElementNS("http://www.w3.org/2000/svg", "a");
        x.setAttributeNS("http://www.w3.org/2000/svg", "class", m.cssClasses), x.setAttributeNS("http://www.w3.org/2000/svg", "rel", "noopener"), a === "sandbox" ? x.setAttributeNS("http://www.w3.org/2000/svg", "target", "_top") : m.linkTarget && x.setAttributeNS("http://www.w3.org/2000/svg", "target", m.linkTarget);
        let fe = /*#__PURE__*/ S.insert(function() {
            return x;
        }, ":first-child"), j = /*#__PURE__*/ S.select(".label-container");
        j && fe.append(function() {
            return j.node();
        });
        let Z = /*#__PURE__*/ S.select(".label");
        Z && fe.append(function() {
            return Z.node();
        });
    }
}, "draw"), u1 = {
...
var at = /*#__PURE__*/ function() {
    var s = /*#__PURE__*/ m$1(function(ke, h, d, p) {
        ...
        performAction: /*#__PURE__*/ m$1(function(h, d, p, o, _, e, me) {
            var t = e.length - 1;
            switch(_){
                case 2:
                    this.$ = [];
        ...
        parse: /*#__PURE__*/ m$1(function(h) {
            var d = this, p = [
                ...
                null
            ], e = [], me = this.table, t = "", L = 0, Pt = 0, Mt = 0, d1 = 2, Ot = 1, p1 = /*#__PURE__*/ e.slice.call(arguments, 1), U = /*#__PURE__*/ Object.create(this.lexer), Ee = {
                yy: {}
            };
            ...
            m$1(g1, "lex");
            for(var Y, st, Ce, Q, D1, it, Ge = {}, He, de, Ut, qe;;){
...
Expecting ` + qe.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : rt = "Parse error on line " + (L + 1) + ": Unexpected " + (Y == Ot ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(rt, {
                ...
                switch(Q[0]){
                    case 1:
                        p.push(Y), _.push(U.yytext), e.push(U.yylloc), p.push(Q[1]), Y = null, st ? (Y = st, st = null) : (Pt = U.yyleng, t = U.yytext, L = U.yylineno, tt = U.yylloc, Mt > 0);
                        break;
                    case 2:
                        ...
                        de && (p = /*#__PURE__*/ p.slice(0, -1 * de * 2), _ = /*#__PURE__*/ _.slice(0, -1 * de), e = /*#__PURE__*/ e.slice(0, -1 * de)), p.push(this.productions_[Q[1]][0]), _.push(Ge.$), e.push(Ge._$), Ut = me[p[p.length - 2]][p[p.length - 1]], p.push(Ut);
                        break;
                    case 3:
                        return true;
                }
...
` + d + "^";
            ...
            test_match: /*#__PURE__*/ m$1(function(h, d) {
                ...
                }, this.options.ranges && (_.yylloc.range = /*#__PURE__*/ this.yylloc.range.slice(0))), o = /*#__PURE__*/ h[0].match(/(?:\r\n?|\n).*/g), o && (this.yylineno += o.length), this.yylloc = {
            ...
            next: /*#__PURE__*/ m$1(function() {
                ...
                for(var _ = /*#__PURE__*/ this._currentRules(), e = 0; e < _.length; e++)if (p = /*#__PURE__*/ this._input.match(this.rules[_[e]]), p && (!d || p[0].length > d[0].length)) {
                    if (d = p, o = e, this.options.backtrack_lexer) {
                        if (h = /*#__PURE__*/ this.test_match(p, _[e]), h !== false) return h;
                        if (this._backtrack) {
                            d = false;
                            continue;
                        } else return false;
                ...
                return d ? (h = /*#__PURE__*/ this.test_match(d, _[o]), h !== false ? h : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
                    text: "",
                    token: null,
                    line: this.yylineno
            ...
            options: {},
            performAction: /*#__PURE__*/ m$1(function(d, p, o, _) {
                switch(o){
                    case 0:
...
var m1 = /*#__PURE__*/ m$1((s, i)=>{
    let r = Vu, n = /*#__PURE__*/ r(s, "r"), a = /*#__PURE__*/ r(s, "g"), l = /*#__PURE__*/ r(s, "b");
    return se(n, a, l, i);
}, "fade"), E1 = /*#__PURE__*/ m$1((s)=>`.label {
...
var ts = {
    ...
    styles: c1,
    init: /*#__PURE__*/ m$1((s)=>{
        s.flowchart || (s.flowchart = {}), s.layout && p_({
            layout: s.layout
        }), s.flowchart.arrowMarkerAbsolute = s.arrowMarkerAbsolute, p_({
            flowchart: {
