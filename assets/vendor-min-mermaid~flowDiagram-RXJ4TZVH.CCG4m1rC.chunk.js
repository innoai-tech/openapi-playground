...
import { Q as Qf } from './vendor-min-mermaid~chunk-USR3SDWQ.vyM1OSdF.chunk.js';
import { I as Ie, Y as Ye } from './vendor-min-mermaid~chunk-YM3XIQPS.CNQBySGW.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { X as IC, t as tt, H as Hl, i as ih, v as vf, B as Bf, M as Mf, w as wf, F as Ff, L as Lf, g as gC, S as Sf, Z as zC, a as Su, b as ae } from './vendor-min-mermaid~chunk-ZKYS2E5M.Dvid1YGB.chunk.js';
...
` + A + `
        ...
        let w, k = /*#__PURE__*/ this.vertices.get(i);
        if (k === void 0 && (k = {
            id: i,
            labelType: "text",
            ...
            styles: [],
            classes: []
        }, this.vertices.set(i, k)), this.vertexCounter++, r !== void 0 ? (this.config = /*#__PURE__*/ Hl(), w = /*#__PURE__*/ this.sanitizeText(/*#__PURE__*/ r.text.trim()), k.labelType = r.type, w.startsWith('"') && w.endsWith('"') && (w = /*#__PURE__*/ w.substring(1, w.length - 1)), k.text = w) : k.text === void 0 && (k.text = i), n !== void 0 && (k.type = n), u?.forEach((E)=>{
            k.styles.push(E);
        }), l?.forEach((E)=>{
            k.classes.push(E);
            ...
            a?.label && (k.text = a?.label), a?.icon && (k.icon = a?.icon, !a.label?.trim() && k.text === i && (k.text = "")), a?.form && (k.form = a?.form), a?.pos && (k.pos = a?.pos), a?.img && (k.img = a?.img, !a.label?.trim() && k.text === i && (k.text = "")), a?.constraint && (k.constraint = a.constraint), a.w && (k.assetWidth = /*#__PURE__*/ Number(a.w)), a.h && (k.assetHeight = /*#__PURE__*/ Number(a.h));
        }
    }
...
You have to call mermaid.initialize.`);
    ...
    getCompiledStyles(i) {
        ...
        for (let n of i){
            ...
            u?.styles && (r = /*#__PURE__*/ [
                ...r,
                ...u.styles ?? []
            ].map((l)=>l.trim())), u?.textStyles && (r = /*#__PURE__*/ [
                ...r,
                ...u.textStyles ?? []
            ].map((l)=>l.trim()));
        }
    ...
    getData() {
        let i = /*#__PURE__*/ Hl(), r = [], n = [], u = /*#__PURE__*/ this.getSubGraphs(), l = new Map, f = new Map;
...
var g1 = /*#__PURE__*/ m$1(function(s, i) {
    ...
    Ie.insertTitle(g, "flowchartTitleText", l?.titleTopMargin || 0, /*#__PURE__*/ n.db.getDiagramTitle()), $(g, k, "flowchart", l?.useMaxWidth || false);
    for (let E of a.nodes){
        let S = /*#__PURE__*/ ih(`#${i} [id="${E.id}"]`);
        ...
        let J = /*#__PURE__*/ S.insert(function() {
            return m;
        }, ":first-child"), ge = /*#__PURE__*/ S.select(".label-container");
        ge && J.append(function() {
            return ge.node();
        });
        let ke = /*#__PURE__*/ S.select(".label");
