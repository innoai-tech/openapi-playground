...
let e;
import { _ as t, n as r, T as n, c as a, u as i, v as o, p as s, x as l, q as c, y as u, z as d, r as f, A as h, B as p, d as m, t as g, w as v, F as b } from "./lib-nodepkg-vuekit.Da1QhWA9.chunk.js";
import { j as y, a as x } from "./lib-nodepkg-vue-jsx-runtime.BWD1o_o5.chunk.js";
import { k as w, g as k, b as M, l as C, s as P, e as _, m as S, n as O, q as D, t as T, u as $, v as R, w as A, x as I, i as L, a as F, y as B, z as j, c as V, A as E, h as H } from "./lib-nodepkg-typedef.Bwrbe8Ho.chunk.js";
...
function ei(e10) {
  var { from: r10 = 0, to: n6 = 1, restSpeed: a2 = 2, restDelta: i2 } = e10, o2 = t(e10, ["from", "to", "restSpeed", "restDelta"]);
  let s2 = { done: false, value: r10 }, { stiffness: l2, damping: c2, mass: u2, velocity: d2, duration: f2, isResolvedFromDuration: h2 } = function(e11) {
    ...
    if (!ea(e11, en) && ea(e11, er)) {
      let r11 = function(e12) {
        let t11, r12, { duration: n7 = 800, bounce: a3 = 0.25, velocity: i3 = 0, mass: o3 = 1 } = e12, s3 = 1 - a3;
        s3 = ee(0.05, 1, s3), n7 = ee(0.01, 10, n7 / 1e3), s3 < 1 ? (t11 = (e13) => {
          let t12 = e13 * s3, r13 = t12 * n7;
          return 1e-3 - (t12 - i3) / et(e13, s3) * Math.exp(-r13);
        }, r12 = (e13) => {
          let r13 = e13 * s3 * n7, a4 = Math.pow(s3, 2) * Math.pow(e13, 2) * n7, o4 = et(Math.pow(e13, 2), s3);
          return (r13 * i3 + i3 - a4) * Math.exp(-r13) * (-t11(e13) + 1e-3 > 0 ? -1 : 1) / o4;
        }) : (t11 = (e13) => -1e-3 + Math.exp(-e13 * n7) * ((e13 - i3) * n7 + 1), r12 = (e13) => n7 * n7 * (i3 - e13) * Math.exp(-e13 * n7));
  ...
  function g2() {
    let e11 = d2 ? -(d2 / 1e3) : 0, t10 = n6 - r10, a3 = c2 / (2 * Math.sqrt(l2 * u2)), o3 = Math.sqrt(l2 / u2) / 1e3;
    if (void 0 === i2 && (i2 = Math.min(Math.abs(n6 - r10) / 100, 0.4)), a3 < 1) {
      let r11 = et(o3, a3);
      p2 = (i3) => n6 - Math.exp(-a3 * o3 * i3) * ((e11 + a3 * o3 * t10) / r11 * Math.sin(r11 * i3) + t10 * Math.cos(r11 * i3)), m2 = (n7) => {
        let i3 = Math.exp(-a3 * o3 * n7);
        return a3 * o3 * i3 * (Math.sin(r11 * n7) * (e11 + a3 * o3 * t10) / r11 + t10 * Math.cos(r11 * n7)) - i3 * (Math.cos(r11 * n7) * (e11 + a3 * o3 * t10) - r11 * t10 * Math.sin(r11 * n7));
      };
    } else if (1 === a3)
      p2 = (r11) => n6 - Math.exp(-o3 * r11) * (t10 + (e11 + o3 * t10) * r11);
    else {
      let r11 = o3 * Math.sqrt(a3 * a3 - 1);
      p2 = (i3) => {
        let s3 = Math.exp(-a3 * o3 * i3), l3 = Math.min(r11 * i3, 300);
        return n6 - s3 * ((e11 + a3 * o3 * t10) * Math.sinh(l3) + r11 * t10 * Math.cosh(l3)) / r11;
      };
    }
  }
  return g2(), { next: (e11) => {
    ...
    if (h2)
      ...
      let r11 = 1e3 * m2(e11), o3 = Math.abs(n6 - t10) <= i2;
      s2.done = Math.abs(r11) <= a2 && o3;
    }
    return s2.value = s2.done ? n6 : t10, s2;
  }, flipTarget: () => {
    d2 = -d2, [r10, n6] = [n6, r10], g2();
  } };
}
ei.needsInterpolation = (e10, t10) => "string" == typeof e10 || "string" == typeof t10;
let eo = (e10) => 0, es = (e10, t10, r10) => {
  let n6 = t10 - e10;
...
function e$(e10) {
  ...
  if (r10 /= 100) {
    ...
    i2 = eT(a3, e11, t10 + 1 / 3), o2 = eT(a3, e11, t10), s2 = eT(a3, e11, t10 - 1 / 3);
  } else
    i2 = o2 = s2 = n6;
...
let eR = (e10, t10, r10) => {
  ...
  let r10 = eI(e10), n6 = eI(t10), a2 = r10.parse(e10), i2 = n6.parse(t10);
  r10 === ex && (a2 = e$(a2), r10 = eM), n6 === ex && (i2 = e$(i2), n6 = eM);
  let o2 = Object.assign({}, a2);
  return (e11) => {
    for (let t11 in o2)
      "alpha" !== t11 && (o2[t11] = eR(a2[t11], i2[t11], e11));
    return o2.alpha = el(a2.alpha, i2.alpha, e11), r10.transform(o2);
  };
...
function ez(e10) {
  let t10 = eO(e10).values, r10 = t10.length, n6 = 0, a2 = 0, i2 = 0;
  for (let e11 = 0; e11 < r10; e11++)
    n6 || "number" == typeof t10[e11] ? n6++ : void 0 !== t10[e11].hue ? i2++ : a2++;
...
function eq(e10, t10) {
  ...
  Q(i2 === t10.length), Q(!n6 || !Array.isArray(n6) || n6.length === i2 - 1), e10[0] > e10[i2 - 1] && (e10 = [].concat(e10), t10 = [].concat(t10), e10.reverse(), t10.reverse());
  let o2 = function(e11, t11, r11) {
    var n7;
    let a3 = [], i3 = r11 || ("number" == typeof (n7 = e11[0]) ? eN : "string" == typeof n7 ? eP.test(n7) ? eL : eW : Array.isArray(n7) ? eE : "object" == typeof n7 ? eH : void 0), o3 = e11.length - 1;
    ...
    return (a3) => {
      ...
      let s3 = es(e11[i3], e11[i3 + 1], a3);
      return t11[i3](s3);
    };
  }(e10, o2);
  return r10 ? (t11) => s2(ee(e10[0], e10[i2 - 1], t11)) : s2;
}
...
let eX = { keyframes: eY, spring: ei, decay: function(e10) {
...
function tr(e10) {
  ...
  return s2 && (null == h2 || h2(), (r10 = l2(function(e11) {
    if (M2 || (e11 = -e11), c2 += e11, !k2) {
      ...
      n6 = e12.value, a2 && (n6 = a2(n6)), k2 = M2 ? e12.done : c2 <= 0;
    }
    if (null == v2 || v2(n6), k2) {
      ...
      return function(e11, t11, r11) {
        ...
        if (Array.isArray(r11))
          ...
          for (var i3 in r11) {
            var o3 = r11[i3];
            if ("object" != typeof o3)
              null != t11 && void 0 !== t11[o3] ? n7 += i3 + "{" + t11[o3] + "}" : tf(o3) && (n7 += th(i3) + ":" + tp(i3, o3) + ";");
            else if (Array.isArray(o3) && "string" == typeof o3[0] && (null == t11 || void 0 === t11[o3[0]]))
              for (var s2 = 0; s2 < o3.length; s2++)
                tf(o3[s2]) && (n7 += th(i3) + ":" + tp(i3, o3[s2]) + ";");
            else {
              var l2 = tm(e11, t11, o3);
              switch (i3) {
                case "animation":
                case "animationName":
                  n7 += th(i3) + ":" + l2 + ";";
...
var tg = /label:\s*([^\s;\n{]+)\s*(;|$)/g, tv = function(e10, t10, r10) {
  ...
  J = void 0;
  var o2 = e10[0];
  null == o2 || void 0 === o2.raw ? (a2 = false, i2 += tm(r10, t10, o2)) : i2 += o2[0];
  for (var s2 = 1; s2 < e10.length; s2++)
    i2 += tm(r10, t10, e10[s2]), a2 && (i2 += o2[s2]);
  tg.lastIndex = 0;
  for (var l2 = ""; null !== (n6 = tg.exec(i2)); )
    l2 += "-" + n6[1];
  ...
  processAll(e10) {
    ...
    if (n6) {
      ...
      _t_.walkStateValues(n6, (r11, n7, a3) => {
        var i3;
        let o2 = `--${this.opt.varPrefix}-state-${n7.join("-")}`, s2 = null !== (i3 = C(n7)) && void 0 !== i3 ? i3 : "", l2 = {};
        this.process(l2, s2, r11, false), e11[o2] = l2[s2], P(t11, [...a3, s2], `var(${o2})`);
...
__publicField(_t_, "convertSelector", (e10) => {
  ...
  if (t10.startsWith("$") || t10.endsWith("$") || t10.startsWith("_")) {
    ...
    if (t10.startsWith("_") ? (e11 = "&", t10 = t10.slice(1)) : t10.startsWith("$") ? (e11 = "& ", t10 = t10.slice(1)) : (r10 = " &", t10 = t10.slice(0, t10.length - 1)), t10.startsWith("data") || t10.startsWith("aria")) {
      ...
      return a2 ? `${e11}[${w(n6)}='${w(a2)}']${r10}` : `${e11}[${w(n6)}]${r10}`;
    }
    if ("&" === e11) {
      if (t10.startsWith("$"))
      ...
      let [r11, n6] = t10.split("__"), a2 = w(r11);
      return n6 ? `${e11}[data-${a2}='${w(n6)}']` : `${e11}[data-${a2}]:not([data-${a2}='false'])`;
    }
  }
});
__publicField(_t_, "walkStateValues", function(e10, t10) {
  ...
  for (let e11 in a2) {
    var i2;
    let o2 = a2[e11], s2 = null !== (i2 = a2.default) && void 0 !== i2 ? i2 : r10.default, l2 = null != n6 ? n6 : k(s2, [...r10.path.slice(1), "$"]), c2 = l2 ? [...r10.selectorPath, l2] : r10.selectorPath, u2 = [...r10.path, e11];
    if (M(o2)) {
...
class tO {
  ...
  static color(e10) {
    return tO.create("var", { value: e10, on: tC(tM.color, tM.bgColor, tM.outlineColor, tM.borderColor, tM.accentColor, tM.fill, tM.stroke), transform: (e11, t10) => S(e11) ? { default: `var(${t10(e11)})`, rgb: `var(${t10(`${e11}/rgb`)})` } : { default: `rgb(${e11[0]}, ${e11[1]}, ${e11[2]})`, rgb: `${e11[0]} ${e11[1]} ${e11[2]}` }, fallback: "" });
  }
  static space(e10) {
  ...
  constructor(e10, { cssVar: t10, transformFallback: r10 }) {
    ...
    _tT.walkValues(e10.value, (n6, a2) => {
      let i2 = a2.join("."), o2 = (n7, a3) => {
        ...
        if (T(i3))
          for (let e11 in i3)
            a3(i3[e11], "default" === e11 ? "" : e11);
        else
          a3(i3, "");
      };
      if (P(this._cssVarRefs, [i2], t10(i2)), M(n6))
        for (let e11 in n6)
          o2(n6[e11], (t11, r11) => {
            P(this._values, [`${i2}${r11 ? `/${r11}` : ""}`, e11], t11);
          });
      else
        o2(n6, (e11, t11) => {
          P(this._values, [`${i2}${t11 ? `/${t11}` : ""}`], e11);
        });
    });
  }
  get tokens() {
...
const _t$ = class _t$ {
  constructor(e10) {
    ...
    _t$.walkValue(e10.value, (e11, t10) => {
      let r10 = t10.join(".");
      P(this._values, [r10], $(e11, "__mixin"));
    });
  }
  get tokens() {
    return D(this._values);
...
let tR = { primary: ["primary"], secondary: ["secondary"], tertiary: ["tertiary"], error: ["error"], warning: ["warning"], success: ["success"], neutral: ["surface", "outline"] }, tA = (e10) => {
  let t10 = k(e10, ["color", "sys"], {});
  return { ...e10, color: { sys: R(tR, (e11) => A(t10, (t11, r10) => I(e11, (e12) => r10.indexOf(e12) > -1))) } };
}, tI = (e10) => (t10) => `rgba(var(${t10}--rgb) / ${e10})`, tL = (e10) => L(e10) && O(e10, "token");
function tF(e10, t10) {
...
const _tj = class _tj {
  constructor(e10, t10 = {}) {
    ...
    __publicField(this, "transformFallback", (e10, t10) => _tj.propsCanBaseDp[e10] && B(t10) ? _tj.propsCanPercent[e10] && 1 > Math.abs(t10) ? `${100 * t10}%` : this.dp(t10) : t10);
        ...
        if (t11.type === tS.var) {
          ...
          for (let t12 of e11.tokens)
            for (let r11 of ["light", "dark"]) {
              ...
              F(i2) || ("_default" === n7 ? P(this.cssVars, [this.cssVar(a2, t12)], i2) : P(this.cssVars, [n7, this.cssVar(a2, t12)], i2));
            }
          continue;
        }
  ...
  toFigmaTokens() {
    let e10 = { space: { dp: { $type: "sizing", $value: 1 } } }, t10 = {}, r10 = {}, n6 = (e11, t11) => T(t11) ? { $type: e11, $value: R(t11, (t12) => n6(e11, t12).$value) } : S(t11) ? { $type: e11, $value: t11.replace(/var\(([^)]+)\)/g, (e12) => {
      var t12, r11;
      let n7 = null !== (r11 = null === (t12 = e12.slice(4, e12.length - 1).slice(`--${this.varPrefix}-`.length).split("--")[0]) || void 0 === t12 ? void 0 : t12.split("__").map((e13, t13) => 0 === t13 ? j(e13) : e13).join(".")) && void 0 !== r11 ? r11 : "";
        ...
        for (let s2 of i2.tokens)
          if (!s2.includes("/")) {
            if (s2.startsWith("sys.")) {
              ...
              tD(e10, [a2, ...s2.split(".")], n6(o3, i2.get(s2, "_default")));
          }
      };
      switch (a2) {
        case "color":
...
let tV = { shadow: tO.shadow({ 0: { _default: "0px 0px 0px rgba(0, 0, 0, 0), 0px 0px 0px 0px rgba(0, 0, 0, 0)", _dark: "0px 0px 0px 0px rgba(0, 0, 0, 0), 0px 0px 0px rgba(0, 0, 0, 0)" }, 1: { _default: "0px 1px 2px rgba(0, 0, 0, 0.3), 0px 1px 3px 1px rgba(0, 0, 0, 0.15)", _dark: "0px 1px 3px 1px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)" }, 2: { _default: "0px 1px 2px rgba(0, 0, 0, 0.3), 0px 2px 6px 2px rgba(0, 0, 0, 0.15)", _dark: "0px 2px 6px 2px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)" }, 3: { _default: "0px 4px 8px 3px rgba(0, 0, 0, 0.15), 0px 1px 3px rgba(0, 0, 0, 0.3)", _dark: "0px 4px 8px 3px rgba(0, 0, 0, 0.15), 0px 1px 3px rgba(0, 0, 0, 0.3)" }, 4: { _default: "0px 6px 10px 4px rgba(0, 0, 0, 0.15), 0px 2px 3px rgba(0, 0, 0, 0.3)", _dark: "0px 6px 10px 4px rgba(0, 0, 0, 0.15), 0px 2px 3px rgba(0, 0, 0, 0.3)" }, 5: { _default: "0px 8px 12px 6px rgba(0, 0, 0, 0.15), 0px 4px 4px rgba(0, 0, 0, 0.3)", _dark: "0px 8px 12px 6px rgba(0, 0, 0, 0.15), 0px 4px 4px rgba(0, 0, 0, 0.3)" } }), elevation: tO.customMixin("elevation", { 0: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "0", _hover: { shadow: "1" } }), 1: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "1", _hover: { shadow: "2" } }), 2: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "2", _hover: { shadow: "3" } }), 3: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "3", _hover: { shadow: "4" } }), 4: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "4", _hover: { shadow: "5" } }) }) }, tE = (e10, t10, r10, n6) => Object.assign(function(e11, t11, r11, n7) {
  ...
  for (let t12 = 0; t12 < 11; ++t12)
    a2[t12] = to(0.1 * t12, e11, r11);
  return (i2) => 0 === i2 || 1 === i2 ? i2 : to(function(t12) {
    let n9 = 0, i3 = 1;
    for (; 10 !== i3 && a2[i3] <= t12; ++i3)
      n9 += 0.1;
    let o2 = n9 + (t12 - a2[--i3]) / (a2[i3 + 1] - a2[i3]) * 0.1, s2 = ts(o2, e11, r11);
    return s2 >= 1e-3 ? function(e12, t13, r12, n10) {
      for (let a3 = 0; a3 < 8; ++a3) {
        let a4 = ts(t13, r12, n10);
        if (0 === a4)
          break;
        let i4 = to(t13, r12, n10) - e12;
        t13 -= i4 / a4;
      }
      return t13;
      ...
      let s3 = 0;
      do
        (i4 = to(o3 = t13 + (r12 - t13) / 2, n10, a3) - e12) > 0 ? r12 = o3 : t13 = o3;
...
class t3 {
  ...
  viewed(e10) {
    let t10 = Math.pow((0 === this.chroma || 0 === this.j ? 0 : this.chroma / Math.sqrt(this.j / 100)) / Math.pow(1.64 - Math.pow(0.29, e10.n), 0.73), 1 / 0.9), r10 = this.hue * Math.PI / 180, n6 = e10.aw * Math.pow(this.j / 100, 1 / e10.c / e10.z), a2 = 5e4 / 13 * (0.25 * (Math.cos(r10 + 2) + 3.8)) * e10.nc * e10.ncb, i2 = n6 / e10.nbb, o2 = Math.sin(r10), s2 = Math.cos(r10), l2 = 23 * (i2 + 0.305) * t10 / (23 * a2 + 11 * t10 * s2 + 108 * t10 * o2), c2 = l2 * s2, u2 = l2 * o2, d2 = (460 * i2 + 451 * c2 + 288 * u2) / 1403, f2 = (460 * i2 - 891 * c2 - 261 * u2) / 1403, h2 = (460 * i2 - 220 * c2 - 6300 * u2) / 1403, p2 = Math.max(0, 27.13 * Math.abs(d2) / (400 - Math.abs(d2))), m2 = tN(d2) * (100 / e10.fl) * Math.pow(p2, 1 / 0.42), g2 = Math.max(0, 27.13 * Math.abs(f2) / (400 - Math.abs(f2))), v2 = tN(f2) * (100 / e10.fl) * Math.pow(g2, 1 / 0.42), b2 = Math.max(0, 27.13 * Math.abs(h2) / (400 - Math.abs(h2))), y2 = tN(h2) * (100 / e10.fl) * Math.pow(b2, 1 / 0.42), x2 = m2 / e10.rgbD[0], w2 = v2 / e10.rgbD[1], k2 = y2 / e10.rgbD[2];
    return function(e11, t11, r11) {
...
class re {
  ...
  constructor(e10, t10, r10, n6, a2, i2, o2, s2) {
    if (this.name = e10, this.palette = t10, this.tone = r10, this.isBackground = n6, this.background = a2, this.secondBackground = i2, this.contrastCurve = o2, this.toneDeltaPair = s2, this.hctCache = /* @__PURE__ */ new Map(), !a2 && i2)
...
const _rp = class _rp {
  ...
  getThemeRoleColors(e10) {
    let t10 = {}, r10 = {};
    for (let i2 in e10) {
      let [o2, s2, l2] = k(e10, [i2], []);
      if (this.seeds[o2]) {
        var n6, a2;
        r10[i2] = rd[s2] ? `${o2}.${s2}` : null === (n6 = this.seeds[o2]) || void 0 === n6 ? void 0 : n6.tone(s2), t10[i2] = rd[l2] ? `${o2}.${l2}` : null === (a2 = this.seeds[o2]) || void 0 === a2 ? void 0 : a2.tone(l2);
      }
    }
    return [t10, r10];
  }
  toDesignTokens() {
    ...
    for (let e11 in t10)
      if (n6[`${e11}`] = { _default: B(t10[e11]) ? rf(t10[e11]) : t10[e11], _dark: B(r10[e11]) ? rf(r10[e11]) : r10[e11] }, rh(e11) && (a2[`${e11}`] = tO.mixin({ bgColor: `sys.${e11}`, color: `sys.on-${e11}` }), a2[`${e11}-container`] = tO.mixin({ bgColor: `sys.${e11}-container`, color: `sys.on-${e11}-container` })), e11.startsWith("surface")) {
    ...
    let i2 = (e11) => Object.keys(rd).reduce((t11, r11) => Object.assign(t11, { [r11]: rf(e11.tone(parseInt(r11))) }), {});
    return { color: tO.color({ ...R(this.seeds, (e11) => i2(e11)), white: [255, 255, 255], black: [0, 0, 0], sys: n6 }), containerStyle: tO.customMixin("containerStyle", { sys: a2 }) };
  }
};
__publicField(_rp, "toHEX", (e10) => `#${rf(e10).map((e11) => E(e11.toString(16), 2, "0")).join("")}`);
...
function rJ(e10, t10, r10, n6, a2, i2, o2, s2, l2, c2, u2) {
  for (var d2 = a2 - 1, f2 = 0 === a2 ? i2 : [""], h2 = f2.length, p2 = 0, m2 = 0, g2 = 0; p2 < n6; ++p2)
    for (var v2 = 0, b2 = rL(e10, d2 + 1, d2 = rD(m2 = o2[p2])), y2 = e10; v2 < h2; ++v2)
...
var r1 = function(e10, t10, r10) {
  ...
  if ("rule" === e10.type && e10.parent && !(e10.length < 1)) {
    ...
    if ((1 !== e10.props.length || 58 === t10.charCodeAt(0) || r5.get(r10)) && !n6) {
      r5.set(e10, true);
      for (var a2 = [], i2 = r4(t10, a2), o2 = r10.props, s2 = 0, l2 = 0; s2 < i2.length; s2++)
        for (var c2 = 0; c2 < o2.length; c2++, l2++)
          e10.props[l2] = a2[s2] ? i2[s2].replace(/&\f/g, o2[c2]) : o2[c2] + " " + i2[s2];
    }
  }
}, r8 = function(e10) {
  if ("decl" === e10.type) {
  ...
  var f2 = (r10 = (t10 = [r3, r8].concat(c2, [r0, (n6 = function(e11) {
    ...
    for (var o3 = "", s3 = 0; s3 < r10; s3++)
      o3 += t10[s3](e11, n7, a3, i3) || "";
    return o3;
  }), h2 = function(e11) {
    var t11, r11;
    return rQ((r11 = function e12(t12, r12, n7, a3, i3, o3, s3, l3, c3) {
      for (var u3, d3 = 0, f3 = 0, h3 = s3, p3 = 0, m2 = 0, g2 = 0, v2 = 1, b2 = 1, y2 = 1, x2 = 0, w2 = "", k2 = i3, M2 = o3, C2 = a3, P2 = w2; b2; )
        switch (g2 = x2, x2 = rU()) {
          case 40:
            ...
            switch (x2) {
              ...
              default:
                if (rB(C2 = rJ(P2, r12, n7, d3, f3, i3, l3, w2, k2 = [], M2 = [], h3), o3), 123 === x2) {
                  if (0 === f3)
                    e12(P2, r12, C2, C2, k2, o3, h3, l3, M2);
                  else
...
let nt = a(() => r9({ key: "css" }), { name: "Cache" }), nr = (e10) => (t10) => {
  ...
  var r10;
  let { slots: n6, expose: a2 } = t10, s2 = rx.use(), l2 = nt.use(), c2 = s2.unstable_css(l2, null !== (r10 = e10.sx) && void 0 !== r10 ? r10 : {}), u2 = () => "0" !== c2.name ? `${l2.key}-${c2.name}` : "", d2 = nr(l2);
  i(() => {
  ...
  return a2({ $$forwardRef: f2 }), () => {
    var t11;
    return y(null !== (t11 = e10.component) && void 0 !== t11 ? t11 : "div", { ref: f2, class: u2(), children: n6 });
  };
}), { displayName: "Box" }), na = (e10, t10) => (r10) => {
  let n6 = {};
  for (let t11 in e10)
    "component" !== t11 && "sx" !== t11 && e10[t11] && (n6[`data-${t11}`] = e10[t11]);
  return y(r10, { ...n6, children: t10.slots });
};
function ni(e10, t10, n6) {
  var a2;
  let o2 = null !== (a2 = L(t10) ? t10 : n6) && void 0 !== a2 ? a2 : na, u2 = M(t10) ? t10 : {};
  return (t11) => {
    let n7 = r({ ...u2, sx: V().optional(), component: V().optional() }, (r10, a3) => {
...
let no = Object.assign(r({ styles: V() }, (e10) => {
  let { styles: t10 } = e10, r10 = rx.use(), n6 = nt.use(), a2 = nr(n6), i2 = r10.unstable_css(n6, S(t10) ? { "&": t10 } : t10);
  return l(() => {
...
let nd = Object.assign(r({ isOpen: H().optional(), style: V().optional(), contentRef: V().optional(), triggerRef: V().optional(), onClickOutside: V(), onEscKeydown: V(), onContentBeforeMount: V(), $transition: V().optional(), $default: V().optional() }, (e10, t10) => {
  var r10;
  let { slots: n6, attrs: a2, emit: i2 } = t10, o2 = e10.contentRef || s(null), l2 = new nu(null !== (r10 = e10.triggerRef) && void 0 !== r10 ? r10 : s(null), o2, () => !!e10.isOpen), u2 = nl.use();
  return d(nc.use().add(l2)), window && f(h(o2, "value"), g((e11) => {
    ...
    var t11;
    let r11 = e10.isOpen ? c(y("div", { ...a2, ref: o2, style: e10.style, children: y(nc, { value: l2, children: null === (t11 = n6.default) || void 0 === t11 ? void 0 : t11.call(n6) }) }), { onVnodeBeforeMount: () => {
      i2("content-before-mount");
    } }) : null;
    return y(p, { to: u2.mountPoint(), children: n6.transition ? n6.transition({ content: r11 }) : r11 });
  };
...
function nI(e10, t10, r10) {
  ...
  t10 && n_(e10) && (a2 = e10.offsetWidth > 0 && n$(n6.width) / e10.offsetWidth || 1, i2 = e10.offsetHeight > 0 && n$(n6.height) / e10.offsetHeight || 1);
  var o2 = (nP(e10) ? nC(e10) : window).visualViewport, s2 = !nA() && r10, l2 = (n6.left + (s2 && o2 ? o2.offsetLeft : 0)) / a2, c2 = (n6.top + (s2 && o2 ? o2.offsetTop : 0)) / i2, u2 = n6.width / a2, d2 = n6.height / i2;
...
function nz(e10) {
  ...
  var $2 = Object.assign({ position: h2 }, m2 && nH), R2 = true === g2 ? (t10 = { x: y2, y: w2 }, r10 = nC(l2), n6 = t10.x, a2 = t10.y, { x: n$(n6 * (i2 = r10.devicePixelRatio || 1)) / i2 || 0, y: n$(a2 * i2) / i2 || 0 }) : { x: y2, y: w2 };
  return (y2 = R2.x, w2 = R2.y, p2) ? Object.assign({}, $2, ((s2 = {})[_2] = C2 ? "0" : "", s2[P2] = M2 ? "0" : "", s2.transform = 1 >= (S2.devicePixelRatio || 1) ? "translate(" + y2 + "px, " + w2 + "px)" : "translate3d(" + y2 + "px, " + w2 + "px, 0)", s2)) : Object.assign({}, $2, ((o2 = {})[_2] = C2 ? w2 + "px" : "", o2[P2] = M2 ? y2 + "px" : "", o2.transform = "", o2));
}
...
function nJ(e10, t10) {
  ...
  }(e10), a2 = n6 === (null == (r10 = e10.ownerDocument) ? void 0 : r10.body), i2 = nC(n6), o2 = a2 ? [i2].concat(i2.visualViewport || [], nK(n6) ? n6 : []) : n6, s2 = t10.concat(o2);
  return a2 ? s2 : s2.concat(nJ(nB(o2)));
}
function nZ(e10) {
...
function nQ(e10, t10, r10) {
  ...
  return t10 === nb ? nZ(function(e11, t11) {
    var r11 = nC(e11), n7 = nF(e11), a3 = r11.visualViewport, i3 = n7.clientWidth, o3 = n7.clientHeight, s3 = 0, l3 = 0;
    if (a3) {
...
function n1(e10, t10) {
  ...
  }, {})), M2 = e10.rects.popper, C2 = e10.elements[void 0 !== y2 && y2 ? b2 === ny ? "reference" : ny : b2], P2 = (r10 = nP(C2) ? C2 : C2.contextElement || nF(e10.elements.popper), n6 = void 0 === m2 ? "clippingParents" : m2, a2 = void 0 === g2 ? nb : g2, l2 = (s2 = [].concat("clippingParents" === n6 ? (i2 = nJ(nB(r10)), nP(o2 = ["absolute", "fixed"].indexOf(nL(r10).position) >= 0 && n_(r10) ? nV(r10) : r10) ? i2.filter(function(e11) {
...
let n2 = { name: "flip", enabled: true, phase: "main", fn: function(e10) {
  ...
  if (!t10.modifiersData[n6]._skip) {
    for (var a2 = r10.mainAxis, i2 = void 0 === a2 || a2, o2 = r10.altAxis, s2 = void 0 === o2 || o2, l2 = r10.fallbackPlacements, c2 = r10.padding, u2 = r10.boundary, d2 = r10.rootBoundary, f2 = r10.altBoundary, h2 = r10.flipVariations, p2 = void 0 === h2 || h2, m2 = r10.allowedAutoPlacements, g2 = t10.options.placement, v2 = nO(g2) === g2, b2 = l2 || (v2 || !p2 ? [nq(g2)] : function(e11) {
      ...
      return e11.concat(nO(r11) === nm ? (a3 = (n7 = { placement: r11, boundary: u2, rootBoundary: d2, padding: c2, flipVariations: p2, allowedAutoPlacements: m2 }).placement, i3 = n7.boundary, o3 = n7.rootBoundary, s3 = n7.padding, l3 = n7.flipVariations, h3 = void 0 === (f3 = n7.allowedAutoPlacements) ? nw : f3, 0 === (b3 = (v3 = (g3 = nE(a3)) ? l3 ? nx : nx.filter(function(e12) {
        return nE(e12) === g3;
      ...
      var A2 = nq(R2), I2 = [];
      if (i2 && I2.push($2[S2] <= 0), s2 && I2.push($2[R2] <= 0, $2[A2] <= 0), I2.every(function(e11) {
        return e11;
      })) {
        C2 = _2, M2 = false;
        break;
...
var n3 = (Y = void 0 === (G = (U = { defaultModifiers: [{ name: "eventListeners", enabled: true, phase: "write", fn: function() {
  ...
  var t10 = e10.state, r10 = e10.instance, n6 = e10.options, a2 = n6.scroll, i2 = void 0 === a2 || a2, o2 = n6.resize, s2 = void 0 === o2 || o2, l2 = nC(t10.elements.popper), c2 = [].concat(t10.scrollParents.reference, t10.scrollParents.popper);
  ...
  var t10 = e10.state, r10 = e10.options, n6 = r10.gpuAcceleration, a2 = r10.adaptive, i2 = r10.roundOffsets, o2 = void 0 === i2 || i2, s2 = { placement: nO(t10.placement), variation: nE(t10.placement), popper: t10.elements.popper, popperRect: t10.rects.popper, gpuAcceleration: void 0 === n6 || n6, isFixed: "fixed" === t10.options.strategy };
  ...
  return Object.assign(t10.elements.popper.style, r10.popper), t10.styles = r10, t10.elements.arrow && Object.assign(t10.elements.arrow.style, r10.arrow), function() {
    Object.keys(t10.elements).forEach(function(e11) {
      ...
      n_(n6) && nM(n6) && (Object.assign(n6.style, i2), Object.keys(a2).forEach(function(e12) {
  ...
  void 0 === r10 && (r10 = K);
  var n6, a2, i2 = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, n4, K), modifiersData: {}, elements: { reference: e10, popper: t10 }, attributes: {}, styles: {} }, o2 = [], s2 = false, l2 = { state: i2, setOptions: function(r11) {
    var n7, a3, s3, u2, d2, f2 = "function" == typeof r11 ? r11(i2.options) : r11;
    c2(), i2.options = Object.assign({}, K, i2.options, f2), i2.scrollParents = { reference: nP(e10) ? nJ(e10) : e10.contextElement ? nJ(e10.contextElement) : [], popper: nJ(t10) };
    var h2 = (a3 = Object.keys(n7 = [].concat(Y, i2.options.modifiers).reduce(function(e11, t11) {
...
let n8 = Object.assign(r({ isOpen: nd.propTypes.isOpen, onClickOutside: nd.propTypes.onClickOutside, placement: V().optional(), modifiers: V().optional(), $transition: nd.propTypes.$transition, $content: V(), $default: V() }, (e10, t10) => {
  let { slots: r10, emit: n6, attrs: a2 } = t10, i2 = s(null), o2 = s(null);
  return v(() => o2.value, (t11) => {
    if (t11 && i2.value) {
      var r11, n7;
      n3(i2.value, t11, { placement: null !== (r11 = e10.placement) && void 0 !== r11 ? r11 : "bottom", modifiers: [...null !== (n7 = e10.modifiers) && void 0 !== n7 ? n7 : [], n2] });
    }
  }), () => {
    var t11, s2;
    ...
    } }), y(nd, { triggerRef: i2, contentRef: o2, isOpen: e10.isOpen, onClickOutside: (e11) => n6("click-outside", e11), style: { zIndex: 100 }, $transition: r10.transition, children: null === (s2 = r10.content) || void 0 === s2 ? void 0 : s2.call(r10) })] }) : null;
  };
