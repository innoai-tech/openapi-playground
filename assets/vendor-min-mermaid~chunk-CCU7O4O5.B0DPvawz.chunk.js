...
function Mr(r, e) {
	...
	return Qr(/* @__PURE__ */ Jr(t, function(o) {
...
function ne(r) {
	...
	}), o = /* @__PURE__ */ Jr(/* @__PURE__ */ Jm(/* @__PURE__ */ bn(/* @__PURE__ */ Jr(n, function(f) {
	...
	function a(f) {
		if (!fm(e, f)) {
			e[f] = !0;
			o[(/* @__PURE__ */ r.node(f)).rank].push(f), Zr(/* @__PURE__ */ r.successors(f), a);
		}
	}
	m$1(a, "dfs");
