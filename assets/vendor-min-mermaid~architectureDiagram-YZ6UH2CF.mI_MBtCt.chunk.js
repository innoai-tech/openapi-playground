...
import { p } from './vendor-min-mermaid~chunk-TYETAW3D._ukrGJe0.chunk.js';
import { d } from './vendor-min-mermaid~chunk-MEBTFSOL.Q9UWSaIn.chunk.js';
import { S as St, y as yt, T as Te } from './vendor-min-mermaid~chunk-2VPXETT4.CFwUPxkR.chunk.js';
...
import { F as Ff, B as Bf, w as wf, v as vf, L as Lf, M as Mf, P as Pl, S as Sf, t as tt, H as Hl, i as ih, p as pl } from './vendor-min-mermaid~chunk-ZKYS2E5M.Cc2x1uDP.chunk.js';
            ...
            var M = {
                ...
                765: (n, i, a)=>{
                    ...
                    R.prototype.newGraphManager = function() {
                        ...
                        var p = /*#__PURE__*/ m$1(function w(U) {
                        ...
                        var X = /*#__PURE__*/ m$1(function(W, V) {
                            ...
                            if ($) {
                                ...
                                lt.forEach(function(st, nt) {
                                    ...
                                    try {
                                        for(var jt = /*#__PURE__*/ st[Symbol.iterator](), ge; !(Kt = (ge = /*#__PURE__*/ jt.next()).done); Kt = !0){
                                            var ie = ge.value;
                    ...
                    var c = /*#__PURE__*/ a(548), t = a(140).CoSELayout, u = a(140).CoSENode, r = a(140).layoutBase.PointD, e = a(140).layoutBase.DimensionD, o = a(140).layoutBase.LayoutConstants, f = a(140).layoutBase.FDLayoutConstants, l = a(140).CoSEConstants, A = /*#__PURE__*/ m$1(function(y, D) {
                        ...
                        var h = /*#__PURE__*/ m$1(function(I) {
                            ...
                            for(var tt = Z.length, B = 0; B < tt; B++){
                                var w = Z[B], U = null;
                                w.intersection(d).length == 0 && (U = /*#__PURE__*/ w.children());
                                ...
                                if (w.outerWidth() != null && w.outerHeight() != null) if (P.randomize) if (!w.isParent()) H = /*#__PURE__*/ I.add(new u(et.graphManager, new r(K[X.get(/*#__PURE__*/ w.id())] - j.w / 2, R[X.get(/*#__PURE__*/ w.id())] - j.h / 2), new e(parseFloat(j.w), parseFloat(j.h))));
                                    ...
                                    var ht = /*#__PURE__*/ c.calcBoundingBox(w, K, R, X);
                                    w.intersection(d).length == 0 ? H = /*#__PURE__*/ I.add(new u(et.graphManager, new r(ht.topLeftX, ht.topLeftY), new e(ht.width, ht.height))) : H = /*#__PURE__*/ I.add(new u(et.graphManager, new r(ht.topLeftX, ht.topLeftY), new e(parseFloat(j.w), parseFloat(j.h))));
                                }
                            ...
                            for(var P = 0, tt = 0, B = 0; B < et.length; B++){
                                ...
                                if (U && H && U !== H && U.getEdgesBetween(H).length == 0) {
                                    ...
                                    j.id = /*#__PURE__*/ w.id(), j.idealLength = /*#__PURE__*/ m(y.idealEdgeLength, w), j.edgeElasticity = /*#__PURE__*/ m(y.edgeElasticity, w), P += j.idealLength, tt++;
                                }
                            }
...
var hr = pl.architecture, vt = new s(()=>({
    ...
    if (vt.records.dataStructures === void 0) {
        let E = {}, M = /*#__PURE__*/ Object.entries(vt.records.nodes).reduce((a, param)=>{
            ...
            [N]: 1
        }, s = /*#__PURE__*/ Object.keys(M).reduce((a, c)=>c === N ? a : {
                ...a,
                [c]: 1
            }, {}), n = /*#__PURE__*/ m$1((a)=>{
            let c = {
...
var ur = /*#__PURE__*/ m$1(async function(E, M) {
        ...
        if (r && (Vt(t) ? v += t === "L" ? -z : z : y += t === "T" ? -z : z + 18), l && (Vt(o) ? C += o === "L" ? -z : z : b += o === "T" ? -z : z + 18), !r && _t.getNode(c)?.type === "junction" && (Vt(t) ? v += t === "L" ? s : -s : y += t === "T" ? s : -s), !l && _t.getNode(e)?.type === "junction" && (Vt(o) ? C += o === "L" ? s : -s : b += o === "T" ? s : -s), a[0]._private.rscratch) {
            ...
            if (A) {
                ...
                if (await Qt$1(J, A, {
                    ...
                    if (h && rr(h)) {
                        let m = /*#__PURE__*/ J.node().getBoundingClientRect(), [d, T] = nr(h);
    ...
    for (let g of N){
        let s = /*#__PURE__*/ M.append("g"), n = /*#__PURE__*/ Gt("iconSize");
        if (g.title) {
...
function Wr(E, M, N) {
    let g = /*#__PURE__*/ m$1((a, c)=>Object.entries(a).reduce((t, param)=>{
            ...
            return t;
        }, {}), "flattenAlignments"), s = /*#__PURE__*/ M.map((a)=>{
        let c = {}, t = {};
...
function Vr(E) {
    let M = [], N = /*#__PURE__*/ m$1((s)=>`${s[0]},${s[1]}`, "posToStr"), g = /*#__PURE__*/ m$1((s)=>s.split(",").map((n)=>parseInt(n)), "strToPos");
    return E.forEach((s)=>{
...
function zr(E, M, N, g, s, param) {
    ...
    return new Promise((a)=>{
        ...
        let u = /*#__PURE__*/ Wr(s, n, i), r = /*#__PURE__*/ Vr(n), e = /*#__PURE__*/ t.layout({
            name: "fcose",
            quality: "proof",
            styleEnabled: false,
            animate: false,
...
var Br = /*#__PURE__*/ m$1(async (E, M, N, g)=>{
    let s = g.db, n = /*#__PURE__*/ s.getServices(), i = /*#__PURE__*/ s.getJunctions(), a = /*#__PURE__*/ s.getGroups(), c = /*#__PURE__*/ s.getEdges(), t = /*#__PURE__*/ s.getDataStructures(), u = /*#__PURE__*/ d(M), r = /*#__PURE__*/ u.append("g");
    ...
    await ur(r, f), await gr(o, f), Ur(s, f), Pl(void 0, u, /*#__PURE__*/ Gt("padding"), /*#__PURE__*/ Gt("useMaxWidth"));
}, "draw"), yr = {
    draw: Br
};
var Ui = {
