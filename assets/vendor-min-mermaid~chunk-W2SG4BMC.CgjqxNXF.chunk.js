...
import { R as Rt, v } from './vendor-min-mermaid~chunk-B4LOWB5X.T-uFuOvQ.chunk.js';
import { n } from './vendor-min-mermaid~chunk-LM6QDVU5.BAO1h6r1.chunk.js';
import { g } from './vendor-min-mermaid~chunk-543QDF6V.CSpQVPcT.chunk.js';
import { R as Rr } from './vendor-min-mermaid~chunk-HXN2J7W2.xQdsu3kt.chunk.js';
import { U as Ut } from './vendor-min-mermaid~chunk-RGZHNYJS.BZGdGDWl.chunk.js';
import { u as ur, A as Ao, E as Eo } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
import { p as pt, i as ia, A as As, $ as $s, V as Vn, K as Kc, J as Jc, Q as Qs, Z as Zs, a as Qc, b as Zc, c as Vc, e as zc, L as Lc, B as Bc } from './vendor-min-mermaid~chunk-BF7QJ6L7.DK9jwCiC.chunk.js';
...
var C = new Map, x = new Map, Jt = /*#__PURE__*/ m$1(()=>{
    ...
    let a = /*#__PURE__*/ Ao(ur().flowchart.htmlLabels), s = await Rr(r, t.label, {
    ...
    if (a) {
        let e = s.children[0], p = /*#__PURE__*/ ia(s);
...
function Y(r, t) {
    ur().flowchart.htmlLabels && r && (r.style.width = t.length * 9 + "px", r.style.height = "12px");
}
m$1(Y, "setTerminalWidth");
var Kt = /*#__PURE__*/ m$1((r, t)=>{
    pt.debug("Moving label abc88 ", r.id, r.label, /*#__PURE__*/ C.get(r.id), t);
    let a = t.updatedPath ? t.updatedPath : t.originalPath, s = /*#__PURE__*/ ur(), { subGraphTitleTotalMargin: l } = n(s);
    if (r.label) {
        let i = /*#__PURE__*/ C.get(r.id), n = r.x, o = r.y;
        if (a) {
            let e = /*#__PURE__*/ Ut.calcLabelPosition(a);
            pt.debug("Moving label " + r.label + " from (", n, ",", o, ") to (", e.x, ",", e.y, ") abc88"), t.updatedPath && (n = e.x, o = e.y);
        }
  ...
  node        : x:${r.x} y:${r.y} w:${r.width} h:${r.height}`);
    ...
    if (Math.abs(l - t.y) * n > Math.abs(s - t.x) * e) {
        ...
        return o === 0 && (m.x = t.x, m.y = t.y), f === 0 && (m.x = t.x), p === 0 && (m.y = t.y), pt.debug(`abc89 top/bottom calc, Q ${p}, q ${c}, R ${f}, r ${o}`, m), m;
    } else {
        a.x < t.x ? o = t.x - n - s : o = s - n - t.x;
        let c = p * o / f, m = a.x < t.x ? a.x + f - o : a.x - f + o, y = a.y < t.y ? a.y + c : a.y - c;
        return pt.debug(`sides calc abc89, Q ${p}, q ${c}, R ${f}, r ${o}`, {
            _x: m,
            _y: y
    ...
    let a = [], s = r[0], l = false;
    return r.forEach((i)=>{
        if (pt.info("abc88 checking point", i, t), !mt(t, i) && !l) {
            let n = /*#__PURE__*/ kt(t, s, i);
            pt.debug("abc88 inside", i, s, n), pt.debug("abc88 intersection", n, t);
            let o = false;
            a.forEach((e)=>{
                o = o || e.x === n.x && e.y === n.y;
            }), a.some((e)=>e.x === n.x && e.y === n.y) ? pt.warn("abc88 no intersect", n, a) : a.push(n), l = true;
        } else pt.warn("abc88 outside", i, s), s = i, l || a.push(i);
...
var lt = /*#__PURE__*/ m$1(function(r, t, a) {
    ...
    for(let s = 0; s < r.length; s++)if (t.includes(s)) {
        ...
        if (Math.abs(i.x - l.x) > 10 && Math.abs(i.y - l.y) >= 10) {
            pt.debug("Corner point fixing", /*#__PURE__*/ Math.abs(i.x - l.x), /*#__PURE__*/ Math.abs(i.y - l.y));
            let y = 5;
            n.x === o.x ? m = {
        ...
        } else pt.debug("Corner point skipping fixing", /*#__PURE__*/ Math.abs(i.x - l.x), /*#__PURE__*/ Math.abs(i.y - l.y));
        a.push(m, e);
    } else a.push(r[s]);
    return a;
}, "fixCorners"), Pt = /*#__PURE__*/ m$1(function(r, t, a, s, l, i, n) {
    let { handDrawnSeed: o } = ur(), e = t.points, p = false, f = l;
    var c = i;
    let m = [];
    for(let b in t.cssCompiledStyles)g(b) || m.push(t.cssCompiledStyles[b]);
    c.intersect && f.intersect && (e = /*#__PURE__*/ e.slice(1, t.points.length - 1), e.unshift(/*#__PURE__*/ f.intersect(e[0])), pt.debug("Last point APA12", t.start, "-->", t.end, e[e.length - 1], c, /*#__PURE__*/ c.intersect(e[e.length - 1])), e.push(/*#__PURE__*/ c.intersect(e[e.length - 1]))), t.toCluster && (pt.info("to cluster abc88", /*#__PURE__*/ a.get(t.toCluster)), e = /*#__PURE__*/ it(t.points, a.get(t.toCluster).node), p = true), t.fromCluster && (pt.debug("from cluster abc88", /*#__PURE__*/ a.get(t.fromCluster), /*#__PURE__*/ JSON.stringify(e, null, 2)), e = /*#__PURE__*/ it(/*#__PURE__*/ e.reverse(), a.get(t.fromCluster).node).reverse(), p = true);
    ...
    let { x: R, y: O } = d(t), ct = /*#__PURE__*/ As().x(R).y(O).curve(k), u;
    switch(t.thickness){
        case "normal":
    ...
    if (t.look === "handDrawn") {
        ...
        u += " transition", g$1 = /*#__PURE__*/ ia($).select("path").attr("id", t.id).attr("class", " " + u + (t.classes ? " " + t.classes : "")).attr("style", w ? w.reduce((v, W)=>v + ";" + W, "") : "");
    ...
    let q = "";
    (ur().flowchart.arrowMarkerAbsolute || ur().state.arrowMarkerAbsolute) && (q = /*#__PURE__*/ Eo(true)), pt.info("arrowTypeStart", t.arrowTypeStart), pt.info("arrowTypeEnd", t.arrowTypeEnd), ot(g$1, t, q, n, s, U);
    let pt$1 = /*#__PURE__*/ Math.floor(e.length / 2), dt = e[pt$1];
