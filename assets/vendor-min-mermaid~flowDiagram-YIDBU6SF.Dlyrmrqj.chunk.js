...
import { V, S } from './vendor-min-mermaid~chunk-E3Q36VHQ.7k1wxTsA.chunk.js';
import { t as tg } from './vendor-min-mermaid~chunk-2BQHA3SY.DoMtHC3O.chunk.js';
import { I as Ie, Y as Ye } from './vendor-min-mermaid~chunk-IIWVAQKY.CwtpAX-Q.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { Z as IC, t as tt, H as Hl, i as ih, v as vf, B as Bf, L as Lf, w as wf, F as Ff, M as Mf, g as gC, S as Sf, _ as zC, a as Su, s as se } from './vendor-min-mermaid~chunk-RAMAZW42.vc82q0BN.chunk.js';
...
` + k + `
        ...
        if (f === void 0 && (f = {
            ...
            styles: [],
            classes: []
        }, this.vertices.set(i, f)), this.vertexCounter++, r !== void 0 ? (this.config = /*#__PURE__*/ Hl(), F = /*#__PURE__*/ this.sanitizeText(/*#__PURE__*/ r.text.trim()), f.labelType = r.type, F.startsWith('"') && F.endsWith('"') && (F = /*#__PURE__*/ F.substring(1, F.length - 1)), f.text = F) : f.text === void 0 && (f.text = i), n !== void 0 && (f.type = n), a?.forEach((m)=>{
            f.styles.push(m);
        }), l?.forEach((m)=>{
            f.classes.push(m);
            ...
            if (u.shape) {
                ...
                if (!tg(u.shape)) throw new Error(`No such shape: ${u.shape}.`);
                f.type = u?.shape;
            }
...
You have to call mermaid.initialize.`);
    ...
    setupToolTips(i) {
        ...
        (r._groups || r)[0][0] === null && (r = /*#__PURE__*/ ih("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), ih(i).select("svg").selectAll("g.node").on("mouseover", (l)=>{
            let g = /*#__PURE__*/ ih(l.currentTarget);
    ...
    clear() {
        ...
        ], this.subGraphs = [], this.subGraphLookup = new Map, this.subCount = 0, this.tooltips = new Map, this.firstGraphFlag = true, this.version = i, this.config = /*#__PURE__*/ Hl(), Sf();
    }
    setGen(i) {
    ...
    addSubGraph(i, r, n) {
        ...
        }, "uniq")(/*#__PURE__*/ r.flat()), k = c.nodeList, u = c.dir, A = Hl().flowchart ?? {};
        if (u = u ?? (A.inheritDir ? this.getDirection() ?? Hl().direction ?? void 0 : void 0), this.version === "gen-1") for(let f = 0; f < k.length; f++)k[f] = /*#__PURE__*/ this.lookUpDomId(k[f]);
    ...
    getData() {
        let i = /*#__PURE__*/ Hl(), r = [], n = [], a = /*#__PURE__*/ this.getSubGraphs(), l = new Map, g = new Map;
...
var k1 = /*#__PURE__*/ m$1(function(s, i) {
    ...
    let { securityLevel: a, flowchart: l, layout: g } = Hl(), c;
    a === "sandbox" && (c = /*#__PURE__*/ ih("#i" + i));
    let k = a === "sandbox" ? c.nodes()[0].contentDocument : document;
    tt.debug("Before getData: ");
    let u = /*#__PURE__*/ n.db.getData();
    tt.debug("Data: ", u);
    let A = /*#__PURE__*/ w(i, a), F = /*#__PURE__*/ n.db.getDirection();
    ...
    Ie.insertTitle(A, "flowchartTitleText", l?.titleTopMargin || 0, /*#__PURE__*/ n.db.getDiagramTitle()), $(A, f, "flowchart", l?.useMaxWidth || false);
    for (let m of u.nodes){
        let S = /*#__PURE__*/ ih(`#${i} [id="${m.id}"]`);
...
var m1 = /*#__PURE__*/ m$1((s, i)=>{
    let r = Su, n = /*#__PURE__*/ r(s, "r"), a = /*#__PURE__*/ r(s, "g"), l = /*#__PURE__*/ r(s, "b");
    return se(n, a, l, i);
