...
var _e, _t, _n;
var e, t, n, r;
import { c as i, I as a, j as l, a as o, r as s, s as d, b as c, d as p, e as u, f as h, T as y, F as f, o as x, t as v, g as m } from "./lib-nodepkg-vuekit.BFTeRu50.chunk.js";
import { o as g, J as b, g as w, S as $, a as k, b as S, r as C, s as O, E } from "./lib-nodepkg-typedef.zwRRER3a.chunk.js";
import { s as N, a as T, P as D, v as A, b as I, B as J } from "./lib-nodepkg-vueuikit.tUPupWmb.chunk.js";
import { I as R, a as _, m as M, b as L, c as P, d as W, e as j } from "./lib-nodepkg-vuematerial.QqnuItX3.chunk.js";
import { O as B, s as z, m as H, f as U, d as F, t as K, E as V, c as X, B as q, S as G } from "./vendor-rxjs.CCKTxAfl.chunk.js";
import { i as Q, g as Y, a as Z, b as ee, s as et, l as en, c as er, d as ei, e as ea } from "./vendor-innoai-tech-lodash.pIS0vKJX.chunk.js";
import { M as el } from "./lib-nodepkg-vuemarkdown.Cag4Km6K.chunk.js";
...
_t = new WeakMap();
let eo = _eo;
let es = i(() => new eo(g(), {})), ed = i(() => ({})), ec = N("span")({ px: 2, pos: "relative", display: "flex", alignItems: "center", gap: 8, visibility: "hidden" }), ep = N("span", (e9, t2) => {
  let { slots: n2 } = t2;
  return (e10) => {
    var _a;
...
let ex = N("div")({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: A("sys.outline-variant", I(0.38)) }), ev = N("div")({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), em = o((e9, t2) => {
  ...
  let { slots: n2, render: r2 } = t2, i2 = eN.use(), a2 = s(es.use().error$, r2((t3) => {
    var _a;
    let r3 = b.create(e9.path), a3 = !e9.viewOnly && !!t3[r3];
...
}()), eP = o((e9, t2) => () => l(em, { $title: "复制当前节点为 JSON 字符串", children: l(eu, { type: "button", onClick: () => eL(JSON.stringify(e9.value, null, 2)), children: l(_, { path: L }) }) }));
class eW extends q {
  static from(e9) {
    let t2 = new eW("");
...
let ez = i(() => new eB()), eH = o((e9, t2) => {
  let n2, { render: r2 } = t2, i2 = x(null), o2 = x(null), c2 = x(null), u2 = ej.from(c2), h2 = eW.from(c2), y2 = ez.use(), f2 = eh.from(c2), m2 = es.use();
  ...
  return (e9.allowRawJSON && s(h2, K((t3) => {
    ...
    return l(eV, { ref: o2, onClick: () => {
      ...
      f2.show();
    }, children: n3 ? l(D, { isOpen: true, placement: "right-start", $content: p(eU, { ref: i2, children: [l(eu, { type: "button", onClick: () => u2.next({ type: "CANCEL" }), children: l(_, { path: P }) }), l(eu, { type: "button", onClick: () => u2.next({ type: "COMMIT" }), children: l(_, { path: W }) })] }), children: l(eF, { children: l("textarea", { ref: c2, rows: 1, value: void 0 == t3 ? "" : `${t3}` }) }) }) : l(eK, { children: JSON.stringify(t3) ?? "undefined" }) });
  }));
  ...
  let { emit: n2 } = t2;
  return () => l(em, { $title: "删除属性", children: l(eu, { type: "button", onClick: () => n2("remove"), children: l(_, { path: j }) }) });
}), eQ = o((e9, t2) => {
  let { render: n2 } = t2, r2 = es.use(), i2 = ed.use();
  return s(e9.value$, n2((t3) => l(eT, { openToken: "{", closeToken: "}", $leading: l(ep, { children: l(eP, { value: t3 }) }), $trailing: l(eY, { ctx: e9.ctx, onAdd: (t4) => {
  ...
  let { emit: n2, render: r2 } = t2, i2 = x(null), o2 = ej.from(i2), c2 = eW.from(i2), u2 = eh.from(i2), h2 = es.use(), y2 = new a({ index: 0 }), f2 = () => {
  ...
  return s(X([c2, u2, y2, e9.options$]), r2((t3) => {
    ...
    return s2 ? s2.length > 0 ? l(eD, { path: e9.ctx.path, children: l(eV, { sx: { mx: -4 }, children: l(ef, { onSelected: (e10) => {
      v2(e10);
    }, open$: u2, $content: l("div", { children: s2.map((e10, t4) => n3 && !e10.propName.includes(n3) ? null : l(eZ, { propName: e10.propName, typedef: e10.typedef, "data-focus": t4 === a2.index % s2.length })) }), children: m2 }) }) }) : null : l(eD, { path: [...e9.ctx.path, $.RecordKey], children: l(eV, { sx: { mx: -4 }, children: l(D, { isOpen: r3, placement: "right-start", $content: p(eU, { children: [l(eu, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: l(_, { path: P }) }), l(eu, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: l(_, { path: W }) })] }), children: l(eF, { children: l("input", { ref: i2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)" }) }) }) }) });
  }));
  ...
  let { render: n2 } = t2, r2 = es.use(), i2 = ed.use();
  return s(e9.value$, n2((t3) => l(eT, { openToken: "[", closeToken: "]", $leading: l(ep, { children: l(eP, { value: t3 }) }), $trailing: l(e2, { ctx: e9.ctx, typedef: e9.typedef, onAdd: (t4) => {
  ...
  let { emit: n2, render: r2 } = t2, i2 = x(null), a2 = eW.from(i2), o2 = ej.from(i2), c2 = eh.from(i2), u2 = es.use(), h2 = () => {
  ...
  let f2 = s(c2, r2((e10) => l(D, { isOpen: e10, placement: "right-start", $content: p(eU, { children: [l(eu, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: l(_, { path: P }) }), l(eu, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: l(_, { path: W }) })] }), children: l(eF, { children: l("input", { ref: i2, type: "text", placeholder: "添加数组项 (可粘贴 JSON 字符串)" }) }) })));
  return () => l(eD, { path: e9.ctx.path, children: l(eV, { sx: { mx: -4 }, children: f2 }) });
}), e8 = o((e9, t2) => {
  let { emit: n2 } = t2;
  return () => l(em, { $title: "移除项", children: l(eu, { type: "button", onClick: () => n2("remove"), children: l(_, { path: j }) }) });
}), e4 = o((e9, t2) => {
  let { render: n2 } = t2, r2 = es.use(), i2 = ed.use();
  return s(e9.value$, n2((t3) => l(eT, { openToken: "{", closeToken: "}", $leading: l(ep, { children: l(eP, { value: t3 }) }), $trailing: l(eY, { ctx: e9.ctx, onAdd: (t4) => {
    r2.update([...e9.ctx.path, t4], void 0);
