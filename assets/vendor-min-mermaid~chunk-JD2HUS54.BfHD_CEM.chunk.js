...
import { u, m, f, p } from './vendor-min-mermaid~chunk-LMGRA235.BXx4trp1.chunk.js';
import { J as Jr, V as Ve$1 } from './vendor-min-mermaid~chunk-TK7VX7YV.CPX48Ryn.chunk.js';
import { J as Je$1, X as Xe$1, S, M as M$1 } from './vendor-min-mermaid~chunk-CRSA2SMT.DrUenSi3.chunk.js';
import { t as tt$1, R as Rf, h as hh, D as De$1, k as kh, I as Il, O as Or, B as ih, C as $f, e as XC, F as ed, G as GC } from './vendor-min-mermaid~chunk-63ZE7VZ5.CfadwiGU.chunk.js';
...
var C = /*#__PURE__*/ m$1(async (l, t, o)=>{
    ...
    let c = await Jr(h, /*#__PURE__*/ De$1(/*#__PURE__*/ Xe$1(s), /*#__PURE__*/ hh()), {
        useHtmlLabels: e,
    ...
    let r = o.useHtmlLabels || Rf(hh()?.flowchart?.htmlLabels), e = /*#__PURE__*/ l.insert("g").attr("class", "label").attr("style", o.labelStyle || ""), a = await Jr(e, /*#__PURE__*/ De$1(/*#__PURE__*/ Xe$1(t), /*#__PURE__*/ hh()), {
        useHtmlLabels: r,
...
async function Ds(l, t, param) {
    ...
    let { shapeSvg: h, bbox: s } = await C(l, t, /*#__PURE__*/ P(t)), c = /*#__PURE__*/ Math.max(s.width + (t.padding ?? 0) * 2, t?.width ?? 0), i = /*#__PURE__*/ Math.max(s.height + (t.padding ?? 0) * 2, t?.height ?? 0), n = -c / 2, p = -i / 2, { cssStyles: m$1 } = t, f = /*#__PURE__*/ v.svg(h), g = /*#__PURE__*/ m(t, {
        fill: o.noteBkgColor,
        stroke: o.noteBorderColor
    });
    t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
    let d = /*#__PURE__*/ f.rectangle(n, p, c, i, g), x = /*#__PURE__*/ h.insert(()=>d, ":first-child");
    return x.attr("class", "basic label-container"), m$1 && t.look !== "handDrawn" && x.selectAll("path").attr("style", m$1), e && t.look !== "handDrawn" && x.selectAll("path").attr("style", e), M(t, x), t.intersect = function(u) {
        return N.rect(t, u);
    }, h;
}
m$1(Ds, "note");
...
async function qt(l, t, o) {
    ...
    let c = await Jr(e, /*#__PURE__*/ ed(/*#__PURE__*/ Xe$1(s)), {
        width: M$1(s, a) + 50,
...
async function mt(l, t, o) {
    let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "";
    if (t === "") return 0;
    let e = /*#__PURE__*/ l.insert("g").attr("class", "label").attr("style", r), a = /*#__PURE__*/ hh(), h = a.htmlLabels ?? true, s = await Jr(e, /*#__PURE__*/ ed(/*#__PURE__*/ Xe$1(t)), {
        width: M$1(t, a) + 50,
        classes: "markdown-node-label",
        useHtmlLabels: h,
        style: r
