import { t as tt } from "./vendor-min-mermaid~chunk-QJLC67TO.Dw34GYds.chunk.js";
...
var Y = /* @__PURE__ */ n((ft, X) => {
  function we(e) {
    ...
    function t(c) {
      ...
      return m$1(d, "debug"), d.namespace = c, d.useColors = /* @__PURE__ */ t.useColors(), d.color = /* @__PURE__ */ t.selectColor(c), d.extend = n2, d.destroy = t.destroy, Object.defineProperty(d, "enabled", {
        enumerable: true,
        configurable: false,
...
function K(e, o) {
  ...
  return m$1(i, "resolve"), (o || Object.keys(t).concat(/* @__PURE__ */ Object.keys(n2))).forEach(i), r;
}
m$1(K, "getIconsTree");
function W(e, o, t) {
  let n2 = e.icons, r = e.aliases || /* @__PURE__ */ Object.create(null), i = {};
  function a(l) {
    i = /* @__PURE__ */ V(n2[l] || r[l], i);
  }
...
function z(e, o, t) {
  ...
  let n2 = /* @__PURE__ */ e.split(ce);
  if (n2 === null || !n2.length) return e;
  let r = [], i = /* @__PURE__ */ n2.shift(), a = /* @__PURE__ */ ae.test(i);
  for (; ; ) {
    if (a) {
      let l = /* @__PURE__ */ parseFloat(i);
      isNaN(l) ? r.push(i) : r.push(Math.ceil(l * o * t) / t);
    } else r.push(i);
    if (i = /* @__PURE__ */ n2.shift(), i === void 0) return r.join("");
    a = !a;
  }
}
m$1(z, "calculateSize");
function fe(e) {
  ...
  for (; n2 >= 0; ) {
    let r = /* @__PURE__ */ e.indexOf(">", n2), i = /* @__PURE__ */ e.indexOf("</" + o);
    if (r === -1 || i === -1) break;
    let a = /* @__PURE__ */ e.indexOf(">", i);
    if (a === -1) break;
    t += /* @__PURE__ */ e.slice(r + 1, i).trim(), e = e.slice(0, n2).trim() + e.slice(a + 1);
  }
  return {
    defs: t,
    content: e
...
function U(e) {
  ...
  let t = [], n2;
  for (; n2 = /* @__PURE__ */ pe.exec(e); ) t.push(n2[1]);
...
var Te = {
  ...
  let r = /* @__PURE__ */ $.get(n2);
  if (!r) {
    let a = /* @__PURE__ */ te.get(n2);
