...
var _a, __, _b, __2;
import { S as Sf, v as vf, B as Bf, w as wf, k as kf, T as Tf, W as Wl, t as tt, r as rh, C as Cf, b as bf, d as dl, aJ as hl, a0 as Os, D as De$1 } from "./vendor-min-mermaid~chunk-OR2G2HG5.D15VT8Rm.chunk.js";
...
var V = /* @__PURE__ */ hl(), qt = (_a = class {
  ...
  getDefaultConfig() {
    ...
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: ((_a2 = dl.quadrantChart) == null ? void 0 : _a2.chartWidth) || 500,
      chartWidth: ((_b2 = dl.quadrantChart) == null ? void 0 : _b2.chartHeight) || 500,
      titlePadding: ((_c = dl.quadrantChart) == null ? void 0 : _c.titlePadding) || 10,
      titleFontSize: ((_d = dl.quadrantChart) == null ? void 0 : _d.titleFontSize) || 20,
      quadrantPadding: ((_e2 = dl.quadrantChart) == null ? void 0 : _e2.quadrantPadding) || 5,
      xAxisLabelPadding: ((_f = dl.quadrantChart) == null ? void 0 : _f.xAxisLabelPadding) || 5,
      yAxisLabelPadding: ((_g = dl.quadrantChart) == null ? void 0 : _g.yAxisLabelPadding) || 5,
      xAxisLabelFontSize: ((_h = dl.quadrantChart) == null ? void 0 : _h.xAxisLabelFontSize) || 16,
      yAxisLabelFontSize: ((_i = dl.quadrantChart) == null ? void 0 : _i.yAxisLabelFontSize) || 16,
      quadrantLabelFontSize: ((_j = dl.quadrantChart) == null ? void 0 : _j.quadrantLabelFontSize) || 16,
      quadrantTextTopPadding: ((_k = dl.quadrantChart) == null ? void 0 : _k.quadrantTextTopPadding) || 5,
      pointTextPadding: ((_l = dl.quadrantChart) == null ? void 0 : _l.pointTextPadding) || 5,
      pointLabelFontSize: ((_m = dl.quadrantChart) == null ? void 0 : _m.pointLabelFontSize) || 12,
      pointRadius: ((_n = dl.quadrantChart) == null ? void 0 : _n.pointRadius) || 5,
      xAxisPosition: ((_o = dl.quadrantChart) == null ? void 0 : _o.xAxisPosition) || "top",
      yAxisPosition: ((_p = dl.quadrantChart) == null ? void 0 : _p.yAxisPosition) || "left",
      quadrantInternalBorderStrokeWidth: ((_q = dl.quadrantChart) == null ? void 0 : _q.quadrantInternalBorderStrokeWidth) || 1,
      quadrantExternalBorderStrokeWidth: ((_r = dl.quadrantChart) == null ? void 0 : _r.quadrantExternalBorderStrokeWidth) || 2
    };
  }
  ...
  getQuadrantPoints(n) {
    let { quadrantSpace: f } = n, { quadrantHeight: u, quadrantLeft: c, quadrantTop: g, quadrantWidth: y } = f, S = /* @__PURE__ */ Os().domain([
      0,
      1
    ]).range([
      c,
      y + c
    ]), i = /* @__PURE__ */ Os().domain([
      0,
      1
    ]).range([
      u + g,
...
var ke = /* @__PURE__ */ Wl();
function j(t) {
  return De$1(/* @__PURE__ */ t.trim(), ke);
}
m$1(j, "textSanitizer");
var E = new qt();
function Se(t) {
...
m$1(ze, "setHeight");
function Ve() {
  let t = /* @__PURE__ */ Wl(), { themeVariables: n, quadrantChart: f } = t;
...
` + t);
  ...
  i === "sandbox" && (A = /* @__PURE__ */ rh("#i" + n));
  let T = /* @__PURE__ */ (i === "sandbox" ? rh(A.nodes()[0].contentDocument.body) : rh("body")).select(`[id="${n}"]`), m = /* @__PURE__ */ T.append("g").attr("class", "main"), b = ((_a2 = S.quadrantChart) == null ? void 0 : _a2.chartWidth) ?? 500, q = ((_b2 = S.quadrantChart) == null ? void 0 : _b2.chartHeight) ?? 500;
  Cf(T, q, b, ((_c = S.quadrantChart) == null ? void 0 : _c.useMaxWidth) ?? true), T.attr("viewBox", "0 0 " + b + " " + q), u.db.setHeight(q), u.db.setWidth(b);
