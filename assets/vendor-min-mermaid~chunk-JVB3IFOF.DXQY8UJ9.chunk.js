...
var je = class r {
    ...
    concat(e) {
        return new r(()=>({
            ...
            let n;
            if (!t.firstDone) {
                do if (n = this.nextFn(t.first), !n.done) return n;
                while (!n.done);
                t.firstDone = true;
            }
            do if (n = t.iterator.next(), !n.done) return n;
            while (!n.done);
            return Ce;
        });
    }
    join() {
        ...
        let t = this.iterator(), n = "", i, s = false;
        do i = t.next(), i.done || (s && (n += e), n += Th(i.value)), s = true;
        while (!i.done);
        return n;
    }
    indexOf(e) {
        let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
        let n = this.iterator(), i = 0, s = n.next();
        for(; !s.done;){
    ...
    forEach(e) {
        let t = this.iterator(), n = 0, i = t.next();
        for(; !i.done;)e(i.value, n), i = t.next(), n++;
    }
    map(e) {
    ...
    filter(e) {
        return new r(this.startFn, (t)=>{
            let n;
            do if (n = this.nextFn(t), !n.done && e(n.value)) return n;
            while (!n.done);
            return Ce;
        });
    }
    ...
    reduce(e, t) {
        let n = this.iterator(), i = t, s = n.next();
        for(; !s.done;)i === void 0 ? i = s.value : i = e(i, s.value), s = n.next();
        return i;
    }
    reduceRight(e, t) {
    ...
    recursiveReduce(e, t, n) {
        let i = e.next();
        if (i.done) return n;
        let s = this.recursiveReduce(e, t, n);
    ...
    flat(e) {
        ...
        return new r(()=>({
            ...
            do {
                ...
                if (!i) if (Ss(s)) n.iterator = s[Symbol.iterator]();
                else return {
                    done: false,
                    value: s
                };
    ...
    distinct(e) {
        return new r(()=>({
            ...
            let n;
            do if (n = this.nextFn(t.internalState), !n.done) {
...
m$1(Ss, "isIterable");
var ei = new je(()=>{}, ()=>Ce), Ce = Object.freeze({
    done: true,
    value: void 0
});
function j() {
    ...
    constructor(e, t, n){
        super(()=>({
            ...
            for(i.pruned && (i.iterators.pop(), i.pruned = false); i.iterators.length > 0;){
                ...
                else return i.iterators.push(t(o.value)[Symbol.iterator]()), o;
            }
            return Ce;
        });
    }
...
function Rh(r, e) {
    ...
    if (r) {
        if (e > 0) {
            let n = e - r.offset, i = r.text.charAt(n);
            t.test(i) || e--;
        }
        return go(r, e);
    }
...
function mo(r, e) {
    if (r) {
        ...
        if (Zn(r)) {
            let n = r.content.findIndex((i)=>!i.hidden);
            for(let i = n - 1; i >= 0; i--){
                let s = r.content[i];
                if (fo(s, e)) return s;
            }
...
function zc(r, e, t) {
    ...
    for(; n <= i;){
        let o = Math.floor((n + i) / 2), l = r.content[o];
...
function qc(r) {
    ...
    for(; r.container;){
        let t = r.container, n = t.content.indexOf(r);
        for(; n > 0;){
            n--;
            let i = t.content[n];
...
function Eh(r) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
    for(; r.container;){
        let t = r.container, n = t.content.indexOf(r), i = t.content.length - 1;
        for(; n < i;){
            n++;
            let s = t.content[n];
...
function Mo(r, e) {
    let t = r.getTypeMetaData(e.$type), n = e;
    for (let i of t.properties)i.defaultValue !== void 0 && n[i.name] === void 0 && (n[i.name] = Yc(i.defaultValue));
}
...
function bo(r, e) {
    ...
    for (let [n, i] of Object.entries(r))if (!n.startsWith("$")) if (le(i)) t[n] = bo(i, e);
    else if (Ee(i)) t[n] = e(t, n, i.$refNode, i.$refText);
    else if (Array.isArray(i)) {
        let s = [];
        for (let o of i)le(o) ? s.push(bo(o, e)) : Ee(o) ? s.push(e(t, n, o.$refNode, o.$refText)) : s.push(o);
        t[n] = s;
    } else t[n] = i;
    return Ds(t), t;
}
...
var Wh = /[0-9a-fA-F]/, Us = /[0-9]/, Vh = /[1-9]/, ar = class {
    ...
    quantifier() {
        ...
        if (!(e === true && t === void 0) && sr(t)) return this.peekChar(0) === "?" ? (this.consumeChar("?"), t.greedy = false) : t.greedy = true, t.type = "Quantifier", t.loc = this.loc(n), t;
    }
    atom() {
        let e, t = this.idx;
    ...
    characterClass() {
        ...
        for(this.consumeChar("["), this.peekChar(0) === "^" && (this.consumeChar("^"), t = true); this.isClassAtom();){
            ...
            if (Do(n) && this.isRangeDash()) {
                ...
                } else Gs(n.value, e), e.push(_("-")), Gs(s.value, e);
            } else Gs(n.value, e);
        }
        return this.consumeChar("]"), {
            type: "Set",
    ...
    function i() {
        ...
        for(m$1(c, "appendOptional"); n < t.length;)switch(t[n]){
            ...
            case "?":
                ...
                break;
            case "{":
                o = /\{\d+,?\d*\}/g, o.lastIndex = n, o = o.exec(t), o ? l(o[0].length) : c(1);
                break;
            case "(":
                if (t[n + 1] === "?") switch(t[n + 2]){
                    ...
                    case "=":
                        ...
                        break;
                    case "!":
                        o = n, n += 3, i(), s += t.substr(o, n - o);
                        break;
                    case "<":
                        switch(t[n + 3]){
                            case "=":
                            case "!":
                                o = n, n += 4, i(), s += t.substr(o, n - o);
                                break;
                            default:
...
function gi(r, e, t) {
    if (!r || !e) return;
    let n = Xo(r, e, r.astNode, true);
    if (n.length !== 0) return t !== void 0 ? t = Math.max(0, Math.min(t, n.length - 1)) : t = 0, n[t];
}
...
function Jo(r, e, t) {
    ...
    let n = Zt(r).iterator(), i, s = [];
    do if (i = n.next(), !i.done) {
        let o = i.value;
...
function nu(r, e, t) {
    ...
    function i(s, o) {
        let l;
        return ir(s, rt) || (l = nu(o, o, t)), t.set(r, l), l;
    }
...
function iu(r) {
    let e = r.$container;
    if (Ut(e)) {
        let t = e.elements, n = t.indexOf(r);
        for(let i = n - 1; i >= 0; i--){
            let s = t[i];
            if (kt(s)) return s;
            {
                let o = dt(t[i]).find(kt);
                if (o) return o;
            }
        }
    }
...
function Yh(r) {
    var e, t, n;
    return He(r) ? (t = (e = r.type) === null || e === void 0 ? void 0 : e.name) !== null && t !== void 0 ? t : "string" : yi(r) ? r.name : (n = yn(r)) !== null && n !== void 0 ? n : r.name;
}
m$1(Yh, "getRuleTypeName");
function Zo(r) {
    var e, t, n;
    return He(r) ? (t = (e = r.type) === null || e === void 0 ? void 0 : e.name) !== null && t !== void 0 ? t : "string" : (n = yn(r)) !== null && n !== void 0 ? n : r.name;
}
m$1(Zo, "getRuleType");
function Tn(r) {
    let e = {
        ...
        i: false,
        u: false
    }, t = xn(r.definition, e), n = Object.entries(e).filter((param)=>{
        let [, i] = param;
        return i;
    }).map((param)=>{
        let [i] = param;
...
function xn(r, e) {
    ...
    if (bs(r)) {
        ...
        if (Lo(r)) return Zh(r);
        if ($o(r)) {
            let t = r.regex.lastIndexOf("/"), n = r.regex.substring(1, t), i = r.regex.substring(t + 1);
            return e && (e.i = i.includes("i"), e.s = i.includes("s"), e.u = i.includes("u")), It(n, {
                cardinality: r.cardinality,
                lookahead: r.lookahead,
                wrap: false
            });
...
function tl(r) {
    let e = [], t = r.Grammar;
    for (let n of t.rules)He(n) && zo(n) && Bo(Tn(n)) && e.push(n.name);
    return {
...
function ip(r) {
    ...
    for(; i && o;)s = t[n], o = cr(s), e = e.concat(ur(s)), n = n + 1, i = t.length > n;
    return mp$1(e);
}
...
var il = class extends Nt {
    ...
    walkTerminal(e, t, n) {}
    walkProdRef(e, t, n) {
        let i = op(e.referencedRule, e.idx) + this.topProd.name, s = t.concat(n), o = new J({
            definition: s
        }), l = ur(o);
        this.follows[i] = l;
    }
                        ...
                        Zr$1(o.value, (c)=>{
                            if (typeof c == "number") zs(c, e, t);
                                ...
                                if (t === true) for(let d = u.from; d <= u.to; d++)zs(d, e, t);
                                    ...
                                    if (u.to >= vn) {
                                        let d = u.from >= vn ? u.from : vn, f = u.to, h = ht(d), p = ht(f);
...
function cp(r, e) {
    let t = String.fromCharCode(r), n = t.toUpperCase();
    if (n !== t) {
        let i = ht(n.charCodeAt(0));
        e[i] = i;
    } else {
        let i = t.toLowerCase();
        if (i !== t) {
...
`
    ...
    let o, l, c, u, d;
    t("misc mapping", ()=>{
        o = Jr$1(n, (A)=>A.tokenTypeIdx), l = Jr$1(n, (A)=>{
            let x = A.GROUP;
            if (x !== se.SKIPPED) {
                if (pr$1(x)) return x;
        ...
        }), u = Jr$1(n, (A)=>A.PUSH_MODE), d = Jr$1(n, (A)=>fm$1(A, "POP_MODE"));
    });
    let f;
    t("Line Terminator Handling", ()=>{
        let A = vu(e.lineTerminatorCharacters);
        f = Jr$1(n, (x)=>false), e.positionTracking !== "onlyOffset" && (f = Jr$1(n, (x)=>fm$1(x, "LINE_BREAKS") ? !!x.LINE_BREAKS : Au(x, A) === false && qs(A, x.PATTERN)));
    });
    let h, p, g, y;
    t("Misc Mapping #2", ()=>{
        h = Jr$1(n, Ru), p = Jr$1(s, Ip), g = Rn$1(n, (A, x)=>{
            let P = x.GROUP;
        ...
        R = Rn$1(n, (A, x, P)=>{
            if (typeof x.PATTERN == "string") {
                ...
                Zr$1(x.START_CHARS_HINT, (Te)=>{
                    let kr = typeof Te == "string" ? Te.charCodeAt(0) : Te, Ae = ht(kr);
...
function xp(r) {
    let e = [], t = Jr$1(r, (s)=>Rn$1(r, (o, l)=>(s.PATTERN.source === l.PATTERN.source && !pm$1(e, l) && l.PATTERN !== se.NA && (e.push(l), o.push(l)), o), []));
    t = Ai$1(t);
    let n = fn$1(t, (s)=>s.length > 1);
    return Jr$1(n, (s)=>{
        let o = Jr$1(s, (c)=>c.name);
        return {
...
function Tu(r, e, t) {
    let n = [], i = false, s = Ai$1(Qr$1(Xr$1(r.modes))), o = Qm(s, (c)=>c[dr] === se.NA), l = vu(t);
    return e && Zr$1(o, (c)=>{
        let u = Au(c, l);
        if (u !== false) {
            let f = {
...
function Cp(r) {
    let e = _f$1(r), t = r, n = true;
    for(; n;){
        t = Ai$1(Qr$1(Jr$1(t, (s)=>s.CATEGORIES)));
        let i = Ri$1(t, e);
        e = e.concat(i), Cr$1(i) ? n = false : t = i;
    }
    return e;
}
            ...
            if (Zr$1(i.modes, (l, c)=>{
                this.TRACE_INIT(`Mode: <${c}> processing`, ()=>{
                    if (this.modes.push(c), this.config.skipValidations === false && this.TRACE_INIT("validatePatterns", ()=>{
                        this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(gu(l, o));
...
` + i);
    ...
    tokenizeInternal(e, t) {
        let n, i, s, o, l, c, u, d, f, h, p, g, y, R, A, x = e, P = x.length, b = 0, Te = 0, kr = this.hasCustom ? 0 : Math.floor(e.length / 10), Ae = new Array(kr), Mt = [], yt = this.trackStartLines ? 1 : void 0, k = this.trackStartLines ? 1 : void 0, T = xu(this.emptyGroups), C = this.trackStartLines, S = this.config.lineTerminatorsPattern, K = 0, O = [], L = [], Le = [], Oe = [];
        Object.freeze(Oe);
        let ee;
        function Ht() {
            return O;
        ...
        for(; b < P;){
            ...
            for(n = 0; n < Ir; n++){
                ...
                u = null;
                let Tt = Ze.short;
                if (Tt !== false ? ve === Tt && (c = Ve) : Ze.isCustom === true ? (A = Ve.exec(x, b, Ae, T), A !== null ? (c = A[0], A.payload !== void 0 && (u = A.payload)) : c = null) : (this.updateLastIndex(Ve, b), c = this.match(Ve, e, b)), c !== null) {
                    if (l = Ze.longerAlt, l !== void 0) {
                        let Dt = l.length;
                        for(s = 0; s < Dt; s++){
                            let xt = O[l[s]], zt = xt.pattern;
                            if (d = null, xt.isCustom === true ? (A = zt.exec(x, b, Ae, T), A !== null ? (o = A[0], A.payload !== void 0 && (d = A.payload)) : o = null) : (this.updateLastIndex(zt, b), o = this.match(zt, e, b)), o && o.length > c.length) {
                                c = o, u = d, Ze = xt;
                                break;
                            }
                        }
            ...
            if (c !== null) {
                if (f = c.length, h = Ze.group, h !== void 0 && (p = Ze.tokenTypeIdx, g = this.createTokenInstance(c, b, p, Ze.tokenType, yt, k, f), this.handlePayload(g, u), h === false ? Te = this.addToken(Ae, Te, g) : T[h].push(g)), e = this.chopInput(e, f), b = b + f, k = this.computeNewColumn(k, f), C === true && Ze.canLineTerminator === true) {
                    let Ve = 0, Tt, Dt;
                    S.lastIndex = 0;
                    do Tt = S.test(c), Tt === true && (Dt = S.lastIndex - 1, Ve++);
                    while (Tt === true);
...
but found: '` + De$1(e).image + "'";
        if (n) return s + n + l;
        {
            let c = Rn$1(r, (h, p)=>h.concat(p), []), u = Jr$1(c, (h)=>`[${Jr$1(h, (p)=>$t(p)).join(", ")}]`), f = `one of these possible Token sequences:
...
inside top level rule: ->` + r.name + "<-";
    ...
    buildDuplicateFoundError (r, e) {
        ...
        let n = r.name, i = De$1(e), s = i.idx, o = We(i), l = t(i), c = s > 0, u = `->${o}${c ? s : ""}<- ${l ? `with argument: ->${l}<-` : ""}
...
For Further details.`;
    ...
    buildAlternationAmbiguityError (r) {
        let e = Jr$1(r.prefixPath, (i)=>$t(i)).join(", "), t = r.alternation.idx === 0 ? "" : r.alternation.idx, n = `Ambiguous Alternatives Detected: <${r.ambiguityIndices.join(" ,")}> in <OR${t}> inside <${r.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
...
<OR${r.alternation.idx}> inside <${r.topLevelRule.name}> Rule.
 has ${r.alternation.definition.length + 1} alternatives.`;
    ...
    buildLeftRecursionError (r) {
        let e = r.topLevelRule.name, t = Jr$1(r.leftRecursionPath, (s)=>s.name), n = `${e} --> ${t.concat([
            e
        ]).join(" --> ")}`;
...
function ea(r, e) {
    ...
    for(m$1(o, "getAlternativesForProd"); t.length < e && i < r.length;){
        ...
        if (l instanceof z) n = o(l.definition);
            ...
            if (l instanceof X) return Zr$1(l.definition, (c)=>{
                Cr$1(c.definition) === false && (n = o(c.definition));
            }), n;
...
function ta(r, e, t, n) {
    ...
    for(f.push({
        ...
        if (R === i) {
            ...
            let P = {
                idx: g,
                def: R.definition.concat(s, Mi$1(p)),
                ruleStack: A,
                occurrenceStack: x
            };
            f.push(P);
            ...
            let x = {
                idx: g,
                def: R.definition.concat(Mi$1(p)),
                ruleStack: y,
                occurrenceStack: v
            };
            f.push(x);
            ...
            let x = R.definition[A], P = {
                idx: g,
                def: x.definition.concat(Mi$1(p)),
                ruleStack: y,
                occurrenceStack: v
            };
            f.push(P), f.push(o);
...
function Wu(r, e, t, n) {
    ...
    if (s && !n) {
        let o = Jr$1(r, (c)=>Qr$1(c)), l = Rn$1(o, (c, u, d)=>(Zr$1(u, (f)=>{
...
function Vu(r, e, t) {
    let n = Ui$1(r, (s)=>s.length === 1), i = r.length;
    if (n && !t) {
        let s = Qr$1(r);
        if (s.length === 1 && Cr$1(s[0].categoryMatches)) {
            ...
            let o = Rn$1(s, (l, c, u)=>(l[c.tokenTypeIdx] = true, Zr$1(c.categoryMatches, (d)=>{
                    l[d] = true;
                }), l), []);
            return function() {
                let l = this.LA(1);
...
var ml = class extends Nt {
    ...
    checkIsTarget(e, t, n, i) {
        return e.idx === this.targetOccurrence && this.targetProdType === t ? (this.restDef = n.concat(i), true) : false;
    }
    walkOption(e, t, n) {
    ...
    for(let o = 1; o <= e; o++){
        ...
        for(let c = 0; c < l.length; c++){
            ...
            for(let d = 0; d < u.length; d++){
                let f = u[d].partialPath, h = u[d].suffixDef, p = pl(f);
...
function qu(r, e, t, n) {
    let i = zi$1(r, (c)=>Fp(c, t)), s = Kp(r, e, t), o = zi$1(r, (c)=>Bp(c, t)), l = zi$1(r, (c)=>Up(c, r, n, t));
...
function Fp(r, e) {
    let t = new gl;
    r.accept(t);
    let n = t.allProductions, i = Vi$1(n, Gp), s = Tm$1(i, (l)=>l.length > 1);
...
function Qu(r, e, t) {
    ...
    return i = Qm(i, (o)=>o.ignoreAmbiguities === true), zi$1(i, (o)=>{
        let l = o.idx, c = o.maxLookahead || e, u = Cn(l, r, c, o), d = Wp(u, o, r, t), f = Vp(u, o, r, t);
        return d.concat(f);
    });
}
...
function Zu(r, e, t) {
    ...
    return Zr$1(r, (i)=>{
        ...
        Zr$1(o, (l)=>{
            let c = Si(l), u = l.maxLookahead || e, d = l.idx, h = $n(d, i, c, u)[0];
            if (Cr$1(Qr$1(h))) {
                let p = t.buildEmptyRepetitionError({
                    topLevelRule: i,
                    repetition: l
                });
                n.push({
...
function Vp(r, e, t, n) {
    ...
    return Ai$1(zi$1(i, (o)=>{
        if (e.definition[o.idx].ignoreAmbiguities === true) return [];
        let c = o.idx, u = o.path, d = fn$1(i, (h)=>e.definition[h.idx].ignoreAmbiguities !== true && h.idx < c && ju(h.path, u));
        return Jr$1(d, (h)=>{
            let p = [
                h.idx + 1,
                c + 1
...
var xl = {}, El = "InRuleRecoveryException", Rl = class extends Error {
    ...
    tryInRepetitionRecovery(e, t, n, i) {
        let s = this.findReSyncTokenType(), o = this.exportLexerState(), l = [], c = false, u = this.LA(1), d = this.LA(1), f = m$1(()=>{
            let h = this.LA(0), p = this.errorMessageProvider.buildMismatchTokenMessage({
                expected: i,
                actual: u,
                previous: h,
    ...
    shouldInRepetitionRecoveryBeTried(e, t, n) {
        return !(n === false || this.tokenMatcher(this.LA(1), e) || this.isBackTracking() || this.canPerformInRuleRecovery(e, this.getFollowsForInRuleRecovery(e, t)));
    }
    ...
    isInCurrentRuleReSyncSet(e) {
        let t = this.getCurrFollowKey(), n = this.getFollowSetFromFollowKey(t);
        return pm$1(n, e);
    }
    findReSyncTokenType() {
    ...
    reSyncTo(e) {
        let t = [], n = this.LA(1);
        for(; this.tokenMatcher(n, e) === false;)n = this.SKIP_TOKEN(), this.addToResyncTokens(n, t);
        return _i$1(t);
    }
    attemptInRepetitionRecovery(e, t, n, i, s, o, l) {}
    getCurrentGrammarPath(e, t) {
        let n = this.getHumanReadableRuleStack(), i = _f$1(this.RULE_OCCURRENCE_STACK);
        return {
            ruleStack: n,
            occurrenceStack: i,
            lastTok: e,
...
function jp(r, e, t, n, i, s, o) {
    let l = this.getKeyForAutomaticLookahead(n, i), c = this.firstAfterRepMap[l];
    if (c === void 0) {
        let h = this.getCurrRuleFullName(), p = this.getGAstProductions()[h];
        c = new s(p, i).startWalking(), this.firstAfterRepMap[l] = c;
    }
...
var Lt = class {
    ...
    validate(e) {
        ...
        if (Cr$1(t)) {
            let n = this.validateEmptyOrAlternatives(e.rules), i = this.validateAmbiguousAlternationAlternatives(e.rules, this.maxLookahead), s = this.validateSomeNonEmptyLookaheadPath(e.rules, this.maxLookahead);
            return [
                ...t,
                ...n,
                ...i,
            ...
            this.TRACE_INIT(`${t.name} Rule Lookahead`, ()=>{
                ...
                Zr$1(n, (u)=>{
                    ...
                    this.TRACE_INIT(`${We(u)}${d}`, ()=>{
                        ...
                        }), h = oa(this.fullRuleNameToShort[t.name], 256, u.idx);
    ...
    computeLookaheadFunc(e, t, n, i, s, o) {
        this.TRACE_INIT(`${o}${t === 0 ? "" : t}`, ()=>{
            let l = this.lookaheadStrategy.buildLookaheadForOptional({
                ...
                dynamicTokensEnabled: this.dynamicTokensEnabled,
                prodType: i
            }), c = oa(this.fullRuleNameToShort[e.name], n, t);
...
m$1(qp, "defaultVisit");
function cd(r, e) {
    let t = m$1(function() {}, "derivedConstructor");
...
function ud(r, e, t) {
    let n = m$1(function() {}, "derivedConstructor");
...
function Yp(r, e) {
    let t = fn$1(e, (i)=>T(r[i]) === false), n = Jr$1(t, (i)=>({
...
var ga = class {
	...
	For Further details.`);
        ...
        if (N(e)) this.tokensMap = Rn$1(e, (s, o)=>(s[o.name] = o, s), {});
        else if (fm$1(e, "modes") && Ui$1(Qr$1(Xr$1(e.modes)), Cu)) {
            let s = Qr$1(Xr$1(e.modes)), o = mp$1(s);
            this.tokensMap = Rn$1(o, (l, c)=>(l[c.name] = c, l), {});
        ...
        let n = fm$1(e, "modes") ? Qr$1(Xr$1(e.modes)) : Xr$1(e), i = Ui$1(n, (s)=>Cr$1(s.categoryMatches));
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    ...
    invokeRuleCatch(e, t, n) {
        ...
        if (Wt(e)) {
            ...
            if (s) {
                ...
                if (this.isInCurrentRuleReSyncSet(l)) if (o.resyncedTokens = this.reSyncTo(l), this.outputCst) {
    ...
    optionInternalLogic(e, t, n) {
        ...
        if (typeof e != "function") {
            ...
            if (o !== void 0) {
                let l = i;
                i = m$1(()=>o.call(this) && l.call(this), "lookAheadFunc");
            }
        } else s = e;
    ...
    atLeastOneInternalLogic(e, t, n) {
        ...
        if (i.call(this) === true) {
            ...
            for(; i.call(this) === true && o === true;)o = this.doSingleRepetition(s);
    ...
    orInternal(e, t) {
        let n = this.getKeyForAutomaticLookahead(256, t), i = N(e) ? e : e.DEF, o = this.getLaFuncFromCache(n).call(this, i);
    ...
    subruleInternal(e, t, n) {
        ...
        try {
            ...
            return this.subruleIdx = t, i = e.apply(this, s), this.cstPostNonTerminal(i, n !== void 0 && n.LABEL !== void 0 ? n.LABEL : e.ruleName), i;
        } catch (s) {
...
var ya = class {
    ...
    raiseNoAltException(e, t) {
        let n = this.getCurrRuleFullName(), i = this.getGAstProductions()[n], s = Cn(e, i, this.maxLookahead), o = [];
...
var Qp = {
 ...
 inside top level rule: <${this.recordingProdStack[0].name}>`);
        ...
        let i = Df(this.recordingProdStack), s = e.ruleName, o = new H({
            idx: t,
            nonTerminalName: s,
            label: n?.LABEL,
...
function Oi(r, e, t) {
    ...
    Ra(t);
    let i = Df(this.recordingProdStack), s = T(e) ? e : e.DEF, o = new r({
        definition: [],
        idx: t
    });
...
var Fe = Object.freeze({
    ...
    recoveryValueFunc: m$1(()=>{}, "recoveryValueFunc"),
    resyncEnabled: true
}), ye;
(function(r) {
...
var Pi = class r {
    ...
    performSelfAnalysis() {
        this.TRACE_INIT("performSelfAnalysis", ()=>{
            ...
            })), !r.DEFER_DEFINITION_ERRORS_HANDLING && !Cr$1(this.definitionErrors)) throw e = Jr$1(this.definitionErrors, (i)=>i.message), new Error(`Parser Definition Errors detected:
 ${e.join(`
-------------------------------
`)}`);
        });
...
function lm(r, e, t) {
    ...
    Kt(r, n);
    let i = Mn(r, e, n, t, pr(r, e, t)), s = _l(r, e, t.separator, t);
    return vd(r, e, t, i, s);
}
...
function dm(r, e, t) {
    ...
    Kt(r, n);
    let i = Jr$1(t.definition, (o)=>Ed(r, e, o));
    return Mn(r, e, n, t, ...i);
}
m$1(dm, "alternation");
function fm(r, e, t) {
...
m$1(fm, "option");
function pr(r, e, t) {
    let n = fn$1(Jr$1(t.definition, (i)=>Ed(r, e, i)), (i)=>i !== void 0);
    return n.length === 1 ? n[0] : n.length === 0 ? void 0 : mm(r, n);
}
m$1(pr, "block");
function Ad(r, e, t, n, i) {
    let s = n.left, o = n.right, l = xe(r, e, t, {
        type: sm
    });
    Kt(r, l);
    let c = xe(r, e, t, {
...
function Mn(r, e, t, n) {
    ...
    return r.decisionMap[hr(e, pm(n), n.idx)] = t, o;
}
m$1(Mn, "makeAlts");
function pm(r) {
...
m$1(_l, "tokenRef");
function gm(r, e, t) {
    let n = t.referencedRule, i = r.ruleToStartState.get(n), s = xe(r, e, t, {
        type: Vt
    }), o = xe(r, e, t, {
        type: Vt
    }), l = new Pn(i, n, o);
...
m$1(gm, "ruleRef");
function ym(r, e, t) {
    let n = r.ruleToStartState.get(e);
    me(n, t.left);
...
var ka = class {
    ...
    buildLookaheadForAlternation(e) {
        let { prodOccurrence: t, rule: n, hasPredicates: i, dynamicTokensEnabled: s } = e, o = this.dfas, l = this.logging, c = hr(n, "Alternation", t), d = this.atn.decisionMap[c].decision, f = Jr$1(na({
            maxLookahead: 1,
            occurrence: t,
        ...
        if (Id(f, false) && !s) {
            ...
            return i ? function(p) {
                var g;
                let y = this.LA(1), v = h[y.tokenTypeIdx];
            ...
            let y = Ol.call(this, o, d, p, l);
            return typeof y == "number" ? y : void 0;
        } : function() {
            let h = Ol.call(this, o, d, kd, l);
            return typeof h == "number" ? h : void 0;
        };
    }
    buildLookaheadForOptional(e) {
        let { prodOccurrence: t, rule: n, prodType: i, dynamicTokensEnabled: s } = e, o = this.dfas, l = this.logging, c = hr(n, i, t), d = this.atn.decisionMap[c].decision, f = Jr$1(na({
            maxLookahead: 1,
            occurrence: t,
            prodType: i,
            rule: n
        ...
        if (Id(f) && f[0][0] && !s) {
            ...
            if (p.length === 1 && Cr$1(p[0].categoryMatches)) {
                ...
                let g = Rn$1(p, (y, v)=>(v !== void 0 && (y[v.tokenTypeIdx] = true, Zr$1(v.categoryMatches, (R)=>{
                        y[R] = true;
                    })), y), {});
                return function() {
                    let y = this.LA(1);
...
function Rm(r) {
    ...
    for(let n = 0; n < e; n++)t[n] = xm(r.decisionStates[n], n);
    return t;
}
...
function Em(r, e, t, n) {
    ...
    for(;;){
        ...
        i = c, o.push(l), l = this.LA(s++);
    }
}
m$1(Em, "performLookahead");
function Am(r, e, t, n, i, s) {
    let o = Cm(e.configs, t, i);
...
function vm(r, e, t, n) {
    ...
    let s = r.atnStartState, o = s.rule, l = s.production, c = km({
        topLevelRule: o,
        ambiguityIndices: t,
        production: l,
        prefixPath: i
...
function km(r) {
    let e = Jr$1(r.prefixPath, (i)=>$t(i)).join(", "), t = r.production.idx === 0 ? "" : r.production.idx, n = `Ambiguous Alternatives Detected: <${r.ambiguityIndices.join(", ")}> in <${Im(r.production)}${t}> inside <${r.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
    return n = n + `See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES
For Further details.`, n;
...
function Nm(r, e, t) {
    let n = zi$1(e.configs.elements, (s)=>s.state.transitions), i = s0(n.filter((s)=>s instanceof On).map((s)=>s.tokenType), (s)=>s.tokenTypeIdx);
    return {
        actualToken: t,
...
function Cm(r, e, t) {
    ...
    for (let o of r.elements){
        ...
        for(let c = 0; c < l; c++){
            let u = o.state.transitions[c], d = $m(u, e);
            d !== void 0 && n.add({
                state: d,
                alt: o.alt,
                stack: o.stack
...
m$1(Sd, "newDFAState");
function Nd(r, e, t, n) {
    return n = Cd(r, n), e.edges[t.tokenTypeIdx] = n, n;
}
m$1(Nd, "addDFAEdge");
function Cd(r, e) {
    if (e === Fi) return e;
...
function Ia(r, e) {
    ...
    for(let i = 0; i < n; i++){
        let s = t.transitions[i], o = Lm(r, s);
        o !== void 0 && Ia(o, e);
    }
}
m$1(Ia, "closure");
...
var wf = "\u200B", Lf = m$1((r)=>r.endsWith(wf) ? r : r + wf, "withRuleSuffix"), Vi = class {
    ...
    rule(e, t) {
        let n = this.computeRuleType(e), i = this.wrapper.DEFINE_RULE(Lf(e.name), this.startImplementation(n, t).bind(this));
    ...
    consume(e, t, n) {
        ...
        if (!this.isRecording() && this.isValidToken(i)) {
            ...
            let o = this.nodeBuilder.buildLeafNode(i, n), { assignment: l, isCrossRef: c } = this.getAssignment(n), u = this.current;
            if (l) {
                let d = Ye(n) ? i.image : this.converter.convert(i.image, o);
                this.assign(l.operator, l.feature, d, o, c);
            } else if (Xl(u)) {
                let d = i.image;
                Ye(n) || (d = this.converter.convert(d, o).toString()), u.value += d;
            }
        }
    }
    isValidToken(e) {
    ...
    performSubruleAssignment(e, t, n) {
        ...
        if (i) this.assign(i.operator, i.feature, e, n, s);
            ...
            let o = this.current;
            if (Xl(o)) o.value += e.toString();
            else if (typeof e == "object" && e) {
                let c = this.assignWithoutOverride(e, o);
    ...
    assign(e, t, n, i, s) {
        ...
        switch(s && typeof n == "string" ? l = this.linker.buildReference(o, t, i, n) : l = n, e){
            case "=":
                {
                    o[t] = l;
                    break;
    ...
    rule(e, t) {
        let n = this.wrapper.DEFINE_RULE(Lf(e.name), this.startImplementation(t).bind(this));
...
m$1(Hi, "createParser");
function Um(r, e) {
    let t = mi(e, false), n = j(e.rules).filter($e).filter((i)=>t.has(i));
    for (let i of n){
...
function yr(r, e) {
    ...
    let n;
    if (Ye(e)) n = zm(r, e);
    else if (kt(e)) n = Bm(r, e);
    else if (rt(e)) n = yr(r, e.terminal);
    else if (nr(e)) n = Of(r, e);
    else if (nt(e)) n = Wm(r, e);
    else if (Ps(e)) n = Km(r, e);
    else if (Ms(e)) n = jm(r, e);
    else if (Ut(e)) n = Hm(r, e);
    else if (So(e)) {
        let i = r.consume++;
        n = m$1(()=>r.parser.consume(i, qe, e), "method");
...
function Wm(r, e) {
    ...
    if ($e(t)) {
        ...
        return (o)=>r.parser.subrule(n, bf(r, t), i, e, s(o));
    } else if (He(t)) {
        let n = r.consume++, i = Jl(r, t.name);
...
function Km(r, e) {
    if (e.elements.length === 1) return yr(r, e.elements[0]);
    {
        ...
        for (let i of e.elements){
            ...
            o && (s.GATE = Ot(o)), t.push(s);
        }
        let n = r.or++;
        return (i)=>r.parser.alternatives(n, t.map((s)=>{
                let o = {
                    ALT: m$1(()=>s.ALT(i), "ALT")
                }, l = s.GATE;
...
function jm(r, e) {
    ...
    let n = r.or++, i = m$1((l, c)=>{
        let u = c.getRuleStack().join("-");
        return `uGroup_${l}_${u}`;
    }, "idFunc"), s = m$1((l)=>r.parser.alternatives(n, t.map((c, u)=>{
            let d = {
                ALT: m$1(()=>true, "ALT")
            }, f = r.parser;
            d.ALT = ()=>{
                if (c.ALT(l), !f.isRecording()) {
                    ...
                    let g = f.unorderedGroups.get(p);
                    typeof g?.[u] > "u" && (g[u] = true);
                }
            };
            let h = c.GATE;
            return h ? d.GATE = ()=>h(l) : d.GATE = ()=>{
                let p = f.unorderedGroups.get(i(n, f));
                return !p?.[u];
            }, d;
        })), "alternatives"), o = Pf(r, Oa(e), s, "*");
    return (l)=>{
        o(l), r.parser.isRecording() || r.parser.unorderedGroups.delete(i(n, r.parser));
    };
}
m$1(jm, "buildUnorderedGroup");
function Hm(r, e) {
    let t = e.elements.map((n)=>yr(r, n));
...
function Of(r, e) {
    ...
    if (t) if (nt(t) && $e(t.rule.ref)) {
        ...
        return (s)=>r.parser.subrule(i, bf(r, n), false, e, s);
    } else if (nt(t) && He(t.rule.ref)) {
        let n = r.consume++, i = Jl(r, t.rule.ref.name);
        return ()=>r.parser.consume(n, i, e);
    } else if (Ye(t)) {
        let n = r.consume++, i = Jl(r, t.value);
        return ()=>r.parser.consume(n, i, e);
        ...
        let n = Ws(e.type.ref), i = n?.terminal;
...
m$1(Pf, "wrap");
function bf(r, e) {
    let t = qm(r, e), n = r.parser.getRule(t);
...
var Pt = class {
    ...
    buildTokens(e, t) {
        let n = j(mi(e, false)), i = this.buildTerminalTokens(n), s = this.buildKeywordTokens(n, i, t);
        return i.forEach((o)=>{
            let l = o.PATTERN;
    ...
    buildTerminalToken(e) {
        let t = Tn(e), n = this.requiresCustomPattern(t) ? this.regexPatternFunction(t) : t, i = {
            name: e.name,
            PATTERN: n
        };
    ...
    buildKeywordToken(e, t, n) {
        let i = this.buildKeywordPattern(e, n), s = {
            name: e.value,
            PATTERN: i,
...
var Ga = class r {
    ...
    update(e, t) {
        for (let n of e)if (r.isIncremental(n)) {
            let i = Hf(n.range), s = this.offsetAt(i.start), o = this.offsetAt(i.end);
            this._content = this._content.substring(0, s) + n.text + this._content.substring(o, this._content.length);
            let l = Math.max(i.start.line, 0), c = Math.max(i.end.line, 0), u = this._lineOffsets, d = Kf(n.text, false, s);
    ...
    offsetAt(e) {
        ...
        let i = e.line + 1 < t.length ? t[e.line + 1] : this._content.length, s = Math.min(n + e.character, i);
...
(function(r) {
    ...
    function n(i, s) {
        let o = i.getText(), l = cc(s.map(ig), (d, f)=>{
            let h = d.range.start.line - f.range.start.line;
            return h === 0 ? d.range.start.character - f.range.start.character : h;
        }), c = 0, u = [];
        for (let d of l){
            ...
            f > c && u.push(o.substring(c, f)), d.newText.length && u.push(d.newText), c = i.offsetAt(d.range.end);
        }
...
function cc(r, e) {
    ...
    let t = r.length / 2 | 0, n = r.slice(0, t), i = r.slice(t);
    cc(n, e), cc(i, e);
    let s = 0, o = 0, l = 0;
            ...
            function o(c, u) {
                for(var d, f = "", h = 0, p = -1, g = 0, y = 0; y <= c.length; ++y){
                    ...
                    if (d === 47) {
                        if (!(p === y - 1 || g === 1)) if (p !== y - 1 && g === 2) {
                            if (f.length < 2 || h !== 2 || f.charCodeAt(f.length - 1) !== 46 || f.charCodeAt(f.length - 2) !== 46) {
                                if (f.length > 2) {
                                    var v = f.lastIndexOf("/");
                                    if (v !== f.length - 1) {
                                        v === -1 ? (f = "", h = 0) : h = (f = f.slice(0, v)).length - 1 - f.lastIndexOf("/"), p = y, g = 0;
                                        continue;
                                    }
                        ...
                        } else f.length > 0 ? f += "/" + c.slice(p + 1, y) : f = c.slice(p + 1, y), h = y - p - 1;
                        p = y, g = 0;
                    } else d === 46 && g !== -1 ? ++g : g = -1;
                }
                return f;
            ...
            var l = {
                resolve: m$1(function() {
                    for(var c, u = "", d = false, f = arguments.length - 1; f >= -1 && !d; f--){
                        var h;
                        f >= 0 ? h = arguments[f] : (c === void 0 && (c = process.cwd()), h = c), s(h), h.length !== 0 && (u = h + "/" + u, d = h.charCodeAt(0) === 47);
                    }
                ...
                normalize: m$1(function(c) {
                    ...
                    return (c = o(c, !u)).length !== 0 || u || (c = "."), c.length > 0 && d && (c += "/"), u ? "/" + c : c;
                }, "normalize"),
                ...
                dirname: m$1(function(c) {
                    if (s(c), c.length === 0) return ".";
                    for(var u = c.charCodeAt(0), d = u === 47, f = -1, h = true, p = c.length - 1; p >= 1; --p)if ((u = c.charCodeAt(p)) === 47) {
                        if (!h) {
                            f = p;
                            break;
                        }
                ...
                parse: m$1(function(c) {
                    ...
                    var d, f = c.charCodeAt(0), h = f === 47;
                    h ? (u.root = "/", d = 1) : d = 0;
                    for(var p = -1, g = 0, y = -1, v = true, R = c.length - 1, A = 0; R >= d; --R)if ((f = c.charCodeAt(R)) !== 47) y === -1 && (v = false, y = R + 1), f === 46 ? p === -1 ? p = R : A !== 1 && (A = 1) : p !== -1 && (A = -1);
                    else if (!v) {
                        g = R + 1;
                        break;
                    }
                    return p === -1 || y === -1 || A === 0 || A === 1 && p === y - 1 && p === g + 1 ? y !== -1 && (u.base = u.name = g === 0 && h ? c.slice(1, y) : c.slice(g, y)) : (g === 0 && h ? (u.name = c.slice(1, p), u.base = c.slice(1, y)) : (u.name = c.slice(g, p), u.base = c.slice(g, y)), u.ext = c.slice(p, y)), g > 0 ? u.dir = c.slice(0, g - 1) : h && (u.dir = "/"), u;
                }, "parse"),
                sep: "/",
                delimiter: ":",
                win32: null,
    ...
    (()=>{
        ...
        class h {
            ...
            constructor(T, C, S, K, O, L = false){
                typeof T == "object" ? (this.scheme = T.scheme || u, this.authority = T.authority || u, this.path = T.path || u, this.query = T.query || u, this.fragment = T.fragment || u) : (this.scheme = function(Le, Oe) {
                    return Le || Oe ? Le : "file";
                }(T, L), this.authority = C || u, this.path = function(Le, Oe) {
                    switch(Le){
                        case "https":
                        case "http":
                        case "file":
            ...
            static file(T) {
                ...
                if (i && (T = T.replace(/\\/g, d)), T[0] === d && T[1] === d) {
                    let S = T.indexOf(d, 2);
                    S === -1 ? (C = T.substring(2), T = d) : (C = T.substring(2, S), T = T.substring(S) || d);
                }
        ...
        class g extends h {
            ...
            toString() {
                let T = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
                return T ? x(this, true) : (this._formatted || (this._formatted = x(this, false)), this._formatted);
            }
            toJSON() {
                let T = {
                    $mid: 1
        ...
        function v(k, T, C) {
            ...
            for(let O = 0; O < k.length; O++){
                ...
                if (L >= 97 && L <= 122 || L >= 65 && L <= 90 || L >= 48 && L <= 57 || L === 45 || L === 46 || L === 95 || L === 126 || T && L === 47 || C && L === 91 || C && L === 93 || C && L === 58) K !== -1 && (S += encodeURIComponent(k.substring(K, O)), K = -1), S !== void 0 && (S += k.charAt(O));
                else {
        ...
        function R(k) {
            ...
            for(let C = 0; C < k.length; C++){
                ...
                S === 35 || S === 63 ? (T === void 0 && (T = k.substr(0, C)), T += y[S]) : T !== void 0 && (T += k[C]);
            }
            return T !== void 0 ? T : k;
        }
        m$1(R, "p");
        function A(k, T) {
            let C;
            return C = k.authority && k.path.length > 1 && k.scheme === "file" ? `//${k.authority}${k.path}` : k.path.charCodeAt(0) === 47 && (k.path.charCodeAt(1) >= 65 && k.path.charCodeAt(1) <= 90 || k.path.charCodeAt(1) >= 97 && k.path.charCodeAt(1) <= 122) && k.path.charCodeAt(2) === 58 ? T ? k.path.substr(1) : k.path[1].toLowerCase() + k.path.substr(2) : k.path, i && (C = C.replace(/\//g, "\\")), C;
        }
        m$1(A, "m");
        function x(k, T) {
            ...
            return Le && (S += "?", S += C(Le, false, false)), Oe && (S += "#", S += T ? Oe : v(Oe, false, false)), S;
        }
        m$1(x, "y");
        function P(k) {
            try {
        ...
        (function(k) {
            k.joinPath = function(T) {
                ...
                return K && O[0] === Mt && !T.authority && (O = O.substring(1)), T.with({
                    path: O
                });
            }, k.dirname = function(T) {
                if (T.path.length === 0 || T.path === Mt) return T;
                let C = Ae.dirname(T.path);
...
(function(r) {
    ...
    function t(i, s) {
        let o = typeof i == "string" ? i : i.path, l = typeof s == "string" ? s : s.path, c = o.split("/").filter((p)=>p.length > 0), u = l.split("/").filter((p)=>p.length > 0), d = 0;
        for(; d < c.length && c[d] === u[d]; d++);
        let f = "../".repeat(c.length - d), h = u.slice(d).join("/");
        return f + h;
    }
...
var zi = class {
    ...
    create(e, t, n) {
        if (typeof t == "string") {
            ...
            let i = this.parse(e, t.getText(), n);
    ...
    async createAsync(e, t, n) {
        if (typeof t == "string") {
            ...
            let i = await this.parseAsync(e, t.getText(), n);
            return this.createLangiumDocument(i, e, t);
        }
    }
    ...
    async update(e, t) {
        var n, i;
        let s = (n = e.parseResult.value.$cstNode) === null || n === void 0 ? void 0 : n.root.fullText, o = (i = this.textDocuments) === null || i === void 0 ? void 0 : i.get(e.uri.toString()), l = o ? o.getText() : await this.fileSystemProvider.readFile(e.uri);
    ...
    createTextDocumentGetter(e, t) {
        ...
        return ()=>i ?? (i = jn.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, t ?? ""));
    }
}, qi = class {
    ...
    invalidateDocument(e) {
        let t = e.toString(), n = this.documentMap.get(t);
...
var uc = Symbol("ref_resolving"), Xi = class {
...
var Ji = class {
    ...
    findDeclarationNode(e) {
        ...
        if (t?.$cstNode) {
            let n = this.nameProvider.getNameNode(t);
            return n ?? t.$cstNode;
        }
    }
    findReferences(e, t) {
        ...
        return t.documentUri && (i = i.filter((s)=>Be.equals(s.sourceUri, t.documentUri))), n.push(...i), j(n);
    }
    getReferenceToSelf(e) {
        let t = this.nameProvider.getNameNode(e);
        if (t) {
            let n = _e(e), i = this.nodeLocator.getAstNodePath(e);
            return {
                sourceUri: n.uri,
                sourcePath: i,
                targetUri: n.uri,
...
var Qi = class {
    ...
    exportNode(e, t, n) {
        ...
        i && t.push(this.descriptions.createDescription(e, i, n));
    }
    ...
    processNode(e, t, n) {
        ...
        if (i) {
            ...
            s && n.add(i, this.descriptions.createDescription(e, s, t));
        }
    }
};
var zn = class {
...
var qn = class {
    ...
    constructor(e, t){
        super((n)=>n.toString()), t ? (this.toDispose.push(e.workspace.DocumentBuilder.onDocumentPhase(t, (n)=>{
...
var ts = class {
    ...
    getScope(e) {
        let t = [], n = this.reflection.getReferenceType(e), i = _e(e.container).precomputedScopes;
        if (i) {
            let o = e.container;
            do {
                let l = i.get(o);
                l.length > 0 && t.push(j(l).filter((c)=>this.reflection.isSubtype(c.type, n))), o = o.$container;
            }while (o);
        }
        let s = this.getGlobalScope(n, e);
        for(let o = t.length - 1; o >= 0; o--)s = this.createScope(t[o], s);
        return s;
    }
    createScope(e, t, n) {
...
var rs = class {
    ...
    serialize(e, t) {
        let n = t ?? {}, i = t?.replacer, s = m$1((l, c)=>this.replacer(l, c, n), "defaultReplacer"), o = i ? (l, c)=>i(l, c, s) : s;
        try {
            return this.currentDocument = _e(e), JSON.stringify(e, o, t?.space);
        } finally{
            this.currentDocument = void 0;
        }
    }
    deserialize(e, t) {
        let n = t ?? {}, i = JSON.parse(e);
    ...
    replacer(e, t, param) {
        ...
        if (!this.ignoreProperties.has(e)) if (Ee(t)) {
            ...
            if (h) {
                ...
                let v = this.astNodeLocator.getAstNodePath(h);
                return {
                    $ref: `${y}#${v}`,
                    $refText: p
                };
            ...
            let h;
            if (s && (h = this.addAstNodeRegionWithAssignmentsTo(Object.assign({}, t)), (!e || t.$document) && h?.$textRegion && (h.$textRegion.documentURI = (d = this.currentDocument) === null || d === void 0 ? void 0 : d.uri.toString())), i && !e && (h ?? (h = Object.assign({}, t)), h.$sourceText = (f = t.$cstNode) === null || f === void 0 ? void 0 : f.text), o) {
                h ?? (h = Object.assign({}, t));
    ...
    addAstNodeRegionWithAssignmentsTo(e) {
        ...
        if (e.$cstNode) {
            let n = e.$textRegion = t(e.$cstNode), i = n.assignments = {};
            return Object.keys(e).filter((s)=>!s.startsWith("$")).forEach((s)=>{
                let o = qo(e.$cstNode, s).map(t);
                o.length !== 0 && (i[s] = o);
            }), e;
        }
    }
    linkNode(e, t, n, i, s, o) {
        for (let [c, u] of Object.entries(e))if (Array.isArray(u)) for(let d = 0; d < u.length; d++){
            let f = u[d];
            Xf(f) ? u[d] = this.reviveReference(e, c, t, f, n) : le(f) && this.linkNode(f, t, n, e, c, d);
        }
        else Xf(u) ? e[c] = this.reviveReference(e, c, t, u, n) : le(u) && this.linkNode(u, t, n, e, c);
        let l = e;
    ...
    reviveReference(e, t, n, i, s) {
        ...
        if (i.$ref) {
            let c = this.getRefNode(n, i.$ref, s.uriConverter);
            if (le(c)) return o || (o = this.nameProvider.getName(c)), {
                $refText: o ?? "",
                ref: c
            };
            l = c;
    ...
    getRefNode(e, t, n) {
        try {
            ...
            if (i < 0) {
                let c = n ? n(t) : Ue.parse(t), u = this.langiumDocuments.getDocument(c);
                return u ? u.parseResult.value : "Could not find document for URI: " + t;
            }
            let s = n ? n(t.substring(0, i)) : Ue.parse(t.substring(0, i)), o = this.langiumDocuments.getDocument(s);
            if (!o) return "Could not find document for URI: " + t;
            if (i === t.length - 1) return o.parseResult.value;
            let l = this.astNodeLocator.getAstNode(o.parseResult.value, t.substring(i + 1));
...
var ns = class {
    ...
    getServices(e) {
        ...
        let s = Be.extname(e), o = this.fileExtensionMap.get(s);
...
var is = class {
    ...
    getChecks(e, t) {
        ...
        return t && (n = n.filter((i)=>t.includes(i.category))), n.map((i)=>i.check);
    }
...
var ss = class {
    ...
    processLinkingErrors(e, t, n) {
        for (let i of e.references){
            ...
            if (s) {
                ...
                t.push(this.toDiagnostic("error", s.message, o));
            }
        }
    }
    async validateAst(e, t) {
        ...
        let i = [], s = m$1((o, l, c)=>{
            i.push(this.toDiagnostic(o, l, c));
        }, "acceptor");
    ...
    async validateAstNodes(e, t, n) {
        ...
        await Promise.all(Je(e).map(async (s)=>{
            await ue(i);
            let o = this.validationRegistry.getChecks(s.$type, t.categories);
...
var as = class {
    ...
    createDescription(e, t, n) {
        ...
        let o, l = m$1(()=>{
            var c;
            return o ?? (o = er((c = this.nameProvider.getNameNode(e)) !== null && c !== void 0 ? c : e.$cstNode));
        }, "nameSegmentGetter");
        return {
            node: e,
            name: t,
...
var ls = class {
    ...
    getAstNode(e, t) {
        return t.split(this.segmentSeparator).reduce((i, s)=>{
            ...
            if (o > 0) {
                let l = s.substring(0, o), c = parseInt(s.substring(o + 1)), u = i[l];
                return u?.[c];
            }
            return i[s];
        }, e);
    ...
    async initialized(e) {
        if (this.workspaceConfig) {
            if (e.register) {
                ...
                e.register({
                    section: t.map((n)=>this.toSectionName(n.LanguageMetaData.languageId))
                });
            }
...
var us = class {
    ...
    async build(e) {
        ...
        for (let o of e){
            ...
            if (o.state === Y.Validated) {
                if (typeof t.validation == "boolean" && t.validation) o.state = Y.IndexedReferences, o.diagnostics = void 0, this.buildState.delete(l);
                    ...
                    let c = this.buildState.get(l), u = (i = c?.result) === null || i === void 0 ? void 0 : i.validationChecks;
                    if (u) {
                        let f = ((s = t.validation.categories) !== null && s !== void 0 ? s : Yn.all).filter((h)=>!u.includes(h));
        ...
        this.currentState = Y.Changed, await this.emitUpdate(e.map((o)=>o.uri), []), await this.buildDocuments(e, t, n);
    }
    async update(e, t) {
        let n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : $.CancellationToken.None;
        this.currentState = Y.Changed;
        for (let o of t)this.langiumDocuments.deleteDocument(o), this.buildState.delete(o.toString()), this.indexManager.remove(o);
        for (let o of e){
        ...
        let i = j(e).concat(t).map((o)=>o.toString()).toSet();
        this.langiumDocuments.all.filter((o)=>!i.has(o.uri.toString()) && this.shouldRelink(o, i)).forEach((o)=>{
            this.serviceRegistry.getServices(o.uri).references.Linker.unlink(o), o.state = Math.min(o.state, Y.ComputedScopes), o.diagnostics = void 0;
        }), await this.emitUpdate(e, t), await ue(n);
        let s = this.sortDocuments(this.langiumDocuments.all.filter((o)=>{
            var l;
            return o.state < Y.Linked || !(!((l = this.buildState.get(o.uri.toString())) === null || l === void 0) && l.completed);
        }).toArray());
    ...
    prepareBuild(e, t) {
        for (let n of e){
            let i = n.uri.toString(), s = this.buildState.get(i);
    ...
    getBuildOptions(e) {
        var t, n;
        return (n = (t = this.buildState.get(e.uri.toString())) === null || t === void 0 ? void 0 : t.options) !== null && n !== void 0 ? n : {};
    }
};
var ds = class {
    ...
    allElements(e, t) {
        ...
        return t && (n = n.filter((i)=>!t || t.has(i))), n.map((i)=>this.getFileDescriptions(i, e)).flat();
    }
    ...
    isAffected(e, t) {
        ...
        return n ? n.some((i)=>!i.local && t.has(i.targetUri.toString())) : false;
    }
};
var fs = class {
    ...
    async performStartup(e) {
        let t = this.serviceRegistry.all.flatMap((s)=>s.LanguageMetaData.fileExtensions), n = [], i = m$1((s)=>{
...
var hs = class {
    ...
    tokenize(e) {
        var n, i, s;
        let o = this.chevrotainLexer.tokenize(e);
        return {
            tokens: o.tokens,
            errors: o.errors,
...
function gc(r, e, t) {
    let n, i;
    typeof r == "string" ? (i = e, n = t) : (i = r.range.start, n = e), i || (i = W.create(0, 0));
    let s = eh(r), o = Tc(n), l = og({
        lines: s,
        position: i,
        options: o
    });
...
function og(r) {
    ...
    for(let l = 0; l < r.lines.length; l++){
        ...
        if (d = d.substring(0, dg(d)), mc(d, f) >= d.length) {
            ...
            let p = Qf.exec(d);
            if (p) {
                let g = p[0], y = p[1], v = W.create(s, o + f), R = W.create(s, o + f + g.length);
                i.push({
                    type: "tag",
                    content: y,
                    range: G.create(v, R)
...
function lg(r, e, t, n) {
    let i = [];
    if (r.length === 0) {
        let s = W.create(t, n), o = W.create(t, n + e.length);
        i.push({
            type: "text",
            content: e,
            range: G.create(s, o)
        ...
        for (let l of r){
            ...
            u.length > 0 && i.push({
                ...
                range: G.create(W.create(t, s + n), W.create(t, c + n))
            });
            let d = u.length + 1, f = l[1];
            if (i.push({
                type: "inline-tag",
                content: f,
                range: G.create(W.create(t, s + d + n), W.create(t, s + d + f.length + n))
                ...
                i.push({
                    type: "text",
                    content: h,
                    range: G.create(W.create(t, s + d + n), W.create(t, s + d + h.length + n))
                });
            } else i.push({
                type: "text",
                content: "",
                range: G.create(W.create(t, s + d + n), W.create(t, s + d + n))
            });
            s = c + l[0].length;
        }
        let o = e.substring(s);
        o.length > 0 && i.push({
            type: "text",
            content: o,
            range: G.create(W.create(t, s + n), W.create(t, s + n + o.length))
        });
    }
    return i;
}
...
function th(r) {
    ...
    for(; e && e.type !== "break" && e.type !== "tag";)i.push(mg(r)), n = e, e = r.tokens[r.index];
...
function rh(r, e) {
    let t = r.tokens[r.index++], n = t.content.substring(1), i = r.tokens[r.index];
    if (i?.type === "text") if (e) {
        let s = nh(r);
...
function gg(r, e, t) {
    ...
    if (r === "linkplain" || r === "linkcode" || r === "link") {
        ...
        if (s > 0) {
            let c = mc(e, s);
            o = e.substring(c), e = e.substring(0, s);
        }
...
var gs = class {
    ...
    documentationLinkRenderer(e, t, n) {
        ...
        if (s && s.nameSegment) {
            let o = s.nameSegment.range.start.line + 1, l = s.nameSegment.range.start.character + 1, c = s.documentUri.with({
                fragment: `L${o},${l}`
            });
            return `[${n}](${c.toString()})`;
        } else return;
...
var Ts = class {
    ...
    async parse(e, t) {
        let n = await this.acquireParserWorker(t), i = new Ge, s, o = t.onCancellationRequested(()=>{
            s = setTimeout(()=>{
...
var Rs = class {
    ...
    dehydrateAstNode(e, t) {
        ...
        for (let [i, s] of Object.entries(e))if (!i.startsWith("$")) if (Array.isArray(s)) {
            let o = [];
            n[i] = o;
            for (let l of s)le(l) ? o.push(this.dehydrateAstNode(l, t)) : Ee(l) ? o.push(this.dehydrateReference(l, t)) : o.push(l);
        } else le(s) ? n[i] = this.dehydrateAstNode(s, t) : Ee(s) ? n[i] = this.dehydrateReference(s, t) : s !== void 0 && (n[i] = s);
        return n;
    }
    ...
    createHydrationContext(e) {
        ...
        if (e.$cstNode) for (let s of Zt(e.$cstNode)){
            let o;
            "fullText" in s ? (o = new Bn(s.fullText), i = o) : "content" in s ? o = new gr : "tokenType" in s && (o = this.hydrateCstLeafNode(s)), o && (n.set(s, o), o.root = i);
        }
        return {
            astNodes: t,
            cstNodes: n
    ...
    hydrateAstNode(e, t) {
        ...
        for (let [i, s] of Object.entries(e))if (!i.startsWith("$")) if (Array.isArray(s)) {
            let o = [];
            n[i] = o;
            for (let l of s)le(l) ? o.push(this.setParent(this.hydrateAstNode(l, t), n)) : Ee(l) ? o.push(this.hydrateReference(l, n, i, t)) : o.push(l);
        } else le(s) ? n[i] = this.setParent(this.hydrateAstNode(s, t), n) : Ee(s) ? n[i] = this.hydrateReference(s, n, i, t) : s !== void 0 && (n[i] = s);
        return n;
    }
    setParent(e, t) {
    ...
    hydrateReference(e, t, n, i) {
        return this.linker.buildReference(t, n, i.cstNodes.get(e.$refNode), e.$refText);
    }
    hydrateCstNode(e, t) {
        ...
        if (typeof e.grammarSource == "number" && (i.grammarSource = this.getGrammarElement(e.grammarSource)), i.astNode = t.astNodes.get(e.astNode), tt(i)) for (let s of e.content){
            let o = this.hydrateCstNode(s, t, n++);
            i.content.push(o);
        }
        return i;
    }
    hydrateCstLeafNode(e) {
        let t = this.getTokenType(e.tokenType), n = e.offset, i = e.length, s = e.startLine, o = e.startColumn, l = e.endLine, c = e.endColumn, u = e.hidden;
        return new mr(n, i, {
            start: {
                line: s,
                character: o
...
function lh(r, e) {
    let t = new Proxy({}, {
        ...
        get: m$1((n, i)=>i === ah ? true : sh(n, i, r, e || t), "get"),
        getOwnPropertyDescriptor: m$1((n, i)=>(sh(n, i, r, e || t), Object.getOwnPropertyDescriptor(n, i)), "getOwnPropertyDescriptor"),
        has: m$1((n, i)=>i in r, "has"),
        ownKeys: m$1(()=>[
...
function Ha(r, e) {
    if (e) {
        for (let [t, n] of Object.entries(e))if (n !== void 0) {
            let i = r[t];
            i !== null && n !== null && typeof i == "object" && typeof n == "object" ? r[t] = Ha(i, n) : r[t] = n;
        }
    }
    return r;
}
...
`.includes(e[t - 1]);
    ...
    matchWhitespace(e, t, n, i) {
        ...
        let o = this.whitespaceRegExp.exec(e);
        return {
    ...
    dedentMatcher(e, t, n, i) {
        ...
        if (u >= d) return null;
        let h = this.indentationStack.lastIndexOf(u);
        ...
        let p = this.indentationStack.length - h - 1, g = (c = (l = e.substring(0, t).match(/[\r\n]+$/)) === null || l === void 0 ? void 0 : l[0].length) !== null && c !== void 0 ? c : 1;
        for(let y = 0; y < p; y++){
    ...
    buildTerminalToken(e) {
        let t = super.buildTerminalToken(e), { indentTokenName: n, dedentTokenName: i, whitespaceTokenName: s } = this.options;
    ...
    tokenize(e) {
        ...
        let n = super.tokenize(e), i = n.report;
...
function bt(r) {
    var e;
    let t = Rg(), n = t.serializer.JsonSerializer.deserialize(r);
    return t.shared.workspace.LangiumDocumentFactory.fromModel(n, Ue.parse(`memory://${(e = n.name) !== null && e !== void 0 ? e : "grammar"}.langium`)), n;
}
...
`);
    ...
    buildKeywordTokens(r, e, t) {
        let n = super.buildKeywordTokens(r, e, t);
        return n.forEach((i)=>{
