...
import { I as Ie$1, L as Le$1, w as we$1 } from "./vendor-min-mermaid~chunk-QS5O44OF.L_MBO-WO.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Q7R0ayzM.chunk.js";
import { L as Lf, M as Mf, B as Bf, F as Ff, w as wf, v as vf, t as tt$1, H as Hl, i as ih, aj as Df, S as Sf, g as gC, E as Er, p as pl } from "./vendor-min-mermaid~chunk-QJLC67TO.Dw34GYds.chunk.js";
var u = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
`, "id:", e, o), !w) throw new Error("GitGraph config not found");
  ...
  }), ie(s2, L, false), w.showBranches && Qe(s2, m), Xe(s2, L), ie(s2, L, true), Ie$1.insertTitle(s2, "gitTitleText", w.titleTopMargin ?? 0, /* @__PURE__ */ n.getDiagramTitle()), Df(void 0, s2, w.diagramPadding, w.useMaxWidth);
}, "draw"), de = {
  draw: tt
};
