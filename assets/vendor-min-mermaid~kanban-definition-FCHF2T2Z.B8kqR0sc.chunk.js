...
import { x as xa, T as Td, E as Ed } from './vendor-min-mermaid~chunk-B4LOWB5X.T-uFuOvQ.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { u as ur, c as cr, a as Pi, r as rt, h as U, i as c, k as g } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
...
var x = [], se = [], re = 0, oe = {}, Ce = /*#__PURE__*/ m$1(()=>{
    ...
    let e = [], g = [], p = /*#__PURE__*/ _e(), r = /*#__PURE__*/ ur();
    for (let d of p){
        let _ = {
            id: d.id,
            label: /*#__PURE__*/ rt(d.label ?? "", r),
            isGroup: true,
            ticket: d.ticket,
            shape: "kanbanSection",
            level: d.level,
    ...
    let _ = /*#__PURE__*/ ur(), b = _.mindmap?.padding ?? Pi.mindmap.padding;
    switch(r){
        case f.ROUNDED_RECT:
        case f.RECT:
        case f.HEXAGON:
    ...
    let l = {
        id: rt(g, _) || "kbn" + re++,
        level: e,
        label: /*#__PURE__*/ rt(p, _),
        width: _.mindmap?.maxNodeWidth ?? Pi.mindmap.maxNodeWidth,
        padding: b,
        isGroup: false
    };
    if (d !== void 0) {
...
` + d + `
    ...
    if (!e) return;
    let g = /*#__PURE__*/ ur(), p = x[x.length - 1];
    e.icon && (p.icon = /*#__PURE__*/ rt(e.icon, g)), e.class && (p.cssClasses = /*#__PURE__*/ rt(e.class, g));
...
}, "type2Str"), Be = /*#__PURE__*/ m$1(()=>pt, "getLogger"), Ve = /*#__PURE__*/ m$1((e)=>oe[e], "getElementById"), Me = {
    clear: Ce,
    addNode: Ae,
    getSections: _e,
    getData: we,
...
` + e);
    let _ = /*#__PURE__*/ r.db.getData(), b = /*#__PURE__*/ ur();
    b.htmlLabels = false;
    ...
    cr(void 0, l, b.mindmap?.padding ?? Pi.kanban.padding, b.mindmap?.useMaxWidth ?? Pi.kanban.useMaxWidth);
}, "draw"), Ne = {
    draw: Ge
};
var Fe = /*#__PURE__*/ m$1((e)=>{
    ...
    let p = /*#__PURE__*/ m$1((r, d)=>e.darkMode ? g(r, d) : c(r, d), "adjuster");
