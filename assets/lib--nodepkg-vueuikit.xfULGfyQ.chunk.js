...
let e;
import { j as t, T as r, f as n, b as a, m as i, l as o, u as s, o as l, q as c, w as u, k as d, F as f } from "./lib--nodepkg-vue-jsx-runtime.BN22WHLF.chunk.js";
import { _ as h, j as p, c as m, k as g, r as v, l as b, d as y, t as x } from "./lib--nodepkg-vuekit.UMOgsAuw.chunk.js";
...
function ei(e10) {
  var { from: t10 = 0, to: r10 = 1, restSpeed: n6 = 2, restDelta: a2 } = e10, i2 = h(e10, ["from", "to", "restSpeed", "restDelta"]);
  ...
  function g2() {
    ...
    if (void 0 === a2 && (a2 = Math.min(Math.abs(r10 - t10) / 100, 0.4)), i3 < 1) {
      let t11 = et(o3, i3);
      p2 = (a3) => r10 - Math.exp(-i3 * o3 * a3) * ((e11 + i3 * o3 * n7) / t11 * Math.sin(t11 * a3) + n7 * Math.cos(t11 * a3)), m2 = (r11) => {
      ...
      p2 = (t11) => r10 - Math.exp(-o3 * t11) * (n7 + (e11 + o3 * n7) * t11);
    else {
...
function tr(e10) {
  ...
  (null === (a2 = C2.needsInterpolation) || void 0 === a2 ? void 0 : a2.call(C2, i2, y2)) && (n6 = eq([0, 100], [i2, y2], { clamp: false }), i2 = 0, y2 = 100);
  ...
  return o2 && (null == f2 || f2(), (t10 = s2(function(e11) {
    if (M2 || (e11 = -e11), l2 += e11, !k2) {
      ...
      r10 = e12.value, n6 && (r10 = n6(r10)), k2 = M2 ? e12.done : l2 <= 0;
    }
...
let tV = { shadow: tO.shadow({ 0: { _default: "0px 0px 0px rgba(0, 0, 0, 0), 0px 0px 0px 0px rgba(0, 0, 0, 0)", _dark: "0px 0px 0px 0px rgba(0, 0, 0, 0), 0px 0px 0px rgba(0, 0, 0, 0)" }, 1: { _default: "0px 1px 2px rgba(0, 0, 0, 0.3), 0px 1px 3px 1px rgba(0, 0, 0, 0.15)", _dark: "0px 1px 3px 1px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)" }, 2: { _default: "0px 1px 2px rgba(0, 0, 0, 0.3), 0px 2px 6px 2px rgba(0, 0, 0, 0.15)", _dark: "0px 2px 6px 2px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)" }, 3: { _default: "0px 4px 8px 3px rgba(0, 0, 0, 0.15), 0px 1px 3px rgba(0, 0, 0, 0.3)", _dark: "0px 4px 8px 3px rgba(0, 0, 0, 0.15), 0px 1px 3px rgba(0, 0, 0, 0.3)" }, 4: { _default: "0px 6px 10px 4px rgba(0, 0, 0, 0.15), 0px 2px 3px rgba(0, 0, 0, 0.3)", _dark: "0px 6px 10px 4px rgba(0, 0, 0, 0.15), 0px 2px 3px rgba(0, 0, 0, 0.3)" }, 5: { _default: "0px 8px 12px 6px rgba(0, 0, 0, 0.15), 0px 4px 4px rgba(0, 0, 0, 0.3)", _dark: "0px 8px 12px 6px rgba(0, 0, 0, 0.15), 0px 4px 4px rgba(0, 0, 0, 0.3)" } }), elevation: tO.customMixin("elevation", { 0: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "0", _hover: { shadow: "1" } }), 1: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "1", _hover: { shadow: "2" } }), 2: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "2", _hover: { shadow: "3" } }), 3: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "3", _hover: { shadow: "4" } }), 4: tO.mixin({ transitionDuration: "md4", transitionTimingFunction: "standard", shadow: "4", _hover: { shadow: "5" } }) }) }, tE = (e10, t10, r10, n6) => Object.assign(function(e11, t11, r11, n7) {
  ...
  let a2 = null != n6 ? n6 : { ...e10, from: { ...e10.to }, to: { ...e10.from } };
  return p({ onComplete: V(), $default: V() }, (n7, i2) => {
...
let no = Object.assign(p({ styles: V() }, (e10) => {
  let { styles: t10 } = e10, r10 = rx.use(), n6 = nt.use(), a2 = nr(n6), o2 = r10.unstable_css(n6, S(t10) ? { "&": t10 } : t10);
  return i(() => {
...
let nd = Object.assign(p({ isOpen: H().optional(), style: V().optional(), contentRef: V().optional(), triggerRef: V().optional(), onClickOutside: V(), onEscKeydown: V(), onContentBeforeMount: V(), $transition: V().optional(), $default: V().optional() }, (e10, r10) => {
  var n6;
  let { slots: i2, attrs: s2, emit: u2 } = r10, d2 = e10.contentRef || a(null), f2 = new nu(null !== (n6 = e10.triggerRef) && void 0 !== n6 ? n6 : a(null), d2, () => !!e10.isOpen), h2 = nl.use();
  return l(nc.use().add(f2)), window && v(b(d2, "value"), x((e11) => {
    ...
    var r11;
    let n7 = e10.isOpen ? o(t("div", { ...s2, ref: d2, style: e10.style, children: t(nc, { value: f2, children: null === (r11 = i2.default) || void 0 === r11 ? void 0 : r11.call(i2) }) }), { onVnodeBeforeMount: () => {
      u2("content-before-mount");
    } }) : null;
    return t(c, { to: h2.mountPoint(), children: i2.transition ? i2.transition({ content: n7 }) : n7 });
  };
...
let n8 = Object.assign(p({ isOpen: nd.propTypes.isOpen, onClickOutside: nd.propTypes.onClickOutside, placement: V().optional(), modifiers: V().optional(), $transition: nd.propTypes.$transition, $content: V(), $default: V() }, (e10, r10) => {
  let { slots: n6, emit: i2, attrs: s2 } = r10, l2 = a(null), c2 = a(null);
  return u(() => c2.value, (t10) => {
    if (t10 && l2.value) {
      var r11, n7;
      n3(l2.value, t10, { placement: null !== (r11 = e10.placement) && void 0 !== r11 ? r11 : "bottom", modifiers: [...null !== (n7 = e10.modifiers) && void 0 !== n7 ? n7 : [], n2] });
    }
  }), () => {
    var r11, a2;
    ...
    } }), t(nd, { triggerRef: l2, contentRef: c2, isOpen: e10.isOpen, onClickOutside: (e11) => i2("click-outside", e11), style: { zIndex: 100 }, $transition: n6.transition, children: null === (a2 = n6.content) || void 0 === a2 ? void 0 : a2.call(n6) })] }) : null;
  };
