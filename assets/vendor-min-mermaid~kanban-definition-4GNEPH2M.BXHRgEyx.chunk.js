...
import { y as yo, s as sg, a as ag } from "./vendor-min-mermaid~chunk-KTJJRPYF.Ba3UtYz5.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Q7R0ayzM.chunk.js";
import { t as tt, H as Hl, P as Pl, p as pl, D as De, al as Wt, am as F, an as E } from "./vendor-min-mermaid~chunk-QJLC67TO.Dw34GYds.chunk.js";
  ...
  var e = /* @__PURE__ */ m$1(function(v, i, n, s) {
    ...
    parse: /* @__PURE__ */ m$1(function(i) {
      var n = this, s = [
        ...
        null
      ], t = [], R = this.table, c = "", z = 0, ae = 0, ce = 0, De2 = 2, le = 1, xe = /* @__PURE__ */ t.slice.call(arguments, 1), m = /* @__PURE__ */ Object.create(this.lexer), P = {
        yy: {}
      };
      ...
      for (var E2, Z, j, D, Ue, $, G = {}, X, I, he, Y; ; ) {
        if (j = s[s.length - 1], this.defaultActions[j] ? D = this.defaultActions[j] : ((E2 === null || typeof E2 > "u") && (E2 = /* @__PURE__ */ Oe()), D = R[j] && R[j][E2]), typeof D > "u" || !D.length || !D[0]) {
          var ee = "";
          Y = [];
          for (X in R[j]) this.terminals_[X] && X > De2 && Y.push("'" + this.terminals_[X] + "'");
...
var Ge = /* @__PURE__ */ m$1((e) => {
  let u = "";
  for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) e["lineColor" + r] = e["lineColor" + r] || e["cScaleInv" + r], Wt(e["lineColor" + r]) ? e["lineColor" + r] = /* @__PURE__ */ F(e["lineColor" + r], 20) : e["lineColor" + r] = /* @__PURE__ */ E(e["lineColor" + r], 20);
