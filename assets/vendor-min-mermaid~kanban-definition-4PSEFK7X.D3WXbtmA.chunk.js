...
import { y as yo, s as sg, a as ag } from "./vendor-min-mermaid~chunk-USR3SDWQ.C0roZ6ow.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Q7R0ayzM.chunk.js";
import { t as tt, H as Hl, P as Pl, p as pl, O as Oe, am as $t, an as F, ao as E } from "./vendor-min-mermaid~chunk-ZKYS2E5M.BgSjvTzJ.chunk.js";
  ...
  var e = /* @__PURE__ */ m$1(function(v, i, n, s) {
    ...
    parse: /* @__PURE__ */ m$1(function(i) {
      var n = this, s = [
        ...
        null
      ], t = [], R = this.table, c = "", z = 0, ae = 0, ce = 0, De = 2, le = 1, xe = /* @__PURE__ */ t.slice.call(arguments, 1), m = /* @__PURE__ */ Object.create(this.lexer), P = {
        yy: {}
      };
      ...
      m$1(Oe2, "lex");
      for (var E2, Z, j, D, Ue, $, G = {}, X, I, he, Y; ; ) {
        if (j = s[s.length - 1], this.defaultActions[j] ? D = this.defaultActions[j] : ((E2 === null || typeof E2 > "u") && (E2 = /* @__PURE__ */ Oe2()), D = R[j] && R[j][E2]), typeof D > "u" || !D.length || !D[0]) {
          var ee = "";
          Y = [];
          for (X in R[j]) this.terminals_[X] && X > De && Y.push("'" + this.terminals_[X] + "'");
          m.showPosition ? ee = "Parse error on line " + (z + 1) + `:
` + m.showPosition() + `
Expecting ` + Y.join(", ") + ", got '" + (this.terminals_[E2] || E2) + "'" : ee = "Parse error on line " + (z + 1) + ": Unexpected " + (E2 == le ? "end of input" : "'" + (this.terminals_[E2] || E2) + "'"), this.parseError(ee, {
            text: m.match,
            token: this.terminals_[E2] || E2,
            line: m.yylineno,
            loc: Q,
            expected: Y
          });
        }
        if (D[0] instanceof Array && D.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + j + ", token: " + E2);
        switch (D[0]) {
          case 1:
            s.push(E2), h.push(m.yytext), t.push(m.yylloc), s.push(D[1]), E2 = null, Z ? (E2 = Z, Z = null) : (ae = m.yyleng, c = m.yytext, z = m.yylineno, Q = m.yylloc, ce > 0);
            break;
          case 2:
...
var x = [], se = [], re = 0, oe = {}, ve = /* @__PURE__ */ m$1(() => {
  ...
  let e = [], u = [], p = /* @__PURE__ */ Ee(), r = /* @__PURE__ */ Hl();
  for (let d2 of p) {
    let _ = {
      id: d2.id,
      label: /* @__PURE__ */ Oe(d2.label ?? "", r),
      isGroup: true,
      ticket: d2.ticket,
      shape: "kanbanSection",
      level: d2.level,
  ...
  var _a, _b;
  let _ = /* @__PURE__ */ Hl(), b = ((_a = _.mindmap) == null ? void 0 : _a.padding) ?? pl.mindmap.padding;
  switch (r) {
    case f.ROUNDED_RECT:
    case f.RECT:
    case f.HEXAGON:
  ...
  let l = {
    id: Oe(u, _) || "kbn" + re++,
    level: e,
    label: /* @__PURE__ */ Oe(p, _),
    width: ((_b = _.mindmap) == null ? void 0 : _b.maxNodeWidth) ?? pl.mindmap.maxNodeWidth,
    padding: b,
    isGroup: false
  };
  if (d2 !== void 0) {
...
` + d2 + `
  ...
  if (!e) return;
  let u = /* @__PURE__ */ Hl(), p = x[x.length - 1];
  e.icon && (p.icon = /* @__PURE__ */ Oe(e.icon, u)), e.class && (p.cssClasses = /* @__PURE__ */ Oe(e.class, u));
...
` + e);
  let _ = /* @__PURE__ */ r.db.getData(), b = /* @__PURE__ */ Hl();
  b.htmlLabels = false;
  ...
  for (let y of g) {
    let A = ((_a = b == null ? void 0 : b.kanban) == null ? void 0 : _a.sectionWidth) || 200;
  ...
  Pl(void 0, l, ((_d = b.mindmap) == null ? void 0 : _d.padding) ?? pl.kanban.padding, ((_e2 = b.mindmap) == null ? void 0 : _e2.useMaxWidth) ?? pl.kanban.useMaxWidth);
}, "draw"), Se = {
  draw: Me
};
var Ge = /* @__PURE__ */ m$1((e) => {
  let u = "";
  for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) e["lineColor" + r] = e["lineColor" + r] || e["cScaleInv" + r], $t(e["lineColor" + r]) ? e["lineColor" + r] = /* @__PURE__ */ F(e["lineColor" + r], 20) : e["lineColor" + r] = /* @__PURE__ */ E(e["lineColor" + r], 20);
  let p = /* @__PURE__ */ m$1((r, d2) => e.darkMode ? E(r, d2) : F(r, d2), "adjuster");
