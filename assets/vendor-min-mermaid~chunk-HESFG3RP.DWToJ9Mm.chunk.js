import { X as Xe$1 } from './vendor-min-mermaid~chunk-YM3XIQPS.BqB7gHkV.chunk.js';
import { t as tt$1, R as Rl, i as ih, C as Cf, g as gC, H as Hl } from './vendor-min-mermaid~chunk-ZKYS2E5M.Cc2x1uDP.chunk.js';
...
`, e = /*#__PURE__*/ e.substring(g.length + 1), c = true), !c) {
                    let D = /*#__PURE__*/ this.rules.other.nextBulletRegex(m), re = /*#__PURE__*/ this.rules.other.hrRegex(m), se = /*#__PURE__*/ this.rules.other.fencesBeginRegex(m), ie = /*#__PURE__*/ this.rules.other.headingBeginRegex(m), _e = /*#__PURE__*/ this.rules.other.htmlBeginRegex(m);
                    for(; e;){
                        let Z = e.split(`
`, 1)[0], C;
                        if (g = Z, this.options.pedantic ? (g = /*#__PURE__*/ g.replace(this.rules.other.listReplaceNesting, "  "), C = g) : C = /*#__PURE__*/ g.replace(this.rules.other.tabCharGlobal, "    "), se.test(g) || ie.test(g) || _e.test(g) || D.test(g) || re.test(g)) break;
...
`, e = /*#__PURE__*/ e.substring(Z.length + 1), f = /*#__PURE__*/ C.slice(m);
    ...
    table(e) {
        ...
        let n = /*#__PURE__*/ de(t[1]), r = /*#__PURE__*/ t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], s = {
            type: "table",
            raw: t[0],
            header: [],
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = s.text) : t.push(r);
    ...
    inlineTokens(e) {
        ...
        for(; e;){
            i || (s = ""), i = false;
            let l;
            if (this.options.extensions?.inline?.some((c)=>(l = /*#__PURE__*/ c.call({
                    lexer: this
