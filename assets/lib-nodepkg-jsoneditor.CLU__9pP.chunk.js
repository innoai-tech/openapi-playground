...
var _values$, _error$, _editing;
import { c as createProvider, I as ImmerBehaviorSubject, j as jsx, a as component$, r as rx, s as subscribeUntilUnmount, b as cloneVNode, d as jsxs, e as ref, f as component, T as Teleport, F as Fragment, o as observableRef, t as tapEffect, g as ref$1 } from "./lib-nodepkg-vuekit.BuiIu7Tz.chunk.js";
import { o as object, J as JSONPointer, g as getDefaultExportFromCjs, S as Schema, a as array, b as any, r as record, s as string, E as EmptyContext } from "./lib-nodepkg-typedef.D-PCYzjh.chunk.js";
import { s as styled, a as size, P as Popper, v as variant, b as alpha, B as Box } from "./lib-nodepkg-vueuikit.BzhbdpiR.chunk.js";
import { I as IconButton, a as Icon, m as mdiHelpBox, b as mdiContentCopy, c as mdiCancel, d as mdiCheckBold, e as mdiMinusBoxOutline } from "./lib-nodepkg-vuematerial.D3GZY0DO.chunk.js";
import { O as Observable, s as switchMap, m as merge, f as fromEvent, d as delay, t as tap, E as EMPTY, c as combineLatest, B as BehaviorSubject, S as Subject } from "./vendor-rxjs.Bs9iBULs.chunk.js";
import { i as isPlainObject, g as get, a as isUndefined, b as isFunction, s as set, l as last, c as isNumber, d as isArray, e as isObject } from "./vendor-innoai-tech-lodash.DimVzCL6.chunk.js";
import { M as Markdown } from "./lib-nodepkg-vuemarkdown.BrhXtQeo.chunk.js";
const _JSONEditor = class _JSONEditor extends Observable {
  constructor(typedef, initials) {
    super((subscriber) => {
      const sub = __privateGet(this, _values$).subscribe(subscriber);
      return () => {
        sub.unsubscribe();
      };
    });
    __privateAdd(this, _values$, new ImmerBehaviorSubject({}));
    __privateAdd(this, _error$, new ImmerBehaviorSubject({}));
    this.typedef = typedef;
    this.initials = initials;
    __privateGet(this, _values$).next(initials);
  }
  static of(typedef, initials) {
    return new _JSONEditor(typedef, initials ?? (typedef.type == "array" ? [] : {}));
  }
  isDirty(value, path) {
  ...
  update(path, valueOrMut, defaultValue) {
    __privateGet(this, _error$).next({});
    if (path.length == 0) {
      __privateGet(this, _values$).next(valueOrMut);
      return;
    }
    if (isFunction(valueOrMut)) {
      __privateGet(this, _values$).next((values) => {
  ...
  setError(path, error) {
    ...
    __privateGet(this, _error$).next((errors) => {
      if (error === null) {
...
const Actions = styled("span", (param, param1) => {
  let { slots } = param1;
  return (Root) => {
    var _a;
    return /* @__PURE__ */ jsx(Root, {
      children: /* @__PURE__ */ jsx(ActionToolbar, {
    ...
    rx(el$, switchMap((inputEl) => {
      if (inputEl) {
        return merge(rx(fromEvent(inputEl, "focus"), tap(() => {
          status$.show();
        })), rx(fromEvent(inputEl, "blur"), delay(200), tap(() => {
          if (status$.value) {
            status$.hide();
          }
        })));
...
const Menu = component$((props, param) => {
  ...
  const handleSelected = (e) => {
    const $el = [
      ...
      var _a;
      return (_a = t == null ? void 0 : t.hasAttribute) == null ? void 0 : _a.call(t, "data-value");
    });
    if ($el) {
  ...
  return rx(open$, render((isOpen) => {
    ...
    return /* @__PURE__ */ jsx(Popper, {
      ...
      $content: /* @__PURE__ */ jsx(PopoverContainer, {
        ...
        children: (_a = slots.content) == null ? void 0 : _a.call(slots)
      }),
      children: ((_c = (_b = slots.default) == null ? void 0 : _b.call(slots)) == null ? void 0 : _c[0]) ?? null
    });
  }));
});
component$((props, param) => {
  let { slots, render } = param;
  const open$ = props.open$ ?? new PopupStatus(false);
  return rx(open$, render((isOpen) => {
    var _a, _b, _c;
    return /* @__PURE__ */ jsx(Popper, {
...
const Tooltip = component$((props, param) => {
  ...
  return rx(open$, render((isOpen) => {
    var _a;
    const child = (_a = slots.default) == null ? void 0 : _a.call(slots)[0];
    return /* @__PURE__ */ jsx(Popper, {
      isOpen,
      placement: props.placement ?? "left",
      $content: /* @__PURE__ */ jsx(TooltipWrapper, {
        children: /* @__PURE__ */ jsx(TooltipContainer, {
...
const PropName = component$((props, param) => {
  let { slots } = param;
  return () => {
    var _a;
    return /* @__PURE__ */ jsxs(PropNameView, {
      ...
      children: [
        slots.leading && /* @__PURE__ */ jsx(PropLeading, {
          "data-visible-on-hover": true,
...
const Block = component((props, param) => {
  let { slots } = param;
  ...
  return () => {
    ...
    return /* @__PURE__ */ jsxs(Fragment, {
      children: [
        /* @__PURE__ */ jsx(Token, {
          children: props.openToken
        }),
        (_a = slots.leading) == null ? void 0 : _a.call(slots),
        /* @__PURE__ */ jsxs(Teleport, {
          to: ctx.$container.value,
          children: [
            /* @__PURE__ */ jsxs(LineSection, {
              "data-indent": ctx.indent,
              children: [
                /* @__PURE__ */ jsx(Lines, {
                  ref: $container
                }),
                /* @__PURE__ */ jsx(LinesTrailing, {
                  ref: $trailing
                }),
                $trailing.value && /* @__PURE__ */ jsx(LayoutContextProvider, {
                  value: {
                    $container: $trailing,
                    indent: 1 + (ctx.indent ?? 0)
                  },
                  children: (_b = slots.trailing) == null ? void 0 : _b.call(slots)
                })
              ]
            }),
            /* @__PURE__ */ jsx(LineRow, {
              style: {
                paddingLeft: `${ctx.indent * 32}px`,
                display: "flex"
              },
              children: /* @__PURE__ */ jsx(Token, {
                children: props.closeToken
              })
            })
          ]
        }),
        $container.value && /* @__PURE__ */ jsx(LayoutContextProvider, {
          value: {
            $container,
            indent: 1 + (ctx.indent ?? 0)
          },
          children: (_c = slots.default) == null ? void 0 : _c.call(slots)
        })
      ]
    });
  };
});
const Line = component$((props, param) => {
  let { slots, render } = param;
  const ctx = LayoutContextProvider.use();
  ...
  const $line = rx(editor$.error$, render((errors) => {
    ...
    return /* @__PURE__ */ jsxs(LineContainer, {
      "data-error": hasError,
      ...
      children: [
        (props.title || props.description) && /* @__PURE__ */ jsx(LineTitle, {
          style: {
            paddingLeft: `${ctx.indent * 32}px`
          },
          children: props.description ? /* @__PURE__ */ jsx(Tooltip, {
            $title: /* @__PURE__ */ jsx(Description, {
        ...
        hasError && /* @__PURE__ */ jsx(LineError, {
          children: `${errors[pointer]}`
        })
      ]
    });
  }));
...
const CopyAsJSONIconBtn = component$((props, param) => {
...
class OneEditing extends Observable {
  constructor() {
    super((subscriber) => {
      const sub = __privateGet(this, _editing).subscribe(subscriber);
      return () => sub.unsubscribe();
    });
    __privateAdd(this, _editing, new BehaviorSubject(null));
  }
  ...
  enable(path) {
    if (!__privateGet(this, _editing).value) {
      __privateGet(this, _editing).next(JSONPointer.create(path));
    }
  }
  disable(path) {
    if (__privateGet(this, _editing).value === JSONPointer.create(path)) {
      __privateGet(this, _editing).next(null);
    }
  }
}
_editing = new WeakMap();
const OneEditingProvider = createProvider(() => new OneEditing());
const ValueInput = component$((props, param) => {
  let { render } = param;
  ...
  const commit = (value) => {
    ...
    if (props.typedef.type === "enums") {
      const enumValues = Schema.schemaProp(props.typedef, "enum") ?? [];
      value ?? (value = enumValues[selectFocus$.value.index % enumValues.length]);
    } else {
      value ?? (value = ((_a = inputEl$.value) == null ? void 0 : _a.value) ? (_b = inputEl$.value) == null ? void 0 : _b.value : void 0);
    }
  ...
  rx(merge(rx(containerEl$, tapEffect((containerEl) => {
      ...
      const resizeObserver = new ResizeObserver((entries) => {
        ...
        for (const entry of entries) {
          if (entry.contentBoxSize) {
            containerHeight = (_a = entry.contentBoxSize[0]) == null ? void 0 : _a.blockSize;
          }
        }
      });
    ...
    if (inputEl) {
      ...
      return merge(rx(fromEvent(inputEl, "blur"), tap((e) => {
        var _a, _b;
        if (e.relatedTarget) {
          if (((_a = containerEl$.value) == null ? void 0 : _a.contains(e.relatedTarget)) || ((_b = actionsEl$.value) == null ? void 0 : _b.contains(e.relatedTarget))) {
            return;
          }
        }
        e.preventDefault();
  ...
  if (props.typedef.type == "enums") {
    return rx(combineLatest([
      ...
      let [value, editing, { index }] = param2;
      const enumValues = Schema.schemaProp(props.typedef, "enum") ?? [];
      ...
      return /* @__PURE__ */ jsx(ValueContainer, {
        ...
        children: editing ? /* @__PURE__ */ jsx(Menu, {
          ...
          $content: /* @__PURE__ */ jsx("div", {
            ref: actionsEl$,
            children: enumValues.map((value2, i) => {
          ...
          children: JSON.stringify(value) ?? "undefined"
        })
      });
    }));
  }
  ...
  return () => {
    return /* @__PURE__ */ jsxs(EnumMenuItemContainer, {
      ...
      children: [
        ...
        props.label && /* @__PURE__ */ jsx(Description, {
...
const RemovePropIconBtn = component$((param, param1) => {
  let { emit } = param1;
  return () => /* @__PURE__ */ jsx(Tooltip, {
    $title: "删除属性",
    children: /* @__PURE__ */ jsx(ActionBtn, {
...
const ObjectInput = component$((props, param) => {
  let { render } = param;
  const editor$ = JSONEditorProvider.use();
  ...
  return rx(props.value$, render((obj) => {
    return /* @__PURE__ */ jsx(Block, {
      openToken: "{",
      closeToken: "}",
      $leading: /* @__PURE__ */ jsx(Actions, {
        children: /* @__PURE__ */ jsx(CopyAsJSONIconBtn, {
          value: obj
        })
      }),
      $trailing: /* @__PURE__ */ jsx(PropValueInput, {
        ctx: props.ctx,
        onAdd: (prop) => {
          editor$.update([
            ...props.ctx.path,
        ...
        options: [
          ...
          let [propName, _propValue, propSchema] = param2;
          return {
      ...
      children: [
        ...
        var _a;
        let [propName, propValue, propSchema] = param2;
        ...
        return /* @__PURE__ */ jsxs(Line, {
          ...
          children: [
            /* @__PURE__ */ jsx(PropName, {
              ...
              $leading: /* @__PURE__ */ jsx(RemovePropIconBtn, {
                onRemove: () => {
                  editor$.delete(path);
                }
              }),
            ...
            (_a = slots.$value) == null ? void 0 : _a.call(slots, propSchema, propValue, {
              ...props.ctx,
              path,
              branch: [
                ...props.ctx.branch,
...
const PropValueInput = component$((props, param) => {
  let { emit, render } = param;
  const inputEl$ = observableRef(null);
  const inputAction$ = InputActionSubject.from(inputEl$);
  const inputText$ = InputText.from(inputEl$);
  ...
  const commit = (prop) => {
    var _a;
    if (props.options) {
      prop ?? (prop = (_a = props.options[selectFocus$.value.index % props.options.length]) == null ? void 0 : _a.propName);
    } else {
      prop ?? (prop = inputText$.value);
    }
    if (prop) {
      emit("add", prop);
      reset();
  ...
  return rx(combineLatest([
    ...
    let [input, open, focus, options] = param2;
    if (options) {
      return options.length > 0 ? /* @__PURE__ */ jsx(Line, {
        path: props.ctx.path,
        children: /* @__PURE__ */ jsx(ValueContainer, {
          sx: {
            mx: -4
          },
    ...
    return /* @__PURE__ */ jsxs(AddPropMenuItemContainer, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Description, {
          children: Schema.metaProp(props.typedef, "title")
        })
      ]
    });
  };
...
const ArrayInput = component$((props, param) => {
  let { render } = param;
  const editor$ = JSONEditorProvider.use();
  const slots = JSONEditorSlotsProvider.use();
  return rx(props.value$, render((value) => {
    return /* @__PURE__ */ jsx(Block, {
      ...
      $trailing: /* @__PURE__ */ jsx(AddItemIconBtn, {
        ctx: props.ctx,
      ...
      children: [
        ...
        var _a;
        let [idx, itemValue, propSchema] = param2;
        const path = [
          ...props.ctx.path,
          idx
        ];
        return /* @__PURE__ */ jsxs(Line, {
          ...
          children: [
            /* @__PURE__ */ jsx(PropName, {
              $leading: /* @__PURE__ */ jsx(RemoteItemIconBtn, {
                onRemove: () => {
                  editor$.delete(path);
                }
              }),
            ...
            (_a = slots.$value) == null ? void 0 : _a.call(slots, propSchema, itemValue, {
              ...props.ctx,
              path,
              branch: [
                ...props.ctx.branch,
...
const AddItemIconBtn = component$((props, param) => {
  let { emit, render } = param;
  const inputEl$ = observableRef(null);
  const inputText$ = InputText.from(inputEl$);
  const inputAction$ = InputActionSubject.from(inputEl$);
  ...
  const commit = (inputValue) => {
    inputValue ?? (inputValue = inputText$.value);
    if (inputValue) {
...
const RemoteItemIconBtn = component$((param, param1) => {
  let { emit } = param1;
  return () => /* @__PURE__ */ jsx(Tooltip, {
    $title: "移除项",
    children: /* @__PURE__ */ jsx(ActionBtn, {
...
const RecordInput = component$((props, param) => {
  let { render } = param;
  const editor$ = JSONEditorProvider.use();
  const slots = JSONEditorSlotsProvider.use();
  return rx(props.value$, render((obj) => {
...
const AnyInput = component$((props, param) => {
  let { render } = param;
  return rx(props.value$, render((value) => {
    if (isArray(value)) {
    ...
    if (isObject(value)) {
      return /* @__PURE__ */ jsx(RecordInput, {
        value,
...
const JSONEditorView = component$((param, param1) => {
  let { render } = param1;
  const editor$ = JSONEditorProvider.use();
  const slots = JSONEditorSlotsProvider.use();
  ...
  return rx(editor$, render((root) => {
    ...
    return /* @__PURE__ */ jsx(OneEditingProvider, {
      children: /* @__PURE__ */ jsx(JSONEditorSlotsProvider, {
        value: {
          $value: slots.$value ?? defaultValueRender
        },
        children: /* @__PURE__ */ jsxs(JSONEditorContainer, {
          children: [
            ...
            $container.value && /* @__PURE__ */ jsx(LayoutContextProvider, {
              ...
              children: /* @__PURE__ */ jsx(Line, {
                path: [],
                viewOnly: true,
                children: valueRender(editor$.typedef, root, EmptyContext)
              })
            })
          ]
        })
