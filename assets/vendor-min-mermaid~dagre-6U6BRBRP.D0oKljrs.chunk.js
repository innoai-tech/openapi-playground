...
import { r as rr, V as Vt, F as Ft, D as Dt, J as Jt } from './vendor-min-mermaid~chunk-3XUXSURB.DiXW_q8i.chunk.js';
import { s as sg, d as da, M, e as eg, t as tg, r as rg, g as ga } from './vendor-min-mermaid~chunk-5DLFQ4IS.FNW_avIl.chunk.js';
import { n } from './vendor-min-mermaid~chunk-LM6QDVU5.BAO1h6r1.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { t as tt, h as hh } from './vendor-min-mermaid~chunk-U6SPV2NK.BkMACcv9.chunk.js';
import { s as sn, _ as _f, J as Jr } from './vendor-min-mermaid~chunk-5ZJXQJOJ.Be7I3AGN.chunk.js';
function h(e) {
    var t = {
        options: {
...
Parent cluster`, s.height), t.setNode(s.id, w), t.parent(f) || (tt.trace("Setting parent", f, s.id), t.setParent(f, s.id, w));
        ...
        if (tt.info("(Insert) Node XXX" + f + ": " + JSON.stringify(/*#__PURE__*/ t.node(f))), r?.clusterNode) {
            ...
            M(r, D), r.diff = N.diff || 0, tt.info("New compound node after recursive render XAX", f, "width", r.width, "height", r.height), eg(D, r);
        ...
        let f = /*#__PURE__*/ t.edges().map(async function(r) {
            ...
            tt.info("Edge " + r.v + " -> " + r.w + ": " + JSON.stringify(r)), tt.info("Edge " + r.v + " -> " + r.w + ": ", r, " ", /*#__PURE__*/ JSON.stringify(/*#__PURE__*/ t.edge(r))), tt.info("Fix", a, "ids:", r.v, r.w, "Translating: ", /*#__PURE__*/ a.get(r.v), /*#__PURE__*/ a.get(r.w)), await Ft(p, w);
        });
        await Promise.all(f);
    ...
    return await Promise.all(/*#__PURE__*/ te(t).map(async function(f) {
        ...
        let N = /*#__PURE__*/ Dt(m, r, a, n$1, w, E, c);
        Jt(r, N);
    ...
    rr(c, e.markers, e.type, e.diagramId), sg(), Vt(), da(), Z(), e.nodes.forEach((o)=>{
        n.setNode(o.id, {
            ...o
