import { $ as Vo, A as $o, F as Go, G as No, I as Ho, L as Ii, Q as Uo, W as Ni, bt as ot, et as Wo, gt as mr, hn as pt, ln as ia, on as Zi, pt as jo } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.BVgxNvHA.chunk.js";
...
var V = /* @__PURE__ */ Ii(), qt = class {
	...
	calculateSpace(n, f, u, c) {
		...
		}, A = this.config.titleFontSize + this.config.titlePadding * 2, h = { top: c ? A : 0 }, T = this.config.quadrantPadding + i.left, m$1 = this.config.quadrantPadding + y.top + h.top, b = this.config.chartWidth - this.config.quadrantPadding * 2 - i.left - i.right, q = this.config.chartHeight - this.config.quadrantPadding * 2 - y.top - y.bottom - h.top, p = b / 2, K = q / 2;
		return {
			xAxisSpace: y,
			yAxisSpace: i,
			titleSpace: h,
