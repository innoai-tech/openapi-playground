import { $t as isString, At as isObject$1, Bt as isUndefined, Ct as capitalize, Dt as isArray, Et as includeBooleanAttr, Ft as toNumber, Gt as mapValues, H as component, Ht as pickBy, It as padStart, Jt as set, Kt as isPlainObject, Lt as kebabCase, Mt as isSpecialBooleanAttr, Nt as isString$2, O as combineLatest, Ot as isFunction$1, Pt as isSymbol, Rt as camelCase, St as camelize, Tt as hyphenate, U as isComponent, Vt as isFunction, W as isPropTypes, Wt as omit, Xt as some, Yt as isNumber, Z as custom, bt as shallowRef, c as observableRef, ct as Fragment, d as SymbolForwardRef, dt as cloneVNode, en as last, f as ref$1, ft as createRenderer, gt as onMounted, ht as onBeforeUnmount, i as toObservable, jt as isOn, kt as isModelListener, lt as Teleport, m as rx, mt as onBeforeMount, n as tapEffect, nn as isObject, o as jsx, ot as BaseTransition, pt as h, qt as keys, rn as get, s as jsxs, st as BaseTransitionPropsValidators, t as createProvider, tn as has, u as subscribeUntilUnmount, ut as callWithAsyncErrorHandling, wt as extend, xt as unref, yt as ref, zt as isEmpty } from "./vendor-innoai-tech-vuekit.CUMstO-e.chunk.js";
import { c as __rest } from "./vendor-rxjs.SmEpAT9z.chunk.js";
var policy = void 0;
...
var Palette = class Palette {
	...
	toDesignTokens(rules = {}) {
		...
		const toTonalPalette = (t) => {
			return Object.keys(tones).reduce((ret, tone) => Object.assign(ret, { [tone]: /* @__PURE__ */ rgbFromArgb(/* @__PURE__ */ t.tone(/* @__PURE__ */ parseInt(tone))) }), {});
		};
		return {
	...
	if (element.length > -1) {
		if (!element["return"]) switch (element.type) {
			case DECLARATION:
				...
				break;
			case KEYFRAMES: return serialize([/* @__PURE__ */ copy(element, { value: /* @__PURE__ */ replace(element.value, "@", "@" + WEBKIT) })], callback);
			case RULESET: if (element.length) return combine(element.props, function(value) {
				switch (match(value, /(::plac\w+|:read-\w+)/)) {
					case ":read-only":
					case ":read-write": return serialize([/* @__PURE__ */ copy(element, { props: [/* @__PURE__ */ replace(value, /:(read-\w+)/, ":" + MOZ + "$1")] })], callback);
					case "::placeholder": return serialize([
						/* @__PURE__ */ copy(element, { props: [/* @__PURE__ */ replace(value, /:(plac\w+)/, ":" + WEBKIT + "input-$1")] }),
						/* @__PURE__ */ copy(element, { props: [/* @__PURE__ */ replace(value, /:(plac\w+)/, ":" + MOZ + "$1")] }),
						/* @__PURE__ */ copy(element, { props: [/* @__PURE__ */ replace(value, /:(plac\w+)/, MS + "input-$1")] })
					], callback);
				}
				return "";
			});
...
export { GlobalStyle as a, ThemeProvider as c, alpha as d, variant as f, CSSReset as i, defineTransition as l, createApp as m, size$1 as n, styled as o, animate as p, Overlay as r, Box as s, Popper as t, transition as u };
