...
import { S as St$1 } from "./vendor-min-mermaid~chunk-UCQ5T4NL.D8XI4L1F.chunk.js";
import { Q as Qt$1 } from "./vendor-min-mermaid~chunk-I5SP4YIW.DqV4C2Qh.chunk.js";
import { J as Je$1, X as Xe$1, S, M as M$1 } from "./vendor-min-mermaid~chunk-QS5O44OF.L_MBO-WO.chunk.js";
import { t as tt$1, H as Hl, d as df, i as ih, D as De$1, p as pl, E as Er, N as Nl, C as Cf, g as gC, h as Ef, f as dC } from "./vendor-min-mermaid~chunk-QJLC67TO.Dw34GYds.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Q7R0ayzM.chunk.js";
var C = /* @__PURE__ */ m$1(async (l, t, o) => {
  var _a2, _b2;
  let r, e = t.useHtmlLabels || df((_a2 = Hl()) == null ? void 0 : _a2.htmlLabels);
  ...
  let c = await Qt$1(h, /* @__PURE__ */ De$1(/* @__PURE__ */ Xe$1(s), /* @__PURE__ */ Hl()), {
    useHtmlLabels: e,
    width: t.width || ((_b2 = Hl().flowchart) == null ? void 0 : _b2.wrappingWidth),
    cssClasses: "markdown-node-label",
    style: t.labelStyle,
    addSvgBackground: !!t.icon || !!t.img
  }), i = /* @__PURE__ */ c.getBBox(), n2 = ((t == null ? void 0 : t.padding) ?? 0) / 2;
  if (e) {
  ...
  let r = o.useHtmlLabels || df((_b2 = (_a2 = Hl()) == null ? void 0 : _a2.flowchart) == null ? void 0 : _b2.htmlLabels), e = /* @__PURE__ */ l.insert("g").attr("class", "label").attr("style", o.labelStyle || ""), a = await Qt$1(e, /* @__PURE__ */ De$1(/* @__PURE__ */ Xe$1(t), /* @__PURE__ */ Hl()), {
    useHtmlLabels: r,
  ...
  if (df((_f2 = (_e3 = Hl()) == null ? void 0 : _e3.flowchart) == null ? void 0 : _f2.htmlLabels)) {
...
function Zs(l, t, o) {
  ...
  let e = o, a = /* @__PURE__ */ Math.max(t, 0.1), h = l[0] && l[0][0] && typeof l[0][0] == "number" ? [
    l
  ] : l, s = [
    0,
    0
  ...
  let c = /* @__PURE__ */ function(i, n2, p) {
    let f = [];
    for (let b of i) {
      let S2 = [
        ...b
    ...
    for (; d.length || g.length; ) {
      ...
      if (d = /* @__PURE__ */ d.filter((b) => !(b.edge.ymax <= y)), d.sort((b, S2) => b.edge.x === S2.edge.x ? 0 : (b.edge.x - S2.edge.x) / Math.abs(b.edge.x - S2.edge.x)), (p !== 1 || x % n2 == 0) && d.length > 1) for (let b = 0; b < d.length; b += 2) {
        let S2 = b + 1;
...
function kt(l, t) {
  ...
  e < 0 && (e = 4 * t.strokeWidth), e = /* @__PURE__ */ Math.round(/* @__PURE__ */ Math.max(e, 0.1));
  let a = 1;
...
var te = (_b = class extends Mt {
  ...
  dotsOnLines(t, o) {
    ...
    e < 0 && (e = 4 * o.strokeWidth), e = /* @__PURE__ */ Math.max(e, 0.1);
    let a = o.fillWeight;
    a < 0 && (a = o.strokeWidth / 2);
    let h = e / 4;
    for (let s of t) {
      let c = /* @__PURE__ */ Vt(s), i = c / e, n2 = Math.ceil(i) - 1, p = c - n2 * e, f = (s[0][0] + s[1][0]) / 2 - e / 4, m = /* @__PURE__ */ Math.min(s[0][1], s[1][1]);
      for (let g = 0; g < n2; g++) {
  ...
  dashedLine(t, o) {
    ...
    return t.forEach((h) => {
      let s = /* @__PURE__ */ Vt(h), c = /* @__PURE__ */ Math.floor(s / (r + e)), i = (s + e - c * (r + e)) / 2, n2 = h[0], p = h[1];
      n2[0] > p[0] && (n2 = h[1], p = h[0]);
      let f = /* @__PURE__ */ Math.atan((p[1] - n2[1]) / (p[0] - n2[0]));
      for (let m = 0; m < c; m++) {
        let g = m * (r + e), d = g + r, y = [
  ...
  zigzagLines(t, o, r) {
    ...
    return t.forEach((a) => {
      ...
      c[0] > i[0] && (c = a[1], i = a[0]);
      let n2 = /* @__PURE__ */ Math.atan((i[1] - c[1]) / (i[0] - c[0]));
      for (let p = 0; p < s; p++) {
...
function $e(l) {
  ...
  for (let { key: h, data: s } of l) switch (h) {
    ...
    case "C":
      ...
      break;
    case "c": {
      let c = /* @__PURE__ */ s.map((i, n2) => n2 % 2 ? i + o : i + t);
      a.push({
        key: "C",
        data: c
      }), t = c[4], o = c[5];
...
function Pe(l) {
  ...
  for (let { key: i, data: n2 } of l) {
    switch (i) {
      ...
      case "A": {
        let p = /* @__PURE__ */ Math.abs(n2[0]), f = /* @__PURE__ */ Math.abs(n2[1]), m = n2[2], g = n2[3], d = n2[4], y = n2[5], x = n2[6];
        p === 0 || f === 0 ? (t.push({
          key: "C",
          data: [
            r,
...
function Be(l, t, o, r, e, a, h, s, c, i) {
  ...
  if (i) [m, g, d, y] = i;
    ...
    [l, t] = /* @__PURE__ */ vt(l, t, -n2), [o, r] = /* @__PURE__ */ vt(o, r, -n2);
  ...
  x = g - m;
  let b = /* @__PURE__ */ Math.cos(m), S2 = /* @__PURE__ */ Math.sin(m), $ = /* @__PURE__ */ Math.cos(g), w = /* @__PURE__ */ Math.sin(g), P = /* @__PURE__ */ Math.tan(x / 4), B = 4 / 3 * e * P, R = 4 / 3 * a * P, j = [
    l,
    t
  ], G = [
    l + B * S2,
  ...
  ].concat(f);
  {
    ...
    for (let L = 0; L < f.length; L += 3) {
      let H = /* @__PURE__ */ vt(f[L][0], f[L][1], n2), O = /* @__PURE__ */ vt(f[L + 1][0], f[L + 1][1], n2), F = /* @__PURE__ */ vt(f[L + 2][0], f[L + 2][1], n2);
      A.push([
        H[0],
        H[1],
        O[0],
...
function Se(l, t) {
  if (l.length) {
    let o = typeof l[0][0] == "number" ? [
      l
    ] : l, r = /* @__PURE__ */ Et(o[0], 1 * (1 + 0.2 * t.roughness), t), e = t.disableMultiStroke ? [] : Et(o[0], 1.5 * (1 + 0.22 * t.roughness), /* @__PURE__ */ ve(t));
    for (let a = 1; a < o.length; a++) {
      let h = o[a];
      if (h.length) {
        let s = /* @__PURE__ */ Et(h, 1 * (1 + 0.2 * t.roughness), t), c = t.disableMultiStroke ? [] : Et(h, 1.5 * (1 + 0.22 * t.roughness), /* @__PURE__ */ ve(t));
...
m$1(Ce, "T");
function ie(l, t, o, r) {
  let [e, a] = De(r.increment, l, t, r.rx, r.ry, 1, r.increment * Lt(0.1, /* @__PURE__ */ Lt(0.4, 1, o), o), o), h = /* @__PURE__ */ Ht(e, null, o);
...
function we(l, t, o, r, e, a, h, s, c) {
  let i = l, n2 = t, p = /* @__PURE__ */ Math.abs(o / 2), f = /* @__PURE__ */ Math.abs(r / 2);
  p += /* @__PURE__ */ _(0.01 * p, c), f += /* @__PURE__ */ _(0.01 * f, c);
  let m = e, g = a;
  for (; m < 0; ) m += 2 * Math.PI, g += 2 * Math.PI;
  g - m > 2 * Math.PI && (m = 0, g = 2 * Math.PI);
  let d = 2 * Math.PI / c.curveStepCount, y = /* @__PURE__ */ Math.min(d / 2, (g - m) / 2), x = /* @__PURE__ */ Me(y, i, n2, p, f, m, g, 1, c);
  if (!c.disableMultiStroke) {
    let b = /* @__PURE__ */ Me(y, i, n2, p, f, m, g, 1.5, c);
    x.push(...b);
  }
  return h && (s ? x.push(.../* @__PURE__ */ ft(i, n2, i + p * Math.cos(m), n2 + f * Math.sin(m), c), .../* @__PURE__ */ ft(i, n2, i + p * Math.cos(g), n2 + f * Math.sin(g), c)) : x.push({
    op: "lineTo",
    data: [
      i,
      n2
...
function Ne(l, t) {
  ...
  for (let { key: h, data: s } of o) switch (h) {
    ...
    case "C": {
      let [c, i, n2, p, f, m] = s;
      r.push(.../* @__PURE__ */ Ks(c, i, n2, p, f, m, a, t)), a = [
        f,
        m
      ];
      break;
...
function ne(l, t, o, r, e, a, h) {
  ...
  let d = [], y = /* @__PURE__ */ m$1(() => _(p, e, i), "M"), x = /* @__PURE__ */ m$1(() => _(n2, e, i), "k"), b = e.preserveVertices;
  return a && (h ? d.push({
    op: "move",
    data: [
      l + (b ? 0 : y()),
...
function le(l, t, o, r) {
  ...
  if (function(s, c) {
    ...
    let c = l[t + 0], i = l[t + 1], n2 = l[t + 2], p = l[t + 3], f = /* @__PURE__ */ xt(c, i, 0.5), m = /* @__PURE__ */ xt(i, n2, 0.5), g = /* @__PURE__ */ xt(n2, p, 0.5), d = /* @__PURE__ */ xt(f, m, 0.5), y = /* @__PURE__ */ xt(m, g, 0.5), x = /* @__PURE__ */ xt(d, y, 0.5);
    le([
      c,
      f,
      d,
...
var st = "none", St = (_h = class {
  ...
  arc(t, o, r, e, a, h) {
    ...
    let i = /* @__PURE__ */ this._o(c), n2 = [], p = /* @__PURE__ */ we(t, o, r, e, a, h, s, true, i);
    ...
    } else n2.push(/* @__PURE__ */ function(f, m, g, d, y, x, b) {
      let S2 = f, $ = m, w = /* @__PURE__ */ Math.abs(g / 2), P = /* @__PURE__ */ Math.abs(d / 2);
      w += /* @__PURE__ */ _(0.01 * w, b), P += /* @__PURE__ */ _(0.01 * P, b);
      let B = y, R = x;
  ...
  path(t, o) {
    ...
    let a = r.fill && r.fill !== "transparent" && r.fill !== st, h = r.stroke !== st, s = !!(r.simplification && r.simplification < 1), c = /* @__PURE__ */ function(n2, p, f) {
      let m = /* @__PURE__ */ Pe(/* @__PURE__ */ $e(/* @__PURE__ */ pe(n2))), g = [], d = [], y = [
        0,
        0
      ], x = [], b = /* @__PURE__ */ m$1(() => {
    ...
    if (a) if (r.fillStyle === "solid") if (c.length === 1) {
      let n2 = /* @__PURE__ */ Ne(t, /* @__PURE__ */ Object.assign(/* @__PURE__ */ Object.assign({}, r), {
        disableMultiStroke: true,
        roughness: r.roughness ? r.roughness + r.fillShapeRoughnessGain : 0
      }));
      e.push({
        type: "fillPath",
        ops: /* @__PURE__ */ this._mergedShape(n2.ops)
      });
    } else e.push(/* @__PURE__ */ Jt(c, r));
    else e.push(/* @__PURE__ */ bt(c, r));
    return h && (s ? c.forEach((n2) => {
      e.push(/* @__PURE__ */ At(n2, false, r));
...
async function or(l) {
  ...
  l.label && Nl(l.label) && (r = await Cf(/* @__PURE__ */ l.label.replace(gC.lineBreakRegex, `
`), /* @__PURE__ */ Hl()));
...
var ar = /* @__PURE__ */ m$1(async (l, t, o, r) => {
  let e = l || "";
  if (typeof e == "object" && (e = e[0]), df(Hl().flowchart.htmlLabels)) {
...
var Ge = /* @__PURE__ */ m$1((l) => {
  ...
  return l.forEach((o) => {
    let [r, e] = o.split(":");
    t.set(/* @__PURE__ */ r.trim(), e == null ? void 0 : e.trim());
  }), t;
...
var Ee = /* @__PURE__ */ m$1(async (l, t) => {
  ...
  if (t.look === "handDrawn") {
    let B = /* @__PURE__ */ v.svg(p), R = /* @__PURE__ */ D(t, {
      ...
      fillWeight: 3,
      seed: e
    }), j = /* @__PURE__ */ B.path(/* @__PURE__ */ J(b, S2, y, x, 0), R);
  ...
  } else $ = /* @__PURE__ */ p.insert("rect", ":first-child"), $.attr("style", c).attr("rx", t.rx).attr("ry", t.ry).attr("x", b).attr("y", S2).attr("width", y).attr("height", x);
  ...
  let o = /* @__PURE__ */ Hl(), { themeVariables: r, handDrawnSeed: e } = o, { altBackground: a, compositeBackground: h, compositeTitleBackground: s, nodeBorder: c } = r, i = /* @__PURE__ */ l.insert("g").attr("class", t.cssClasses).attr("id", t.id).attr("data-id", t.id).attr("data-look", t.look), n2 = /* @__PURE__ */ i.insert("g", ":first-child"), p = /* @__PURE__ */ i.insert("g").attr("class", "cluster-label"), f = /* @__PURE__ */ i.append("rect"), m = /* @__PURE__ */ p.node().appendChild(await $t(t.label, t.labelStyle, void 0, true)), g = /* @__PURE__ */ m.getBBox();
  if (df(o.flowchart.htmlLabels)) {
  ...
  if (t.look === "handDrawn") {
    ...
    let I = /* @__PURE__ */ G.rectangle($, P, x, S2, {
      fill: j ? a : h,
  ...
  } else B = /* @__PURE__ */ n2.insert("rect", ":first-child"), B.attr("class", "outer").attr("x", $).attr("y", w).attr("width", x).attr("height", b).attr("data-look", t.look), f.attr("class", "inner").attr("x", $).attr("y", P).attr("width", x).attr("height", S2);
  p.attr("transform", `translate(${t.x - g.width / 2}, ${w + 1 - (df(o.flowchart.htmlLabels) ? 0 : 3)})`);
  ...
  if (t.look === "handDrawn") {
    let B = /* @__PURE__ */ v.svg(p), R = /* @__PURE__ */ D(t, {
      ...
      fillWeight: 4,
      seed: e
    }), j = /* @__PURE__ */ B.path(/* @__PURE__ */ J(b, S2, y, x, t.rx), R);
    $ = /* @__PURE__ */ p.insert(() => (tt$1.debug("Rough node insert CXC", j), j), ":first-child"), $.select("path:nth-child(2)").attr("style", /* @__PURE__ */ i.join(";")), $.select("path").attr("style", /* @__PURE__ */ n$1.join(";").replace("fill", "stroke"));
  } else $ = /* @__PURE__ */ p.insert("rect", ":first-child"), $.attr("style", c).attr("rx", t.rx).attr("ry", t.ry).attr("x", b).attr("y", S2).attr("width", y).attr("height", x);
  let { subGraphTitleTopMargin: w } = n(o);
  if (m.attr("transform", `translate(${t.x - d.width / 2}, ${t.y - t.height / 2 + w})`), s) {
  ...
  let m;
  if (t.look === "handDrawn") {
    let y = /* @__PURE__ */ v.svg(h).rectangle(p, f, i, n2, {
      fill: "lightgrey",
      roughness: 0.5,
      strokeLineDash: [
        5
  ...
  } else m = /* @__PURE__ */ s.insert("rect", ":first-child"), m.attr("class", "divider").attr("x", p).attr("y", f).attr("width", i).attr("height", n2).attr("data-look", t.look);
  ...
  divider: pr,
  kanbanSection: hr
}, je = /* @__PURE__ */ new Map(), yo = /* @__PURE__ */ m$1(async (l, t) => {
...
function dr(l, t, o, r) {
  ...
  r.x < e && (i = -i);
  var n2 = /* @__PURE__ */ Math.abs(t * o * s / c);
  return r.y < a && (n2 = -n2), {
    x: e + i,
    y: a + n2
  };
...
function yr(l, t, o, r) {
  ...
  if (e = t.y - l.y, h = l.x - t.x, c = t.x * l.y - l.x * t.y, f = e * o.x + h * o.y + c, m = e * r.x + h * r.y + c, !(f !== 0 && m !== 0 && Le(f, m)) && (a = r.y - o.y, s = o.x - r.x, i = r.x * o.y - o.x * r.y, n2 = a * l.x + s * l.y + i, p = a * t.x + s * t.y + i, !(n2 !== 0 && p !== 0 && Le(n2, p)) && (g = e * s - a * h, g !== 0))) return d = /* @__PURE__ */ Math.abs(g / 2), y = h * i - s * c, x = y < 0 ? (y - d) / g : (y + d) / g, y = a * c - e * i, b = y < 0 ? (y - d) / g : (y + d) / g, {
    x,
    y: b
  };
}
...
function xr(l, t, o) {
  ...
  return a.length ? (a.length > 1 && a.sort(function(n2, p) {
    let f = n2.x - o.x, m = n2.y - o.y, g = /* @__PURE__ */ Math.sqrt(f * f + m * m), d = p.x - o.x, y = p.y - o.y, x = /* @__PURE__ */ Math.sqrt(d * d + y * y);
...
function Ve(l, t) {
  ...
  let n2 = /* @__PURE__ */ c.circle(0, 0, h * 2, i), p = /* @__PURE__ */ a.insert(() => n2, ":first-child");
...
function Ie(l, t, o, r, e, a, h) {
  let c = (l + o) / 2, i = (t + r) / 2, n2 = /* @__PURE__ */ Math.atan2(r - t, o - l), p = (o - l) / 2, f = (r - t) / 2, m = p / e, g = f / a, d = /* @__PURE__ */ Math.sqrt(m ** 2 + g ** 2);
  if (d > 1) throw new Error("The given radii are too small to create an arc between the points.");
  let y = /* @__PURE__ */ Math.sqrt(1 - d ** 2), x = c + y * a * Math.sin(n2) * (h ? -1 : 1), b = i - y * e * Math.cos(n2) * (h ? -1 : 1), S2 = /* @__PURE__ */ Math.atan2((t - b) / a, (l - x) / e), w = Math.atan2((r - b) / a, (o - x) / e) - S2;
...
async function Fe(l, t) {
  ...
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = a.width + t.padding + 20, s = a.height + t.padding, c = s / 2, i = c / (2.5 + s / 50), { cssStyles: n2 } = t, p = [
    {
      x: h / 2,
      y: -s / 2
    },
...
async function _e(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = a.height + t.padding, s = 12, c = a.width + t.padding + s, i = 0, n2 = c, p = -h, f = 0, m = [
    {
      x: i + s,
      y: p
    },
  ...
  if (t.look === "handDrawn") {
    let y = /* @__PURE__ */ v.svg(e), x = /* @__PURE__ */ D(t, {}), b = /* @__PURE__ */ V(m), S2 = /* @__PURE__ */ y.path(b, x);
    g = /* @__PURE__ */ e.insert(() => S2, ":first-child").attr("transform", `translate(${-c / 2}, ${h / 2})`), d && g.attr("style", d);
...
function ze(l, t) {
  ...
  let i = /* @__PURE__ */ V(h), n2 = /* @__PURE__ */ s.path(i, c), p = /* @__PURE__ */ r.insert(() => n2, ":first-child");
...
async function qe(l, t) {
  ...
  if (t.look === "handDrawn") {
    let n2 = /* @__PURE__ */ v.svg(e), p = /* @__PURE__ */ D(t, {}), f = /* @__PURE__ */ n2.circle(0, 0, s * 2, p);
...
function Xe(l, t) {
  ...
  let e = /* @__PURE__ */ l.insert("g").attr("class", /* @__PURE__ */ T(t)).attr("id", t.domId ?? t.id), a = /* @__PURE__ */ Math.max(30, (t == null ? void 0 : t.width) ?? 0), { cssStyles: h } = t, s = /* @__PURE__ */ v.svg(e), c = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (c.roughness = 0, c.fillStyle = "solid");
  let i = /* @__PURE__ */ s.circle(0, 0, a * 2, c), n2 = /* @__PURE__ */ br(a), p = /* @__PURE__ */ s.path(n2, c), f = /* @__PURE__ */ e.insert(() => i, ":first-child");
...
async function Ye(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = a.width + (t.padding ?? 0), c = a.height + (t.padding ?? 0), i = /* @__PURE__ */ Math.max(5, c * 0.1), { cssStyles: n2 } = t, p = [
    ...
    .../* @__PURE__ */ dt(s / 2 + s * 0.1, -i, i, 20, -180, -270),
    .../* @__PURE__ */ dt(s / 2 + s * 0.1, i, i, 20, -90, -180),
    {
      x: -s / 2 - i,
      y: c / 2
    },
  ...
  let y = /* @__PURE__ */ V(p).replace("Z", ""), x = /* @__PURE__ */ m.path(y, g), b = /* @__PURE__ */ V(f), S2 = /* @__PURE__ */ m.path(b, {
    ...g
...
async function Qe(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = 80, s = 20, c = /* @__PURE__ */ Math.max(h, (a.width + (t.padding ?? 0) * 2) * 1.25, (t == null ? void 0 : t.width) ?? 0), i = /* @__PURE__ */ Math.max(s, a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), n2 = i / 2, { cssStyles: p } = t, f = /* @__PURE__ */ v.svg(e), m = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  let g = c, d = i, y = g - n2, x = d / 4, b = [
    ...
    .../* @__PURE__ */ Rt(-y, -d / 2, n2, 50, 270, 90)
  ], S2 = /* @__PURE__ */ V(b), $ = /* @__PURE__ */ f.path(S2, m), w = /* @__PURE__ */ e.insert(() => $, ":first-child");
...
async function Je(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + t.padding, t.width ?? 0), c = s / 2, i = c / (2.5 + s / 50), n2 = /* @__PURE__ */ Math.max(a.height + i + t.padding, t.height ?? 0), p, { cssStyles: f } = t;
  if (t.look === "handDrawn") {
    let m = /* @__PURE__ */ v.svg(e), g = /* @__PURE__ */ wr(0, 0, s, n2, c, i), d = /* @__PURE__ */ Nr(0, i, s, n2, c, i), y = /* @__PURE__ */ m.path(g, /* @__PURE__ */ D(t, {})), x = /* @__PURE__ */ m.path(d, /* @__PURE__ */ D(t, {
      fill: "none"
    }));
    p = /* @__PURE__ */ e.insert(() => x, ":first-child"), p = /* @__PURE__ */ e.insert(() => y, ":first-child"), p.attr("class", "basic label-container"), f && p.attr("style", f);
  } else {
    let m = /* @__PURE__ */ Sr(0, 0, s, n2, c, i);
...
async function Ke(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = a.width + t.padding, c = a.height + t.padding, i = c * 0.2, n2 = -s / 2, p = -c / 2 - i / 2, { cssStyles: f } = t, m = /* @__PURE__ */ v.svg(e), g = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  let d = [
    {
      x: n2,
...
async function ts(l, t) {
  ...
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, halfPadding: h } = await C(l, t, /* @__PURE__ */ T(t)), c = a.width / 2 + h + 5, i = a.width / 2 + h, n2, { cssStyles: p } = t;
  if (t.look === "handDrawn") {
    ...
    n2 = /* @__PURE__ */ e.insert("g", ":first-child"), n2.attr("class", /* @__PURE__ */ Je$1(t.cssClasses)).attr("style", /* @__PURE__ */ Je$1(p)), (_a2 = n2.node()) == null ? void 0 : _a2.appendChild(d), (_b2 = n2.node()) == null ? void 0 : _b2.appendChild(y);
  } else {
    n2 = /* @__PURE__ */ e.insert("g", ":first-child");
    let f = /* @__PURE__ */ n2.insert("circle", ":first-child"), m = /* @__PURE__ */ n2.insert("circle");
...
function es(l, t, param) {
  ...
  let a = /* @__PURE__ */ l.insert("g").attr("class", /* @__PURE__ */ T(t)).attr("id", t.domId ?? t.id), h = 7, { cssStyles: s } = t, c = /* @__PURE__ */ v.svg(a), { nodeBorder: i } = o, n2 = /* @__PURE__ */ D(t, {
    fillStyle: "solid"
  });
  t.look !== "handDrawn" && (n2.roughness = 0);
  let p = /* @__PURE__ */ c.circle(0, 0, h * 2, n2), f = /* @__PURE__ */ a.insert(() => p, ":first-child");
...
async function ss(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = a.width + (t.padding ?? 0), c = s + a.height, i = s + a.height, n2 = [
    {
      x: 0,
      y: -c
    },
  ...
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  let g = /* @__PURE__ */ V(n2), d = /* @__PURE__ */ f.path(g, m), y = /* @__PURE__ */ e.insert(() => d, ":first-child").attr("transform", `translate(${-c / 2}, ${c / 2})`);
...
function rs(l, t, param) {
  ...
  t.label = "";
  let h = /* @__PURE__ */ l.insert("g").attr("class", /* @__PURE__ */ T(t)).attr("id", t.domId ?? t.id), { cssStyles: s } = t, c = /* @__PURE__ */ Math.max(70, (t == null ? void 0 : t.width) ?? 0), i = /* @__PURE__ */ Math.max(10, (t == null ? void 0 : t.height) ?? 0);
  o === "LR" && (c = /* @__PURE__ */ Math.max(10, (t == null ? void 0 : t.width) ?? 0), i = /* @__PURE__ */ Math.max(70, (t == null ? void 0 : t.height) ?? 0));
  let n2 = -1 * c / 2, p = -1 * i / 2, f = /* @__PURE__ */ v.svg(h), m = /* @__PURE__ */ D(t, {
    stroke: e.lineColor,
    fill: e.lineColor
  });
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  let g = /* @__PURE__ */ f.rectangle(n2, p, c, i, m), d = /* @__PURE__ */ h.insert(() => g, ":first-child");
...
async function os(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let e = 80, a = 50, { shapeSvg: h, bbox: s } = await C(l, t, /* @__PURE__ */ T(t)), c = /* @__PURE__ */ Math.max(e, s.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), i = /* @__PURE__ */ Math.max(a, s.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), n2 = i / 2, { cssStyles: p } = t, f = /* @__PURE__ */ v.svg(h), m = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  let g = [
    {
      x: -c / 2,
    ...
    .../* @__PURE__ */ Rt(-c / 2 + n2, 0, n2, 50, 90, 270),
    {
      x: c / 2 - n2,
      y: i / 2
    },
...
async function as(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = 4, s = a.height + t.padding, c = s / h, i = a.width + 2 * c + t.padding, n2 = [
    {
      x: c,
      y: 0
    },
...
async function is(l, t) {
  ...
  let { shapeSvg: e } = await C(l, t, /* @__PURE__ */ T(t)), a = /* @__PURE__ */ Math.max(30, (t == null ? void 0 : t.width) ?? 0), h = /* @__PURE__ */ Math.max(30, (t == null ? void 0 : t.height) ?? 0), { cssStyles: s } = t, c = /* @__PURE__ */ v.svg(e), i = /* @__PURE__ */ D(t, {});
  ...
  ], p = /* @__PURE__ */ V(n2), f = /* @__PURE__ */ c.path(p, i), m = /* @__PURE__ */ e.insert(() => f, ":first-child");
...
async function ns(l, t, param) {
  ...
  t.labelStyle = e;
  let a = t.assetHeight ?? 48, h = t.assetWidth ?? 48, s = /* @__PURE__ */ Math.max(a, h), c = r == null ? void 0 : r.wrappingWidth;
  t.width = /* @__PURE__ */ Math.max(s, c ?? 0);
  let { shapeSvg: i, bbox: n2, label: p } = await C(l, t, "icon-shape default"), f = t.pos === "t", m = s, g = s, { nodeBorder: d } = o, { stylesMap: y } = nt(t), x = -g / 2, b = -m / 2, S2 = t.label ? 8 : 0, $ = /* @__PURE__ */ v.svg(i), w = /* @__PURE__ */ D(t, {
    stroke: "none",
    fill: "none"
  });
  t.look !== "handDrawn" && (w.roughness = 0, w.fillStyle = "solid");
  let P = /* @__PURE__ */ $.rectangle(x, b, g, m, w), B = /* @__PURE__ */ Math.max(g, n2.width), R = m + n2.height + S2, j = /* @__PURE__ */ $.rectangle(-B / 2, -R / 2, B, R, {
    ...w,
    fill: "transparent",
    stroke: "none"
...
async function ls(l, t, param) {
  ...
  let a = t.assetHeight ?? 48, h = t.assetWidth ?? 48, s = /* @__PURE__ */ Math.max(a, h), c = r == null ? void 0 : r.wrappingWidth;
  t.width = /* @__PURE__ */ Math.max(s, c ?? 0);
  let { shapeSvg: i, bbox: n2, label: p } = await C(l, t, "icon-shape default"), f = 20, m = t.label ? 8 : 0, g = t.pos === "t", { nodeBorder: d, mainBkg: y } = o, { stylesMap: x } = nt(t), b = /* @__PURE__ */ v.svg(i), S2 = /* @__PURE__ */ D(t, {});
  ...
  let P = /* @__PURE__ */ w.node().getBBox(), B = P.width, R = P.height, j = P.x, G = P.y, E = Math.max(B, R) * Math.SQRT2 + f * 2, I = /* @__PURE__ */ b.circle(0, 0, E, S2), A = /* @__PURE__ */ Math.max(E, n2.width), L = E + n2.height + m, H = /* @__PURE__ */ b.rectangle(-A / 2, -L / 2, A, L, {
    ...S2,
    fill: "transparent",
    stroke: "none"
...
async function cs(l, t, param) {
  ...
  let a = t.assetHeight ?? 48, h = t.assetWidth ?? 48, s = /* @__PURE__ */ Math.max(a, h), c = r == null ? void 0 : r.wrappingWidth;
  t.width = /* @__PURE__ */ Math.max(s, c ?? 0);
  let { shapeSvg: i, bbox: n2, halfPadding: p, label: f } = await C(l, t, "icon-shape default"), m = t.pos === "t", g = s + p * 2, d = s + p * 2, { nodeBorder: y, mainBkg: x } = o, { stylesMap: b } = nt(t), S2 = -d / 2, $ = -g / 2, w = t.label ? 8 : 0, P = /* @__PURE__ */ v.svg(i), B = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (B.roughness = 0, B.fillStyle = "solid");
  let R = /* @__PURE__ */ b.get("fill");
  B.stroke = R ?? x;
  let j = /* @__PURE__ */ P.path(/* @__PURE__ */ J(S2, $, d, g, 5), B), G = /* @__PURE__ */ Math.max(d, n2.width), E = g + n2.height + w, I = /* @__PURE__ */ P.rectangle(-G / 2, -E / 2, G, E, {
    ...B,
    fill: "transparent",
    stroke: "none"
...
async function hs(l, t, param) {
  ...
  let R = /* @__PURE__ */ b.get("fill");
  B.stroke = R ?? x;
  let j = /* @__PURE__ */ P.path(/* @__PURE__ */ J(S2, $, d, g, 0.1), B), G = /* @__PURE__ */ Math.max(d, n2.width), E = g + n2.height + w, I = /* @__PURE__ */ P.rectangle(-G / 2, -E / 2, G, E, {
    ...B,
    fill: "transparent",
    stroke: "none"
...
async function ps(l, t, param) {
  ...
  let c = /* @__PURE__ */ Math.max(t.label ? s ?? 0 : 0, (t == null ? void 0 : t.assetWidth) ?? e), i = t.constraint === "on" && (t == null ? void 0 : t.assetHeight) ? t.assetHeight * t.imageAspectRatio : c, n2 = t.constraint === "on" ? i / t.imageAspectRatio : (t == null ? void 0 : t.assetHeight) ?? a;
  t.width = /* @__PURE__ */ Math.max(i, s ?? 0);
  let { shapeSvg: p, bbox: f, label: m } = await C(l, t, "image-shape default"), g = t.pos === "t", d = -i / 2, y = -n2 / 2, x = t.label ? 8 : 0, b = /* @__PURE__ */ v.svg(p), S2 = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (S2.roughness = 0, S2.fillStyle = "solid");
  let $ = /* @__PURE__ */ b.rectangle(d, y, i, n2, S2), w = /* @__PURE__ */ Math.max(i, f.width), P = n2 + f.height + x, B = /* @__PURE__ */ b.rectangle(-w / 2, -P / 2, w, P, {
    ...S2,
    fill: "none",
    stroke: "none"
...
async function ms(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), s = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), c = [
    {
      x: 0,
      y: 0
    },
  ...
  if (t.look === "handDrawn") {
    ...
    i = /* @__PURE__ */ e.insert(() => g, ":first-child").attr("transform", `translate(${-h / 2}, ${s / 2})`), n2 && i.attr("style", n2);
...
async function ct(l, t, o) {
  let { labelStyles: r, nodeStyles: e } = k(t);
  t.labelStyle = r;
  let { shapeSvg: a, bbox: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(h.width + o.labelPaddingX * 2, (t == null ? void 0 : t.width) || 0), c = /* @__PURE__ */ Math.max(h.height + o.labelPaddingY * 2, (t == null ? void 0 : t.height) || 0), i = -s / 2, n2 = -c / 2, p, { rx: f, ry: m } = t, { cssStyles: g } = t;
  if ((o == null ? void 0 : o.rx) && o.ry && (f = o.rx, m = o.ry), t.look === "handDrawn") {
    let d = /* @__PURE__ */ v.svg(a), y = /* @__PURE__ */ D(t, {}), x = f || m ? d.path(/* @__PURE__ */ J(i, n2, s, c, f || 0), y) : d.rectangle(i, n2, s, c, y);
    p = /* @__PURE__ */ a.insert(() => x, ":first-child"), p.attr("class", "basic label-container").attr("style", /* @__PURE__ */ Je$1(g));
  } else p = /* @__PURE__ */ a.insert("rect", ":first-child"), p.attr("class", "basic label-container").attr("style", e).attr("rx", /* @__PURE__ */ Je$1(f)).attr("ry", /* @__PURE__ */ Je$1(m)).attr("x", i).attr("y", n2).attr("width", s).attr("height", c);
...
async function gs(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0), (t == null ? void 0 : t.width) ?? 0), s = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0), (t == null ? void 0 : t.height) ?? 0), c = [
    {
      x: 0,
      y: 0
    },
...
function us(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.label = "", t.labelStyle = o;
  let e = /* @__PURE__ */ l.insert("g").attr("class", /* @__PURE__ */ T(t)).attr("id", t.domId ?? t.id), { cssStyles: a } = t, h = /* @__PURE__ */ Math.max(35, (t == null ? void 0 : t.width) ?? 0), s = /* @__PURE__ */ Math.max(35, (t == null ? void 0 : t.height) ?? 0), c = 7, i = [
    {
      x: h,
      y: 0
    },
  ...
  ], n2 = /* @__PURE__ */ v.svg(e), p = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (p.roughness = 0, p.fillStyle = "solid");
  let f = /* @__PURE__ */ V(i), m = /* @__PURE__ */ n2.path(f, p), g = /* @__PURE__ */ e.insert(() => m, ":first-child");
...
async function ys(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0), t.width ?? 0), c = s / 2, i = c / (2.5 + s / 50), n2 = /* @__PURE__ */ Math.max(a.height + i + (t.padding ?? 0), t.height ?? 0), p = n2 * 0.1, f, { cssStyles: m } = t;
  if (t.look === "handDrawn") {
    let g = /* @__PURE__ */ v.svg(e), d = /* @__PURE__ */ Mr(0, 0, s, n2, c, i, p), y = /* @__PURE__ */ kr(0, i, s, n2, c, i), x = /* @__PURE__ */ D(t, {}), b = /* @__PURE__ */ g.path(d, x), S2 = /* @__PURE__ */ g.path(y, x);
    e.insert(() => S2, ":first-child").attr("class", "line"), f = /* @__PURE__ */ e.insert(() => b, ":first-child"), f.attr("class", "basic label-container"), m && f.attr("style", m);
  } else {
    let g = /* @__PURE__ */ Dr(0, 0, s, n2, c, i, p);
...
async function xs(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), c = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), i = c / 4, n2 = c + i, { cssStyles: p } = t, f = /* @__PURE__ */ v.svg(e), m = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  let g = [
    {
      x: -s / 2 - s / 2 * 0.1,
    ...
    .../* @__PURE__ */ at(-s / 2 - s / 2 * 0.1, n2 / 2, s / 2 + s / 2 * 0.1, n2 / 2, i, 0.8),
    {
      x: s / 2 + s / 2 * 0.1,
      y: -n2 / 2
    },
...
async function bs(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), c = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), i = 5, n2 = -s / 2, p = -c / 2, { cssStyles: f } = t, m = /* @__PURE__ */ v.svg(e), g = /* @__PURE__ */ D(t, {}), d = [
    {
      x: n2 - i,
      y: p + i
    },
  ...
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  let x = /* @__PURE__ */ V(d), b = /* @__PURE__ */ m.path(x, g), S2 = /* @__PURE__ */ V(y), $ = /* @__PURE__ */ m.path(S2, {
    ...g,
    fill: "none"
...
async function Ss(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), c = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), i = c / 4, n2 = c + i, p = -s / 2, f = -n2 / 2, m = 5, { cssStyles: g } = t, d = /* @__PURE__ */ at(p - m, f + n2 + m, p + s - m, f + n2 + m, i, 0.8), y = d == null ? void 0 : d[d.length - 1], x = [
    {
      x: p - m,
      y: f + m
    },
  ...
  ], S2 = /* @__PURE__ */ v.svg(e), $ = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && ($.roughness = 0, $.fillStyle = "solid");
  let w = /* @__PURE__ */ V(x), P = /* @__PURE__ */ S2.path(w, $), B = /* @__PURE__ */ V(b), R = /* @__PURE__ */ S2.path(B, $), j = /* @__PURE__ */ e.insert(() => P, ":first-child");
...
async function ws(l, t, param) {
  ...
  let { shapeSvg: h, bbox: s } = await C(l, t, /* @__PURE__ */ T(t)), c = /* @__PURE__ */ Math.max(s.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), i = /* @__PURE__ */ Math.max(s.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), n2 = -c / 2, p = -i / 2, { cssStyles: f } = t, m = /* @__PURE__ */ v.svg(h), g = /* @__PURE__ */ D(t, {
    fill: o.noteBkgColor,
    stroke: o.noteBorderColor
  });
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  let d = /* @__PURE__ */ m.rectangle(n2, p, c, i, g), y = /* @__PURE__ */ h.insert(() => d, ":first-child");
...
async function Ns(l, t) {
  ...
  if (t.look === "handDrawn") {
    ...
    n2 = /* @__PURE__ */ e.insert(() => d, ":first-child").attr("transform", `translate(${-c / 2}, ${c / 2})`), p && n2.attr("style", p);
  } else n2 = /* @__PURE__ */ K(e, c, c, i);
...
async function vs(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0), (t == null ? void 0 : t.width) ?? 0), c = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0), (t == null ? void 0 : t.height) ?? 0), i = -s / 2, n2 = -c / 2, p = n2 / 2, f = [
    {
      x: i + p,
      y: n2
    },
...
async function Ds(l, t) {
  ...
  let a = /* @__PURE__ */ l.insert("g").attr("class", e).attr("id", t.domId || t.id), h = /* @__PURE__ */ a.insert("g"), s = /* @__PURE__ */ a.insert("g").attr("class", "label").attr("style", r), c = t.description, i = t.label, n2 = /* @__PURE__ */ s.node().appendChild(await $t(i, t.labelStyle, true, true)), p = {
    width: 0,
    height: 0
  };
  if (df((_b2 = (_a2 = Hl()) == null ? void 0 : _a2.flowchart) == null ? void 0 : _b2.htmlLabels)) {
    let R = n2.children[0], j = /* @__PURE__ */ ih(n2);
    p = /* @__PURE__ */ R.getBoundingClientRect(), j.attr("width", p.width), j.attr("height", p.height);
  }
  tt$1.info("Text 2", c);
  let f = c || [], m = /* @__PURE__ */ n2.getBBox(), g = /* @__PURE__ */ s.node().appendChild(await $t(f.join ? f.join("<br/>") : f, t.labelStyle, true, true)), d = g.children[0], y = /* @__PURE__ */ ih(g);
  p = /* @__PURE__ */ d.getBoundingClientRect(), y.attr("width", p.width), y.attr("height", p.height);
  let x = (t.padding || 0) / 2;
  ih(g).attr("transform", "translate( " + (p.width > m.width ? 0 : (m.width - p.width) / 2) + ", " + (m.height + x + 5) + ")"), ih(n2).attr("transform", "translate( " + (p.width < m.width ? 0 : -(m.width - p.width) / 2) + ", 0)"), p = /* @__PURE__ */ s.node().getBBox(), s.attr("transform", "translate(" + -p.width / 2 + ", " + (-p.height / 2 - x + 3) + ")");
  let b = p.width + (t.padding || 0), S2 = p.height + (t.padding || 0), $ = -p.width / 2 - x, w = -p.height / 2 - x, P, B;
  if (t.look === "handDrawn") {
    let R = /* @__PURE__ */ v.svg(a), j = /* @__PURE__ */ D(t, {}), G = /* @__PURE__ */ R.path(/* @__PURE__ */ J($, w, b, S2, t.rx || 0), j), E = /* @__PURE__ */ R.line(-p.width / 2 - x, -p.height / 2 - x + m.height + x, p.width / 2 + x, -p.height / 2 - x + m.height + x, j);
...
async function ks(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = (t == null ? void 0 : t.padding) ?? 0, c = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), i = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), n2 = -a.width / 2 - s, p = -a.height / 2 - s, { cssStyles: f } = t, m = /* @__PURE__ */ v.svg(e), g = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  let d = [
    {
      x: n2,
...
async function $s(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), c = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), i = -s / 2, n2 = -c / 2, { cssStyles: p } = t, f = /* @__PURE__ */ v.svg(e), m = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (m.roughness = 0, m.fillStyle = "solid");
  let g = [
    {
      x: i,
...
async function Bs(l, t) {
  ...
  if (t.look === "handDrawn") {
    let n2 = /* @__PURE__ */ v.svg(e), p = /* @__PURE__ */ D(t, {}), f = /* @__PURE__ */ J(-s / 2, -h / 2, s, h, h / 2), m = /* @__PURE__ */ n2.path(f, p);
...
function Cs(l, t, param) {
  ...
  let { labelStyles: r, nodeStyles: e } = k(t);
  t.labelStyle = r;
  let { cssStyles: a } = t, { lineColor: h, stateBorder: s, nodeBorder: c } = o, i = /* @__PURE__ */ l.insert("g").attr("class", "node default").attr("id", t.domId || t.id), n2 = /* @__PURE__ */ v.svg(i), p = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (p.roughness = 0, p.fillStyle = "solid");
  let f = /* @__PURE__ */ n2.circle(0, 0, 14, {
    ...p,
    stroke: h,
    strokeWidth: 2
  }), m = s ?? c, g = /* @__PURE__ */ n2.circle(0, 0, 5, {
    ...p,
    fill: m,
    stroke: m,
    strokeWidth: 2,
...
async function Gs(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = ((t == null ? void 0 : t.padding) || 0) / 2, s = a.width + t.padding, c = a.height + t.padding, i = -a.width / 2 - h, n2 = -a.height / 2 - h, p = [
    {
      x: 0,
      y: 0
    },
  ...
  if (t.look === "handDrawn") {
    let f = /* @__PURE__ */ v.svg(e), m = /* @__PURE__ */ D(t, {}), g = /* @__PURE__ */ f.rectangle(i - 8, n2, s + 16, c, m), d = /* @__PURE__ */ f.line(i, n2, i, n2 + c, m), y = /* @__PURE__ */ f.line(i + s, n2, i + s, n2 + c, m);
...
async function Es(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), s = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), c = -h / 2, i = -s / 2, n2 = 0.2 * s, p = 0.2 * s, { cssStyles: f } = t, m = /* @__PURE__ */ v.svg(e), g = /* @__PURE__ */ D(t, {}), d = [
    {
      x: c - n2 / 2,
      y: i
    },
...
async function js(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), c = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), i = c / 4, n2 = 0.2 * s, p = 0.2 * c, f = c + i, { cssStyles: m } = t, g = /* @__PURE__ */ v.svg(e), d = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
  let y = [
    {
      x: -s / 2 - s / 2 * 0.1,
    ...
    .../* @__PURE__ */ at(-s / 2 - s / 2 * 0.1, f / 2, s / 2 + s / 2 * 0.1, f / 2, i, 0.8),
    {
      x: s / 2 + s / 2 * 0.1,
      y: -f / 2
    },
    ...
    .../* @__PURE__ */ at(x + s, (b + c) * 1.3, x + s - n2, (b + c) * 1.5, -c * 0.03, 0.5)
  ], $ = /* @__PURE__ */ V(y), w = /* @__PURE__ */ g.path($, d), P = /* @__PURE__ */ V(S2), B = /* @__PURE__ */ g.path(P, {
    ...d,
    fillStyle: "solid"
...
async function As(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = /* @__PURE__ */ Math.max(a.width + t.padding, (t == null ? void 0 : t.width) || 0), s = /* @__PURE__ */ Math.max(a.height + t.padding, (t == null ? void 0 : t.height) || 0), c = -h / 2, i = -s / 2, n2 = /* @__PURE__ */ e.insert("rect", ":first-child");
...
async function Os(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h, halfPadding: s } = await C(l, t, /* @__PURE__ */ T(t)), c = t.look === "neo" ? s * 2 : s, i = a.height + c, n2 = i / 2, p = n2 / (2.5 + i / 50), f = a.width + p + c, { cssStyles: m } = t, g;
  if (t.look === "handDrawn") {
    let d = /* @__PURE__ */ v.svg(e), y = /* @__PURE__ */ Br(0, 0, f, i, p, n2), x = /* @__PURE__ */ Tr(0, 0, f, i, p, n2), b = /* @__PURE__ */ d.path(y, /* @__PURE__ */ D(t, {})), S2 = /* @__PURE__ */ d.path(x, /* @__PURE__ */ D(t, {
      fill: "none"
    }));
    g = /* @__PURE__ */ e.insert(() => S2, ":first-child"), g = /* @__PURE__ */ e.insert(() => b, ":first-child"), g.attr("class", "basic label-container"), m && g.attr("style", m);
  } else {
    let d = /* @__PURE__ */ Pr(0, 0, f, i, p, n2);
...
async function Hs(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = 60, s = 20, c = /* @__PURE__ */ Math.max(h, a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), i = /* @__PURE__ */ Math.max(s, a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), { cssStyles: n2 } = t, p = /* @__PURE__ */ v.svg(e), f = /* @__PURE__ */ D(t, {});
...
async function Ws(l, t) {
  ...
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ df((_a2 = Hl().flowchart) == null ? void 0 : _a2.htmlLabels), c = a.width + (t.padding ?? 0), i = c + a.height, n2 = c + a.height, p = [
    {
      x: 0,
      y: 0
    },
...
async function Vs(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a, label: h } = await C(l, t, /* @__PURE__ */ T(t)), s = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), c = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), i = c / 8, n2 = c + i, { cssStyles: p } = t, m = 70 - s, g = m > 0 ? m / 2 : 0, d = /* @__PURE__ */ v.svg(e), y = /* @__PURE__ */ D(t, {});
  ...
  let x = [
    ...
    .../* @__PURE__ */ at(-s / 2 - g, n2 / 2, s / 2 + g, n2 / 2, i, 0.8),
    {
      x: s / 2 + g,
      y: -n2 / 2
    },
  ...
  ], b = /* @__PURE__ */ V(x), S2 = /* @__PURE__ */ d.path(b, y), $ = /* @__PURE__ */ e.insert(() => S2, ":first-child");
...
async function Is(l, t) {
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let { shapeSvg: e, bbox: a } = await C(l, t, /* @__PURE__ */ T(t)), h = 100, s = 50, c = /* @__PURE__ */ Math.max(a.width + (t.padding ?? 0) * 2, (t == null ? void 0 : t.width) ?? 0), i = /* @__PURE__ */ Math.max(a.height + (t.padding ?? 0) * 2, (t == null ? void 0 : t.height) ?? 0), n2 = c / i, p = c, f = i;
  p > f * n2 ? f = p / n2 : p = f * n2, p = /* @__PURE__ */ Math.max(p, h), f = /* @__PURE__ */ Math.max(f, s);
  let m = /* @__PURE__ */ Math.min(f * 0.2, f / 4), g = f + m * 2, { cssStyles: d } = t, y = /* @__PURE__ */ v.svg(e), x = /* @__PURE__ */ D(t, {});
  ...
  let b = [
    ...
    .../* @__PURE__ */ at(p / 2, -g / 2, -p / 2, -g / 2, m, -1)
  ], S2 = /* @__PURE__ */ V(b), $ = /* @__PURE__ */ y.path(S2, x), w = /* @__PURE__ */ e.insert(() => $, ":first-child");
...
async function me(l, t) {
  ...
  if (o.attributes.length === 0 && t.label) {
    ...
    if (!df(r.htmlLabels)) {
      let it = /* @__PURE__ */ Q.select("text"), rt = (_c2 = it.node()) == null ? void 0 : _c2.getBBox();
  ...
  let c = /* @__PURE__ */ T(t);
  c || (c = "node default");
  let i = /* @__PURE__ */ l.insert("g").attr("class", c).attr("id", t.domId || t.id), n2 = await Pt(i, t.label ?? "", r, 0, 0, [
    "name"
  ], s);
  n2.height += a;
  ...
  t.look !== "handDrawn" && (B.roughness = 0, B.fillStyle = "solid");
  let R = /* @__PURE__ */ Math.max($.width + e * 2, (t == null ? void 0 : t.width) || 0, w), j = /* @__PURE__ */ Math.max($.height + (f[0] || p) + a, (t == null ? void 0 : t.height) || 0), G = -R / 2, E = -j / 2;
  ...
  for (let [q, Q] of f.entries()) {
    ...
    let it = q % 2 === 0 && Q !== 0, rt = /* @__PURE__ */ P.rectangle(G, n2.height + E + Q, R, n2.height, {
      ...B,
      fill: it ? H : O,
      stroke: F
    });
  ...
  let W = /* @__PURE__ */ P.line(G, n2.height + E, R + G, n2.height + E, B);
  i.insert(() => W).attr("class", "divider"), W = /* @__PURE__ */ P.line(m + G, n2.height + E, m + G, j + E, B), i.insert(() => W).attr("class", "divider"), x && (W = /* @__PURE__ */ P.line(m + g + G, n2.height + E, m + g + G, j + E, B), i.insert(() => W).attr("class", "divider")), b && (W = /* @__PURE__ */ P.line(m + g + d + G, n2.height + E, m + g + d + G, j + E, B), i.insert(() => W).attr("class", "divider"));
  for (let q of f) W = /* @__PURE__ */ P.line(G, n2.height + E + q, R + G, n2.height + E + q, B), i.insert(() => W).attr("class", "divider");
...
async function Pt(l, t, o) {
  ...
  t !== dC(t) && (t = /* @__PURE__ */ dC(t), t = /* @__PURE__ */ t.replaceAll("<", "&lt;").replaceAll(">", "&gt;"));
  ...
  if (t.includes("&lt;") || t.includes("&gt;")) {
    let n2 = c.children[0];
    for (n2.textContent = /* @__PURE__ */ n2.textContent.replaceAll("&lt;", "<").replaceAll("&gt;", ">"); n2.childNodes[0]; ) n2 = n2.childNodes[0], n2.textContent = /* @__PURE__ */ n2.textContent.replaceAll("&lt;", "<").replaceAll("&gt;", ">");
  }
  ...
  if (df(o.htmlLabels)) {
    ...
    let p = /* @__PURE__ */ ih(c);
    i = /* @__PURE__ */ n2.getBoundingClientRect(), p.attr("width", i.width), p.attr("height", i.height);
  }
  return i;
}
m$1(Pt, "addText");
async function _s(l, t, o, r) {
  ...
  let a = r ? 0 : 3, h = /* @__PURE__ */ l.insert("g").attr("class", /* @__PURE__ */ T(t)).attr("id", t.domId || t.id), s = null, c = null, i = null, n2 = null, p = 0, f = 0, m = 0;
  ...
  m = i.node().getBBox().height, m <= 0 && (m = e / 2), n2 = /* @__PURE__ */ h.insert("g").attr("class", "methods-group text");
  let y = 0;
  ...
  return c.attr("transform", `translate(${-g.width / 2}, ${p})`), x = /* @__PURE__ */ h.node().getBBox(), i.attr("transform", `translate(0, ${p + f + e * 2})`), x = /* @__PURE__ */ h.node().getBBox(), n2.attr("transform", `translate(0, ${p + f + (m ? m + e * 4 : e * 2)})`), x = /* @__PURE__ */ h.node().getBBox(), {
    shapeSvg: h,
    bbox: x
  };
}
...
async function Ft(l, t, o) {
  ...
  let e = /* @__PURE__ */ l.insert("g").attr("class", "label").attr("style", /* @__PURE__ */ r.join("; ")), a = /* @__PURE__ */ Er(), h = "useHtmlLabels" in t ? t.useHtmlLabels : df(a.htmlLabels) ?? true, s = "";
  "text" in t ? s = t.text : s = t.label, !h && s.startsWith("\\") && (s = /* @__PURE__ */ s.substring(1)), Nl(s) && (h = true);
...
async function zs(l, t) {
  var _a2, _b2;
  let o = /* @__PURE__ */ Hl(), r = o.class.padding ?? 12, e = r, a = t.useHtmlLabels ?? df(o.htmlLabels) ?? true, h = t;
  ...
  let f = h.members.length === 0 && h.methods.length === 0 && !((_b2 = o.class) == null ? void 0 : _b2.hideEmptyMembersBox), m = /* @__PURE__ */ v.svg(s), g = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (g.roughness = 0, g.fillStyle = "solid");
  let d = c.width, y = c.height;
  h.members.length === 0 && h.methods.length === 0 ? y += e : h.members.length > 0 && h.methods.length === 0 && (y += e * 2);
  let x = -d / 2, b = -y / 2, S2 = /* @__PURE__ */ m.rectangle(x - r, b - r - (f ? r : h.members.length === 0 && h.methods.length === 0 ? -r / 2 : 0), d + 2 * r, y + 2 * r + (f ? r * 2 : h.members.length === 0 && h.methods.length === 0 ? -r : 0), g), $ = /* @__PURE__ */ s.insert(() => S2, ":first-child");
...
async function qs(l, t) {
  ...
  let { labelStyles: o, nodeStyles: r } = k(t);
  t.labelStyle = o;
  let e = t, a = t, h = 20, s = 20, c = "verifyMethod" in t, i = /* @__PURE__ */ T(t), n2 = /* @__PURE__ */ l.insert("g").attr("class", i).attr("id", t.domId ?? t.id), p;
  ...
  let g = (((_a2 = n2.node()) == null ? void 0 : _a2.getBBox().width) ?? 200) + h, d = (((_b2 = n2.node()) == null ? void 0 : _b2.getBBox().height) ?? 200) + h, y = -g / 2, x = -d / 2, b = /* @__PURE__ */ v.svg(n2), S2 = /* @__PURE__ */ D(t, {});
  t.look !== "handDrawn" && (S2.roughness = 0, S2.fillStyle = "solid");
  let $ = /* @__PURE__ */ b.rectangle(y, x, g, d, S2), w = /* @__PURE__ */ n2.insert(() => $, ":first-child");
  if (w.attr("class", "basic label-container").attr("style", r), n2.selectAll(".label").each((P, B, R) => {
    ...
    let P = /* @__PURE__ */ b.line(y, x + p + m + s, y + g, x + p + m + s, S2);
...
async function ht(l, t, o) {
  ...
  if (h) {
    let i = s.children[0], n2 = /* @__PURE__ */ ih(s);
    c = /* @__PURE__ */ i.getBoundingClientRect(), n2.attr("width", c.width), n2.attr("height", c.height);
  } else {
    let i = s.children[0];
    for (let n2 of i.children) n2.textContent = /* @__PURE__ */ n2.textContent.replaceAll("&gt;", ">").replaceAll("&lt;", "<"), r && n2.setAttribute("style", r);
...
async function Xs(l, t, param) {
  ...
  let { shapeSvg: s, bbox: c, label: i } = await C(l, t, /* @__PURE__ */ T(t)), n2 = t.padding || 10, p = "", f;
  "ticket" in t && t.ticket && ((_a2 = o == null ? void 0 : o.kanban) == null ? void 0 : _a2.ticketBaseUrl) && (p = (_b2 = o == null ? void 0 : o.kanban) == null ? void 0 : _b2.ticketBaseUrl.replace("#TICKET#", t.ticket), f = /* @__PURE__ */ s.insert("svg:a", ":first-child").attr("class", "kanban-ticket-link").attr("xlink:href", p).attr("target", "_blank"));
  let m = {
  ...
  if (t.look === "handDrawn") {
    let I = /* @__PURE__ */ v.svg(s), A = /* @__PURE__ */ D(t, {}), L = j || G ? I.path(/* @__PURE__ */ J(P, B, S2, w, j || 0), A) : I.rectangle(P, B, S2, w, A);
    R = /* @__PURE__ */ s.insert(() => L, ":first-child"), R.attr("class", "basic label-container").attr("style", E || null);
  } else {
    R = /* @__PURE__ */ s.insert("rect", ":first-child"), R.attr("class", "basic label-container __APA__").attr("style", e).attr("rx", j ?? 5).attr("ry", G ?? 5).attr("x", P).attr("y", B).attr("width", S2).attr("height", w);
