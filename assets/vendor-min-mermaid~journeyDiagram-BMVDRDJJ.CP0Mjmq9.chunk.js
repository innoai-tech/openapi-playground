import { g, h, y, x } from './vendor-min-mermaid~chunk-X5LG3FBU.C7azMJTH.chunk.js';
import { o } from './vendor-min-mermaid~chunk-ZZTKAOFA.BmEKORPt.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { F as Ff, B as Bf, w as wf, v as vf, M as Mf, L as Lf, H as Hl, i as ih, T as Tf, S as Sf, am as bc } from './vendor-min-mermaid~chunk-RAMAZW42.vc82q0BN.chunk.js';
...
var L = "", J = [], B = [], N = [], Pt = /*#__PURE__*/ m$1(function() {
    J.length = 0, B.length = 0, L = "", N.length = 0, Sf();
...
var Q = /*#__PURE__*/ m$1(function(t, e) {
    ...
    function d(g) {
        let m = /*#__PURE__*/ bc().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
        g.append("path").attr("class", "mouth").attr("d", m).attr("transform", "translate(" + e.cx + "," + (e.cy + 2) + ")");
    }
    m$1(d, "smile");
    function u(g) {
        let m = /*#__PURE__*/ bc().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
...
function Xt(t) {
    let e = Hl().journey, s = e.maxLabelWidth;
    O = 0;
    let c = 60;
...
var S = Hl().journey, I = 0, Ht = /*#__PURE__*/ m$1(function(t, e, s, c) {
    let r = /*#__PURE__*/ Hl(), d = r.journey.titleColor, u = r.journey.titleFontSize, f = r.journey.titleFontFamily, g = r.securityLevel, m;
    g === "sandbox" && (m = /*#__PURE__*/ ih("#i" + e));
    let x = g === "sandbox" ? ih(m.nodes()[0].contentDocument.body) : ih("body");
    $.init();
    ...
    Tf(h, l, v, S.useMaxWidth), h.append("line").attr("x1", I).attr("y1", S.height * 4).attr("x2", v - I - 4).attr("y2", S.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
    let k = a ? 70 : 0;
    ...
    let c = Hl().journey, r = "", d = c.height * 2 + c.diagramMarginY, u = s + d, f = 0, g = "#CCC", m = "black", x = 0;
