...
class tl {
  ...
  decode(t2) {
    ...
    if ((r2 == null ? void 0 : r2.title) && (n2 = n2.use(to({ title: r2 == null ? void 0 : r2.title })), i2 = true), r2 == null ? void 0 : r2.description) {
      if (i2) n2 = n2.use(to({ description: r2 == null ? void 0 : r2.description }));
      else {
