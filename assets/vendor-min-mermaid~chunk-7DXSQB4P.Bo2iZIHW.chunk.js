...
import { S } from './vendor-min-mermaid~chunk-G4RV2GLT.CakohKaL.chunk.js';
import { I as Ie$1, C as Ce } from './vendor-min-mermaid~chunk-CRSA2SMT.DrUenSi3.chunk.js';
import { t as tt$1, h as hh, j as jf, X as Xf, K as Kf, Z as Zf, Q as Qf, J as Jf, e as XC, V as Vf } from './vendor-min-mermaid~chunk-63ZE7VZ5.CfadwiGU.chunk.js';
...
var Ft = /*#__PURE__*/ m$1(function(t) {
    ...
    let { securityLevel: r, state: d, layout: u } = hh();
    ...
    Ie$1.insertTitle(S$1, "statediagramTitleText", d?.titleTopMargin ?? 25, /*#__PURE__*/ n.db.getDiagramTitle()), y(S$1, m$1, J, d?.useMaxWidth ?? true);
}, "draw"), qe = {
    getClasses: Ne,
    draw: Oe,
    getDir: Ft
            ...
            case tt:
                {
                    ...
                    let m = {
                        ...
                        style: Rt,
                        labelStyle: "",
                        label: /*#__PURE__*/ XC.sanitizeText(S.description ?? "", /*#__PURE__*/ hh()),
                        arrowheadStyle: vt,
                        labelpos: Nt,
                        labelType: Ot,
                        thickness: wt,
...
var q = /*#__PURE__*/ m$1((t, e, s, n, r, d, u, f)=>{
    ...
    if (tt$1.info("dataFetcher parsedItem", e, m, b), S !== "root") {
        ...
        e.description && (Array.isArray(p.description) ? (p.shape = gt, p.description.push(e.description)) : p.description?.length && p.description.length > 0 ? (p.shape = gt, p.description === S ? p.description = [
            ...
            p.description,
            e.description
        ]) : (p.shape = ft, p.description = e.description), p.description = /*#__PURE__*/ XC.sanitizeTextOrArray(p.description, L)), p.description?.length === 1 && p.shape === gt && (p.type === "group" ? p.shape = Pt : p.shape = ft), !p.type && e.doc && (tt$1.info("Setting cluster for XCX", S, /*#__PURE__*/ me(e)), p.type = "group", p.isGroup = true, p.dir = /*#__PURE__*/ me(e), p.shape = e.type === pt ? Gt : Pt, p.cssClasses = `${p.cssClasses} ${pe} ${d ? fe : ""}`);
        let k = {
            labelStyle: "",
            shape: p.shape,
            label: p.description,
...
var A = {
    ...
    extract(e) {
        ...
        let s = /*#__PURE__*/ this.getStates(), n = /*#__PURE__*/ hh();
    ...
    addState(e) {
        ...
        if (r && (tt$1.info("Setting state description", m, r), (Array.isArray(r) ? r : [
            ...
            let E = /*#__PURE__*/ this.currentDocument.states.get(m);
            if (!E) throw new Error(`State not found: ${m}`);
            E.note = d, E.note.text = /*#__PURE__*/ XC.sanitizeText(E.note.text, /*#__PURE__*/ hh());
        }
    ...
    clear(e) {
        this.nodes = [], this.edges = [], this.documents = {
            root: /*#__PURE__*/ _e()
        }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = /*#__PURE__*/ Ee(), e || (this.links = new Map, Vf());
    }
    getState(e) {
    ...
    addRelationObjs(e, s) {
        ...
        this.addState(r, d, e.doc, e.description, e.note, e.classes, e.styles, e.textStyles), this.addState(u, f, s.doc, s.description, s.note, s.classes, s.styles, s.textStyles), this.currentDocument.relations.push({
            id1: r,
            id2: u,
            relationTitle: /*#__PURE__*/ XC.sanitizeText(n, /*#__PURE__*/ hh())
        });
    }
    addRelation(e, s, n) {
        if (typeof e == "object" && typeof s == "object") this.addRelationObjs(e, s, n);
            ...
            this.addState(r, d), this.addState(u, f), this.currentDocument.relations.push({
                id1: r,
                id2: u,
                relationTitle: n ? XC.sanitizeText(n, /*#__PURE__*/ hh()) : void 0
            });
        }
    }
    addDescription(e, s) {
        let n = /*#__PURE__*/ this.currentDocument.states.get(e), r = s.startsWith(":") ? s.replace(":", "").trim() : s;
        n?.descriptions?.push(XC.sanitizeText(r, /*#__PURE__*/ hh()));
    }
    cleanupLabel(e) {
