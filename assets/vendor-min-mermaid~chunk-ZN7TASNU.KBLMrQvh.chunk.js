...
var _a, __;
import { m as h, e as fn, Z as Zr, s as sn, H as Kn, X as Xr, R as Rn } from "./vendor-min-mermaid~chunk-5ZJXQJOJ.DZaYt2YO.chunk.js";
import { C as Cr } from "./vendor-min-mermaid~chunk-YPUTD6PB.DtdPbVSC.chunk.js";
import { u as Mt, T } from "./vendor-min-mermaid~chunk-6BY5RJGC.BwVspKnk.chunk.js";
import { m as m$1 } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
var P = "\0", l = "\0", v = "", m = (_a = class {
  constructor(e = {}) {
  ...
  removeNode(e) {
    if (Object.prototype.hasOwnProperty.call(this._nodes, e)) {
      var t = m$1((s) => this.removeEdge(this._edgeObjs[s]), "removeEdge");
  ...
  filterNodes(e) {
    ...
    return m$1(r, "findParent"), this._isCompound && Zr(t.nodes(), function(n) {
      t.setParent(n, r(n));
    }), t;
  }
...
}, __ = new WeakMap(), __privateAdd(_a, __, m$1(_a, "Graph")), _a);
