...
import { w, $ } from './vendor-min-mermaid~chunk-IO347I67.DJHmq1cW.chunk.js';
import { V, S } from './vendor-min-mermaid~chunk-L736DJ4U.DfHRCDE5.chunk.js';
import './vendor-min-mermaid~chunk-QTJCGBHB.F-krgANJ.chunk.js';
import { Q as Qf } from './vendor-min-mermaid~chunk-USR3SDWQ.BTTdHODe.chunk.js';
import './vendor-min-mermaid~chunk-2VPXETT4.C9tLaSPs.chunk.js';
import './vendor-min-mermaid~chunk-S67DUUA5.BF3SGhc4.chunk.js';
import './vendor-min-mermaid~chunk-LM6QDVU5.CLWvmYRr.chunk.js';
import './vendor-min-mermaid~chunk-HESFG3RP.DM0RUiMH.chunk.js';
import { I as Ie, Y as Ye } from './vendor-min-mermaid~chunk-YM3XIQPS.DjUuqvt-.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.ByXaayWf.chunk.js';
import { X as IC, t as tt, H as Hl, i as ih, v as vf, B as Bf, M as Mf, w as wf, F as Ff, L as Lf, g as gC, S as Sf, Z as zC, a as Su, b as ae } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
...
` + A + `
        ...
        let g = this.edges.find((E)=>E.id === i);
        if (g) {
            let E = a;
            E?.animate !== void 0 && (g.animate = E.animate), E?.animation !== void 0 && (g.animation = E.animation);
            return;
        }
        let w, k = this.vertices.get(i);
        if (k === void 0 && (k = {
            id: i,
            labelType: "text",
            ...
            styles: [],
            classes: []
        }, this.vertices.set(i, k)), this.vertexCounter++, r !== void 0 ? (this.config = Hl(), w = this.sanitizeText(r.text.trim()), k.labelType = r.type, w.startsWith('"') && w.endsWith('"') && (w = w.substring(1, w.length - 1)), k.text = w) : k.text === void 0 && (k.text = i), n !== void 0 && (k.type = n), u?.forEach((E)=>{
            k.styles.push(E);
        }), l?.forEach((E)=>{
            k.classes.push(E);
            ...
            a?.label && (k.text = a?.label), a?.icon && (k.icon = a?.icon, !a.label?.trim() && k.text === i && (k.text = "")), a?.form && (k.form = a?.form), a?.pos && (k.pos = a?.pos), a?.img && (k.img = a?.img, !a.label?.trim() && k.text === i && (k.text = "")), a?.constraint && (k.constraint = a.constraint), a.w && (k.assetWidth = Number(a.w)), a.h && (k.assetHeight = Number(a.h));
        }
    }
    addSingleLink(i, r, n, u) {
        ...
        let A = n.text;
        if (A !== void 0 && (c.text = this.sanitizeText(A.text.trim()), c.text.startsWith('"') && c.text.endsWith('"') && (c.text = c.text.substring(1, c.text.length - 1)), c.labelType = A.type), n !== void 0 && (c.type = n.type, c.stroke = n.stroke, c.length = n.length > 10 ? 10 : n.length), u && !this.edges.some((a)=>a.id === u)) c.id = u, c.isUserDefinedId = true;
        else {
            let a = this.edges.filter((g)=>g.start === c.start && g.end === c.end);
            a.length === 0 ? c.id = Ye(c.start, c.end, {
                counter: 0,
                prefix: "L"
            }) : c.id = Ye(c.start, c.end, {
                counter: a.length + 1,
                prefix: "L"
            });
        }
...
You have to call mermaid.initialize.`);
    ...
    updateLink(i, r) {
        i.forEach((n)=>{
            ...
            n === "default" ? this.edges.defaultStyle = r : (this.edges[n].style = r, (this.edges[n]?.style?.length ?? 0) > 0 && !this.edges[n]?.style?.some((u)=>u?.startsWith("fill")) && this.edges[n]?.style?.push("fill:none"));
        });
    }
    addClass(i, r) {
        ...
        i.split(",").forEach((u)=>{
            ...
            l === void 0 && (l = {
                ...
                styles: [],
                textStyles: []
            }, this.classes.set(u, l)), n?.forEach((f)=>{
                if (/color/.exec(f)) {
                    let c = f.replace("fill", "bgFill");
                    l.textStyles.push(c);
                }
                l.styles.push(f);
            });
    ...
    setClass(i, r) {
        for (let n of i.split(",")){
            let u = this.vertices.get(n);
            u && u.classes.push(r);
            let l = this.edges.find((c)=>c.id === n);
            l && l.classes.push(r);
            let f = this.subGraphLookup.get(n);
            f && f.classes.push(r);
        }
    }
    setTooltip(i, r) {
    ...
    setClickFun(i, r, n) {
        ...
        f && (f.haveCallback = true, this.funs.push(()=>{
            let c = document.querySelector(`[id="${u}"]`);
    ...
    setLink(i, r, n) {
        i.split(",").forEach((u)=>{
            let l = this.vertices.get(u);
            l !== void 0 && (l.link = Ie.formatUrl(r, this.config), l.linkTarget = n);
    ...
    setupToolTips(i) {
        let r = ih(".mermaidTooltip");
        (r._groups || r)[0][0] === null && (r = ih("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), ih(i).select("svg").selectAll("g.node").on("mouseover", (l)=>{
            let f = ih(l.currentTarget);
            if (f.attr("title") === null) return;
            let A = l.currentTarget?.getBoundingClientRect();
            r.transition().duration(200).style("opacity", ".9"), r.text(f.attr("title")).style("left", window.scrollX + A.left + (A.right - A.left) / 2 + "px").style("top", window.scrollY + A.bottom + "px"), r.html(r.html().replace(/&lt;br\/&gt;/g, "<br/>")), f.classed("hover", true);
        }).on("mouseout", (l)=>{
    ...
    clear() {
        ...
        ], this.subGraphs = [], this.subGraphLookup = new Map, this.subCount = 0, this.tooltips = new Map, this.firstGraphFlag = true, this.version = i, this.config = Hl(), Sf();
    }
    setGen(i) {
    ...
    addSubGraph(i, r, n) {
        ...
        let f = m$1((g)=>{
            ...
            return {
                nodeList: g.filter(function(m) {
                    let J = typeof m;
                    return m.stmt && m.stmt === "dir" ? (E = m.value, false) : m.trim() === "" ? false : J in w ? w[J].hasOwnProperty(m) ? false : w[J][m] = true : k.includes(m) ? false : k.push(m);
                }),
                dir: E
            };
        }, "uniq"), { nodeList: c, dir: A } = f(r.flat());
        if (this.version === "gen-1") for(let g = 0; g < c.length; g++)c[g] = this.lookUpDomId(c[g]);
    ...
    indexNodes2(i, r) {
        ...
        let u = 0, l = 1;
        for(; u < n.length;){
            let f = this.getPosForId(n[u]);
            if (f >= 0) {
                let c = this.indexNodes2(i, f);
                if (c.result) return {
                    result: true,
                    count: l + c.count
                };
    ...
    destructEndLink(i) {
        let r = i.trim(), n = r.slice(0, -1), u = "arrow_open";
        switch(r.slice(-1)){
            case "x":
                u = "arrow_cross", r.startsWith("x") && (u = "double_" + u, n = n.slice(1));
                break;
            case ">":
                u = "arrow_point", r.startsWith("<") && (u = "double_" + u, n = n.slice(1));
                break;
            case "o":
                u = "arrow_circle", r.startsWith("o") && (u = "double_" + u, n = n.slice(1));
                break;
        }
    ...
    destructLink(i, r) {
        let n = this.destructEndLink(i), u;
        if (r) {
            if (u = this.destructStartLink(r), u.stroke !== n.stroke) return {
                type: "INVALID",
                stroke: "INVALID"
            };
    ...
    addNodeFromVertex(i, r, n, u, l, f) {
        let c = n.get(i.id), A = u.get(i.id) ?? false, a = this.findNode(r, i.id);
        if (a) a.cssStyles = i.styles, a.cssCompiledStyles = this.getCompiledStyles(i.classes), a.cssClasses = i.classes.join(" ");
        else {
            let g = {
                id: i.id,
                label: i.text,
    ...
    getCompiledStyles(i) {
        let r = [];
        for (let n of i){
            let u = this.classes.get(n);
            u?.styles && (r = [
                ...r,
                ...u.styles ?? []
            ].map((l)=>l.trim())), u?.textStyles && (r = [
                ...r,
                ...u.textStyles ?? []
            ].map((l)=>l.trim()));
        }
    ...
    getData() {
        let i = Hl(), r = [], n = [], u = this.getSubGraphs(), l = new Map, f = new Map;
        for(let a = u.length - 1; a >= 0; a--){
            let g = u[a];
            g.nodes.length > 0 && f.set(g.id, true);
            for (let w of g.nodes)l.set(w, g.id);
        }
        for(let a = u.length - 1; a >= 0; a--){
            let g = u[a];
            r.push({
        ...
        return A.forEach((a, g)=>{
            let { arrowTypeStart: w, arrowTypeEnd: k } = this.destructEdgeType(a.type), E = [
                ...A.defaultStyle ?? []
            ];
            ...
            let S = {
                ...
                thickness: a.stroke,
                minlen: a.length,
                classes: a?.stroke === "invisible" ? "" : "edge-thickness-normal edge-pattern-solid flowchart-link",
                arrowTypeStart: a?.stroke === "invisible" || a?.type === "arrow_open" ? "none" : w,
                arrowTypeEnd: a?.stroke === "invisible" || a?.type === "arrow_open" ? "none" : k,
                ...
                curve: a.interpolate || this.edges.defaultInterpolate || i.flowchart?.curve
            };
            n.push(S);
        }), {
            nodes: r,
...
var g1 = m$1(function(s, i) {
    return i.db.getClasses();
}, "getClasses"), k1 = m$1(async function(s, i, r, n) {
    ...
    let a = n.db.getData();
    tt.debug("Data: ", a);
    let g = w(i, u), w$1 = n.db.getDirection();
    a.type = n.type, a.layoutAlgorithm = V(f), a.layoutAlgorithm === "dagre" && f === "elk" && tt.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), a.direction = w$1, a.nodeSpacing = l?.nodeSpacing || 50, a.rankSpacing = l?.rankSpacing || 50, a.markers = [
        "point",
        "circle",
        "cross"
    ], a.diagramId = i, tt.debug("REF1:", a), await S(a, g);
    let k = a.config.flowchart?.diagramPadding ?? 8;
    Ie.insertTitle(g, "flowchartTitleText", l?.titleTopMargin || 0, n.db.getDiagramTitle()), $(g, k, "flowchart", l?.useMaxWidth || false);
    for (let E of a.nodes){
        let S = ih(`#${i} [id="${E.id}"]`);
        if (!S || !E.link) continue;
        let m = A.createElementNS("http://www.w3.org/2000/svg", "a");
        ...
        let J = S.insert(function() {
            return m;
        }, ":first-child"), ge = S.select(".label-container");
        ge && J.append(function() {
            return ge.node();
        });
        let ke = S.select(".label");
...
var at = function() {
    var s = m$1(function(fe, h, d, p) {
        ...
        performAction: m$1(function(h, d, p, o, B, e, me) {
            var t = e.length - 1;
            switch(B){
                case 2:
                    this.$ = [];
                ...
                case 61:
                    ...
                    break;
                case 62:
                    this.$ = e[t - 7], o.addVertex(e[t - 7], e[t - 1], "rect", void 0, void 0, void 0, Object.fromEntries([
                        [
                            e[t - 5],
                            e[t - 3]
                        ]
        ...
        parse: m$1(function(h) {
            var d = this, p = [
                0
            ], o = [], B = [
                null
            ], e = [], me = this.table, t = "", L = 0, Pt = 0, Mt = 0, h1 = 2, Ot = 1, d1 = e.slice.call(arguments, 1), U = Object.create(this.lexer), Ee = {
                yy: {}
            };
            ...
            function f1() {
                var X;
                return X = o.pop() || U.lex() || Ot, typeof X != "number" && (X instanceof Array && (o = X, X = o.pop()), X = d.symbols_[X] || X), X;
            }
            m$1(f1, "lex");
            for(var K, st, Ce, q, C1, it, Ge = {}, He, ce, Ut, Xe;;){
                if (Ce = p[p.length - 1], this.defaultActions[Ce] ? q = this.defaultActions[Ce] : ((K === null || typeof K > "u") && (K = f1()), q = me[Ce] && me[Ce][K]), typeof q > "u" || !q.length || !q[0]) {
                    var rt = "";
                    Xe = [];
...
Expecting ` + Xe.join(", ") + ", got '" + (this.terminals_[K] || K) + "'" : rt = "Parse error on line " + (L + 1) + ": Unexpected " + (K == Ot ? "end of input" : "'" + (this.terminals_[K] || K) + "'"), this.parseError(rt, {
                ...
                switch(q[0]){
                    case 1:
                        p.push(K), B.push(U.yytext), e.push(U.yylloc), p.push(q[1]), K = null, st ? (K = st, st = null) : (Pt = U.yyleng, t = U.yytext, L = U.yylineno, tt = U.yylloc, Mt > 0);
                        break;
                    case 2:
                        ...
                        ]), it = this.performAction.apply(Ge, [
                            t,
                            Pt,
                            L,
                            Ee.yy,
                        ...
                        ce && (p = p.slice(0, -1 * ce * 2), B = B.slice(0, -1 * ce), e = e.slice(0, -1 * ce)), p.push(this.productions_[q[1]][0]), B.push(Ge.$), e.push(Ge._$), Ut = me[p[p.length - 2]][p[p.length - 1]], p.push(Ut);
                        break;
                    case 3:
                        return true;
                }
        ...
        var fe = {
            EOF: 1,
            parseError: m$1(function(d, p) {
                if (this.yy.parser) this.yy.parser.parseError(d, p);
                else throw new Error(d);
            }, "parseError"),
            setInput: m$1(function(h, d) {
...
` + d + "^";
            ...
            test_match: m$1(function(h, d) {
                ...
                ]), this._more = false, this._backtrack = false, this._input = this._input.slice(h[0].length), this.matched += h[0], p = this.performAction.call(this, this.yy, this, d, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), p) return p;
                if (this._backtrack) {
            ...
            next: m$1(function() {
                ...
                for(var B = this._currentRules(), e = 0; e < B.length; e++)if (p = this._input.match(this.rules[B[e]]), p && (!d || p[0].length > d[0].length)) {
                    if (d = p, o = e, this.options.backtrack_lexer) {
                        if (h = this.test_match(p, B[e]), h !== false) return h;
                        if (this._backtrack) {
                            d = false;
                            continue;
                        } else return false;
                ...
                return d ? (h = this.test_match(d, B[o]), h !== false ? h : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
                    text: "",
                    token: null,
                    line: this.yylineno
            ...
            options: {},
            performAction: m$1(function(d, p, o, B) {
                switch(o){
                    case 0:
...
var o1 = u1;
var A1 = m$1((s, i)=>{
    let r = Su, n = r(s, "r"), u = r(s, "g"), l = r(s, "b");
    return ae(n, u, l, i);
}, "fade"), m1 = m$1((s)=>`.label {
  ...
  .labelBkg {
    background-color: ${A1(s.edgeLabelBackground, .5)};
    // background-color:
  }
