import { g, h, y, x } from './vendor-min-mermaid~chunk-TLQDAFRX.CgcyZEvl.chunk.js';
import { o } from './vendor-min-mermaid~chunk-ZZTKAOFA.BmEKORPt.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { G as Go, U as Uo, H as Ho, N as No, j as jo, $ as $o, u as ur, R as Ro, P as Po } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
import { i as ia, I as ks } from './vendor-min-mermaid~chunk-BF7QJ6L7.DK9jwCiC.chunk.js';
...
var L = "", J = [], B = [], N = [], Pt = /*#__PURE__*/ m$1(function() {
    J.length = 0, B.length = 0, L = "", N.length = 0, Po();
    ...
    getConfig: /*#__PURE__*/ m$1(()=>ur().journey, "getConfig"),
    clear: Pt,
    setDiagramTitle: $o,
    getDiagramTitle: jo,
    setAccTitle: No,
...
function Xt(t) {
    let e = ur().journey, s = e.maxLabelWidth;
    O = 0;
    let c = 60;
...
var S = ur().journey, I = 0, Ht = /*#__PURE__*/ m$1(function(t, e, s, c) {
    let r = /*#__PURE__*/ ur(), d = r.journey.titleColor, u = r.journey.titleFontSize, f = r.journey.titleFontFamily, g = r.securityLevel, m;
    ...
    Ro(h, l, v, S.useMaxWidth), h.append("line").attr("x1", I).attr("y1", S.height * 4).attr("x2", v - I - 4).attr("y2", S.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
    let k = a ? 70 : 0;
    ...
    let c = ur().journey, r = "", d = c.height * 2 + c.diagramMarginY, u = s + d, f = 0, g = "#CCC", m = "black", x = 0;
