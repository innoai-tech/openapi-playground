...
import { p as Mt, y as T } from "./vendor-min-mermaid~chunk-A4ITRWGT.Q-yxLqnU.chunk.js";
import { n as Cr } from "./vendor-min-mermaid~chunk-IQQE2MEC.Ch8P21i0.chunk.js";
import { C as Zr, P as h, W as sn, c as Kn, h as Rn, j as fn, x as Xr } from "./vendor-min-mermaid~chunk-OMTJKCYW.DapDh1DZ.chunk.js";
var P = "\0", l = "\0", v = "", m$1 = class {
	static {
		m(this, "Graph");
	}
	constructor(e = {}) {
	...
	removeNode(e) {
		if (Object.prototype.hasOwnProperty.call(this._nodes, e)) {
			var t = /* @__PURE__ */ m((s) => this.removeEdge(this._edgeObjs[s]), "removeEdge");
	...
	filterNodes(e) {
		...
		var s = this;
		Zr(this._nodes, function(n, h$1) {
			e(h$1) && t.setNode(h$1, n);
		}), Zr(this._edgeObjs, function(n) {
			t.hasNode(n.v) && t.hasNode(n.w) && t.setEdge(n, /* @__PURE__ */ s.edge(n));
		});
		var i = {};
		function r(n) {
			var h$1 = /* @__PURE__ */ s.parent(n);
			return h$1 === void 0 || t.hasNode(h$1) ? (i[n] = h$1, h$1) : h$1 in i ? i[h$1] : r(h$1);
		}
		return m(r, "findParent"), this._isCompound && Zr(/* @__PURE__ */ t.nodes(), function(n) {
	...
	setEdge() {
		...
		typeof n == "object" && n !== null && "v" in n ? (e = n.v, t = n.w, s = n.name, arguments.length === 2 && (i = arguments[1], r = !0)) : (e = n, t = arguments[1], s = arguments[3], arguments.length > 2 && (i = arguments[2], r = !0)), e = "" + e, t = "" + t, sn(s) || (s = "" + s);
		var h$1 = /* @__PURE__ */ p(this._isDirected, e, t, s);
		...
		this.setNode(e), this.setNode(t), this._edgeLabels[h$1] = r ? i : this._defaultEdgeLabelFn(e, t, s);
		var c = /* @__PURE__ */ D(this._isDirected, e, t, s);
		return e = c.v, t = c.w, Object.freeze(c), this._edgeObjs[h$1] = c, L(this._preds[t], e), L(this._sucs[e], t), this._in[t][h$1] = c, this._out[e][h$1] = c, this._edgeCount++, this;
	}
	edge(e, t, s) {
...
m$1.prototype._nodeCount = 0;
m$1.prototype._edgeCount = 0;
function L(d, e) {
	d[e] ? d[e]++ : d[e] = 1;
}
