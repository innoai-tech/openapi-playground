import { H as Hl, t as tt$1, i as ih, P as Pl, al as Wt$1, am as F$1, an as E, ak as bc, aM as un, S as Sf } from "./vendor-min-mermaid~chunk-QJLC67TO.Dw34GYds.chunk.js";
...
var X = /* @__PURE__ */ function() {
  var n = /* @__PURE__ */ m$1(function(m, i, a, c) {
    ...
    performAction: /* @__PURE__ */ m$1(function(i, a, c, p, y, l, E2) {
      var k = l.length - 1;
      switch (y) {
        case 1:
          return l[k - 1];
    ...
    parse: /* @__PURE__ */ m$1(function(i) {
      var a = this, c = [
        ...
        null
      ], l = [], E2 = this.table, k = "", N = 0, C = 0, V = 0, et = 2, L = 1, v = /* @__PURE__ */ l.slice.call(arguments, 1), b = /* @__PURE__ */ Object.create(this.lexer), T = {
        yy: {}
      };
      ...
      for (var w, Z, B, M, Jt, J, R = {}, O, $, nt, j; ; ) {
        if (B = c[c.length - 1], this.defaultActions[B] ? M = this.defaultActions[B] : ((w === null || typeof w > "u") && (w = /* @__PURE__ */ Mt()), M = E2[B] && E2[B][w]), typeof M > "u" || !M.length || !M[0]) {
          var K = "";
          j = [];
...
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : K = "Parse error on line " + (N + 1) + ": Unexpected " + (w == L ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(K, {
        ...
        switch (M[0]) {
          ...
          case 2:
            ...
            $ && (c = /* @__PURE__ */ c.slice(0, -1 * $ * 2), y = /* @__PURE__ */ y.slice(0, -1 * $), l = /* @__PURE__ */ l.slice(0, -1 * $)), c.push(this.productions_[M[1]][0]), y.push(R.$), l.push(R._$), nt = E2[c[c.length - 2]][c[c.length - 1]], c.push(nt);
            break;
          case 3:
            return true;
        }
...
function St(n, t) {
  n.each(function() {
    var e = /* @__PURE__ */ ih(this), o2 = /* @__PURE__ */ e.text().split(/(\s+|<br>)/).reverse(), r, u = [], h = 1.1, f = /* @__PURE__ */ e.attr("y"), g = /* @__PURE__ */ parseFloat(/* @__PURE__ */ e.attr("dy")), d = /* @__PURE__ */ e.text(null).append("tspan").attr("x", 0).attr("y", f).attr("dy", g + "em");
...
var jt = /* @__PURE__ */ m$1(function(n, t, e, o2) {
  ...
  tt$1.debug("maxSectionHeight before draw", i), tt$1.debug("maxTaskHeight before draw", a), m && m.length > 0 ? m.forEach((L) => {
    ...
    let T = /* @__PURE__ */ d.append("g"), A = /* @__PURE__ */ H.drawNode(T, b, E2, r);
...
var qt = /* @__PURE__ */ m$1((n) => {
  let t = "";
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], Wt$1(n["lineColor" + e]) ? n["lineColor" + e] = /* @__PURE__ */ F$1(n["lineColor" + e], 20) : n["lineColor" + e] = /* @__PURE__ */ E(n["lineColor" + e], 20);
