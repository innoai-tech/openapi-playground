import { h, x as x$1 } from './vendor-min-mermaid~chunk-SQHZINSB.CUS1FH5S.chunk.js';
import { M, S as St, W as Wt$1 } from './vendor-min-mermaid~chunk-3R3PQ5PD.DqcBTR0a.chunk.js';
import { f } from './vendor-min-mermaid~chunk-TI4EEUUG.BFlBPHyk.chunk.js';
import { K as Kf, Q as Qf, Z as Zf, j as jf, h as hh, k as kh, t as tt, G as Gf, M as Mt$1, C as Ce$1, e as jC } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
...
var F = [], mt = [
    ...
    ve = /*#__PURE__*/ Ce$1(e, /*#__PURE__*/ hh());
    ...
    re = /*#__PURE__*/ Ce$1(e, /*#__PURE__*/ hh());
}, "setTitle"), Nt = {
...
var se = /*#__PURE__*/ m$1(function(e, t) {
    ...
    function t(l, n, a, r, i, u, d, b) {
        let { fontSize: p, fontFamily: E, fontWeight: T } = b, D = /*#__PURE__*/ l.split(jC.lineBreakRegex);
...
function z(e, t, s, o, l) {
    if (!t[e].width) if (s) t[e].text = /*#__PURE__*/ St(t[e].text, l, o), t[e].textLines = t[e].text.split(jC.lineBreakRegex).length, t[e].width = l, t[e].height = /*#__PURE__*/ Wt$1(t[e].text, o);
    else {
        let n = /*#__PURE__*/ t[e].text.split(jC.lineBreakRegex);
        t[e].textLines = n.length;
        let a = 0;
        t[e].height = 0, t[e].width = 0;
        for (let r of n)t[e].width = /*#__PURE__*/ Math.max(/*#__PURE__*/ M(r, o), t[e].width), a = /*#__PURE__*/ Wt$1(r, o), t[e].height = t[e].height + a;
    }
}
...
var P0 = /*#__PURE__*/ m$1(function(e, t, s, o) {
    ...
    d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * x.diagramMarginX).attr("y", p.starty + x.diagramMarginY), Gf(i, T, P, x.useMaxWidth);
    let B = d ? 60 : 0;
