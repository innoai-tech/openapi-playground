import { t as tt } from './vendor-min-mermaid~chunk-ZKYS2E5M.CRzVS5tA.chunk.js';
...
var Q = n((ct, _) => {
  ...
  function Ce(e) {
    if (e = String(e), !(e.length > 100)) {
      ...
      if (o) {
        var t = parseFloat(o[1]), n = (o[2] || "ms").toLowerCase();
        switch (n) {
          case "years":
          case "year":
          case "yrs":
...
var Y = n((ft, X) => {
  function we(e) {
    ...
    function t(c) {
      ...
      return m$1(d, "debug"), d.namespace = c, d.useColors = t.useColors(), d.color = t.selectColor(c), d.extend = n, d.destroy = t.destroy, Object.defineProperty(d, "enabled", { enumerable: true, configurable: false, get: m$1(() => p !== null ? p : (m !== t.namespaces && (m = t.namespaces, w = t.enabled(c)), w), "get"), set: m$1((u) => {
        p = u;
      }, "set") }), typeof t.init == "function" && t.init(d), d;
    }
    m$1(t, "createDebug");
    function n(c, f) {
...
var se = Object.freeze({ left: 0, top: 0, width: 16, height: 16 }), b = Object.freeze({ rotate: 0, vFlip: false, hFlip: false }), P = Object.freeze({ ...se, ...b }), H = Object.freeze({ ...P, body: "", hidden: false });
var ie = Object.freeze({ width: null, height: null }), J = Object.freeze({ ...ie, ...b });
var L = m$1((e, o, t, n = "") => {
  let r = e.split(":");
  if (e.slice(0, 1) === "@") {
  ...
  if (r.length > 1) {
    let l = r.pop(), C = r.pop(), x = { provider: r.length > 0 ? r[0] : n, prefix: C, name: l };
    return o && !O(x) ? null : x;
  }
  let i = r[0], a = i.split("-");
  if (a.length > 1) {
    let l = { provider: n, prefix: a.shift(), name: a.join("-") };
    return o && !O(l) ? null : l;
  }
  if (t && n === "") {
    let l = { provider: n, prefix: "", name: i };
...
m$1(V, "mergeIconData");
function K(e, o) {
  let t = e.icons, n = e.aliases || /* @__PURE__ */ Object.create(null), r = /* @__PURE__ */ Object.create(null);
  function i(a) {
    if (t[a]) return r[a] = [];
    if (!(a in r)) {
      r[a] = null;
  ...
  return m$1(i, "resolve"), (o || Object.keys(t).concat(Object.keys(n))).forEach(i), r;
}
m$1(K, "getIconsTree");
function W(e, o, t) {
...
m$1(z, "calculateSize");
function fe(e, o = "defs") {
  let t = "", n = e.indexOf("<" + o);
  for (; n >= 0; ) {
    let r = e.indexOf(">", n), i = e.indexOf("</" + o);
    if (r === -1 || i === -1) break;
    let a = e.indexOf(">", i);
    if (a === -1) break;
    t += e.slice(r + 1, i).trim(), e = e.slice(0, n).trim() + e.slice(a + 1);
  }
  return { defs: t, content: e };
}
m$1(fe, "splitSVGDefs");
function le(e, o) {
...
function N(e, o) {
  let t = { ...P, ...e }, n = { ...J, ...o }, r = { left: t.left, top: t.top, width: t.width, height: t.height }, i = t.body;
  [t, n].forEach((d) => {
  ...
  let w = [r.left, r.top, C, x];
  return p.viewBox = w.join(" "), { attributes: p, viewBox: w, body: i };
}
m$1(N, "iconToSVG");
...
m$1(q, "iconToHTML");
q$1(ee());
var Te = { body: '<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/><text transform="translate(21.16 64.67)" style="fill: #fff; font-family: ArialMT, Arial; font-size: 67.75px;"><tspan x="0" y="0">?</tspan></text></g>', height: 80, width: 80 }, $ = /* @__PURE__ */ new Map(), te = /* @__PURE__ */ new Map(), yt = m$1((e) => {
  for (let o of e) {
...
var St = m$1(async (e, o) => {
  ...
  let n = N(t, o);
  return q(U(n.body), n.attributes);
}, "getIconSVG");
