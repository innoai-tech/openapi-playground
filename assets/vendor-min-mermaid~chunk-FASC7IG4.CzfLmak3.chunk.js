...
import { Z as Zr$1, q as Tn$1, N as Nf, r as bn$1, D as Df, t as dn$1, u as lp, J as Jr$1, v as Jm, s as sn$1, y as ym, b as fm, w as Ti, Q as Qr$1, O as Om, x as tp, K as Ki, d as fn$1, X as Xr$1, R as Rn, B as gp, C as np, E as hi, F as Zi, G as Ji } from "./vendor-min-mermaid~chunk-5ZJXQJOJ.C1fDHJEj.chunk.js";
import { t as qs, u as Mt, a as N } from "./vendor-min-mermaid~chunk-6BY5RJGC.DKNoSLq2.chunk.js";
...
function Qr(r, e, n, t, o, a, i) {
  ...
  r.setParent(d, i), h.borderTop = d, r.setParent(c, i), h.borderBottom = c, Zr$1(f, function(l) {
    Qr(r, e, n, t, o, a, l);
    var p = /* @__PURE__ */ r.node(l), m2 = p.borderTop ? p.borderTop : l, v = p.borderBottom ? p.borderBottom : l, b = p.borderTop ? t : 2 * t, D = m2 !== v ? 1 : o - a[i] + 1;
    r.setEdge(d, m2, {
      weight: b,
      minlen: D,
      nestingEdge: true
...
function hr(r, e, n, t) {
  ...
  if (i && (l.vs = /* @__PURE__ */ Qr$1([
    ...
    var p = /* @__PURE__ */ r.node(r.predecessors(i)[0]), m2 = /* @__PURE__ */ r.node(r.predecessors(f)[0]);
...
function He(r, e) {
  ...
  function t(o, a) {
    ...
    return Zr$1(a, function(h, l) {
      var p = /* @__PURE__ */ Ke(r, h), m2 = p ? r.node(p).order : d;
  ...
  return Zr$1(e, function(f) {
    ...
    Zr$1(f, function(c) {
      ...
      if (h.length) {
        ...
        for (var l = (h.length - 1) / 2, p = /* @__PURE__ */ Math.floor(l), m2 = /* @__PURE__ */ Math.ceil(l); p <= m2; ++p) {
          var v = h[p];
...
function $e(r, e, n, t, o) {
  ...
  function d(l, p) {
    for (var m2 = /* @__PURE__ */ i.nodes(), v = /* @__PURE__ */ m2.pop(), b = {}; v; ) b[v] ? l(v) : (b[v] = true, m2.push(v), m2 = /* @__PURE__ */ m2.concat(/* @__PURE__ */ p(v))), v = /* @__PURE__ */ m2.pop();
  }
  m$1(d, "iterate");
  function c(l) {
    a[l] = /* @__PURE__ */ i.inEdges(l).reduce(function(p, m2) {
  ...
  function h(l) {
    ...
    }, Number.POSITIVE_INFINITY), m2 = /* @__PURE__ */ r.node(l);
    p !== Number.POSITIVE_INFINITY && m2.borderType !== f && (a[l] = /* @__PURE__ */ Math.max(a[l], p));
  }
...
function gn(r) {
  ...
  function d(c) {
    ...
    e = /* @__PURE__ */ Math.min(e, h - p / 2), n = /* @__PURE__ */ Math.max(n, h + p / 2), t = /* @__PURE__ */ Math.min(t, l - m2 / 2), o = /* @__PURE__ */ Math.max(o, l + m2 / 2);
  }
