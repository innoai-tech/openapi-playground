const __vite__fileDeps=["assets/webapp-openapi-playground-page.DKHAwvix.chunk.js","assets/webapp-openapi-playground-mod-openapi.COOEBvPp.chunk.js","assets/webapp-openapi-playground-page-operations._VC5VAIm.chunk.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
var n, e;
import { c as t, a as o, O as i, r, f as a, j as s, b as l, s as d, t as c, p, d as m, e as h, C as u, G as f, R as b, T as g, g as y, h as v, i as E, k as w } from "./webapp-openapi-playground-mod-openapi.COOEBvPp.chunk.js";
(function() {
...
}, N = Object.assign(o(() => () => h(y, {})), { displayName: "IndexDefault" }), F = v({ history: E(new URL(null !== (e = null === (n = document.querySelector("base")) || void 0 === n ? void 0 : n.href) && void 0 !== e ? e : "/").pathname), routes: [{ name: "operations", path: "/operations", component: () => T(() => import("./webapp-openapi-playground-page.DKHAwvix.chunk.js"), true ? __vite__mapDeps([0,1]) : void 0), children: [{ name: "operations-operationId", path: ":operationId", component: () => T(() => import("./webapp-openapi-playground-page-operations._VC5VAIm.chunk.js"), true ? __vite__mapDeps([2,1]) : void 0), props: true }], props: true }, { name: "index", path: "/", component: N, props: true }] });
