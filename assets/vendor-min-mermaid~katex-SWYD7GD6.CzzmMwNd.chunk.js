...
function St(r, e, t) {
    ...
    var a = /*#__PURE__*/ r.charCodeAt(0), n = S0[e][a];
    if (!n && r[0] in Yt && (a = /*#__PURE__*/ Yt[r[0]].charCodeAt(0), n = S0[e][a]), !n && t === "text" && wr(a) && (n = S0[e][77]), n) return {
        depth: n[0],
        height: n[1],
        italic: n[2],
        skew: n[3],
...
var oe, ze, Ae = [
    ...
    return true;
}, "canCombine"), i1 = /*#__PURE__*/ m$1((r)=>{
    for(var e = 0; e < r.length - 1; e++){
        var t = r[e], a = r[e + 1];
        t instanceof h0 && a instanceof h0 && n1(t, a) && (t.text += a.text, t.height = /*#__PURE__*/ Math.max(t.height, a.height), t.depth = /*#__PURE__*/ Math.max(t.depth, a.depth), t.italic = a.italic, r.splice(e + 1, 1), e--);
    }
    return r;
    ...
    return Mt(s), s;
}, "makeSpan"), Tr = /*#__PURE__*/ m$1((r, e, t, a)=>new j0(r, e, t, a), "makeSvgSpan"), s1 = /*#__PURE__*/ m$1(function(e, t, a) {
    var n = /*#__PURE__*/ o0([
        e
    ], [], t);
...
}, "buildExpression"), Jt = /*#__PURE__*/ m$1(function r(e, t, a, n, s) {
    n && e.push(n);
...
}, "checkPartialGroup"), y1 = /*#__PURE__*/ m$1(function r(e, t) {
    var a = /*#__PURE__*/ Nr(e);
    if (a) {
        var n = a.children;
        if (n.length) {
...
var Bt = /*#__PURE__*/ m$1((r, e)=>{
    var t, a, n;
    r && r.type === "supsub" ? (a = /*#__PURE__*/ L(r.base, "accent"), t = a.base, r.base = t, n = /*#__PURE__*/ Ja(/*#__PURE__*/ G(r, e)), r.base = a) : (a = /*#__PURE__*/ L(r, "accent"), t = a.base);
...
}, "htmlBuilder$a"), Or = /*#__PURE__*/ m$1((r, e)=>{
    var t = r.isStretchy ? E0.mathMLnode(r.label) : new M.MathNode("mo", [
        /*#__PURE__*/ g0(r.label, r.mode)
...
D({
    ...
    handler: /*#__PURE__*/ m$1((r, e)=>{
        var t = /*#__PURE__*/ Le(e[0]), a = !B1.test(r.funcName), n = !a || r.funcName === "\\widehat" || r.funcName === "\\widetilde" || r.funcName === "\\widecheck";
        return {
            type: "accent",
            mode: r.parser.mode,
            label: r.funcName,
...
D({
    ...
    htmlBuilder: /*#__PURE__*/ m$1((r, e)=>{
        var t = /*#__PURE__*/ G(r.base, e), a = /*#__PURE__*/ E0.svgSpan(r, e), n = r.label === "\\utilde" ? .12 : 0, s = /*#__PURE__*/ y.makeVList({
            positionType: "top",
    ...
    mathmlBuilder: /*#__PURE__*/ m$1((r, e)=>{
        var t = /*#__PURE__*/ E0.mathMLnode(r.label), a = new M.MathNode("munder", [
            /*#__PURE__*/ $(r.base, e),
            t
        ]);
...
D({
    ...
    htmlBuilder (r, e) {
        ...
        var h = /*#__PURE__*/ E0.svgSpan(r, e), c = -e.fontMetrics().axisHeight + .5 * h.height, v = -e.fontMetrics().axisHeight - .5 * h.height - .111;
    ...
    mathmlBuilder (r, e) {
        var t = /*#__PURE__*/ E0.mathMLnode(r.label);
...
var C1 = {
    ...
    ".": "no arrow"
        ...
        mode: "math",
        style: "display"
    }), "newCell"), er = /*#__PURE__*/ m$1((r)=>r.type === "textord" && r.text === "@", "isStartOfArrow"), q1 = /*#__PURE__*/ m$1((r, e)=>(r.type === "mathord" || r.type === "atom") && r.text === e, "isLabelEnd");
function N1(r, e, t) {
    var a = C1[r];
    switch(a){
        case "\\\\cdrightarrow":
...
D({
    ...
    handler (r) {
        var { parser: e, funcName: t } = r, a = /*#__PURE__*/ Gr(/*#__PURE__*/ e.gullet.popToken());
...
D({
    ...
    handler (r) {
        var { parser: e, funcName: t } = r, a = /*#__PURE__*/ Gr(/*#__PURE__*/ e.gullet.popToken()), n = /*#__PURE__*/ e.gullet.popToken(), s = /*#__PURE__*/ e.gullet.popToken();
...
var ue = /*#__PURE__*/ m$1(function(e, t, a) {
...
}, "makeStackedDelim"), at = 80, nt = .08, it = /*#__PURE__*/ m$1(function(e, t, a, n, s) {
    ...
    return n.type === "small" ? (b = 1e3 + 1e3 * o + at, e < 1 ? s = 1 : e < 1.4 && (s = .7), c = (1 + o + nt) / s, v = (1 + o) / s, h = /*#__PURE__*/ it("sqrtMain", c, b, o, t), h.style.minWidth = "0.853em", x = .833 / s) : n.type === "large" ? (b = (1e3 + at) * he[n.size], v = (he[n.size] + o) / s, c = (he[n.size] + o + nt) / s, h = /*#__PURE__*/ it("sqrtSize" + n.size, c, b, o, t), h.style.minWidth = "1.02em", x = 1 / s) : (c = e + o + nt, v = e + o, b = Math.floor(1e3 * e + o) + at, h = /*#__PURE__*/ it("sqrtTall", c, b, o, t), h.style.minWidth = "0.742em", x = 1.056), h.height = v, h.style.height = /*#__PURE__*/ T(c), {
        span: h,
        advanceWidth: x,
...
D({
    ...
    mathmlBuilder: /*#__PURE__*/ m$1((r)=>{
        var e = [];
        r.delim !== "." && e.push(/*#__PURE__*/ g0(r.delim, r.mode));
        ...
        var a = /*#__PURE__*/ T(N0.sizeToMaxHeight[r.size]);
...
D({
    ...
    htmlBuilder: /*#__PURE__*/ m$1((r, e)=>{
        ...
        if (r.left === "." ? h = /*#__PURE__*/ pe(e, [
            "mopen"
        ]) : h = /*#__PURE__*/ N0.leftRightDelim(r.left, a, n, e, r.mode, [
            "mopen"
        ]), t.unshift(h), s) for(var c = 1; c < t.length; c++){
            var v = t[c], b = v.isMiddle;
            b && (t[c] = /*#__PURE__*/ N0.leftRightDelim(b.delim, a, n, b.options, r.mode, []));
        }
        var x;
        if (r.right === ".") x = /*#__PURE__*/ pe(e, [
            ...
            x = /*#__PURE__*/ N0.leftRightDelim(r.right, a, n, k, r.mode, [
                "mclose"
            ]);
        }
...
D({
    ...
    htmlBuilder: /*#__PURE__*/ m$1((r, e)=>{
        ...
        if (r.delim === ".") t = /*#__PURE__*/ pe(e, []);
            ...
            t = /*#__PURE__*/ N0.sizedDelim(r.delim, 1, e, r.mode, []);
            var a = {
                delim: r.delim,
                options: e
            };
...
var Ct = /*#__PURE__*/ m$1((r, e)=>{
    ...
    if (a === "sout") s = /*#__PURE__*/ y.makeSpan([
        ...
        var B = 0, q = 0, N = 0;
        /box/.test(a) ? (N = /*#__PURE__*/ Math.max(e.fontMetrics().fboxrule, e.minRuleThickness), B = e.fontMetrics().fboxsep + (a === "colorbox" ? 0 : N), q = B) : a === "angl" ? (N = /*#__PURE__*/ Math.max(e.fontMetrics().defaultRuleThickness, e.minRuleThickness), B = 4 * N, q = /*#__PURE__*/ Math.max(0, .25 - t.depth)) : (B = h ? .2 : 0, q = B), s = /*#__PURE__*/ E0.encloseSpan(t, a, B, q, e), /fbox|boxed|fcolorbox/.test(a) ? (s.style.borderStyle = "solid", s.style.borderWidth = /*#__PURE__*/ T(N)) : a === "angl" && N !== .049 && (s.style.borderTopWidth = /*#__PURE__*/ T(N), s.style.borderRightWidth = /*#__PURE__*/ T(N)), o = t.depth + q, r.backgroundColor && (s.style.backgroundColor = r.backgroundColor, r.borderColor && (s.style.borderColor = r.borderColor));
    }
    var H;
    if (r.backgroundColor) H = /*#__PURE__*/ y.makeVList({
        positionType: "individualShift",
        children: [
            {
                type: "elem",
...
function U0(r, e, t) {
    ...
    m$1(F, "beginRow");
    function U() {
        H && (r.gullet.macros.get("\\df@tag") ? (H.push(/*#__PURE__*/ r.subparse([
            new v0("\\df@tag")
        ])), r.gullet.macros.set("\\df@tag", void 0, true)) : H.push(!!c && r.gullet.macros.get("\\@eqnsw") === "1"));
    }
    for(m$1(U, "endRow"), F(), N.push(/*#__PURE__*/ ar(r));;){
        ...
        if (Y === "&") {
            ...
            r.consume();
            var V = void 0;
            r.gullet.future().text !== " " && (V = /*#__PURE__*/ r.parseSizeGroup(true)), q.push(V ? V.value : null), U(), N.push(/*#__PURE__*/ ar(r)), A = [], B.push(A), F();
...
z0({
    ...
    handler (r, e) {
        ...
        return U0(r.parser, s, /*#__PURE__*/ Rt(r.envName));
    },
    htmlBuilder: A0,
    mathmlBuilder: T0
});
z0({
    ...
    handler (r) {
        ...
        var s = /*#__PURE__*/ U0(r.parser, a, /*#__PURE__*/ Rt(r.envName)), o = /*#__PURE__*/ Math.max(0, .../*#__PURE__*/ s.body.map((h)=>h.length));
...
z0({
    ...
    handler (r) {
        var e = {
            arraystretch: .5
        }, t = /*#__PURE__*/ U0(r.parser, e, "script");
...
z0({
    ...
    handler (r, e) {
        ...
        if (s = /*#__PURE__*/ U0(r.parser, s, "script"), s.body.length > 0 && s.body[0].length > 1) throw new z("{subarray} can contain only one column");
        return s;
    },
    htmlBuilder: A0,
    mathmlBuilder: T0
...
z0({
    ...
    handler (r) {
        ...
        }, t = /*#__PURE__*/ U0(r.parser, e, /*#__PURE__*/ Rt(r.envName));
        return {
            type: "leftright",
            mode: r.mode,
            body: [
...
var ea = /*#__PURE__*/ m$1((r, e)=>{
    var t = r.font, a = /*#__PURE__*/ e.withFont(t);
    return G(r.body, a);
}, "htmlBuilder$5"), ta = /*#__PURE__*/ m$1((r, e)=>{
    var t = r.font, a = /*#__PURE__*/ e.withFont(t);
    return $(r.body, a);
}, "mathmlBuilder$4"), ir = {
    "\\Bbb": "\\mathbb",
...
var ra = /*#__PURE__*/ m$1((r, e)=>{
...
}, "adjustStyle"), Et = /*#__PURE__*/ m$1((r, e)=>{
    var t = /*#__PURE__*/ ra(r.size, e.style), a = /*#__PURE__*/ t.fracNum(), n = /*#__PURE__*/ t.fracDen(), s;
    ...
    if (b) {
        ...
        N < A && (w += .5 * (A - N), B += .5 * (A - N)), q = /*#__PURE__*/ y.makeVList({
            positionType: "individualShift",
            children: [
                {
                    type: "elem",
    ...
    return r.leftDelim == null ? P = /*#__PURE__*/ pe(e, [
        "mopen"
    ]) : P = /*#__PURE__*/ N0.customSizedDelim(r.leftDelim, U, true, /*#__PURE__*/ e.havingStyle(t), r.mode, [
        "mopen"
    ]), r.continued ? Y = /*#__PURE__*/ y.makeSpan([]) : r.rightDelim == null ? Y = /*#__PURE__*/ pe(e, [
        "mclose"
    ]) : Y = /*#__PURE__*/ N0.customSizedDelim(r.rightDelim, U, true, /*#__PURE__*/ e.havingStyle(t), r.mode, [
        "mclose"
    ]), y.makeSpan(/*#__PURE__*/ [
        "mord"
...
}, "htmlBuilder$4"), It = /*#__PURE__*/ m$1((r, e)=>{
    ...
    var n = /*#__PURE__*/ ra(r.size, e.style);
...
D({
    ...
    handler (r, e) {
        var { parser: t } = r, a = e[4], n = e[5], s = /*#__PURE__*/ Le(e[0]), o = s.type === "atom" && s.family === "open" ? lr(s.text) : null, h = /*#__PURE__*/ Le(e[1]), c = h.type === "atom" && h.family === "close" ? lr(h.text) : null, v = /*#__PURE__*/ L(e[2], "size"), b, x = null;
...
D({
    ...
    handler: /*#__PURE__*/ m$1((r, e)=>{
        var { parser: t, funcName: a } = r, n = e[0], s = /*#__PURE__*/ Aa(L(e[1], "infix").size), o = e[2], h = s.number > 0;
        return {
            type: "genfrac",
            mode: t.mode,
            numer: n,
...
}, "htmlBuilder$3"), j1 = /*#__PURE__*/ m$1((r, e)=>{
    var t = /*#__PURE__*/ E0.mathMLnode(r.label);
...
D({
    ...
    mathmlBuilder: /*#__PURE__*/ m$1((r, e)=>V0(r.body, e), "mathmlBuilder")
});
D({
    type: "htmlmathml",
    names: [
    ...
    mathmlBuilder: /*#__PURE__*/ m$1((r, e)=>V0(r.mathml, e), "mathmlBuilder")
});
...
D({
    ...
    htmlBuilder: /*#__PURE__*/ m$1((r, e)=>{
        var t = /*#__PURE__*/ or(r, e), a = /*#__PURE__*/ r0(t, e, false);
        return y.makeFragment(a);
    }, "htmlBuilder"),
    mathmlBuilder: /*#__PURE__*/ m$1((r, e)=>{
        var t = /*#__PURE__*/ or(r, e);
        return V0(t, e);
    }, "mathmlBuilder")
});
var na = /*#__PURE__*/ m$1((r, e, t, a, n, s, o)=>{
...
}, "htmlBuilder$1"), J1 = /*#__PURE__*/ m$1((r, e)=>{
...
D({
    ...
    htmlBuilder (r, e) {
        ...
        if (r.index) {
            var A = /*#__PURE__*/ e.havingStyle(I.SCRIPTSCRIPT), B = /*#__PURE__*/ G(r.index, A, e), q = .6 * (w.height - w.depth), N = /*#__PURE__*/ y.makeVList({
                positionType: "shift",
                positionData: -q,
                children: [
                    {
...
D({
    ...
    htmlBuilder (r, e) {
        var t = hr[r.style], a = /*#__PURE__*/ e.havingStyle(t).withFont("");
        return la(r.body, a, e);
    },
    mathmlBuilder (r, e) {
        var t = hr[r.style], a = /*#__PURE__*/ e.havingStyle(t), n = /*#__PURE__*/ m0(r.body, a), s = new M.MathNode("mstyle", n), o = {
            display: [
                "0",
                "true"
            ],
...
Z0({
    ...
    htmlBuilder (r, e) {
        ...
        var q = e.sizeMultiplier, N = /*#__PURE__*/ T(.5 / v.ptPerEm / q), H = null;
        if (c) {
...
Z0({
    ...
    mathmlBuilder (r, e) {
        var t = new M.MathNode("mo", [
            /*#__PURE__*/ g0(r.text, r.mode)
        ]);
        if (r.family === "bin") {
            var a = /*#__PURE__*/ At(r, e);
...
Z0({
    ...
    mathmlBuilder (r, e) {
        var t = /*#__PURE__*/ g0(r.text, r.mode, e), a = At(r, e) || "normal", n;
...
D({
    ...
    htmlBuilder (r, e) {
        var t = /*#__PURE__*/ fr(r, e), a = /*#__PURE__*/ r0(r.body, t, true);
        return y.makeSpan([
            "mord",
            "text"
        ], a, t);
...
D({
    ...
    htmlBuilder (r, e) {
        for(var t = /*#__PURE__*/ pr(r), a = [], n = /*#__PURE__*/ e.havingStyle(/*#__PURE__*/ e.style.text()), s = 0; s < t.length; s++){
            var o = t[s];
...
var pr = /*#__PURE__*/ m$1((r)=>r.body.replace(/ /g, r.star ? "\u2423" : "\xA0"), "makeVerb"), P0 = qr, ua = `[ \r
...
var Ot = /*#__PURE__*/ m$1((r, e, t)=>{
    var a = r.consumeArg().tokens;
    if (a.length !== 1) throw new z("\\newcommand's first argument must be a macro name");
    var n = a[0].text, s = /*#__PURE__*/ r.isDefined(n);
    ...
    if (a = r.consumeArg().tokens, a.length === 1 && a[0].text === "[") {
        for(var h = "", c = /*#__PURE__*/ r.expandNextToken(); c.text !== "]" && c.text !== "EOF";)h += c.text, c = /*#__PURE__*/ r.expandNextToken();
        if (!h.match(/^\s*[0-9]+\s*$/)) throw new z("Invalid number of arguments: " + h);
        o = /*#__PURE__*/ parseInt(h), a = r.consumeArg().tokens;
    }
...
m("\\show", (r)=>{
    ...
    return console.log(e, /*#__PURE__*/ r.macros.get(t), P0[t], W.math[t], W.text[t]), "";
});
m("\\bgroup", "{");
m("\\egroup", "}");
m("~", "\\nobreakspace");
...
var ha = /*#__PURE__*/ T(S0["Main-Regular"][84][1] - .7 * S0["Main-Regular"][65][1]);
...
}, br = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, qe = /*#__PURE__*/ Object.freeze({
    "\u208A": "+",
    "\u208B": "-",
    "\u208C": "=",
    "\u208D": "(",
