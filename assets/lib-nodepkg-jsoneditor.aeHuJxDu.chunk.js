...
var _e, _t, _n;
var e, t, n, l;
import { c as a, I as i, j as r, a as o, r as d, s, b as p, d as c, e as u, f as h, T as y, F as v, g as m, o as f, t as x, h as b } from "./lib-nodepkg-vuekit.BuMHRMp9.chunk.js";
import { o as g, J as w, S as N, a as C, b as S, r as $, s as k, E as O } from "./lib-nodepkg-typedef.BsYo_O8x.chunk.js";
import { s as E, v as I, P as T, a as A, b as D, B as R } from "./lib-nodepkg-vueuikit.BRE8okFg.chunk.js";
import { I as J, a as L, m as P, b as M, c as B, d as _, e as W } from "./lib-nodepkg-vuematerial.CVl0YFoA.chunk.js";
import { O as j, s as z, m as H, f as F, d as U, t as V, E as K, c as X, B as q, S as G } from "./vendor-rxjs.0fvETg7O.chunk.js";
import { i as Q, g as Y, a as Z, b as ee, s as et, l as en, c as el, d as ea, e as ei } from "./vendor-innoai-tech-lodash.BIpaKHXU.chunk.js";
import { M as er } from "./lib-nodepkg-vuemarkdown.DR5du_WU.chunk.js";
...
let ey = D({ apply(e6) {
  ...
  return d(o2, i2((e7) => {
    var t3, n3, l3, i3;
    return r(T, { isOpen: e7, onClickOutside: () => o2.hide(), onEscKeydown: () => o2.hide(), placement: "bottom-start", middleware: [ey], $content: r(em, { onClick: s2, children: null === (t3 = a2.content) || void 0 === t3 ? void 0 : t3.call(a2) }), children: null !== (i3 = null === (l3 = a2.default) || void 0 === l3 ? void 0 : null === (n3 = l3.call(a2)) || void 0 === n3 ? void 0 : n3[0]) && void 0 !== i3 ? i3 : null });
  }));
...
o((e6, t2) => {
  ...
  return d(i2, a2((e7) => {
    var t3, n3, a3, o2;
    return r(T, { isOpen: e7, onClickOutside: () => i2.hide(), placement: "bottom-start", $content: r(em, { children: null === (t3 = l2.content) || void 0 === t3 ? void 0 : t3.call(l2) }), children: null !== (o2 = null === (a3 = l2.default) || void 0 === a3 ? void 0 : null === (n3 = a3.call(l2)) || void 0 === n3 ? void 0 : n3[0]) && void 0 !== o2 ? o2 : null });
  }));
}, { displayName: "Popover", props: ["open$"] });
let em = E("div", { displayName: "PopoverContainer" })({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: I("sys.outline-variant", A(0.38)) }), ef = E("div", { displayName: "MenuItem" })({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), ex = o((e6, t2) => {
  let { slots: n2, render: l2 } = t2, a2 = new eh(false);
  return d(a2, l2((t3) => {
    var l3, i2;
    let o2 = null === (l3 = n2.default) || void 0 === l3 ? void 0 : l3.call(n2)[0];
    return r(T, { isOpen: t3, placement: null !== (i2 = e6.placement) && void 0 !== i2 ? i2 : "left", $content: r(eg, { children: r(eb, { children: n2.title() }) }), children: o2 ? p(o2, { onMouseover: () => {
      a2.show();
    }, onMouseout: () => {
      a2.hide();
    } }) : null });
...
let eM = m(function() {
  ...
  let {} = t2;
  return () => r(ex, { $title: "复制当前节点为 JSON 字符串", children: r(eu, { type: "button", onClick: () => eM(JSON.stringify(e6.value, null, 2)), children: r(J, { path: M }) }) });
...
_n = new WeakMap();
let ez = a(() => new ej()), eH = o((e6, t2) => {
  let n2, { render: l2 } = t2, a2 = f(null), o2 = f(null), p2 = f(null), c2 = eW.from(p2), h2 = e_.from(p2), y2 = ez.use(), v2 = eh.from(p2), m2 = ed.use();
  ej.sync(y2, { editing$: v2, value$: e6.value$, path: () => e6.ctx.path });
  let b2 = () => {
  ...
  return (e6.allowRawJSON && d(h2, V((t3) => {
    let n3 = t3.trim();
    ...
    var n3, l3, i2;
    let [d2, s2, { index: c3 }] = t3, u2 = null !== (n3 = N.schemaProp(e6.typedef, "enum")) && void 0 !== n3 ? n3 : [], h3 = null !== (l3 = N.metaProp(e6.typedef, "enumLabels")) && void 0 !== l3 ? l3 : [];
  ...
  return d(e6.value$, n2((t3) => r(eI, { openToken: "{", closeToken: "}", $leading: r(ec, { children: r(eB, { value: t3 }) }), $trailing: r(eG, { ctx: e6.ctx, onAdd: (t4) => {
    ...
    return u(eT, { path: p2, dirty: l2.isDirty(d2, p2), title: N.metaProp(s2, "title"), description: N.metaProp(s2, "description"), children: [r(eN, { deprecated: N.schemaProp(s2, "deprecated"), $leading: r(eX, { onRemove: () => {
      l2.delete(p2);
    } }), children: String(o2) }), u(ew, { children: [":", " "] }), null === (i2 = a2.$value) || void 0 === i2 ? void 0 : i2.call(a2, s2, d2, { ...e6.ctx, path: p2, branch: [...e6.ctx.branch, d2] })] });
  }) })));
}, { displayName: "ObjectInput", props: ["typedef", "ctx", "value"] }), eG = o((e6, t2) => {
  let { emit: n2, render: l2 } = t2, a2 = f(null), o2 = eW.from(a2), p2 = e_.from(a2), c2 = eh.from(a2), h2 = ed.use(), y2 = new i({ index: 0 }), v2 = () => {
  ...
  let m2 = (t3) => {
    ...
    t3 ? (n2("add", t3), v2()) : h2.setError([...e6.ctx.path, N.RecordKey], "无效的属性值");
  };
  d(o2, V((e7) => {
    switch (e7.type) {
      case "SELECT":
  ...
  return d(X([p2, c2, y2, e6.options$]), l2((t3) => {
    ...
    return d2 ? d2.length > 0 ? r(eT, { path: e6.ctx.path, children: r(eU, { sx: { mx: -4 }, children: r(ev, { onSelected: (e7) => {
      m2(e7);
    }, open$: c2, $content: r("div", { children: d2.map((e7, t4) => n3 && !e7.propName.includes(n3) ? null : r(eQ, { propName: e7.propName, typedef: e7.typedef, "data-focus": t4 === i2.index % d2.length })) }), children: x2 }) }) }) : null : r(eT, { path: [...e6.ctx.path, N.RecordKey], children: r(eU, { sx: { mx: -4 }, children: r(T, { isOpen: l3, placement: "right-start", $content: u(eF, { children: [r(eu, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: r(J, { path: B }) }), r(eu, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: r(J, { path: _ }) })] }), children: r("div", { "data-input-wrapper": true, children: r("input", { ref: a2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)" }) }) }) }) });
  }));
  ...
  return d(e6.value$, n2((t3) => r(eI, { openToken: "[", closeToken: "]", $leading: r(ec, { children: r(eB, { value: t3 }) }), $trailing: r(e0, { ctx: e6.ctx, typedef: e6.typedef, onAdd: (t4) => {
    ...
    return u(eT, { path: s2, dirty: l2.isDirty(o2, s2), children: [r(eN, { $leading: r(e1, { onRemove: () => {
      l2.delete(s2);
  ...
  let { emit: n2, render: l2 } = t2, a2 = f(null), i2 = e_.from(a2), o2 = eW.from(a2), p2 = eh.from(a2), c2 = ed.use(), h2 = () => {
  ...
  let v2 = d(p2, l2((e7) => r(T, { isOpen: e7, placement: "right-start", $content: u(eF, { children: [r(eu, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: r(J, { path: B }) }), r(eu, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: r(J, { path: _ }) })] }), children: r("div", { "data-input-wrapper": true, children: r("input", { ref: a2, type: "text", placeholder: "添加数组项 (可粘贴 JSON 字符串)" }) }) })));
  ...
  let {} = e6, { emit: n2 } = t2;
  return () => r(ex, { $title: "移除项", children: r(eu, { type: "button", onClick: () => n2("remove"), children: r(J, { path: W }) }) });
  ...
  return d(e6.value$, n2((t3) => r(eI, { openToken: "{", closeToken: "}", $leading: r(ec, { children: r(eB, { value: t3 }) }), $trailing: r(eG, { ctx: e6.ctx, onAdd: (t4) => {
    ...
    if (!Object.hasOwn(t3, o2)) return null;
    let p2 = [...e6.ctx.path, o2];
    return u(eT, { path: p2, dirty: l2.isDirty(d2, p2), children: [r(eN, { $leading: r(eX, { onRemove: () => {
      l2.delete(p2);
    } }), children: String(o2) }), u(ew, { children: [":", " "] }), null === (i2 = a2.$value) || void 0 === i2 ? void 0 : i2.call(a2, s2, d2, { ...e6.ctx, path: p2, branch: [...e6.ctx.branch, d2] })] });
  }) })));
  ...
  return d(l2, n2((e7) => {
    ...
    return r(ez, { children: r(es, { value: { $value: null !== (n3 = a2.$value) && void 0 !== n3 ? n3 : e4 }, children: u(e5, { children: [r("section", { ref: i2 }), i2.value && r(eE, { value: { indent: 0, $container: i2 }, children: r(eT, { path: [], viewOnly: true, children: o2(l2.typedef, e7, O) }) })] }) }) });
  }));
