...
import { m, g } from './vendor-min-mermaid~chunk-Z2NOIGJN.DWxZ2T3l.chunk.js';
import { L as Lt } from './vendor-min-mermaid~chunk-3R3PQ5PD.DqcBTR0a.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { O as Or, G as Gf, S as no, t as tt, T as Zr, _ as co, a0 as oc, k as kh, j as jf, Z as Zf, J as Jf, b as td, Q as Qf, K as Kf, I as Il, X as Xf } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
var $ = class {
    constructor(){
        this.nodes = [];
        this.levels = new Map;
    ...
    clear() {
        Xf(), this.nodes = [], this.levels = new Map, this.outerNodes = [], this.classes = new Map, this.root = void 0;
    }
};
function fe(m) {
    if (!m.length) return [];
...
var we = 10, F = 10, E = 25, Ne = /*#__PURE__*/ m$1((m$2, a, n, o)=>{
    let c = o.db, l = /*#__PURE__*/ c.getConfig(), d$1 = l.padding ?? we, u = /*#__PURE__*/ c.getDiagramTitle(), W = /*#__PURE__*/ c.getRoot(), { themeVariables: r } = Or();
    if (!W) return;
    let P = u ? 30 : 0, T = /*#__PURE__*/ d(a), X = l.nodeWidth ? l.nodeWidth * F : 960, Y = l.nodeHeight ? l.nodeHeight * F : 500, G = X, q = Y + P;
    T.attr("viewBox", `0 0 ${G} ${q}`), Gf(T, q, G, l.useMaxWidth);
    let C;
    try {
        let e = l.valueFormat || ",";
