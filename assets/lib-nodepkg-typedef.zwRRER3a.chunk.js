...
function $(e10) {
  ...
  return T(e10) || b(e10) || !w(e10) || (j(e10) > 1 && (e10.set = e10.add = e10.clear = e10.delete = R), Object.freeze(e10), t2 && Object.entries(e10).forEach((e11) => {
    let [t3, r2] = e11;
    return $(r2, true);
  })), e10;
}
...
var J = { get(e10, t2) {
  ...
  let r2 = A(e10);
  if (!S(r2, t2)) {
    var n2 = e10, i2 = r2, a2 = t2;
    let o3 = B(i2, a2);
    return o3 ? "value" in o3 ? o3.value : (_a2 = o3.get) == null ? void 0 : _a2.call(n2.draft_) : void 0;
  }
  let o2 = r2[t2];
  return e10.finalized_ || !w(o2) ? o2 : o2 === U(e10.base_, t2) ? (X(e10), e10.copy_[t2] = Q(o2, e10)) : o2;
  ...
  if (!p) p = 1, t2 = e10 || (e10 = {}), function(e11) {
    ...
    e11("decorate", function(e12, t4, r3, n3) {
      if (g2(r3)) {
        ...
        for (var i3 = e12, a3 = t4, o3 = i3.length - 1; o3 >= 0; --o3) {
          var s3 = (0, i3[o3])(a3);
          if (!g2(s3) && !b2(s3)) {
      ...
      return b2(n3) && (n3 = void 0), function(e13, t5, r4, n4) {
        for (var i4 = e13.length - 1; i4 >= 0; --i4) {
          var a4 = (0, e13[i4])(t5, r4, n4);
          if (!g2(a4) && !b2(a4)) {
...
class er {
  ...
  static define(e10, t2, r2, n2) {
    if (e10 && e10.constructor && e10.constructor != Object) {
      if (f(r2)) return void Reflect.defineMetadata(t2, Z(Reflect.getMetadata(t2, e10) ?? n2 ?? {}, r2), e10);
...
class ei extends TypeError {
  constructor(e10, t2) {
    let r2, { message: n2, explanation: i2, ...a2 } = e10, { path: o2 } = e10, s2 = 0 === o2.length ? n2 : `At path: ${o2.join(".")} -- ${n2}`;
    super(i2 ?? s2);
...
const _ed = class _ed {
  static create(t2, r2, i2) {
    var _a2;
    let a2, o2 = r2 ?? ((_a2 = t2[_ed.underlying]) == null ? void 0 : _a2.schema) ?? {};
...
let eD = e_.create, eI = eO.create, eK = eN.create, eC = eP.create, eL = ej.create, eq = ef((e10, t2, r2) => eg.refine(e10, (e11) => !!e11 && e11.length >= t2 || (r2 ?? `Expected string value length great than or equal ${t2}, but received "${e11}"`), { minLength: t2 })), eW = ef((e10, t2, r2) => eg.refine(e10, (e11) => !!e11 && e11.length <= t2 || (r2 ?? `Expected string value length less than or equal ${t2}, but received "${e11}"`), { maxLength: t2 })), eV = ef((e10, t2, r2) => {
  let n2 = eg.refine(e10, (n3) => !!t2.test(n3) || (r2 ?? `Expected a ${e10.type} matching \`/${t2.source}/\` but received "${n3}"`), { pattern: t2.source });
  return r2 ? n2.use(to({ "x-pattern-err-msg": r2 })) : n2;
}), eJ = eS.create, eH = eM.create, eU = ef((e10, t2, r2) => eg.refine(e10, (e11) => e11 >= t2 || (r2 ?? `Expected value great than or equal ${t2}, but received "${e11}"`), { minimum: t2 })), eB = ef((e10, t2, r2) => eg.refine(e10, (e11) => e11 > t2 || (r2 ?? `Expected value great than ${t2}, but received "${e11}"`), { exclusiveMinimum: t2 })), eG = ef((e10, t2, r2) => eg.refine(e10, (e11) => e11 <= t2 || (r2 ?? `Expected value less than or equal ${t2}, but received "${e11}"`), { maximum: t2 })), eX = ef((e10, t2, r2) => eg.refine(e10, (e11) => e11 < t2 || (r2 ?? `Expected value less than or equal ${t2}, but received "${e11}"`), { exclusiveMaximum: t2 })), eQ = ef((e10, t2, r2) => eg.refine(e10, (e11) => e11 % t2 == 0 || (r2 ?? `Expected value multiple of ${t2}, but received "${e11}"`), { multipleOf: t2 })), eY = ex.create, eZ = eE.create, e0 = eA.create, e1 = eA.nativeEnum, e2 = eA.literal, e3 = e$.create, e4 = eR.create, e6 = ek.create, e5 = eT.create, e7 = ef((e10, t2, r2) => eg.refine(e10, (e11) => !!i(e11) && e11.length >= t2 || (r2 ?? `Expected array value at least ${t2}, but received "${e11 == null ? void 0 : e11.length}"`), { minItems: t2 })), e8 = ef((e10, t2, r2) => eg.refine(e10, (e11) => !!i(e11) && e11.length <= t2 || (r2 ?? `Expected array value  ${t2}, but received "${e11 == null ? void 0 : e11.length}"`), { maxItems: t2 })), e9 = ez.create, te = eF.create, tt = eF.discriminatorMapping, tr = ev.define, tn = eg.refine, ti = ef((e10, t2) => eb.create(e10, t2)), ta = ef((e10) => ew.create(e10)), to = ef((e10, t2) => eg.of(e10, { [ed.meta]: t2 })), ts = Object.freeze(Object.defineProperty({ __proto__: null, annotate: to, any: eI, array: e5, binary: eZ, boolean: eY, custom: tr, defaults: ti, discriminatorMapping: tt, enums: e0, exclusiveMaximum: eX, exclusiveMinimum: eB, integer: eH, intersection: e9, literal: e2, maxItems: e8, maxLength: eW, maximum: eG, minItems: e7, minLength: eq, minimum: eU, multipleOf: eQ, nativeEnum: e1, never: eK, nil: eC, number: eJ, object: e3, optional: ta, pattern: eV, record: e4, ref: eD, refine: tn, string: eL, tuple: e6, union: te }, Symbol.toStringTag, { value: "Module" })), tc = (e10) => {
  var _a2;
...
class tl {
  ...
  decode(t2) {
    let r2 = structuredClone(t2), n2 = this._decode(r2), i2 = false;
    if ((r2 == null ? void 0 : r2.title) && (n2 = n2.use(to({ title: r2 == null ? void 0 : r2.title })), i2 = true), r2 == null ? void 0 : r2.description) if (i2) n2 = n2.use(to({ description: r2 == null ? void 0 : r2.description }));
    else {
      let [e10, ...t3] = r2 == null ? void 0 : r2.description.split(/[.\n]/);
      n2 = n2.use(to({ title: e10, description: t3 ? t3.join("\n").trim() : void 0 }));
    }
    if (r2) {
      for (let t3 of tv) if (!e(r2[t3])) {
        if ("pattern" == t3) {
          n2 = n2.use(eV(new RegExp(r2[t3]), r2["x-pattern-err-msg"])), delete r2[t3];
          continue;
        }
        let e10 = ts[t3];
        e10 && (n2 = n2.use(e10(r2[t3])), delete r2[t3]);
      }
      delete r2.title, delete r2.description, Object.keys(r2).length > 0 && (n2 = n2.use(to(r2)));
    }
    return n2;
  }
  _decode(t2) {
...
let tu = (e10) => "object" === e10.type, tf = (e10) => "null" === e10.type, td = (e10) => "array" === e10.type, tp = (e10) => "number" === e10.type || "integer" === e10.type, th = (e10) => "string" === e10.type, ty = (e10) => "boolean" === e10.type, tm = { object: ["properties", "additionalProperties", "propertyNames", "maxProperties", "minProperties"], array: ["contains", "items", "additionalItems", "unevaluatedItems", "maxItems", "minItems", "uniqueItems", "maxContains", "minContains"], string: ["pattern", "contentMediaType", "contentEncoding", "contentSchema", "maxLength", "minLength"], number: ["maximum", "minimum", "multipleOf", "exclusiveMaximum", "exclusiveMinimum"] }, tv = ["maxProperties", "minProperties", "maxItems", "minItems", "uniqueItems", "pattern", "maxLength", "minLength", "maximum", "minimum", "multipleOf", "exclusiveMaximum", "exclusiveMinimum"], tg = (e10, t2) => t2.some((t3) => Object.hasOwn(e10, t3)), tb = (e10) => !tg(e10, ["type", "$ref", "$id", "oneOf", "anyOf", "allOf"]), tw = function() {
  let e10 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
  if (s(e10)) return {};
  if (!e10.type) {
