...
var ex = eb ? (e) => eb.createHTML(e) : (e) => e, ew = "undefined" != typeof document ? document : null, eC = ew && ew.createElement("template"), ek = "transition", eP = "animation", eM = Symbol("_vtc"), eS = {
	...
	leaveToClass: String
}, e_ = ei({}, ee, eS), eA = ((eu = (e, { slots: t }) => X(K, function(e) {
	let t = {};
	for (let r in e) r in eS || (t[r] = e[r]);
	if (!1 === e.css) return t;
	let { name: n = "v", type: a, duration: i, enterFromClass: o = `${n}-enter-from`, enterActiveClass: l = `${n}-enter-active`, enterToClass: c = `${n}-enter-to`, appearFromClass: u = o, appearActiveClass: h = l, appearToClass: f = c, leaveFromClass: d = `${n}-leave-from`, leaveActiveClass: m = `${n}-leave-active`, leaveToClass: g = `${n}-leave-to` } = e, p = function(e) {
		...
		e._enterCancelled = n, e$(e, t ? f : c), e$(e, t ? h : l), r && r();
	}, A = (e, t) => {
		e._isLeaving = !1, e$(e, d), e$(e, g), e$(e, m), t && t();
	}, T = (e) => (t, r) => {
		let n = e ? M : x, i = () => _(t, e, r);
		eT(n, [t, i]), eO(() => {
			e$(t, e ? u : o), eD(t, e ? f : c), eR(n) || eI(t, a, y, i);
		});
	};
	return ei(t, {
		onBeforeEnter(e) {
...
var eX = Symbol("_vei"), eJ = /(?:Once|Passive|Capture)$/, eZ = 0, eQ = Promise.resolve(), e0 = (e) => 111 === e.charCodeAt(0) && 110 === e.charCodeAt(1) && e.charCodeAt(2) > 96 && 123 > e.charCodeAt(2), e1 = ei({ patchProp: (e, t, r, n, a, o) => {
	...
	if ("class" === t) {
		var l;
		let t;
		l = n, (t = e[eM]) && (l = (l ? [l, ...t] : [...t]).join(" ")), null == l ? e.removeAttribute("class") : s ? e.setAttribute("class", l) : e.className = l;
		...
		if (n && s) s.value = n;
			...
			if (n) {
				...
				}).value = c, s.attached = eZ || (eQ.then(() => eZ = 0), eZ = Date.now()), s), e.addEventListener(r, l, h);
			} else s && (e.removeEventListener(r, s, h), o[t] = void 0);
		}
	...
	processAll(t, r = !0) {
		...
		if (a) {
			...
			e.walkStateValues(a, (e, n, a) => {
				...
				this.process(s, o, e, !1), t[i] = s[o], f(r, [...a, o], `var(${i})`);
...
var rM = class e {
	...
	constructor(t, { cssVar: r, transformFallback: n }) {
		e.walkValues(t.value, (e, a) => {
			...
			if (f(this._cssVarRefs, [i], r(i)), d(e)) for (let t in e) o(e[t], (e, r) => {
				f(this._values, [`${i}${r ? `/${r}` : ""}`, t], e);
			});
			else o(e, (e, t) => {
				f(this._values, [`${i}${t ? `/${t}` : ""}`], e);
			});
		});
	}
	get tokens() {
...
let rA = (e) => {
	...
	return {
		...e,
		color: { sys: l(r_, (e) => u(t, (t, r) => _(e, (e) => r.indexOf(e) > -1))) }
	};
...
var rD = (e) => e.reduce((e, t) => Object.assign(e, { [t]: !0 }), {}), r$ = class e {
	...
	constructor(e, t = {}) {
		for (let r in this.theme = e, this.varPrefix = t.varPrefix ?? "vk", this.mode = t.mode ?? "light", f(this.cssVars, [this.cssVar("space", "dp")], "0.1rem"), e) {
			let t = e[r];
			if (t) {
				if (t.type === rC.var) {
					let e = new rM(t, {
					...
					for (let t of e.tokens) for (let a of ["light", "dark"]) {
						...
						n(o) || ("_default" === i ? f(this.cssVars, [this.cssVar(r, t)], o) : f(this.cssVars, [i, this.cssVar(r, t)], o));
					}
					continue;
				}
				if (t.type === rC.mixin) {
...
var nd = {
	...
	static toHEX = (e) => `#${nm(e).map((e) => h(e.toString(16), 2, "0")).join("")}`;
	...
	static fromColors = (t) => {
		...
		return i && (u.n1 = r6.fromHueAndChroma(nh(i), 4)), o && (u.n2 = r6.fromHueAndChroma(nh(o), 8)), new e({
			primary: u.a1,
			secondary: u.a2,
			tertiary: u.a3,
			neutral: u.n1,
...
function ao(...e) {
	...
	return r ??= (e, t) => (r) => {
		...
		let t = Object.assign(c({
			...
			let o = nC.use(), s = an.use(), l = aa(s), c = R(""), u = o.unstable_css(s, e), h = () => ("0" !== u.name ? `${s.key}-${u.name}${c.value}` : `${c.value}`) + (t.name ? ` ${t.name}` : "");
			if (a.__styled) {
				let e = o.unstable_css(s, n.sx ?? {});
				"0" !== e.name && (c.value = ` ${s.key}-${e.name}`), V(() => {
					l({
						serialized: u,
						isStringTag: !0
					}), l({
...
let ac = et(() => ({ mountPoint: () => document.body }), { name: "OverlaySetting" });
var au = et(() => new ah(es(null), es(null), () => !1), { name: "Overlay" }), ah = class {
	children = [];
	constructor(e, t, r) {
...
}, af = c((e, { slots: t, attrs: r, emit: n }) => {
	let a = e.contentRef || es(null), i = new ah(e.triggerRef ?? es(null), a, () => !!e.isOpen), o = ac.use();
	return B(au.use().add(i)), window && j(H(a, "value"), G((e) => {
		if (!e) return;
		let t = (e) => {
