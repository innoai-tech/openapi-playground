import { h, x as x$1 } from './vendor-min-mermaid~chunk-TLQDAFRX.CgcyZEvl.chunk.js';
import { M, S as St, W as Wt$1 } from './vendor-min-mermaid~chunk-RGZHNYJS.BZGdGDWl.chunk.js';
import { f } from './vendor-min-mermaid~chunk-TI4EEUUG.BFlBPHyk.chunk.js';
import { U as Uo, G as Go, H as Ho, N as No, u as ur, R as Ro, v, r as rt, n as nn } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
...
var F = [], mt = [
    ...
    getConfig: /*#__PURE__*/ m$1(()=>ur().c4, "getConfig"),
    clear: d0,
    LINETYPE: f0,
    ARROWTYPE: p0,
    PLACEMENT: y0,
...
var se = /*#__PURE__*/ m$1(function(e, t) {
    ...
    function t(l, n, a, r, i, u, d, b) {
        let { fontSize: p, fontFamily: E, fontWeight: T } = b, D = /*#__PURE__*/ l.split(nn.lineBreakRegex);
...
var x = {}, Wt = class {
    ...
    v(x, e), e.fontFamily && (x.personFontFamily = x.systemFontFamily = x.messageFontFamily = e.fontFamily), e.fontSize && (x.personFontSize = x.systemFontSize = x.messageFontSize = e.fontSize), e.fontWeight && (x.personFontWeight = x.systemFontWeight = x.messageFontWeight = e.fontWeight);
...
function z(e, t, s, o, l) {
    if (!t[e].width) if (s) t[e].text = /*#__PURE__*/ St(t[e].text, l, o), t[e].textLines = t[e].text.split(nn.lineBreakRegex).length, t[e].width = l, t[e].height = /*#__PURE__*/ Wt$1(t[e].text, o);
    else {
        let n = /*#__PURE__*/ t[e].text.split(nn.lineBreakRegex);
...
var P0 = /*#__PURE__*/ m$1(function(e, t, s, o) {
    x = ur().c4;
    let l = ur().securityLevel, n;
    l === "sandbox" && (n = /*#__PURE__*/ ia("#i" + t));
    let a = l === "sandbox" ? ia(n.nodes()[0].contentDocument.body) : ia("body"), r = o.db;
    o.db.setWrap(x.wrap), Se = /*#__PURE__*/ r.getC4ShapeInRow(), le = /*#__PURE__*/ r.getC4BoundaryInRow(), pt.debug(`C:${JSON.stringify(x, null, 2)}`);
    ...
    d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * x.diagramMarginX).attr("y", p.starty + x.diagramMarginY), Ro(i, T, P, x.useMaxWidth);
    let B = d ? 60 : 0;
    i.attr("viewBox", p.startx - x.diagramMarginX + " -" + (x.diagramMarginY + B) + " " + P + " " + (T + B)), pt.debug("models:", p);
}, "draw"), ce = {
