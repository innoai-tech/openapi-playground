import { gt as mr, hn as pt } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.BVgxNvHA.chunk.js";
import { N as _f, Q as m$1, U as sn, x as Jr } from "./vendor-min-mermaid~architecture-U656AL7Q-3ZQKGQJL.BH0ewMis.chunk.js";
import { n, s as m } from "./vendor-min-mermaid~blockDiagram-BWRZOBD3.B56fyXqp.chunk.js";
import { _ as Rd, b as xa, c as cr, d as kr, f as pr, h as Gd, l as dr, m as Ed, p as D, u as fr, v as Td, y as ba } from "./vendor-min-mermaid~chunk-AI4T2ZLM.LnVbLFqH.chunk.js";
import { t as fn } from "./vendor-min-mermaid~chunk-CCU7O4O5.B0DPvawz.chunk.js";
function h(e) {
	var t = {
		options: {
...
var ae = /* @__PURE__ */ m$1((e, t, n$1) => {
	...
	e.nodes().forEach(function(n$1) {
		...
		c.length > 0 ? (pt.debug("Cluster identified", n$1, v), s.forEach((o) => {
			let l = /* @__PURE__ */ J(o.v, n$1), u = /* @__PURE__ */ J(o.w, n$1);
			l ^ u && (pt.warn("Edge: ", o, " leaves cluster ", n$1), pt.warn("Descendants of XXX ", n$1, ": ", /* @__PURE__ */ v.get(n$1)), a.get(n$1).externalConnections = !0);
...
Parent cluster`, s.height), t.setNode(s.id, w), t.parent(f) || (pt.trace("Setting parent", f, s.id), t.setParent(f, s.id, w));
	...
	return await Promise.all(/* @__PURE__ */ te(t).map(async function(f) {
		...
		dr(r, /* @__PURE__ */ fr(m$2, r, a, n$1, w, E, c));
