...
import { e as Lt, t as tt, u as ug, h as fg, G as Gc, Y as Yc, j as cg, k as hg, x as Rc, f as go, s as sg, y as lg, z as ag, o as ig, A as ng, D as og, I as rg, l as eg, n as tg, J as Ac, K as Mc, d as Bc, Q as ja, U as Fi, V as dx, g as gC, i as ih } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
import { k as ki, t as qs } from './vendor-min-mermaid~chunk-6BY5RJGC.DU6P-5on.chunk.js';
...
`, "ig");
        ...
        let n, i = [];
        for(; (n = ja.exec(t)) !== null;)if (n.index === ja.lastIndex && ja.lastIndex++, n && !e || e && n[1]?.match(e) || e && n[2]?.match(e)) {
...
function ve(t, e, r) {
    ...
    let i = 25 + t, o = T(n, i), s = 10 + t * .5, u = Math.atan2(n[0].y - o.y, n[0].x - o.x), c = {
        x: 0,
        y: 0
    };
