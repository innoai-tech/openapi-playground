import { h, x as x$1 } from './vendor-min-mermaid~chunk-FJQDG6D3.OB9jmE-Z.chunk.js';
import { M, $ as $e$1, W as We$1 } from './vendor-min-mermaid~chunk-CRSA2SMT.DrUenSi3.chunk.js';
import { f } from './vendor-min-mermaid~chunk-TI4EEUUG.BFlBPHyk.chunk.js';
import { Z as Zf, K as Kf, j as jf, X as Xf, h as hh, k as kh, t as tt, Y as Yf, M as Mt$1, D as De$1, e as XC } from './vendor-min-mermaid~chunk-63ZE7VZ5.CfadwiGU.chunk.js';
...
var Mt = /*#__PURE__*/ function() {
    var e = /*#__PURE__*/ m$1(function(xt, m, _, k) {
        ...
        performAction: /*#__PURE__*/ m$1(function(m, _, k, g, R, h, Dt) {
            var f = h.length - 1;
            switch(R){
                case 3:
                    g.setDirection("TB");
                ...
                case 12:
                    ...
                    break;
                case 19:
                    g.setTitle(/*#__PURE__*/ h[f].substring(6)), this.$ = /*#__PURE__*/ h[f].substring(6);
                    break;
                case 20:
                    g.setAccDescription(/*#__PURE__*/ h[f].substring(15)), this.$ = /*#__PURE__*/ h[f].substring(15);
                    break;
                case 21:
                    this.$ = /*#__PURE__*/ h[f].trim(), g.setTitle(this.$);
                    break;
                case 22:
                case 23:
                    this.$ = /*#__PURE__*/ h[f].trim(), g.setAccDescription(this.$);
                    break;
                case 28:
                ...
                case 73:
                case 75:
                    this.$ = /*#__PURE__*/ h[f].trim();
                    break;
                case 74:
                    let Et = {};
                    Et[h[f - 1].trim()] = /*#__PURE__*/ h[f].trim(), this.$ = Et;
                    break;
                case 76:
                    this.$ = "";
                    break;
        ...
        parse: /*#__PURE__*/ m$1(function(m) {
            var _ = this, k = [
                ...
                null
            ], h = [], Dt = this.table, f = "", Et = 0, ue = 0, de = 0, Ye = 2, fe = 1, Ie = /*#__PURE__*/ h.slice.call(arguments, 1), S = /*#__PURE__*/ Object.create(this.lexer), At = {
                yy: {}
            };
            ...
            function L0(Y) {
                k.length = k.length - 2 * Y, R.length = R.length - Y, h.length = h.length - Y;
            }
            m$1(L0, "popStack");
            function Ue() {
                var Y;
            ...
            m$1(Ue, "lex");
            for(var M, Zt, Ct, I, N0, $t, Tt = {}, It, W, pe, jt;;){
                if (Ct = k[k.length - 1], this.defaultActions[Ct] ? I = this.defaultActions[Ct] : ((M === null || typeof M > "u") && (M = /*#__PURE__*/ Ue()), I = Dt[Ct] && Dt[Ct][M]), typeof I > "u" || !I.length || !I[0]) {
                    var te = "";
                    jt = [];
...
Expecting ` + jt.join(", ") + ", got '" + (this.terminals_[M] || M) + "'" : te = "Parse error on line " + (Et + 1) + ": Unexpected " + (M == fe ? "end of input" : "'" + (this.terminals_[M] || M) + "'"), this.parseError(te, {
                ...
                switch(I[0]){
                    case 1:
                        k.push(M), R.push(S.yytext), h.push(S.yylloc), k.push(I[1]), M = null, Zt ? (M = Zt, Zt = null) : (ue = S.yyleng, f = S.yytext, Et = S.yylineno, Jt = S.yylloc, de > 0);
                        break;
                    case 2:
                        ...
                        W && (k = /*#__PURE__*/ k.slice(0, -1 * W * 2), R = /*#__PURE__*/ R.slice(0, -1 * W), h = /*#__PURE__*/ h.slice(0, -1 * W)), k.push(this.productions_[I[1]][0]), R.push(Tt.$), h.push(Tt._$), pe = Dt[k[k.length - 2]][k[k.length - 1]], k.push(pe);
                        break;
                    case 3:
                        return true;
                }
...
` + _ + "^";
            ...
            next: /*#__PURE__*/ m$1(function() {
                ...
                for(var R = /*#__PURE__*/ this._currentRules(), h = 0; h < R.length; h++)if (k = /*#__PURE__*/ this._input.match(this.rules[R[h]]), k && (!_ || k[0].length > _[0].length)) {
                    if (_ = k, g = h, this.options.backtrack_lexer) {
                        if (m = /*#__PURE__*/ this.test_match(k, R[h]), m !== false) return m;
                        if (this._backtrack) {
                            _ = false;
                            continue;
                        } else return false;
...
var F = [], mt = [
    ...
    ve = /*#__PURE__*/ De$1(e, /*#__PURE__*/ hh());
    ...
    re = /*#__PURE__*/ De$1(e, /*#__PURE__*/ hh());
}, "setTitle"), Nt = {
    ...
    getConfig: /*#__PURE__*/ m$1(()=>hh().c4, "getConfig"),
    clear: d0,
    LINETYPE: f0,
    ARROWTYPE: p0,
    PLACEMENT: y0,
...
var se = /*#__PURE__*/ m$1(function(e, t) {
    ...
    return d.fontWeight = "bold", d.fontSize = d.fontSize + 2, d.fontColor = n, Q(s)(t.label.text, r, t.x, t.y + t.label.Y, t.width, t.height, {
        fill: n
    }, d), d = /*#__PURE__*/ s[t.typeC4Shape.text + "Font"](), d.fontColor = n, t.techn && t.techn?.text !== "" ? Q(s)(t.techn.text, r, t.x, t.y + t.techn.Y, t.width, t.height, {
        fill: n,
        "font-style": "italic"
    ...
    function t(l, n, a, r, i, u, d, b) {
        let { fontSize: p, fontFamily: E, fontWeight: T } = b, D = /*#__PURE__*/ l.split(XC.lineBreakRegex);
...
}, oe = /*#__PURE__*/ m$1(function(e) {
    Mt$1(x, e), e.fontFamily && (x.personFontFamily = x.systemFontFamily = x.messageFontFamily = e.fontFamily), e.fontSize && (x.personFontSize = x.systemFontSize = x.messageFontSize = e.fontSize), e.fontWeight && (x.personFontWeight = x.systemFontWeight = x.messageFontWeight = e.fontWeight);
...
function z(e, t, s, o, l) {
    if (!t[e].width) if (s) t[e].text = /*#__PURE__*/ $e$1(t[e].text, l, o), t[e].textLines = t[e].text.split(XC.lineBreakRegex).length, t[e].width = l, t[e].height = /*#__PURE__*/ We$1(t[e].text, o);
    else {
        let n = /*#__PURE__*/ t[e].text.split(XC.lineBreakRegex);
...
var Pe = /*#__PURE__*/ m$1(function(e, t, s) {
    ...
    for (let n of o){
        ...
        switch(r.fontSize = r.fontSize - 2, a.typeC4Shape.width = /*#__PURE__*/ M("\xAB" + a.typeC4Shape.text + "\xBB", r), a.typeC4Shape.height = r.fontSize + 2, a.typeC4Shape.Y = x.c4ShapePadding, l = a.typeC4Shape.Y + a.typeC4Shape.height - 4, a.image = {
            width: 0,
            height: 0,
            Y: 0
        }, a.typeC4Shape.text){
    ...
    static #_ = m$1(this, "Point");
    constructor(t, s){
        this.x = t, this.y = s;
    }
}, De = /*#__PURE__*/ m$1(function(e, t) {
...
function Le(e, t, s, o, l) {
    ...
    for (let [a, r] of o.entries()){
        ...
        let E = /*#__PURE__*/ l.db.getBoundaries(t);
...
var P0 = /*#__PURE__*/ m$1(function(e, t, s, o) {
    x = hh().c4;
    let l = hh().securityLevel, n;
    l === "sandbox" && (n = /*#__PURE__*/ kh("#i" + t));
    let a = l === "sandbox" ? kh(n.nodes()[0].contentDocument.body) : kh("body"), r = o.db;
    o.db.setWrap(x.wrap), Se = /*#__PURE__*/ r.getC4ShapeInRow(), le = /*#__PURE__*/ r.getC4BoundaryInRow(), tt.debug(`C:${JSON.stringify(x, null, 2)}`);
    let i = l === "sandbox" ? a.select(`[id="${t}"]`) : kh(`[id="${t}"]`);
    ...
    let d = /*#__PURE__*/ o.db.getTitle(), b = /*#__PURE__*/ o.db.getBoundaries("");
    ...
    d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * x.diagramMarginX).attr("y", p.starty + x.diagramMarginY), Yf(i, T, P, x.useMaxWidth);
    let B = d ? 60 : 0;
