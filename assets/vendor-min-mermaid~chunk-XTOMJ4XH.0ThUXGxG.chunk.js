import { $ as Vo, A as $o, F as Go, G as No, I as Ho, Q as Uo, _ as Ut, d as Ct, dt as hn, gt as mr, hn as pt, pt as jo } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.DWYnMD9N.chunk.js";
...
import { t as S } from "./vendor-min-mermaid~chunk-A6NU47M6.CTZRTDvy.chunk.js";
	...
	draw: /* @__PURE__ */ m$1(async function(t, e, s, n) {
		...
		try {
			(typeof n.db.getLinks == "function" ? n.db.getLinks() : /* @__PURE__ */ new Map()).forEach((b, L) => {
				...
				if (!x) {
					pt.warn("⚠️ Invalid or missing stateId from key:", /* @__PURE__ */ JSON.stringify(L));
					return;
				}
