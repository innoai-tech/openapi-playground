...
import { x as xa, T as Td, E as Ed } from './vendor-min-mermaid~chunk-EQI6KKA3.DOKLknab.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { m as mr, d as dr, a as Ni, o as ot, e as U, f as c, g } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
...
var x = [], se = [], re = 0, oe = {}, Ce = /*#__PURE__*/ m$1(()=>{
    ...
    let e = [], g = [], p = /*#__PURE__*/ _e(), r = /*#__PURE__*/ mr();
    for (let d of p){
        let _ = {
            id: d.id,
            label: /*#__PURE__*/ ot(d.label ?? "", r),
            isGroup: true,
            ticket: d.ticket,
            shape: "kanbanSection",
            level: d.level,
    ...
    let _ = /*#__PURE__*/ mr(), b = _.mindmap?.padding ?? Ni.mindmap.padding;
    switch(r){
        case f.ROUNDED_RECT:
        case f.RECT:
        case f.HEXAGON:
...
` + d + `
    ...
    if (!e) return;
    let g = /*#__PURE__*/ mr(), p = x[x.length - 1];
    e.icon && (p.icon = /*#__PURE__*/ ot(e.icon, g)), e.class && (p.cssClasses = /*#__PURE__*/ ot(e.class, g));
...
` + e);
    let _ = /*#__PURE__*/ r.db.getData(), b = /*#__PURE__*/ mr();
    b.htmlLabels = false;
