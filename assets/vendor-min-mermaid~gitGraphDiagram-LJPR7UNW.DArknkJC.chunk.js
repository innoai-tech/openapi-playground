...
import { U as Ut, L as Lt, w as wt } from './vendor-min-mermaid~chunk-3R3PQ5PD.DqcBTR0a.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { b as td, J as Jf, K as Kf, Q as Qf, Z as Zf, j as jf, t as tt$1, h as hh, k as kh, ap as id, X as Xf, e as jC, O as Or, I as Il } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
var u = {
    NORMAL: 0,
    REVERSE: 1,
    HIGHLIGHT: 2,
...
var he = Il.gitGraph, M = /*#__PURE__*/ m$1(()=>Lt({
        ...he,
        ...Or().gitGraph
    }), "getConfig"), i = new s(()=>{
...
var fe = /*#__PURE__*/ m$1(function(r) {
    ...
    let n = /*#__PURE__*/ M();
    o = /*#__PURE__*/ jC.sanitizeText(o, n), e = /*#__PURE__*/ jC.sanitizeText(e, n), t = t?.map((s)=>jC.sanitizeText(s, n));
    let m = {
    ...
    i.records.head = m, tt$1.info("main branch", n.mainBranchName), i.records.commits.has(m.id) && tt$1.warn(`Commit ID ${m.id} already exists`), i.records.commits.set(m.id, m), i.records.branches.set(i.records.currBranch, m.id), tt$1.debug("in pushCommit " + m.id);
}, "commit"), xe = /*#__PURE__*/ m$1(function(r) {
    let e = r.name, o = r.order;
    if (e = /*#__PURE__*/ jC.sanitizeText(e, /*#__PURE__*/ M()), i.records.branches.has(e)) throw new Error(`Trying to create an existing branch. (Help: Either use a new name if you want create a new branch or try using "checkout ${e}")`);
    ...
    e = /*#__PURE__*/ jC.sanitizeText(e, n), o && (o = /*#__PURE__*/ jC.sanitizeText(o, n));
    ...
    let n = /*#__PURE__*/ M();
    if (e = /*#__PURE__*/ jC.sanitizeText(e, n), o = /*#__PURE__*/ jC.sanitizeText(o, n), a = a?.map((g)=>jC.sanitizeText(g, n)), t = /*#__PURE__*/ jC.sanitizeText(t, n), !e || !i.records.commits.has(e)) {
    ...
    if (r = /*#__PURE__*/ jC.sanitizeText(r, /*#__PURE__*/ M()), i.records.branches.has(r)) {
...
var Ie = /*#__PURE__*/ hh(), w = Ie?.gitGraph, P = 10, D = 40, k = 4, T = 2, G = 8, b = new Map, C = new Map, R = 30, L = new Map, A = [], E = 0, y = "LR", qe = /*#__PURE__*/ m$1(()=>{
...
`, "id:", e, o), !w) throw new Error("GitGraph config not found");
    ...
    }), ie(s, L, false), w.showBranches && Qe(s, m), Xe(s, L), ie(s, L, true), Ut.insertTitle(s, "gitTitleText", w.titleTopMargin ?? 0, /*#__PURE__*/ n.getDiagramTitle()), id(void 0, s, w.diagramPadding, w.useMaxWidth);
}, "draw"), de = {
    draw: tt
};
