import { B as Bf, F as Ff, L as Lf, M as Mf, w as wf, v as vf, H as Hl, t as tt, i as ih, T as Tf, S as Sf, p as pl, W as hl, a1 as Is, O as Oe } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.ByXaayWf.chunk.js';
import './lib-nodepkg-typedef.BfNI1ZyL.chunk.js';
var Et = function() {
    var t = m$1(function(X, o, l, x) {
        ...
        performAction: m$1(function(o, l, x, d, k, e, ht) {
            var s = e.length - 1;
            switch(k){
                case 23:
                    this.$ = e[s];
...
Expecting ` + mt.join(", ") + ", got '" + (this.terminals_[z] || z) + "'" : Lt = "Parse error on line " + (yt + 1) + ": Unexpected " + (z == ee ? "end of input" : "'" + (this.terminals_[z] || z) + "'"), this.parseError(Lt, {
        ...
        var X = {
            EOF: 1,
            parseError: m$1(function(l, x) {
                if (this.yy.parser) this.yy.parser.parseError(l, x);
                else throw new Error(l);
            }, "parseError"),
            setInput: m$1(function(o, l) {
...
` + l + "^";
            ...
            test_match: m$1(function(o, l) {
                ...
                ]), this._more = false, this._backtrack = false, this._input = this._input.slice(o[0].length), this.matched += o[0], x = this.performAction.call(this, this.yy, this, l, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), x) return x;
                if (this._backtrack) {
...
` + this.showPosition(), {
            ...
            performAction: m$1(function(l, x, d, k) {
                switch(d){
                    case 0:
                        break;
                    case 1:
...
var V = hl(), qt = class {
    ...
    static #_ = m$1(this, "QuadrantBuilder");
    getDefaultData() {
        return {
            titleText: "",
            quadrant1Text: "",
    ...
    getDefaultConfig() {
        return {
            ...
            showYAxis: true,
            showTitle: true,
            chartHeight: pl.quadrantChart?.chartWidth || 500,
            chartWidth: pl.quadrantChart?.chartHeight || 500,
            titlePadding: pl.quadrantChart?.titlePadding || 10,
            titleFontSize: pl.quadrantChart?.titleFontSize || 20,
            quadrantPadding: pl.quadrantChart?.quadrantPadding || 5,
            xAxisLabelPadding: pl.quadrantChart?.xAxisLabelPadding || 5,
            yAxisLabelPadding: pl.quadrantChart?.yAxisLabelPadding || 5,
            xAxisLabelFontSize: pl.quadrantChart?.xAxisLabelFontSize || 16,
            yAxisLabelFontSize: pl.quadrantChart?.yAxisLabelFontSize || 16,
            quadrantLabelFontSize: pl.quadrantChart?.quadrantLabelFontSize || 16,
            quadrantTextTopPadding: pl.quadrantChart?.quadrantTextTopPadding || 5,
            pointTextPadding: pl.quadrantChart?.pointTextPadding || 5,
            pointLabelFontSize: pl.quadrantChart?.pointLabelFontSize || 12,
            pointRadius: pl.quadrantChart?.pointRadius || 5,
            xAxisPosition: pl.quadrantChart?.xAxisPosition || "top",
            yAxisPosition: pl.quadrantChart?.yAxisPosition || "left",
            quadrantInternalBorderStrokeWidth: pl.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
            quadrantExternalBorderStrokeWidth: pl.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
        };
    }
    ...
    clear() {
        this.config = this.getDefaultConfig(), this.themeConfig = this.getDefaultThemeConfig(), this.data = this.getDefaultData(), this.classes = new Map, tt.info("clear called");
    }
    setData(n) {
        this.data = {
            ...this.data,
    ...
    getQuadrantPoints(n) {
        let { quadrantSpace: f } = n, { quadrantHeight: u, quadrantLeft: c, quadrantTop: g, quadrantWidth: y } = f, S = Is().domain([
            0,
            1
        ]).range([
            c,
...
var G = class extends Error {
    static #_ = m$1(this, "InvalidStyleError");
    constructor(n, f, u){
...
m$1(ze, "setHeight");
function Ve() {
    let t = Hl(), { themeVariables: n, quadrantChart: f } = t;
...
` + t);
    ...
    i === "sandbox" && (A = ih("#i" + n));
    let T = (i === "sandbox" ? ih(A.nodes()[0].contentDocument.body) : ih("body")).select(`[id="${n}"]`), m = T.append("g").attr("class", "main"), b = S.quadrantChart?.chartWidth ?? 500, q = S.quadrantChart?.chartHeight ?? 500;
    Tf(T, q, b, S.quadrantChart?.useMaxWidth ?? true), T.attr("viewBox", "0 0 " + b + " " + q), u.db.setHeight(q), u.db.setWidth(b);
