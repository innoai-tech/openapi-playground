...
import { D as Vc, L as Zc, O as Vn, Q as zc, V as ia, _ as Lc, a as As, b as Qc, g as Kc, h as Jc, o as Bc, q as pt, r as $s, x as Qs, z as Zs } from "./vendor-min-mermaid~chunk-63GW7ZVL.JXMkVvO5.chunk.js";
import { U as mr, m as Mo } from "./vendor-min-mermaid~chunk-KXVH62NG.DXOHBXLD.chunk.js";
import { c as Ut } from "./vendor-min-mermaid~chunk-EFRVIJHI.Df9d5nYk.chunk.js";
import { i as Rr } from "./vendor-min-mermaid~chunk-GOL2OBWC.B4BOjWXT.chunk.js";
import { n as s, r as w, t as d } from "./vendor-min-mermaid~chunk-RV6DXAHM.B4WAb6xn.chunk.js";
import { t as n } from "./vendor-min-mermaid~chunk-LM6QDVU5.Cv6-ZsBo.chunk.js";
import { n as g, r as m } from "./vendor-min-mermaid~chunk-5V7UUW6L.DAO7dsPA.chunk.js";
import { s as Rt, u as v } from "./vendor-min-mermaid~chunk-EQI6KKA3.DKxGc_Rn.chunk.js";
var xt = /* @__PURE__ */ m$1((r, t, a, s$1, i, n$1) => {
	...
	let p = `${i}_${n$1}-${o.type}${t === "start" ? "Start" : "End"}`;
	if (e && e.trim() !== "") {
		let d$1 = `${p}_${e.replace(/[^\dA-Za-z]/g, "_")}`;
...
var bt = /* @__PURE__ */ m$1(function(r, t, a) {
	let s$1 = t.x - r.x, i = t.y - r.y, e = a / Math.sqrt(s$1 * s$1 + i * i);
	return {
		x: t.x - e * s$1,
		y: t.y - e * i
	};
	...
	return `0 ${t} ${Array(o).fill(`${i} ${n$1}`).join(" ")} ${a}`;
