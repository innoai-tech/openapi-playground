...
import { F as ki, V as qs } from "./vendor-min-mermaid~chunk-A4ITRWGT.Q-yxLqnU.chunk.js";
import { $ as zs, D as Vc, F as Xc, L as Zc, O as Vn, Q as zc, S as Rs, V as ia, Y as qc, _ as Lc, b as Qc, d as Gc, f as Hc, g as Kc, h as Jc, j as Wc, o as Bc, q as pt, r as $s, u as Es, x as Qs, z as Zs } from "./vendor-min-mermaid~chunk-63GW7ZVL.JXMkVvO5.chunk.js";
import { $ as v, K as os, R as hn, S as Ti, u as Jt } from "./vendor-min-mermaid~chunk-KXVH62NG.DXOHBXLD.chunk.js";
...
`, "ig");
		...
		let n, i = [];
		for (; (n = /* @__PURE__ */ Ti.exec(e)) !== null;) if (n.index === Ti.lastIndex && Ti.lastIndex++, n && !t || t && n[1]?.match(t) || t && n[2]?.match(t)) {
...
function dt(e, t) {
	if (!e) return t;
	return ut[`curve${e.charAt(0).toUpperCase() + e.slice(1)}`] ?? t;
}
...
function vt(e, t, r) {
	...
	let o = /* @__PURE__ */ T(n, 25 + e), s = 10 + e * .5, u = /* @__PURE__ */ Math.atan2(n[0].y - o.y, n[0].x - o.x), c = {
		x: 0,
		y: 0
	};
...
var wt = /* @__PURE__ */ m((e) => Mt(e.length), "random"), Pt = /* @__PURE__ */ m(function() {
	...
	let r = /* @__PURE__ */ t.text.replace(hn.lineBreakRegex, " "), [, n] = $(t.fontSize), i = /* @__PURE__ */ e.append("text");
...
var S = /* @__PURE__ */ ki((e, t) => {
	...
	let [, o] = $(r), s = ["sans-serif", n], u = /* @__PURE__ */ e.split(hn.lineBreakRegex), c = [], l = /* @__PURE__ */ ia("body");
	if (!l.remove) return {
		width: 0,
		height: 0,
		lineHeight: 0
	...
	for (let h of s) {
		...
		for (let ot of u) {
			...
			g.width = /* @__PURE__ */ Math.round(/* @__PURE__ */ Math.max(g.width, y.width)), f$1 = /* @__PURE__ */ Math.round(y.height), g.height += f$1, g.lineHeight = /* @__PURE__ */ Math.round(/* @__PURE__ */ Math.max(g.lineHeight, f$1));
		}
		c.push(g);
	}
	p.remove();
	return c[isNaN(c[1].height) || isNaN(c[1].width) || isNaN(c[1].lineHeight) || c[0].height > c[1].height && c[0].width > c[1].width && c[0].lineHeight > c[1].lineHeight ? 0 : 1];
...
var Jt$1 = /* @__PURE__ */ m((e, t, { counter: r = 0, prefix: n, suffix: i }, o) => o || `${n ? `${n}_` : ""}${e}_${t}_${r}${i ? `_${i}` : ""}`, "getEdgeId");
function Vt(e) {
	return e ?? null;
}
...
export { zt as _, Lt as a, Ut as c, Xt as d, Yt as f, wt as g, dt as h, Jt$1 as i, Vt as l, ct as m, Ct as n, M as o, bt as p, It as r, St as s, $ as t, Wt as u };
