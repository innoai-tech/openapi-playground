...
import { m, S, u, p } from './vendor-min-mermaid~chunk-543QDF6V.CSpQVPcT.chunk.js';
import { R as Rr$1, A as Ae$1 } from './vendor-min-mermaid~chunk-HXN2J7W2.xQdsu3kt.chunk.js';
import { V as Vt$1, Y as Yt$1, $, M } from './vendor-min-mermaid~chunk-RGZHNYJS.BZGdGDWl.chunk.js';
import { A as Ao, u as ur$1, r as rt$1, a as Pi, M as Mt$1, l as lr$1, I as Io, n as nn, Y as Yo, b as an } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
...
var C = /*#__PURE__*/ m$1(async (c, t, i)=>{
    let r, e = t.useHtmlLabels || Ao(ur$1()?.htmlLabels);
    ...
    let l = await Rr$1(h, /*#__PURE__*/ rt$1(/*#__PURE__*/ Yt$1(s), /*#__PURE__*/ ur$1()), {
        useHtmlLabels: e,
        width: t.width || ur$1().flowchart?.wrappingWidth,
                ...
                ...m
                    ...
                    function u() {
                        if (g.style.display = "flex", g.style.flexDirection = "column", d) {
                            let b = ur$1().fontSize ? ur$1().fontSize : window.getComputedStyle(document.body).fontSize, S = 5, [k = Pi.fontSize] = $(b), w = k * S + "px";
    ...
    let r = i.useHtmlLabels || Ao(ur$1()?.flowchart?.htmlLabels), e = /*#__PURE__*/ c.insert("g").attr("class", "label").attr("style", i.labelStyle || ""), a = await Rr$1(e, /*#__PURE__*/ rt$1(/*#__PURE__*/ Yt$1(t), /*#__PURE__*/ ur$1()), {
        useHtmlLabels: r,
        width: i.width || ur$1()?.flowchart?.wrappingWidth,
        style: i.labelStyle,
...
m$1(pr, "applyStyle");
async function mr(c) {
    let t = /*#__PURE__*/ ia(/*#__PURE__*/ document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), i = /*#__PURE__*/ t.append("xhtml:div"), r = /*#__PURE__*/ ur$1(), e = c.label;
    c.label && lr$1(c.label) && (e = await Io(/*#__PURE__*/ c.label.replace(nn.lineBreakRegex, `
`), r));
    let h = '<span class="' + (c.isNode ? "nodeLabel" : "edgeLabel") + '" ' + (c.labelStyle ? 'style="' + c.labelStyle + '"' : "") + ">" + e + "</span>";
    return i.html(/*#__PURE__*/ rt$1(h, r)), pr(i, c.labelStyle), i.style("display", "inline-block"), i.style("padding-right", "1px"), i.style("white-space", "nowrap"), i.attr("xmlns", "http://www.w3.org/1999/xhtml"), t.node();
}
m$1(mr, "addHtmlLabel");
var fr = /*#__PURE__*/ m$1(async (c, t, i, r)=>{
    let e = c || "";
    if (typeof e == "object" && (e = e[0]), Ao(ur$1().flowchart.htmlLabels)) {
...
var He = /*#__PURE__*/ m$1(async (c, t)=>{
    ...
    p.attr("transform", `translate(${t.x - d.width / 2}, ${w + 1 - (Ao(i.flowchart.htmlLabels) ? 0 : 3)})`);
    ...
    let i = /*#__PURE__*/ ur$1(), { themeVariables: r, handDrawnSeed: e } = i, { nodeBorder: a } = r, h = /*#__PURE__*/ c.insert("g").attr("class", t.cssClasses).attr("id", t.id).attr("data-look", t.look), s = /*#__PURE__*/ h.insert("g", ":first-child"), l = 0 * t.padding, o = t.width + l;
    t.diff = -t.padding;
...
async function ms(c, t, { config: { themeVariables: i, flowchart: r } }) {
    ...
    t.icon && w.html(`<g>${await Ae$1(t.icon, {
        height: s,
        width: s,
        fallbackPrefix: ""
    })}</g>`);
...
async function vs(c, t, { config: { themeVariables: i } }) {
    let { labelStyles: r, nodeStyles: e } = m(t);
    t.labelStyle = r, t.useHtmlLabels || Mt$1().flowchart?.htmlLabels !== false || (t.centerLabel = true);
...
async function _s(c, t) {
    let { labelStyles: i, nodeStyles: r } = m(t);
    t.labelStyle = i;
    let { shapeSvg: e, bbox: a, label: h } = await C(c, t, /*#__PURE__*/ P(t)), s = /*#__PURE__*/ Ao(ur$1().flowchart?.htmlLabels), l = a.width + (t.padding ?? 0), o = l + a.height, n = l + a.height, p = [
        {
            x: 0,
            y: 0
        },
...
async function ye(c, t) {
    ...
    if (i.alias && (t.label = i.alias), t.look === "handDrawn") {
        let { themeVariables: Y } = Mt$1(), { background: J } = Y, tt = {
            ...t,
            id: t.id + "-background",
            look: "default",
            cssStyles: [
    ...
    let W = /*#__PURE__*/ R.rectangle(G, j, O, V, E), A = /*#__PURE__*/ n.insert(()=>W, ":first-child").attr("style", /*#__PURE__*/ h.join("")), { themeVariables: I } = Mt$1(), { rowEven: F, rowOdd: Q, nodeBorder: it } = I;
    m$1.push(0);
...
async function Gt(c, t, i, r = 0, e = 0, a = [], h = "") {
    ...
    t !== an(t) && (t = /*#__PURE__*/ an(t), t = /*#__PURE__*/ t.replaceAll("<", "&lt;").replaceAll(">", "&gt;"));
...
async function Zt(c, t, i, r = []) {
    let e = /*#__PURE__*/ c.insert("g").attr("class", "label").attr("style", /*#__PURE__*/ r.join("; ")), a = /*#__PURE__*/ Mt$1(), h = "useHtmlLabels" in t ? t.useHtmlLabels : Ao(a.htmlLabels) ?? true, s = "";
    "text" in t ? s = t.text : s = t.label, !h && s.startsWith("\\") && (s = /*#__PURE__*/ s.substring(1)), lr$1(s) && (h = true);
    let l = await Rr$1(e, /*#__PURE__*/ Yo(/*#__PURE__*/ Yt$1(s)), {
        width: M(s, a) + 50,
...
m$1(Zt, "addText");
async function Zs(c, t) {
    let i = /*#__PURE__*/ ur$1(), r = i.class.padding ?? 12, e = r, a = t.useHtmlLabels ?? Ao(i.htmlLabels) ?? true, h = t;
...
async function pt(c, t, i, r = "") {
    if (t === "") return 0;
    let e = /*#__PURE__*/ c.insert("g").attr("class", "label").attr("style", r), a = /*#__PURE__*/ ur$1(), h = a.htmlLabels ?? true, s = await Rr$1(e, /*#__PURE__*/ Yo(/*#__PURE__*/ Yt$1(t)), {
        width: M(t, a) + 50,
        classes: "markdown-node-label",
        useHtmlLabels: h,
        style: r
