...
import { $ as v, D as Wo, R as hn, T as Uo, U as mr, o as Go, q as ot, s as Ho, t as $o } from "./vendor-min-mermaid~chunk-KXVH62NG.DXOHBXLD.chunk.js";
import { t as f } from "./vendor-min-mermaid~chunk-THXVA4DE.LE6PFG6l.chunk.js";
import { o as M, s as St, u as Wt } from "./vendor-min-mermaid~chunk-EFRVIJHI.Df9d5nYk.chunk.js";
import { a as h, o as x } from "./vendor-min-mermaid~chunk-WONJCSFZ.BI2ynUz6.chunk.js";
var Mt = /* @__PURE__ */ function() {
	var e = /* @__PURE__ */ m(function(xt, m$1, _, k) {
		for (_ = _ || {}, k = xt.length; k--; _[xt[k]] = m$1);
		return _;
	}, "o"), t = [1, 24], s = [1, 25], o = [1, 26], l = [1, 27], n = [1, 28], a = [1, 63], r = [1, 64], i = [1, 65], u = [1, 66], d = [1, 67], b = [1, 68], p = [1, 69], E = [1, 29], T = [1, 30], D = [1, 31], P = [1, 32], B = [1, 33], j = [1, 34], H = [1, 35], q$1 = [1, 36], G = [1, 37], K = [1, 38], J = [1, 39], Z = [1, 40], $ = [1, 41], tt = [1, 42], et = [1, 43], nt = [1, 44], it = [1, 45], rt = [1, 46], at = [1, 47], st = [1, 48], lt = [1, 50], ot$1 = [1, 51], ct = [1, 52], ht = [1, 53], ut = [1, 54], dt = [1, 55], ft = [1, 56], pt$1 = [1, 57], yt = [1, 58], bt = [1, 59], gt = [1, 60], Ot = [14, 42], Qt = [
		14,
		34,
		36,
		37,
		...
		performAction: /* @__PURE__ */ m(function(m$1, _, k, g, R, h$1, Dt) {
			var f$1 = h$1.length - 1;
			switch (R) {
				case 3:
					g.setDirection("TB");
					break;
				...
				case 11:
				case 12:
					g.setC4Type(h$1[f$1 - 3]);
					break;
				case 19:
					g.setTitle(/* @__PURE__ */ h$1[f$1].substring(6)), this.$ = /* @__PURE__ */ h$1[f$1].substring(6);
					break;
				case 20:
					g.setAccDescription(/* @__PURE__ */ h$1[f$1].substring(15)), this.$ = /* @__PURE__ */ h$1[f$1].substring(15);
					break;
				case 21:
					this.$ = /* @__PURE__ */ h$1[f$1].trim(), g.setTitle(this.$);
					break;
				case 22:
				case 23:
					this.$ = /* @__PURE__ */ h$1[f$1].trim(), g.setAccDescription(this.$);
					break;
				case 28:
					h$1[f$1].splice(2, 0, "ENTERPRISE"), g.addPersonOrSystemBoundary(...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 29:
					h$1[f$1].splice(2, 0, "SYSTEM"), g.addPersonOrSystemBoundary(...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 30:
					g.addPersonOrSystemBoundary(...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 31:
					h$1[f$1].splice(2, 0, "CONTAINER"), g.addContainerBoundary(...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 32:
					g.addDeploymentNode("node", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 33:
					g.addDeploymentNode("nodeL", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 34:
					g.addDeploymentNode("nodeR", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 35:
					g.popBoundaryParseStack();
					break;
				case 39:
					g.addPersonOrSystem("person", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 40:
					g.addPersonOrSystem("external_person", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 41:
					g.addPersonOrSystem("system", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 42:
					g.addPersonOrSystem("system_db", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 43:
					g.addPersonOrSystem("system_queue", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 44:
					g.addPersonOrSystem("external_system", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 45:
					g.addPersonOrSystem("external_system_db", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 46:
					g.addPersonOrSystem("external_system_queue", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 47:
					g.addContainer("container", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 48:
					g.addContainer("container_db", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 49:
					g.addContainer("container_queue", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 50:
					g.addContainer("external_container", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 51:
					g.addContainer("external_container_db", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 52:
					g.addContainer("external_container_queue", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 53:
					g.addComponent("component", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 54:
					g.addComponent("component_db", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 55:
					g.addComponent("component_queue", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 56:
					g.addComponent("external_component", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 57:
					g.addComponent("external_component_db", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 58:
					g.addComponent("external_component_queue", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 60:
					g.addRel("rel", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 61:
					g.addRel("birel", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 62:
					g.addRel("rel_u", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 63:
					g.addRel("rel_d", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 64:
					g.addRel("rel_l", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 65:
					g.addRel("rel_r", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 66:
					g.addRel("rel_b", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 67:
					h$1[f$1].splice(0, 1), g.addRel("rel", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 68:
					g.updateElStyle("update_el_style", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 69:
					g.updateRelStyle("update_rel_style", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 70:
					g.updateLayoutConfig("update_layout_config", ...h$1[f$1]), this.$ = h$1[f$1];
					break;
				case 71:
					this.$ = [h$1[f$1]];
					break;
				case 72:
					h$1[f$1].unshift(h$1[f$1 - 1]), this.$ = h$1[f$1];
					break;
				case 73:
				case 75:
					this.$ = /* @__PURE__ */ h$1[f$1].trim();
					break;
				case 74:
					let Et = {};
					Et[h$1[f$1 - 1].trim()] = /* @__PURE__ */ h$1[f$1].trim(), this.$ = Et;
					break;
				case 76:
					this.$ = "";
					break;
		...
		parse: /* @__PURE__ */ m(function(m$1) {
			var _ = this, k = [0], g = [], R = [null], h$1 = [], Dt = this.table, f$1 = "", Et = 0, ue = 0, de = 0, Ye = 2, fe = 1, Ie = /* @__PURE__ */ h$1.slice.call(arguments, 1), S = /* @__PURE__ */ Object.create(this.lexer), At = { yy: {} };
...
Expecting ` + jt.join(", ") + ", got '" + (this.terminals_[M$1] || M$1) + "'" : te = "Parse error on line " + (Et + 1) + ": Unexpected " + (M$1 == fe ? "end of input" : "'" + (this.terminals_[M$1] || M$1) + "'"), this.parseError(te, {
				...
				switch (I[0]) {
					case 1:
						k.push(M$1), R.push(S.yytext), h$1.push(S.yylloc), k.push(I[1]), M$1 = null, Zt ? (M$1 = Zt, Zt = null) : (ue = S.yyleng, f$1 = S.yytext, Et = S.yylineno, Jt = S.yylloc, de > 0 && de--);
						break;
					case 2:
...
` + _ + "^";
			...
			test_match: /* @__PURE__ */ m(function(m$1, _) {
				...
				}, this.options.ranges && (R.yylloc.range = /* @__PURE__ */ this.yylloc.range.slice(0))), g = /* @__PURE__ */ m$1[0].match(/(?:\r\n?|\n).*/g), g && (this.yylineno += g.length), this.yylloc = {
			...
			next: /* @__PURE__ */ m(function() {
				...
				for (var R = /* @__PURE__ */ this._currentRules(), h$1 = 0; h$1 < R.length; h$1++) if (k = /* @__PURE__ */ this._input.match(this.rules[R[h$1]]), k && (!_ || k[0].length > _[0].length)) {
					if (_ = k, g = h$1, this.options.backtrack_lexer) {
				...
				return _ ? (m$1 = /* @__PURE__ */ this.test_match(_, R[g]), m$1 !== !1 ? m$1 : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
					text: "",
					token: null,
					line: this.yylineno
			...
			options: {},
			performAction: /* @__PURE__ */ m(function(_, k, g, R) {
				switch (g) {
					case 0: return 6;
					case 1: return 7;
					case 2: return 8;
...
var F = [], mt = [""], L = "global", U = "", X = [{
...
}, "setC4Type"), We = /* @__PURE__ */ m(function(e, t, s, o, l, n, a, r, i) {
	...
	i.wrap = /* @__PURE__ */ _t(), i.typeC4Shape = { text: e }, i.parentBoundary = L;
...
}, "popBoundaryParseStack"), $e = /* @__PURE__ */ m(function(e, t, s, o, l, n, a, r, i, u, d) {
...
var se = /* @__PURE__ */ m(function(e, t) {
	...
	for (let n of t) {
		...
		Q(s)(n.label.text, o, Math.min(n.startPoint.x, n.endPoint.x) + Math.abs(n.endPoint.x - n.startPoint.x) / 2 + i, Math.min(n.startPoint.y, n.endPoint.y) + Math.abs(n.endPoint.y - n.startPoint.y) / 2 + u, n.label.width, n.label.height, { fill: a }, b), n.techn && n.techn.text !== "" && (b = /* @__PURE__ */ s.messageFont(), Q(s)("[" + n.techn.text + "]", o, Math.min(n.startPoint.x, n.endPoint.x) + Math.abs(n.endPoint.x - n.startPoint.x) / 2 + i, Math.min(n.startPoint.y, n.endPoint.y) + Math.abs(n.endPoint.y - n.startPoint.y) / 2 + s.messageFontSize + 5 + u, /* @__PURE__ */ Math.max(n.label.width, n.techn.width), n.techn.height, {
			fill: a,
			"font-style": "italic"
		}, b));
	}
	...
	switch (t.typeC4Shape.text) {
		...
		case "external_component":
			i.x = t.x, i.y = t.y, i.fill = o, i.width = t.width, i.height = t.height, i.stroke = l, i.rx = 2.5, i.ry = 2.5, i.attrs = { "stroke-width": .5 }, se(r, i);
			break;
		case "system_db":
	...
	return d.fontWeight = "bold", d.fontSize = d.fontSize + 2, d.fontColor = n, Q(s)(t.label.text, r, t.x, t.y + t.label.Y, t.width, t.height, { fill: n }, d), d = /* @__PURE__ */ s[t.typeC4Shape.text + "Font"](), d.fontColor = n, t.techn && t.techn?.text !== "" ? Q(s)(t.techn.text, r, t.x, t.y + t.techn.Y, t.width, t.height, {
		fill: n,
		"font-style": "italic"
	}, d) : t.type && t.type.text !== "" && Q(s)(t.type.text, r, t.x, t.y + t.type.Y, t.width, t.height, {
		fill: n,
		"font-style": "italic"
	}, d), t.descr && t.descr.text !== "" && (d = /* @__PURE__ */ s.personFont(), d.fontColor = n, Q(s)(t.descr.text, r, t.x, t.y + t.descr.Y, t.width, t.height, { fill: n }, d)), t.height;
	...
	function e(l, n, a, r, i, u, d) {
		o(/* @__PURE__ */ n.append("text").attr("x", a + i / 2).attr("y", r + u / 2 + 5).style("text-anchor", "middle").text(l), d);
	}
	m(e, "byText");
...
var Pe = /* @__PURE__ */ m(function(e, t, s) {
	...
	for (let n of o) {
		...
		let i = a.wrap && x$1.wrap, u = x$1.width - x$1.c4ShapePadding * 2, d = /* @__PURE__ */ Bt(x$1, a.typeC4Shape.text);
		if (d.fontSize = d.fontSize + 2, d.fontWeight = "bold", z("label", a, i, d, u), a.label.Y = l + 8, l = a.label.Y + a.label.height, a.type && a.type.text !== "") {
			...
			z("type", a, i, /* @__PURE__ */ Bt(x$1, a.typeC4Shape.text), u), a.type.Y = l + 5, l = a.type.Y + a.type.height;
		} else if (a.techn && a.techn.text !== "") {
			a.techn.text = "[" + a.techn.text + "]";
			z("techn", a, i, /* @__PURE__ */ Bt(x$1, a.techn.text), u), a.techn.Y = l + 5, l = a.techn.Y + a.techn.height;
		}
		let b = l, p = a.label.width;
		if (a.descr && a.descr.text !== "") z("descr", a, i, /* @__PURE__ */ Bt(x$1, a.typeC4Shape.text), u), a.descr.Y = l + 20, l = a.descr.Y + a.descr.height, p = /* @__PURE__ */ Math.max(a.label.width, a.descr.width), b = l - a.descr.textLines * 5;
...
function Le(e, t, s, o, l) {
	...
	for (let [a, r] of o.entries()) {
		...
		let u = r.wrap && x$1.wrap, d = /* @__PURE__ */ Vt(x$1);
		if (d.fontSize = d.fontSize + 2, d.fontWeight = "bold", z("label", r, u, d, n.data.widthLimit), r.label.Y = i + 8, i = r.label.Y + r.label.height, r.type && r.type.text !== "") {
			...
			z("type", r, u, /* @__PURE__ */ Vt(x$1), n.data.widthLimit), r.type.Y = i + 5, i = r.type.Y + r.type.height;
		}
		...
		if (a == 0 || a % le === 0) {
			let T = s.data.startx + x$1.diagramMarginX, D = s.data.stopy + x$1.diagramMarginY + i;
			n.setData(T, T, D, D);
		} else {
		...
		E.length > 0 && Le(e, t, n, E, l), r.alias !== "global" && Pe(e, r, n), s.data.stopy = /* @__PURE__ */ Math.max(n.data.stopy + x$1.c4ShapeMargin, s.data.stopy), s.data.stopx = /* @__PURE__ */ Math.max(n.data.stopx + x$1.c4ShapeMargin, s.data.stopx), zt = /* @__PURE__ */ Math.max(zt, s.data.stopx), Xt = /* @__PURE__ */ Math.max(Xt, s.data.stopy);
	}
}
...
var ce = {
	...
	draw: /* @__PURE__ */ m(function(e, t, s, o) {
		...
		let d = /* @__PURE__ */ o.db.getTitle();
		Le(i, "", u, /* @__PURE__ */ o.db.getBoundaries(""), o), V.insertArrowHead(i), V.insertArrowEnd(i), V.insertArrowCrossHead(i), V.insertArrowFilledHead(i), S0(i, /* @__PURE__ */ o.db.getRels(), o.db.getC4Shape, o), u.data.stopx = zt, u.data.stopy = Xt;
		let p = u.data, T = p.stopy - p.starty + 2 * x$1.diagramMarginY, P = p.stopx - p.startx + 2 * x$1.diagramMarginX;
		d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * x$1.diagramMarginX).attr("y", p.starty + x$1.diagramMarginY), Wo(i, T, P, x$1.useMaxWidth);
		let B = d ? 60 : 0;
		i.attr("viewBox", p.startx - x$1.diagramMarginX + " -" + (x$1.diagramMarginY + B) + " " + P + " " + (T + B)), pt.debug("models:", p);
	}, "draw")
};
var u1 = {
	parser: Ce,
