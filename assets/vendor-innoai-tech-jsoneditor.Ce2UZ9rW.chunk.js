...
import { J as r, S as i, X as l, Z as o, a, c as u, j as s, v as c, y as d } from "./vendor-innoai-tech-fetcher.BFkhBuB3.chunk.js";
import { D as p, F as f, I as h, L as m, Lt as g, M as y, N as v, O as x, P as k, Pt as b, Q as C, V as S, W as w, Z as A, a as L, c as T, l as E, m as D, n as M, o as I, p as N, r as O, s as P, t as z, u as F, x as _ } from "./vendor-innoai-tech-vuekit.D5qvH0e4.chunk.js";
import { _ as R, d as H, f as V, g as B, l as $, m as j, n as U, o as q, r as W, s as J, t as Z, u as X, v as K } from "./vendor-innoai-tech-vueuikit.pIVJTYGn.chunk.js";
import { f as Q, i as Y, l as G, r as ee, s as et, t as en, u as er } from "./vendor-rxjs.nCW51blg.chunk.js";
var ei, el, eo = {};
function ea(e, t, n) {
	var r;
...
var iT = O((e, {}) => D(e.text$, ee(), L((t) => {
...
}), iD = q(iE, { displayName: "FilledButton" })({
	containerStyle: "sys.primary",
	py: 6,
	px: 16,
	_hover: {
		shadow: "1",
		_$before: { bgColor: V("white", H(.08)) }
	},
	_focus: {
		shadow: "1",
		_$before: { bgColor: V("white", H(.12)) }
	},
	_active: {
		shadow: "1",
		_$before: { bgColor: V("white", H(.12)) }
	...
	_disabled: {
		shadow: "0",
		color: V("sys.on-surface", H(.38)),
		bgColor: "rgba(0,0,0,0)",
		_$before: { bgColor: V("sys.on-surface", H(.12)) }
	}
}), iM = q(iE, { displayName: "TextButton" })({
	extends: [{
		px: 16,
		$data_icon: {
...
}), iH = q(iM, { displayName: "IconButton" })({
	boxSize: 36,
	p: 0,
...
X.duration.sm4, X.easing.standard.decelerate, X.duration.sm1, X.easing.standard.accelerate, X.duration.sm4, X.easing.standard.decelerate, X.duration.sm1, X.easing.standard.accelerate, X.duration.sm4, X.easing.standard.decelerate, X.duration.sm1, X.easing.standard.accelerate, X.duration.sm4, X.easing.standard.decelerate, X.duration.sm1, X.easing.standard.accelerate;
var iB = q("div", { displayName: "TooltipContainer" })({
	mt: 4,
	py: 2,
	px: 8,
	rounded: "xs",
	...
	return () => {
		...
		return l ? I(Z, {
			...
			$transition: ({ content: e }) => I(iV, { children: e }),
			$content: I(iB, { children: l }),
			children: i ? w(i, {
				onVnodeMounted: (e) => {
...
var ij = q("div", { displayName: "Container" })({
	pos: "absolute",
	top: 0,
	left: 0,
	h: "100vh",
	...
	alignItems: "center",
	justifyContent: "center"
}), iU = q("div", { displayName: "DialogBackdrop" })({
	cursor: "pointer",
	pos: "absolute",
	top: 0,
	left: 0,
	...
	duration: X.duration.sm4,
	easing: X.easing.standard.accelerate
}), iW = _((e, { slots: t, emit: n }) => {
	let r = C(e.isOpen ?? !1), i = C(!1);
	return A(() => e.isOpen, (e) => {
		...
		children: P(ij, { children: [I(iq, {
			onComplete: (e) => {
				"leave" === e && (r.value = !1, n("close"));
			},
			children: i.value ? I(iU, { onClick: () => {
				i.value = !1;
			} }) : null
		}), t.default?.()] })
	});
...
X.duration.sm4, X.easing.standard.accelerate, X.duration.sm1, X.easing.standard.accelerate;
let iJ = (e) => o(e) ? e : s(e) ? [] : [e], iZ = ((ei = {})[ei.NONE = 0] = "NONE", ei[ei.EXACT = 1] = "EXACT", ei[ei.PREFIX = 2] = "PREFIX", ei), iX = ((el = {}).NONE = "NONE", el.ADD = "ADD", el.EDIT = "EDIT", el.DELETE = "DELETE", el);
var iK = class e extends i {
	static of(t, n) {
	...
	delete(e) {
		0 != e.length && (console.log("[json-editor]", "delete", e), this.#e.next((t) => {
			let n = K(e);
			if (B(n)) {
				let r = e.slice(0, e.length - 1), i = r.length > 0 ? g(t, r) : t;
				if (o(i)) return void i.splice(n, 1);
			}
			let r = e.slice(0, e.length - 1), i = r.length > 0 ? g(t, r) : t;
			delete i[n];
		}));
	...
	errorAt$(e) {
		let t = this.#r(e);
		return D(this.error$, u((e) => e[t]), ee());
	}
	foldedPrefix$(e) {
		let t = this.#r(e);
		return D(this.foldedPointerPrefixes$, u((e) => {
...
let iQ = z(() => new iK(y(), {})), iY = z(() => ({}));
var iG = q("span", { displayName: "ActionToolbar" })({
	px: 2,
	pos: "relative",
	visibility: "hidden",
	border: "1px solid",
	...
	wordBreak: "keep-all",
	whiteSpace: "nowrap"
}), i2 = q(i0, { displayName: "TokenView" })({
	font: "code",
	opacity: .3
}), i3 = q(iG, { displayName: "PropLeading" })({
	position: "absolute",
	ml: -28
}), i4 = q(i0, { displayName: "PropNameView" })({
	position: "relative",
	display: "flex",
	alignItems: "center",
	userSelect: "none",
...
}), i9 = class e extends N {
	static from(t) {
		let n = new e(!1);
		return D(t, en((e) => e ? et(D(G(e, "focus"), a(() => {
			n.show();
		})), D(G(e, "blur"), Y(200), a(() => {
			n.value && n.hide();
		}))) : Q), F()), n;
	...
	props: ["open$"],
	emits: ["selected"]
}), i7 = q("div", { displayName: "PopoverContainer" })({
	textStyle: "sys.body-small",
	pos: "relative",
...
}), ln = q("span", { displayName: "PropDescription" })({
	display: "block",
	textStyle: "sys.body-small",
	"& p": {
		my: 1,
	...
	return D(r, n((n) => {
		...
		return I(Z, {
			...
			$content: I(ll, { children: I(li, { children: t.title() }) }),
			children: i ? w(i, {
				onMouseover: () => {
					r.show();
				},
	...
	displayName: "Tooltip",
	props: ["placement"]
}), li = q("div", { displayName: "TooltipContainer" })({
	py: 4,
	px: 12,
	rounded: "xs",
	shadow: "3",
	...
	pos: "relative",
	zIndex: 100
}), ll = q("div", { displayName: "TooltipWrapper" })({ px: 8 }), lo = q("div", { displayName: "LineError" })({
	display: "block",
	fontSize: 10,
	lineHeight: 14,
	color: "sys.error",
	...
	top: -2,
	right: 0
}), la = q("div", { displayName: "LinePrefix" })({
	position: "relative",
	display: "flex",
	alignItems: "start",
	...
	px: 12,
	userSelect: "none"
}), lu = q("div", { displayName: "LineContent" })({
	flex: 1,
	minW: 0
}), ls = q("div", { displayName: "LineContentMain" })({
	position: "relative",
	display: "flex",
	alignItems: "start"
}), lc = q(i2, { displayName: "LineNumber" })({
	opacity: .28,
	font: "code"
}), ld = q(i2, (e) => (t) => I(t, { children: I(iR, { path: e.folded ? "M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" : "M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" }) }), {
...
}), lp = q("div", (e, { slots: t }) => (n) => P(n, { children: [I(la, { children: t.leading?.() }), I(lu, {
	sx: { paddingLeft: 14 * e.indent * 2 },
	children: P(ls, { children: [t.default?.(), t.comment?.()] })
})] }), {
	...
	[`&[data-dirty=${iX.EDIT}]`]: { bgColor: V("sys.warning-container", H(.38)) },
	[`&[data-dirty=${iX.ADD}]`]: { bgColor: V("sys.success-container", H(.38)) },
	[`&[data-dirty=${iX.DELETE}]`]: {
		bgColor: V("sys.error-container", H(.38)),
		textDecoration: "line-through",
		opacity: .58
	},
	_error: { bgColor: V("sys.error-container", H(.38)) }
}), lf = class e extends N {
	static from(t) {
		let n = new e("");
		return D(t, en((e) => e ? D(G(e, "input"), a((e) => {
			n.next(e.target.value?.trim());
		})) : Q), E()), n;
	}
}, lh = class e extends d {
	static from(t) {
		let n = new e();
		return D(t, en((e) => e ? et(D(G(e, "keypress"), a((e) => {
	...
	static sync(e, t) {
		return D(et(D(e, a((e) => {
			e && e == f.create(t.path()) && t.editing$.show();
		})), D(t.editing$, Y(1), a((n) => {
			n || e.disable(t.path());
		})), D(er([t.value$, e]), Y(1), a(([n, r]) => {
			s(n) && !r && e.enable(t.path());
		}))), E());
	}
	#i = new c(null);
	constructor() {
	...
	enable(e) {
		this.#i.value || this.#i.next(f.create(e));
	}
	disable(e) {
		this.#i.value === f.create(e) && this.#i.next(null);
	}
};
let lg = z(() => new lm());
var ly = O((e, { render: t }) => {
	let n, r = T(null), i = T(null), l = T(null), o = lh.from(l), u = lf.from(l), c = lg.use(), d = i9.from(l), p = iQ.use();
	lm.sync(c, {
		editing$: d,
		value$: e.value$,
		path: () => e.ctx.path
	...
	let f = () => {
		...
		if ("enums" === e.typedef.type) {
			...
			t ??= n[m.value.index % n.length];
		} else t ??= l.value?.value ? l.value?.value : void 0;
		if (s(t)) return void p.delete(e.ctx.path);
		let [n, r] = e.typedef.validate(t, { coerce: !0 });
		if (n) return void p.setError(e.ctx.path, n.message);
		p.update(e.ctx.path, r), g();
	};
	return (e.allowRawJSON && D(u, a((t) => {
		let n = t.trim();
		if (n.startsWith("{") && n.endsWith("}") || n.startsWith("[") && n.endsWith("]")) try {
			let t = JSON.parse(n);
			p.update(e.ctx.path, t), g();
		} catch (t) {
			p.setError(e.ctx.path, "无效的 JSON 字符串");
		}
	}), E()), D(o, a((t) => {
		switch (t.type) {
			case "SELECT":
			...
			case "COMMIT":
				y();
				break;
			case "CANCEL": g(), m.next({ index: f() }), s(e.value) && p.delete(e.ctx.path);
		}
	}), E()), D(et(D(i, M((e) => {
		if (e) {
		...
		if (e) {
			...
			return setTimeout(() => l(e)), et(D(G(e, "blur"), a((t) => {
				t.relatedTarget && (i.value?.contains(t.relatedTarget) || r.value?.contains(t.relatedTarget)) || (t.preventDefault(), y(e.value));
			})), D(G(e, "input"), a((e) => {
				l(e.target), u.next(e.target.value);
			})));
		}
		return Q;
	}))), E()), "enums" == e.typedef.type) ? D(er([
		e.value$,
		d,
		m
	]), t(([t, n, { index: o }]) => {
		let a = h.schemaProp(e.typedef, "enum") ?? [], u = h.metaProp(e.typedef, "enumLabels") ?? [];
		return I(lb, {
			ref: i,
			onClick: () => {
				d.show();
			...
			children: n ? I(i8, {
				...
				$content: I("div", {
					ref: r,
					children: a.map((e, t) => I(lS, {
						"data-focus": o % a.length === t,
						value: e,
						label: u[t]
					}))
				}),
				children: I(lx, { children: I("input", {
					value: void 0 == t ? "" : `${t}`,
					ref: l,
					"data-options": !0
				}) })
			}) : I(lk, { children: JSON.stringify(t) ?? "undefined" })
		});
	})) : D(er([e.value$, d]), t(([t, n]) => I(lb, {
		ref: i,
		onClick: () => {
		...
		children: n ? I(Z, {
			...
			$content: P(lv, {
				...
				children: [I(i1, {
					...
					children: I(iR, { path: iI })
				}), I(i1, {
					type: "button",
					onClick: () => o.next({ type: "COMMIT" }),
					children: I(iR, { path: iN })
				})]
			}),
			children: I(lx, { children: I("textarea", {
				ref: l,
				rows: 1,
				value: void 0 == t ? "" : `${t}`
			}) })
...
}), lv = q("div", { displayName: "ValueInputActions" })({
	borderRight: "1px solid",
	borderTop: "1px solid",
	borderBottom: "1px solid",
	borderColor: V("sys.outline-variant", H(.38)),
	...
	py: 0,
	ml: -4
}), lx = q("div", { displayName: "InputWrapper" })({
	flex: 1,
	minWidth: 0,
	maxWidth: "80%",
	display: "flex",
...
}), lb = q("div", { displayName: "ValueContainer" })({
	wordBreak: "keep-all",
	whiteSpace: "nowrap",
	cursor: "pointer",
	display: "flex",
...
}), lC = q(le, { displayName: "EnumMenuItemContainer" })({ [`& ${i5}`]: { textAlign: "left" } }), lS = _((e) => () => P(lC, {
	"data-value": e.value,
	tabindex: 0,
	children: [I(i5, { children: e.value }), e.label && I(ln, { children: e.label })]
}), {
	...
	children: I(i1, {
		...
		children: I(iR, { path: "M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z" })
	})
}), {
	...
	children: I(i1, {
		type: "button",
		onClick: () => e("remove"),
		children: I(iR, { path: "M19,19V5H5V19H19M19,3A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5C3,3.89 3.9,3 5,3H19M17,11V13H7V11H17Z" })
	})
}), {
	displayName: "ItemRemoveIconBtn",
	emits: ["remove"]
}), lE = O((e, { emit: t, render: n }) => {
	let r = T(null), i = lf.from(r), l = lh.from(r), o = i9.from(r), u = iQ.use(), s = () => {
		r.value && (r.value.value = "", r.value.blur());
	}, c = (n) => {
		if (n ??= i.value) {
			let [r, i] = h.schemaProp(e.typedef, "items").validate(n, { coerce: !0 });
			if (r) return void u.setError(e.ctx.path, r);
			t("add", i);
		} else t("add", void 0);
		s();
	};
	D(i, a((t) => {
		...
		if (n.startsWith("[") && n.endsWith("]")) try {
			let t = JSON.parse(n);
			u.update(e.ctx.path, t), s();
		} catch (t) {
			u.setError(e.ctx.path, "无效的 JSON 字符串");
		}
		if (n.startsWith("{") && n.endsWith("}")) try {
			c(JSON.parse(n));
		} catch (t) {
	...
	props: ["ctx", "typedef"],
	emits: ["add"]
}), lD = O((e, { emit: t, render: n }) => {
	let r = T(null), i = lh.from(r), l = lf.from(r), o = i9.from(r), u = iQ.use(), s = N.seed({ index: 0 }), c = () => {
	...
	D(l, a((t) => {
		...
		if (n.startsWith("{") && n.endsWith("}")) try {
			let t = JSON.parse(n);
			u.update(e.ctx.path, t), c();
		} catch (t) {
			u.setError(e.ctx.path, "无效的 JSON 字符串");
		}
	}), E());
	let d = (n) => {
		e.options ? n ??= e.options[s.value.index % e.options.length]?.propName : n ??= l.value, n ? (t("add", n), c()) : u.setError([...e.ctx.path, h.RecordKey], "无效的属性值");
	};
	D(i, a((e) => {
		switch (e.type) {
			case "SELECT":
	...
	let p = D(o, n((e) => I(lx, { children: I("input", {
		ref: r,
		type: "text",
	...
	return D(er([
		...
		children: I(i8, {
			...
			open$: o,
			$content: I("div", { children: l.map((t, r) => e && !t.propName.includes(e) ? null : I(lM, {
	...
	children: [I(i5, {
		...
		children: e.propName
	}), I(ln, { children: h.metaProp(e.typedef, "title") })]
}), {
	displayName: "PropMenuItem",
	props: ["propName", "typedef"]
}), lI = q(le, { displayName: "AddPropMenuItemContainer" })({ [`& ${i5}`]: { textAlign: "left" } }), lN = O((e, { render: t }) => {
	let n = iQ.use(), r = iY.use(), i = D(e.n$, t((e) => I(lc, { children: e }))), l = f.create(e.ctx.path);
	return D(er([
		e.close$,
		e.value$,
		n.errorAt$(l),
		...
		let d = !!u, p = o(a) || "array" == e.typedef.type, f = !p && b(a);
		if (t) return c ? null : I(S, { children: I(lp, {
			"data-error": d,
			$leading: i,
			indent: e.ctx.path.length,
			children: p ? P(S, { children: [P(i2, { children: ["]", "\xA0\xA0"] }), !e.ctx.readOnly && I(lE, {
				ctx: e.ctx,
				typedef: e.typedef,
				onAdd: (t) => {
			...
			})] }) : f ? P(S, { children: [P(i2, { children: ["}", "\xA0\xA0"] }), !e.ctx.readOnly && I(lD, {
				ctx: e.ctx,
				onAdd: (t) => {
					n.update([...e.ctx.path, t], void 0);
				},
				options: "record" != e.typedef.type ? [...e.typedef.entries(a, e.ctx)].filter(([e]) => !Object.hasOwn(a, e)).map(([e, t, n]) => ({
					propName: String(e),
					typedef: n
				})) : void 0
			})] }) : null
		...
		let m = () => {
			let t = K(e.ctx.path);
			return P(S, { children: [s(t) ? null : I(i5, {
				deprecated: h.schemaProp(e.typedef, "deprecated"),
				$leading: e.ctx.readOnly ? null : I(lT, { onRemove: () => {
					n.delete(e.ctx.path);
				} }),
				children: I(J, {
					sx: R(t) ? { opacity: 1 } : {
			...
			}), R(t) ? I(i2, { children: ": " }) : e.ctx.path.length > 0 ? I(i2, { children: "\xA0\xA0" }) : null] });
		};
		return I(lp, {
			indent: e.ctx.path.length,
			"data-dirty": ((e, t) => {
				if (!(o(e) || b(e))) {
					if (s(t) && !s(e)) return iX.ADD;
					if (!s(t) && s(e)) return iX.DELETE;
					if (!s(t) && !s(e) && e !== t) return iX.EDIT;
				}
				return iX.NONE;
			})(a, e.previous),
			"data-error": d,
			$leading: P(S, { children: [i, p || f ? I(ld, {
				folded: c !== iZ.NONE,
				onClick: () => {
					n.toggleFold(l);
				}
			...
			$comment: (() => {
				...
				return P(S, { children: [(t || n) && I(lt, { children: n ? I(lr, {
					$title: I(ln, { children: I(iT, { text: n }) }),
					placement: "top",
					children: P("div", { children: [
						t,
						" ",
						I(iR, { path: "M11,18H13V16H11V18M12,6A4,4 0 0,0 8,10H10A2,2 0 0,1 12,8A2,2 0 0,1 14,10C14,12 11,11.75 11,15H13C13,12.75 16,12.5 16,10A4,4 0 0,0 12,6M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3Z" })
					] })
				}) : I("span", { children: t }) }), d && I(lo, { children: `${u}` })] });
			})(),
			children: (() => {
				if (c) {
					if (c == iZ.EXACT) {
						if (p) return P(S, { children: [m(), I(i2, { children: "[...]" })] });
						if (f) return P(S, { children: [m(), I(i2, { children: "{...}" })] });
					}
					return null;
				}
				return P(S, { children: [m(), p ? P(S, { children: [I(i2, { children: "[" }), I(iG, { children: I(lL, { value: a }) })] }) : f ? P(S, { children: [I(i2, { children: "{" }), I(iG, { children: I(lL, { value: a }) })] }) : r.$value?.(e.typedef, a, e.ctx)] });
			})()
		});
	}));
}, {
...
var lP = O((e, { render: t }) => {
	...
	return D(n, t((t) => I(lg, { children: I(iY, {
		value: { $value: r.$value ?? lO },
		children: I(lz, { children: I(lF, { children: [...function* e(t, n, r, i) {
			if ("object" == r.type || "record" == r.type || "intersection" == r.type || "union" == r.type && h.schemaProp(r, "discriminator")) {
				...
				for (let [t, o, a] of (yield l, r.entries(l.value, i))) Object.hasOwn(l.value, t) && (yield* e(o, g(n, [t]), a, {
					...i,
					path: [...i.path, t],
					branch: [...i.branch, o]
				}));
			...
			if ("union" == r.type && s(h.schemaProp(r, "discriminator"))) {
				...
				if (l?.length == 2) {
					...
					if (r && o && h.schemaProp(r, "items").type == o.type) {
						...
						for (let [t, n, u] of (yield a, r.entries(l, i))) yield* e(n, g(o, [t]), u, {
							...i,
							path: [...i.path, t],
							branch: [...i.branch, n]
						});
			...
			if ("array" == r.type) {
				...
				for (let [o, a, u] of (yield l, r.entries(t, i))) yield* e(a, g(n, [o]), u, {
					...i,
					path: [...i.path, o],
					branch: [...i.branch, a]
				});
			...
			if ("any" == r.type || "unknown" == r.type) {
				if (o(t)) return void (yield* e(t, n, x(p()), i));
				if (l(t)) return void (yield* e(t, n, v(k(), p()), i));
			}
			yield {
				value: t,
				previous: n,
	...
	props: ["readOnly"]
}), lz = q("div", { displayName: "JSONEditorContainer" })({
	w: "100%",
	h: "100%",
	overflow: "auto"
}), lF = q("div", ({}, { slots: e }) => (t) => I(t, { children: e.default() }), { displayName: "Lines" })({
	position: "relative",
	display: "flex",
