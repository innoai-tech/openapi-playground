import { $ as $t$1, n as nr, v } from "./vendor-min-mermaid~chunk-USR3SDWQ.C0roZ6ow.chunk.js";
...
import { Q as Qt } from "./vendor-min-mermaid~chunk-HESFG3RP.B_75pM7B.chunk.js";
import { I as Ie } from "./vendor-min-mermaid~chunk-YM3XIQPS.TrSm0jHB.chunk.js";
import { t as tt, H as Hl, m as mf, i as ih, c as vc, d as Bc, f as go, u as ug, h as fg, G as Gc, Y as Yc, j as cg, k as hg, s as sg, l as eg, n as tg, o as ig } from "./vendor-min-mermaid~chunk-ZKYS2E5M.BgSjvTzJ.chunk.js";
...
}, nt = /* @__PURE__ */ m$1((r, t, a, s, l, i, n2) => {
  var _a;
  let o = pt[a];
  if (!o) {
...
var W = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), Gt = /* @__PURE__ */ m$1(() => {
  W.clear(), x.clear();
...
var Ft = /* @__PURE__ */ m$1((r, t) => {
  ...
  if (r.label) {
    let i = /* @__PURE__ */ W.get(r.id), n2 = r.x, o = r.y;
    if (a) {
...
var it = /* @__PURE__ */ m$1(function(r, t, a) {
  ...
  for (let s = 0; s < r.length; s++) if (t.includes(s)) {
    let l = r[s - 1], i = r[s + 1], n2 = r[s], o = /* @__PURE__ */ it(l, n2, 5), e = /* @__PURE__ */ it(i, n2, 5), p = e.x - o.x, f = e.y - o.y;
    a.push(o);
  ...
  return a;
}, "fixCorners"), Jt = /* @__PURE__ */ m$1(function(r, t, a, s, l, i, n2) {
  var _a;
  ...
  let w, q = /* @__PURE__ */ lt(y), M = Array.isArray(t.style) ? t.style : [
    t.style
  ], U = /* @__PURE__ */ M.find((u) => u == null ? void 0 : u.startsWith("stroke:"));
  if (t.look === "handDrawn") {
    ...
    let u = /* @__PURE__ */ m.join(";"), v2 = M ? M.reduce((H, ct) => H + ct + ";", "") : "", _ = "";
    t.animate && (_ = " edge-animation-fast"), t.animation && (_ = " edge-animation-" + t.animation);
    let X = u ? u + ";" + v2 + ";" : v2;
    w = /* @__PURE__ */ r.append("path").attr("d", q).attr("id", t.id).attr("class", " " + b + (t.classes ? " " + t.classes : "") + (_ ?? "")).attr("style", X), U = (_a = X.match(/stroke:([^;]+)/)) == null ? void 0 : _a[1];
  }
  let $ = "";
  (Hl().flowchart.arrowMarkerAbsolute || Hl().state.arrowMarkerAbsolute) && ($ = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, $ = /* @__PURE__ */ $.replace(/\(/g, "\\(").replace(/\)/g, "\\)")), tt.info("arrowTypeStart", t.arrowTypeStart), tt.info("arrowTypeEnd", t.arrowTypeEnd), st(w, t, $, n2, s, U);
  let C = {};
