import { H as Hl, t as tt$1, i as ih, P as Pl, an as $t$1, ao as F$1, ap as E, am as bc, aN as un, S as Sf } from './vendor-min-mermaid~chunk-RAMAZW42.vc82q0BN.chunk.js';
...
var z = "", dt = 0, Y = [], G = [], F = [], pt = /*#__PURE__*/ m$1(()=>un, "getCommonDb"), yt = /*#__PURE__*/ m$1(function() {
    Y.length = 0, G.length = 0, z = "", F.length = 0, Sf();
...
var $t = 12, q = /*#__PURE__*/ m$1(function(n, t) {
    ...
    function u(g) {
        let p = /*#__PURE__*/ bc().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
        g.append("path").attr("class", "mouth").attr("d", p).attr("transform", "translate(" + t.cx + "," + (t.cy + 2) + ")");
    }
    m$1(u, "smile");
    function h(g) {
        let p = /*#__PURE__*/ bc().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
...
function St(n, t) {
    n.each(function() {
        var e = /*#__PURE__*/ ih(this), o = /*#__PURE__*/ e.text().split(/(\s+|<br>)/).reverse(), r, u = [], h = 1.1, f = /*#__PURE__*/ e.attr("y"), g = /*#__PURE__*/ parseFloat(/*#__PURE__*/ e.attr("dy")), p = /*#__PURE__*/ e.text(null).append("tspan").attr("x", 0).attr("y", f).attr("dy", g + "em");
...
var jt = /*#__PURE__*/ m$1(function(n, t, e, o) {
    ...
    let p = /*#__PURE__*/ (h === "sandbox" ? ih(f.nodes()[0].contentDocument.body) : ih("body")).select("#" + t);
    p.append("g");
