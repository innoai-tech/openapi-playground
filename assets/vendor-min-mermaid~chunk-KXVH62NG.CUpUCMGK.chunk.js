...
import { p as pt, e as Wh } from './vendor-min-mermaid~chunk-63GW7ZVL.CUmzAGpZ.chunk.js';
...
var jt = {}, os = /*#__PURE__*/ m$1(function(e, t) {
...
}, "detectType"), ss = /*#__PURE__*/ m$1((...e)=>{
    for (let { id: t, detector: i, loader: s } of e)Se(t, i, s);
}, "registerLazyLoadedDiagrams"), Se = /*#__PURE__*/ m$1((e, t, i)=>{
    jt[e] && pt.warn(`Detector with key ${e} already exists. Overwriting.`), jt[e] = {
        detector: t,
        loader: i
    }, pt.debug(`Detector with key ${e} added${i ? " with loader" : ""}`);
}, "addDetector"), as = /*#__PURE__*/ m$1((e)=>jt[e].loader, "getDiagramLoader");
var Fe = m$1((e, t, { depth: i = 2, clobber: s = false } = {})=>{
    let l = {
        depth: i,
        clobber: s
    };
...
var Vt = {
    ...
    hsl2rgb: /*#__PURE__*/ m$1(({ h: e, s: t, l: i }, s)=>{
        ...
        switch(s){
            case "r":
                return Vt.hue2rgb(d, l, e + .3333333333333333) * 255;
            case "g":
...
var _e = class {
    ...
    get r() {
        ...
        return !this.type.is(S.HSL) && i !== void 0 ? i : (this._ensureHSL(), m.channel.hsl2rgb(t, "r"));
    }
    get g() {
        let t = this.data, i = t.g;
        return !this.type.is(S.HSL) && i !== void 0 ? i : (this._ensureHSL(), m.channel.hsl2rgb(t, "g"));
    }
    get b() {
        let t = this.data, i = t.b;
        return !this.type.is(S.HSL) && i !== void 0 ? i : (this._ensureHSL(), m.channel.hsl2rgb(t, "b"));
    }
    get h() {
        let t = this.data, i = t.h;
        return !this.type.is(S.RGB) && i !== void 0 ? i : (this._ensureRGB(), m.channel.rgb2hsl(t, "h"));
    }
    get s() {
        let t = this.data, i = t.s;
        return !this.type.is(S.RGB) && i !== void 0 ? i : (this._ensureRGB(), m.channel.rgb2hsl(t, "s"));
    }
    get l() {
        let t = this.data, i = t.l;
        return !this.type.is(S.RGB) && i !== void 0 ? i : (this._ensureRGB(), m.channel.rgb2hsl(t, "l"));
    }
    get a() {
        return this.data.a;
    }
...
var Ai = {
    ...
    parse: /*#__PURE__*/ m$1((e)=>{
        ...
        return tt.set({
            ...
            b: /*#__PURE__*/ m.channel.clamp.b(E ? parseFloat(x) * 2.55 : parseFloat(x)),
            a: A ? m.channel.clamp.a(H ? parseFloat(A) / 100 : parseFloat(A)) : 1
        }, e);
    }, "parse"),
    stringify: /*#__PURE__*/ m$1((e)=>{
        let { r: t, g: i, b: s, a: l } = e;
...
var qr = {
    ...
    stringify: /*#__PURE__*/ m$1((e)=>!e.changed && e.color ? e.color : e.type.is(S.HSL) || e.data.r === void 0 ? _t.stringify(e) : e.a < 1 || !Number.isInteger(e.r) || !Number.isInteger(e.g) || !Number.isInteger(e.b) ? Et.stringify(e) : at.stringify(e), "stringify")
}, F = qr;
...
var Rr = /*#__PURE__*/ m$1((e, t, i = 0, s = 1)=>{
...
var Wr = /*#__PURE__*/ m$1((e, t)=>m.lang.round(F.parse(e)[t]), "channel"), Pr = Wr;
var Nr = /*#__PURE__*/ m$1((e)=>{
    let { r: t, g: i, b: s } = F.parse(e), l = .2126 * m.channel.toLinear(t) + .7152 * m.channel.toLinear(i) + .0722 * m.channel.toLinear(s);
    return m.lang.round(l);
}, "luminance"), Mi = Nr;
var Hr = /*#__PURE__*/ m$1((e)=>Mi(e) >= .5, "isLight"), Oi = Hr;
var Ur = /*#__PURE__*/ m$1((e)=>!Oi(e), "isDark"), U = Ur;
var Gr = /*#__PURE__*/ m$1((e, t, i)=>{
    let s = /*#__PURE__*/ F.parse(e), l = s[t], d = /*#__PURE__*/ m.channel.clamp[t](l + i);
    return l !== d && (s[t] = d), F.stringify(s);
}, "adjustChannel"), Zt = Gr;
var $r = /*#__PURE__*/ m$1((e, t)=>Zt(e, "l", t), "lighten"), c = $r;
var jr = /*#__PURE__*/ m$1((e, t)=>Zt(e, "l", -t), "darken"), g = jr;
var Vr = /*#__PURE__*/ m$1((e, t)=>{
    let i = /*#__PURE__*/ F.parse(e), s = {};
    for(let l in t)t[l] && (s[l] = i[l] + t[l]);
    return Kt(e, s);
}, "adjust"), a = Vr;
var Yr = /*#__PURE__*/ m$1((e, t, i = 50)=>{
...
}, Wi = m$1((e, t = "")=>Object.keys(e).reduce((i, s)=>Array.isArray(e[s]) ? i : typeof e[s] == "object" && e[s] !== null ? [
            ...i,
            t + s,
            .../*#__PURE__*/ Wi(e[s], "")
        ] : [
...
var Jt = m$1((e)=>{
    if (pt.debug("sanitizeDirective called with", e), !(typeof e != "object" || e == null)) {
        ...
        for (let t of Object.keys(e)){
            ...
            for (let s of i)t.includes(s) && (pt.debug("sanitizing css option", t), e[t] = /*#__PURE__*/ Kr(e[t]));
        }
...
}, "sanitizeDirective"), Kr = /*#__PURE__*/ m$1((e)=>{
    let t = 0, i = 0;
    for (let s of e){
...
var Mt = /*#__PURE__*/ Object.freeze(Ni), P = /*#__PURE__*/ v({}, Mt), Qt, lt = [], At = /*#__PURE__*/ v({}, Mt), te = /*#__PURE__*/ m$1((e, t)=>{
    let i = /*#__PURE__*/ v({}, e), s = {};
    for (let l of t)Gi(l), s = /*#__PURE__*/ v(s, l);
    if (i = /*#__PURE__*/ v(i, s), s.theme && s.theme in rt) {
        let l = /*#__PURE__*/ v({}, Qt), d = /*#__PURE__*/ v(l.themeVariables || {}, s.themeVariables);
        i.theme && i.theme in rt && (i.themeVariables = /*#__PURE__*/ rt[i.theme].getThemeVariables(d));
    }
    return At = i, $i(At), At;
}, "updateCurrentConfig"), Zr = /*#__PURE__*/ m$1((e)=>(P = /*#__PURE__*/ v({}, Mt), P = /*#__PURE__*/ v(P, e), e.theme && rt[e.theme] && (P.themeVariables = /*#__PURE__*/ rt[e.theme].getThemeVariables(e.themeVariables)), te(P, lt), P), "setSiteConfig"), Xl = /*#__PURE__*/ m$1((e)=>{
    Qt = /*#__PURE__*/ v({}, e);
}, "saveConfigFromInitialize"), Kl = /*#__PURE__*/ m$1((e)=>(P = /*#__PURE__*/ v(P, e), te(P, lt), P), "updateSiteConfig"), Zl = /*#__PURE__*/ m$1(()=>v({}, P), "getSiteConfig"), Ui = /*#__PURE__*/ m$1((e)=>($i(e), v(At, e), Ot()), "setConfig"), Ot = /*#__PURE__*/ m$1(()=>v({}, At), "getConfig"), Gi = m$1((e)=>{
    e && ([
        "secure",
        ...P.secure ?? []
    ].forEach((t)=>{
...
We || (We = /*#__PURE__*/ m$1(function(t, i, s) {
    return t.apply(i, s);
}, "apply"));
Pe || (Pe = /*#__PURE__*/ m$1(function(t, i) {
    return new t(...i);
}, "construct"));
...
var Xi = /*#__PURE__*/ z([
    ...
    comment: 8,
    document: 9
}, bo = /*#__PURE__*/ m$1(function() {
    return typeof window > "u" ? null : window;
}, "getGlobal"), To = /*#__PURE__*/ m$1(function(t, i) {
...
}, "_createTrustedTypesPolicy"), tr = /*#__PURE__*/ m$1(function() {
    return {
...
function sr() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : bo(), t = /*#__PURE__*/ m$1((C)=>sr(C), "DOMPurify");
    ...
    let { MUSTACHE_EXPR: ce, ERB_EXPR: de, TMPLIT_EXPR: ge, DATA_ATTR: yr, ARIA_ATTR: br, IS_SCRIPT_OR_DATA: Tr, ATTR_WHITESPACE: Ye, CUSTOM_ELEMENT: kr } = Qi, { IS_ALLOWED_URI: Xe } = Qi, L = null, Ke = /*#__PURE__*/ p({}, [
    ...
    })), Bt = null, ue = null, Je = true, me = true, Qe = false, ti = true, gt = false, Rt = true, st = false, Ce = false, pe = false, ut = false, Wt = false, Pt = false, ei = true, ii = false, Br = "user-content-", fe = true, St = false, mt = {}, Ct = null, ri = /*#__PURE__*/ p({}, [
        "annotation-xml",
        "audio",
        "colgroup",
        "desc",
        ...
        "style",
        "xmlns"
    ]), Nt = "http://www.w3.org/1998/Math/MathML", Ht = "http://www.w3.org/2000/svg", V = "http://www.w3.org/1999/xhtml", pt = V, ye = false, be = null, Sr = /*#__PURE__*/ p({}, [
        Nt,
        Ht,
        V
    ], De), Ut = /*#__PURE__*/ p({}, [
        ...
        "text/html"
    ], _r = "text/html", _ = null, ft = null, Er = /*#__PURE__*/ i.createElement("form"), li = /*#__PURE__*/ m$1(function(o) {
        return o instanceof RegExp || o instanceof Function;
    }, "isRegexOrFunction"), Te = /*#__PURE__*/ m$1(function() {
        let o = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        if (!(ft && ft === o)) {
            if ((!o || typeof o != "object") && (o = {}), o = /*#__PURE__*/ J(o), Ft = Lr.indexOf(o.PARSER_MEDIA_TYPE) === -1 ? _r : o.PARSER_MEDIA_TYPE, _ = Ft === "application/xhtml+xml" ? De : re, L = $(o, "ALLOWED_TAGS") ? p({}, o.ALLOWED_TAGS, _) : Ke, O = $(o, "ALLOWED_ATTR") ? p({}, o.ALLOWED_ATTR, _) : Ze, be = $(o, "ALLOWED_NAMESPACES") ? p({}, o.ALLOWED_NAMESPACES, De) : Sr, xe = $(o, "ADD_URI_SAFE_ATTR") ? p(/*#__PURE__*/ J(ai), o.ADD_URI_SAFE_ATTR, _) : ai, oi = $(o, "ADD_DATA_URI_TAGS") ? p(/*#__PURE__*/ J(si), o.ADD_DATA_URI_TAGS, _) : si, Ct = $(o, "FORBID_CONTENTS") ? p({}, o.FORBID_CONTENTS, _) : ri, Bt = $(o, "FORBID_TAGS") ? p({}, o.FORBID_TAGS, _) : J({}), ue = $(o, "FORBID_ATTR") ? p({}, o.FORBID_ATTR, _) : J({}), mt = $(o, "USE_PROFILES") ? o.USE_PROFILES : false, Je = o.ALLOW_ARIA_ATTR !== false, me = o.ALLOW_DATA_ATTR !== false, Qe = o.ALLOW_UNKNOWN_PROTOCOLS || false, ti = o.ALLOW_SELF_CLOSE_IN_ATTR !== false, gt = o.SAFE_FOR_TEMPLATES || false, Rt = o.SAFE_FOR_XML !== false, st = o.WHOLE_DOCUMENT || false, ut = o.RETURN_DOM || false, Wt = o.RETURN_DOM_FRAGMENT || false, Pt = o.RETURN_TRUSTED_TYPE || false, pe = o.FORCE_BODY || false, ei = o.SANITIZE_DOM !== false, ii = o.SANITIZE_NAMED_PROPS || false, fe = o.KEEP_CONTENT !== false, St = o.IN_PLACE || false, Xe = o.ALLOWED_URI_REGEXP || rr, pt = o.NAMESPACE || V, Ut = o.MATHML_TEXT_INTEGRATION_POINTS || Ut, Gt = o.HTML_INTEGRATION_POINTS || Gt, b = o.CUSTOM_ELEMENT_HANDLING || {}, o.CUSTOM_ELEMENT_HANDLING && li(o.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (b.tagNameCheck = o.CUSTOM_ELEMENT_HANDLING.tagNameCheck), o.CUSTOM_ELEMENT_HANDLING && li(o.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (b.attributeNameCheck = o.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), o.CUSTOM_ELEMENT_HANDLING && typeof o.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (b.allowCustomizedBuiltInElements = o.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), gt && (me = false), Wt && (ut = true), mt && (L = /*#__PURE__*/ p({}, Ki), O = [], mt.html === true && (p(L, Xi), p(O, Zi)), mt.svg === true && (p(L, Ie), p(O, Re), p(O, ie)), mt.svgFilters === true && (p(L, qe), p(O, Re), p(O, ie)), mt.mathMl === true && (p(L, ze), p(O, Ji), p(O, ie))), o.ADD_TAGS && (L === Ke && (L = /*#__PURE__*/ J(L)), p(L, o.ADD_TAGS, _)), o.ADD_ATTR && (O === Ze && (O = /*#__PURE__*/ J(O)), p(O, o.ADD_ATTR, _)), o.ADD_URI_SAFE_ATTR && p(xe, o.ADD_URI_SAFE_ATTR, _), o.FORBID_CONTENTS && (Ct === ri && (Ct = /*#__PURE__*/ J(Ct)), p(Ct, o.FORBID_CONTENTS, _)), fe && (L["#text"] = true), st && p(L, [
                "html",
                "head",
                "body"
            ]), L.table && (p(L, [
                "tbody"
            ]), delete Bt.tbody), o.TRUSTED_TYPES_POLICY) {
                if (typeof o.TRUSTED_TYPES_POLICY.createHTML != "function") throw Dt('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');
                if (typeof o.TRUSTED_TYPES_POLICY.createScriptURL != "function") throw Dt('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');
                M = o.TRUSTED_TYPES_POLICY, kt = /*#__PURE__*/ M.createHTML("");
        ...
        ...ze,
        ...co
    ]), Ar = /*#__PURE__*/ m$1(function(o) {
        let n = /*#__PURE__*/ dt(o);
        (!n || !n.tagName) && (n = {
            namespaceURI: pt,
            tagName: "template"
        });
        let u = /*#__PURE__*/ re(o.tagName), y = /*#__PURE__*/ re(n.tagName);
        return be[o.namespaceURI] ? o.namespaceURI === Ht ? n.namespaceURI === V ? u === "svg" : n.namespaceURI === Nt ? u === "svg" && (y === "annotation-xml" || Ut[y]) : !!ni[u] : o.namespaceURI === Nt ? n.namespaceURI === V ? u === "math" : n.namespaceURI === Ht ? u === "math" && Gt[y] : !!hi[u] : o.namespaceURI === V ? n.namespaceURI === Ht && !Gt[y] || n.namespaceURI === Nt && !Ut[y] ? false : !hi[u] && (Fr[u] || !ni[u]) : !!(Ft === "application/xhtml+xml" && be[o.namespaceURI]) : false;
    ...
    }, "_forceRemove"), xt = /*#__PURE__*/ m$1(function(o, n) {
        try {
            vt(t.removed, {
        ...
        if (n.removeAttribute(o), o === "is") if (ut || Wt) try {
            j(n);
        } catch  {}
        else try {
            n.setAttribute(o, "");
        } catch  {}
    }, "_removeAttribute"), ci = /*#__PURE__*/ m$1(function(o) {
        let n = null, u = null;
        ...
        Ft === "application/xhtml+xml" && pt === V && (o = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + o + "</body></html>");
        let y = M ? M.createHTML(o) : o;
        if (pt === V) try {
            n = /*#__PURE__*/ new nt().parseFromString(y, Ft);
        } catch  {}
        if (!n || !n.documentElement) {
            n = /*#__PURE__*/ he.createDocument(pt, "template", null);
            try {
                n.documentElement.innerHTML = ye ? kt : y;
            } catch  {}
        }
        let w = n.body || n.documentElement;
        return o && u && w.insertBefore(/*#__PURE__*/ i.createTextNode(u), w.childNodes[0] || null), pt === V ? fr.call(n, st ? "html" : "body")[0] : st ? n.documentElement : w;
    }, "_initDocument"), di = /*#__PURE__*/ m$1(function(o) {
        return Cr.call(o.ownerDocument || o, o, A.SHOW_ELEMENT | A.SHOW_COMMENT | A.SHOW_TEXT | A.SHOW_PROCESSING_INSTRUCTION | A.SHOW_CDATA_SECTION, null);
    }, "_createNodeIterator"), ke = /*#__PURE__*/ m$1(function(o) {
        return o instanceof bt && (typeof o.nodeName != "string" || typeof o.textContent != "string" || typeof o.removeChild != "function" || !(o.attributes instanceof H) || typeof o.removeAttribute != "function" || typeof o.setAttribute != "function" || typeof o.namespaceURI != "string" || typeof o.insertBefore != "function" || typeof o.hasChildNodes != "function");
    }, "_isClobbered"), gi = /*#__PURE__*/ m$1(function(o) {
    ...
    m$1(Y, "_executeHooks");
    let ui = /*#__PURE__*/ m$1(function(o) {
        let n = null;
        if (Y(I.beforeSanitizeElements, o, null), ke(o)) return j(o), true;
        let u = /*#__PURE__*/ _(o.nodeName);
        if (Y(I.uponSanitizeElement, o, {
            tagName: u,
            allowedTags: L
        }), Rt && o.hasChildNodes() && !gi(o.firstElementChild) && q(/<[/\w!]/g, o.innerHTML) && q(/<[/\w!]/g, o.textContent) || o.nodeType === qt.progressingInstruction || Rt && o.nodeType === qt.comment && q(/<[/\w]/g, o.data)) return j(o), true;
        if (!L[u] || Bt[u]) {
            ...
            if (fe && !Ct[u]) {
                let y = dt(o) || o.parentNode, w = ne(o) || o.childNodes;
                if (w && y) {
                    let B = w.length;
                    for(let W = B - 1; W >= 0; --W){
                        let X = /*#__PURE__*/ ct(w[W], true);
                        X.__removalCount = (o.__removalCount || 0) + 1, y.insertBefore(X, /*#__PURE__*/ le(o));
                    }
                }
            }
            return j(o), true;
        }
        return o instanceof E && !Ar(o) || (u === "noscript" || u === "noembed" || u === "noframes") && q(/<\/no(script|embed|frames)/i, o.innerHTML) ? (j(o), true) : (gt && o.nodeType === qt.text && (n = o.textContent, ee([
            ce,
            de,
            ge
        ], (y)=>{
            n = /*#__PURE__*/ wt(n, y, " ");
        }), o.textContent !== n && (vt(t.removed, {
            element: /*#__PURE__*/ o.cloneNode()
        }), o.textContent = n)), Y(I.afterSanitizeElements, o, null), false);
    }, "_sanitizeElements"), mi = /*#__PURE__*/ m$1(function(o, n, u) {
        if (ei && (n === "id" || n === "name") && (u in i || u in Er)) return false;
        if (!(me && !ue[n] && q(yr, n))) {
            if (!(Je && q(br, n))) {
                if (!O[n] || ue[n]) {
                    if (!(Ci(o) && (b.tagNameCheck instanceof RegExp && q(b.tagNameCheck, o) || b.tagNameCheck instanceof Function && b.tagNameCheck(o)) && (b.attributeNameCheck instanceof RegExp && q(b.attributeNameCheck, n) || b.attributeNameCheck instanceof Function && b.attributeNameCheck(n)) || n === "is" && b.allowCustomizedBuiltInElements && (b.tagNameCheck instanceof RegExp && q(b.tagNameCheck, u) || b.tagNameCheck instanceof Function && b.tagNameCheck(u)))) return false;
                } else if (!xe[n]) {
                    if (!q(Xe, /*#__PURE__*/ wt(u, Ye, ""))) {
                        if (!((n === "src" || n === "xlink:href" || n === "href") && o !== "script" && so(u, "data:") === 0 && oi[o])) {
        ...
        return true;
    }, "_isValidAttribute"), Ci = /*#__PURE__*/ m$1(function(o) {
        return o !== "annotation-xml" && Yi(o, kr);
    }, "_isBasicCustomElement"), pi = /*#__PURE__*/ m$1(function(o) {
        Y(I.beforeSanitizeAttributes, o, null);
        let { attributes: n } = o;
        if (!n || ke(o)) return;
        let u = {
            attrName: "",
        ...
        for(; y--;){
            let w = n[y], { name: B, namespaceURI: W, value: X } = w, Lt = /*#__PURE__*/ _(B), Be = X, D = B === "value" ? Be : ao(Be);
            if (u.attrName = Lt, u.attrValue = D, u.keepAttr = true, u.forceKeepAttr = void 0, Y(I.uponSanitizeAttribute, o, u), D = u.attrValue, ii && (Lt === "id" || Lt === "name") && (xt(B, o), D = Br + D), Rt && q(/((--!?|])>)|<\/(style|title)/i, D)) {
                xt(B, o);
                continue;
            }
            ...
            if (D !== Be) try {
                W ? o.setAttributeNS(W, B, D) : o.setAttribute(B, D), ke(o) ? j(o) : Vi(t.removed);
            } catch  {
                xt(B, o);
            }
        }
        Y(I.afterSanitizeAttributes, o, null);
    }, "_sanitizeAttributes"), Mr = /*#__PURE__*/ m$1(function C(o) {
        let n = null, u = /*#__PURE__*/ di(o);
        for(Y(I.beforeSanitizeShadowDOM, o, null); n = /*#__PURE__*/ u.nextNode();)Y(I.uponSanitizeShadowNode, n, null), ui(n), pi(n), n.content instanceof d && C(n.content);
        Y(I.afterSanitizeShadowDOM, o, null);
    }, "_sanitizeShadowDOM");
    return t.sanitize = function(C) {
        ...
        if (Ce || Te(o), t.removed = [], typeof C == "string" && (St = false), St) {
            if (C.nodeName) {
                let X = /*#__PURE__*/ _(C.nodeName);
                if (!L[X] || Bt[X]) throw Dt("root node is forbidden and cannot be sanitized in-place");
            }
        } else if (C instanceof x) n = /*#__PURE__*/ ci("<!---->"), u = /*#__PURE__*/ n.ownerDocument.importNode(C, true), u.nodeType === qt.element && u.nodeName === "BODY" || u.nodeName === "HTML" ? n = u : n.appendChild(u);
        else {
        ...
        if (ut) {
            ...
            return (O.shadowroot || O.shadowrootmode) && (w = /*#__PURE__*/ xr.call(s, w, true)), w;
        }
...
` + W), gt && ee([
        ...
        ft || Te({});
        let u = /*#__PURE__*/ _(C), y = /*#__PURE__*/ _(o);
        return mi(u, y, n);
    }, t.addHook = function(C, o) {
        typeof o == "function" && vt(I[C], o);
    }, t.removeHook = function(C, o) {
        if (o !== void 0) {
            let n = /*#__PURE__*/ ro(I[C], o);
...
m$1(sr, "createDOMPurify");
var yt = /*#__PURE__*/ sr();
var zt = /<br\s*\/?>/gi, ko = /*#__PURE__*/ m$1((e)=>e ? cr(e).replace(/\\n/g, "#br#").split("#br#") : [
        ""
    ], "getRows"), Bo = /*#__PURE__*/ (()=>{
    let e = false;
    return ()=>{
...
m$1(So, "setupDompurifyHooks");
var hr = /*#__PURE__*/ m$1((e)=>(Bo(), yt.sanitize(e)), "removeScript"), ar = /*#__PURE__*/ m$1((e, t)=>{
    ...
    return e;
}, "sanitizeMore"), ot = /*#__PURE__*/ m$1((e, t)=>e && (t.dompurifyConfig ? e = /*#__PURE__*/ yt.sanitize(/*#__PURE__*/ ar(e, t), t.dompurifyConfig).toString() : e = /*#__PURE__*/ yt.sanitize(/*#__PURE__*/ ar(e, t), {
        FORBID_TAGS: [
            "style"
        ]
    }).toString(), e), "sanitizeText"), Fo = /*#__PURE__*/ m$1((e, t)=>typeof e == "string" ? ot(e, t) : e.flat().map((i)=>ot(i, t)), "sanitizeTextOrArray"), Lo = /*#__PURE__*/ m$1((e)=>zt.test(e), "hasBreaks"), _o = /*#__PURE__*/ m$1((e)=>e.split(zt), "splitBreaks"), Eo = /*#__PURE__*/ m$1((e)=>e.replace(/#br#/g, "<br/>"), "placeholderToBreak"), cr = /*#__PURE__*/ m$1((e)=>e.replace(zt, "#br#"), "breakToPlaceholder"), Ao = /*#__PURE__*/ m$1((e)=>{
    let t = "";
...
}, "getUrl"), Mo = /*#__PURE__*/ m$1((e)=>!(e === false || [
        "false",
        "null",
        "0"
    ].includes(/*#__PURE__*/ String(e).trim().toLowerCase())), "evaluate"), Oo = /*#__PURE__*/ m$1(function(...e) {
    let t = /*#__PURE__*/ e.filter((i)=>!isNaN(i));
    return Math.max(...t);
}, "getMax"), vo = /*#__PURE__*/ m$1(function(...e) {
    let t = /*#__PURE__*/ e.filter((i)=>!isNaN(i));
    return Math.min(...t);
}, "getMin"), ln = /*#__PURE__*/ m$1(function(e) {
    ...
    return i.join("");
}, "parseGenericTypes"), Ne = /*#__PURE__*/ m$1((e, t)=>Math.max(0, e.split(t).length - 1), "countOccurrence"), wo = /*#__PURE__*/ m$1((e, t)=>{
    let i = /*#__PURE__*/ Ne(e, "~"), s = /*#__PURE__*/ Ne(t, "~");
    return i === 1 && s === 1;
}, "shouldCombineSets"), Do = /*#__PURE__*/ m$1((e)=>{
    let t = /*#__PURE__*/ Ne(e, "~"), i = false;
    if (t <= 1) return e;
...
}, "processSet"), lr = /*#__PURE__*/ m$1(()=>window.MathMLElement !== void 0, "isMathMLSupported"), oe = /\$\$(.*)\$\$/g, nr = /*#__PURE__*/ m$1((e)=>(e.match(oe)?.length ?? 0) > 0, "hasKatex"), nn = /*#__PURE__*/ m$1(async (e, t)=>{
    ...
    return i.remove(), l;
}, "calculateMathMLDimensions"), Io = /*#__PURE__*/ m$1(async (e, t)=>{
    if (!nr(e)) return e;
    if (!(lr() || t.legacyMathML || t.forceLegacyMathML)) return e.replace(oe, "MathML is unsupported in this environment.");
    {
        ...
        }, true               ? __vite__mapDeps([0,1]) : void 0), s = t.forceLegacyMathML || !lr() && t.legacyMathML ? "htmlAndMathml" : "mathml";
...
}, "renderKatexUnsanitized"), qo = /*#__PURE__*/ m$1(async (e, t)=>ot(await Io(e, t), t), "renderKatexSanitized"), hn = {
    getRows: ko,
    sanitizeText: ot,
...
var zo = /*#__PURE__*/ m$1(function(e, t) {
    for (let i of t)e.attr(i[0], i[1]);
}, "d3Attrs"), Ro = /*#__PURE__*/ m$1(function(e, t, i) {
    let s = new Map;
    return i ? (s.set("width", "100%"), s.set("style", `max-width: ${t}px;`)) : (s.set("height", e), s.set("width", t)), s;
}, "calculateSvgSizeAttrs"), Wo = /*#__PURE__*/ m$1(function(e, t, i, s) {
    let l = /*#__PURE__*/ Ro(t, i, s);
    zo(e, l);
}, "configureSvgSize"), dr = /*#__PURE__*/ m$1(function(e, t, i, s) {
...
var He = "", Ue = "", Ge = "", $e = /*#__PURE__*/ m$1((e)=>ot(e, /*#__PURE__*/ Ot()), "sanitizeText"), No = /*#__PURE__*/ m$1(()=>{
    He = "", Ge = "", Ue = "";
}, "clear"), Ho = /*#__PURE__*/ m$1((e)=>{
    He = /*#__PURE__*/ $e(e).replace(/^\s+/g, "");
}, "setAccTitle"), Uo = /*#__PURE__*/ m$1(()=>He, "getAccTitle"), Go = /*#__PURE__*/ m$1((e)=>{
    Ge = /*#__PURE__*/ $e(e).replace(/\n\s+/g, `
`);
}, "setAccDescription"), $o = /*#__PURE__*/ m$1(()=>Ge, "getAccDescription"), jo = /*#__PURE__*/ m$1((e)=>{
    Ue = /*#__PURE__*/ $e(e);
}, "setDiagramTitle"), Vo = /*#__PURE__*/ m$1(()=>Ue, "getDiagramTitle");
var ur = pt, Yo = Wh, mr = Ot, En = Ui, An = Mt;
var Xo = /*#__PURE__*/ m$1((e)=>ot(e, /*#__PURE__*/ mr()), "sanitizeText"), Ko = dr, Zo = /*#__PURE__*/ m$1(()=>je, "getCommonDb"), ae = {}, Mn = /*#__PURE__*/ m$1((e, t, i)=>{
...
}, "registerDiagram"), On = /*#__PURE__*/ m$1((e)=>{
...
export { $o as $, Ao as A, Zr as B, yt as C, as as D, En as E, $t as F, Go as G, Ho as H, Ii as I, Jt as J, Ko as K, Jl as L, Mo as M, No as N, Ot as O, Pr as P, Ql as Q, pn as R, bi as S, Ti as T, Uo as U, Vo as V, Wo as W, Xo as X, tn as Y, Z, nn as _, Ni as a, je as a0, os as b, An as c, dr as d, U as e, c as f, g, hn as h, Mt as i, jo as j, Kl as k, ln as l, mr as m, nr as n, ot as o, Zl as p, qo as q, Ui as r, ss as s, Mn as t, jt as u, v, On as w, Xl as x, rt as y, zt as z };
