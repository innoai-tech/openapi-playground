const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-min-mermaid~katex-SWYD7GD6.DTjLgD7O.chunk.js","assets/vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js"])))=>i.map(i=>d[i]);
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
import { m as m$1, q, n, o } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
var Ya = n((qo, Po) => {
  (function(t9, e) {
    typeof qo == "object" && typeof Po < "u" ? Po.exports = e() : typeof define == "function" && define.amd ? define(e) : (t9 = typeof globalThis < "u" ? globalThis : t9 || self).dayjs = e();
  })(qo, function() {
    ...
    }, q2 = m$1(function(k, x, y) {
      var L = String(k);
      return !L || L.length >= x ? k : "" + Array(x + 1 - L.length).join(y) + k;
    }, "m"), G = {
      s: q2,
      z: m$1(function(k) {
        var x = -k.utcOffset(), y = Math.abs(x), L = Math.floor(y / 60), S = y % 60;
        return (x <= 0 ? "+" : "-") + q2(L, 2, "0") + ":" + q2(S, 2, "0");
      }, "z"),
      m: m$1(function k(x, y) {
        if (x.date() < y.date()) return -k(y, x);
        var L = 12 * (y.year() - x.year()) + (y.month() - x.month()), S = x.clone().add(L, h), z = y - S < 0, I = x.clone().add(L + (z ? -1 : 1), h);
    ...
    M[O] = W;
    var P = "$isDayjsObject", w = m$1(function(k) {
      return k instanceof it || !(!k || !k[P]);
    }, "S"), X = m$1(function k(x, y, L) {
      var S;
      if (!x) return O;
      if (typeof x == "string") {
        var z = x.toLowerCase();
    ...
    var it = function() {
      function k(y) {
        this.$L = X(y.locale, null, true), this.parse(y), this.$x = this.$x || y.x || {}, this[P] = true;
      }
      m$1(k, "M");
      var x = k.prototype;
      return x.parse = function(y) {
        this.$d = function(L) {
          ...
          if (typeof S == "string" && !/Z$/i.test(S)) {
            var I = S.match(T);
            if (I) {
              var U = I[2] - 1 || 0, rt = (I[7] || "0").substring(0, 3);
        ...
        var S = this, z = !!$.u(L) || L, I = $.p(y), U = m$1(function(_t, lt) {
          var v = $.w(S.$u ? Date.UTC(S.$y, lt, _t) : new Date(S.$y, lt, _t), S);
          return z ? v : v.endOf(l);
        }, "l"), rt = m$1(function(_t, lt) {
          return $.w(S.toDate()[_t].apply(S.toDate("s"), (z ? [
            0,
            0,
            0,
            0
        ...
        var S, z = $.p(y), I = "set" + (this.$u ? "UTC" : ""), U = (S = {}, S[l] = I + "Date", S[f] = I + "Date", S[h] = I + "Month", S[p] = I + "FullYear", S[a] = I + "Hours", S[s] = I + "Minutes", S[n2] = I + "Seconds", S[o2] = I + "Milliseconds", S)[z], rt = z === l ? this.$D + (L - this.$W) : L;
        if (z === h || z === p) {
          var Y = this.clone().set(f, 1);
          Y.$d[U](rt), Y.init(), this.$d = Y.set(f, Math.min(this.$D, Y.daysInMonth())).$d;
        } else U && this.$d[U](rt);
        ...
        var S, z = this;
        y = Number(y);
        var I = $.p(L), U = m$1(function(nt) {
          var Q = j(z);
          return $.w(Q.date(Q.date() + Math.round(nt * y)), z);
        }, "y");
        ...
        var z = y || "YYYY-MM-DDTHH:mm:ssZ", I = $.z(this), U = this.$H, rt = this.$m, Y = this.$M, nt = S.weekdays, Q = S.months, Ft = S.meridiem, Z = m$1(function(lt, v, H, V) {
          return lt && (lt[v] || lt(L, z)) || H[v].slice(0, V);
        }, "h"), Ct = m$1(function(lt) {
        ...
        var z, I = this, U = $.p(L), rt = j(y), Y = (rt.utcOffset() - this.utcOffset()) * e, nt = this - rt, Q = m$1(function() {
          return $.m(I, rt);
        }, "D");
        switch (U) {
          case p:
...
}, "setLogLevel"), Pt = m$1((t9) => `%c${(0, Ga.default)().format("ss.SSS")} : ${t9} : `, "format");
...
var Ti = {}, dx = m$1(function(t9, e) {
  t9 = t9.replace(Xa, "").replace(ja, "").replace(Za, `
`);
...
var $o = m$1(function(t9, e) {
  ...
  return Array.isArray(e) && !Array.isArray(t9) ? (e.forEach((s) => $o(t9, s, n2)), t9) : Array.isArray(e) && Array.isArray(t9) ? (e.forEach((s) => {
    ...
    typeof e[s] == "object" && (t9[s] === void 0 || typeof t9[s] == "object") ? (t9[s] === void 0 && (t9[s] = Array.isArray(e[s]) ? [] : {}), t9[s] = $o(t9[s], e[s], {
      depth: r - 1,
      clobber: o2
...
var ki = {
  ...
  clamp: {
    r: m$1((t9) => t9 >= 255 ? 255 : t9 < 0 ? 0 : t9, "r"),
    g: m$1((t9) => t9 >= 255 ? 255 : t9 < 0 ? 0 : t9, "g"),
    b: m$1((t9) => t9 >= 255 ? 255 : t9 < 0 ? 0 : t9, "b"),
    h: m$1((t9) => t9 % 360, "h"),
    s: m$1((t9) => t9 >= 100 ? 100 : t9 < 0 ? 0 : t9, "s"),
    l: m$1((t9) => t9 >= 100 ? 100 : t9 < 0 ? 0 : t9, "l"),
    a: m$1((t9) => t9 >= 1 ? 1 : t9 < 0 ? 0 : t9, "a")
  },
  toLinear: m$1((t9) => {
    let e = t9 / 255;
    return t9 > 0.03928 ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92;
  }, "toLinear"),
  hue2rgb: m$1((t9, e, r) => (r < 0 && (r += 1), r > 1 && (r -= 1), r < 0.16666666666666666 ? t9 + (e - t9) * 6 * r : r < 0.5 ? e : r < 0.6666666666666666 ? t9 + (e - t9) * (0.6666666666666666 - r) * 6 : t9), "hue2rgb"),
  hsl2rgb: m$1((param, o2) => {
  ...
  rgb2hsl: m$1((param, o2) => {
    let { r: t9, g: e, b: r } = param;
    t9 /= 255, e /= 255, r /= 255;
    let n2 = Math.max(t9, e, r), s = Math.min(t9, e, r), a = (n2 + s) / 2;
...
var gu = {
  clamp: m$1((t9, e, r) => e > r ? Math.min(e, Math.max(r, t9)) : Math.min(r, Math.max(e, t9)), "clamp"),
  round: m$1((t9) => Math.round(t9 * 1e10) / 1e10, "round")
}, Qa = gu;
var xu = {
  dec2hex: m$1((t9) => {
    let e = Math.round(t9).toString(16);
...
var se = {};
for (let t9 = 0; t9 <= 255; t9++) se[t9] = R.unit.dec2hex(t9);
var ut = {
  ALL: 0,
  RGB: 1,
  HSL: 2
...
var Uo = (_c2 = class {
  ...
  _ensureHSL() {
    ...
    r === void 0 && (e.h = R.channel.rgb2hsl(e, "h")), o2 === void 0 && (e.s = R.channel.rgb2hsl(e, "s")), n2 === void 0 && (e.l = R.channel.rgb2hsl(e, "l"));
  }
  _ensureRGB() {
    let e = this.data, { r, g: o2, b: n2 } = e;
    r === void 0 && (e.r = R.channel.hsl2rgb(e, "r")), o2 === void 0 && (e.g = R.channel.hsl2rgb(e, "g")), n2 === void 0 && (e.b = R.channel.hsl2rgb(e, "b"));
  }
  get r() {
...
var rl = {
  ...
  parse: m$1((t9) => {
    ...
    let e = t9.match(rl.re);
    if (!e) return;
    let r = e[1], o2 = parseInt(r, 16), n2 = r.length, s = n2 % 4 === 0, a = n2 > 4, l = a ? 1 : 17, c = a ? 8 : 4, h = s ? 0 : -1, u = a ? 255 : 15;
    return pe.set({
      r: (o2 >> c * (h + 3) & u) * l,
      g: (o2 >> c * (h + 2) & u) * l,
      b: (o2 >> c * (h + 1) & u) * l,
...
var Si = {
  ...
  _hue2deg: m$1((t9) => {
    ...
    return R.channel.clamp.h(parseFloat(t9));
  }, "_hue2deg"),
  parse: m$1((t9) => {
    let e = t9.charCodeAt(0);
    if (e !== 104 && e !== 72) return;
    let r = t9.match(Si.re);
    if (!r) return;
    let [, o2, n2, s, a, l] = r;
    return pe.set({
      h: Si._hue2deg(o2),
      s: R.channel.clamp.s(parseFloat(n2)),
      l: R.channel.clamp.l(parseFloat(s)),
...
var il = {
  ...
  parse: m$1((t9) => {
    ...
    let r = t9.match(il.re);
    if (!r) return;
    let [, o2, n2, s, a, l, c, h, u] = r;
    return pe.set({
      r: R.channel.clamp.r(n2 ? parseFloat(o2) * 2.55 : parseFloat(o2)),
      g: R.channel.clamp.g(a ? parseFloat(s) * 2.55 : parseFloat(s)),
      b: R.channel.clamp.b(c ? parseFloat(l) * 2.55 : parseFloat(l)),
...
var _u = {
  ...
  stringify: m$1((t9) => !t9.changed && t9.color ? t9.color : t9.type.is(ut.HSL) || t9.data.r === void 0 ? Fr.stringify(t9) : t9.a < 1 || !Number.isInteger(t9.r) || !Number.isInteger(t9.g) || !Number.isInteger(t9.b) ? Mr.stringify(t9) : Ae.stringify(t9), "stringify")
}, ft = _u;
var bu = m$1((t9, e) => {
  let r = ft.parse(t9);
  for (let o2 in e) r[o2] = R.channel.clamp[o2](e[o2]);
  return ft.stringify(r);
}, "change"), wi = bu;
var Tu = m$1(function(t9, e) {
  ...
  let n2 = pe.set({
    r: R.channel.clamp.r(t9),
    g: R.channel.clamp.g(e),
    b: R.channel.clamp.b(r),
    a: R.channel.clamp.a(o2)
  });
  return ft.stringify(n2);
}, "rgba"), ae = Tu;
var ku = m$1((t9, e) => R.lang.round(ft.parse(t9)[e]), "channel"), Su = ku;
var vu = m$1((t9) => {
...
var wu = m$1((t9) => ol(t9) >= 0.5, "isLight"), nl = wu;
var Bu = m$1((t9) => !nl(t9), "isDark"), $t = Bu;
var Fu = m$1((t9, e, r) => {
  let o2 = ft.parse(t9), n2 = o2[e], s = R.channel.clamp[e](n2 + r);
  return n2 !== s && (o2[e] = s), ft.stringify(o2);
}, "adjustChannel"), Bi = Fu;
var Mu = m$1((t9, e) => Bi(t9, "l", e), "lighten"), F = Mu;
var Lu = m$1((t9, e) => Bi(t9, "l", -e), "darken"), E = Lu;
var Au = m$1((t9, e) => {
  let r = ft.parse(t9), o2 = {};
  for (let n2 in e) e[n2] && (o2[n2] = r[n2] + e[n2]);
  return wi(t9, o2);
}, "adjust"), m = Au;
var Eu = m$1(function(t9, e) {
...
var Go = (_d2 = class {
  ...
  updateColors() {
    ...
    if (this.primaryTextColor = this.primaryTextColor || (this.darkMode ? "#eee" : "#333"), this.secondaryColor = this.secondaryColor || m(this.primaryColor, {
      ...
      h: 330
    }), this.darkMode) for (let r = 0; r < this.THEME_COLOR_LIMIT; r++) this["cScale" + r] = E(this["cScale" + r], 75);
    else for (let r = 0; r < this.THEME_COLOR_LIMIT; r++) this["cScale" + r] = E(this["cScale" + r], 25);
    ...
    this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || this.primaryColor, this.fillType1 = this.fillType1 || this.secondaryColor, this.fillType2 = this.fillType2 || m(this.primaryColor, {
      ...
      h: 120
    }), this.darkMode ? (this.git0 = F(this.git0, 25), this.git1 = F(this.git1, 25), this.git2 = F(this.git2, 25), this.git3 = F(this.git3, 25), this.git4 = F(this.git4, 25), this.git5 = F(this.git5, 25), this.git6 = F(this.git6, 25), this.git7 = F(this.git7, 25)) : (this.git0 = E(this.git0, 25), this.git1 = E(this.git1, 25), this.git2 = E(this.git2, 25), this.git3 = E(this.git3, 25), this.git4 = E(this.git4, 25), this.git5 = E(this.git5, 25), this.git6 = E(this.git6, 25), this.git7 = E(this.git7, 25)), this.gitInv0 = this.gitInv0 || b(this.git0), this.gitInv1 = this.gitInv1 || b(this.git1), this.gitInv2 = this.gitInv2 || b(this.git2), this.gitInv3 = this.gitInv3 || b(this.git3), this.gitInv4 = this.gitInv4 || b(this.git4), this.gitInv5 = this.gitInv5 || b(this.git5), this.gitInv6 = this.gitInv6 || b(this.git6), this.gitInv7 = this.gitInv7 || b(this.git7), this.branchLabelColor = this.branchLabelColor || (this.darkMode ? "black" : this.labelTextColor), this.gitBranchLabel0 = this.gitBranchLabel0 || this.branchLabelColor, this.gitBranchLabel1 = this.gitBranchLabel1 || this.branchLabelColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.branchLabelColor, this.gitBranchLabel3 = this.gitBranchLabel3 || this.branchLabelColor, this.gitBranchLabel4 = this.gitBranchLabel4 || this.branchLabelColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.branchLabelColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.branchLabelColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.branchLabelColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || ge, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || xe;
  }
  calculate(e) {
    if (typeof e != "object") {
      this.updateColors();
...
var Vo = (_e2 = class {
  ...
  updateColors() {
    ...
    }, this.classText = this.primaryTextColor, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || "1", this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || (this.darkMode ? E(this.secondaryColor, 30) : this.secondaryColor), this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = F(this.secondaryColor, 20), this.git1 = F(this.pie2 || this.secondaryColor, 20), this.git2 = F(this.pie3 || this.tertiaryColor, 20), this.git3 = F(this.pie4 || m(this.primaryColor, {
      h: -30
    }), 20), this.git4 = F(this.pie5 || m(this.primaryColor, {
      h: -60
    }), 20), this.git5 = F(this.pie6 || m(this.primaryColor, {
      h: -90
    }), 10), this.git6 = F(this.pie7 || m(this.primaryColor, {
      h: 60
    }), 10), this.git7 = F(this.pie8 || m(this.primaryColor, {
      h: 120
...
}, __5 = new WeakMap(), __privateAdd(_e2, __5, m$1(_e2, "Theme")), _e2), ll = m$1((t9) => {
  let e = new Vo();
  return e.calculate(t9), e;
}, "getThemeVariables");
var Xo = (_f2 = class {
  ...
  updateColors() {
    ...
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++) this["cScale" + e] = E(this["cScale" + e], 10), this["cScalePeer" + e] = this["cScalePeer" + e] || E(this["cScale" + e], 25);
    ...
    this.nodeBkg = this.mainBkg, this.nodeBorder = this.border1, this.clusterBkg = this.secondBkg, this.clusterBorder = this.border2, this.defaultLinkColor = this.lineColor, this.titleColor = this.textColor, this.edgeLabelBackground = this.labelBackground, this.actorBorder = F(this.border1, 23), this.actorBkg = this.mainBkg, this.labelBoxBkgColor = this.actorBkg, this.signalColor = this.textColor, this.signalTextColor = this.textColor, this.labelBoxBorderColor = this.actorBorder, this.labelTextColor = this.actorTextColor, this.loopTextColor = this.actorTextColor, this.noteBorderColor = this.border2, this.noteTextColor = this.actorTextColor, this.actorLineColor = this.actorBorder, this.taskTextColor = this.taskTextLightColor, this.taskTextOutsideColor = this.taskTextDarkColor, this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.rowOdd = this.rowOdd || F(this.primaryColor, 75) || "#ffffff", this.rowEven = this.rowEven || F(this.primaryColor, 1), this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || "#f0f0f0", this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.nodeBorder, this.specialStateColor = this.lineColor, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.classText = this.primaryTextColor, this.fillType0 = this.primaryColor, this.fillType1 = this.secondaryColor, this.fillType2 = m(this.primaryColor, {
      h: 64
    }), this.fillType3 = m(this.secondaryColor, {
      h: 64
    }), this.fillType4 = m(this.primaryColor, {
      ...
      h: 120
    }), this.darkMode ? (this.git0 = F(this.git0, 25), this.git1 = F(this.git1, 25), this.git2 = F(this.git2, 25), this.git3 = F(this.git3, 25), this.git4 = F(this.git4, 25), this.git5 = F(this.git5, 25), this.git6 = F(this.git6, 25), this.git7 = F(this.git7, 25)) : (this.git0 = E(this.git0, 25), this.git1 = E(this.git1, 25), this.git2 = E(this.git2, 25), this.git3 = E(this.git3, 25), this.git4 = E(this.git4, 25), this.git5 = E(this.git5, 25), this.git6 = E(this.git6, 25), this.git7 = E(this.git7, 25)), this.gitInv0 = this.gitInv0 || E(b(this.git0), 25), this.gitInv1 = this.gitInv1 || b(this.git1), this.gitInv2 = this.gitInv2 || b(this.git2), this.gitInv3 = this.gitInv3 || b(this.git3), this.gitInv4 = this.gitInv4 || b(this.git4), this.gitInv5 = this.gitInv5 || b(this.git5), this.gitInv6 = this.gitInv6 || b(this.git6), this.gitInv7 = this.gitInv7 || b(this.git7), this.gitBranchLabel0 = this.gitBranchLabel0 || b(this.labelTextColor), this.gitBranchLabel1 = this.gitBranchLabel1 || this.labelTextColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.labelTextColor, this.gitBranchLabel3 = this.gitBranchLabel3 || b(this.labelTextColor), this.gitBranchLabel4 = this.gitBranchLabel4 || this.labelTextColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.labelTextColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.labelTextColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.labelTextColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || "10px", this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || "10px", this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || ge, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || xe;
  }
  calculate(e) {
...
}, __6 = new WeakMap(), __privateAdd(_f2, __6, m$1(_f2, "Theme")), _f2), hl = m$1((t9) => {
  let e = new Xo();
  return e.calculate(t9), e;
}, "getThemeVariables");
var jo = (_g2 = class {
...
}, __7 = new WeakMap(), __privateAdd(_g2, __7, m$1(_g2, "Theme")), _g2), cl = m$1((t9) => {
  let e = new jo();
  return e.calculate(t9), e;
}, "getThemeVariables");
var Zo = (_h2 = class {
  constructor() {
    this.primaryColor = "#eee", this.contrast = "#707070", this.secondaryColor = F(this.contrast, 55), this.background = "#ffffff", this.tertiaryColor = m(this.primaryColor, {
      h: -160
  ...
  updateColors() {
    var _a3, _b2, _c3, _d3, _e3, _f3, _g3, _h3, _i2, _j2, _k2, _l3, _m, _n2, _o2, _p2, _q, _r2, _s2, _t, _u2;
    this.secondBkg = F(this.contrast, 55), this.border2 = this.contrast, this.actorBorder = F(this.border1, 23), this.actorBkg = this.mainBkg, this.actorTextColor = this.text, this.actorLineColor = this.actorBorder, this.signalColor = this.text, this.signalTextColor = this.text, this.labelBoxBkgColor = this.actorBkg, this.labelBoxBorderColor = this.actorBorder, this.labelTextColor = this.text, this.loopTextColor = this.text, this.noteBorderColor = "#999", this.noteBkgColor = "#666", this.noteTextColor = "#fff", this.cScale0 = this.cScale0 || "#555", this.cScale1 = this.cScale1 || "#F4F4F4", this.cScale2 = this.cScale2 || "#555", this.cScale3 = this.cScale3 || "#BBB", this.cScale4 = this.cScale4 || "#777", this.cScale5 = this.cScale5 || "#999", this.cScale6 = this.cScale6 || "#DDD", this.cScale7 = this.cScale7 || "#FFF", this.cScale8 = this.cScale8 || "#DDD", this.cScale9 = this.cScale9 || "#BBB", this.cScale10 = this.cScale10 || "#999", this.cScale11 = this.cScale11 || "#777";
    for (let e = 0; e < this.THEME_COLOR_LIMIT; e++) this["cScaleInv" + e] = this["cScaleInv" + e] || b(this["cScale" + e]);
...
}, __8 = new WeakMap(), __privateAdd(_h2, __8, m$1(_h2, "Theme")), _h2), ul = m$1((t9) => {
  let e = new Zo();
  return e.calculate(t9), e;
}, "getThemeVariables");
var ye = {
...
var fl = {
  ...
  c4: {
    ...
    external_personFont: m$1(function() {
      return {
    ...
    external_systemFont: m$1(function() {
      return {
    ...
    external_system_dbFont: m$1(function() {
      return {
    ...
    external_system_queueFont: m$1(function() {
      return {
    ...
    external_containerFont: m$1(function() {
      return {
    ...
    external_container_dbFont: m$1(function() {
      return {
    ...
    container_queueFont: m$1(function() {
      return {
    ...
    external_container_queueFont: m$1(function() {
      return {
    ...
    external_componentFont: m$1(function() {
      return {
    ...
    external_component_dbFont: m$1(function() {
      return {
    ...
    component_queueFont: m$1(function() {
      return {
    ...
    external_component_queueFont: m$1(function() {
      return {
...
var Fi = m$1((t9) => {
  if (tt.debug("sanitizeDirective called with", t9), !(typeof t9 != "object" || t9 == null)) {
    ...
    for (let e of Object.keys(t9)) {
      ...
      for (let o2 of r) e.includes(o2) && (tt.debug("sanitizing css option", e), t9[e] = Du(t9[e]));
    }
...
var Ar = Object.freeze(pl), Rt = Lt({}, Ar), xl, tr = [], Lr = Lt({}, Ar), Mi = m$1((t9, e) => {
  let r = Lt({}, t9), o2 = {};
  for (let n2 of e) Cl(n2), o2 = Lt(o2, n2);
  if (r = Lt(r, o2), o2.theme && o2.theme in ye) {
    let n2 = Lt({}, xl), s = Lt(n2.themeVariables || {}, o2.themeVariables);
    r.theme && r.theme in ye && (r.themeVariables = ye[r.theme].getThemeVariables(s));
  }
  return Lr = r, _l(Lr), Lr;
}, "updateCurrentConfig"), Iu = m$1((t9) => (Rt = Lt({}, Ar), Rt = Lt(Rt, t9), t9.theme && ye[t9.theme] && (Rt.themeVariables = ye[t9.theme].getThemeVariables(t9.themeVariables)), Mi(Rt, tr), Rt), "setSiteConfig"), oC = m$1((t9) => {
  xl = Lt({}, t9);
}, "saveConfigFromInitialize"), nC = m$1((t9) => (Rt = Lt(Rt, t9), Mi(Rt, tr), Rt), "updateSiteConfig"), sC = m$1(() => Lt({}, Rt), "getSiteConfig"), yl = m$1((t9) => (_l(t9), Lt(Lr, t9), Er()), "setConfig"), Er = m$1(() => Lt({}, Lr), "getConfig"), Cl = m$1((t9) => {
  t9 && ([
    "secure",
    ...Rt.secure ?? []
  ].forEach((e) => {
...
Et || (Et = m$1(function(e) {
  return e;
}, "freeze"));
Wt || (Wt = m$1(function(e) {
  return e;
}, "seal"));
rn || (rn = m$1(function(e, r, o2) {
  return e.apply(r, o2);
}, "apply"));
on || (on = m$1(function(e, r) {
  return new e(...r);
}, "construct"));
var Li = Ot(Array.prototype.forEach), Wu = Ot(Array.prototype.lastIndexOf), Tl = Ot(Array.prototype.pop), Or = Ot(Array.prototype.push), $u = Ot(Array.prototype.splice), Ei = Ot(String.prototype.toLowerCase), Ko = Ot(String.prototype.toString), kl = Ot(String.prototype.match), Dr = Ot(String.prototype.replace), Hu = Ot(String.prototype.indexOf), Uu = Ot(String.prototype.trim), Ht = Ot(Object.prototype.hasOwnProperty), At = Ot(RegExp.prototype.test), Ir = Yu(TypeError);
function Ot(t9) {
  return function(e) {
...
function Ee(t9) {
  let e = Al(null);
  for (let [r, o2] of Ll(t9)) Ht(t9, r) && (Array.isArray(o2) ? e[r] = Gu(o2) : o2 && typeof o2 == "object" && o2.constructor === Object ? e[r] = Ee(o2) : e[r] = o2);
  return e;
}
m$1(Ee, "clone");
function zr(t9, e) {
...
var Sl = Et([
  ...
  "xml:space",
  "xmlns:xlink"
]), ju = Wt(/\{\{[\w\W]*|[\w\W]*\}\}/gm), Zu = Wt(/<%[\w\W]*|[\w\W]*%>/gm), Ku = Wt(/\$\{[\w\W]*/gm), Qu = Wt(/^data-[\-\w.\u00B7-\uFFFF]+$/), Ju = Wt(/^aria-[\-\w]+$/), El = Wt(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i), tf = Wt(/^(?:\w+script|data):/i), ef = Wt(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g), Ol = Wt(/^html$/i), rf = Wt(/^[a-z][.\w]*(-[.\w]+)+$/i), Fl = Object.freeze({
  __proto__: null,
  ARIA_ATTR: Ju,
  ATTR_WHITESPACE: ef,
  CUSTOM_ELEMENT: rf,
...
}, "getGlobal"), nf = m$1(function(e, r) {
  if (typeof e != "object" || typeof e.createPolicy != "function") return null;
  let o2 = null, n2 = "data-tt-policy-suffix";
  r && r.hasAttribute(n2) && (o2 = r.getAttribute(n2));
...
}, "_createTrustedTypesPolicy"), Ml = m$1(function() {
  return {
...
function Dl() {
  ...
  let { MUSTACHE_EXPR: k, ERB_EXPR: x, TMPLIT_EXPR: y, DATA_ATTR: L, ARIA_ATTR: S, IS_SCRIPT_OR_DATA: z, ATTR_WHITESPACE: I, CUSTOM_ELEMENT: U } = Fl, { IS_ALLOWED_URI: rt } = Fl, Y = null, nt = K({}, [
  ...
  })), Ct = null, _t = null, lt = true, v = true, H = false, V = true, C = false, mt = true, J = false, bt = false, Tt = false, It = false, Le = false, pi = false, Ba = true, Fa = false, nu = "user-content-", Oo = true, vr = false, Ze = {}, Ke = null, Ma = K({}, [
    "annotation-xml",
    "audio",
    "colgroup",
    "desc",
    ...
    "style",
    "xmlns"
  ]), gi = "http://www.w3.org/1998/Math/MathML", xi = "http://www.w3.org/2000/svg", ie = "http://www.w3.org/1999/xhtml", Qe = ie, Io = false, zo = null, su = K({}, [
    gi,
    xi,
    ie
  ], Ko), yi = K({}, [
    ...
    if (!(Je && Je === d)) {
      if ((!d || typeof d != "object") && (d = {}), d = Ee(d), wr = lu.indexOf(d.PARSER_MEDIA_TYPE) === -1 ? hu : d.PARSER_MEDIA_TYPE, pt = wr === "application/xhtml+xml" ? Ko : Ei, Y = Ht(d, "ALLOWED_TAGS") ? K({}, d.ALLOWED_TAGS, pt) : nt, Q = Ht(d, "ALLOWED_ATTR") ? K({}, d.ALLOWED_ATTR, pt) : Ft, zo = Ht(d, "ALLOWED_NAMESPACES") ? K({}, d.ALLOWED_NAMESPACES, Ko) : su, Do = Ht(d, "ADD_URI_SAFE_ATTR") ? K(Ee(Ea), d.ADD_URI_SAFE_ATTR, pt) : Ea, La = Ht(d, "ADD_DATA_URI_TAGS") ? K(Ee(Aa), d.ADD_DATA_URI_TAGS, pt) : Aa, Ke = Ht(d, "FORBID_CONTENTS") ? K({}, d.FORBID_CONTENTS, pt) : Ma, Ct = Ht(d, "FORBID_TAGS") ? K({}, d.FORBID_TAGS, pt) : {}, _t = Ht(d, "FORBID_ATTR") ? K({}, d.FORBID_ATTR, pt) : {}, Ze = Ht(d, "USE_PROFILES") ? d.USE_PROFILES : false, lt = d.ALLOW_ARIA_ATTR !== false, v = d.ALLOW_DATA_ATTR !== false, H = d.ALLOW_UNKNOWN_PROTOCOLS || false, V = d.ALLOW_SELF_CLOSE_IN_ATTR !== false, C = d.SAFE_FOR_TEMPLATES || false, mt = d.SAFE_FOR_XML !== false, J = d.WHOLE_DOCUMENT || false, It = d.RETURN_DOM || false, Le = d.RETURN_DOM_FRAGMENT || false, pi = d.RETURN_TRUSTED_TYPE || false, Tt = d.FORCE_BODY || false, Ba = d.SANITIZE_DOM !== false, Fa = d.SANITIZE_NAMED_PROPS || false, Oo = d.KEEP_CONTENT !== false, vr = d.IN_PLACE || false, rt = d.ALLOWED_URI_REGEXP || El, Qe = d.NAMESPACE || ie, yi = d.MATHML_TEXT_INTEGRATION_POINTS || yi, Ci = d.HTML_INTEGRATION_POINTS || Ci, Z = d.CUSTOM_ELEMENT_HANDLING || {}, d.CUSTOM_ELEMENT_HANDLING && Oa(d.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (Z.tagNameCheck = d.CUSTOM_ELEMENT_HANDLING.tagNameCheck), d.CUSTOM_ELEMENT_HANDLING && Oa(d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (Z.attributeNameCheck = d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), d.CUSTOM_ELEMENT_HANDLING && typeof d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (Z.allowCustomizedBuiltInElements = d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), C && (v = false), Le && (It = true), Ze && (Y = K({}, vl), Q = [], Ze.html === true && (K(Y, Sl), K(Q, wl)), Ze.svg === true && (K(Y, Qo), K(Q, en), K(Q, Ai)), Ze.svgFilters === true && (K(Y, Jo), K(Q, en), K(Q, Ai)), Ze.mathMl === true && (K(Y, tn), K(Q, Bl), K(Q, Ai))), d.ADD_TAGS && (Y === nt && (Y = Ee(Y)), K(Y, d.ADD_TAGS, pt)), d.ADD_ATTR && (Q === Ft && (Q = Ee(Q)), K(Q, d.ADD_ATTR, pt)), d.ADD_URI_SAFE_ATTR && K(Do, d.ADD_URI_SAFE_ATTR, pt), d.FORBID_CONTENTS && (Ke === Ma && (Ke = Ee(Ke)), K(Ke, d.FORBID_CONTENTS, pt)), Oo && (Y["#text"] = true), J && K(Y, [
        ...
        M = d.TRUSTED_TYPES_POLICY, P = M.createHTML("");
      } else M === void 0 && (M = nf(g, n2)), M !== null && typeof P == "string" && (P = M.createHTML(""));
      Et && Et(d), Je = d;
    }
  }, "_parseConfig"), Da = K({}, [
    ...Qo,
    ...
    let D = Ei(d.tagName), at = Ei(_.tagName);
  ...
  }, "_checkValidNamespace"), jt = m$1(function(d) {
    Or(e.removed, {
      element: d
    });
    try {
  ...
  }, "_forceRemove"), _i2 = m$1(function(d, _) {
    try {
      Or(e.removed, {
  ...
  }, "_removeAttribute"), za = m$1(function(d) {
    let _ = null, D = null;
    ...
    if (Qe === ie) try {
      _ = new f().parseFromString(at, wr);
    } catch {
    }
    if (!_ || !_.documentElement) {
      _ = w.createDocument(Qe, "template", null);
      try {
    ...
    return d && D && Bt.insertBefore(r.createTextNode(D), Bt.childNodes[0] || null), Qe === ie ? $.call(_, J ? "html" : "body")[0] : J ? _.documentElement : Bt;
  }, "_initDocument"), Ra = m$1(function(d) {
  ...
  }, "_createNodeIterator"), No = m$1(function(d) {
  ...
  }, "_isClobbered"), Na = m$1(function(d) {
  ...
  let qa = m$1(function(d) {
      ...
      if (Oo && !Ke[D]) {
        ...
        if (Bt && at) {
          ...
          for (let zt = kt - 1; zt >= 0; --zt) {
            let Zt = A(Bt[zt], true);
            Zt.__removalCount = (d.__removalCount || 0) + 1, at.insertBefore(Zt, q2(d));
          }
        }
      }
      return jt(d), true;
  ...
  }, "_sanitizeElements"), Pa = m$1(function(d, _, D) {
    ...
    return true;
  }, "_isValidAttribute"), Wa = m$1(function(d) {
    return d !== "annotation-xml" && kl(d, U);
  }, "_isBasicCustomElement"), $a = m$1(function(d) {
    ...
    for (; at--; ) {
      let Bt = _[at], { name: kt, namespaceURI: zt, value: Zt } = Bt, Br = pt(kt), Mt = kt === "value" ? Zt : Uu(Zt);
  ...
  }, "_sanitizeAttributes"), fu = m$1(function N(d) {
    let _ = null, D = Ra(d);
    for (oe(B.beforeSanitizeShadowDOM, d, null); _ = D.nextNode(); ) oe(B.uponSanitizeShadowNode, _, null), qa(_), $a(_), _.content instanceof s && N(_.content);
  ...
  return e.sanitize = function(N) {
    ...
    if (Io = !N, Io && (N = "<!-->"), typeof N != "string" && !Na(N)) if (typeof N.toString == "function") {
      if (N = N.toString(), typeof N != "string") throw Ir("dirty is not a string, aborting");
    } else throw Ir("toString is not a function");
    if (!e.isSupported) return N;
    if (bt || Ro(d), e.removed = [], typeof N == "string" && (vr = false), vr) {
      if (N.nodeName) {
        let Zt = pt(N.nodeName);
        if (!Y[Zt] || Ct[Zt]) throw Ir("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (N instanceof l) _ = za("<!---->"), D = _.ownerDocument.importNode(N, true), D.nodeType === Rr.element && D.nodeName === "BODY" || D.nodeName === "HTML" ? _ = D : _.appendChild(D);
    else {
      if (!It && !C && !J && N.indexOf("<") === -1) return M && pi ? M.createHTML(N) : N;
      if (_ = za(N), !_) return It ? null : pi ? P : "";
    }
    _ && Tt && jt(_.firstChild);
    let kt = Ra(vr ? N : _);
    for (; at = kt.nextNode(); ) qa(at), $a(at), at.content instanceof s && fu(at.content);
    if (vr) return N;
    if (It) {
      if (Le) for (Bt = j.call(_.ownerDocument); _.firstChild; ) Bt.appendChild(_.firstChild);
      else Bt = _;
      return (Q.shadowroot || Q.shadowrootmode) && (Bt = it.call(o2, Bt, true)), Bt;
    }
...
var er = Dl();
var Nr = /<br\s*\/?>/gi, sf = m$1((t9) => t9 ? ql(t9).replace(/\\n/g, "#br#").split("#br#") : [
  ""
], "getRows"), af = /* @__PURE__ */ (() => {
  let t9 = false;
  return () => {
...
var Nl = m$1((t9) => (af(), er.sanitize(t9)), "removeScript"), Il = m$1((t9, e) => {
  var _a3;
  if (((_a3 = e.flowchart) == null ? void 0 : _a3.htmlLabels) !== false) {
    let r = e.securityLevel;
    r === "antiscript" || r === "strict" ? t9 = Nl(t9) : r !== "loose" && (t9 = ql(t9), t9 = t9.replace(/</g, "&lt;").replace(/>/g, "&gt;"), t9 = t9.replace(/=/g, "&equals;"), t9 = ff(t9));
  }
  return t9;
}, "sanitizeMore"), Oe = m$1((t9, e) => t9 && (e.dompurifyConfig ? t9 = er.sanitize(Il(t9, e), e.dompurifyConfig).toString() : t9 = er.sanitize(Il(t9, e), {
  FORBID_TAGS: [
    "style"
  ]
}).toString(), t9), "sanitizeText"), hf = m$1((t9, e) => typeof t9 == "string" ? Oe(t9, e) : t9.flat().map((r) => Oe(r, e)), "sanitizeTextOrArray"), cf = m$1((t9) => Nr.test(t9), "hasBreaks"), uf = m$1((t9) => t9.split(Nr), "splitBreaks"), ff = m$1((t9) => t9.replace(/#br#/g, "<br/>"), "placeholderToBreak"), ql = m$1((t9) => t9.replace(Nr, "#br#"), "breakToPlaceholder"), df = m$1((t9) => {
  let e = "";
...
}, "getUrl"), mf = m$1((t9) => !(t9 === false || [
  "false",
  "null",
  "0"
].includes(String(t9).trim().toLowerCase())), "evaluate"), pf = m$1(function() {
  for (var _len = arguments.length, t9 = new Array(_len), _key = 0; _key < _len; _key++) {
    t9[_key] = arguments[_key];
  }
  let e = t9.filter((r) => !isNaN(r));
  return Math.max(...e);
}, "getMax"), gf = m$1(function() {
  for (var _len = arguments.length, t9 = new Array(_len), _key = 0; _key < _len; _key++) {
    t9[_key] = arguments[_key];
  }
  let e = t9.filter((r) => !isNaN(r));
  return Math.min(...e);
}, "getMin"), mC = m$1(function(t9) {
  let e = t9.split(/(,)/), r = [];
  ...
  return r.join("");
}, "parseGenericTypes"), nn = m$1((t9, e) => Math.max(0, t9.split(e).length - 1), "countOccurrence"), xf = m$1((t9, e) => {
  let r = nn(t9, "~"), o2 = nn(e, "~");
  return r === 1 && o2 === 1;
}, "shouldCombineSets"), yf = m$1((t9) => {
  let e = nn(t9, "~"), r = false;
  if (e <= 1) return t9;
  e % 2 !== 0 && t9.startsWith("~") && (t9 = t9.substring(1), r = true);
  let o2 = [
    ...t9
  ], n2 = o2.indexOf("~"), s = o2.lastIndexOf("~");
  for (; n2 !== -1 && s !== -1 && n2 !== s; ) o2[n2] = "<", o2[s] = ">", n2 = o2.indexOf("~"), s = o2.lastIndexOf("~");
  return r && o2.unshift("~"), o2.join("");
}, "processSet"), zl = m$1(() => window.MathMLElement !== void 0, "isMathMLSupported"), sn = /\$\$(.*)\$\$/g, Rl = m$1((t9) => {
  var _a3;
  return (((_a3 = t9.match(sn)) == null ? void 0 : _a3.length) ?? 0) > 0;
}, "hasKatex"), pC = m$1(async (t9, e) => {
  var _a3;
  t9 = await Cf(t9, e);
  ...
  return r.remove(), n2;
}, "calculateMathMLDimensions"), Cf = m$1(async (t9, e) => {
  if (!Rl(t9)) return t9;
  ...
  let { default: r } = await __vitePreload(async () => {
    const { default: r2 } = await import("./vendor-min-mermaid~katex-SWYD7GD6.DTjLgD7O.chunk.js");
    return {
      default: r2
    };
...
var _f = m$1(function(t9, e) {
  for (let r of e) t9.attr(r[0], r[1]);
}, "d3Attrs"), bf = m$1(function(t9, e, r) {
  let o2 = /* @__PURE__ */ new Map();
  return r ? (o2.set("width", "100%"), o2.set("style", `max-width: ${e}px;`)) : (o2.set("height", t9), o2.set("width", e)), o2;
}, "calculateSvgSizeAttrs"), Tf = m$1(function(t9, e, r, o2) {
  let n2 = bf(e, r, o2);
  _f(t9, n2);
}, "configureSvgSize"), Pl = m$1(function(t9, e, r, o2) {
  let n2 = e.node().getBBox(), s = n2.width, a = n2.height;
...
var Oi = {}, kf = m$1((t9, e, r) => {
  let o2 = "";
  return t9 in Oi && Oi[t9] ? o2 = Oi[t9](r) : tt.warn(`No theme found for ${t9}`), ` & {
...
var an = "", ln = "", hn = "", cn = m$1((t9) => Oe(t9, Er()), "sanitizeText"), Sf = m$1(() => {
  an = "", hn = "", ln = "";
}, "clear"), vf = m$1((t9) => {
  an = cn(t9).replace(/^\s+/g, "");
}, "setAccTitle"), wf = m$1(() => an, "getAccTitle"), Bf = m$1((t9) => {
  hn = cn(t9).replace(/\n\s+/g, `
`);
}, "setAccDescription"), Ff = m$1(() => hn, "getAccDescription"), Mf = m$1((t9) => {
  ln = cn(t9);
}, "setDiagramTitle"), Lf = m$1(() => ln, "getDiagramTitle");
var $l = tt, Af = Va, Hl = Er, IC = yl, zC = Ar;
var Ef = m$1((t9) => Oe(t9, Hl()), "sanitizeText"), Of = Pl, Df = m$1(() => un, "getCommonDb"), Di = {}, RC = m$1((t9, e, r) => {
  var _a3;
...
function Ul(t9, e) {
  ...
  if (e === void 0) for (let o2 of t9) o2 != null && (r < o2 || r === void 0 && o2 >= o2) && (r = o2);
    ...
    let o2 = -1;
    for (let n2 of t9) (n2 = e(n2, ++o2, t9)) != null && (r < n2 || r === void 0 && n2 >= n2) && (r = n2);
  }
  return r;
}
m$1(Ul, "max");
...
function Ie(t9) {
  let e, r, o2;
  t9.length !== 2 ? (e = De, r = m$1((l, c) => De(t9(l), c), "compare2"), o2 = m$1((l, c) => t9(l) - c, "delta")) : (e = t9 === De || t9 === dn ? t9 : If, r = t9, o2 = t9);
  function n2(l, c) {
...
var rr = (_j = class extends Map {
  ...
  set(e, r) {
    return super.set(Nf(this, e), r);
  }
  delete(e) {
    return super.delete(qf(this, e));
  }
...
function qf(param, r) {
  let { _intern: t9, _key: e } = param;
  let o2 = e(r);
  return t9.has(o2) && (r = t9.get(o2), t9.delete(o2)), r;
}
...
m$1(Pf, "keyof");
var Wf = Math.sqrt(50), $f = Math.sqrt(10), Hf = Math.sqrt(2);
function Ii(t9, e, r) {
  let o2 = (e - t9) / Math.max(0, r), n2 = Math.floor(Math.log10(o2)), s = o2 / Math.pow(10, n2), a = s >= Wf ? 10 : s >= $f ? 5 : s >= Hf ? 2 : 1, l, c, h;
  return n2 < 0 ? (h = Math.pow(10, -n2) / a, l = Math.round(t9 * h), c = Math.round(e * h), l / h < t9 && ++l, c / h > e && --c, h = -h) : (h = Math.pow(10, n2) * a, l = Math.round(t9 / h), c = Math.round(e / h), l * h < t9 && ++l, c * h > e && --c), c < l && 0.5 <= r && r < 2 ? Ii(t9, e, r * 2) : [
    l,
    c,
    h
  ];
...
function Ri(t9, e, r) {
  ...
  for (var o2 = -1, n2 = Math.max(0, Math.ceil((e - t9) / r)) | 0, s = new Array(n2); ++o2 < n2; ) s[o2] = t9 + o2 * r;
  return s;
}
m$1(Ri, "range");
function gn(t9) {
...
m$1(Gf, "number");
function Vf(t9, e) {
  return e = Math.max(0, t9.bandwidth() - e * 2) / 2, t9.round() && (e = Math.round(e)), (r) => +t9(r) + e;
}
m$1(Vf, "center");
function Xf() {
  return !this.__axis;
...
function Zl(t9, e) {
  ...
  function f(g) {
    var T = o2 ?? (e.ticks ? e.ticks.apply(e, r) : e.domain()), A = n2 ?? (e.tickFormat ? e.tickFormat.apply(e, r) : gn), W = Math.max(s, 0) + l, q2 = e.range(), G = +q2[0] + c, O = +q2[q2.length - 1] + c, M = (e.bandwidth ? Vf : Gf)(e.copy(), c), P = g.selection ? g.selection() : g, w = P.selectAll(".domain").data([
      null
    ]), X = P.selectAll(".tick").data(T, e).order(), j = X.exit(), $ = X.enter().append("g").attr("class", "tick"), it = X.select("line"), B = X.select("text");
    w = w.merge(w.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), X = X.merge($), it = it.merge($.append("line").attr("stroke", "currentColor").attr(u + "2", h * s)), B = B.merge($.append("text").attr("fill", "currentColor").attr(u, h * W).attr("dy", t9 === qi ? "0em" : t9 === yn ? "0.71em" : "0.32em")), g !== P && (w = w.transition(g), X = X.transition(g), it = it.transition(g), B = B.transition(g), j = j.transition(g).attr("opacity", jl).attr("transform", function(k) {
      return isFinite(k = M(k)) ? p(k + c) : this.getAttribute("transform");
    }), $.attr("opacity", jl).attr("transform", function(k) {
      var x = this.parentNode.__axis;
      return p((x && isFinite(x = x(k)) ? x : M(k)) + c);
...
m$1(Ce, "default");
function Cn(t9) {
  typeof t9 != "function" && (t9 = Ce(t9));
  for (var e = this._groups, r = e.length, o2 = new Array(r), n2 = 0; n2 < r; ++n2) for (var s = e[n2], a = s.length, l = o2[n2] = new Array(a), c, h, u = 0; u < a; ++u) (c = s[u]) && (h = t9.call(c, c.__data__, u, s)) && ("__data__" in c && (h.__data__ = c.__data__), l[u] = h);
...
function Jf(t9) {
  return function() {
    return _n(t9.apply(this, arguments));
  };
}
m$1(Jf, "arrayAll");
function bn(t9) {
  typeof t9 == "function" ? t9 = Jf(t9) : t9 = or(t9);
  for (var e = this._groups, r = e.length, o2 = [], n2 = [], s = 0; s < r; ++s) for (var a = e[s], l = a.length, c, h = 0; h < l; ++h) (c = a[h]) && (o2.push(t9.call(c, c.__data__, h, a)), n2.push(c));
  return new ht(o2, n2);
}
m$1(bn, "default");
function nr(t9) {
...
function ad(t9, e, r, o2, n2, s, a) {
  ...
  for (l = 0; l < p; ++l) g = a.call(t9, s[l], l, s) + "", (c = h.get(g)) ? (o2[l] = c, c.__data__ = s[l], h.delete(g)) : r[l] = new Wr(t9, s[l]);
...
function Bn(t9, e) {
  ...
  for (var s = n2.length, a = new Array(s), l = new Array(s), c = new Array(s), h = 0; h < s; ++h) {
    var u = o2[h], p = n2[h], f = p.length, g = hd(t9.call(u, u && u.__data__, h, o2)), T = g.length, A = l[h] = new Array(T), W = a[h] = new Array(T), q2 = c[h] = new Array(f);
    r(u, p, A, W, q2, g, e);
...
m$1(Fn, "default");
function Mn(t9, e, r) {
  var o2 = this.enter(), n2 = this, s = this.exit();
  return typeof t9 == "function" ? (o2 = t9(o2), o2 && (o2 = o2.selection())) : o2 = o2.append(t9 + ""), e != null && (n2 = e(n2), n2 && (n2 = n2.selection())), r == null ? s.remove() : r(s), o2 && n2 ? o2.merge(n2).order() : n2;
}
m$1(Mn, "default");
function Ln(t9) {
  for (var e = t9.selection ? t9.selection() : t9, r = this._groups, o2 = e._groups, n2 = r.length, s = o2.length, a = Math.min(n2, s), l = new Array(n2), c = 0; c < a; ++c) for (var h = r[c], u = o2[c], p = h.length, f = l[c] = new Array(p), g, T = 0; T < p; ++T) (g = h[T] || u[T]) && (f[T] = g);
  for (; c < n2; ++c) l[c] = r[c];
...
function Qt(t9) {
  var e = t9 += "", r = e.indexOf(":");
  return r >= 0 && (e = t9.slice(0, r)) !== "xmlns" && (t9 = t9.slice(r + 1)), qn.hasOwnProperty(e) ? {
    space: qn[e],
    local: t9
  } : t9;
}
...
function Pn(t9, e) {
  ...
  return this.each((e == null ? r.local ? fd : ud : typeof e == "function" ? r.local ? gd : pd : r.local ? md : dd)(r, e));
}
m$1(Pn, "default");
function $r(t9) {
...
function Cd(t9, e, r) {
  return function() {
    var o2 = e.apply(this, arguments);
    o2 == null ? this.style.removeProperty(t9) : this.style.setProperty(t9, o2, r);
  };
}
m$1(Cd, "styleFunction");
function Wn(t9, e, r) {
  return arguments.length > 1 ? this.each((e == null ? xd : typeof e == "function" ? Cd : yd)(t9, e, r ?? "")) : _e(this.node(), t9);
}
m$1(Wn, "default");
function _e(t9, e) {
...
function $n(t9, e) {
  return arguments.length > 1 ? this.each((e == null ? _d : typeof e == "function" ? Td : bd)(t9, e)) : this.node()[t9];
}
m$1($n, "default");
function Kl(t9) {
...
m$1(Hn, "classList");
function Ql(t9) {
  this._node = t9, this._names = Kl(t9.getAttribute("class") || "");
}
m$1(Ql, "ClassList");
Ql.prototype = {
  add: m$1(function(t9) {
  ...
  remove: m$1(function(t9) {
    var e = this._names.indexOf(t9);
    e >= 0 && (this._names.splice(e, 1), this._node.setAttribute("class", this._names.join(" ")));
  }, "remove"),
  contains: m$1(function(t9) {
    return this._names.indexOf(t9) >= 0;
  }, "contains")
};
function Jl(t9, e) {
  for (var r = Hn(t9), o2 = -1, n2 = e.length; ++o2 < n2; ) r.add(e[o2]);
}
m$1(Jl, "classedAdd");
function th(t9, e) {
  for (var r = Hn(t9), o2 = -1, n2 = e.length; ++o2 < n2; ) r.remove(e[o2]);
}
...
function Un(t9, e) {
  var r = Kl(t9 + "");
  if (arguments.length < 2) {
    for (var o2 = Hn(this.node()), n2 = -1, s = r.length; ++n2 < s; ) if (!o2.contains(r[n2])) return false;
    return true;
  }
  return this.each((typeof e == "function" ? vd : e ? kd : Sd)(r, e));
}
m$1(Un, "default");
function wd() {
  this.textContent = "";
...
function Zn(t9, e) {
  ...
  return this.select(function() {
    return this.insertBefore(r.apply(this, arguments), o2.apply(this, arguments) || null);
  });
}
m$1(Zn, "default");
function Rd() {
...
function Wd(t9) {
  return t9.trim().split(/^|\s+/).map(function(e) {
    var r = "", o2 = e.indexOf(".");
    return o2 >= 0 && (r = e.slice(o2 + 1), e = e.slice(0, o2)), {
      type: e,
      name: r
    };
  });
...
function ts(t9, e, r) {
  ...
  for (l = e ? Hd : $d, n2 = 0; n2 < s; ++n2) this.each(l(o2[n2], e, r));
  return this;
}
m$1(ts, "default");
function eh(t9, e, r) {
  var o2 = $r(t9), n2 = o2.CustomEvent;
  typeof n2 == "function" ? n2 = new n2(e, r) : (n2 = o2.document.createEvent("Event"), r ? (n2.initEvent(e, r.bubbles, r.cancelable), n2.detail = r.detail) : n2.initEvent(e, false, false)), t9.dispatchEvent(n2);
}
...
function Yd(t9, e) {
  return function() {
    return eh(this, t9, e.apply(this, arguments));
  };
}
m$1(Yd, "dispatchFunction");
function es(t9, e) {
  return this.each((typeof e == "function" ? Yd : Ud)(t9, e));
}
m$1(es, "default");
function* rs() {
...
m$1(be, "default");
function sr(t9, e) {
  var r = Object.create(t9.prototype);
...
function Yt(t9) {
  var e, r;
  return t9 = (t9 + "").trim().toLowerCase(), (e = Vd.exec(t9)) ? (r = e[1].length, e = parseInt(e[1], 16), r === 6 ? ah(e) : r === 3 ? new St(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : r === 8 ? $i(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : r === 4 ? $i(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = Xd.exec(t9)) ? new St(e[1], e[2], e[3], 1) : (e = jd.exec(t9)) ? new St(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = Zd.exec(t9)) ? $i(e[1], e[2], e[3], e[4]) : (e = Kd.exec(t9)) ? $i(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = Qd.exec(t9)) ? ch(e[1], e[2] / 100, e[3] / 100, 1) : (e = Jd.exec(t9)) ? ch(e[1], e[2] / 100, e[3] / 100, e[4]) : oh.hasOwnProperty(t9) ? ah(oh[t9]) : t9 === "transparent" ? new St(NaN, NaN, NaN, 0) : null;
}
m$1(Yt, "color");
function ah(t9) {
...
m$1($i, "rgba");
function ns(t9) {
  return t9 instanceof Te || (t9 = Yt(t9)), t9 ? (t9 = t9.rgb(), new St(t9.r, t9.g, t9.b, t9.opacity)) : new St();
}
m$1(ns, "rgbConvert");
...
m$1(Re, "clampi");
function ze(t9) {
  return t9 = Re(t9), (t9 < 16 ? "0" : "") + t9.toString(16);
}
m$1(ze, "hex");
...
function fh(t9) {
  ...
  if (t9 instanceof Te || (t9 = Yt(t9)), !t9) return new Ut();
  if (t9 instanceof Ut) return t9;
  t9 = t9.rgb();
  var e = t9.r / 255, r = t9.g / 255, o2 = t9.b / 255, n2 = Math.min(e, r, o2), s = Math.max(e, r, o2), a = NaN, l = s - n2, c = (s + n2) / 2;
...
function bh(t9) {
  ...
  t9 instanceof St || (t9 = ns(t9));
  var e = hs(t9.r), r = hs(t9.g), o2 = hs(t9.b), n2 = ss((0.2225045 * e + 0.7168786 * r + 0.0606169 * o2) / xh), s, a;
  return e === r && r === o2 ? s = a = n2 : (s = ss((0.4360747 * e + 0.3850649 * r + 0.1430804 * o2) / gh), a = ss((0.0139322 * e + 0.0971045 * r + 0.7141733 * o2) / yh)), new te(116 * n2 - 16, 500 * (s - n2), 200 * (n2 - a), t9.opacity);
}
m$1(bh, "labConvert");
...
function om(t9) {
  ...
  if (t9 instanceof te || (t9 = bh(t9)), t9.a === 0 && t9.b === 0) return new he(NaN, 0 < t9.l && t9.l < 100 ? 0 : NaN, t9.l, t9.opacity);
...
m$1(kh, "linear");
function nm(t9, e, r) {
  return t9 = Math.pow(t9, r), e = Math.pow(e, r) - t9, r = 1 / r, function(o2) {
...
function wh(t9) {
  return function(e, r) {
    var o2 = t9((e = Gr(e)).h, (r = Gr(r)).h), n2 = ce(e.c, r.c), s = ce(e.l, r.l), a = ce(e.opacity, r.opacity);
    return function(l) {
      return e.h = o2(l), e.c = n2(l), e.l = s(l), e.opacity = a(l), e + "";
    };
  };
}
m$1(wh, "hcl");
...
function ds(t9) {
  var e = t9.length;
  return function(r) {
    var o2 = Math.floor(((r %= 1) < 0 ? ++r : r) * e), n2 = t9[(o2 + e - 1) % e], s = t9[o2 % e], a = t9[(o2 + 1) % e], l = t9[(o2 + 2) % e];
    return us((r - o2 / e) * e, n2, s, a, l);
  };
}
m$1(ds, "default");
var Ne = m$1(function t(e) {
  var r = vh(e);
  function o2(n2, s) {
    var a = r((n2 = lr(n2)).r, (s = lr(s)).r), l = r(n2.g, s.g), c = r(n2.b, s.b), h = ce(n2.opacity, s.opacity);
    return function(u) {
      return n2.r = a(u), n2.g = l(u), n2.b = c(u), n2.opacity = h(u), n2 + "";
    };
  }
...
function Bh(t9) {
  return function(e) {
    ...
    for (a = 0; a < r; ++a) l = lr(e[a]), o2[a] = l.r || 0, n2[a] = l.g || 0, s[a] = l.b || 0;
    return o2 = t9(o2), n2 = t9(n2), s = t9(s), l.opacity = 1, function(c) {
      return l.r = o2(c), l.g = n2(c), l.b = s(c), l + "";
    };
  };
}
m$1(Bh, "rgbSpline");
function ms(t9, e) {
  e || (e = []);
  var r = t9 ? Math.min(e.length, t9.length) : 0, o2 = e.slice(), n2;
  return function(s) {
...
function Mh(t9, e) {
  ...
  for (a = 0; a < o2; ++a) n2[a] = ke(t9[a], e[a]);
  for (; a < r; ++a) s[a] = e[a];
  return function(l) {
    for (a = 0; a < o2; ++a) s[a] = n2[a](l);
    return s;
  };
}
m$1(Mh, "genericArray");
...
function gs(t9, e) {
  ...
  for (n2 in e) n2 in t9 ? r[n2] = ke(t9[n2], e[n2]) : o2[n2] = e[n2];
  return function(s) {
    for (n2 in r) o2[n2] = r[n2](s);
    return o2;
  };
}
m$1(gs, "default");
...
function ur(t9, e) {
  ...
  for (t9 = t9 + "", e = e + ""; (o2 = ys.exec(t9)) && (n2 = xs.exec(e)); ) (s = n2.index) > r && (s = e.slice(r, s), l[a] ? l[a] += s : l[++a] = s), (o2 = o2[0]) === (n2 = n2[0]) ? l[a] ? l[a] += n2 : l[++a] = n2 : (l[++a] = null, c.push({
    i: a,
    x: gt(o2, n2)
  })), r = xs.lastIndex;
  return r < e.length && (s = e.slice(r), l[a] ? l[a] += s : l[++a] = s), l.length < 2 ? c[0] ? um(c[0].x) : cm(e) : (e = c.length, function(h) {
...
function ke(t9, e) {
  var r = typeof e, o2;
  return e == null || r === "boolean" ? cr(e) : (r === "number" ? gt : r === "string" ? (o2 = Yt(e)) ? (e = o2, Ne) : ur : e instanceof Yt ? Ne : e instanceof Date ? ps : Fh(e) ? ms : Array.isArray(e) ? Mh : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? gs : gt)(t9, e);
}
m$1(ke, "default");
function Vi(t9, e) {
  return t9 = +t9, e = +e, function(r) {
...
function ji(t9, e, r, o2, n2, s) {
  var a, l, c;
  return (a = Math.sqrt(t9 * t9 + e * e)) && (t9 /= a, e /= a), (c = t9 * r + e * o2) && (r -= t9 * c, o2 -= e * c), (l = Math.sqrt(r * r + o2 * o2)) && (r /= l, o2 /= l, c /= l), t9 * o2 < e * r && (t9 = -t9, e = -e, c = -c, a = -a), {
    translateX: n2,
    translateY: s,
...
m$1(Ah, "parseCss");
function Eh(t9) {
  return t9 == null ? Xi : (Zi || (Zi = document.createElementNS("http://www.w3.org/2000/svg", "g")), Zi.setAttribute("transform", t9), (t9 = Zi.transform.baseVal.consolidate()) ? (t9 = t9.matrix, ji(t9.a, t9.b, t9.c, t9.d, t9.e, t9.f)) : Xi);
}
m$1(Eh, "parseSvg");
function Oh(t9, e, r, o2) {
  ...
  function s(h, u, p, f, g, T) {
    if (h !== p || u !== f) {
      var A = g.push("translate(", null, e, null, r);
      T.push({
        i: A - 4,
        x: gt(h, p)
      }, {
  ...
  function c(h, u, p, f, g, T) {
    if (h !== p || u !== f) {
      var A = g.push(n2(g) + "scale(", null, ",", null, ")");
      T.push({
        i: A - 4,
        x: gt(h, p)
      }, {
  ...
  return m$1(c, "scale"), function(h, u) {
    var p = [], f = [];
    return h = t9(h), u = t9(u), s(h.translateX, h.translateY, u.translateX, u.translateY, p, f), a(h.rotate, u.rotate, p, f), l(h.skewX, u.skewX, p, f), c(h.scaleX, h.scaleY, u.scaleX, u.scaleY, p, f), h = u = null, function(g) {
      for (var T = -1, A = f.length, W; ++T < A; ) p[(W = f[T]).i] = W.x(g);
      return p.join("");
    };
  };
}
m$1(Oh, "interpolateTransform");
var Cs = Oh(Ah, "px, ", "px)", "deg)"), _s = Oh(Eh, ", ", ")", ")");
function Se(t9, e) {
...
function Vr() {
  ...
  return m$1(n2, "scale"), n2.domain = function(s) {
    ...
    return arguments.length ? (r = Array.from(s), n2) : r.slice();
...
function fm(t9, e) {
  ...
  return t9 > e && (r = t9, t9 = e, e = r), function(o2) {
    return Math.max(t9, Math.min(e, o2));
  };
}
m$1(fm, "clamper");
function dm(t9, e, r) {
  var o2 = t9[0], n2 = t9[1], s = e[0], a = e[1];
  return n2 < o2 ? (o2 = Ss(n2, o2), s = r(a, s)) : (o2 = Ss(o2, n2), s = r(s, a)), function(l) {
    return s(o2(l));
  };
}
m$1(dm, "bimap");
function mm(t9, e, r) {
  ...
  for (t9[o2] < t9[0] && (t9 = t9.slice().reverse(), e = e.slice().reverse()); ++a < o2; ) n2[a] = Ss(t9[a], t9[a + 1]), s[a] = r(e[a], e[a + 1]);
  return function(l) {
...
m$1(mm, "polymap");
function Ki(t9, e) {
  return e.domain(t9.domain()).range(t9.range()).interpolate(t9.interpolate()).clamp(t9.clamp()).unknown(t9.unknown());
}
m$1(Ki, "copy");
function pm() {
  var t9 = Dh, e = Dh, r = ke, o2, n2, s, a = fr, l, c, h;
  function u() {
    var f = Math.min(t9.length, e.length);
    return a !== fr && (a = fm(t9[0], t9[f - 1])), l = f > 2 ? mm : dm, c = h = null, p;
  }
  m$1(u, "rescale");
  function p(f) {
    return f == null || isNaN(f = +f) ? s : (c || (c = l(t9.map(o2), e, r)))(o2(a(f)));
  }
  return m$1(p, "scale"), p.invert = function(f) {
    return a(n2((h || (h = l(e, t9.map(o2), gt)))(f)));
  }, p.domain = function(f) {
    return arguments.length ? (t9 = Array.from(f, ks), u()) : t9.slice();
  }, p.range = function(f) {
    return arguments.length ? (e = Array.from(f), u()) : e.slice();
  }, p.rangeRound = function(f) {
    return e = Array.from(f), r = Vi, u();
  }, p.clamp = function(f) {
...
m$1(Xr, "continuous");
function vs(t9) {
  return Math.abs(t9 = Math.round(t9)) >= 1e21 ? t9.toLocaleString("en").replace(/,/g, "") : t9.toString(10);
}
m$1(vs, "default");
function qe(t9, e) {
  if ((r = (t9 = e ? t9.toExponential(e - 1) : t9.toExponential()).indexOf("e")) < 0) return null;
  var r, o2 = t9.slice(0, r);
  return [
...
function Gt(t9) {
  return t9 = qe(Math.abs(t9)), t9 ? t9[1] : NaN;
}
m$1(Gt, "default");
function ws(t9, e) {
  return function(r, o2) {
    for (var n2 = r.length, s = [], a = 0, l = t9[0], c = 0; n2 > 0 && l > 0 && (c + l + 1 > o2 && (l = Math.max(1, o2 - c)), s.push(r.substring(n2 -= l, n2 + l)), !((c += l + 1) > o2)); ) l = t9[a = (a + 1) % t9.length];
...
var gm = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function ve(t9) {
  if (!(e = gm.exec(t9))) throw new Error("invalid format: " + t9);
  var e;
  return new Qi({
    fill: e[1],
    align: e[2],
...
function Ls(t9, e) {
  var r = qe(t9, e);
  if (!r) return t9 + "";
  var o2 = r[0], n2 = r[1], s = n2 - (Ms = Math.max(-8, Math.min(8, Math.floor(n2 / 3))) * 3) + 1, a = o2.length;
  return s === a ? o2 : s > a ? o2 + new Array(s - a + 1).join("0") : s > 0 ? o2.slice(0, s) + "." + o2.slice(s) : "0." + new Array(1 - s).join("0") + qe(t9, Math.max(0, e + s - 1))[0];
}
m$1(Ls, "default");
function Ji(t9, e) {
  var r = qe(t9, e);
...
m$1(Ji, "default");
var As = {
  "%": m$1((t9, e) => (t9 * 100).toFixed(e), "%"),
  b: m$1((t9) => Math.round(t9).toString(2), "b"),
  c: m$1((t9) => t9 + "", "c"),
  d: vs,
  e: m$1((t9, e) => t9.toExponential(e), "e"),
  f: m$1((t9, e) => t9.toFixed(e), "f"),
  g: m$1((t9, e) => t9.toPrecision(e), "g"),
  o: m$1((t9) => Math.round(t9).toString(8), "o"),
  p: m$1((t9, e) => Ji(t9 * 100, e), "p"),
  r: Ji,
  s: Ls,
  X: m$1((t9) => Math.round(t9).toString(16).toUpperCase(), "X"),
  x: m$1((t9) => Math.round(t9).toString(16), "x")
};
function to(t9) {
  return t9;
}
...
function Es(t9) {
  var e = t9.grouping === void 0 || t9.thousands === void 0 ? to : ws(Ih.call(t9.grouping, Number), t9.thousands + ""), r = t9.currency === void 0 ? "" : t9.currency[0] + "", o2 = t9.currency === void 0 ? "" : t9.currency[1] + "", n2 = t9.decimal === void 0 ? "." : t9.decimal + "", s = t9.numerals === void 0 ? to : Bs(Ih.call(t9.numerals, String)), a = t9.percent === void 0 ? "%" : t9.percent + "", l = t9.minus === void 0 ? "−" : t9.minus + "", c = t9.nan === void 0 ? "NaN" : t9.nan + "";
  function h(p) {
    p = ve(p);
    ...
    var w = A === "$" ? r : A === "#" && /[boxX]/.test(P) ? "0" + P.toLowerCase() : "", X = A === "$" ? o2 : /[%p]/.test(P) ? a : "", j = As[P], $ = /[defgprs%]/.test(P);
    ...
    function it(B) {
      ...
      if (P === "c") x = j(B) + x, B = "";
        ...
        B = +B;
        var z = B < 0 || 1 / B < 0;
        if (B = isNaN(B) ? c : j(Math.abs(B), O), M && (B = Fs(B)), z && +B == 0 && T !== "+" && (z = false), k = (z ? T === "(" ? T : l : T === "-" || T === "(" ? "" : T) + k, x = (P === "s" ? zh[8 + Ms / 3] : "") + x + (z && T === "(" ? ")" : ""), $) {
          for (y = -1, L = B.length; ++y < L; ) if (S = B.charCodeAt(y), 48 > S || S > 57) {
            x = (S === 46 ? n2 + B.slice(y + 1) : B.slice(y)) + x, B = B.slice(0, y);
            break;
          }
        }
      }
      ...
      switch (G && W && (B = e(U + B, U.length ? q2 - x.length : 1 / 0), U = ""), g) {
        case "<":
          B = k + B + x + U;
          break;
        case "=":
  ...
  m$1(h, "newFormat");
  function u(p, f) {
    var g = h((p = ve(p), p.type = "f", p)), T = Math.max(-8, Math.min(8, Math.floor(Gt(f) / 3))) * 3, A = Math.pow(10, -T), W = zh[8 + T / 3];
    return function(q2) {
      return g(A * q2) + W;
    };
  }
...
function Os(t9) {
  return eo = Es(t9), ro = eo.format, io = eo.formatPrefix, eo;
}
m$1(Os, "defaultLocale");
function oo(t9) {
  return Math.max(0, -Gt(Math.abs(t9)));
}
m$1(oo, "default");
function no(t9, e) {
  return Math.max(0, Math.max(-8, Math.min(8, Math.floor(Gt(e) / 3))) * 3 - Gt(Math.abs(t9)));
}
m$1(no, "default");
function so(t9, e) {
  return t9 = Math.abs(t9), e = Math.abs(e) - t9, Math.max(0, Gt(e) - Gt(t9)) + 1;
}
m$1(so, "default");
function Ds(t9, e, r, o2) {
  var n2 = ir(t9, e, r), s;
  switch (o2 = ve(o2 ?? ",f"), o2.type) {
    case "s": {
      var a = Math.max(Math.abs(t9), Math.abs(e));
      return o2.precision == null && !isNaN(s = no(n2, a)) && (o2.precision = s), io(o2, a);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      o2.precision == null && !isNaN(s = so(n2, Math.max(Math.abs(t9), Math.abs(e)))) && (o2.precision = s - (o2.type === "e"));
      break;
    }
    case "f":
    case "%": {
      o2.precision == null && !isNaN(s = oo(n2)) && (o2.precision = s - (o2.type === "%") * 2);
      break;
    }
  }
  return ro(o2);
...
function xm(t9) {
  ...
  return t9.ticks = function(r) {
    ...
    r == null && (r = 10);
    var o2 = e(), n2 = 0, s = o2.length - 1, a = o2[n2], l = o2[s], c, h, u = 10;
    for (l < a && (h = a, a = l, l = h, h = n2, n2 = s, s = h); u-- > 0; ) {
      if (h = qr(a, l, r), h === c) return o2[n2] = a, o2[s] = l, e(o2);
...
function ot(t9, e, r, o2) {
  ...
  return m$1(n2, "interval"), n2.floor = (s) => (t9(s = /* @__PURE__ */ new Date(+s)), s), n2.ceil = (s) => (t9(s = new Date(s - 1)), e(s, 1), t9(s), s), n2.round = (s) => {
    let a = n2(s), l = n2.ceil(s);
    return s - a < l - s ? a : l;
  }, n2.offset = (s, a) => (e(s = /* @__PURE__ */ new Date(+s), a == null ? 1 : Math.floor(a)), s), n2.range = (s, a, l) => {
    let c = [];
    if (s = n2.ceil(s), l = l == null ? 1 : Math.floor(l), !(s < a) || !(l > 0)) return c;
    let h;
    do
  ...
  }), r && (n2.count = (s, a) => (zs.setTime(+s), Rs.setTime(+a), t9(zs), t9(Rs), Math.floor(r(zs, Rs))), n2.every = (s) => (s = Math.floor(s), !isFinite(s) || !(s > 0) ? null : s > 1 ? n2.filter(o2 ? (a) => o2(a) % s === 0 : (a) => n2.count(0, a) % s === 0) : n2)), n2;
}
m$1(ot, "timeInterval");
var Pe = ot(() => {
}, (t9, e) => {
...
Pe.every = (t9) => (t9 = Math.floor(t9), !isFinite(t9) || !(t9 > 0) ? null : t9 > 1 ? ot((e) => {
...
lo.range;
var ue = ot((t9) => t9.setHours(0, 0, 0, 0), (t9, e) => t9.setDate(t9.getDate() + e), (t9, e) => (e - t9 - (e.getTimezoneOffset() - t9.getTimezoneOffset()) * 6e4) / 864e5, (t9) => t9.getDate() - 1);
ue.range;
var Zr = ot((t9) => {
...
m$1(He, "timeWeekday");
var fe = He(0), pr = He(1), Ph = He(2), Wh = He(3), we = He(4), $h = He(5), Hh = He(6);
fe.range;
pr.range;
Ph.range;
Wh.range;
...
m$1(Ue, "utcWeekday");
var Ye = Ue(0), gr = Ue(1), Yh = Ue(2), Gh = Ue(3), Be = Ue(4), Vh = Ue(5), Xh = Ue(6);
Ye.range;
gr.range;
Yh.range;
Gh.range;
...
Nt.every = (t9) => !isFinite(t9 = Math.floor(t9)) || !(t9 > 0) ? null : ot((e) => {
...
Vt.every = (t9) => !isFinite(t9 = Math.floor(t9)) || !(t9 > 0) ? null : ot((e) => {
...
function Kh(t9, e, r, o2, n2, s) {
  ...
  m$1(l, "ticks");
  function c(h, u, p) {
    let f = Math.abs(u - h) / p, g = Ie((param) => {
      let [, , W] = param;
      return W;
    }).right(a, f);
    if (g === a.length) return t9.every(ir(h / 31536e6, u / 31536e6, p));
    if (g === 0) return Pe.every(Math.max(ir(h, u, p), 1));
...
m$1(Kr, "newDate");
function $s(t9) {
  var e = t9.dateTime, r = t9.date, o2 = t9.time, n2 = t9.periods, s = t9.days, a = t9.shortDays, l = t9.months, c = t9.shortMonths, h = Qr(n2), u = Jr(n2), p = Qr(s), f = Jr(s), g = Qr(a), T = Jr(a), A = Qr(l), W = Jr(l), q2 = Qr(c), G = Jr(c), O = {
    a: z,
    A: I,
    b: U,
    B: rt,
  ...
  O.x = w(r, O), O.X = w(o2, O), O.c = w(e, O), M.x = w(r, M), M.X = w(o2, M), M.c = w(e, M);
  function w(v, H) {
    return function(V) {
      var C = [], mt = -1, J = 0, bt = v.length, Tt, It, Le;
      for (V instanceof Date || (V = /* @__PURE__ */ new Date(+V)); ++mt < bt; ) v.charCodeAt(mt) === 37 && (C.push(v.slice(J, mt)), (It = Qh[Tt = v.charAt(++mt)]) != null ? Tt = v.charAt(++mt) : It = Tt === "e" ? " " : "0", (Le = H[Tt]) && (Tt = Le(V, It)), C.push(Tt), J = mt + 1);
      return C.push(v.slice(J, mt)), C.join("");
    };
  }
  m$1(w, "newFormat");
  function X(v, H) {
    return function(V) {
      var C = Kr(1900, void 0, 1), mt = j(C, v, V += "", 0), J, bt;
      ...
      if (H && !("Z" in C) && (C.Z = 0), "p" in C && (C.H = C.H % 12 + C.p * 12), C.m === void 0 && (C.m = "q" in C ? C.q : 0), "V" in C) {
        ...
        "w" in C || (C.w = 1), "Z" in C ? (J = Ws(Kr(C.y, 0, 1)), bt = J.getUTCDay(), J = bt > 4 || bt === 0 ? gr.ceil(J) : gr(J), J = Zr.offset(J, (C.V - 1) * 7), C.y = J.getUTCFullYear(), C.m = J.getUTCMonth(), C.d = J.getUTCDate() + (C.w + 6) % 7) : (J = Ps(Kr(C.y, 0, 1)), bt = J.getDay(), J = bt > 4 || bt === 0 ? pr.ceil(J) : pr(J), J = ue.offset(J, (C.V - 1) * 7), C.y = J.getFullYear(), C.m = J.getMonth(), C.d = J.getDate() + (C.w + 6) % 7);
      } else ("W" in C || "U" in C) && ("w" in C || (C.w = "u" in C ? C.u % 7 : "W" in C ? 1 : 0), bt = "Z" in C ? Ws(Kr(C.y, 0, 1)).getUTCDay() : Ps(Kr(C.y, 0, 1)).getDay(), C.m = 0, C.d = "W" in C ? (C.w + 6) % 7 + C.W * 7 - (bt + 5) % 7 : C.w + C.U * 7 - (bt + 6) % 7);
  ...
  function j(v, H, V, C) {
    for (var mt = 0, J = H.length, bt = V.length, Tt, It; mt < J; ) {
      if (C >= bt) return -1;
      if (Tt = H.charCodeAt(mt++), Tt === 37) {
        if (Tt = H.charAt(mt++), It = P[Tt in Qh ? H.charAt(mt++) : Tt], !It || (C = It(v, V, C)) < 0) return -1;
  ...
  function $(v, H, V) {
    var C = h.exec(H.slice(V));
    return C ? (v.p = u.get(C[0].toLowerCase()), V + C[0].length) : -1;
  }
  m$1($, "parsePeriod");
  function it(v, H, V) {
    var C = g.exec(H.slice(V));
    return C ? (v.w = T.get(C[0].toLowerCase()), V + C[0].length) : -1;
  }
  m$1(it, "parseShortWeekday");
  function B(v, H, V) {
    var C = p.exec(H.slice(V));
    return C ? (v.w = f.get(C[0].toLowerCase()), V + C[0].length) : -1;
  }
  m$1(B, "parseWeekday");
  function k(v, H, V) {
    var C = q2.exec(H.slice(V));
    return C ? (v.m = G.get(C[0].toLowerCase()), V + C[0].length) : -1;
  }
  m$1(k, "parseShortMonth");
  function x(v, H, V) {
    var C = A.exec(H.slice(V));
    return C ? (v.m = W.get(C[0].toLowerCase()), V + C[0].length) : -1;
  }
  m$1(x, "parseMonth");
  function y(v, H, V) {
    return j(v, e, H, V);
  ...
  return m$1(lt, "formatUTCQuarter"), {
    format: m$1(function(v) {
      var H = w(v += "", O);
      return H.toString = function() {
        return v;
      }, H;
    }, "format"),
    parse: m$1(function(v) {
      var H = X(v += "", false);
      return H.toString = function() {
        return v;
      }, H;
    }, "parse"),
    utcFormat: m$1(function(v) {
      var H = w(v += "", M);
      return H.toString = function() {
        return v;
      }, H;
    }, "utcFormat"),
    utcParse: m$1(function(v) {
      var H = X(v += "", true);
      return H.toString = function() {
        return v;
      }, H;
...
m$1(tc, "parseYear");
function Qm(t9, e, r) {
  var o2 = /^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(e.slice(r, r + 6));
...
function np(t9, e, r) {
  var o2 = xt.exec(e.slice(r, r + 6));
  return o2 ? (t9.L = Math.floor(o2[0] / 1e3), r + o2[0].length) : -1;
}
m$1(np, "parseMicroseconds");
function sp(t9, e, r) {
  var o2 = Um.exec(e.slice(r, r + 1));
  return o2 ? r + o2[0].length : -1;
}
m$1(sp, "parseLiteralPercent");
function ap(t9, e, r) {
  var o2 = xt.exec(e.slice(r));
...
function ic(t9, e) {
  return et(t9.getDate(), e, 2);
}
m$1(ic, "formatDayOfMonth");
function hp(t9, e) {
  return et(t9.getHours(), e, 2);
}
m$1(hp, "formatHour24");
function cp(t9, e) {
...
m$1(cp, "formatHour12");
function up(t9, e) {
  return et(1 + ue.count(Nt(t9), t9), e, 3);
}
m$1(up, "formatDayOfYear");
function lc(t9, e) {
  return et(t9.getMilliseconds(), e, 3);
}
...
function mp(t9, e) {
  return et(t9.getMinutes(), e, 2);
}
m$1(mp, "formatMinutes");
function pp(t9, e) {
  return et(t9.getSeconds(), e, 2);
}
...
function xp(t9, e) {
  return et(fe.count(Nt(t9) - 1, t9), e, 2);
}
...
m$1(hc, "dISO");
function yp(t9, e) {
  return t9 = hc(t9), et(we.count(Nt(t9), t9) + (Nt(t9).getDay() === 4), e, 2);
}
...
function _p(t9, e) {
  return et(pr.count(Nt(t9) - 1, t9), e, 2);
}
...
m$1(bp, "formatYear");
function Tp(t9, e) {
  return t9 = hc(t9), et(t9.getFullYear() % 100, e, 2);
}
...
function vp(t9) {
  var e = t9.getTimezoneOffset();
  return (e > 0 ? "-" : (e *= -1, "+")) + et(e / 60 | 0, "0", 2) + et(e % 60, "0", 2);
}
m$1(vp, "formatZone");
function oc(t9, e) {
  return et(t9.getUTCDate(), e, 2);
}
m$1(oc, "formatUTCDayOfMonth");
function wp(t9, e) {
  return et(t9.getUTCHours(), e, 2);
}
...
function Fp(t9, e) {
  return et(1 + Zr.count(Vt(t9), t9), e, 3);
}
m$1(Fp, "formatUTCDayOfYear");
function cc(t9, e) {
  return et(t9.getUTCMilliseconds(), e, 3);
}
...
function Ap(t9, e) {
  return et(t9.getUTCMinutes(), e, 2);
}
m$1(Ap, "formatUTCMinutes");
function Ep(t9, e) {
  return et(t9.getUTCSeconds(), e, 2);
}
...
function Dp(t9, e) {
  return et(Ye.count(Vt(t9) - 1, t9), e, 2);
}
...
m$1(uc, "UTCdISO");
function Ip(t9, e) {
  return t9 = uc(t9), et(Be.count(Vt(t9), t9) + (Vt(t9).getUTCDay() === 4), e, 2);
}
...
function Rp(t9, e) {
  return et(gr.count(Vt(t9) - 1, t9), e, 2);
}
...
function qp(t9, e) {
  return t9 = uc(t9), et(t9.getUTCFullYear() % 100, e, 2);
}
...
function Hs(t9) {
  return yr = $s(t9), uo = yr.format, yr.parse, yr.utcFormat, yr.utcParse, yr;
}
m$1(Hs, "defaultLocale");
function Us(t9, e) {
  t9 = t9.slice();
  var r = 0, o2 = t9.length - 1, n2 = t9[r], s = t9[o2], a;
  return s < n2 && (a = r, r = o2, o2 = a, a = n2, n2 = s, s = a), t9[r] = e.floor(n2), t9[o2] = e.ceil(s), t9;
}
m$1(Us, "nice");
function Hp(t9) {
  return new Date(t9);
...
function pc(t9, e, r, o2, n2, s, a, l, c, h) {
  var u = Xr(), p = u.invert, f = u.domain, g = h(".%L"), T = h(":%S"), A = h("%I:%M"), W = h("%I %p"), q2 = h("%a %d"), G = h("%b %d"), O = h("%B"), M = h("%Y");
  function P(w) {
  ...
  return m$1(P, "tickFormat"), u.invert = function(w) {
    ...
    return arguments.length ? f(Array.from(w, Up)) : f().map(Hp);
  }, u.ticks = function(w) {
    var X = f();
    ...
    var X = f();
    return (!w || typeof w.range != "function") && (w = e(X[0], X[X.length - 1], w ?? 10)), w ? f(Us(X, w)) : u;
  }, u.copy = function() {
    return Ki(u, pc(t9, e, r, o2, n2, s, a, l, c, h));
  }, u;
}
m$1(pc, "calendar");
function gc() {
  return Se.apply(pc(Ns, qs, Nt, xr, fe, ue, mr, dr, ee, uo).domain([
    new Date(2e3, 0, 1),
    new Date(2e3, 0, 2)
  ]), arguments);
}
m$1(gc, "time");
function Ys() {
  var t9 = Vr().unknown(void 0), e = t9.domain, r = t9.range, o2 = 0, n2 = 1, s, a, l = false, c = 0, h = 0, u = 0.5;
  delete t9.unknown;
  function p() {
    var f = e().length, g = n2 < o2, T = g ? n2 : o2, A = g ? o2 : n2;
    s = (A - T) / Math.max(1, f - c + h * 2), l && (s = Math.floor(s)), T += (A - T - s * (f - c)) * u, a = s * (1 - c), l && (T = Math.round(T), a = Math.round(a));
    var W = Ri(f).map(function(q2) {
      return T + s * q2;
    });
...
m$1(Gs, "default");
var Yp = Gs("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
function st(t9) {
  return m$1(function() {
    return t9;
  }, "constant");
...
var Xe = (_k = class {
  ...
  arcTo(e, r, o2, n2, s) {
    ...
    if (this._x1 === null) this._append`M${this._x1 = e},${this._y1 = r}`;
      ...
      let g = o2 - a, T = n2 - l, A = c * c + h * h, W = g * g + T * T, q2 = Math.sqrt(A), G = Math.sqrt(f), O = s * Math.tan((js - Math.acos((A + f - W) / (2 * q2 * G))) / 2), M = O / G, P = O / q2;
...
function po(t9, e, r, o2, n2, s, a) {
  var l = t9 - r, c = e - o2, h = (a ? s : -s) / Ge(l * l + c * c), u = h * c, p = -h * l, f = t9 + u, g = e + p, T = r + u, A = o2 + p, W = (f + T) / 2, q2 = (g + A) / 2, G = T - f, O = A - g, M = G * G + O * O, P = n2 - s, w = f * A - T * g, X = (O < 0 ? -1 : 1) * Ge(xc(0, P * P * M - w * w)), j = (w * O - G * X) / M, $ = (-w * G - O * X) / M, it = (w * O + G * X) / M, B = (-w * G + O * X) / M, k = j - W, x = $ - q2, y = it - W, L = B - q2;
...
function bc() {
  var t9 = Xp, e = jp, r = st(0), o2 = null, n2 = Zp, s = Kp, a = Qp, l = null, c = mo(h);
  function h() {
    var u, p, f = +t9.apply(this, arguments), g = +e.apply(this, arguments), T = n2.apply(this, arguments) - ti, A = s.apply(this, arguments) - ti, W = Vs(A - T), q2 = A > T;
    if (l || (l = u = c()), g < f && (p = g, g = f, f = p), !(g > yt)) l.moveTo(0, 0);
    else if (W > _r - yt) l.moveTo(g * Fe(T), g * Xt(T)), l.arc(0, 0, g, T, A, !q2), f > yt && (l.moveTo(f * Fe(A), f * Xt(A)), l.arc(0, 0, f, A, T, q2));
    else {
      var G = T, O = A, M = T, P = A, w = W, X = W, j = a.apply(this, arguments) / 2, $ = j > yt && (o2 ? +o2.apply(this, arguments) : Ge(f * f + g * g)), it = fo(Vs(g - f) / 2, +r.apply(this, arguments)), B = it, k = it, x, y;
      if ($ > yt) {
        var L = Xs($ / f * Xt(j)), S = Xs($ / g * Xt(j));
      ...
      if (it > yt) {
        ...
        if (W < Cr) if (Z = Jp(z, I, Q, Ft, Y, nt, U, rt)) {
          var Ct = z - Z[0], _t = I - Z[1], lt = Y - Z[0], v = nt - Z[1], H = 1 / Xt(yc((Ct * lt + _t * v) / (Ge(Ct * Ct + _t * _t) * Ge(lt * lt + v * v))) / 2), V = Ge(Z[0] * Z[0] + Z[1] * Z[1]);
          B = fo(it, (f - V) / (H - 1)), k = fo(it, (g - V) / (H + 1));
        } else B = k = 0;
      }
      X > yt ? k > yt ? (x = po(Q, Ft, z, I, g, k, q2), y = po(Y, nt, U, rt, g, k, q2), l.moveTo(x.cx + x.x01, x.cy + x.y01), k < it ? l.arc(x.cx, x.cy, k, vt(x.y01, x.x01), vt(y.y01, y.x01), !q2) : (l.arc(x.cx, x.cy, k, vt(x.y01, x.x01), vt(x.y11, x.x11), !q2), l.arc(0, 0, g, vt(x.cy + x.y11, x.cx + x.x11), vt(y.cy + y.y11, y.cx + y.x11), !q2), l.arc(y.cx, y.cy, k, vt(y.y11, y.x11), vt(y.y01, y.x01), !q2))) : (l.moveTo(z, I), l.arc(0, 0, g, G, O, !q2)) : l.moveTo(z, I), !(f > yt) || !(w > yt) ? l.lineTo(U, rt) : B > yt ? (x = po(U, rt, Y, nt, f, -B, q2), y = po(z, I, Q, Ft, f, -B, q2), l.lineTo(x.cx + x.x01, x.cy + x.y01), B < it ? l.arc(x.cx, x.cy, B, vt(x.y01, x.x01), vt(y.y01, y.x01), !q2) : (l.arc(x.cx, x.cy, B, vt(x.y01, x.x01), vt(x.y11, x.x11), !q2), l.arc(0, 0, f, vt(x.cy + x.y11, x.cx + x.x11), vt(y.cy + y.y11, y.cx + y.x11), q2), l.arc(y.cx, y.cy, B, vt(y.y11, y.x11), vt(y.y01, y.x01), !q2))) : l.arc(0, 0, f, P, M, q2);
    }
...
m$1(Tc, "Linear");
Tc.prototype = {
  areaStart: m$1(function() {
    this._line = 0;
  }, "areaStart"),
  areaEnd: m$1(function() {
    this._line = NaN;
  }, "areaEnd"),
  lineStart: m$1(function() {
    this._point = 0;
  }, "lineStart"),
  lineEnd: m$1(function() {
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  }, "lineEnd"),
  point: m$1(function(t9, e) {
...
m$1(Sc, "y");
function vc(t9, e) {
  var r = st(true), o2 = null, n2 = go, s = null, a = mo(l);
  t9 = typeof t9 == "function" ? t9 : t9 === void 0 ? kc : st(t9), e = typeof e == "function" ? e : e === void 0 ? Sc : st(e);
  function l(c) {
    var h, u = (c = ei(c)).length, p, f = false, g;
    for (o2 == null && (s = n2(g = a())), h = 0; h <= u; ++h) !(h < u && r(p = c[h], h, c)) === f && ((f = !f) ? s.lineStart() : s.lineEnd()), f && s.point(+t9(p, h, c), +e(p, h, c));
  ...
  return m$1(l, "line"), l.x = function(c) {
    ...
    return arguments.length ? (n2 = c, o2 != null && (s = n2(o2)), l) : n2;
  }, l.context = function(c) {
    return arguments.length ? (c == null ? o2 = s = null : s = n2(o2 = c), l) : o2;
  }, l;
}
m$1(vc, "default");
function Ks(t9, e) {
...
m$1(Qs, "default");
function wc() {
  var t9 = Qs, e = Ks, r = null, o2 = st(0), n2 = st(_r), s = st(0);
  function a(l) {
    var c, h = (l = ei(l)).length, u, p, f = 0, g = new Array(h), T = new Array(h), A = +o2.apply(this, arguments), W = Math.min(_r, Math.max(-_r, n2.apply(this, arguments) - A)), q2, G = Math.min(Math.abs(W) / h, s.apply(this, arguments)), O = G * (W < 0 ? -1 : 1), M;
...
Oc.prototype = {
  ...
  point: m$1(function(t9, e) {
    if (t9 = +t9, e = +e, this._point) {
      ...
      this._l23_a = Math.sqrt(this._l23_2a = Math.pow(r * r + o2 * o2, this._alpha));
    }
    switch (this._point) {
      case 0:
        this._point = 1, this._line ? this._context.lineTo(t9, e) : this._context.moveTo(t9, e);
...
function qc(t9, e, r) {
  ...
  return (Nc(s) + Nc(a)) * Math.min(Math.abs(s), Math.abs(a), 0.5 * Math.abs(l)) || 0;
}
m$1(qc, "slope3");
function Pc(t9, e) {
  var r = t9._x1 - t9._x0;
  ...
  lineEnd: m$1(function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Js(this, this._t0, Pc(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  }, "lineEnd"),
    ...
    if (t9 = +t9, e = +e, !(t9 === this._x1 && e === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, Js(this, Pc(this, r = qc(this, t9, e)), r);
          break;
        default:
          Js(this, this._t0, r = qc(this, t9, e));
          break;
      }
...
m$1(Wc, "MonotoneY");
(Wc.prototype = Object.create(bo.prototype)).point = function(t9, e) {
...
$c.prototype = {
  moveTo: m$1(function(t9, e) {
    this._context.moveTo(e, t9);
  }, "moveTo"),
  closePath: m$1(function() {
    this._context.closePath();
  }, "closePath"),
  lineTo: m$1(function(t9, e) {
    this._context.lineTo(e, t9);
  }, "lineTo"),
  bezierCurveTo: m$1(function(t9, e, r, o2, n2, s) {
...
Uc.prototype = {
  ...
  lineEnd: m$1(function() {
    ...
    else for (var o2 = Hc(t9), n2 = Hc(e), s = 0, a = 1; a < r; ++s, ++a) this._context.bezierCurveTo(o2[0][s], n2[0][s], o2[1][s], n2[1][s], t9[a], e[a]);
...
function mg(t9, e) {
  return t9.trim().split(/^|\s+/).map(function(r) {
    var o2 = "", n2 = r.indexOf(".");
    if (n2 >= 0 && (o2 = r.slice(n2 + 1), r = r.slice(0, n2)), r && !e.hasOwnProperty(r)) throw new Error("unknown type: " + r);
    return {
      type: r,
      name: o2
    };
...
ko.prototype = Xc.prototype = {
  constructor: ko,
  on: m$1(function(t9, e) {
    var r = this._, o2 = mg(t9 + "", r), n2, s = -1, a = o2.length;
    if (arguments.length < 2) {
      for (; ++s < a; ) if ((n2 = (t9 = o2[s]).type) && (n2 = pg(r[n2], t9.name))) return n2;
      return;
    }
    if (e != null && typeof e != "function") throw new Error("invalid callback: " + e);
    for (; ++s < a; ) if (n2 = (t9 = o2[s]).type) r[n2] = Vc(r[n2], t9.name, e);
    else if (e == null) for (n2 in r) r[n2] = Vc(r[n2], t9.name, null);
    return this;
  }, "on"),
  copy: m$1(function() {
    var t9 = {}, e = this._;
    for (var r in e) t9[r] = e[r].slice();
    return new ko(t9);
  }, "copy"),
  call: m$1(function(t9, e) {
...
function Vc(t9, e, r) {
  for (var o2 = 0, n2 = t9.length; o2 < n2; ++o2) if (t9[o2].name === e) {
    t9[o2] = dg, t9 = t9.slice(0, o2).concat(t9.slice(o2 + 1));
    break;
  }
...
function ea(t9) {
  if (!kr) {
    ...
    var e = t9 - je;
    e > 24 ? (t9 < 1 / 0 && (ni = setTimeout(jc, t9 - ai.now() - wo)), oi && (oi = clearInterval(oi))) : (oi || (vo = ai.now(), oi = setInterval(xg, Zc)), kr = 1, Kc(jc));
  }
}
m$1(ea, "sleep");
function ci(t9, e, r) {
...
m$1(ci, "default");
var Cg = ta("start", "end", "cancel", "interrupt"), _g = [], eu = 0, Jc = 1, Mo = 2, Fo = 3, tu = 4, Lo = 5, ui = 6;
...
function bg(t9, e, r) {
  ...
  function a(h) {
    ...
    if (ci(function() {
      ...
      for (r.state = Fo, n2 = new Array(f = r.tween.length), u = 0, p = -1; u < f; ++u) (g = r.tween[u].value.call(t9, t9.__data__, r.index, r.group)) && (n2[++p] = g);
      n2.length = p + 1;
    }
  }
  m$1(a, "start");
...
function Tg(t9, e) {
  var r, o2;
  return function() {
    var n2 = wt(this, t9), s = n2.tween;
    if (s !== r) {
      o2 = r = s;
      for (var a = 0, l = o2.length; a < l; ++a) if (o2[a].name === e) {
        o2 = o2.slice(), o2.splice(a, 1);
        break;
      }
    }
    n2.tween = o2;
...
function ia(t9, e) {
  ...
  if (t9 += "", arguments.length < 2) {
    for (var o2 = dt(this.node(), r).tween, n2 = 0, s = o2.length, a; n2 < s; ++n2) if ((a = o2[n2]).name === t9) return a.value;
    return null;
  }
  return this.each((e == null ? Tg : kg)(r, t9, e));
}
m$1(ia, "default");
function Sr(t9, e, r) {
  var o2 = t9._id;
  return t9.each(function() {
    var n2 = wt(this, o2);
    (n2.value || (n2.value = {}))[e] = r.apply(this, arguments);
  }), function(n2) {
...
function mi(t9, e) {
  var r;
  return (typeof e == "number" ? gt : e instanceof Yt ? Ne : (r = Yt(e)) ? (e = r, Ne) : ur)(t9, e);
}
m$1(mi, "default");
function Sg(t9) {
  return function() {
...
function wg(t9, e, r) {
  var o2, n2 = r + "", s;
  return function() {
    var a = this.getAttribute(t9);
    return a === n2 ? null : a === o2 ? s : s = e(o2 = a, r);
  };
}
m$1(wg, "attrConstant");
function Bg(t9, e, r) {
  var o2, n2 = r + "", s;
  return function() {
    var a = this.getAttributeNS(t9.space, t9.local);
    return a === n2 ? null : a === o2 ? s : s = e(o2 = a, r);
  };
}
...
function Fg(t9, e, r) {
  ...
  return function() {
    var a, l = r(this), c;
    return l == null ? void this.removeAttribute(t9) : (a = this.getAttribute(t9), c = l + "", a === c ? null : a === o2 && c === n2 ? s : (n2 = c, s = e(o2 = a, l)));
  };
}
m$1(Fg, "attrFunction");
function Mg(t9, e, r) {
  ...
  return function() {
    var a, l = r(this), c;
    return l == null ? void this.removeAttributeNS(t9.space, t9.local) : (a = this.getAttributeNS(t9.space, t9.local), c = l + "", a === c ? null : a === o2 && c === n2 ? s : (n2 = c, s = e(o2 = a, l)));
  };
}
m$1(Mg, "attrFunctionNS");
function oa(t9, e) {
  var r = Qt(t9), o2 = r === "transform" ? _s : mi;
  return this.attrTween(t9, typeof e == "function" ? (r.local ? Mg : Fg)(r, o2, Sr(this, "attr." + t9, e)) : e == null ? (r.local ? vg : Sg)(r) : (r.local ? Bg : wg)(r, o2, e));
}
m$1(oa, "default");
function Lg(t9, e) {
  return function(r) {
    this.setAttribute(t9, e.call(this, r));
  };
}
m$1(Lg, "attrInterpolate");
function Ag(t9, e) {
  return function(r) {
    this.setAttributeNS(t9.space, t9.local, e.call(this, r));
  };
}
...
function na(t9, e) {
  ...
  var o2 = Qt(t9);
  return this.tween(r, (o2.local ? Eg : Og)(o2, e));
}
m$1(na, "default");
function Dg(t9, e) {
  return function() {
...
function sa(t9) {
  var e = this._id;
  return arguments.length ? this.each((typeof t9 == "function" ? Dg : Ig)(e, t9)) : dt(this.node(), e).delay;
}
m$1(sa, "default");
function zg(t9, e) {
  return function() {
...
function aa(t9) {
  var e = this._id;
  return arguments.length ? this.each((typeof t9 == "function" ? zg : Rg)(e, t9)) : dt(this.node(), e).duration;
}
m$1(aa, "default");
function Ng(t9, e) {
  if (typeof e != "function") throw new Error();
...
function la(t9) {
  var e = this._id;
  return arguments.length ? this.each(Ng(e, t9)) : dt(this.node(), e).ease;
}
m$1(la, "default");
function qg(t9, e) {
  return function() {
...
function ha(t9) {
  ...
  return this.each(qg(this._id, t9));
}
m$1(ha, "default");
function ca(t9) {
  typeof t9 != "function" && (t9 = nr(t9));
...
function ua(t9) {
  ...
  for (var e = this._groups, r = t9._groups, o2 = e.length, n2 = r.length, s = Math.min(o2, n2), a = new Array(o2), l = 0; l < s; ++l) for (var c = e[l], h = r[l], u = c.length, p = a[l] = new Array(u), f, g = 0; g < u; ++g) (f = c[g] || h[g]) && (p[g] = f);
  for (; l < o2; ++l) a[l] = e[l];
...
function Wg(t9, e, r) {
  ...
  return function() {
    var a = s(this, t9), l = a.on;
    l !== o2 && (n2 = (o2 = l).copy()).on(e, r), a.on = n2;
  };
}
m$1(Wg, "onFunction");
function fa(t9, e) {
  var r = this._id;
  return arguments.length < 2 ? dt(this.node(), r).on.on(t9) : this.each(Wg(r, t9, e));
}
m$1(fa, "default");
function $g(t9) {
  return function() {
...
function da() {
  return this.on("end.remove", $g(this._id));
}
m$1(da, "default");
function ma(t9) {
  var e = this._name, r = this._id;
  typeof t9 != "function" && (t9 = Ce(t9));
  for (var o2 = this._groups, n2 = o2.length, s = new Array(n2), a = 0; a < n2; ++a) for (var l = o2[a], c = l.length, h = s[a] = new Array(c), u, p, f = 0; f < c; ++f) (u = l[f]) && (p = t9.call(u, u.__data__, f, l)) && ("__data__" in u && (p.__data__ = u.__data__), h[f] = p, de(h[f], e, r, f, h, dt(u, r)));
  return new Dt(s, this._parents, e, r);
}
m$1(ma, "default");
function pa(t9) {
  var e = this._name, r = this._id;
  typeof t9 != "function" && (t9 = or(t9));
  for (var o2 = this._groups, n2 = o2.length, s = [], a = [], l = 0; l < n2; ++l) for (var c = o2[l], h = c.length, u, p = 0; p < h; ++p) if (u = c[p]) {
    for (var f = t9.call(u, u.__data__, p, c), g, T = dt(u, r), A = 0, W = f.length; A < W; ++A) (g = f[A]) && de(g, e, r, A, f, T);
    s.push(f), a.push(u);
  }
...
function Ug(t9, e) {
  var r, o2, n2;
  return function() {
    var s = _e(this, t9), a = (this.style.removeProperty(t9), _e(this, t9));
    return s === a ? null : s === r && a === o2 ? n2 : n2 = e(r = s, o2 = a);
  };
}
m$1(Ug, "styleNull");
function ru(t9) {
...
function Gg(t9, e, r) {
  var o2, n2, s;
  return function() {
    var a = _e(this, t9), l = r(this), c = l + "";
    return l == null && (c = l = (this.style.removeProperty(t9), _e(this, t9))), a === c ? null : a === o2 && c === n2 ? s : (n2 = c, s = e(o2 = a, l));
  };
}
...
function Vg(t9, e) {
  ...
  return function() {
    var c = wt(this, t9), h = c.on, u = c.value[s] == null ? l || (l = ru(e)) : void 0;
    (h !== r || n2 !== u) && (o2 = (r = h).copy()).on(a, n2 = u), c.on = o2;
  };
}
m$1(Vg, "styleMaybeRemove");
function xa(t9, e, r) {
  var o2 = (t9 += "") == "transform" ? Cs : mi;
  return e == null ? this.styleTween(t9, Ug(t9, o2)).on("end.style." + t9, ru(t9)) : typeof e == "function" ? this.styleTween(t9, Gg(t9, o2, Sr(this, "style." + t9, e))).each(Vg(this._id, t9)) : this.styleTween(t9, Yg(t9, o2, e), r).on("end.style." + t9, null);
}
m$1(xa, "default");
function Xg(t9, e, r) {
  return function(o2) {
    this.style.setProperty(t9, e.call(this, o2), r);
  };
}
...
function ya(t9, e, r) {
  ...
  if (typeof e != "function") throw new Error();
  return this.tween(o2, jg(t9, e, r ?? ""));
}
m$1(ya, "default");
function Zg(t9) {
  return function() {
...
m$1(Kg, "textFunction");
function Ca(t9) {
  return this.tween("text", typeof t9 == "function" ? Kg(Sr(this, "text", t9)) : Zg(t9 == null ? "" : t9 + ""));
}
m$1(Ca, "default");
function Qg(t9) {
  return function(e) {
...
function Jg(t9) {
  var e, r;
  function o2() {
    var n2 = t9.apply(this, arguments);
...
function _a(t9) {
  ...
  if (typeof t9 != "function") throw new Error();
  return this.tween(e, Jg(t9));
}
m$1(_a, "default");
function ba() {
  for (var t9 = this._name, e = this._id, r = Ao(), o2 = this._groups, n2 = o2.length, s = 0; s < n2; ++s) for (var a = o2[s], l = a.length, c, h = 0; h < l; ++h) if (c = a[h]) {
    var u = dt(c, e);
    de(c, t9, r, h, a, {
...
m$1(ba, "default");
function Ta() {
  var t9, e, r = this, o2 = r._id, n2 = r.size();
  return new Promise(function(s, a) {
    ...
    r.each(function() {
      var h = wt(this, o2), u = h.on;
      u !== t9 && (e = (t9 = u).copy(), e._.cancel.push(l), e._.interrupt.push(l), e._.end.push(c)), h.on = e;
    }), n2 === 0 && s();
  });
}
m$1(Ta, "default");
...
function ka(t9) {
  var e, r;
  t9 instanceof Dt ? (e = t9._id, t9 = t9._name) : (e = Ao(), (r = ex).time = hi(), t9 = t9 == null ? null : t9 + "");
