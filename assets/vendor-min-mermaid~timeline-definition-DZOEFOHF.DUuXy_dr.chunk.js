import { m as mr, d as dr, e as U, f as c, g, a0 as je, N as No } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
import { p as pt$1, i as ia, I as ks } from './vendor-min-mermaid~chunk-63GW7ZVL.CUmzAGpZ.chunk.js';
...
var z = "", dt = 0, Y = [], G = [], F = [], pt = /*#__PURE__*/ m$1(()=>je, "getCommonDb"), yt = /*#__PURE__*/ m$1(function() {
...
var $t = 12, q = /*#__PURE__*/ m$1(function(n, t) {
    ...
    _t++, r.append("line").attr("id", "task" + _t).attr("x1", o).attr("y1", t.y).attr("x2", o).attr("y2", 450).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Ht(r, {
        cx: o,
        cy: 300 + (5 - t.score) * 30,
        score: t.score
    });
...
function St(n, t) {
    n.each(function() {
        var e = /*#__PURE__*/ ia(this), o = /*#__PURE__*/ e.text().split(/(\s+|<br>)/).reverse(), r, u = [], h = 1.1, f = /*#__PURE__*/ e.attr("y"), g = /*#__PURE__*/ parseFloat(/*#__PURE__*/ e.attr("dy")), p = /*#__PURE__*/ e.text(null).append("tspan").attr("x", 0).attr("y", f).attr("dy", g + "em");
...
var jt = /*#__PURE__*/ m$1(function(n, t, e, o) {
    ...
    pt$1.debug("task", b), A.initGraphics(p);
    let m = /*#__PURE__*/ o.db.getSections();
    pt$1.debug("sections", m);
    ...
    m.forEach(function(L) {
        ...
        pt$1.debug("sectionHeight before draw", x), i = /*#__PURE__*/ Math.max(i, x + 20);
    });
    let N = 0, C = 0;
    pt$1.debug("tasks.length", b.length);
    for (let [L, v] of b.entries()){
        ...
        pt$1.debug("taskHeight before draw", T), a = /*#__PURE__*/ Math.max(a, T + 20), N = /*#__PURE__*/ Math.max(N, v.events.length);
        let $ = 0;
    ...
    pt$1.debug("maxSectionHeight before draw", i), pt$1.debug("maxTaskHeight before draw", a), m && m.length > 0 ? m.forEach((L)=>{
        ...
        pt$1.debug("sectionNode", x);
        let T = /*#__PURE__*/ p.append("g"), $ = /*#__PURE__*/ A.drawNode(T, x, E, r);
        pt$1.debug("sectionNode output", $), T.attr("transform", `translate(${y}, ${d})`), l += i + 50, v.length > 0 && Et(p, v, E, y, l, a, r, N, C, i, false), y += 200 * Math.max(v.length, 1), l = d, E++;
    }) : (k = false, Et(p, b, E, y, l, a, r, N, C, i, true));
    let V = /*#__PURE__*/ p.node().getBBox();
    pt$1.debug("bounds", V), _ && p.append("text").text(_).attr("x", V.width / 2 - u).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), c = k ? i + a + 150 : a + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", u).attr("y1", c).attr("x2", V.width + 3 * u).attr("y2", c).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), dr(void 0, p, r.timeline?.padding ?? 50, r.timeline?.useMaxWidth ?? false);
    ...
    for (let _ of t){
        ...
        pt$1.debug("taskNode", m);
        let i = /*#__PURE__*/ n.append("g").attr("class", "taskWrapper"), c = A.drawNode(i, m, e, h).height;
        if (pt$1.debug("taskHeight after draw", c), i.attr("transform", `translate(${o}, ${r})`), u = /*#__PURE__*/ Math.max(u, c), _.events) {
