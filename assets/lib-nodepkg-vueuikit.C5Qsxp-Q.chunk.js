...
let e;
import { d as t, j as r, k as n, c as a, o, l as i, m as s, n as l, f as c, p as u, b as d, u as f, q as h, r as p, t as m, T as g, s as v, v as b, w as y, e as x, F as w } from "./lib-nodepkg-vuekit.DlrPz-PK.chunk.js";
import { c as k, b as M } from "./lib-nodepkg-typedef.BGrUPue-.chunk.js";
import { u as C, g as P, i as _, l as S, s as O, f as D, c as $, p as R, v as T, e as A, o as I, m as L, w as B, k as F, r as j, a as V, x as E, y as H, z } from "./vendor-innoai-tech-lodash.DaXqQgFo.chunk.js";
import { _ as W } from "./vendor-rxjs.D2F2rdN9.chunk.js";
...
function es(e10) {
  var { from: t10 = 0, to: r10 = 1, restSpeed: n6 = 2, restDelta: a2 } = e10, o2 = W(e10, ["from", "to", "restSpeed", "restDelta"]);
  let i2 = { done: false, value: t10 }, { stiffness: s2, damping: l2, mass: c2, velocity: u2, duration: d2, isResolvedFromDuration: f2 } = function(e11) {
    ...
    if (!ei(e11, eo) && ei(e11, ea)) {
      let r11 = function(e12) {
        ...
        s3 = er(0.05, 1, s3), n7 = er(0.01, 10, n7 / 1e3), s3 < 1 ? (t12 = (e13) => {
          let t13 = e13 * s3, r13 = t13 * n7;
          return 1e-3 - (t13 - o3) / en(e13, s3) * Math.exp(-r13);
        }, r12 = (e13) => {
          let r13 = e13 * s3 * n7, a4 = Math.pow(s3, 2) * Math.pow(e13, 2) * n7, i4 = Math.exp(-r13), l4 = en(Math.pow(e13, 2), s3);
  ...
  function m2() {
    ...
    } else if (1 === o3) h2 = (t11) => r10 - Math.exp(-i3 * t11) * (n7 + (e11 + i3 * n7) * t11);
    else {
  ...
  return m2(), { next: (e11) => {
    ...
    if (f2) i2.done = e11 >= d2;
      ...
      let o3 = Math.abs(1e3 * p2(e11)) <= n6, s3 = Math.abs(r10 - t11) <= a2;
      i2.done = o3 && s3;
    }
...
let ex = (e10, t10) => (r10) => !!(eg(r10) && em.test(r10) && r10.startsWith(e10) || t10 && Object.prototype.hasOwnProperty.call(r10, t10)), ew = (e10, t10, r10) => (n6) => {
  if (!eg(n6)) return n6;
  let [a2, o2, i2, s2] = n6.match(eh);
  ...
  return "hsla(" + Math.round(t10) + ", " + ey.transform(ef(r10)) + ", " + ey.transform(ef(n6)) + ", " + ef(eb.transform(a2)) + ")";
  ...
  return "rgba(" + eC.transform(t10) + ", " + eC.transform(r10) + ", " + eC.transform(n6) + ", " + ef(eb.transform(a2)) + ")";
...
function e$(e10) {
  ...
  let t10 = [], r10 = 0, n6 = e10.match(ep);
  n6 && (r10 = n6.length, e10 = e10.replace(ep, eO), t10.push(...n6.map(eS.parse)));
  let a2 = e10.match(eh);
  return a2 && (e10 = e10.replace(eh, eD), t10.push(...a2.map(ev.parse))), { values: t10, numColors: r10, tokenised: e10 };
}
let eR = function(e10) {
  let { values: t10, numColors: r10, tokenised: n6 } = e$(e10), a2 = t10.length;
  return (e11) => {
    let t11 = n6;
    for (let n7 = 0; n7 < a2; n7++) t11 = t11.replace(n7 < r10 ? eO : eD, n7 < r10 ? eS.transform(e11[n7]) : ef(e11[n7]));
    return t11;
  };
};
...
let eI = (e10, t10, r10) => {
  ...
  let r10 = eB(e10), n6 = eB(t10), a2 = r10.parse(e10), o2 = n6.parse(t10);
  r10 === ek && (a2 = eA(a2), r10 = eP), n6 === ek && (o2 = eA(o2), n6 = eP);
...
let ez = (e10, t10) => {
  let r10 = [...e10], n6 = r10.length, a2 = e10.map((e11, r11) => eH(e11, t10[r11]));
  return (e11) => {
  ...
  for (let a2 in r10) void 0 !== e10[a2] && void 0 !== t10[a2] && (n6[a2] = eH(e10[a2], t10[a2]));
  return (e11) => {
...
function eN(e10) {
  let t10 = e$(e10).values, r10 = t10.length, n6 = 0, a2 = 0, o2 = 0;
  for (let e11 = 0; e11 < r10; e11++) n6 || "number" == typeof t10[e11] ? n6++ : void 0 !== t10[e11].hue ? o2++ : a2++;
  return { parsed: t10, numNumbers: n6, numRGB: a2, numHSL: o2 };
}
let eq = (e10, t10) => {
  let r10 = eR(t10), n6 = eN(e10), a2 = eN(t10);
  return n6.numHSL === a2.numHSL && n6.numRGB === a2.numRGB && n6.numNumbers >= a2.numNumbers ? eE(ez(n6.parsed, a2.parsed), r10) : (r11) => `${r11 > 0 ? t10 : e10}`;
...
function eG(e10, t10) {
  ...
  et(o2 === t10.length), et(!n6 || !Array.isArray(n6) || n6.length === o2 - 1), e10[0] > e10[o2 - 1] && (e10 = [].concat(e10), t10 = [].concat(t10), e10.reverse(), t10.reverse());
  let i2 = function(e11, t11, r11) {
    var n7;
    let a3 = [], o3 = r11 || ("number" == typeof (n7 = e11[0]) ? eU : "string" == typeof n7 ? eS.test(n7) ? eF : eq : Array.isArray(n7) ? ez : "object" == typeof n7 ? eW : void 0), i3 = e11.length - 1;
    for (let r12 = 0; r12 < i3; r12++) {
      let n9 = o3(e11[r12], e11[r12 + 1]);
      t11 && (n9 = eE(Array.isArray(t11) ? t11[r12] : t11, n9)), a3.push(n9);
    }
    return a3;
  }(t10, n6, a2), s2 = 2 === o2 ? function(e11, t11) {
    let [r11, n7] = e11, [a3] = t11;
    return (e12) => a3(ec(r11, n7, e12));
...
function eK(e10) {
  ...
  function c2() {
    return eG(l2, s2, { ease: Array.isArray(n6) ? n6 : s2.map(() => n6 || eX).splice(0, s2.length - 1) });
  }
  let u2 = c2();
...
let eJ = { keyframes: eK, spring: es, decay: function(e10) {
  ...
  return e10[t10] = function(e11) {
    ...
    return e2 || tt(), r10.schedule(e11, t11, n6);
  }, e10;
...
function ta(e10) {
  ...
  (null === (a2 = M2.needsInterpolation) || void 0 === a2 ? void 0 : a2.call(M2, o2, b2)) && (n6 = eG([0, 100], [o2, b2], { clamp: false }), o2 = 0, b2 = 100);
    ...
    if (null == g2 || g2(r10), w2) {
      if (0 === y2 && (null != x2 || (x2 = l2)), y2 < c2) {
        ...
        a3 = l2, o3 = x2, (k2 ? a3 >= o3 + d2 : a3 <= -d2) && (y2++, "reverse" === u2 ? l2 = function(e12, t11) {
          ...
          return n7 ? tr(t11 + -e12, t11, r11) : t11 - (e12 - t11) + r11;
  ...
  switch (typeof r10) {
    ...
    case "object":
      ...
      if (void 0 !== r10.styles) {
        var n6 = r10.next;
        if (void 0 !== n6) for (; void 0 !== n6; ) Q = { name: n6.name, styles: n6.styles, next: Q }, n6 = n6.next;
        return r10.styles + ";";
      }
      return function(e11, t11, r11) {
        var n7 = "";
        if (Array.isArray(r11)) for (var a3 = 0; a3 < r11.length; a3++) n7 += tv(e11, t11, r11[a3]) + ";";
        else for (var o3 in r11) {
          var i3 = r11[o3];
          if ("object" != typeof i3) null != t11 && void 0 !== t11[i3] ? n7 += o3 + "{" + t11[i3] + "}" : tp(i3) && (n7 += tm(o3) + ":" + tg(o3, i3) + ";");
          else if (Array.isArray(i3) && "string" == typeof i3[0] && (null == t11 || void 0 === t11[i3[0]])) for (var s2 = 0; s2 < i3.length; s2++) tp(i3[s2]) && (n7 += tm(o3) + ":" + tg(o3, i3[s2]) + ";");
          else {
...
let tx = ty(), tw = { paddingX: [tx.paddingLeft, tx.paddingRight], paddingY: [tx.paddingTop, tx.paddingBottom], marginX: [tx.marginInlineStart, tx.marginInlineEnd], marginY: [tx.marginTop, tx.marginBottom], borderX: [tx.borderLeft, tx.borderRight], borderY: [tx.borderTop, tx.borderBottom], color: [tx.color, tx.fill], borderTopRadius: [tx.borderTopLeftRadius, tx.borderTopRightRadius], borderBottomRadius: [tx.borderBottomLeftRadius, tx.borderBottomRightRadius], borderRightRadius: [tx.borderTopRightRadius, tx.borderBottomRightRadius], borderLeftRadius: [tx.borderTopLeftRadius, tx.borderBottomLeftRadius], backgroundGradient: [tx.backgroundImage], boxSize: [tx.width, tx.height] }, tk = ty(), tM = { font: tk.fontFamily, shadow: tk.boxShadow, rounded: tk.borderRadius, roundedTop: tk.borderTopRadius, roundedBottom: tk.borderBottomRadius, roundedLeft: tk.borderLeftRadius, roundedRight: tk.borderRightRadius, bg: tk.background, bgImage: tk.backgroundImage, bgSize: tk.backgroundSize, bgPosition: tk.backgroundPosition, bgRepeat: tk.backgroundRepeat, bgAttachment: tk.backgroundAttachment, bgColor: tk.backgroundColor, bgGradient: tk.backgroundGradient, bgClip: tk.backgroundClip, pos: tk.position, p: tk.padding, pt: tk.paddingTop, pr: tk.paddingRight, pl: tk.paddingLeft, pb: tk.paddingBottom, ps: tk.paddingInlineStart, pe: tk.paddingInlineEnd, px: tk.paddingX, py: tk.paddingY, m: tk.margin, mt: tk.marginTop, mr: tk.marginRight, ml: tk.marginLeft, mb: tk.marginBottom, ms: tk.marginInlineStart, me: tk.marginInlineEnd, mx: tk.marginX, my: tk.marginY, w: tk.width, minW: tk.minWidth, maxW: tk.maxWidth, h: tk.height, minH: tk.minHeight, maxH: tk.maxHeight }, tC = ty(), tP = function() {
  for (var e10 = arguments.length, t10 = Array(e10), r10 = 0; r10 < e10; r10++) t10[r10] = arguments[r10];
  let n6 = [...t10];
  for (let e11 of t10) tM[e11] && n6.push(tM[e11]);
  return n6;
...
const _tS = class _tS {
  ...
  processAll(e10) {
    ...
    if (n6) {
      let e11 = {}, t11 = {};
      _tS.walkStateValues(n6, (r11, n7, a3) => {
        var o3;
        let i2 = `--${this.opt.varPrefix}-state-${n7.join("-")}`, s2 = null !== (o3 = S(n7)) && void 0 !== o3 ? o3 : "", l2 = {};
...
__publicField(_tS, "convertSelector", (e10) => {
  ...
  if (t10.startsWith("$") || t10.endsWith("$") || t10.startsWith("_")) {
    ...
    if (t10.startsWith("_") ? (e11 = "&", t10 = t10.slice(1)) : t10.startsWith("$") ? (e11 = "& ", t10 = t10.slice(1)) : (r10 = " &", t10 = t10.slice(0, t10.length - 1)), t10.startsWith("data") || t10.startsWith("aria")) {
      ...
      return a2 ? `${e11}[${C(n6)}='${C(a2)}']${r10}` : `${e11}[${C(n6)}]${r10}`;
    }
    if ("&" === e11) {
      ...
      let [r11, n6] = t10.split("__"), a2 = C(r11);
      return n6 ? `${e11}[data-${a2}='${C(n6)}']` : `${e11}[data-${a2}]:not([data-${a2}='false'])`;
    }
  }
});
__publicField(_tS, "walkStateValues", function(e10, t10) {
  ...
  for (let e11 in a2) {
    var o2;
    let i2 = a2[e11], s2 = null !== (o2 = a2.default) && void 0 !== o2 ? o2 : r10.default, l2 = null != n6 ? n6 : P(s2, [...r10.path.slice(1), "$"]), c2 = l2 ? [...r10.selectorPath, l2] : r10.selectorPath, u2 = [...r10.path, e11];
    if (_(i2)) {
...
const _tR = class _tR {
  constructor(e10, { cssVar: t10, transformFallback: r10 }) {
    ...
    _tR.walkValues(e10.value, (n6, a2) => {
      ...
      if (O(this._cssVarRefs, [o2], t10(o2)), _(n6)) for (let e11 in n6) i2(n6[e11], (t11, r11) => {
...
const _tV = class _tV {
  constructor(e10, t10 = {}) {
    ...
    var r10, n6;
    for (let a2 in this.theme = e10, this.varPrefix = null !== (r10 = t10.varPrefix) && void 0 !== r10 ? r10 : "vk", this.mode = null !== (n6 = t10.mode) && void 0 !== n6 ? n6 : "light", O(this.cssVars, [this.cssVar("space", "dp")], "0.1rem"), e10) {
      let t11 = e10[a2];
      if (t11) {
        if (t11.type === tO.var) {
          ...
          for (let t12 of e11.tokens) for (let r11 of ["light", "dark"]) {
            ...
            V(o2) || ("_default" === n7 ? O(this.cssVars, [this.cssVar(a2, t12)], o2) : O(this.cssVars, [n7, this.cssVar(a2, t12)], o2));
          }
          continue;
        }
  ...
  unstable_css(e10, t10) {
    ...
    return n6.__emotion_styles = null !== (r10 = n6.__emotion_styles) && void 0 !== r10 ? r10 : function(e11, t11, r11) {
      ...
      tb.lastIndex = 0;
      for (var l2 = ""; null !== (n7 = tb.exec(o2)); ) l2 += "-" + n7[1];
  ...
  toFigmaTokens() {
    let e10 = { space: { dp: { $type: "sizing", $value: 1 } } }, t10 = {}, r10 = {}, n6 = (e11, t11) => A(t11) ? { $type: e11, $value: L(t11, (t12) => n6(e11, t12).$value) } : $(t11) ? { $type: e11, $value: t11.replace(/var\(([^)]+)\)/g, (e12) => {
      var t12, r11;
      ...
      let o2 = this.tokens[a2], i2 = (i3) => {
        for (let s2 of o2.tokens) if (!s2.includes("/")) {
          if (s2.startsWith("sys.")) {
            ...
            t$(t10, [a2, ...s2.split(".")], n6(i3, e11)), e11 !== l2 && t$(r10, [a2, ...s2.split(".")], n6(i3, l2));
          } else t$(e10, [a2, ...s2.split(".")], n6(i3, o2.get(s2, "_default")));
        }
      };
      switch (a2) {
        case "color":
...
class t6 {
  ...
  static hueOf(e10) {
    let t10 = tG(e10, t6.SCALED_DISCOUNT_FROM_LINRGB), r10 = t6.chromaticAdaptation(t10[0]), n6 = t6.chromaticAdaptation(t10[1]), a2 = t6.chromaticAdaptation(t10[2]);
  ...
  static setCoordinate(e10, t10, r10, n6) {
    let a2 = t6.intercept(e10[n6], t10, r10[n6]);
  ...
  static nthVertex(e10, t10) {
    let r10 = t6.Y_FROM_LINRGB[0], n6 = t6.Y_FROM_LINRGB[1], a2 = t6.Y_FROM_LINRGB[2], o2 = t10 % 4 <= 1 ? 0 : 100, i2 = t10 % 2 == 0 ? 0 : 100;
    if (t10 < 4) {
  ...
  static bisectToSegment(e10, t10) {
    ...
    for (let l2 = 0; l2 < 12; l2++) {
      ...
      (s2 || t6.areInCyclicOrder(a2, u2, o2)) && (s2 = false, t6.areInCyclicOrder(a2, t10, u2) ? (n6 = c2, o2 = u2) : (r10 = c2, a2 = u2));
    }
    return [r10, n6];
  }
  ...
  static bisectToLimit(e10, t10) {
    let r10 = t6.bisectToSegment(e10, t10), n6 = r10[0], a2 = t6.hueOf(n6), o2 = r10[1];
    for (let e11 = 0; e11 < 3; e11++) if (n6[e11] !== o2[e11]) {
      let r11 = -1, i2 = 255;
      n6[e11] < o2[e11] ? (r11 = t6.criticalPlaneBelow(t6.trueDelinearized(n6[e11])), i2 = t6.criticalPlaneAbove(t6.trueDelinearized(o2[e11]))) : (r11 = t6.criticalPlaneAbove(t6.trueDelinearized(n6[e11])), i2 = t6.criticalPlaneBelow(t6.trueDelinearized(o2[e11])));
      for (let s2 = 0; s2 < 8 && !(1 >= Math.abs(i2 - r11)); s2++) {
        let s3 = Math.floor((r11 + i2) / 2), l2 = t6.CRITICAL_PLANES[s3], c2 = t6.setCoordinate(n6, l2, o2, e11), u2 = t6.hueOf(c2);
        t6.areInCyclicOrder(a2, t10, u2) ? (o2 = c2, i2 = s3) : (n6 = c2, a2 = u2, r11 = s3);
      }
    }
    return t6.midpoint(n6, o2);
  }
  ...
  static findResultByJ(e10, t10, r10) {
    let n6 = 11 * Math.sqrt(r10), a2 = t3.DEFAULT, o2 = 1 / Math.pow(1.64 - Math.pow(0.29, a2.n), 0.73), i2 = 5e4 / 13 * (0.25 * (Math.cos(e10 + 2) + 3.8)) * a2.nc * a2.ncb, s2 = Math.sin(e10), l2 = Math.cos(e10);
  ...
  static solveToInt(e10, t10, r10) {
    ...
    (n6 = e10 % 360) < 0 && (n6 += 360);
    let a2 = (e10 = n6) / 180 * Math.PI, o2 = t0(r10), i2 = t6.findResultByJ(a2, t10, o2);
...
class t7 {
  ...
  static lighter(e10, t10) {
    ...
    let r10 = t0(e10), n6 = t10 * (r10 + 5) - 5, a2 = t7.ratioOfYs(n6, r10), o2 = Math.abs(a2 - t10);
  ...
  static darker(e10, t10) {
    if (e10 < 0 || e10 > 100) return -1;
    let r10 = t0(e10), n6 = (r10 + 5) / t10 - 5, a2 = t7.ratioOfYs(r10, n6), o2 = Math.abs(a2 - t10);
    if (a2 < t10 && o2 > 0.04) return -1;
    let i2 = t1(n6) - 0.4;
    return i2 < 0 || i2 > 100 ? -1 : i2;
  }
...
class rt {
  ...
  constructor(e10, t10, r10, n6, a2, o2, i2, s2) {
    if (this.name = e10, this.palette = t10, this.tone = r10, this.isBackground = n6, this.background = a2, this.secondBackground = o2, this.contrastCurve = i2, this.toneDeltaPair = s2, this.hctCache = /* @__PURE__ */ new Map(), !a2 && o2) throw Error(`Color ${e10} has secondBackgrounddefined, but background is not defined.`);
  ...
  getTone(e10) {
    ...
    }
    {
      ...
      if (t7.ratioOfTones(n6, r10) >= a2 || (r10 = rt.foregroundTone(n6, a2)), t10 && (r10 = rt.foregroundTone(n6, a2)), this.isBackground && 50 <= r10 && r10 < 60 && (r10 = t7.ratioOfTones(49, n6) >= a2 ? 49 : 60), this.secondBackground) {
  ...
  static foregroundTone(e10, t10) {
    let r10 = t7.lighterUnsafe(e10, t10), n6 = t7.darkerUnsafe(e10, t10), a2 = t7.ratioOfTones(r10, e10), o2 = t7.ratioOfTones(n6, e10);
    if (!rt.tonePrefersLightForeground(e10)) return o2 >= t10 || o2 >= a2 ? n6 : r10;
    {
...
class rl {
  ...
  static createKeyColor(e10, t10) {
    let r10 = t9.from(e10, t10, 50), n6 = Math.abs(r10.chroma - t10);
...
class rc {
  ...
  static createPaletteFromColors(e10, t10) {
    ...
    if (t10.secondary) {
      let n6 = new rc(t10.secondary, e10);
      r10.a2 = n6.a1;
    }
    if (t10.tertiary) {
      let n6 = new rc(t10.tertiary, e10);
      r10.a3 = n6.a1;
    }
    if (t10.error) {
      let n6 = new rc(t10.error, e10);
      r10.error = n6.a1;
    }
    if (t10.neutral) {
      let n6 = new rc(t10.neutral, e10);
      r10.n1 = n6.n1;
    }
    if (t10.neutralVariant) {
      let n6 = new rc(t10.neutralVariant, e10);
      r10.n2 = n6.n2;
    }
    return r10;
  }
  constructor(e10, t10) {
    let r10 = t9.fromInt(e10), n6 = r10.hue, a2 = r10.chroma;
    t10 ? (this.a1 = rl.fromHueAndChroma(n6, a2), this.a2 = rl.fromHueAndChroma(n6, a2 / 3), this.a3 = rl.fromHueAndChroma(n6 + 60, a2 / 2), this.n1 = rl.fromHueAndChroma(n6, Math.min(a2 / 12, 4)), this.n2 = rl.fromHueAndChroma(n6, Math.min(a2 / 6, 8))) : (this.a1 = rl.fromHueAndChroma(n6, Math.max(48, a2)), this.a2 = rl.fromHueAndChroma(n6, 16), this.a3 = rl.fromHueAndChroma(n6 + 60, 24), this.n1 = rl.fromHueAndChroma(n6, 4), this.n2 = rl.fromHueAndChroma(n6, 8)), this.error = rl.fromHueAndChroma(25, 84);
  }
}
function ru(e10) {
  ...
  let a2 = 0, o2 = 0, i2 = 0;
  return t10 ? (a2 = rd(e10.slice(0, 1).repeat(2)), o2 = rd(e10.slice(1, 2).repeat(2)), i2 = rd(e10.slice(2, 3).repeat(2))) : r10 ? (a2 = rd(e10.slice(0, 2)), o2 = rd(e10.slice(2, 4)), i2 = rd(e10.slice(4, 6))) : n6 && (a2 = rd(e10.slice(2, 4)), o2 = rd(e10.slice(4, 6)), i2 = rd(e10.slice(6, 8))), (-16777216 | (255 & a2) << 16 | (255 & o2) << 8 | 255 & i2) >>> 0;
}
function rd(e10) {
...
const _rm = class _rm {
  ...
  normalizeRoleRules() {
    let e10 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t10 = _rm.createRoleColorSourcePicker(), r10 = _rm.createRoleColorRuleBuilder().rule("shadow", t10.neutral(0)).rule("scrim", t10.neutral(0)).rule("outline", t10.neutralVariant(87)).rule("outline-variant", t10.neutralVariant(80)).rule("surface", t10.neutral(99)).rule("on-surface", t10.neutral(10)).rule("surface-variant", t10.neutralVariant(90)).rule("on-surface-variant", t10.neutralVariant(30)).rule("surface-dim", t10.neutral(87)).rule("surface-bright", t10.neutral(98)).rule("surface-container-lowest", t10.neutral(100)).rule("surface-container-low", t10.neutral(96)).rule("surface-container", t10.neutral(94)).rule("surface-container-high", t10.neutral(92)).rule("surface-container-highest", t10.neutral(90)).rule("inverse-surface", t10.neutral(20)).rule("inverse-on-surface", t10.neutral(95)).rule("inverse-primary", t10.primary(80)), n6 = _rm.createRoleColorRuleBuilder("dark").rule("shadow", t10.neutral(0)).rule("scrim", t10.neutral(0)).rule("outline", t10.neutralVariant(60)).rule("outline-variant", t10.neutralVariant(30)).rule("surface", t10.neutral(10)).rule("on-surface", t10.neutral(90)).rule("surface-variant", t10.neutralVariant(30)).rule("on-surface-variant", t10.neutralVariant(80)).rule("surface-dim", t10.neutral(6)).rule("surface-bright", t10.neutral(24)).rule("surface-container-lowest", t10.neutral(4)).rule("surface-container-low", t10.neutral(10)).rule("surface-container", t10.neutral(12)).rule("surface-container-high", t10.neutral(17)).rule("surface-container-highest", t10.neutral(22)).rule("inverse-surface", t10.neutral(90)).rule("inverse-on-surface", t10.neutral(20)).rule("inverse-primary", t10.primary(40));
  ...
  getThemeRoleColors(e10) {
    ...
    for (let [o2, [i2, s2]] of Object.entries(e10)) if (this.seeds[i2]) {
      ...
      t10[o2] = rf[s2] ? `${String(i2)}.${s2}` : null === (n6 = this.seeds[i2]) || void 0 === n6 ? void 0 : n6.tone(s2);
    }
    return [t10, r10];
  }
  toDesignTokens() {
    let e10 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t10 = this.normalizeRoleRules(e10), [r10, n6] = this.getThemeRoleColors(t10), a2 = {}, o2 = {};
    for (let e11 in r10) if (a2[`${e11}`] = { _default: E(r10[e11]) ? rh(r10[e11]) : r10[e11], _dark: E(n6[e11]) ? rh(n6[e11]) : n6[e11] }, rp(e11) && (o2[`${e11}`] = tD.mixin({ bgColor: `sys.${e11}`, color: `sys.on-${e11}` }), o2[`${e11}-container`] = tD.mixin({ bgColor: `sys.${e11}-container`, color: `sys.on-${e11}-container` })), e11.startsWith("surface")) {
...
__publicField(_rm, "fromColors", (e10) => {
  let { primary: t10, secondary: r10, tertiary: n6, neutral: a2, neutralVariant: o2, error: i2, ...s2 } = e10, l2 = rc.contentFromColors({ primary: ru(t10), secondary: r10 ? ru(r10) : void 0, tertiary: n6 ? ru(n6) : void 0, error: i2 ? ru(i2) : void 0 });
...
function rq(e10, t10, r10, n6, a2, o2, i2) {
  return { value: e10, root: t10, parent: r10, type: n6, props: a2, children: o2, line: rV, column: rE, length: i2, return: "" };
}
function rU(e10, t10) {
...
function rZ(e10, t10, r10, n6, a2, o2, i2, s2, l2, c2, u2) {
  for (var d2 = a2 - 1, f2 = 0 === a2 ? o2 : [""], h2 = f2.length, p2 = 0, m2 = 0, g2 = 0; p2 < n6; ++p2) for (var v2 = 0, b2 = rB(e10, d2 + 1, d2 = r$(m2 = i2[p2])), y2 = e10; v2 < h2; ++v2) (y2 = (m2 > 0 ? f2[v2] + " " + b2 : rA(b2, /&\f/g, f2[v2])).trim()) && (l2[g2++] = y2);
  return rq(e10, t10, r10, 0 === a2 ? rS : s2, l2, c2, u2);
}
function rQ(e10, t10, r10, n6) {
  return rq(e10, t10, r10, rO, rB(e10, 0, n6), rB(e10, n6 + 1, -1), n6);
}
function r0(e10, t10) {
  for (var r10 = "", n6 = e10.length, a2 = 0; a2 < n6; a2++) r10 += t10(e10[a2], a2, e10, t10) || "";
  return r10;
}
function r1(e10, t10, r10, n6) {
  switch (e10.type) {
    case "@layer":
    ...
    case r_:
      return "";
    case rD:
      return e10.return = e10.value + "{" + r0(e10.children, n6) + "}";
    case rS:
      e10.value = e10.props.join(",");
  }
  return rF(r10 = r0(e10.children, n6)) ? e10.return = e10.value + "{" + r10 + "}" : "";
}
var r2 = function(e10, t10, r10) {
  for (var n6 = 0, a2 = 0; n6 = a2, a2 = rY(), 38 === n6 && 12 === a2 && (t10[r10] = 1), !rX(a2); ) rG();
  return rB(rN, e10, rz);
}, r4 = function(e10, t10) {
  var r10 = -1, n6 = 44;
  do
    switch (rX(n6)) {
      case 0:
        38 === n6 && 12 === rY() && (t10[r10] = 1), e10[r10] += r2(rz - 1, t10, r10);
        break;
      case 2:
        e10[r10] += rJ(n6);
        break;
  ...
  if ("rule" === e10.type && e10.parent && !(e10.length < 1)) {
    ...
    if ((1 !== e10.props.length || 58 === t10.charCodeAt(0) || r3.get(r10)) && !n6) {
      r3.set(e10, true);
  ...
  if (e10.length > -1 && !e10.return) switch (e10.type) {
    case rO:
      ...
      break;
    case rD:
      return r0([rU(e10, { value: rA(e10.value, "@", "@" + rP) })], n6);
    case rS:
      if (e10.length) {
        var a2, o2;
        return a2 = e10.props, o2 = function(t11) {
          ...
          switch (r11 = t11, (r11 = /(::plac\w+|:read-\w+)/.exec(r11)) ? r11[0] : r11) {
            case ":read-only":
            case ":read-write":
              return r0([rU(e10, { props: [rA(t11, /:(read-\w+)/, ":" + rC + "$1")] })], n6);
            case "::placeholder":
              return r0([rU(e10, { props: [rA(t11, /:(plac\w+)/, ":" + rP + "input-$1")] }), rU(e10, { props: [rA(t11, /:(plac\w+)/, ":" + rC + "$1")] }), rU(e10, { props: [rA(t11, /:(plac\w+)/, rM + "input-$1")] })], n6);
          }
          return "";
        }, a2.map(o2).join("");
      }
  ...
  var f2 = (r10 = (t10 = [r8, r6].concat(c2, [r1, (n6 = function(e11) {
    i2.insert(e11);
  }, function(e11) {
    !e11.root && (e11 = e11.return) && n6(e11);
  })])).length, function(e11, n7, a3, o3) {
    for (var i3 = "", s3 = 0; s3 < r10; s3++) i3 += t10[s3](e11, n7, a3, o3) || "";
    return i3;
  }), h2 = function(e11) {
    var t11, r11;
    return r0((r11 = function e12(t12, r12, n7, a3, o3, i3, s3, l3, c3) {
        ...
        case 47:
          switch (rY()) {
            ...
            case 47:
              ...
              }(rG(), rz), r12, n7, r_, rR(rW), rB(u3, 2, -2), 0), c3);
              break;
            default:
              P2 += "/";
          }
        ...
        case 0:
          switch (x2) {
            ...
            case 125:
              b2 = 0;
            case 59 + f3:
              -1 == y2 && (P2 = rA(P2, /\f/g, "")), m2 > 0 && rF(P2) - h3 && rj(m2 > 32 ? rQ(P2 + ";", a3, n7, h3 - 1) : rQ(rA(P2, " ", "") + ";", a3, n7, h3 - 2), c3);
              break;
            case 59:
              P2 += ";";
            default:
              if (rj(C2 = rZ(P2, r12, n7, d3, f3, o3, l3, w2, k2 = [], M2 = [], h3), i3), 123 === x2) {
...
let nr = a(() => r7({ key: "css" }), { name: "Cache" }), nn = (e10) => (t10) => {
  ...
  var n6;
  let { slots: a2, expose: s2 } = t10, l2 = rw.use(), c2 = nr.use(), u2 = l2.unstable_css(c2, null !== (n6 = e10.sx) && void 0 !== n6 ? n6 : {}), d2 = () => "0" !== u2.name ? `${c2.key}-${u2.name}` : "", f2 = nn(c2);
  o(() => {
...
function no() {
  let e10;
  for (var n6 = arguments.length, a2 = Array(n6), i2 = 0; i2 < n6; i2++) a2[i2] = arguments[i2];
  let f2 = "div", h2 = {}, p2 = {};
  for (let t10 of a2) {
    if (j(t10)) {
      e10 = t10;
  ...
  return null != e10 || (e10 = (e11, t10) => (n7) => {
    ...
    let n7 = Object.assign(t({ ...h2, sx: k().optional(), component: k().optional() }, (t10, a3) => {
      let i3 = rw.use(), s2 = nr.use(), l2 = nn(s2), h3 = c(""), p3 = i3.unstable_css(s2, r10), m2 = () => ("0" !== p3.name ? `${s2.key}-${p3.name}${h3.value}` : `${h3.value}`) + (n7.name ? ` ${n7.name}` : "");
      if (f2.__styled) {
        var g2;
...
let ni = t({ styles: k() }, (e10) => {
  let { styles: t10 } = e10, r10 = rw.use(), n6 = nr.use(), a2 = nn(n6), o2 = r10.unstable_css(n6, $(t10) ? { "&": t10 } : t10);
  return u(() => {
...
let nd = t({ isOpen: M().optional(), style: k().optional(), contentRef: k().optional(), triggerRef: k().optional(), onClickOutside: k(), onEscKeydown: k(), onContentBeforeMount: k(), $transition: k().optional(), $default: k().optional() }, (e10, t10) => {
  var n6;
  let { slots: a2, attrs: o2, emit: i2 } = t10, s2 = e10.contentRef || c(null), l2 = new nu(null !== (n6 = e10.triggerRef) && void 0 !== n6 ? n6 : c(null), s2, () => !!e10.isOpen), u2 = nl.use();
  return h(nc.use().add(l2)), window && p(m(s2, "value"), b((e11) => {
    ...
    var t11;
    let n7 = e10.isOpen ? d(r("div", { ...o2, ref: s2, style: e10.style, children: r(nc, { value: l2, children: null === (t11 = a2.default) || void 0 === t11 ? void 0 : t11.call(a2) }) }), { onVnodeBeforeMount: () => {
...
function nI(e10, t10, r10) {
  ...
  t10 && n_(e10) && (a2 = e10.offsetWidth > 0 && nR(n6.width) / e10.offsetWidth || 1, o2 = e10.offsetHeight > 0 && nR(n6.height) / e10.offsetHeight || 1);
...
function nz(e10) {
  ...
  var R2 = Object.assign({ position: h2 }, m2 && nH), T2 = true === g2 ? (t10 = { x: y2, y: w2 }, r10 = nC(l2), n6 = t10.x, a2 = t10.y, { x: nR(n6 * (o2 = r10.devicePixelRatio || 1)) / o2 || 0, y: nR(a2 * o2) / o2 || 0 }) : { x: y2, y: w2 };
...
function nQ(e10, t10, r10) {
  ...
  return t10 === nb ? nZ(function(e11, t11) {
    var r11 = nC(e11), n7 = nB(e11), a3 = r11.visualViewport, o3 = n7.clientWidth, i3 = n7.clientHeight, s3 = 0, l3 = 0;
    if (a3) {
...
function n1(e10, t10) {
  ...
  var r10, n6, a2, o2, i2, s2, l2, c2, u2 = t10, d2 = u2.placement, f2 = void 0 === d2 ? e10.placement : d2, h2 = u2.strategy, p2 = void 0 === h2 ? e10.strategy : h2, m2 = u2.boundary, g2 = u2.rootBoundary, v2 = u2.elementContext, b2 = void 0 === v2 ? ny : v2, y2 = u2.altBoundary, x2 = u2.padding, w2 = void 0 === x2 ? 0 : x2, k2 = Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 }, "number" != typeof w2 ? w2 : ng.reduce(function(e11, t11) {
  ...
  }, {})), M2 = e10.rects.popper, C2 = e10.elements[void 0 !== y2 && y2 ? b2 === ny ? "reference" : ny : b2], P2 = (r10 = nP(C2) ? C2 : C2.contextElement || nB(e10.elements.popper), n6 = void 0 === m2 ? "clippingParents" : m2, a2 = void 0 === g2 ? nb : g2, l2 = (s2 = [].concat("clippingParents" === n6 ? (o2 = nJ(nF(r10)), nP(i2 = ["absolute", "fixed"].indexOf(nL(r10).position) >= 0 && n_(r10) ? nV(r10) : r10) ? o2.filter(function(e11) {
    ...
    return e11.top = nD(n7.top, e11.top), e11.right = n$(n7.right, e11.right), e11.bottom = n$(n7.bottom, e11.bottom), e11.left = nD(n7.left, e11.left), e11;
...
var n3 = (K = void 0 === (X = (Y = { defaultModifiers: [{ name: "eventListeners", enabled: true, phase: "write", fn: function() {
  ...
  void 0 === r10 && (r10 = Z);
  var n6, a2, o2 = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, n4, Z), modifiersData: {}, elements: { reference: e10, popper: t10 }, attributes: {}, styles: {} }, i2 = [], s2 = false, l2 = { state: o2, setOptions: function(r11) {
    ...
    var h2 = (a3 = Object.keys(n7 = [].concat(K, o2.options.modifiers).reduce(function(e11, t11) {
...
let n8 = t((e10, t10) => {
  let { slots: n6, emit: a2, attrs: o2 } = t10, i2 = c(null), s2 = c(null);
  return y(() => s2.value, (t11) => {
    if (t11 && i2.value) {
      var r10, n7;
      n3(i2.value, t11, { placement: null !== (r10 = e10.placement) && void 0 !== r10 ? r10 : "bottom", modifiers: [...null !== (n7 = e10.modifiers) && void 0 !== n7 ? n7 : [], n2] });
    }
  }), () => {
    var t11, l2;
    ...
    } }), r(nd, { triggerRef: i2, contentRef: s2, isOpen: e10.isOpen, onClickOutside: (e11) => a2("click-outside", e11), style: { zIndex: 100 }, $transition: n6.transition, children: null === (l2 = n6.content) || void 0 === l2 ? void 0 : l2.call(n6) })] }) : null;
  };
