...
import { M as Mt$1, t as tt$1, U as Ug, Y as Yg, m as mu, p as pu, H as Hg, $ as $g, f as au, g as bo, q as qg, W as Wg, P as Pg, i as zg, N as Ng, l as Rg, n as Ig, o as Og, D as Dg, r as tu, u as Qc, d as Zc, v as ml, A as Ai, w as Gx, e as jC, k as kh } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
import { k as ki, q as qs } from './vendor-min-mermaid~chunk-6BY5RJGC.Dd6vUk5z.chunk.js';
...
var ct = "\u200B", ut = {
    ...
    curveBumpY: Og,
    curveBundle: Ig,
    curveCardinalClosed: Rg,
    curveCardinalOpen: Ng,
    curveCardinal: zg,
    curveCatmullRomClosed: Pg,
    curveCatmullRomOpen: Wg,
    curveCatmullRom: qg,
    curveLinear: bo,
    curveLinearClosed: au,
    curveMonotoneX: $g,
    curveMonotoneY: Hg,
    curveNatural: pu,
    curveStep: mu,
    ...
    if (Array.isArray(r)) {
        ...
        Ai(s), n = /*#__PURE__*/ Mt$1(n, [
            ...s
        ]);
    } else n = r.args;
    if (!n) return;
    let i = /*#__PURE__*/ Gx(e, t), o = "config";
...
`, "ig");
        e = /*#__PURE__*/ e.trim().replace(r, "").replace(/'/gm, '"'), tt$1.debug(`Detecting diagram directive${t !== null ? " type:" + t : ""} based on the text:${e}`);
        let n, i = [];
        for(; (n = /*#__PURE__*/ ml.exec(e)) !== null;)if (n.index === ml.lastIndex && ml.lastIndex++, n && !t || t && n[1]?.match(t) || t && n[2]?.match(t)) {
        ...
        return tt$1.error(`ERROR: ${r.message} - Unable to parse directive type: '${t}' based on the text: '${e}'`), {
            type: void 0,
            args: null
        };
    }
...
var mt = /*#__PURE__*/ m$1((e, ...t)=>{
    ...
    for(let s = 0; s < n; s++)if (o = o[r[s]], !o) {
        tt$1.error(`Function name: ${e} not found in window`);
        return;
    }
    o[i](...t);
}, "runFunc");
...
var tt = /*#__PURE__*/ m$1((e, t = 2)=>{
    ...
    tt$1.info(`our points ${JSON.stringify(t)}`), t[0] !== r && (t = /*#__PURE__*/ t.reverse());
...
function vt(e, t, r) {
    ...
    tt$1.info("our points", n), t !== "start_left" && t !== "start_right" && n.reverse();
...
var wt = /*#__PURE__*/ m$1((e)=>Mt(e.length), "random"), Pt = /*#__PURE__*/ m$1(function() {
    ...
    let r = /*#__PURE__*/ t.text.replace(jC.lineBreakRegex, " "), [, n] = $(t.fontSize), i = /*#__PURE__*/ e.append("text");
    ...
    if (!e || (r = /*#__PURE__*/ Object.assign({
        ...
        fontFamily: "Arial",
        joinWith: "<br/>"
    }, r), jC.lineBreakRegex.test(e))) return e;
...
var S = /*#__PURE__*/ ki((e, t)=>{
    ...
    let [, o] = $(r), s = [
        "sans-serif",
        n
    ], u = /*#__PURE__*/ e.split(jC.lineBreakRegex), c = [], l = /*#__PURE__*/ kh("body");
    if (!l.remove) return {
        width: 0,
        height: 0,
        lineHeight: 0
