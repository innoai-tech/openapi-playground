import { $ as Vo, A as $o, At as $n, F as Go, G as No, I as Ho, Mn as c, Q as Uo, Rt as He, W as Ni, Wt as Pn, Yt as Ua, et as Wo, hn as pt, jn as p, k as d, ln as ia, m as Lt, pt as jo, q as Ot } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.BVgxNvHA.chunk.js";
import { Q as m$1 } from "./vendor-min-mermaid~architecture-U656AL7Q-3ZQKGQJL.BH0ewMis.chunk.js";
import { x as y } from "./vendor-min-mermaid~chunk-AI4T2ZLM.LnVbLFqH.chunk.js";
import { n as g, r as m } from "./vendor-min-mermaid~chunk-5V7UUW6L.DShEeGXl.chunk.js";
var $ = class {
	constructor() {
		this.nodes = [];
...
var we = 10, F = 10, E = 25, ge = {
	draw: /* @__PURE__ */ m$1((m$2, a, n, o) => {
		...
		k.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", E).attr("class", "treemapSectionHeader").attr("fill", "none").attr("fill-opacity", .6).attr("stroke-width", .6).attr("style", (e) => e.depth === 0 ? "display: none;" : ""), k.append("clipPath").attr("id", (e, t) => `clip-section-${a}-${t}`).append("rect").attr("width", (e) => Math.max(0, e.x1 - e.x0 - 12)).attr("height", E), k.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", (e) => e.y1 - e.y0).attr("class", (e, t) => `treemapSection section${t}`).attr("fill", (e) => A(e.data.name)).attr("fill-opacity", .6).attr("stroke", (e) => he(e.data.name)).attr("stroke-width", 2).attr("stroke-opacity", .4).attr("style", (e) => {
			...
			if (e.depth === 0) return "display: none;";
			let t = "dominant-baseline: middle; font-size: 12px; fill:" + B(e.data.name) + "; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;", s = /* @__PURE__ */ m({ cssCompiledStyles: e.data.cssCompiledStyles });
			...
			if (e.depth === 0) return "display: none;";
			let t = "text-anchor: end; dominant-baseline: middle; font-size: 10px; fill:" + B(e.data.name) + "; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;", s = /* @__PURE__ */ m({ cssCompiledStyles: e.data.cssCompiledStyles });
			return t + s.labelStyles.replace("color:", "fill:");
		});
		...
		R.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", (e) => e.y1 - e.y0).attr("class", "treemapLeaf").attr("fill", (e) => e.parent ? A(e.parent.data.name) : A(e.data.name)).attr("style", (e) => m({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles).attr("fill-opacity", .3).attr("stroke", (e) => e.parent ? A(e.parent.data.name) : A(e.data.name)).attr("stroke-width", 3), R.append("clipPath").attr("id", (e, t) => `clip-${a}-${t}`).append("rect").attr("width", (e) => Math.max(0, e.x1 - e.x0 - 4)).attr("height", (e) => Math.max(0, e.y1 - e.y0 - 4)), R.append("text").attr("class", "treemapLabel").attr("x", (e) => (e.x1 - e.x0) / 2).attr("y", (e) => (e.y1 - e.y0) / 2).attr("style", (e) => {
			let t = "text-anchor: middle; dominant-baseline: middle; font-size: 38px;fill:" + B(e.data.name) + ";", s = /* @__PURE__ */ m({ cssCompiledStyles: e.data.cssCompiledStyles });
			return t + s.labelStyles.replace("color:", "fill:");
			...
			let s = "text-anchor: middle; dominant-baseline: hanging; font-size: 28px;fill:" + B(t.data.name) + ";", f = /* @__PURE__ */ m({ cssCompiledStyles: t.data.cssCompiledStyles });
		...
		y(T, xe, "flowchart", l?.useMaxWidth || !1);
	}, "draw"),
