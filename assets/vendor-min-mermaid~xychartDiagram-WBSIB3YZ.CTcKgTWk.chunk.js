import { d as d$1 } from './vendor-min-mermaid~chunk-U7M5BGKE.CkyUFSiE.chunk.js';
import { o as os } from './vendor-min-mermaid~chunk-IXVBHSNP.BDZ5TJ6K.chunk.js';
import { L as Lt$1 } from './vendor-min-mermaid~chunk-3R3PQ5PD.DqcBTR0a.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { K as Kf, Q as Qf, b as td, J as Jf, Z as Zf, j as jf, t as tt$1, G as Gf, X as Xf, O as Or, I as Il, L as Ll, C as Ce$1, aR as us, a6 as es, c as Xc } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
...
var Q = class {
    ...
    static{
        m$1(this, "TextDimensionCalculatorWithFont");
    }
    getMaxDimension(t, e) {
        ...
        for (let l of t){
            let x = /*#__PURE__*/ os(n, 1, l), y = x ? x.width : l.length * e, A = x ? x.height : e;
...
function Jt() {
    ...
    return Lt$1(i.xyChart, t.themeVariables.xyChart);
}
m$1(Jt, "getChartDefaultThemeConfig");
function te() {
    let i = /*#__PURE__*/ Or();
    return Lt$1(Il.xyChart, i.xyChart);
}
...
function Ce() {
    ...
    return d.title = /*#__PURE__*/ td(), ut.build(tt, d, et, Zt);
}
...
var we = /*#__PURE__*/ m$1(function() {
    Xf(), J = 0, tt = /*#__PURE__*/ te(), d = /*#__PURE__*/ ee(), et = /*#__PURE__*/ Jt(), vt = /*#__PURE__*/ et.plotColorPalette.split(",").map((i)=>i.trim()), xt = false, Et = false;
}, "clear"), ne = {
    getDrawableElem: Ce,
    clear: we,
    setAccTitle: jf,
...
` + i);
    ...
    Gf(_, x.height, x.width, true), _.attr("viewBox", `0 0 ${x.width} ${x.height}`), I.attr("fill", l.backgroundColor), n.setTmpSVGG(/*#__PURE__*/ _.append("g").attr("class", "mermaid-tmp-group"));
