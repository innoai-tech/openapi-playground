import { K as Kf, Q as Qf, b as td, J as Jf, Z as Zf, j as jf, h as hh, t as tt, k as kh, G as Gf, X as Xf, I as Il, L as Ll, a6 as es, C as Ce$1 } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
...
var V = /*#__PURE__*/ Ll(), qt = class {
    ...
    getDefaultConfig() {
        return {
            ...
            showYAxis: true,
            showTitle: true,
            chartHeight: Il.quadrantChart?.chartWidth || 500,
            chartWidth: Il.quadrantChart?.chartHeight || 500,
            titlePadding: Il.quadrantChart?.titlePadding || 10,
            titleFontSize: Il.quadrantChart?.titleFontSize || 20,
            quadrantPadding: Il.quadrantChart?.quadrantPadding || 5,
            xAxisLabelPadding: Il.quadrantChart?.xAxisLabelPadding || 5,
            yAxisLabelPadding: Il.quadrantChart?.yAxisLabelPadding || 5,
            xAxisLabelFontSize: Il.quadrantChart?.xAxisLabelFontSize || 16,
            yAxisLabelFontSize: Il.quadrantChart?.yAxisLabelFontSize || 16,
            quadrantLabelFontSize: Il.quadrantChart?.quadrantLabelFontSize || 16,
            quadrantTextTopPadding: Il.quadrantChart?.quadrantTextTopPadding || 5,
            pointTextPadding: Il.quadrantChart?.pointTextPadding || 5,
            pointLabelFontSize: Il.quadrantChart?.pointLabelFontSize || 12,
            pointRadius: Il.quadrantChart?.pointRadius || 5,
            xAxisPosition: Il.quadrantChart?.xAxisPosition || "top",
            yAxisPosition: Il.quadrantChart?.yAxisPosition || "left",
            quadrantInternalBorderStrokeWidth: Il.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
            quadrantExternalBorderStrokeWidth: Il.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
        };
    }
    ...
    clear() {
        this.config = /*#__PURE__*/ this.getDefaultConfig(), this.themeConfig = /*#__PURE__*/ this.getDefaultThemeConfig(), this.data = /*#__PURE__*/ this.getDefaultData(), this.classes = new Map, tt.info("clear called");
    }
    setData(n) {
        this.data = {
            ...this.data,
    ...
    getQuadrantPoints(n) {
        let { quadrantSpace: f } = n, { quadrantHeight: u, quadrantLeft: c, quadrantTop: g, quadrantWidth: y } = f, S = /*#__PURE__*/ es().domain([
            0,
            1
        ]).range([
            c,
            y + c
        ]), i = /*#__PURE__*/ es().domain([
            0,
            1
        ]).range([
            u + g,
...
var ke = /*#__PURE__*/ hh();
function j(t) {
    return Ce$1(/*#__PURE__*/ t.trim(), ke);
}
m$1(j, "textSanitizer");
var E = new qt;
function Se(t) {
...
m$1(ze, "setHeight");
function Ve() {
    let t = /*#__PURE__*/ hh(), { themeVariables: n, quadrantChart: f } = t;
...
` + t);
    ...
    i === "sandbox" && (A = /*#__PURE__*/ kh("#i" + n));
    let T = /*#__PURE__*/ (i === "sandbox" ? kh(A.nodes()[0].contentDocument.body) : kh("body")).select(`[id="${n}"]`), m = /*#__PURE__*/ T.append("g").attr("class", "main"), b = S.quadrantChart?.chartWidth ?? 500, q = S.quadrantChart?.chartHeight ?? 500;
    Gf(T, q, b, S.quadrantChart?.useMaxWidth ?? true), T.attr("viewBox", "0 0 " + b + " " + q), u.db.setHeight(q), u.db.setWidth(b);
