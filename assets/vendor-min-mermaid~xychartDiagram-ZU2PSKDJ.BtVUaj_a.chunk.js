import { d as d$1 } from './vendor-min-mermaid~chunk-ZKOTWRZ5.C1eh_0yz.chunk.js';
import { Q as Qr } from './vendor-min-mermaid~chunk-TK7VX7YV.CPX48Ryn.chunk.js';
import { L as Le } from './vendor-min-mermaid~chunk-CRSA2SMT.DrUenSi3.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { Z as Zf, K as Kf, J as Jf, Q as Qf, j as jf, X as Xf, t as tt$1, Y as Yf, V as Vf, O as Or, I as Il, L as Ll, D as De$1, aR as us, a6 as es, c as Xc } from './vendor-min-mermaid~chunk-63ZE7VZ5.CfadwiGU.chunk.js';
var kt = /*#__PURE__*/ function() {
    var i = /*#__PURE__*/ m$1(function(F, o, h, p) {
        ...
        performAction: /*#__PURE__*/ m$1(function(o, h, p, u, b, r, Z) {
            var m = r.length - 1;
            switch(b){
                case 5:
                    u.setOrientation(r[m]);
                    break;
                case 9:
                    u.setDiagramTitle(/*#__PURE__*/ r[m].text.trim());
                    break;
                case 12:
                    u.setLineData({
                        text: "",
                ...
                case 14:
                    ...
                    break;
                case 15:
                    u.setBarData(r[m - 1], r[m]);
                    break;
                case 16:
                    this.$ = /*#__PURE__*/ r[m].trim(), u.setAccTitle(this.$);
                    break;
                case 17:
                case 18:
                    this.$ = /*#__PURE__*/ r[m].trim(), u.setAccDescription(this.$);
                    break;
                case 19:
                    this.$ = r[m - 1];
                    break;
                ...
                case 25:
                    ...
                    break;
                case 26:
                    u.setXAxisRangeData(/*#__PURE__*/ Number(r[m - 2]), /*#__PURE__*/ Number(r[m]));
                    break;
                case 27:
                    this.$ = r[m - 1];
                    break;
                ...
                case 32:
                    ...
                    break;
                case 33:
                    u.setYAxisRangeData(/*#__PURE__*/ Number(r[m - 2]), /*#__PURE__*/ Number(r[m]));
                    break;
                case 37:
                    this.$ = {
                        text: r[m],
        ...
        parse: /*#__PURE__*/ m$1(function(o) {
            var h = this, p = [
                ...
                null
            ], r = [], Z = this.table, m = "", it = 0, Xt = 0, Yt = 0, oe = 2, Vt = 1, he = /*#__PURE__*/ r.slice.call(arguments, 1), T = /*#__PURE__*/ Object.create(this.lexer), G = {
                yy: {}
            };
...
Expecting ` + st.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : yt = "Parse error on line " + (it + 1) + ": Unexpected " + (k == Vt ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(yt, {
                ...
                switch(Y[0]){
                    case 1:
                        p.push(k), b.push(T.yytext), r.push(T.yylloc), p.push(Y[1]), k = null, dt ? (k = dt, dt = null) : (Xt = T.yyleng, m = T.yytext, it = T.yylineno, ft = T.yylloc, Yt > 0);
                        break;
                    case 2:
                        ...
                        ]), bt = /*#__PURE__*/ this.performAction.apply($, /*#__PURE__*/ [
                            m,
                            Xt,
                            it,
                            G.yy,
        ...
        var F = {
            EOF: 1,
            parseError: /*#__PURE__*/ m$1(function(h, p) {
...
` + h + "^";
            ...
            test_match: /*#__PURE__*/ m$1(function(o, h) {
                ...
                ]), this._more = false, this._backtrack = false, this._input = /*#__PURE__*/ this._input.slice(o[0].length), this.matched += o[0], p = /*#__PURE__*/ this.performAction.call(this, this.yy, this, h, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), p) return p;
                if (this._backtrack) {
            ...
            next: /*#__PURE__*/ m$1(function() {
                ...
                for(var b = /*#__PURE__*/ this._currentRules(), r = 0; r < b.length; r++)if (p = /*#__PURE__*/ this._input.match(this.rules[b[r]]), p && (!h || p[0].length > h[0].length)) {
                    if (h = p, u = r, this.options.backtrack_lexer) {
                        if (o = /*#__PURE__*/ this.test_match(p, b[r]), o !== false) return o;
                        if (this._backtrack) {
                            h = false;
                            continue;
                        } else return false;
                ...
                return h ? (o = /*#__PURE__*/ this.test_match(h, b[u]), o !== false ? o : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
                    text: "",
                    token: null,
                    line: this.yylineno
            ...
            performAction: /*#__PURE__*/ m$1(function(h, p, u, b) {
                switch(u){
                    case 0:
                        break;
                    case 1:
    ...
    return m$1(U, "Parser"), U.prototype = S, S.Parser = U, new U;
}();
kt.parser = kt;
var qt = kt;
function St(i) {
...
m$1(ot, "isBandAxisData");
function q(i) {
    return i.type === "linear";
}
m$1(q, "isLinearAxisData");
var Q = class {
    constructor(t){
        this.parentGroup = t;
    }
    ...
    getMaxDimension(t, e) {
        ...
        for (let l of t){
            let x = /*#__PURE__*/ Qr(n, 1, l), y = x ? x.width : l.length * e, A = x ? x.height : e;
...
var K = class {
    ...
    calculateSpaceIfDrawnHorizontally(t) {
        ...
        if (this.axisConfig.showTick && e >= this.axisConfig.tickLength && (this.showTick = true, e -= this.axisConfig.tickLength), this.axisConfig.showTitle && this.title) {
            let a = /*#__PURE__*/ this.textDimensionCalculator.getMaxDimension([
                this.title
            ], this.axisConfig.titleFontSize), n = a.height + this.axisConfig.titlePadding * 2;
...
var ht = class extends K {
    ...
    constructor(t, e, a, n, l){
        super(t, n, l, e), this.categories = a, this.scale = /*#__PURE__*/ us().domain(this.categories).range(/*#__PURE__*/ this.getRange());
    }
    setRange(t) {
        super.setRange(t);
    }
    recalculateScale() {
        this.scale = /*#__PURE__*/ us().domain(this.categories).range(/*#__PURE__*/ this.getRange()).paddingInner(1).paddingOuter(0).align(.5), tt$1.trace("BandAxis axis final categories, range: ", this.categories, /*#__PURE__*/ this.getRange());
    }
    getTickValues() {
...
var lt = class extends K {
    ...
    constructor(t, e, a, n, l){
        super(t, n, l, e), this.domain = a, this.scale = /*#__PURE__*/ es().domain(this.domain).range(/*#__PURE__*/ this.getRange());
    }
    getTickValues() {
    ...
    recalculateScale() {
        ...
        this.axisPosition === "left" && t.reverse(), this.scale = /*#__PURE__*/ es().domain(t).range(/*#__PURE__*/ this.getRange());
    }
    getScaleValue(t) {
        return this.scale(t);
    }
...
function _t(i, t, e, a) {
    let n = new Q(a);
    return ot(i) ? new ht(t, e, i.categories, i.title, n) : new lt(t, e, [
        i.min,
        i.max
    ], i.title, n);
}
...
var Rt = class {
    ...
    calculateSpace(t) {
        ...
        ], this.chartConfig.titleFontSize), a = /*#__PURE__*/ Math.max(e.width, t.width), n = e.height + 2 * this.chartConfig.titlePadding;
        return e.width <= a && e.height <= n && this.chartConfig.showTitle && this.chartData.title && (this.boundingRect.width = a, this.boundingRect.height = n, this.showChartTitle = true), {
            width: this.boundingRect.width,
            height: this.boundingRect.height
        };
    }
...
var ct = class {
    ...
    getDrawableElement() {
        let t = /*#__PURE__*/ this.plotData.data.map((a)=>[
                /*#__PURE__*/ this.xAxis.getScaleValue(a[0]),
                /*#__PURE__*/ this.yAxis.getScaleValue(a[1])
            ]), e;
        return this.orientation === "horizontal" ? e = /*#__PURE__*/ Xc().y((a)=>a[0]).x((a)=>a[1])(t) : e = /*#__PURE__*/ Xc().x((a)=>a[0]).y((a)=>a[1])(t), e ? [
            {
                groupTexts: [
                    "plot",
...
var gt = class {
    ...
    getDrawableElement() {
        let t = /*#__PURE__*/ this.barData.data.map((l)=>[
                /*#__PURE__*/ this.xAxis.getScaleValue(l[0]),
                /*#__PURE__*/ this.yAxis.getScaleValue(l[1])
            ]), a = Math.min(this.xAxis.getAxisOuterPadding() * 2, /*#__PURE__*/ this.xAxis.getTickDistance()) * (1 - .05), n = a / 2;
...
var ut = class {
    ...
    static build(t, e, a, n) {
        return new pt(t, e, a, n).getDrawableElement();
    }
};
var J = 0, Zt, tt = /*#__PURE__*/ te(), et = /*#__PURE__*/ Jt(), d = /*#__PURE__*/ ee(), vt = /*#__PURE__*/ et.plotColorPalette.split(",").map((i)=>i.trim()), xt = false, Et = false;
function Jt() {
    let i = /*#__PURE__*/ Ll(), t = /*#__PURE__*/ Or();
    return Le(i.xyChart, t.themeVariables.xyChart);
}
m$1(Jt, "getChartDefaultThemeConfig");
function te() {
    let i = /*#__PURE__*/ Or();
    return Le(Il.xyChart, i.xyChart);
}
m$1(te, "getChartDefaultConfig");
function ee() {
    return {
        yAxis: {
            type: "linear",
...
m$1(ee, "getChartDefaultData");
function Lt(i) {
    let t = /*#__PURE__*/ Or();
    return De$1(/*#__PURE__*/ i.trim(), t);
}
m$1(Lt, "textSanitizer");
function ge(i) {
    Zt = i;
}
m$1(ge, "setTmpSVGG");
...
function ue(i) {
    d.xAxis.title = /*#__PURE__*/ Lt(i.text);
}
...
m$1(ie, "setXAxisRangeData");
function xe(i) {
    d.xAxis = {
        type: "band",
        title: d.xAxis.title,
        categories: /*#__PURE__*/ i.map((t)=>Lt(t.text))
    }, xt = true;
}
m$1(xe, "setXAxisBand");
function me(i) {
    d.yAxis.title = /*#__PURE__*/ Lt(i.text);
}
...
function de(i) {
    let t = /*#__PURE__*/ Math.min(...i), e = /*#__PURE__*/ Math.max(...i), a = q(d.yAxis) ? d.yAxis.min : 1 / 0, n = q(d.yAxis) ? d.yAxis.max : -1 / 0;
    d.yAxis = {
        type: "linear",
        title: d.yAxis.title,
...
function ae(i) {
    ...
    if (!xt) {
        let e = q(d.xAxis) ? d.xAxis.min : 1 / 0, a = q(d.xAxis) ? d.xAxis.max : -1 / 0;
        ie(/*#__PURE__*/ Math.min(e, 1), /*#__PURE__*/ Math.max(a, i.length));
    }
    if (Et || de(i), ot(d.xAxis) && (t = /*#__PURE__*/ d.xAxis.categories.map((e, a)=>[
            e,
            i[a]
        ])), q(d.xAxis)) {
        let e = d.xAxis.min, a = d.xAxis.max, n = (a - e) / (i.length - 1), l = [];
        for(let x = e; x <= a; x += n)l.push(`${x}`);
        t = /*#__PURE__*/ l.map((x, y)=>[
                x,
                i[y]
            ]);
    }
...
m$1(ae, "transformDataWithoutCategory");
function se(i) {
...
m$1(ye, "setBarData");
function Ce() {
    if (d.plots.length === 0) throw Error("No Plot to render, please provide a plot with some data");
    return d.title = /*#__PURE__*/ Jf(), ut.build(tt, d, et, Zt);
}
...
m$1(De, "getXYChartData");
var we = /*#__PURE__*/ m$1(function() {
    Vf(), J = 0, tt = /*#__PURE__*/ te(), d = /*#__PURE__*/ ee(), et = /*#__PURE__*/ Jt(), vt = /*#__PURE__*/ et.plotColorPalette.split(",").map((i)=>i.trim()), xt = false, Et = false;
}, "clear"), ne = {
    getDrawableElem: Ce,
    clear: we,
    setAccTitle: Xf,
...
var ke = /*#__PURE__*/ m$1((i, t, e, a)=>{
    ...
    m$1(B, "getTextTransformation"), tt$1.debug(`Rendering xychart chart
` + i);
    let _ = /*#__PURE__*/ d$1(t), L = /*#__PURE__*/ _.append("g").attr("class", "main"), I = /*#__PURE__*/ L.append("rect").attr("width", x.width).attr("height", x.height).attr("class", "background");
    Yf(_, x.height, x.width, true), _.attr("viewBox", `0 0 ${x.width} ${x.height}`), I.attr("fill", l.backgroundColor), n.setTmpSVGG(/*#__PURE__*/ _.append("g").attr("class", "mermaid-tmp-group"));
