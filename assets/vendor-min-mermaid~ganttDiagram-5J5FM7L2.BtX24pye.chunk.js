import { U as Ut$1 } from './vendor-min-mermaid~chunk-3R3PQ5PD.DqcBTR0a.chunk.js';
import { f } from './vendor-min-mermaid~chunk-TI4EEUUG.BFlBPHyk.chunk.js';
import { Q as Qf, K as Kf, b as td, J as Jf, Z as Zf, j as jf, h as hh, k as kh, a3 as qc, a4 as uh, a5 as ch, G as Gf, a6 as es, a7 as Mp, t as tt$1, a8 as _d, a9 as xo, aa as Cr, ab as fe, ac as fc, ad as uc, ae as Be$1, af as cc, ag as hc, ah as xr, ai as ue, aj as gr, ak as mr, al as ee, am as We$1, an as Cd, e as jC, X as Xf, ao as ul } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
...
Ot.parser = Ot;
var Se = Ot;
var Ie = /*#__PURE__*/ q$1(/*#__PURE__*/ f()), q = /*#__PURE__*/ q$1(/*#__PURE__*/ ul()), Fe = /*#__PURE__*/ q$1(/*#__PURE__*/ Ee()), We = /*#__PURE__*/ q$1(/*#__PURE__*/ Me()), Oe = /*#__PURE__*/ q$1(/*#__PURE__*/ Le());
...
var Ae = {
    ...
    Qt = [], wt = [], ft = "", Kt = [], Tt = 0, Ht = void 0, vt = void 0, V = [], K = "", Xt = "", $t = "", qt = void 0, Ut = "", yt = [], pt = [], gt = false, Jt = false, jt = 0, Zt = new Map, Xf(), te = "sunday", _t = "saturday";
    ...
    {
        tt$1.debug("Invalid date:" + s), tt$1.debug("With date format:" + n.trim());
        let h = new Date(s);
    ...
    let s = n;
    hh().securityLevel !== "loose" && (s = /*#__PURE__*/ (0, Ie.sanitizeUrl)(n)), t.split(",").forEach(function(a) {
        st(a) !== void 0 && (Ge(a, ()=>{
            window.open(s, "_self");
        }), Zt.set(a, s));
    }), je(t, "clickable");
    ...
    if (hh().securityLevel !== "loose" || n === void 0) return;
    let a = [];
    if (typeof s == "string") {
...
var In = /*#__PURE__*/ m$1(function() {
    ...
    let r = hh().gantt, d = hh().securityLevel, h;
    d === "sandbox" && (h = /*#__PURE__*/ kh("#i" + n));
    let D = d === "sandbox" ? kh(h.nodes()[0].contentDocument.body) : kh("body"), _ = d === "sandbox" ? h.nodes()[0].contentDocument : document, A = /*#__PURE__*/ _.getElementById(n);
    ...
    let p = /*#__PURE__*/ D.select(`[id="${n}"]`), y = /*#__PURE__*/ qc().domain([
    ...
    m$1(L, "taskCompare"), C.sort(L), Y(C, tt, z), Gf(p, z, tt, r.useMaxWidth), p.append("text").text(/*#__PURE__*/ a.db.getDiagramTitle()).attr("x", tt / 2).attr("y", r.titleTopMargin).attr("class", "titleText");
    function Y(g, v, T) {
        let x = r.barHeight, b = x + r.barGap, w = r.topPadding, l = r.leftPadding, f = /*#__PURE__*/ es().domain([
            0,
            W.length
        ]).range([
            "#00B9FA",
    ...
    function $(g, v, T, x) {
        ...
        let f = /*#__PURE__*/ _d(y).tickSize(-x + v + r.gridLineStartPadding).tickFormat(/*#__PURE__*/ xo(l)), u = /*#__PURE__*/ /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(a.db.getTickInterval() || r.tickInterval);
        if (u !== null) {
            let m = u[1], e = u[2], c = a.db.getWeekday() || r.weekday;
            switch(e){
                case "millisecond":
                    f.ticks(/*#__PURE__*/ We$1.every(m));
                    break;
                case "second":
                    f.ticks(/*#__PURE__*/ ee.every(m));
                    break;
                case "minute":
                    f.ticks(/*#__PURE__*/ mr.every(m));
                    break;
                case "hour":
                    f.ticks(/*#__PURE__*/ gr.every(m));
                    break;
                case "day":
                    f.ticks(/*#__PURE__*/ ue.every(m));
                    break;
                case "week":
                    f.ticks(/*#__PURE__*/ qe[c].every(m));
                    break;
                case "month":
                    f.ticks(/*#__PURE__*/ Cr.every(m));
                    break;
            }
        }
        if (p.append("g").attr("class", "grid").attr("transform", "translate(" + g + ", " + (x - 50) + ")").call(f).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em"), a.db.topAxisEnabled() || r.topAxis) {
            let m = /*#__PURE__*/ Cd(y).tickSize(-x + v + r.gridLineStartPadding).tickFormat(/*#__PURE__*/ xo(l));
            if (u !== null) {
                let e = u[1], c = u[2], i = a.db.getWeekday() || r.weekday;
                switch(c){
                    case "millisecond":
                        m.ticks(/*#__PURE__*/ We$1.every(e));
                        break;
                    case "second":
                        m.ticks(/*#__PURE__*/ ee.every(e));
                        break;
                    case "minute":
                        m.ticks(/*#__PURE__*/ mr.every(e));
                        break;
                    case "hour":
                        m.ticks(/*#__PURE__*/ gr.every(e));
                        break;
                    case "day":
                        m.ticks(/*#__PURE__*/ ue.every(e));
                        break;
                    case "week":
                        m.ticks(/*#__PURE__*/ qe[i].every(e));
                        break;
                    case "month":
                        m.ticks(/*#__PURE__*/ Cr.every(e));
                        break;
                }
            }
    ...
    function U(g, v) {
        ...
        p.append("g").selectAll("text").data(x).enter().append(function(b) {
            let w = /*#__PURE__*/ b[0].split(jC.lineBreakRegex), l = -(w.length - 1) / 2, f = /*#__PURE__*/ _.createElementNS("http://www.w3.org/2000/svg", "text");
