...
function xt(t, e) {
    ...
    if (!r) {
        if (Array.isArray(t) || (r = xi(t)) || e && t && typeof t.length == "number") {
            r && (t = r);
            var a = 0, n = m$1(function() {}, "F");
            return {
                s: n,
                n: m$1(function() {
                    return a >= t.length ? {
...
Ue && Ue.document;
var Cl = Ye(""), mo = Ye({}), Sl = Ye(function() {}), Dl = typeof HTMLElement > "u" ? "undefined" : Ye(HTMLElement), Ba = m$1(function(e) {
...
function Sv(t) {
    ...
    t = nv(t);
    var r = Ev.test(t);
    return r || Tv.test(t) ? Cv(t.slice(2), r ? 2 : 8) : xv.test(t) ? es : +t;
}
m$1(Sv, "toNumber");
...
function Bv(t, e, r) {
    ...
    function g(T) {
        var E = a, D = n;
        return a = n = void 0, u = T, s = t.apply(D, E), s;
    }
    m$1(g, "invokeFunc");
    function h(T) {
...
var Ma = Bv, Gn = Ue ? Ue.performance : null, Po = Gn && Gn.now ? function() {
    ...
    return 0;
}, "zeroify"), Si = m$1(function() {}, "noop"), $e = m$1(function(e) {
    throw new Error(e);
    ...
    function t(e) {
        if (ur(this, t), this._obj = Object.create(null), this.size = 0, e != null) {
            var r;
...
var Wf = et({
...
}, "getAllChildren"), ac = m$1(function t(e, r) {
    if (!e) return "";
    if (e.left && e.right) {
...
}, "buildDendrogram"), nc = m$1(function t(e, r, a) {
    if (!e) return [];
    var n = [], i = [], s = [];
    return r === 0 ? (e.left && Wa(e.left, n), e.right && Wa(e.right, i), s = n.concat(i), [
        ...
        a.collection(e.value)
    ] : (e.left && (n = t(e.left, r - 1, a)), e.right && (i = t(e.right, r - 1, a)), n.concat(i));
    ...
    .5 <= r && r < 1 || $e("Damping must range on [0.5, 1).  Got: ".concat(r));
    var n = [
        "median",
        "mean",
        "min",
...
var Yo = 0, _o = 1, Zo = 2, Xt = m$1(function t(e) {
...
}, "resolver"), yc = m$1(function t(e, r) {
    if (e === r || e.proxy === r) {
...
Xt.all = function(t) {
    return new Xt(function(e, r) {
        for(var a = new Array(t.length), n = 0, i = m$1(function(l, u) {
...
var Gd = Mi, Wd = 500;
function Hd(t) {
    var e = Gd(t, function(a) {
        return r.size === Wd && r.clear(), a;
    }), r = e.cache;
    return e;
}
m$1(Hd, "memoizeCapped");
var Ud = Hd, Xd = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Yd = /\\(\\)?/g, _d = Ud(function(t) {
    var e = [];
...
function Zd(t, e) {
    for(var r = -1, a = t == null ? 0 : t.length, n = Array(a); ++r < a;)n[r] = e(t[r], r, t);
    return n;
}
m$1(Zd, "arrayMap");
...
var sh = ih, oh = function() {
    try {
        var t = Ri(Object, "defineProperty");
        return t({}, "", {}), t;
    } catch  {}
}(), Ss = oh;
function uh(t, e, r) {
...
var Sh = Ch, Dh = {
    data: m$1(function(e) {
        var r = {
            ...
            immutableKeys: {},
            updateStyle: false,
            beforeGet: m$1(function(n) {}, "beforeGet"),
            beforeSet: m$1(function(n, i) {}, "beforeSet"),
            onSet: m$1(function(n) {}, "onSet"),
...
(function() {
    var t, e, r;
    for(t = ke.comparatorOp.split("|"), r = 0; r < t.length; r++)e = t[r], ke.comparatorOp += "|@" + e;
    for(t = ke.comparatorOp.split("|"), r = 0; r < t.length; r++)e = t[r], !(e.indexOf("!") >= 0) && e !== "=" && (ke.comparatorOp += "|\\!" + e);
})();
var Ie = m$1(function() {
    return {
        checks: []
...
Ge[oe.DIRECTED_EDGE] = function(t, e) {
    return Ve(t.source, e.source()) && Ve(t.target, e.target());
};
...
Ge[oe.CHILD] = function(t, e) {
    return Ve(t.child, e) && Ve(t.parent, e.parent());
};
...
function Oi(t, e, r, a) {
    for(var n = [], i = new Wr, s = t.cy(), o = s.hasCompoundNodes(), l = 0; l < t.length; l++){
        var u = t[l];
...
he(Rn, {
    degree: Yn(function(t, e) {
        return e.source().same(e.target()) ? 2 : 1;
    }),
    indegree: Yn(function(t, e) {
        return e.target().same(t) ? 1 : 0;
    }),
    outdegree: Yn(function(t, e) {
...
he(Rn, {
    minDegree: Pr("degree", function(t, e) {
        return t < e;
    }),
    maxDegree: Pr("degree", function(t, e) {
        return t > e;
    }),
    minIndegree: Pr("indegree", function(t, e) {
        return t < e;
    }),
    maxIndegree: Pr("indegree", function(t, e) {
        return t > e;
    }),
    minOutdegree: Pr("outdegree", function(t, e) {
        return t < e;
    }),
    maxOutdegree: Pr("outdegree", function(t, e) {
        return t > e;
    })
});
he(Rn, {
...
vr.boundingBox = function(t) {
    var e;
    if (this.length === 1 && this[0]._private.bbCache != null && !this[0]._private.styleDirty && (t === void 0 || t.useCache === void 0 || t.useCache === true)) t === void 0 ? t = Da : t = Bs(t), e = ks(this[0], t);
    else {
        e = yt(), t = t || Da;
        var r = Bs(t), a = this, n = a.cy(), i = n.styleEnabled();
...
}, "renderedName"), ig = Object.keys(As).reduce(function(t, e) {
    var r = As[e], a = ng(e);
    return t[e] = function() {
...
var gu = /^([^.]+)(\.(?:[^.]+))?$/, og = ".*", pu = {
    ...
    addEventFields: m$1(function() {}, "addEventFields"),
    callbackContext: m$1(function(e) {
        return e;
    }, "callbackContext"),
    beforeEmit: m$1(function() {}, "beforeEmit"),
    afterEmit: m$1(function() {}, "afterEmit"),
    bubble: m$1(function() {
        return false;
    }, "bubble"),
    parent: m$1(function() {
...
var pg = Ln("eleVisible", function(t) {
...
function Vs(t) {
    ...
    return t = he({}, e, t), m$1(function(a) {
        for(var n = [], i = this.edges(), s = t, o = 0; o < i.length; o++)for(var l = i[o], u = l._private, f = u.source, c = f._private.data.id, d = u.data.target, g = f._private.edges, h = 0; h < g.length; h++){
...
Fe.clone = function() {
    for(var t = this.cy(), e = [], r = 0; r < this.length; r++){
        var a = this[r], n = a.json(), i = new Sn(t, n, false);
        e.push(i);
    }
    return new at(t, e);
};
...
Fe.restore = function() {
    ...
    if (o.length > 0) {
        ...
        var K;
        n.hasCompoundNodes ? K = a.collection().merge($).merge($.connectedNodes()).merge($.parent()) : K = $, K.dirtyCompoundBoundsCache().dirtyBoundingBoxCache().updateStyle(t), t ? $.emitAndNotify("add") : e && $.emit("add");
    }
    return r;
};
Fe.removed = function() {
...
function bg(t, e, r, a) {
    ...
    function w() {
        for(var B = 0; B < l; ++B)d[B] = y(B * u, t, r);
    }
    ...
    function S(B) {
        ...
        --P;
        var R = (B - d[P]) / (d[P + 1] - d[P]), I = A + R * u, L = p(I, t, r);
    ...
    var D = m$1(function(A) {
        return T || E(), t === e && r === a ? A : A === 0 ? 0 : A === 1 ? 1 : y(S(A), e, a);
    }, "f");
...
var wg = function() {
    ...
    ease: ze(.25, .1, .25, 1),
    "ease-in": ze(.42, 0, 1, 1),
    "ease-out": ze(0, 0, .58, 1),
    "ease-in-out": ze(.42, 0, .58, 1),
    "ease-in-sine": ze(.47, 0, .745, .715),
    "ease-out-sine": ze(.39, .575, .565, 1),
    "ease-in-out-sine": ze(.445, .05, .55, .95),
    "ease-in-quad": ze(.55, .085, .68, .53),
    "ease-out-quad": ze(.25, .46, .45, .94),
    "ease-in-out-quad": ze(.455, .03, .515, .955),
    "ease-in-cubic": ze(.55, .055, .675, .19),
    "ease-out-cubic": ze(.215, .61, .355, 1),
    "ease-in-out-cubic": ze(.645, .045, .355, 1),
    "ease-in-quart": ze(.895, .03, .685, .22),
    "ease-out-quart": ze(.165, .84, .44, 1),
    "ease-in-out-quart": ze(.77, 0, .175, 1),
    "ease-in-quint": ze(.755, .05, .855, .06),
    "ease-out-quint": ze(.23, 1, .32, 1),
    "ease-in-out-quint": ze(.86, 0, .07, 1),
    "ease-in-expo": ze(.95, .05, .795, .035),
    "ease-out-expo": ze(.19, 1, .22, 1),
    "ease-in-out-expo": ze(1, 0, 0, 1),
    "ease-in-circ": ze(.6, .04, .98, .335),
    "ease-out-circ": ze(.075, .82, .165, 1),
    "ease-in-out-circ": ze(.785, .135, .15, .86),
...
function xg(t, e, r, a) {
    ...
    if (s.duration === 0 ? y = 1 : y = (r - l) / s.duration, s.applying && (y = s.progress), y < 0 ? y = 0 : y > 1 && (y = 1), s.delay == null) {
        ...
        if (b1 && n && !t.locked()) {
            var w = {};
            sa(p.x, b1.x) && (w.x = Br(p.x, b1.x, y, m)), sa(p.y, b1.y) && (w.y = Br(p.y, b1.y, y, m)), t.position(w);
        }
        var x = s.startPan, S = s.pan, T = i.pan, E = S != null && a;
        E && (sa(x.x, S.x) && (T.x = Br(x.x, S.x, y, m)), sa(x.y, S.y) && (T.y = Br(x.y, S.y, y, m)), t.emit("pan"));
        var D = s.startZoom, C = s.zoom, B = C != null && a;
        B && (sa(D, C) && (i.zoom = Ea(i.minZoom, Br(D, C, y, m), i.maxZoom)), t.emit("zoom")), (E || B) && t.emit("viewport");
        var A = s.style;
        if (A && A.length > 0 && n) {
...
lt.updateStyleHints = function(t) {
    var e = t._private, r = this, a = r.propertyGroupNames, n = r.propertyGroupKeys, i = m$1(function(U, te, se) {
    ...
    for(var c = m$1(function(U, te) {
        ...
        if (w != null) {
            ...
            x.hashOverride != null ? E = x.hashOverride(t, w) : w.pfValue != null && (E = w.pfValue);
...
lt.applyParsedProperty = function(t, e) {
    var r = this, a = e, n = t._private.style, i, s = r.types, o = r.properties[a.name].type, l = a.bypass, u = n[a.name], f = u && u.bypass, c = t._private, d = "mapping", g = m$1(function(Y) {
        return Y == null ? null : Y.pfValue != null ? Y.pfValue : Y.value;
    }, "getVal"), h = m$1(function() {
        var Y = g(u), Z = g(a);
        r.checkTriggers(t, a.name, Y, Z);
    }, "checkTriggers");
    if (e.name === "curve-style" && t.isEdge() && (e.value !== "bezier" && t.isLoop() || e.value === "haystack" && (t.source().isParent() || t.target().isParent())) && (a = e = this.parse(e.name, "bezier", l)), a.delete) return n[a.name] = void 0, h(), true;
        ...
        case s.fn:
            {
                ...
                if (i = this.parse(a.name, q, a.bypass, d), !i) return Re("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + t.id() + "` is invalid)"), false;
                i.mapping = zt(a), a = i;
                break;
            }
        case void 0:
    ...
    if (t = t[0], t) {
        ...
        if (s) {
            ...
            if (r && i.number && o != null && ae(o)) {
                var f = t.cy().zoom(), c = m$1(function(y) {
                    return y * f;
...
Vt.getNonDefaultPropertiesHash = function(t, e, r) {
    ...
    for(l = 0; l < e.length; l++)if (n = e[l], i = t.pstyle(n, false), i != null) if (i.pfValue != null) a[0] = ba(o, a[0]), a[1] = wa(o, a[1]);
...
var tt = {};
(function() {
    var t = Xe, e = Ol, r = zl, a = Fl, n = Vl, i = m$1(function(W) {
        return "^" + W + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
...
Nn.parse = function(t, e, r, a) {
    ...
    var i = a === "mapping" || a === true || a === false || a == null ? "dontcare" : a, s = r ? "t" : "f", o = "" + e, l = Ro(t, o, s, i), u = n.propCache = n.propCache || [], f;
    return (f = u[l]) || (f = u[l] = n.parseImplWarn(t, e, r, a)), (r || a === "mapping") && (f = zt(f), f && (f.value = zt(f.value))), f;
};
Nn.parseImplWarn = function(t, e, r, a) {
    var n = this.parseImpl(t, e, r, a);
    return !n && e != null && Re("The style property `".concat(t, ": ").concat(e, "` is invalid")), n && (n.name === "width" || n.name === "height") && e === "label" && Re("The style value of `label` is deprecated for `" + n.name + "`"), n;
};
Nn.parseImpl = function(t, e, r, a) {
    ...
    if (u.multiple && a !== "multiple") {
        ...
        for(var x = [], S = [], T = [], E = "", D = false, C = 0; C < w.length; C++){
            var B = n.parse(t, w[C], r, "multiple");
...
ut.clear = function() {
    for(var t = this._private, e = t.cy, r = e.elements(), a = 0; a < this.length; a++)this[a] = void 0;
...
function Tu(t) {
    this.options = he({}, Ag, Rg, t);
}
m$1(Tu, "BreadthFirstLayout");
Tu.prototype.run = function() {
    var t = this.options, e = t.cy, r = t.eles, a = r.nodes().filter(function(ve) {
        return ve.isChildless();
    }), n = r, i = t.directed, s = t.acyclic || t.maximal || t.maximalAdjustments > 0, o = !!t.boundingBox, l = e.extent(), u = yt(o ? t.boundingBox : {
        x1: l.x1,
        y1: l.y1,
        w: l.w,
        h: l.h
    ...
    if (Et(t.roots)) f = t.roots;
        ...
        for(var c = [], d = 0; d < t.roots.length; d++){
            var g = t.roots[d], h = e.getElementById(g);
            c.push(h);
        }
        f = e.collection(c);
    } else if (ce(t.roots)) f = e.$(t.roots);
    else if (i) f = a.roots();
    else {
        var m = r.components();
        f = e.collection();
    ...
    if (t.avoidOverlap) for(var N = 0; N < a.length; N++){
        var $ = a[N], H = $.layoutDimensions(t), q = H.w, K = H.h;
        O = Math.max(O, q, K);
    }
    ...
    var se = {
        ...
        w: -1,
        h: -1
    }), Se = Math.max(Q === 1 ? 0 : o ? (u.h - t.padding * 2 - le.h) / (Q - 1) : (u.h - t.padding * 2 - le.h) / (Q + 1), O), Me = b1.reduce(function(ve, ue) {
        ...
        if (t.circle) {
            ...
            var j = b1[me].length, k = Math.max(j === 1 ? 0 : o ? (u.w - t.padding * 2 - le.w) / ((t.grid ? Me : j) - 1) : (u.w - t.padding * 2 - le.w) / ((t.grid ? Me : j) + 1), O), F = {
                x: se.x + (ge + 1 - (j + 1) / 2) * k,
...
function zn(t) {
    this.options = he({}, Ig, t), this.options.layout = this;
...
zn.prototype.run = function() {
    ...
    var n = Ht(), i = m$1(function() {
        ...
        if (t.animate === true || t.animate === false) i(), r.one("layoutstop", t.stop), r.emit({
            ...
            var d = t.eles.nodes(), g = Du(a, t, d);
            d.layoutPositions(r, t, g);
        }
    }, "done"), l = 0, u = true;
    if (t.animate === true) {
        var f = m$1(function c() {
            for(var d = 0; u && d < t.refresh;)u = s(l), l++, d++;
            if (!u) Hs(a, t), o();
            else {
                var g = Ht();
...
var Og = m$1(function(e, r, a) {
...
}, "findLCA"), zg = m$1(function t(e, r, a, n) {
    var i = n.graphSet[a];
    ...
    for(var s = 0, o = 0; o < i.length; o++){
        ...
        if (f.length !== 0) {
            var c = n.indexToGraph[n.idToIndex[f[0]]], d = t(e, r, c, n);
    ...
    return i;
}, "limitForce"), Zg = m$1(function t(e, r) {
    var a = e.parentId;
    if (a != null) {
    ...
    rows: void 0,
    cols: void 0,
    position: m$1(function(e) {}, "position"),
    sort: void 0,
    animate: false,
    animationDuration: 500,
    animationEasing: void 0,
...
Pu.prototype.run = function() {
    var t = this.options, e = t.eles, r = e.nodes(), a = Ke(t.positions);
    function n(i) {
        if (t.positions == null) return rf(i.position());
...
m$1(Au, "NullRenderer");
var Us = m$1(function() {}, "noop"), Xs = m$1(function() {
...
qi.registerArrowShapes = function() {
    var t = this.arrowShapes = {}, e = this, r = m$1(function(u, f, c, d, g, h, m) {
...
Sr.findContainerClientCoords = function() {
    ...
    var t = this.container, e = t.getBoundingClientRect(), r = this.cy.window().getComputedStyle(t), a = m$1(function(p) {
...
Sr.findNearestElements = function(t, e, r, a) {
    ...
    function b1(E) {
        ...
        if (C.edgeType === "segments" || C.edgeType === "straight" || C.edgeType === "haystack") {
            for(var L = C.allpts, O = 0; O + 3 < L.length; O += 2)if (pf(t, e, L[O], L[O + 1], L[O + 2], L[O + 3], R) && M > (I = xf(t, e, L[O], L[O + 1], L[O + 2], L[O + 3]))) return y(E, I), true;
        } else if (C.edgeType === "bezier" || C.edgeType === "multibezier" || C.edgeType === "self" || C.edgeType === "compound") {
            for(var L = C.allpts, O = 0; O + 5 < C.allpts.length; O += 4)if (yf(t, e, L[O], L[O + 1], L[O + 2], L[O + 3], L[O + 4], L[O + 5], R) && M > (I = wf(t, e, L[O], L[O + 1], L[O + 2], L[O + 3], L[O + 4], L[O + 5]))) return y(E, I), true;
        }
...
wn.calculateArrowAngles = function(t) {
    ...
    if (r ? (f = e.haystackPts[0], c = e.haystackPts[1], d = e.haystackPts[2], g = e.haystackPts[3]) : (f = e.arrowStartX, c = e.arrowStartY, d = e.arrowEndX, g = e.arrowEndY), p = e.midX, b1 = e.midY, i) l = f - e.segpts[0], u = c - e.segpts[1];
        ...
        var h = e.allpts, m = je(h[0], h[2], h[4], .1), y = je(h[1], h[3], h[5], .1);
        l = f - m, u = c - y;
    } else l = f - p, u = c - b1;
    ...
    if (r && (p = (f + d) / 2, b1 = (c + g) / 2), l = d - f, u = g - c, i) {
        ...
        if (S.length / 2 % 2 === 0) {
            ...
            T = je(h[B], h[A], h[P], .4999), E = je(h[B + 1], h[A + 1], h[P + 1], .4999), D = je(h[B], h[A], h[P], .5), C = je(h[B + 1], h[A + 1], h[P + 1], .5);
        }
        l = D - T, u = C - E;
    }
    ...
    if (e.midsrcArrowAngle = Ka(l, u), i) l = d - e.segpts[e.segpts.length - 2], u = g - e.segpts[e.segpts.length - 1];
        ...
        var h = e.allpts, R = h.length, m = je(h[R - 6], h[R - 4], h[R - 2], .9), y = je(h[R - 5], h[R - 3], h[R - 1], .9);
        l = d - m, u = g - y;
    } else l = d - p, u = g - b1;
...
wn.getArrowWidth = wn.getArrowHeight = function(t, e) {
    ...
    return a || (a = Math.max(Math.pow(t * 13.37, .9), 29) * e, r[t + ", " + e] = a, a);
};
...
vt.findMidptPtsEtc = function(t, e) {
    var r = e.posPts, a = e.intersectionPts, n = e.vectorNormInverse, i, s = t.pstyle("source-endpoint"), o = t.pstyle("target-endpoint"), l = s.units != null && o.units != null, u = m$1(function(S, T, E, D) {
    ...
    switch(f){
        ...
        case "endpoints":
            {
                if (l) {
                    var c = this.manualEndptToPx(t.source()[0], s), d = We(c, 2), g = d[0], h = d[1], m = this.manualEndptToPx(t.target()[0], o), y = We(m, 2), p = y[0], b1 = y[1], w = {
                        x1: g,
                        y1: h,
                        x2: p,
                        y2: b1
                    ...
                    n = u(g, h, p, b1), i = w;
                } else Re("Edge ".concat(t.id(), " has edge-distances:endpoints specified without manual endpoints specified via source-endpoint and target-endpoint.  Falling back on edge-distances:intersection (default).")), i = a;
                break;
            }
    }
    return {
...
vt.findSegmentsPoints = function(t, e) {
    ...
    for(var f = 0; f < o; f++){
        var c = a.pfValue[f], d = n.pfValue[f], g = 1 - c, h = c, m = this.findMidptPtsEtc(t, e), y = m.midptPts, p = m.vectorNormInverse, b1 = {
            x: y.x1 * g + y.x2 * h,
            y: y.y1 * g + y.y2 * h
        };
...
vt.findLoopPoints = function(t, e, r, a) {
    var n = t._private.rscratch, i = e.dirCounts, s = e.srcPos, o = t.pstyle("control-point-distances"), l = o ? o.pfValue[0] : void 0, u = t.pstyle("loop-direction").pfValue, f = t.pstyle("loop-sweep").pfValue, c = t.pstyle("control-point-step-size").pfValue;
    n.edgeType = "self";
    var d = r, g = c;
    a && (d = 0, g = l);
...
vt.findCompoundLoopPoints = function(t, e, r, a) {
    ...
    n.edgeType = "compound";
    var i = e.srcPos, s = e.tgtPos, o = e.srcW, l = e.srcH, u = e.tgtW, f = e.tgtH, c = t.pstyle("control-point-step-size").pfValue, d = t.pstyle("control-point-distances"), g = d ? d.pfValue[0] : void 0, h = r, m = c;
    a && (h = 0, m = g);
    var y = 50, p = {
        x: i.x - o / 2,
        y: i.y - l / 2
        ...
        x: Math.min(p.x, b1.x),
        y: Math.min(p.y, b1.y)
    }, x = .5, S = Math.max(x, Math.log(o * .01)), T = Math.max(x, Math.log(u * .01));
    n.ctrlpts = [
        w.x,
...
vt.findBezierPoints = function(t, e, r, a, n) {
    var i = t._private.rscratch, s = t.pstyle("control-point-step-size").pfValue, o = t.pstyle("control-point-distances"), l = t.pstyle("control-point-weights"), u = o && l ? Math.min(o.value.length, l.value.length) : 1, f = o ? o.pfValue[0] : void 0, c = l.value[0], d = a;
    i.edgeType = d ? "multibezier" : "bezier", i.ctrlpts = [];
    for(var g = 0; g < u; g++){
        var h = (.5 - e.eles.length / 2 + r) * s * (n ? -1 : 1), m = void 0, y = zo(h);
        d && (f = o ? o.pfValue[g] : s, c = l.value[g]), a ? m = f : m = f !== void 0 ? y * f : void 0;
        var p = m !== void 0 ? m : h, b1 = 1 - c, w = c, x = this.findMidptPtsEtc(t, e), S = x.midptPts, T = x.vectorNormInverse, E = {
            x: S.x1 * b1 + S.x2 * w,
            y: S.y1 * b1 + S.y2 * w
        };
...
vt.storeAllpts = function(t) {
    ...
    if (e.edgeType === "multibezier" || e.edgeType === "bezier" || e.edgeType === "self" || e.edgeType === "compound") {
        ...
        var a, n;
        e.ctrlpts.length / 2 % 2 === 0 ? (a = e.allpts.length / 2 - 1, e.midX = e.allpts[a], e.midY = e.allpts[a + 1]) : (a = e.allpts.length / 2 - 3, n = .5, e.midX = je(e.allpts[a], e.allpts[a + 2], e.allpts[a + 4], n), e.midY = je(e.allpts[a + 1], e.allpts[a + 3], e.allpts[a + 5], n));
...
Na.findEndpoints = function(t) {
    ...
    var Le = Ga(r, R, e.arrowShapes[o].spacing(t) + u), ve = Ga(r, R, e.arrowShapes[o].gap(t) + u);
    ...
    var ie = Ga(r, I, e.arrowShapes[l].spacing(t) + f), de = Ga(r, I, e.arrowShapes[l].gap(t) + f);
...
Ki.storeEdgeProjections = function(t) {
    ...
    if (e.rstyle.bezierPts = null, e.rstyle.linePts = null, e.rstyle.haystackPts = null, a === "multibezier" || a === "bezier" || a === "self" || a === "compound") {
        e.rstyle.bezierPts = [];
        for(var n = 0; n + 5 < r.allpts.length; n += 4)np(this, t, r.allpts.slice(n, n + 6));
...
qt.recalculateNodeLabelProjection = function(t) {
    ...
    if (!rr(e)) {
        var r, a, n = t._private, i = t.width(), s = t.height(), o = t.padding(), l = t.position(), u = t.pstyle("text-halign").strValue, f = t.pstyle("text-valign").strValue, c = n.rscratch, d = n.rstyle;
        switch(u){
            case "left":
                r = l.x - i / 2 - o;
                break;
...
var Ou = m$1(function(e, r) {
    ...
    var i = Ea(0, n - .001, 1), s = Ea(0, n + .001, 1), o = Or(e, r, a, i), l = Or(e, r, a, s);
    return Nu(o, l);
}, "bezierAngle");
...
qt.applyPrefixedLabelDimensions = function(t, e) {
    var r = t._private, a = this.getLabelText(t, e), n = this.calculateLabelDimensions(t, a), i = t.pstyle("line-height").pfValue, s = t.pstyle("text-wrap").strValue, o = At(r.rscratch, "labelWrapCachedLines", e) || [], l = s !== "wrap" ? 1 : Math.max(o.length, 1), u = n.height / l, f = u * i, c = n.width, d = n.height + (l - 1) * (i - 1) * u;
...
qt.getLabelText = function(t, e) {
    var r = t._private, a = e ? e + "-" : "", n = t.pstyle(a + "label").strValue, i = t.pstyle("text-transform").value, s = m$1(function(Y, Z) {
...
`), c = t.pstyle("text-max-width").pfValue, d = t.pstyle("text-overflow-wrap").value, g = d === "anywhere", h = [], m = /[\s\u200b]+|$/g, y = 0; y < f.length; y++){
            var p = f[y], b1 = this.calculateLabelDimensions(t, p), w = b1.width;
            if (g) {
            ...
            if (w > c) {
                ...
                try {
                    for(D.s(); !(C = D.n()).done;){
                        ...
                        E = B.index + A.length;
                        var M = T.length === 0 ? P : T + P + A, R = this.calculateLabelDimensions(t, M), I = R.width;
...
qt.calculateLabelDimensions = function(t, e) {
    var r = this, a = r.cy.window(), n = a.document, i = ar(e, t._private.labelDimsKey), s = r.labelDimCache || (r.labelDimCache = []), o = s[i];
    if (o != null) return o;
...
Fn.registerCalculationListeners = function() {
    var t = this.cy, e = t.collection(), r = this, a = m$1(function(s) {
    ...
    r.binder(t).on("bounds.* dirty.*", m$1(function(s) {
        var o = s.target;
        a(o);
...
Qr.binder = function(t) {
    var e = this, r = e.cy.window(), a = t === r || t === r.document || t === r.document.body || Al(t);
...
Qr.load = function() {
    var t = this, e = t.cy.window(), r = m$1(function(k) {
        return k.selected();
    ...
    var C = m$1(function() {
        ...
        for(var F = t.findContainerClientCoords(), X = F[0], V = F[1], G = F[2], ne = F[3], _ = k.touches ? k.touches : [
            k
    ...
    t.registerBinding(t.container, "mousedown", m$1(function(k) {
        if (B(k) && !(t.hoverData.which === 1 && k.which !== 1)) {
            k.preventDefault(), w(), t.hoverData.capture = true, t.hoverData.which = k.which;
            var F = t.cy, X = [
                k.clientX,
                k.clientY
            ], V = t.projectIntoViewport(X[0], X[1]), G = t.selection, ne = t.findNearestElements(V[0], V[1], true, false), _ = ne[0], ie = t.dragData.possibleDragElements;
            ...
            if (k.which == 3) {
                ...
                _ ? (_.activate(), _.emit(Ee), t.hoverData.down = _) : F.emit(Ee), t.hoverData.downTime = new Date().getTime(), t.hoverData.cxtDragged = false;
            } else if (k.which == 1) {
                _ && _.activate();
                {
                    if (_ != null && t.nodeIsGrabbable(_)) {
                        ...
                        if (c(_), !_.selected()) ie = t.dragData.possibleDragElements = F.collection(), y(_, {
                            addToList: ie
                        }), _.emit(fe("grabon")).emit(fe("grab"));
                        else {
                            ie = t.dragData.possibleDragElements = F.collection();
                    ...
                    t.hoverData.down = _, t.hoverData.downs = ne, t.hoverData.downTime = new Date().getTime();
                }
                n(_, [
                    "mousedown",
                    "tapstart",
    ...
    t.registerBinding([
        ...
        if (!(!F && !B(k))) {
            var X = false, V = t.cy, G = V.zoom(), ne = [
                k.clientX,
                k.clientY
            ], _ = t.projectIntoViewport(ne[0], ne[1]), ie = t.hoverData.mdownPos, de = t.hoverData.mdownGPos, Ee = t.selection, fe = null;
            !t.hoverData.draggingEles && !t.hoverData.dragging && !t.hoverData.selecting && (fe = t.findNearestElement(_[0], _[1], true, false));
            ...
            if (t.hoverData.which === 3) {
                ...
                _ = t.projectIntoViewport(k.clientX, k.clientY);
                ...
                if (qe) {
                    if (!t.hoverData.dragging && V.boxSelectionEnabled() && (ft || !V.panningEnabled() || !V.userPanningEnabled())) Mt();
                        ...
                        var Gt = s(xe, t.hoverData.downs);
                        Gt && (t.hoverData.dragging = true, t.hoverData.justStartedPan = true, Ee[4] = 0, t.data.bgActivePosistion = Lr(ie), t.redrawHint("select", true), t.redraw());
                    }
    ...
    var P, M, R;
    t.registerBinding(e, "mouseup", m$1(function(k) {
        if (!(t.hoverData.which === 1 && k.which !== 1 && t.hoverData.capture)) {
            var F = t.hoverData.capture;
            if (F) {
                t.hoverData.capture = false;
                var X = t.cy, V = t.projectIntoViewport(k.clientX, k.clientY), G = t.selection, ne = t.findNearestElement(V[0], V[1], true, false), _ = t.dragData.possibleDragElements, ie = t.hoverData.down, de = i(k);
                if (t.data.bgActivePosistion && (t.redrawHint("select", true), t.redraw()), t.hoverData.tapholdCancelled = true, t.data.bgActivePosistion = void 0, ie && ie.unactivate(), t.hoverData.which === 3) {
                    ...
                    if (n(ne, [
                    ...
                    }, X.multiClickDebounceTime()), R = k.timeStamp)), ie == null && !t.dragData.didDrag && !t.hoverData.selecting && !t.hoverData.dragged && !i(k) && (X.$(r).unselect([
                        "tapunselect"
                    ]), _.length > 0 && t.redrawHint("eles", true), t.dragData.possibleDragElements = _ = X.collection()), ne == ie && !t.dragData.didDrag && !t.hoverData.selecting && ne != null && ne._private.selectable && (t.hoverData.dragging || (X.selectionType() === "additive" || de ? ne.selected() ? ne.unselect([
                        "tapunselect"
                    ]) : ne.select([
                        "tapselect"
                        ...
                        var we = X.collection(t.getAllInBox(G[0], G[1], G[2], G[3]));
    ...
    var I = m$1(function(k) {
        if (!t.scrollingPage) {
            var F = t.cy, X = F.zoom(), V = F.pan(), G = t.projectIntoViewport(k.clientX, k.clientY), ne = [
                G[0] * X + V.x,
                G[1] * X + V.y
            ];
            ...
            if (F.panningEnabled() && F.userPanningEnabled() && F.zoomingEnabled() && F.userZoomingEnabled()) {
                k.preventDefault(), t.data.wheelZooming = true, clearTimeout(t.data.wheelTimeout), t.data.wheelTimeout = setTimeout(function() {
    ...
    t.registerBinding(t.container, "wheel", I, true), t.registerBinding(e, "scroll", m$1(function(k) {
        t.scrollingPage = true, clearTimeout(t.scrollingPageTimeout), t.scrollingPageTimeout = setTimeout(function() {
            t.scrollingPage = false;
        }, 250);
    }, "scrollHandler"), true), t.registerBinding(t.container, "gesturestart", m$1(function(k) {
    ...
    }, true), t.registerBinding(t.container, "mouseout", m$1(function(k) {
        var F = t.projectIntoViewport(k.clientX, k.clientY);
        t.cy.emit({
            originalEvent: k,
            type: "mouseout",
            position: {
    ...
    }, "mouseOutHandler"), false), t.registerBinding(t.container, "mouseover", m$1(function(k) {
        var F = t.projectIntoViewport(k.clientX, k.clientY);
        t.cy.emit({
            originalEvent: k,
            type: "mouseover",
    ...
    t.registerBinding(t.container, "touchstart", U = m$1(function(k) {
        if (t.hasTouchStarted = true, !!B(k)) {
            ...
            if (k.touches[0]) {
                var G = t.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
                X[0] = G[0], X[1] = G[1];
            }
            if (k.touches[1]) {
                var G = t.projectIntoViewport(k.touches[1].clientX, k.touches[1].clientY);
                X[2] = G[0], X[3] = G[1];
            }
            if (k.touches[2]) {
                var G = t.projectIntoViewport(k.touches[2].clientX, k.touches[2].clientY);
                X[4] = G[0], X[5] = G[1];
            }
            if (k.touches[1]) {
                t.touchData.singleTouchMoved = true, p(t.dragData.touchDragEles);
                var ne = t.findContainerClientCoords();
                ...
                var de = 200, Ee = de * de;
                if (q < Ee && !k.touches[2]) {
                    var fe = t.findNearestElement(X[0], X[1], true, true), we = t.findNearestElement(X[2], X[3], true, true);
            ...
            if (k.touches[2]) F.boxSelectionEnabled() && k.preventDefault();
                ...
                if (k.touches[0]) {
                    var xe = t.findNearestElements(X[0], X[1], true, true), pe = xe[0];
                    if (pe != null && (pe.activate(), t.touchData.start = pe, t.touchData.starts = xe, t.nodeIsGrabbable(pe))) {
                        var Ne = t.dragData.touchDragEles = F.collection(), qe = null;
                        t.redrawHint("eles", true), t.redrawHint("drag", true), pe.selected() ? (qe = F.$(function(Qe) {
    ...
    var te;
    t.registerBinding(e, "touchmove", te = m$1(function(k) {
        var F = t.touchData.capture;
        if (!(!F && !B(k))) {
            var X = t.selection, V = t.cy, G = t.touchData.now, ne = t.touchData.earlier, _ = V.zoom();
            if (k.touches[0]) {
                var ie = t.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
                G[0] = ie[0], G[1] = ie[1];
            }
            if (k.touches[1]) {
                var ie = t.projectIntoViewport(k.touches[1].clientX, k.touches[1].clientY);
                G[2] = ie[0], G[3] = ie[1];
            }
            if (k.touches[2]) {
                var ie = t.projectIntoViewport(k.touches[2].clientX, k.touches[2].clientY);
                G[4] = ie[0], G[5] = ie[1];
            }
            ...
            if (F && t.touchData.cxt) {
                ...
                var it = t.findNearestElement(G[0], G[1], true, true);
                ...
                var It = t.touchData.start, bt = k.touches[0].clientX - Z, He = k.touches[0].clientY - J, Ze = k.touches[1].clientX - Z, Qe = k.touches[1].clientY - J, Ui = W(bt, He, Ze, Qe), ll = Ui / H;
                if (re) {
                ...
                if (!t.hoverData.draggingEles && !t.swipePanning && (it = t.findNearestElement(G[0], G[1], true, true)), F && kt != null && k.preventDefault(), F && kt != null && t.nodeIsDraggable(kt)) if (Ee) {
                ...
                if (F && (kt == null || kt.pannable()) && V.panningEnabled() && V.userPanningEnabled()) {
                    var yl = s(kt, t.touchData.starts);
                    yl && (k.preventDefault(), t.data.bgActivePosistion || (t.data.bgActivePosistion = Lr(t.touchData.startPosition)), t.swipePanning ? (V.panBy({
                        x: fe[0] * _,
                        y: fe[1] * _
    ...
    var se;
    t.registerBinding(e, "touchcancel", se = m$1(function(k) {
        var F = t.touchData.start;
        t.touchData.capture = false, F && F.unactivate();
    }, "touchcancelHandler"));
    var le, Se, Me, Le;
    if (t.registerBinding(e, "touchend", le = m$1(function(k) {
        ...
        var G = t.cy, ne = G.zoom(), _ = t.touchData.now, ie = t.touchData.earlier;
        if (k.touches[0]) {
            var de = t.projectIntoViewport(k.touches[0].clientX, k.touches[0].clientY);
            _[0] = de[0], _[1] = de[1];
        }
        if (k.touches[1]) {
            var de = t.projectIntoViewport(k.touches[1].clientX, k.touches[1].clientY);
            _[2] = de[0], _[3] = de[1];
        }
        if (k.touches[2]) {
            var de = t.projectIntoViewport(k.touches[2].clientX, k.touches[2].clientY);
            _[4] = de[0], _[5] = de[1];
        }
        F && F.unactivate();
        var Ee;
        ...
        if (!k.touches[2] && G.boxSelectionEnabled() && t.touchData.selecting) {
            ...
            var we = G.collection(t.getAllInBox(V[0], V[1], V[2], V[3]));
            ...
            if (!k.touches[0]) {
                if (!k.touches[0]) {
                    ...
                    if (F != null) {
                        ...
                        var qe = t.findNearestElement(_[0], _[1], true, true);
                        n(qe, [
                            "touchend",
                            "tapend",
                            "vmouseup",
                    ...
                    }, G.multiClickDebounceTime()), Le = k.timeStamp)), F != null && !t.dragData.didDrag && F._private.selectable && ft < t.touchTapThreshold2 && !t.pinching && (G.selectionType() === "single" ? (G.$(r).unmerge(F).unselect([
                        "tapunselect"
                    ]), F.select([
                        "tapselect"
...
Yt.generateBarrel = function() {
    return this.nodeShapes.barrel = {
        ...
        intersectLine: m$1(function(e, r, a, n, i, s, o, l) {
            var u = .15, f = .5, c = .85, d = this.generateBarrelBezierPts(a + 2 * o, n + 2 * o, e, r), g = m$1(function(y) {
                var p = Or({
                    x: y[0],
                    y: y[1]
                }, {
...
Yt.registerNodeShapes = function() {
    ...
    this.generateEllipse(), this.generatePolygon("triangle", dt(3, 0)), this.generateRoundPolygon("round-triangle", dt(3, 0)), this.generatePolygon("rectangle", dt(4, 0)), t.square = t.rectangle, this.generateRoundRectangle(), this.generateCutRectangle(), this.generateBarrel(), this.generateBottomRoundrectangle();
    {
        var r = [
            0,
            1,
    ...
    var a = new Array(20);
    {
        var n = ii(5, 0), i = ii(5, Math.PI / 5), s = .5 * (3 - Math.sqrt(5));
        s *= 1.57;
...
_e.getElement = function(t, e, r, a, n) {
    ...
    var u = Math.pow(2, a), f = e.h * u, c = e.w * u, d = s.eleTextBiggerThanMin(t, u);
    ...
    if (y.context.setTransform(1, 0, 0, 1, 0, 0), y.context.clearRect(y.usedWidth, 0, c, h), b1(C)) B();
        ...
        for(var A = T.level; A > a; A--)C = i.getElement(t, e, r, A, Ir.downscale);
        B();
    ...
    return g = {
        ...
        height: f,
        scaledLabelShown: d
    }, y.usedWidth += Math.ceil(c + up), y.eleCaches.push(g), l.set(t, a, g), i.checkTextureFullness(y), g;
};
...
_e.addTexture = function(t, e) {
    ...
    return a.push(n), n.eleCaches = [], n.height = t, n.width = Math.max(lp, e), n.usedWidth = 0, n.invalidatedWidth = 0, n.fullnessChecks = 0, n.canvas = r.renderer.makeOffscreenCanvas(n.width, n.height), n.context = n.canvas.getContext("2d"), n;
};
...
_e.queueElement = function(t, e) {
    ...
    if (s) s.level = Math.max(s.level, e), s.eles.merge(t), s.reqs++, a.updateItem(s);
    else {
        var o = {
...
var Ep = 1, ga = -4, xn = 2, Tp = 3.99, Cp = 50, Sp = 50, Dp = .15, kp = .1, Pp = .9, Bp = .9, Ap = 1, ro = 250, Rp = 4e3 * 4e3, ao = 32767, Mp = true, Gu = m$1(function(e) {
...
nt.getLayers = function(t, e, r) {
    ...
    var l = a.layersByLevel, u = Math.pow(2, r), f = l[r] = l[r] || [], c, d = a.levelIsComplete(r, t), g, h = m$1(function() {
    ...
    var m = m$1(function() {
        if (!c) {
            c = yt();
            for(var B = 0; B < t.length; B++)Fo(c, t[B].boundingBox());
        }
        return c;
...
nt.updateElementsInLayers = function(t, e) {
    for(var r = this, a = Aa(t[0]), n = 0; n < t.length; n++)for(var i = a ? null : t[n], s = a ? t[n] : t[n].ele, o = s._private.rscratch, l = o.imgLayerCaches = o.imgLayerCaches || {}, u = ga; u <= xn; u++){
        var f = l[u];
...
nt.invalidateElements = function(t) {
    var e = this;
    t.length !== 0 && (e.lastInvalidationTime = Ht(), !(t.length === 0 || !e.haveLayers()) && e.updateElementsInLayers(t, m$1(function(a, n, i) {
        e.invalidateLayer(a);
    }, "invalAssocLayers")));
};
nt.invalidateLayer = function(t) {
    if (this.lastInvalidationTime = Ht(), !t.invalid) {
...
nt.refineElementTextures = function(t) {
    var e = this;
    e.updateElementsInLayers(t, m$1(function(a, n, i) {
        var s = a.replacement;
    ...
    if (!(u.w === 0 || u.h === 0)) {
        ...
        if (f != null) {
            ...
            if (d !== 0) {
                ...
                w = T.x, x = T.y, t.translate(w, x), t.rotate(d), S = l.getImgSmoothing(t), S || l.setImgSmoothing(t, true);
...
_t.drawArrowShape = function(t, e, r, a, n, i, s, o, l) {
    var u = this, f = this.usePaths() && n !== "triangle-cross", c = false, d, g = e, h = {
        x: s,
        y: o
    }, m = t.pstyle("arrow-scale").value, y = this.getArrowWidth(a, m), p = u.arrowShapes[n];
    if (f) {
...
Gi.drawInscribedImage = function(t, e, r, a, n) {
    ...
    if (f(r, "background-width", "value", a) !== "auto" && (f(r, "background-width", "units", a) === "%" ? B = f(r, "background-width", "pfValue", a) * y : B = f(r, "background-width", "pfValue", a)), f(r, "background-height", "value", a) !== "auto" && (f(r, "background-height", "units", a) === "%" ? A = f(r, "background-height", "pfValue", a) * p : A = f(r, "background-height", "pfValue", a)), !(B === 0 || A === 0)) {
        ...
        var Y = t.globalAlpha;
        t.globalAlpha = S;
        var Z = i.getImgSmoothing(t), J = false;
...
Dr.eleTextBiggerThanMin = function(t, e) {
    if (!e) {
        var r = t.cy().zoom(), a = this.getPixelRatio(), n = Math.ceil(ki(r * a));
        e = Math.pow(2, n);
    }
...
Dr.drawText = function(t, e, r) {
    ...
    if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
        ...
        if (d != null && d !== "" && !isNaN(l) && !isNaN(u)) {
            ...
            var S;
            switch(a ? S = this.getTextAngle(e, r) : S = 0, S !== 0 && (f = l, c = u, t.translate(f, c), t.rotate(S), l = 0, u = 0), x){
                case "top":
                    break;
                case "center":
                    u += m / 2;
        ...
        var Se = m$1(function() {
            ...
            if (K > 0) {
                ...
                if (G === "ellipse") s.drawEllipsePath(we || t, V.x, V.y, de, Ee);
                    ...
                    var Gt = (ne + K + Q) / o;
                    fe = hn(gn(fe, Gt)), s.drawPolygonPath(we || t, V.x, V.y, o, l, fe);
                } else {
                    var it = (ne + K + Q) / o;
                    fe = hn(gn(fe, -it)), s.drawPolygonPath(we || t, V.x, V.y, o, l, fe);
                }
...
ht.createGradientStyleFor = function(t, e, r, a, n) {
    ...
    if (a === "radial-gradient") if (r.isEdge()) {
        ...
        i = t.createRadialGradient(c.x, c.y, 0, c.x, c.y, Math.max(d, g));
    } else {
        var h = s ? {
            x: 0,
            y: 0
        } : r.position(), m = r.paddedWidth(), y = r.paddedHeight();
        i = t.createRadialGradient(h.x, h.y, 0, h.x, h.y, Math.max(m, y));
    }
    else if (r.isEdge()) {
        var p = r.sourceEndpoint(), b1 = r.targetEndpoint();
        i = t.createLinearGradient(p.x, p.y, b1.x, b1.y);
    } else {
        var w = s ? {
            x: 0,
            y: 0
        ...
        switch(D){
            case "to-bottom":
                i = t.createLinearGradient(w.x, w.y - E, w.x, w.y + E);
                break;
            case "to-top":
                i = t.createLinearGradient(w.x, w.y + E, w.x, w.y - E);
                break;
            case "to-left":
                i = t.createLinearGradient(w.x + T, w.y, w.x - T, w.y);
                break;
            case "to-right":
                i = t.createLinearGradient(w.x - T, w.y, w.x + T, w.y);
                break;
            ...
            case "to-right-bottom":
                i = t.createLinearGradient(w.x - T, w.y - E, w.x + T, w.y + E);
                break;
            case "to-top-right":
            case "to-right-top":
                i = t.createLinearGradient(w.x - T, w.y + E, w.x + T, w.y - E);
...
ht.drawSelectionRectangle = function(t, e) {
    var r = this, a = r.cy, n = r.data, i = a.style(), s = t.drawOnlyNodeLayer, o = t.drawAllLayers, l = n.canvasNeedsRedraw, u = t.forcedContext;
...
function Wp(t, e, r) {
    var a = oo(t, t.VERTEX_SHADER, e), n = oo(t, t.FRAGMENT_SHADER, r), i = t.createProgram();
...
function _p(t, e, r, a) {
    var n = Xu(t, e), i = We(n, 2), s = i[0], o = i[1], l = Yu(t, o, a), u = t.createBuffer();
...
function wt(t, e, r, a) {
    var n = Xu(t, r), i = We(n, 3), s = i[0], o = i[1], l = i[2], u = Yu(t, o, e * s), f = s * l, c = t.createBuffer();
    ...
    for(var d = new Array(e), g = 0; g < e; g++)d[g] = Yp(t, o, u, f, s, g);
...
var ya = {
    ...
    function t(e, r) {
        ur(this, t), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.atlasSize = r.webglTexSize, this.rows = r.webglTexRows, this.enableWrapping = r.enableWrapping, this.texHeight = Math.floor(this.atlasSize / this.rows), this.maxTexWidth = this.atlasSize, this.texture = null, this.canvas = null, this.needsBuffer = true, this.freePointer = {
            x: 0,
            row: 0
        }, this.keyToLocation = new Map, this.canvas = r.createTextureCanvas(e, this.atlasSize, this.atlasSize), this.scratch = r.createTextureCanvas(e, this.atlasSize, this.texHeight, "scratch");
    }
    ...
    return m$1(t, "AtlasCollection"), lr(t, [
        ...
        },
        {
            ...
            value: m$1(function() {
                var r = new Set, a = xt(this.styleKeyToAtlas.keys()), n;
                try {
                    for(a.s(); !(n = a.n()).done;){
                        var i = n.value;
        ...
        },
        {
            ...
            value: m$1(function() {
                ...
                var i = [], s = new Map, o = null, l = xt(this.atlases), u;
                try {
                    var f = m$1(function() {
                        ...
                        if (o(g)) {
                            ...
                            try {
                                for(m.s(); !(y = m.n()).done;){
                                    ...
                                    if (u(p.type)) {
                                        var b1 = p.getKey(g);
                                        i ? (p.atlasCollection.deleteKey(h, b1), p.atlasCollection.styleKeyNeedsRedraw.add(b1), f = !0) : f |= p.atlasCollection.checkKeyIsInvalid(h, b1);
                                    }
                                }
                            } catch (w) {
                                m.e(w);
...
m$1(uy, "clearCanvas");
function ly(t) {
    var e = t.canvasWidth, r = t.canvasHeight, a = Wi(t), n = a.pan, i = a.zoom, s = pa();
    En(s, s, [
        n.x,
        n.y
    ]), Hi(s, s, [
...
function Ju(t, e) {
    var r = t.canvasWidth, a = t.canvasHeight, n = Wi(t), i = n.pan, s = n.zoom;
...
function cy(t) {
    var e = m$1(function(n, i, s) {
        for(var o = n.atlasManager.getRenderTypeOpts(i), l = t.data.contexts[t.NODE], u = .125, f = o.atlasCollection.atlases, c = 0; c < f.length; c++){
...
function dy(t, e, r, a, n) {
    var i, s, o, l, u = Wi(t), f = u.pan, c = u.zoom;
    if (a === void 0 || n === void 0) {
        var d = ti(t, f, c, e, r), g = We(d, 2), h = g[0], m = g[1], y = 6;
        i = h - y / 2, s = m - y / 2, o = y, l = y;
    } else {
        var p = ti(t, f, c, e, r), b1 = We(p, 2), w = b1[0], x = b1[1], S = ti(t, f, c, a, n), T = We(S, 2), E = T[0], D = T[1];
...
function hy(t, e, r) {
    var a = dy(t, e, r), n = t.getCachedZSortedEles(), i, s, o = xt(a), l;
    try {
        for(o.s(); !(l = o.n()).done;){
            var u = l.value, f = n[u];
...
function ju(t, e, r) {
    var a, n;
    t.webglDebug && (n = [], a = performance.now());
    ...
    if (r.screen && t.data.canvasNeedsRedraw[t.SELECT_BOX] && vy(t, e), t.data.canvasNeedsRedraw[t.NODE] || r.picking) {
        ...
        var u = ly(t), f = t.getCachedZSortedEles();
...
Fa.bufferCanvasImage = function(t) {
    ...
    if (t.scale !== void 0) i *= t.scale, s *= t.scale, u = t.scale;
        ...
        var f = 1 / 0, c = 1 / 0;
        ae(t.maxWidth) && (f = u * t.maxWidth / i), ae(t.maxHeight) && (c = u * t.maxHeight / s), u = Math.min(f, c), i *= u, s *= u;
    }
    o || (i *= l, s *= l, u *= l);
...
function gy(t, e) {
    for(var r = atob(t), a = new ArrayBuffer(r.length), n = new Uint8Array(a), i = 0; i < r.length; i++)n[i] = r.charCodeAt(i);
    return new Blob([
        a
    ], {
        type: e
...
m$1(tl, "output");
Fa.png = function(t) {
    return tl(t, this.bufferCanvasImage(t), "image/png");
};
Fa.jpg = function(t) {
    return tl(t, this.bufferCanvasImage(t), "image/jpeg");
};
var rl = {};
...
Cr.css = function(t, e) {
    ...
    else if (Pe(t)) for(var a = t, n = Object.keys(a), i = 0; i < n.length; i++){
        var s = n[i], o = a[s];
        if (o != null) {
