...
import { w as wf, B as Bf, S as Sf, v as vf, T as Tf, k as kf, W as Wl, X as DC, r as rh, aH as Vr, z as zl, b as bf, m as mC, aK as Wd } from "./vendor-min-mermaid~chunk-OR2G2HG5.CGE7obu6.chunk.js";
...
lt.parser = lt;
var G = lt;
var tt = [], et = [], Z = /* @__PURE__ */ new Map(), Ft = /* @__PURE__ */ m$1(() => {
  tt = [], et = [], Z = /* @__PURE__ */ new Map(), bf();
}, "clear"), ut = (_a = class {
  constructor(r, i, u = 0) {
    this.source = r;
    this.target = i;
...
}, __ = new WeakMap(), __privateAdd(_a, __, m$1(_a, "SankeyLink")), _a), Ht = /* @__PURE__ */ m$1((t, r, i) => {
  tt.push(new ut(t, r, i));
}, "addLink"), ft = (_b = class {
  constructor(r) {
    this.ID = r;
  }
}, __2 = new WeakMap(), __privateAdd(_b, __2, m$1(_b, "SankeyNode")), _b), Yt = /* @__PURE__ */ m$1((t) => {
  t = /* @__PURE__ */ mC.sanitizeText(t, /* @__PURE__ */ Wl());
  let r = /* @__PURE__ */ Z.get(t);
  return r === void 0 && (r = new ft(t), Z.set(t, r), et.push(r)), r;
}, "findOrCreateNode"), qt = /* @__PURE__ */ m$1(() => et, "getNodes"), Ut = /* @__PURE__ */ m$1(() => tt, "getLinks"), Xt = /* @__PURE__ */ m$1(() => ({
  ...
  nodesMap: Z,
  getConfig: /* @__PURE__ */ m$1(() => Wl().sankey, "getConfig"),
  getNodes: qt,
  getLinks: Ut,
  getGraph: Xt,
  addLink: Ht,
...
function rt() {
  ...
  function E(param) {
    let { nodes: n } = param;
    for (let f of n) f.value = f.fixedValue === void 0 ? Math.max(/* @__PURE__ */ F(f.sourceLinks, pt), /* @__PURE__ */ F(f.targetLinks, pt)) : f.fixedValue;
  }
  ...
  function B(n) {
    let f = /* @__PURE__ */ W(n, (h) => (u - r - (h.length - 1) * m) / F(h, pt));
    for (let h of n) {
      let d = r;
      for (let s of h) {
  ...
  function R(n) {
    ...
    for (let h = 0; h < p; ++h) {
      let d = /* @__PURE__ */ Math.pow(0.99, h), s = /* @__PURE__ */ Math.max(1 - d, (h + 1) / p);
      N(f, d, s), w(f, d, s);
    }
  }
...
var se = {
  ...
  center: dt,
  justify: Q
}, ae = /* @__PURE__ */ m$1(function(t, r, i, u) {
  let { securityLevel: c, sankey: S } = Wl(), m = DC.sankey, x;
  c === "sandbox" && (x = /* @__PURE__ */ rh("#i" + r));
  let o = c === "sandbox" ? rh(x.nodes()[0].contentDocument.body) : rh("body"), a = c === "sandbox" ? o.select(`[id="${r}"]`) : rh(`[id="${r}"]`), l = (S == null ? void 0 : S.width) ?? m.width, k = (S == null ? void 0 : S.height) ?? m.width, _ = (S == null ? void 0 : S.useMaxWidth) ?? m.useMaxWidth, p = (S == null ? void 0 : S.nodeAlignment) ?? m.nodeAlignment, v = (S == null ? void 0 : S.prefix) ?? m.prefix, C = (S == null ? void 0 : S.suffix) ?? m.suffix, E = (S == null ? void 0 : S.showValues) ?? m.showValues, M = /* @__PURE__ */ u.db.getGraph(), D = se[p];
...
${v}${Math.round(T * 100) / 100}${C}` : y;
  ...
  let N = /* @__PURE__ */ a.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(M.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), P = (S == null ? void 0 : S.linkColor) ?? "gradient";
  if (P === "gradient") {
  ...
  N.append("path").attr("d", /* @__PURE__ */ it()).attr("stroke", O).attr("stroke-width", (y) => Math.max(1, y.width)), zl(void 0, a, 0, _);
}, "draw"), Vt = {
  draw: ae
};
var Wt = /* @__PURE__ */ m$1((t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
`).trim(), "prepareTextForParsing");
var le = /* @__PURE__ */ G.parse.bind(G);
G.parse = (t) => le(/* @__PURE__ */ Wt(t));
var wn = {
  parser: G,
  db: Ot,
  renderer: Vt
