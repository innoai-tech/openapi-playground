...
var _e, _t, _n;
var e, t, n, a;
import { c as r, I as i, j as l, a as o, r as s, s as d, b as p, d as c, e as u, f as h, T as y, F as m, o as f, t as x, g as v } from "./lib-nodepkg-vuekit.BOSnaom6.chunk.js";
import { o as g, J as b, g as w, S as N, a as C, b as S, r as $, s as k, E as O } from "./lib-nodepkg-typedef.wThrm2fx.chunk.js";
import { s as E, v as I, P as T, a as A, b as D, B as R } from "./lib-nodepkg-vueuikit.CfNSk5ff.chunk.js";
import { I as J, a as L, m as P, b as M, c as B, d as _, e as W } from "./lib-nodepkg-vuematerial.66s2WbJK.chunk.js";
import { O as j, s as z, m as H, f as F, d as U, t as V, E as K, c as X, B as q, S as G } from "./vendor-rxjs.BHYITtPb.chunk.js";
import { i as Q, g as Y, a as Z, b as ee, s as et, l as en, c as ea, d as er, e as ei } from "./vendor-innoai-tech-lodash.BIpaKHXU.chunk.js";
import { M as el } from "./lib-nodepkg-vuemarkdown.BDgwosmJ.chunk.js";
...
_t = new WeakMap();
let eo = _eo;
let es = r(() => new eo(g(), {})), ed = r(() => ({})), ep = E("span", { displayName: "ActionToolbar" })({ px: 2, pos: "relative", display: "flex", alignItems: "center", gap: 8, visibility: "hidden" }), ec = E("span", (e6, t2) => {
  let { slots: n2 } = t2;
  return (e7) => {
    var _a;
    return l(e7, { children: l(ep, { "data-visible-on-hover": true, children: (_a = n2.default) == null ? void 0 : _a.call(n2) }) });
  };
}, { displayName: "Actions" })({ display: "flex" }), eu = E(L, { displayName: "ActionBtn" })({ transition: "none", width: 24, height: 24, rounded: 12, [`& ${J}`]: { svg: { width: 18, height: 18 } } });
class eh extends i {
  static from(e6) {
    let t2 = new eh(false);
...
let ey = D({ apply(e6) {
  ...
  return s(i2, r2((e7) => {
    var _a, _b, _c;
    return l(T, { isOpen: e7, onClickOutside: () => i2.hide(), onEscKeydown: () => i2.hide(), placement: "bottom-start", middleware: [ey], $content: l(ef, { onClick: o2, children: (_a = a2.content) == null ? void 0 : _a.call(a2) }), children: ((_c = (_b = a2.default) == null ? void 0 : _b.call(a2)) == null ? void 0 : _c[0]) ?? null });
  }));
...
o((e6, t2) => {
  ...
  return s(r2, a2((e7) => {
    var _a, _b, _c;
    return l(T, { isOpen: e7, onClickOutside: () => r2.hide(), placement: "bottom-start", $content: l(ef, { children: (_a = n2.content) == null ? void 0 : _a.call(n2) }), children: ((_c = (_b = n2.default) == null ? void 0 : _b.call(n2)) == null ? void 0 : _c[0]) ?? null });
  }));
}, { displayName: "Popover", props: ["open$"] });
let ef = E("div", { displayName: "PopoverContainer" })({ textStyle: "sys.body-small", pos: "relative", roundedBottom: "sm", containerStyle: "sys.surface-container-lowest", borderBottom: "1px solid", borderRight: "1px solid", borderLeft: "1px solid", borderColor: I("sys.outline-variant", A(0.38)) }), ex = E("div", { displayName: "MenuItem" })({ px: 8, py: 2, gap: 8, display: "flex", alignItems: "center", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" }, _focus: { containerStyle: "sys.surface-container", outline: 0 } }), ev = o((e6, t2) => {
  let { slots: n2, render: a2 } = t2, r2 = new eh(false);
  return s(r2, a2((t3) => {
    var _a;
    let a3 = (_a = n2.default) == null ? void 0 : _a.call(n2)[0];
    return l(T, { isOpen: t3, placement: e6.placement ?? "left", $content: l(eb, { children: l(eg, { children: n2.title() }) }), children: a3 ? p(a3, { onMouseover: () => {
      r2.show();
    }, onMouseout: () => {
      r2.hide();
    } }) : null });
  }));
}, { displayName: "Tooltip", props: ["placement"] }), eg = E("div", { displayName: "TooltipContainer" })({ py: 4, px: 12, rounded: "xs", shadow: "3", textStyle: "sys.body-small", containerStyle: "sys.on-surface", pos: "relative", zIndex: 100 }), eb = E("div", { displayName: "TooltipWrapper" })({ px: 8 }), ew = E("span", { displayName: "Token" })({ textStyle: "sys.label-small", fontWeight: "bold", fontFamily: "inherit", fontSize: 12, lineHeight: 24, wordBreak: "keep-all", whiteSpace: "nowrap", font: "code", opacity: 0.3 }), eN = o((e6, t2) => {
  let { slots: n2 } = t2;
  return () => {
    var _a;
    return u(eS, { "data-deprecated": e6.deprecated, "data-optional": e6.optional, "data-nullable": e6.nullable, children: [n2.leading && l(eC, { "data-visible-on-hover": true, children: n2.leading() }), (_a = n2.default) == null ? void 0 : _a.call(n2)] });
  };
}, { displayName: "PropName", props: ["deprecated", "optional", "nullable"] }), eC = E(ep, { displayName: "PropLeading" })({ position: "absolute", ml: -28 }), eS = E("div", { displayName: "PropNameView" })({ position: "relative", display: "flex", alignItems: "center", textStyle: "sys.label-small", fontWeight: "bold", fontFamily: "inherit", wordBreak: "keep-all", whiteSpace: "nowrap", border: "1px solid", borderColor: "rgba(0,0,0,0)", fontSize: 12, lineHeight: 24, _deprecated: { textDecoration: "line-through" }, _optional: { "&:after": { content: '"?"', color: "sys.secondary", opacity: 0.58 } } }), e$ = E("div", { displayName: "LineTitle" })({ position: "absolute", zIndex: 1, left: 0, opacity: 0.58, fontSize: 10, lineHeight: 10, top: 0, "& > *": { display: "flex", alignItems: "center", gap: 4, "&::before": { content: '"// "', font: "code" } } }), ek = E("div", { displayName: "LineError" })({ display: "block", fontSize: 10, lineHeight: 14, color: "sys.error" }), eO = E("div", { displayName: "LineContainer" })({ position: "relative", py: 4, _hover: { containerStyle: "sys.surface-container", "& [data-visible-on-hover]": { visibility: "visible" } }, "&:focus-within": { containerStyle: "sys.surface-container" }, _dirty: { bgColor: I("sys.warning-container", A(0.38)) }, _error: { bgColor: "sys.error-container" }, [`&:has(${ec})`]: { [`& > ${ek}`]: { display: "none" }, _error: { bgColor: "inherit" } } }), eE = r(() => ({ indent: 0, $container: h(null) }), { name: "IntentContext" }), eI = c((e6, t2) => {
  let { slots: n2 } = t2, a2 = eE.use(), r2 = h(null), i2 = h(null);
  return () => {
    var _a, _b, _c;
    return u(m, { children: [l(ew, { children: e6.openToken }), (_a = n2.leading) == null ? void 0 : _a.call(n2), u(y, { to: a2.$container.value, children: [u(eD, { "data-indent": a2.indent, children: [l(eA, { ref: r2 }), l(eR, { ref: i2 }), i2.value && l(eE, { value: { $container: i2, indent: 1 + (a2.indent ?? 0) }, children: (_b = n2.trailing) == null ? void 0 : _b.call(n2) })] }), l(eJ, { style: { paddingLeft: `${32 * a2.indent}px`, display: "flex" }, children: l(ew, { children: e6.closeToken }) })] }), r2.value && l(eE, { value: { $container: r2, indent: 1 + (a2.indent ?? 0) }, children: (_c = n2.default) == null ? void 0 : _c.call(n2) })] });
  };
}, { displayName: "Block", props: ["openToken", "closeToken"] }), eT = o((e6, t2) => {
  let { slots: n2, render: a2 } = t2, r2 = eE.use(), i2 = s(es.use().error$, a2((t3) => {
    var _a;
    let a3 = b.create(e6.path), i3 = !e6.viewOnly && !!t3[a3];
    return u(eO, { "data-error": i3, "data-dirty": e6.dirty, style: { paddingLeft: `${32 * r2.indent}px` }, children: [(e6.title || e6.description) && l(e$, { style: { paddingLeft: `${32 * r2.indent}px` }, children: e6.description ? l(ev, { $title: l(eL, { children: l(el, { text: e6.description }) }), children: u("div", { children: [e6.title, " ", l(J, { path: P })] }) }) : l("span", { children: e6.title }) }), l(eJ, { children: (_a = n2.default) == null ? void 0 : _a.call(n2) }), i3 && l(ek, { children: `${t3[a3]}` })] });
  }));
...
}()), eB = o((e6, t2) => () => l(ev, { $title: "复制当前节点为 JSON 字符串", children: l(eu, { type: "button", onClick: () => eM(JSON.stringify(e6.value, null, 2)), children: l(J, { path: M }) }) }), { displayName: "CopyAsJSONIconBtn", props: ["value"] });
class e_ extends q {
  static from(e6) {
    let t2 = new e_("");
...
class ej extends j {
  ...
  static sync(e6, t2) {
    return s(H(s(e6, V((e7) => {
      e7 && e7 == b.create(t2.path()) && t2.editing$.show();
  ...
  enable(e6) {
    __privateGet(this, _n).value || __privateGet(this, _n).next(b.create(e6));
  }
  disable(e6) {
    __privateGet(this, _n).value === b.create(e6) && __privateGet(this, _n).next(null);
  }
}
_n = new WeakMap();
let ez = r(() => new ej()), eH = o((e6, t2) => {
  let n2, { render: a2 } = t2, r2 = f(null), o2 = f(null), p2 = f(null), c2 = eW.from(p2), h2 = e_.from(p2), y2 = ez.use(), m2 = eh.from(p2), v2 = es.use();
  ej.sync(y2, { editing$: m2, value$: e6.value$, path: () => e6.ctx.path });
  let g2 = () => {
    ...
    w2(), b2.next({ index: g2() }), Z(e6.value) && v2.delete(e6.ctx.path);
  }, S2 = (t3) => {
    var _a, _b;
    if ("enums" === e6.typedef.type) {
  ...
  return (e6.allowRawJSON && s(h2, V((t3) => {
    let n3 = t3.trim();
    ...
    if (e7) {
      ...
      return a3(e7), H(s(F(e7, "blur"), V((t4) => {
        var _a, _b;
        t4.relatedTarget && (((_a = o2.value) == null ? void 0 : _a.contains(t4.relatedTarget)) || ((_b = r2.value) == null ? void 0 : _b.contains(t4.relatedTarget))) || (t4.preventDefault(), S2(e7.value));
      })), s(F(e7, "input"), V((e9) => {
        a3(e9.target), h2.next(e9.target.value);
      })));
    }
    return K;
  }))), d()), "enums" == e6.typedef.type) ? s(X([e6.value$, m2, b2]), a2((t3) => {
  ...
  return s(e6.value$, n2((t3) => l(eI, { openToken: "{", closeToken: "}", $leading: l(ec, { children: l(eB, { value: t3 }) }), $trailing: l(eG, { ctx: e6.ctx, onAdd: (t4) => {
    ...
    return u(eT, { path: d2, dirty: a2.isDirty(o2, d2), title: N.metaProp(s2, "title"), description: N.metaProp(s2, "description"), children: [l(eN, { deprecated: N.schemaProp(s2, "deprecated"), $leading: l(eX, { onRemove: () => {
      a2.delete(d2);
    } }), children: String(i2) }), u(ew, { children: [":", " "] }), (_a = r2.$value) == null ? void 0 : _a.call(r2, s2, o2, { ...e6.ctx, path: d2, branch: [...e6.ctx.branch, o2] })] });
  }) })));
}, { displayName: "ObjectInput", props: ["typedef", "ctx", "value"] }), eG = o((e6, t2) => {
  let { emit: n2, render: a2 } = t2, r2 = f(null), o2 = eW.from(r2), p2 = e_.from(r2), c2 = eh.from(r2), h2 = es.use(), y2 = new i({ index: 0 }), m2 = () => {
  ...
  s(p2, V((t3) => {
    ...
    if (n3.startsWith("{") && n3.endsWith("}")) try {
      let t4 = JSON.parse(n3);
      h2.update(e6.ctx.path, t4), m2();
    } catch (t4) {
      h2.setError(e6.ctx.path, "无效的 JSON 字符串");
    }
  }), d());
  let x2 = (t3) => {
    var _a;
    e6.options ? t3 ?? (t3 = (_a = e6.options[y2.value.index % e6.options.length]) == null ? void 0 : _a.propName) : t3 ?? (t3 = p2.value), t3 ? (n2("add", t3), m2()) : h2.setError([...e6.ctx.path, N.RecordKey], "无效的属性值");
  };
  s(o2, V((e7) => {
    switch (e7.type) {
      case "SELECT":
  ...
  return s(X([p2, c2, y2, e6.options$]), a2((t3) => {
    ...
    return s2 ? s2.length > 0 ? l(eT, { path: e6.ctx.path, children: l(eU, { sx: { mx: -4 }, children: l(em, { onSelected: (e7) => {
      x2(e7);
    }, open$: c2, $content: l("div", { children: s2.map((e7, t4) => n3 && !e7.propName.includes(n3) ? null : l(eQ, { propName: e7.propName, typedef: e7.typedef, "data-focus": t4 === i2.index % s2.length })) }), children: v2 }) }) }) : null : l(eT, { path: [...e6.ctx.path, N.RecordKey], children: l(eU, { sx: { mx: -4 }, children: l(T, { isOpen: a3, placement: "right-start", $content: u(eF, { children: [l(eu, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: l(J, { path: B }) }), l(eu, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: l(J, { path: _ }) })] }), children: l("div", { "data-input-wrapper": true, children: l("input", { ref: r2, type: "text", placeholder: "添加属性 (可粘贴 JSON 字符串)" }) }) }) }) });
  }));
}, { displayName: "PropValueInput", props: ["ctx", "options"], emits: ["add"] }), eQ = c((e6) => () => u(eY, { "data-value": e6.propName, tabindex: 0, children: [l(eN, { optional: N.schemaProp(e6.typedef, N.optional), children: e6.propName }), l(eL, { children: N.metaProp(e6.typedef, "title") })] }), { displayName: "PropMenuItem", props: ["propName", "typedef"] }), eY = E(ex, { displayName: "AddPropMenuItemContainer" })({ [`& ${eN}`]: { textAlign: "left" } }), eZ = o((e6, t2) => {
  let { render: n2 } = t2, a2 = es.use(), r2 = ed.use();
  return s(e6.value$, n2((t3) => l(eI, { openToken: "[", closeToken: "]", $leading: l(ec, { children: l(eB, { value: t3 }) }), $trailing: l(e0, { ctx: e6.ctx, typedef: e6.typedef, onAdd: (t4) => {
    ...
    return u(eT, { path: s2, dirty: a2.isDirty(i2, s2), children: [l(eN, { $leading: l(e1, { onRemove: () => {
      a2.delete(s2);
  ...
  let { emit: n2, render: a2 } = t2, r2 = f(null), i2 = e_.from(r2), o2 = eW.from(r2), p2 = eh.from(r2), c2 = es.use(), h2 = () => {
  ...
  let m2 = s(p2, a2((e7) => l(T, { isOpen: e7, placement: "right-start", $content: u(eF, { children: [l(eu, { type: "button", onClick: () => o2.next({ type: "CANCEL" }), children: l(J, { path: B }) }), l(eu, { type: "button", onClick: () => o2.next({ type: "COMMIT" }), children: l(J, { path: _ }) })] }), children: l("div", { "data-input-wrapper": true, children: l("input", { ref: r2, type: "text", placeholder: "添加数组项 (可粘贴 JSON 字符串)" }) }) })));
  ...
  let { emit: n2 } = t2;
  return () => l(ev, { $title: "移除项", children: l(eu, { type: "button", onClick: () => n2("remove"), children: l(J, { path: W }) }) });
  ...
  return s(e6.value$, n2((t3) => l(eI, { openToken: "{", closeToken: "}", $leading: l(ec, { children: l(eB, { value: t3 }) }), $trailing: l(eG, { ctx: e6.ctx, onAdd: (t4) => {
    ...
    if (!Object.hasOwn(t3, i2)) return null;
    let d2 = [...e6.ctx.path, i2];
    return u(eT, { path: d2, dirty: a2.isDirty(o2, d2), children: [l(eN, { $leading: l(eX, { onRemove: () => {
      a2.delete(d2);
    } }), children: String(i2) }), u(ew, { children: [":", " "] }), (_a = r2.$value) == null ? void 0 : _a.call(r2, s2, o2, { ...e6.ctx, path: d2, branch: [...e6.ctx.branch, o2] })] });
  }) })));
}, { displayName: "RecordInput", props: ["ctx", "value", "typedef"] }), e2 = o((e6, t2) => {
  let { render: n2 } = t2;
  return s(e6.value$, n2((t3) => er(t3) ? l(eZ, { value: t3, typedef: C(S()), ctx: e6.ctx }) : ei(t3) ? l(e8, { value: t3, typedef: $(k(), S()), ctx: e6.ctx }) : l(eH, { value: t3, typedef: S(), ctx: e6.ctx, allowRawJSON: true })));
  ...
  return s(a2, n2((e7) => {
    let t3 = r2.$value ?? e4;
    return l(ez, { children: l(ed, { value: { $value: r2.$value ?? e4 }, children: u(e5, { children: [l("section", { ref: i2 }), i2.value && l(eE, { value: { indent: 0, $container: i2 }, children: l(eT, { path: [], viewOnly: true, children: t3(a2.typedef, e7, O) }) })] }) }) });
  }));
