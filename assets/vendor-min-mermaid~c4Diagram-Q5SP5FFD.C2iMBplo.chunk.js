import { A as $o, D as f, Et as v, F as Go, I as Ho, Ot as zt$1, Q as Uo, bt as ot, dt as hn, et as Wo, g as St, gt as mr, h as M, hn as pt, ln as ia, y as Wt } from "./vendor-min-mermaid~architectureDiagram-4X3Z3J56.BVgxNvHA.chunk.js";
...
var Pe = /* @__PURE__ */ m(function(e, t, s) {
	...
	z("label", t, o, l, n), V.drawBoundary(e, t, x$1);
	...
	for (let n of o) {
		...
		if (d$1.fontSize = d$1.fontSize + 2, d$1.fontWeight = "bold", z("label", a, i$1, d$1, u), a.label.Y = l + 8, l = a.label.Y + a.label.height, a.type && a.type.text !== "") {
			...
			let E$1 = /* @__PURE__ */ Bt(x$1, a.typeC4Shape.text);
			z("type", a, i$1, E$1, u), a.type.Y = l + 5, l = a.type.Y + a.type.height;
		} else if (a.techn && a.techn.text !== "") {
			a.techn.text = "[" + a.techn.text + "]";
			let E$1 = /* @__PURE__ */ Bt(x$1, a.techn.text);
			z("techn", a, i$1, E$1, u), a.techn.Y = l + 5, l = a.techn.Y + a.techn.height;
		}
		let b = l, p = a.label.width;
		if (a.descr && a.descr.text !== "") {
			let E$1 = /* @__PURE__ */ Bt(x$1, a.typeC4Shape.text);
			z("descr", a, i$1, E$1, u), a.descr.Y = l + 20, l = a.descr.Y + a.descr.height, p = /* @__PURE__ */ Math.max(a.label.width, a.descr.width), b = l - a.descr.textLines * 5;
		}
	...
	for (let n of t) {
		...
		let d$1 = /* @__PURE__ */ s(n.from), b = /* @__PURE__ */ s(n.to), p = /* @__PURE__ */ D0(d$1, b);
