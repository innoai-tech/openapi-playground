...
import { i as T, B as F, d as B, t as L, a as P, C as W, g as R, h as J, D as H, c as A, f as M, F as z, J as V, G as U, j as E, o as K } from "./lib-nodepkg-typedef.C-lDlS3A.chunk.js";
...
let eS = function() {
  ...
  let t2 = new URLSearchParams(), r2 = (e11, n2) => {
    ...
    P(n2) || 0 === `${n2}`.length || t2.append(e11, `${n2}`);
  };
  return F(e10, (e11, t3) => {
    r2(t3, e11);
  }), t2.toString();
  ...
  if (eO(t2)) {
    ...
    let r2 = new FormData(), n2 = (e11, t3) => {
      t3 instanceof File || t3 instanceof Blob ? r2.append(e11, t3) : B(t3) ? F(t3, (t4) => n2(e11, t4)) : L(t3) ? r2.append(e11, JSON.stringify(t3)) : r2.append(e11, t3);
    };
    return F(e10, (e11, t3) => n2(t3, e11)), r2;
  }
  return ej(t2) ? ek(e10) : B(e10) || L(e10) ? JSON.stringify(e10) : e10;
}, eN = (e10) => {
...
let eT = function(e10) {
...
}, eF = f(() => eq.empty(), { name: "OpenAPI" }), eB = (e10) => (t2, r2) => t2[e10] == r2[e10] ? 0 : t2[e10] < r2[e10] ? -1 : 1, eL = y((e10, t2) => {
  let {} = e10, {} = t2, n2 = eF.use(), a2 = new d({ operationId: void 0 }), o2 = new r();
  c(o2, v(200), i((e11) => {
    a2.next((t3) => {
  ...
  let l2 = c(a2, p((e11) => n2.operations$(e11)), b((e11) => {
    ...
    return G(eW, { children: [Q(eR, { children: Q("input", { type: "text", placeholder: "请输入 operationId 查询", onInput: (e12) => {
      ...
      let [t4, r2] = e12;
      return G("div", { "data-nav-group": true, children: [Q("div", { "data-nav-group-heading": true, children: t4 }), Q("div", { "data-nav-group-contents": true, children: null == r2 ? void 0 : r2.toSorted(eB("operationId")).map((e13) => {
        var t5;
  ...
  return () => G(eP, { children: [l2, Q(eH, { children: Q($, {}) })] });
...
let e4 = Object.assign(ez, { displayName: "Token" }), e2 = Object.assign(eV, { displayName: "PropName" }), e8 = Object.assign(eU, { displayName: "Line" }), e6 = Object.assign(eE, { displayName: "Description" }), e3 = Object.assign(eQ, { displayName: "Indent" }), e5 = Object.assign(e0, { displayName: "SchemaView" }), e7 = y({ code: A(), response: A() }, (e10) => {
  ...
  return () => {
    ...
    return G(e9, { children: [Q(te, { "data-failed": function(e11) {
      ...
      return e12.startsWith("StatusError{") ? e12.slice(12, e12.length - 1).split(",").reduce((e13, t3) => {
        ...
        return P(r3) || P(n3) ? e13 : { ...e13, [r3]: n3 };
      }, {}) : null;
  ...
  let {} = t2, r2 = eo(P(e10.field$.input) ? "" : ev.stringify(e10.field$.input));
...
${L(n2) ? JSON.stringify(n2) : String(n2)}
`;
  ...
  return G(th, { children: [Q(tp, { ...t2 }), Q(w, { children: Object.entries({ ...td(), ...t2.headers }).toSorted().map((e11) => {
    ...
    if (tv(e11.headers).includes("multipart/form-data")) {
    ...
    return tv(e11.headers).includes("application/x-www-form-urlencoded") ? ek(e11.body) : tb(e11.headers) ? JSON.stringify(e11.body, null, 2) : e11.body;
  }(t2)] })] });
}), tf = (e10) => Buffer.from(e10).toString("utf8"), ty = (e10, t2) => {
...
}, tg = _({ response: A() }, (e10, t2) => {
  let {} = t2;
  return () => {
    let t3 = e10.response;
    return tv(t3.headers).includes("image/") ? Q("div", { children: Q("img", { src: ty(t3.body, tv(t3.headers)), alt: "" }) }) : G(th, { children: [G("span", { children: ["HTTP/* ", t3.status] }), Q("br", {}), t3.headers && Q(w, { children: Object.entries(t3.headers).map((e11) => {
      let [t4, r2] = e11;
      return Q(tc, { field: t4, value: r2 }, t4);
    }) }), Q("br", {}), t3.body ? tb(t3.headers) ? JSON.stringify(t3.body, null, 2) : `${tf(t3.body)}` : null] });
  };
});
function tv() {
  let e10 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
...
let tb = (e10) => tv(e10).includes("application/json"), tx = Object.assign(tm, { displayName: "HttpRequest" }), t$ = Object.assign(tg, { displayName: "HTTPResponse" }), t_ = y({ operationID: M() }, (e10) => c(eF.use().response$(e10.operationID), b((e11) => Q(tw, { children: Q(t$, { response: e11 }) })))), tw = X("section")({ maxHeight: "40vh", overflow: "auto" }), tS = Object.assign(t_, { displayName: "ResponsePreview" }), tI = y({ operation: A(), $default: A() }, (e10, t2) => {
  var r2, n2, a2, o2;
  let { slots: l2 } = t2, s2 = eF.use(), d2 = {};
  ...
  if (e10.operation.requestBody) {
    ...
    if (t3) {
      ...
      e11.includes("json") ? d2.body = n3.use(et(ts)) : e11.includes("octet-stream") ? d2.body = n3.use(et(tq)) : d2.body = n3;
    }
  }
  ...
  let m2 = c(h2.inputs$, b((t3) => {
    ...
    return r3 ? Q(tx, { request: r3(t3) }) : null;
  }));
  return () => {
    var t3;
  ...
  return k(() => {
    ...
    var t3, n3, i2, a2, o2;
    let [l2, s2] = e11, d2 = null !== (i2 = null === (t3 = r2.meta) || void 0 === t3 ? void 0 : t3.input) && void 0 !== i2 ? i2 : tN, c2 = null !== (a2 = null === (n3 = r2.meta) || void 0 === n3 ? void 0 : n3.readOnlyWhenInitialExist) && void 0 !== a2 && a2 && !!l2.initial;
    return Q(ta, { valued: !P(null != s2 ? s2 : l2.initial), invalid: !!l2.error, focus: !!l2.focus, $label: G("span", { children: [null !== (o2 = r2.meta.label) && void 0 !== o2 ? o2 : r2.name, r2.optional ? "（非必填）" : ""] }), $supporting: G(e8, { children: [Q(e6, { schema: r2.typedef }), Q(e5, { schema: r2.typedef })] }), $trailing: d2.$trailing, children: Q(d2, { field$: r2, readOnly: c2 }) });
  }));
}), tj = _({ readOnly: J().optional(), field$: A() }, (e10) => () => {
...
}), tk = y({ field$: A(), readOnly: J().optional(), accept: M().optional() }, (e10) => {
  let t2 = N(null);
  return c(t2, i((t3) => {
...
}), tC = Object.assign(tI, { displayName: "RequestBuilder" }), tN = Object.assign(tj, { displayName: "TextInput" }), tq = Object.assign(tk, { displayName: "FileSelectInput" }), tD = y({ operationId: M() }, (e10, t2) => {
  let {} = t2, r2 = eF.use(), n2 = c(e10.operationId$, p((e11) => r2.operation$(e11))), i2 = c(n2, D((e11) => !!e11)), a2 = c(i2, b((e11) => {
    var t3;
  ...
  })), o2 = c(i2, b((e11) => Q("span", { children: e11.description }))), l2 = c(i2, b((e11) => {
    var t3;
    return Q(tC, { operation: e11, children: Q(w, { children: Object.entries(null !== (t3 = e11.responses) && void 0 !== t3 ? t3 : {}).map((e12) => {
      let [t4, r3] = e12;
      return Q(tr, { code: t4, response: r3 }, t4);
    }) }) }, e11.operationId);
  }));
  return c(n2, b((e11) => e11 ? G(tT, { children: [a2, G(Y, { sx: { flex: 1, overflow: "hidden", py: 24, display: "flex", flexDirection: "column", alignItems: "stretch" }, children: [o2, Q(Y, { sx: { flex: 1, overflow: "auto" }, children: l2 })] })] }, e11.operationId) : null));
}), tT = X("div")({ height: "100%", display: "flex", flexDirection: "column", alignItems: "stretch" }), tF = X("div")({ display: "flex", alignItems: "center", width: "100%", px: 16, py: 8, gap: 16, $data_operation_method: { textTransform: "uppercase", fontSize: 24, fontFamily: "code" }, $data_operation_path: { fontFamily: "code" }, $data_operation_summary: { opacity: 0.8, textStyle: "sys.body-small" } }), tB = Object.assign(tD, { displayName: "OperationView" });
export {
  eF as O,
  tB as a,
  eM as b,
