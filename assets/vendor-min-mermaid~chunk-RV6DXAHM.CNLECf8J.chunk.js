...
var t = /*#__PURE__*/ m$1((n)=>Array.isArray(n) ? {
        x: n[0],
        y: n[1]
    } : n, "pointTransformer"), w = /*#__PURE__*/ m$1((n)=>({
        x: /*#__PURE__*/ m$1(function(o, c, e) {
            ...
            let l = /*#__PURE__*/ Math.abs(t(o).x - t(e[e.length - 1]).x), m = /*#__PURE__*/ Math.abs(t(o).y - t(e[e.length - 1]).y), i = /*#__PURE__*/ Math.abs(t(o).x - t(e[0]).x), x = /*#__PURE__*/ Math.abs(t(o).y - t(e[0]).y), u = s[n.arrowTypeStart], y = s[n.arrowTypeEnd], g = 1;
            if (l < y && l > 0 && m < y) {
                let r = y + g - l;
                r *= f === "right" ? -1 : 1, a -= r;
            }
        ...
        y: /*#__PURE__*/ m$1(function(o, c, e) {
            ...
            let l = /*#__PURE__*/ Math.abs(t(o).y - t(e[e.length - 1]).y), m = /*#__PURE__*/ Math.abs(t(o).x - t(e[e.length - 1]).x), i = /*#__PURE__*/ Math.abs(t(o).y - t(e[0]).y), x = /*#__PURE__*/ Math.abs(t(o).x - t(e[0]).x), u = s[n.arrowTypeStart], y = s[n.arrowTypeEnd], g = 1;
            if (l < y && l > 0 && m < y) {
                let r = y + g - l;
                r *= f === "up" ? -1 : 1, a -= r;
            }
