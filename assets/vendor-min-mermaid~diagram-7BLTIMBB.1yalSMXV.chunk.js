...
import { d as d$1 } from './vendor-min-mermaid~chunk-MEBTFSOL.cBCPBz3V.chunk.js';
...
import { B as Bf, F as Ff, L as Lf, M as Mf, w as wf, v as vf, T as Tf, S as Sf, E as Er, p as pl, t as tt } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
...
var H = m$1((t, e, i, s)=>{
    let c = s.db, r = c.getConfig(), { rowHeight: o, paddingY: m, bitWidth: y, bitsPerRow: l } = r, P = c.getPacket(), n = c.getDiagramTitle(), f = o + m, p = f * (P.length + 1) - (n ? 0 : o), k = y * l + 2, g = d$1(e);
