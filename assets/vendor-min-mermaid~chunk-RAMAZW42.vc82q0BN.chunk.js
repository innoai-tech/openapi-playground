...
var Ys = /*#__PURE__*/ n((Po, Wo)=>{
    (function(t, e) {
        typeof Po == "object" && typeof Wo < "u" ? Wo.exports = /*#__PURE__*/ e() : typeof define == "function" && define.amd ? define(e) : (t = typeof globalThis < "u" ? globalThis : t || self).dayjs = /*#__PURE__*/ e();
    })(Po, function() {
        var t = 1e3, e = 6e4, r = 36e5, o = "millisecond", n = "second", a = "minute", s = "hour", l = "day", c = "week", h = "month", u = "quarter", p = "year", f = "date", g = "Invalid Date", T = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, A = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, W = {
            name: "en",
            ...
            var M = /*#__PURE__*/ String(k);
            return !M || M.length >= x ? k : "" + Array(x + 1 - M.length).join(y) + k;
        }, "m"), G = {
            s: q,
            z: /*#__PURE__*/ m$1(function(k) {
                var x = -k.utcOffset(), y = /*#__PURE__*/ Math.abs(x), M = /*#__PURE__*/ Math.floor(y / 60), S = y % 60;
                return (x <= 0 ? "+" : "-") + q(M, 2, "0") + ":" + q(S, 2, "0");
            }, "z"),
            m: /*#__PURE__*/ m$1(function k(x, y) {
                if (x.date() < y.date()) return -k(y, x);
                var M = 12 * (y.year() - x.year()) + (y.month() - x.month()), S = /*#__PURE__*/ x.clone().add(M, h), z = y - S < 0, I = /*#__PURE__*/ x.clone().add(M + (z ? -1 : 1), h);
                return +(-(M + (y - S) / (z ? S - I : I - S)) || 0);
            }, "t"),
        ...
        }, "S"), X = /*#__PURE__*/ m$1(function k(x, y, M) {
            var S;
            if (!x) return D;
            if (typeof x == "string") {
        ...
        var it = /*#__PURE__*/ function() {
            ...
            return x.parse = function(y) {
                this.$d = /*#__PURE__*/ function(M) {
                    var S = M.date, z = M.utc;
            ...
            }, x.isSame = function(y, M) {
                var S = /*#__PURE__*/ j(y);
                return this.startOf(M) <= S && S <= this.endOf(M);
            }, x.isAfter = function(y, M) {
                return j(y) < this.startOf(M);
            }, x.isBefore = function(y, M) {
                return this.endOf(M) < j(y);
            }, x.$g = function(y, M, S) {
                return $.u(y) ? this[M] : this.set(S, y);
            }, x.unix = function() {
                return Math.floor(this.valueOf() / 1e3);
            }, x.valueOf = function() {
                return this.$d.getTime();
            }, x.startOf = function(y, M) {
                var S = this, z = !!$.u(M) || M, I = /*#__PURE__*/ $.p(y), U = /*#__PURE__*/ m$1(function(_t, lt) {
                ...
                var S, z = /*#__PURE__*/ $.p(y), I = "set" + (this.$u ? "UTC" : ""), U = (S = {}, S[l] = I + "Date", S[f] = I + "Date", S[h] = I + "Month", S[p] = I + "FullYear", S[s] = I + "Hours", S[a] = I + "Minutes", S[n] = I + "Seconds", S[o] = I + "Milliseconds", S)[z], rt = z === l ? this.$D + (M - this.$W) : M;
                if (z === h || z === p) {
                ...
                var S, z = this;
                y = /*#__PURE__*/ Number(y);
                var I = /*#__PURE__*/ $.p(M), U = /*#__PURE__*/ m$1(function(nt) {
                    var Q = /*#__PURE__*/ j(z);
                ...
                if (I === l) return U(1);
                if (I === c) return U(7);
                var rt = (S = {}, S[a] = e, S[s] = r, S[n] = t, S)[I] || 1, Y = this.$d.getTime() + y * rt;
                return $.w(Y, this);
            }, x.subtract = function(y, M) {
                return this.add(-1 * y, M);
            }, x.format = function(y) {
                var M = this, S = /*#__PURE__*/ this.$locale();
                ...
                var z = y || "YYYY-MM-DDTHH:mm:ssZ", I = /*#__PURE__*/ $.z(this), U = this.$H, rt = this.$m, Y = this.$M, nt = S.weekdays, Q = S.months, Ft = S.meridiem, Z = /*#__PURE__*/ m$1(function(lt, v, H, V) {
                    return lt && (lt[v] || lt(M, z)) || H[v].slice(0, V);
                    ...
                    return v || function(H) {
                        switch(H){
                            ...
                            case "d":
                                return String(M.$W);
                            case "dd":
                                return Z(S.weekdaysMin, M.$W, nt, 2);
                            case "ddd":
                                return Z(S.weekdaysShort, M.$W, nt, 3);
                            case "dddd":
                                return nt[M.$W];
                            case "H":
                                return String(U);
            ...
            }, x.diff = function(y, M, S) {
                var z, I = this, U = /*#__PURE__*/ $.p(M), rt = /*#__PURE__*/ j(y), Y = (rt.utcOffset() - this.utcOffset()) * e, nt = this - rt, Q = /*#__PURE__*/ m$1(function() {
                    return $.m(I, rt);
                }, "D");
                switch(U){
                    case p:
                ...
                return L[this.$L];
            }, x.locale = function(y, M) {
                if (!y) return this.$L;
                var S = /*#__PURE__*/ this.clone(), z = /*#__PURE__*/ X(y, M, true);
                return z && (S.$L = z), S;
            }, x.clone = function() {
        ...
        return j.prototype = B, [
            ...
            return j(1e3 * k);
        }, j.en = L[D], j.Ls = L, j.p = {}, j;
    });
});
var Gs = /*#__PURE__*/ q(/*#__PURE__*/ Ys());
var ne = {
    trace: 0,
    debug: 1,
    info: 2,
...
}, "setLogLevel"), Pt = /*#__PURE__*/ m$1((t)=>`%c${(0, Gs.default)().format("ss.SSS")} : ${t} : `, "format");
...
var Ti = {}, dx = /*#__PURE__*/ m$1(function(t, e) {
    t = /*#__PURE__*/ t.replace(Xs, "").replace(js, "").replace(Zs, `
`);
    ...
    for (let { id: e, detector: r, loader: o } of t)$o(e, r, o);
}, "registerLazyLoadedDiagrams"), $o = /*#__PURE__*/ m$1((t, e, r)=>{
...
var Ho = m$1(function(t, e) {
    let { depth: r = 2, clobber: o = false } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    let n = {
        depth: r,
        clobber: o
    };
    return Array.isArray(e) && !Array.isArray(t) ? (e.forEach((a)=>Ho(t, a, n)), t) : Array.isArray(e) && Array.isArray(t) ? (e.forEach((a)=>{
        ...
        typeof e[a] == "object" && (t[a] === void 0 || typeof t[a] == "object") ? (t[a] === void 0 && (t[a] = Array.isArray(e[a]) ? [] : {}), t[a] = /*#__PURE__*/ Ho(t[a], e[a], {
            depth: r - 1,
            clobber: o
        })) : (o || typeof t[a] != "object" && typeof e[a] != "object") && (t[a] = e[a]);
    }), t);
}, "assignWithDepth"), Mt = Ho;
var ki = {
    min: {
        r: 0,
        g: 0,
    ...
    hsl2rgb: /*#__PURE__*/ m$1((param, o)=>{
        ...
        switch(o){
            case "r":
                return ki.hue2rgb(a, n, t + .3333333333333333) * 255;
            case "g":
                return ki.hue2rgb(a, n, t) * 255;
            case "b":
                return ki.hue2rgb(a, n, t - .3333333333333333) * 255;
        }
    }, "hsl2rgb"),
...
var ae = {};
for(let t = 0; t <= 255; t++)ae[t] = /*#__PURE__*/ R.unit.dec2hex(t);
var ut = {
    ALL: 0,
    RGB: 1,
    HSL: 2
...
var Si = {
    ...
    parse: /*#__PURE__*/ m$1((t)=>{
        ...
        return pe.set({
            ...
            l: /*#__PURE__*/ R.channel.clamp.l(/*#__PURE__*/ parseFloat(a)),
            a: s ? R.channel.clamp.a(l ? parseFloat(s) / 100 : parseFloat(s)) : 1
        }, t);
    }, "parse"),
    stringify: /*#__PURE__*/ m$1((t)=>{
...
var il = {
    ...
    parse: /*#__PURE__*/ m$1((t)=>{
        ...
        return pe.set({
            ...
            g: /*#__PURE__*/ R.channel.clamp.g(s ? parseFloat(a) * 2.55 : parseFloat(a)),
...
var _u = {
    ...
    parse: /*#__PURE__*/ m$1((t)=>{
        ...
        let e = Ae.parse(t) || Lr.parse(t) || Fr.parse(t) || Go.parse(t);
        if (e) return e;
        throw new Error(`Unsupported color format: "${t}"`);
    }, "parse"),
    stringify: /*#__PURE__*/ m$1((t)=>!t.changed && t.color ? t.color : t.type.is(ut.HSL) || t.data.r === void 0 ? Fr.stringify(t) : t.a < 1 || !Number.isInteger(t.r) || !Number.isInteger(t.g) || !Number.isInteger(t.b) ? Lr.stringify(t) : Ae.stringify(t), "stringify")
}, ft = _u;
...
var Fu = /*#__PURE__*/ m$1((t, e, r)=>{
    let o = /*#__PURE__*/ ft.parse(t), n = o[e], a = /*#__PURE__*/ R.channel.clamp[e](n + r);
    return n !== a && (o[e] = a), ft.stringify(o);
}, "adjustChannel"), Bi = Fu;
var Lu = /*#__PURE__*/ m$1((t, e)=>Bi(t, "l", e), "lighten"), F = Lu;
var Mu = /*#__PURE__*/ m$1((t, e)=>Bi(t, "l", -e), "darken"), E = Mu;
...
var Eu = /*#__PURE__*/ m$1(function(t, e) {
    ...
    let { r: o, g: n, b: a, a: s } = ft.parse(t), { r: l, g: c, b: h, a: u } = ft.parse(e), p = r / 100, f = p * 2 - 1, g = s - u, A = ((f * g === -1 ? f : (f + g) / (1 + f * g)) + 1) / 2, W = 1 - A, q = o * A + l * W, G = n * A + c * W, D = a * A + h * W, L = s * p + u * (1 - p);
    return se(q, G, D, L);
}, "mix"), al = Eu;
var Du = /*#__PURE__*/ m$1(function(t) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 100;
    let r = /*#__PURE__*/ ft.parse(t);
    return r.r = 255 - r.r, r.g = 255 - r.g, r.b = 255 - r.b, al(r, t, e);
}, "invert"), b = Du;
...
var Fi = m$1((t)=>{
    if (tt.debug("sanitizeDirective called with", t), !(typeof t != "object" || t == null)) {
        ...
        for (let e of Object.keys(t)){
            ...
            for (let o of r)e.includes(o) && (tt.debug("sanitizing css option", e), t[e] = /*#__PURE__*/ Ou(t[e]));
        }
...
}, "sanitizeDirective"), Ou = /*#__PURE__*/ m$1((t)=>{
    let e = 0, r = 0;
    for (let o of t){
...
var Ar = /*#__PURE__*/ Object.freeze(pl), Rt = /*#__PURE__*/ Mt({}, Ar), xl, tr = [], Mr = /*#__PURE__*/ Mt({}, Ar), Li = /*#__PURE__*/ m$1((t, e)=>{
    let r = /*#__PURE__*/ Mt({}, t), o = {};
    for (let n of e)Cl(n), o = /*#__PURE__*/ Mt(o, n);
    if (r = /*#__PURE__*/ Mt(r, o), o.theme && o.theme in ye) {
        let n = /*#__PURE__*/ Mt({}, xl), a = /*#__PURE__*/ Mt(n.themeVariables || {}, o.themeVariables);
        r.theme && r.theme in ye && (r.themeVariables = /*#__PURE__*/ ye[r.theme].getThemeVariables(a));
    }
    return Mr = r, _l(Mr), Mr;
}, "updateCurrentConfig"), Iu = /*#__PURE__*/ m$1((t)=>(Rt = /*#__PURE__*/ Mt({}, Ar), Rt = /*#__PURE__*/ Mt(Rt, t), t.theme && ye[t.theme] && (Rt.themeVariables = /*#__PURE__*/ ye[t.theme].getThemeVariables(t.themeVariables)), Li(Rt, tr), Rt), "setSiteConfig"), oC = /*#__PURE__*/ m$1((t)=>{
    xl = /*#__PURE__*/ Mt({}, t);
}, "saveConfigFromInitialize"), nC = /*#__PURE__*/ m$1((t)=>(Rt = /*#__PURE__*/ Mt(Rt, t), Li(Rt, tr), Rt), "updateSiteConfig"), aC = /*#__PURE__*/ m$1(()=>Mt({}, Rt), "getSiteConfig"), yl = /*#__PURE__*/ m$1((t)=>(_l(t), Mt(Mr, t), Er()), "setConfig"), Er = /*#__PURE__*/ m$1(()=>Mt({}, Mr), "getConfig"), Cl = m$1((t)=>{
    t && ([
        "secure",
        ...Rt.secure ?? []
    ].forEach((e)=>{
...
var { entries: Ml, setPrototypeOf: bl, isFrozen: Nu, getPrototypeOf: qu, getOwnPropertyDescriptor: Pu } = Object, { freeze: Et, seal: Wt, create: Al } = Object, { apply: on, construct: nn } = typeof Reflect < "u" && Reflect;
...
on || (on = /*#__PURE__*/ m$1(function(e, r, o) {
    return e.apply(r, o);
}, "apply"));
nn || (nn = /*#__PURE__*/ m$1(function(e, r) {
    return new e(...r);
}, "construct"));
var Mi = /*#__PURE__*/ Dt(Array.prototype.forEach), Wu = /*#__PURE__*/ Dt(Array.prototype.lastIndexOf), Tl = /*#__PURE__*/ Dt(Array.prototype.pop), Dr = /*#__PURE__*/ Dt(Array.prototype.push), $u = /*#__PURE__*/ Dt(Array.prototype.splice), Ei = /*#__PURE__*/ Dt(String.prototype.toLowerCase), Qo = /*#__PURE__*/ Dt(String.prototype.toString), kl = /*#__PURE__*/ Dt(String.prototype.match), Or = /*#__PURE__*/ Dt(String.prototype.replace), Hu = /*#__PURE__*/ Dt(String.prototype.indexOf), Uu = /*#__PURE__*/ Dt(String.prototype.trim), Ut = /*#__PURE__*/ Dt(Object.prototype.hasOwnProperty), At = /*#__PURE__*/ Dt(RegExp.prototype.test), Ir = /*#__PURE__*/ Yu(TypeError);
function Dt(t) {
    return function(e) {
...
function Ee(t) {
    ...
    for (let [r, o] of Ml(t))Ut(t, r) && (Array.isArray(o) ? e[r] = /*#__PURE__*/ Gu(o) : o && typeof o == "object" && o.constructor === Object ? e[r] = /*#__PURE__*/ Ee(o) : e[r] = o);
    return e;
}
m$1(Ee, "clone");
function zr(t, e) {
...
var Sl = /*#__PURE__*/ Et([
    ...
    "xml:space",
    "xmlns:xlink"
]), ju = /*#__PURE__*/ Wt(/\{\{[\w\W]*|[\w\W]*\}\}/gm), Zu = /*#__PURE__*/ Wt(/<%[\w\W]*|[\w\W]*%>/gm), Ku = /*#__PURE__*/ Wt(/\$\{[\w\W]*/gm), Qu = /*#__PURE__*/ Wt(/^data-[\-\w.\u00B7-\uFFFF]+$/), Ju = /*#__PURE__*/ Wt(/^aria-[\-\w]+$/), El = /*#__PURE__*/ Wt(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i), tf = /*#__PURE__*/ Wt(/^(?:\w+script|data):/i), ef = /*#__PURE__*/ Wt(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g), Dl = /*#__PURE__*/ Wt(/^html$/i), rf = /*#__PURE__*/ Wt(/^[a-z][.\w]*(-[.\w]+)+$/i), Fl = /*#__PURE__*/ Object.freeze({
    __proto__: null,
    ARIA_ATTR: Ju,
    ATTR_WHITESPACE: ef,
    CUSTOM_ELEMENT: rf,
...
}, "_createTrustedTypesPolicy"), Ll = /*#__PURE__*/ m$1(function() {
    return {
...
function Ol() {
    let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : of(), e = /*#__PURE__*/ m$1((N)=>Ol(N), "DOMPurify");
    if (e.version = "3.2.5", e.removed = [], !t || !t.document || t.document.nodeType !== Rr.document || !t.Element) return e.isSupported = false, e;
    let { document: r } = t, o = r, n = o.currentScript, { DocumentFragment: a, HTMLTemplateElement: s, Node: l, Element: c, NodeFilter: h, NamedNodeMap: u = t.NamedNodeMap || t.MozNamedAttrMap, HTMLFormElement: p, DOMParser: f, trustedTypes: g } = t, T = c.prototype, A = /*#__PURE__*/ zr(T, "cloneNode"), W = /*#__PURE__*/ zr(T, "remove"), q = /*#__PURE__*/ zr(T, "nextSibling"), G = /*#__PURE__*/ zr(T, "childNodes"), D = /*#__PURE__*/ zr(T, "parentNode");
    if (typeof s == "function") {
        let N = /*#__PURE__*/ r.createElement("template");
        N.content && N.content.ownerDocument && (r = N.content.ownerDocument);
    }
    let L, P = "", { implementation: w, createNodeIterator: X, createDocumentFragment: j, getElementsByTagName: $ } = r, { importNode: it } = o, B = /*#__PURE__*/ Ll();
    e.isSupported = typeof Ml == "function" && typeof D == "function" && w && w.createHTMLDocument !== void 0;
    let { MUSTACHE_EXPR: k, ERB_EXPR: x, TMPLIT_EXPR: y, DATA_ATTR: M, ARIA_ATTR: S, IS_SCRIPT_OR_DATA: z, ATTR_WHITESPACE: I, CUSTOM_ELEMENT: U } = Fl, { IS_ALLOWED_URI: rt } = Fl, Y = null, nt = /*#__PURE__*/ K({}, [
        ...Sl,
        ...Jo,
        ...tn,
        ...en,
    ...
    })), Ct = null, _t = null, lt = true, v = true, H = false, V = true, C = false, mt = true, J = false, bt = false, Tt = false, It = false, Me = false, pi = false, Bs = true, Fs = false, nu = "user-content-", Oo = true, vr = false, Ze = {}, Ke = null, Ls = /*#__PURE__*/ K({}, [
        "annotation-xml",
        "audio",
        "colgroup",
        "desc",
        ...
        "style",
        "xmlns"
    ]), gi = "http://www.w3.org/1998/Math/MathML", xi = "http://www.w3.org/2000/svg", ie = "http://www.w3.org/1999/xhtml", Qe = ie, zo = false, Ro = null, au = /*#__PURE__*/ K({}, [
        gi,
        xi,
        ie
    ], Qo), yi = /*#__PURE__*/ K({}, [
        ...
        "text/html"
    ], hu = "text/html", pt = null, Je = null, cu = /*#__PURE__*/ r.createElement("form"), Ds = /*#__PURE__*/ m$1(function(d) {
        return d instanceof RegExp || d instanceof Function;
    }, "isRegexOrFunction"), No = /*#__PURE__*/ m$1(function() {
        let d = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        if (!(Je && Je === d)) {
            if ((!d || typeof d != "object") && (d = {}), d = /*#__PURE__*/ Ee(d), wr = lu.indexOf(d.PARSER_MEDIA_TYPE) === -1 ? hu : d.PARSER_MEDIA_TYPE, pt = wr === "application/xhtml+xml" ? Qo : Ei, Y = Ut(d, "ALLOWED_TAGS") ? K({}, d.ALLOWED_TAGS, pt) : nt, Q = Ut(d, "ALLOWED_ATTR") ? K({}, d.ALLOWED_ATTR, pt) : Ft, Ro = Ut(d, "ALLOWED_NAMESPACES") ? K({}, d.ALLOWED_NAMESPACES, Qo) : au, Io = Ut(d, "ADD_URI_SAFE_ATTR") ? K(/*#__PURE__*/ Ee(Es), d.ADD_URI_SAFE_ATTR, pt) : Es, Ms = Ut(d, "ADD_DATA_URI_TAGS") ? K(/*#__PURE__*/ Ee(As), d.ADD_DATA_URI_TAGS, pt) : As, Ke = Ut(d, "FORBID_CONTENTS") ? K({}, d.FORBID_CONTENTS, pt) : Ls, Ct = Ut(d, "FORBID_TAGS") ? K({}, d.FORBID_TAGS, pt) : {}, _t = Ut(d, "FORBID_ATTR") ? K({}, d.FORBID_ATTR, pt) : {}, Ze = Ut(d, "USE_PROFILES") ? d.USE_PROFILES : false, lt = d.ALLOW_ARIA_ATTR !== false, v = d.ALLOW_DATA_ATTR !== false, H = d.ALLOW_UNKNOWN_PROTOCOLS || false, V = d.ALLOW_SELF_CLOSE_IN_ATTR !== false, C = d.SAFE_FOR_TEMPLATES || false, mt = d.SAFE_FOR_XML !== false, J = d.WHOLE_DOCUMENT || false, It = d.RETURN_DOM || false, Me = d.RETURN_DOM_FRAGMENT || false, pi = d.RETURN_TRUSTED_TYPE || false, Tt = d.FORCE_BODY || false, Bs = d.SANITIZE_DOM !== false, Fs = d.SANITIZE_NAMED_PROPS || false, Oo = d.KEEP_CONTENT !== false, vr = d.IN_PLACE || false, rt = d.ALLOWED_URI_REGEXP || El, Qe = d.NAMESPACE || ie, yi = d.MATHML_TEXT_INTEGRATION_POINTS || yi, Ci = d.HTML_INTEGRATION_POINTS || Ci, Z = d.CUSTOM_ELEMENT_HANDLING || {}, d.CUSTOM_ELEMENT_HANDLING && Ds(d.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (Z.tagNameCheck = d.CUSTOM_ELEMENT_HANDLING.tagNameCheck), d.CUSTOM_ELEMENT_HANDLING && Ds(d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (Z.attributeNameCheck = d.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), d.CUSTOM_ELEMENT_HANDLING && typeof d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (Z.allowCustomizedBuiltInElements = d.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), C && (v = false), Me && (It = true), Ze && (Y = /*#__PURE__*/ K({}, vl), Q = [], Ze.html === true && (K(Y, Sl), K(Q, wl)), Ze.svg === true && (K(Y, Jo), K(Q, rn), K(Q, Ai)), Ze.svgFilters === true && (K(Y, tn), K(Q, rn), K(Q, Ai)), Ze.mathMl === true && (K(Y, en), K(Q, Bl), K(Q, Ai))), d.ADD_TAGS && (Y === nt && (Y = /*#__PURE__*/ Ee(Y)), K(Y, d.ADD_TAGS, pt)), d.ADD_ATTR && (Q === Ft && (Q = /*#__PURE__*/ Ee(Q)), K(Q, d.ADD_ATTR, pt)), d.ADD_URI_SAFE_ATTR && K(Io, d.ADD_URI_SAFE_ATTR, pt), d.FORBID_CONTENTS && (Ke === Ls && (Ke = /*#__PURE__*/ Ee(Ke)), K(Ke, d.FORBID_CONTENTS, pt)), Oo && (Y["#text"] = true), J && K(Y, [
                "html",
                "head",
                "body"
            ]), Y.table && (K(Y, [
                ...
                L = d.TRUSTED_TYPES_POLICY, P = /*#__PURE__*/ L.createHTML("");
            } else L === void 0 && (L = /*#__PURE__*/ nf(g, n)), L !== null && typeof P == "string" && (P = /*#__PURE__*/ L.createHTML(""));
            Et && Et(d), Je = d;
        }
    }, "_parseConfig"), Os = /*#__PURE__*/ K({}, [
        ...Jo,
        ...tn,
        ...Vu
    ]), Is = /*#__PURE__*/ K({}, [
        ...
        let O = /*#__PURE__*/ Ei(d.tagName), st = /*#__PURE__*/ Ei(_.tagName);
        return Ro[d.namespaceURI] ? d.namespaceURI === xi ? _.namespaceURI === ie ? O === "svg" : _.namespaceURI === gi ? O === "svg" && (st === "annotation-xml" || yi[st]) : !!Os[O] : d.namespaceURI === gi ? _.namespaceURI === ie ? O === "math" : _.namespaceURI === xi ? O === "math" && Ci[st] : !!Is[O] : d.namespaceURI === ie ? _.namespaceURI === xi && !Ci[st] || _.namespaceURI === gi && !yi[st] ? false : !Is[O] && (su[O] || !Os[O]) : !!(wr === "application/xhtml+xml" && Ro[d.namespaceURI]) : false;
        ...
        if (_.removeAttribute(d), d === "is") if (It || Me) try {
            Zt(_);
        } catch  {}
        else try {
            _.setAttribute(d, "");
        } catch  {}
    }, "_removeAttribute"), zs = /*#__PURE__*/ m$1(function(d) {
        let _ = null, O = null;
        ...
        let st = L ? L.createHTML(d) : d;
        if (Qe === ie) try {
            _ = /*#__PURE__*/ new f().parseFromString(st, wr);
        } catch  {}
        if (!_ || !_.documentElement) {
            _ = /*#__PURE__*/ w.createDocument(Qe, "template", null);
            try {
                _.documentElement.innerHTML = zo ? P : st;
            } catch  {}
        }
        let Bt = _.body || _.documentElement;
        return d && O && Bt.insertBefore(/*#__PURE__*/ r.createTextNode(O), Bt.childNodes[0] || null), Qe === ie ? $.call(_, J ? "html" : "body")[0] : J ? _.documentElement : Bt;
    }, "_initDocument"), Rs = /*#__PURE__*/ m$1(function(d) {
    ...
    }, "_createNodeIterator"), qo = /*#__PURE__*/ m$1(function(d) {
    ...
    }, "_isClobbered"), Ns = /*#__PURE__*/ m$1(function(d) {
    ...
    let qs = /*#__PURE__*/ m$1(function(d) {
        let _ = null;
        if (oe(B.beforeSanitizeElements, d, null), qo(d)) return Zt(d), true;
        let O = /*#__PURE__*/ pt(d.nodeName);
        if (oe(B.uponSanitizeElement, d, {
            tagName: O,
            allowedTags: Y
        }), d.hasChildNodes() && !Ns(d.firstElementChild) && At(/<[/\w!]/g, d.innerHTML) && At(/<[/\w!]/g, d.textContent) || d.nodeType === Rr.progressingInstruction || mt && d.nodeType === Rr.comment && At(/<[/\w]/g, d.data)) return Zt(d), true;
        if (!Y[O] || Ct[O]) {
            if (!Ct[O] && Ws(O) && (Z.tagNameCheck instanceof RegExp && At(Z.tagNameCheck, O) || Z.tagNameCheck instanceof Function && Z.tagNameCheck(O))) return false;
            if (Oo && !Ke[O]) {
                let st = D(d) || d.parentNode, Bt = G(d) || d.childNodes;
                if (Bt && st) {
                    let kt = Bt.length;
                    for(let zt = kt - 1; zt >= 0; --zt){
                        let Kt = /*#__PURE__*/ A(Bt[zt], true);
                        Kt.__removalCount = (d.__removalCount || 0) + 1, st.insertBefore(Kt, /*#__PURE__*/ q(d));
                    }
                }
            }
            return Zt(d), true;
        }
        return d instanceof c && !uu(d) || (O === "noscript" || O === "noembed" || O === "noframes") && At(/<\/no(script|embed|frames)/i, d.innerHTML) ? (Zt(d), true) : (C && d.nodeType === Rr.text && (_ = d.textContent, Mi([
            k,
            x,
            y
        ], (st)=>{
            _ = /*#__PURE__*/ Or(_, st, " ");
        }), d.textContent !== _ && (Dr(e.removed, {
            element: /*#__PURE__*/ d.cloneNode()
        }), d.textContent = _)), oe(B.afterSanitizeElements, d, null), false);
    }, "_sanitizeElements"), Ps = /*#__PURE__*/ m$1(function(d, _, O) {
        if (Bs && (_ === "id" || _ === "name") && (O in r || O in cu)) return false;
        if (!(v && !_t[_] && At(M, _))) {
            if (!(lt && At(S, _))) {
                if (!Q[_] || _t[_]) {
                    if (!(Ws(d) && (Z.tagNameCheck instanceof RegExp && At(Z.tagNameCheck, d) || Z.tagNameCheck instanceof Function && Z.tagNameCheck(d)) && (Z.attributeNameCheck instanceof RegExp && At(Z.attributeNameCheck, _) || Z.attributeNameCheck instanceof Function && Z.attributeNameCheck(_)) || _ === "is" && Z.allowCustomizedBuiltInElements && (Z.tagNameCheck instanceof RegExp && At(Z.tagNameCheck, O) || Z.tagNameCheck instanceof Function && Z.tagNameCheck(O)))) return false;
                } else if (!Io[_]) {
                    if (!At(rt, /*#__PURE__*/ Or(O, I, ""))) {
                        if (!((_ === "src" || _ === "xlink:href" || _ === "href") && d !== "script" && Hu(O, "data:") === 0 && Ms[d])) {
                            if (!(H && !At(z, /*#__PURE__*/ Or(O, I, "")))) {
                                if (O) return false;
                            }
                        }
                    }
        ...
        return true;
    }, "_isValidAttribute"), Ws = /*#__PURE__*/ m$1(function(d) {
        return d !== "annotation-xml" && kl(d, U);
    }, "_isBasicCustomElement"), $s = /*#__PURE__*/ m$1(function(d) {
        ...
        for(; st--;){
            let Bt = _[st], { name: kt, namespaceURI: zt, value: Kt } = Bt, Br = /*#__PURE__*/ pt(kt), Lt = kt === "value" ? Kt : Uu(Kt);
            if (O.attrName = Br, O.attrValue = Lt, O.keepAttr = true, O.forceKeepAttr = void 0, oe(B.uponSanitizeAttribute, d, O), Lt = O.attrValue, Fs && (Br === "id" || Br === "name") && (_i(kt, d), Lt = nu + Lt), mt && At(/((--!?|])>)|<\/(style|title)/i, Lt)) {
                _i(kt, d);
                continue;
            }
            if (O.forceKeepAttr || (_i(kt, d), !O.keepAttr)) continue;
            if (!V && At(/\/>/i, Lt)) {
                _i(kt, d);
                continue;
            }
            C && Mi([
                ...
                Lt = /*#__PURE__*/ Or(Lt, Us, " ");
            });
            let Hs = /*#__PURE__*/ pt(d.nodeName);
            if (Ps(Hs, Br, Lt)) {
                if (L && typeof g == "object" && typeof g.getAttributeType == "function" && !zt) switch(g.getAttributeType(Hs, Br)){
                    case "TrustedHTML":
                        {
                            Lt = /*#__PURE__*/ L.createHTML(Lt);
                            break;
                        }
                    case "TrustedScriptURL":
                        {
                            Lt = /*#__PURE__*/ L.createScriptURL(Lt);
                            break;
                        }
                }
                try {
                    zt ? d.setAttributeNS(zt, kt, Lt) : d.setAttribute(kt, Lt), qo(d) ? Zt(d) : Tl(e.removed);
                } catch  {}
            }
        }
        oe(B.afterSanitizeAttributes, d, null);
    }, "_sanitizeAttributes"), fu = /*#__PURE__*/ m$1(function N(d) {
        let _ = null, O = /*#__PURE__*/ Rs(d);
        for(oe(B.beforeSanitizeShadowDOM, d, null); _ = /*#__PURE__*/ O.nextNode();)oe(B.uponSanitizeShadowNode, _, null), qs(_), $s(_), _.content instanceof a && N(_.content);
        oe(B.afterSanitizeShadowDOM, d, null);
    }, "_sanitizeShadowDOM");
    return e.sanitize = function(N) {
        let d = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ = null, O = null, st = null, Bt = null;
        if (zo = !N, zo && (N = "<!-->"), typeof N != "string" && !Ns(N)) if (typeof N.toString == "function") {
        ...
        if (bt || No(d), e.removed = [], typeof N == "string" && (vr = false), vr) {
            if (N.nodeName) {
                let Kt = /*#__PURE__*/ pt(N.nodeName);
                if (!Y[Kt] || Ct[Kt]) throw Ir("root node is forbidden and cannot be sanitized in-place");
            }
        } else if (N instanceof l) _ = /*#__PURE__*/ zs("<!---->"), O = /*#__PURE__*/ _.ownerDocument.importNode(N, true), O.nodeType === Rr.element && O.nodeName === "BODY" || O.nodeName === "HTML" ? _ = O : _.appendChild(O);
        else {
            if (!It && !C && !J && N.indexOf("<") === -1) return L && pi ? L.createHTML(N) : N;
            if (_ = /*#__PURE__*/ zs(N), !_) return It ? null : pi ? P : "";
        }
        _ && Tt && Zt(_.firstChild);
        let kt = /*#__PURE__*/ Rs(vr ? N : _);
        for(; st = /*#__PURE__*/ kt.nextNode();)qs(st), $s(st), st.content instanceof a && fu(st.content);
        if (vr) return N;
        if (It) {
            if (Me) for(Bt = /*#__PURE__*/ j.call(_.ownerDocument); _.firstChild;)Bt.appendChild(_.firstChild);
            else Bt = _;
            return (Q.shadowroot || Q.shadowrootmode) && (Bt = /*#__PURE__*/ it.call(o, Bt, true)), Bt;
        }
        let zt = J ? _.outerHTML : _.innerHTML;
        return J && Y["!doctype"] && _.ownerDocument && _.ownerDocument.doctype && _.ownerDocument.doctype.name && At(Dl, _.ownerDocument.doctype.name) && (zt = "<!DOCTYPE " + _.ownerDocument.doctype.name + `>
` + zt), C && Mi([
            k,
            x,
            y
        ], (Kt)=>{
            zt = /*#__PURE__*/ Or(zt, Kt, " ");
        }), L && pi ? L.createHTML(zt) : zt;
        ...
        Je || No({});
        let O = /*#__PURE__*/ pt(N), st = /*#__PURE__*/ pt(d);
        return Ps(O, st, _);
    }, e.addHook = function(N, d) {
        typeof d == "function" && Dr(B[N], d);
...
m$1(Ol, "createDOMPurify");
var er = /*#__PURE__*/ Ol();
var Nr = /<br\s*\/?>/gi, af = /*#__PURE__*/ m$1((t)=>t ? ql(t).replace(/\\n/g, "#br#").split("#br#") : [
        ""
    ], "getRows"), sf = /*#__PURE__*/ (()=>{
    let t = false;
    return ()=>{
...
var Nl = /*#__PURE__*/ m$1((t)=>(sf(), er.sanitize(t)), "removeScript"), Il = /*#__PURE__*/ m$1((t, e)=>{
    ...
    return t;
}, "sanitizeMore"), De = /*#__PURE__*/ m$1((t, e)=>t && (e.dompurifyConfig ? t = /*#__PURE__*/ er.sanitize(/*#__PURE__*/ Il(t, e), e.dompurifyConfig).toString() : t = /*#__PURE__*/ er.sanitize(/*#__PURE__*/ Il(t, e), {
        FORBID_TAGS: [
            "style"
        ]
    }).toString(), t), "sanitizeText"), hf = /*#__PURE__*/ m$1((t, e)=>typeof t == "string" ? De(t, e) : t.flat().map((r)=>De(r, e)), "sanitizeTextOrArray"), cf = /*#__PURE__*/ m$1((t)=>Nr.test(t), "hasBreaks"), uf = /*#__PURE__*/ m$1((t)=>t.split(Nr), "splitBreaks"), ff = /*#__PURE__*/ m$1((t)=>t.replace(/#br#/g, "<br/>"), "placeholderToBreak"), ql = /*#__PURE__*/ m$1((t)=>t.replace(Nr, "#br#"), "breakToPlaceholder"), df = /*#__PURE__*/ m$1((t)=>{
    let e = "";
    ...
    for(let o = 0; o < e.length; o++){
        ...
        if (n === "," && o > 0 && o + 1 < e.length) {
            let a = e[o - 1], s = e[o + 1];
            xf(a, s) && (n = a + "," + s, o++, r.pop());
        }
        r.push(/*#__PURE__*/ yf(n));
    }
    return r.join("");
}, "parseGenericTypes"), an = /*#__PURE__*/ m$1((t, e)=>Math.max(0, t.split(e).length - 1), "countOccurrence"), xf = /*#__PURE__*/ m$1((t, e)=>{
    let r = /*#__PURE__*/ an(t, "~"), o = /*#__PURE__*/ an(e, "~");
    return r === 1 && o === 1;
}, "shouldCombineSets"), yf = /*#__PURE__*/ m$1((t)=>{
    let e = /*#__PURE__*/ an(t, "~"), r = false;
    if (e <= 1) return t;
...
}, "processSet"), zl = /*#__PURE__*/ m$1(()=>window.MathMLElement !== void 0, "isMathMLSupported"), Di = /\$\$(.*)\$\$/g, Rl = /*#__PURE__*/ m$1((t)=>(t.match(Di)?.length ?? 0) > 0, "hasKatex"), pC = /*#__PURE__*/ m$1(async (t, e)=>{
    t = await Cf(t, e);
    ...
    if (!Rl(t)) return t;
    if (!(zl() || e.legacyMathML || e.forceLegacyMathML)) return t.replace(Di, "MathML is unsupported in this environment.");
    {
        ...
        return t.split(Nr).map((n)=>Rl(n) ? `<div style="display: flex; align-items: center; justify-content: center; white-space: nowrap;">${n}</div>` : `<div>${n}</div>`).join("").replace(Di, (n, a)=>r.renderToString(a, {
                throwOnError: true,
                displayMode: true,
                output: o
...
var _f = /*#__PURE__*/ m$1(function(t, e) {
    ...
    let l = 0, c = 0;
    tt.info(`Graph bounds: ${l}x${c}`, t), l = a + r * 2, c = s + r * 2, tt.info(`Calculated bounds: ${l}x${c}`), Tf(e, c, l, o);
...
var sn = "", ln = "", hn = "", cn = /*#__PURE__*/ m$1((t)=>De(t, /*#__PURE__*/ Er()), "sanitizeText"), Sf = /*#__PURE__*/ m$1(()=>{
    sn = "", hn = "", ln = "";
}, "clear"), vf = /*#__PURE__*/ m$1((t)=>{
    sn = /*#__PURE__*/ cn(t).replace(/^\s+/g, "");
}, "setAccTitle"), wf = /*#__PURE__*/ m$1(()=>sn, "getAccTitle"), Bf = /*#__PURE__*/ m$1((t)=>{
    hn = /*#__PURE__*/ cn(t).replace(/\n\s+/g, `
`);
}, "setAccDescription"), Ff = /*#__PURE__*/ m$1(()=>hn, "getAccDescription"), Lf = /*#__PURE__*/ m$1((t)=>{
    ln = /*#__PURE__*/ cn(t);
}, "setDiagramTitle"), Mf = /*#__PURE__*/ m$1(()=>ln, "getDiagramTitle");
var $l = tt, Af = Vs, Hl = Er, IC = yl, zC = Ar;
var Ef = /*#__PURE__*/ m$1((t)=>De(t, /*#__PURE__*/ Hl()), "sanitizeText"), Df = Pl, Of = /*#__PURE__*/ m$1(()=>un, "getCommonDb"), Ii = {}, RC = /*#__PURE__*/ m$1((t, e, r)=>{
    Ii[t] && $l.warn(`Diagram with id ${t} already registered. Overwriting.`), Ii[t] = e, r && $o(t, r), Wl(t, e.styles), e.injectUtils?.($l, Af, Hl, Ef, Df, Of(), ()=>{});
...
function Ie(t) {
    let e, r, o;
    t.length !== 2 ? (e = Oe, r = /*#__PURE__*/ m$1((l, c)=>Oe(/*#__PURE__*/ t(l), c), "compare2"), o = /*#__PURE__*/ m$1((l, c)=>t(l) - c, "delta")) : (e = t === Oe || t === dn ? t : If, r = t, o = t);
    function n(l, c) {
...
m$1(mn, "number");
var Gl = /*#__PURE__*/ Ie(Oe), Vl = Gl.right;
Gl.left;
Ie(mn).center;
var pn = Vl;
...
function zi(t, e, r) {
    let o = (e - t) / Math.max(0, r), n = /*#__PURE__*/ Math.floor(/*#__PURE__*/ Math.log10(o)), a = o / Math.pow(10, n), s = a >= Wf ? 10 : a >= $f ? 5 : a >= Hf ? 2 : 1, l, c, h;
    return n < 0 ? (h = Math.pow(10, -n) / s, l = /*#__PURE__*/ Math.round(t * h), c = /*#__PURE__*/ Math.round(e * h), l / h < t && ++l, c / h > e && --c, h = -h) : (h = Math.pow(10, n) * s, l = /*#__PURE__*/ Math.round(t / h), c = /*#__PURE__*/ Math.round(e / h), l * h < t && ++l, c * h > e && --c), c < l && .5 <= r && r < 2 ? zi(t, e, r * 2) : [
        l,
        c,
        h
    ];
...
function Ri(t, e, r) {
    ...
    let o = e < t, [n, a, s] = o ? zi(e, t, r) : zi(t, e, r);
    if (!(a >= n)) return [];
...
m$1(gn, "default");
var Pi = 1, xn = 2, yn = 3, qi = 4, jl = 1e-6;
function Uf(t) {
...
m$1(Xf, "entering");
function Zl(t, e) {
    var r = [], o = null, n = null, a = 6, s = 6, l = 3, c = typeof window < "u" && window.devicePixelRatio > 1 ? 0 : .5, h = t === Pi || t === qi ? -1 : 1, u = t === qi || t === xn ? "x" : "y", p = t === Pi || t === yn ? Uf : Yf;
    function f(g) {
        var T = o ?? (e.ticks ? e.ticks.apply(e, r) : e.domain()), A = n ?? (e.tickFormat ? e.tickFormat.apply(e, r) : gn), W = Math.max(a, 0) + l, q = /*#__PURE__*/ e.range(), G = +q[0] + c, D = +q[q.length - 1] + c, L = /*#__PURE__*/ (e.bandwidth ? Vf : Gf)(/*#__PURE__*/ e.copy(), c), P = g.selection ? g.selection() : g, w = /*#__PURE__*/ P.selectAll(".domain").data([
            null
        ...
        w = /*#__PURE__*/ w.merge(/*#__PURE__*/ w.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), X = /*#__PURE__*/ X.merge($), it = /*#__PURE__*/ it.merge(/*#__PURE__*/ $.append("line").attr("stroke", "currentColor").attr(u + "2", h * a)), B = /*#__PURE__*/ B.merge(/*#__PURE__*/ $.append("text").attr("fill", "currentColor").attr(u, h * W).attr("dy", t === Pi ? "0em" : t === yn ? "0.71em" : "0.32em")), g !== P && (w = /*#__PURE__*/ w.transition(g), X = /*#__PURE__*/ X.transition(g), it = /*#__PURE__*/ it.transition(g), B = /*#__PURE__*/ B.transition(g), j = /*#__PURE__*/ j.transition(g).attr("opacity", jl).attr("transform", function(k) {
            return isFinite(k = /*#__PURE__*/ L(k)) ? p(k + c) : this.getAttribute("transform");
        }), $.attr("opacity", jl).attr("transform", function(k) {
            var x = this.parentNode.__axis;
            return p((x && isFinite(x = /*#__PURE__*/ x(k)) ? x : L(k)) + c);
        })), j.remove(), w.attr("d", t === qi || t === xn ? s ? "M" + h * s + "," + G + "H" + c + "V" + D + "H" + h * s : "M" + c + "," + G + "V" + D : s ? "M" + G + "," + h * s + "V" + c + "H" + D + "V" + h * s : "M" + G + "," + c + "H" + D), X.attr("opacity", 1).attr("transform", function(k) {
            return p(L(k) + c);
        }), it.attr(u + "2", h * a), B.attr(u, h * W).text(A), P.filter(Xf).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === xn ? "start" : t === qi ? "end" : "middle"), P.each(function() {
            this.__axis = L;
        });
    }
...
m$1(rd, "childFirst");
function Tn(t) {
    return this.select(t == null ? rd : ed(typeof t == "function" ? t : Wi(t)));
}
m$1(Tn, "default");
...
function kn(t) {
    return this.selectAll(t == null ? od : nd(typeof t == "function" ? t : Wi(t)));
}
m$1(kn, "default");
function Sn(t) {
...
m$1(wn, "default");
function ad(t, e, r, o, n, a) {
    for(var s = 0, l, c = e.length, h = a.length; s < h; ++s)(l = e[s]) ? (l.__data__ = a[s], o[s] = l) : r[s] = new Wr(t, a[s]);
    for(; s < c; ++s)(l = e[s]) && (n[s] = l);
}
m$1(ad, "bindIndex");
function sd(t, e, r, o, n, a, s) {
    ...
    for(l = 0; l < p; ++l)g = s.call(t, a[l], l, a) + "", (c = /*#__PURE__*/ h.get(g)) ? (o[l] = c, c.__data__ = a[l], h.delete(g)) : r[l] = new Wr(t, a[l]);
...
function Bn(t, e) {
    ...
    var r = e ? sd : ad, o = this._parents, n = this._groups;
    typeof t != "function" && (t = /*#__PURE__*/ wn(t));
    for(var a = n.length, s = new Array(a), l = new Array(a), c = new Array(a), h = 0; h < a; ++h){
        var u = o[h], p = n[h], f = p.length, g = /*#__PURE__*/ hd(/*#__PURE__*/ t.call(u, u && u.__data__, h, o)), T = g.length, A = l[h] = new Array(T), W = s[h] = new Array(T), q = c[h] = new Array(f);
        r(u, p, A, W, q, g, e);
        for(var G = 0, D = 0, L, P; G < T; ++G)if (L = A[G]) {
            for(G >= D && (D = G + 1); !(P = W[D]) && ++D < T;);
            L._next = P || null;
        }
    }
...
m$1(Ln, "default");
function Mn(t) {
    for(var e = t.selection ? t.selection() : t, r = this._groups, o = e._groups, n = r.length, a = o.length, s = /*#__PURE__*/ Math.min(n, a), l = new Array(n), c = 0; c < s; ++c)for(var h = r[c], u = o[c], p = h.length, f = l[c] = new Array(p), g, T = 0; T < p; ++T)(g = h[T] || u[T]) && (f[T] = g);
    for(; c < n; ++c)l[c] = r[c];
...
function Un(t, e) {
    var r = /*#__PURE__*/ Kl(t + "");
    if (arguments.length < 2) {
        for(var o = /*#__PURE__*/ Hn(/*#__PURE__*/ this.node()), n = -1, a = r.length; ++n < a;)if (!o.contains(r[n])) return false;
        return true;
    }
...
m$1(Ad, "htmlFunction");
function Gn(t) {
    return arguments.length ? this.each(t == null ? Ld : (typeof t == "function" ? Ad : Md)(t)) : this.node().innerHTML;
}
m$1(Gn, "default");
function Ed() {
...
function Od(t) {
    return function() {
        ...
        return r === $i && e.documentElement.namespaceURI === $i ? e.createElement(t) : e.createElementNS(r, t);
    };
}
m$1(Od, "creatorInherit");
function Id(t) {
    return function() {
...
function Hd(t, e, r) {
    return function() {
        var o = this.__on, n, a = /*#__PURE__*/ Pd(e);
        if (o) {
...
m$1(Hd, "onAdd");
function ta(t, e, r) {
    var o = /*#__PURE__*/ Wd(t + ""), n, a = o.length, s;
    if (arguments.length < 2) {
    ...
    for(l = e ? Hd : $d, n = 0; n < a; ++n)this.each(/*#__PURE__*/ l(o[n], e, r));
    return this;
}
m$1(ta, "default");
function eh(t, e, r) {
...
function Te() {}
m$1(Te, "Color");
var Ur = .7, Yi = 1 / Ur, sr = "\\s*([+-]?\\d+)\\s*", Yr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Jt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Vd = /^#([0-9a-f]{3,8})$/, Xd = new RegExp(`^rgb\\(${sr},${sr},${sr}\\)$`), jd = new RegExp(`^rgb\\(${Jt},${Jt},${Jt}\\)$`), Zd = new RegExp(`^rgba\\(${sr},${sr},${sr},${Yr}\\)$`), Kd = new RegExp(`^rgba\\(${Jt},${Jt},${Jt},${Yr}\\)$`), Qd = new RegExp(`^hsl\\(${Yr},${Jt},${Jt}\\)$`), Jd = new RegExp(`^hsla\\(${Yr},${Jt},${Jt},${Yr}\\)$`), oh = {
    aliceblue: 15792383,
...
m$1(ah, "color_formatRgb");
function Gt(t) {
    var e, r;
    return t = /*#__PURE__*/ (t + "").trim().toLowerCase(), (e = /*#__PURE__*/ Vd.exec(t)) ? (r = e[1].length, e = /*#__PURE__*/ parseInt(e[1], 16), r === 6 ? sh(e) : r === 3 ? new St(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : r === 8 ? Hi(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : r === 4 ? Hi(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = /*#__PURE__*/ Xd.exec(t)) ? new St(e[1], e[2], e[3], 1) : (e = /*#__PURE__*/ jd.exec(t)) ? new St(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = /*#__PURE__*/ Zd.exec(t)) ? Hi(e[1], e[2], e[3], e[4]) : (e = /*#__PURE__*/ Kd.exec(t)) ? Hi(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = /*#__PURE__*/ Qd.exec(t)) ? ch(e[1], e[2] / 100, e[3] / 100, 1) : (e = /*#__PURE__*/ Jd.exec(t)) ? ch(e[1], e[2] / 100, e[3] / 100, e[4]) : oh.hasOwnProperty(t) ? sh(oh[t]) : t === "transparent" ? new St(NaN, NaN, NaN, 0) : null;
}
m$1(Gt, "color");
function sh(t) {
...
m$1(na, "rgbConvert");
function lr(t, e, r, o) {
    return arguments.length === 1 ? na(t) : new St(t, e, r, o ?? 1);
}
m$1(lr, "rgb");
function St(t, e, r, o) {
...
m$1(St, "Rgb");
be(St, lr, /*#__PURE__*/ ar(Te, {
    brighter (t) {
        return t = t == null ? Yi : Math.pow(Yi, t), new St(this.r * t, this.g * t, this.b * t, this.opacity);
    },
    darker (t) {
    ...
    clamp () {
        return new St(Re(this.r), Re(this.g), Re(this.b), Gi(this.opacity));
    },
    displayable () {
...
function hh() {
    let t = /*#__PURE__*/ Gi(this.opacity);
...
m$1(fh, "hslConvert");
function dh(t, e, r, o) {
    return arguments.length === 1 ? fh(t) : new Yt(t, e, r, o ?? 1);
}
m$1(dh, "hsl");
function Yt(t, e, r, o) {
...
m$1(Yt, "Hsl");
be(Yt, dh, /*#__PURE__*/ ar(Te, {
    brighter (t) {
        return t = t == null ? Yi : Math.pow(Yi, t), new Yt(this.h, this.s, this.l * t, this.opacity);
    },
    darker (t) {
        return t = t == null ? Ur : Math.pow(Ur, t), new Yt(this.h, this.s, this.l * t, this.opacity);
    },
    rgb () {
        var t = this.h % 360 + (this.h < 0) * 360, e = isNaN(t) || isNaN(this.s) ? 0 : this.s, r = this.l, o = r + (r < .5 ? r : 1 - r) * e, n = 2 * r - o;
        return new St(oa(t >= 240 ? t - 240 : t + 120, n, o), oa(t, n, o), oa(t < 120 ? t + 240 : t - 120, n, o), this.opacity);
    },
    clamp () {
        return new Yt(uh(this.h), Ui(this.s), Ui(this.l), Gi(this.opacity));
    },
    displayable () {
    ...
    formatHsl () {
        let t = /*#__PURE__*/ Gi(this.opacity);
        return `${t === 1 ? "hsl(" : "hsla("}${uh(this.h)}, ${Ui(this.s) * 100}%, ${Ui(this.l) * 100}%${t === 1 ? ")" : `, ${t})`}`;
    }
}));
function uh(t) {
...
var Vi = 18, gh = .96422, xh = 1, yh = .82521, Ch = 4 / 29, hr = 6 / 29, _h = 3 * hr * hr, im = hr * hr * hr;
function bh(t) {
    if (t instanceof te) return new te(t.l, t.a, t.b, t.opacity);
    if (t instanceof he) return Th(t);
    t instanceof St || (t = /*#__PURE__*/ na(t));
    var e = /*#__PURE__*/ ha(t.r), r = /*#__PURE__*/ ha(t.g), o = /*#__PURE__*/ ha(t.b), n = /*#__PURE__*/ aa((.2225045 * e + .7168786 * r + .0606169 * o) / xh), a, s;
    return e === r && r === o ? a = s = n : (a = /*#__PURE__*/ aa((.4360747 * e + .3850649 * r + .1430804 * o) / gh), s = /*#__PURE__*/ aa((.0139322 * e + .0971045 * r + .7141733 * o) / yh)), new te(116 * n - 16, 500 * (a - n), 200 * (n - s), t.opacity);
}
m$1(bh, "labConvert");
function ca(t, e, r, o) {
...
m$1(te, "Lab");
be(te, ca, /*#__PURE__*/ ar(Te, {
    brighter (t) {
        return new te(this.l + Vi * (t ?? 1), this.a, this.b, this.opacity);
    },
    darker (t) {
        return new te(this.l - Vi * (t ?? 1), this.a, this.b, this.opacity);
    },
    rgb () {
        ...
        return e = gh * sa(e), t = xh * sa(t), r = yh * sa(r), new St(la(3.1338561 * e - 1.6168667 * t - .4906146 * r), la(-0.9787684 * e + 1.9161415 * t + .033454 * r), la(.0719453 * e - .2289914 * t + 1.4052427 * r), this.opacity);
    }
}));
function aa(t) {
...
m$1(Th, "hcl2lab");
be(he, Gr, /*#__PURE__*/ ar(Te, {
    brighter (t) {
        return new he(this.h, this.c, this.l + Vi * (t ?? 1), this.opacity);
    },
    darker (t) {
        return new he(this.h, this.c, this.l - Vi * (t ?? 1), this.opacity);
    },
...
function wh(t) {
    return function(e, r) {
        var o = /*#__PURE__*/ t((e = /*#__PURE__*/ Gr(e)).h, (r = /*#__PURE__*/ Gr(r)).h), n = /*#__PURE__*/ ce(e.c, r.c), a = /*#__PURE__*/ ce(e.l, r.l), s = /*#__PURE__*/ ce(e.opacity, r.opacity);
        return function(l) {
...
m$1(wh, "hcl");
var am = /*#__PURE__*/ wh(Sh);
function ua(t, e, r, o, n) {
    var a = t * t, s = a * t;
...
var Ne = /*#__PURE__*/ m$1(function t(e) {
    var r = /*#__PURE__*/ vh(e);
    function o(n, a) {
        var s = /*#__PURE__*/ r((n = /*#__PURE__*/ lr(n)).r, (a = /*#__PURE__*/ lr(a)).r), l = /*#__PURE__*/ r(n.g, a.g), c = /*#__PURE__*/ r(n.b, a.b), h = /*#__PURE__*/ ce(n.opacity, a.opacity);
        return function(u) {
...
function Bh(t) {
    return function(e) {
        ...
        for(s = 0; s < r; ++s)l = /*#__PURE__*/ lr(e[s]), o[s] = l.r || 0, n[s] = l.g || 0, a[s] = l.b || 0;
...
m$1(ga, "default");
var ya = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, xa = new RegExp(ya.source, "g");
function cm(t) {
    return function() {
        return t;
    };
...
m$1(um, "one");
function ur(t, e) {
    var r = ya.lastIndex = xa.lastIndex = 0, o, n, a, s = -1, l = [], c = [];
    for(t = t + "", e = e + ""; (o = /*#__PURE__*/ ya.exec(t)) && (n = /*#__PURE__*/ xa.exec(e));)(a = n.index) > r && (a = /*#__PURE__*/ e.slice(r, a), l[s] ? l[s] += a : l[++s] = a), (o = o[0]) === (n = n[0]) ? l[s] ? l[s] += n : l[++s] = n : (l[++s] = null, c.push({
        i: s,
        x: /*#__PURE__*/ gt(o, n)
    })), r = xa.lastIndex;
    return r < e.length && (a = /*#__PURE__*/ e.slice(r), l[s] ? l[s] += a : l[++s] = a), l.length < 2 ? c[0] ? um(c[0].x) : cm(e) : (e = c.length, function(h) {
...
function ke(t, e) {
    var r = typeof e, o;
    return e == null || r === "boolean" ? cr(e) : (r === "number" ? gt : r === "string" ? (o = /*#__PURE__*/ Gt(e)) ? (e = o, Ne) : ur : e instanceof Gt ? Ne : e instanceof Date ? pa : Fh(e) ? ma : Array.isArray(e) ? Lh : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? ga : gt)(t, e);
}
m$1(ke, "default");
function Xi(t, e) {
    return t = +t, e = +e, function(r) {
...
function Ah(t) {
    ...
    return e.isIdentity ? ji : Zi(e.a, e.b, e.c, e.d, e.e, e.f);
}
m$1(Ah, "parseCss");
function Eh(t) {
    return t == null ? ji : (Ki || (Ki = /*#__PURE__*/ document.createElementNS("http://www.w3.org/2000/svg", "g")), Ki.setAttribute("transform", t), (t = /*#__PURE__*/ Ki.transform.baseVal.consolidate()) ? (t = t.matrix, Zi(t.a, t.b, t.c, t.d, t.e, t.f)) : ji);
}
m$1(Eh, "parseSvg");
function Dh(t, e, r, o) {
    function n(h) {
...
m$1(Dh, "interpolateTransform");
var Ca = /*#__PURE__*/ Dh(Ah, "px, ", "px)", "deg)"), _a = /*#__PURE__*/ Dh(Eh, ", ", ")", ")");
function Se(t, e) {
...
m$1(Se, "initRange");
var ba = /*#__PURE__*/ Symbol("implicit");
function Vr() {
    var t = new rr, e = [], r = [], o = ba;
    function n(a) {
...
function dm(t, e, r) {
    ...
    return n < o ? (o = /*#__PURE__*/ Sa(n, o), a = /*#__PURE__*/ r(s, a)) : (o = /*#__PURE__*/ Sa(o, n), a = /*#__PURE__*/ r(a, s)), function(l) {
...
function mm(t, e, r) {
    ...
    for(t[o] < t[0] && (t = /*#__PURE__*/ t.slice().reverse(), e = /*#__PURE__*/ e.slice().reverse()); ++s < o;)n[s] = /*#__PURE__*/ Sa(t[s], t[s + 1]), a[s] = /*#__PURE__*/ r(e[s], e[s + 1]);
    return function(l) {
        var c = pn(t, l, 1, o) - 1;
...
m$1(Qi, "copy");
function pm() {
    var t = Oh, e = Oh, r = ke, o, n, a, s = fr, l, c, h;
    function u() {
        var f = /*#__PURE__*/ Math.min(t.length, e.length);
        return s !== fr && (s = /*#__PURE__*/ fm(t[0], t[f - 1])), l = f > 2 ? mm : dm, c = h = null, p;
    }
    m$1(u, "rescale");
    function p(f) {
    ...
    return m$1(p, "scale"), p.invert = function(f) {
        ...
        return arguments.length ? (t = /*#__PURE__*/ Array.from(f, ka), u()) : t.slice();
    }, p.range = function(f) {
        return arguments.length ? (e = /*#__PURE__*/ Array.from(f), u()) : e.slice();
    }, p.rangeRound = function(f) {
        return e = /*#__PURE__*/ Array.from(f), r = Xi, u();
    }, p.clamp = function(f) {
        return arguments.length ? (s = f ? true : fr, u()) : s !== fr;
...
var Aa = {
    ...
    p: /*#__PURE__*/ m$1((t, e)=>to(t * 100, e), "p"),
    r: to,
    s: Ma,
...
function Ea(t) {
    var e = t.grouping === void 0 || t.thousands === void 0 ? eo : wa(/*#__PURE__*/ Ih.call(t.grouping, Number), t.thousands + ""), r = t.currency === void 0 ? "" : t.currency[0] + "", o = t.currency === void 0 ? "" : t.currency[1] + "", n = t.decimal === void 0 ? "." : t.decimal + "", a = t.numerals === void 0 ? eo : Ba(/*#__PURE__*/ Ih.call(t.numerals, String)), s = t.percent === void 0 ? "%" : t.percent + "", l = t.minus === void 0 ? "\u2212" : t.minus + "", c = t.nan === void 0 ? "NaN" : t.nan + "";
    function h(p) {
        p = /*#__PURE__*/ ve(p);
        var f = p.fill, g = p.align, T = p.sign, A = p.symbol, W = p.zero, q = p.width, G = p.comma, D = p.precision, L = p.trim, P = p.type;
        P === "n" ? (G = true, P = "g") : Aa[P] || (D === void 0 && (D = 12), L = true, P = "g"), (W || f === "0" && g === "=") && (W = true, f = "0", g = "=");
        var w = A === "$" ? r : A === "#" && /[boxX]/.test(P) ? "0" + P.toLowerCase() : "", X = A === "$" ? o : /[%p]/.test(P) ? s : "", j = Aa[P], $ = /*#__PURE__*/ /[defgprs%]/.test(P);
        D = D === void 0 ? 6 : /[gprs]/.test(P) ? Math.max(1, /*#__PURE__*/ Math.min(21, D)) : Math.max(0, /*#__PURE__*/ Math.min(20, D));
        function it(B) {
            var k = w, x = X, y, M, S;
            if (P === "c") x = j(B) + x, B = "";
            else {
                B = +B;
                var z = B < 0 || 1 / B < 0;
                if (B = isNaN(B) ? c : j(/*#__PURE__*/ Math.abs(B), D), L && (B = /*#__PURE__*/ Fa(B)), z && +B == 0 && T !== "+" && (z = false), k = (z ? T === "(" ? T : l : T === "-" || T === "(" ? "" : T) + k, x = (P === "s" ? zh[8 + La / 3] : "") + x + (z && T === "(" ? ")" : ""), $) {
                    for(y = -1, M = B.length; ++y < M;)if (S = /*#__PURE__*/ B.charCodeAt(y), 48 > S || S > 57) {
    ...
    m$1(h, "newFormat");
    function u(p, f) {
        var g = /*#__PURE__*/ h((p = /*#__PURE__*/ ve(p), p.type = "f", p)), T = Math.max(-8, /*#__PURE__*/ Math.min(8, /*#__PURE__*/ Math.floor(Vt(f) / 3))) * 3, A = /*#__PURE__*/ Math.pow(10, -T), W = zh[8 + T / 3];
        return function(q) {
            return g(A * q) + W;
        };
    }
...
function Da(t) {
    return ro = /*#__PURE__*/ Ea(t), io = ro.format, oo = ro.formatPrefix, ro;
}
...
function Oa(t, e, r, o) {
    ...
    switch(o = /*#__PURE__*/ ve(o ?? ",f"), o.type){
        ...
        case "r":
            {
                o.precision == null && !isNaN(a = /*#__PURE__*/ so(n, /*#__PURE__*/ Math.max(/*#__PURE__*/ Math.abs(t), /*#__PURE__*/ Math.abs(e)))) && (o.precision = a - (o.type === "e"));
                break;
            }
        case "f":
        case "%":
            {
                o.precision == null && !isNaN(a = /*#__PURE__*/ no(n)) && (o.precision = a - (o.type === "%") * 2);
                break;
            }
    }
    return io(o);
...
function Ia() {
    ...
    return t.copy = function() {
        return Qi(t, /*#__PURE__*/ Ia());
    }, Se.apply(t, arguments), xm(t);
}
m$1(Ia, "linear");
var za = new Date, Ra = new Date;
function ot(t, e, r, o) {
    function n(a) {
    ...
    return m$1(n, "interval"), n.floor = (a)=>(t(a = new Date(+a)), a), n.ceil = (a)=>(t(a = new Date(a - 1)), e(a, 1), t(a), a), n.round = (a)=>{
        ...
        }), r && (n.count = (a, s)=>(za.setTime(+a), Ra.setTime(+s), t(za), t(Ra), Math.floor(/*#__PURE__*/ r(za, Ra))), n.every = (a)=>(a = /*#__PURE__*/ Math.floor(a), !isFinite(a) || !(a > 0) ? null : a > 1 ? n.filter(o ? (s)=>o(s) % a === 0 : (s)=>n.count(0, s) % a === 0) : n)), n;
}
m$1(ot, "timeInterval");
...
function Kh(t, e, r, o, n, a) {
    ...
    function c(h, u, p) {
        ...
        if (g === s.length) return t.every(/*#__PURE__*/ ir(h / 31536e6, u / 31536e6, p));
        if (g === 0) return Pe.every(/*#__PURE__*/ Math.max(/*#__PURE__*/ ir(h, u, p), 1));
        let [T, A] = s[f / s[g - 1][2] < s[g][2] / f ? g - 1 : g];
        return T.every(A);
    }
...
m$1(Kh, "ticker");
var [$m, Hm] = Kh(Xt, uo, Ye, co, ho, lo), [Na, qa] = Kh(Nt, xr, fe, ue, mr, dr);
function Pa(t) {
    if (0 <= t.y && t.y < 100) {
...
m$1(Kr, "newDate");
function $a(t) {
    var e = t.dateTime, r = t.date, o = t.time, n = t.periods, a = t.days, s = t.shortDays, l = t.months, c = t.shortMonths, h = /*#__PURE__*/ Qr(n), u = /*#__PURE__*/ Jr(n), p = /*#__PURE__*/ Qr(a), f = /*#__PURE__*/ Jr(a), g = /*#__PURE__*/ Qr(s), T = /*#__PURE__*/ Jr(s), A = /*#__PURE__*/ Qr(l), W = /*#__PURE__*/ Jr(l), q = /*#__PURE__*/ Qr(c), G = /*#__PURE__*/ Jr(c), D = {
        a: z,
        A: I,
        b: U,
        B: rt,
    ...
    D.x = /*#__PURE__*/ w(r, D), D.X = /*#__PURE__*/ w(o, D), D.c = /*#__PURE__*/ w(e, D), L.x = /*#__PURE__*/ w(r, L), L.X = /*#__PURE__*/ w(o, L), L.c = /*#__PURE__*/ w(e, L);
    function w(v, H) {
        return function(V) {
            var C = [], mt = -1, J = 0, bt = v.length, Tt, It, Me;
            for(V instanceof Date || (V = new Date(+V)); ++mt < bt;)v.charCodeAt(mt) === 37 && (C.push(/*#__PURE__*/ v.slice(J, mt)), (It = Qh[Tt = /*#__PURE__*/ v.charAt(++mt)]) != null ? Tt = /*#__PURE__*/ v.charAt(++mt) : It = Tt === "e" ? " " : "0", (Me = H[Tt]) && (Tt = /*#__PURE__*/ Me(V, It)), C.push(Tt), J = mt + 1);
    ...
    function X(v, H) {
        return function(V) {
            ...
            if (H && !("Z" in C) && (C.Z = 0), "p" in C && (C.H = C.H % 12 + C.p * 12), C.m === void 0 && (C.m = "q" in C ? C.q : 0), "V" in C) {
                ...
                "w" in C || (C.w = 1), "Z" in C ? (J = /*#__PURE__*/ Wa(/*#__PURE__*/ Kr(C.y, 0, 1)), bt = /*#__PURE__*/ J.getUTCDay(), J = bt > 4 || bt === 0 ? gr.ceil(J) : gr(J), J = /*#__PURE__*/ Zr.offset(J, (C.V - 1) * 7), C.y = /*#__PURE__*/ J.getUTCFullYear(), C.m = /*#__PURE__*/ J.getUTCMonth(), C.d = J.getUTCDate() + (C.w + 6) % 7) : (J = /*#__PURE__*/ Pa(/*#__PURE__*/ Kr(C.y, 0, 1)), bt = /*#__PURE__*/ J.getDay(), J = bt > 4 || bt === 0 ? pr.ceil(J) : pr(J), J = /*#__PURE__*/ ue.offset(J, (C.V - 1) * 7), C.y = /*#__PURE__*/ J.getFullYear(), C.m = /*#__PURE__*/ J.getMonth(), C.d = J.getDate() + (C.w + 6) % 7);
            } else ("W" in C || "U" in C) && ("w" in C || (C.w = "u" in C ? C.u % 7 : "W" in C ? 1 : 0), bt = "Z" in C ? Wa(/*#__PURE__*/ Kr(C.y, 0, 1)).getUTCDay() : Pa(/*#__PURE__*/ Kr(C.y, 0, 1)).getDay(), C.m = 0, C.d = "W" in C ? (C.w + 6) % 7 + C.W * 7 - (bt + 5) % 7 : C.w + C.U * 7 - (bt + 6) % 7);
            return "Z" in C ? (C.H += C.Z / 100 | 0, C.M += C.Z % 100, Wa(C)) : Pa(C);
        };
    }
    m$1(X, "newParse");
    function j(v, H, V, C) {
...
function Fp(t, e) {
    return et(1 + Zr.count(/*#__PURE__*/ Xt(t), t), e, 3);
}
...
m$1(Lp, "formatUTCMicroseconds");
function Mp(t, e) {
    return et(t.getUTCMonth() + 1, e, 2);
}
m$1(Mp, "formatUTCMonthNumber");
function Ap(t, e) {
...
m$1(Dp, "formatUTCWeekdayNumberMonday");
function Op(t, e) {
    return et(/*#__PURE__*/ Ye.count(Xt(t) - 1, t), e, 2);
}
m$1(Op, "formatUTCWeekNumberSunday");
function uc(t) {
    var e = /*#__PURE__*/ t.getUTCDay();
...
m$1(uc, "UTCdISO");
function Ip(t, e) {
    return t = /*#__PURE__*/ uc(t), et(Be.count(/*#__PURE__*/ Xt(t), t) + (Xt(t).getUTCDay() === 4), e, 2);
}
...
function Rp(t, e) {
    return et(/*#__PURE__*/ gr.count(Xt(t) - 1, t), e, 2);
}
...
function Ha(t) {
    return yr = /*#__PURE__*/ $a(t), fo = yr.format, yr.parse, yr.utcFormat, yr.utcParse, yr;
}
m$1(Ha, "defaultLocale");
function Ua(t, e) {
    t = /*#__PURE__*/ t.slice();
...
m$1(Up, "number");
function pc(t, e, r, o, n, a, s, l, c, h) {
    var u = /*#__PURE__*/ Xr(), p = u.invert, f = u.domain, g = /*#__PURE__*/ h(".%L"), T = /*#__PURE__*/ h(":%S"), A = /*#__PURE__*/ h("%I:%M"), W = /*#__PURE__*/ h("%I %p"), q = /*#__PURE__*/ h("%a %d"), G = /*#__PURE__*/ h("%b %d"), D = /*#__PURE__*/ h("%B"), L = /*#__PURE__*/ h("%Y");
    function P(w) {
        return (c(w) < w ? g : l(w) < w ? T : s(w) < w ? A : a(w) < w ? W : o(w) < w ? n(w) < w ? q : G : r(w) < w ? D : L)(w);
    }
    return m$1(P, "tickFormat"), u.invert = function(w) {
        ...
        var X = /*#__PURE__*/ f();
        return (!w || typeof w.range != "function") && (w = /*#__PURE__*/ e(X[0], X[X.length - 1], w ?? 10)), w ? f(/*#__PURE__*/ Ua(X, w)) : u;
    }, u.copy = function() {
        return Qi(u, /*#__PURE__*/ pc(t, e, r, o, n, a, s, l, c, h));
    }, u;
}
m$1(pc, "calendar");
function gc() {
    return Se.apply(/*#__PURE__*/ pc(Na, qa, Nt, xr, fe, ue, mr, dr, ee, fo).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2)
    ]), arguments);
}
m$1(gc, "time");
function Ya() {
    var t = /*#__PURE__*/ Vr().unknown(void 0), e = t.domain, r = t.range, o = 0, n = 1, a, s, l = false, c = 0, h = 0, u = .5;
    delete t.unknown;
    function p() {
        var f = e().length, g = n < o, T = g ? n : o, A = g ? o : n;
        a = (A - T) / Math.max(1, f - c + h * 2), l && (a = /*#__PURE__*/ Math.floor(a)), T += (A - T - a * (f - c)) * u, s = a * (1 - c), l && (T = /*#__PURE__*/ Math.round(T), s = /*#__PURE__*/ Math.round(s));
        var W = /*#__PURE__*/ Ni(f).map(function(q) {
            return T + a * q;
        });
...
m$1(Ga, "default");
var Yp = /*#__PURE__*/ Ga("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
function at(t) {
    return m$1(function() {
        return t;
    }, "constant");
...
m$1(at, "default");
var Va = Math.abs, vt = Math.atan2, Fe = Math.cos, xc = Math.max, mo = Math.min, jt = Math.sin, Ge = Math.sqrt, yt = 1e-12, Cr = Math.PI, ti = Cr / 2, _r = 2 * Cr;
function yc(t) {
...
m$1(Xa, "asin");
var ja = Math.PI, Za = 2 * ja, Ve = 1e-6, Gp = Za - Ve;
function Cc(t) {
    this._ += t[0];
...
var Xe = class {
    ...
    arcTo(e, r, o, n, a) {
        ...
        else if (f > Ve) if (!(Math.abs(p * c - h * u) > Ve) || !a) this._append`L${this._x1 = e},${this._y1 = r}`;
        else {
            let g = o - s, T = n - l, A = c * c + h * h, W = g * g + T * T, q = /*#__PURE__*/ Math.sqrt(A), G = /*#__PURE__*/ Math.sqrt(f), D = a * Math.tan((ja - Math.acos((A + f - W) / (2 * q * G))) / 2), L = D / G, P = D / q;
            Math.abs(L - 1) > Ve && this._append`L${e + L * u},${r + L * p}`, this._append`A${a},${a},0,0,${+(p * g > u * T)},${this._x1 = e + P * c},${this._y1 = r + P * h}`;
        }
    }
    arc(e, r, o, n, a, s) {
        if (e = +e, r = +r, o = +o, s = !!s, o < 0) throw new Error(`negative radius: ${o}`);
        let l = o * Math.cos(n), c = o * Math.sin(n), h = e + l, u = r + c, p = 1 ^ s, f = s ? n - a : a - n;
        this._x1 === null ? this._append`M${h},${u}` : (Math.abs(this._x1 - h) > Ve || Math.abs(this._y1 - u) > Ve) && this._append`L${h},${u}`, o && (f < 0 && (f = f % Za + Za), f > Gp ? this._append`A${o},${o},0,1,${p},${e - l},${r - c}A${o},${o},0,1,${p},${this._x1 = h},${this._y1 = u}` : f > Ve && this._append`A${o},${o},0,${+(f >= ja)},${p},${this._x1 = e + o * Math.cos(a)},${this._y1 = r + o * Math.sin(a)}`);
    }
    rect(e, r, o, n) {
...
m$1(Jp, "intersect");
function go(t, e, r, o, n, a, s) {
    var l = t - r, c = e - o, h = (s ? a : -a) / Ge(l * l + c * c), u = h * c, p = -h * l, f = t + u, g = e + p, T = r + u, A = o + p, W = (f + T) / 2, q = (g + A) / 2, G = T - f, D = A - g, L = G * G + D * D, P = n - a, w = f * A - T * g, X = (D < 0 ? -1 : 1) * Ge(/*#__PURE__*/ xc(0, P * P * L - w * w)), j = (w * D - G * X) / L, $ = (-w * G - D * X) / L, it = (w * D + G * X) / L, B = (-w * G + D * X) / L, k = j - W, x = $ - q, y = it - W, M = B - q;
    return k * k + x * x > y * y + M * M && (j = it, $ = B), {
        cx: j,
        cy: $,
        x01: -u,
        y01: -p,
...
m$1(go, "cornerTangents");
function bc() {
    var t = Xp, e = jp, r = /*#__PURE__*/ at(0), o = null, n = Zp, a = Kp, s = Qp, l = null, c = /*#__PURE__*/ po(h);
    function h() {
        var u, p, f = +t.apply(this, arguments), g = +e.apply(this, arguments), T = n.apply(this, arguments) - ti, A = a.apply(this, arguments) - ti, W = /*#__PURE__*/ Va(A - T), q = A > T;
        if (l || (l = u = /*#__PURE__*/ c()), g < f && (p = g, g = f, f = p), !(g > yt)) l.moveTo(0, 0);
        else if (W > _r - yt) l.moveTo(g * Fe(T), g * jt(T)), l.arc(0, 0, g, T, A, !q), f > yt && (l.moveTo(f * Fe(A), f * jt(A)), l.arc(0, 0, f, A, T, q));
        else {
            var G = T, D = A, L = T, P = A, w = W, X = W, j = s.apply(this, arguments) / 2, $ = j > yt && (o ? +o.apply(this, arguments) : Ge(f * f + g * g)), it = /*#__PURE__*/ mo(Va(g - f) / 2, +r.apply(this, arguments)), B = it, k = it, x, y;
            if ($ > yt) {
                var M = /*#__PURE__*/ Xa($ / f * jt(j)), S = /*#__PURE__*/ Xa($ / g * jt(j));
                (w -= M * 2) > yt ? (M *= q ? 1 : -1, L += M, P -= M) : (w = 0, L = P = (T + A) / 2), (X -= S * 2) > yt ? (S *= q ? 1 : -1, G += S, D -= S) : (X = 0, G = D = (T + A) / 2);
            }
            var z = g * Fe(G), I = g * jt(G), U = f * Fe(P), rt = f * jt(P);
            if (it > yt) {
                var Y = g * Fe(D), nt = g * jt(D), Q = f * Fe(L), Ft = f * jt(L), Z;
                if (W < Cr) if (Z = /*#__PURE__*/ Jp(z, I, Q, Ft, Y, nt, U, rt)) {
                    var Ct = z - Z[0], _t = I - Z[1], lt = Y - Z[0], v = nt - Z[1], H = 1 / jt(yc((Ct * lt + _t * v) / (Ge(Ct * Ct + _t * _t) * Ge(lt * lt + v * v))) / 2), V = /*#__PURE__*/ Ge(Z[0] * Z[0] + Z[1] * Z[1]);
                    B = /*#__PURE__*/ mo(it, (f - V) / (H - 1)), k = /*#__PURE__*/ mo(it, (g - V) / (H + 1));
                } else B = k = 0;
            }
            X > yt ? k > yt ? (x = /*#__PURE__*/ go(Q, Ft, z, I, g, k, q), y = /*#__PURE__*/ go(Y, nt, U, rt, g, k, q), l.moveTo(x.cx + x.x01, x.cy + x.y01), k < it ? l.arc(x.cx, x.cy, k, /*#__PURE__*/ vt(x.y01, x.x01), /*#__PURE__*/ vt(y.y01, y.x01), !q) : (l.arc(x.cx, x.cy, k, /*#__PURE__*/ vt(x.y01, x.x01), /*#__PURE__*/ vt(x.y11, x.x11), !q), l.arc(0, 0, g, /*#__PURE__*/ vt(x.cy + x.y11, x.cx + x.x11), /*#__PURE__*/ vt(y.cy + y.y11, y.cx + y.x11), !q), l.arc(y.cx, y.cy, k, /*#__PURE__*/ vt(y.y11, y.x11), /*#__PURE__*/ vt(y.y01, y.x01), !q))) : (l.moveTo(z, I), l.arc(0, 0, g, G, D, !q)) : l.moveTo(z, I), !(f > yt) || !(w > yt) ? l.lineTo(U, rt) : B > yt ? (x = /*#__PURE__*/ go(U, rt, Y, nt, f, -B, q), y = /*#__PURE__*/ go(z, I, Q, Ft, f, -B, q), l.lineTo(x.cx + x.x01, x.cy + x.y01), B < it ? l.arc(x.cx, x.cy, B, /*#__PURE__*/ vt(x.y01, x.x01), /*#__PURE__*/ vt(y.y01, y.x01), !q) : (l.arc(x.cx, x.cy, B, /*#__PURE__*/ vt(x.y01, x.x01), /*#__PURE__*/ vt(x.y11, x.x11), !q), l.arc(0, 0, f, /*#__PURE__*/ vt(x.cy + x.y11, x.cx + x.x11), /*#__PURE__*/ vt(y.cy + y.y11, y.cx + y.x11), q), l.arc(y.cx, y.cy, B, /*#__PURE__*/ vt(y.y11, y.x11), /*#__PURE__*/ vt(y.y01, y.x01), !q))) : l.arc(0, 0, f, P, L, q);
        }
        if (l.closePath(), u) return l = null, u + "" || null;
    }
    return m$1(h, "arc"), h.centroid = function() {
        var u = (+t.apply(this, arguments) + +e.apply(this, arguments)) / 2, p = (+n.apply(this, arguments) + +a.apply(this, arguments)) / 2 - Cr / 2;
        return [
            Fe(p) * u,
            jt(p) * u
        ];
...
m$1(Sc, "y");
function vc(t, e) {
    var r = /*#__PURE__*/ at(true), o = null, n = xo, a = null, s = /*#__PURE__*/ po(l);
    t = typeof t == "function" ? t : t === void 0 ? kc : at(t), e = typeof e == "function" ? e : e === void 0 ? Sc : at(e);
    function l(c) {
...
m$1(Qa, "default");
function wc() {
    var t = Qa, e = Ka, r = null, o = /*#__PURE__*/ at(0), n = /*#__PURE__*/ at(_r), a = /*#__PURE__*/ at(0);
    function s(l) {
        var c, h = (l = /*#__PURE__*/ ei(l)).length, u, p, f = 0, g = new Array(h), T = new Array(h), A = +o.apply(this, arguments), W = /*#__PURE__*/ Math.min(_r, /*#__PURE__*/ Math.max(-_r, n.apply(this, arguments) - A)), q, G = /*#__PURE__*/ Math.min(Math.abs(W) / h, /*#__PURE__*/ a.apply(this, arguments)), D = G * (W < 0 ? -1 : 1), L;
        for(c = 0; c < h; ++c)(L = T[g[c] = c] = +t(l[c], c, l)) > 0 && (f += L);
        for(e != null ? g.sort(function(P, w) {
            return e(T[P], T[w]);
        }) : r != null && g.sort(function(P, w) {
            return r(l[P], l[w]);
        }), c = 0, p = f ? (W - h * D) / f : 0; c < h; ++c, A = q)u = g[c], L = T[u], q = A + (L > 0 ? L * p : 0) + D, T[u] = {
            data: l[u],
            index: c,
            value: L,
            startAngle: A,
...
function tg(t) {
    return new yo(t, true);
}
m$1(tg, "bumpX");
function eg(t) {
    return new yo(t, false);
}
m$1(eg, "bumpY");
function br(t, e, r) {
...
var sg = /*#__PURE__*/ m$1(function t(e) {
    function r(o) {
        return e ? new Oc(o, e) : new _o(o, 0);
    }
    return m$1(r, "catmullRom"), r.alpha = function(o) {
        return t(+o);
    }, r;
...
var lg = /*#__PURE__*/ m$1(function t(e) {
    function r(o) {
        return e ? new Ic(o, e) : new bo(o, 0);
    }
    return m$1(r, "catmullRom"), r.alpha = function(o) {
        return t(+o);
    }, r;
...
function qc(t, e, r) {
    ...
    return (Nc(a) + Nc(s)) * Math.min(/*#__PURE__*/ Math.abs(a), /*#__PURE__*/ Math.abs(s), .5 * Math.abs(l)) || 0;
}
m$1(qc, "slope3");
function Pc(t, e) {
    var r = t._x1 - t._x0;
    ...
    lineEnd: /*#__PURE__*/ m$1(function() {
        switch(this._point){
            case 2:
                ...
                break;
            case 3:
                Ja(this, this._t0, /*#__PURE__*/ Pc(this, this._t0));
                break;
        }
        (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
    }, "lineEnd"),
        ...
        if (t = +t, e = +e, !(t === this._x1 && e === this._y1)) {
            switch(this._point){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    this._point = 3, Ja(this, /*#__PURE__*/ Pc(this, r = /*#__PURE__*/ qc(this, t, e)), r);
                    break;
                default:
                    Ja(this, this._t0, r = /*#__PURE__*/ qc(this, t, e));
                    break;
            }
...
m$1(Wc, "MonotoneY");
(Wc.prototype = /*#__PURE__*/ Object.create(To.prototype)).point = function(t, e) {
    To.prototype.point.call(this, e, t);
};
function $c(t) {
    this._context = t;
}
...
Uc.prototype = {
    ...
    lineEnd: /*#__PURE__*/ m$1(function() {
        ...
        else for(var o = /*#__PURE__*/ Hc(t), n = /*#__PURE__*/ Hc(e), a = 0, s = 1; s < r; ++a, ++s)this._context.bezierCurveTo(o[0][a], n[0][a], o[1][a], n[1][a], t[s], e[s]);
...
So.prototype = Xc.prototype = {
    constructor: So,
    on: /*#__PURE__*/ m$1(function(t, e) {
        var r = this._, o = /*#__PURE__*/ mg(t + "", r), n, a = -1, s = o.length;
        if (arguments.length < 2) {
            for(; ++a < s;)if ((n = (t = o[a]).type) && (n = /*#__PURE__*/ pg(r[n], t.name))) return n;
            return;
        }
        if (e != null && typeof e != "function") throw new Error("invalid callback: " + e);
        for(; ++a < s;)if (n = (t = o[a]).type) r[n] = /*#__PURE__*/ Vc(r[n], t.name, e);
...
m$1(Vc, "set");
var ts = Xc;
var kr = 0, ni = 0, oi = 0, Zc = 1e3, vo, ai, wo = 0, je = 0, Bo = 0, si = typeof performance == "object" && performance.now ? performance : Date, Kc = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
    setTimeout(t, 17);
};
function hi() {
    return je || (Kc(gg), je = si.now() + Bo);
}
m$1(hi, "now");
function gg() {
    je = 0;
...
m$1(li, "Timer");
li.prototype = Fo.prototype = {
    constructor: li,
    restart: /*#__PURE__*/ m$1(function(t, e, r) {
        if (typeof t != "function") throw new TypeError("callback is not a function");
        r = (r == null ? hi() : +r) + (e == null ? 0 : +e), !this._next && ai !== this && (ai ? ai._next = this : vo = this, ai = this), this._call = t, this._time = r, es();
    }, "restart"),
...
function Qc() {
    hi(), ++kr;
    for(var t = vo, e; t;)(e = je - t._time) >= 0 && t._call.call(void 0, e), t = t._next;
    --kr;
}
m$1(Qc, "timerFlush");
function jc() {
    je = (wo = /*#__PURE__*/ si.now()) + Bo, kr = ni = 0;
    try {
        Qc();
    } finally{
        kr = 0, yg(), je = 0;
...
m$1(jc, "wake");
function xg() {
    var t = /*#__PURE__*/ si.now(), e = t - wo;
    e > Zc && (Bo -= e, wo = t);
}
m$1(xg, "poke");
function yg() {
    for(var t, e = vo, r, o = 1 / 0; e;)e._call ? (o > e._time && (o = e._time), t = e, e = e._next) : (r = e._next, e._next = null, e = t ? t._next = r : vo = r);
    ai = t, es(o);
}
m$1(yg, "nap");
function es(t) {
    if (!kr) {
        ...
        var e = t - je;
        e > 24 ? (t < 1 / 0 && (ni = /*#__PURE__*/ setTimeout(jc, t - si.now() - Bo)), oi && (oi = /*#__PURE__*/ clearInterval(oi))) : (oi || (wo = /*#__PURE__*/ si.now(), oi = /*#__PURE__*/ setInterval(xg, Zc)), kr = 1, Kc(jc));
    }
}
m$1(es, "sleep");
function ci(t, e, r) {
...
m$1(ci, "default");
var Cg = /*#__PURE__*/ ts("start", "end", "cancel", "interrupt"), _g = [], eu = 0, Jc = 1, Mo = 2, Lo = 3, tu = 4, Ao = 5, ui = 6;
...
function wt(t, e) {
    var r = /*#__PURE__*/ dt(t, e);
    if (r.state > Lo) throw new Error("too late; already running");
    return r;
}
m$1(wt, "set");
function dt(t, e) {
...
function bg(t, e, r) {
    ...
    o[e] = r, r.timer = /*#__PURE__*/ Fo(a, 0, r.time);
    function a(h) {
        r.state = Jc, r.timer.restart(s, r.delay, r.time), r.delay <= h && s(h - r.delay);
    }
    m$1(a, "schedule");
    function s(h) {
        var u, p, f, g;
        ...
        if (ci(function() {
            r.state === Lo && (r.state = tu, r.timer.restart(l, r.delay, r.time), l(h));
        }), r.state = Mo, r.on.call("start", t, t.__data__, r.index, r.group), r.state === Mo) {
            for(r.state = Lo, n = new Array(f = r.tween.length), u = 0, p = -1; u < f; ++u)(g = /*#__PURE__*/ r.tween[u].value.call(t, t.__data__, r.index, r.group)) && (n[++p] = g);
            n.length = p + 1;
        }
    }
    m$1(s, "start");
    function l(h) {
        for(var u = h < r.duration ? r.ease.call(null, h / r.duration) : (r.timer.restart(c), r.state = Ao, 1), p = -1, f = n.length; ++p < f;)n[p].call(t, u);
        r.state === Ao && (r.on.call("end", t, t.__data__, r.index, r.group), c());
    }
    m$1(l, "tick");
    function c() {
...
function di(t, e) {
    ...
    if (r) {
        ...
        for(s in r){
            ...
            n = o.state > Mo && o.state < Ao, o.state = ui, o.timer.stop(), o.on.call(n ? "interrupt" : "cancel", t, t.__data__, o.index, o.group), delete r[s];
        }
...
function mi(t, e) {
    var r;
    return (typeof e == "number" ? gt : e instanceof Gt ? Ne : (r = /*#__PURE__*/ Gt(e)) ? (e = r, Ne) : ur)(t, e);
}
m$1(mi, "default");
function Sg(t) {
    return function() {
...
m$1(Lg, "attrFunctionNS");
function os(t, e) {
    var r = /*#__PURE__*/ Qt(t), o = r === "transform" ? _a : mi;
    return this.attrTween(t, typeof e == "function" ? (r.local ? Lg : Fg)(r, o, /*#__PURE__*/ Sr(this, "attr." + t, e)) : e == null ? (r.local ? vg : Sg)(r) : (r.local ? Bg : wg)(r, o, e));
}
m$1(os, "default");
function Mg(t, e) {
    return function(r) {
...
function ns(t, e) {
    ...
    var o = /*#__PURE__*/ Qt(t);
    return this.tween(r, /*#__PURE__*/ (o.local ? Eg : Dg)(o, e));
}
m$1(ns, "default");
function Og(t, e) {
    return function() {
...
function as(t) {
    var e = this._id;
    return arguments.length ? this.each(/*#__PURE__*/ (typeof t == "function" ? Og : Ig)(e, t)) : dt(/*#__PURE__*/ this.node(), e).delay;
}
m$1(as, "default");
function zg(t, e) {
    return function() {
...
function Vg(t, e) {
    ...
    return function() {
        var c = /*#__PURE__*/ wt(this, t), h = c.on, u = c.value[a] == null ? l || (l = /*#__PURE__*/ ru(e)) : void 0;
        (h !== r || n !== u) && (o = /*#__PURE__*/ (r = h).copy()).on(s, n = u), c.on = o;
    };
}
m$1(Vg, "styleMaybeRemove");
function xs(t, e, r) {
    var o = (t += "") == "transform" ? Ca : mi;
...
m$1(_s, "default");
function bs() {
    for(var t = this._name, e = this._id, r = /*#__PURE__*/ Eo(), o = this._groups, n = o.length, a = 0; a < n; ++a)for(var s = o[a], l = s.length, c, h = 0; h < l; ++h)if (c = s[h]) {
...
function ks(t) {
    var e, r;
    t instanceof Ot ? (e = t._id, t = t._name) : (e = /*#__PURE__*/ Eo(), (r = ex).time = /*#__PURE__*/ hi(), t = t == null ? null : t + "");
    for(var o = this._groups, n = o.length, a = 0; a < n; ++a)for(var s = o[a], l = s.length, c, h = 0; h < l; ++h)(c = s[h]) && de(c, t, e, h, s, r || rx(c, e));
    return new Ot(o, this._parents, t, e);
}
m$1(ks, "default");
le.prototype.interrupt = rs;
le.prototype.transition = ks;
function ou(t) {
    return [
        +t[0],
        +t[1]
...
var vs = new Le(1, 0, 0);
ws.prototype = Le.prototype;
function ws(t) {
    for(; !t.__zoom;)if (!(t = t.parentNode)) return vs;
    return t.__zoom;
}
m$1(ws, "transform");
export { gc as $, sg as A, Bf as B, Cf as C, De as D, Er as E, Ff as F, Gc as G, Hl as H, ng as I, og as J, rg as K, Lf as L, Mf as M, Ac as N, Lc as O, Pl as P, js as Q, Rl as R, Sf as S, Tf as T, Fi as U, dx as V, Nr as W, hl as X, Yc as Y, IC as Z, zC as _, Su as a, Yl as a0, Ul as a1, Ia as a2, am as a3, Zf as a4, fo as a5, xr as a6, fe as a7, Hh as a8, $h as a9, ye as aA, Iu as aB, Vs as aC, er as aD, px as aE, bi as aF, sC as aG, kC as aH, Xs as aI, Vr as aJ, wc as aK, Yp as aL, pC as aM, un as aN, Ya as aO, we as aa, Wh as ab, Ph as ac, pr as ad, ue as ae, mr as af, dr as ag, ee as ah, Pe as ai, jf as aj, Ys as ak, Df as al, bc as am, $t as an, F as ao, E as ap, mx as aq, Ar as ar, nC as as, aC as at, yl as au, lC as av, RC as aw, Ti as ax, NC as ay, oC as az, vc as b, Bc as c, df as d, Mt as e, Ef as f, gC as g, mC as h, ih as i, fg as j, cg as k, hg as l, mf as m, ag as n, eg as o, pl as p, tg as q, ig as r, se as s, tt as t, ug as u, vf as v, wf as w, xo as x, Rc as y, lg as z };
