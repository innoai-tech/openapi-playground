...
let V = k("div", { displayName: "PopoverContainer" })({ py: 4, rounded: "sm", shadow: "1", containerStyle: "sys.surface", textStyle: "sys.body-small", pos: "relative", maxW: "30vw" }), L = k("div", { displayName: "MenuItem" })({ px: 12, py: 8, gap: 23, display: "flex", alignItems: "start", justifyContent: "space-between", textAlign: "right", textStyle: "sys.body-small", cursor: "pointer", _hover: { containerStyle: "sys.surface-container" } }), U = N({ from: { opacity: 0 }, to: { opacity: 1 }, duration: S.duration.md1, easing: S.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: S.duration.sm4, easing: S.easing.standard.decelerate }), H = n((e2, t2) => {
  ...
  return (t3) => {
    var l2, a2;
    let r2 = o(t3, { "data-deprecated": e2.deprecated, "data-optional": e2.optional, "data-nullable": e2.nullable, children: [n2.leading && i(G, { "data-visible-on-hover": true, children: null === (l2 = n2.leading) || void 0 === l2 ? void 0 : l2.call(n2) }), null === (a2 = n2.default) || void 0 === a2 ? void 0 : a2.call(n2)] });
...
}, { displayName: "Line", props: ["dirty"] }), et = k("div", { displayName: "LineRow" })({ display: "flex", alignItems: "end", _hover: { containerStyle: "sys.surface-container", "& [data-visible-on-hover]": { visibility: "visible" } }, _dirty: { bgColor: C("sys.warning-container", I(0.38)) } }), en = k("span", { displayName: "Description" })({ display: "inline-block", maxWidth: "20vw", "& p": { my: "0.5em" } }), el = r((e2, t2) => {
  let { emit: n2 } = t2;
...
let ev = p(function(e2, t2) {
  ...
  let { render: n2 } = t2, a2 = F.use(), r2 = K.use();
  return l(e2.value$, n2((t3) => i(Z, { openToken: "{", closeToken: "}", $leading: o(es, { children: [i(ek, { onAddProp: (t4) => {
    a2.next((n3) => {
    ...
    return o(ee, { dirty: a2.isDirty(s2, p2), children: [i(Q, { deprecated: c2.getSchema("deprecated"), description: c2.getMeta("description"), $leading: i(ew, { onRemove: () => {
      a2.next((t4) => {
        let n4 = t4;
  ...
  let {} = e2, { emit: n2 } = t2;
  return () => i(H, { $title: "移除节点", children: i(ec, { onClick: () => n2("remove"), children: i(O, { path: J }) }) });
  ...
  return () => {
    ...
    return (null == r2 ? void 0 : r2.length) > 0 ? i(M, { open$: a2, onSelected: (e4) => {
      l2("add-prop", e4);
    }, $content: r2, children: i(H, { $title: "添加属性", children: i(ec, { onClick: () => a2.show(), children: i(O, { path: P }) }) }) }) : null;
  };
  ...
  return l(e2.value$, n2((t3) => i(W, { open$: a2, $content: i(eC, { value: t3, onSubmit: (t4) => {
    r2.next((n3) => {
      w(n3, e2.ctx.path, t4);
    }), a2.hide();
  ...
  let { render: n2 } = t2, a2 = F.use(), r2 = K.use();
  return l(e2.value$, n2((t3) => i(Z, { openToken: "[", closeToken: "]", $leading: o(es, { children: [i(eA, { onAdd: () => {
    a2.next((t4) => {
    ...
    return o(ee, { dirty: a2.isDirty(d2, c2), children: [i(Q, { sx: { opacity: 0.3, mr: "0.5em" }, $leading: i(eT, { onRemove: () => {
      a2.next((t5) => {
  ...
  let {} = e2, { emit: n2 } = t2;
  return () => i(H, { $title: "添加数组项", children: i(ec, { onClick: () => n2("add"), children: i(O, { path: P }) }) });
}, { displayName: "AddItemIconBtn", emits: ["add"] }), eT = n((e2, t2) => {
  let {} = e2, { emit: n2 } = t2;
  return () => i(H, { $title: "移除节点", children: i(ec, { onClick: () => n2("remove"), children: i(O, { path: J }) }) });
}, { displayName: "RemoteItemIconBtn", emits: ["remove"] }), eE = n((e2, t2) => {
  let { render: n2 } = t2, a2 = F.use(), r2 = K.use();
  return l(e2.value$, n2((t3) => i(Z, { openToken: "{", closeToken: "}", $leading: o(es, { children: [i(ej, { onAddKey: (t4) => {
    a2.next((n3) => {
      let l2 = [...e2.ctx.path, t4];
      w(n3, l2, y(n3, l2));
    });
    ...
    if (!Object.hasOwn(t3, d2)) return null;
    let p2 = [...e2.ctx.path, d2];
    return o(ee, { dirty: a2.isDirty(s2, p2), children: [i(Q, { $leading: i(eR, { onRemove: () => {
      a2.next((t4) => {
        let n4 = t4;
        for (let t5 of e2.ctx.path) n4 = n4[t5];
        delete n4[d2];
  ...
  let {} = e2, { emit: n2 } = t2, l2 = new _(false);
  return () => i(W, { open$: l2, $content: i(eJ, { onSubmit: (e3) => {
  ...
  return l(e2.value$, n2((t3) => {
    ...
    return i(M, { open$: r2, onSelected: (t4) => {
      a2.next((n4) => {
        w(n4, e2.ctx.path, t4);
      });
  ...
  let { render: n2 } = t2, a2 = new _(false), r2 = F.use();
  return l(e2.value$, n2((t3) => i(W, { open$: a2, $content: i(eF, { value: t3, onSubmit: (t4) => {
    r2.next((n3) => {
      w(n3, e2.ctx.path, t4);
    }), a2.hide();
  } }), children: i("div", { children: i(el, { value: t3, onClick: () => {
  ...
  let { render: n2 } = t2, a2 = F.use(), r2 = new _(false);
  return l(e2.value$, n2((t3) => i(M, { open$: r2, onSelected: (t4) => {
    a2.next((n3) => {
  ...
  let { render: n2 } = t2, a2 = new _(false), r2 = F.use();
  return l(e2.value$, n2((t3) => i(W, { open$: a2, $content: i(eW, { value: t3, onSubmit: (t4) => {
    r2.next((n3) => {
      w(n3, e2.ctx.path, t4);
    }), a2.hide();
  } }), children: i("div", { children: i(el, { value: t3, onClick: () => {
...
}, { displayName: "NumberForm", props: ["value"], emits: ["submit"] }), e_ = (e2, t2, n2) => "object" == e2.type || "intersection" == e2.type || "union" == e2.type && e2.getSchema("discriminator") ? i(eg, { typedef: e2, value: null != t2 ? t2 : {}, ctx: n2 }) : "union" == e2.type && f(e2.getSchema("discriminator")) ? i(e$, { typedef: e2, value: t2, ctx: n2 }) : "record" == e2.type ? i(eE, { typedef: e2, value: t2, ctx: n2 }) : "array" == e2.type ? i(eO, { typedef: e2, value: t2, ctx: n2 }) : "enums" == e2.type ? i(eP, { typedef: e2, value: t2, ctx: n2 }) : "string" == e2.type ? i(eB, { typedef: e2, value: t2, ctx: n2 }) : "number" == e2.type || "integer" == e2.type ? i(eM, { typedef: e2, value: t2, ctx: n2 }) : "boolean" == e2.type ? i(eK, { typedef: e2, value: t2, ctx: n2 }) : void 0, eV = n((e2, t2) => {
  let {} = e2, { render: n2 } = t2, a2 = F.use(), r2 = K.use(), s2 = d(null);
  return l(a2, n2((e3) => {
    var t3, n3;
    let l2 = null !== (t3 = r2.$value) && void 0 !== t3 ? t3 : e_;
    return i(K, { value: { $value: null !== (n3 = r2.$value) && void 0 !== n3 ? n3 : e_ }, children: o(eL, { children: [i("section", { ref: s2 }), s2.value && i(Y, { value: { indent: 0, $container: s2 }, children: i(ee, { children: l2(a2.typedef, e3, h) }) })] }) });
  }));
