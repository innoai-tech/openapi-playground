...
import { V, S } from './vendor-min-mermaid~chunk-W6CKT3PL.BD4rRGDw.chunk.js';
import { M as Md } from './vendor-min-mermaid~chunk-EQI6KKA3.DOKLknab.chunk.js';
import { U as Ut, J as Jt } from './vendor-min-mermaid~chunk-EFRVIJHI.wT3iKf0B.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { E as En, m as mr, H as Ho, G as Go, j as jo, U as Uo, $ as $o, V as Vo, h as hn, N as No, c as An, P as Pr, Z } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
import { p as pt, i as ia } from './vendor-min-mermaid~chunk-63GW7ZVL.CUmzAGpZ.chunk.js';
var b1 = "flowchart-", Qe = class {
    constructor(){
        this.vertexCounter = 0;
        this.config = /*#__PURE__*/ mr();
...
` + k + `
        ...
        if (f === void 0 && (f = {
            ...
            styles: [],
            classes: []
        }, this.vertices.set(i, f)), this.vertexCounter++, r !== void 0 ? (this.config = /*#__PURE__*/ mr(), F = /*#__PURE__*/ this.sanitizeText(/*#__PURE__*/ r.text.trim()), f.labelType = r.type, F.startsWith('"') && F.endsWith('"') && (F = /*#__PURE__*/ F.substring(1, F.length - 1)), f.text = F) : f.text === void 0 && (f.text = i), n !== void 0 && (f.type = n), a?.forEach((m)=>{
            f.styles.push(m);
        }), l?.forEach((m)=>{
            f.classes.push(m);
...
You have to call mermaid.initialize.`);
    ...
    clear(i = "gen-2") {
        ...
        ], this.subGraphs = [], this.subGraphLookup = new Map, this.subCount = 0, this.tooltips = new Map, this.firstGraphFlag = true, this.version = i, this.config = /*#__PURE__*/ mr(), No();
    }
    setGen(i) {
    ...
    addSubGraph(i, r, n) {
        ...
        }, "uniq")(/*#__PURE__*/ r.flat()), k = c.nodeList, u = c.dir, A = mr().flowchart ?? {};
        if (u = u ?? (A.inheritDir ? this.getDirection() ?? mr().direction ?? void 0 : void 0), this.version === "gen-1") for(let f = 0; f < k.length; f++)k[f] = /*#__PURE__*/ this.lookUpDomId(k[f]);
    ...
    getData() {
        let i = /*#__PURE__*/ mr(), r = [], n = [], a = /*#__PURE__*/ this.getSubGraphs(), l = new Map, g = new Map;
...
var m1 = /*#__PURE__*/ m$1((s, i)=>{
    let r = Pr, n = /*#__PURE__*/ r(s, "r"), a = /*#__PURE__*/ r(s, "g"), l = /*#__PURE__*/ r(s, "b");
    return Z(n, a, l, i);
...
var ts = {
    ...
    styles: c1,
    init: /*#__PURE__*/ m$1((s)=>{
        s.flowchart || (s.flowchart = {}), s.layout && En({
            layout: s.layout
        }), s.flowchart.arrowMarkerAbsolute = s.arrowMarkerAbsolute, En({
            flowchart: {
