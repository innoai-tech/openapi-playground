import { t as tt } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
...
var Y = n((ft, X)=>{
    function we(e) {
        ...
        function t(c) {
            ...
            return m$1(d, "debug"), d.namespace = c, d.useColors = t.useColors(), d.color = t.selectColor(c), d.extend = n, d.destroy = t.destroy, Object.defineProperty(d, "enabled", {
                enumerable: true,
                configurable: false,
