...
import { U as Ut, L as Lt, w as wt } from './vendor-min-mermaid~chunk-EFRVIJHI.wT3iKf0B.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { V as Vo, j as jo, G as Go, $ as $o, U as Uo, H as Ho, m as mr, K as Ko, N as No, h as hn, O as Ot, a as Ni } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
...
var he = Ni.gitGraph, M = /*#__PURE__*/ m$1(()=>Lt({
        ...he,
        ...Ot().gitGraph
    }), "getConfig"), i = new s(()=>{
...
var fe = /*#__PURE__*/ m$1(function(r) {
    ...
    let n = /*#__PURE__*/ M();
    o = /*#__PURE__*/ hn.sanitizeText(o, n), e = /*#__PURE__*/ hn.sanitizeText(e, n), t = t?.map((s)=>hn.sanitizeText(s, n));
    let m = {
...
var Ie = /*#__PURE__*/ mr(), w = Ie?.gitGraph, P = 10, D = 40, k = 4, T = 2, G = 8, b = new Map, C = new Map, R = 30, L = new Map, A = [], E = 0, y = "LR", qe = /*#__PURE__*/ m$1(()=>{
...
`, "id:", e, o), !w) throw new Error("GitGraph config not found");
    ...
    }), ie(s, L, false), w.showBranches && Qe(s, m), Xe(s, L), ie(s, L, true), Ut.insertTitle(s, "gitTitleText", w.titleTopMargin ?? 0, /*#__PURE__*/ n.getDiagramTitle()), Ko(void 0, s, w.diagramPadding, w.useMaxWidth);
}, "draw"), de = {
    draw: tt
};
