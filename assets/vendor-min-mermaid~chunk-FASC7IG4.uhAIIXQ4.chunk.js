...
import { Z as Zr$1, T as Tn$1, N as Nf, b as bn$1, D as Df, d as dn$1, l as lp, J as Jr$1, a as Jm, s as sn$1, y as ym, f as fm, c as Ti, Q as Qr$1, O as Om, t as tp, K as Ki, e as fn$1, X as Xr$1, R as Rn, g as gp, n as np, h as hi, i as Zi, j as Ji } from "./vendor-min-mermaid~chunk-5ZJXQJOJ.DZaYt2YO.chunk.js";
import { t as qs, u as Mt, a as N } from "./vendor-min-mermaid~chunk-6BY5RJGC.BwVspKnk.chunk.js";
...
m$1(g, "addDummyNode");
function xr(r) {
  var e = new m().setGraph(r.graph());
  return Zr$1(r.nodes(), function(n) {
    e.setNode(n, r.node(n));
  }), Zr$1(r.edges(), function(n) {
...
function kr(r) {
  var e = ym(Jr$1(r.nodes(), function(n) {
    return r.node(n).rank;
  }));
  Zr$1(r.nodes(), function(n) {
    var t = r.node(n);
    fm(t, "rank") && (t.rank -= e);
  });
}
...
function gr(r) {
  var e = ym(Jr$1(r.nodes(), function(a) {
    return r.node(a).rank;
  })), n = [];
  Zr$1(r.nodes(), function(a) {
...
function er(r) {
  return bn$1(Jr$1(r.nodes(), function(e) {
    var n = r.node(e).rank;
    if (!sn$1(n)) return n;
  }));
}
...
m$1(jr, "undo");
function Rr(r) {
  Zr$1(r.nodes(), function(e) {
    Cr(r.node(e));
  }), Zr$1(r.edges(), function(e) {
    Cr(r.edge(e));
  });
}
...
}, __ = new WeakMap(), __privateAdd(_a, __, m$1(_a, "List")), _a);
function Sr(r) {
...
function Mr(r, e) {
  ...
  var n = Ee(r, e || we), t = be(n.graph, n.buckets, n.zeroIdx);
  return Qr$1(Jr$1(t, function(o) {
...
function or(r, e, n, t, o) {
  var a = o ? [] : void 0;
  return Zr$1(r.inEdges(t.v), function(i) {
    var f = r.edge(i), d = r.node(i.v);
    o && a.push({
      v: i.v,
      w: i.w
    }), d.out -= f, ar(e, n, d);
  }), Zr$1(r.outEdges(t.v), function(i) {
...
m$1(ar, "assignBucket");
function Fr(r) {
  var e = r.graph().acyclicer === "greedy" ? Mr(r, n(r)) : ye(r);
  Zr$1(e, function(t) {
    var o = r.edge(t);
    r.removeEdge(t), o.forwardName = t.name, o.reversed = true, r.setEdge(t.w, t.v, o, lp("rev"));
  });
  function n(t) {
    return function(o) {
...
function ye(r) {
  var e = [], n = {}, t = {};
  function o(a) {
    Object.prototype.hasOwnProperty.call(t, a) || (t[a] = true, n[a] = true, Zr$1(r.outEdges(a), function(i) {
      Object.prototype.hasOwnProperty.call(n, i.w) ? e.push(i) : o(i.w);
    }), delete n[a]);
  }
  return m$1(o, "dfs"), Zr$1(r.nodes(), o), e;
}
m$1(ye, "dfsFAS");
function Gr(r) {
  Zr$1(r.edges(), function(e) {
...
m$1(Gr, "undo");
function Br(r) {
  r.graph().dummyChains = [], Zr$1(r.edges(), function(e) {
    xe(r, e);
  });
}
m$1(Br, "run");
function xe(r, e) {
  ...
  if (a !== t + 1) {
    ...
    for (l = 0, ++t; t < a; ++l, ++t) f.points = [], c = {
      ...
      edgeObj: e,
      rank: t
    }, h = g(r, "edge", c, "_d"), t === d && (c.width = f.width, c.height = f.height, c.dummy = "edge-label", c.labelpos = f.labelpos), r.setEdge(n, h, {
      weight: f.weight
...
function ir(r) {
  ...
  function o(a) {
    ...
    Object.prototype.hasOwnProperty.call(e, a) || (n[a] = true, e[a] = true, Zr$1(r.predecessors(a), o), delete n[a], t.push(a));
  }
  if (m$1(o, "visit"), Zr$1(r.sinks(), o), tp(e) !== r.nodeCount()) throw new W();
  return t;
}
m$1(ir, "topsort");
function W() {
...
function Yr(r, e, n, t, o, a) {
  Object.prototype.hasOwnProperty.call(t, e) || (t[e] = true, n || a.push(e), Zr$1(o(e), function(i) {
    Yr(r, i, n, t, o, a);
  }), n && a.push(e));
}
m$1(Yr, "doDfs");
...
function ur(r, e) {
  var n = sr(r, r.nodes());
  n = n.slice(0, n.length - 1), Zr$1(n, function(t) {
    Ce(r, e, t);
  });
}
...
function Ur(r, e, n) {
  var t = r.node(n), o = t.parent, a = true, i = e.edge(n, o), f = 0;
  return i || (a = false, i = e.edge(o, n)), f = i.weight, Zr$1(e.nodeEdges(n), function(d) {
    var c = d.v === n, h = c ? d.w : d.v;
    if (h !== o) {
      var l = c === a, p = e.edge(d).weight;
      if (f += l ? p : -p, je(r, n, h)) {
        var m2 = r.edge(n, h).cutvalue;
        f += l ? -m2 : m2;
      }
    }
  }), f;
...
function Wr(r, e, n, t, o) {
  var a = n, i = r.node(t);
  return e[t] = true, Zr$1(r.neighbors(t), function(f) {
...
function Xr(r, e, n) {
  ...
  var a = r.node(t), i = r.node(o), f = a, d = false;
  a.lim > i.lim && (f = i, d = true);
  var c = fn$1(e.edges(), function(h) {
...
function Te(r, e) {
  var n = Ki(r.nodes(), function(o) {
    return !e.node(o).parent;
  }), t = fr(r, n);
  t = t.slice(1), Zr$1(t, function(o) {
    var a = r.node(o).parent, i = e.edge(o, a), f = false;
    i || (i = e.edge(a, o), f = true), e.node(o).rank = e.node(a).rank + (f ? i.minlen : -i.minlen);
  });
}
m$1(Te, "updateRanks");
function je(r, e, n) {
...
function Kr(r) {
  var e = g(r, "root", {}, "_root"), n = Me(r), t = bn$1(Xr$1(n)) - 1, o = 2 * t + 1;
  r.graph().nestingRoot = e, Zr$1(r.edges(), function(i) {
    r.edge(i).minlen *= o;
  });
  var a = Fe(r) + 1;
  Zr$1(r.children(), function(i) {
    Qr(r, e, o, a, t, n, i);
...
function Qr(r, e, n, t, o, a, i) {
  ...
  r.setParent(d, i), h.borderTop = d, r.setParent(c, i), h.borderBottom = c, Zr$1(f, function(l) {
    Qr(r, e, n, t, o, a, l);
    var p = r.node(l), m2 = p.borderTop ? p.borderTop : l, v = p.borderBottom ? p.borderBottom : l, b = p.borderTop ? t : 2 * t, D = m2 !== v ? 1 : o - a[i] + 1;
    r.setEdge(d, m2, {
      weight: b,
      minlen: D,
      nestingEdge: true
...
function Me(r) {
  ...
  return m$1(n, "dfs"), Zr$1(r.children(), function(t) {
    n(t, 1);
  }), e;
}
m$1(Me, "treeDepths");
function Fe(r) {
  return Rn(r.edges(), function(e, n) {
...
function Zr(r) {
  var e = r.graph();
  r.removeNode(e.nestingRoot), delete e.nestingRoot, Zr$1(r.edges(), function(n) {
    var t = r.edge(n);
...
function re(r, e, n) {
  ...
  return Zr$1(r.nodes(), function(a) {
    var i = r.node(a), f = r.parent(a);
    (i.rank === e || i.minRank <= e && e <= i.maxRank) && (o.setNode(a), o.setParent(a, f || t), Zr$1(r[n](a), function(d) {
      var c = d.v === a ? d.w : d.v, h = o.edge(c, a), l = sn$1(h) ? 0 : h.weight;
      o.setEdge(c, a, {
...
function Ve(r) {
  for (var e; r.hasNode(e = lp("_root")); ) ;
  return e;
}
...
m$1(ee, "crossCount");
function Be(r, e, n) {
  for (var t = gp(n, Jr$1(n, function(c, h) {
    return h;
  })), o = Qr$1(Jr$1(e, function(c) {
    return np(Jr$1(r.outEdges(c), function(h) {
      return {
        pos: t[h.w],
  ...
  var i = 2 * a - 1;
  a -= 1;
  var f = Jr$1(new Array(i), function() {
    return 0;
  }), d = 0;
  return Zr$1(o.forEach(function(c) {
    var h = c.pos + a;
    f[h] += c.weight;
...
function ne(r) {
  var e = {}, n = fn$1(r.nodes(), function(f) {
    return !r.children(f).length;
  }), t = bn$1(Jr$1(n, function(f) {
    return r.node(f).rank;
  })), o = Jr$1(Jm(t + 1), function() {
    return [];
  });
  function a(f) {
    if (!fm(e, f)) {
      e[f] = true;
      var d = r.node(f);
      o[d.rank].push(f), Zr$1(r.successors(f), a);
    }
  }
  m$1(a, "dfs");
  var i = np(n, function(f) {
    return r.node(f).rank;
  });
  return Zr$1(i, a), o;
}
...
function oe(r, e) {
  ...
  }), Zr$1(e.edges(), function(o) {
    var a = n[o.v], i = n[o.w];
    !sn$1(a) && !sn$1(i) && (i.indegree++, a.out.push(n[o.w]));
  });
  var t = fn$1(n, function(o) {
    return !o.indegree;
  });
  return Ae(t);
}
...
function Ae(r) {
  ...
  for (m$1(t, "handleOut"); r.length; ) {
    var o = r.pop();
    e.push(o), Zr$1(o.in.reverse(), n(o)), Zr$1(o.out, t(o));
  }
  return Jr$1(fn$1(e, function(a) {
    return !a.merged;
  }), function(a) {
    return Tn$1(a, [
      "vs",
...
function De(r, e) {
  var n = 0, t = 0;
  r.weight && (n += r.barycenter * r.weight, t += r.weight), e.weight && (n += e.barycenter * e.weight, t += e.weight), r.vs = e.vs.concat(r.vs), r.barycenter = n / t, r.weight = t, r.i = Math.min(e.i, r.i), e.merged = true;
}
m$1(De, "mergeEntries");
function ie(r, e) {
  var n = Nr(r, function(h) {
    return Object.prototype.hasOwnProperty.call(h, "barycenter");
  }), t = n.lhs, o = np(n.rhs, function(h) {
    return -h.i;
  }), a = [], i = 0, f = 0, d = 0;
  t.sort(Ye(!!e)), d = ae(a, o, d), Zr$1(t, function(h) {
...
m$1(ie, "sort");
function ae(r, e, n) {
  for (var t; e.length && (t = Df(e)).i <= n; ) e.pop(), r.push(t.vs), n++;
  return n;
}
...
function hr(r, e, n, t) {
  ...
  if (i && (l.vs = Qr$1([
    ...
    var p = r.node(r.predecessors(i)[0]), m2 = r.node(r.predecessors(f)[0]);
    Object.prototype.hasOwnProperty.call(l, "barycenter") || (l.barycenter = 0, l.weight = 0), l.barycenter = (l.barycenter * l.weight + p.order + m2.order) / (l.weight + 2), l.weight += 2;
  }
  return l;
}
m$1(hr, "sortSubgraph");
...
function ue(r) {
  var e = er(r), n = se(r, Jm(1, e + 1), "inEdges"), t = se(r, Jm(e - 1, -1, -1), "outEdges"), o = ne(r);
  fe(r, o);
...
function de(r) {
  ...
  Zr$1(r.graph().dummyChains, function(n) {
    for (var t = r.node(n), o = t.edgeObj, a = qe(r, e, o.v, o.w), i = a.path, f = a.lca, d = 0, c = i[d], h = true; n !== o.w; ) {
      if (t = r.node(n), h) {
...
function qe(r, e, n, t) {
  var o = [], a = [], i = Math.min(e[n].low, e[t].low), f = Math.max(e[n].lim, e[t].lim), d, c;
  d = n;
  do
...
function Xe(r) {
  ...
  function t(o) {
    var a = n;
    Zr$1(r.children(o), t), e[o] = {
      low: a,
      lim: n++
    };
  }
  return m$1(t, "dfs"), Zr$1(r.children(), t), e;
}
m$1(Xe, "postorder");
function He(r, e) {
  var n = {};
  function t(o, a) {
    var i = 0, f = 0, d = o.length, c = Df(a);
    return Zr$1(a, function(h, l) {
      var p = Ke(r, h), m2 = p ? r.node(p).order : d;
      (p || h === c) && (Zr$1(a.slice(f, l + 1), function(v) {
        Zr$1(r.predecessors(v), function(b) {
          var D = r.node(b), mr = D.order;
          (mr < i || m2 < mr) && !(D.dummy && r.node(v).dummy) && ce(n, b, v);
        });
      }), f = l + 1, i = m2);
    }), a;
  }
...
function Je(r, e) {
  ...
  function t(a, i, f, d, c) {
    var h;
    Zr$1(Jm(i, f), function(l) {
      h = a[l], r.node(h).dummy && Zr$1(r.predecessors(h), function(p) {
        var m2 = r.node(p);
        m2.dummy && (m2.order < d || m2.order > c) && ce(n, p, h);
      });
    });
  }
  m$1(t, "scan");
...
function Ke(r, e) {
  if (r.node(e).dummy) return Ki(r.predecessors(e), function(n) {
  ...
  return Zr$1(e, function(f) {
    ...
    Zr$1(f, function(c) {
      ...
      if (h.length) {
        ...
        for (var l = (h.length - 1) / 2, p = Math.floor(l), m2 = Math.ceil(l); p <= m2; ++p) {
          var v = h[p];
...
function $e(r, e, n, t, o) {
  ...
  function d(l, p) {
    for (var m2 = i.nodes(), v = m2.pop(), b = {}; v; ) b[v] ? l(v) : (b[v] = true, m2.push(v), m2 = m2.concat(p(v))), v = m2.pop();
  }
  m$1(d, "iterate");
  function c(l) {
    a[l] = i.inEdges(l).reduce(function(p, m2) {
      return Math.max(p, a[m2.v] + i.edge(m2));
    }, 0);
  }
  m$1(c, "pass1");
  function h(l) {
    ...
    }, Number.POSITIVE_INFINITY), m2 = r.node(l);
    p !== Number.POSITIVE_INFINITY && m2.borderType !== f && (a[l] = Math.max(a[l], p));
  }
  return m$1(h, "pass2"), d(c, i.predecessors.bind(i)), d(h, i.successors.bind(i)), Zr$1(t, function(l) {
    a[l] = a[n[l]];
  }), a;
}
m$1($e, "horizontalCompaction");
function rn(r, e, n, t) {
  var o = new m(), a = r.graph(), i = on(a.nodesep, a.edgesep, t);
  return Zr$1(e, function(f) {
    var d;
    Zr$1(f, function(c) {
      var h = n[c];
...
function nn(r, e) {
  ...
  Zr$1([
    ...
    Zr$1([
      ...
      if (d !== e) {
        var h = Xr$1(d);
        c = i === "l" ? t - ym(h) : o - bn$1(h), c && (r[f] = dn$1(d, function(l) {
          return l + c;
        }));
      }
    });
...
m$1(tn, "balance");
function he(r) {
  var e = C(r), n = qs(He(r, e), Je(r, e)), t = {}, o;
  Zr$1([
    "u",
    "d"
  ], function(i) {
...
m$1(an, "width");
function le(r) {
  r = X(r), sn(r), Ji(he(r), function(e, n) {
    r.node(n).x = e;
  });
}
m$1(le, "position");
...
function bn(r) {
  ...
  return e.setGraph(qs({}, hn, lr(n, cn), Tn$1(n, ln))), Zr$1(r.nodes(), function(t) {
    var o = pr(r.node(t));
    e.setNode(t, Nf(lr(o, pn), mn)), e.setParent(t, r.parent(t));
  }), Zr$1(r.edges(), function(t) {
    var o = pr(r.edge(t));
    e.setEdge(t, qs({}, _n, lr(o, vn), Tn$1(o, wn)));
  }), e;
}
m$1(bn, "buildLayoutGraph");
function En(r) {
  var e = r.graph();
  e.ranksep /= 2, Zr$1(r.edges(), function(n) {
    var t = r.edge(n);
...
function yn(r) {
  Zr$1(r.edges(), function(e) {
    var n = r.edge(e);
    if (n.width && n.height) {
      var t = r.node(e.v), o = r.node(e.w), a = {
...
function xn(r) {
  ...
  Zr$1(r.nodes(), function(n) {
    var t = r.node(n);
    t.borderTop && (t.minRank = r.node(t.borderTop).rank, t.maxRank = r.node(t.borderBottom).rank, e = bn$1(e, t.maxRank));
  }), r.graph().maxRank = e;
}
...
function gn(r) {
  ...
  function d(c) {
    var h = c.x, l = c.y, p = c.width, m2 = c.height;
    e = Math.min(e, h - p / 2), n = Math.max(n, h + p / 2), t = Math.min(t, l - m2 / 2), o = Math.max(o, l + m2 / 2);
  }
  m$1(d, "getExtremes"), Zr$1(r.nodes(), function(c) {
    d(r.node(c));
  }), Zr$1(r.edges(), function(c) {
    var h = r.edge(c);
    Object.prototype.hasOwnProperty.call(h, "x") && d(h);
  }), e -= i, t -= f, Zr$1(r.nodes(), function(c) {
    var h = r.node(c);
    h.x -= e, h.y -= t;
  }), Zr$1(r.edges(), function(c) {
    var h = r.edge(c);
...
function Ln(r) {
  Zr$1(r.nodes(), function(e) {
    if (r.children(e).length) {
      var n = r.node(e), t = r.node(n.borderTop), o = r.node(n.borderBottom), a = r.node(Df(n.borderLeft)), i = r.node(Df(n.borderRight));
