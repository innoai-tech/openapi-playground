import { s as e, v as o, b as a, d as t, t as r, P as s, O as i } from "./lib-nodepkg-vueuikit.CuyTwmRm.chunk.js";
import { j as n, f as l, g as d, b as p, w as c, d as u } from "./lib-nodepkg-vuekit.DBltawvf.chunk.js";
import { g as y } from "./vendor-innoai-tech-lodash.BqsjFXV_.chunk.js";
...
e("div", { displayName: "ListItem" })({ "& + &": { borderTop: "1px solid", borderColor: "sys.outline-variant" }, py: 8, px: 16, textStyle: "sys.label-large", containerStyle: "sys.surface-container", _hover: { cursor: "pointer", bgColor: o("sys.on-surface", a(0.08)) } }), l((e2, o2) => {
  let { slots: a2 } = o2, t2 = d(false);
  return () => {
    var _a;
    ...
    return n(s, { isOpen: t2.value, placement: e2.placement, onClickOutside: () => {
      t2.value = false;
    }, $content: n(A, { children: (_a = a2.menu) == null ? void 0 : _a.call(a2) }), children: o3 ? p(o3, { onClick: () => {
      t2.value = true;
    } }) : null });
  };
...
let z = t({ from: { opacity: 0 }, to: { opacity: 1 }, duration: r.duration.md1, easing: r.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: r.duration.sm4, easing: r.easing.standard.accelerate }), L = l((e2, o2) => {
  ...
  return c(() => e2.isOpen, (e3) => {
    ...
    var _a;
    return n(i, { isOpen: r2.value, onContentBeforeMount: () => {
      s2.value = true;
    }, onEscKeydown: () => {
      s2.value = false;
    }, children: u(I, { children: [n(z, { onComplete: (e3) => {
      "leave" === e3 && (r2.value = false, t2("close"));
    }, children: s2.value ? n(k, { onClick: () => {
      s2.value = false;
...
e("label", (e2, o2) => {
  ...
  return (o3) => {
    var _a, _b, _c;
    let t2 = e2.valued, r2 = e2.invalid, s2 = e2.disabled, i2 = (((_a = a2.default) == null ? void 0 : _a.call(a2)) ?? []).map((e3) => "input" === e3.type ? (t2 = !!y(e3.props, ["value"], y(e3.props, ["placeholder"], t2)), s2 = y(e3.props, ["disabled"], s2), p(e3, { disabled: s2 })) : p(e3));
    return u(o3, { "data-valued": t2, "data-invalid": r2, "data-disabled": s2, "data-focus-within": e2.focus, "data-has-leading": !!a2.leading, "data-has-trailing": !!a2.trailing, children: [u("div", { "data-input-container": "", children: [a2.leading && n(T, { role: "leading", children: a2.leading() }), n("div", { "data-input-label": "", children: (_b = a2.label) == null ? void 0 : _b.call(a2) }), i2, a2.trailing && n(T, { role: "trailing", children: a2.trailing() })] }), a2.supporting && n("div", { "data-input-supporting": "", children: (_c = a2.supporting) == null ? void 0 : _c.call(a2) })] });
  };
