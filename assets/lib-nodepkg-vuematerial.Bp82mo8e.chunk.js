...
let w = e("span", (e2, o2) => (o3) => {
  ...
  return () => {
    let o3 = a2.default()[0];
    return i(s, { isOpen: t2.value, $content: i(M, { children: e2.title }), $transition: (e3) => {
      let { content: o4 } = e3;
      return i(H, { children: o4 });
...
let A = t({ from: { opacity: 0 }, to: { opacity: 1 }, duration: r.duration.md1, easing: r.easing.standard.accelerate }, { from: { opacity: 1 }, to: { opacity: 0 }, duration: r.duration.sm4, easing: r.easing.standard.accelerate }), I = n((e2, o2) => {
  var a2;
  ...
  return c(() => e2.isOpen, (e3) => {
    ...
    return i(l, { isOpen: s2.value, onContentBeforeMount: () => {
      ...
      n2.value = false;
    }, children: u(N, { children: [i(A, { onComplete: (e4) => {
      "leave" === e4 && (s2.value = false, r2("close"));
    }, children: n2.value ? i(S, { onClick: () => {
      n2.value = false;
...
e("label", (e2, o2) => {
  ...
  return (o3) => {
    ...
    return u(o3, { "data-valued": n2, "data-invalid": d2, "data-disabled": c2, "data-focus-within": e2.focus, "data-has-leading": !!a2.leading, "data-has-trailing": !!a2.trailing, children: [u("div", { "data-input-container": "", children: [a2.leading && i(k, { role: "leading", children: a2.leading() }), i("div", { "data-input-label": "", children: null === (r2 = a2.label) || void 0 === r2 ? void 0 : r2.call(a2) }), b2, a2.trailing && i(k, { role: "trailing", children: a2.trailing() })] }), a2.supporting && i("div", { "data-input-supporting": "", children: null === (s2 = a2.supporting) || void 0 === s2 ? void 0 : s2.call(a2) })] });
  };
...
let k = e("div", { displayName: "Maker", props: ["role"] })({ pos: "absolute", top: 4, bottom: 4, display: "flex", alignItems: "center", color: "sys.on-surface-variant", _role__leading: { left: 12, $data_icon: { ml: -4 } }, _role__trailing: { right: 12, $data_icon: { mr: -4 } } });
export {
  I as D,
  m as F,
  w as I,
