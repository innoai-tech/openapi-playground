import { G as Gr } from "./vendor-min-mermaid~chunk-MBJCTAW2.dQwDb1IE.chunk.js";
import { d } from "./vendor-min-mermaid~chunk-MEBTFSOL.CCNoLlnV.chunk.js";
import { Q as Qt$1 } from "./vendor-min-mermaid~chunk-HESFG3RP.X24hc0uC.chunk.js";
import { S } from "./vendor-min-mermaid~chunk-YM3XIQPS.DzKxOkHI.chunk.js";
import { m as m$1, q, n } from "./vendor-min-mermaid~chunk-GTKDMUJJ.Cm_2-rE8.chunk.js";
import { t as tt, H as Hl, P as Pl, p as pl, O as Oe, am as $t$1, an as F, ao as E, i as ih } from "./vendor-min-mermaid~chunk-ZKYS2E5M.DYmB7G2x.chunk.js";
...
var pt = n((rt, ft) => {
  m$1(function(I, o) {
    typeof rt == "object" && typeof ft == "object" ? ft.exports = o() : typeof define == "function" && define.amd ? define([], o) : typeof rt == "object" ? rt.layoutBase = o() : I.layoutBase = o();
    ...
    return function(E2) {
      ...
      function o(i) {
        ...
        return E2[i].call(e.exports, e, e.exports, o), e.l = true, e.exports;
      }
      return m$1(o, "__webpack_require__"), o.m = E2, o.c = I, o.i = function(i) {
        return i;
      }, o.d = function(i, e, t) {
      ...
      function(E2, I, o) {
        var i = o(2), e = o(8), t = o(9);
        function r(f, a, d2) {
          i.call(this, d2), this.isOverlapingSourceAndTarget = false, this.vGraphObject = d2, this.bendpoints = [], this.source = f, this.target = a;
        }
        m$1(r, "LEdge"), r.prototype = Object.create(i.prototype);
        ...
        r.prototype.getSource = function() {
          ...
          for (var d2 = this.getOtherEnd(f), s = a.getGraphManager().getRoot(); ; ) {
            if (d2.getOwner() == a) return d2;
            if (d2.getOwner() == s) break;
            d2 = d2.getOwner().getParent();
          }
          return null;
      ...
      function(E2, I, o) {
        ...
        m$1(i, "LGraphObject"), E2.exports = i;
      },
      function(E2, I, o) {
        var i = o(2), e = o(10), t = o(13), r = o(0), l = o(16), f = o(4);
        function a(s, c, u, v) {
        ...
        m$1(a, "LNode"), a.prototype = Object.create(i.prototype);
        for (var d2 in i) a[d2] = i[d2];
        a.prototype.getEdges = function() {
          ...
          if (s.add(this), this.child != null) for (var v = this.child.getNodes(), m = 0; m < v.length; m++) c = v[m], u = c.withChildren(), u.forEach(function(T) {
            s.add(T);
          });
          return s;
          ...
          else for (var u = this.child.getNodes(), v = 0; v < u.length; v++) c = u[v], s += c.getNoOfChildren();
          return s == 0 && (s = 1), s;
          ...
          if (this.getChild().getNodes().length != 0) {
            var s = this.getChild();
            if (s.updateBounds(true), this.rect.x = s.getLeft(), this.rect.y = s.getTop(), this.setWidth(s.getRight() - s.getLeft()), this.setHeight(s.getBottom() - s.getTop()), r.NODE_DIMENSIONS_INCLUDE_LABELS) {
          ...
          var v = new f(c, u), m = s.inverseTransformPoint(v);
      ...
      function(E2, I, o) {
        var i = o(2), e = o(10), t = o(0), r = o(6), l = o(3), f = o(1), a = o(13), d2 = o(12), s = o(11);
        function c(v, m, T) {
        ...
        m$1(c, "LGraph"), c.prototype = Object.create(i.prototype);
        ...
        c.prototype.getNodes = function() {
          ...
          if (v instanceof l) {
            ...
            for (var T = m.edges.slice(), y, A = T.length, O = 0; O < A; O++) y = T[O], y.isInterGraph ? this.graphManager.remove(y) : y.source.owner.remove(y);
            var R = this.nodes.indexOf(m);
            ...
            var n2 = y.source.edges.indexOf(y), h = y.target.edges.indexOf(y);
            if (!(n2 > -1 && h > -1)) throw "Source and/or target doesn't know this edge!";
            y.source.edges.splice(n2, 1), y.target != y.source && y.target.edges.splice(h, 1);
            var R = y.source.owner.getEdges().indexOf(y);
            if (R == -1) throw "Not in owner's edge list!";
            y.source.owner.getEdges().splice(R, 1);
          }
        }, c.prototype.updateLeftTop = function() {
          for (var v = e.MAX_VALUE, m = e.MAX_VALUE, T, y, A, O = this.getNodes(), R = O.length, n2 = 0; n2 < R; n2++) {
            var h = O[n2];
            T = h.getTop(), y = h.getLeft(), v > T && (v = T), m > y && (m = y);
          }
          return v == e.MAX_VALUE ? null : (O[0].getParent().paddingLeft != null ? A = O[0].getParent().paddingLeft : A = this.margin, this.left = m - A, this.top = v - A, new d2(this.left, this.top));
        }, c.prototype.updateBounds = function(v) {
          for (var m = e.MAX_VALUE, T = -e.MAX_VALUE, y = e.MAX_VALUE, A = -e.MAX_VALUE, O, R, n2, h, g, p = this.nodes, D = p.length, N = 0; N < D; N++) {
            var M = p[N];
            v && M.child != null && M.updateBounds(), O = M.getLeft(), R = M.getRight(), n2 = M.getTop(), h = M.getBottom(), m > O && (m = O), T < R && (T = R), y > n2 && (y = n2), A < h && (A = h);
          }
          var C = new a(m, y, T - m, A - y);
          m == e.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), p[0].getParent().paddingLeft != null ? g = p[0].getParent().paddingLeft : g = this.margin, this.left = C.x - g, this.right = C.x + C.width + g, this.top = C.y - g, this.bottom = C.y + C.height + g;
        }, c.calculateBounds = function(v) {
          for (var m = e.MAX_VALUE, T = -e.MAX_VALUE, y = e.MAX_VALUE, A = -e.MAX_VALUE, O, R, n2, h, g = v.length, p = 0; p < g; p++) {
            var D = v[p];
            O = D.getLeft(), R = D.getRight(), n2 = D.getTop(), h = D.getBottom(), m > O && (m = O), T < R && (T = R), y > n2 && (y = n2), A < h && (A = h);
          }
          ...
          var m = new s(), T = /* @__PURE__ */ new Set(), y = this.nodes[0], A, O, R = y.withChildren();
          for (R.forEach(function(N) {
            m.push(N), T.add(N);
          }); m.length !== 0; ) {
            y = m.shift(), A = y.getEdges();
            for (var n2 = A.length, h = 0; h < n2; h++) {
              var g = A[h];
              if (O = g.getOtherEndInGraph(y, this), O != null && !T.has(O)) {
                var p = O.withChildren();
      ...
      function(E2, I, o) {
        var i, e = o(1);
        function t(r) {
          i = o(5), this.layout = r, this.graphs = [], this.edges = [];
        }
        m$1(t, "LGraphManager"), t.prototype.addRoot = function() {
          var r = this.layout.newGraph(), l = this.layout.newNode(null), f = this.add(r, l);
          return this.setRootGraph(f), this.rootGraph;
        }, t.prototype.add = function(r, l, f, a, d2) {
          if (f == null && a == null && d2 == null) {
            ...
            d2 = f, a = l, f = r;
            var s = a.getOwner(), c = d2.getOwner();
            ...
            if (s == c) return f.isInterGraph = false, s.add(f, a, d2);
            if (f.isInterGraph = true, f.source = a, f.target = d2, this.edges.indexOf(f) > -1) throw "Edge already in inter-graph edge list!";
          ...
          if (r instanceof i) {
            ...
            for (var a, d2 = f.length, s = 0; s < d2; s++) a = f[s], l.remove(a);
            var c = [];
            c = c.concat(l.getNodes());
            var u;
            d2 = c.length;
            for (var s = 0; s < d2; s++) u = c[s], l.remove(u);
            l == this.rootGraph && this.setRootGraph(null);
            var v = this.graphs.indexOf(l);
            ...
            var v = a.source.edges.indexOf(a);
            if (a.source.edges.splice(v, 1), v = a.target.edges.indexOf(a), a.target.edges.splice(v, 1), !(a.source.owner != null && a.source.owner.getGraphManager() != null)) throw "Edge owner graph or owner graph manager is null!";
            if (a.source.owner.getGraphManager().edges.indexOf(a) == -1) throw "Not in owner graph manager's edge list!";
            var v = a.source.owner.getGraphManager().edges.indexOf(a);
          ...
          if (this.allNodes == null) {
            for (var r = [], l = this.getGraphs(), f = l.length, a = 0; a < f; a++) r = r.concat(l[a].getNodes());
            this.allNodes = r;
          }
          ...
          if (this.allEdges == null) {
            for (var r = [], l = this.getGraphs(), f = l.length, a = 0; a < l.length; a++) r = r.concat(l[a].getEdges());
          ...
          var f = r.getOwner(), a;
          do {
            if (a = f.getParent(), a == null) break;
            if (a == l) return true;
            if (f = a.getOwner(), f == null) break;
          } while (true);
          f = l.getOwner();
          do {
            if (a = f.getParent(), a == null) break;
          ...
          for (var r, l, f, a, d2, s = this.getAllEdges(), c = s.length, u = 0; u < c; u++) {
            if (r = s[u], l = r.source, f = r.target, r.lca = null, r.sourceInLca = l, r.targetInLca = f, l == f) {
              r.lca = l.getOwner();
              continue;
            }
            for (a = l.getOwner(); r.lca == null; ) {
              for (r.targetInLca = f, d2 = f.getOwner(); r.lca == null; ) {
                if (d2 == a) {
                  r.lca = d2;
                  break;
                }
                if (d2 == this.rootGraph) break;
                if (r.lca != null) throw "assert failed";
                r.targetInLca = d2.getParent(), d2 = r.targetInLca.getOwner();
              }
              if (a == this.rootGraph) break;
              r.lca == null && (r.sourceInLca = a.getParent(), a = r.sourceInLca.getOwner());
            }
            if (r.lca == null) throw "assert failed";
          }
          ...
          for (var f, a = r.getNodes(), d2 = a.length, s = 0; s < d2; s++) f = a[s], f.inclusionTreeDepth = l, f.child != null && this.calcInclusionTreeDepths(f.child, l + 1);
      ...
      function(E2, I, o) {
        ...
        m$1(e, "IGeometry"), e.calcSeparationAmount = function(t, r, l, f) {
          ...
          var a = new Array(2);
          this.decideDirectionsForOverlappingNodes(t, r, a), l[0] = Math.min(t.getRight(), r.getRight()) - Math.max(t.x, r.x), l[1] = Math.min(t.getBottom(), r.getBottom()) - Math.max(t.y, r.y), t.getX() <= r.getX() && t.getRight() >= r.getRight() ? l[0] += Math.min(r.getX() - t.getX(), t.getRight() - r.getRight()) : r.getX() <= t.getX() && r.getRight() >= t.getRight() && (l[0] += Math.min(t.getX() - r.getX(), r.getRight() - t.getRight())), t.getY() <= r.getY() && t.getBottom() >= r.getBottom() ? l[1] += Math.min(r.getY() - t.getY(), t.getBottom() - r.getBottom()) : r.getY() <= t.getY() && r.getBottom() >= t.getBottom() && (l[1] += Math.min(t.getY() - r.getY(), r.getBottom() - t.getBottom()));
          var d2 = Math.abs((r.getCenterY() - t.getCenterY()) / (r.getCenterX() - t.getCenterX()));
          r.getCenterY() === t.getCenterY() && r.getCenterX() === t.getCenterX() && (d2 = 1);
          var s = d2 * l[0], c = l[1] / d2;
          ...
          var f = t.getCenterX(), a = t.getCenterY(), d2 = r.getCenterX(), s = r.getCenterY();
          if (t.intersects(r)) return l[0] = f, l[1] = a, l[2] = d2, l[3] = s, true;
          var c = t.getX(), u = t.getY(), v = t.getRight(), m = t.getX(), T = t.getBottom(), y = t.getRight(), A = t.getWidthHalf(), O = t.getHeightHalf(), R = r.getX(), n2 = r.getY(), h = r.getRight(), g = r.getX(), p = r.getBottom(), D = r.getRight(), N = r.getWidthHalf(), M = r.getHeightHalf(), C = false, w = false;
          if (f === d2) {
            if (a > s) return l[0] = f, l[1] = u, l[2] = d2, l[3] = p, false;
            if (a < s) return l[0] = f, l[1] = T, l[2] = d2, l[3] = n2, false;
          } else if (a === s) {
            if (f > d2) return l[0] = c, l[1] = a, l[2] = h, l[3] = s, false;
            if (f < d2) return l[0] = v, l[1] = a, l[2] = R, l[3] = s, false;
          } else {
            var P = t.height / t.width, U = r.height / r.width, F2 = (s - a) / (d2 - f), x = void 0, G = void 0, S2 = void 0, _ = void 0, X = void 0, b = void 0;
            if (-P === F2 ? f > d2 ? (l[0] = m, l[1] = T, C = true) : (l[0] = v, l[1] = u, C = true) : P === F2 && (f > d2 ? (l[0] = c, l[1] = u, C = true) : (l[0] = y, l[1] = T, C = true)), -U === F2 ? d2 > f ? (l[2] = g, l[3] = p, w = true) : (l[2] = h, l[3] = n2, w = true) : U === F2 && (d2 > f ? (l[2] = R, l[3] = n2, w = true) : (l[2] = D, l[3] = p, w = true)), C && w) return false;
            if (f > d2 ? a > s ? (x = this.getCardinalDirection(P, F2, 4), G = this.getCardinalDirection(U, F2, 2)) : (x = this.getCardinalDirection(-P, F2, 3), G = this.getCardinalDirection(-U, F2, 1)) : a > s ? (x = this.getCardinalDirection(-P, F2, 1), G = this.getCardinalDirection(-U, F2, 3)) : (x = this.getCardinalDirection(P, F2, 2), G = this.getCardinalDirection(U, F2, 4)), !C) switch (x) {
              case 1:
                _ = u, S2 = f + -O / F2, l[0] = S2, l[1] = _;
                break;
              case 2:
                S2 = y, _ = a + A * F2, l[0] = S2, l[1] = _;
                break;
              case 3:
                _ = T, S2 = f + O / F2, l[0] = S2, l[1] = _;
                break;
              case 4:
                S2 = m, _ = a + -A * F2, l[0] = S2, l[1] = _;
                break;
            }
            if (!w) switch (G) {
              case 1:
                b = n2, X = d2 + -M / F2, l[2] = X, l[3] = b;
                break;
              case 2:
                X = D, b = s + N * F2, l[2] = X, l[3] = b;
                break;
              case 3:
                b = p, X = d2 + M / F2, l[2] = X, l[3] = b;
                break;
              case 4:
                X = g, b = s + -N * F2, l[2] = X, l[3] = b;
                break;
            }
          }
          return false;
          ...
          var a = t.x, d2 = t.y, s = r.x, c = r.y, u = l.x, v = l.y, m = f.x, T = f.y, y = void 0, A = void 0, O = void 0, R = void 0, n2 = void 0, h = void 0, g = void 0, p = void 0, D = void 0;
          return O = c - d2, n2 = a - s, g = s * d2 - a * c, R = T - v, h = u - m, p = m * v - u * T, D = O * h - R * n2, D === 0 ? null : (y = (n2 * p - h * g) / D, A = (R * g - O * p) / D, new i(y, A));
        }, e.angleOfVector = function(t, r, l, f) {
          var a = void 0;
          return t !== l ? (a = Math.atan((f - r) / (l - t)), l < t ? a += Math.PI : f < r && (a += this.TWO_PI)) : f < r ? a = this.ONE_AND_HALF_PI : a = this.HALF_PI, a;
        }, e.doIntersect = function(t, r, l, f) {
          var a = t.x, d2 = t.y, s = r.x, c = r.y, u = l.x, v = l.y, m = f.x, T = f.y, y = (s - a) * (T - v) - (m - u) * (c - d2);
          if (y === 0) return false;
          var A = ((T - v) * (m - a) + (u - m) * (T - d2)) / y, O = ((d2 - c) * (m - a) + (s - a) * (T - d2)) / y;
          return 0 < A && A < 1 && 0 < O && O < 1;
        }, e.HALF_PI = 0.5 * Math.PI, e.ONE_AND_HALF_PI = 1.5 * Math.PI, e.TWO_PI = 2 * Math.PI, e.THREE_PI = 3 * Math.PI, E2.exports = e;
      },
      function(E2, I, o) {
        function i() {
        }
      ...
      function(E2, I, o) {
        ...
        m$1(i, "Integer"), i.MAX_VALUE = 2147483647, i.MIN_VALUE = -2147483648, E2.exports = i;
      },
      function(E2, I, o) {
        var i = function() {
          function a(d2, s) {
            for (var c = 0; c < s.length; c++) {
              var u = s[c];
              u.enumerable = u.enumerable || false, u.configurable = true, "value" in u && (u.writable = true), Object.defineProperty(d2, u.key, u);
            }
          }
          return m$1(a, "defineProperties"), function(d2, s, c) {
            return s && a(d2.prototype, s), c && a(d2, c), d2;
          };
        }();
        function e(a, d2) {
          if (!(a instanceof d2)) throw new TypeError("Cannot call a class as a function");
        }
        m$1(e, "_classCallCheck");
        var t = m$1(function(d2) {
          return {
            value: d2,
            next: null,
            prev: null
          };
        }, "nodeFrom"), r = m$1(function(d2, s, c, u) {
          return d2 !== null ? d2.next = s : u.head = s, c !== null ? c.prev = s : u.tail = s, s.prev = d2, s.next = c, u.length++, s;
        }, "add"), l = m$1(function(d2, s) {
          var c = d2.prev, u = d2.next;
          return c !== null ? c.next = u : s.head = u, u !== null ? u.prev = c : s.tail = c, d2.prev = d2.next = null, s.length--, d2;
        }, "_remove"), f = function() {
          function a(d2) {
            var s = this;
            e(this, a), this.length = 0, this.head = null, this.tail = null, d2 == null ? void 0 : d2.forEach(function(c) {
              return s.push(c);
            });
          }
          return m$1(a, "LinkedList"), i(a, [
            ...
            {
              key: "insertBefore",
              value: m$1(function(s, c) {
                return r(c.prev, t(s), c, this);
              }, "insertBefore")
            },
            {
              key: "insertAfter",
              value: m$1(function(s, c) {
                return r(c, t(s), c.next, this);
              }, "insertAfter")
            },
            {
            ...
            {
              key: "push",
              value: m$1(function(s) {
                return r(this.tail, t(s), null, this);
              }, "push")
            },
            {
              key: "unshift",
              value: m$1(function(s) {
                return r(null, t(s), this.head, this);
              }, "unshift")
            },
            {
              key: "remove",
      ...
      function(E2, I, o) {
        function i(u) {
          if (Array.isArray(u)) {
            for (var v = 0, m = Array(u.length); v < u.length; v++) m[v] = u[v];
            return m;
          } else return Array.from(u);
        }
        m$1(i, "_toConsumableArray");
        var e = o(0), t = o(6), r = o(3), l = o(1), f = o(5), a = o(4), d2 = o(17), s = o(27);
        function c(u) {
          s.call(this), this.layoutQuality = e.QUALITY, this.createBendsAsNeeded = e.DEFAULT_CREATE_BENDS_AS_NEEDED, this.incremental = e.DEFAULT_INCREMENTAL, this.animationOnLayout = e.DEFAULT_ANIMATION_ON_LAYOUT, this.animationDuringLayout = e.DEFAULT_ANIMATION_DURING_LAYOUT, this.animationPeriod = e.DEFAULT_ANIMATION_PERIOD, this.uniformLeafNodeSizes = e.DEFAULT_UNIFORM_LEAF_NODE_SIZES, this.edgeToDummyNodes = /* @__PURE__ */ new Map(), this.graphManager = new t(this), this.isLayoutFinished = false, this.isSubLayout = false, this.isRemoteUse = false, u != null && (this.isRemoteUse = u);
        }
        m$1(c, "Layout"), c.RANDOM_SEED = 1, c.prototype = Object.create(s.prototype), c.prototype.getGraphManager = function() {
          return this.graphManager;
          ...
          var u;
          return this.checkLayoutSuccess() ? u = false : u = this.layout(), e.ANIMATE === "during" ? false : (u && (this.isSubLayout || this.doPostLayout()), this.tilingPostLayout && this.tilingPostLayout(), this.isLayoutFinished = true, u);
        }, c.prototype.doPostLayout = function() {
          this.incremental || this.transform(), this.update();
        }, c.prototype.update2 = function() {
          if (this.createBendsAsNeeded && (this.createBendpointsFromDummyNodes(), this.graphManager.resetAllEdges()), !this.isRemoteUse) {
            for (var u, v = this.graphManager.getAllEdges(), m = 0; m < v.length; m++) u = v[m];
            for (var T, y = this.graphManager.getRoot().getNodes(), m = 0; m < y.length; m++) T = y[m];
          ...
          if (u == null) this.update2();
            ...
            var v = u;
            if (v.getChild() != null) for (var m = v.getChild().getNodes(), T = 0; T < m.length; T++) update(m[T]);
          ...
          if (u == null) this.transform(new a(0, 0));
            ...
            var v = new d2(), m = this.graphManager.getRoot().updateLeftTop();
            if (m != null) {
              v.setWorldOrgX(u.x), v.setWorldOrgY(u.y), v.setDeviceOrgX(m.x), v.setDeviceOrgY(m.y);
              for (var T = this.getAllNodes(), y, A = 0; A < T.length; A++) y = T[A], y.transform(v);
            }
          }
        }, c.prototype.positionNodesRandomly = function(u) {
          if (u == null) this.positionNodesRandomly(this.getGraphManager().getRoot()), this.getGraphManager().getRoot().updateBounds(true);
          else for (var v, m, T = u.getNodes(), y = 0; y < T.length; y++) v = T[y], m = v.getChild(), m == null || m.getNodes().length == 0 ? v.scatter() : (this.positionNodesRandomly(m), v.updateBounds());
        }, c.prototype.getFlatForest = function() {
          for (var u = [], v = true, m = this.graphManager.getRoot().getNodes(), T = true, y = 0; y < m.length; y++) m[y].getChild() != null && (T = false);
          if (!T) return u;
          var A = /* @__PURE__ */ new Set(), O = [], R = /* @__PURE__ */ new Map(), n2 = [];
          for (n2 = n2.concat(m); n2.length > 0 && v; ) {
            for (O.push(n2[0]); O.length > 0 && v; ) {
              var h = O[0];
              O.splice(0, 1), A.add(h);
              for (var g = h.getEdges(), y = 0; y < g.length; y++) {
                var p = g[y].getOtherEnd(h);
            ...
            if (!v) u = [];
              ...
              for (var y = 0; y < D.length; y++) {
                var N = D[y], M = n2.indexOf(N);
                M > -1 && n2.splice(M, 1);
              }
              A = /* @__PURE__ */ new Set(), R = /* @__PURE__ */ new Map();
            }
          }
          return u;
        }, c.prototype.createDummyNodesForBendpoints = function(u) {
          for (var v = [], m = u.source, T = this.graphManager.calcLowestCommonAncestor(u.source, u.target), y = 0; y < u.bendpoints.length; y++) {
          ...
          var u = [];
          u = u.concat(this.graphManager.getAllEdges()), u = [].concat(i(this.edgeToDummyNodes.keys())).concat(u);
          for (var v = 0; v < u.length; v++) {
            var m = u[v];
            if (m.bendpoints.length > 0) {
              for (var T = this.edgeToDummyNodes.get(m), y = 0; y < T.length; y++) {
                var A = T[y], O = new a(A.getCenterX(), A.getCenterY()), R = m.bendpoints.get(y);
          ...
          if (m != null && T != null) {
            ...
            var R, n2;
            return u <= 50 ? (R = 9 * v / 500, n2 = v / 10) : (R = 9 * v / 50, n2 = -8 * v), R * u + n2;
          }
        }, c.findCenterOfTree = function(u) {
          var v = [];
          v = v.concat(u);
          var m = [], T = /* @__PURE__ */ new Map(), y = false, A = null;
          (v.length == 1 || v.length == 2) && (y = true, A = v[0]);
          for (var O = 0; O < v.length; O++) {
            var R = v[O], n2 = R.getNeighborsList().size;
            T.set(R, R.getNeighborsList().size), n2 == 1 && m.push(R);
          }
          var h = [];
          for (h = h.concat(m); !y; ) {
            var g = [];
            g = g.concat(h), h = [];
            for (var O = 0; O < v.length; O++) {
              var R = v[O], p = v.indexOf(R);
              p >= 0 && v.splice(p, 1);
              var D = R.getNeighborsList();
            ...
            m = m.concat(h), (v.length == 1 || v.length == 2) && (y = true, A = v[0]);
          }
          return A;
      ...
      function(E2, I, o) {
        function i(s) {
          if (Array.isArray(s)) {
            for (var c = 0, u = Array(s.length); c < s.length; c++) u[c] = s[c];
            return u;
          } else return Array.from(s);
        }
        m$1(i, "_toConsumableArray");
        var e = o(15), t = o(7), r = o(0), l = o(8), f = o(9);
        function a() {
        ...
        m$1(a, "FDLayout"), a.prototype = Object.create(e.prototype);
        for (var d2 in e) a[d2] = e[d2];
        a.prototype.initParameters = function() {
          ...
          for (var s, c, u, v, m, T, y = this.getGraphManager().getAllEdges(), A = 0; A < y.length; A++) s = y[A], s.idealLength = this.idealEdgeLength, s.isInterGraph && (u = s.getSource(), v = s.getTarget(), m = s.getSourceInLca().getEstimatedSize(), T = s.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (s.idealLength += m + T - 2 * r.SIMPLE_NODE_SIZE), c = s.getLca().getInclusionTreeDepth(), s.idealLength += t.DEFAULT_EDGE_LENGTH * t.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (u.getInclusionTreeDepth() + v.getInclusionTreeDepth() - 2 * c));
        }, a.prototype.initSpringEmbedder = function() {
          var s = this.getAllNodes().length;
          this.incremental ? (s > t.ADAPTATION_LOWER_NODE_LIMIT && (this.coolingFactor = Math.max(this.coolingFactor * t.COOLING_ADAPTATION_FACTOR, this.coolingFactor - (s - t.ADAPTATION_LOWER_NODE_LIMIT) / (t.ADAPTATION_UPPER_NODE_LIMIT - t.ADAPTATION_LOWER_NODE_LIMIT) * this.coolingFactor * (1 - t.COOLING_ADAPTATION_FACTOR))), this.maxNodeDisplacement = t.MAX_NODE_DISPLACEMENT_INCREMENTAL) : (s > t.ADAPTATION_LOWER_NODE_LIMIT ? this.coolingFactor = Math.max(t.COOLING_ADAPTATION_FACTOR, 1 - (s - t.ADAPTATION_LOWER_NODE_LIMIT) / (t.ADAPTATION_UPPER_NODE_LIMIT - t.ADAPTATION_LOWER_NODE_LIMIT) * (1 - t.COOLING_ADAPTATION_FACTOR)) : this.coolingFactor = 1, this.initialCoolingFactor = this.coolingFactor, this.maxNodeDisplacement = t.MAX_NODE_DISPLACEMENT), this.maxIterations = Math.max(this.getAllNodes().length * 5, this.maxIterations), this.totalDisplacementThreshold = this.displacementThresholdPerNode * this.getAllNodes().length, this.repulsionRange = this.calcRepulsionRange();
        }, a.prototype.calcSpringForces = function() {
          for (var s = this.getAllEdges(), c, u = 0; u < s.length; u++) c = s[u], this.calcSpringForce(c, c.idealLength);
        }, a.prototype.calcRepulsionForces = function() {
          var s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, c = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, u, v, m, T, y = this.getAllNodes(), A;
          if (this.useFRGridVariant) for (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && s && this.updateGrid(), A = /* @__PURE__ */ new Set(), u = 0; u < y.length; u++) m = y[u], this.calculateRepulsionForceOfANode(m, A, s, c), A.add(m);
          ...
          for (var s, c = this.getAllNodesToApplyGravitation(), u = 0; u < c.length; u++) s = c[u], this.calcGravitationalForce(s);
        }, a.prototype.moveNodes = function() {
          for (var s = this.getAllNodes(), c, u = 0; u < s.length; u++) c = s[u], c.move();
        }, a.prototype.calcSpringForce = function(s, c) {
          var u = s.getSource(), v = s.getTarget(), m, T, y, A;
          ...
          m = s.getLength(), m != 0 && (T = this.springConstant * (m - c), y = T * (s.lengthX / m), A = T * (s.lengthY / m), u.springForceX += y, u.springForceY += A, v.springForceX -= y, v.springForceY -= A);
        }, a.prototype.calcRepulsionForce = function(s, c) {
          var u = s.getRect(), v = c.getRect(), m = new Array(2), T = new Array(4), y, A, O, R, n2, h, g;
          if (u.intersects(v)) {
          ...
          for (var s, c = this.graphManager.getAllNodes(), u = 0; u < c.length; u++) s = c[u], s.noOfChildren = s.getNoOfChildren();
        }, a.prototype.calcGrid = function(s) {
          var c = 0, u = 0;
          c = parseInt(Math.ceil((s.getRight() - s.getLeft()) / this.repulsionRange)), u = parseInt(Math.ceil((s.getBottom() - s.getTop()) / this.repulsionRange));
          ...
          var v = 0, m = 0, T = 0, y = 0;
          v = parseInt(Math.floor((s.getRect().x - c) / this.repulsionRange)), m = parseInt(Math.floor((s.getRect().width + s.getRect().x - c) / this.repulsionRange)), T = parseInt(Math.floor((s.getRect().y - u) / this.repulsionRange)), y = parseInt(Math.floor((s.getRect().height + s.getRect().y - u) / this.repulsionRange));
          for (var A = v; A <= m; A++) for (var O = T; O <= y; O++) this.grid[A][O].push(s), s.setGridCoordinates(v, m, T, y);
        }, a.prototype.updateGrid = function() {
          var s, c, u = this.getAllNodes();
          for (this.grid = this.calcGrid(this.graphManager.getRoot()), s = 0; s < u.length; s++) c = u[s], this.addNodeToGrid(c, this.graphManager.getRoot().getLeft(), this.graphManager.getRoot().getTop());
          ...
          if (this.totalIterations % t.GRID_CALCULATION_CHECK_PERIOD == 1 && u || v) {
            ...
            for (var T, y = this.grid, A = s.startX - 1; A < s.finishX + 2; A++) for (var O = s.startY - 1; O < s.finishY + 2; O++) if (!(A < 0 || O < 0 || A >= y.length || O >= y[0].length)) {
              for (var R = 0; R < y[A][O].length; R++) if (T = y[A][O][R], !(s.getOwner() != T.getOwner() || s == T) && !c.has(T) && !m.has(T)) {
                var n2 = Math.abs(s.getCenterX() - T.getCenterX()) - (s.getWidth() / 2 + T.getWidth() / 2), h = Math.abs(s.getCenterY() - T.getCenterY()) - (s.getHeight() / 2 + T.getHeight() / 2);
                n2 <= this.repulsionRange && h <= this.repulsionRange && m.add(T);
              }
            }
            s.surrounding = [].concat(i(m));
          }
      ...
      function(E2, I, o) {
        ...
        m$1(t, "FDLayoutEdge"), t.prototype = Object.create(i.prototype);
      ...
      function(E2, I, o) {
        ...
        m$1(e, "FDLayoutNode"), e.prototype = Object.create(i.prototype);
        for (var t in i) e[t] = i[t];
      ...
      function(E2, I, o) {
        ...
        m$1(e, "HashSet"), e.prototype.add = function(t) {
          ...
          for (var r = Object.keys(this.set), l = r.length, f = 0; f < l; f++) t.push(this.set[r[f]]);
        }, e.prototype.size = function() {
          return Object.keys(this.set).length;
      ...
      function(E2, I, o) {
        var i = function() {
          ...
          return m$1(l, "defineProperties"), function(f, a, d2) {
            return a && l(f.prototype, a), d2 && l(f, d2), f;
          };
        }();
        function e(l, f) {
        ...
        m$1(e, "_classCallCheck");
        var t = o(11), r = function() {
          function l(f, a) {
            e(this, l), (a !== null || a !== void 0) && (this.compareFunction = this._defaultCompareFunction);
            var d2 = void 0;
            f instanceof t ? d2 = f.size() : d2 = f.length, this._quicksort(f, 0, d2 - 1);
          }
          return m$1(l, "Quicksort"), i(l, [
            {
              key: "_quicksort",
              value: m$1(function(a, d2, s) {
                if (d2 < s) {
                  var c = this._partition(a, d2, s);
                  this._quicksort(a, d2, c), this._quicksort(a, c + 1, s);
                }
              }, "_quicksort")
            },
            {
              key: "_partition",
              value: m$1(function(a, d2, s) {
                for (var c = this._get(a, d2), u = d2, v = s; ; ) {
                  for (; this.compareFunction(c, this._get(a, v)); ) v--;
                  for (; this.compareFunction(this._get(a, u), c); ) u++;
            ...
            {
              key: "_get",
              value: m$1(function(a, d2) {
                return a instanceof t ? a.get_object_at(d2) : a[d2];
              }, "_get")
            },
            {
              key: "_set",
              value: m$1(function(a, d2, s) {
                a instanceof t ? a.set_object_at(d2, s) : a[d2] = s;
              }, "_set")
            },
            {
              key: "_swap",
              value: m$1(function(a, d2, s) {
                var c = this._get(a, d2);
                this._set(a, d2, this._get(a, s)), this._set(a, s, c);
              }, "_swap")
            },
            {
      ...
      function(E2, I, o) {
        var i = function() {
          function r(l, f) {
            for (var a = 0; a < f.length; a++) {
              var d2 = f[a];
              d2.enumerable = d2.enumerable || false, d2.configurable = true, "value" in d2 && (d2.writable = true), Object.defineProperty(l, d2.key, d2);
            }
          }
        ...
        var t = function() {
          function r(l, f) {
            var a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1, d2 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : -1, s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : -1;
            e(this, r), this.sequence1 = l, this.sequence2 = f, this.match_score = a, this.mismatch_penalty = d2, this.gap_penalty = s, this.iMax = l.length + 1, this.jMax = f.length + 1, this.grid = new Array(this.iMax);
          ...
          return m$1(r, "NeedlemanWunsch"), i(r, [
            ...
            },
            {
              ...
              value: m$1(function() {
                ...
                for (var d2 = 1; d2 < this.iMax; d2++) for (var s = 1; s < this.jMax; s++) {
                  var c = void 0;
                  this.sequence1[d2 - 1] === this.sequence2[s - 1] ? c = this.grid[d2 - 1][s - 1] + this.match_score : c = this.grid[d2 - 1][s - 1] + this.mismatch_penalty;
                  var u = this.grid[d2 - 1][s] + this.gap_penalty, v = this.grid[d2][s - 1] + this.gap_penalty, m = [
                    c,
                    u,
                    v
                  ], T = this.arrayAllMaxIndexes(m);
                  this.grid[d2][s] = m[T[0]], this.tracebackGrid[d2][s] = [
                    T.includes(0),
                    T.includes(1),
                    T.includes(2)
                  ];
            ...
            },
            {
              ...
              value: m$1(function() {
                ...
                for (f.push({
                  ...
                  var a = f[0], d2 = this.tracebackGrid[a.pos[0]][a.pos[1]];
                  d2[0] && f.push({
                    pos: [
                      a.pos[0] - 1,
                      a.pos[1] - 1
            ...
            {
              key: "getAllIndexes",
              value: m$1(function(f, a) {
                for (var d2 = [], s = -1; (s = f.indexOf(a, s + 1)) !== -1; ) d2.push(s);
                return d2;
              }, "getAllIndexes")
            },
            {
              key: "arrayAllMaxIndexes",
              value: m$1(function(f) {
...
var vt = n((it, dt) => {
  m$1(function(I, o) {
    typeof it == "object" && typeof dt == "object" ? dt.exports = o(pt()) : typeof define == "function" && define.amd ? define([
      "layout-base"
    ], o) : typeof it == "object" ? it.coseBase = o(pt()) : I.coseBase = o(I.layoutBase);
  }, "webpackUniversalModuleDefinition")(it, function(E2) {
    return function(I) {
      var o = {};
      function i(e) {
      ...
      function(I, o, i) {
        ...
        m$1(t, "CoSEEdge"), t.prototype = Object.create(e.prototype);
        for (var r in e) t[r] = e[r];
        I.exports = t;
      },
      function(I, o, i) {
        ...
        m$1(t, "CoSEGraph"), t.prototype = Object.create(e.prototype);
        for (var r in e) t[r] = e[r];
        I.exports = t;
      },
      function(I, o, i) {
        ...
        m$1(t, "CoSEGraphManager"), t.prototype = Object.create(e.prototype);
        for (var r in e) t[r] = e[r];
        I.exports = t;
      },
      function(I, o, i) {
        ...
        function r(f, a, d2, s) {
          e.call(this, f, a, d2, s);
        }
        m$1(r, "CoSENode"), r.prototype = Object.create(e.prototype);
        ...
        r.prototype.move = function() {
          ...
          for (var d2 = this.getChild().getNodes(), s, c = 0; c < d2.length; c++) s = d2[c], s.getChild() == null ? (s.moveBy(f, a), s.displacementX += f, s.displacementY += a) : s.propogateDisplacementToChildren(f, a);
      ...
      function(I, o, i) {
        var e = i(0).FDLayout, t = i(4), r = i(3), l = i(5), f = i(2), a = i(1), d2 = i(0).FDLayoutConstants, s = i(0).LayoutConstants, c = i(0).Point, u = i(0).PointD, v = i(0).Layout, m = i(0).Integer, T = i(0).IGeometry, y = i(0).LGraph, A = i(0).Transform;
        function O() {
          e.call(this), this.toBeTiled = {};
        }
        m$1(O, "CoSELayout"), O.prototype = Object.create(e.prototype);
        for (var R in e) O[R] = e[R];
        O.prototype.newGraphManager = function() {
          var n2 = new t(this);
          return this.graphManager = n2, n2;
        }, O.prototype.newGraph = function(n2) {
          return new r(null, this.graphManager, n2);
        }, O.prototype.newNode = function(n2) {
          return new l(this.graphManager, n2);
        }, O.prototype.newEdge = function(n2) {
          return new f(null, null, n2);
        }, O.prototype.initParameters = function() {
          e.prototype.initParameters.call(this, arguments), this.isSubLayout || (a.DEFAULT_EDGE_LENGTH < 10 ? this.idealEdgeLength = 10 : this.idealEdgeLength = a.DEFAULT_EDGE_LENGTH, this.useSmartIdealEdgeLengthCalculation = a.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION, this.springConstant = d2.DEFAULT_SPRING_STRENGTH, this.repulsionConstant = d2.DEFAULT_REPULSION_STRENGTH, this.gravityConstant = d2.DEFAULT_GRAVITY_STRENGTH, this.compoundGravityConstant = d2.DEFAULT_COMPOUND_GRAVITY_STRENGTH, this.gravityRangeFactor = d2.DEFAULT_GRAVITY_RANGE_FACTOR, this.compoundGravityRangeFactor = d2.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR, this.prunedNodesAll = [], this.growTreeIterations = 0, this.afterGrowthIterations = 0, this.isTreeGrowing = false, this.isGrowthFinished = false, this.coolingCycle = 0, this.maxCoolingCycle = this.maxIterations / d2.CONVERGENCE_CHECK_PERIOD, this.finalTemperature = d2.CONVERGENCE_CHECK_PERIOD / this.maxIterations, this.coolingAdjuster = 1);
        }, O.prototype.layout = function() {
          var n2 = s.DEFAULT_CREATE_BENDS_AS_NEEDED;
          return n2 && (this.createBendpoints(), this.graphManager.resetAllEdges()), this.level = 0, this.classicLayout();
          ...
          if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
            if (a.TREE_REDUCTION_ON_INCREMENTAL) {
              ...
              var h = new Set(this.getAllNodes()), g = this.nodesWithGravity.filter(function(N) {
                return h.has(N);
              });
              this.graphManager.setAllNodesToApplyGravitation(g);
            }
          } else {
            var n2 = this.getFlatForest();
            if (n2.length > 0) this.positionNodesRadially(n2);
            else {
              this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
              var h = new Set(this.getAllNodes()), g = this.nodesWithGravity.filter(function(p) {
                return h.has(p);
              });
          ...
          if (this.totalIterations % d2.CONVERGENCE_CHECK_PERIOD == 0 && !this.isTreeGrowing && !this.isGrowthFinished) {
          ...
          if (this.isTreeGrowing) {
            if (this.growTreeIterations % 10 == 0) if (this.prunedNodesAll.length > 0) {
              ...
              var n2 = new Set(this.getAllNodes()), h = this.nodesWithGravity.filter(function(D) {
                return n2.has(D);
              });
              this.graphManager.setAllNodesToApplyGravitation(h), this.graphManager.updateBounds(), this.updateGrid(), this.coolingFactor = d2.DEFAULT_COOLING_FACTOR_INCREMENTAL;
            } else this.isTreeGrowing = false, this.isGrowthFinished = true;
            this.growTreeIterations++;
          }
          if (this.isGrowthFinished) {
            if (this.isConverged()) return true;
            this.afterGrowthIterations % 10 == 0 && (this.graphManager.updateBounds(), this.updateGrid()), this.coolingFactor = d2.DEFAULT_COOLING_FACTOR_INCREMENTAL * ((100 - this.afterGrowthIterations) / 100), this.afterGrowthIterations++;
          }
          ...
          for (var n2 = this.graphManager.getAllNodes(), h = {}, g = 0; g < n2.length; g++) {
            var p = n2[g].rect, D = n2[g].id;
            h[D] = {
              id: D,
              x: p.getCenterX(),
              y: p.getCenterY(),
          ...
          var n2 = [], h, g = this.graphManager.getGraphs(), p = g.length, D;
          for (D = 0; D < p; D++) h = g[D], h.updateConnected(), h.isConnected || (n2 = n2.concat(h.getNodes()));
          return n2;
        }, O.prototype.createBendpoints = function() {
          var n2 = [];
          n2 = n2.concat(this.graphManager.getAllEdges());
          var h = /* @__PURE__ */ new Set(), g;
          for (g = 0; g < n2.length; g++) {
            var p = n2[g];
            if (!h.has(p)) {
              var D = p.getSource(), N = p.getTarget();
              if (D == N) p.getBendpoints().push(new u()), p.getBendpoints().push(new u()), this.createDummyNodesForBendpoints(p), h.add(p);
              else {
                var M = [];
                if (M = M.concat(D.getEdgeListToNode(N)), M = M.concat(N.getEdgeListToNode(D)), !h.has(M[0])) {
                  if (M.length > 1) {
                    var C;
            ...
            if (h.size == n2.length) break;
          }
        }, O.prototype.positionNodesRadially = function(n2) {
          for (var h = new c(0, 0), g = Math.ceil(Math.sqrt(n2.length)), p = 0, D = 0, N = 0, M = new u(0, 0), C = 0; C < n2.length; C++) {
            C % g == 0 && (N = 0, D = p, C != 0 && (D += a.DEFAULT_COMPONENT_SEPERATION), p = 0);
            var w = n2[C], P = v.findCenterOfTree(w);
            h.x = N, h.y = D, M = O.radialLayout(w, P, h), M.y > p && (p = Math.floor(M.y)), N = Math.floor(M.x + a.DEFAULT_COMPONENT_SEPERATION);
          }
          this.transform(new u(s.WORLD_CENTER_X - M.x / 2, s.WORLD_CENTER_Y - M.y / 2));
        }, O.radialLayout = function(n2, h, g) {
          var p = Math.max(this.maxDiagonalInTree(n2), a.DEFAULT_RADIAL_SEPARATION);
          O.branchRadialLayout(h, null, 0, 359, 0, p);
          var D = y.calculateBounds(n2), N = new A();
          N.setDeviceOrgX(D.getMinX()), N.setDeviceOrgY(D.getMinY()), N.setWorldOrgX(g.x), N.setWorldOrgY(g.y);
          for (var M = 0; M < n2.length; M++) {
            var C = n2[M];
            C.transform(N);
          }
          var w = new u(D.getMaxX(), D.getMaxY());
          return N.inverseTransformPoint(w);
        }, O.branchRadialLayout = function(n2, h, g, p, D, N) {
          var M = (p - g + 1) / 2;
          M < 0 && (M += 180);
          var C = (M + g) % 360, w = C * T.TWO_PI / 360, U = D * Math.cos(w), F2 = D * Math.sin(w);
          n2.setCenter(U, F2);
          var x = [];
          x = x.concat(n2.getEdges());
          var G = x.length;
          h != null && G--;
          for (var S2 = 0, _ = x.length, X, b = n2.getEdgesBetween(h); b.length > 1; ) {
            var H = b[0];
            b.splice(0, 1);
            var z = x.indexOf(H);
          ...
          for (var B = Math.abs(p - g) / G, Y = X; S2 != G; Y = ++Y % _) {
            var K = x[Y].getOtherEnd(n2);
            if (K != h) {
              var j = (g + S2 * B) % 360, $ = (j + B) % 360;
              O.branchRadialLayout(K, n2, j, $, D + N, N), S2++;
            }
          }
        }, O.maxDiagonalInTree = function(n2) {
          for (var h = m.MIN_VALUE, g = 0; g < n2.length; g++) {
            var p = n2[g], D = p.getDiagonal();
            D > h && (h = D);
          }
          return h;
          ...
          for (var g = [], p = this.graphManager.getAllNodes(), D = 0; D < p.length; D++) {
            var N = p[D], M = N.getParent();
            this.getNodeDegreeWithChildren(N) === 0 && (M.id == null || !this.getToBeTiled(M)) && g.push(N);
          }
          for (var D = 0; D < g.length; D++) {
            var N = g[D], C = N.getParent().id;
            typeof h[C] > "u" && (h[C] = []), h[C] = h[C].concat(N);
          }
          Object.keys(h).forEach(function(w) {
            if (h[w].length > 1) {
              var P = "DummyCompound_" + w;
              n2.memberGroups[P] = h[w];
              var U = h[w][0].getParent(), F2 = new l(n2.graphManager);
              F2.id = P, F2.paddingLeft = U.paddingLeft || 0, F2.paddingRight = U.paddingRight || 0, F2.paddingBottom = U.paddingBottom || 0, F2.paddingTop = U.paddingTop || 0, n2.idToDummyNode[P] = F2;
              var x = n2.getGraphManager().add(n2.newGraph(), F2), G = U.getChild();
              G.add(F2);
              for (var S2 = 0; S2 < h[w].length; S2++) {
                var _ = h[w][S2];
                G.remove(_), x.add(_);
              }
            }
          ...
          for (var g = 0; g < this.compoundOrder.length; g++) h[this.compoundOrder[g].id] = this.compoundOrder[g], n2[this.compoundOrder[g].id] = [].concat(this.compoundOrder[g].getChild().getNodes()), this.graphManager.remove(this.compoundOrder[g].getChild()), this.compoundOrder[g].child = null;
          this.graphManager.resetAllNodes(), this.tileCompoundMembers(n2, h);
        }, O.prototype.clearZeroDegreeMembers = function() {
          var n2 = this, h = this.tiledZeroDegreePack = [];
          Object.keys(this.memberGroups).forEach(function(g) {
            var p = n2.idToDummyNode[g];
            h[g] = n2.tileNodes(n2.memberGroups[g], p.paddingLeft + p.paddingRight), p.rect.width = h[g].width, p.rect.height = h[g].height;
          });
        }, O.prototype.repopulateCompounds = function() {
          for (var n2 = this.compoundOrder.length - 1; n2 >= 0; n2--) {
            var h = this.compoundOrder[n2], g = h.id, p = h.paddingLeft, D = h.paddingTop;
          ...
          Object.keys(h).forEach(function(g) {
            var p = n2.idToDummyNode[g], D = p.paddingLeft, N = p.paddingTop;
            n2.adjustLocations(h[g], p.rect.x, p.rect.y, D, N);
          });
        }, O.prototype.getToBeTiled = function(n2) {
          var h = n2.id;
          if (this.toBeTiled[h] != null) return this.toBeTiled[h];
          var g = n2.getChild();
          if (g == null) return this.toBeTiled[h] = false, false;
          for (var p = g.getNodes(), D = 0; D < p.length; D++) {
            var N = p[D];
        ...
        }, O.prototype.getNodeDegree = function(n2) {
          for (var h = n2.id, g = n2.getEdges(), p = 0, D = 0; D < g.length; D++) {
            var N = g[D];
            N.getSource().id !== N.getTarget().id && (p = p + 1);
          }
          return p;
        }, O.prototype.getNodeDegreeWithChildren = function(n2) {
          var h = this.getNodeDegree(n2);
          if (n2.getChild() == null) return h;
          for (var g = n2.getChild().getNodes(), p = 0; p < g.length; p++) {
            var D = g[p];
            h += this.getNodeDegreeWithChildren(D);
          }
          return h;
        }, O.prototype.performDFSOnCompounds = function() {
          this.compoundOrder = [], this.fillCompexOrderByDFS(this.graphManager.getRoot().getNodes());
        }, O.prototype.fillCompexOrderByDFS = function(n2) {
        ...
        }, O.prototype.adjustLocations = function(n2, h, g, p, D) {
          h += p, g += D;
          for (var N = h, M = 0; M < n2.rows.length; M++) {
            var C = n2.rows[M];
            h = N;
            for (var w = 0, P = 0; P < C.length; P++) {
              var U = C[P];
              U.rect.x = h, U.rect.y = g, h += U.rect.width + n2.horizontalPadding, U.rect.height > w && (w = U.rect.height);
            }
            g += w + n2.verticalPadding;
          }
        }, O.prototype.tileCompoundMembers = function(n2, h) {
          var g = this;
          this.tiledMemberPack = [], Object.keys(n2).forEach(function(p) {
            var D = h[p];
            g.tiledMemberPack[p] = g.tileNodes(n2[p], D.paddingLeft + D.paddingRight), D.rect.width = g.tiledMemberPack[p].width, D.rect.height = g.tiledMemberPack[p].height;
          });
        }, O.prototype.tileNodes = function(n2, h) {
          ...
          n2.sort(function(C, w) {
            return C.rect.width * C.rect.height > w.rect.width * w.rect.height ? -1 : C.rect.width * C.rect.height < w.rect.width * w.rect.height ? 1 : 0;
          });
          for (var N = 0; N < n2.length; N++) {
            var M = n2[N];
            D.rows.length == 0 ? this.insertNodeToRow(D, M, 0, h) : this.canAddHorizontal(D, M.rect.width, M.rect.height) ? this.insertNodeToRow(D, M, this.getShortestRowIndex(D), h) : this.insertNodeToRow(D, M, D.rows.length, h), this.shiftToLastRow(D);
          }
          return D;
        }, O.prototype.insertNodeToRow = function(n2, h, g, p) {
          var D = p;
          if (g == n2.rows.length) {
            var N = [];
            n2.rows.push(N), n2.rowWidth.push(D), n2.rowHeight.push(0);
          }
          var M = n2.rowWidth[g] + h.rect.width;
          n2.rows[g].length > 0 && (M += n2.horizontalPadding), n2.rowWidth[g] = M, n2.width < M && (n2.width = M);
          var C = h.rect.height;
          g > 0 && (C += n2.verticalPadding);
          var w = 0;
          C > n2.rowHeight[g] && (w = n2.rowHeight[g], n2.rowHeight[g] = C, w = n2.rowHeight[g] - w), n2.height += w, n2.rows[g].push(h);
        }, O.prototype.getShortestRowIndex = function(n2) {
          for (var h = -1, g = Number.MAX_VALUE, p = 0; p < n2.rows.length; p++) n2.rowWidth[p] < g && (h = p, g = n2.rowWidth[p]);
          return h;
        }, O.prototype.getLongestRowIndex = function(n2) {
          for (var h = -1, g = Number.MIN_VALUE, p = 0; p < n2.rows.length; p++) n2.rowWidth[p] > g && (h = p, g = n2.rowWidth[p]);
          return h;
        }, O.prototype.canAddHorizontal = function(n2, h, g) {
          var p = this.getShortestRowIndex(n2);
          if (p < 0) return true;
          var D = n2.rowWidth[p];
          if (D + n2.horizontalPadding + h <= n2.width) return true;
          var N = 0;
          n2.rowHeight[p] < g && p > 0 && (N = g + n2.verticalPadding - n2.rowHeight[p]);
          var M;
          n2.width - D >= h + n2.horizontalPadding ? M = (n2.height + N) / (D + h + n2.horizontalPadding) : M = (n2.height + N) / n2.width, N = g + n2.verticalPadding;
          var C;
          return n2.width < h ? C = (n2.height + N) / h : C = (n2.height + N) / n2.width, C < 1 && (C = 1 / C), M < 1 && (M = 1 / M), M < C;
        }, O.prototype.shiftToLastRow = function(n2) {
          var h = this.getLongestRowIndex(n2), g = n2.rowWidth.length - 1, p = n2.rows[h], D = p[p.length - 1], N = D.width + n2.horizontalPadding;
          if (n2.width - n2.rowWidth[g] > N && h != g) {
            p.splice(-1, 1), n2.rows[g].push(D), n2.rowWidth[h] = n2.rowWidth[h] - N, n2.rowWidth[g] = n2.rowWidth[g] + N, n2.width = n2.rowWidth[instance.getLongestRowIndex(n2)];
            for (var M = Number.MIN_VALUE, C = 0; C < p.length; C++) p[C].height > M && (M = p[C].height);
            h > 0 && (M += n2.verticalPadding);
            var w = n2.rowHeight[h] + n2.rowHeight[g];
            n2.rowHeight[h] = M, n2.rowHeight[g] < D.height + n2.verticalPadding && (n2.rowHeight[g] = D.height + n2.verticalPadding);
            var P = n2.rowHeight[h] + n2.rowHeight[g];
            n2.height += P - w, this.shiftToLastRow(n2);
          }
          ...
          for (var n2 = [], h = true, g; h; ) {
            var p = this.graphManager.getAllNodes(), D = [];
            h = false;
            ...
            if (h == true) {
              ...
              n2.push(M), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
            }
          }
          this.prunedNodesAll = n2;
        }, O.prototype.growTree = function(n2) {
          for (var h = n2.length, g = n2[h - 1], p, D = 0; D < g.length; D++) p = g[D], this.findPlaceforPrunedNode(p), p[2].add(p[0]), p[2].add(p[1], p[1].source, p[1].target);
          n2.splice(n2.length - 1, 1), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
        }, O.prototype.findPlaceforPrunedNode = function(n2) {
          var h, g, p = n2[0];
          p == n2[1].source ? g = n2[1].target : g = n2[1].source;
          var D = g.startX, N = g.finishX, M = g.startY, C = g.finishY, w = 0, P = 0, U = 0, F2 = 0, x = [
            w,
            U,
            P,
            F2
          ...
          for (var S2 = m.MAX_VALUE, _, X, b = 0; b < x.length; b++) x[b] < S2 ? (S2 = x[b], _ = 1, X = b) : x[b] == S2 && _++;
          if (_ == 3 && S2 == 0) x[0] == 0 && x[1] == 0 && x[2] == 0 ? h = 1 : x[0] == 0 && x[1] == 0 && x[3] == 0 ? h = 0 : x[0] == 0 && x[2] == 0 && x[3] == 0 ? h = 3 : x[1] == 0 && x[2] == 0 && x[3] == 0 && (h = 2);
          else if (_ == 2 && S2 == 0) {
          ...
          h == 0 ? p.setCenter(g.getCenterX(), g.getCenterY() - g.getHeight() / 2 - d2.DEFAULT_EDGE_LENGTH - p.getHeight() / 2) : h == 1 ? p.setCenter(g.getCenterX() + g.getWidth() / 2 + d2.DEFAULT_EDGE_LENGTH + p.getWidth() / 2, g.getCenterY()) : h == 2 ? p.setCenter(g.getCenterX(), g.getCenterY() + g.getHeight() / 2 + d2.DEFAULT_EDGE_LENGTH + p.getHeight() / 2) : p.setCenter(g.getCenterX() - g.getWidth() / 2 - d2.DEFAULT_EDGE_LENGTH - p.getWidth() / 2, g.getCenterY());
        }, I.exports = O;
      },
      function(I, o, i) {
        var e = {};
        e.layoutBase = i(0), e.CoSEConstants = i(1), e.CoSEEdge = i(2), e.CoSEGraph = i(3), e.CoSEGraphManager = i(4), e.CoSELayout = i(6), e.CoSENode = i(5), I.exports = e;
      }
    ]);
  });
});
var xt = n((nt, yt) => {
  m$1(function(I, o) {
    typeof nt == "object" && typeof yt == "object" ? yt.exports = o(vt()) : typeof define == "function" && define.amd ? define([
      "cose-base"
    ], o) : typeof nt == "object" ? nt.cytoscapeCoseBilkent = o(vt()) : I.cytoscapeCoseBilkent = o(I.coseBase);
  }, "webpackUniversalModuleDefinition")(nt, function(E2) {
    return function(I) {
      var o = {};
      function i(e) {
        if (o[e]) return o[e].exports;
      ...
      function(I, o, i) {
        var e = i(0).layoutBase.LayoutConstants, t = i(0).layoutBase.FDLayoutConstants, r = i(0).CoSEConstants, l = i(0).CoSELayout, f = i(0).CoSENode, a = i(0).layoutBase.PointD, d2 = i(0).layoutBase.DimensionD, s = {
          ready: m$1(function() {
          }, "ready"),
          stop: m$1(function() {
          }, "stop"),
        ...
        m$1(c, "extend");
        function u(T) {
          this.options = c(s, T), v(this.options);
        }
        m$1(u, "_CoSELayout");
        var v = m$1(function(y) {
        ...
        u.prototype.run = function() {
          ...
          this.idToLNode = {};
          var R = this.layout = new l(), n2 = this;
          n2.stopped = false, this.cy = this.options.cy, this.cy.trigger({
            type: "layoutstart",
            layout: this
          });
          var h = R.newGraphManager();
          this.gm = h;
          var g = this.options.eles.nodes(), p = this.options.eles.edges();
          this.root = h.addRoot(), this.processChildrenList(this.root, this.getTopMostNodes(g), R);
          for (var D = 0; D < p.length; D++) {
            var N = p[D], M = this.idToLNode[N.data("source")], C = this.idToLNode[N.data("target")];
            if (M !== C && M.getEdgesBetween(C).length == 0) {
              var w = h.add(R.newEdge(), M, C);
              w.id = N.id();
            }
          }
          var P = m$1(function(x, G) {
            typeof x == "number" && (x = G);
            var S2 = x.data("id"), _ = n2.idToLNode[S2];
            return {
              x: _.getRect().getCenterX(),
              y: _.getRect().getCenterY()
            };
          }, "getPositions"), U = m$1(function F2() {
            for (var x = m$1(function() {
              A.fit && A.cy.fit(A.eles, A.padding), T || (T = true, n2.cy.one("layoutready", A.ready), n2.cy.trigger({
                type: "layoutready",
                layout: n2
              }));
            }, "afterReposition"), G = n2.options.refresh, S2, _ = 0; _ < G && !S2; _++) S2 = n2.stopped || n2.layout.tick();
            if (S2) {
              R.checkLayoutSuccess() && !R.isSubLayout && R.doPostLayout(), R.tilingPostLayout && R.tilingPostLayout(), R.isLayoutFinished = true, n2.options.eles.nodes().positions(P), x(), n2.cy.one("layoutstop", n2.options.stop), n2.cy.trigger({
                type: "layoutstop",
                layout: n2
              }), y && cancelAnimationFrame(y), T = false;
              return;
            }
            var X = n2.layout.getPositionsData();
            A.eles.nodes().positions(function(b, H) {
              if (typeof b == "number" && (b = H), !b.isParent()) {
                for (var z = b.id(), B = X[z], Y = b; B == null && (B = X[Y.data("parent")] || X["DummyCompound_" + Y.data("parent")], X[z] = B, Y = Y.parent()[0], Y != null); ) ;
                return B != null ? {
                  x: B.x,
                  y: B.y
                } : {
            ...
            }), x(), y = requestAnimationFrame(F2);
          }, "iterateAnimated");
          return R.addListener("layoutstarted", function() {
            n2.options.animate === "during" && (y = requestAnimationFrame(U));
          }), R.runLayout(), this.options.animate !== "during" && (n2.options.eles.nodes().not(":parent").layoutPositions(n2, n2.options, P), T = false), this;
        }, u.prototype.getTopMostNodes = function(T) {
          for (var y = {}, A = 0; A < T.length; A++) y[T[A].id()] = true;
          var O = T.filter(function(R, n2) {
            typeof R == "number" && (R = n2);
          ...
          for (var O = y.length, R = 0; R < O; R++) {
            var n2 = y[R], h = n2.children(), g, p = n2.layoutDimensions({
              nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels
            });
            if (n2.outerWidth() != null && n2.outerHeight() != null ? g = T.add(new f(A.graphManager, new a(n2.position("x") - p.w / 2, n2.position("y") - p.h / 2), new d2(parseFloat(p.w), parseFloat(p.h)))) : g = T.add(new f(this.graphManager)), g.id = n2.data("id"), g.paddingLeft = parseInt(n2.css("padding")), g.paddingTop = parseInt(n2.css("padding")), g.paddingRight = parseInt(n2.css("padding")), g.paddingBottom = parseInt(n2.css("padding")), this.options.nodeDimensionsIncludeLabels && n2.isParent()) {
              var D = n2.boundingBox({
                includeLabels: true,
                includeNodes: false
              }).w, N = n2.boundingBox({
                includeLabels: true,
                includeNodes: false
              }).h, M = n2.css("text-halign");
              g.labelWidth = D, g.labelHeight = N, g.labelPos = M;
            }
            if (this.idToLNode[n2.data("id")] = g, isNaN(g.rect.x) && (g.rect.x = 0), isNaN(g.rect.y) && (g.rect.y = 0), h != null && h.length > 0) {
              var C;
              C = A.getGraphManager().add(A.newGraph(), g), this.processChildrenList(C, h, A);
            }
          }
        }, u.prototype.stop = function() {
          return this.stopped = true, this;
        };
        var m = m$1(function(y) {
...
var gt = function() {
  var E2 = m$1(function(R, n2, h, g) {
    for (h = h || {}, g = R.length; g--; h[R[g]] = n2) ;
    return h;
  }, "o"), I = [
    1,
    4
    ...
    performAction: m$1(function(n2, h, g, p, D, N, M) {
      var C = N.length - 1;
      switch (D) {
        case 6:
        case 7:
    ...
    parseError: m$1(function(n2, h) {
      if (h.recoverable) this.trace(n2);
      else {
        var g = new Error(n2);
        throw g.hash = h, g;
      }
    }, "parseError"),
    parse: m$1(function(n2) {
      var h = this, g = [
        0
      ], p = [], D = [
        null
      ], N = [], M = this.table, C = "", w = 0, P = 0, U = 0, F2 = 2, x = 1, G = N.slice.call(arguments, 1), S2 = Object.create(this.lexer), _ = {
        yy: {}
      };
      for (var X in this.yy) Object.prototype.hasOwnProperty.call(this.yy, X) && (_.yy[X] = this.yy[X]);
      S2.setInput(n2, _.yy), _.yy.lexer = S2, _.yy.parser = this, typeof S2.yylloc > "u" && (S2.yylloc = {});
      var b = S2.yylloc;
      N.push(b);
      var H = S2.options && S2.options.ranges;
      ...
      function B() {
        var W;
        return W = p.pop() || S2.lex() || x, typeof W != "number" && (W instanceof Array && (p = W, W = p.pop()), W = h.symbols_[W] || W), W;
      }
      m$1(B, "lex");
      for (var Y, K, j, $, ge, ot, J = {}, st, Z, Et, at; ; ) {
        if (j = g[g.length - 1], this.defaultActions[j] ? $ = this.defaultActions[j] : ((Y === null || typeof Y > "u") && (Y = B()), $ = M[j] && M[j][Y]), typeof $ > "u" || !$.length || !$[0]) {
          var ht = "";
          at = [];
          for (st in M[j]) this.terminals_[st] && st > F2 && at.push("'" + this.terminals_[st] + "'");
          S2.showPosition ? ht = "Parse error on line " + (w + 1) + `:
` + S2.showPosition() + `
Expecting ` + at.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : ht = "Parse error on line " + (w + 1) + ": Unexpected " + (Y == x ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(ht, {
        ...
        switch ($[0]) {
          case 1:
            g.push(Y), D.push(S2.yytext), N.push(S2.yylloc), g.push($[1]), Y = null, K ? (Y = K, K = null) : (P = S2.yyleng, C = S2.yytext, w = S2.yylineno, b = S2.yylloc, U > 0);
            break;
          case 2:
            ...
            Z && (g = g.slice(0, -1 * Z * 2), D = D.slice(0, -1 * Z), N = N.slice(0, -1 * Z)), g.push(this.productions_[$[1]][0]), D.push(J.$), N.push(J._$), Et = M[g[g.length - 2]][g[g.length - 1]], g.push(Et);
            break;
          case 3:
            return true;
        }
    ...
    var R = {
      EOF: 1,
      parseError: m$1(function(h, g) {
        if (this.yy.parser) this.yy.parser.parseError(h, g);
        else throw new Error(h);
      }, "parseError"),
      setInput: m$1(function(n2, h) {
        return this.yy = h || this.yy || {}, this._input = n2, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = [
          "INITIAL"
        ], this.yylloc = {
          first_line: 1,
          first_column: 0,
      ...
      input: m$1(function() {
        ...
        this.yytext += n2, this.yyleng++, this.offset++, this.match += n2, this.matched += n2;
        var h = n2.match(/(?:\r\n?|\n).*/g);
        return h ? (this.yylineno++, this.yylloc.last_line++) : this.yylloc.last_column++, this.options.ranges && this.yylloc.range[1]++, this._input = this._input.slice(1), n2;
      }, "input"),
      unput: m$1(function(n2) {
        var h = n2.length, g = n2.split(/(?:\r\n?|\n)/g);
        this._input = n2 + this._input, this.yytext = this.yytext.substr(0, this.yytext.length - h), this.offset -= h;
...
` + this.showPosition(), {
      ...
      less: m$1(function(n2) {
        this.unput(this.match.slice(n2));
      }, "less"),
      pastInput: m$1(function() {
        var n2 = this.matched.substr(0, this.matched.length - this.match.length);
        return (n2.length > 20 ? "..." : "") + n2.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      upcomingInput: m$1(function() {
        var n2 = this.match;
        return n2.length < 20 && (n2 += this._input.substr(0, 20 - n2.length)), (n2.substr(0, 20) + (n2.length > 20 ? "..." : "")).replace(/\n/g, "");
      }, "upcomingInput"),
      showPosition: m$1(function() {
        var n2 = this.pastInput(), h = new Array(n2.length + 1).join("-");
        return n2 + this.upcomingInput() + `
` + h + "^";
      }, "showPosition"),
      test_match: m$1(function(n2, h) {
        var g, p, D;
        ...
        }, this.options.ranges && (D.yylloc.range = this.yylloc.range.slice(0))), p = n2[0].match(/(?:\r\n?|\n).*/g), p && (this.yylineno += p.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: p ? p[p.length - 1].length - p[p.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + n2[0].length
        }, this.yytext += n2[0], this.match += n2[0], this.matches = n2, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [
          this.offset,
          this.offset += this.yyleng
        ]), this._more = false, this._backtrack = false, this._input = this._input.slice(n2[0].length), this.matched += n2[0], g = this.performAction.call(this, this.yy, this, h, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), g) return g;
        if (this._backtrack) {
      ...
      next: m$1(function() {
        ...
        for (var D = this._currentRules(), N = 0; N < D.length; N++) if (g = this._input.match(this.rules[D[N]]), g && (!h || g[0].length > h[0].length)) {
          if (h = g, p = N, this.options.backtrack_lexer) {
            if (n2 = this.test_match(g, D[N]), n2 !== false) return n2;
            if (this._backtrack) {
              h = false;
              continue;
            } else return false;
        ...
        return h ? (n2 = this.test_match(h, D[p]), n2 !== false ? n2 : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: m$1(function(h, g, p, D) {
        switch (p) {
          case 0:
...
gt.parser = gt;
var Ct = gt;
var V = [], Mt = 0, ut = {}, Yt = m$1(() => {
  V = [], Mt = 0, ut = {};
}, "clear"), Xt = m$1(function(E2) {
  for (let I = V.length - 1; I >= 0; I--) if (V[I].level < E2) return V[I];
  return null;
}, "getParent"), kt = m$1(() => V.length > 0 ? V[0] : null, "getMindmap"), Ht = m$1((E2, I, o, i) => {
  var _a, _b;
  tt.info("addNode", E2, I, o, i);
  let e = Hl(), t = ((_a = e.mindmap) == null ? void 0 : _a.padding) ?? pl.mindmap.padding;
  switch (i) {
    case k.ROUNDED_RECT:
    case k.RECT:
    case k.HEXAGON:
  ...
  let r = {
    ...
    type: i,
    children: [],
    width: ((_b = e.mindmap) == null ? void 0 : _b.maxNodeWidth) ?? pl.mindmap.maxNodeWidth,
    padding: t
  }, l = Xt(E2);
  ...
  switch (tt.debug("In get type", E2, I), E2) {
    case "[":
      return k.RECT;
    case "(":
  ...
  ut[E2] = I;
}, "setElementForId"), Bt = m$1((E2) => {
  if (!E2) return;
  let I = Hl(), o = V[V.length - 1];
  E2.icon && (o.icon = Oe(E2.icon, I)), E2.class && (o.class = Oe(E2.class, I));
}, "decorateNode"), Vt = m$1((E2) => {
  switch (E2) {
    case k.DEFAULT:
      return "no-border";
    case k.RECT:
...
}, "type2Str"), jt = m$1(() => tt, "getLogger"), Zt = m$1((E2) => ut[E2], "getElementById"), Qt = {
  clear: Yt,
  addNode: Ht,
  getMindmap: kt,
  nodeType: k,
...
var Gt = q(xt());
var zt = 12, Kt = m$1(function(E2, I, o, i) {
  I.append("path").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E2.type2Str(o.type)).attr("d", `M0 ${o.height - 5} v${-o.height + 2 * 5} q0,-5 5,-5 h${o.width - 2 * 5} q5,0 5,5 v${o.height - 5} H0 Z`), I.append("line").attr("class", "node-line-" + i).attr("x1", 0).attr("y1", o.height).attr("x2", o.width).attr("y2", o.height);
}, "defaultBkg"), Jt = m$1(function(E2, I, o) {
  I.append("rect").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E2.type2Str(o.type)).attr("height", o.height).attr("width", o.width);
}, "rectBkg"), qt = m$1(function(E2, I, o) {
  let i = o.width, e = o.height, t = 0.15 * i, r = 0.25 * i, l = 0.35 * i, f = 0.2 * i;
  I.append("path").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E2.type2Str(o.type)).attr("d", `M0 0 a${t},${t} 0 0,1 ${i * 0.25},${-1 * i * 0.1}
      a${l},${l} 1 0,1 ${i * 0.4},${-1 * i * 0.1}
      a${r},${r} 1 0,1 ${i * 0.35},${1 * i * 0.2}

      a${t},${t} 1 0,1 ${i * 0.15},${1 * e * 0.35}
      a${f},${f} 1 0,1 ${-1 * i * 0.15},${1 * e * 0.65}

      a${r},${t} 1 0,1 ${-1 * i * 0.25},${i * 0.15}
      a${l},${l} 1 0,1 ${-1 * i * 0.5},0
      a${t},${t} 1 0,1 ${-1 * i * 0.25},${-1 * i * 0.15}

      a${t},${t} 1 0,1 ${-1 * i * 0.1},${-1 * e * 0.35}
      a${f},${f} 1 0,1 ${i * 0.1},${-1 * e * 0.65}

    H0 V0 Z`);
}, "cloudBkg"), te = m$1(function(E2, I, o) {
  let i = o.width, e = o.height, t = 0.15 * i;
  I.append("path").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E2.type2Str(o.type)).attr("d", `M0 0 a${t},${t} 1 0,0 ${i * 0.25},${-1 * e * 0.1}
      a${t},${t} 1 0,0 ${i * 0.25},0
      a${t},${t} 1 0,0 ${i * 0.25},0
      a${t},${t} 1 0,0 ${i * 0.25},${1 * e * 0.1}

      a${t},${t} 1 0,0 ${i * 0.15},${1 * e * 0.33}
      a${t * 0.8},${t * 0.8} 1 0,0 0,${1 * e * 0.34}
      a${t},${t} 1 0,0 ${-1 * i * 0.15},${1 * e * 0.33}

      a${t},${t} 1 0,0 ${-1 * i * 0.25},${e * 0.15}
      a${t},${t} 1 0,0 ${-1 * i * 0.25},0
      a${t},${t} 1 0,0 ${-1 * i * 0.25},0
      a${t},${t} 1 0,0 ${-1 * i * 0.25},${-1 * e * 0.15}

      a${t},${t} 1 0,0 ${-1 * i * 0.1},${-1 * e * 0.33}
      a${t * 0.8},${t * 0.8} 1 0,0 0,${-1 * e * 0.34}
      a${t},${t} 1 0,0 ${i * 0.1},${-1 * e * 0.33}

    H0 V0 Z`);
}, "bangBkg"), ee = m$1(function(E2, I, o) {
  I.append("circle").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E2.type2Str(o.type)).attr("r", o.width / 2);
}, "circleBkg");
function re(E2, I, o, i, e) {
  return E2.insert("polygon", ":first-child").attr("points", i.map(function(t) {
    return t.x + "," + t.y;
  }).join(" ")).attr("transform", "translate(" + (e.width - I) / 2 + ", " + o + ")");
}
m$1(re, "insertPolygonShape");
var ie = m$1(function(E2, I, o) {
  ...
  re(I, r, i, l, o);
}, "hexagonBkg"), ne = m$1(function(E2, I, o) {
  I.append("rect").attr("id", "node-" + o.id).attr("class", "node-bkg node-" + E2.type2Str(o.type)).attr("height", o.height).attr("rx", o.padding).attr("ry", o.padding).attr("width", o.width);
}, "roundedRectBkg"), wt = m$1(async function(E2, I, o, i, e) {
  let t = e.htmlLabels, r = i % (zt - 1), l = I.append("g");
  o.section = r;
  let f = "section-" + r;
  r < 0 && (f += " section-root"), l.attr("class", (o.class ? o.class + " " : "") + "mindmap-node " + f);
  let a = l.append("g"), d2 = l.append("g"), s = o.descr.replace(/(<br\/*>)/g, `
`);
  await Qt$1(d2, s, {
    useHtmlLabels: t,
    width: o.width,
    classes: "mindmap-node-label"
  }, e), t || d2.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle");
  let c = d2.node().getBBox(), [u] = S(e.fontSize);
  if (o.height = c.height + u * 1.1 * 0.5 + o.padding, o.width = c.width + 2 * o.padding, o.icon) if (o.type === E2.nodeType.CIRCLE) o.height += 50, o.width += 50, l.append("foreignObject").attr("height", "50px").attr("width", o.width).attr("style", "text-align: center;").append("div").attr("class", "icon-container").append("i").attr("class", "node-icon-" + r + " " + o.icon), d2.attr("transform", "translate(" + o.width / 2 + ", " + (o.height / 2 - 1.5 * o.padding) + ")");
  else {
    o.width += 50;
    let v = o.height;
    o.height = Math.max(v, 60);
    let m = Math.abs(o.height - v);
    l.append("foreignObject").attr("width", "60px").attr("height", o.height).attr("style", "text-align: center;margin-top:" + m / 2 + "px;").append("div").attr("class", "icon-container").append("i").attr("class", "node-icon-" + r + " " + o.icon), d2.attr("transform", "translate(" + (25 + o.width / 2) + ", " + (m / 2 + o.padding / 2) + ")");
  }
  else if (t) {
    let v = (o.width - c.width) / 2, m = (o.height - c.height) / 2;
    d2.attr("transform", "translate(" + v + ", " + m + ")");
  } else {
    let v = o.width / 2, m = o.padding / 2;
    d2.attr("transform", "translate(" + v + ", " + m + ")");
  }
  switch (o.type) {
    case E2.nodeType.DEFAULT:
      Kt(E2, a, o, r);
      break;
    case E2.nodeType.ROUNDED_RECT:
      ne(E2, a, o, r);
      break;
    case E2.nodeType.RECT:
      Jt(E2, a, o, r);
      break;
    case E2.nodeType.CIRCLE:
      a.attr("transform", "translate(" + o.width / 2 + ", " + +o.height / 2 + ")"), ee(E2, a, o, r);
      break;
    case E2.nodeType.CLOUD:
      qt(E2, a, o, r);
      break;
    case E2.nodeType.BANG:
      te(E2, a, o, r);
      break;
    case E2.nodeType.HEXAGON:
      ie(E2, a, o, r);
      break;
  }
  return E2.setElementForId(o.id, l), o.height;
}, "drawNode"), St = m$1(function(E2, I) {
  let o = E2.getElementById(I.id), i = I.x || 0, e = I.y || 0;
  o.attr("transform", "translate(" + i + "," + e + ")");
}, "positionNode");
Gr.use(Gt.default);
async function Ft(E2, I, o, i, e) {
  await wt(E2, I, o, i, e), o.children && await Promise.all(o.children.map((t, r) => Ft(E2, I, t, i < 0 ? r : i, e)));
}
m$1(Ft, "drawNodes");
function se(E2, I) {
  I.edges().map((o, i) => {
    ...
    if (o[0]._private.bodyBounds) {
      ...
      tt.trace("Edge: ", i, e), E2.insert("path").attr("d", `M ${t.startX},${t.startY} L ${t.midX},${t.midY} L${t.endX},${t.endY} `).attr("class", "edge section-edge-" + e.section + " edge-depth-" + e.depth);
    }
  });
}
m$1(se, "drawEdges");
function _t(E2, I, o, i) {
  I.add({
    group: "nodes",
    data: {
      id: E2.id.toString(),
  ...
  }), E2.children && E2.children.forEach((e) => {
    _t(e, I, o, i + 1), I.add({
      group: "edges",
      data: {
        id: `${E2.id}_${e.id}`,
...
function ae(E2, I) {
  return new Promise((o) => {
    let i = ih("body").append("div").attr("id", "cy").attr("style", "display:none"), e = Gr({
    ...
    i.remove(), _t(E2, e, I, 0), e.nodes().forEach(function(t) {
      t.layoutDimensions = () => {
        let r = t.data();
        return {
          w: r.width,
...
function oe(E2, I) {
  I.nodes().map((o, i) => {
    let e = o.data();
    e.x = o.position().x, e.y = o.position().y, St(E2, e);
    let t = E2.getElementById(e.nodeId);
...
var he = m$1(async (E2, I, o, i) => {
  var _a, _b;
  tt.debug(`Rendering mindmap diagram
` + E2);
  let e = i.db, t = e.getMindmap();
  if (!t) return;
  let r = Hl();
  r.htmlLabels = false;
  let l = d(I), f = l.append("g");
  f.attr("class", "mindmap-edges");
  let a = l.append("g");
  a.attr("class", "mindmap-nodes"), await Ft(e, a, t, -1, r);
  let d$1 = await ae(t, r);
  se(f, d$1), oe(e, d$1), Pl(void 0, l, ((_a = r.mindmap) == null ? void 0 : _a.padding) ?? pl.mindmap.padding, ((_b = r.mindmap) == null ? void 0 : _b.useMaxWidth) ?? pl.mindmap.useMaxWidth);
}, "draw"), bt = {
  draw: he
};
var le = m$1((E$1) => {
  let I = "";
  for (let o = 0; o < E$1.THEME_COLOR_LIMIT; o++) E$1["lineColor" + o] = E$1["lineColor" + o] || E$1["cScaleInv" + o], $t$1(E$1["lineColor" + o]) ? E$1["lineColor" + o] = F(E$1["lineColor" + o], 20) : E$1["lineColor" + o] = E(E$1["lineColor" + o], 20);
