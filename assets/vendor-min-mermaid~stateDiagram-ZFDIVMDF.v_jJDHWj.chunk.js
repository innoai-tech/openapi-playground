import { g as gs, B as Be, _ as _e } from './vendor-min-mermaid~chunk-AI4T2ZLM.BmbCvWRN.chunk.js';
...
import { m as mr, W as Wo, h as hn, A as Ao } from './vendor-min-mermaid~chunk-KXVH62NG.CUpUCMGK.chunk.js';
import { i as ia, p as pt, A as As, $ as $s } from './vendor-min-mermaid~chunk-63GW7ZVL.CUmzAGpZ.chunk.js';
var j = /*#__PURE__*/ m$1((e)=>e.append("circle").attr("class", "start-state").attr("r", mr().state.sizeUnit).attr("cx", mr().state.padding + mr().state.sizeUnit).attr("cy", mr().state.padding + mr().state.sizeUnit), "drawStartState"), q = /*#__PURE__*/ m$1((e)=>e.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", mr().state.textHeight).attr("class", "divider").attr("x2", mr().state.textHeight * 2).attr("y1", 0).attr("y2", 0), "drawDivider"), Z = /*#__PURE__*/ m$1((e, n)=>{
    ...
    let s = /*#__PURE__*/ m$1(function(p, y, w) {
        let k = /*#__PURE__*/ p.append("tspan").attr("x", 2 * mr().state.padding).text(y);
        w || k.attr("dy", mr().state.textHeight);
    ...
    let m = /*#__PURE__*/ e.append("line").attr("x1", mr().state.padding).attr("y1", mr().state.padding + g + mr().state.dividerMargin / 2).attr("y2", mr().state.padding + g + mr().state.dividerMargin / 2).attr("class", "descr-divider"), h = /*#__PURE__*/ x.node().getBBox(), d = /*#__PURE__*/ Math.max(h.width, r.width);
    return m.attr("x2", d + 3 * mr().state.padding), e.insert("rect", ":first-child").attr("x", mr().state.padding).attr("y", mr().state.padding).attr("width", d + 2 * mr().state.padding).attr("height", h.height + g + 2 * mr().state.padding).attr("rx", mr().state.radius), e;
...
var D = /*#__PURE__*/ m$1((e, n, s, c)=>{
    ...
    let s = /*#__PURE__*/ n.append("rect").attr("x", 0).attr("y", mr().state.padding), c = /*#__PURE__*/ n.append("g"), { textWidth: r, textHeight: g } = D(e, 0, 0, c);
    ...
    if (mr().state.arrowMarkerAbsolute && (i = /*#__PURE__*/ Ao(true)), x.attr("marker-end", "url(" + i + "#" + c(_e.relationType.DEPENDENCY) + "End)"), s.title !== void 0) {
        let o = /*#__PURE__*/ e.append("g").attr("class", "stateLabel"), { x: m, y: h } = Ut.calcLabelPosition(n.points), d = /*#__PURE__*/ hn.getRows(s.title), p = 0, y = [], w = 0, k = 0;
        ...
        o.insert("rect", ":first-child").attr("class", "box").attr("x", m - w / 2 - mr().state.padding / 2).attr("y", h - M / 2 - mr().state.padding / 2 - 3.5).attr("width", w + mr().state.padding).attr("height", M + mr().state.padding), pt.info(H);
    }
    Y++;
}, "drawEdge");
var S, G = {}, et = /*#__PURE__*/ m$1(function() {}, "setConf"), it = /*#__PURE__*/ m$1(function(e) {
    ...
    Wo(o, y, w, S.useMaxWidth), o.attr("viewBox", `${d.x - S.padding}  ${d.y - S.padding} ` + p + " " + y);
