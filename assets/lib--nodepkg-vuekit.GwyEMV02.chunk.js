import { b as e, u as t, c as r, n as l, d as o, e as a, r as i, f as u, h as s, p as c, g as f, w as p, j as d, o as h, k as m } from "./lib--nodepkg-vueuikit.Cwinxioe.chunk.js";
import { p as v, f as g, B as y, m as b, t as _, i as w } from "./vendor--rxjs.D2Za7iWR.chunk.js";
import { i as P, p as O, k as E, c as j, d as S, b as k, e as R, o as x } from "./lib--nodepkg-typedef.5X_Ny0jI.chunk.js";
import { j as $ } from "./lib--nodepkg-vue-jsx-runtime.CmBQ_T3E.chunk.js";
function C(e10, t2) {
...
function eg(e10) {
  let t2 = function(e11) {
    let { history: t3, location: r3 } = window, l3 = { value: em(e11, r3) }, o2 = { value: t3.state };
    ...
    return o2.value || a2(l3.value, { back: null, current: l3.value, forward: null, position: t3.length - 1, replaced: true, scroll: null }, true), { location: l3, state: o2, push: function(e12, r4) {
      ...
      let u2 = F({}, ev(l3.value, e12, null), { position: i2.position + 1 }, r4);
      a2(e12, u2, false), l3.value = e12;
    }, replace: function(e12, r4) {
      let i2 = F({}, t3.state, ev(o2.value.back, e12, o2.value.forward, true), r4, { position: o2.value.position });
    ...
    let o2 = [], a2 = [], i2 = null, u2 = (a3) => {
      let { state: u3 } = a3, s3 = em(e11, location), c2 = r3.value, f2 = t3.value, p2 = 0;
      if (u3) {
...
(e2 = e8 || (e8 = {}))[e2.aborted = 4] = "aborted", e2[e2.cancelled = 8] = "cancelled", e2[e2.duplicated = 16] = "duplicated";
...
function eI(e10) {
  let r2 = o(eD), l2 = o(eq), a2 = u(() => {
    let l3 = t(e10.to);
    return r2.resolve(l3);
  }), i2 = u(() => {
    let { matched: e11 } = a2.value, { length: t2 } = e11, r3 = e11[t2 - 1], o2 = l2.matched;
    if (!r3 || !o2.length)
      return -1;
    let i3 = o2.findIndex(ea.bind(null, r3));
    if (i3 > -1)
      return i3;
    let u2 = eK(e11[t2 - 2]);
    return t2 > 1 && eK(r3) === u2 && o2[o2.length - 1].path !== u2 ? o2.findIndex(ea.bind(null, e11[t2 - 2])) : i3;
  }), s2 = u(() => i2.value > -1 && function(e11, t2) {
    for (let r3 in t2) {
      let l3 = t2[r3], o2 = e11[r3];
      if ("string" == typeof l3) {
        if (l3 !== o2)
          return false;
      } else if (!q(o2) || o2.length !== l3.length || l3.some((e12, t3) => e12 !== o2[t3]))
        return false;
    }
    return true;
  }(l2.params, a2.value.params)), c2 = u(() => i2.value > -1 && i2.value === l2.matched.length - 1 && ei(l2.params, a2.value.params));
  return { route: a2, href: u(() => a2.value.href), isActive: s2, isExactActive: c2, navigate: function() {
...
let eG = a({ name: "RouterLink", compatConfig: { MODE: 3 }, props: { to: { type: [String, Object], required: true }, replace: Boolean, activeClass: String, exactActiveClass: String, custom: Boolean, ariaCurrentValue: { type: String, default: "page" } }, useLink: eI, setup(e10, t2) {
  let { slots: r2 } = t2, l2 = i(eI(e10)), { options: a2 } = o(eD), c2 = u(() => ({ [eN(e10.activeClass, a2.linkActiveClass, "router-link-active")]: l2.isActive, [eN(e10.exactActiveClass, a2.linkExactActiveClass, "router-link-exact-active")]: l2.isExactActive }));
  return () => {
    let t3 = r2.default && r2.default(l2);
    return e10.custom ? t3 : s("a", { "aria-current": l2.isExactActive ? e10.ariaCurrentValue : null, href: l2.href, onClick: l2.navigate, class: c2.value }, t3);
  };
} });
function eK(e10) {
  return e10 ? e10.aliasOf ? e10.aliasOf.path : e10.path : "";
}
let eN = (e10, t2, r2) => null != e10 ? e10 : null != t2 ? t2 : r2, eT = a({ name: "RouterView", inheritAttrs: false, props: { name: { type: String, default: "default" }, route: Object }, compatConfig: { MODE: 3 }, setup(e10, r2) {
  let { attrs: l2, slots: a2 } = r2, i2 = o(eL), d2 = u(() => e10.route || i2.value), h2 = o(eM, 0), m2 = u(() => {
    let e11, r3 = t(h2), { matched: l3 } = d2.value;
    for (; (e11 = l3[r3]) && !e11.components; )
      r3++;
    return r3;
  }), v2 = u(() => d2.value.matched[m2.value]);
  c(eM, u(() => m2.value + 1)), c(eF, v2), c(eL, d2);
  let g2 = f();
  return p(() => [g2.value, v2.value, e10.name], (e11, t2) => {
    ...
    let t2 = d2.value, r3 = e10.name, o2 = v2.value, i3 = o2 && o2.components[r3];
    if (!i3)
      return eV(a2.default, { Component: i3, route: t2 });
    let u2 = o2.props[r3], c2 = s(i3, F({}, u2 ? true === u2 ? t2.params : "function" == typeof u2 ? u2(t2) : u2 : null, l2, { onVnodeUnmounted: (e11) => {
...
function eH(o2) {
  ...
  let s2 = function(e10, t2) {
    let r2 = [], l2 = /* @__PURE__ */ new Map();
    function o3(e11, i3, u3) {
      let s3, c3;
      let f3 = !u3, p3 = { path: e11.path, redirect: e11.redirect, name: e11.name, meta: e11.meta || {}, aliasOf: void 0, beforeEnter: e11.beforeEnter, props: function(e12) {
        ...
        if ("component" in e12)
          ...
          for (let l3 in e12.components)
            t3[l3] = "object" == typeof r3 ? r3[l3] : r3;
        return t3;
      ...
      for (let t3 of h3) {
        let { path: h4 } = t3;
        if (i3 && "/" !== h4[0]) {
          let e12 = i3.record.path, r3 = "/" === e12[e12.length - 1] ? "" : "/";
          t3.path = i3.record.path + (h4 && r3 + h4);
        }
        if (s3 = function(e12, t4, r3) {
          let l3 = function(e13, t5) {
            let r4 = F({}, eE, t5), l4 = [], o5 = r4.start ? "^" : "", a4 = [];
            for (let t6 of e13) {
              let e14 = t6.length ? [] : [90];
              r4.strict && !t6.length && (o5 += "/");
              for (let l5 = 0; l5 < t6.length; l5++) {
                let i5 = t6[l5], u4 = 40 + (r4.sensitive ? 0.25 : 0);
                if (0 === i5.type)
                  l5 || (o5 += "/"), o5 += i5.value.replace(ej, "\\$&"), u4 += 40;
                else if (1 === i5.type) {
                  let { value: e15, repeatable: r5, optional: s4, regexp: c4 } = i5;
                  ...
                  let p4 = r5 ? `((?:${f4})(?:/(?:${f4}))*)` : `(${f4})`;
                  l5 || (p4 = s4 && t6.length < 2 ? `(?:/${p4})` : "/" + p4), s4 && (p4 += "?"), o5 += p4, u4 += 20, s4 && (u4 += -8), r5 && (u4 += -20), ".*" === f4 && (u4 += -50);
                }
                e14.push(u4);
              }
              l4.push(e14);
            ...
            if (r4.strict && r4.end) {
              let e14 = l4.length - 1;
              l4[e14][l4[e14].length - 1] += 0.7000000000000001;
            }
            r4.strict || (o5 += "/?"), r4.end ? o5 += "$" : r4.strict && (o5 += "(?:/|$)");
            let i4 = new RegExp(o5, r4.sensitive ? "" : "i");
            return { re: i4, score: l4, keys: a4, parse: function(e14) {
              let t6 = e14.match(i4), r5 = {};
              if (!t6)
                return null;
              for (let e15 = 1; e15 < t6.length; e15++) {
                let l5 = t6[e15] || "", o6 = a4[e15 - 1];
                r5[o6.name] = l5 && o6.repeatable ? l5.split("/") : l5;
              }
              return r5;
            }, stringify: function(t6) {
              let r5 = "", l5 = false;
              for (let o6 of e13)
                for (let e14 of (l5 && r5.endsWith("/") || (r5 += "/"), l5 = false, o6))
                  if (0 === e14.type)
                    r5 += e14.value;
                  else if (1 === e14.type) {
                    let { value: a5, repeatable: i5, optional: u4 } = e14, s4 = a5 in t6 ? t6[a5] : "";
                    if (q(s4) && !i5)
                      throw Error(`Provided param "${a5}" is an array but it is not repeatable (* or + modifiers)`);
                    let c4 = q(s4) ? s4.join("/") : s4;
                    if (!c4) {
                      if (u4)
                        o6.length < 2 && (r5.endsWith("/") ? r5 = r5.slice(0, -1) : l5 = true);
                      else
            ...
            let s4 = 0, c4 = "", f4 = "";
            function p4() {
              c4 && (0 === o5 ? t5.push({ type: 0, value: c4 }) : 1 === o5 || 2 === o5 || 3 === o5 ? (t5.length > 1 && ("*" === r4 || "+" === r4) && l4(`A repeatable param (${c4}) must be alone in its segment. eg: '/:ids+.`), t5.push({ type: 1, value: c4, regexp: f4, repeatable: "*" === r4 || "+" === r4, optional: "*" === r4 || "?" === r4 })) : l4("Invalid state to consume buffer"), c4 = "");
            }
            for (; s4 < e13.length; ) {
              if ("\\" === (r4 = e13[s4++]) && 2 !== o5) {
                a4 = o5, o5 = 4;
            ...
            return 2 === o5 && l4(`Unfinished custom RegExp for param "${c4}"`), p4(), u4(), i4;
          }(e12.path), r3), o4 = F(l3, { record: e12, parent: t4, children: [], alias: [] });
          return t4 && !o4.record.aliasOf == !t4.record.aliasOf && t4.children.push(o4), o4;
        }(t3, i3, d3), u3 ? u3.alias.push(s3) : ((c3 = c3 || s3) !== s3 && c3.alias.push(s3), f3 && e11.name && !e$(s3) && a3(e11.name)), p3.children) {
          let e12 = p3.children;
        ...
        u3 = u3 || s3, (s3.record.components && Object.keys(s3.record.components).length || s3.record.name || s3.record.redirect) && function(e12) {
          ...
          for (; t4 < r2.length && function(e13, t5) {
            let r3 = 0, l3 = e13.score, o4 = t5.score;
            for (; r3 < l3.length && r3 < o4.length; ) {
            ...
            if (1 === Math.abs(o4.length - l3.length)) {
              if (eS(l3))
                return 1;
              if (eS(o4))
                return -1;
            }
            return o4.length - l3.length;
          }(e12, r2[t4]) >= 0 && (e12.record.path !== r2[t4].record.path || !function e13(t5, r3) {
            return r3.children.some((r4) => r4 === t5 || e13(t5, r4));
          }(e12, r2[t4])); )
            t4++;
          r2.splice(t4, 0, e12), e12.record.name && !e$(e12) && l2.set(e12.record.name, e12);
        }(s3);
      }
      return c3 ? () => {
        a3(c3);
    ...
    function a3(e11) {
      if (ey(e11)) {
        let t3 = l2.get(e11);
        t3 && (l2.delete(e11), r2.splice(r2.indexOf(t3), 1), t3.children.forEach(a3), t3.alias.forEach(a3));
      } else {
        let t3 = r2.indexOf(e11);
        t3 > -1 && (r2.splice(t3, 1), e11.record.name && l2.delete(e11.record.name), e11.children.forEach(a3), e11.alias.forEach(a3));
      }
    }
    return t2 = eC({ strict: false, end: true, sensitive: false }, t2), e10.forEach((e11) => o3(e11)), { addRoute: o3, resolve: function(e11, t3) {
      ...
      if ("name" in e11 && e11.name) {
        if (!(o4 = l2.get(e11.name)))
          throw ew(1, { location: e11 });
        i3 = o4.record.name, u3 = F(ex(t3.params, o4.keys.filter((e12) => !e12.optional).concat(o4.parent ? o4.parent.keys.filter((e12) => e12.optional) : []).map((e12) => e12.name)), e11.params && ex(e11.params, o4.keys.map((e12) => e12.name))), a4 = o4.stringify(u3);
      } else if (null != e11.path)
        a4 = e11.path, (o4 = r2.find((e12) => e12.re.test(a4))) && (u3 = o4.parse(a4), i3 = o4.record.name);
      else {
        if (!(o4 = t3.name ? l2.get(t3.name) : r2.find((e12) => e12.re.test(t3.path))))
          throw ew(1, { location: e11, currentLocation: t3 });
        i3 = o4.record.name, u3 = F({}, t3.params, e11.params), a4 = o4.stringify(u3);
      }
      let s3 = [], c3 = o4;
      for (; c3; )
        s3.unshift(c3.record), c3 = c3.parent;
      return { name: i3, path: a4, params: u3, matched: s3, meta: s3.reduce((e12, t4) => F(e12, t4.meta), {}) };
    }, removeRoute: a3, getRoutes: function() {
      return r2;
    }, getRecordMatcher: function(e11) {
      return l2.get(e11);
    } };
  }(o2.routes, o2), c2 = o2.parseQuery || eA, f2 = o2.stringifyQuery || ez, p2 = o2.history, d2 = eU(), h2 = eU(), m2 = eU(), v2 = e(eb), g2 = eb;
  z && o2.scrollBehavior && "scrollRestoration" in history && (history.scrollRestoration = "manual");
  let y2 = M.bind(null, (e10) => "" + e10), b2 = M.bind(null, ee), _2 = M.bind(null, et);
  function w2(e10, t2) {
    let r2;
    if (t2 = F({}, t2 || v2.value), "string" == typeof e10) {
      let r3 = el(c2, e10, t2.path), l3 = s2.resolve({ path: r3.path }, t2), o4 = p2.createHref(r3.fullPath);
      return F(r3, l3, { params: _2(l3.params), hash: et(r3.hash), redirectedFrom: void 0, href: o4 });
    }
    if (null != e10.path)
      ...
      let l3 = F({}, e10.params);
      for (let e11 in l3)
        null == l3[e11] && delete l3[e11];
      r2 = F({}, e10, { params: b2(l3) }), t2.params = b2(t2.params);
    }
    let l2 = s2.resolve(r2, t2), o3 = e10.hash || "";
    l2.params = y2(_2(l2.params));
    let a3 = function(e11, t3) {
      let r3 = t3.query ? e11(t3.query) : "";
      return t3.path + (r3 && "?") + r3 + (t3.hash || "");
    }(f2, F({}, e10, { hash: Z(o3).replace(H, "{").replace(Q, "}").replace(T, "^"), path: l2.path })), i3 = p2.createHref(a3);
    return F({ fullPath: a3, hash: o3, query: f2 === ez ? function(e11) {
      let t3 = {};
      for (let r3 in e11) {
        let l3 = e11[r3];
        void 0 !== l3 && (t3[r3] = q(l3) ? l3.map((e12) => null == e12 ? null : "" + e12) : null == l3 ? l3 : "" + l3);
      }
      return t3;
    }(e10.query) : e10.query || {} }, l2, { redirectedFrom: void 0, href: i3 });
  }
  function P2(e10) {
    return "string" == typeof e10 ? el(c2, e10, v2.value.path) : F({}, e10);
  }
  function O2(e10, t2) {
    if (g2 !== e10)
  ...
  function E2(e10) {
    ...
    if (t2 && t2.redirect) {
      let { redirect: r2 } = t2, l2 = "function" == typeof r2 ? r2(e10) : r2;
      return "string" == typeof l2 && ((l2 = l2.includes("?") || l2.includes("#") ? l2 = P2(l2) : { path: l2 }).params = {}), F({ query: e10.query, hash: e10.hash, params: null != l2.path ? {} : e10.params }, l2);
    }
  }
  function j2(e10, t2) {
    let r2;
    let l2 = g2 = w2(e10), o3 = v2.value, a3 = e10.state, i3 = e10.force, u3 = true === e10.replace, s3 = E2(l2);
    return s3 ? j2(F(P2(s3), { state: "object" == typeof s3 ? F({}, a3, s3.state) : a3, force: i3, replace: u3 }), t2 || l2) : (l2.redirectedFrom = t2, !i3 && function(e11, t3, r3) {
      let l3 = t3.matched.length - 1, o4 = r3.matched.length - 1;
      return l3 > -1 && l3 === o4 && ea(t3.matched[l3], r3.matched[o4]) && ei(t3.params, r3.params) && e11(t3.query) === e11(r3.query) && t3.hash === r3.hash;
    }(f2, o3, l2) && (r2 = ew(16, { to: l2, from: o3 }), W2(o3, o3, true, false)), (r2 ? Promise.resolve(r2) : R2(l2, o3)).catch((e11) => eP(e11) ? eP(e11, 2) ? e11 : U2(e11) : L2(e11, l2, o3)).then((e11) => {
      if (e11) {
        if (eP(e11, 2))
          return j2(F({ replace: u3 }, P2(e11.to), { state: "object" == typeof e11.to ? F({}, a3, e11.to.state) : a3, force: i3 }), t2 || l2);
      } else
        e11 = $2(l2, o3, true, u3, a3);
      return x2(l2, o3, e11), e11;
    }));
  }
  function S2(e10, t2) {
    let r2 = O2(e10, t2);
  ...
  function R2(e10, t2) {
    let r2;
    let [l2, o3, a3] = function(e11, t3) {
      let r3 = [], l3 = [], o4 = [], a4 = Math.max(t3.matched.length, e11.matched.length);
      for (let i4 = 0; i4 < a4; i4++) {
        let a5 = t3.matched[i4];
        a5 && (e11.matched.find((e12) => ea(e12, a5)) ? l3.push(a5) : r3.push(a5));
        let u3 = e11.matched[i4];
        u3 && !t3.matched.find((e12) => ea(e12, u3)) && o4.push(u3);
      }
      return [r3, l3, o4];
    }(e10, t2);
    for (let o4 of (r2 = eB(l2.reverse(), "beforeRouteLeave", e10, t2), l2))
      o4.leaveGuards.forEach((l3) => {
        r2.push(eW(l3, e10, t2));
      });
    let i3 = S2.bind(null, e10, t2);
    return r2.push(i3), K2(r2).then(() => {
      for (let l3 of (r2 = [], d2.list()))
        r2.push(eW(l3, e10, t2));
      return r2.push(i3), K2(r2);
    }).then(() => {
      for (let l3 of (r2 = eB(o3, "beforeRouteUpdate", e10, t2), o3))
        l3.updateGuards.forEach((l4) => {
      ...
      for (let l3 of (r2 = [], a3))
        if (l3.beforeEnter) {
          if (q(l3.beforeEnter))
            for (let o4 of l3.beforeEnter)
              r2.push(eW(o4, e10, t2));
          else
            r2.push(eW(l3.beforeEnter, e10, t2));
        }
      return r2.push(i3), K2(r2);
    }).then(() => (e10.matched.forEach((e11) => e11.enterCallbacks = {}), (r2 = eB(a3, "beforeRouteEnter", e10, t2, k2)).push(i3), K2(r2))).then(() => {
      for (let l3 of (r2 = [], h2.list()))
        r2.push(eW(l3, e10, t2));
      return r2.push(i3), K2(r2);
    }).catch((e11) => eP(e11, 8) ? e11 : Promise.reject(e11));
  }
  function x2(e10, t2, r2) {
    m2.list().forEach((l2) => k2(() => l2(e10, t2, r2)));
  }
  function $2(e10, t2, r2, l2, o3) {
    let a3 = O2(e10, t2);
    if (a3)
      return a3;
    let i3 = t2 === eb, u3 = z ? history.state : {};
    r2 && (l2 || i3 ? p2.replace(e10.fullPath, F({ scroll: i3 && u3 && u3.scroll }, o3)) : p2.push(e10.fullPath, o3)), v2.value = e10, W2(e10, t2, r2, i3), U2();
  }
  let C2 = eU(), A2 = eU();
  function L2(e10, t2, r2) {
    U2(e10);
    let l2 = A2.list();
    return l2.length ? l2.forEach((l3) => l3(e10, t2, r2)) : console.error(e10), Promise.reject(e10);
  }
  function U2(e10) {
    return i2 || (i2 = !e10, a2 || (a2 = p2.listen((e11, t2, r2) => {
      if (!G2.listening)
        return;
      let l2 = w2(e11), o3 = E2(l2);
      if (o3) {
        j2(F(o3, { replace: true }), l2).catch(D);
        return;
      }
      g2 = l2;
      let a3 = v2.value;
      if (z) {
        var i3, u3;
        i3 = ep(a3.fullPath, r2.delta), u3 = ef(), ed.set(i3, u3);
      }
      R2(l2, a3).catch((e12) => eP(e12, 12) ? e12 : eP(e12, 2) ? (j2(e12.to, l2).then((e13) => {
        eP(e13, 20) && !r2.delta && r2.type === e3.pop && p2.go(-1, false);
      }).catch(D), Promise.reject()) : (r2.delta && p2.go(-r2.delta, false), L2(e12, l2, a3))).then((e12) => {
        (e12 = e12 || $2(l2, a3, false)) && (r2.delta && !eP(e12, 8) ? p2.go(-r2.delta, false) : r2.type === e3.pop && eP(e12, 20) && p2.go(-1, false)), x2(l2, a3, e12);
      }).catch(D);
    })), C2.list().forEach((t2) => {
      let [r2, l2] = t2;
      return e10 ? l2(e10) : r2();
    }), C2.reset()), e10;
  }
  function W2(e10, t2, r2, a3) {
    let { scrollBehavior: i3 } = o2;
    if (!z || !i3)
      return Promise.resolve();
    let u3 = !r2 && function(e11) {
      let t3 = ed.get(e11);
      return ed.delete(e11), t3;
    }(ep(e10.fullPath, 0)) || (a3 || !r2) && history.state && history.state.scroll || null;
    return l().then(() => i3(e10, t2, u3)).then((e11) => e11 && function(e12) {
      let t3;
      if ("el" in e12) {
        let r3 = e12.el, l2 = "string" == typeof r3 && r3.startsWith("#"), o3 = "string" == typeof r3 ? l2 ? document.getElementById(r3.slice(1)) : document.querySelector(r3) : r3;
        if (!o3)
          return;
        t3 = function(e13, t4) {
          let r4 = document.documentElement.getBoundingClientRect(), l3 = e13.getBoundingClientRect();
          return { behavior: t4.behavior, left: l3.left - r4.left - (t4.left || 0), top: l3.top - r4.top - (t4.top || 0) };
        }(o3, e12);
      } else
        t3 = e12;
  ...
  let B2 = (e10) => p2.go(e10), I2 = /* @__PURE__ */ new Set(), G2 = { currentRoute: v2, listening: true, addRoute: function(e10, t2) {
    let r2, l2;
    return ey(e10) ? (r2 = s2.getRecordMatcher(e10), l2 = t2) : l2 = e10, s2.addRoute(l2, r2);
  ...
  }, resolve: w2, options: o2, push: function(e10) {
    return j2(e10);
  }, replace: function(e10) {
    return j2(F(P2(e10), { replace: true }));
  }, go: B2, back: () => B2(-1), forward: () => B2(1), beforeEach: d2.add, beforeResolve: h2.add, afterEach: m2.add, onError: A2.add, isReady: function() {
    return i2 && v2.value !== eb ? Promise.resolve() : new Promise((e10, t2) => {
      C2.add([e10, t2]);
    });
  }, install(e10) {
    e10.component("RouterLink", eG), e10.component("RouterView", eT), e10.config.globalProperties.$router = this, Object.defineProperty(e10.config.globalProperties, "$route", { enumerable: true, get: () => t(v2) }), z && !u2 && v2.value === eb && (u2 = true, j2(p2.location).catch((e11) => {
    }));
    let l2 = {};
    for (let e11 in eb)
      Object.defineProperty(l2, e11, { get: () => v2.value[e11], enumerable: true });
    e10.provide(eD, this), e10.provide(eq, r(l2)), e10.provide(eL, v2);
    let o3 = e10.unmount;
    I2.add(e10), e10.unmount = function() {
      I2.delete(e10), I2.size < 1 && (g2 = eb, a2 && a2(), a2 = null, v2.value = eb, u2 = false, i2 = false), o3();
    };
  } };
  function K2(e10) {
...
var e0, e1, e2, e3, e4, e8, e5, e6 = Symbol.for("immer-nothing"), e7 = Symbol.for("immer-draftable"), e9 = Symbol.for("immer-state");
function te(e10) {
  for (var t2 = arguments.length, r2 = Array(t2 > 1 ? t2 - 1 : 0), l2 = 1; l2 < t2; l2++)
    r2[l2 - 1] = arguments[l2];
...
function tn(e10) {
  var t2;
  return !!e10 && (to(e10) || Array.isArray(e10) || !!e10[e7] || !!(null === (t2 = e10.constructor) || void 0 === t2 ? void 0 : t2[e7]) || tc(e10) || tf(e10));
}
...
function th(e10) {
  ...
  return tv(e10) || tr(e10) || !tn(e10) || (ti(e10) > 1 && (e10.set = e10.add = e10.clear = e10.delete = tm), Object.freeze(e10), t2 && Object.entries(e10).forEach((e11) => {
    let [t3, r2] = e11;
    return th(r2, true);
  })), e10;
}
...
function tw(e10) {
  e10 === e5 && (e5 = e10.parent_);
}
function tP(e10) {
  return e5 = { drafts_: [], parent_: e5, immer_: e10, canAutoFreeze_: true, unfinalizedDrafts_: 0 };
}
function tO(e10) {
  let t2 = e10[e9];
...
function tE(e10, t2) {
  ...
  let r2 = t2.drafts_[0];
  return void 0 !== e10 && e10 !== r2 ? (r2[e9].modified_ && (t_(t2), te(4)), tn(e10) && (e10 = tj(t2, e10), t2.parent_ || tk(t2, e10)), t2.patches_ && ty("Patches").generateReplacementPatches_(r2[e9].base_, e10, t2.patches_, t2.inversePatches_)) : e10 = tj(t2, r2, []), t_(t2), t2.patches_ && t2.patchListener_(t2.patches_, t2.inversePatches_), e10 !== e6 ? e10 : void 0;
}
...
function tF(e10, t2) {
  let r2 = tc(e10) ? ty("MapSet").proxyMap_(e10, t2) : tf(e10) ? ty("MapSet").proxySet_(e10, t2) : function(e11, t3) {
    let r3 = Array.isArray(e11), l2 = { type_: r3 ? 1 : 0, scope_: t3 ? t3.scope_ : e5, modified_: false, finalized_: false, assigned_: {}, parent_: t3, base_: e11, draft_: null, copy_: null, revoke_: null, isManual_: false }, o2 = l2, a2 = tR;
    r3 && (o2 = [l2], a2 = tx);
    let { revoke: i2, proxy: u2 } = Proxy.revocable(o2, a2);
    return l2.draft_ = u2, l2.revoke_ = i2, u2;
  }(e10, t2);
  return (t2 ? t2.scope_ : e5).drafts_.push(r2), r2;
}
ta(tR, (e10, t2) => {
  tx[e10] = function() {
  ...
  constructor(e10) {
    this.autoFreeze_ = true, this.useStrictShallowCopy_ = false, this.produce = (e11, t2, r2) => {
      ...
      if (e11 && "object" == typeof e11)
        ...
        if (void 0 === (l2 = t2(e11)) && (l2 = e11), l2 === e6 && (l2 = void 0), this.autoFreeze_ && th(l2, true), r2) {
          let t3 = [], o2 = [];
...
function tL() {
  let e10;
  return d((t2, r2) => ({ get: () => (t2(), e10), set(t3) {
    var l2;
...
let tI = C({ elem$: j(), $default: j() }, (t2, r2) => {
  ...
  let r2 = new y(e10[t2]);
  return p(() => e10[t2], (e11) => r2.next(e11)), r2;
}, tK = (e10) => {
  let t2 = {};
  for (let r2 in e10) {
...
let tT = (e10) => {
  let t2 = new tq(e10), r2 = d((e11, r3) => ({ get: () => (e11(), t2.value), set(e12) {
    var l2;
...
function tX(e10, t2, r2) {
  var l2, a2, i2, u2;
  let s2;
  let f2 = k(e10) ? e10 : {}, p2 = P(e10) ? e10 : t2, d2 = null !== (l2 = null != r2 ? r2 : t2) && void 0 !== l2 ? l2 : {}, h2 = Symbol(null !== (a2 = d2.name) && void 0 !== a2 ? a2 : "");
  if (R(f2)) {
    let e11;
    let t3 = () => (void 0 === e11 && (e11 = p2({})), e11);
    return A(C({ value: j().optional(), $default: j().optional() }, (e12, r3) => {
      var l3;
      let { slots: o2 } = r3;
      return c(h2, null !== (l3 = e12.value) && void 0 !== l3 ? l3 : t3()), () => {
        var e13;
        return null === (e13 = o2.default) || void 0 === e13 ? void 0 : e13.call(o2);
      };
    }, { ...d2, name: `Provide(${null !== (i2 = d2.name) && void 0 !== i2 ? i2 : ""})` }), { use: () => o(h2, t3, true) });
  }
  let m2 = x(f2), v2 = () => m2.create({}), g2 = () => (void 0 === s2 && (s2 = p2(v2())), s2);
  return A(C({ ...f2, $default: j().optional() }, (e11, t3) => {
    let { slots: r3 } = t3;
    return c(h2, p2(e11)), () => {
      var e12;
      return null === (e12 = r3.default) || void 0 === e12 ? void 0 : e12.call(r3);
    };
  }, { ...d2, name: `Provide(${null !== (u2 = d2.name) && void 0 !== u2 ? u2 : ""})` }), { use: () => o(h2, g2, true) });
}
export {
  tq as I,
  eY as R,
