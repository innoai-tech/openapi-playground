...
import { V, S } from './vendor-min-mermaid~chunk-G4RV2GLT.CakohKaL.chunk.js';
import { Z as Zf$1 } from './vendor-min-mermaid~chunk-JD2HUS54.BfHD_CEM.chunk.js';
import { I as Ie, Y as Ye } from './vendor-min-mermaid~chunk-CRSA2SMT.DrUenSi3.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { a1 as d_, t as tt, h as hh, k as kh, X as Xf, Z as Zf, Q as Qf, j as jf, K as Kf, J as Jf, e as XC, V as Vf, a2 as p_, b as Vu, s as se } from './vendor-min-mermaid~chunk-63ZE7VZ5.CfadwiGU.chunk.js';
var b1 = "flowchart-", Qe = class {
    ...
    static #_ = m$1(this, "FlowDB");
    sanitizeText(i) {
        return XC.sanitizeText(i, this.config);
    }
    lookUpDomId(i) {
        for (let r of this.vertices.values())if (r.id === i) return r.domId;
        return i;
    }
    addVertex(i, r, n, a, l, g) {
        let c = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : {}, k = arguments.length > 7 ? arguments[7] : void 0;
...
` + k + `
        ...
        if (A) {
            let m = u;
            m?.animate !== void 0 && (A.animate = m.animate), m?.animation !== void 0 && (A.animation = m.animation);
            return;
        }
    ...
    addSingleLink(i, r, n, a) {
        ...
        if (k !== void 0 && (c.text = /*#__PURE__*/ this.sanitizeText(/*#__PURE__*/ k.text.trim()), c.text.startsWith('"') && c.text.endsWith('"') && (c.text = /*#__PURE__*/ c.text.substring(1, c.text.length - 1)), c.labelType = k.type), n !== void 0 && (c.type = n.type, c.stroke = n.stroke, c.length = n.length > 10 ? 10 : n.length), a && !this.edges.some((u)=>u.id === a)) c.id = a, c.isUserDefinedId = true;
            ...
            u.length === 0 ? c.id = /*#__PURE__*/ Ye(c.start, c.end, {
                counter: 0,
                prefix: "L"
...
You have to call mermaid.initialize.`);
    ...
    clear() {
        ...
        ], this.subGraphs = [], this.subGraphLookup = new Map, this.subCount = 0, this.tooltips = new Map, this.firstGraphFlag = true, this.version = i, this.config = /*#__PURE__*/ hh(), Vf();
    }
    setGen(i) {
...
var k1 = /*#__PURE__*/ m$1(function(s, i) {
    ...
    Ie.insertTitle(A, "flowchartTitleText", l?.titleTopMargin || 0, /*#__PURE__*/ n.db.getDiagramTitle()), y(A, f, "flowchart", l?.useMaxWidth || false);
...
var ts = {
    ...
    styles: c1,
    init: /*#__PURE__*/ m$1((s)=>{
        s.flowchart || (s.flowchart = {}), s.layout && d_({
            layout: s.layout
        }), s.flowchart.arrowMarkerAbsolute = s.arrowMarkerAbsolute, d_({
            flowchart: {
