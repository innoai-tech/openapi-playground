...
import { V, S } from './vendor-min-mermaid~chunk-L2HI3BDI.Dq5F1R3d.chunk.js';
import { M as Md } from './vendor-min-mermaid~chunk-B4LOWB5X.T-uFuOvQ.chunk.js';
import { U as Ut, J as Jt } from './vendor-min-mermaid~chunk-RGZHNYJS.BZGdGDWl.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { _ as _n, u as ur, N as No, U as Uo, $ as $o, H as Ho, G as Go, j as jo, n as nn, P as Po, g as En, W as Wr, Z } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
import { p as pt, i as ia } from './vendor-min-mermaid~chunk-BF7QJ6L7.DK9jwCiC.chunk.js';
var b1 = "flowchart-", Qe = class {
    constructor(){
        this.vertexCounter = 0;
        this.config = /*#__PURE__*/ ur();
    ...
    sanitizeText(i) {
        return nn.sanitizeText(i, this.config);
    }
    lookUpDomId(i) {
...
` + k + `
        ...
        if (f === void 0 && (f = {
            ...
            styles: [],
            classes: []
        }, this.vertices.set(i, f)), this.vertexCounter++, r !== void 0 ? (this.config = /*#__PURE__*/ ur(), F = /*#__PURE__*/ this.sanitizeText(/*#__PURE__*/ r.text.trim()), f.labelType = r.type, F.startsWith('"') && F.endsWith('"') && (F = /*#__PURE__*/ F.substring(1, F.length - 1)), f.text = F) : f.text === void 0 && (f.text = i), n !== void 0 && (f.type = n), a?.forEach((m)=>{
            f.styles.push(m);
        }), l?.forEach((m)=>{
            f.classes.push(m);
...
You have to call mermaid.initialize.`);
    ...
    clear(i = "gen-2") {
        ...
        ], this.subGraphs = [], this.subGraphLookup = new Map, this.subCount = 0, this.tooltips = new Map, this.firstGraphFlag = true, this.version = i, this.config = /*#__PURE__*/ ur(), Po();
    }
    setGen(i) {
    ...
    addSubGraph(i, r, n) {
        ...
        }, "uniq")(/*#__PURE__*/ r.flat()), k = c.nodeList, u = c.dir, A = ur().flowchart ?? {};
        if (u = u ?? (A.inheritDir ? this.getDirection() ?? ur().direction ?? void 0 : void 0), this.version === "gen-1") for(let f = 0; f < k.length; f++)k[f] = /*#__PURE__*/ this.lookUpDomId(k[f]);
    ...
    getData() {
        let i = /*#__PURE__*/ ur(), r = [], n = [], a = /*#__PURE__*/ this.getSubGraphs(), l = new Map, g = new Map;
...
var k1 = /*#__PURE__*/ m$1(function(s, i) {
    ...
    let { securityLevel: a, flowchart: l, layout: g } = ur(), c;
...
var m1 = /*#__PURE__*/ m$1((s, i)=>{
    let r = Wr, n = /*#__PURE__*/ r(s, "r"), a = /*#__PURE__*/ r(s, "g"), l = /*#__PURE__*/ r(s, "b");
    return Z(n, a, l, i);
...
var ts = {
    ...
    styles: c1,
    init: /*#__PURE__*/ m$1((s)=>{
        s.flowchart || (s.flowchart = {}), s.layout && _n({
            layout: s.layout
        }), s.flowchart.arrowMarkerAbsolute = s.arrowMarkerAbsolute, _n({
            flowchart: {
