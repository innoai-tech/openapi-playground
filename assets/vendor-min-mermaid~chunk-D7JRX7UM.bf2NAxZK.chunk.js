import { w as w$1, $ } from './vendor-min-mermaid~chunk-IO347I67.DJHmq1cW.chunk.js';
import { S } from './vendor-min-mermaid~chunk-L736DJ4U.DfHRCDE5.chunk.js';
import { I as Ie, C as Ce } from './vendor-min-mermaid~chunk-YM3XIQPS.DjUuqvt-.chunk.js';
import { t as tt, H as Hl, g as gC, S as Sf, w as wf, v as vf, F as Ff, B as Bf, M as Mf, L as Lf } from './vendor-min-mermaid~chunk-ZKYS2E5M.BBMfbsl4.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.ByXaayWf.chunk.js';
var xt = function() {
    var t = m$1(function(G, o, h, n) {
        ...
        performAction: m$1(function(o, h, n, E, g, i, K) {
            var u = i.length - 1;
            switch(g){
                case 3:
                ...
                case 13:
                    let at = i[u - 1];
                    at.description = E.trimColon(i[u]), this.$ = at;
                    break;
                case 14:
                    this.$ = {
                        stmt: "relation",
                ...
                case 26:
                    ...
                    break;
                case 29:
                    this.$ = i[u].trim(), E.setAccTitle(this.$);
                    break;
                case 30:
                case 31:
                    this.$ = i[u].trim(), E.setAccDescription(this.$);
                    break;
                case 32:
                case 33:
                    this.$ = {
        ...
        parse: m$1(function(o) {
            var h = this, n = [
                ...
                null
            ], i = [], K = this.table, u = "", F = 0, U = 0, J = 0, at = 2, ot = 1, Ce = i.slice.call(arguments, 1), k = Object.create(this.lexer), B = {
                yy: {}
            };
            ...
            function Ie() {
                var A;
                return A = E.pop() || k.lex() || ot, typeof A != "number" && (A instanceof Array && (E = A, A = E.pop()), A = h.symbols_[A] || A), A;
            }
            m$1(Ie, "lex");
            for(var D, bt, M, C, He, kt, H = {}, ct, R, Vt, lt;;){
                if (M = n[n.length - 1], this.defaultActions[M] ? C = this.defaultActions[M] : ((D === null || typeof D > "u") && (D = Ie()), C = K[M] && K[M][D]), typeof C > "u" || !C.length || !C[0]) {
                    var Dt = "";
                    lt = [];
...
Expecting ` + lt.join(", ") + ", got '" + (this.terminals_[D] || D) + "'" : Dt = "Parse error on line " + (F + 1) + ": Unexpected " + (D == ot ? "end of input" : "'" + (this.terminals_[D] || D) + "'"), this.parseError(Dt, {
                ...
                switch(C[0]){
                    ...
                    case 2:
                        if (R = this.productions_[C[1]][1], H.$ = g[g.length - R], H._$ = {
                            ...
                            g,
                            i
                        ].concat(Ce)), typeof kt < "u") return kt;
                        R && (n = n.slice(0, -1 * R * 2), g = g.slice(0, -1 * R), i = i.slice(0, -1 * R)), n.push(this.productions_[C[1]][0]), g.push(H.$), i.push(H._$), Vt = K[n[n.length - 2]][n[n.length - 1]], n.push(Vt);
                        break;
                    case 3:
                        return true;
                }
        ...
        var G = {
            EOF: 1,
            parseError: m$1(function(h, n) {
                if (this.yy.parser) this.yy.parser.parseError(h, n);
                else throw new Error(h);
            }, "parseError"),
            setInput: m$1(function(o, h) {
...
` + h + "^";
            ...
            test_match: m$1(function(o, h) {
                ...
                }, this.options.ranges && (g.yylloc.range = this.yylloc.range.slice(0))), E = o[0].match(/(?:\r\n?|\n).*/g), E && (this.yylineno += E.length), this.yylloc = {
                ...
                ]), this._more = false, this._backtrack = false, this._input = this._input.slice(o[0].length), this.matched += o[0], n = this.performAction.call(this, this.yy, this, h, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), n) return n;
                if (this._backtrack) {
            ...
            next: m$1(function() {
                ...
                for(var g = this._currentRules(), i = 0; i < g.length; i++)if (n = this._input.match(this.rules[g[i]]), n && (!h || n[0].length > h[0].length)) {
                    if (h = n, E = i, this.options.backtrack_lexer) {
                        if (o = this.test_match(n, g[i]), o !== false) return o;
                        if (this._backtrack) {
                            h = false;
                            continue;
                        } else return false;
                ...
                return h ? (o = this.test_match(h, g[E]), o !== false ? o : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
                    text: "",
                    token: null,
                    line: this.yylineno
            ...
            performAction: m$1(function(h, n, E, g) {
                switch(E){
                    case 0:
                        return 41;
                    case 1:
...
var Yt = m$1(function(t) {
    let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : ht;
    if (!t.doc) return e;
    let s = e;
    for (let a of t.doc)a.stmt === "dir" && (s = a.value);
    return s;
}, "getDir"), Ge = m$1(function(t, e) {
    return e.db.getClasses();
}, "getClasses"), we = m$1(async function(t, e, s, a) {
    tt.info("REF0:"), tt.info("Drawing state diagram (v2)", e);
    let { securityLevel: c, state: f, layout: r } = Hl();
    a.db.extract(a.db.getRootDocV2());
    let d = a.db.getData(), p = w$1(e, c);
    d.type = a.type, d.layoutAlgorithm = r, d.nodeSpacing = f?.nodeSpacing || 50, d.rankSpacing = f?.rankSpacing || 50, d.markers = [
        "barb"
    ], d.diagramId = e, await S(d, p);
    let T = 8;
    Ie.insertTitle(p, "statediagramTitleText", f?.titleTopMargin ?? 25, a.db.getDiagramTitle()), $(p, T, z, f?.useMaxWidth ?? true);
}, "draw"), ss = {
    getClasses: Ge,
    draw: we,
    getDir: Yt
            ...
            case q:
                {
                    ...
                    let T = {
                        ...
                        style: Ct,
                        labelStyle: "",
                        label: gC.sanitizeText(p.description, Hl()),
                        arrowheadStyle: Lt,
                        labelpos: It,
                        labelType: vt,
                        thickness: Rt,
...
var W = m$1((t, e, s, a, c, f, r, d)=>{
    let p = e.id, T = s.get(p), m = Ye(T), b = Fe(T);
    if (tt.info("dataFetcher parsedItem", e, T, b), p !== "root") {
        let I = dt;
        e.start === true ? I = ne : e.start === false && (I = ae), e.type !== V && (I = e.type), yt.get(p) || yt.set(p, {
            id: p,
            shape: I,
            description: gC.sanitizeText(p, Hl()),
            cssClasses: `${m} ${le}`,
            cssStyles: b
        });
        let S = yt.get(p);
        e.description && (Array.isArray(S.description) ? (S.shape = pt, S.description.push(e.description)) : S.description?.length > 0 ? (S.shape = pt, S.description === p ? S.description = [
            e.description
        ] : S.description = [
            S.description,
            e.description
        ]) : (S.shape = dt, S.description = e.description), S.description = gC.sanitizeTextOrArray(S.description, Hl())), S.description?.length === 1 && S.shape === pt && (S.type === "group" ? S.shape = Nt : S.shape = dt), !S.type && e.doc && (tt.info("Setting cluster for XCX", p, ye(e)), S.type = "group", S.isGroup = true, S.dir = ye(e), S.shape = e.type === ut ? Ot : Nt, S.cssClasses = `${S.cssClasses} ${de} ${f ? pe : ""}`);
        let L = {
            labelStyle: "",
            shape: S.shape,
            label: S.description,
        ...
        if (L.shape === Ot && (L.label = ""), t && t.id !== "root" && (tt.trace("Setting node ", p, " to be child of its parent ", t.id), L.parentId = t.id), L.centerLabel = true, e.note) {
            ...
            w++, Y.id = $, v.parentId = $, St(a, Y, d), St(a, v, d), St(a, L, d);
            let N = p, P = v.id;
...
var De = m$1(()=>({
        ...
        states: new Map,
        documents: {}
    }), "newDoc"), Tt = m$1((t)=>JSON.parse(JSON.stringify(t)), "clone"), xe = class {
    static #_ = m$1(this, "StateDB");
    constructor(e){
        this.clear(), this.version = e, this.setRootDoc = this.setRootDoc.bind(this), this.getDividerId = this.getDividerId.bind(this), this.setDirection = this.setDirection.bind(this), this.trimColon = this.trimColon.bind(this);
    }
    version;
    nodes = [];
    edges = [];
    ...
    setRootDoc(e) {
        tt.info("Setting root doc", e), this.rootDoc = e, this.version === 1 ? this.extract(e) : this.extract(this.getRootDocV2());
    }
    getRootDoc() {
        return this.rootDoc;
    }
    docTranslator(e, s, a) {
        ...
        else if (s.stmt === j && (s.id === "[*]" ? (s.id = a ? e.id + "_start" : e.id + "_end", s.start = a) : s.id = s.id.trim()), s.doc) {
            let c = [], f = [], r;
            for(r = 0; r < s.doc.length; r++)if (s.doc[r].type === ut) {
                let d = Tt(s.doc[r]);
                d.doc = Tt(f), c.push(d), f = [];
            } else f.push(s.doc[r]);
    ...
    extract(e) {
        ...
        e.doc ? s = e.doc : s = e, tt.info(s), this.clear(true), tt.info("Extract initial document:", s), s.forEach((r)=>{
            switch(tt.warn("Statement", r.stmt), r.stmt){
                ...
                case ie:
                    {
                        let d = r.id.trim().split(","), p = r.styleClass.split(",");
                        d.forEach((T)=>{
                            let m = this.getState(T);
                            if (m === void 0) {
                                let b = T.trim();
                                this.addState(b), m = this.getState(b);
                            }
                            m.styles = p.map((b)=>b.replace(/;/g, "")?.trim());
                        });
                    }
                    break;
                case re:
        ...
        let a = this.getStates(), f = Hl().look;
        Te(), W(void 0, this.getRootDocV2(), a, this.nodes, this.edges, true, f, this.classes), this.nodes.forEach((r)=>{
    ...
    addState(e) {
        ...
        if (this.currentDocument.states.has(T) ? (this.currentDocument.states.get(T).doc || (this.currentDocument.states.get(T).doc = a), this.currentDocument.states.get(T).type || (this.currentDocument.states.get(T).type = s)) : (tt.info("Adding state ", T, c), this.currentDocument.states.set(T, {
            ...
            styles: [],
            textStyles: []
        })), c && (tt.info("Setting state description", T, c), typeof c == "string" && this.addDescription(T, c.trim()), typeof c == "object" && c.forEach((m)=>this.addDescription(T, m.trim()))), f) {
            let m = this.currentDocument.states.get(T);
            m.note = f, m.note.text = gC.sanitizeText(m.note.text, Hl());
        }
        r && (tt.info("Setting state classes", T, r), (typeof r == "string" ? [
            r
        ] : r).forEach((b)=>this.setCssClass(T, b.trim()))), d && (tt.info("Setting state styles", T, d), (typeof d == "string" ? [
            d
        ] : d).forEach((b)=>this.setStyle(T, b.trim()))), p && (tt.info("Setting state styles", T, d), (typeof p == "string" ? [
            p
        ] : p).forEach((b)=>this.setTextStyle(T, b.trim())));
    }
    clear(e) {
        this.nodes = [], this.edges = [], this.documents = {
            root: De()
        }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = ke(), e || Sf();
    }
    getState(e) {
    ...
    addRelationObjs(e, s, a) {
        let c = this.startIdIfNeeded(e.id.trim()), f = this.startTypeIfNeeded(e.id.trim(), e.type), r = this.startIdIfNeeded(s.id.trim()), d = this.startTypeIfNeeded(s.id.trim(), s.type);
        this.addState(c, f, e.doc, e.description, e.note, e.classes, e.styles, e.textStyles), this.addState(r, d, s.doc, s.description, s.note, s.classes, s.styles, s.textStyles), this.currentDocument.relations.push({
            id1: c,
            id2: r,
            relationTitle: gC.sanitizeText(a, Hl())
        });
    }
    addRelation(e, s, a) {
        if (typeof e == "object") this.addRelationObjs(e, s, a);
        else {
            let c = this.startIdIfNeeded(e.trim()), f = this.startTypeIfNeeded(e), r = this.endIdIfNeeded(s.trim()), d = this.endTypeIfNeeded(s);
            this.addState(c, f), this.addState(r, d), this.currentDocument.relations.push({
                id1: c,
                id2: r,
                title: gC.sanitizeText(a, Hl())
            });
        }
    }
    addDescription(e, s) {
        let a = this.currentDocument.states.get(e), c = s.startsWith(":") ? s.replace(":", "").trim() : s;
        a.descriptions.push(gC.sanitizeText(c, Hl()));
    }
    cleanupLabel(e) {
    ...
    addStyleClass(e) {
        ...
        s?.split(Me).forEach((c)=>{
            let f = c.replace(/([^;]*);/, "$1").trim();
            if (RegExp(me).exec(c)) {
                let d = f.replace(be, Be).replace(me, be);
                a.textStyles.push(d);
            }
            a.styles.push(f);
        });
    ...
    setCssClass(e, s) {
        e.split(",").forEach((a)=>{
            ...
            if (c === void 0) {
                let f = a.trim();
                this.addState(f), c = this.getState(f);
            }
            c.classes.push(s);
        });
    }
    ...
    getDirection() {
        return this.getDirectionStatement()?.value ?? ee;
    }
    setDirection(e) {
    ...
    getData() {
        ...
        return {
            ...
            other: {},
            config: e,
            direction: Yt(this.getRootDocV2())
        };
    }
    getConfig() {
        return Hl().state;
