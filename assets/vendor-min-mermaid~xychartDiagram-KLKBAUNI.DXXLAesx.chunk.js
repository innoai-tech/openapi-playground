import { d as d$1 } from './vendor-min-mermaid~chunk-L2GBLFDY.bt0T5m3z.chunk.js';
import { v as vr } from './vendor-min-mermaid~chunk-HXN2J7W2.xQdsu3kt.chunk.js';
import { L as Lt$1 } from './vendor-min-mermaid~chunk-RGZHNYJS.BZGdGDWl.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { U as Uo, G as Go, j as jo, $ as $o, H as Ho, N as No, R as Ro, P as Po, M as Mt, a as Pi, D as Di, r as rt } from './vendor-min-mermaid~chunk-NIZHWIZP.41FV3HsL.chunk.js';
import { p as pt$1, _ as oo, k as Zi, A as As } from './vendor-min-mermaid~chunk-BF7QJ6L7.DK9jwCiC.chunk.js';
...
var Q = class {
    ...
    getMaxDimension(t, e) {
        ...
        for (let l of t){
            let x = /*#__PURE__*/ vr(n, 1, l), y = x ? x.width : l.length * e, A = x ? x.height : e;
...
var ht = class extends K {
    ...
    recalculateScale() {
        this.scale = /*#__PURE__*/ oo().domain(this.categories).range(/*#__PURE__*/ this.getRange()).paddingInner(1).paddingOuter(0).align(.5), pt$1.trace("BandAxis axis final categories, range: ", this.categories, /*#__PURE__*/ this.getRange());
    }
    getTickValues() {
...
function Ce() {
    ...
    return d.title = /*#__PURE__*/ jo(), ut.build(tt, d, et, Zt);
}
...
var we = /*#__PURE__*/ m$1(function() {
    Po(), J = 0, tt = /*#__PURE__*/ te(), d = /*#__PURE__*/ ee(), et = /*#__PURE__*/ Jt(), vt = /*#__PURE__*/ et.plotColorPalette.split(",").map((i)=>i.trim()), xt = false, Et = false;
}, "clear"), ne = {
    getDrawableElem: Ce,
    clear: we,
    setAccTitle: No,
...
var ke = /*#__PURE__*/ m$1((i, t, e, a)=>{
    ...
    m$1(B, "getTextTransformation"), pt$1.debug(`Rendering xychart chart
` + i);
    ...
    Ro(_, x.height, x.width, true), _.attr("viewBox", `0 0 ${x.width} ${x.height}`), I.attr("fill", l.backgroundColor), n.setTmpSVGG(/*#__PURE__*/ _.append("g").attr("class", "mermaid-tmp-group"));
