...
import { e as er, J as Jt, D as Dt, P as Pt, K as Kt } from './vendor-min-mermaid~chunk-JOFIKEML.DGFg8CVB.chunk.js';
import { s as sg, d as da, $ as $$1, e as eg, t as tg, r as rg, g as ga } from './vendor-min-mermaid~chunk-DPMNACAB.CIbaf8QU.chunk.js';
import { n } from './vendor-min-mermaid~chunk-LM6QDVU5.BAO1h6r1.chunk.js';
import { m as m$1 } from './vendor-min-mermaid~chunk-GTKDMUJJ.CzbCS-C_.chunk.js';
import { t as tt, h as hh } from './vendor-min-mermaid~chunk-F632ZYSZ.C3jO8jR6.chunk.js';
import { s as sn, _ as _f, J as Jr } from './vendor-min-mermaid~chunk-5ZJXQJOJ.DEJYVNbD.chunk.js';
function h(e) {
    var t = {
        options: {
...
Parent cluster`, s.height), t.setNode(s.id, w), t.parent(f) || (tt.trace("Setting parent", f, s.id), t.setParent(f, s.id, w));
        ...
        if (tt.info("(Insert) Node XXX" + f + ": " + JSON.stringify(/*#__PURE__*/ t.node(f))), r?.clusterNode) {
            ...
            $$1(r, D), r.diff = N.diff || 0, tt.info("New compound node after recursive render XAX", f, "width", r.width, "height", r.height), eg(D, r);
            ...
            node: r
        })) : (tt.trace("Node - the non recursive path XAX", f, b, /*#__PURE__*/ t.node(f), l), await tg(b, /*#__PURE__*/ t.node(f), {
            config: o,
            dir: l
        }));
    })), await m$1(async ()=>{
        let f = /*#__PURE__*/ t.edges().map(async function(r) {
            ...
            tt.info("Edge " + r.v + " -> " + r.w + ": " + JSON.stringify(r)), tt.info("Edge " + r.v + " -> " + r.w + ": ", r, " ", /*#__PURE__*/ JSON.stringify(/*#__PURE__*/ t.edge(r))), tt.info("Fix", a, "ids:", r.v, r.w, "Translating: ", /*#__PURE__*/ a.get(r.v), /*#__PURE__*/ a.get(r.w)), await Dt(p, w);
        });
        await Promise.all(f);
    ...
    return await Promise.all(/*#__PURE__*/ te(t).map(async function(f) {
        let r = /*#__PURE__*/ t.node(f);
        if (tt.info("Position XBX => " + f + ": (" + r.x, "," + r.y, ") width: ", r.width, " height: ", r.height), r?.clusterNode) r.y += S, tt.info("A tainted cluster node XBX1", f, r.id, r.width, r.height, r.x, r.y, /*#__PURE__*/ t.parent(f)), a.get(r.id).node = r, rg(r);
            ...
            tt.debug("OffsetY", N, "labelHeight", E, "halfPadding", w), await ga(d, r), a.get(r.id).node = r;
        } else {
            let w = /*#__PURE__*/ t.node(r.parentId);
            r.y += S / 2, tt.info("A regular node XBX1 - using the padding", r.id, "parent", r.parentId, r.width, r.height, r.x, r.y, "offsetY", r.offsetY, "parent", w, w?.offsetY, r), rg(r);
        }
        ...
        let N = /*#__PURE__*/ Pt(m, r, a, n$1, w, E, c);
        Kt(r, N);
    ...
    er(c, e.markers, e.type, e.diagramId), sg(), Jt(), da(), Z(), e.nodes.forEach((o)=>{
        n.setNode(o.id, {
            ...o
