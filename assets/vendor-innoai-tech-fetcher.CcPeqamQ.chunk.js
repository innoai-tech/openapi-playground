import { M as e, N as t, O as r, T as s, b as n, j as o, k as i, p as a, v as u } from "./vendor-innoai-tech-vuekit.DFxPSnTM.chunk.js";
var p = (e) => !!e && e.constructor === Object, l = Array.isArray, d = (e) => {
...
}, y = (e, t) => new b(e, t), b = class extends t {
	requesting$ = new o(!1);
	error$ = new e();
	_success$ = new e();
	_input$ = new e();
	...
	unsubscribe = this._input$.pipe(s((e) => (this.requesting$.next(!0), i(this.fetcher.request(this.createConfig(e))).pipe(a((e) => this._success$.next(e)), n((e) => (this.error$.next(e), r(e)))))), a(() => {
